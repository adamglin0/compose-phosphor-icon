...
public val BoldGroup.`Table-bold`: ImageVector
    get() {
        if (`_table-bold` != null) {
            return `_table-bold`!!
        }
        `_table-bold` = Builder(name = "Table-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_table-bold`: ImageVector? = null
