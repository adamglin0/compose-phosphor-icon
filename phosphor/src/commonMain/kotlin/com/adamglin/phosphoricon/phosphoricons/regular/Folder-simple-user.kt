...
public val RegularGroup.`Folder-simple-user`: ImageVector
    get() {
        if (`_folder-simple-user` != null) {
            return `_folder-simple-user`!!
        }
        `_folder-simple-user` = Builder(name = "Folder-simple-user", defaultWidth = 256.0.dp,
...
private var `_folder-simple-user`: ImageVector? = null
