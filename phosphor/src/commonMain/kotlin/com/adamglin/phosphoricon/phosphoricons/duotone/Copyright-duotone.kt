...
public val DuotoneGroup.`Copyright-duotone`: ImageVector
    get() {
        if (`_copyright-duotone` != null) {
            return `_copyright-duotone`!!
        }
        `_copyright-duotone` = Builder(name = "Copyright-duotone", defaultWidth = 256.0.dp,
...
private var `_copyright-duotone`: ImageVector? = null
