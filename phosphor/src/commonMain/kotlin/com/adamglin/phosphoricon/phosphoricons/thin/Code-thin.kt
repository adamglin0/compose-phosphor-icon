...
public val ThinGroup.`Code-thin`: ImageVector
    get() {
        if (`_code-thin` != null) {
            return `_code-thin`!!
        }
        `_code-thin` = Builder(name = "Code-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_code-thin`: ImageVector? = null
