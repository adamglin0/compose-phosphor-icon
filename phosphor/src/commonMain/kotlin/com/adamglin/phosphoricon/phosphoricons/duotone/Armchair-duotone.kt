...
public val DuotoneGroup.`Armchair-duotone`: ImageVector
    get() {
        if (`_armchair-duotone` != null) {
            return `_armchair-duotone`!!
        }
        `_armchair-duotone` = Builder(name = "Armchair-duotone", defaultWidth = 256.0.dp,
...
private var `_armchair-duotone`: ImageVector? = null
