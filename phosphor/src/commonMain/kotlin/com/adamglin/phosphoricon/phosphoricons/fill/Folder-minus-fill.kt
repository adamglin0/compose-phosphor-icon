...
public val FillGroup.`Folder-minus-fill`: ImageVector
    get() {
        if (`_folder-minus-fill` != null) {
            return `_folder-minus-fill`!!
        }
        `_folder-minus-fill` = Builder(name = "Folder-minus-fill", defaultWidth = 256.0.dp,
...
private var `_folder-minus-fill`: ImageVector? = null
