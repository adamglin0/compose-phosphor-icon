...
public val RegularGroup.`Dice-two`: ImageVector
    get() {
        if (`_dice-two` != null) {
            return `_dice-two`!!
        }
        `_dice-two` = Builder(name = "Dice-two", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dice-two`: ImageVector? = null
