...
public val DuotoneGroup.`Behance-logo-duotone`: ImageVector
    get() {
        if (`_behance-logo-duotone` != null) {
            return `_behance-logo-duotone`!!
        }
        `_behance-logo-duotone` = Builder(name = "Behance-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_behance-logo-duotone`: ImageVector? = null
