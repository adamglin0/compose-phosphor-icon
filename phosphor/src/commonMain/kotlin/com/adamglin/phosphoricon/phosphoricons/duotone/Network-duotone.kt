...
public val DuotoneGroup.`Network-duotone`: ImageVector
    get() {
        if (`_network-duotone` != null) {
            return `_network-duotone`!!
        }
        `_network-duotone` = Builder(name = "Network-duotone", defaultWidth = 256.0.dp,
...
private var `_network-duotone`: ImageVector? = null
