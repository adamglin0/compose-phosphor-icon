...
public val BoldGroup.`Heart-half-bold`: ImageVector
    get() {
        if (`_heart-half-bold` != null) {
            return `_heart-half-bold`!!
        }
        `_heart-half-bold` = Builder(name = "Heart-half-bold", defaultWidth = 256.0.dp,
...
private var `_heart-half-bold`: ImageVector? = null
