...
public val BoldGroup.`Currency-eur-bold`: ImageVector
    get() {
        if (`_currency-eur-bold` != null) {
            return `_currency-eur-bold`!!
        }
        `_currency-eur-bold` = Builder(name = "Currency-eur-bold", defaultWidth = 256.0.dp,
...
private var `_currency-eur-bold`: ImageVector? = null
