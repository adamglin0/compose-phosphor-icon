...
public val LightGroup.`User-focus-light`: ImageVector
    get() {
        if (`_user-focus-light` != null) {
            return `_user-focus-light`!!
        }
        `_user-focus-light` = Builder(name = "User-focus-light", defaultWidth = 256.0.dp,
...
private var `_user-focus-light`: ImageVector? = null
