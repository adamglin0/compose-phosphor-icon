...
public val DuotoneGroup.`Cake-duotone`: ImageVector
    get() {
        if (`_cake-duotone` != null) {
            return `_cake-duotone`!!
        }
        `_cake-duotone` = Builder(name = "Cake-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cake-duotone`: ImageVector? = null
