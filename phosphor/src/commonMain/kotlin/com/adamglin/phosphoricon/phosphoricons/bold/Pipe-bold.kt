...
public val BoldGroup.`Pipe-bold`: ImageVector
    get() {
        if (`_pipe-bold` != null) {
            return `_pipe-bold`!!
        }
        `_pipe-bold` = Builder(name = "Pipe-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pipe-bold`: ImageVector? = null
