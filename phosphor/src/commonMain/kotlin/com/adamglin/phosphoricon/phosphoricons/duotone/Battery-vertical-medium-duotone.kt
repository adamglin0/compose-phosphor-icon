...
public val DuotoneGroup.`Battery-vertical-medium-duotone`: ImageVector
    get() {
        if (`_battery-vertical-medium-duotone` != null) {
            return `_battery-vertical-medium-duotone`!!
        }
        `_battery-vertical-medium-duotone` = Builder(name = "Battery-vertical-medium-duotone",
...
private var `_battery-vertical-medium-duotone`: ImageVector? = null
