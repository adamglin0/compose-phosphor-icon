...
public val DuotoneGroup.`Arrows-out-duotone`: ImageVector
    get() {
        if (`_arrows-out-duotone` != null) {
            return `_arrows-out-duotone`!!
        }
        `_arrows-out-duotone` = Builder(name = "Arrows-out-duotone", defaultWidth = 256.0.dp,
...
private var `_arrows-out-duotone`: ImageVector? = null
