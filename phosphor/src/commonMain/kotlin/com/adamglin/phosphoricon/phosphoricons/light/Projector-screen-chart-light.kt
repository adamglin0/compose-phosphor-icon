...
public val LightGroup.`Projector-screen-chart-light`: ImageVector
    get() {
        if (`_projector-screen-chart-light` != null) {
            return `_projector-screen-chart-light`!!
        }
        `_projector-screen-chart-light` = Builder(name = "Projector-screen-chart-light",
...
private var `_projector-screen-chart-light`: ImageVector? = null
