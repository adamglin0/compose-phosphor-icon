...
public val LightGroup.`Office-chair-light`: ImageVector
    get() {
        if (`_office-chair-light` != null) {
            return `_office-chair-light`!!
        }
        `_office-chair-light` = Builder(name = "Office-chair-light", defaultWidth = 256.0.dp,
...
private var `_office-chair-light`: ImageVector? = null
