...
public val BoldGroup.`File-pdf-bold`: ImageVector
    get() {
        if (`_file-pdf-bold` != null) {
            return `_file-pdf-bold`!!
        }
        `_file-pdf-bold` = Builder(name = "File-pdf-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-pdf-bold`: ImageVector? = null
