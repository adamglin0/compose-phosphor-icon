...
public val DuotoneGroup.`Feather-duotone`: ImageVector
    get() {
        if (`_feather-duotone` != null) {
            return `_feather-duotone`!!
        }
        `_feather-duotone` = Builder(name = "Feather-duotone", defaultWidth = 256.0.dp,
...
private var `_feather-duotone`: ImageVector? = null
