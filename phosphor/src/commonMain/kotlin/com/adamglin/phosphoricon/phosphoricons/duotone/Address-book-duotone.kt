...
public val DuotoneGroup.`Address-book-duotone`: ImageVector
    get() {
        if (`_address-book-duotone` != null) {
            return `_address-book-duotone`!!
        }
        `_address-book-duotone` = Builder(name = "Address-book-duotone", defaultWidth = 256.0.dp,
...
private var `_address-book-duotone`: ImageVector? = null
