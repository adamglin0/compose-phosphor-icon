...
public val BoldGroup.`Tipi-bold`: ImageVector
    get() {
        if (`_tipi-bold` != null) {
            return `_tipi-bold`!!
        }
        `_tipi-bold` = Builder(name = "Tipi-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tipi-bold`: ImageVector? = null
