...
public val LightGroup.`Lightbulb-light`: ImageVector
    get() {
        if (`_lightbulb-light` != null) {
            return `_lightbulb-light`!!
        }
        `_lightbulb-light` = Builder(name = "Lightbulb-light", defaultWidth = 256.0.dp,
...
private var `_lightbulb-light`: ImageVector? = null
