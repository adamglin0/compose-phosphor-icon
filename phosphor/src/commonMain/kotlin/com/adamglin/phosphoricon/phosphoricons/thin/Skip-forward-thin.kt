...
public val ThinGroup.`Skip-forward-thin`: ImageVector
    get() {
        if (`_skip-forward-thin` != null) {
            return `_skip-forward-thin`!!
        }
        `_skip-forward-thin` = Builder(name = "Skip-forward-thin", defaultWidth = 256.0.dp,
...
private var `_skip-forward-thin`: ImageVector? = null
