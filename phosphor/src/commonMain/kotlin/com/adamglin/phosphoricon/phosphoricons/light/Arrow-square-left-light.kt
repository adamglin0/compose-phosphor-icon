...
public val LightGroup.`Arrow-square-left-light`: ImageVector
    get() {
        if (`_arrow-square-left-light` != null) {
            return `_arrow-square-left-light`!!
        }
        `_arrow-square-left-light` = Builder(name = "Arrow-square-left-light", defaultWidth =
...
private var `_arrow-square-left-light`: ImageVector? = null
