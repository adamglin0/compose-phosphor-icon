...
public val ThinGroup.`Microphone-thin`: ImageVector
    get() {
        if (`_microphone-thin` != null) {
            return `_microphone-thin`!!
        }
        `_microphone-thin` = Builder(name = "Microphone-thin", defaultWidth = 256.0.dp,
...
private var `_microphone-thin`: ImageVector? = null
