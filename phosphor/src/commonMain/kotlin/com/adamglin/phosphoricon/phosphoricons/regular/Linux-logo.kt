...
public val RegularGroup.`Linux-logo`: ImageVector
    get() {
        if (`_linux-logo` != null) {
            return `_linux-logo`!!
        }
        `_linux-logo` = Builder(name = "Linux-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_linux-logo`: ImageVector? = null
