...
public val BoldGroup.`Lock-simple-open-bold`: ImageVector
    get() {
        if (`_lock-simple-open-bold` != null) {
            return `_lock-simple-open-bold`!!
        }
        `_lock-simple-open-bold` = Builder(name = "Lock-simple-open-bold", defaultWidth = 256.0.dp,
...
private var `_lock-simple-open-bold`: ImageVector? = null
