...
public val LightGroup.`Align-top-light`: ImageVector
    get() {
        if (`_align-top-light` != null) {
            return `_align-top-light`!!
        }
        `_align-top-light` = Builder(name = "Align-top-light", defaultWidth = 256.0.dp,
...
private var `_align-top-light`: ImageVector? = null
