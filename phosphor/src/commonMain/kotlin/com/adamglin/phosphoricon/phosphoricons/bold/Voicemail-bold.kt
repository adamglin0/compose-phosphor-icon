...
public val BoldGroup.`Voicemail-bold`: ImageVector
    get() {
        if (`_voicemail-bold` != null) {
            return `_voicemail-bold`!!
        }
        `_voicemail-bold` = Builder(name = "Voicemail-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_voicemail-bold`: ImageVector? = null
