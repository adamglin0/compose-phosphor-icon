...
public val RegularGroup.`Four-k`: ImageVector
    get() {
        if (`_four-k` != null) {
            return `_four-k`!!
        }
        `_four-k` = Builder(name = "Four-k", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_four-k`: ImageVector? = null
