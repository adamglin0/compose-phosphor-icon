...
public val DuotoneGroup.`Skype-logo-duotone`: ImageVector
    get() {
        if (`_skype-logo-duotone` != null) {
            return `_skype-logo-duotone`!!
        }
        `_skype-logo-duotone` = Builder(name = "Skype-logo-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(224.0f, 176.0f)
                arcToRelative(48.0f, 48.0f, 0.0f, false, true, -77.31f, 38.0f)
                arcTo(88.07f, 88.07f, 0.0f, false, true, 42.0f, 109.31f)
                arcTo(48.0f, 48.0f, 0.0f, false, true, 109.31f, 42.0f)
                arcTo(88.07f, 88.07f, 0.0f, false, true, 214.0f, 146.69f)
                arcTo(47.77f, 47.77f, 0.0f, false, true, 224.0f, 176.0f)
                close()
            }
...
private var `_skype-logo-duotone`: ImageVector? = null
