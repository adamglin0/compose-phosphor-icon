...
public val LightGroup.`Car-simple-light`: ImageVector
    get() {
        if (`_car-simple-light` != null) {
            return `_car-simple-light`!!
        }
        `_car-simple-light` = Builder(name = "Car-simple-light", defaultWidth = 256.0.dp,
...
private var `_car-simple-light`: ImageVector? = null
