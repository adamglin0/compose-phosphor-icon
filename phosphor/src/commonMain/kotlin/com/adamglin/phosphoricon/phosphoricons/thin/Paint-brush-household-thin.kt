...
public val ThinGroup.`Paint-brush-household-thin`: ImageVector
    get() {
        if (`_paint-brush-household-thin` != null) {
            return `_paint-brush-household-thin`!!
        }
        `_paint-brush-household-thin` = Builder(name = "Paint-brush-household-thin", defaultWidth =
...
private var `_paint-brush-household-thin`: ImageVector? = null
