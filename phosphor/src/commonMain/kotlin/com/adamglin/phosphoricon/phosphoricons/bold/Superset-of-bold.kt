...
public val BoldGroup.`Superset-of-bold`: ImageVector
    get() {
        if (`_superset-of-bold` != null) {
            return `_superset-of-bold`!!
        }
        `_superset-of-bold` = Builder(name = "Superset-of-bold", defaultWidth = 256.0.dp,
...
private var `_superset-of-bold`: ImageVector? = null
