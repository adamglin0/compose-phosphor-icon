...
public val RegularGroup.`Medium-logo`: ImageVector
    get() {
        if (`_medium-logo` != null) {
            return `_medium-logo`!!
        }
        `_medium-logo` = Builder(name = "Medium-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_medium-logo`: ImageVector? = null
