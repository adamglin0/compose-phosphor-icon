...
public val LightGroup.`Thermometer-light`: ImageVector
    get() {
        if (`_thermometer-light` != null) {
            return `_thermometer-light`!!
        }
        `_thermometer-light` = Builder(name = "Thermometer-light", defaultWidth = 256.0.dp,
...
private var `_thermometer-light`: ImageVector? = null
