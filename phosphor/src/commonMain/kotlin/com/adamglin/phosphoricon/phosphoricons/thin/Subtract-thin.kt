...
public val ThinGroup.`Subtract-thin`: ImageVector
    get() {
        if (`_subtract-thin` != null) {
            return `_subtract-thin`!!
        }
        `_subtract-thin` = Builder(name = "Subtract-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_subtract-thin`: ImageVector? = null
