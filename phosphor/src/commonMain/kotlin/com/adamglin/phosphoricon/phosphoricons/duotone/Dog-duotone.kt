...
public val DuotoneGroup.`Dog-duotone`: ImageVector
    get() {
        if (`_dog-duotone` != null) {
            return `_dog-duotone`!!
        }
        `_dog-duotone` = Builder(name = "Dog-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dog-duotone`: ImageVector? = null
