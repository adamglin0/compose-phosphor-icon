...
public val ThinGroup.`Gender-nonbinary-thin`: ImageVector
    get() {
        if (`_gender-nonbinary-thin` != null) {
            return `_gender-nonbinary-thin`!!
        }
        `_gender-nonbinary-thin` = Builder(name = "Gender-nonbinary-thin", defaultWidth = 256.0.dp,
...
private var `_gender-nonbinary-thin`: ImageVector? = null
