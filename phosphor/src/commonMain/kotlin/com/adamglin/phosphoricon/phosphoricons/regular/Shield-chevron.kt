...
public val RegularGroup.`Shield-chevron`: ImageVector
    get() {
        if (`_shield-chevron` != null) {
            return `_shield-chevron`!!
        }
        `_shield-chevron` = Builder(name = "Shield-chevron", defaultWidth = 256.0.dp, defaultHeight
...
private var `_shield-chevron`: ImageVector? = null
