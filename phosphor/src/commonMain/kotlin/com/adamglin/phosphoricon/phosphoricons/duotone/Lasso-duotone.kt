...
public val DuotoneGroup.`Lasso-duotone`: ImageVector
    get() {
        if (`_lasso-duotone` != null) {
            return `_lasso-duotone`!!
        }
        `_lasso-duotone` = Builder(name = "Lasso-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lasso-duotone`: ImageVector? = null
