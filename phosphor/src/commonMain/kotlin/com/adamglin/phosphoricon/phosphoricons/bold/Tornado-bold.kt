...
public val BoldGroup.`Tornado-bold`: ImageVector
    get() {
        if (`_tornado-bold` != null) {
            return `_tornado-bold`!!
        }
        `_tornado-bold` = Builder(name = "Tornado-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tornado-bold`: ImageVector? = null
