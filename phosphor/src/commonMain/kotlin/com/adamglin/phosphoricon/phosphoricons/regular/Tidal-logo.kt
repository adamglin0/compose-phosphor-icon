...
public val RegularGroup.`Tidal-logo`: ImageVector
    get() {
        if (`_tidal-logo` != null) {
            return `_tidal-logo`!!
        }
        `_tidal-logo` = Builder(name = "Tidal-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tidal-logo`: ImageVector? = null
