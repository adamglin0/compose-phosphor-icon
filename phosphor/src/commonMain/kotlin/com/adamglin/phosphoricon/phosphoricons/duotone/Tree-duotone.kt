...
public val DuotoneGroup.`Tree-duotone`: ImageVector
    get() {
        if (`_tree-duotone` != null) {
            return `_tree-duotone`!!
        }
        `_tree-duotone` = Builder(name = "Tree-duotone", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(232.0f, 127.82f)
                curveToRelative(0.09f, 33.94f, -28.41f, 63.3f, -62.34f, 64.16f)
                arcToRelative(63.72f, 63.72f, 0.0f, false, true, -41.66f, -14.0f)
                arcToRelative(63.71f, 63.71f, 0.0f, false, true, -41.65f, 14.0f)
                curveToRelative(-33.93f, -0.86f, -62.44f, -30.22f, -62.35f, -64.16f)
                arcToRelative(64.0f, 64.0f, 0.0f, false, true, 40.13f, -59.2f)
                arcToRelative(68.0f, 68.0f, 0.0f, false, true, 127.74f, 0.0f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(55.79f, 55.79f, 0.0f, false, true, 67.11f, 76.0f)
...
private var `_tree-duotone`: ImageVector? = null
