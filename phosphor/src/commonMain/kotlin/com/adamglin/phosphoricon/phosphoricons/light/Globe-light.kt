...
public val LightGroup.`Globe-light`: ImageVector
    get() {
        if (`_globe-light` != null) {
            return `_globe-light`!!
        }
        `_globe-light` = Builder(name = "Globe-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_globe-light`: ImageVector? = null
