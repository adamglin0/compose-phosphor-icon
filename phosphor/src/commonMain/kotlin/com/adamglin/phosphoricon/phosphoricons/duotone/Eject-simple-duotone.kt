...
public val DuotoneGroup.`Eject-simple-duotone`: ImageVector
    get() {
        if (`_eject-simple-duotone` != null) {
            return `_eject-simple-duotone`!!
        }
        `_eject-simple-duotone` = Builder(name = "Eject-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_eject-simple-duotone`: ImageVector? = null
