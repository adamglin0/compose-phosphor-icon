...
public val BoldGroup.`Cell-signal-x-bold`: ImageVector
    get() {
        if (`_cell-signal-x-bold` != null) {
            return `_cell-signal-x-bold`!!
        }
        `_cell-signal-x-bold` = Builder(name = "Cell-signal-x-bold", defaultWidth = 256.0.dp,
...
private var `_cell-signal-x-bold`: ImageVector? = null
