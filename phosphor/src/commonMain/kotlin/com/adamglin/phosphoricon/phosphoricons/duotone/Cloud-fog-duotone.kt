...
public val DuotoneGroup.`Cloud-fog-duotone`: ImageVector
    get() {
        if (`_cloud-fog-duotone` != null) {
            return `_cloud-fog-duotone`!!
        }
        `_cloud-fog-duotone` = Builder(name = "Cloud-fog-duotone", defaultWidth = 256.0.dp,
...
private var `_cloud-fog-duotone`: ImageVector? = null
