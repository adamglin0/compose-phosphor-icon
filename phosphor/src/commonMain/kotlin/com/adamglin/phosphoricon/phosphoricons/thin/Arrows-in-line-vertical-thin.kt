...
public val ThinGroup.`Arrows-in-line-vertical-thin`: ImageVector
    get() {
        if (`_arrows-in-line-vertical-thin` != null) {
            return `_arrows-in-line-vertical-thin`!!
        }
        `_arrows-in-line-vertical-thin` = Builder(name = "Arrows-in-line-vertical-thin",
...
private var `_arrows-in-line-vertical-thin`: ImageVector? = null
