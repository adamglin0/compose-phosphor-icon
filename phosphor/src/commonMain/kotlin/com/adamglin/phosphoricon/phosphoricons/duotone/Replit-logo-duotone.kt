...
public val DuotoneGroup.`Replit-logo-duotone`: ImageVector
    get() {
        if (`_replit-logo-duotone` != null) {
            return `_replit-logo-duotone`!!
        }
        `_replit-logo-duotone` = Builder(name = "Replit-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_replit-logo-duotone`: ImageVector? = null
