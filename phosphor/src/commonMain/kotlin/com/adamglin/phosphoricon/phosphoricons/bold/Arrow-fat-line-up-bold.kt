...
public val BoldGroup.`Arrow-fat-line-up-bold`: ImageVector
    get() {
        if (`_arrow-fat-line-up-bold` != null) {
            return `_arrow-fat-line-up-bold`!!
        }
        `_arrow-fat-line-up-bold` = Builder(name = "Arrow-fat-line-up-bold", defaultWidth =
...
private var `_arrow-fat-line-up-bold`: ImageVector? = null
