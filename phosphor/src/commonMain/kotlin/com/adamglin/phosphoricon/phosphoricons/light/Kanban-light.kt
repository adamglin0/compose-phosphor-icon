...
public val LightGroup.`Kanban-light`: ImageVector
    get() {
        if (`_kanban-light` != null) {
            return `_kanban-light`!!
        }
        `_kanban-light` = Builder(name = "Kanban-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_kanban-light`: ImageVector? = null
