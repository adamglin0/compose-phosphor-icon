...
public val ThinGroup.`Linux-logo-thin`: ImageVector
    get() {
        if (`_linux-logo-thin` != null) {
            return `_linux-logo-thin`!!
        }
        `_linux-logo-thin` = Builder(name = "Linux-logo-thin", defaultWidth = 256.0.dp,
...
private var `_linux-logo-thin`: ImageVector? = null
