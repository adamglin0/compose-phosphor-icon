...
public val DuotoneGroup.`Flower-duotone`: ImageVector
    get() {
        if (`_flower-duotone` != null) {
            return `_flower-duotone`!!
        }
        `_flower-duotone` = Builder(name = "Flower-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_flower-duotone`: ImageVector? = null
