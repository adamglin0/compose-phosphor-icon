...
public val BoldGroup.`Rainbow-cloud-bold`: ImageVector
    get() {
        if (`_rainbow-cloud-bold` != null) {
            return `_rainbow-cloud-bold`!!
        }
        `_rainbow-cloud-bold` = Builder(name = "Rainbow-cloud-bold", defaultWidth = 256.0.dp,
...
private var `_rainbow-cloud-bold`: ImageVector? = null
