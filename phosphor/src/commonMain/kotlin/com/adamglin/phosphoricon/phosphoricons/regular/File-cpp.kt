...
public val RegularGroup.`File-cpp`: ImageVector
    get() {
        if (`_file-cpp` != null) {
            return `_file-cpp`!!
        }
        `_file-cpp` = Builder(name = "File-cpp", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-cpp`: ImageVector? = null
