...
public val FillGroup.`Hand-arrow-up-fill`: ImageVector
    get() {
        if (`_hand-arrow-up-fill` != null) {
            return `_hand-arrow-up-fill`!!
        }
        `_hand-arrow-up-fill` = Builder(name = "Hand-arrow-up-fill", defaultWidth = 256.0.dp,
...
private var `_hand-arrow-up-fill`: ImageVector? = null
