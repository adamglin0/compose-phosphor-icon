...
public val ThinGroup.`Dots-six-vertical-thin`: ImageVector
    get() {
        if (`_dots-six-vertical-thin` != null) {
            return `_dots-six-vertical-thin`!!
        }
        `_dots-six-vertical-thin` = Builder(name = "Dots-six-vertical-thin", defaultWidth =
...
private var `_dots-six-vertical-thin`: ImageVector? = null
