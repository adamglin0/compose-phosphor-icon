...
public val RegularGroup.`Bell-simple-ringing`: ImageVector
    get() {
        if (`_bell-simple-ringing` != null) {
            return `_bell-simple-ringing`!!
        }
        `_bell-simple-ringing` = Builder(name = "Bell-simple-ringing", defaultWidth = 256.0.dp,
...
private var `_bell-simple-ringing`: ImageVector? = null
