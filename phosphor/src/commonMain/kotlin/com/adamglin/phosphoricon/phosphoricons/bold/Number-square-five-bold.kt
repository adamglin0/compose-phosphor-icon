...
public val BoldGroup.`Number-square-five-bold`: ImageVector
    get() {
        if (`_number-square-five-bold` != null) {
            return `_number-square-five-bold`!!
        }
        `_number-square-five-bold` = Builder(name = "Number-square-five-bold", defaultWidth =
...
private var `_number-square-five-bold`: ImageVector? = null
