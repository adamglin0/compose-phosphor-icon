...
public val LightGroup.`Virtual-reality-light`: ImageVector
    get() {
        if (`_virtual-reality-light` != null) {
            return `_virtual-reality-light`!!
        }
        `_virtual-reality-light` = Builder(name = "Virtual-reality-light", defaultWidth = 256.0.dp,
...
private var `_virtual-reality-light`: ImageVector? = null
