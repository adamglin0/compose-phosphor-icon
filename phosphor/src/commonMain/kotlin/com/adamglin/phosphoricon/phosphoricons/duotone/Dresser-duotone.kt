...
public val DuotoneGroup.`Dresser-duotone`: ImageVector
    get() {
        if (`_dresser-duotone` != null) {
            return `_dresser-duotone`!!
        }
        `_dresser-duotone` = Builder(name = "Dresser-duotone", defaultWidth = 256.0.dp,
...
private var `_dresser-duotone`: ImageVector? = null
