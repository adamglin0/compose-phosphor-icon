...
public val LightGroup.`Bone-light`: ImageVector
    get() {
        if (`_bone-light` != null) {
            return `_bone-light`!!
        }
        `_bone-light` = Builder(name = "Bone-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bone-light`: ImageVector? = null
