...
public val BoldGroup.`Volleyball-bold`: ImageVector
    get() {
        if (`_volleyball-bold` != null) {
            return `_volleyball-bold`!!
        }
        `_volleyball-bold` = Builder(name = "Volleyball-bold", defaultWidth = 256.0.dp,
...
private var `_volleyball-bold`: ImageVector? = null
