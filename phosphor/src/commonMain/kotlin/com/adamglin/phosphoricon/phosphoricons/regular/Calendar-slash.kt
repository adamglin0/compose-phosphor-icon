...
public val RegularGroup.`Calendar-slash`: ImageVector
    get() {
        if (`_calendar-slash` != null) {
            return `_calendar-slash`!!
        }
        `_calendar-slash` = Builder(name = "Calendar-slash", defaultWidth = 256.0.dp, defaultHeight
...
private var `_calendar-slash`: ImageVector? = null
