...
public val LightGroup.`Dress-light`: ImageVector
    get() {
        if (`_dress-light` != null) {
            return `_dress-light`!!
        }
        `_dress-light` = Builder(name = "Dress-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dress-light`: ImageVector? = null
