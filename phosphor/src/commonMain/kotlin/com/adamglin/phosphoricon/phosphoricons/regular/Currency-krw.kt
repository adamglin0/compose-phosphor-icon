...
public val RegularGroup.`Currency-krw`: ImageVector
    get() {
        if (`_currency-krw` != null) {
            return `_currency-krw`!!
        }
        `_currency-krw` = Builder(name = "Currency-krw", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_currency-krw`: ImageVector? = null
