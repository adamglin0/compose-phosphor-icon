...
public val LightGroup.`Push-pin-simple-light`: ImageVector
    get() {
        if (`_push-pin-simple-light` != null) {
            return `_push-pin-simple-light`!!
        }
        `_push-pin-simple-light` = Builder(name = "Push-pin-simple-light", defaultWidth = 256.0.dp,
...
private var `_push-pin-simple-light`: ImageVector? = null
