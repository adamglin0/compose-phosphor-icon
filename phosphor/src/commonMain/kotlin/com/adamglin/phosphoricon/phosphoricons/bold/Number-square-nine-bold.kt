...
public val BoldGroup.`Number-square-nine-bold`: ImageVector
    get() {
        if (`_number-square-nine-bold` != null) {
            return `_number-square-nine-bold`!!
        }
        `_number-square-nine-bold` = Builder(name = "Number-square-nine-bold", defaultWidth =
...
private var `_number-square-nine-bold`: ImageVector? = null
