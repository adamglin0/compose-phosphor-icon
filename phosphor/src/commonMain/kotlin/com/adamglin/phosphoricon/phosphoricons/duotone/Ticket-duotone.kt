...
public val DuotoneGroup.`Ticket-duotone`: ImageVector
    get() {
        if (`_ticket-duotone` != null) {
            return `_ticket-duotone`!!
        }
        `_ticket-duotone` = Builder(name = "Ticket-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_ticket-duotone`: ImageVector? = null
