...
public val FillGroup.`Bread-fill`: ImageVector
    get() {
        if (`_bread-fill` != null) {
            return `_bread-fill`!!
        }
        `_bread-fill` = Builder(name = "Bread-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(40.0f, 40.0f, 0.0f, false, false, 200.0f, 40.0f)
                close()
