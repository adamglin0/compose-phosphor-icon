...
public val RegularGroup.`Lamp-pendant`: ImageVector
    get() {
        if (`_lamp-pendant` != null) {
            return `_lamp-pendant`!!
        }
        `_lamp-pendant` = Builder(name = "Lamp-pendant", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lamp-pendant`: ImageVector? = null
