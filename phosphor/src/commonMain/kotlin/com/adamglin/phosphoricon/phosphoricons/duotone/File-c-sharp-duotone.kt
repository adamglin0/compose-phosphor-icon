...
public val DuotoneGroup.`File-c-sharp-duotone`: ImageVector
    get() {
        if (`_file-c-sharp-duotone` != null) {
            return `_file-c-sharp-duotone`!!
        }
        `_file-c-sharp-duotone` = Builder(name = "File-c-sharp-duotone", defaultWidth = 256.0.dp,
...
private var `_file-c-sharp-duotone`: ImageVector? = null
