...
public val ThinGroup.`Greater-than-thin`: ImageVector
    get() {
        if (`_greater-than-thin` != null) {
            return `_greater-than-thin`!!
        }
        `_greater-than-thin` = Builder(name = "Greater-than-thin", defaultWidth = 256.0.dp,
...
private var `_greater-than-thin`: ImageVector? = null
