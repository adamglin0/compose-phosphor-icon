...
public val DuotoneGroup.`Cards-duotone`: ImageVector
    get() {
        if (`_cards-duotone` != null) {
            return `_cards-duotone`!!
        }
        `_cards-duotone` = Builder(name = "Cards-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cards-duotone`: ImageVector? = null
