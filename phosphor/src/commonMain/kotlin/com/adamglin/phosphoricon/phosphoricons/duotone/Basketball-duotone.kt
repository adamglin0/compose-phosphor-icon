...
public val DuotoneGroup.`Basketball-duotone`: ImageVector
    get() {
        if (`_basketball-duotone` != null) {
            return `_basketball-duotone`!!
        }
        `_basketball-duotone` = Builder(name = "Basketball-duotone", defaultWidth = 256.0.dp,
...
private var `_basketball-duotone`: ImageVector? = null
