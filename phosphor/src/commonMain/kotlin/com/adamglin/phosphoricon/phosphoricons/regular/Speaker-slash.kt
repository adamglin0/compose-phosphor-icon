...
public val RegularGroup.`Speaker-slash`: ImageVector
    get() {
        if (`_speaker-slash` != null) {
            return `_speaker-slash`!!
        }
        `_speaker-slash` = Builder(name = "Speaker-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_speaker-slash`: ImageVector? = null
