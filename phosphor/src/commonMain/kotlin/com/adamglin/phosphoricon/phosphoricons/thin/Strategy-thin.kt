...
public val ThinGroup.`Strategy-thin`: ImageVector
    get() {
        if (`_strategy-thin` != null) {
            return `_strategy-thin`!!
        }
        `_strategy-thin` = Builder(name = "Strategy-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_strategy-thin`: ImageVector? = null
