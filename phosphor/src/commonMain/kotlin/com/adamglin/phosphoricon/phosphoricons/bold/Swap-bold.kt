...
public val BoldGroup.`Swap-bold`: ImageVector
    get() {
        if (`_swap-bold` != null) {
            return `_swap-bold`!!
        }
        `_swap-bold` = Builder(name = "Swap-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_swap-bold`: ImageVector? = null
