...
public val BoldGroup.`Yarn-bold`: ImageVector
    get() {
        if (`_yarn-bold` != null) {
            return `_yarn-bold`!!
        }
        `_yarn-bold` = Builder(name = "Yarn-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_yarn-bold`: ImageVector? = null
