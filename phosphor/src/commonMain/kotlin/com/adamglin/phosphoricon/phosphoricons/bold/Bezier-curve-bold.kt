...
public val BoldGroup.`Bezier-curve-bold`: ImageVector
    get() {
        if (`_bezier-curve-bold` != null) {
            return `_bezier-curve-bold`!!
        }
        `_bezier-curve-bold` = Builder(name = "Bezier-curve-bold", defaultWidth = 256.0.dp,
...
private var `_bezier-curve-bold`: ImageVector? = null
