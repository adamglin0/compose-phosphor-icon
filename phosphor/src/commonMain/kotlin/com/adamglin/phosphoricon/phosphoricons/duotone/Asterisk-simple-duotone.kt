...
public val DuotoneGroup.`Asterisk-simple-duotone`: ImageVector
    get() {
        if (`_asterisk-simple-duotone` != null) {
            return `_asterisk-simple-duotone`!!
        }
        `_asterisk-simple-duotone` = Builder(name = "Asterisk-simple-duotone", defaultWidth =
...
private var `_asterisk-simple-duotone`: ImageVector? = null
