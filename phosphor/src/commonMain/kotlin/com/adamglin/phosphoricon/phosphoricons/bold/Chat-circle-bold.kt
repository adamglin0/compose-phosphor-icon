...
public val BoldGroup.`Chat-circle-bold`: ImageVector
    get() {
        if (`_chat-circle-bold` != null) {
            return `_chat-circle-bold`!!
        }
        `_chat-circle-bold` = Builder(name = "Chat-circle-bold", defaultWidth = 256.0.dp,
...
private var `_chat-circle-bold`: ImageVector? = null
