...
public val DuotoneGroup.`Mountains-duotone`: ImageVector
    get() {
        if (`_mountains-duotone` != null) {
            return `_mountains-duotone`!!
        }
        `_mountains-duotone` = Builder(name = "Mountains-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineToRelative(-33.0f, 55.75f)
                lineToRelative(-21.0f, -35.67f)
...
private var `_mountains-duotone`: ImageVector? = null
