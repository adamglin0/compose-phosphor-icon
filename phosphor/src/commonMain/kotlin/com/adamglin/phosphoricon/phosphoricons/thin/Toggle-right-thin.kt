...
public val ThinGroup.`Toggle-right-thin`: ImageVector
    get() {
        if (`_toggle-right-thin` != null) {
            return `_toggle-right-thin`!!
        }
        `_toggle-right-thin` = Builder(name = "Toggle-right-thin", defaultWidth = 256.0.dp,
...
private var `_toggle-right-thin`: ImageVector? = null
