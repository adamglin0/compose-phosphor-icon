...
public val RegularGroup.`High-definition`: ImageVector
    get() {
        if (`_high-definition` != null) {
            return `_high-definition`!!
        }
        `_high-definition` = Builder(name = "High-definition", defaultWidth = 256.0.dp,
...
private var `_high-definition`: ImageVector? = null
