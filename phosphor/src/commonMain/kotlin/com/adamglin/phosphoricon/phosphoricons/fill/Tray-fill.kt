...
public val FillGroup.`Tray-fill`: ImageVector
    get() {
        if (`_tray-fill` != null) {
            return `_tray-fill`!!
        }
        `_tray-fill` = Builder(name = "Tray-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tray-fill`: ImageVector? = null
