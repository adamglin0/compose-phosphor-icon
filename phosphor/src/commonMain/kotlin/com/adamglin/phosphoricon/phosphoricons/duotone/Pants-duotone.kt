...
public val DuotoneGroup.`Pants-duotone`: ImageVector
    get() {
        if (`_pants-duotone` != null) {
            return `_pants-duotone`!!
        }
        `_pants-duotone` = Builder(name = "Pants-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pants-duotone`: ImageVector? = null
