...
public val ThinGroup.`Bell-slash-thin`: ImageVector
    get() {
        if (`_bell-slash-thin` != null) {
            return `_bell-slash-thin`!!
        }
        `_bell-slash-thin` = Builder(name = "Bell-slash-thin", defaultWidth = 256.0.dp,
...
private var `_bell-slash-thin`: ImageVector? = null
