...
public val LightGroup.`Carrot-light`: ImageVector
    get() {
        if (`_carrot-light` != null) {
            return `_carrot-light`!!
        }
        `_carrot-light` = Builder(name = "Carrot-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_carrot-light`: ImageVector? = null
