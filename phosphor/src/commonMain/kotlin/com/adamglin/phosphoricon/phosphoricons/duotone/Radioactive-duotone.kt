...
public val DuotoneGroup.`Radioactive-duotone`: ImageVector
    get() {
        if (`_radioactive-duotone` != null) {
            return `_radioactive-duotone`!!
        }
        `_radioactive-duotone` = Builder(name = "Radioactive-duotone", defaultWidth = 256.0.dp,
...
private var `_radioactive-duotone`: ImageVector? = null
