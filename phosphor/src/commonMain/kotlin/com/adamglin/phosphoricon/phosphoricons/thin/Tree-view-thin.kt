...
public val ThinGroup.`Tree-view-thin`: ImageVector
    get() {
        if (`_tree-view-thin` != null) {
            return `_tree-view-thin`!!
        }
        `_tree-view-thin` = Builder(name = "Tree-view-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_tree-view-thin`: ImageVector? = null
