...
public val BoldGroup.`Desktop-bold`: ImageVector
    get() {
        if (`_desktop-bold` != null) {
            return `_desktop-bold`!!
        }
        `_desktop-bold` = Builder(name = "Desktop-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_desktop-bold`: ImageVector? = null
