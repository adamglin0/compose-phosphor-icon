...
public val ThinGroup.`Steam-logo-thin`: ImageVector
    get() {
        if (`_steam-logo-thin` != null) {
            return `_steam-logo-thin`!!
        }
        `_steam-logo-thin` = Builder(name = "Steam-logo-thin", defaultWidth = 256.0.dp,
...
private var `_steam-logo-thin`: ImageVector? = null
