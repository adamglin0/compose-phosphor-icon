...
public val DuotoneGroup.`Calendar-star-duotone`: ImageVector
    get() {
        if (`_calendar-star-duotone` != null) {
            return `_calendar-star-duotone`!!
        }
        `_calendar-star-duotone` = Builder(name = "Calendar-star-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(149.6f, 143.41f)
                lineTo(157.67f, 176.0f)
                lineTo(128.0f, 158.54f)
                lineTo(98.33f, 176.0f)
                lineToRelative(8.07f, -32.59f)
                lineTo(80.0f, 121.61f)
                lineToRelative(34.65f, -2.67f)
                lineTo(128.0f, 88.0f)
                lineToRelative(13.35f, 30.94f)
                lineTo(176.0f, 121.61f)
                close()
            }
...
private var `_calendar-star-duotone`: ImageVector? = null
