...
public val BoldGroup.`Crane-bold`: ImageVector
    get() {
        if (`_crane-bold` != null) {
            return `_crane-bold`!!
        }
        `_crane-bold` = Builder(name = "Crane-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_crane-bold`: ImageVector? = null
