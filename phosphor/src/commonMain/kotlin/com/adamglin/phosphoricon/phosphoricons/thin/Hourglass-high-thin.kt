...
public val ThinGroup.`Hourglass-high-thin`: ImageVector
    get() {
        if (`_hourglass-high-thin` != null) {
            return `_hourglass-high-thin`!!
        }
        `_hourglass-high-thin` = Builder(name = "Hourglass-high-thin", defaultWidth = 256.0.dp,
...
private var `_hourglass-high-thin`: ImageVector? = null
