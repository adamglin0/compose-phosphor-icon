...
public val BoldGroup.`Seatbelt-bold`: ImageVector
    get() {
        if (`_seatbelt-bold` != null) {
            return `_seatbelt-bold`!!
        }
        `_seatbelt-bold` = Builder(name = "Seatbelt-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seatbelt-bold`: ImageVector? = null
