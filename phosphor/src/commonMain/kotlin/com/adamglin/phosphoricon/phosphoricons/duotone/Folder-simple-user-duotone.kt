...
public val DuotoneGroup.`Folder-simple-user-duotone`: ImageVector
    get() {
        if (`_folder-simple-user-duotone` != null) {
            return `_folder-simple-user-duotone`!!
        }
        `_folder-simple-user-duotone` = Builder(name = "Folder-simple-user-duotone", defaultWidth =
...
private var `_folder-simple-user-duotone`: ImageVector? = null
