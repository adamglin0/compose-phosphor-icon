...
public val LightGroup.`Clipboard-light`: ImageVector
    get() {
        if (`_clipboard-light` != null) {
            return `_clipboard-light`!!
        }
        `_clipboard-light` = Builder(name = "Clipboard-light", defaultWidth = 256.0.dp,
...
private var `_clipboard-light`: ImageVector? = null
