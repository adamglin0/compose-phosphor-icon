...
public val DuotoneGroup.`Arrows-in-duotone`: ImageVector
    get() {
        if (`_arrows-in-duotone` != null) {
            return `_arrows-in-duotone`!!
        }
        `_arrows-in-duotone` = Builder(name = "Arrows-in-duotone", defaultWidth = 256.0.dp,
...
private var `_arrows-in-duotone`: ImageVector? = null
