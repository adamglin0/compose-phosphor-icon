...
public val BoldGroup.`Note-bold`: ImageVector
    get() {
        if (`_note-bold` != null) {
            return `_note-bold`!!
        }
        `_note-bold` = Builder(name = "Note-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_note-bold`: ImageVector? = null
