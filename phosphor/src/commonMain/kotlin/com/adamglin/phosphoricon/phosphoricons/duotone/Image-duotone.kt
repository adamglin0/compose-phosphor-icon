...
public val DuotoneGroup.`Image-duotone`: ImageVector
    get() {
        if (`_image-duotone` != null) {
            return `_image-duotone`!!
        }
        `_image-duotone` = Builder(name = "Image-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_image-duotone`: ImageVector? = null
