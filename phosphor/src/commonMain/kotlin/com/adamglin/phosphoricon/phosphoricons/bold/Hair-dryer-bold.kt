...
public val BoldGroup.`Hair-dryer-bold`: ImageVector
    get() {
        if (`_hair-dryer-bold` != null) {
            return `_hair-dryer-bold`!!
        }
        `_hair-dryer-bold` = Builder(name = "Hair-dryer-bold", defaultWidth = 256.0.dp,
...
private var `_hair-dryer-bold`: ImageVector? = null
