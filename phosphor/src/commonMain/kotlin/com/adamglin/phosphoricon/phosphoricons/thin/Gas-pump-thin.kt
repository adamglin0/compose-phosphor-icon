...
public val ThinGroup.`Gas-pump-thin`: ImageVector
    get() {
        if (`_gas-pump-thin` != null) {
            return `_gas-pump-thin`!!
        }
        `_gas-pump-thin` = Builder(name = "Gas-pump-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gas-pump-thin`: ImageVector? = null
