...
public val FillGroup.`Envelope-open-fill`: ImageVector
    get() {
        if (`_envelope-open-fill` != null) {
            return `_envelope-open-fill`!!
        }
        `_envelope-open-fill` = Builder(name = "Envelope-open-fill", defaultWidth = 256.0.dp,
...
private var `_envelope-open-fill`: ImageVector? = null
