...
public val FillGroup.`Polygon-fill`: ImageVector
    get() {
        if (`_polygon-fill` != null) {
            return `_polygon-fill`!!
        }
        `_polygon-fill` = Builder(name = "Polygon-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_polygon-fill`: ImageVector? = null
