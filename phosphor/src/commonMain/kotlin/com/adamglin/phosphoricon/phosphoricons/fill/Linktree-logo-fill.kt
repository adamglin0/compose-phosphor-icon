...
public val FillGroup.`Linktree-logo-fill`: ImageVector
    get() {
        if (`_linktree-logo-fill` != null) {
            return `_linktree-logo-fill`!!
        }
        `_linktree-logo-fill` = Builder(name = "Linktree-logo-fill", defaultWidth = 256.0.dp,
...
private var `_linktree-logo-fill`: ImageVector? = null
