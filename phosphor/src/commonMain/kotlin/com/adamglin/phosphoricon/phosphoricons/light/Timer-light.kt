...
public val LightGroup.`Timer-light`: ImageVector
    get() {
        if (`_timer-light` != null) {
            return `_timer-light`!!
        }
        `_timer-light` = Builder(name = "Timer-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_timer-light`: ImageVector? = null
