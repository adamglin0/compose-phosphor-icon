...
public val ThinGroup.`Cube-transparent-thin`: ImageVector
    get() {
        if (`_cube-transparent-thin` != null) {
            return `_cube-transparent-thin`!!
        }
        `_cube-transparent-thin` = Builder(name = "Cube-transparent-thin", defaultWidth = 256.0.dp,
...
private var `_cube-transparent-thin`: ImageVector? = null
