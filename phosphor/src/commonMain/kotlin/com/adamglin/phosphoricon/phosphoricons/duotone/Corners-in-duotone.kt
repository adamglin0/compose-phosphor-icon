...
public val DuotoneGroup.`Corners-in-duotone`: ImageVector
    get() {
        if (`_corners-in-duotone` != null) {
            return `_corners-in-duotone`!!
        }
        `_corners-in-duotone` = Builder(name = "Corners-in-duotone", defaultWidth = 256.0.dp,
...
private var `_corners-in-duotone`: ImageVector? = null
