...
public val BoldGroup.`Chat-teardrop-dots-bold`: ImageVector
    get() {
        if (`_chat-teardrop-dots-bold` != null) {
            return `_chat-teardrop-dots-bold`!!
        }
        `_chat-teardrop-dots-bold` = Builder(name = "Chat-teardrop-dots-bold", defaultWidth =
...
private var `_chat-teardrop-dots-bold`: ImageVector? = null
