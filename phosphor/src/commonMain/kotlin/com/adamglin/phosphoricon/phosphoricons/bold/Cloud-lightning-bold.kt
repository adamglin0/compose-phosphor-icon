...
public val BoldGroup.`Cloud-lightning-bold`: ImageVector
    get() {
        if (`_cloud-lightning-bold` != null) {
            return `_cloud-lightning-bold`!!
        }
        `_cloud-lightning-bold` = Builder(name = "Cloud-lightning-bold", defaultWidth = 256.0.dp,
...
private var `_cloud-lightning-bold`: ImageVector? = null
