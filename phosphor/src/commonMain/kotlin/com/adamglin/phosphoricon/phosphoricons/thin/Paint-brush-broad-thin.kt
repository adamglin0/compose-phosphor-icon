...
public val ThinGroup.`Paint-brush-broad-thin`: ImageVector
    get() {
        if (`_paint-brush-broad-thin` != null) {
            return `_paint-brush-broad-thin`!!
        }
        `_paint-brush-broad-thin` = Builder(name = "Paint-brush-broad-thin", defaultWidth =
...
private var `_paint-brush-broad-thin`: ImageVector? = null
