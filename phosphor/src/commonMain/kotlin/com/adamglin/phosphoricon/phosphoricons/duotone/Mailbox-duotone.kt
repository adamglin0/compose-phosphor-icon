...
public val DuotoneGroup.`Mailbox-duotone`: ImageVector
    get() {
        if (`_mailbox-duotone` != null) {
            return `_mailbox-duotone`!!
        }
        `_mailbox-duotone` = Builder(name = "Mailbox-duotone", defaultWidth = 256.0.dp,
...
private var `_mailbox-duotone`: ImageVector? = null
