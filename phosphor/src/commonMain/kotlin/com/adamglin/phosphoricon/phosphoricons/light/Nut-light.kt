...
public val LightGroup.`Nut-light`: ImageVector
    get() {
        if (`_nut-light` != null) {
            return `_nut-light`!!
        }
        `_nut-light` = Builder(name = "Nut-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_nut-light`: ImageVector? = null
