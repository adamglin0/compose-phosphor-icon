...
public val BoldGroup.`Shield-slash-bold`: ImageVector
    get() {
        if (`_shield-slash-bold` != null) {
            return `_shield-slash-bold`!!
        }
        `_shield-slash-bold` = Builder(name = "Shield-slash-bold", defaultWidth = 256.0.dp,
...
private var `_shield-slash-bold`: ImageVector? = null
