...
public val ThinGroup.`Car-profile-thin`: ImageVector
    get() {
        if (`_car-profile-thin` != null) {
            return `_car-profile-thin`!!
        }
        `_car-profile-thin` = Builder(name = "Car-profile-thin", defaultWidth = 256.0.dp,
...
private var `_car-profile-thin`: ImageVector? = null
