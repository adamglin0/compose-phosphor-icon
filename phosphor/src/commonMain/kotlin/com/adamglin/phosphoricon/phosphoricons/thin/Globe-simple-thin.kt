...
public val ThinGroup.`Globe-simple-thin`: ImageVector
    get() {
        if (`_globe-simple-thin` != null) {
            return `_globe-simple-thin`!!
        }
        `_globe-simple-thin` = Builder(name = "Globe-simple-thin", defaultWidth = 256.0.dp,
...
private var `_globe-simple-thin`: ImageVector? = null
