...
public val BoldGroup.`Tree-evergreen-bold`: ImageVector
    get() {
        if (`_tree-evergreen-bold` != null) {
            return `_tree-evergreen-bold`!!
        }
        `_tree-evergreen-bold` = Builder(name = "Tree-evergreen-bold", defaultWidth = 256.0.dp,
...
private var `_tree-evergreen-bold`: ImageVector? = null
