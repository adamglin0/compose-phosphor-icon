...
public val FillGroup.`Hand-fill`: ImageVector
    get() {
        if (`_hand-fill` != null) {
            return `_hand-fill`!!
        }
        `_hand-fill` = Builder(name = "Hand-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-fill`: ImageVector? = null
