...
public val LightGroup.`Orange-light`: ImageVector
    get() {
        if (`_orange-light` != null) {
            return `_orange-light`!!
        }
        `_orange-light` = Builder(name = "Orange-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_orange-light`: ImageVector? = null
