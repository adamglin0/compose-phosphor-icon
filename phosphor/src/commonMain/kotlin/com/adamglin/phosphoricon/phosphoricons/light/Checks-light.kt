...
public val LightGroup.`Checks-light`: ImageVector
    get() {
        if (`_checks-light` != null) {
            return `_checks-light`!!
        }
        `_checks-light` = Builder(name = "Checks-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_checks-light`: ImageVector? = null
