...
public val DuotoneGroup.`Ranking-duotone`: ImageVector
    get() {
        if (`_ranking-duotone` != null) {
            return `_ranking-duotone`!!
        }
        `_ranking-duotone` = Builder(name = "Ranking-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(32.0f, 208.0f)
                lineTo(32.0f, 104.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 40.0f, 96.0f)
                close()
...
private var `_ranking-duotone`: ImageVector? = null
