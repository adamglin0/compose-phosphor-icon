...
public val BoldGroup.`Battery-warning-vertical-bold`: ImageVector
    get() {
        if (`_battery-warning-vertical-bold` != null) {
            return `_battery-warning-vertical-bold`!!
        }
        `_battery-warning-vertical-bold` = Builder(name = "Battery-warning-vertical-bold",
...
private var `_battery-warning-vertical-bold`: ImageVector? = null
