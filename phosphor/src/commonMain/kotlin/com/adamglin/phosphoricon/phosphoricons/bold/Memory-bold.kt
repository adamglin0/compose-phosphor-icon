...
public val BoldGroup.`Memory-bold`: ImageVector
    get() {
        if (`_memory-bold` != null) {
            return `_memory-bold`!!
        }
        `_memory-bold` = Builder(name = "Memory-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_memory-bold`: ImageVector? = null
