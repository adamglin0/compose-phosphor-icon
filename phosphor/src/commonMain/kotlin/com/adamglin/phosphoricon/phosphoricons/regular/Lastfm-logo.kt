...
public val RegularGroup.`Lastfm-logo`: ImageVector
    get() {
        if (`_lastfm-logo` != null) {
            return `_lastfm-logo`!!
        }
        `_lastfm-logo` = Builder(name = "Lastfm-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lastfm-logo`: ImageVector? = null
