...
public val DuotoneGroup.`Pencil-line-duotone`: ImageVector
    get() {
        if (`_pencil-line-duotone` != null) {
            return `_pencil-line-duotone`!!
        }
        `_pencil-line-duotone` = Builder(name = "Pencil-line-duotone", defaultWidth = 256.0.dp,
...
private var `_pencil-line-duotone`: ImageVector? = null
