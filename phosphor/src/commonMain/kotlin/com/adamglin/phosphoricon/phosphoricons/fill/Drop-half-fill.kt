...
public val FillGroup.`Drop-half-fill`: ImageVector
    get() {
        if (`_drop-half-fill` != null) {
            return `_drop-half-fill`!!
        }
        `_drop-half-fill` = Builder(name = "Drop-half-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_drop-half-fill`: ImageVector? = null
