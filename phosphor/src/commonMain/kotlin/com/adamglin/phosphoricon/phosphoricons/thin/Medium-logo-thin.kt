...
public val ThinGroup.`Medium-logo-thin`: ImageVector
    get() {
        if (`_medium-logo-thin` != null) {
            return `_medium-logo-thin`!!
        }
        `_medium-logo-thin` = Builder(name = "Medium-logo-thin", defaultWidth = 256.0.dp,
...
private var `_medium-logo-thin`: ImageVector? = null
