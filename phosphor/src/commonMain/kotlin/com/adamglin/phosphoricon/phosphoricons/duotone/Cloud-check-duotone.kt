...
public val DuotoneGroup.`Cloud-check-duotone`: ImageVector
    get() {
        if (`_cloud-check-duotone` != null) {
            return `_cloud-check-duotone`!!
        }
        `_cloud-check-duotone` = Builder(name = "Cloud-check-duotone", defaultWidth = 256.0.dp,
...
private var `_cloud-check-duotone`: ImageVector? = null
