...
public val BoldGroup.`Paint-brush-bold`: ImageVector
    get() {
        if (`_paint-brush-bold` != null) {
            return `_paint-brush-bold`!!
        }
        `_paint-brush-bold` = Builder(name = "Paint-brush-bold", defaultWidth = 256.0.dp,
...
private var `_paint-brush-bold`: ImageVector? = null
