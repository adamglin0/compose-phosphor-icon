...
public val DuotoneGroup.`High-definition-duotone`: ImageVector
    get() {
        if (`_high-definition-duotone` != null) {
            return `_high-definition-duotone`!!
        }
        `_high-definition-duotone` = Builder(name = "High-definition-duotone", defaultWidth =
...
private var `_high-definition-duotone`: ImageVector? = null
