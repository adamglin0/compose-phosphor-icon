...
public val RegularGroup.`Pencil-simple`: ImageVector
    get() {
        if (`_pencil-simple` != null) {
            return `_pencil-simple`!!
        }
        `_pencil-simple` = Builder(name = "Pencil-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pencil-simple`: ImageVector? = null
