...
public val BoldGroup.`Paw-print-bold`: ImageVector
    get() {
        if (`_paw-print-bold` != null) {
            return `_paw-print-bold`!!
        }
        `_paw-print-bold` = Builder(name = "Paw-print-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_paw-print-bold`: ImageVector? = null
