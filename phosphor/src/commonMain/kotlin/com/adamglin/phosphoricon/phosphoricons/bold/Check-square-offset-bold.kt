...
public val BoldGroup.`Check-square-offset-bold`: ImageVector
    get() {
        if (`_check-square-offset-bold` != null) {
            return `_check-square-offset-bold`!!
        }
        `_check-square-offset-bold` = Builder(name = "Check-square-offset-bold", defaultWidth =
...
private var `_check-square-offset-bold`: ImageVector? = null
