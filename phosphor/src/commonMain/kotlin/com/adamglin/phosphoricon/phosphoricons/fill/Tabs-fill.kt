...
public val FillGroup.`Tabs-fill`: ImageVector
    get() {
        if (`_tabs-fill` != null) {
            return `_tabs-fill`!!
        }
        `_tabs-fill` = Builder(name = "Tabs-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tabs-fill`: ImageVector? = null
