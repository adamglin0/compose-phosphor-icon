...
public val BoldGroup.`Truck-bold`: ImageVector
    get() {
        if (`_truck-bold` != null) {
            return `_truck-bold`!!
        }
        `_truck-bold` = Builder(name = "Truck-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_truck-bold`: ImageVector? = null
