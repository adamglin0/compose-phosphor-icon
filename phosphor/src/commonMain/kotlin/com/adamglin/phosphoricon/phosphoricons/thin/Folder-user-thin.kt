...
public val ThinGroup.`Folder-user-thin`: ImageVector
    get() {
        if (`_folder-user-thin` != null) {
            return `_folder-user-thin`!!
        }
        `_folder-user-thin` = Builder(name = "Folder-user-thin", defaultWidth = 256.0.dp,
...
private var `_folder-user-thin`: ImageVector? = null
