...
public val ThinGroup.`Copyleft-thin`: ImageVector
    get() {
        if (`_copyleft-thin` != null) {
            return `_copyleft-thin`!!
        }
        `_copyleft-thin` = Builder(name = "Copyleft-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_copyleft-thin`: ImageVector? = null
