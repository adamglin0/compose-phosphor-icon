...
public val DuotoneGroup.`Link-simple-horizontal-duotone`: ImageVector
    get() {
        if (`_link-simple-horizontal-duotone` != null) {
            return `_link-simple-horizontal-duotone`!!
        }
        `_link-simple-horizontal-duotone` = Builder(name = "Link-simple-horizontal-duotone",
...
private var `_link-simple-horizontal-duotone`: ImageVector? = null
