...
public val RegularGroup.`List-numbers`: ImageVector
    get() {
        if (`_list-numbers` != null) {
            return `_list-numbers`!!
        }
        `_list-numbers` = Builder(name = "List-numbers", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_list-numbers`: ImageVector? = null
