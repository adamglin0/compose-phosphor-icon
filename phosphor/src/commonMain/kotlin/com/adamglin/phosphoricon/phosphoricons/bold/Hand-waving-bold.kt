...
public val BoldGroup.`Hand-waving-bold`: ImageVector
    get() {
        if (`_hand-waving-bold` != null) {
            return `_hand-waving-bold`!!
        }
        `_hand-waving-bold` = Builder(name = "Hand-waving-bold", defaultWidth = 256.0.dp,
...
private var `_hand-waving-bold`: ImageVector? = null
