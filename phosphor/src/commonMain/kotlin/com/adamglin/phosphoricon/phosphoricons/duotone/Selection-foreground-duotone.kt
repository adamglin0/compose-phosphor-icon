...
public val DuotoneGroup.`Selection-foreground-duotone`: ImageVector
    get() {
        if (`_selection-foreground-duotone` != null) {
            return `_selection-foreground-duotone`!!
        }
        `_selection-foreground-duotone` = Builder(name = "Selection-foreground-duotone",
...
private var `_selection-foreground-duotone`: ImageVector? = null
