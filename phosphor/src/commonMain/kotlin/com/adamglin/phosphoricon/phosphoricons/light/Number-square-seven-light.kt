...
public val LightGroup.`Number-square-seven-light`: ImageVector
    get() {
        if (`_number-square-seven-light` != null) {
            return `_number-square-seven-light`!!
        }
        `_number-square-seven-light` = Builder(name = "Number-square-seven-light", defaultWidth =
...
private var `_number-square-seven-light`: ImageVector? = null
