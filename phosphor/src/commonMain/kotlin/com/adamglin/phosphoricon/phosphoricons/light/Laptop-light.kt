...
public val LightGroup.`Laptop-light`: ImageVector
    get() {
        if (`_laptop-light` != null) {
            return `_laptop-light`!!
        }
        `_laptop-light` = Builder(name = "Laptop-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_laptop-light`: ImageVector? = null
