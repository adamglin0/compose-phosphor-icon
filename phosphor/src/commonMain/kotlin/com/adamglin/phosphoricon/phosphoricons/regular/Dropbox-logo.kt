...
public val RegularGroup.`Dropbox-logo`: ImageVector
    get() {
        if (`_dropbox-logo` != null) {
            return `_dropbox-logo`!!
        }
        `_dropbox-logo` = Builder(name = "Dropbox-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dropbox-logo`: ImageVector? = null
