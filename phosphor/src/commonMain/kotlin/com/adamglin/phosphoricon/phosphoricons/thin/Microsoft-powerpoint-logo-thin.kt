...
public val ThinGroup.`Microsoft-powerpoint-logo-thin`: ImageVector
    get() {
        if (`_microsoft-powerpoint-logo-thin` != null) {
            return `_microsoft-powerpoint-logo-thin`!!
        }
        `_microsoft-powerpoint-logo-thin` = Builder(name = "Microsoft-powerpoint-logo-thin",
...
private var `_microsoft-powerpoint-logo-thin`: ImageVector? = null
