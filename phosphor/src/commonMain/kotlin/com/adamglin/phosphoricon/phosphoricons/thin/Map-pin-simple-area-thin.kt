...
public val ThinGroup.`Map-pin-simple-area-thin`: ImageVector
    get() {
        if (`_map-pin-simple-area-thin` != null) {
            return `_map-pin-simple-area-thin`!!
        }
        `_map-pin-simple-area-thin` = Builder(name = "Map-pin-simple-area-thin", defaultWidth =
...
private var `_map-pin-simple-area-thin`: ImageVector? = null
