...
public val BoldGroup.`Cactus-bold`: ImageVector
    get() {
        if (`_cactus-bold` != null) {
            return `_cactus-bold`!!
        }
        `_cactus-bold` = Builder(name = "Cactus-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cactus-bold`: ImageVector? = null
