...
public val BoldGroup.`Dice-six-bold`: ImageVector
    get() {
        if (`_dice-six-bold` != null) {
            return `_dice-six-bold`!!
        }
        `_dice-six-bold` = Builder(name = "Dice-six-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dice-six-bold`: ImageVector? = null
