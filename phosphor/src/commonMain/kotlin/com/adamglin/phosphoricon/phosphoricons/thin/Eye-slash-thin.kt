...
public val ThinGroup.`Eye-slash-thin`: ImageVector
    get() {
        if (`_eye-slash-thin` != null) {
            return `_eye-slash-thin`!!
        }
        `_eye-slash-thin` = Builder(name = "Eye-slash-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_eye-slash-thin`: ImageVector? = null
