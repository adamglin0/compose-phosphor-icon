...
public val LightGroup.`Bus-light`: ImageVector
    get() {
        if (`_bus-light` != null) {
            return `_bus-light`!!
        }
        `_bus-light` = Builder(name = "Bus-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bus-light`: ImageVector? = null
