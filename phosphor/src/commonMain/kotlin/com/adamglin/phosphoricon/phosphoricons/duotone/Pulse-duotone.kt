...
public val DuotoneGroup.`Pulse-duotone`: ImageVector
    get() {
        if (`_pulse-duotone` != null) {
            return `_pulse-duotone`!!
        }
        `_pulse-duotone` = Builder(name = "Pulse-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pulse-duotone`: ImageVector? = null
