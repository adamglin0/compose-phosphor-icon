...
public val ThinGroup.`Speaker-none-thin`: ImageVector
    get() {
        if (`_speaker-none-thin` != null) {
            return `_speaker-none-thin`!!
        }
        `_speaker-none-thin` = Builder(name = "Speaker-none-thin", defaultWidth = 256.0.dp,
...
private var `_speaker-none-thin`: ImageVector? = null
