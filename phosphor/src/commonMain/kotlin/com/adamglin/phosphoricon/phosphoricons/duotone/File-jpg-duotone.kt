...
public val DuotoneGroup.`File-jpg-duotone`: ImageVector
    get() {
        if (`_file-jpg-duotone` != null) {
            return `_file-jpg-duotone`!!
        }
        `_file-jpg-duotone` = Builder(name = "File-jpg-duotone", defaultWidth = 256.0.dp,
...
private var `_file-jpg-duotone`: ImageVector? = null
