...
public val LightGroup.`Drop-half-light`: ImageVector
    get() {
        if (`_drop-half-light` != null) {
            return `_drop-half-light`!!
        }
        `_drop-half-light` = Builder(name = "Drop-half-light", defaultWidth = 256.0.dp,
...
private var `_drop-half-light`: ImageVector? = null
