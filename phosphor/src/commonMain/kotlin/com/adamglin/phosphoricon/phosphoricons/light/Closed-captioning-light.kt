...
public val LightGroup.`Closed-captioning-light`: ImageVector
    get() {
        if (`_closed-captioning-light` != null) {
            return `_closed-captioning-light`!!
        }
        `_closed-captioning-light` = Builder(name = "Closed-captioning-light", defaultWidth =
...
private var `_closed-captioning-light`: ImageVector? = null
