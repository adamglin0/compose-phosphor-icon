...
public val BoldGroup.`Folder-plus-bold`: ImageVector
    get() {
        if (`_folder-plus-bold` != null) {
            return `_folder-plus-bold`!!
        }
        `_folder-plus-bold` = Builder(name = "Folder-plus-bold", defaultWidth = 256.0.dp,
...
private var `_folder-plus-bold`: ImageVector? = null
