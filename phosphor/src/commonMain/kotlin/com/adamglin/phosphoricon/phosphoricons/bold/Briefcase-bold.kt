...
public val BoldGroup.`Briefcase-bold`: ImageVector
    get() {
        if (`_briefcase-bold` != null) {
            return `_briefcase-bold`!!
        }
        `_briefcase-bold` = Builder(name = "Briefcase-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_briefcase-bold`: ImageVector? = null
