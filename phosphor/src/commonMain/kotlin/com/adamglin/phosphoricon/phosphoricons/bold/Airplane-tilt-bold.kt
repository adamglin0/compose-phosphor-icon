...
public val BoldGroup.`Airplane-tilt-bold`: ImageVector
    get() {
        if (`_airplane-tilt-bold` != null) {
            return `_airplane-tilt-bold`!!
        }
        `_airplane-tilt-bold` = Builder(name = "Airplane-tilt-bold", defaultWidth = 256.0.dp,
...
private var `_airplane-tilt-bold`: ImageVector? = null
