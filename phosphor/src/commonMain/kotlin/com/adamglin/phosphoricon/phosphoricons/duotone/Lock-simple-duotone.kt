...
public val DuotoneGroup.`Lock-simple-duotone`: ImageVector
    get() {
        if (`_lock-simple-duotone` != null) {
            return `_lock-simple-duotone`!!
        }
        `_lock-simple-duotone` = Builder(name = "Lock-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_lock-simple-duotone`: ImageVector? = null
