...
public val RegularGroup.`Hand-soap`: ImageVector
    get() {
        if (`_hand-soap` != null) {
            return `_hand-soap`!!
        }
        `_hand-soap` = Builder(name = "Hand-soap", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-soap`: ImageVector? = null
