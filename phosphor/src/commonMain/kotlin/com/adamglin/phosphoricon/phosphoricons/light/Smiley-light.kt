...
public val LightGroup.`Smiley-light`: ImageVector
    get() {
        if (`_smiley-light` != null) {
            return `_smiley-light`!!
        }
        `_smiley-light` = Builder(name = "Smiley-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_smiley-light`: ImageVector? = null
