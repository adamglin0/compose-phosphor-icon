...
public val RegularGroup.`File-lock`: ImageVector
    get() {
        if (`_file-lock` != null) {
            return `_file-lock`!!
        }
        `_file-lock` = Builder(name = "File-lock", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-lock`: ImageVector? = null
