...
public val ThinGroup.`Trolley-thin`: ImageVector
    get() {
        if (`_trolley-thin` != null) {
            return `_trolley-thin`!!
        }
        `_trolley-thin` = Builder(name = "Trolley-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_trolley-thin`: ImageVector? = null
