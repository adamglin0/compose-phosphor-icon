...
public val ThinGroup.`Webhooks-logo-thin`: ImageVector
    get() {
        if (`_webhooks-logo-thin` != null) {
            return `_webhooks-logo-thin`!!
        }
        `_webhooks-logo-thin` = Builder(name = "Webhooks-logo-thin", defaultWidth = 256.0.dp,
...
private var `_webhooks-logo-thin`: ImageVector? = null
