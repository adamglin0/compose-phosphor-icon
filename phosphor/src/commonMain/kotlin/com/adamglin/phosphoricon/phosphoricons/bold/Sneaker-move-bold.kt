...
public val BoldGroup.`Sneaker-move-bold`: ImageVector
    get() {
        if (`_sneaker-move-bold` != null) {
            return `_sneaker-move-bold`!!
        }
        `_sneaker-move-bold` = Builder(name = "Sneaker-move-bold", defaultWidth = 256.0.dp,
...
private var `_sneaker-move-bold`: ImageVector? = null
