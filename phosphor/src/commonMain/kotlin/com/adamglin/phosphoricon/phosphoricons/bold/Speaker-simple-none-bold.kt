...
public val BoldGroup.`Speaker-simple-none-bold`: ImageVector
    get() {
        if (`_speaker-simple-none-bold` != null) {
            return `_speaker-simple-none-bold`!!
        }
        `_speaker-simple-none-bold` = Builder(name = "Speaker-simple-none-bold", defaultWidth =
...
private var `_speaker-simple-none-bold`: ImageVector? = null
