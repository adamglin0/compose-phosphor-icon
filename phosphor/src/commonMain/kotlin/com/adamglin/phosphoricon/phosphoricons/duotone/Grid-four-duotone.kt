...
public val DuotoneGroup.`Grid-four-duotone`: ImageVector
    get() {
        if (`_grid-four-duotone` != null) {
            return `_grid-four-duotone`!!
        }
        `_grid-four-duotone` = Builder(name = "Grid-four-duotone", defaultWidth = 256.0.dp,
...
private var `_grid-four-duotone`: ImageVector? = null
