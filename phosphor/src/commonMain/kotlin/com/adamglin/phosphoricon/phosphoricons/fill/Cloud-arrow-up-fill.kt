...
public val FillGroup.`Cloud-arrow-up-fill`: ImageVector
    get() {
        if (`_cloud-arrow-up-fill` != null) {
            return `_cloud-arrow-up-fill`!!
        }
        `_cloud-arrow-up-fill` = Builder(name = "Cloud-arrow-up-fill", defaultWidth = 256.0.dp,
...
private var `_cloud-arrow-up-fill`: ImageVector? = null
