...
public val RegularGroup.`Currency-ngn`: ImageVector
    get() {
        if (`_currency-ngn` != null) {
            return `_currency-ngn`!!
        }
        `_currency-ngn` = Builder(name = "Currency-ngn", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_currency-ngn`: ImageVector? = null
