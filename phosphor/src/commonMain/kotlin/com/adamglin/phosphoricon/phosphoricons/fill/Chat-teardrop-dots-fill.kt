...
public val FillGroup.`Chat-teardrop-dots-fill`: ImageVector
    get() {
        if (`_chat-teardrop-dots-fill` != null) {
            return `_chat-teardrop-dots-fill`!!
        }
        `_chat-teardrop-dots-fill` = Builder(name = "Chat-teardrop-dots-fill", defaultWidth =
...
private var `_chat-teardrop-dots-fill`: ImageVector? = null
