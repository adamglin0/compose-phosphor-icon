...
public val ThinGroup.`Chart-pie-slice-thin`: ImageVector
    get() {
        if (`_chart-pie-slice-thin` != null) {
            return `_chart-pie-slice-thin`!!
        }
        `_chart-pie-slice-thin` = Builder(name = "Chart-pie-slice-thin", defaultWidth = 256.0.dp,
...
private var `_chart-pie-slice-thin`: ImageVector? = null
