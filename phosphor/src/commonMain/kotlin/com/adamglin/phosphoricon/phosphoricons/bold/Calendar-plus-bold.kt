...
public val BoldGroup.`Calendar-plus-bold`: ImageVector
    get() {
        if (`_calendar-plus-bold` != null) {
            return `_calendar-plus-bold`!!
        }
        `_calendar-plus-bold` = Builder(name = "Calendar-plus-bold", defaultWidth = 256.0.dp,
...
private var `_calendar-plus-bold`: ImageVector? = null
