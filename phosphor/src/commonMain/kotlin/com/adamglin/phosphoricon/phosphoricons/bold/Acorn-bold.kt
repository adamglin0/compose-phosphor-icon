...
public val BoldGroup.`Acorn-bold`: ImageVector
    get() {
        if (`_acorn-bold` != null) {
            return `_acorn-bold`!!
        }
        `_acorn-bold` = Builder(name = "Acorn-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_acorn-bold`: ImageVector? = null
