...
public val BoldGroup.`User-plus-bold`: ImageVector
    get() {
        if (`_user-plus-bold` != null) {
            return `_user-plus-bold`!!
        }
        `_user-plus-bold` = Builder(name = "User-plus-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_user-plus-bold`: ImageVector? = null
