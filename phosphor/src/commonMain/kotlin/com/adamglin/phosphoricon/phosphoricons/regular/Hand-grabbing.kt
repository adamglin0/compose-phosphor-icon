...
public val RegularGroup.`Hand-grabbing`: ImageVector
    get() {
        if (`_hand-grabbing` != null) {
            return `_hand-grabbing`!!
        }
        `_hand-grabbing` = Builder(name = "Hand-grabbing", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-grabbing`: ImageVector? = null
