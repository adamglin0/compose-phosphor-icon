...
public val ThinGroup.`Code-block-thin`: ImageVector
    get() {
        if (`_code-block-thin` != null) {
            return `_code-block-thin`!!
        }
        `_code-block-thin` = Builder(name = "Code-block-thin", defaultWidth = 256.0.dp,
...
private var `_code-block-thin`: ImageVector? = null
