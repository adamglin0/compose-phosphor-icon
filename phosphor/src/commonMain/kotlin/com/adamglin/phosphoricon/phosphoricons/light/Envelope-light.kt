...
public val LightGroup.`Envelope-light`: ImageVector
    get() {
        if (`_envelope-light` != null) {
            return `_envelope-light`!!
        }
        `_envelope-light` = Builder(name = "Envelope-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_envelope-light`: ImageVector? = null
