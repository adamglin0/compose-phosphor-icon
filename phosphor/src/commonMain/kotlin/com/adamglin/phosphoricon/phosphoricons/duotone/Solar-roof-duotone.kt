...
public val DuotoneGroup.`Solar-roof-duotone`: ImageVector
    get() {
        if (`_solar-roof-duotone` != null) {
            return `_solar-roof-duotone`!!
        }
        `_solar-roof-duotone` = Builder(name = "Solar-roof-duotone", defaultWidth = 256.0.dp,
...
private var `_solar-roof-duotone`: ImageVector? = null
