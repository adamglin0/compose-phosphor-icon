...
public val ThinGroup.`Map-trifold-thin`: ImageVector
    get() {
        if (`_map-trifold-thin` != null) {
            return `_map-trifold-thin`!!
        }
        `_map-trifold-thin` = Builder(name = "Map-trifold-thin", defaultWidth = 256.0.dp,
...
private var `_map-trifold-thin`: ImageVector? = null
