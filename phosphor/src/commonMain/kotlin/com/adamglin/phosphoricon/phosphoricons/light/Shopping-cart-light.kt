...
public val LightGroup.`Shopping-cart-light`: ImageVector
    get() {
        if (`_shopping-cart-light` != null) {
            return `_shopping-cart-light`!!
        }
        `_shopping-cart-light` = Builder(name = "Shopping-cart-light", defaultWidth = 256.0.dp,
...
private var `_shopping-cart-light`: ImageVector? = null
