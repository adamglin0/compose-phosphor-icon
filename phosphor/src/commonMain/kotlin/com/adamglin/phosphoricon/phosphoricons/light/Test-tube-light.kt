...
public val LightGroup.`Test-tube-light`: ImageVector
    get() {
        if (`_test-tube-light` != null) {
            return `_test-tube-light`!!
        }
        `_test-tube-light` = Builder(name = "Test-tube-light", defaultWidth = 256.0.dp,
...
private var `_test-tube-light`: ImageVector? = null
