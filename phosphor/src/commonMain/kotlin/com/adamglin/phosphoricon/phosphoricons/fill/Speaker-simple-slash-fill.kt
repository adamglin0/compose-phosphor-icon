...
public val FillGroup.`Speaker-simple-slash-fill`: ImageVector
    get() {
        if (`_speaker-simple-slash-fill` != null) {
            return `_speaker-simple-slash-fill`!!
        }
        `_speaker-simple-slash-fill` = Builder(name = "Speaker-simple-slash-fill", defaultWidth =
...
private var `_speaker-simple-slash-fill`: ImageVector? = null
