...
public val BoldGroup.`Heart-straight-bold`: ImageVector
    get() {
        if (`_heart-straight-bold` != null) {
            return `_heart-straight-bold`!!
        }
        `_heart-straight-bold` = Builder(name = "Heart-straight-bold", defaultWidth = 256.0.dp,
...
private var `_heart-straight-bold`: ImageVector? = null
