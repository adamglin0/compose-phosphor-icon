...
public val BoldGroup.`Shipping-container-bold`: ImageVector
    get() {
        if (`_shipping-container-bold` != null) {
            return `_shipping-container-bold`!!
        }
        `_shipping-container-bold` = Builder(name = "Shipping-container-bold", defaultWidth =
...
private var `_shipping-container-bold`: ImageVector? = null
