...
public val LightGroup.`Instagram-logo-light`: ImageVector
    get() {
        if (`_instagram-logo-light` != null) {
            return `_instagram-logo-light`!!
        }
        `_instagram-logo-light` = Builder(name = "Instagram-logo-light", defaultWidth = 256.0.dp,
...
private var `_instagram-logo-light`: ImageVector? = null
