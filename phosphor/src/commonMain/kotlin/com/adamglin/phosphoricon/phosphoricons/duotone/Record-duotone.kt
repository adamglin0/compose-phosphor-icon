...
public val DuotoneGroup.`Record-duotone`: ImageVector
    get() {
        if (`_record-duotone` != null) {
            return `_record-duotone`!!
        }
        `_record-duotone` = Builder(name = "Record-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_record-duotone`: ImageVector? = null
