...
public val DuotoneGroup.`Arrows-clockwise-duotone`: ImageVector
    get() {
        if (`_arrows-clockwise-duotone` != null) {
            return `_arrows-clockwise-duotone`!!
        }
        `_arrows-clockwise-duotone` = Builder(name = "Arrows-clockwise-duotone", defaultWidth =
...
private var `_arrows-clockwise-duotone`: ImageVector? = null
