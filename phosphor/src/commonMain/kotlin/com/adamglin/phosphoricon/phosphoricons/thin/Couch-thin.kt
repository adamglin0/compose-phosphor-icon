...
public val ThinGroup.`Couch-thin`: ImageVector
    get() {
        if (`_couch-thin` != null) {
            return `_couch-thin`!!
        }
        `_couch-thin` = Builder(name = "Couch-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_couch-thin`: ImageVector? = null
