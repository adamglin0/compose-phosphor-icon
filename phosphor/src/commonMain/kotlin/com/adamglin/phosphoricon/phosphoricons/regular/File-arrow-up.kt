...
public val RegularGroup.`File-arrow-up`: ImageVector
    get() {
        if (`_file-arrow-up` != null) {
            return `_file-arrow-up`!!
        }
        `_file-arrow-up` = Builder(name = "File-arrow-up", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-arrow-up`: ImageVector? = null
