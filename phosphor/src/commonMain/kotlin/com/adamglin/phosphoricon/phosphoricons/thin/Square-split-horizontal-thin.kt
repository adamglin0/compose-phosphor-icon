...
public val ThinGroup.`Square-split-horizontal-thin`: ImageVector
    get() {
        if (`_square-split-horizontal-thin` != null) {
            return `_square-split-horizontal-thin`!!
        }
        `_square-split-horizontal-thin` = Builder(name = "Square-split-horizontal-thin",
...
private var `_square-split-horizontal-thin`: ImageVector? = null
