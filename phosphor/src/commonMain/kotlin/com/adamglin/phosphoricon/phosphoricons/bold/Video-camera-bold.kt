...
public val BoldGroup.`Video-camera-bold`: ImageVector
    get() {
        if (`_video-camera-bold` != null) {
            return `_video-camera-bold`!!
        }
        `_video-camera-bold` = Builder(name = "Video-camera-bold", defaultWidth = 256.0.dp,
...
private var `_video-camera-bold`: ImageVector? = null
