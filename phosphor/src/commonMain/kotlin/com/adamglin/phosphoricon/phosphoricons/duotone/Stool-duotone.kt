...
public val DuotoneGroup.`Stool-duotone`: ImageVector
    get() {
        if (`_stool-duotone` != null) {
            return `_stool-duotone`!!
        }
        `_stool-duotone` = Builder(name = "Stool-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stool-duotone`: ImageVector? = null
