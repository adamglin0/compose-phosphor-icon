...
public val DuotoneGroup.`Coffee-duotone`: ImageVector
    get() {
        if (`_coffee-duotone` != null) {
            return `_coffee-duotone`!!
        }
        `_coffee-duotone` = Builder(name = "Coffee-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_coffee-duotone`: ImageVector? = null
