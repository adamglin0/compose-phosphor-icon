...
public val ThinGroup.`Drone-thin`: ImageVector
    get() {
        if (`_drone-thin` != null) {
            return `_drone-thin`!!
        }
        `_drone-thin` = Builder(name = "Drone-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_drone-thin`: ImageVector? = null
