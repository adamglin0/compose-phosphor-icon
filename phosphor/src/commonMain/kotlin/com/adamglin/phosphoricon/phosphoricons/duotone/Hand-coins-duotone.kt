...
public val DuotoneGroup.`Hand-coins-duotone`: ImageVector
    get() {
        if (`_hand-coins-duotone` != null) {
            return `_hand-coins-duotone`!!
        }
        `_hand-coins-duotone` = Builder(name = "Hand-coins-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-coins-duotone`: ImageVector? = null
