...
public val DuotoneGroup.`Skip-forward-circle-duotone`: ImageVector
    get() {
        if (`_skip-forward-circle-duotone` != null) {
            return `_skip-forward-circle-duotone`!!
        }
        `_skip-forward-circle-duotone` = Builder(name = "Skip-forward-circle-duotone", defaultWidth
...
private var `_skip-forward-circle-duotone`: ImageVector? = null
