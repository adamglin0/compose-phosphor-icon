...
public val DuotoneGroup.`Phone-duotone`: ImageVector
    get() {
        if (`_phone-duotone` != null) {
            return `_phone-duotone`!!
        }
        `_phone-duotone` = Builder(name = "Phone-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-duotone`: ImageVector? = null
