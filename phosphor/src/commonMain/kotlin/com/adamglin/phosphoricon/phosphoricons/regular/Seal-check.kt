...
public val RegularGroup.`Seal-check`: ImageVector
    get() {
        if (`_seal-check` != null) {
            return `_seal-check`!!
        }
        `_seal-check` = Builder(name = "Seal-check", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seal-check`: ImageVector? = null
