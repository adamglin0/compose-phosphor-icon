...
public val ThinGroup.`Battery-plus-thin`: ImageVector
    get() {
        if (`_battery-plus-thin` != null) {
            return `_battery-plus-thin`!!
        }
        `_battery-plus-thin` = Builder(name = "Battery-plus-thin", defaultWidth = 256.0.dp,
...
private var `_battery-plus-thin`: ImageVector? = null
