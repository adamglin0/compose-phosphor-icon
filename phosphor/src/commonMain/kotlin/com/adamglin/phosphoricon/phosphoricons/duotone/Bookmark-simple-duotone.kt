...
public val DuotoneGroup.`Bookmark-simple-duotone`: ImageVector
    get() {
        if (`_bookmark-simple-duotone` != null) {
            return `_bookmark-simple-duotone`!!
        }
        `_bookmark-simple-duotone` = Builder(name = "Bookmark-simple-duotone", defaultWidth =
...
private var `_bookmark-simple-duotone`: ImageVector? = null
