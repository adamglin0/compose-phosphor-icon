...
public val BoldGroup.`List-plus-bold`: ImageVector
    get() {
        if (`_list-plus-bold` != null) {
            return `_list-plus-bold`!!
        }
        `_list-plus-bold` = Builder(name = "List-plus-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_list-plus-bold`: ImageVector? = null
