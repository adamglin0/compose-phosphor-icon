...
public val ThinGroup.`Pipe-thin`: ImageVector
    get() {
        if (`_pipe-thin` != null) {
            return `_pipe-thin`!!
        }
        `_pipe-thin` = Builder(name = "Pipe-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pipe-thin`: ImageVector? = null
