...
public val ThinGroup.`Church-thin`: ImageVector
    get() {
        if (`_church-thin` != null) {
            return `_church-thin`!!
        }
        `_church-thin` = Builder(name = "Church-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_church-thin`: ImageVector? = null
