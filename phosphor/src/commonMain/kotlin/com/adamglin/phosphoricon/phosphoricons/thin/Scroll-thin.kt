...
public val ThinGroup.`Scroll-thin`: ImageVector
    get() {
        if (`_scroll-thin` != null) {
            return `_scroll-thin`!!
        }
        `_scroll-thin` = Builder(name = "Scroll-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scroll-thin`: ImageVector? = null
