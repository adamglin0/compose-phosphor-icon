...
public val BoldGroup.`Hammer-bold`: ImageVector
    get() {
        if (`_hammer-bold` != null) {
            return `_hammer-bold`!!
        }
        `_hammer-bold` = Builder(name = "Hammer-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hammer-bold`: ImageVector? = null
