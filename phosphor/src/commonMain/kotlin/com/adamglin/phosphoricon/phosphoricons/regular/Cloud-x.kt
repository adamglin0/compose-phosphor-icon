...
public val RegularGroup.`Cloud-x`: ImageVector
    get() {
        if (`_cloud-x` != null) {
            return `_cloud-x`!!
        }
        `_cloud-x` = Builder(name = "Cloud-x", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_cloud-x`: ImageVector? = null
