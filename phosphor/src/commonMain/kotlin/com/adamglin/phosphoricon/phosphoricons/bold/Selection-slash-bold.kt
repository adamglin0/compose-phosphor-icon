...
public val BoldGroup.`Selection-slash-bold`: ImageVector
    get() {
        if (`_selection-slash-bold` != null) {
            return `_selection-slash-bold`!!
        }
        `_selection-slash-bold` = Builder(name = "Selection-slash-bold", defaultWidth = 256.0.dp,
...
private var `_selection-slash-bold`: ImageVector? = null
