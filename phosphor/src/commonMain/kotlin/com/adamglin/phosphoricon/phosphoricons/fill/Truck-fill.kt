...
public val FillGroup.`Truck-fill`: ImageVector
    get() {
        if (`_truck-fill` != null) {
            return `_truck-fill`!!
        }
        `_truck-fill` = Builder(name = "Truck-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.13f, 8.13f, 0.0f, false, false, 255.43f, 117.0f)
                close()
                moveTo(80.0f, 208.0f)
