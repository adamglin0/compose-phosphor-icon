...
public val DuotoneGroup.`Rss-simple-duotone`: ImageVector
    get() {
        if (`_rss-simple-duotone` != null) {
            return `_rss-simple-duotone`!!
        }
        `_rss-simple-duotone` = Builder(name = "Rss-simple-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(152.0f, 152.0f, 0.0f, false, true, 216.0f, 192.0f)
                close()
            }
...
private var `_rss-simple-duotone`: ImageVector? = null
