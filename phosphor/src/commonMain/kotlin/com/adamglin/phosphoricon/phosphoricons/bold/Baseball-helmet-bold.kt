...
public val BoldGroup.`Baseball-helmet-bold`: ImageVector
    get() {
        if (`_baseball-helmet-bold` != null) {
            return `_baseball-helmet-bold`!!
        }
        `_baseball-helmet-bold` = Builder(name = "Baseball-helmet-bold", defaultWidth = 256.0.dp,
...
private var `_baseball-helmet-bold`: ImageVector? = null
