...
public val ThinGroup.`Text-h-five-thin`: ImageVector
    get() {
        if (`_text-h-five-thin` != null) {
            return `_text-h-five-thin`!!
        }
        `_text-h-five-thin` = Builder(name = "Text-h-five-thin", defaultWidth = 256.0.dp,
...
private var `_text-h-five-thin`: ImageVector? = null
