...
public val DuotoneGroup.`Textbox-duotone`: ImageVector
    get() {
        if (`_textbox-duotone` != null) {
            return `_textbox-duotone`!!
        }
        `_textbox-duotone` = Builder(name = "Textbox-duotone", defaultWidth = 256.0.dp,
...
private var `_textbox-duotone`: ImageVector? = null
