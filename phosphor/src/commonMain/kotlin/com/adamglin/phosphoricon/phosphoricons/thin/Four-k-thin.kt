...
public val ThinGroup.`Four-k-thin`: ImageVector
    get() {
        if (`_four-k-thin` != null) {
            return `_four-k-thin`!!
        }
        `_four-k-thin` = Builder(name = "Four-k-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_four-k-thin`: ImageVector? = null
