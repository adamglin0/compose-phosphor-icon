...
public val RegularGroup.`Arrow-fat-left`: ImageVector
    get() {
        if (`_arrow-fat-left` != null) {
            return `_arrow-fat-left`!!
        }
        `_arrow-fat-left` = Builder(name = "Arrow-fat-left", defaultWidth = 256.0.dp, defaultHeight
...
private var `_arrow-fat-left`: ImageVector? = null
