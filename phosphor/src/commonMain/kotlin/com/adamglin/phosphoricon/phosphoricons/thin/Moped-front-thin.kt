...
public val ThinGroup.`Moped-front-thin`: ImageVector
    get() {
        if (`_moped-front-thin` != null) {
            return `_moped-front-thin`!!
        }
        `_moped-front-thin` = Builder(name = "Moped-front-thin", defaultWidth = 256.0.dp,
...
private var `_moped-front-thin`: ImageVector? = null
