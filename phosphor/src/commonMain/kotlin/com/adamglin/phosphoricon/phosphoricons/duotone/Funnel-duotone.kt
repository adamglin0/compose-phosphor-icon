...
public val DuotoneGroup.`Funnel-duotone`: ImageVector
    get() {
        if (`_funnel-duotone` != null) {
            return `_funnel-duotone`!!
        }
        `_funnel-duotone` = Builder(name = "Funnel-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_funnel-duotone`: ImageVector? = null
