...
public val DuotoneGroup.`Traffic-signal-duotone`: ImageVector
    get() {
        if (`_traffic-signal-duotone` != null) {
            return `_traffic-signal-duotone`!!
        }
        `_traffic-signal-duotone` = Builder(name = "Traffic-signal-duotone", defaultWidth =
...
private var `_traffic-signal-duotone`: ImageVector? = null
