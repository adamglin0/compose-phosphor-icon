...
public val ThinGroup.`Cloud-fog-thin`: ImageVector
    get() {
        if (`_cloud-fog-thin` != null) {
            return `_cloud-fog-thin`!!
        }
        `_cloud-fog-thin` = Builder(name = "Cloud-fog-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cloud-fog-thin`: ImageVector? = null
