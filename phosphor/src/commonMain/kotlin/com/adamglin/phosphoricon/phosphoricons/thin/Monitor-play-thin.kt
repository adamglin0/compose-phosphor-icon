...
public val ThinGroup.`Monitor-play-thin`: ImageVector
    get() {
        if (`_monitor-play-thin` != null) {
            return `_monitor-play-thin`!!
        }
        `_monitor-play-thin` = Builder(name = "Monitor-play-thin", defaultWidth = 256.0.dp,
...
private var `_monitor-play-thin`: ImageVector? = null
