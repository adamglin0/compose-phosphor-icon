...
public val ThinGroup.`Person-simple-throw-thin`: ImageVector
    get() {
        if (`_person-simple-throw-thin` != null) {
            return `_person-simple-throw-thin`!!
        }
        `_person-simple-throw-thin` = Builder(name = "Person-simple-throw-thin", defaultWidth =
...
private var `_person-simple-throw-thin`: ImageVector? = null
