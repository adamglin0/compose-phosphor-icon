...
public val DuotoneGroup.`First-aid-kit-duotone`: ImageVector
    get() {
        if (`_first-aid-kit-duotone` != null) {
            return `_first-aid-kit-duotone`!!
        }
        `_first-aid-kit-duotone` = Builder(name = "First-aid-kit-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineToRelative(16.0f)
                horizontalLineToRelative(16.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 160.0f, 136.0f)
                close()
            }
        }
        .build()
...
private var `_first-aid-kit-duotone`: ImageVector? = null
