...
public val ThinGroup.`Blueprint-thin`: ImageVector
    get() {
        if (`_blueprint-thin` != null) {
            return `_blueprint-thin`!!
        }
        `_blueprint-thin` = Builder(name = "Blueprint-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_blueprint-thin`: ImageVector? = null
