...
public val ThinGroup.`House-simple-thin`: ImageVector
    get() {
        if (`_house-simple-thin` != null) {
            return `_house-simple-thin`!!
        }
        `_house-simple-thin` = Builder(name = "House-simple-thin", defaultWidth = 256.0.dp,
...
private var `_house-simple-thin`: ImageVector? = null
