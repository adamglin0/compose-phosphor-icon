...
public val RegularGroup.`Suitcase-rolling`: ImageVector
    get() {
        if (`_suitcase-rolling` != null) {
            return `_suitcase-rolling`!!
        }
        `_suitcase-rolling` = Builder(name = "Suitcase-rolling", defaultWidth = 256.0.dp,
...
private var `_suitcase-rolling`: ImageVector? = null
