...
public val DuotoneGroup.`Music-notes-simple-duotone`: ImageVector
    get() {
        if (`_music-notes-simple-duotone` != null) {
            return `_music-notes-simple-duotone`!!
        }
        `_music-notes-simple-duotone` = Builder(name = "Music-notes-simple-duotone", defaultWidth =
...
private var `_music-notes-simple-duotone`: ImageVector? = null
