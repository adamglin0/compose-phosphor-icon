...
public val ThinGroup.`Rows-plus-top-thin`: ImageVector
    get() {
        if (`_rows-plus-top-thin` != null) {
            return `_rows-plus-top-thin`!!
        }
        `_rows-plus-top-thin` = Builder(name = "Rows-plus-top-thin", defaultWidth = 256.0.dp,
...
private var `_rows-plus-top-thin`: ImageVector? = null
