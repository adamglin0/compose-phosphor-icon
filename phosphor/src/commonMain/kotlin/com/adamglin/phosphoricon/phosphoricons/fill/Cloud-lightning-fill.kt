...
public val FillGroup.`Cloud-lightning-fill`: ImageVector
    get() {
        if (`_cloud-lightning-fill` != null) {
            return `_cloud-lightning-fill`!!
        }
        `_cloud-lightning-fill` = Builder(name = "Cloud-lightning-fill", defaultWidth = 256.0.dp,
...
private var `_cloud-lightning-fill`: ImageVector? = null
