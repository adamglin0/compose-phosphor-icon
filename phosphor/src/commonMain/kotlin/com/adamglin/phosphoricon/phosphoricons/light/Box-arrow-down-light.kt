...
public val LightGroup.`Box-arrow-down-light`: ImageVector
    get() {
        if (`_box-arrow-down-light` != null) {
            return `_box-arrow-down-light`!!
        }
        `_box-arrow-down-light` = Builder(name = "Box-arrow-down-light", defaultWidth = 256.0.dp,
...
private var `_box-arrow-down-light`: ImageVector? = null
