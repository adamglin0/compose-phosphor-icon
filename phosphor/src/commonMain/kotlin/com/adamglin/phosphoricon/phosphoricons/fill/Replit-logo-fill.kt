...
public val FillGroup.`Replit-logo-fill`: ImageVector
    get() {
        if (`_replit-logo-fill` != null) {
            return `_replit-logo-fill`!!
        }
        `_replit-logo-fill` = Builder(name = "Replit-logo-fill", defaultWidth = 256.0.dp,
...
private var `_replit-logo-fill`: ImageVector? = null
