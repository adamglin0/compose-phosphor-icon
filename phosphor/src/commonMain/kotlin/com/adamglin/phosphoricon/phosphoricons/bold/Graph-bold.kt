...
public val BoldGroup.`Graph-bold`: ImageVector
    get() {
        if (`_graph-bold` != null) {
            return `_graph-bold`!!
        }
        `_graph-bold` = Builder(name = "Graph-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_graph-bold`: ImageVector? = null
