...
public val LightGroup.`Megaphone-light`: ImageVector
    get() {
        if (`_megaphone-light` != null) {
            return `_megaphone-light`!!
        }
        `_megaphone-light` = Builder(name = "Megaphone-light", defaultWidth = 256.0.dp,
...
private var `_megaphone-light`: ImageVector? = null
