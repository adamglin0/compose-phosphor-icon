...
public val DuotoneGroup.`Tennis-ball-duotone`: ImageVector
    get() {
        if (`_tennis-ball-duotone` != null) {
            return `_tennis-ball-duotone`!!
        }
        `_tennis-ball-duotone` = Builder(name = "Tennis-ball-duotone", defaultWidth = 256.0.dp,
...
private var `_tennis-ball-duotone`: ImageVector? = null
