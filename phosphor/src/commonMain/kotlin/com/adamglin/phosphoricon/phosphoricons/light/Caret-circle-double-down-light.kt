...
public val LightGroup.`Caret-circle-double-down-light`: ImageVector
    get() {
        if (`_caret-circle-double-down-light` != null) {
            return `_caret-circle-double-down-light`!!
        }
        `_caret-circle-double-down-light` = Builder(name = "Caret-circle-double-down-light",
...
private var `_caret-circle-double-down-light`: ImageVector? = null
