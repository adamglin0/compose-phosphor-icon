...
public val BoldGroup.`Caret-circle-double-left-bold`: ImageVector
    get() {
        if (`_caret-circle-double-left-bold` != null) {
            return `_caret-circle-double-left-bold`!!
        }
        `_caret-circle-double-left-bold` = Builder(name = "Caret-circle-double-left-bold",
...
private var `_caret-circle-double-left-bold`: ImageVector? = null
