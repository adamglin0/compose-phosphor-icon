...
public val ThinGroup.`Tag-thin`: ImageVector
    get() {
        if (`_tag-thin` != null) {
            return `_tag-thin`!!
        }
        `_tag-thin` = Builder(name = "Tag-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_tag-thin`: ImageVector? = null
