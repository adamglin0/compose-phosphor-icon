...
public val DuotoneGroup.`Basket-duotone`: ImageVector
    get() {
        if (`_basket-duotone` != null) {
            return `_basket-duotone`!!
        }
        `_basket-duotone` = Builder(name = "Basket-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_basket-duotone`: ImageVector? = null
