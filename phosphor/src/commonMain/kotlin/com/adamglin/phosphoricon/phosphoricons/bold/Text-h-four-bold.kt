...
public val BoldGroup.`Text-h-four-bold`: ImageVector
    get() {
        if (`_text-h-four-bold` != null) {
            return `_text-h-four-bold`!!
        }
        `_text-h-four-bold` = Builder(name = "Text-h-four-bold", defaultWidth = 256.0.dp,
...
private var `_text-h-four-bold`: ImageVector? = null
