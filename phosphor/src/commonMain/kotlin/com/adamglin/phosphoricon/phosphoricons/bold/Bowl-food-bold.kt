...
public val BoldGroup.`Bowl-food-bold`: ImageVector
    get() {
        if (`_bowl-food-bold` != null) {
            return `_bowl-food-bold`!!
        }
        `_bowl-food-bold` = Builder(name = "Bowl-food-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bowl-food-bold`: ImageVector? = null
