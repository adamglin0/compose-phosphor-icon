...
public val RegularGroup.`Anchor-simple`: ImageVector
    get() {
        if (`_anchor-simple` != null) {
            return `_anchor-simple`!!
        }
        `_anchor-simple` = Builder(name = "Anchor-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_anchor-simple`: ImageVector? = null
