...
public val BoldGroup.`Number-circle-two-bold`: ImageVector
    get() {
        if (`_number-circle-two-bold` != null) {
            return `_number-circle-two-bold`!!
        }
        `_number-circle-two-bold` = Builder(name = "Number-circle-two-bold", defaultWidth =
...
private var `_number-circle-two-bold`: ImageVector? = null
