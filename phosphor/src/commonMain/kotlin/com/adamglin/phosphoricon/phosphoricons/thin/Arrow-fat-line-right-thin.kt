...
public val ThinGroup.`Arrow-fat-line-right-thin`: ImageVector
    get() {
        if (`_arrow-fat-line-right-thin` != null) {
            return `_arrow-fat-line-right-thin`!!
        }
        `_arrow-fat-line-right-thin` = Builder(name = "Arrow-fat-line-right-thin", defaultWidth =
...
private var `_arrow-fat-line-right-thin`: ImageVector? = null
