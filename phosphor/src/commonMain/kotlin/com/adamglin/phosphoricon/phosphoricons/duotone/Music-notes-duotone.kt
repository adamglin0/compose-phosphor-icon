...
public val DuotoneGroup.`Music-notes-duotone`: ImageVector
    get() {
        if (`_music-notes-duotone` != null) {
            return `_music-notes-duotone`!!
        }
        `_music-notes-duotone` = Builder(name = "Music-notes-duotone", defaultWidth = 256.0.dp,
...
private var `_music-notes-duotone`: ImageVector? = null
