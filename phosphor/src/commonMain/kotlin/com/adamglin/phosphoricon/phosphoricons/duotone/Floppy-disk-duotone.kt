...
public val DuotoneGroup.`Floppy-disk-duotone`: ImageVector
    get() {
        if (`_floppy-disk-duotone` != null) {
            return `_floppy-disk-duotone`!!
        }
        `_floppy-disk-duotone` = Builder(name = "Floppy-disk-duotone", defaultWidth = 256.0.dp,
...
private var `_floppy-disk-duotone`: ImageVector? = null
