...
public val BoldGroup.`Wechat-logo-bold`: ImageVector
    get() {
        if (`_wechat-logo-bold` != null) {
            return `_wechat-logo-bold`!!
        }
        `_wechat-logo-bold` = Builder(name = "Wechat-logo-bold", defaultWidth = 256.0.dp,
...
private var `_wechat-logo-bold`: ImageVector? = null
