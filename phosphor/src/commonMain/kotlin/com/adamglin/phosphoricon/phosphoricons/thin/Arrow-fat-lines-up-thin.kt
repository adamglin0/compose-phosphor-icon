...
public val ThinGroup.`Arrow-fat-lines-up-thin`: ImageVector
    get() {
        if (`_arrow-fat-lines-up-thin` != null) {
            return `_arrow-fat-lines-up-thin`!!
        }
        `_arrow-fat-lines-up-thin` = Builder(name = "Arrow-fat-lines-up-thin", defaultWidth =
...
private var `_arrow-fat-lines-up-thin`: ImageVector? = null
