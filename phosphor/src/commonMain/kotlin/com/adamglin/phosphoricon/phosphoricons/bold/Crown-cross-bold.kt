...
public val BoldGroup.`Crown-cross-bold`: ImageVector
    get() {
        if (`_crown-cross-bold` != null) {
            return `_crown-cross-bold`!!
        }
        `_crown-cross-bold` = Builder(name = "Crown-cross-bold", defaultWidth = 256.0.dp,
...
private var `_crown-cross-bold`: ImageVector? = null
