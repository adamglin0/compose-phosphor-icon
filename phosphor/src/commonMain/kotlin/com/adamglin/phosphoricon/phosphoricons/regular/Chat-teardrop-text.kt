...
public val RegularGroup.`Chat-teardrop-text`: ImageVector
    get() {
        if (`_chat-teardrop-text` != null) {
            return `_chat-teardrop-text`!!
        }
        `_chat-teardrop-text` = Builder(name = "Chat-teardrop-text", defaultWidth = 256.0.dp,
...
private var `_chat-teardrop-text`: ImageVector? = null
