...
public val BoldGroup.`Asterisk-bold`: ImageVector
    get() {
        if (`_asterisk-bold` != null) {
            return `_asterisk-bold`!!
        }
        `_asterisk-bold` = Builder(name = "Asterisk-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_asterisk-bold`: ImageVector? = null
