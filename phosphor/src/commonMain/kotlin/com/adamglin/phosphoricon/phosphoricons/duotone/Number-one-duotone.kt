...
public val DuotoneGroup.`Number-one-duotone`: ImageVector
    get() {
        if (`_number-one-duotone` != null) {
            return `_number-one-duotone`!!
        }
        `_number-one-duotone` = Builder(name = "Number-one-duotone", defaultWidth = 256.0.dp,
...
private var `_number-one-duotone`: ImageVector? = null
