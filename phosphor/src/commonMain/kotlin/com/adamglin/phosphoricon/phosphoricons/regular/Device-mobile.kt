...
public val RegularGroup.`Device-mobile`: ImageVector
    get() {
        if (`_device-mobile` != null) {
            return `_device-mobile`!!
        }
        `_device-mobile` = Builder(name = "Device-mobile", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_device-mobile`: ImageVector? = null
