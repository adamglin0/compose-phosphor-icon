...
public val ThinGroup.`Cake-thin`: ImageVector
    get() {
        if (`_cake-thin` != null) {
            return `_cake-thin`!!
        }
        `_cake-thin` = Builder(name = "Cake-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cake-thin`: ImageVector? = null
