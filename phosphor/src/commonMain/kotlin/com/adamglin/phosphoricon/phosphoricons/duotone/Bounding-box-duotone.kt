...
public val DuotoneGroup.`Bounding-box-duotone`: ImageVector
    get() {
        if (`_bounding-box-duotone` != null) {
            return `_bounding-box-duotone`!!
        }
        `_bounding-box-duotone` = Builder(name = "Bounding-box-duotone", defaultWidth = 256.0.dp,
...
private var `_bounding-box-duotone`: ImageVector? = null
