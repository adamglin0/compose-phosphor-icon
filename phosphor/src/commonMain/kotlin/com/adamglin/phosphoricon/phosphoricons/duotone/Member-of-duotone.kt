...
public val DuotoneGroup.`Member-of-duotone`: ImageVector
    get() {
        if (`_member-of-duotone` != null) {
            return `_member-of-duotone`!!
        }
        `_member-of-duotone` = Builder(name = "Member-of-duotone", defaultWidth = 256.0.dp,
...
private var `_member-of-duotone`: ImageVector? = null
