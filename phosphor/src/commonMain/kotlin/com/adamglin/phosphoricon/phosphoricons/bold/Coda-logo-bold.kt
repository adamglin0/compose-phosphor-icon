...
public val BoldGroup.`Coda-logo-bold`: ImageVector
    get() {
        if (`_coda-logo-bold` != null) {
            return `_coda-logo-bold`!!
        }
        `_coda-logo-bold` = Builder(name = "Coda-logo-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_coda-logo-bold`: ImageVector? = null
