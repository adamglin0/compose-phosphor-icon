...
public val DuotoneGroup.`Arrow-u-right-down-duotone`: ImageVector
    get() {
        if (`_arrow-u-right-down-duotone` != null) {
            return `_arrow-u-right-down-duotone`!!
        }
        `_arrow-u-right-down-duotone` = Builder(name = "Arrow-u-right-down-duotone", defaultWidth =
...
private var `_arrow-u-right-down-duotone`: ImageVector? = null
