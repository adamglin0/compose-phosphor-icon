...
public val BoldGroup.`Dog-bold`: ImageVector
    get() {
        if (`_dog-bold` != null) {
            return `_dog-bold`!!
        }
        `_dog-bold` = Builder(name = "Dog-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dog-bold`: ImageVector? = null
