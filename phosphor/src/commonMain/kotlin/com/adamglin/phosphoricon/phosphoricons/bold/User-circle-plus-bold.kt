...
public val BoldGroup.`User-circle-plus-bold`: ImageVector
    get() {
        if (`_user-circle-plus-bold` != null) {
            return `_user-circle-plus-bold`!!
        }
        `_user-circle-plus-bold` = Builder(name = "User-circle-plus-bold", defaultWidth = 256.0.dp,
...
private var `_user-circle-plus-bold`: ImageVector? = null
