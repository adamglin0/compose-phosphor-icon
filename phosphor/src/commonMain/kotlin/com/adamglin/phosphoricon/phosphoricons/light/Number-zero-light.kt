...
public val LightGroup.`Number-zero-light`: ImageVector
    get() {
        if (`_number-zero-light` != null) {
            return `_number-zero-light`!!
        }
        `_number-zero-light` = Builder(name = "Number-zero-light", defaultWidth = 256.0.dp,
...
private var `_number-zero-light`: ImageVector? = null
