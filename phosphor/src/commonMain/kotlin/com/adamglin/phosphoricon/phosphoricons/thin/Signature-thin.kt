...
public val ThinGroup.`Signature-thin`: ImageVector
    get() {
        if (`_signature-thin` != null) {
            return `_signature-thin`!!
        }
        `_signature-thin` = Builder(name = "Signature-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_signature-thin`: ImageVector? = null
