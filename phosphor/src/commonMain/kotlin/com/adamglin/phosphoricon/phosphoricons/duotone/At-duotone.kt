...
public val DuotoneGroup.`At-duotone`: ImageVector
    get() {
        if (`_at-duotone` != null) {
            return `_at-duotone`!!
        }
        `_at-duotone` = Builder(name = "At-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_at-duotone`: ImageVector? = null
