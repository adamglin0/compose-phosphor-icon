...
public val BoldGroup.`Less-than-bold`: ImageVector
    get() {
        if (`_less-than-bold` != null) {
            return `_less-than-bold`!!
        }
        `_less-than-bold` = Builder(name = "Less-than-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_less-than-bold`: ImageVector? = null
