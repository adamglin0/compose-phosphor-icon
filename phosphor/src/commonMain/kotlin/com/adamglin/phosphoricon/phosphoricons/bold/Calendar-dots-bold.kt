...
public val BoldGroup.`Calendar-dots-bold`: ImageVector
    get() {
        if (`_calendar-dots-bold` != null) {
            return `_calendar-dots-bold`!!
        }
        `_calendar-dots-bold` = Builder(name = "Calendar-dots-bold", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 192.0f, 128.0f)
                close()
                moveTo(96.0f, 176.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, -16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 96.0f, 176.0f)
                close()
...
private var `_calendar-dots-bold`: ImageVector? = null
