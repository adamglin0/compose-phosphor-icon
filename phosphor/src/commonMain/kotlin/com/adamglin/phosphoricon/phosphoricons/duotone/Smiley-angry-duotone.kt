...
public val DuotoneGroup.`Smiley-angry-duotone`: ImageVector
    get() {
        if (`_smiley-angry-duotone` != null) {
            return `_smiley-angry-duotone`!!
        }
        `_smiley-angry-duotone` = Builder(name = "Smiley-angry-duotone", defaultWidth = 256.0.dp,
...
private var `_smiley-angry-duotone`: ImageVector? = null
