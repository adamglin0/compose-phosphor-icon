...
public val ThinGroup.`Signpost-thin`: ImageVector
    get() {
        if (`_signpost-thin` != null) {
            return `_signpost-thin`!!
        }
        `_signpost-thin` = Builder(name = "Signpost-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_signpost-thin`: ImageVector? = null
