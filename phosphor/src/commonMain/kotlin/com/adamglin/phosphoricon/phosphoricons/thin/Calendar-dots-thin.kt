...
public val ThinGroup.`Calendar-dots-thin`: ImageVector
    get() {
        if (`_calendar-dots-thin` != null) {
            return `_calendar-dots-thin`!!
        }
        `_calendar-dots-thin` = Builder(name = "Calendar-dots-thin", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 136.0f, 132.0f)
                close()
...
private var `_calendar-dots-thin`: ImageVector? = null
