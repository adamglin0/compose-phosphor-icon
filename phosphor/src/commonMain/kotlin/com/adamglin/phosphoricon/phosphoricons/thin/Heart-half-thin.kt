...
public val ThinGroup.`Heart-half-thin`: ImageVector
    get() {
        if (`_heart-half-thin` != null) {
            return `_heart-half-thin`!!
        }
        `_heart-half-thin` = Builder(name = "Heart-half-thin", defaultWidth = 256.0.dp,
...
private var `_heart-half-thin`: ImageVector? = null
