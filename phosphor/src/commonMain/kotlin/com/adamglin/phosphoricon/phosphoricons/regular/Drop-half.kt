...
public val RegularGroup.`Drop-half`: ImageVector
    get() {
        if (`_drop-half` != null) {
            return `_drop-half`!!
        }
        `_drop-half` = Builder(name = "Drop-half", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_drop-half`: ImageVector? = null
