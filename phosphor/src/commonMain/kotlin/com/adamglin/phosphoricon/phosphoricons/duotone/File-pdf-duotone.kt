...
public val DuotoneGroup.`File-pdf-duotone`: ImageVector
    get() {
        if (`_file-pdf-duotone` != null) {
            return `_file-pdf-duotone`!!
        }
        `_file-pdf-duotone` = Builder(name = "File-pdf-duotone", defaultWidth = 256.0.dp,
...
private var `_file-pdf-duotone`: ImageVector? = null
