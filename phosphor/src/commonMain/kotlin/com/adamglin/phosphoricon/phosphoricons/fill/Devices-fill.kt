...
public val FillGroup.`Devices-fill`: ImageVector
    get() {
        if (`_devices-fill` != null) {
            return `_devices-fill`!!
        }
        `_devices-fill` = Builder(name = "Devices-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_devices-fill`: ImageVector? = null
