...
public val ThinGroup.`Potted-plant-thin`: ImageVector
    get() {
        if (`_potted-plant-thin` != null) {
            return `_potted-plant-thin`!!
        }
        `_potted-plant-thin` = Builder(name = "Potted-plant-thin", defaultWidth = 256.0.dp,
...
private var `_potted-plant-thin`: ImageVector? = null
