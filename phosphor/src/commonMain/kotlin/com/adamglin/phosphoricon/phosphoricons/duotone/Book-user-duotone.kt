...
public val DuotoneGroup.`Book-user-duotone`: ImageVector
    get() {
        if (`_book-user-duotone` != null) {
            return `_book-user-duotone`!!
        }
        `_book-user-duotone` = Builder(name = "Book-user-duotone", defaultWidth = 256.0.dp,
...
private var `_book-user-duotone`: ImageVector? = null
