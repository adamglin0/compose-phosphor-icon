...
public val LightGroup.`Star-four-light`: ImageVector
    get() {
        if (`_star-four-light` != null) {
            return `_star-four-light`!!
        }
        `_star-four-light` = Builder(name = "Star-four-light", defaultWidth = 256.0.dp,
...
private var `_star-four-light`: ImageVector? = null
