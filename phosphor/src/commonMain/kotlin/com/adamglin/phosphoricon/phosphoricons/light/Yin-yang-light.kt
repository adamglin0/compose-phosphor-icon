...
public val LightGroup.`Yin-yang-light`: ImageVector
    get() {
        if (`_yin-yang-light` != null) {
            return `_yin-yang-light`!!
        }
        `_yin-yang-light` = Builder(name = "Yin-yang-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_yin-yang-light`: ImageVector? = null
