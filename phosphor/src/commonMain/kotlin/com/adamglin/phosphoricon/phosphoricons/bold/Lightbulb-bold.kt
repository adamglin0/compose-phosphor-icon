...
public val BoldGroup.`Lightbulb-bold`: ImageVector
    get() {
        if (`_lightbulb-bold` != null) {
            return `_lightbulb-bold`!!
        }
        `_lightbulb-bold` = Builder(name = "Lightbulb-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_lightbulb-bold`: ImageVector? = null
