...
public val ThinGroup.`Text-superscript-thin`: ImageVector
    get() {
        if (`_text-superscript-thin` != null) {
            return `_text-superscript-thin`!!
        }
        `_text-superscript-thin` = Builder(name = "Text-superscript-thin", defaultWidth = 256.0.dp,
...
private var `_text-superscript-thin`: ImageVector? = null
