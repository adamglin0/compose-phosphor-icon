...
public val ThinGroup.`Stack-overflow-logo-thin`: ImageVector
    get() {
        if (`_stack-overflow-logo-thin` != null) {
            return `_stack-overflow-logo-thin`!!
        }
        `_stack-overflow-logo-thin` = Builder(name = "Stack-overflow-logo-thin", defaultWidth =
...
private var `_stack-overflow-logo-thin`: ImageVector? = null
