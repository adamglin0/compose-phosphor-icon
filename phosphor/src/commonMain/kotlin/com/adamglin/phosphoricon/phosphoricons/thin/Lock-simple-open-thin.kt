...
public val ThinGroup.`Lock-simple-open-thin`: ImageVector
    get() {
        if (`_lock-simple-open-thin` != null) {
            return `_lock-simple-open-thin`!!
        }
        `_lock-simple-open-thin` = Builder(name = "Lock-simple-open-thin", defaultWidth = 256.0.dp,
...
private var `_lock-simple-open-thin`: ImageVector? = null
