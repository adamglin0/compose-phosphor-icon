...
public val RegularGroup.`Cloud-snow`: ImageVector
    get() {
        if (`_cloud-snow` != null) {
            return `_cloud-snow`!!
        }
        `_cloud-snow` = Builder(name = "Cloud-snow", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-snow`: ImageVector? = null
