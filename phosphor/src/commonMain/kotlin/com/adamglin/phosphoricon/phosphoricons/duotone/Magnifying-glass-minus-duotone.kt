...
public val DuotoneGroup.`Magnifying-glass-minus-duotone`: ImageVector
    get() {
        if (`_magnifying-glass-minus-duotone` != null) {
            return `_magnifying-glass-minus-duotone`!!
        }
        `_magnifying-glass-minus-duotone` = Builder(name = "Magnifying-glass-minus-duotone",
...
private var `_magnifying-glass-minus-duotone`: ImageVector? = null
