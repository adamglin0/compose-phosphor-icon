...
public val LightGroup.`Battery-vertical-high-light`: ImageVector
    get() {
        if (`_battery-vertical-high-light` != null) {
            return `_battery-vertical-high-light`!!
        }
        `_battery-vertical-high-light` = Builder(name = "Battery-vertical-high-light", defaultWidth
...
private var `_battery-vertical-high-light`: ImageVector? = null
