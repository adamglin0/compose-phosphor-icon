...
public val RegularGroup.`Tray-arrow-down`: ImageVector
    get() {
        if (`_tray-arrow-down` != null) {
            return `_tray-arrow-down`!!
        }
        `_tray-arrow-down` = Builder(name = "Tray-arrow-down", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-down`: ImageVector? = null
