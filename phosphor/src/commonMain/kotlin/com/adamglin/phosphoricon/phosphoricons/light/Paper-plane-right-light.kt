...
public val LightGroup.`Paper-plane-right-light`: ImageVector
    get() {
        if (`_paper-plane-right-light` != null) {
            return `_paper-plane-right-light`!!
        }
        `_paper-plane-right-light` = Builder(name = "Paper-plane-right-light", defaultWidth =
...
private var `_paper-plane-right-light`: ImageVector? = null
