...
public val FillGroup.`Feather-fill`: ImageVector
    get() {
        if (`_feather-fill` != null) {
            return `_feather-fill`!!
        }
        `_feather-fill` = Builder(name = "Feather-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_feather-fill`: ImageVector? = null
