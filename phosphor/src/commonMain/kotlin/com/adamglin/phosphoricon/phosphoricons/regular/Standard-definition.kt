...
public val RegularGroup.`Standard-definition`: ImageVector
    get() {
        if (`_standard-definition` != null) {
            return `_standard-definition`!!
        }
        `_standard-definition` = Builder(name = "Standard-definition", defaultWidth = 256.0.dp,
...
private var `_standard-definition`: ImageVector? = null
