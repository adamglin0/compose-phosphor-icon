...
public val LightGroup.`Wechat-logo-light`: ImageVector
    get() {
        if (`_wechat-logo-light` != null) {
            return `_wechat-logo-light`!!
        }
        `_wechat-logo-light` = Builder(name = "Wechat-logo-light", defaultWidth = 256.0.dp,
...
private var `_wechat-logo-light`: ImageVector? = null
