...
public val DuotoneGroup.`Google-logo-duotone`: ImageVector
    get() {
        if (`_google-logo-duotone` != null) {
            return `_google-logo-duotone`!!
        }
        `_google-logo-duotone` = Builder(name = "Google-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_google-logo-duotone`: ImageVector? = null
