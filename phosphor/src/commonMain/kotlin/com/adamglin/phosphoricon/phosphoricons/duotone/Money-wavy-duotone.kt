...
public val DuotoneGroup.`Money-wavy-duotone`: ImageVector
    get() {
        if (`_money-wavy-duotone` != null) {
            return `_money-wavy-duotone`!!
        }
        `_money-wavy-duotone` = Builder(name = "Money-wavy-duotone", defaultWidth = 256.0.dp,
...
private var `_money-wavy-duotone`: ImageVector? = null
