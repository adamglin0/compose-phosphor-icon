...
public val FillGroup.`Tiktok-logo-fill`: ImageVector
    get() {
        if (`_tiktok-logo-fill` != null) {
            return `_tiktok-logo-fill`!!
        }
        `_tiktok-logo-fill` = Builder(name = "Tiktok-logo-fill", defaultWidth = 256.0.dp,
...
private var `_tiktok-logo-fill`: ImageVector? = null
