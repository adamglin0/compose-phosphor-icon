...
public val DuotoneGroup.`Dots-three-duotone`: ImageVector
    get() {
        if (`_dots-three-duotone` != null) {
            return `_dots-three-duotone`!!
        }
        `_dots-three-duotone` = Builder(name = "Dots-three-duotone", defaultWidth = 256.0.dp,
...
private var `_dots-three-duotone`: ImageVector? = null
