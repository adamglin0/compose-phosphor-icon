...
public val LightGroup.`Hurricane-light`: ImageVector
    get() {
        if (`_hurricane-light` != null) {
            return `_hurricane-light`!!
        }
        `_hurricane-light` = Builder(name = "Hurricane-light", defaultWidth = 256.0.dp,
...
private var `_hurricane-light`: ImageVector? = null
