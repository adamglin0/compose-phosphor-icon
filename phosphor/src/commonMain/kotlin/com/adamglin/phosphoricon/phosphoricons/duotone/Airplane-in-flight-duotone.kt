...
public val DuotoneGroup.`Airplane-in-flight-duotone`: ImageVector
    get() {
        if (`_airplane-in-flight-duotone` != null) {
            return `_airplane-in-flight-duotone`!!
        }
        `_airplane-in-flight-duotone` = Builder(name = "Airplane-in-flight-duotone", defaultWidth =
...
private var `_airplane-in-flight-duotone`: ImageVector? = null
