...
public val ThinGroup.`Pinwheel-thin`: ImageVector
    get() {
        if (`_pinwheel-thin` != null) {
            return `_pinwheel-thin`!!
        }
        `_pinwheel-thin` = Builder(name = "Pinwheel-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pinwheel-thin`: ImageVector? = null
