...
public val LightGroup.`Github-logo-light`: ImageVector
    get() {
        if (`_github-logo-light` != null) {
            return `_github-logo-light`!!
        }
        `_github-logo-light` = Builder(name = "Github-logo-light", defaultWidth = 256.0.dp,
...
private var `_github-logo-light`: ImageVector? = null
