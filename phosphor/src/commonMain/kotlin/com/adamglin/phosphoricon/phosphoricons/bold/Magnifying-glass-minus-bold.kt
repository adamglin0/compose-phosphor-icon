...
public val BoldGroup.`Magnifying-glass-minus-bold`: ImageVector
    get() {
        if (`_magnifying-glass-minus-bold` != null) {
            return `_magnifying-glass-minus-bold`!!
        }
        `_magnifying-glass-minus-bold` = Builder(name = "Magnifying-glass-minus-bold", defaultWidth
...
private var `_magnifying-glass-minus-bold`: ImageVector? = null
