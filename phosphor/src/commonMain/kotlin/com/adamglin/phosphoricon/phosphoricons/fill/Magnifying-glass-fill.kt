...
public val FillGroup.`Magnifying-glass-fill`: ImageVector
    get() {
        if (`_magnifying-glass-fill` != null) {
            return `_magnifying-glass-fill`!!
        }
        `_magnifying-glass-fill` = Builder(name = "Magnifying-glass-fill", defaultWidth = 256.0.dp,
...
private var `_magnifying-glass-fill`: ImageVector? = null
