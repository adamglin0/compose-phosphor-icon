...
public val FillGroup.`Speaker-none-fill`: ImageVector
    get() {
        if (`_speaker-none-fill` != null) {
            return `_speaker-none-fill`!!
        }
        `_speaker-none-fill` = Builder(name = "Speaker-none-fill", defaultWidth = 256.0.dp,
...
private var `_speaker-none-fill`: ImageVector? = null
