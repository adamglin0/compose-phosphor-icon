...
public val FillGroup.`Cloud-fog-fill`: ImageVector
    get() {
        if (`_cloud-fog-fill` != null) {
            return `_cloud-fog-fill`!!
        }
        `_cloud-fog-fill` = Builder(name = "Cloud-fog-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cloud-fog-fill`: ImageVector? = null
