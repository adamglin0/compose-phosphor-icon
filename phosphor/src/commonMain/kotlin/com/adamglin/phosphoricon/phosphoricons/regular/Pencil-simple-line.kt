...
public val RegularGroup.`Pencil-simple-line`: ImageVector
    get() {
        if (`_pencil-simple-line` != null) {
            return `_pencil-simple-line`!!
        }
        `_pencil-simple-line` = Builder(name = "Pencil-simple-line", defaultWidth = 256.0.dp,
...
private var `_pencil-simple-line`: ImageVector? = null
