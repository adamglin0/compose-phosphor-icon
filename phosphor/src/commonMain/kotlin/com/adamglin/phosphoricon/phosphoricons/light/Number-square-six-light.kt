...
public val LightGroup.`Number-square-six-light`: ImageVector
    get() {
        if (`_number-square-six-light` != null) {
            return `_number-square-six-light`!!
        }
        `_number-square-six-light` = Builder(name = "Number-square-six-light", defaultWidth =
...
private var `_number-square-six-light`: ImageVector? = null
