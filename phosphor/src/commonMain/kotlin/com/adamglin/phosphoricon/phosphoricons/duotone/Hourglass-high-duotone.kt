...
public val DuotoneGroup.`Hourglass-high-duotone`: ImageVector
    get() {
        if (`_hourglass-high-duotone` != null) {
            return `_hourglass-high-duotone`!!
        }
        `_hourglass-high-duotone` = Builder(name = "Hourglass-high-duotone", defaultWidth =
...
private var `_hourglass-high-duotone`: ImageVector? = null
