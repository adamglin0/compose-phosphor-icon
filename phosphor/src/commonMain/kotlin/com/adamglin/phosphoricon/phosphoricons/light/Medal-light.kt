...
public val LightGroup.`Medal-light`: ImageVector
    get() {
        if (`_medal-light` != null) {
            return `_medal-light`!!
        }
        `_medal-light` = Builder(name = "Medal-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_medal-light`: ImageVector? = null
