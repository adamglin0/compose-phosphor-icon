...
public val ThinGroup.`Dresser-thin`: ImageVector
    get() {
        if (`_dresser-thin` != null) {
            return `_dresser-thin`!!
        }
        `_dresser-thin` = Builder(name = "Dresser-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dresser-thin`: ImageVector? = null
