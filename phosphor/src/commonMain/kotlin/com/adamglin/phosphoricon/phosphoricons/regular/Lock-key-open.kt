...
public val RegularGroup.`Lock-key-open`: ImageVector
    get() {
        if (`_lock-key-open` != null) {
            return `_lock-key-open`!!
        }
        `_lock-key-open` = Builder(name = "Lock-key-open", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-key-open`: ImageVector? = null
