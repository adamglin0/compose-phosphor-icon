...
public val BoldGroup.`Airplay-bold`: ImageVector
    get() {
        if (`_airplay-bold` != null) {
            return `_airplay-bold`!!
        }
        `_airplay-bold` = Builder(name = "Airplay-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_airplay-bold`: ImageVector? = null
