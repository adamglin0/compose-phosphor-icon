...
public val DuotoneGroup.`Pencil-simple-slash-duotone`: ImageVector
    get() {
        if (`_pencil-simple-slash-duotone` != null) {
            return `_pencil-simple-slash-duotone`!!
        }
        `_pencil-simple-slash-duotone` = Builder(name = "Pencil-simple-slash-duotone", defaultWidth
...
private var `_pencil-simple-slash-duotone`: ImageVector? = null
