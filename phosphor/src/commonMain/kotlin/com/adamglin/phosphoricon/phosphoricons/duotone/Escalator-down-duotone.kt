...
public val DuotoneGroup.`Escalator-down-duotone`: ImageVector
    get() {
        if (`_escalator-down-duotone` != null) {
            return `_escalator-down-duotone`!!
        }
        `_escalator-down-duotone` = Builder(name = "Escalator-down-duotone", defaultWidth =
...
private var `_escalator-down-duotone`: ImageVector? = null
