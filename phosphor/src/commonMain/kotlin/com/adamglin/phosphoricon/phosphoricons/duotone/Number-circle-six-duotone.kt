...
public val DuotoneGroup.`Number-circle-six-duotone`: ImageVector
    get() {
        if (`_number-circle-six-duotone` != null) {
            return `_number-circle-six-duotone`!!
        }
        `_number-circle-six-duotone` = Builder(name = "Number-circle-six-duotone", defaultWidth =
...
private var `_number-circle-six-duotone`: ImageVector? = null
