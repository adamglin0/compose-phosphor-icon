...
public val FillGroup.`Text-subscript-fill`: ImageVector
    get() {
        if (`_text-subscript-fill` != null) {
            return `_text-subscript-fill`!!
        }
        `_text-subscript-fill` = Builder(name = "Text-subscript-fill", defaultWidth = 256.0.dp,
...
private var `_text-subscript-fill`: ImageVector? = null
