...
public val BoldGroup.`Test-tube-bold`: ImageVector
    get() {
        if (`_test-tube-bold` != null) {
            return `_test-tube-bold`!!
        }
        `_test-tube-bold` = Builder(name = "Test-tube-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_test-tube-bold`: ImageVector? = null
