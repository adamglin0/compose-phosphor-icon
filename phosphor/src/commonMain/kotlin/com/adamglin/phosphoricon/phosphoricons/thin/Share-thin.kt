...
public val ThinGroup.`Share-thin`: ImageVector
    get() {
        if (`_share-thin` != null) {
            return `_share-thin`!!
        }
        `_share-thin` = Builder(name = "Share-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_share-thin`: ImageVector? = null
