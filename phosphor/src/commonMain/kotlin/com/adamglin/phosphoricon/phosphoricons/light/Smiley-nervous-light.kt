...
public val LightGroup.`Smiley-nervous-light`: ImageVector
    get() {
        if (`_smiley-nervous-light` != null) {
            return `_smiley-nervous-light`!!
        }
        `_smiley-nervous-light` = Builder(name = "Smiley-nervous-light", defaultWidth = 256.0.dp,
...
private var `_smiley-nervous-light`: ImageVector? = null
