...
public val ThinGroup.`Basket-thin`: ImageVector
    get() {
        if (`_basket-thin` != null) {
            return `_basket-thin`!!
        }
        `_basket-thin` = Builder(name = "Basket-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_basket-thin`: ImageVector? = null
