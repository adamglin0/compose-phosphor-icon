...
public val ThinGroup.`Carrot-thin`: ImageVector
    get() {
        if (`_carrot-thin` != null) {
            return `_carrot-thin`!!
        }
        `_carrot-thin` = Builder(name = "Carrot-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_carrot-thin`: ImageVector? = null
