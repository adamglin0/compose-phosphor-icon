...
public val BoldGroup.`Chart-polar-bold`: ImageVector
    get() {
        if (`_chart-polar-bold` != null) {
            return `_chart-polar-bold`!!
        }
        `_chart-polar-bold` = Builder(name = "Chart-polar-bold", defaultWidth = 256.0.dp,
...
private var `_chart-polar-bold`: ImageVector? = null
