...
public val DuotoneGroup.`Tidal-logo-duotone`: ImageVector
    get() {
        if (`_tidal-logo-duotone` != null) {
            return `_tidal-logo-duotone`!!
        }
        `_tidal-logo-duotone` = Builder(name = "Tidal-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_tidal-logo-duotone`: ImageVector? = null
