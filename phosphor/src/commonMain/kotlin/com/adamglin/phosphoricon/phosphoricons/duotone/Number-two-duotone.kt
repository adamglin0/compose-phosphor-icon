...
public val DuotoneGroup.`Number-two-duotone`: ImageVector
    get() {
        if (`_number-two-duotone` != null) {
            return `_number-two-duotone`!!
        }
        `_number-two-duotone` = Builder(name = "Number-two-duotone", defaultWidth = 256.0.dp,
...
private var `_number-two-duotone`: ImageVector? = null
