...
public val DuotoneGroup.`Campfire-duotone`: ImageVector
    get() {
        if (`_campfire-duotone` != null) {
            return `_campfire-duotone`!!
        }
        `_campfire-duotone` = Builder(name = "Campfire-duotone", defaultWidth = 256.0.dp,
...
private var `_campfire-duotone`: ImageVector? = null
