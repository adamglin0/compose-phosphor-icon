...
public val DuotoneGroup.`Belt-duotone`: ImageVector
    get() {
        if (`_belt-duotone` != null) {
            return `_belt-duotone`!!
        }
        `_belt-duotone` = Builder(name = "Belt-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_belt-duotone`: ImageVector? = null
