...
public val BoldGroup.`Copy-bold`: ImageVector
    get() {
        if (`_copy-bold` != null) {
            return `_copy-bold`!!
        }
        `_copy-bold` = Builder(name = "Copy-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_copy-bold`: ImageVector? = null
