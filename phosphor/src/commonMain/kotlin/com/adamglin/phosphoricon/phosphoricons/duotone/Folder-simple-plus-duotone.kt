...
public val DuotoneGroup.`Folder-simple-plus-duotone`: ImageVector
    get() {
        if (`_folder-simple-plus-duotone` != null) {
            return `_folder-simple-plus-duotone`!!
        }
        `_folder-simple-plus-duotone` = Builder(name = "Folder-simple-plus-duotone", defaultWidth =
...
private var `_folder-simple-plus-duotone`: ImageVector? = null
