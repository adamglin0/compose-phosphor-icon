...
public val DuotoneGroup.`Unite-duotone`: ImageVector
    get() {
        if (`_unite-duotone` != null) {
            return `_unite-duotone`!!
        }
        `_unite-duotone` = Builder(name = "Unite-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_unite-duotone`: ImageVector? = null
