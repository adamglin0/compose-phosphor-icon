...
public val ThinGroup.`Nuclear-plant-thin`: ImageVector
    get() {
        if (`_nuclear-plant-thin` != null) {
            return `_nuclear-plant-thin`!!
        }
        `_nuclear-plant-thin` = Builder(name = "Nuclear-plant-thin", defaultWidth = 256.0.dp,
...
private var `_nuclear-plant-thin`: ImageVector? = null
