...
public val FillGroup.`Number-circle-three-fill`: ImageVector
    get() {
        if (`_number-circle-three-fill` != null) {
            return `_number-circle-three-fill`!!
        }
        `_number-circle-three-fill` = Builder(name = "Number-circle-three-fill", defaultWidth =
...
private var `_number-circle-three-fill`: ImageVector? = null
