...
public val LightGroup.`Star-and-crescent-light`: ImageVector
    get() {
        if (`_star-and-crescent-light` != null) {
            return `_star-and-crescent-light`!!
        }
        `_star-and-crescent-light` = Builder(name = "Star-and-crescent-light", defaultWidth =
...
private var `_star-and-crescent-light`: ImageVector? = null
