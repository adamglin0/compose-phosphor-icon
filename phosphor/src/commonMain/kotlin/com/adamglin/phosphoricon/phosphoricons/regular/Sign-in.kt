...
public val RegularGroup.`Sign-in`: ImageVector
    get() {
        if (`_sign-in` != null) {
            return `_sign-in`!!
        }
        `_sign-in` = Builder(name = "Sign-in", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_sign-in`: ImageVector? = null
