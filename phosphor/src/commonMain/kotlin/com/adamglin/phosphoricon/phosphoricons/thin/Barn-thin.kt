...
public val ThinGroup.`Barn-thin`: ImageVector
    get() {
        if (`_barn-thin` != null) {
            return `_barn-thin`!!
        }
        `_barn-thin` = Builder(name = "Barn-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barn-thin`: ImageVector? = null
