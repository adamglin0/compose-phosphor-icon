...
public val ThinGroup.`Video-camera-thin`: ImageVector
    get() {
        if (`_video-camera-thin` != null) {
            return `_video-camera-thin`!!
        }
        `_video-camera-thin` = Builder(name = "Video-camera-thin", defaultWidth = 256.0.dp,
...
private var `_video-camera-thin`: ImageVector? = null
