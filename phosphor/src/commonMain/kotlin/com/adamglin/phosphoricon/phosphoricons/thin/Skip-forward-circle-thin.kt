...
public val ThinGroup.`Skip-forward-circle-thin`: ImageVector
    get() {
        if (`_skip-forward-circle-thin` != null) {
            return `_skip-forward-circle-thin`!!
        }
        `_skip-forward-circle-thin` = Builder(name = "Skip-forward-circle-thin", defaultWidth =
...
private var `_skip-forward-circle-thin`: ImageVector? = null
