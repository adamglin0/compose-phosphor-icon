...
public val RegularGroup.`Speaker-simple-slash`: ImageVector
    get() {
        if (`_speaker-simple-slash` != null) {
            return `_speaker-simple-slash`!!
        }
        `_speaker-simple-slash` = Builder(name = "Speaker-simple-slash", defaultWidth = 256.0.dp,
...
private var `_speaker-simple-slash`: ImageVector? = null
