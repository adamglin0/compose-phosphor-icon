...
public val DuotoneGroup.`Bank-duotone`: ImageVector
    get() {
        if (`_bank-duotone` != null) {
            return `_bank-duotone`!!
        }
        `_bank-duotone` = Builder(name = "Bank-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bank-duotone`: ImageVector? = null
