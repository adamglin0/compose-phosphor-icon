...
public val ThinGroup.`Number-circle-five-thin`: ImageVector
    get() {
        if (`_number-circle-five-thin` != null) {
            return `_number-circle-five-thin`!!
        }
        `_number-circle-five-thin` = Builder(name = "Number-circle-five-thin", defaultWidth =
...
private var `_number-circle-five-thin`: ImageVector? = null
