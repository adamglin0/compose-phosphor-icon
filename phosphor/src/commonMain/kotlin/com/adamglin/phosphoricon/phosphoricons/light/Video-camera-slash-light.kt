...
public val LightGroup.`Video-camera-slash-light`: ImageVector
    get() {
        if (`_video-camera-slash-light` != null) {
            return `_video-camera-slash-light`!!
        }
        `_video-camera-slash-light` = Builder(name = "Video-camera-slash-light", defaultWidth =
...
private var `_video-camera-slash-light`: ImageVector? = null
