...
public val DuotoneGroup.`Paint-brush-duotone`: ImageVector
    get() {
        if (`_paint-brush-duotone` != null) {
            return `_paint-brush-duotone`!!
        }
        `_paint-brush-duotone` = Builder(name = "Paint-brush-duotone", defaultWidth = 256.0.dp,
...
private var `_paint-brush-duotone`: ImageVector? = null
