...
public val BoldGroup.`Network-slash-bold`: ImageVector
    get() {
        if (`_network-slash-bold` != null) {
            return `_network-slash-bold`!!
        }
        `_network-slash-bold` = Builder(name = "Network-slash-bold", defaultWidth = 256.0.dp,
...
private var `_network-slash-bold`: ImageVector? = null
