...
public val ThinGroup.`Selection-background-thin`: ImageVector
    get() {
        if (`_selection-background-thin` != null) {
            return `_selection-background-thin`!!
        }
        `_selection-background-thin` = Builder(name = "Selection-background-thin", defaultWidth =
...
private var `_selection-background-thin`: ImageVector? = null
