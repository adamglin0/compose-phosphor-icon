...
public val ThinGroup.`Jar-label-thin`: ImageVector
    get() {
        if (`_jar-label-thin` != null) {
            return `_jar-label-thin`!!
        }
        `_jar-label-thin` = Builder(name = "Jar-label-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_jar-label-thin`: ImageVector? = null
