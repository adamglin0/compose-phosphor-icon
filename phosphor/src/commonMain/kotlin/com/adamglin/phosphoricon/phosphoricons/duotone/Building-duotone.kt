...
public val DuotoneGroup.`Building-duotone`: ImageVector
    get() {
        if (`_building-duotone` != null) {
            return `_building-duotone`!!
        }
        `_building-duotone` = Builder(name = "Building-duotone", defaultWidth = 256.0.dp,
...
private var `_building-duotone`: ImageVector? = null
