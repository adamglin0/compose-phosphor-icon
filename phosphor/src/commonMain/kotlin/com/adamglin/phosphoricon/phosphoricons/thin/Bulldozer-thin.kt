...
public val ThinGroup.`Bulldozer-thin`: ImageVector
    get() {
        if (`_bulldozer-thin` != null) {
            return `_bulldozer-thin`!!
        }
        `_bulldozer-thin` = Builder(name = "Bulldozer-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bulldozer-thin`: ImageVector? = null
