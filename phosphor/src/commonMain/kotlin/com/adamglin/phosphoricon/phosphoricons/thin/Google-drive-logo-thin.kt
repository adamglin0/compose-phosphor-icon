...
public val ThinGroup.`Google-drive-logo-thin`: ImageVector
    get() {
        if (`_google-drive-logo-thin` != null) {
            return `_google-drive-logo-thin`!!
        }
        `_google-drive-logo-thin` = Builder(name = "Google-drive-logo-thin", defaultWidth =
...
private var `_google-drive-logo-thin`: ImageVector? = null
