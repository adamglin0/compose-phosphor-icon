...
public val BoldGroup.`Chat-centered-bold`: ImageVector
    get() {
        if (`_chat-centered-bold` != null) {
            return `_chat-centered-bold`!!
        }
        `_chat-centered-bold` = Builder(name = "Chat-centered-bold", defaultWidth = 256.0.dp,
...
private var `_chat-centered-bold`: ImageVector? = null
