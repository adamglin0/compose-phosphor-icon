...
public val BoldGroup.`Drop-half-bold`: ImageVector
    get() {
        if (`_drop-half-bold` != null) {
            return `_drop-half-bold`!!
        }
        `_drop-half-bold` = Builder(name = "Drop-half-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_drop-half-bold`: ImageVector? = null
