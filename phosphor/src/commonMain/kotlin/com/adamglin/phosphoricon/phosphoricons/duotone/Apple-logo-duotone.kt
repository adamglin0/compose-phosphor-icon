...
public val DuotoneGroup.`Apple-logo-duotone`: ImageVector
    get() {
        if (`_apple-logo-duotone` != null) {
            return `_apple-logo-duotone`!!
        }
        `_apple-logo-duotone` = Builder(name = "Apple-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_apple-logo-duotone`: ImageVector? = null
