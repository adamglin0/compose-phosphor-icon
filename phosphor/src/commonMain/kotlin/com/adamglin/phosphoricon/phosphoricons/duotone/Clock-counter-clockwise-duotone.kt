...
public val DuotoneGroup.`Clock-counter-clockwise-duotone`: ImageVector
    get() {
        if (`_clock-counter-clockwise-duotone` != null) {
            return `_clock-counter-clockwise-duotone`!!
        }
        `_clock-counter-clockwise-duotone` = Builder(name = "Clock-counter-clockwise-duotone",
...
private var `_clock-counter-clockwise-duotone`: ImageVector? = null
