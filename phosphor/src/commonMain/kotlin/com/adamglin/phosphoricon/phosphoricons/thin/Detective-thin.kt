...
public val ThinGroup.`Detective-thin`: ImageVector
    get() {
        if (`_detective-thin` != null) {
            return `_detective-thin`!!
        }
        `_detective-thin` = Builder(name = "Detective-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_detective-thin`: ImageVector? = null
