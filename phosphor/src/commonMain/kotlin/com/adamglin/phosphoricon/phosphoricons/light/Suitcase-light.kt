...
public val LightGroup.`Suitcase-light`: ImageVector
    get() {
        if (`_suitcase-light` != null) {
            return `_suitcase-light`!!
        }
        `_suitcase-light` = Builder(name = "Suitcase-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_suitcase-light`: ImageVector? = null
