...
public val BoldGroup.`Scroll-bold`: ImageVector
    get() {
        if (`_scroll-bold` != null) {
            return `_scroll-bold`!!
        }
        `_scroll-bold` = Builder(name = "Scroll-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scroll-bold`: ImageVector? = null
