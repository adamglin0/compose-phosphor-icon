...
public val BoldGroup.`Star-and-crescent-bold`: ImageVector
    get() {
        if (`_star-and-crescent-bold` != null) {
            return `_star-and-crescent-bold`!!
        }
        `_star-and-crescent-bold` = Builder(name = "Star-and-crescent-bold", defaultWidth =
...
private var `_star-and-crescent-bold`: ImageVector? = null
