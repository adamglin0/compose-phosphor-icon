...
public val LightGroup.`Hand-arrow-up-light`: ImageVector
    get() {
        if (`_hand-arrow-up-light` != null) {
            return `_hand-arrow-up-light`!!
        }
        `_hand-arrow-up-light` = Builder(name = "Hand-arrow-up-light", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(2.52f, 2.52f, 0.0f, false, false, 0.33f, -0.15f)
                ...
                close()
                moveTo(155.76f, 60.24f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 0.0f, -8.48f)
                lineToRelative(32.0f, -32.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, 8.48f, 0.0f)
                lineToRelative(32.0f, 32.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, true, true, -8.48f, 8.48f)
                lineTo(198.0f, 38.49f)
                lineTo(198.0f, 104.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, true, -12.0f, 0.0f)
                lineTo(186.0f, 38.49f)
                lineTo(164.24f, 60.24f)
                arcTo(6.0f, 6.0f, 0.0f, false, true, 155.76f, 60.24f)
                close()
            }
        }
        .build()
...
private var `_hand-arrow-up-light`: ImageVector? = null
