...
public val BoldGroup.`Chat-circle-dots-bold`: ImageVector
    get() {
        if (`_chat-circle-dots-bold` != null) {
            return `_chat-circle-dots-bold`!!
        }
        `_chat-circle-dots-bold` = Builder(name = "Chat-circle-dots-bold", defaultWidth = 256.0.dp,
...
private var `_chat-circle-dots-bold`: ImageVector? = null
