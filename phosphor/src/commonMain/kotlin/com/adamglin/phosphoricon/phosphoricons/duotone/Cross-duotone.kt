...
public val DuotoneGroup.`Cross-duotone`: ImageVector
    get() {
        if (`_cross-duotone` != null) {
            return `_cross-duotone`!!
        }
        `_cross-duotone` = Builder(name = "Cross-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cross-duotone`: ImageVector? = null
