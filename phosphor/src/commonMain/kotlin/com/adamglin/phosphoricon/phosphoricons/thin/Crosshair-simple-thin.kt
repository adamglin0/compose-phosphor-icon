...
public val ThinGroup.`Crosshair-simple-thin`: ImageVector
    get() {
        if (`_crosshair-simple-thin` != null) {
            return `_crosshair-simple-thin`!!
        }
        `_crosshair-simple-thin` = Builder(name = "Crosshair-simple-thin", defaultWidth = 256.0.dp,
...
private var `_crosshair-simple-thin`: ImageVector? = null
