...
public val DuotoneGroup.`Washing-machine-duotone`: ImageVector
    get() {
        if (`_washing-machine-duotone` != null) {
            return `_washing-machine-duotone`!!
        }
        `_washing-machine-duotone` = Builder(name = "Washing-machine-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(125.66f, 117.66f)
                lineTo(109.66f, 133.66f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f)
                lineToRelative(16.0f, -16.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 11.32f)
                close()
                moveTo(157.66f, 114.34f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 11.32f)
                lineToRelative(-32.0f, 32.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -11.32f, -11.32f)
                lineToRelative(32.0f, -32.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 157.66f, 114.34f)
                close()
            }
        }
        .build()
...
private var `_washing-machine-duotone`: ImageVector? = null
