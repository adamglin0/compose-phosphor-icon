...
public val BoldGroup.`Metronome-bold`: ImageVector
    get() {
        if (`_metronome-bold` != null) {
            return `_metronome-bold`!!
        }
        `_metronome-bold` = Builder(name = "Metronome-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_metronome-bold`: ImageVector? = null
