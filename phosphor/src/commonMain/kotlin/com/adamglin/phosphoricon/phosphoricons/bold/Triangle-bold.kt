...
public val BoldGroup.`Triangle-bold`: ImageVector
    get() {
        if (`_triangle-bold` != null) {
            return `_triangle-bold`!!
        }
        `_triangle-bold` = Builder(name = "Triangle-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_triangle-bold`: ImageVector? = null
