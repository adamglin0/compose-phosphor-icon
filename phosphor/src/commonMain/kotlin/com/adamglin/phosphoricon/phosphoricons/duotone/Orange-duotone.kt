...
public val DuotoneGroup.`Orange-duotone`: ImageVector
    get() {
        if (`_orange-duotone` != null) {
            return `_orange-duotone`!!
        }
        `_orange-duotone` = Builder(name = "Orange-duotone", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(80.0f, 80.0f, 0.0f, false, true, 208.0f, 152.0f)
                close()
            }
...
private var `_orange-duotone`: ImageVector? = null
