...
public val DuotoneGroup.`Chart-line-up-duotone`: ImageVector
    get() {
        if (`_chart-line-up-duotone` != null) {
            return `_chart-line-up-duotone`!!
        }
        `_chart-line-up-duotone` = Builder(name = "Chart-line-up-duotone", defaultWidth = 256.0.dp,
...
private var `_chart-line-up-duotone`: ImageVector? = null
