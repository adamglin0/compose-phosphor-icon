...
public val DuotoneGroup.`File-arrow-up-duotone`: ImageVector
    get() {
        if (`_file-arrow-up-duotone` != null) {
            return `_file-arrow-up-duotone`!!
        }
        `_file-arrow-up-duotone` = Builder(name = "File-arrow-up-duotone", defaultWidth = 256.0.dp,
...
private var `_file-arrow-up-duotone`: ImageVector? = null
