...
public val DuotoneGroup.`Handbag-duotone`: ImageVector
    get() {
        if (`_handbag-duotone` != null) {
            return `_handbag-duotone`!!
        }
        `_handbag-duotone` = Builder(name = "Handbag-duotone", defaultWidth = 256.0.dp,
...
private var `_handbag-duotone`: ImageVector? = null
