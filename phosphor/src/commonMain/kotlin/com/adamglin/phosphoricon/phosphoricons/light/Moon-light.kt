...
public val LightGroup.`Moon-light`: ImageVector
    get() {
        if (`_moon-light` != null) {
            return `_moon-light`!!
        }
        `_moon-light` = Builder(name = "Moon-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_moon-light`: ImageVector? = null
