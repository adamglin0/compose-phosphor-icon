...
public val RegularGroup.`Speaker-hifi`: ImageVector
    get() {
        if (`_speaker-hifi` != null) {
            return `_speaker-hifi`!!
        }
        `_speaker-hifi` = Builder(name = "Speaker-hifi", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_speaker-hifi`: ImageVector? = null
