...
public val LightGroup.`Mask-happy-light`: ImageVector
    get() {
        if (`_mask-happy-light` != null) {
            return `_mask-happy-light`!!
        }
        `_mask-happy-light` = Builder(name = "Mask-happy-light", defaultWidth = 256.0.dp,
...
private var `_mask-happy-light`: ImageVector? = null
