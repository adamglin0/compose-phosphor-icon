...
public val FillGroup.`Scroll-fill`: ImageVector
    get() {
        if (`_scroll-fill` != null) {
            return `_scroll-fill`!!
        }
        `_scroll-fill` = Builder(name = "Scroll-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scroll-fill`: ImageVector? = null
