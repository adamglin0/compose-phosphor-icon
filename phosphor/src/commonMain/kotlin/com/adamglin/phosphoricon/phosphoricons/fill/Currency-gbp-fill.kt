...
public val FillGroup.`Currency-gbp-fill`: ImageVector
    get() {
        if (`_currency-gbp-fill` != null) {
            return `_currency-gbp-fill`!!
        }
        `_currency-gbp-fill` = Builder(name = "Currency-gbp-fill", defaultWidth = 256.0.dp,
...
private var `_currency-gbp-fill`: ImageVector? = null
