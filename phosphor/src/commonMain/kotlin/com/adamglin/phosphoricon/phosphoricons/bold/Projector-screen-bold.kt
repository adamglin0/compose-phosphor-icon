...
public val BoldGroup.`Projector-screen-bold`: ImageVector
    get() {
        if (`_projector-screen-bold` != null) {
            return `_projector-screen-bold`!!
        }
        `_projector-screen-bold` = Builder(name = "Projector-screen-bold", defaultWidth = 256.0.dp,
...
private var `_projector-screen-bold`: ImageVector? = null
