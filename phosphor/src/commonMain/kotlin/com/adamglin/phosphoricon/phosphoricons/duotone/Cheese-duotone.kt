...
public val DuotoneGroup.`Cheese-duotone`: ImageVector
    get() {
        if (`_cheese-duotone` != null) {
            return `_cheese-duotone`!!
        }
        `_cheese-duotone` = Builder(name = "Cheese-duotone", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(24.0f, 24.0f, 0.0f, false, true, 24.0f, 23.54f)
                curveTo(56.25f, 149.0f, 44.91f, 160.0f, 31.46f, 160.0f)
                lineTo(24.0f, 160.0f)
                ...
                lineTo(232.0f, 88.0f)
                arcTo(48.0f, 48.0f, 0.0f, false, false, 184.0f, 40.0f)
                close()
                moveTo(168.0f, 136.0f)
                arcToRelative(32.0f, 32.0f, 0.0f, false, true, -27.72f, -48.0f)
                horizontalLineToRelative(55.44f)
                arcTo(32.0f, 32.0f, 0.0f, false, true, 168.0f, 136.0f)
                close()
            }
...
private var `_cheese-duotone`: ImageVector? = null
