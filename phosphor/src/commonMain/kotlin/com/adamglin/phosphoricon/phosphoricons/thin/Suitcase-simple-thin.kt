...
public val ThinGroup.`Suitcase-simple-thin`: ImageVector
    get() {
        if (`_suitcase-simple-thin` != null) {
            return `_suitcase-simple-thin`!!
        }
        `_suitcase-simple-thin` = Builder(name = "Suitcase-simple-thin", defaultWidth = 256.0.dp,
...
private var `_suitcase-simple-thin`: ImageVector? = null
