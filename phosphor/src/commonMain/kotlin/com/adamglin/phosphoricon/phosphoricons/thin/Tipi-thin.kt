...
public val ThinGroup.`Tipi-thin`: ImageVector
    get() {
        if (`_tipi-thin` != null) {
            return `_tipi-thin`!!
        }
        `_tipi-thin` = Builder(name = "Tipi-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tipi-thin`: ImageVector? = null
