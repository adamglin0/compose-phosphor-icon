...
public val BoldGroup.`Ticket-bold`: ImageVector
    get() {
        if (`_ticket-bold` != null) {
            return `_ticket-bold`!!
        }
        `_ticket-bold` = Builder(name = "Ticket-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ticket-bold`: ImageVector? = null
