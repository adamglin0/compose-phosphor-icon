...
public val BoldGroup.`Thumbs-down-bold`: ImageVector
    get() {
        if (`_thumbs-down-bold` != null) {
            return `_thumbs-down-bold`!!
        }
        `_thumbs-down-bold` = Builder(name = "Thumbs-down-bold", defaultWidth = 256.0.dp,
...
private var `_thumbs-down-bold`: ImageVector? = null
