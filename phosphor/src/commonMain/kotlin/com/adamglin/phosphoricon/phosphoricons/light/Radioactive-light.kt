...
public val LightGroup.`Radioactive-light`: ImageVector
    get() {
        if (`_radioactive-light` != null) {
            return `_radioactive-light`!!
        }
        `_radioactive-light` = Builder(name = "Radioactive-light", defaultWidth = 256.0.dp,
...
private var `_radioactive-light`: ImageVector? = null
