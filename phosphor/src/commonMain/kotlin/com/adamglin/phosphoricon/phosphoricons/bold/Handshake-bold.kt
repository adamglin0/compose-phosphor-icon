...
public val BoldGroup.`Handshake-bold`: ImageVector
    get() {
        if (`_handshake-bold` != null) {
            return `_handshake-bold`!!
        }
        `_handshake-bold` = Builder(name = "Handshake-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_handshake-bold`: ImageVector? = null
