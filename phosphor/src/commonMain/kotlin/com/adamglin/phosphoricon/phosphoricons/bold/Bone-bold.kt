...
public val BoldGroup.`Bone-bold`: ImageVector
    get() {
        if (`_bone-bold` != null) {
            return `_bone-bold`!!
        }
        `_bone-bold` = Builder(name = "Bone-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bone-bold`: ImageVector? = null
