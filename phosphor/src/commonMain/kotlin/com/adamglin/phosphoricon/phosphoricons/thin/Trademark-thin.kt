...
public val ThinGroup.`Trademark-thin`: ImageVector
    get() {
        if (`_trademark-thin` != null) {
            return `_trademark-thin`!!
        }
        `_trademark-thin` = Builder(name = "Trademark-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_trademark-thin`: ImageVector? = null
