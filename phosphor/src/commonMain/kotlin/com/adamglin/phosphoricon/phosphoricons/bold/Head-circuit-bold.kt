...
public val BoldGroup.`Head-circuit-bold`: ImageVector
    get() {
        if (`_head-circuit-bold` != null) {
            return `_head-circuit-bold`!!
        }
        `_head-circuit-bold` = Builder(name = "Head-circuit-bold", defaultWidth = 256.0.dp,
...
private var `_head-circuit-bold`: ImageVector? = null
