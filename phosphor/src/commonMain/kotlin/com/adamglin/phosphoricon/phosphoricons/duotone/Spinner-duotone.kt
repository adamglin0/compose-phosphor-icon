...
public val DuotoneGroup.`Spinner-duotone`: ImageVector
    get() {
        if (`_spinner-duotone` != null) {
            return `_spinner-duotone`!!
        }
        `_spinner-duotone` = Builder(name = "Spinner-duotone", defaultWidth = 256.0.dp,
...
private var `_spinner-duotone`: ImageVector? = null
