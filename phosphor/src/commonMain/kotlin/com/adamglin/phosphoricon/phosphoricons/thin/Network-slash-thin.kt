...
public val ThinGroup.`Network-slash-thin`: ImageVector
    get() {
        if (`_network-slash-thin` != null) {
            return `_network-slash-thin`!!
        }
        `_network-slash-thin` = Builder(name = "Network-slash-thin", defaultWidth = 256.0.dp,
...
private var `_network-slash-thin`: ImageVector? = null
