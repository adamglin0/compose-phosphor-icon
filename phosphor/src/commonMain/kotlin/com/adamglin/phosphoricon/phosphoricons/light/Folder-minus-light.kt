...
public val LightGroup.`Folder-minus-light`: ImageVector
    get() {
        if (`_folder-minus-light` != null) {
            return `_folder-minus-light`!!
        }
        `_folder-minus-light` = Builder(name = "Folder-minus-light", defaultWidth = 256.0.dp,
...
private var `_folder-minus-light`: ImageVector? = null
