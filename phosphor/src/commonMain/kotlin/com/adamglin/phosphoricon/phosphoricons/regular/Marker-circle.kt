...
public val RegularGroup.`Marker-circle`: ImageVector
    get() {
        if (`_marker-circle` != null) {
            return `_marker-circle`!!
        }
        `_marker-circle` = Builder(name = "Marker-circle", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_marker-circle`: ImageVector? = null
