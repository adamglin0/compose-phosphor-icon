...
public val BoldGroup.`Translate-bold`: ImageVector
    get() {
        if (`_translate-bold` != null) {
            return `_translate-bold`!!
        }
        `_translate-bold` = Builder(name = "Translate-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_translate-bold`: ImageVector? = null
