...
public val FillGroup.`Egg-crack-fill`: ImageVector
    get() {
        if (`_egg-crack-fill` != null) {
            return `_egg-crack-fill`!!
        }
        `_egg-crack-fill` = Builder(name = "Egg-crack-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_egg-crack-fill`: ImageVector? = null
