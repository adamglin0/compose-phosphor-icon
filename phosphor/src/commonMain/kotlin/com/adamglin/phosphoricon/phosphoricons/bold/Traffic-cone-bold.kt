...
public val BoldGroup.`Traffic-cone-bold`: ImageVector
    get() {
        if (`_traffic-cone-bold` != null) {
            return `_traffic-cone-bold`!!
        }
        `_traffic-cone-bold` = Builder(name = "Traffic-cone-bold", defaultWidth = 256.0.dp,
...
private var `_traffic-cone-bold`: ImageVector? = null
