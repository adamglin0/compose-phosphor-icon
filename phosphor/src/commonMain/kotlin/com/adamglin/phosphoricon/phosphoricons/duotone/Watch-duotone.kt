...
public val DuotoneGroup.`Watch-duotone`: ImageVector
    get() {
        if (`_watch-duotone` != null) {
            return `_watch-duotone`!!
        }
        `_watch-duotone` = Builder(name = "Watch-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_watch-duotone`: ImageVector? = null
