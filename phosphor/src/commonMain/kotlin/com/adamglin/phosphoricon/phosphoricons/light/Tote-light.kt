...
public val LightGroup.`Tote-light`: ImageVector
    get() {
        if (`_tote-light` != null) {
            return `_tote-light`!!
        }
        `_tote-light` = Builder(name = "Tote-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tote-light`: ImageVector? = null
