...
public val DuotoneGroup.`Chat-centered-duotone`: ImageVector
    get() {
        if (`_chat-centered-duotone` != null) {
            return `_chat-centered-duotone`!!
        }
        `_chat-centered-duotone` = Builder(name = "Chat-centered-duotone", defaultWidth = 256.0.dp,
...
private var `_chat-centered-duotone`: ImageVector? = null
