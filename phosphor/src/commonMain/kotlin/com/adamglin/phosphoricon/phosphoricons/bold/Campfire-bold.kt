...
public val BoldGroup.`Campfire-bold`: ImageVector
    get() {
        if (`_campfire-bold` != null) {
            return `_campfire-bold`!!
        }
        `_campfire-bold` = Builder(name = "Campfire-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_campfire-bold`: ImageVector? = null
