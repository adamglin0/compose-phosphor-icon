...
public val DuotoneGroup.`Circuitry-duotone`: ImageVector
    get() {
        if (`_circuitry-duotone` != null) {
            return `_circuitry-duotone`!!
        }
        `_circuitry-duotone` = Builder(name = "Circuitry-duotone", defaultWidth = 256.0.dp,
...
private var `_circuitry-duotone`: ImageVector? = null
