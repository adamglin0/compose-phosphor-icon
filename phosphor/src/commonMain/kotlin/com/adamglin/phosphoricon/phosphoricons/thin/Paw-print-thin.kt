...
public val ThinGroup.`Paw-print-thin`: ImageVector
    get() {
        if (`_paw-print-thin` != null) {
            return `_paw-print-thin`!!
        }
        `_paw-print-thin` = Builder(name = "Paw-print-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_paw-print-thin`: ImageVector? = null
