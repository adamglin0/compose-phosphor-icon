...
public val DuotoneGroup.`Footprints-duotone`: ImageVector
    get() {
        if (`_footprints-duotone` != null) {
            return `_footprints-duotone`!!
        }
        `_footprints-duotone` = Builder(name = "Footprints-duotone", defaultWidth = 256.0.dp,
...
private var `_footprints-duotone`: ImageVector? = null
