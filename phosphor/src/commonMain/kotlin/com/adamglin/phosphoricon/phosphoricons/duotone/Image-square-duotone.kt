...
public val DuotoneGroup.`Image-square-duotone`: ImageVector
    get() {
        if (`_image-square-duotone` != null) {
            return `_image-square-duotone`!!
        }
        `_image-square-duotone` = Builder(name = "Image-square-duotone", defaultWidth = 256.0.dp,
...
private var `_image-square-duotone`: ImageVector? = null
