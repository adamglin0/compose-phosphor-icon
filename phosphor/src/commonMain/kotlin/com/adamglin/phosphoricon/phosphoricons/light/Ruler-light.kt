...
public val LightGroup.`Ruler-light`: ImageVector
    get() {
        if (`_ruler-light` != null) {
            return `_ruler-light`!!
        }
        `_ruler-light` = Builder(name = "Ruler-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ruler-light`: ImageVector? = null
