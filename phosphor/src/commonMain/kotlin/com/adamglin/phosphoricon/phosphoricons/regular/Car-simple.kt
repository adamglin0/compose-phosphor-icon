...
public val RegularGroup.`Car-simple`: ImageVector
    get() {
        if (`_car-simple` != null) {
            return `_car-simple`!!
        }
        `_car-simple` = Builder(name = "Car-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_car-simple`: ImageVector? = null
