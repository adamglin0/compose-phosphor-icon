...
public val BoldGroup.`Shirt-folded-bold`: ImageVector
    get() {
        if (`_shirt-folded-bold` != null) {
            return `_shirt-folded-bold`!!
        }
        `_shirt-folded-bold` = Builder(name = "Shirt-folded-bold", defaultWidth = 256.0.dp,
...
private var `_shirt-folded-bold`: ImageVector? = null
