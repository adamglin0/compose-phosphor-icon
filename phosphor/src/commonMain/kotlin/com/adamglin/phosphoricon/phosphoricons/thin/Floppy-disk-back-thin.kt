...
public val ThinGroup.`Floppy-disk-back-thin`: ImageVector
    get() {
        if (`_floppy-disk-back-thin` != null) {
            return `_floppy-disk-back-thin`!!
        }
        `_floppy-disk-back-thin` = Builder(name = "Floppy-disk-back-thin", defaultWidth = 256.0.dp,
...
private var `_floppy-disk-back-thin`: ImageVector? = null
