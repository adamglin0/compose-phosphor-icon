...
public val LightGroup.`Dresser-light`: ImageVector
    get() {
        if (`_dresser-light` != null) {
            return `_dresser-light`!!
        }
        `_dresser-light` = Builder(name = "Dresser-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dresser-light`: ImageVector? = null
