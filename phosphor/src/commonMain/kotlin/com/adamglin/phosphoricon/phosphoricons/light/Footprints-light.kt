...
public val LightGroup.`Footprints-light`: ImageVector
    get() {
        if (`_footprints-light` != null) {
            return `_footprints-light`!!
        }
        `_footprints-light` = Builder(name = "Footprints-light", defaultWidth = 256.0.dp,
...
private var `_footprints-light`: ImageVector? = null
