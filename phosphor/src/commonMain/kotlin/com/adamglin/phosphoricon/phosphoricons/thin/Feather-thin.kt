...
public val ThinGroup.`Feather-thin`: ImageVector
    get() {
        if (`_feather-thin` != null) {
            return `_feather-thin`!!
        }
        `_feather-thin` = Builder(name = "Feather-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_feather-thin`: ImageVector? = null
