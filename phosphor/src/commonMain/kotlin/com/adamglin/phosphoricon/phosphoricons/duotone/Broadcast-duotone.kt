...
public val DuotoneGroup.`Broadcast-duotone`: ImageVector
    get() {
        if (`_broadcast-duotone` != null) {
            return `_broadcast-duotone`!!
        }
        `_broadcast-duotone` = Builder(name = "Broadcast-duotone", defaultWidth = 256.0.dp,
...
private var `_broadcast-duotone`: ImageVector? = null
