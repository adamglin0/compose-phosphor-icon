...
public val RegularGroup.`Arrow-fat-lines-up`: ImageVector
    get() {
        if (`_arrow-fat-lines-up` != null) {
            return `_arrow-fat-lines-up`!!
        }
        `_arrow-fat-lines-up` = Builder(name = "Arrow-fat-lines-up", defaultWidth = 256.0.dp,
...
private var `_arrow-fat-lines-up`: ImageVector? = null
