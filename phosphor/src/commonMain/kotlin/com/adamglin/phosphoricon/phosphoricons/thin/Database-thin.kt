...
public val ThinGroup.`Database-thin`: ImageVector
    get() {
        if (`_database-thin` != null) {
            return `_database-thin`!!
        }
        `_database-thin` = Builder(name = "Database-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_database-thin`: ImageVector? = null
