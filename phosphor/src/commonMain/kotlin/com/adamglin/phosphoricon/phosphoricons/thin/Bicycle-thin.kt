...
public val ThinGroup.`Bicycle-thin`: ImageVector
    get() {
        if (`_bicycle-thin` != null) {
            return `_bicycle-thin`!!
        }
        `_bicycle-thin` = Builder(name = "Bicycle-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bicycle-thin`: ImageVector? = null
