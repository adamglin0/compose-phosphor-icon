...
public val LightGroup.`Slack-logo-light`: ImageVector
    get() {
        if (`_slack-logo-light` != null) {
            return `_slack-logo-light`!!
        }
        `_slack-logo-light` = Builder(name = "Slack-logo-light", defaultWidth = 256.0.dp,
...
private var `_slack-logo-light`: ImageVector? = null
