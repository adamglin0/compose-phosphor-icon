...
public val ThinGroup.`Football-helmet-thin`: ImageVector
    get() {
        if (`_football-helmet-thin` != null) {
            return `_football-helmet-thin`!!
        }
        `_football-helmet-thin` = Builder(name = "Football-helmet-thin", defaultWidth = 256.0.dp,
...
private var `_football-helmet-thin`: ImageVector? = null
