...
public val DuotoneGroup.`Translate-duotone`: ImageVector
    get() {
        if (`_translate-duotone` != null) {
            return `_translate-duotone`!!
        }
        `_translate-duotone` = Builder(name = "Translate-duotone", defaultWidth = 256.0.dp,
...
private var `_translate-duotone`: ImageVector? = null
