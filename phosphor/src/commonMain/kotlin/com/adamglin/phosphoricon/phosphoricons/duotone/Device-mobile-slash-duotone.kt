...
public val DuotoneGroup.`Device-mobile-slash-duotone`: ImageVector
    get() {
        if (`_device-mobile-slash-duotone` != null) {
            return `_device-mobile-slash-duotone`!!
        }
        `_device-mobile-slash-duotone` = Builder(name = "Device-mobile-slash-duotone", defaultWidth
...
private var `_device-mobile-slash-duotone`: ImageVector? = null
