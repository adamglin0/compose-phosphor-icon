...
public val RegularGroup.`Building-apartment`: ImageVector
    get() {
        if (`_building-apartment` != null) {
            return `_building-apartment`!!
        }
        `_building-apartment` = Builder(name = "Building-apartment", defaultWidth = 256.0.dp,
...
private var `_building-apartment`: ImageVector? = null
