...
public val LightGroup.`Circle-dashed-light`: ImageVector
    get() {
        if (`_circle-dashed-light` != null) {
            return `_circle-dashed-light`!!
        }
        `_circle-dashed-light` = Builder(name = "Circle-dashed-light", defaultWidth = 256.0.dp,
...
private var `_circle-dashed-light`: ImageVector? = null
