...
public val ThinGroup.`Folder-simple-minus-thin`: ImageVector
    get() {
        if (`_folder-simple-minus-thin` != null) {
            return `_folder-simple-minus-thin`!!
        }
        `_folder-simple-minus-thin` = Builder(name = "Folder-simple-minus-thin", defaultWidth =
...
private var `_folder-simple-minus-thin`: ImageVector? = null
