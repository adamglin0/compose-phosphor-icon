...
public val ThinGroup.`Text-subscript-thin`: ImageVector
    get() {
        if (`_text-subscript-thin` != null) {
            return `_text-subscript-thin`!!
        }
        `_text-subscript-thin` = Builder(name = "Text-subscript-thin", defaultWidth = 256.0.dp,
...
private var `_text-subscript-thin`: ImageVector? = null
