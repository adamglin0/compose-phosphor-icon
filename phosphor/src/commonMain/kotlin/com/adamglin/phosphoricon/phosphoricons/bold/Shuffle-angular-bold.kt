...
public val BoldGroup.`Shuffle-angular-bold`: ImageVector
    get() {
        if (`_shuffle-angular-bold` != null) {
            return `_shuffle-angular-bold`!!
        }
        `_shuffle-angular-bold` = Builder(name = "Shuffle-angular-bold", defaultWidth = 256.0.dp,
...
private var `_shuffle-angular-bold`: ImageVector? = null
