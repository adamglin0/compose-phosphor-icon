...
public val LightGroup.`Plus-light`: ImageVector
    get() {
        if (`_plus-light` != null) {
            return `_plus-light`!!
        }
        `_plus-light` = Builder(name = "Plus-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plus-light`: ImageVector? = null
