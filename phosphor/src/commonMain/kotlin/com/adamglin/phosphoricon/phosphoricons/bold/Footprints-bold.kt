...
public val BoldGroup.`Footprints-bold`: ImageVector
    get() {
        if (`_footprints-bold` != null) {
            return `_footprints-bold`!!
        }
        `_footprints-bold` = Builder(name = "Footprints-bold", defaultWidth = 256.0.dp,
...
private var `_footprints-bold`: ImageVector? = null
