...
public val BoldGroup.`Mask-happy-bold`: ImageVector
    get() {
        if (`_mask-happy-bold` != null) {
            return `_mask-happy-bold`!!
        }
        `_mask-happy-bold` = Builder(name = "Mask-happy-bold", defaultWidth = 256.0.dp,
...
private var `_mask-happy-bold`: ImageVector? = null
