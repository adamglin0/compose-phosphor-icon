...
public val LightGroup.`Camera-light`: ImageVector
    get() {
        if (`_camera-light` != null) {
            return `_camera-light`!!
        }
        `_camera-light` = Builder(name = "Camera-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_camera-light`: ImageVector? = null
