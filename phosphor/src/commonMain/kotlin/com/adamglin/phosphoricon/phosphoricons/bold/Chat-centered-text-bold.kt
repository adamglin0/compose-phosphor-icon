...
public val BoldGroup.`Chat-centered-text-bold`: ImageVector
    get() {
        if (`_chat-centered-text-bold` != null) {
            return `_chat-centered-text-bold`!!
        }
        `_chat-centered-text-bold` = Builder(name = "Chat-centered-text-bold", defaultWidth =
...
private var `_chat-centered-text-bold`: ImageVector? = null
