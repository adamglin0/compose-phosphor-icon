...
public val ThinGroup.`Phone-plus-thin`: ImageVector
    get() {
        if (`_phone-plus-thin` != null) {
            return `_phone-plus-thin`!!
        }
        `_phone-plus-thin` = Builder(name = "Phone-plus-thin", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 140.0f, 80.0f)
                close()
            }
        }
        .build()
...
private var `_phone-plus-thin`: ImageVector? = null
