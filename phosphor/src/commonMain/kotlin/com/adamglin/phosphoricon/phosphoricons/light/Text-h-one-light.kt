...
public val LightGroup.`Text-h-one-light`: ImageVector
    get() {
        if (`_text-h-one-light` != null) {
            return `_text-h-one-light`!!
        }
        `_text-h-one-light` = Builder(name = "Text-h-one-light", defaultWidth = 256.0.dp,
...
private var `_text-h-one-light`: ImageVector? = null
