...
public val BoldGroup.`Hexagon-bold`: ImageVector
    get() {
        if (`_hexagon-bold` != null) {
            return `_hexagon-bold`!!
        }
        `_hexagon-bold` = Builder(name = "Hexagon-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hexagon-bold`: ImageVector? = null
