...
public val LightGroup.`Books-light`: ImageVector
    get() {
        if (`_books-light` != null) {
            return `_books-light`!!
        }
        `_books-light` = Builder(name = "Books-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_books-light`: ImageVector? = null
