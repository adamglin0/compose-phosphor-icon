...
public val ThinGroup.`Cloud-rain-thin`: ImageVector
    get() {
        if (`_cloud-rain-thin` != null) {
            return `_cloud-rain-thin`!!
        }
        `_cloud-rain-thin` = Builder(name = "Cloud-rain-thin", defaultWidth = 256.0.dp,
...
private var `_cloud-rain-thin`: ImageVector? = null
