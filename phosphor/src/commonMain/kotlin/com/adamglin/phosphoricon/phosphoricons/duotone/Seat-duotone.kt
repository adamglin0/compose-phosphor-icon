...
public val DuotoneGroup.`Seat-duotone`: ImageVector
    get() {
        if (`_seat-duotone` != null) {
            return `_seat-duotone`!!
        }
        `_seat-duotone` = Builder(name = "Seat-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seat-duotone`: ImageVector? = null
