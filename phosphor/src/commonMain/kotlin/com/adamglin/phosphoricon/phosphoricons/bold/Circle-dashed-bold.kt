...
public val BoldGroup.`Circle-dashed-bold`: ImageVector
    get() {
        if (`_circle-dashed-bold` != null) {
            return `_circle-dashed-bold`!!
        }
        `_circle-dashed-bold` = Builder(name = "Circle-dashed-bold", defaultWidth = 256.0.dp,
...
private var `_circle-dashed-bold`: ImageVector? = null
