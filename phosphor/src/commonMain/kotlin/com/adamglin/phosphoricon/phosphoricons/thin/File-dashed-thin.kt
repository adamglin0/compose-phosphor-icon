...
public val ThinGroup.`File-dashed-thin`: ImageVector
    get() {
        if (`_file-dashed-thin` != null) {
            return `_file-dashed-thin`!!
        }
        `_file-dashed-thin` = Builder(name = "File-dashed-thin", defaultWidth = 256.0.dp,
...
private var `_file-dashed-thin`: ImageVector? = null
