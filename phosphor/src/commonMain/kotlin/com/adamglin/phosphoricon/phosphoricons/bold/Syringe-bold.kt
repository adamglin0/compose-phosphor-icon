...
public val BoldGroup.`Syringe-bold`: ImageVector
    get() {
        if (`_syringe-bold` != null) {
            return `_syringe-bold`!!
        }
        `_syringe-bold` = Builder(name = "Syringe-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_syringe-bold`: ImageVector? = null
