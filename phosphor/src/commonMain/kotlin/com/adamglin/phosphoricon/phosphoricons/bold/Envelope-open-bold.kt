...
public val BoldGroup.`Envelope-open-bold`: ImageVector
    get() {
        if (`_envelope-open-bold` != null) {
            return `_envelope-open-bold`!!
        }
        `_envelope-open-bold` = Builder(name = "Envelope-open-bold", defaultWidth = 256.0.dp,
...
private var `_envelope-open-bold`: ImageVector? = null
