...
public val BoldGroup.`File-jpg-bold`: ImageVector
    get() {
        if (`_file-jpg-bold` != null) {
            return `_file-jpg-bold`!!
        }
        `_file-jpg-bold` = Builder(name = "File-jpg-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-jpg-bold`: ImageVector? = null
