...
public val ThinGroup.`Tornado-thin`: ImageVector
    get() {
        if (`_tornado-thin` != null) {
            return `_tornado-thin`!!
        }
        `_tornado-thin` = Builder(name = "Tornado-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tornado-thin`: ImageVector? = null
