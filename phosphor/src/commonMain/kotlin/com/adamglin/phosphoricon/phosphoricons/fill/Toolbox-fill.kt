...
public val FillGroup.`Toolbox-fill`: ImageVector
    get() {
        if (`_toolbox-fill` != null) {
            return `_toolbox-fill`!!
        }
        `_toolbox-fill` = Builder(name = "Toolbox-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_toolbox-fill`: ImageVector? = null
