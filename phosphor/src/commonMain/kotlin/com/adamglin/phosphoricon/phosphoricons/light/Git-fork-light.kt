...
public val LightGroup.`Git-fork-light`: ImageVector
    get() {
        if (`_git-fork-light` != null) {
            return `_git-fork-light`!!
        }
        `_git-fork-light` = Builder(name = "Git-fork-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_git-fork-light`: ImageVector? = null
