...
public val DuotoneGroup.`Baseball-helmet-duotone`: ImageVector
    get() {
        if (`_baseball-helmet-duotone` != null) {
            return `_baseball-helmet-duotone`!!
        }
        `_baseball-helmet-duotone` = Builder(name = "Baseball-helmet-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(20.0f, 20.0f, 0.0f, false, true, 88.0f, 176.0f)
                close()
...
private var `_baseball-helmet-duotone`: ImageVector? = null
