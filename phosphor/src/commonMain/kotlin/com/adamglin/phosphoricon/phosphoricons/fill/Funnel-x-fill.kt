...
public val FillGroup.`Funnel-x-fill`: ImageVector
    get() {
        if (`_funnel-x-fill` != null) {
            return `_funnel-x-fill`!!
        }
        `_funnel-x-fill` = Builder(name = "Funnel-x-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_funnel-x-fill`: ImageVector? = null
