...
public val DuotoneGroup.`File-ts-duotone`: ImageVector
    get() {
        if (`_file-ts-duotone` != null) {
            return `_file-ts-duotone`!!
        }
        `_file-ts-duotone` = Builder(name = "File-ts-duotone", defaultWidth = 256.0.dp,
...
private var `_file-ts-duotone`: ImageVector? = null
