...
public val DuotoneGroup.`Keyhole-duotone`: ImageVector
    get() {
        if (`_keyhole-duotone` != null) {
            return `_keyhole-duotone`!!
        }
        `_keyhole-duotone` = Builder(name = "Keyhole-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(144.0f, 139.72f)
                lineTo(160.0f, 176.0f)
                horizontalLineTo(96.0f)
                lineToRelative(16.0f, -36.28f)
...
private var `_keyhole-duotone`: ImageVector? = null
