...
public val FillGroup.`Checks-fill`: ImageVector
    get() {
        if (`_checks-fill` != null) {
            return `_checks-fill`!!
        }
        `_checks-fill` = Builder(name = "Checks-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 72.0f, 168.0f)
                close()
...
private var `_checks-fill`: ImageVector? = null
