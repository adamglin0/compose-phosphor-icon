...
public val BoldGroup.`Camera-plus-bold`: ImageVector
    get() {
        if (`_camera-plus-bold` != null) {
            return `_camera-plus-bold`!!
        }
        `_camera-plus-bold` = Builder(name = "Camera-plus-bold", defaultWidth = 256.0.dp,
...
private var `_camera-plus-bold`: ImageVector? = null
