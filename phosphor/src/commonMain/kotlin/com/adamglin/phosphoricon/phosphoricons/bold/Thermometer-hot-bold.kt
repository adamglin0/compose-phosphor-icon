...
public val BoldGroup.`Thermometer-hot-bold`: ImageVector
    get() {
        if (`_thermometer-hot-bold` != null) {
            return `_thermometer-hot-bold`!!
        }
        `_thermometer-hot-bold` = Builder(name = "Thermometer-hot-bold", defaultWidth = 256.0.dp,
...
private var `_thermometer-hot-bold`: ImageVector? = null
