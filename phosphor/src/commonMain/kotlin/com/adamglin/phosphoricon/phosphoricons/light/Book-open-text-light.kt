...
public val LightGroup.`Book-open-text-light`: ImageVector
    get() {
        if (`_book-open-text-light` != null) {
            return `_book-open-text-light`!!
        }
        `_book-open-text-light` = Builder(name = "Book-open-text-light", defaultWidth = 256.0.dp,
...
private var `_book-open-text-light`: ImageVector? = null
