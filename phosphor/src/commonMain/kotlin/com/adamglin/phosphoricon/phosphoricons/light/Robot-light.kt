...
public val LightGroup.`Robot-light`: ImageVector
    get() {
        if (`_robot-light` != null) {
            return `_robot-light`!!
        }
        `_robot-light` = Builder(name = "Robot-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_robot-light`: ImageVector? = null
