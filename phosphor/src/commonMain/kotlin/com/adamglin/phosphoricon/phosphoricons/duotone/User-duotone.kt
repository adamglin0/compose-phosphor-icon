...
public val DuotoneGroup.`User-duotone`: ImageVector
    get() {
        if (`_user-duotone` != null) {
            return `_user-duotone`!!
        }
        `_user-duotone` = Builder(name = "User-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_user-duotone`: ImageVector? = null
