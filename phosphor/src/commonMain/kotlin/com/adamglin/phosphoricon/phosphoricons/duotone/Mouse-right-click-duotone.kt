...
public val DuotoneGroup.`Mouse-right-click-duotone`: ImageVector
    get() {
        if (`_mouse-right-click-duotone` != null) {
            return `_mouse-right-click-duotone`!!
        }
        `_mouse-right-click-duotone` = Builder(name = "Mouse-right-click-duotone", defaultWidth =
...
private var `_mouse-right-click-duotone`: ImageVector? = null
