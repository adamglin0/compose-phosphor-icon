...
public val DuotoneGroup.`Eye-slash-duotone`: ImageVector
    get() {
        if (`_eye-slash-duotone` != null) {
            return `_eye-slash-duotone`!!
        }
        `_eye-slash-duotone` = Builder(name = "Eye-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_eye-slash-duotone`: ImageVector? = null
