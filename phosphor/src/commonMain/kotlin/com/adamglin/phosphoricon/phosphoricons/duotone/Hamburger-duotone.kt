...
public val DuotoneGroup.`Hamburger-duotone`: ImageVector
    get() {
        if (`_hamburger-duotone` != null) {
            return `_hamburger-duotone`!!
        }
        `_hamburger-duotone` = Builder(name = "Hamburger-duotone", defaultWidth = 256.0.dp,
...
private var `_hamburger-duotone`: ImageVector? = null
