...
public val BoldGroup.`Speaker-low-bold`: ImageVector
    get() {
        if (`_speaker-low-bold` != null) {
            return `_speaker-low-bold`!!
        }
        `_speaker-low-bold` = Builder(name = "Speaker-low-bold", defaultWidth = 256.0.dp,
...
private var `_speaker-low-bold`: ImageVector? = null
