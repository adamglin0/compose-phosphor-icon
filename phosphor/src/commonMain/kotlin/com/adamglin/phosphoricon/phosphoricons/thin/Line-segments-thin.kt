...
public val ThinGroup.`Line-segments-thin`: ImageVector
    get() {
        if (`_line-segments-thin` != null) {
            return `_line-segments-thin`!!
        }
        `_line-segments-thin` = Builder(name = "Line-segments-thin", defaultWidth = 256.0.dp,
...
private var `_line-segments-thin`: ImageVector? = null
