...
public val RegularGroup.`File-csv`: ImageVector
    get() {
        if (`_file-csv` != null) {
            return `_file-csv`!!
        }
        `_file-csv` = Builder(name = "File-csv", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-csv`: ImageVector? = null
