...
public val DuotoneGroup.`Linux-logo-duotone`: ImageVector
    get() {
        if (`_linux-logo-duotone` != null) {
            return `_linux-logo-duotone`!!
        }
        `_linux-logo-duotone` = Builder(name = "Linux-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_linux-logo-duotone`: ImageVector? = null
