...
public val BoldGroup.`Sliders-bold`: ImageVector
    get() {
        if (`_sliders-bold` != null) {
            return `_sliders-bold`!!
        }
        `_sliders-bold` = Builder(name = "Sliders-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sliders-bold`: ImageVector? = null
