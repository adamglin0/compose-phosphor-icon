...
public val FillGroup.`Bell-simple-ringing-fill`: ImageVector
    get() {
        if (`_bell-simple-ringing-fill` != null) {
            return `_bell-simple-ringing-fill`!!
        }
        `_bell-simple-ringing-fill` = Builder(name = "Bell-simple-ringing-fill", defaultWidth =
...
private var `_bell-simple-ringing-fill`: ImageVector? = null
