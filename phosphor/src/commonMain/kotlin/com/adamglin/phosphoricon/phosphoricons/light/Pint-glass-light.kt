...
public val LightGroup.`Pint-glass-light`: ImageVector
    get() {
        if (`_pint-glass-light` != null) {
            return `_pint-glass-light`!!
        }
        `_pint-glass-light` = Builder(name = "Pint-glass-light", defaultWidth = 256.0.dp,
...
private var `_pint-glass-light`: ImageVector? = null
