...
public val ThinGroup.`Cloud-snow-thin`: ImageVector
    get() {
        if (`_cloud-snow-thin` != null) {
            return `_cloud-snow-thin`!!
        }
        `_cloud-snow-thin` = Builder(name = "Cloud-snow-thin", defaultWidth = 256.0.dp,
...
private var `_cloud-snow-thin`: ImageVector? = null
