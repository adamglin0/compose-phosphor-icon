...
public val FillGroup.`Monitor-play-fill`: ImageVector
    get() {
        if (`_monitor-play-fill` != null) {
            return `_monitor-play-fill`!!
        }
        `_monitor-play-fill` = Builder(name = "Monitor-play-fill", defaultWidth = 256.0.dp,
...
private var `_monitor-play-fill`: ImageVector? = null
