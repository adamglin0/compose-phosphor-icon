...
public val DuotoneGroup.`Cowboy-hat-duotone`: ImageVector
    get() {
        if (`_cowboy-hat-duotone` != null) {
            return `_cowboy-hat-duotone`!!
        }
        `_cowboy-hat-duotone` = Builder(name = "Cowboy-hat-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(190.53f, 160.18f)
                curveTo(158.13f, 192.0f, 128.0f, 192.0f, 128.0f, 192.0f)
                reflectiveCurveToRelative(-30.13f, 0.0f, -62.53f, -31.82f)
                lineTo(70.06f, 136.0f)
                horizontalLineTo(185.94f)
                close()
            }
...
private var `_cowboy-hat-duotone`: ImageVector? = null
