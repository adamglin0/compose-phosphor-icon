...
public val DuotoneGroup.`Number-circle-zero-duotone`: ImageVector
    get() {
        if (`_number-circle-zero-duotone` != null) {
            return `_number-circle-zero-duotone`!!
        }
        `_number-circle-zero-duotone` = Builder(name = "Number-circle-zero-duotone", defaultWidth =
...
private var `_number-circle-zero-duotone`: ImageVector? = null
