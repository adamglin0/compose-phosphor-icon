...
public val RegularGroup.`Map-pin-simple-area`: ImageVector
    get() {
        if (`_map-pin-simple-area` != null) {
            return `_map-pin-simple-area`!!
        }
        `_map-pin-simple-area` = Builder(name = "Map-pin-simple-area", defaultWidth = 256.0.dp,
...
private var `_map-pin-simple-area`: ImageVector? = null
