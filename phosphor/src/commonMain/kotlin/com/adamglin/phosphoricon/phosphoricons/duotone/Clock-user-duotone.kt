...
public val DuotoneGroup.`Clock-user-duotone`: ImageVector
    get() {
        if (`_clock-user-duotone` != null) {
            return `_clock-user-duotone`!!
        }
        `_clock-user-duotone` = Builder(name = "Clock-user-duotone", defaultWidth = 256.0.dp,
...
private var `_clock-user-duotone`: ImageVector? = null
