...
public val DuotoneGroup.`Rss-duotone`: ImageVector
    get() {
        if (`_rss-duotone` != null) {
            return `_rss-duotone`!!
        }
        `_rss-duotone` = Builder(name = "Rss-duotone", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(160.0f, 160.0f, 0.0f, false, true, 216.0f, 200.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(166.89f, 166.89f, 0.0f, false, false, 56.0f, 32.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, 16.0f)
...
private var `_rss-duotone`: ImageVector? = null
