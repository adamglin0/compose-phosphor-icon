...
public val DuotoneGroup.`Split-vertical-duotone`: ImageVector
    get() {
        if (`_split-vertical-duotone` != null) {
            return `_split-vertical-duotone`!!
        }
        `_split-vertical-duotone` = Builder(name = "Split-vertical-duotone", defaultWidth =
...
private var `_split-vertical-duotone`: ImageVector? = null
