...
public val LightGroup.`Number-circle-six-light`: ImageVector
    get() {
        if (`_number-circle-six-light` != null) {
            return `_number-circle-six-light`!!
        }
        `_number-circle-six-light` = Builder(name = "Number-circle-six-light", defaultWidth =
...
private var `_number-circle-six-light`: ImageVector? = null
