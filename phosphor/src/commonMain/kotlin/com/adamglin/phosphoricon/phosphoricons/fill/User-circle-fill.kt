...
public val FillGroup.`User-circle-fill`: ImageVector
    get() {
        if (`_user-circle-fill` != null) {
            return `_user-circle-fill`!!
        }
        `_user-circle-fill` = Builder(name = "User-circle-fill", defaultWidth = 256.0.dp,
...
private var `_user-circle-fill`: ImageVector? = null
