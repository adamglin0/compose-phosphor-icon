...
public val BoldGroup.`Text-subscript-bold`: ImageVector
    get() {
        if (`_text-subscript-bold` != null) {
            return `_text-subscript-bold`!!
        }
        `_text-subscript-bold` = Builder(name = "Text-subscript-bold", defaultWidth = 256.0.dp,
...
private var `_text-subscript-bold`: ImageVector? = null
