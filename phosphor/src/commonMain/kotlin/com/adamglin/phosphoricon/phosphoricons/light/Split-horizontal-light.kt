...
public val LightGroup.`Split-horizontal-light`: ImageVector
    get() {
        if (`_split-horizontal-light` != null) {
            return `_split-horizontal-light`!!
        }
        `_split-horizontal-light` = Builder(name = "Split-horizontal-light", defaultWidth =
...
private var `_split-horizontal-light`: ImageVector? = null
