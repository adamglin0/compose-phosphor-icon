...
public val FillGroup.`Jar-fill`: ImageVector
    get() {
        if (`_jar-fill` != null) {
            return `_jar-fill`!!
        }
        `_jar-fill` = Builder(name = "Jar-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_jar-fill`: ImageVector? = null
