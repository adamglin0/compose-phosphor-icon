...
public val FillGroup.`Envelope-simple-open-fill`: ImageVector
    get() {
        if (`_envelope-simple-open-fill` != null) {
            return `_envelope-simple-open-fill`!!
        }
        `_envelope-simple-open-fill` = Builder(name = "Envelope-simple-open-fill", defaultWidth =
...
private var `_envelope-simple-open-fill`: ImageVector? = null
