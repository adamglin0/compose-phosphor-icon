...
public val DuotoneGroup.`Butterfly-duotone`: ImageVector
    get() {
        if (`_butterfly-duotone` != null) {
            return `_butterfly-duotone`!!
        }
        `_butterfly-duotone` = Builder(name = "Butterfly-duotone", defaultWidth = 256.0.dp,
...
private var `_butterfly-duotone`: ImageVector? = null
