...
public val ThinGroup.`User-minus-thin`: ImageVector
    get() {
        if (`_user-minus-thin` != null) {
            return `_user-minus-thin`!!
        }
        `_user-minus-thin` = Builder(name = "User-minus-thin", defaultWidth = 256.0.dp,
...
private var `_user-minus-thin`: ImageVector? = null
