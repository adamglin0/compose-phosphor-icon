...
public val FillGroup.`Arrows-in-cardinal-fill`: ImageVector
    get() {
        if (`_arrows-in-cardinal-fill` != null) {
            return `_arrows-in-cardinal-fill`!!
        }
        `_arrows-in-cardinal-fill` = Builder(name = "Arrows-in-cardinal-fill", defaultWidth =
...
private var `_arrows-in-cardinal-fill`: ImageVector? = null
