...
public val LightGroup.`Note-pencil-light`: ImageVector
    get() {
        if (`_note-pencil-light` != null) {
            return `_note-pencil-light`!!
        }
        `_note-pencil-light` = Builder(name = "Note-pencil-light", defaultWidth = 256.0.dp,
...
private var `_note-pencil-light`: ImageVector? = null
