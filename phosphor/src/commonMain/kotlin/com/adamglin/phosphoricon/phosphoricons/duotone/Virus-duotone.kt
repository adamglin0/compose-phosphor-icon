...
public val DuotoneGroup.`Virus-duotone`: ImageVector
    get() {
        if (`_virus-duotone` != null) {
            return `_virus-duotone`!!
        }
        `_virus-duotone` = Builder(name = "Virus-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_virus-duotone`: ImageVector? = null
