...
public val BoldGroup.`Lockers-bold`: ImageVector
    get() {
        if (`_lockers-bold` != null) {
            return `_lockers-bold`!!
        }
        `_lockers-bold` = Builder(name = "Lockers-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lockers-bold`: ImageVector? = null
