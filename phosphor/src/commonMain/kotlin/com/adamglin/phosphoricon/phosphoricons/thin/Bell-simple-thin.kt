...
public val ThinGroup.`Bell-simple-thin`: ImageVector
    get() {
        if (`_bell-simple-thin` != null) {
            return `_bell-simple-thin`!!
        }
        `_bell-simple-thin` = Builder(name = "Bell-simple-thin", defaultWidth = 256.0.dp,
...
private var `_bell-simple-thin`: ImageVector? = null
