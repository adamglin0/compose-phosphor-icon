...
public val DuotoneGroup.`Rainbow-duotone`: ImageVector
    get() {
        if (`_rainbow-duotone` != null) {
            return `_rainbow-duotone`!!
        }
        `_rainbow-duotone` = Builder(name = "Rainbow-duotone", defaultWidth = 256.0.dp,
...
private var `_rainbow-duotone`: ImageVector? = null
