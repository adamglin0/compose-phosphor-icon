...
public val BoldGroup.`Upload-bold`: ImageVector
    get() {
        if (`_upload-bold` != null) {
            return `_upload-bold`!!
        }
        `_upload-bold` = Builder(name = "Upload-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_upload-bold`: ImageVector? = null
