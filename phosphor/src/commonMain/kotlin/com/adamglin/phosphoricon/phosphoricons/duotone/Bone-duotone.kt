...
public val DuotoneGroup.`Bone-duotone`: ImageVector
    get() {
        if (`_bone-duotone` != null) {
            return `_bone-duotone`!!
        }
        `_bone-duotone` = Builder(name = "Bone-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bone-duotone`: ImageVector? = null
