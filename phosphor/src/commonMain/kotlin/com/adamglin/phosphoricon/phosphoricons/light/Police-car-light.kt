...
public val LightGroup.`Police-car-light`: ImageVector
    get() {
        if (`_police-car-light` != null) {
            return `_police-car-light`!!
        }
        `_police-car-light` = Builder(name = "Police-car-light", defaultWidth = 256.0.dp,
...
private var `_police-car-light`: ImageVector? = null
