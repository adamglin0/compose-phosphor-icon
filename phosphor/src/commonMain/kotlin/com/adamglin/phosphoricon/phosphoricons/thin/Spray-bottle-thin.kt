...
public val ThinGroup.`Spray-bottle-thin`: ImageVector
    get() {
        if (`_spray-bottle-thin` != null) {
            return `_spray-bottle-thin`!!
        }
        `_spray-bottle-thin` = Builder(name = "Spray-bottle-thin", defaultWidth = 256.0.dp,
...
private var `_spray-bottle-thin`: ImageVector? = null
