...
public val BoldGroup.`Number-circle-five-bold`: ImageVector
    get() {
        if (`_number-circle-five-bold` != null) {
            return `_number-circle-five-bold`!!
        }
        `_number-circle-five-bold` = Builder(name = "Number-circle-five-bold", defaultWidth =
...
private var `_number-circle-five-bold`: ImageVector? = null
