...
public val FillGroup.`Gps-fix-fill`: ImageVector
    get() {
        if (`_gps-fix-fill` != null) {
            return `_gps-fix-fill`!!
        }
        `_gps-fix-fill` = Builder(name = "Gps-fix-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gps-fix-fill`: ImageVector? = null
