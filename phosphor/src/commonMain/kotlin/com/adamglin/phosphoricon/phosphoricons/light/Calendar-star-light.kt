...
public val LightGroup.`Calendar-star-light`: ImageVector
    get() {
        if (`_calendar-star-light` != null) {
            return `_calendar-star-light`!!
        }
        `_calendar-star-light` = Builder(name = "Calendar-star-light", defaultWidth = 256.0.dp,
...
private var `_calendar-star-light`: ImageVector? = null
