...
public val DuotoneGroup.`Seal-check-duotone`: ImageVector
    get() {
        if (`_seal-check-duotone` != null) {
            return `_seal-check-duotone`!!
        }
        `_seal-check-duotone` = Builder(name = "Seal-check-duotone", defaultWidth = 256.0.dp,
...
private var `_seal-check-duotone`: ImageVector? = null
