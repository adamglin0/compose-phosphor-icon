...
public val LightGroup.`Clock-countdown-light`: ImageVector
    get() {
        if (`_clock-countdown-light` != null) {
            return `_clock-countdown-light`!!
        }
        `_clock-countdown-light` = Builder(name = "Clock-countdown-light", defaultWidth = 256.0.dp,
...
private var `_clock-countdown-light`: ImageVector? = null
