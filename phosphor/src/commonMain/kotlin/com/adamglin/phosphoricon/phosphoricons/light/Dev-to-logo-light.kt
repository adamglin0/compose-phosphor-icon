...
public val LightGroup.`Dev-to-logo-light`: ImageVector
    get() {
        if (`_dev-to-logo-light` != null) {
            return `_dev-to-logo-light`!!
        }
        `_dev-to-logo-light` = Builder(name = "Dev-to-logo-light", defaultWidth = 256.0.dp,
...
private var `_dev-to-logo-light`: ImageVector? = null
