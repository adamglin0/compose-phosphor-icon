...
public val LightGroup.`Barn-light`: ImageVector
    get() {
        if (`_barn-light` != null) {
            return `_barn-light`!!
        }
        `_barn-light` = Builder(name = "Barn-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barn-light`: ImageVector? = null
