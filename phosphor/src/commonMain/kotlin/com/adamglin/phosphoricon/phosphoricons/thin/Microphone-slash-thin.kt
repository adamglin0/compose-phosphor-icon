...
public val ThinGroup.`Microphone-slash-thin`: ImageVector
    get() {
        if (`_microphone-slash-thin` != null) {
            return `_microphone-slash-thin`!!
        }
        `_microphone-slash-thin` = Builder(name = "Microphone-slash-thin", defaultWidth = 256.0.dp,
...
private var `_microphone-slash-thin`: ImageVector? = null
