...
public val BoldGroup.`Network-x-bold`: ImageVector
    get() {
        if (`_network-x-bold` != null) {
            return `_network-x-bold`!!
        }
        `_network-x-bold` = Builder(name = "Network-x-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_network-x-bold`: ImageVector? = null
