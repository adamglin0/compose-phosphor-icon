...
public val RegularGroup.`Dots-nine`: ImageVector
    get() {
        if (`_dots-nine` != null) {
            return `_dots-nine`!!
        }
        `_dots-nine` = Builder(name = "Dots-nine", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dots-nine`: ImageVector? = null
