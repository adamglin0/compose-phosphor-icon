...
public val LightGroup.`Airplane-in-flight-light`: ImageVector
    get() {
        if (`_airplane-in-flight-light` != null) {
            return `_airplane-in-flight-light`!!
        }
        `_airplane-in-flight-light` = Builder(name = "Airplane-in-flight-light", defaultWidth =
...
private var `_airplane-in-flight-light`: ImageVector? = null
