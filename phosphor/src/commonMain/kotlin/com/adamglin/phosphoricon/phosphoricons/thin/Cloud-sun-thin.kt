...
public val ThinGroup.`Cloud-sun-thin`: ImageVector
    get() {
        if (`_cloud-sun-thin` != null) {
            return `_cloud-sun-thin`!!
        }
        `_cloud-sun-thin` = Builder(name = "Cloud-sun-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cloud-sun-thin`: ImageVector? = null
