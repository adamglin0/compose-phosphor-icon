...
public val BoldGroup.`Number-zero-bold`: ImageVector
    get() {
        if (`_number-zero-bold` != null) {
            return `_number-zero-bold`!!
        }
        `_number-zero-bold` = Builder(name = "Number-zero-bold", defaultWidth = 256.0.dp,
...
private var `_number-zero-bold`: ImageVector? = null
