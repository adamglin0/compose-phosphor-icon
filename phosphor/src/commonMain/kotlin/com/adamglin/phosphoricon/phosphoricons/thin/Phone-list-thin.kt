...
public val ThinGroup.`Phone-list-thin`: ImageVector
    get() {
        if (`_phone-list-thin` != null) {
            return `_phone-list-thin`!!
        }
        `_phone-list-thin` = Builder(name = "Phone-list-thin", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 212.0f, 181.57f)
                close()
                moveTo(140.0f, 64.0f)
                ...
                lineTo(144.0f, 68.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 140.0f, 64.0f)
                close()
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 140.0f, 104.0f)
                close()
            }
        }
        .build()
...
private var `_phone-list-thin`: ImageVector? = null
