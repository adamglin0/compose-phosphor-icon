...
public val FillGroup.`Pepper-fill`: ImageVector
    get() {
        if (`_pepper-fill` != null) {
            return `_pepper-fill`!!
        }
        `_pepper-fill` = Builder(name = "Pepper-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pepper-fill`: ImageVector? = null
