...
public val RegularGroup.`Solar-roof`: ImageVector
    get() {
        if (`_solar-roof` != null) {
            return `_solar-roof`!!
        }
        `_solar-roof` = Builder(name = "Solar-roof", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_solar-roof`: ImageVector? = null
