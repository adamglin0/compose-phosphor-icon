...
public val BoldGroup.`Spinner-bold`: ImageVector
    get() {
        if (`_spinner-bold` != null) {
            return `_spinner-bold`!!
        }
        `_spinner-bold` = Builder(name = "Spinner-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spinner-bold`: ImageVector? = null
