...
public val BoldGroup.`Football-bold`: ImageVector
    get() {
        if (`_football-bold` != null) {
            return `_football-bold`!!
        }
        `_football-bold` = Builder(name = "Football-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_football-bold`: ImageVector? = null
