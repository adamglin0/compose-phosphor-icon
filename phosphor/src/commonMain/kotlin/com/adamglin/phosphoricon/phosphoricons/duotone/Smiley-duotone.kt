...
public val DuotoneGroup.`Smiley-duotone`: ImageVector
    get() {
        if (`_smiley-duotone` != null) {
            return `_smiley-duotone`!!
        }
        `_smiley-duotone` = Builder(name = "Smiley-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_smiley-duotone`: ImageVector? = null
