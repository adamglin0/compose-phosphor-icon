...
public val RegularGroup.`File-audio`: ImageVector
    get() {
        if (`_file-audio` != null) {
            return `_file-audio`!!
        }
        `_file-audio` = Builder(name = "File-audio", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-audio`: ImageVector? = null
