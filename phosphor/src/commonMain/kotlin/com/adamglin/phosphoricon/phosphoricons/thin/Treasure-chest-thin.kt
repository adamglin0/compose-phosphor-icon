...
public val ThinGroup.`Treasure-chest-thin`: ImageVector
    get() {
        if (`_treasure-chest-thin` != null) {
            return `_treasure-chest-thin`!!
        }
        `_treasure-chest-thin` = Builder(name = "Treasure-chest-thin", defaultWidth = 256.0.dp,
...
private var `_treasure-chest-thin`: ImageVector? = null
