...
public val ThinGroup.`Siren-thin`: ImageVector
    get() {
        if (`_siren-thin` != null) {
            return `_siren-thin`!!
        }
        `_siren-thin` = Builder(name = "Siren-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_siren-thin`: ImageVector? = null
