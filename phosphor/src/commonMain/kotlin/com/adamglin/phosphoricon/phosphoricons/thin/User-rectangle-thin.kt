...
public val ThinGroup.`User-rectangle-thin`: ImageVector
    get() {
        if (`_user-rectangle-thin` != null) {
            return `_user-rectangle-thin`!!
        }
        `_user-rectangle-thin` = Builder(name = "User-rectangle-thin", defaultWidth = 256.0.dp,
...
private var `_user-rectangle-thin`: ImageVector? = null
