...
public val LightGroup.`Cursor-click-light`: ImageVector
    get() {
        if (`_cursor-click-light` != null) {
            return `_cursor-click-light`!!
        }
        `_cursor-click-light` = Builder(name = "Cursor-click-light", defaultWidth = 256.0.dp,
...
private var `_cursor-click-light`: ImageVector? = null
