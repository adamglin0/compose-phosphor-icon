...
public val DuotoneGroup.`Paint-roller-duotone`: ImageVector
    get() {
        if (`_paint-roller-duotone` != null) {
            return `_paint-roller-duotone`!!
        }
        `_paint-roller-duotone` = Builder(name = "Paint-roller-duotone", defaultWidth = 256.0.dp,
...
private var `_paint-roller-duotone`: ImageVector? = null
