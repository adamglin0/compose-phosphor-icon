...
public val BoldGroup.`Island-bold`: ImageVector
    get() {
        if (`_island-bold` != null) {
            return `_island-bold`!!
        }
        `_island-bold` = Builder(name = "Island-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_island-bold`: ImageVector? = null
