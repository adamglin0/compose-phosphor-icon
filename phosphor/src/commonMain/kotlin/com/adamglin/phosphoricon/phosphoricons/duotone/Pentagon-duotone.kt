...
public val DuotoneGroup.`Pentagon-duotone`: ImageVector
    get() {
        if (`_pentagon-duotone` != null) {
            return `_pentagon-duotone`!!
        }
        `_pentagon-duotone` = Builder(name = "Pentagon-duotone", defaultWidth = 256.0.dp,
...
private var `_pentagon-duotone`: ImageVector? = null
