...
public val RegularGroup.`Chart-polar`: ImageVector
    get() {
        if (`_chart-polar` != null) {
            return `_chart-polar`!!
        }
        `_chart-polar` = Builder(name = "Chart-polar", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chart-polar`: ImageVector? = null
