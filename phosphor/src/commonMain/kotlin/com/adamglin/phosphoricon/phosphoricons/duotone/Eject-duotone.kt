...
public val DuotoneGroup.`Eject-duotone`: ImageVector
    get() {
        if (`_eject-duotone` != null) {
            return `_eject-duotone`!!
        }
        `_eject-duotone` = Builder(name = "Eject-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eject-duotone`: ImageVector? = null
