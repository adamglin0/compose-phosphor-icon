...
public val DuotoneGroup.`Selection-inverse-duotone`: ImageVector
    get() {
        if (`_selection-inverse-duotone` != null) {
            return `_selection-inverse-duotone`!!
        }
        `_selection-inverse-duotone` = Builder(name = "Selection-inverse-duotone", defaultWidth =
...
private var `_selection-inverse-duotone`: ImageVector? = null
