...
public val LightGroup.`Lockers-light`: ImageVector
    get() {
        if (`_lockers-light` != null) {
            return `_lockers-light`!!
        }
        `_lockers-light` = Builder(name = "Lockers-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lockers-light`: ImageVector? = null
