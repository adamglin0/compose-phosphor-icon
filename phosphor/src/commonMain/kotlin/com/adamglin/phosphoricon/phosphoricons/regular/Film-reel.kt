...
public val RegularGroup.`Film-reel`: ImageVector
    get() {
        if (`_film-reel` != null) {
            return `_film-reel`!!
        }
        `_film-reel` = Builder(name = "Film-reel", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_film-reel`: ImageVector? = null
