...
public val BoldGroup.`Cookie-bold`: ImageVector
    get() {
        if (`_cookie-bold` != null) {
            return `_cookie-bold`!!
        }
        `_cookie-bold` = Builder(name = "Cookie-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cookie-bold`: ImageVector? = null
