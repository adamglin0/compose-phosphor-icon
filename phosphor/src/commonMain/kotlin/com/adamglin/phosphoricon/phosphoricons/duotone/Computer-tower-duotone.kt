...
public val DuotoneGroup.`Computer-tower-duotone`: ImageVector
    get() {
        if (`_computer-tower-duotone` != null) {
            return `_computer-tower-duotone`!!
        }
        `_computer-tower-duotone` = Builder(name = "Computer-tower-duotone", defaultWidth =
...
private var `_computer-tower-duotone`: ImageVector? = null
