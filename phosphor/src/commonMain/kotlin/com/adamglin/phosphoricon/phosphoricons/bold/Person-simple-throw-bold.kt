...
public val BoldGroup.`Person-simple-throw-bold`: ImageVector
    get() {
        if (`_person-simple-throw-bold` != null) {
            return `_person-simple-throw-bold`!!
        }
        `_person-simple-throw-bold` = Builder(name = "Person-simple-throw-bold", defaultWidth =
...
private var `_person-simple-throw-bold`: ImageVector? = null
