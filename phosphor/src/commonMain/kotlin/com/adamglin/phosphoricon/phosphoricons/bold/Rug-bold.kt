...
public val BoldGroup.`Rug-bold`: ImageVector
    get() {
        if (`_rug-bold` != null) {
            return `_rug-bold`!!
        }
        `_rug-bold` = Builder(name = "Rug-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_rug-bold`: ImageVector? = null
