...
public val DuotoneGroup.`Skip-forward-duotone`: ImageVector
    get() {
        if (`_skip-forward-duotone` != null) {
            return `_skip-forward-duotone`!!
        }
        `_skip-forward-duotone` = Builder(name = "Skip-forward-duotone", defaultWidth = 256.0.dp,
...
private var `_skip-forward-duotone`: ImageVector? = null
