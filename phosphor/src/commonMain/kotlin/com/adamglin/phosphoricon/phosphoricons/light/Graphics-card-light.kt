...
public val LightGroup.`Graphics-card-light`: ImageVector
    get() {
        if (`_graphics-card-light` != null) {
            return `_graphics-card-light`!!
        }
        `_graphics-card-light` = Builder(name = "Graphics-card-light", defaultWidth = 256.0.dp,
...
private var `_graphics-card-light`: ImageVector? = null
