...
public val LightGroup.`Pause-light`: ImageVector
    get() {
        if (`_pause-light` != null) {
            return `_pause-light`!!
        }
        `_pause-light` = Builder(name = "Pause-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pause-light`: ImageVector? = null
