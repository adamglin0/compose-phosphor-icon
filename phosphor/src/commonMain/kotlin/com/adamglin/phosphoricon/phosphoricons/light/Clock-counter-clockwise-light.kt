...
public val LightGroup.`Clock-counter-clockwise-light`: ImageVector
    get() {
        if (`_clock-counter-clockwise-light` != null) {
            return `_clock-counter-clockwise-light`!!
        }
        `_clock-counter-clockwise-light` = Builder(name = "Clock-counter-clockwise-light",
...
private var `_clock-counter-clockwise-light`: ImageVector? = null
