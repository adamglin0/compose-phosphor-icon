...
public val LightGroup.`App-store-logo-light`: ImageVector
    get() {
        if (`_app-store-logo-light` != null) {
            return `_app-store-logo-light`!!
        }
        `_app-store-logo-light` = Builder(name = "App-store-logo-light", defaultWidth = 256.0.dp,
...
private var `_app-store-logo-light`: ImageVector? = null
