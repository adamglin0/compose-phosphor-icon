...
public val FillGroup.`Pipe-fill`: ImageVector
    get() {
        if (`_pipe-fill` != null) {
            return `_pipe-fill`!!
        }
        `_pipe-fill` = Builder(name = "Pipe-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pipe-fill`: ImageVector? = null
