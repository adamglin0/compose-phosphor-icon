...
public val BoldGroup.`Steering-wheel-bold`: ImageVector
    get() {
        if (`_steering-wheel-bold` != null) {
            return `_steering-wheel-bold`!!
        }
        `_steering-wheel-bold` = Builder(name = "Steering-wheel-bold", defaultWidth = 256.0.dp,
...
private var `_steering-wheel-bold`: ImageVector? = null
