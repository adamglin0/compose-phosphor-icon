...
public val DuotoneGroup.`Not-equals-duotone`: ImageVector
    get() {
        if (`_not-equals-duotone` != null) {
            return `_not-equals-duotone`!!
        }
        `_not-equals-duotone` = Builder(name = "Not-equals-duotone", defaultWidth = 256.0.dp,
...
private var `_not-equals-duotone`: ImageVector? = null
