...
public val DuotoneGroup.`Hand-deposit-duotone`: ImageVector
    get() {
        if (`_hand-deposit-duotone` != null) {
            return `_hand-deposit-duotone`!!
        }
        `_hand-deposit-duotone` = Builder(name = "Hand-deposit-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-deposit-duotone`: ImageVector? = null
