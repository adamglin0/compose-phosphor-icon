...
public val BoldGroup.`List-checks-bold`: ImageVector
    get() {
        if (`_list-checks-bold` != null) {
            return `_list-checks-bold`!!
        }
        `_list-checks-bold` = Builder(name = "List-checks-bold", defaultWidth = 256.0.dp,
...
private var `_list-checks-bold`: ImageVector? = null
