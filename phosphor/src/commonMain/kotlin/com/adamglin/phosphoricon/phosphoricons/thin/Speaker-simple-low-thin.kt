...
public val ThinGroup.`Speaker-simple-low-thin`: ImageVector
    get() {
        if (`_speaker-simple-low-thin` != null) {
            return `_speaker-simple-low-thin`!!
        }
        `_speaker-simple-low-thin` = Builder(name = "Speaker-simple-low-thin", defaultWidth =
...
private var `_speaker-simple-low-thin`: ImageVector? = null
