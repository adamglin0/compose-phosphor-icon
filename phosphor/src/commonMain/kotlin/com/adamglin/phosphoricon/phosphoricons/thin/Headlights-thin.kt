...
public val ThinGroup.`Headlights-thin`: ImageVector
    get() {
        if (`_headlights-thin` != null) {
            return `_headlights-thin`!!
        }
        `_headlights-thin` = Builder(name = "Headlights-thin", defaultWidth = 256.0.dp,
...
private var `_headlights-thin`: ImageVector? = null
