...
public val ThinGroup.`Drop-half-bottom-thin`: ImageVector
    get() {
        if (`_drop-half-bottom-thin` != null) {
            return `_drop-half-bottom-thin`!!
        }
        `_drop-half-bottom-thin` = Builder(name = "Drop-half-bottom-thin", defaultWidth = 256.0.dp,
...
private var `_drop-half-bottom-thin`: ImageVector? = null
