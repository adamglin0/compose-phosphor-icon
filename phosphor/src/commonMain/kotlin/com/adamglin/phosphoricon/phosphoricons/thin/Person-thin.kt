...
public val ThinGroup.`Person-thin`: ImageVector
    get() {
        if (`_person-thin` != null) {
            return `_person-thin`!!
        }
        `_person-thin` = Builder(name = "Person-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_person-thin`: ImageVector? = null
