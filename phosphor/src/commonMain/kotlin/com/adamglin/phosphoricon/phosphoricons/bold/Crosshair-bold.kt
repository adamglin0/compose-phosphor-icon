...
public val BoldGroup.`Crosshair-bold`: ImageVector
    get() {
        if (`_crosshair-bold` != null) {
            return `_crosshair-bold`!!
        }
        `_crosshair-bold` = Builder(name = "Crosshair-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_crosshair-bold`: ImageVector? = null
