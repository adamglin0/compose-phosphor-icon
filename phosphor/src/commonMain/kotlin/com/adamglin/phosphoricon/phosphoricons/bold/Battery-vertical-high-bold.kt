...
public val BoldGroup.`Battery-vertical-high-bold`: ImageVector
    get() {
        if (`_battery-vertical-high-bold` != null) {
            return `_battery-vertical-high-bold`!!
        }
        `_battery-vertical-high-bold` = Builder(name = "Battery-vertical-high-bold", defaultWidth =
...
private var `_battery-vertical-high-bold`: ImageVector? = null
