...
public val LightGroup.`Pentagon-light`: ImageVector
    get() {
        if (`_pentagon-light` != null) {
            return `_pentagon-light`!!
        }
        `_pentagon-light` = Builder(name = "Pentagon-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_pentagon-light`: ImageVector? = null
