...
public val ThinGroup.`File-plus-thin`: ImageVector
    get() {
        if (`_file-plus-thin` != null) {
            return `_file-plus-thin`!!
        }
        `_file-plus-thin` = Builder(name = "File-plus-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-plus-thin`: ImageVector? = null
