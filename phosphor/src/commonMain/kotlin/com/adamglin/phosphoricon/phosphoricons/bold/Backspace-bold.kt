...
public val BoldGroup.`Backspace-bold`: ImageVector
    get() {
        if (`_backspace-bold` != null) {
            return `_backspace-bold`!!
        }
        `_backspace-bold` = Builder(name = "Backspace-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_backspace-bold`: ImageVector? = null
