...
public val LightGroup.`Phone-light`: ImageVector
    get() {
        if (`_phone-light` != null) {
            return `_phone-light`!!
        }
        `_phone-light` = Builder(name = "Phone-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-light`: ImageVector? = null
