...
public val BoldGroup.`User-sound-bold`: ImageVector
    get() {
        if (`_user-sound-bold` != null) {
            return `_user-sound-bold`!!
        }
        `_user-sound-bold` = Builder(name = "User-sound-bold", defaultWidth = 256.0.dp,
...
private var `_user-sound-bold`: ImageVector? = null
