...
public val ThinGroup.`Gif-thin`: ImageVector
    get() {
        if (`_gif-thin` != null) {
            return `_gif-thin`!!
        }
        `_gif-thin` = Builder(name = "Gif-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_gif-thin`: ImageVector? = null
