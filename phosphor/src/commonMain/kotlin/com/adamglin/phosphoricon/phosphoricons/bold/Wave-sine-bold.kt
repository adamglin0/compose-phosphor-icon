...
public val BoldGroup.`Wave-sine-bold`: ImageVector
    get() {
        if (`_wave-sine-bold` != null) {
            return `_wave-sine-bold`!!
        }
        `_wave-sine-bold` = Builder(name = "Wave-sine-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_wave-sine-bold`: ImageVector? = null
