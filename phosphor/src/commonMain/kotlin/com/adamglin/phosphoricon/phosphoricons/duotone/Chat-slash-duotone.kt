...
public val DuotoneGroup.`Chat-slash-duotone`: ImageVector
    get() {
        if (`_chat-slash-duotone` != null) {
            return `_chat-slash-duotone`!!
        }
        `_chat-slash-duotone` = Builder(name = "Chat-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_chat-slash-duotone`: ImageVector? = null
