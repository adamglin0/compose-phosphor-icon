...
public val ThinGroup.`Funnel-thin`: ImageVector
    get() {
        if (`_funnel-thin` != null) {
            return `_funnel-thin`!!
        }
        `_funnel-thin` = Builder(name = "Funnel-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_funnel-thin`: ImageVector? = null
