...
public val LightGroup.`Calendar-slash-light`: ImageVector
    get() {
        if (`_calendar-slash-light` != null) {
            return `_calendar-slash-light`!!
        }
        `_calendar-slash-light` = Builder(name = "Calendar-slash-light", defaultWidth = 256.0.dp,
...
private var `_calendar-slash-light`: ImageVector? = null
