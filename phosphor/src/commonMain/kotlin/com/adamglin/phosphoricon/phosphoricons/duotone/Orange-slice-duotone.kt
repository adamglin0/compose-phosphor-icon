...
public val DuotoneGroup.`Orange-slice-duotone`: ImageVector
    get() {
        if (`_orange-slice-duotone` != null) {
            return `_orange-slice-duotone`!!
        }
        `_orange-slice-duotone` = Builder(name = "Orange-slice-duotone", defaultWidth = 256.0.dp,
...
private var `_orange-slice-duotone`: ImageVector? = null
