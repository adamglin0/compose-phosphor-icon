...
public val FillGroup.`Screencast-fill`: ImageVector
    get() {
        if (`_screencast-fill` != null) {
            return `_screencast-fill`!!
        }
        `_screencast-fill` = Builder(name = "Screencast-fill", defaultWidth = 256.0.dp,
...
private var `_screencast-fill`: ImageVector? = null
