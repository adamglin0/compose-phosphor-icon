...
public val DuotoneGroup.`Pizza-duotone`: ImageVector
    get() {
        if (`_pizza-duotone` != null) {
            return `_pizza-duotone`!!
        }
        `_pizza-duotone` = Builder(name = "Pizza-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pizza-duotone`: ImageVector? = null
