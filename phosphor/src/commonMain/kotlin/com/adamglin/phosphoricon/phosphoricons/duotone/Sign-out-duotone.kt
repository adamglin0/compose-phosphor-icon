...
public val DuotoneGroup.`Sign-out-duotone`: ImageVector
    get() {
        if (`_sign-out-duotone` != null) {
            return `_sign-out-duotone`!!
        }
        `_sign-out-duotone` = Builder(name = "Sign-out-duotone", defaultWidth = 256.0.dp,
...
private var `_sign-out-duotone`: ImageVector? = null
