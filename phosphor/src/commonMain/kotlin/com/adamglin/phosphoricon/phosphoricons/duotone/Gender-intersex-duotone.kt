...
public val DuotoneGroup.`Gender-intersex-duotone`: ImageVector
    get() {
        if (`_gender-intersex-duotone` != null) {
            return `_gender-intersex-duotone`!!
        }
        `_gender-intersex-duotone` = Builder(name = "Gender-intersex-duotone", defaultWidth =
...
private var `_gender-intersex-duotone`: ImageVector? = null
