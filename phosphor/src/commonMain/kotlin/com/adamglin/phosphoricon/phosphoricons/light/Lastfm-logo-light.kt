...
public val LightGroup.`Lastfm-logo-light`: ImageVector
    get() {
        if (`_lastfm-logo-light` != null) {
            return `_lastfm-logo-light`!!
        }
        `_lastfm-logo-light` = Builder(name = "Lastfm-logo-light", defaultWidth = 256.0.dp,
...
private var `_lastfm-logo-light`: ImageVector? = null
