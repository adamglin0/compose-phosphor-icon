...
public val DuotoneGroup.`Upload-simple-duotone`: ImageVector
    get() {
        if (`_upload-simple-duotone` != null) {
            return `_upload-simple-duotone`!!
        }
        `_upload-simple-duotone` = Builder(name = "Upload-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_upload-simple-duotone`: ImageVector? = null
