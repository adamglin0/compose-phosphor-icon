...
public val ThinGroup.`Math-operations-thin`: ImageVector
    get() {
        if (`_math-operations-thin` != null) {
            return `_math-operations-thin`!!
        }
        `_math-operations-thin` = Builder(name = "Math-operations-thin", defaultWidth = 256.0.dp,
...
private var `_math-operations-thin`: ImageVector? = null
