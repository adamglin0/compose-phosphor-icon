...
public val LightGroup.`Swap-light`: ImageVector
    get() {
        if (`_swap-light` != null) {
            return `_swap-light`!!
        }
        `_swap-light` = Builder(name = "Swap-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_swap-light`: ImageVector? = null
