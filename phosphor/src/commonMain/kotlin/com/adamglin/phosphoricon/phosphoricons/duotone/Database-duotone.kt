...
public val DuotoneGroup.`Database-duotone`: ImageVector
    get() {
        if (`_database-duotone` != null) {
            return `_database-duotone`!!
        }
        `_database-duotone` = Builder(name = "Database-duotone", defaultWidth = 256.0.dp,
...
private var `_database-duotone`: ImageVector? = null
