...
public val DuotoneGroup.`Tent-duotone`: ImageVector
    get() {
        if (`_tent-duotone` != null) {
            return `_tent-duotone`!!
        }
        `_tent-duotone` = Builder(name = "Tent-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tent-duotone`: ImageVector? = null
