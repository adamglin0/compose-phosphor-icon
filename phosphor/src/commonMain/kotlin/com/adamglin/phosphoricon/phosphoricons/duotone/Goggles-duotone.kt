...
public val DuotoneGroup.`Goggles-duotone`: ImageVector
    get() {
        if (`_goggles-duotone` != null) {
            return `_goggles-duotone`!!
        }
        `_goggles-duotone` = Builder(name = "Goggles-duotone", defaultWidth = 256.0.dp,
...
private var `_goggles-duotone`: ImageVector? = null
