...
public val BoldGroup.`Soccer-ball-bold`: ImageVector
    get() {
        if (`_soccer-ball-bold` != null) {
            return `_soccer-ball-bold`!!
        }
        `_soccer-ball-bold` = Builder(name = "Soccer-ball-bold", defaultWidth = 256.0.dp,
...
private var `_soccer-ball-bold`: ImageVector? = null
