...
public val ThinGroup.`Image-square-thin`: ImageVector
    get() {
        if (`_image-square-thin` != null) {
            return `_image-square-thin`!!
        }
        `_image-square-thin` = Builder(name = "Image-square-thin", defaultWidth = 256.0.dp,
...
private var `_image-square-thin`: ImageVector? = null
