...
public val DuotoneGroup.`Meteor-duotone`: ImageVector
    get() {
        if (`_meteor-duotone` != null) {
            return `_meteor-duotone`!!
        }
        `_meteor-duotone` = Builder(name = "Meteor-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_meteor-duotone`: ImageVector? = null
