...
public val DuotoneGroup.`File-rs-duotone`: ImageVector
    get() {
        if (`_file-rs-duotone` != null) {
            return `_file-rs-duotone`!!
        }
        `_file-rs-duotone` = Builder(name = "File-rs-duotone", defaultWidth = 256.0.dp,
...
private var `_file-rs-duotone`: ImageVector? = null
