...
public val LightGroup.`Currency-ngn-light`: ImageVector
    get() {
        if (`_currency-ngn-light` != null) {
            return `_currency-ngn-light`!!
        }
        `_currency-ngn-light` = Builder(name = "Currency-ngn-light", defaultWidth = 256.0.dp,
...
private var `_currency-ngn-light`: ImageVector? = null
