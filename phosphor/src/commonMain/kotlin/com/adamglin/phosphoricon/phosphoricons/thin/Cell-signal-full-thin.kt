...
public val ThinGroup.`Cell-signal-full-thin`: ImageVector
    get() {
        if (`_cell-signal-full-thin` != null) {
            return `_cell-signal-full-thin`!!
        }
        `_cell-signal-full-thin` = Builder(name = "Cell-signal-full-thin", defaultWidth = 256.0.dp,
...
private var `_cell-signal-full-thin`: ImageVector? = null
