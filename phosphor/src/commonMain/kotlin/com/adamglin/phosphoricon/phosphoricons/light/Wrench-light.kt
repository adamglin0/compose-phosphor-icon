...
public val LightGroup.`Wrench-light`: ImageVector
    get() {
        if (`_wrench-light` != null) {
            return `_wrench-light`!!
        }
        `_wrench-light` = Builder(name = "Wrench-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wrench-light`: ImageVector? = null
