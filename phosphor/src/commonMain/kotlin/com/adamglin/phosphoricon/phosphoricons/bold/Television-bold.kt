...
public val BoldGroup.`Television-bold`: ImageVector
    get() {
        if (`_television-bold` != null) {
            return `_television-bold`!!
        }
        `_television-bold` = Builder(name = "Television-bold", defaultWidth = 256.0.dp,
...
private var `_television-bold`: ImageVector? = null
