...
public val BoldGroup.`Crosshair-simple-bold`: ImageVector
    get() {
        if (`_crosshair-simple-bold` != null) {
            return `_crosshair-simple-bold`!!
        }
        `_crosshair-simple-bold` = Builder(name = "Crosshair-simple-bold", defaultWidth = 256.0.dp,
...
private var `_crosshair-simple-bold`: ImageVector? = null
