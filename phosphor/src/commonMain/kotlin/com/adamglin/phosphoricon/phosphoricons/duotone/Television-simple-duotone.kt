...
public val DuotoneGroup.`Television-simple-duotone`: ImageVector
    get() {
        if (`_television-simple-duotone` != null) {
            return `_television-simple-duotone`!!
        }
        `_television-simple-duotone` = Builder(name = "Television-simple-duotone", defaultWidth =
...
private var `_television-simple-duotone`: ImageVector? = null
