...
public val BoldGroup.`Cursor-bold`: ImageVector
    get() {
        if (`_cursor-bold` != null) {
            return `_cursor-bold`!!
        }
        `_cursor-bold` = Builder(name = "Cursor-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cursor-bold`: ImageVector? = null
