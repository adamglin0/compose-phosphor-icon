...
public val BoldGroup.`Device-tablet-bold`: ImageVector
    get() {
        if (`_device-tablet-bold` != null) {
            return `_device-tablet-bold`!!
        }
        `_device-tablet-bold` = Builder(name = "Device-tablet-bold", defaultWidth = 256.0.dp,
...
private var `_device-tablet-bold`: ImageVector? = null
