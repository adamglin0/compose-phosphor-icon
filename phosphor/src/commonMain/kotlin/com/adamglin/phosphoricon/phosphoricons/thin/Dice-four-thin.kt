...
public val ThinGroup.`Dice-four-thin`: ImageVector
    get() {
        if (`_dice-four-thin` != null) {
            return `_dice-four-thin`!!
        }
        `_dice-four-thin` = Builder(name = "Dice-four-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dice-four-thin`: ImageVector? = null
