...
public val DuotoneGroup.`Car-simple-duotone`: ImageVector
    get() {
        if (`_car-simple-duotone` != null) {
            return `_car-simple-duotone`!!
        }
        `_car-simple-duotone` = Builder(name = "Car-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_car-simple-duotone`: ImageVector? = null
