...
public val DuotoneGroup.`Camera-duotone`: ImageVector
    get() {
        if (`_camera-duotone` != null) {
            return `_camera-duotone`!!
        }
        `_camera-duotone` = Builder(name = "Camera-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_camera-duotone`: ImageVector? = null
