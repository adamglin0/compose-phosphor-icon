...
public val FillGroup.`Mouse-scroll-fill`: ImageVector
    get() {
        if (`_mouse-scroll-fill` != null) {
            return `_mouse-scroll-fill`!!
        }
        `_mouse-scroll-fill` = Builder(name = "Mouse-scroll-fill", defaultWidth = 256.0.dp,
...
private var `_mouse-scroll-fill`: ImageVector? = null
