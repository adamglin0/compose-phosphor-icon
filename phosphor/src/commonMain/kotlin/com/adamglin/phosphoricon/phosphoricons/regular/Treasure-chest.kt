...
public val RegularGroup.`Treasure-chest`: ImageVector
    get() {
        if (`_treasure-chest` != null) {
            return `_treasure-chest`!!
        }
        `_treasure-chest` = Builder(name = "Treasure-chest", defaultWidth = 256.0.dp, defaultHeight
...
private var `_treasure-chest`: ImageVector? = null
