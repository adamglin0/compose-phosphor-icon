...
public val ThinGroup.`Coffee-thin`: ImageVector
    get() {
        if (`_coffee-thin` != null) {
            return `_coffee-thin`!!
        }
        `_coffee-thin` = Builder(name = "Coffee-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coffee-thin`: ImageVector? = null
