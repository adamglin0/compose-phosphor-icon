...
public val LightGroup.`File-vue-light`: ImageVector
    get() {
        if (`_file-vue-light` != null) {
            return `_file-vue-light`!!
        }
        `_file-vue-light` = Builder(name = "File-vue-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-vue-light`: ImageVector? = null
