...
public val FillGroup.`Grains-slash-fill`: ImageVector
    get() {
        if (`_grains-slash-fill` != null) {
            return `_grains-slash-fill`!!
        }
        `_grains-slash-fill` = Builder(name = "Grains-slash-fill", defaultWidth = 256.0.dp,
...
private var `_grains-slash-fill`: ImageVector? = null
