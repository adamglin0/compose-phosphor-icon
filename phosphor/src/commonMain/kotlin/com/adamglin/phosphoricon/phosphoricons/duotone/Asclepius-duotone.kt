...
public val DuotoneGroup.`Asclepius-duotone`: ImageVector
    get() {
        if (`_asclepius-duotone` != null) {
            return `_asclepius-duotone`!!
        }
        `_asclepius-duotone` = Builder(name = "Asclepius-duotone", defaultWidth = 256.0.dp,
...
private var `_asclepius-duotone`: ImageVector? = null
