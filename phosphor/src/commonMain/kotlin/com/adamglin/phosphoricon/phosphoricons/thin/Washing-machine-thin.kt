...
public val ThinGroup.`Washing-machine-thin`: ImageVector
    get() {
        if (`_washing-machine-thin` != null) {
            return `_washing-machine-thin`!!
        }
        `_washing-machine-thin` = Builder(name = "Washing-machine-thin", defaultWidth = 256.0.dp,
...
private var `_washing-machine-thin`: ImageVector? = null
