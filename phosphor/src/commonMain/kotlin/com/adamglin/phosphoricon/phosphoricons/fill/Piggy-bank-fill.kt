...
public val FillGroup.`Piggy-bank-fill`: ImageVector
    get() {
        if (`_piggy-bank-fill` != null) {
            return `_piggy-bank-fill`!!
        }
        `_piggy-bank-fill` = Builder(name = "Piggy-bank-fill", defaultWidth = 256.0.dp,
...
private var `_piggy-bank-fill`: ImageVector? = null
