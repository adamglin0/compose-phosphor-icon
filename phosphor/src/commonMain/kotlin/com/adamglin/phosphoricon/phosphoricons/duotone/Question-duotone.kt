...
public val DuotoneGroup.`Question-duotone`: ImageVector
    get() {
        if (`_question-duotone` != null) {
            return `_question-duotone`!!
        }
        `_question-duotone` = Builder(name = "Question-duotone", defaultWidth = 256.0.dp,
...
private var `_question-duotone`: ImageVector? = null
