...
public val FillGroup.`Couch-fill`: ImageVector
    get() {
        if (`_couch-fill` != null) {
            return `_couch-fill`!!
        }
        `_couch-fill` = Builder(name = "Couch-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_couch-fill`: ImageVector? = null
