...
public val DuotoneGroup.`Sunglasses-duotone`: ImageVector
    get() {
        if (`_sunglasses-duotone` != null) {
            return `_sunglasses-duotone`!!
        }
        `_sunglasses-duotone` = Builder(name = "Sunglasses-duotone", defaultWidth = 256.0.dp,
...
private var `_sunglasses-duotone`: ImageVector? = null
