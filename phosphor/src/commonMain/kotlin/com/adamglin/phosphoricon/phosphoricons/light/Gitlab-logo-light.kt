...
public val LightGroup.`Gitlab-logo-light`: ImageVector
    get() {
        if (`_gitlab-logo-light` != null) {
            return `_gitlab-logo-light`!!
        }
        `_gitlab-logo-light` = Builder(name = "Gitlab-logo-light", defaultWidth = 256.0.dp,
...
private var `_gitlab-logo-light`: ImageVector? = null
