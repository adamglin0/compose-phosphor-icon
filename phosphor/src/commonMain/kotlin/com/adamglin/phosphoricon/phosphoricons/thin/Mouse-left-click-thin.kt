...
public val ThinGroup.`Mouse-left-click-thin`: ImageVector
    get() {
        if (`_mouse-left-click-thin` != null) {
            return `_mouse-left-click-thin`!!
        }
        `_mouse-left-click-thin` = Builder(name = "Mouse-left-click-thin", defaultWidth = 256.0.dp,
...
private var `_mouse-left-click-thin`: ImageVector? = null
