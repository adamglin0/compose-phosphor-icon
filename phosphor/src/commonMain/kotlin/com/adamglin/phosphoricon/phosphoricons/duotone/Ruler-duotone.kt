...
public val DuotoneGroup.`Ruler-duotone`: ImageVector
    get() {
        if (`_ruler-duotone` != null) {
            return `_ruler-duotone`!!
        }
        `_ruler-duotone` = Builder(name = "Ruler-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ruler-duotone`: ImageVector? = null
