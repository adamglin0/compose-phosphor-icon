...
public val DuotoneGroup.`House-simple-duotone`: ImageVector
    get() {
        if (`_house-simple-duotone` != null) {
            return `_house-simple-duotone`!!
        }
        `_house-simple-duotone` = Builder(name = "House-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_house-simple-duotone`: ImageVector? = null
