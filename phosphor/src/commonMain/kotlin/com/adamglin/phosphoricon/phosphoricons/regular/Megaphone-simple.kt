...
public val RegularGroup.`Megaphone-simple`: ImageVector
    get() {
        if (`_megaphone-simple` != null) {
            return `_megaphone-simple`!!
        }
        `_megaphone-simple` = Builder(name = "Megaphone-simple", defaultWidth = 256.0.dp,
...
private var `_megaphone-simple`: ImageVector? = null
