...
public val LightGroup.`Pix-logo-light`: ImageVector
    get() {
        if (`_pix-logo-light` != null) {
            return `_pix-logo-light`!!
        }
        `_pix-logo-light` = Builder(name = "Pix-logo-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_pix-logo-light`: ImageVector? = null
