...
public val ThinGroup.`Browsers-thin`: ImageVector
    get() {
        if (`_browsers-thin` != null) {
            return `_browsers-thin`!!
        }
        `_browsers-thin` = Builder(name = "Browsers-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_browsers-thin`: ImageVector? = null
