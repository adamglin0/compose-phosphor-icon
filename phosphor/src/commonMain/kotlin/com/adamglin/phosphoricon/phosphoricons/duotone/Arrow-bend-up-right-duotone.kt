...
public val DuotoneGroup.`Arrow-bend-up-right-duotone`: ImageVector
    get() {
        if (`_arrow-bend-up-right-duotone` != null) {
            return `_arrow-bend-up-right-duotone`!!
        }
        `_arrow-bend-up-right-duotone` = Builder(name = "Arrow-bend-up-right-duotone", defaultWidth
...
private var `_arrow-bend-up-right-duotone`: ImageVector? = null
