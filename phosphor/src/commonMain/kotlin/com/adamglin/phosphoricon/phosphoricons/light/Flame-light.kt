...
public val LightGroup.`Flame-light`: ImageVector
    get() {
        if (`_flame-light` != null) {
            return `_flame-light`!!
        }
        `_flame-light` = Builder(name = "Flame-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flame-light`: ImageVector? = null
