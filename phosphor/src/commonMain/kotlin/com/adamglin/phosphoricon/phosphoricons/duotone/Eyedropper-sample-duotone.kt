...
public val DuotoneGroup.`Eyedropper-sample-duotone`: ImageVector
    get() {
        if (`_eyedropper-sample-duotone` != null) {
            return `_eyedropper-sample-duotone`!!
        }
        `_eyedropper-sample-duotone` = Builder(name = "Eyedropper-sample-duotone", defaultWidth =
...
private var `_eyedropper-sample-duotone`: ImageVector? = null
