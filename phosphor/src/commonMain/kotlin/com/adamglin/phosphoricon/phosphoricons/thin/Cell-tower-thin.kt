...
public val ThinGroup.`Cell-tower-thin`: ImageVector
    get() {
        if (`_cell-tower-thin` != null) {
            return `_cell-tower-thin`!!
        }
        `_cell-tower-thin` = Builder(name = "Cell-tower-thin", defaultWidth = 256.0.dp,
...
private var `_cell-tower-thin`: ImageVector? = null
