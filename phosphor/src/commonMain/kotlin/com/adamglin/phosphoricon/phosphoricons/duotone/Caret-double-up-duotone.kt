...
public val DuotoneGroup.`Caret-double-up-duotone`: ImageVector
    get() {
        if (`_caret-double-up-duotone` != null) {
            return `_caret-double-up-duotone`!!
        }
        `_caret-double-up-duotone` = Builder(name = "Caret-double-up-duotone", defaultWidth =
...
private var `_caret-double-up-duotone`: ImageVector? = null
