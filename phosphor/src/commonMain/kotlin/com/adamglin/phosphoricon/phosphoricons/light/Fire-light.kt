...
public val LightGroup.`Fire-light`: ImageVector
    get() {
        if (`_fire-light` != null) {
            return `_fire-light`!!
        }
        `_fire-light` = Builder(name = "Fire-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fire-light`: ImageVector? = null
