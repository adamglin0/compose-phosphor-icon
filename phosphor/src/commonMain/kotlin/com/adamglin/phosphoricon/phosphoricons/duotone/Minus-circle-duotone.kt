...
public val DuotoneGroup.`Minus-circle-duotone`: ImageVector
    get() {
        if (`_minus-circle-duotone` != null) {
            return `_minus-circle-duotone`!!
        }
        `_minus-circle-duotone` = Builder(name = "Minus-circle-duotone", defaultWidth = 256.0.dp,
...
private var `_minus-circle-duotone`: ImageVector? = null
