...
public val LightGroup.`Baby-carriage-light`: ImageVector
    get() {
        if (`_baby-carriage-light` != null) {
            return `_baby-carriage-light`!!
        }
        `_baby-carriage-light` = Builder(name = "Baby-carriage-light", defaultWidth = 256.0.dp,
...
private var `_baby-carriage-light`: ImageVector? = null
