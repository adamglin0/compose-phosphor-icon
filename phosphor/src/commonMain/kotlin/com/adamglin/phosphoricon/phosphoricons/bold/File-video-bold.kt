...
public val BoldGroup.`File-video-bold`: ImageVector
    get() {
        if (`_file-video-bold` != null) {
            return `_file-video-bold`!!
        }
        `_file-video-bold` = Builder(name = "File-video-bold", defaultWidth = 256.0.dp,
...
private var `_file-video-bold`: ImageVector? = null
