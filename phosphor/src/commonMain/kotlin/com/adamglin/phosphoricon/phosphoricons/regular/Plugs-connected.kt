...
public val RegularGroup.`Plugs-connected`: ImageVector
    get() {
        if (`_plugs-connected` != null) {
            return `_plugs-connected`!!
        }
        `_plugs-connected` = Builder(name = "Plugs-connected", defaultWidth = 256.0.dp,
...
private var `_plugs-connected`: ImageVector? = null
