...
public val ThinGroup.`Folder-lock-thin`: ImageVector
    get() {
        if (`_folder-lock-thin` != null) {
            return `_folder-lock-thin`!!
        }
        `_folder-lock-thin` = Builder(name = "Folder-lock-thin", defaultWidth = 256.0.dp,
...
private var `_folder-lock-thin`: ImageVector? = null
