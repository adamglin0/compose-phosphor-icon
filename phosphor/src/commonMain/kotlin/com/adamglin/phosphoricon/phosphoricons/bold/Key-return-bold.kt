...
public val BoldGroup.`Key-return-bold`: ImageVector
    get() {
        if (`_key-return-bold` != null) {
            return `_key-return-bold`!!
        }
        `_key-return-bold` = Builder(name = "Key-return-bold", defaultWidth = 256.0.dp,
...
private var `_key-return-bold`: ImageVector? = null
