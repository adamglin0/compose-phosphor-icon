...
public val BoldGroup.`Arrow-bend-double-up-right-bold`: ImageVector
    get() {
        if (`_arrow-bend-double-up-right-bold` != null) {
            return `_arrow-bend-double-up-right-bold`!!
        }
        `_arrow-bend-double-up-right-bold` = Builder(name = "Arrow-bend-double-up-right-bold",
...
private var `_arrow-bend-double-up-right-bold`: ImageVector? = null
