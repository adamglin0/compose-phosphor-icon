...
public val DuotoneGroup.`Caret-double-left-duotone`: ImageVector
    get() {
        if (`_caret-double-left-duotone` != null) {
            return `_caret-double-left-duotone`!!
        }
        `_caret-double-left-duotone` = Builder(name = "Caret-double-left-duotone", defaultWidth =
...
private var `_caret-double-left-duotone`: ImageVector? = null
