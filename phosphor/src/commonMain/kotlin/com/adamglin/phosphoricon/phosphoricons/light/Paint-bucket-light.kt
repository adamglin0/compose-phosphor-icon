...
public val LightGroup.`Paint-bucket-light`: ImageVector
    get() {
        if (`_paint-bucket-light` != null) {
            return `_paint-bucket-light`!!
        }
        `_paint-bucket-light` = Builder(name = "Paint-bucket-light", defaultWidth = 256.0.dp,
...
private var `_paint-bucket-light`: ImageVector? = null
