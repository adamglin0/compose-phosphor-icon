...
public val BoldGroup.`Football-helmet-bold`: ImageVector
    get() {
        if (`_football-helmet-bold` != null) {
            return `_football-helmet-bold`!!
        }
        `_football-helmet-bold` = Builder(name = "Football-helmet-bold", defaultWidth = 256.0.dp,
...
private var `_football-helmet-bold`: ImageVector? = null
