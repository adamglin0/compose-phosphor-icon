...
public val BoldGroup.`Compass-tool-bold`: ImageVector
    get() {
        if (`_compass-tool-bold` != null) {
            return `_compass-tool-bold`!!
        }
        `_compass-tool-bold` = Builder(name = "Compass-tool-bold", defaultWidth = 256.0.dp,
...
private var `_compass-tool-bold`: ImageVector? = null
