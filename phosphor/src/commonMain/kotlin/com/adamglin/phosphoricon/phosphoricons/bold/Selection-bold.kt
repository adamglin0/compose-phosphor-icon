...
public val BoldGroup.`Selection-bold`: ImageVector
    get() {
        if (`_selection-bold` != null) {
            return `_selection-bold`!!
        }
        `_selection-bold` = Builder(name = "Selection-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_selection-bold`: ImageVector? = null
