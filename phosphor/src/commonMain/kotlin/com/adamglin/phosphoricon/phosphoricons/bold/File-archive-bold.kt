...
public val BoldGroup.`File-archive-bold`: ImageVector
    get() {
        if (`_file-archive-bold` != null) {
            return `_file-archive-bold`!!
        }
        `_file-archive-bold` = Builder(name = "File-archive-bold", defaultWidth = 256.0.dp,
...
private var `_file-archive-bold`: ImageVector? = null
