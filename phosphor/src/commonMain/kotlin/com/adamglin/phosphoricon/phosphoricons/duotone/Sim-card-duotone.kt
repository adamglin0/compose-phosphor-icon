...
public val DuotoneGroup.`Sim-card-duotone`: ImageVector
    get() {
        if (`_sim-card-duotone` != null) {
            return `_sim-card-duotone`!!
        }
        `_sim-card-duotone` = Builder(name = "Sim-card-duotone", defaultWidth = 256.0.dp,
...
private var `_sim-card-duotone`: ImageVector? = null
