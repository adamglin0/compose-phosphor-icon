...
public val BoldGroup.`Flip-horizontal-bold`: ImageVector
    get() {
        if (`_flip-horizontal-bold` != null) {
            return `_flip-horizontal-bold`!!
        }
        `_flip-horizontal-bold` = Builder(name = "Flip-horizontal-bold", defaultWidth = 256.0.dp,
...
private var `_flip-horizontal-bold`: ImageVector? = null
