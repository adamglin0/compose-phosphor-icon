...
public val BoldGroup.`Suitcase-simple-bold`: ImageVector
    get() {
        if (`_suitcase-simple-bold` != null) {
            return `_suitcase-simple-bold`!!
        }
        `_suitcase-simple-bold` = Builder(name = "Suitcase-simple-bold", defaultWidth = 256.0.dp,
...
private var `_suitcase-simple-bold`: ImageVector? = null
