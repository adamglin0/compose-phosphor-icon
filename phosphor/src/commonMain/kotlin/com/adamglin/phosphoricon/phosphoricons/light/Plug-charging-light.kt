...
public val LightGroup.`Plug-charging-light`: ImageVector
    get() {
        if (`_plug-charging-light` != null) {
            return `_plug-charging-light`!!
        }
        `_plug-charging-light` = Builder(name = "Plug-charging-light", defaultWidth = 256.0.dp,
...
private var `_plug-charging-light`: ImageVector? = null
