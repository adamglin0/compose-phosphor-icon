...
public val LightGroup.`Arrow-fat-lines-up-light`: ImageVector
    get() {
        if (`_arrow-fat-lines-up-light` != null) {
            return `_arrow-fat-lines-up-light`!!
        }
        `_arrow-fat-lines-up-light` = Builder(name = "Arrow-fat-lines-up-light", defaultWidth =
...
private var `_arrow-fat-lines-up-light`: ImageVector? = null
