...
public val RegularGroup.`Not-superset-of`: ImageVector
    get() {
        if (`_not-superset-of` != null) {
            return `_not-superset-of`!!
        }
        `_not-superset-of` = Builder(name = "Not-superset-of", defaultWidth = 256.0.dp,
...
private var `_not-superset-of`: ImageVector? = null
