...
public val FillGroup.`Standard-definition-fill`: ImageVector
    get() {
        if (`_standard-definition-fill` != null) {
            return `_standard-definition-fill`!!
        }
        `_standard-definition-fill` = Builder(name = "Standard-definition-fill", defaultWidth =
...
private var `_standard-definition-fill`: ImageVector? = null
