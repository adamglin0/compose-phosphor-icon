...
public val ThinGroup.`Layout-thin`: ImageVector
    get() {
        if (`_layout-thin` != null) {
            return `_layout-thin`!!
        }
        `_layout-thin` = Builder(name = "Layout-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_layout-thin`: ImageVector? = null
