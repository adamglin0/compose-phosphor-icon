...
public val LightGroup.`Plus-square-light`: ImageVector
    get() {
        if (`_plus-square-light` != null) {
            return `_plus-square-light`!!
        }
        `_plus-square-light` = Builder(name = "Plus-square-light", defaultWidth = 256.0.dp,
...
private var `_plus-square-light`: ImageVector? = null
