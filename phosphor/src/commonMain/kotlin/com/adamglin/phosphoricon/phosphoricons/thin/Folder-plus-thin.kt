...
public val ThinGroup.`Folder-plus-thin`: ImageVector
    get() {
        if (`_folder-plus-thin` != null) {
            return `_folder-plus-thin`!!
        }
        `_folder-plus-thin` = Builder(name = "Folder-plus-thin", defaultWidth = 256.0.dp,
...
private var `_folder-plus-thin`: ImageVector? = null
