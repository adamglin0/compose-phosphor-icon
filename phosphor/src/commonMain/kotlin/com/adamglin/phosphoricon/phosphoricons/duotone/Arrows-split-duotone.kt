...
public val DuotoneGroup.`Arrows-split-duotone`: ImageVector
    get() {
        if (`_arrows-split-duotone` != null) {
            return `_arrows-split-duotone`!!
        }
        `_arrows-split-duotone` = Builder(name = "Arrows-split-duotone", defaultWidth = 256.0.dp,
...
private var `_arrows-split-duotone`: ImageVector? = null
