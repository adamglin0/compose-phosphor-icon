...
public val FillGroup.`Chalkboard-teacher-fill`: ImageVector
    get() {
        if (`_chalkboard-teacher-fill` != null) {
            return `_chalkboard-teacher-fill`!!
        }
        `_chalkboard-teacher-fill` = Builder(name = "Chalkboard-teacher-fill", defaultWidth =
...
private var `_chalkboard-teacher-fill`: ImageVector? = null
