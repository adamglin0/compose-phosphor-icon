...
public val DuotoneGroup.`Arrow-line-up-right-duotone`: ImageVector
    get() {
        if (`_arrow-line-up-right-duotone` != null) {
            return `_arrow-line-up-right-duotone`!!
        }
        `_arrow-line-up-right-duotone` = Builder(name = "Arrow-line-up-right-duotone", defaultWidth
...
private var `_arrow-line-up-right-duotone`: ImageVector? = null
