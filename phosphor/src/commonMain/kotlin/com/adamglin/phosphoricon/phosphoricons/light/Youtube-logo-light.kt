...
public val LightGroup.`Youtube-logo-light`: ImageVector
    get() {
        if (`_youtube-logo-light` != null) {
            return `_youtube-logo-light`!!
        }
        `_youtube-logo-light` = Builder(name = "Youtube-logo-light", defaultWidth = 256.0.dp,
...
private var `_youtube-logo-light`: ImageVector? = null
