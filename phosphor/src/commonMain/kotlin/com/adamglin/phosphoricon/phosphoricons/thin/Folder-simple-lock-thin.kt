...
public val ThinGroup.`Folder-simple-lock-thin`: ImageVector
    get() {
        if (`_folder-simple-lock-thin` != null) {
            return `_folder-simple-lock-thin`!!
        }
        `_folder-simple-lock-thin` = Builder(name = "Folder-simple-lock-thin", defaultWidth =
...
private var `_folder-simple-lock-thin`: ImageVector? = null
