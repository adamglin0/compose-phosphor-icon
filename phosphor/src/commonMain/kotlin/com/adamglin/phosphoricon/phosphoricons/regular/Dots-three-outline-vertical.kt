...
public val RegularGroup.`Dots-three-outline-vertical`: ImageVector
    get() {
        if (`_dots-three-outline-vertical` != null) {
            return `_dots-three-outline-vertical`!!
        }
        `_dots-three-outline-vertical` = Builder(name = "Dots-three-outline-vertical", defaultWidth
...
private var `_dots-three-outline-vertical`: ImageVector? = null
