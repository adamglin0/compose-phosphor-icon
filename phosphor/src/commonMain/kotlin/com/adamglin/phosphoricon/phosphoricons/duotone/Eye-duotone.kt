...
public val DuotoneGroup.`Eye-duotone`: ImageVector
    get() {
        if (`_eye-duotone` != null) {
            return `_eye-duotone`!!
        }
        `_eye-duotone` = Builder(name = "Eye-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eye-duotone`: ImageVector? = null
