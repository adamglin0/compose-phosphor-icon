...
public val DuotoneGroup.`Microsoft-word-logo-duotone`: ImageVector
    get() {
        if (`_microsoft-word-logo-duotone` != null) {
            return `_microsoft-word-logo-duotone`!!
        }
        `_microsoft-word-logo-duotone` = Builder(name = "Microsoft-word-logo-duotone", defaultWidth
...
private var `_microsoft-word-logo-duotone`: ImageVector? = null
