...
public val DuotoneGroup.`File-vue-duotone`: ImageVector
    get() {
        if (`_file-vue-duotone` != null) {
            return `_file-vue-duotone`!!
        }
        `_file-vue-duotone` = Builder(name = "File-vue-duotone", defaultWidth = 256.0.dp,
...
private var `_file-vue-duotone`: ImageVector? = null
