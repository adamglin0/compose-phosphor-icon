...
public val RegularGroup.`Bounding-box`: ImageVector
    get() {
        if (`_bounding-box` != null) {
            return `_bounding-box`!!
        }
        `_bounding-box` = Builder(name = "Bounding-box", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bounding-box`: ImageVector? = null
