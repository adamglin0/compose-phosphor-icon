...
public val DuotoneGroup.`Plug-charging-duotone`: ImageVector
    get() {
        if (`_plug-charging-duotone` != null) {
            return `_plug-charging-duotone`!!
        }
        `_plug-charging-duotone` = Builder(name = "Plug-charging-duotone", defaultWidth = 256.0.dp,
...
private var `_plug-charging-duotone`: ImageVector? = null
