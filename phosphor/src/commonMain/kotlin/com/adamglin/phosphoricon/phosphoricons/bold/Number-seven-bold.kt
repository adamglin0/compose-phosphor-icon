...
public val BoldGroup.`Number-seven-bold`: ImageVector
    get() {
        if (`_number-seven-bold` != null) {
            return `_number-seven-bold`!!
        }
        `_number-seven-bold` = Builder(name = "Number-seven-bold", defaultWidth = 256.0.dp,
...
private var `_number-seven-bold`: ImageVector? = null
