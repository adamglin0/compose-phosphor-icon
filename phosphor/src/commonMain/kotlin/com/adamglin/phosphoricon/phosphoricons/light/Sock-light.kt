...
public val LightGroup.`Sock-light`: ImageVector
    get() {
        if (`_sock-light` != null) {
            return `_sock-light`!!
        }
        `_sock-light` = Builder(name = "Sock-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sock-light`: ImageVector? = null
