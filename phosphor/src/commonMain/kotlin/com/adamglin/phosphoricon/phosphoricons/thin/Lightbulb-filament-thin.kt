...
public val ThinGroup.`Lightbulb-filament-thin`: ImageVector
    get() {
        if (`_lightbulb-filament-thin` != null) {
            return `_lightbulb-filament-thin`!!
        }
        `_lightbulb-filament-thin` = Builder(name = "Lightbulb-filament-thin", defaultWidth =
...
private var `_lightbulb-filament-thin`: ImageVector? = null
