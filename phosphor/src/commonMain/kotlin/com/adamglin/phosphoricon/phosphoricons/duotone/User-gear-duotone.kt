...
public val DuotoneGroup.`User-gear-duotone`: ImageVector
    get() {
        if (`_user-gear-duotone` != null) {
            return `_user-gear-duotone`!!
        }
        `_user-gear-duotone` = Builder(name = "User-gear-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 224.0f, 144.0f)
                close()
            }
        }
        .build()
...
private var `_user-gear-duotone`: ImageVector? = null
