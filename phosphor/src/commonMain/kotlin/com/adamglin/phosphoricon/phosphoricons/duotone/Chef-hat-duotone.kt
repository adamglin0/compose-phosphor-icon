...
public val DuotoneGroup.`Chef-hat-duotone`: ImageVector
    get() {
        if (`_chef-hat-duotone` != null) {
            return `_chef-hat-duotone`!!
        }
        `_chef-hat-duotone` = Builder(name = "Chef-hat-duotone", defaultWidth = 256.0.dp,
...
private var `_chef-hat-duotone`: ImageVector? = null
