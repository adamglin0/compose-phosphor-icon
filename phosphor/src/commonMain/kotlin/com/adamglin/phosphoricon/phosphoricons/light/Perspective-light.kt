...
public val LightGroup.`Perspective-light`: ImageVector
    get() {
        if (`_perspective-light` != null) {
            return `_perspective-light`!!
        }
        `_perspective-light` = Builder(name = "Perspective-light", defaultWidth = 256.0.dp,
...
private var `_perspective-light`: ImageVector? = null
