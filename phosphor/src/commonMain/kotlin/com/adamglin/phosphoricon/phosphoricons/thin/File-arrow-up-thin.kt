...
public val ThinGroup.`File-arrow-up-thin`: ImageVector
    get() {
        if (`_file-arrow-up-thin` != null) {
            return `_file-arrow-up-thin`!!
        }
        `_file-arrow-up-thin` = Builder(name = "File-arrow-up-thin", defaultWidth = 256.0.dp,
...
private var `_file-arrow-up-thin`: ImageVector? = null
