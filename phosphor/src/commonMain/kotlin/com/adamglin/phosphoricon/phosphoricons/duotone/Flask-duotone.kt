...
public val DuotoneGroup.`Flask-duotone`: ImageVector
    get() {
        if (`_flask-duotone` != null) {
            return `_flask-duotone`!!
        }
        `_flask-duotone` = Builder(name = "Flask-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flask-duotone`: ImageVector? = null
