...
public val DuotoneGroup.`Jar-label-duotone`: ImageVector
    get() {
        if (`_jar-label-duotone` != null) {
            return `_jar-label-duotone`!!
        }
        `_jar-label-duotone` = Builder(name = "Jar-label-duotone", defaultWidth = 256.0.dp,
...
private var `_jar-label-duotone`: ImageVector? = null
