...
public val DuotoneGroup.`Git-commit-duotone`: ImageVector
    get() {
        if (`_git-commit-duotone` != null) {
            return `_git-commit-duotone`!!
        }
        `_git-commit-duotone` = Builder(name = "Git-commit-duotone", defaultWidth = 256.0.dp,
...
private var `_git-commit-duotone`: ImageVector? = null
