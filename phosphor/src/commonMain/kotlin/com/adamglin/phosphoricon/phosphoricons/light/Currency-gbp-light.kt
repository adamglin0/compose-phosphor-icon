...
public val LightGroup.`Currency-gbp-light`: ImageVector
    get() {
        if (`_currency-gbp-light` != null) {
            return `_currency-gbp-light`!!
        }
        `_currency-gbp-light` = Builder(name = "Currency-gbp-light", defaultWidth = 256.0.dp,
...
private var `_currency-gbp-light`: ImageVector? = null
