...
public val ThinGroup.`Minus-circle-thin`: ImageVector
    get() {
        if (`_minus-circle-thin` != null) {
            return `_minus-circle-thin`!!
        }
        `_minus-circle-thin` = Builder(name = "Minus-circle-thin", defaultWidth = 256.0.dp,
...
private var `_minus-circle-thin`: ImageVector? = null
