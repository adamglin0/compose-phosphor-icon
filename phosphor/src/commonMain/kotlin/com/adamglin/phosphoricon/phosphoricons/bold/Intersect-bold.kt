...
public val BoldGroup.`Intersect-bold`: ImageVector
    get() {
        if (`_intersect-bold` != null) {
            return `_intersect-bold`!!
        }
        `_intersect-bold` = Builder(name = "Intersect-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_intersect-bold`: ImageVector? = null
