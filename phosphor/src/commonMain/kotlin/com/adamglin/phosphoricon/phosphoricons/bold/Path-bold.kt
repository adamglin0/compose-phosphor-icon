...
public val BoldGroup.`Path-bold`: ImageVector
    get() {
        if (`_path-bold` != null) {
            return `_path-bold`!!
        }
        `_path-bold` = Builder(name = "Path-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_path-bold`: ImageVector? = null
