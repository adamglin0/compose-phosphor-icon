...
public val BoldGroup.`Fish-simple-bold`: ImageVector
    get() {
        if (`_fish-simple-bold` != null) {
            return `_fish-simple-bold`!!
        }
        `_fish-simple-bold` = Builder(name = "Fish-simple-bold", defaultWidth = 256.0.dp,
...
private var `_fish-simple-bold`: ImageVector? = null
