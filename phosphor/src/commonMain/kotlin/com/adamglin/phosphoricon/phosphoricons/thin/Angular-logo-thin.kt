...
public val ThinGroup.`Angular-logo-thin`: ImageVector
    get() {
        if (`_angular-logo-thin` != null) {
            return `_angular-logo-thin`!!
        }
        `_angular-logo-thin` = Builder(name = "Angular-logo-thin", defaultWidth = 256.0.dp,
...
private var `_angular-logo-thin`: ImageVector? = null
