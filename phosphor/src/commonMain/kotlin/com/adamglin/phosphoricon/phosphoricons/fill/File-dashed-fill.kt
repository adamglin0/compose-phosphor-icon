...
public val FillGroup.`File-dashed-fill`: ImageVector
    get() {
        if (`_file-dashed-fill` != null) {
            return `_file-dashed-fill`!!
        }
        `_file-dashed-fill` = Builder(name = "File-dashed-fill", defaultWidth = 256.0.dp,
...
private var `_file-dashed-fill`: ImageVector? = null
