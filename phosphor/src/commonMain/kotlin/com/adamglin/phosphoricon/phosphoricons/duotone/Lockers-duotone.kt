...
public val DuotoneGroup.`Lockers-duotone`: ImageVector
    get() {
        if (`_lockers-duotone` != null) {
            return `_lockers-duotone`!!
        }
        `_lockers-duotone` = Builder(name = "Lockers-duotone", defaultWidth = 256.0.dp,
...
private var `_lockers-duotone`: ImageVector? = null
