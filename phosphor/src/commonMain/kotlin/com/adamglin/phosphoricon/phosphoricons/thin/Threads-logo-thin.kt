...
public val ThinGroup.`Threads-logo-thin`: ImageVector
    get() {
        if (`_threads-logo-thin` != null) {
            return `_threads-logo-thin`!!
        }
        `_threads-logo-thin` = Builder(name = "Threads-logo-thin", defaultWidth = 256.0.dp,
...
private var `_threads-logo-thin`: ImageVector? = null
