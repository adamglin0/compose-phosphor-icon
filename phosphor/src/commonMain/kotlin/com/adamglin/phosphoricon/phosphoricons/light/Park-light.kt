...
public val LightGroup.`Park-light`: ImageVector
    get() {
        if (`_park-light` != null) {
            return `_park-light`!!
        }
        `_park-light` = Builder(name = "Park-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_park-light`: ImageVector? = null
