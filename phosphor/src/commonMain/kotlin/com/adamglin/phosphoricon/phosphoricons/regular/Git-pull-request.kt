...
public val RegularGroup.`Git-pull-request`: ImageVector
    get() {
        if (`_git-pull-request` != null) {
            return `_git-pull-request`!!
        }
        `_git-pull-request` = Builder(name = "Git-pull-request", defaultWidth = 256.0.dp,
...
private var `_git-pull-request`: ImageVector? = null
