...
public val BoldGroup.`Chat-text-bold`: ImageVector
    get() {
        if (`_chat-text-bold` != null) {
            return `_chat-text-bold`!!
        }
        `_chat-text-bold` = Builder(name = "Chat-text-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_chat-text-bold`: ImageVector? = null
