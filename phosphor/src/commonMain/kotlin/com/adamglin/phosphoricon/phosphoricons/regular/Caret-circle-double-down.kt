...
public val RegularGroup.`Caret-circle-double-down`: ImageVector
    get() {
        if (`_caret-circle-double-down` != null) {
            return `_caret-circle-double-down`!!
        }
        `_caret-circle-double-down` = Builder(name = "Caret-circle-double-down", defaultWidth =
...
private var `_caret-circle-double-down`: ImageVector? = null
