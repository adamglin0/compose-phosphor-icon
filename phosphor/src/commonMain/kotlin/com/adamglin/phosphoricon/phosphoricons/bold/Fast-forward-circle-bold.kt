...
public val BoldGroup.`Fast-forward-circle-bold`: ImageVector
    get() {
        if (`_fast-forward-circle-bold` != null) {
            return `_fast-forward-circle-bold`!!
        }
        `_fast-forward-circle-bold` = Builder(name = "Fast-forward-circle-bold", defaultWidth =
...
private var `_fast-forward-circle-bold`: ImageVector? = null
