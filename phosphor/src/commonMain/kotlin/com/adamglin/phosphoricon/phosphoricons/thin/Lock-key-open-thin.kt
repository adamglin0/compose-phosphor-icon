...
public val ThinGroup.`Lock-key-open-thin`: ImageVector
    get() {
        if (`_lock-key-open-thin` != null) {
            return `_lock-key-open-thin`!!
        }
        `_lock-key-open-thin` = Builder(name = "Lock-key-open-thin", defaultWidth = 256.0.dp,
...
private var `_lock-key-open-thin`: ImageVector? = null
