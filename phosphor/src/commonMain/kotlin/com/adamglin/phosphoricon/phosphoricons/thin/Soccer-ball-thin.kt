...
public val ThinGroup.`Soccer-ball-thin`: ImageVector
    get() {
        if (`_soccer-ball-thin` != null) {
            return `_soccer-ball-thin`!!
        }
        `_soccer-ball-thin` = Builder(name = "Soccer-ball-thin", defaultWidth = 256.0.dp,
...
private var `_soccer-ball-thin`: ImageVector? = null
