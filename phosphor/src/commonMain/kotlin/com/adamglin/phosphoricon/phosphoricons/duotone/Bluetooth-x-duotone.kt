...
public val DuotoneGroup.`Bluetooth-x-duotone`: ImageVector
    get() {
        if (`_bluetooth-x-duotone` != null) {
            return `_bluetooth-x-duotone`!!
        }
        `_bluetooth-x-duotone` = Builder(name = "Bluetooth-x-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                close()
                moveTo(167.47f, 73.6f)
                lineTo(112.0f, 32.0f)
                verticalLineToRelative(96.0f)
                lineToRelative(55.47f, -41.6f)
                arcTo(8.0f, 8.0f, 0.0f, false, false, 167.47f, 73.6f)
                close()
            }
...
private var `_bluetooth-x-duotone`: ImageVector? = null
