...
public val DuotoneGroup.`Folder-user-duotone`: ImageVector
    get() {
        if (`_folder-user-duotone` != null) {
            return `_folder-user-duotone`!!
        }
        `_folder-user-duotone` = Builder(name = "Folder-user-duotone", defaultWidth = 256.0.dp,
...
private var `_folder-user-duotone`: ImageVector? = null
