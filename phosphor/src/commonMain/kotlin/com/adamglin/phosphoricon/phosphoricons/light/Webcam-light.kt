...
public val LightGroup.`Webcam-light`: ImageVector
    get() {
        if (`_webcam-light` != null) {
            return `_webcam-light`!!
        }
        `_webcam-light` = Builder(name = "Webcam-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_webcam-light`: ImageVector? = null
