...
public val DuotoneGroup.`Pinwheel-duotone`: ImageVector
    get() {
        if (`_pinwheel-duotone` != null) {
            return `_pinwheel-duotone`!!
        }
        `_pinwheel-duotone` = Builder(name = "Pinwheel-duotone", defaultWidth = 256.0.dp,
...
private var `_pinwheel-duotone`: ImageVector? = null
