...
public val BoldGroup.`Rewind-circle-bold`: ImageVector
    get() {
        if (`_rewind-circle-bold` != null) {
            return `_rewind-circle-bold`!!
        }
        `_rewind-circle-bold` = Builder(name = "Rewind-circle-bold", defaultWidth = 256.0.dp,
...
private var `_rewind-circle-bold`: ImageVector? = null
