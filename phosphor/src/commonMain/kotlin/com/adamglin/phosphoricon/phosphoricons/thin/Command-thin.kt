...
public val ThinGroup.`Command-thin`: ImageVector
    get() {
        if (`_command-thin` != null) {
            return `_command-thin`!!
        }
        `_command-thin` = Builder(name = "Command-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_command-thin`: ImageVector? = null
