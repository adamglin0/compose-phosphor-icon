...
public val LightGroup.`Scribble-light`: ImageVector
    get() {
        if (`_scribble-light` != null) {
            return `_scribble-light`!!
        }
        `_scribble-light` = Builder(name = "Scribble-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_scribble-light`: ImageVector? = null
