...
public val FillGroup.`Pen-fill`: ImageVector
    get() {
        if (`_pen-fill` != null) {
            return `_pen-fill`!!
        }
        `_pen-fill` = Builder(name = "Pen-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_pen-fill`: ImageVector? = null
