...
public val DuotoneGroup.`File-js-duotone`: ImageVector
    get() {
        if (`_file-js-duotone` != null) {
            return `_file-js-duotone`!!
        }
        `_file-js-duotone` = Builder(name = "File-js-duotone", defaultWidth = 256.0.dp,
...
private var `_file-js-duotone`: ImageVector? = null
