...
public val DuotoneGroup.`Flower-tulip-duotone`: ImageVector
    get() {
        if (`_flower-tulip-duotone` != null) {
            return `_flower-tulip-duotone`!!
        }
        `_flower-tulip-duotone` = Builder(name = "Flower-tulip-duotone", defaultWidth = 256.0.dp,
...
private var `_flower-tulip-duotone`: ImageVector? = null
