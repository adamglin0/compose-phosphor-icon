...
public val LightGroup.`Heart-half-light`: ImageVector
    get() {
        if (`_heart-half-light` != null) {
            return `_heart-half-light`!!
        }
        `_heart-half-light` = Builder(name = "Heart-half-light", defaultWidth = 256.0.dp,
...
private var `_heart-half-light`: ImageVector? = null
