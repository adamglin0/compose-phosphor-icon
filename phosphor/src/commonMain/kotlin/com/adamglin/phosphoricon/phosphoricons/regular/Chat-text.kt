...
public val RegularGroup.`Chat-text`: ImageVector
    get() {
        if (`_chat-text` != null) {
            return `_chat-text`!!
        }
        `_chat-text` = Builder(name = "Chat-text", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chat-text`: ImageVector? = null
