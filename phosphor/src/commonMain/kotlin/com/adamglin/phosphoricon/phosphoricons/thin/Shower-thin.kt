...
public val ThinGroup.`Shower-thin`: ImageVector
    get() {
        if (`_shower-thin` != null) {
            return `_shower-thin`!!
        }
        `_shower-thin` = Builder(name = "Shower-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shower-thin`: ImageVector? = null
