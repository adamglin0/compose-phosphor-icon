...
public val BoldGroup.`Dna-bold`: ImageVector
    get() {
        if (`_dna-bold` != null) {
            return `_dna-bold`!!
        }
        `_dna-bold` = Builder(name = "Dna-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dna-bold`: ImageVector? = null
