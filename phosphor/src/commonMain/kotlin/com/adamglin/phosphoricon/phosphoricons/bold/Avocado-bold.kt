...
public val BoldGroup.`Avocado-bold`: ImageVector
    get() {
        if (`_avocado-bold` != null) {
            return `_avocado-bold`!!
        }
        `_avocado-bold` = Builder(name = "Avocado-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_avocado-bold`: ImageVector? = null
