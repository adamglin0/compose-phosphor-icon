...
public val DuotoneGroup.`Battery-charging-duotone`: ImageVector
    get() {
        if (`_battery-charging-duotone` != null) {
            return `_battery-charging-duotone`!!
        }
        `_battery-charging-duotone` = Builder(name = "Battery-charging-duotone", defaultWidth =
...
private var `_battery-charging-duotone`: ImageVector? = null
