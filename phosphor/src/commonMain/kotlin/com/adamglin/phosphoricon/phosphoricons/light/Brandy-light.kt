...
public val LightGroup.`Brandy-light`: ImageVector
    get() {
        if (`_brandy-light` != null) {
            return `_brandy-light`!!
        }
        `_brandy-light` = Builder(name = "Brandy-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_brandy-light`: ImageVector? = null
