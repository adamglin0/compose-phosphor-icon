...
public val BoldGroup.`Hand-pointing-bold`: ImageVector
    get() {
        if (`_hand-pointing-bold` != null) {
            return `_hand-pointing-bold`!!
        }
        `_hand-pointing-bold` = Builder(name = "Hand-pointing-bold", defaultWidth = 256.0.dp,
...
private var `_hand-pointing-bold`: ImageVector? = null
