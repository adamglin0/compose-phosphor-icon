...
public val DuotoneGroup.`Folder-simple-minus-duotone`: ImageVector
    get() {
        if (`_folder-simple-minus-duotone` != null) {
            return `_folder-simple-minus-duotone`!!
        }
        `_folder-simple-minus-duotone` = Builder(name = "Folder-simple-minus-duotone", defaultWidth
...
private var `_folder-simple-minus-duotone`: ImageVector? = null
