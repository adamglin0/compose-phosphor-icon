...
public val LightGroup.`Strategy-light`: ImageVector
    get() {
        if (`_strategy-light` != null) {
            return `_strategy-light`!!
        }
        `_strategy-light` = Builder(name = "Strategy-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_strategy-light`: ImageVector? = null
