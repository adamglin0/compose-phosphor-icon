...
public val LightGroup.`Pencil-circle-light`: ImageVector
    get() {
        if (`_pencil-circle-light` != null) {
            return `_pencil-circle-light`!!
        }
        `_pencil-circle-light` = Builder(name = "Pencil-circle-light", defaultWidth = 256.0.dp,
...
private var `_pencil-circle-light`: ImageVector? = null
