...
public val BoldGroup.`Virus-bold`: ImageVector
    get() {
        if (`_virus-bold` != null) {
            return `_virus-bold`!!
        }
        `_virus-bold` = Builder(name = "Virus-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_virus-bold`: ImageVector? = null
