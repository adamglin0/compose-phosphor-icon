...
public val ThinGroup.`Pix-logo-thin`: ImageVector
    get() {
        if (`_pix-logo-thin` != null) {
            return `_pix-logo-thin`!!
        }
        `_pix-logo-thin` = Builder(name = "Pix-logo-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pix-logo-thin`: ImageVector? = null
