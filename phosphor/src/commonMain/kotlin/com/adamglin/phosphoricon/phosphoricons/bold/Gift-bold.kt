...
public val BoldGroup.`Gift-bold`: ImageVector
    get() {
        if (`_gift-bold` != null) {
            return `_gift-bold`!!
        }
        `_gift-bold` = Builder(name = "Gift-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gift-bold`: ImageVector? = null
