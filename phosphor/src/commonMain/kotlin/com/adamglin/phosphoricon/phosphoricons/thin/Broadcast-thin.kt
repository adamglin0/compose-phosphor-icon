...
public val ThinGroup.`Broadcast-thin`: ImageVector
    get() {
        if (`_broadcast-thin` != null) {
            return `_broadcast-thin`!!
        }
        `_broadcast-thin` = Builder(name = "Broadcast-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_broadcast-thin`: ImageVector? = null
