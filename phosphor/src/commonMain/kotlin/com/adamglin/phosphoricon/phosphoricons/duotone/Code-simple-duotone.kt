...
public val DuotoneGroup.`Code-simple-duotone`: ImageVector
    get() {
        if (`_code-simple-duotone` != null) {
            return `_code-simple-duotone`!!
        }
        `_code-simple-duotone` = Builder(name = "Code-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_code-simple-duotone`: ImageVector? = null
