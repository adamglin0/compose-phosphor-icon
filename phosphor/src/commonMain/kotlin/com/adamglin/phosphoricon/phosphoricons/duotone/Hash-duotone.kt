...
public val DuotoneGroup.`Hash-duotone`: ImageVector
    get() {
        if (`_hash-duotone` != null) {
            return `_hash-duotone`!!
        }
        `_hash-duotone` = Builder(name = "Hash-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hash-duotone`: ImageVector? = null
