...
public val RegularGroup.`Disco-ball`: ImageVector
    get() {
        if (`_disco-ball` != null) {
            return `_disco-ball`!!
        }
        `_disco-ball` = Builder(name = "Disco-ball", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_disco-ball`: ImageVector? = null
