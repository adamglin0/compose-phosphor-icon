...
public val BoldGroup.`House-bold`: ImageVector
    get() {
        if (`_house-bold` != null) {
            return `_house-bold`!!
        }
        `_house-bold` = Builder(name = "House-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_house-bold`: ImageVector? = null
