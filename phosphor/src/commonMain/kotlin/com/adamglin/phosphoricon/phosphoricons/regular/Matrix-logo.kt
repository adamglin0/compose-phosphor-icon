...
public val RegularGroup.`Matrix-logo`: ImageVector
    get() {
        if (`_matrix-logo` != null) {
            return `_matrix-logo`!!
        }
        `_matrix-logo` = Builder(name = "Matrix-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_matrix-logo`: ImageVector? = null
