...
public val LightGroup.`Hand-arrow-down-light`: ImageVector
    get() {
        if (`_hand-arrow-down-light` != null) {
            return `_hand-arrow-down-light`!!
        }
        `_hand-arrow-down-light` = Builder(name = "Hand-arrow-down-light", defaultWidth = 256.0.dp,
...
private var `_hand-arrow-down-light`: ImageVector? = null
