...
public val LightGroup.`Projector-screen-light`: ImageVector
    get() {
        if (`_projector-screen-light` != null) {
            return `_projector-screen-light`!!
        }
        `_projector-screen-light` = Builder(name = "Projector-screen-light", defaultWidth =
...
private var `_projector-screen-light`: ImageVector? = null
