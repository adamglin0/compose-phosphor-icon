...
public val DuotoneGroup.`Briefcase-duotone`: ImageVector
    get() {
        if (`_briefcase-duotone` != null) {
            return `_briefcase-duotone`!!
        }
        `_briefcase-duotone` = Builder(name = "Briefcase-duotone", defaultWidth = 256.0.dp,
...
private var `_briefcase-duotone`: ImageVector? = null
