...
public val BoldGroup.`Popcorn-bold`: ImageVector
    get() {
        if (`_popcorn-bold` != null) {
            return `_popcorn-bold`!!
        }
        `_popcorn-bold` = Builder(name = "Popcorn-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_popcorn-bold`: ImageVector? = null
