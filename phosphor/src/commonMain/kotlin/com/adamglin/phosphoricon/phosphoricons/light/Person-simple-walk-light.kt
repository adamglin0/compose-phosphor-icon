...
public val LightGroup.`Person-simple-walk-light`: ImageVector
    get() {
        if (`_person-simple-walk-light` != null) {
            return `_person-simple-walk-light`!!
        }
        `_person-simple-walk-light` = Builder(name = "Person-simple-walk-light", defaultWidth =
...
private var `_person-simple-walk-light`: ImageVector? = null
