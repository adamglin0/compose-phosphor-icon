...
public val ThinGroup.`Closed-captioning-thin`: ImageVector
    get() {
        if (`_closed-captioning-thin` != null) {
            return `_closed-captioning-thin`!!
        }
        `_closed-captioning-thin` = Builder(name = "Closed-captioning-thin", defaultWidth =
...
private var `_closed-captioning-thin`: ImageVector? = null
