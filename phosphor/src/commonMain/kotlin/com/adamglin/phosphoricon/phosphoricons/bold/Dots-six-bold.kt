...
public val BoldGroup.`Dots-six-bold`: ImageVector
    get() {
        if (`_dots-six-bold` != null) {
            return `_dots-six-bold`!!
        }
        `_dots-six-bold` = Builder(name = "Dots-six-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dots-six-bold`: ImageVector? = null
