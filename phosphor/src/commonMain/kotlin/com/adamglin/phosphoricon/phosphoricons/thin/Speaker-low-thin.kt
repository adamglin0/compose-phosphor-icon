...
public val ThinGroup.`Speaker-low-thin`: ImageVector
    get() {
        if (`_speaker-low-thin` != null) {
            return `_speaker-low-thin`!!
        }
        `_speaker-low-thin` = Builder(name = "Speaker-low-thin", defaultWidth = 256.0.dp,
...
private var `_speaker-low-thin`: ImageVector? = null
