...
public val LightGroup.`Arrows-counter-clockwise-light`: ImageVector
    get() {
        if (`_arrows-counter-clockwise-light` != null) {
            return `_arrows-counter-clockwise-light`!!
        }
        `_arrows-counter-clockwise-light` = Builder(name = "Arrows-counter-clockwise-light",
...
private var `_arrows-counter-clockwise-light`: ImageVector? = null
