...
public val DuotoneGroup.`Windmill-duotone`: ImageVector
    get() {
        if (`_windmill-duotone` != null) {
            return `_windmill-duotone`!!
        }
        `_windmill-duotone` = Builder(name = "Windmill-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineToRelative(10.27f, -71.89f)
                lineToRelative(17.63f, -30.0f)
...
private var `_windmill-duotone`: ImageVector? = null
