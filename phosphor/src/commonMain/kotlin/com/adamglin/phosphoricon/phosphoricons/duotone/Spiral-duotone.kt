...
public val DuotoneGroup.`Spiral-duotone`: ImageVector
    get() {
        if (`_spiral-duotone` != null) {
            return `_spiral-duotone`!!
        }
        `_spiral-duotone` = Builder(name = "Spiral-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_spiral-duotone`: ImageVector? = null
