...
public val BoldGroup.`Scales-bold`: ImageVector
    get() {
        if (`_scales-bold` != null) {
            return `_scales-bold`!!
        }
        `_scales-bold` = Builder(name = "Scales-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scales-bold`: ImageVector? = null
