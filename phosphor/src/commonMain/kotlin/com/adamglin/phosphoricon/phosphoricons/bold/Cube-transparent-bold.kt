...
public val BoldGroup.`Cube-transparent-bold`: ImageVector
    get() {
        if (`_cube-transparent-bold` != null) {
            return `_cube-transparent-bold`!!
        }
        `_cube-transparent-bold` = Builder(name = "Cube-transparent-bold", defaultWidth = 256.0.dp,
...
private var `_cube-transparent-bold`: ImageVector? = null
