...
public val ThinGroup.`Scribble-loop-thin`: ImageVector
    get() {
        if (`_scribble-loop-thin` != null) {
            return `_scribble-loop-thin`!!
        }
        `_scribble-loop-thin` = Builder(name = "Scribble-loop-thin", defaultWidth = 256.0.dp,
...
private var `_scribble-loop-thin`: ImageVector? = null
