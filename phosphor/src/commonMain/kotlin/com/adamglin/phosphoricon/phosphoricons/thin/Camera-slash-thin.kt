...
public val ThinGroup.`Camera-slash-thin`: ImageVector
    get() {
        if (`_camera-slash-thin` != null) {
            return `_camera-slash-thin`!!
        }
        `_camera-slash-thin` = Builder(name = "Camera-slash-thin", defaultWidth = 256.0.dp,
...
private var `_camera-slash-thin`: ImageVector? = null
