...
public val BoldGroup.`Framer-logo-bold`: ImageVector
    get() {
        if (`_framer-logo-bold` != null) {
            return `_framer-logo-bold`!!
        }
        `_framer-logo-bold` = Builder(name = "Framer-logo-bold", defaultWidth = 256.0.dp,
...
private var `_framer-logo-bold`: ImageVector? = null
