...
public val BoldGroup.`File-js-bold`: ImageVector
    get() {
        if (`_file-js-bold` != null) {
            return `_file-js-bold`!!
        }
        `_file-js-bold` = Builder(name = "File-js-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-js-bold`: ImageVector? = null
