...
public val DuotoneGroup.`Lego-duotone`: ImageVector
    get() {
        if (`_lego-duotone` != null) {
            return `_lego-duotone`!!
        }
        `_lego-duotone` = Builder(name = "Lego-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lego-duotone`: ImageVector? = null
