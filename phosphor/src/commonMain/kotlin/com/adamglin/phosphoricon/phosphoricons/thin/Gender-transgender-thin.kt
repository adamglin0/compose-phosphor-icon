...
public val ThinGroup.`Gender-transgender-thin`: ImageVector
    get() {
        if (`_gender-transgender-thin` != null) {
            return `_gender-transgender-thin`!!
        }
        `_gender-transgender-thin` = Builder(name = "Gender-transgender-thin", defaultWidth =
...
private var `_gender-transgender-thin`: ImageVector? = null
