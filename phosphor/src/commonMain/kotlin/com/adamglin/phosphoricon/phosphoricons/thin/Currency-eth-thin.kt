...
public val ThinGroup.`Currency-eth-thin`: ImageVector
    get() {
        if (`_currency-eth-thin` != null) {
            return `_currency-eth-thin`!!
        }
        `_currency-eth-thin` = Builder(name = "Currency-eth-thin", defaultWidth = 256.0.dp,
...
private var `_currency-eth-thin`: ImageVector? = null
