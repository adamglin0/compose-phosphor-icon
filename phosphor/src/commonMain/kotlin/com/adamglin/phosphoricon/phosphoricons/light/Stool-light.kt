...
public val LightGroup.`Stool-light`: ImageVector
    get() {
        if (`_stool-light` != null) {
            return `_stool-light`!!
        }
        `_stool-light` = Builder(name = "Stool-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stool-light`: ImageVector? = null
