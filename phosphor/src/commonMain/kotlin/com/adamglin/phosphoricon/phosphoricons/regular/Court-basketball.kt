...
public val RegularGroup.`Court-basketball`: ImageVector
    get() {
        if (`_court-basketball` != null) {
            return `_court-basketball`!!
        }
        `_court-basketball` = Builder(name = "Court-basketball", defaultWidth = 256.0.dp,
...
private var `_court-basketball`: ImageVector? = null
