...
public val DuotoneGroup.`Framer-logo-duotone`: ImageVector
    get() {
        if (`_framer-logo-duotone` != null) {
            return `_framer-logo-duotone`!!
        }
        `_framer-logo-duotone` = Builder(name = "Framer-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_framer-logo-duotone`: ImageVector? = null
