...
public val ThinGroup.`Keyboard-thin`: ImageVector
    get() {
        if (`_keyboard-thin` != null) {
            return `_keyboard-thin`!!
        }
        `_keyboard-thin` = Builder(name = "Keyboard-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_keyboard-thin`: ImageVector? = null
