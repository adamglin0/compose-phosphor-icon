...
public val DuotoneGroup.`Images-duotone`: ImageVector
    get() {
        if (`_images-duotone` != null) {
            return `_images-duotone`!!
        }
        `_images-duotone` = Builder(name = "Images-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_images-duotone`: ImageVector? = null
