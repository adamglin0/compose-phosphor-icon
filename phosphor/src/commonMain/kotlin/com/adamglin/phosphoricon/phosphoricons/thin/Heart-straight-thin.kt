...
public val ThinGroup.`Heart-straight-thin`: ImageVector
    get() {
        if (`_heart-straight-thin` != null) {
            return `_heart-straight-thin`!!
        }
        `_heart-straight-thin` = Builder(name = "Heart-straight-thin", defaultWidth = 256.0.dp,
...
private var `_heart-straight-thin`: ImageVector? = null
