...
public val ThinGroup.`Sneaker-move-thin`: ImageVector
    get() {
        if (`_sneaker-move-thin` != null) {
            return `_sneaker-move-thin`!!
        }
        `_sneaker-move-thin` = Builder(name = "Sneaker-move-thin", defaultWidth = 256.0.dp,
...
private var `_sneaker-move-thin`: ImageVector? = null
