...
public val LightGroup.`Fast-forward-circle-light`: ImageVector
    get() {
        if (`_fast-forward-circle-light` != null) {
            return `_fast-forward-circle-light`!!
        }
        `_fast-forward-circle-light` = Builder(name = "Fast-forward-circle-light", defaultWidth =
...
private var `_fast-forward-circle-light`: ImageVector? = null
