...
public val LightGroup.`Dropbox-logo-light`: ImageVector
    get() {
        if (`_dropbox-logo-light` != null) {
            return `_dropbox-logo-light`!!
        }
        `_dropbox-logo-light` = Builder(name = "Dropbox-logo-light", defaultWidth = 256.0.dp,
...
private var `_dropbox-logo-light`: ImageVector? = null
