...
public val BoldGroup.`File-zip-bold`: ImageVector
    get() {
        if (`_file-zip-bold` != null) {
            return `_file-zip-bold`!!
        }
        `_file-zip-bold` = Builder(name = "File-zip-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-zip-bold`: ImageVector? = null
