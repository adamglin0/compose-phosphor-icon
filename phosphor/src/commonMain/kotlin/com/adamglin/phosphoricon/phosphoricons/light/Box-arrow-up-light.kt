...
public val LightGroup.`Box-arrow-up-light`: ImageVector
    get() {
        if (`_box-arrow-up-light` != null) {
            return `_box-arrow-up-light`!!
        }
        `_box-arrow-up-light` = Builder(name = "Box-arrow-up-light", defaultWidth = 256.0.dp,
...
private var `_box-arrow-up-light`: ImageVector? = null
