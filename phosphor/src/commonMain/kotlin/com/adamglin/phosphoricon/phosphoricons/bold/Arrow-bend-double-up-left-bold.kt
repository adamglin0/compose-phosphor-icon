...
public val BoldGroup.`Arrow-bend-double-up-left-bold`: ImageVector
    get() {
        if (`_arrow-bend-double-up-left-bold` != null) {
            return `_arrow-bend-double-up-left-bold`!!
        }
        `_arrow-bend-double-up-left-bold` = Builder(name = "Arrow-bend-double-up-left-bold",
...
private var `_arrow-bend-double-up-left-bold`: ImageVector? = null
