...
public val DuotoneGroup.`Number-circle-two-duotone`: ImageVector
    get() {
        if (`_number-circle-two-duotone` != null) {
            return `_number-circle-two-duotone`!!
        }
        `_number-circle-two-duotone` = Builder(name = "Number-circle-two-duotone", defaultWidth =
...
private var `_number-circle-two-duotone`: ImageVector? = null
