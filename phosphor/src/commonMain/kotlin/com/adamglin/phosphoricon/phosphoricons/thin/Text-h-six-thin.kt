...
public val ThinGroup.`Text-h-six-thin`: ImageVector
    get() {
        if (`_text-h-six-thin` != null) {
            return `_text-h-six-thin`!!
        }
        `_text-h-six-thin` = Builder(name = "Text-h-six-thin", defaultWidth = 256.0.dp,
...
private var `_text-h-six-thin`: ImageVector? = null
