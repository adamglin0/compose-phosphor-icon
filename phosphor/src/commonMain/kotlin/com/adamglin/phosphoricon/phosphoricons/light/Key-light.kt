...
public val LightGroup.`Key-light`: ImageVector
    get() {
        if (`_key-light` != null) {
            return `_key-light`!!
        }
        `_key-light` = Builder(name = "Key-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_key-light`: ImageVector? = null
