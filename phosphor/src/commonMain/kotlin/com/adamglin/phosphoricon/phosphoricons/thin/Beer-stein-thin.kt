...
public val ThinGroup.`Beer-stein-thin`: ImageVector
    get() {
        if (`_beer-stein-thin` != null) {
            return `_beer-stein-thin`!!
        }
        `_beer-stein-thin` = Builder(name = "Beer-stein-thin", defaultWidth = 256.0.dp,
...
private var `_beer-stein-thin`: ImageVector? = null
