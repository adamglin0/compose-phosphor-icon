...
public val FillGroup.`Identification-card-fill`: ImageVector
    get() {
        if (`_identification-card-fill` != null) {
            return `_identification-card-fill`!!
        }
        `_identification-card-fill` = Builder(name = "Identification-card-fill", defaultWidth =
...
private var `_identification-card-fill`: ImageVector? = null
