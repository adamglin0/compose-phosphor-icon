...
public val LightGroup.`Chat-slash-light`: ImageVector
    get() {
        if (`_chat-slash-light` != null) {
            return `_chat-slash-light`!!
        }
        `_chat-slash-light` = Builder(name = "Chat-slash-light", defaultWidth = 256.0.dp,
...
private var `_chat-slash-light`: ImageVector? = null
