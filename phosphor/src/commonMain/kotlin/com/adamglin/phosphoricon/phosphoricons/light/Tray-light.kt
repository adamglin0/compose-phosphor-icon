...
public val LightGroup.`Tray-light`: ImageVector
    get() {
        if (`_tray-light` != null) {
            return `_tray-light`!!
        }
        `_tray-light` = Builder(name = "Tray-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tray-light`: ImageVector? = null
