...
public val LightGroup.`Shirt-folded-light`: ImageVector
    get() {
        if (`_shirt-folded-light` != null) {
            return `_shirt-folded-light`!!
        }
        `_shirt-folded-light` = Builder(name = "Shirt-folded-light", defaultWidth = 256.0.dp,
...
private var `_shirt-folded-light`: ImageVector? = null
