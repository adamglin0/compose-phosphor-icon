...
public val ThinGroup.`Align-center-horizontal-thin`: ImageVector
    get() {
        if (`_align-center-horizontal-thin` != null) {
            return `_align-center-horizontal-thin`!!
        }
        `_align-center-horizontal-thin` = Builder(name = "Align-center-horizontal-thin",
...
private var `_align-center-horizontal-thin`: ImageVector? = null
