...
public val DuotoneGroup.`Bicycle-duotone`: ImageVector
    get() {
        if (`_bicycle-duotone` != null) {
            return `_bicycle-duotone`!!
        }
        `_bicycle-duotone` = Builder(name = "Bicycle-duotone", defaultWidth = 256.0.dp,
...
private var `_bicycle-duotone`: ImageVector? = null
