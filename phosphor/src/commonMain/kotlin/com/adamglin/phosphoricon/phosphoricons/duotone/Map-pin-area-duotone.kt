...
public val DuotoneGroup.`Map-pin-area-duotone`: ImageVector
    get() {
        if (`_map-pin-area-duotone` != null) {
            return `_map-pin-area-duotone`!!
        }
        `_map-pin-area-duotone` = Builder(name = "Map-pin-area-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(184.0f, 80.0f)
                curveToRelative(0.0f, 56.0f, -56.0f, 88.0f, -56.0f, 88.0f)
                reflectiveCurveTo(72.0f, 136.0f, 72.0f, 80.0f)
...
private var `_map-pin-area-duotone`: ImageVector? = null
