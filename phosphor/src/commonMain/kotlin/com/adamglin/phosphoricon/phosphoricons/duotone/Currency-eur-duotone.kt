...
public val DuotoneGroup.`Currency-eur-duotone`: ImageVector
    get() {
        if (`_currency-eur-duotone` != null) {
            return `_currency-eur-duotone`!!
        }
        `_currency-eur-duotone` = Builder(name = "Currency-eur-duotone", defaultWidth = 256.0.dp,
...
private var `_currency-eur-duotone`: ImageVector? = null
