...
public val LightGroup.`X-logo-light`: ImageVector
    get() {
        if (`_x-logo-light` != null) {
            return `_x-logo-light`!!
        }
        `_x-logo-light` = Builder(name = "X-logo-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_x-logo-light`: ImageVector? = null
