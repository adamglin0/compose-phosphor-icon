...
public val ThinGroup.`Yin-yang-thin`: ImageVector
    get() {
        if (`_yin-yang-thin` != null) {
            return `_yin-yang-thin`!!
        }
        `_yin-yang-thin` = Builder(name = "Yin-yang-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_yin-yang-thin`: ImageVector? = null
