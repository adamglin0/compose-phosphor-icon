...
public val DuotoneGroup.`Article-medium-duotone`: ImageVector
    get() {
        if (`_article-medium-duotone` != null) {
            return `_article-medium-duotone`!!
        }
        `_article-medium-duotone` = Builder(name = "Article-medium-duotone", defaultWidth =
...
private var `_article-medium-duotone`: ImageVector? = null
