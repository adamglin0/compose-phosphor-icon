...
public val DuotoneGroup.`Gps-slash-duotone`: ImageVector
    get() {
        if (`_gps-slash-duotone` != null) {
            return `_gps-slash-duotone`!!
        }
        `_gps-slash-duotone` = Builder(name = "Gps-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_gps-slash-duotone`: ImageVector? = null
