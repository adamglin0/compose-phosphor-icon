...
public val LightGroup.`Folder-dashed-light`: ImageVector
    get() {
        if (`_folder-dashed-light` != null) {
            return `_folder-dashed-light`!!
        }
        `_folder-dashed-light` = Builder(name = "Folder-dashed-light", defaultWidth = 256.0.dp,
...
private var `_folder-dashed-light`: ImageVector? = null
