...
public val ThinGroup.`Pencil-slash-thin`: ImageVector
    get() {
        if (`_pencil-slash-thin` != null) {
            return `_pencil-slash-thin`!!
        }
        `_pencil-slash-thin` = Builder(name = "Pencil-slash-thin", defaultWidth = 256.0.dp,
...
private var `_pencil-slash-thin`: ImageVector? = null
