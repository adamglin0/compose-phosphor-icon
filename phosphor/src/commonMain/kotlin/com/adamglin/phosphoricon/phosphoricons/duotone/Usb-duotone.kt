...
public val DuotoneGroup.`Usb-duotone`: ImageVector
    get() {
        if (`_usb-duotone` != null) {
            return `_usb-duotone`!!
        }
        `_usb-duotone` = Builder(name = "Usb-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_usb-duotone`: ImageVector? = null
