...
public val LightGroup.`Selection-slash-light`: ImageVector
    get() {
        if (`_selection-slash-light` != null) {
            return `_selection-slash-light`!!
        }
        `_selection-slash-light` = Builder(name = "Selection-slash-light", defaultWidth = 256.0.dp,
...
private var `_selection-slash-light`: ImageVector? = null
