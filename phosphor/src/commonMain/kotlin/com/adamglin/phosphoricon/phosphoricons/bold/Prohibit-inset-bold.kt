...
public val BoldGroup.`Prohibit-inset-bold`: ImageVector
    get() {
        if (`_prohibit-inset-bold` != null) {
            return `_prohibit-inset-bold`!!
        }
        `_prohibit-inset-bold` = Builder(name = "Prohibit-inset-bold", defaultWidth = 256.0.dp,
...
private var `_prohibit-inset-bold`: ImageVector? = null
