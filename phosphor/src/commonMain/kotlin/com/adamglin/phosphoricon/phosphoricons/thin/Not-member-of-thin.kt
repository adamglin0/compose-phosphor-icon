...
public val ThinGroup.`Not-member-of-thin`: ImageVector
    get() {
        if (`_not-member-of-thin` != null) {
            return `_not-member-of-thin`!!
        }
        `_not-member-of-thin` = Builder(name = "Not-member-of-thin", defaultWidth = 256.0.dp,
...
private var `_not-member-of-thin`: ImageVector? = null
