...
public val DuotoneGroup.`Shield-slash-duotone`: ImageVector
    get() {
        if (`_shield-slash-duotone` != null) {
            return `_shield-slash-duotone`!!
        }
        `_shield-slash-duotone` = Builder(name = "Shield-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_shield-slash-duotone`: ImageVector? = null
