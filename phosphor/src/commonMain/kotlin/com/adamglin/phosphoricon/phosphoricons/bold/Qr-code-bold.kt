...
public val BoldGroup.`Qr-code-bold`: ImageVector
    get() {
        if (`_qr-code-bold` != null) {
            return `_qr-code-bold`!!
        }
        `_qr-code-bold` = Builder(name = "Qr-code-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_qr-code-bold`: ImageVector? = null
