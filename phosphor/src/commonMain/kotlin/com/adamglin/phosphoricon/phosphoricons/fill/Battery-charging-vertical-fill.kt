...
public val FillGroup.`Battery-charging-vertical-fill`: ImageVector
    get() {
        if (`_battery-charging-vertical-fill` != null) {
            return `_battery-charging-vertical-fill`!!
        }
        `_battery-charging-vertical-fill` = Builder(name = "Battery-charging-vertical-fill",
...
private var `_battery-charging-vertical-fill`: ImageVector? = null
