...
public val LightGroup.`Broadcast-light`: ImageVector
    get() {
        if (`_broadcast-light` != null) {
            return `_broadcast-light`!!
        }
        `_broadcast-light` = Builder(name = "Broadcast-light", defaultWidth = 256.0.dp,
...
private var `_broadcast-light`: ImageVector? = null
