...
public val BoldGroup.`Person-simple-snowboard-bold`: ImageVector
    get() {
        if (`_person-simple-snowboard-bold` != null) {
            return `_person-simple-snowboard-bold`!!
        }
        `_person-simple-snowboard-bold` = Builder(name = "Person-simple-snowboard-bold",
...
private var `_person-simple-snowboard-bold`: ImageVector? = null
