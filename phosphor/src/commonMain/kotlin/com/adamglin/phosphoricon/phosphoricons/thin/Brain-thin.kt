...
public val ThinGroup.`Brain-thin`: ImageVector
    get() {
        if (`_brain-thin` != null) {
            return `_brain-thin`!!
        }
        `_brain-thin` = Builder(name = "Brain-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_brain-thin`: ImageVector? = null
