...
public val LightGroup.`File-video-light`: ImageVector
    get() {
        if (`_file-video-light` != null) {
            return `_file-video-light`!!
        }
        `_file-video-light` = Builder(name = "File-video-light", defaultWidth = 256.0.dp,
...
private var `_file-video-light`: ImageVector? = null
