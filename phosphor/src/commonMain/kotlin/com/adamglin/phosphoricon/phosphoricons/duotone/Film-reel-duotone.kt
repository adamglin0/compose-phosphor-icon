...
public val DuotoneGroup.`Film-reel-duotone`: ImageVector
    get() {
        if (`_film-reel-duotone` != null) {
            return `_film-reel-duotone`!!
        }
        `_film-reel-duotone` = Builder(name = "Film-reel-duotone", defaultWidth = 256.0.dp,
...
private var `_film-reel-duotone`: ImageVector? = null
