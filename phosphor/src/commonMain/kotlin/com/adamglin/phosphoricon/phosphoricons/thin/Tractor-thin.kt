...
public val ThinGroup.`Tractor-thin`: ImageVector
    get() {
        if (`_tractor-thin` != null) {
            return `_tractor-thin`!!
        }
        `_tractor-thin` = Builder(name = "Tractor-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tractor-thin`: ImageVector? = null
