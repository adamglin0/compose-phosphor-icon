...
public val ThinGroup.`Bluetooth-x-thin`: ImageVector
    get() {
        if (`_bluetooth-x-thin` != null) {
            return `_bluetooth-x-thin`!!
        }
        `_bluetooth-x-thin` = Builder(name = "Bluetooth-x-thin", defaultWidth = 256.0.dp,
...
private var `_bluetooth-x-thin`: ImageVector? = null
