...
public val DuotoneGroup.`Exclude-duotone`: ImageVector
    get() {
        if (`_exclude-duotone` != null) {
            return `_exclude-duotone`!!
        }
        `_exclude-duotone` = Builder(name = "Exclude-duotone", defaultWidth = 256.0.dp,
...
private var `_exclude-duotone`: ImageVector? = null
