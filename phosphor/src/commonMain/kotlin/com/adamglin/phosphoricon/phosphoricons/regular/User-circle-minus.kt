...
public val RegularGroup.`User-circle-minus`: ImageVector
    get() {
        if (`_user-circle-minus` != null) {
            return `_user-circle-minus`!!
        }
        `_user-circle-minus` = Builder(name = "User-circle-minus", defaultWidth = 256.0.dp,
...
private var `_user-circle-minus`: ImageVector? = null
