...
public val BoldGroup.`Newspaper-clipping-bold`: ImageVector
    get() {
        if (`_newspaper-clipping-bold` != null) {
            return `_newspaper-clipping-bold`!!
        }
        `_newspaper-clipping-bold` = Builder(name = "Newspaper-clipping-bold", defaultWidth =
...
private var `_newspaper-clipping-bold`: ImageVector? = null
