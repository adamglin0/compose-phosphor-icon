...
public val ThinGroup.`T-shirt-thin`: ImageVector
    get() {
        if (`_t-shirt-thin` != null) {
            return `_t-shirt-thin`!!
        }
        `_t-shirt-thin` = Builder(name = "T-shirt-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_t-shirt-thin`: ImageVector? = null
