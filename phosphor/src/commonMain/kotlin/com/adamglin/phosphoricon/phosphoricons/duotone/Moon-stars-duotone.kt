...
public val DuotoneGroup.`Moon-stars-duotone`: ImageVector
    get() {
        if (`_moon-stars-duotone` != null) {
            return `_moon-stars-duotone`!!
        }
        `_moon-stars-duotone` = Builder(name = "Moon-stars-duotone", defaultWidth = 256.0.dp,
...
private var `_moon-stars-duotone`: ImageVector? = null
