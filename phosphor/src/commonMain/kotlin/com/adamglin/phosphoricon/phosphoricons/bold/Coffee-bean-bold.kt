...
public val BoldGroup.`Coffee-bean-bold`: ImageVector
    get() {
        if (`_coffee-bean-bold` != null) {
            return `_coffee-bean-bold`!!
        }
        `_coffee-bean-bold` = Builder(name = "Coffee-bean-bold", defaultWidth = 256.0.dp,
...
private var `_coffee-bean-bold`: ImageVector? = null
