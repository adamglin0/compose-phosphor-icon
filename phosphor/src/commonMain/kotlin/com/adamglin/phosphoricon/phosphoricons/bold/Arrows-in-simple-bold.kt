...
public val BoldGroup.`Arrows-in-simple-bold`: ImageVector
    get() {
        if (`_arrows-in-simple-bold` != null) {
            return `_arrows-in-simple-bold`!!
        }
        `_arrows-in-simple-bold` = Builder(name = "Arrows-in-simple-bold", defaultWidth = 256.0.dp,
...
private var `_arrows-in-simple-bold`: ImageVector? = null
