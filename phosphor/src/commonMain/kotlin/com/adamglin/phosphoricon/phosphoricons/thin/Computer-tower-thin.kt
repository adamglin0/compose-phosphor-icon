...
public val ThinGroup.`Computer-tower-thin`: ImageVector
    get() {
        if (`_computer-tower-thin` != null) {
            return `_computer-tower-thin`!!
        }
        `_computer-tower-thin` = Builder(name = "Computer-tower-thin", defaultWidth = 256.0.dp,
...
private var `_computer-tower-thin`: ImageVector? = null
