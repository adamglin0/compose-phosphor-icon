...
public val DuotoneGroup.`Coin-vertical-duotone`: ImageVector
    get() {
        if (`_coin-vertical-duotone` != null) {
            return `_coin-vertical-duotone`!!
        }
        `_coin-vertical-duotone` = Builder(name = "Coin-vertical-duotone", defaultWidth = 256.0.dp,
...
private var `_coin-vertical-duotone`: ImageVector? = null
