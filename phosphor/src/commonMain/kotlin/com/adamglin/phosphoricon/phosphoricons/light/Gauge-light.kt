...
public val LightGroup.`Gauge-light`: ImageVector
    get() {
        if (`_gauge-light` != null) {
            return `_gauge-light`!!
        }
        `_gauge-light` = Builder(name = "Gauge-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gauge-light`: ImageVector? = null
