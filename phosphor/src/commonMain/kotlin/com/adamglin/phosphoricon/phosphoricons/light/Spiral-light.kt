...
public val LightGroup.`Spiral-light`: ImageVector
    get() {
        if (`_spiral-light` != null) {
            return `_spiral-light`!!
        }
        `_spiral-light` = Builder(name = "Spiral-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spiral-light`: ImageVector? = null
