...
public val DuotoneGroup.`Device-mobile-speaker-duotone`: ImageVector
    get() {
        if (`_device-mobile-speaker-duotone` != null) {
            return `_device-mobile-speaker-duotone`!!
        }
        `_device-mobile-speaker-duotone` = Builder(name = "Device-mobile-speaker-duotone",
...
private var `_device-mobile-speaker-duotone`: ImageVector? = null
