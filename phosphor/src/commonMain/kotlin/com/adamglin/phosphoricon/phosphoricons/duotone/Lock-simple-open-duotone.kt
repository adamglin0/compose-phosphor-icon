...
public val DuotoneGroup.`Lock-simple-open-duotone`: ImageVector
    get() {
        if (`_lock-simple-open-duotone` != null) {
            return `_lock-simple-open-duotone`!!
        }
        `_lock-simple-open-duotone` = Builder(name = "Lock-simple-open-duotone", defaultWidth =
...
private var `_lock-simple-open-duotone`: ImageVector? = null
