...
public val BoldGroup.`Egg-crack-bold`: ImageVector
    get() {
        if (`_egg-crack-bold` != null) {
            return `_egg-crack-bold`!!
        }
        `_egg-crack-bold` = Builder(name = "Egg-crack-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_egg-crack-bold`: ImageVector? = null
