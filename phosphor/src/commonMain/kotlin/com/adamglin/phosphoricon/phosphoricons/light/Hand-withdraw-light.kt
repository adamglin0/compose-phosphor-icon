...
public val LightGroup.`Hand-withdraw-light`: ImageVector
    get() {
        if (`_hand-withdraw-light` != null) {
            return `_hand-withdraw-light`!!
        }
        `_hand-withdraw-light` = Builder(name = "Hand-withdraw-light", defaultWidth = 256.0.dp,
...
private var `_hand-withdraw-light`: ImageVector? = null
