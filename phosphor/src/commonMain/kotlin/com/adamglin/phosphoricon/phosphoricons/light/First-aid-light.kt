...
public val LightGroup.`First-aid-light`: ImageVector
    get() {
        if (`_first-aid-light` != null) {
            return `_first-aid-light`!!
        }
        `_first-aid-light` = Builder(name = "First-aid-light", defaultWidth = 256.0.dp,
...
private var `_first-aid-light`: ImageVector? = null
