...
public val ThinGroup.`Hand-thin`: ImageVector
    get() {
        if (`_hand-thin` != null) {
            return `_hand-thin`!!
        }
        `_hand-thin` = Builder(name = "Hand-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-thin`: ImageVector? = null
