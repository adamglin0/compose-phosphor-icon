...
public val DuotoneGroup.`Airplane-tilt-duotone`: ImageVector
    get() {
        if (`_airplane-tilt-duotone` != null) {
            return `_airplane-tilt-duotone`!!
        }
        `_airplane-tilt-duotone` = Builder(name = "Airplane-tilt-duotone", defaultWidth = 256.0.dp,
...
private var `_airplane-tilt-duotone`: ImageVector? = null
