...
public val ThinGroup.`Skip-back-thin`: ImageVector
    get() {
        if (`_skip-back-thin` != null) {
            return `_skip-back-thin`!!
        }
        `_skip-back-thin` = Builder(name = "Skip-back-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_skip-back-thin`: ImageVector? = null
