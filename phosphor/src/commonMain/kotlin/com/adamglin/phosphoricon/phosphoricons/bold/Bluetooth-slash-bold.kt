...
public val BoldGroup.`Bluetooth-slash-bold`: ImageVector
    get() {
        if (`_bluetooth-slash-bold` != null) {
            return `_bluetooth-slash-bold`!!
        }
        `_bluetooth-slash-bold` = Builder(name = "Bluetooth-slash-bold", defaultWidth = 256.0.dp,
...
private var `_bluetooth-slash-bold`: ImageVector? = null
