...
public val ThinGroup.`Qr-code-thin`: ImageVector
    get() {
        if (`_qr-code-thin` != null) {
            return `_qr-code-thin`!!
        }
        `_qr-code-thin` = Builder(name = "Qr-code-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_qr-code-thin`: ImageVector? = null
