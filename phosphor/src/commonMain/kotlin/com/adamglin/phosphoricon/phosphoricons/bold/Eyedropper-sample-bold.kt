...
public val BoldGroup.`Eyedropper-sample-bold`: ImageVector
    get() {
        if (`_eyedropper-sample-bold` != null) {
            return `_eyedropper-sample-bold`!!
        }
        `_eyedropper-sample-bold` = Builder(name = "Eyedropper-sample-bold", defaultWidth =
...
private var `_eyedropper-sample-bold`: ImageVector? = null
