...
public val BoldGroup.`Bridge-bold`: ImageVector
    get() {
        if (`_bridge-bold` != null) {
            return `_bridge-bold`!!
        }
        `_bridge-bold` = Builder(name = "Bridge-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bridge-bold`: ImageVector? = null
