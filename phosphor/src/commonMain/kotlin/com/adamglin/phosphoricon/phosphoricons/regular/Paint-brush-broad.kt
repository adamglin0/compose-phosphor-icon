...
public val RegularGroup.`Paint-brush-broad`: ImageVector
    get() {
        if (`_paint-brush-broad` != null) {
            return `_paint-brush-broad`!!
        }
        `_paint-brush-broad` = Builder(name = "Paint-brush-broad", defaultWidth = 256.0.dp,
...
private var `_paint-brush-broad`: ImageVector? = null
