...
public val LightGroup.`Dna-light`: ImageVector
    get() {
        if (`_dna-light` != null) {
            return `_dna-light`!!
        }
        `_dna-light` = Builder(name = "Dna-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dna-light`: ImageVector? = null
