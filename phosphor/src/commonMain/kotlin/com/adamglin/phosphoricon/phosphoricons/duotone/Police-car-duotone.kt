...
public val DuotoneGroup.`Police-car-duotone`: ImageVector
    get() {
        if (`_police-car-duotone` != null) {
            return `_police-car-duotone`!!
        }
        `_police-car-duotone` = Builder(name = "Police-car-duotone", defaultWidth = 256.0.dp,
...
private var `_police-car-duotone`: ImageVector? = null
