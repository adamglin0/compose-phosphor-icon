...
public val LightGroup.`Speaker-slash-light`: ImageVector
    get() {
        if (`_speaker-slash-light` != null) {
            return `_speaker-slash-light`!!
        }
        `_speaker-slash-light` = Builder(name = "Speaker-slash-light", defaultWidth = 256.0.dp,
...
private var `_speaker-slash-light`: ImageVector? = null
