...
public val FillGroup.`Sign-out-fill`: ImageVector
    get() {
        if (`_sign-out-fill` != null) {
            return `_sign-out-fill`!!
        }
        `_sign-out-fill` = Builder(name = "Sign-out-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sign-out-fill`: ImageVector? = null
