...
public val ThinGroup.`Speaker-slash-thin`: ImageVector
    get() {
        if (`_speaker-slash-thin` != null) {
            return `_speaker-slash-thin`!!
        }
        `_speaker-slash-thin` = Builder(name = "Speaker-slash-thin", defaultWidth = 256.0.dp,
...
private var `_speaker-slash-thin`: ImageVector? = null
