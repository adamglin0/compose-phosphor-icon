...
public val ThinGroup.`Person-simple-snowboard-thin`: ImageVector
    get() {
        if (`_person-simple-snowboard-thin` != null) {
            return `_person-simple-snowboard-thin`!!
        }
        `_person-simple-snowboard-thin` = Builder(name = "Person-simple-snowboard-thin",
...
private var `_person-simple-snowboard-thin`: ImageVector? = null
