...
public val DuotoneGroup.`Wifi-high-duotone`: ImageVector
    get() {
        if (`_wifi-high-duotone` != null) {
            return `_wifi-high-duotone`!!
        }
        `_wifi-high-duotone` = Builder(name = "Wifi-high-duotone", defaultWidth = 256.0.dp,
...
private var `_wifi-high-duotone`: ImageVector? = null
