...
public val ThinGroup.`Tote-simple-thin`: ImageVector
    get() {
        if (`_tote-simple-thin` != null) {
            return `_tote-simple-thin`!!
        }
        `_tote-simple-thin` = Builder(name = "Tote-simple-thin", defaultWidth = 256.0.dp,
...
private var `_tote-simple-thin`: ImageVector? = null
