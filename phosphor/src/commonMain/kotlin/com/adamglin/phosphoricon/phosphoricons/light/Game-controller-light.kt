...
public val LightGroup.`Game-controller-light`: ImageVector
    get() {
        if (`_game-controller-light` != null) {
            return `_game-controller-light`!!
        }
        `_game-controller-light` = Builder(name = "Game-controller-light", defaultWidth = 256.0.dp,
...
private var `_game-controller-light`: ImageVector? = null
