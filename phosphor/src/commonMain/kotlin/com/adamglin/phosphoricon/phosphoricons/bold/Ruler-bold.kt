...
public val BoldGroup.`Ruler-bold`: ImageVector
    get() {
        if (`_ruler-bold` != null) {
            return `_ruler-bold`!!
        }
        `_ruler-bold` = Builder(name = "Ruler-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ruler-bold`: ImageVector? = null
