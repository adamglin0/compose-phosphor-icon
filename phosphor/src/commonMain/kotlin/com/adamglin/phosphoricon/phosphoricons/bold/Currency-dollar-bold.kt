...
public val BoldGroup.`Currency-dollar-bold`: ImageVector
    get() {
        if (`_currency-dollar-bold` != null) {
            return `_currency-dollar-bold`!!
        }
        `_currency-dollar-bold` = Builder(name = "Currency-dollar-bold", defaultWidth = 256.0.dp,
...
private var `_currency-dollar-bold`: ImageVector? = null
