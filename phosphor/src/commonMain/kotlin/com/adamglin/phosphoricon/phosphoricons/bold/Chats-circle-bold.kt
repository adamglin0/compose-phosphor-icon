...
public val BoldGroup.`Chats-circle-bold`: ImageVector
    get() {
        if (`_chats-circle-bold` != null) {
            return `_chats-circle-bold`!!
        }
        `_chats-circle-bold` = Builder(name = "Chats-circle-bold", defaultWidth = 256.0.dp,
...
private var `_chats-circle-bold`: ImageVector? = null
