...
public val ThinGroup.`Lock-thin`: ImageVector
    get() {
        if (`_lock-thin` != null) {
            return `_lock-thin`!!
        }
        `_lock-thin` = Builder(name = "Lock-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-thin`: ImageVector? = null
