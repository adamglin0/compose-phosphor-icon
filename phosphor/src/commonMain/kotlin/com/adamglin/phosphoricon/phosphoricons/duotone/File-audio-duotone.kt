...
public val DuotoneGroup.`File-audio-duotone`: ImageVector
    get() {
        if (`_file-audio-duotone` != null) {
            return `_file-audio-duotone`!!
        }
        `_file-audio-duotone` = Builder(name = "File-audio-duotone", defaultWidth = 256.0.dp,
...
private var `_file-audio-duotone`: ImageVector? = null
