...
public val DuotoneGroup.`Play-duotone`: ImageVector
    get() {
        if (`_play-duotone` != null) {
            return `_play-duotone`!!
        }
        `_play-duotone` = Builder(name = "Play-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_play-duotone`: ImageVector? = null
