...
public val BoldGroup.`Moped-bold`: ImageVector
    get() {
        if (`_moped-bold` != null) {
            return `_moped-bold`!!
        }
        `_moped-bold` = Builder(name = "Moped-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_moped-bold`: ImageVector? = null
