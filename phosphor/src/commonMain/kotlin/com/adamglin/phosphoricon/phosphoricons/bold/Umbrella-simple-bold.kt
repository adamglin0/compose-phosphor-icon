...
public val BoldGroup.`Umbrella-simple-bold`: ImageVector
    get() {
        if (`_umbrella-simple-bold` != null) {
            return `_umbrella-simple-bold`!!
        }
        `_umbrella-simple-bold` = Builder(name = "Umbrella-simple-bold", defaultWidth = 256.0.dp,
...
private var `_umbrella-simple-bold`: ImageVector? = null
