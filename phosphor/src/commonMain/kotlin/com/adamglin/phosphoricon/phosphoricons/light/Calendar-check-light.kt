...
public val LightGroup.`Calendar-check-light`: ImageVector
    get() {
        if (`_calendar-check-light` != null) {
            return `_calendar-check-light`!!
        }
        `_calendar-check-light` = Builder(name = "Calendar-check-light", defaultWidth = 256.0.dp,
...
private var `_calendar-check-light`: ImageVector? = null
