...
public val BoldGroup.`Play-circle-bold`: ImageVector
    get() {
        if (`_play-circle-bold` != null) {
            return `_play-circle-bold`!!
        }
        `_play-circle-bold` = Builder(name = "Play-circle-bold", defaultWidth = 256.0.dp,
...
private var `_play-circle-bold`: ImageVector? = null
