...
public val LightGroup.`Tornado-light`: ImageVector
    get() {
        if (`_tornado-light` != null) {
            return `_tornado-light`!!
        }
        `_tornado-light` = Builder(name = "Tornado-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tornado-light`: ImageVector? = null
