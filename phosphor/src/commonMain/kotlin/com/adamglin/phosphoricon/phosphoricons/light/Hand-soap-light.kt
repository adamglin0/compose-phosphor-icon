...
public val LightGroup.`Hand-soap-light`: ImageVector
    get() {
        if (`_hand-soap-light` != null) {
            return `_hand-soap-light`!!
        }
        `_hand-soap-light` = Builder(name = "Hand-soap-light", defaultWidth = 256.0.dp,
...
private var `_hand-soap-light`: ImageVector? = null
