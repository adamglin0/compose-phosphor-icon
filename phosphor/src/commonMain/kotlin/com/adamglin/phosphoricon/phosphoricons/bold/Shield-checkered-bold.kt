...
public val BoldGroup.`Shield-checkered-bold`: ImageVector
    get() {
        if (`_shield-checkered-bold` != null) {
            return `_shield-checkered-bold`!!
        }
        `_shield-checkered-bold` = Builder(name = "Shield-checkered-bold", defaultWidth = 256.0.dp,
...
private var `_shield-checkered-bold`: ImageVector? = null
