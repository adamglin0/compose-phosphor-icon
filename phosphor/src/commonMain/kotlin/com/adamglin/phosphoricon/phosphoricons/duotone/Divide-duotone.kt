...
public val DuotoneGroup.`Divide-duotone`: ImageVector
    get() {
        if (`_divide-duotone` != null) {
            return `_divide-duotone`!!
        }
        `_divide-duotone` = Builder(name = "Divide-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_divide-duotone`: ImageVector? = null
