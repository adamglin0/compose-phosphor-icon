...
public val DuotoneGroup.`Number-square-four-duotone`: ImageVector
    get() {
        if (`_number-square-four-duotone` != null) {
            return `_number-square-four-duotone`!!
        }
        `_number-square-four-duotone` = Builder(name = "Number-square-four-duotone", defaultWidth =
...
private var `_number-square-four-duotone`: ImageVector? = null
