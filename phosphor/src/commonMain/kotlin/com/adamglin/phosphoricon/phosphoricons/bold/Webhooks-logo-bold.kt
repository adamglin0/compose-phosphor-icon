...
public val BoldGroup.`Webhooks-logo-bold`: ImageVector
    get() {
        if (`_webhooks-logo-bold` != null) {
            return `_webhooks-logo-bold`!!
        }
        `_webhooks-logo-bold` = Builder(name = "Webhooks-logo-bold", defaultWidth = 256.0.dp,
...
private var `_webhooks-logo-bold`: ImageVector? = null
