...
public val DuotoneGroup.`Boot-duotone`: ImageVector
    get() {
        if (`_boot-duotone` != null) {
            return `_boot-duotone`!!
        }
        `_boot-duotone` = Builder(name = "Boot-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_boot-duotone`: ImageVector? = null
