...
public val BoldGroup.`Dice-three-bold`: ImageVector
    get() {
        if (`_dice-three-bold` != null) {
            return `_dice-three-bold`!!
        }
        `_dice-three-bold` = Builder(name = "Dice-three-bold", defaultWidth = 256.0.dp,
...
private var `_dice-three-bold`: ImageVector? = null
