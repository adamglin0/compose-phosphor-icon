...
public val ThinGroup.`Exclude-thin`: ImageVector
    get() {
        if (`_exclude-thin` != null) {
            return `_exclude-thin`!!
        }
        `_exclude-thin` = Builder(name = "Exclude-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_exclude-thin`: ImageVector? = null
