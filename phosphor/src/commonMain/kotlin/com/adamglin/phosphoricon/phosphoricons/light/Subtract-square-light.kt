...
public val LightGroup.`Subtract-square-light`: ImageVector
    get() {
        if (`_subtract-square-light` != null) {
            return `_subtract-square-light`!!
        }
        `_subtract-square-light` = Builder(name = "Subtract-square-light", defaultWidth = 256.0.dp,
...
private var `_subtract-square-light`: ImageVector? = null
