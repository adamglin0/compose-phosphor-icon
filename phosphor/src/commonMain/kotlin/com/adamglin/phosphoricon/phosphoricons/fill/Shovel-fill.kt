...
public val FillGroup.`Shovel-fill`: ImageVector
    get() {
        if (`_shovel-fill` != null) {
            return `_shovel-fill`!!
        }
        `_shovel-fill` = Builder(name = "Shovel-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shovel-fill`: ImageVector? = null
