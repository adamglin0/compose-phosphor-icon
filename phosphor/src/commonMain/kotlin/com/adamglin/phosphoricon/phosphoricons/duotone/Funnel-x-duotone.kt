...
public val DuotoneGroup.`Funnel-x-duotone`: ImageVector
    get() {
        if (`_funnel-x-duotone` != null) {
            return `_funnel-x-duotone`!!
        }
        `_funnel-x-duotone` = Builder(name = "Funnel-x-duotone", defaultWidth = 256.0.dp,
...
private var `_funnel-x-duotone`: ImageVector? = null
