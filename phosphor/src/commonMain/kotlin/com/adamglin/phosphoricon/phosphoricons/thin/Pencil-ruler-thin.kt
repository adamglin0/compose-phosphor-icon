...
public val ThinGroup.`Pencil-ruler-thin`: ImageVector
    get() {
        if (`_pencil-ruler-thin` != null) {
            return `_pencil-ruler-thin`!!
        }
        `_pencil-ruler-thin` = Builder(name = "Pencil-ruler-thin", defaultWidth = 256.0.dp,
...
private var `_pencil-ruler-thin`: ImageVector? = null
