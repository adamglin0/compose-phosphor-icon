...
public val DuotoneGroup.`Bell-simple-ringing-duotone`: ImageVector
    get() {
        if (`_bell-simple-ringing-duotone` != null) {
            return `_bell-simple-ringing-duotone`!!
        }
        `_bell-simple-ringing-duotone` = Builder(name = "Bell-simple-ringing-duotone", defaultWidth
...
private var `_bell-simple-ringing-duotone`: ImageVector? = null
