...
public val FillGroup.`Bathtub-fill`: ImageVector
    get() {
        if (`_bathtub-fill` != null) {
            return `_bathtub-fill`!!
        }
        `_bathtub-fill` = Builder(name = "Bathtub-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bathtub-fill`: ImageVector? = null
