...
public val DuotoneGroup.`Share-network-duotone`: ImageVector
    get() {
        if (`_share-network-duotone` != null) {
            return `_share-network-duotone`!!
        }
        `_share-network-duotone` = Builder(name = "Share-network-duotone", defaultWidth = 256.0.dp,
...
private var `_share-network-duotone`: ImageVector? = null
