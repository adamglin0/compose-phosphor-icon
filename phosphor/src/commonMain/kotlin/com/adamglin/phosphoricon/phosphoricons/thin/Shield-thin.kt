...
public val ThinGroup.`Shield-thin`: ImageVector
    get() {
        if (`_shield-thin` != null) {
            return `_shield-thin`!!
        }
        `_shield-thin` = Builder(name = "Shield-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shield-thin`: ImageVector? = null
