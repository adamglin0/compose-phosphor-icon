...
public val DuotoneGroup.`Vector-two-duotone`: ImageVector
    get() {
        if (`_vector-two-duotone` != null) {
            return `_vector-two-duotone`!!
        }
        `_vector-two-duotone` = Builder(name = "Vector-two-duotone", defaultWidth = 256.0.dp,
...
private var `_vector-two-duotone`: ImageVector? = null
