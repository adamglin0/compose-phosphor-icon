...
public val DuotoneGroup.`Not-member-of-duotone`: ImageVector
    get() {
        if (`_not-member-of-duotone` != null) {
            return `_not-member-of-duotone`!!
        }
        `_not-member-of-duotone` = Builder(name = "Not-member-of-duotone", defaultWidth = 256.0.dp,
...
private var `_not-member-of-duotone`: ImageVector? = null
