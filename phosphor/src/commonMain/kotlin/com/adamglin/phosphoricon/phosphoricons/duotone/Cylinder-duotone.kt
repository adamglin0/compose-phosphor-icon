...
public val DuotoneGroup.`Cylinder-duotone`: ImageVector
    get() {
        if (`_cylinder-duotone` != null) {
            return `_cylinder-duotone`!!
        }
        `_cylinder-duotone` = Builder(name = "Cylinder-duotone", defaultWidth = 256.0.dp,
...
private var `_cylinder-duotone`: ImageVector? = null
