...
public val DuotoneGroup.`Flag-pennant-duotone`: ImageVector
    get() {
        if (`_flag-pennant-duotone` != null) {
            return `_flag-pennant-duotone`!!
        }
        `_flag-pennant-duotone` = Builder(name = "Flag-pennant-duotone", defaultWidth = 256.0.dp,
...
private var `_flag-pennant-duotone`: ImageVector? = null
