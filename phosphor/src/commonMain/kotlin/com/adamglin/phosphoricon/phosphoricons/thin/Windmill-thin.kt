...
public val ThinGroup.`Windmill-thin`: ImageVector
    get() {
        if (`_windmill-thin` != null) {
            return `_windmill-thin`!!
        }
        `_windmill-thin` = Builder(name = "Windmill-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_windmill-thin`: ImageVector? = null
