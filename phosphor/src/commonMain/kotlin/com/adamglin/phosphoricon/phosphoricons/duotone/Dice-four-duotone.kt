...
public val DuotoneGroup.`Dice-four-duotone`: ImageVector
    get() {
        if (`_dice-four-duotone` != null) {
            return `_dice-four-duotone`!!
        }
        `_dice-four-duotone` = Builder(name = "Dice-four-duotone", defaultWidth = 256.0.dp,
...
private var `_dice-four-duotone`: ImageVector? = null
