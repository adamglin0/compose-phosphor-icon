...
public val DuotoneGroup.`Bus-duotone`: ImageVector
    get() {
        if (`_bus-duotone` != null) {
            return `_bus-duotone`!!
        }
        `_bus-duotone` = Builder(name = "Bus-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bus-duotone`: ImageVector? = null
