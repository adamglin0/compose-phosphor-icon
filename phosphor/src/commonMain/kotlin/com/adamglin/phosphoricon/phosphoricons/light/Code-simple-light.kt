...
public val LightGroup.`Code-simple-light`: ImageVector
    get() {
        if (`_code-simple-light` != null) {
            return `_code-simple-light`!!
        }
        `_code-simple-light` = Builder(name = "Code-simple-light", defaultWidth = 256.0.dp,
...
private var `_code-simple-light`: ImageVector? = null
