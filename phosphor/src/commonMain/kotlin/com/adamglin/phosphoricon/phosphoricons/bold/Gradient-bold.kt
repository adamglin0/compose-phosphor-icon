...
public val BoldGroup.`Gradient-bold`: ImageVector
    get() {
        if (`_gradient-bold` != null) {
            return `_gradient-bold`!!
        }
        `_gradient-bold` = Builder(name = "Gradient-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gradient-bold`: ImageVector? = null
