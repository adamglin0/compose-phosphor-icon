...
public val ThinGroup.`Baby-thin`: ImageVector
    get() {
        if (`_baby-thin` != null) {
            return `_baby-thin`!!
        }
        `_baby-thin` = Builder(name = "Baby-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_baby-thin`: ImageVector? = null
