...
public val ThinGroup.`Lamp-pendant-thin`: ImageVector
    get() {
        if (`_lamp-pendant-thin` != null) {
            return `_lamp-pendant-thin`!!
        }
        `_lamp-pendant-thin` = Builder(name = "Lamp-pendant-thin", defaultWidth = 256.0.dp,
...
private var `_lamp-pendant-thin`: ImageVector? = null
