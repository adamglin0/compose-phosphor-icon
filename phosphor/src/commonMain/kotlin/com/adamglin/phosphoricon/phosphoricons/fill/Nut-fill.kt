...
public val FillGroup.`Nut-fill`: ImageVector
    get() {
        if (`_nut-fill` != null) {
            return `_nut-fill`!!
        }
        `_nut-fill` = Builder(name = "Nut-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_nut-fill`: ImageVector? = null
