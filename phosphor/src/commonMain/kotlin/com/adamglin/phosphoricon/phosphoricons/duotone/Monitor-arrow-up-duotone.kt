...
public val DuotoneGroup.`Monitor-arrow-up-duotone`: ImageVector
    get() {
        if (`_monitor-arrow-up-duotone` != null) {
            return `_monitor-arrow-up-duotone`!!
        }
        `_monitor-arrow-up-duotone` = Builder(name = "Monitor-arrow-up-duotone", defaultWidth =
...
private var `_monitor-arrow-up-duotone`: ImageVector? = null
