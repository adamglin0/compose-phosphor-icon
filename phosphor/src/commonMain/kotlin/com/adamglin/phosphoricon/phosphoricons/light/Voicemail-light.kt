...
public val LightGroup.`Voicemail-light`: ImageVector
    get() {
        if (`_voicemail-light` != null) {
            return `_voicemail-light`!!
        }
        `_voicemail-light` = Builder(name = "Voicemail-light", defaultWidth = 256.0.dp,
...
private var `_voicemail-light`: ImageVector? = null
