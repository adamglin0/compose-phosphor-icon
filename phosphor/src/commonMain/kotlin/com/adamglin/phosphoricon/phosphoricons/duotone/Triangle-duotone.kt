...
public val DuotoneGroup.`Triangle-duotone`: ImageVector
    get() {
        if (`_triangle-duotone` != null) {
            return `_triangle-duotone`!!
        }
        `_triangle-duotone` = Builder(name = "Triangle-duotone", defaultWidth = 256.0.dp,
...
private var `_triangle-duotone`: ImageVector? = null
