...
public val LightGroup.`Metronome-light`: ImageVector
    get() {
        if (`_metronome-light` != null) {
            return `_metronome-light`!!
        }
        `_metronome-light` = Builder(name = "Metronome-light", defaultWidth = 256.0.dp,
...
private var `_metronome-light`: ImageVector? = null
