...
public val DuotoneGroup.`Cell-signal-medium-duotone`: ImageVector
    get() {
        if (`_cell-signal-medium-duotone` != null) {
            return `_cell-signal-medium-duotone`!!
        }
        `_cell-signal-medium-duotone` = Builder(name = "Cell-signal-medium-duotone", defaultWidth =
...
private var `_cell-signal-medium-duotone`: ImageVector? = null
