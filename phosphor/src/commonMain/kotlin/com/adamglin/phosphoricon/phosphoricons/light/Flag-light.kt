...
public val LightGroup.`Flag-light`: ImageVector
    get() {
        if (`_flag-light` != null) {
            return `_flag-light`!!
        }
        `_flag-light` = Builder(name = "Flag-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flag-light`: ImageVector? = null
