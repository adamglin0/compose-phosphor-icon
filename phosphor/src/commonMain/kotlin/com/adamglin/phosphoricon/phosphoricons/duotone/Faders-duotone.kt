...
public val DuotoneGroup.`Faders-duotone`: ImageVector
    get() {
        if (`_faders-duotone` != null) {
            return `_faders-duotone`!!
        }
        `_faders-duotone` = Builder(name = "Faders-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_faders-duotone`: ImageVector? = null
