...
public val ThinGroup.`Bezier-curve-thin`: ImageVector
    get() {
        if (`_bezier-curve-thin` != null) {
            return `_bezier-curve-thin`!!
        }
        `_bezier-curve-thin` = Builder(name = "Bezier-curve-thin", defaultWidth = 256.0.dp,
...
private var `_bezier-curve-thin`: ImageVector? = null
