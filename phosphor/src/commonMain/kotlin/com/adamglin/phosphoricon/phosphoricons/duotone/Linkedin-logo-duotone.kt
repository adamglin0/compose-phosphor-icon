...
public val DuotoneGroup.`Linkedin-logo-duotone`: ImageVector
    get() {
        if (`_linkedin-logo-duotone` != null) {
            return `_linkedin-logo-duotone`!!
        }
        `_linkedin-logo-duotone` = Builder(name = "Linkedin-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_linkedin-logo-duotone`: ImageVector? = null
