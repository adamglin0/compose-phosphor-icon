...
public val ThinGroup.`Traffic-sign-thin`: ImageVector
    get() {
        if (`_traffic-sign-thin` != null) {
            return `_traffic-sign-thin`!!
        }
        `_traffic-sign-thin` = Builder(name = "Traffic-sign-thin", defaultWidth = 256.0.dp,
...
private var `_traffic-sign-thin`: ImageVector? = null
