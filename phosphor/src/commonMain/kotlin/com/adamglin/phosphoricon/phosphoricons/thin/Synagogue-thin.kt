...
public val ThinGroup.`Synagogue-thin`: ImageVector
    get() {
        if (`_synagogue-thin` != null) {
            return `_synagogue-thin`!!
        }
        `_synagogue-thin` = Builder(name = "Synagogue-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_synagogue-thin`: ImageVector? = null
