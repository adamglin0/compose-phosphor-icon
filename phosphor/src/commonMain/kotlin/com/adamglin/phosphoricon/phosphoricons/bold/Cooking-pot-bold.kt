...
public val BoldGroup.`Cooking-pot-bold`: ImageVector
    get() {
        if (`_cooking-pot-bold` != null) {
            return `_cooking-pot-bold`!!
        }
        `_cooking-pot-bold` = Builder(name = "Cooking-pot-bold", defaultWidth = 256.0.dp,
...
private var `_cooking-pot-bold`: ImageVector? = null
