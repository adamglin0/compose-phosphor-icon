...
public val DuotoneGroup.`Binary-duotone`: ImageVector
    get() {
        if (`_binary-duotone` != null) {
            return `_binary-duotone`!!
        }
        `_binary-duotone` = Builder(name = "Binary-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_binary-duotone`: ImageVector? = null
