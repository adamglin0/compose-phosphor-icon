...
public val DuotoneGroup.`Circles-four-duotone`: ImageVector
    get() {
        if (`_circles-four-duotone` != null) {
            return `_circles-four-duotone`!!
        }
        `_circles-four-duotone` = Builder(name = "Circles-four-duotone", defaultWidth = 256.0.dp,
...
private var `_circles-four-duotone`: ImageVector? = null
