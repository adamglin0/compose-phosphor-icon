...
public val LightGroup.`Google-cardboard-logo-light`: ImageVector
    get() {
        if (`_google-cardboard-logo-light` != null) {
            return `_google-cardboard-logo-light`!!
        }
        `_google-cardboard-logo-light` = Builder(name = "Google-cardboard-logo-light", defaultWidth
...
private var `_google-cardboard-logo-light`: ImageVector? = null
