...
public val LightGroup.`Funnel-light`: ImageVector
    get() {
        if (`_funnel-light` != null) {
            return `_funnel-light`!!
        }
        `_funnel-light` = Builder(name = "Funnel-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_funnel-light`: ImageVector? = null
