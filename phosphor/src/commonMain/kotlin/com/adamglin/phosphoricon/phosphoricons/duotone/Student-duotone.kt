...
public val DuotoneGroup.`Student-duotone`: ImageVector
    get() {
        if (`_student-duotone` != null) {
            return `_student-duotone`!!
        }
        `_student-duotone` = Builder(name = "Student-duotone", defaultWidth = 256.0.dp,
...
private var `_student-duotone`: ImageVector? = null
