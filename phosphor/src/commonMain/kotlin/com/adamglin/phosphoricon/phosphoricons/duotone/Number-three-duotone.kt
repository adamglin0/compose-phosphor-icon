...
public val DuotoneGroup.`Number-three-duotone`: ImageVector
    get() {
        if (`_number-three-duotone` != null) {
            return `_number-three-duotone`!!
        }
        `_number-three-duotone` = Builder(name = "Number-three-duotone", defaultWidth = 256.0.dp,
...
private var `_number-three-duotone`: ImageVector? = null
