...
public val BoldGroup.`Pencil-ruler-bold`: ImageVector
    get() {
        if (`_pencil-ruler-bold` != null) {
            return `_pencil-ruler-bold`!!
        }
        `_pencil-ruler-bold` = Builder(name = "Pencil-ruler-bold", defaultWidth = 256.0.dp,
...
private var `_pencil-ruler-bold`: ImageVector? = null
