...
public val LightGroup.`Camera-plus-light`: ImageVector
    get() {
        if (`_camera-plus-light` != null) {
            return `_camera-plus-light`!!
        }
        `_camera-plus-light` = Builder(name = "Camera-plus-light", defaultWidth = 256.0.dp,
...
private var `_camera-plus-light`: ImageVector? = null
