...
public val ThinGroup.`Car-simple-thin`: ImageVector
    get() {
        if (`_car-simple-thin` != null) {
            return `_car-simple-thin`!!
        }
        `_car-simple-thin` = Builder(name = "Car-simple-thin", defaultWidth = 256.0.dp,
...
private var `_car-simple-thin`: ImageVector? = null
