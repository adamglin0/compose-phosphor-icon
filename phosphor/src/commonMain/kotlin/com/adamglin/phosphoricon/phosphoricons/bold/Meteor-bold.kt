...
public val BoldGroup.`Meteor-bold`: ImageVector
    get() {
        if (`_meteor-bold` != null) {
            return `_meteor-bold`!!
        }
        `_meteor-bold` = Builder(name = "Meteor-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_meteor-bold`: ImageVector? = null
