...
public val LightGroup.`Angle-light`: ImageVector
    get() {
        if (`_angle-light` != null) {
            return `_angle-light`!!
        }
        `_angle-light` = Builder(name = "Angle-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_angle-light`: ImageVector? = null
