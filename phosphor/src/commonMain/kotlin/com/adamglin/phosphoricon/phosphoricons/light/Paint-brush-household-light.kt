...
public val LightGroup.`Paint-brush-household-light`: ImageVector
    get() {
        if (`_paint-brush-household-light` != null) {
            return `_paint-brush-household-light`!!
        }
        `_paint-brush-household-light` = Builder(name = "Paint-brush-household-light", defaultWidth
...
private var `_paint-brush-household-light`: ImageVector? = null
