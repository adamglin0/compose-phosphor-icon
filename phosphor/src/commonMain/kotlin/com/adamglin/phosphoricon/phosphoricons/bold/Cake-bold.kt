...
public val BoldGroup.`Cake-bold`: ImageVector
    get() {
        if (`_cake-bold` != null) {
            return `_cake-bold`!!
        }
        `_cake-bold` = Builder(name = "Cake-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cake-bold`: ImageVector? = null
