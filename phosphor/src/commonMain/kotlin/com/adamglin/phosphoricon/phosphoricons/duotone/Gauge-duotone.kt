...
public val DuotoneGroup.`Gauge-duotone`: ImageVector
    get() {
        if (`_gauge-duotone` != null) {
            return `_gauge-duotone`!!
        }
        `_gauge-duotone` = Builder(name = "Gauge-duotone", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveTo(24.0f, 95.65f, 70.15f, 48.2f, 127.63f, 48.0f)
...
private var `_gauge-duotone`: ImageVector? = null
