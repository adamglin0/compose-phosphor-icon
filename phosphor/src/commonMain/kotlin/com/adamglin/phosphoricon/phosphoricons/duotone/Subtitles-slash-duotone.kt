...
public val DuotoneGroup.`Subtitles-slash-duotone`: ImageVector
    get() {
        if (`_subtitles-slash-duotone` != null) {
            return `_subtitles-slash-duotone`!!
        }
        `_subtitles-slash-duotone` = Builder(name = "Subtitles-slash-duotone", defaultWidth =
...
private var `_subtitles-slash-duotone`: ImageVector? = null
