...
public val LightGroup.`Egg-light`: ImageVector
    get() {
        if (`_egg-light` != null) {
            return `_egg-light`!!
        }
        `_egg-light` = Builder(name = "Egg-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_egg-light`: ImageVector? = null
