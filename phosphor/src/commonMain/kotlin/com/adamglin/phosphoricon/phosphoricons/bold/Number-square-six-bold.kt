...
public val BoldGroup.`Number-square-six-bold`: ImageVector
    get() {
        if (`_number-square-six-bold` != null) {
            return `_number-square-six-bold`!!
        }
        `_number-square-six-bold` = Builder(name = "Number-square-six-bold", defaultWidth =
...
private var `_number-square-six-bold`: ImageVector? = null
