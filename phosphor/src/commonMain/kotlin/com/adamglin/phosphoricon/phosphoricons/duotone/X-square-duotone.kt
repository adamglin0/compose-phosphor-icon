...
public val DuotoneGroup.`X-square-duotone`: ImageVector
    get() {
        if (`_x-square-duotone` != null) {
            return `_x-square-duotone`!!
        }
        `_x-square-duotone` = Builder(name = "X-square-duotone", defaultWidth = 256.0.dp,
...
private var `_x-square-duotone`: ImageVector? = null
