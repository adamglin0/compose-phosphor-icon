...
public val ThinGroup.`Barricade-thin`: ImageVector
    get() {
        if (`_barricade-thin` != null) {
            return `_barricade-thin`!!
        }
        `_barricade-thin` = Builder(name = "Barricade-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_barricade-thin`: ImageVector? = null
