...
public val BoldGroup.`Video-camera-slash-bold`: ImageVector
    get() {
        if (`_video-camera-slash-bold` != null) {
            return `_video-camera-slash-bold`!!
        }
        `_video-camera-slash-bold` = Builder(name = "Video-camera-slash-bold", defaultWidth =
...
private var `_video-camera-slash-bold`: ImageVector? = null
