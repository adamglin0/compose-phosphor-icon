...
public val DuotoneGroup.`Github-logo-duotone`: ImageVector
    get() {
        if (`_github-logo-duotone` != null) {
            return `_github-logo-duotone`!!
        }
        `_github-logo-duotone` = Builder(name = "Github-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_github-logo-duotone`: ImageVector? = null
