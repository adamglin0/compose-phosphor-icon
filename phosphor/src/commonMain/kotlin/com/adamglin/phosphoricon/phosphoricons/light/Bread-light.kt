...
public val LightGroup.`Bread-light`: ImageVector
    get() {
        if (`_bread-light` != null) {
            return `_bread-light`!!
        }
        `_bread-light` = Builder(name = "Bread-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bread-light`: ImageVector? = null
