...
public val DuotoneGroup.`Selection-all-duotone`: ImageVector
    get() {
        if (`_selection-all-duotone` != null) {
            return `_selection-all-duotone`!!
        }
        `_selection-all-duotone` = Builder(name = "Selection-all-duotone", defaultWidth = 256.0.dp,
...
private var `_selection-all-duotone`: ImageVector? = null
