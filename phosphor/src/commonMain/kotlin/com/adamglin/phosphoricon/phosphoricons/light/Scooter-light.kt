...
public val LightGroup.`Scooter-light`: ImageVector
    get() {
        if (`_scooter-light` != null) {
            return `_scooter-light`!!
        }
        `_scooter-light` = Builder(name = "Scooter-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scooter-light`: ImageVector? = null
