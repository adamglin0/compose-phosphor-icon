...
public val DuotoneGroup.`Arrow-bend-double-up-left-duotone`: ImageVector
    get() {
        if (`_arrow-bend-double-up-left-duotone` != null) {
            return `_arrow-bend-double-up-left-duotone`!!
        }
        `_arrow-bend-double-up-left-duotone` = Builder(name = "Arrow-bend-double-up-left-duotone",
...
private var `_arrow-bend-double-up-left-duotone`: ImageVector? = null
