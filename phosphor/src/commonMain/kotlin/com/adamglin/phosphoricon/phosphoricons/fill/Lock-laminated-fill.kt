...
public val FillGroup.`Lock-laminated-fill`: ImageVector
    get() {
        if (`_lock-laminated-fill` != null) {
            return `_lock-laminated-fill`!!
        }
        `_lock-laminated-fill` = Builder(name = "Lock-laminated-fill", defaultWidth = 256.0.dp,
...
private var `_lock-laminated-fill`: ImageVector? = null
