...
public val DuotoneGroup.`Playlist-duotone`: ImageVector
    get() {
        if (`_playlist-duotone` != null) {
            return `_playlist-duotone`!!
        }
        `_playlist-duotone` = Builder(name = "Playlist-duotone", defaultWidth = 256.0.dp,
...
private var `_playlist-duotone`: ImageVector? = null
