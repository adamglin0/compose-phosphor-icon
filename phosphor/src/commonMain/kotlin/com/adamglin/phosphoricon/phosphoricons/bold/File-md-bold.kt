...
public val BoldGroup.`File-md-bold`: ImageVector
    get() {
        if (`_file-md-bold` != null) {
            return `_file-md-bold`!!
        }
        `_file-md-bold` = Builder(name = "File-md-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-md-bold`: ImageVector? = null
