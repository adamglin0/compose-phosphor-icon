...
public val LightGroup.`Hand-light`: ImageVector
    get() {
        if (`_hand-light` != null) {
            return `_hand-light`!!
        }
        `_hand-light` = Builder(name = "Hand-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-light`: ImageVector? = null
