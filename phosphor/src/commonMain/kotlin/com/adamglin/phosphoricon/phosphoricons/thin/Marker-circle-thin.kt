...
public val ThinGroup.`Marker-circle-thin`: ImageVector
    get() {
        if (`_marker-circle-thin` != null) {
            return `_marker-circle-thin`!!
        }
        `_marker-circle-thin` = Builder(name = "Marker-circle-thin", defaultWidth = 256.0.dp,
...
private var `_marker-circle-thin`: ImageVector? = null
