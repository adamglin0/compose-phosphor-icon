...
public val DuotoneGroup.`Tray-arrow-up-duotone`: ImageVector
    get() {
        if (`_tray-arrow-up-duotone` != null) {
            return `_tray-arrow-up-duotone`!!
        }
        `_tray-arrow-up-duotone` = Builder(name = "Tray-arrow-up-duotone", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-up-duotone`: ImageVector? = null
