...
public val LightGroup.`Door-light`: ImageVector
    get() {
        if (`_door-light` != null) {
            return `_door-light`!!
        }
        `_door-light` = Builder(name = "Door-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_door-light`: ImageVector? = null
