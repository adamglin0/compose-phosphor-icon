...
public val ThinGroup.`Google-cardboard-logo-thin`: ImageVector
    get() {
        if (`_google-cardboard-logo-thin` != null) {
            return `_google-cardboard-logo-thin`!!
        }
        `_google-cardboard-logo-thin` = Builder(name = "Google-cardboard-logo-thin", defaultWidth =
...
private var `_google-cardboard-logo-thin`: ImageVector? = null
