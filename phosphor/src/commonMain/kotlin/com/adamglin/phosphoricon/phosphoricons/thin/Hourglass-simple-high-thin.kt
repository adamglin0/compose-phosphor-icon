...
public val ThinGroup.`Hourglass-simple-high-thin`: ImageVector
    get() {
        if (`_hourglass-simple-high-thin` != null) {
            return `_hourglass-simple-high-thin`!!
        }
        `_hourglass-simple-high-thin` = Builder(name = "Hourglass-simple-high-thin", defaultWidth =
...
private var `_hourglass-simple-high-thin`: ImageVector? = null
