...
public val BoldGroup.`Watch-bold`: ImageVector
    get() {
        if (`_watch-bold` != null) {
            return `_watch-bold`!!
        }
        `_watch-bold` = Builder(name = "Watch-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_watch-bold`: ImageVector? = null
