...
public val BoldGroup.`Golf-bold`: ImageVector
    get() {
        if (`_golf-bold` != null) {
            return `_golf-bold`!!
        }
        `_golf-bold` = Builder(name = "Golf-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_golf-bold`: ImageVector? = null
