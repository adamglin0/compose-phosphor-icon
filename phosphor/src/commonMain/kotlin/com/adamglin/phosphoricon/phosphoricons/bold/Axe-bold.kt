...
public val BoldGroup.`Axe-bold`: ImageVector
    get() {
        if (`_axe-bold` != null) {
            return `_axe-bold`!!
        }
        `_axe-bold` = Builder(name = "Axe-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_axe-bold`: ImageVector? = null
