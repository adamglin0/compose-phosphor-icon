...
public val BoldGroup.`Arrows-clockwise-bold`: ImageVector
    get() {
        if (`_arrows-clockwise-bold` != null) {
            return `_arrows-clockwise-bold`!!
        }
        `_arrows-clockwise-bold` = Builder(name = "Arrows-clockwise-bold", defaultWidth = 256.0.dp,
...
private var `_arrows-clockwise-bold`: ImageVector? = null
