...
public val DuotoneGroup.`Flashlight-duotone`: ImageVector
    get() {
        if (`_flashlight-duotone` != null) {
            return `_flashlight-duotone`!!
        }
        `_flashlight-duotone` = Builder(name = "Flashlight-duotone", defaultWidth = 256.0.dp,
...
private var `_flashlight-duotone`: ImageVector? = null
