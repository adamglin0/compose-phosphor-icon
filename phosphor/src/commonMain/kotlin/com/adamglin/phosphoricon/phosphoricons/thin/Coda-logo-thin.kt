...
public val ThinGroup.`Coda-logo-thin`: ImageVector
    get() {
        if (`_coda-logo-thin` != null) {
            return `_coda-logo-thin`!!
        }
        `_coda-logo-thin` = Builder(name = "Coda-logo-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_coda-logo-thin`: ImageVector? = null
