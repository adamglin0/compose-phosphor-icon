...
public val ThinGroup.`Factory-thin`: ImageVector
    get() {
        if (`_factory-thin` != null) {
            return `_factory-thin`!!
        }
        `_factory-thin` = Builder(name = "Factory-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_factory-thin`: ImageVector? = null
