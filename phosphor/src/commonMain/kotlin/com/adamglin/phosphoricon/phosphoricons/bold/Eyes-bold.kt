...
public val BoldGroup.`Eyes-bold`: ImageVector
    get() {
        if (`_eyes-bold` != null) {
            return `_eyes-bold`!!
        }
        `_eyes-bold` = Builder(name = "Eyes-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eyes-bold`: ImageVector? = null
