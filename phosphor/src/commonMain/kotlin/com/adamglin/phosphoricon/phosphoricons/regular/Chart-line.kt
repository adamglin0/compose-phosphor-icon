...
public val RegularGroup.`Chart-line`: ImageVector
    get() {
        if (`_chart-line` != null) {
            return `_chart-line`!!
        }
        `_chart-line` = Builder(name = "Chart-line", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chart-line`: ImageVector? = null
