...
public val BoldGroup.`File-arrow-up-bold`: ImageVector
    get() {
        if (`_file-arrow-up-bold` != null) {
            return `_file-arrow-up-bold`!!
        }
        `_file-arrow-up-bold` = Builder(name = "File-arrow-up-bold", defaultWidth = 256.0.dp,
...
private var `_file-arrow-up-bold`: ImageVector? = null
