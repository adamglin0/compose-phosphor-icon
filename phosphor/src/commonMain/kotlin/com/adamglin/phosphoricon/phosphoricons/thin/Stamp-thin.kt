...
public val ThinGroup.`Stamp-thin`: ImageVector
    get() {
        if (`_stamp-thin` != null) {
            return `_stamp-thin`!!
        }
        `_stamp-thin` = Builder(name = "Stamp-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stamp-thin`: ImageVector? = null
