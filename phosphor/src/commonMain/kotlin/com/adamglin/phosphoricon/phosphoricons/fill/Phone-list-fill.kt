...
public val FillGroup.`Phone-list-fill`: ImageVector
    get() {
        if (`_phone-list-fill` != null) {
            return `_phone-list-fill`!!
        }
        `_phone-list-fill` = Builder(name = "Phone-list-fill", defaultWidth = 256.0.dp,
...
private var `_phone-list-fill`: ImageVector? = null
