...
public val BoldGroup.`Gauge-bold`: ImageVector
    get() {
        if (`_gauge-bold` != null) {
            return `_gauge-bold`!!
        }
        `_gauge-bold` = Builder(name = "Gauge-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gauge-bold`: ImageVector? = null
