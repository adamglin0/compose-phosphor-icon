...
public val ThinGroup.`Bowl-food-thin`: ImageVector
    get() {
        if (`_bowl-food-thin` != null) {
            return `_bowl-food-thin`!!
        }
        `_bowl-food-thin` = Builder(name = "Bowl-food-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bowl-food-thin`: ImageVector? = null
