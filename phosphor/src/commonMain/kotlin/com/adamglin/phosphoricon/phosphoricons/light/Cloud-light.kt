...
public val LightGroup.`Cloud-light`: ImageVector
    get() {
        if (`_cloud-light` != null) {
            return `_cloud-light`!!
        }
        `_cloud-light` = Builder(name = "Cloud-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-light`: ImageVector? = null
