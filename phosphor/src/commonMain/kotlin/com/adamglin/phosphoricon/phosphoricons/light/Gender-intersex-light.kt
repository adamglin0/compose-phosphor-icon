...
public val LightGroup.`Gender-intersex-light`: ImageVector
    get() {
        if (`_gender-intersex-light` != null) {
            return `_gender-intersex-light`!!
        }
        `_gender-intersex-light` = Builder(name = "Gender-intersex-light", defaultWidth = 256.0.dp,
...
private var `_gender-intersex-light`: ImageVector? = null
