...
public val LightGroup.`Briefcase-light`: ImageVector
    get() {
        if (`_briefcase-light` != null) {
            return `_briefcase-light`!!
        }
        `_briefcase-light` = Builder(name = "Briefcase-light", defaultWidth = 256.0.dp,
...
private var `_briefcase-light`: ImageVector? = null
