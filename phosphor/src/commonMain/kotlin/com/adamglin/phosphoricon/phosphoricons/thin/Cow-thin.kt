...
public val ThinGroup.`Cow-thin`: ImageVector
    get() {
        if (`_cow-thin` != null) {
            return `_cow-thin`!!
        }
        `_cow-thin` = Builder(name = "Cow-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_cow-thin`: ImageVector? = null
