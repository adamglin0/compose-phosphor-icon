...
public val RegularGroup.`Globe-x`: ImageVector
    get() {
        if (`_globe-x` != null) {
            return `_globe-x`!!
        }
        `_globe-x` = Builder(name = "Globe-x", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_globe-x`: ImageVector? = null
