...
public val BoldGroup.`Number-circle-nine-bold`: ImageVector
    get() {
        if (`_number-circle-nine-bold` != null) {
            return `_number-circle-nine-bold`!!
        }
        `_number-circle-nine-bold` = Builder(name = "Number-circle-nine-bold", defaultWidth =
...
private var `_number-circle-nine-bold`: ImageVector? = null
