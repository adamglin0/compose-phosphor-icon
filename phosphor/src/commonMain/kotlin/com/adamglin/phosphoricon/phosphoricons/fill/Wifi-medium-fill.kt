...
public val FillGroup.`Wifi-medium-fill`: ImageVector
    get() {
        if (`_wifi-medium-fill` != null) {
            return `_wifi-medium-fill`!!
        }
        `_wifi-medium-fill` = Builder(name = "Wifi-medium-fill", defaultWidth = 256.0.dp,
...
private var `_wifi-medium-fill`: ImageVector? = null
