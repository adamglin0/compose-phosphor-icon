...
public val DuotoneGroup.`Subset-of-duotone`: ImageVector
    get() {
        if (`_subset-of-duotone` != null) {
            return `_subset-of-duotone`!!
        }
        `_subset-of-duotone` = Builder(name = "Subset-of-duotone", defaultWidth = 256.0.dp,
...
private var `_subset-of-duotone`: ImageVector? = null
