...
public val DuotoneGroup.`Bell-z-duotone`: ImageVector
    get() {
        if (`_bell-z-duotone` != null) {
            return `_bell-z-duotone`!!
        }
        `_bell-z-duotone` = Builder(name = "Bell-z-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bell-z-duotone`: ImageVector? = null
