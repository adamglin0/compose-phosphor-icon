...
public val DuotoneGroup.`Flag-banner-duotone`: ImageVector
    get() {
        if (`_flag-banner-duotone` != null) {
            return `_flag-banner-duotone`!!
        }
        `_flag-banner-duotone` = Builder(name = "Flag-banner-duotone", defaultWidth = 256.0.dp,
...
private var `_flag-banner-duotone`: ImageVector? = null
