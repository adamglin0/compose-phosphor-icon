...
public val BoldGroup.`Train-simple-bold`: ImageVector
    get() {
        if (`_train-simple-bold` != null) {
            return `_train-simple-bold`!!
        }
        `_train-simple-bold` = Builder(name = "Train-simple-bold", defaultWidth = 256.0.dp,
...
private var `_train-simple-bold`: ImageVector? = null
