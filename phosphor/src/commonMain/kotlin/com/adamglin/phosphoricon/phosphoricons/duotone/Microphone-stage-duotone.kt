...
public val DuotoneGroup.`Microphone-stage-duotone`: ImageVector
    get() {
        if (`_microphone-stage-duotone` != null) {
            return `_microphone-stage-duotone`!!
        }
        `_microphone-stage-duotone` = Builder(name = "Microphone-stage-duotone", defaultWidth =
...
private var `_microphone-stage-duotone`: ImageVector? = null
