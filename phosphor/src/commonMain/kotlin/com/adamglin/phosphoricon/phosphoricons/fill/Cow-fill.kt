...
public val FillGroup.`Cow-fill`: ImageVector
    get() {
        if (`_cow-fill` != null) {
            return `_cow-fill`!!
        }
        `_cow-fill` = Builder(name = "Cow-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_cow-fill`: ImageVector? = null
