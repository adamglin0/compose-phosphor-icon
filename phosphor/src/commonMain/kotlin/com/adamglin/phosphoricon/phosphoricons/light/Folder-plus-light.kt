...
public val LightGroup.`Folder-plus-light`: ImageVector
    get() {
        if (`_folder-plus-light` != null) {
            return `_folder-plus-light`!!
        }
        `_folder-plus-light` = Builder(name = "Folder-plus-light", defaultWidth = 256.0.dp,
...
private var `_folder-plus-light`: ImageVector? = null
