...
public val LightGroup.`Chat-teardrop-slash-light`: ImageVector
    get() {
        if (`_chat-teardrop-slash-light` != null) {
            return `_chat-teardrop-slash-light`!!
        }
        `_chat-teardrop-slash-light` = Builder(name = "Chat-teardrop-slash-light", defaultWidth =
...
private var `_chat-teardrop-slash-light`: ImageVector? = null
