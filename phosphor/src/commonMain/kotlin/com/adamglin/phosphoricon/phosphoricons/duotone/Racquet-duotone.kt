...
public val DuotoneGroup.`Racquet-duotone`: ImageVector
    get() {
        if (`_racquet-duotone` != null) {
            return `_racquet-duotone`!!
        }
        `_racquet-duotone` = Builder(name = "Racquet-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(213.0f, 133.0f)
                curveToRelative(-31.0f, 31.05f, -76.36f, 36.08f, -101.2f, 11.24f)
                reflectiveCurveTo(92.0f, 74.07f, 123.0f, 43.0f)
                reflectiveCurveToRelative(76.36f, -36.08f, 101.2f, -11.24f)
                reflectiveCurveTo(244.0f, 101.93f, 213.0f, 133.0f)
                close()
            }
...
private var `_racquet-duotone`: ImageVector? = null
