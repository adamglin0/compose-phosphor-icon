...
public val ThinGroup.`Unite-thin`: ImageVector
    get() {
        if (`_unite-thin` != null) {
            return `_unite-thin`!!
        }
        `_unite-thin` = Builder(name = "Unite-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_unite-thin`: ImageVector? = null
