...
public val BoldGroup.`Folder-star-bold`: ImageVector
    get() {
        if (`_folder-star-bold` != null) {
            return `_folder-star-bold`!!
        }
        `_folder-star-bold` = Builder(name = "Folder-star-bold", defaultWidth = 256.0.dp,
...
private var `_folder-star-bold`: ImageVector? = null
