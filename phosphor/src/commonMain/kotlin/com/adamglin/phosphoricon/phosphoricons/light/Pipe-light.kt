...
public val LightGroup.`Pipe-light`: ImageVector
    get() {
        if (`_pipe-light` != null) {
            return `_pipe-light`!!
        }
        `_pipe-light` = Builder(name = "Pipe-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pipe-light`: ImageVector? = null
