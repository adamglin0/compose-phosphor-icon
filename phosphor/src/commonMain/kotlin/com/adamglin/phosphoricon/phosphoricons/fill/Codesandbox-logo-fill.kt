...
public val FillGroup.`Codesandbox-logo-fill`: ImageVector
    get() {
        if (`_codesandbox-logo-fill` != null) {
            return `_codesandbox-logo-fill`!!
        }
        `_codesandbox-logo-fill` = Builder(name = "Codesandbox-logo-fill", defaultWidth = 256.0.dp,
...
private var `_codesandbox-logo-fill`: ImageVector? = null
