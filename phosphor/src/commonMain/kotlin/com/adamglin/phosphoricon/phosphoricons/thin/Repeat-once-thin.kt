...
public val ThinGroup.`Repeat-once-thin`: ImageVector
    get() {
        if (`_repeat-once-thin` != null) {
            return `_repeat-once-thin`!!
        }
        `_repeat-once-thin` = Builder(name = "Repeat-once-thin", defaultWidth = 256.0.dp,
...
private var `_repeat-once-thin`: ImageVector? = null
