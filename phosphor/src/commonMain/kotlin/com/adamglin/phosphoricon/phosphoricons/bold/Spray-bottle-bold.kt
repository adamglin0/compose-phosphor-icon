...
public val BoldGroup.`Spray-bottle-bold`: ImageVector
    get() {
        if (`_spray-bottle-bold` != null) {
            return `_spray-bottle-bold`!!
        }
        `_spray-bottle-bold` = Builder(name = "Spray-bottle-bold", defaultWidth = 256.0.dp,
...
private var `_spray-bottle-bold`: ImageVector? = null
