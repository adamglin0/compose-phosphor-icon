...
public val DuotoneGroup.`Money-duotone`: ImageVector
    get() {
        if (`_money-duotone` != null) {
            return `_money-duotone`!!
        }
        `_money-duotone` = Builder(name = "Money-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_money-duotone`: ImageVector? = null
