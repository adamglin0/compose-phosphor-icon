...
public val DuotoneGroup.`Standard-definition-duotone`: ImageVector
    get() {
        if (`_standard-definition-duotone` != null) {
            return `_standard-definition-duotone`!!
        }
        `_standard-definition-duotone` = Builder(name = "Standard-definition-duotone", defaultWidth
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(40.0f, 40.0f, 0.0f, false, true, 204.0f, 128.0f)
                close()
                moveTo(24.0f, 48.0f)
                ...
                curveTo(97.64f, 91.94f, 89.65f, 88.0f, 80.0f, 88.0f)
...
private var `_standard-definition-duotone`: ImageVector? = null
