...
public val DuotoneGroup.`Eraser-duotone`: ImageVector
    get() {
        if (`_eraser-duotone` != null) {
            return `_eraser-duotone`!!
        }
        `_eraser-duotone` = Builder(name = "Eraser-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_eraser-duotone`: ImageVector? = null
