...
public val DuotoneGroup.`File-plus-duotone`: ImageVector
    get() {
        if (`_file-plus-duotone` != null) {
            return `_file-plus-duotone`!!
        }
        `_file-plus-duotone` = Builder(name = "File-plus-duotone", defaultWidth = 256.0.dp,
...
private var `_file-plus-duotone`: ImageVector? = null
