...
public val BoldGroup.`Shield-bold`: ImageVector
    get() {
        if (`_shield-bold` != null) {
            return `_shield-bold`!!
        }
        `_shield-bold` = Builder(name = "Shield-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shield-bold`: ImageVector? = null
