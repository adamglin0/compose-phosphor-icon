...
public val LightGroup.`Hourglass-simple-light`: ImageVector
    get() {
        if (`_hourglass-simple-light` != null) {
            return `_hourglass-simple-light`!!
        }
        `_hourglass-simple-light` = Builder(name = "Hourglass-simple-light", defaultWidth =
...
private var `_hourglass-simple-light`: ImageVector? = null
