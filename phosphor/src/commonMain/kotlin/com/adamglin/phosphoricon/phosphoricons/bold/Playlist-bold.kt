...
public val BoldGroup.`Playlist-bold`: ImageVector
    get() {
        if (`_playlist-bold` != null) {
            return `_playlist-bold`!!
        }
        `_playlist-bold` = Builder(name = "Playlist-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_playlist-bold`: ImageVector? = null
