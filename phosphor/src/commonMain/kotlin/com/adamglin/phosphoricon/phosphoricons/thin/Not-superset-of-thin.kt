...
public val ThinGroup.`Not-superset-of-thin`: ImageVector
    get() {
        if (`_not-superset-of-thin` != null) {
            return `_not-superset-of-thin`!!
        }
        `_not-superset-of-thin` = Builder(name = "Not-superset-of-thin", defaultWidth = 256.0.dp,
...
private var `_not-superset-of-thin`: ImageVector? = null
