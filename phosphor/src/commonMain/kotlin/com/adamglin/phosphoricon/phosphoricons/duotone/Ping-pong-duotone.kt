...
public val DuotoneGroup.`Ping-pong-duotone`: ImageVector
    get() {
        if (`_ping-pong-duotone` != null) {
            return `_ping-pong-duotone`!!
        }
        `_ping-pong-duotone` = Builder(name = "Ping-pong-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(206.6f, 81.4f)
                lineTo(81.4f, 206.6f)
                arcTo(93.92f, 93.92f, 0.0f, false, true, 32.0f, 122.69f)
                curveToRelative(0.69f, -49.55f, 41.13f, -90.0f, 90.68f, -90.68f)
                arcTo(93.92f, 93.92f, 0.0f, false, true, 206.6f, 81.4f)
                close()
            }
...
private var `_ping-pong-duotone`: ImageVector? = null
