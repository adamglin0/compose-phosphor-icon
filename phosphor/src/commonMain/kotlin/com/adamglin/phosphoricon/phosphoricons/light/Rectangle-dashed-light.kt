...
public val LightGroup.`Rectangle-dashed-light`: ImageVector
    get() {
        if (`_rectangle-dashed-light` != null) {
            return `_rectangle-dashed-light`!!
        }
        `_rectangle-dashed-light` = Builder(name = "Rectangle-dashed-light", defaultWidth =
...
private var `_rectangle-dashed-light`: ImageVector? = null
