...
public val RegularGroup.`Qr-code`: ImageVector
    get() {
        if (`_qr-code` != null) {
            return `_qr-code`!!
        }
        `_qr-code` = Builder(name = "Qr-code", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_qr-code`: ImageVector? = null
