...
public val ThinGroup.`Files-thin`: ImageVector
    get() {
        if (`_files-thin` != null) {
            return `_files-thin`!!
        }
        `_files-thin` = Builder(name = "Files-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_files-thin`: ImageVector? = null
