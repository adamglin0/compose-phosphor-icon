...
public val DuotoneGroup.`Clover-duotone`: ImageVector
    get() {
        if (`_clover-duotone` != null) {
            return `_clover-duotone`!!
        }
        `_clover-duotone` = Builder(name = "Clover-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_clover-duotone`: ImageVector? = null
