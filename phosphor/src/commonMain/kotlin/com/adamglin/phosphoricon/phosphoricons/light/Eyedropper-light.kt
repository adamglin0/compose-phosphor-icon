...
public val LightGroup.`Eyedropper-light`: ImageVector
    get() {
        if (`_eyedropper-light` != null) {
            return `_eyedropper-light`!!
        }
        `_eyedropper-light` = Builder(name = "Eyedropper-light", defaultWidth = 256.0.dp,
...
private var `_eyedropper-light`: ImageVector? = null
