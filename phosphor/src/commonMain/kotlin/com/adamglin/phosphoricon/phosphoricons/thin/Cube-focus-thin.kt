...
public val ThinGroup.`Cube-focus-thin`: ImageVector
    get() {
        if (`_cube-focus-thin` != null) {
            return `_cube-focus-thin`!!
        }
        `_cube-focus-thin` = Builder(name = "Cube-focus-thin", defaultWidth = 256.0.dp,
...
private var `_cube-focus-thin`: ImageVector? = null
