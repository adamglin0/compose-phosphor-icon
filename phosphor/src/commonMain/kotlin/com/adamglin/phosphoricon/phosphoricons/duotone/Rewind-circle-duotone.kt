...
public val DuotoneGroup.`Rewind-circle-duotone`: ImageVector
    get() {
        if (`_rewind-circle-duotone` != null) {
            return `_rewind-circle-duotone`!!
        }
        `_rewind-circle-duotone` = Builder(name = "Rewind-circle-duotone", defaultWidth = 256.0.dp,
...
private var `_rewind-circle-duotone`: ImageVector? = null
