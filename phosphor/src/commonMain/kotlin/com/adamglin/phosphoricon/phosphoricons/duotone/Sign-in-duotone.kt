...
public val DuotoneGroup.`Sign-in-duotone`: ImageVector
    get() {
        if (`_sign-in-duotone` != null) {
            return `_sign-in-duotone`!!
        }
        `_sign-in-duotone` = Builder(name = "Sign-in-duotone", defaultWidth = 256.0.dp,
...
private var `_sign-in-duotone`: ImageVector? = null
