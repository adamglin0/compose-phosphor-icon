...
public val BoldGroup.`Less-than-or-equal-bold`: ImageVector
    get() {
        if (`_less-than-or-equal-bold` != null) {
            return `_less-than-or-equal-bold`!!
        }
        `_less-than-or-equal-bold` = Builder(name = "Less-than-or-equal-bold", defaultWidth =
...
private var `_less-than-or-equal-bold`: ImageVector? = null
