...
public val DuotoneGroup.`Truck-duotone`: ImageVector
    get() {
        if (`_truck-duotone` != null) {
            return `_truck-duotone`!!
        }
        `_truck-duotone` = Builder(name = "Truck-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_truck-duotone`: ImageVector? = null
