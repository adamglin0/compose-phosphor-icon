...
public val FillGroup.`Chat-teardrop-slash-fill`: ImageVector
    get() {
        if (`_chat-teardrop-slash-fill` != null) {
            return `_chat-teardrop-slash-fill`!!
        }
        `_chat-teardrop-slash-fill` = Builder(name = "Chat-teardrop-slash-fill", defaultWidth =
...
private var `_chat-teardrop-slash-fill`: ImageVector? = null
