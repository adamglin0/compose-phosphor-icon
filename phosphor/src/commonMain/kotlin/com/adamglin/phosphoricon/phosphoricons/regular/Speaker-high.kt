...
public val RegularGroup.`Speaker-high`: ImageVector
    get() {
        if (`_speaker-high` != null) {
            return `_speaker-high`!!
        }
        `_speaker-high` = Builder(name = "Speaker-high", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_speaker-high`: ImageVector? = null
