...
public val DuotoneGroup.`Film-slate-duotone`: ImageVector
    get() {
        if (`_film-slate-duotone` != null) {
            return `_film-slate-duotone`!!
        }
        `_film-slate-duotone` = Builder(name = "Film-slate-duotone", defaultWidth = 256.0.dp,
...
private var `_film-slate-duotone`: ImageVector? = null
