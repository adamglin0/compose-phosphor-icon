...
public val DuotoneGroup.`Bug-duotone`: ImageVector
    get() {
        if (`_bug-duotone` != null) {
            return `_bug-duotone`!!
        }
        `_bug-duotone` = Builder(name = "Bug-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bug-duotone`: ImageVector? = null
