...
public val ThinGroup.`Drop-half-thin`: ImageVector
    get() {
        if (`_drop-half-thin` != null) {
            return `_drop-half-thin`!!
        }
        `_drop-half-thin` = Builder(name = "Drop-half-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_drop-half-thin`: ImageVector? = null
