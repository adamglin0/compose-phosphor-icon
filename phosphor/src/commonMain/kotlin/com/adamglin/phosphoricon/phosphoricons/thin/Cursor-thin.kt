...
public val ThinGroup.`Cursor-thin`: ImageVector
    get() {
        if (`_cursor-thin` != null) {
            return `_cursor-thin`!!
        }
        `_cursor-thin` = Builder(name = "Cursor-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cursor-thin`: ImageVector? = null
