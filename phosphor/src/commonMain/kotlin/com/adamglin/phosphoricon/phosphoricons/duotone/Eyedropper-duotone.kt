...
public val DuotoneGroup.`Eyedropper-duotone`: ImageVector
    get() {
        if (`_eyedropper-duotone` != null) {
            return `_eyedropper-duotone`!!
        }
        `_eyedropper-duotone` = Builder(name = "Eyedropper-duotone", defaultWidth = 256.0.dp,
...
private var `_eyedropper-duotone`: ImageVector? = null
