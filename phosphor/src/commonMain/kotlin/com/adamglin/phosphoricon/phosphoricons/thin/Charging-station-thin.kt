...
public val ThinGroup.`Charging-station-thin`: ImageVector
    get() {
        if (`_charging-station-thin` != null) {
            return `_charging-station-thin`!!
        }
        `_charging-station-thin` = Builder(name = "Charging-station-thin", defaultWidth = 256.0.dp,
...
private var `_charging-station-thin`: ImageVector? = null
