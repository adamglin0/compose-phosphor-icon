...
public val DuotoneGroup.`Keyboard-duotone`: ImageVector
    get() {
        if (`_keyboard-duotone` != null) {
            return `_keyboard-duotone`!!
        }
        `_keyboard-duotone` = Builder(name = "Keyboard-duotone", defaultWidth = 256.0.dp,
...
private var `_keyboard-duotone`: ImageVector? = null
