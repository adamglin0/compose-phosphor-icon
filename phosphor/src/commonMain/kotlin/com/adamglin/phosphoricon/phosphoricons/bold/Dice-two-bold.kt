...
public val BoldGroup.`Dice-two-bold`: ImageVector
    get() {
        if (`_dice-two-bold` != null) {
            return `_dice-two-bold`!!
        }
        `_dice-two-bold` = Builder(name = "Dice-two-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dice-two-bold`: ImageVector? = null
