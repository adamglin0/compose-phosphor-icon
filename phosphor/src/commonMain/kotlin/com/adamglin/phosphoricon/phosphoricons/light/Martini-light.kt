...
public val LightGroup.`Martini-light`: ImageVector
    get() {
        if (`_martini-light` != null) {
            return `_martini-light`!!
        }
        `_martini-light` = Builder(name = "Martini-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_martini-light`: ImageVector? = null
