...
public val DuotoneGroup.`Credit-card-duotone`: ImageVector
    get() {
        if (`_credit-card-duotone` != null) {
            return `_credit-card-duotone`!!
        }
        `_credit-card-duotone` = Builder(name = "Credit-card-duotone", defaultWidth = 256.0.dp,
...
private var `_credit-card-duotone`: ImageVector? = null
