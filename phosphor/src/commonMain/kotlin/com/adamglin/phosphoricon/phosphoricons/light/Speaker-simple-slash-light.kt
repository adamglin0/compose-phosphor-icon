...
public val LightGroup.`Speaker-simple-slash-light`: ImageVector
    get() {
        if (`_speaker-simple-slash-light` != null) {
            return `_speaker-simple-slash-light`!!
        }
        `_speaker-simple-slash-light` = Builder(name = "Speaker-simple-slash-light", defaultWidth =
...
private var `_speaker-simple-slash-light`: ImageVector? = null
