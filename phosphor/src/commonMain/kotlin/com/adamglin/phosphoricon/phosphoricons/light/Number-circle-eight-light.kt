...
public val LightGroup.`Number-circle-eight-light`: ImageVector
    get() {
        if (`_number-circle-eight-light` != null) {
            return `_number-circle-eight-light`!!
        }
        `_number-circle-eight-light` = Builder(name = "Number-circle-eight-light", defaultWidth =
...
private var `_number-circle-eight-light`: ImageVector? = null
