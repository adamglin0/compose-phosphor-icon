...
public val ThinGroup.`Meteor-thin`: ImageVector
    get() {
        if (`_meteor-thin` != null) {
            return `_meteor-thin`!!
        }
        `_meteor-thin` = Builder(name = "Meteor-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_meteor-thin`: ImageVector? = null
