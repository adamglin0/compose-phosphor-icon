...
public val LightGroup.`Stack-overflow-logo-light`: ImageVector
    get() {
        if (`_stack-overflow-logo-light` != null) {
            return `_stack-overflow-logo-light`!!
        }
        `_stack-overflow-logo-light` = Builder(name = "Stack-overflow-logo-light", defaultWidth =
...
private var `_stack-overflow-logo-light`: ImageVector? = null
