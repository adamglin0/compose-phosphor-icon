...
public val LightGroup.`Belt-light`: ImageVector
    get() {
        if (`_belt-light` != null) {
            return `_belt-light`!!
        }
        `_belt-light` = Builder(name = "Belt-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_belt-light`: ImageVector? = null
