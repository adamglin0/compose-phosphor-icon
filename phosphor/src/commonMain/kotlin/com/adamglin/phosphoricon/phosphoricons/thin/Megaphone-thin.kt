...
public val ThinGroup.`Megaphone-thin`: ImageVector
    get() {
        if (`_megaphone-thin` != null) {
            return `_megaphone-thin`!!
        }
        `_megaphone-thin` = Builder(name = "Megaphone-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_megaphone-thin`: ImageVector? = null
