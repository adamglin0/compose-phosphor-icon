...
public val RegularGroup.`Currency-eth`: ImageVector
    get() {
        if (`_currency-eth` != null) {
            return `_currency-eth`!!
        }
        `_currency-eth` = Builder(name = "Currency-eth", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_currency-eth`: ImageVector? = null
