...
public val LightGroup.`Hourglass-high-light`: ImageVector
    get() {
        if (`_hourglass-high-light` != null) {
            return `_hourglass-high-light`!!
        }
        `_hourglass-high-light` = Builder(name = "Hourglass-high-light", defaultWidth = 256.0.dp,
...
private var `_hourglass-high-light`: ImageVector? = null
