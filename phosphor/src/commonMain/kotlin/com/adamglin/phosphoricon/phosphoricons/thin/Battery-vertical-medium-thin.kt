...
public val ThinGroup.`Battery-vertical-medium-thin`: ImageVector
    get() {
        if (`_battery-vertical-medium-thin` != null) {
            return `_battery-vertical-medium-thin`!!
        }
        `_battery-vertical-medium-thin` = Builder(name = "Battery-vertical-medium-thin",
...
private var `_battery-vertical-medium-thin`: ImageVector? = null
