...
public val ThinGroup.`Arrow-square-down-left-thin`: ImageVector
    get() {
        if (`_arrow-square-down-left-thin` != null) {
            return `_arrow-square-down-left-thin`!!
        }
        `_arrow-square-down-left-thin` = Builder(name = "Arrow-square-down-left-thin", defaultWidth
...
private var `_arrow-square-down-left-thin`: ImageVector? = null
