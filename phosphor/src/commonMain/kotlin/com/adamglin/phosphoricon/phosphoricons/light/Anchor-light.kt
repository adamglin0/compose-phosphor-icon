...
public val LightGroup.`Anchor-light`: ImageVector
    get() {
        if (`_anchor-light` != null) {
            return `_anchor-light`!!
        }
        `_anchor-light` = Builder(name = "Anchor-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_anchor-light`: ImageVector? = null
