...
public val ThinGroup.`Soundcloud-logo-thin`: ImageVector
    get() {
        if (`_soundcloud-logo-thin` != null) {
            return `_soundcloud-logo-thin`!!
        }
        `_soundcloud-logo-thin` = Builder(name = "Soundcloud-logo-thin", defaultWidth = 256.0.dp,
...
private var `_soundcloud-logo-thin`: ImageVector? = null
