...
public val RegularGroup.`File-text`: ImageVector
    get() {
        if (`_file-text` != null) {
            return `_file-text`!!
        }
        `_file-text` = Builder(name = "File-text", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-text`: ImageVector? = null
