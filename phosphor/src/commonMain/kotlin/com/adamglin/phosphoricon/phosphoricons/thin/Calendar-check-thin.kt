...
public val ThinGroup.`Calendar-check-thin`: ImageVector
    get() {
        if (`_calendar-check-thin` != null) {
            return `_calendar-check-thin`!!
        }
        `_calendar-check-thin` = Builder(name = "Calendar-check-thin", defaultWidth = 256.0.dp,
...
private var `_calendar-check-thin`: ImageVector? = null
