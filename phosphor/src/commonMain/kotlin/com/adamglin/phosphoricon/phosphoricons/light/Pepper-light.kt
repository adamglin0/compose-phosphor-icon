...
public val LightGroup.`Pepper-light`: ImageVector
    get() {
        if (`_pepper-light` != null) {
            return `_pepper-light`!!
        }
        `_pepper-light` = Builder(name = "Pepper-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pepper-light`: ImageVector? = null
