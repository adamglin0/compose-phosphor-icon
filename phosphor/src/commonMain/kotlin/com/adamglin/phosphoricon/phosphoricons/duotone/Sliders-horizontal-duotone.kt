...
public val DuotoneGroup.`Sliders-horizontal-duotone`: ImageVector
    get() {
        if (`_sliders-horizontal-duotone` != null) {
            return `_sliders-horizontal-duotone`!!
        }
        `_sliders-horizontal-duotone` = Builder(name = "Sliders-horizontal-duotone", defaultWidth =
...
private var `_sliders-horizontal-duotone`: ImageVector? = null
