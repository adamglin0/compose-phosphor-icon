...
public val DuotoneGroup.`Disco-ball-duotone`: ImageVector
    get() {
        if (`_disco-ball-duotone` != null) {
            return `_disco-ball-duotone`!!
        }
        `_disco-ball-duotone` = Builder(name = "Disco-ball-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                reflectiveCurveToRelative(32.0f, -24.0f, 32.0f, -80.0f)
                close()
                moveTo(112.0f, 72.0f)
                reflectiveCurveTo(80.0f, 96.0f, 80.0f, 152.0f)
                horizontalLineToRelative(64.0f)
                curveTo(144.0f, 96.0f, 112.0f, 72.0f, 112.0f, 72.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(88.24f, 160.0f)
                horizontalLineToRelative(47.52f)
                curveToRelative(-2.0f, 33.52f, -16.13f, 52.95f, -23.76f, 61.08f)
                curveTo(104.36f, 212.93f, 90.23f, 193.51f, 88.24f, 160.0f)
                close()
                moveTo(88.24f, 144.0f)
                curveToRelative(2.0f, -33.52f, 16.13f, -52.95f, 23.76f, -61.08f)
                ...
                close()
                moveTo(132.33f, 221.06f)
                curveToRelative(8.65f, -12.7f, 17.93f, -32.7f, 19.44f, -61.06f)
                horizontalLineToRelative(31.77f)
                arcTo(72.16f, 72.16f, 0.0f, false, true, 132.33f, 221.06f)
                close()
                moveTo(256.0f, 88.0f)
...
private var `_disco-ball-duotone`: ImageVector? = null
