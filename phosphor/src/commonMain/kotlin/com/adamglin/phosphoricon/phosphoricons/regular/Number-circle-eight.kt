...
public val RegularGroup.`Number-circle-eight`: ImageVector
    get() {
        if (`_number-circle-eight` != null) {
            return `_number-circle-eight`!!
        }
        `_number-circle-eight` = Builder(name = "Number-circle-eight", defaultWidth = 256.0.dp,
...
private var `_number-circle-eight`: ImageVector? = null
