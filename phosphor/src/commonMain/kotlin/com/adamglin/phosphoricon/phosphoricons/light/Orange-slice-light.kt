...
public val LightGroup.`Orange-slice-light`: ImageVector
    get() {
        if (`_orange-slice-light` != null) {
            return `_orange-slice-light`!!
        }
        `_orange-slice-light` = Builder(name = "Orange-slice-light", defaultWidth = 256.0.dp,
...
private var `_orange-slice-light`: ImageVector? = null
