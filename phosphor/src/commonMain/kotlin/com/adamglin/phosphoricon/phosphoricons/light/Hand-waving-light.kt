...
public val LightGroup.`Hand-waving-light`: ImageVector
    get() {
        if (`_hand-waving-light` != null) {
            return `_hand-waving-light`!!
        }
        `_hand-waving-light` = Builder(name = "Hand-waving-light", defaultWidth = 256.0.dp,
...
private var `_hand-waving-light`: ImageVector? = null
