...
public val LightGroup.`Arrow-fat-lines-right-light`: ImageVector
    get() {
        if (`_arrow-fat-lines-right-light` != null) {
            return `_arrow-fat-lines-right-light`!!
        }
        `_arrow-fat-lines-right-light` = Builder(name = "Arrow-fat-lines-right-light", defaultWidth
...
private var `_arrow-fat-lines-right-light`: ImageVector? = null
