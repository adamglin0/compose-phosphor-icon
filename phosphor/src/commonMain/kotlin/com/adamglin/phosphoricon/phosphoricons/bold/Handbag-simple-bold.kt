...
public val BoldGroup.`Handbag-simple-bold`: ImageVector
    get() {
        if (`_handbag-simple-bold` != null) {
            return `_handbag-simple-bold`!!
        }
        `_handbag-simple-bold` = Builder(name = "Handbag-simple-bold", defaultWidth = 256.0.dp,
...
private var `_handbag-simple-bold`: ImageVector? = null
