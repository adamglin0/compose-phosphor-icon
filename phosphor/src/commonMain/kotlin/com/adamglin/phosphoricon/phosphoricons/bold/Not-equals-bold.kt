...
public val BoldGroup.`Not-equals-bold`: ImageVector
    get() {
        if (`_not-equals-bold` != null) {
            return `_not-equals-bold`!!
        }
        `_not-equals-bold` = Builder(name = "Not-equals-bold", defaultWidth = 256.0.dp,
...
private var `_not-equals-bold`: ImageVector? = null
