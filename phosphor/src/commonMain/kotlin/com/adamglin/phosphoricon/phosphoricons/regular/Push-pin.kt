...
public val RegularGroup.`Push-pin`: ImageVector
    get() {
        if (`_push-pin` != null) {
            return `_push-pin`!!
        }
        `_push-pin` = Builder(name = "Push-pin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_push-pin`: ImageVector? = null
