...
public val FillGroup.`Buildings-fill`: ImageVector
    get() {
        if (`_buildings-fill` != null) {
            return `_buildings-fill`!!
        }
        `_buildings-fill` = Builder(name = "Buildings-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_buildings-fill`: ImageVector? = null
