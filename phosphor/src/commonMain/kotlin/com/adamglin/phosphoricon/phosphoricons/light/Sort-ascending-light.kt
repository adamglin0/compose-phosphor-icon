...
public val LightGroup.`Sort-ascending-light`: ImageVector
    get() {
        if (`_sort-ascending-light` != null) {
            return `_sort-ascending-light`!!
        }
        `_sort-ascending-light` = Builder(name = "Sort-ascending-light", defaultWidth = 256.0.dp,
...
private var `_sort-ascending-light`: ImageVector? = null
