...
public val ThinGroup.`Quotes-thin`: ImageVector
    get() {
        if (`_quotes-thin` != null) {
            return `_quotes-thin`!!
        }
        `_quotes-thin` = Builder(name = "Quotes-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_quotes-thin`: ImageVector? = null
