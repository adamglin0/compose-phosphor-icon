...
public val ThinGroup.`Chart-line-down-thin`: ImageVector
    get() {
        if (`_chart-line-down-thin` != null) {
            return `_chart-line-down-thin`!!
        }
        `_chart-line-down-thin` = Builder(name = "Chart-line-down-thin", defaultWidth = 256.0.dp,
...
private var `_chart-line-down-thin`: ImageVector? = null
