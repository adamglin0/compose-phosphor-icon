...
public val LightGroup.`Command-light`: ImageVector
    get() {
        if (`_command-light` != null) {
            return `_command-light`!!
        }
        `_command-light` = Builder(name = "Command-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_command-light`: ImageVector? = null
