...
public val BoldGroup.`Hourglass-simple-low-bold`: ImageVector
    get() {
        if (`_hourglass-simple-low-bold` != null) {
            return `_hourglass-simple-low-bold`!!
        }
        `_hourglass-simple-low-bold` = Builder(name = "Hourglass-simple-low-bold", defaultWidth =
...
private var `_hourglass-simple-low-bold`: ImageVector? = null
