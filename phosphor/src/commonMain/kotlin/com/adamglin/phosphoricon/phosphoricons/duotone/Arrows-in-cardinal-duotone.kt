...
public val DuotoneGroup.`Arrows-in-cardinal-duotone`: ImageVector
    get() {
        if (`_arrows-in-cardinal-duotone` != null) {
            return `_arrows-in-cardinal-duotone`!!
        }
        `_arrows-in-cardinal-duotone` = Builder(name = "Arrows-in-cardinal-duotone", defaultWidth =
...
private var `_arrows-in-cardinal-duotone`: ImageVector? = null
