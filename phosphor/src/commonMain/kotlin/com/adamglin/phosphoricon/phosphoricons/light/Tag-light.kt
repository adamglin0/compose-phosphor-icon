...
public val LightGroup.`Tag-light`: ImageVector
    get() {
        if (`_tag-light` != null) {
            return `_tag-light`!!
        }
        `_tag-light` = Builder(name = "Tag-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tag-light`: ImageVector? = null
