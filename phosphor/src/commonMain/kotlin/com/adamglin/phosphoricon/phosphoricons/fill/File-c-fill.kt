...
public val FillGroup.`File-c-fill`: ImageVector
    get() {
        if (`_file-c-fill` != null) {
            return `_file-c-fill`!!
        }
        `_file-c-fill` = Builder(name = "File-c-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-c-fill`: ImageVector? = null
