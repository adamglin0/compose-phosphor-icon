...
public val FillGroup.`Circuitry-fill`: ImageVector
    get() {
        if (`_circuitry-fill` != null) {
            return `_circuitry-fill`!!
        }
        `_circuitry-fill` = Builder(name = "Circuitry-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_circuitry-fill`: ImageVector? = null
