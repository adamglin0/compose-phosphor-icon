...
public val DuotoneGroup.`Soccer-ball-duotone`: ImageVector
    get() {
        if (`_soccer-ball-duotone` != null) {
            return `_soccer-ball-duotone`!!
        }
        `_soccer-ball-duotone` = Builder(name = "Soccer-ball-duotone", defaultWidth = 256.0.dp,
...
private var `_soccer-ball-duotone`: ImageVector? = null
