...
public val LightGroup.`Tipi-light`: ImageVector
    get() {
        if (`_tipi-light` != null) {
            return `_tipi-light`!!
        }
        `_tipi-light` = Builder(name = "Tipi-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tipi-light`: ImageVector? = null
