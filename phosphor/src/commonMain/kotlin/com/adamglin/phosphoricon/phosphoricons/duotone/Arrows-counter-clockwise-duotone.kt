...
public val DuotoneGroup.`Arrows-counter-clockwise-duotone`: ImageVector
    get() {
        if (`_arrows-counter-clockwise-duotone` != null) {
            return `_arrows-counter-clockwise-duotone`!!
        }
        `_arrows-counter-clockwise-duotone` = Builder(name = "Arrows-counter-clockwise-duotone",
...
private var `_arrows-counter-clockwise-duotone`: ImageVector? = null
