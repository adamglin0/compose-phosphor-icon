...
public val DuotoneGroup.`User-minus-duotone`: ImageVector
    get() {
        if (`_user-minus-duotone` != null) {
            return `_user-minus-duotone`!!
        }
        `_user-minus-duotone` = Builder(name = "User-minus-duotone", defaultWidth = 256.0.dp,
...
private var `_user-minus-duotone`: ImageVector? = null
