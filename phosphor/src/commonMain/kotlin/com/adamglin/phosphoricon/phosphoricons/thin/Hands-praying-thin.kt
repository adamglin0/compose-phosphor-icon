...
public val ThinGroup.`Hands-praying-thin`: ImageVector
    get() {
        if (`_hands-praying-thin` != null) {
            return `_hands-praying-thin`!!
        }
        `_hands-praying-thin` = Builder(name = "Hands-praying-thin", defaultWidth = 256.0.dp,
...
private var `_hands-praying-thin`: ImageVector? = null
