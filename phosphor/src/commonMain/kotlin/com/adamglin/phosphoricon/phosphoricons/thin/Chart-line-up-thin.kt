...
public val ThinGroup.`Chart-line-up-thin`: ImageVector
    get() {
        if (`_chart-line-up-thin` != null) {
            return `_chart-line-up-thin`!!
        }
        `_chart-line-up-thin` = Builder(name = "Chart-line-up-thin", defaultWidth = 256.0.dp,
...
private var `_chart-line-up-thin`: ImageVector? = null
