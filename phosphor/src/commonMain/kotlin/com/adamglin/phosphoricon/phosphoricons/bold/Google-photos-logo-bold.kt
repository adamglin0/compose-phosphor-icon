...
public val BoldGroup.`Google-photos-logo-bold`: ImageVector
    get() {
        if (`_google-photos-logo-bold` != null) {
            return `_google-photos-logo-bold`!!
        }
        `_google-photos-logo-bold` = Builder(name = "Google-photos-logo-bold", defaultWidth =
...
private var `_google-photos-logo-bold`: ImageVector? = null
