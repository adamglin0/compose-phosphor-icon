...
public val ThinGroup.`Rug-thin`: ImageVector
    get() {
        if (`_rug-thin` != null) {
            return `_rug-thin`!!
        }
        `_rug-thin` = Builder(name = "Rug-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_rug-thin`: ImageVector? = null
