...
public val LightGroup.`File-png-light`: ImageVector
    get() {
        if (`_file-png-light` != null) {
            return `_file-png-light`!!
        }
        `_file-png-light` = Builder(name = "File-png-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-png-light`: ImageVector? = null
