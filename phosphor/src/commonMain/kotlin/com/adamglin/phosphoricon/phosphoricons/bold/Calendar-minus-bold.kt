...
public val BoldGroup.`Calendar-minus-bold`: ImageVector
    get() {
        if (`_calendar-minus-bold` != null) {
            return `_calendar-minus-bold`!!
        }
        `_calendar-minus-bold` = Builder(name = "Calendar-minus-bold", defaultWidth = 256.0.dp,
...
private var `_calendar-minus-bold`: ImageVector? = null
