...
public val ThinGroup.`User-focus-thin`: ImageVector
    get() {
        if (`_user-focus-thin` != null) {
            return `_user-focus-thin`!!
        }
        `_user-focus-thin` = Builder(name = "User-focus-thin", defaultWidth = 256.0.dp,
...
private var `_user-focus-thin`: ImageVector? = null
