...
public val BoldGroup.`Pinwheel-bold`: ImageVector
    get() {
        if (`_pinwheel-bold` != null) {
            return `_pinwheel-bold`!!
        }
        `_pinwheel-bold` = Builder(name = "Pinwheel-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pinwheel-bold`: ImageVector? = null
