...
public val ThinGroup.`Eyeglasses-thin`: ImageVector
    get() {
        if (`_eyeglasses-thin` != null) {
            return `_eyeglasses-thin`!!
        }
        `_eyeglasses-thin` = Builder(name = "Eyeglasses-thin", defaultWidth = 256.0.dp,
...
private var `_eyeglasses-thin`: ImageVector? = null
