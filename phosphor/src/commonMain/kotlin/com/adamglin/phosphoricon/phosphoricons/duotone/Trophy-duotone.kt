...
public val DuotoneGroup.`Trophy-duotone`: ImageVector
    get() {
        if (`_trophy-duotone` != null) {
            return `_trophy-duotone`!!
        }
        `_trophy-duotone` = Builder(name = "Trophy-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_trophy-duotone`: ImageVector? = null
