...
public val ThinGroup.`Belt-thin`: ImageVector
    get() {
        if (`_belt-thin` != null) {
            return `_belt-thin`!!
        }
        `_belt-thin` = Builder(name = "Belt-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_belt-thin`: ImageVector? = null
