...
public val ThinGroup.`Corners-in-thin`: ImageVector
    get() {
        if (`_corners-in-thin` != null) {
            return `_corners-in-thin`!!
        }
        `_corners-in-thin` = Builder(name = "Corners-in-thin", defaultWidth = 256.0.dp,
...
private var `_corners-in-thin`: ImageVector? = null
