...
public val LightGroup.`Flip-horizontal-light`: ImageVector
    get() {
        if (`_flip-horizontal-light` != null) {
            return `_flip-horizontal-light`!!
        }
        `_flip-horizontal-light` = Builder(name = "Flip-horizontal-light", defaultWidth = 256.0.dp,
...
private var `_flip-horizontal-light`: ImageVector? = null
