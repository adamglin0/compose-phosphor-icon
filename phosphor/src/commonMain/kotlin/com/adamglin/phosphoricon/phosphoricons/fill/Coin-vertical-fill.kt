...
public val FillGroup.`Coin-vertical-fill`: ImageVector
    get() {
        if (`_coin-vertical-fill` != null) {
            return `_coin-vertical-fill`!!
        }
        `_coin-vertical-fill` = Builder(name = "Coin-vertical-fill", defaultWidth = 256.0.dp,
...
private var `_coin-vertical-fill`: ImageVector? = null
