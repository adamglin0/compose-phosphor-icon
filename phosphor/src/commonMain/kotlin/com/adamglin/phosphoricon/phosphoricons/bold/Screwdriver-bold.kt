...
public val BoldGroup.`Screwdriver-bold`: ImageVector
    get() {
        if (`_screwdriver-bold` != null) {
            return `_screwdriver-bold`!!
        }
        `_screwdriver-bold` = Builder(name = "Screwdriver-bold", defaultWidth = 256.0.dp,
...
private var `_screwdriver-bold`: ImageVector? = null
