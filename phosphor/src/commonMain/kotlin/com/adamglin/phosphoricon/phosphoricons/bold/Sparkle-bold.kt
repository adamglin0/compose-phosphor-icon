...
public val BoldGroup.`Sparkle-bold`: ImageVector
    get() {
        if (`_sparkle-bold` != null) {
            return `_sparkle-bold`!!
        }
        `_sparkle-bold` = Builder(name = "Sparkle-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sparkle-bold`: ImageVector? = null
