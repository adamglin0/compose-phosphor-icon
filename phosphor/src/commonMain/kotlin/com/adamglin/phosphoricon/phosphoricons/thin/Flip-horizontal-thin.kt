...
public val ThinGroup.`Flip-horizontal-thin`: ImageVector
    get() {
        if (`_flip-horizontal-thin` != null) {
            return `_flip-horizontal-thin`!!
        }
        `_flip-horizontal-thin` = Builder(name = "Flip-horizontal-thin", defaultWidth = 256.0.dp,
...
private var `_flip-horizontal-thin`: ImageVector? = null
