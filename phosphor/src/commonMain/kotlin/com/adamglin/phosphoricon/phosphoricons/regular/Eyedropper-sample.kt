...
public val RegularGroup.`Eyedropper-sample`: ImageVector
    get() {
        if (`_eyedropper-sample` != null) {
            return `_eyedropper-sample`!!
        }
        `_eyedropper-sample` = Builder(name = "Eyedropper-sample", defaultWidth = 256.0.dp,
...
private var `_eyedropper-sample`: ImageVector? = null
