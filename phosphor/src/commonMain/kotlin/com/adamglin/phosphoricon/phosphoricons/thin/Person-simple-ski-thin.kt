...
public val ThinGroup.`Person-simple-ski-thin`: ImageVector
    get() {
        if (`_person-simple-ski-thin` != null) {
            return `_person-simple-ski-thin`!!
        }
        `_person-simple-ski-thin` = Builder(name = "Person-simple-ski-thin", defaultWidth =
...
private var `_person-simple-ski-thin`: ImageVector? = null
