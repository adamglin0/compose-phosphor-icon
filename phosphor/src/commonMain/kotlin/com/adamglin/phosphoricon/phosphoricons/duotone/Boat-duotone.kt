...
public val DuotoneGroup.`Boat-duotone`: ImageVector
    get() {
        if (`_boat-duotone` != null) {
            return `_boat-duotone`!!
        }
        `_boat-duotone` = Builder(name = "Boat-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_boat-duotone`: ImageVector? = null
