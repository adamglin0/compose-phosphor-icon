...
public val BoldGroup.`Aperture-bold`: ImageVector
    get() {
        if (`_aperture-bold` != null) {
            return `_aperture-bold`!!
        }
        `_aperture-bold` = Builder(name = "Aperture-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_aperture-bold`: ImageVector? = null
