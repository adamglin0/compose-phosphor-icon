...
public val LightGroup.`Knife-light`: ImageVector
    get() {
        if (`_knife-light` != null) {
            return `_knife-light`!!
        }
        `_knife-light` = Builder(name = "Knife-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_knife-light`: ImageVector? = null
