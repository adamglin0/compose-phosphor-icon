...
public val BoldGroup.`Cowboy-hat-bold`: ImageVector
    get() {
        if (`_cowboy-hat-bold` != null) {
            return `_cowboy-hat-bold`!!
        }
        `_cowboy-hat-bold` = Builder(name = "Cowboy-hat-bold", defaultWidth = 256.0.dp,
...
private var `_cowboy-hat-bold`: ImageVector? = null
