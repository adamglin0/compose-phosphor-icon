...
public val ThinGroup.`Push-pin-simple-slash-thin`: ImageVector
    get() {
        if (`_push-pin-simple-slash-thin` != null) {
            return `_push-pin-simple-slash-thin`!!
        }
        `_push-pin-simple-slash-thin` = Builder(name = "Push-pin-simple-slash-thin", defaultWidth =
...
private var `_push-pin-simple-slash-thin`: ImageVector? = null
