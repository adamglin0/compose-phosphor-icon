...
public val DuotoneGroup.`Train-simple-duotone`: ImageVector
    get() {
        if (`_train-simple-duotone` != null) {
            return `_train-simple-duotone`!!
        }
        `_train-simple-duotone` = Builder(name = "Train-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_train-simple-duotone`: ImageVector? = null
