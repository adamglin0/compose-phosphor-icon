...
public val ThinGroup.`Currency-krw-thin`: ImageVector
    get() {
        if (`_currency-krw-thin` != null) {
            return `_currency-krw-thin`!!
        }
        `_currency-krw-thin` = Builder(name = "Currency-krw-thin", defaultWidth = 256.0.dp,
...
private var `_currency-krw-thin`: ImageVector? = null
