...
public val FillGroup.`Users-three-fill`: ImageVector
    get() {
        if (`_users-three-fill` != null) {
            return `_users-three-fill`!!
        }
        `_users-three-fill` = Builder(name = "Users-three-fill", defaultWidth = 256.0.dp,
...
private var `_users-three-fill`: ImageVector? = null
