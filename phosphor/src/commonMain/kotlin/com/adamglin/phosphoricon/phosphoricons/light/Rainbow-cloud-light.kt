...
public val LightGroup.`Rainbow-cloud-light`: ImageVector
    get() {
        if (`_rainbow-cloud-light` != null) {
            return `_rainbow-cloud-light`!!
        }
        `_rainbow-cloud-light` = Builder(name = "Rainbow-cloud-light", defaultWidth = 256.0.dp,
...
private var `_rainbow-cloud-light`: ImageVector? = null
