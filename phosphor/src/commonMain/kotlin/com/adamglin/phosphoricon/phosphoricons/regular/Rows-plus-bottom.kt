...
public val RegularGroup.`Rows-plus-bottom`: ImageVector
    get() {
        if (`_rows-plus-bottom` != null) {
            return `_rows-plus-bottom`!!
        }
        `_rows-plus-bottom` = Builder(name = "Rows-plus-bottom", defaultWidth = 256.0.dp,
...
private var `_rows-plus-bottom`: ImageVector? = null
