...
public val ThinGroup.`Binoculars-thin`: ImageVector
    get() {
        if (`_binoculars-thin` != null) {
            return `_binoculars-thin`!!
        }
        `_binoculars-thin` = Builder(name = "Binoculars-thin", defaultWidth = 256.0.dp,
...
private var `_binoculars-thin`: ImageVector? = null
