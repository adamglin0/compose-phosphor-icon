...
public val LightGroup.`Dots-six-vertical-light`: ImageVector
    get() {
        if (`_dots-six-vertical-light` != null) {
            return `_dots-six-vertical-light`!!
        }
        `_dots-six-vertical-light` = Builder(name = "Dots-six-vertical-light", defaultWidth =
...
private var `_dots-six-vertical-light`: ImageVector? = null
