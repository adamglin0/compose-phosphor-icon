...
public val DuotoneGroup.`Book-duotone`: ImageVector
    get() {
        if (`_book-duotone` != null) {
            return `_book-duotone`!!
        }
        `_book-duotone` = Builder(name = "Book-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_book-duotone`: ImageVector? = null
