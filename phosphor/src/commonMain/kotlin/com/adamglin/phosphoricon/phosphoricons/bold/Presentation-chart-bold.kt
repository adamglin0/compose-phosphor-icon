...
public val BoldGroup.`Presentation-chart-bold`: ImageVector
    get() {
        if (`_presentation-chart-bold` != null) {
            return `_presentation-chart-bold`!!
        }
        `_presentation-chart-bold` = Builder(name = "Presentation-chart-bold", defaultWidth =
...
private var `_presentation-chart-bold`: ImageVector? = null
