...
public val FillGroup.`Metronome-fill`: ImageVector
    get() {
        if (`_metronome-fill` != null) {
            return `_metronome-fill`!!
        }
        `_metronome-fill` = Builder(name = "Metronome-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_metronome-fill`: ImageVector? = null
