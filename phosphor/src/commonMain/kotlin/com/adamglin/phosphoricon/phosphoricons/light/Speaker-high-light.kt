...
public val LightGroup.`Speaker-high-light`: ImageVector
    get() {
        if (`_speaker-high-light` != null) {
            return `_speaker-high-light`!!
        }
        `_speaker-high-light` = Builder(name = "Speaker-high-light", defaultWidth = 256.0.dp,
...
private var `_speaker-high-light`: ImageVector? = null
