...
public val FillGroup.`Dice-six-fill`: ImageVector
    get() {
        if (`_dice-six-fill` != null) {
            return `_dice-six-fill`!!
        }
        `_dice-six-fill` = Builder(name = "Dice-six-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dice-six-fill`: ImageVector? = null
