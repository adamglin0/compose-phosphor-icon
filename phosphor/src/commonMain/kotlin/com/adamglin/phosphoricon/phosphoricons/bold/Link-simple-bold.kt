...
public val BoldGroup.`Link-simple-bold`: ImageVector
    get() {
        if (`_link-simple-bold` != null) {
            return `_link-simple-bold`!!
        }
        `_link-simple-bold` = Builder(name = "Link-simple-bold", defaultWidth = 256.0.dp,
...
private var `_link-simple-bold`: ImageVector? = null
