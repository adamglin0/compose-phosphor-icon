...
public val LightGroup.`Ranking-light`: ImageVector
    get() {
        if (`_ranking-light` != null) {
            return `_ranking-light`!!
        }
        `_ranking-light` = Builder(name = "Ranking-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ranking-light`: ImageVector? = null
