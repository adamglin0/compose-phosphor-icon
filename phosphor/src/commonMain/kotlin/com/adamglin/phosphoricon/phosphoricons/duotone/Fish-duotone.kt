...
public val DuotoneGroup.`Fish-duotone`: ImageVector
    get() {
        if (`_fish-duotone` != null) {
            return `_fish-duotone`!!
        }
        `_fish-duotone` = Builder(name = "Fish-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fish-duotone`: ImageVector? = null
