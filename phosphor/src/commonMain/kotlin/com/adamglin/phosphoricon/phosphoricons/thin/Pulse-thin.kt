...
public val ThinGroup.`Pulse-thin`: ImageVector
    get() {
        if (`_pulse-thin` != null) {
            return `_pulse-thin`!!
        }
        `_pulse-thin` = Builder(name = "Pulse-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pulse-thin`: ImageVector? = null
