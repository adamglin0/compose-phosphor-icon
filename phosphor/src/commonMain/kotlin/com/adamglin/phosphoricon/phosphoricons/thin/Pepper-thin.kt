...
public val ThinGroup.`Pepper-thin`: ImageVector
    get() {
        if (`_pepper-thin` != null) {
            return `_pepper-thin`!!
        }
        `_pepper-thin` = Builder(name = "Pepper-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pepper-thin`: ImageVector? = null
