...
public val DuotoneGroup.`Align-center-horizontal-duotone`: ImageVector
    get() {
        if (`_align-center-horizontal-duotone` != null) {
            return `_align-center-horizontal-duotone`!!
        }
        `_align-center-horizontal-duotone` = Builder(name = "Align-center-horizontal-duotone",
...
private var `_align-center-horizontal-duotone`: ImageVector? = null
