...
public val LightGroup.`Google-drive-logo-light`: ImageVector
    get() {
        if (`_google-drive-logo-light` != null) {
            return `_google-drive-logo-light`!!
        }
        `_google-drive-logo-light` = Builder(name = "Google-drive-logo-light", defaultWidth =
...
private var `_google-drive-logo-light`: ImageVector? = null
