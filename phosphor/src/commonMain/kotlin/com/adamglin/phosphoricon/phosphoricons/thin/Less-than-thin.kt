...
public val ThinGroup.`Less-than-thin`: ImageVector
    get() {
        if (`_less-than-thin` != null) {
            return `_less-than-thin`!!
        }
        `_less-than-thin` = Builder(name = "Less-than-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_less-than-thin`: ImageVector? = null
