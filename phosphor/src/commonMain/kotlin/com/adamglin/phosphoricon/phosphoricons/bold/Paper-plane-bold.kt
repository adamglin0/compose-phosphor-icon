...
public val BoldGroup.`Paper-plane-bold`: ImageVector
    get() {
        if (`_paper-plane-bold` != null) {
            return `_paper-plane-bold`!!
        }
        `_paper-plane-bold` = Builder(name = "Paper-plane-bold", defaultWidth = 256.0.dp,
...
private var `_paper-plane-bold`: ImageVector? = null
