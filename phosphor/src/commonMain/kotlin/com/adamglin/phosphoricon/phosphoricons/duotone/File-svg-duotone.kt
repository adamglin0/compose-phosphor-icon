...
public val DuotoneGroup.`File-svg-duotone`: ImageVector
    get() {
        if (`_file-svg-duotone` != null) {
            return `_file-svg-duotone`!!
        }
        `_file-svg-duotone` = Builder(name = "File-svg-duotone", defaultWidth = 256.0.dp,
...
private var `_file-svg-duotone`: ImageVector? = null
