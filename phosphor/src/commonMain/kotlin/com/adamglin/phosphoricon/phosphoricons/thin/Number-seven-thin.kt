...
public val ThinGroup.`Number-seven-thin`: ImageVector
    get() {
        if (`_number-seven-thin` != null) {
            return `_number-seven-thin`!!
        }
        `_number-seven-thin` = Builder(name = "Number-seven-thin", defaultWidth = 256.0.dp,
...
private var `_number-seven-thin`: ImageVector? = null
