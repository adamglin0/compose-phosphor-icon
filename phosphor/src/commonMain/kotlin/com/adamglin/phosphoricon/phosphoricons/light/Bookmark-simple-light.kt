...
public val LightGroup.`Bookmark-simple-light`: ImageVector
    get() {
        if (`_bookmark-simple-light` != null) {
            return `_bookmark-simple-light`!!
        }
        `_bookmark-simple-light` = Builder(name = "Bookmark-simple-light", defaultWidth = 256.0.dp,
...
private var `_bookmark-simple-light`: ImageVector? = null
