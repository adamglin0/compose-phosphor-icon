...
public val DuotoneGroup.`Superset-of-duotone`: ImageVector
    get() {
        if (`_superset-of-duotone` != null) {
            return `_superset-of-duotone`!!
        }
        `_superset-of-duotone` = Builder(name = "Superset-of-duotone", defaultWidth = 256.0.dp,
...
private var `_superset-of-duotone`: ImageVector? = null
