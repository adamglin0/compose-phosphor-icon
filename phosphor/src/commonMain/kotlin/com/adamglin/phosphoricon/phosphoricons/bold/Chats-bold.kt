...
public val BoldGroup.`Chats-bold`: ImageVector
    get() {
        if (`_chats-bold` != null) {
            return `_chats-bold`!!
        }
        `_chats-bold` = Builder(name = "Chats-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chats-bold`: ImageVector? = null
