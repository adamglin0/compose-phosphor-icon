...
public val BoldGroup.`Mouse-simple-bold`: ImageVector
    get() {
        if (`_mouse-simple-bold` != null) {
            return `_mouse-simple-bold`!!
        }
        `_mouse-simple-bold` = Builder(name = "Mouse-simple-bold", defaultWidth = 256.0.dp,
...
private var `_mouse-simple-bold`: ImageVector? = null
