...
public val LightGroup.`Unite-square-light`: ImageVector
    get() {
        if (`_unite-square-light` != null) {
            return `_unite-square-light`!!
        }
        `_unite-square-light` = Builder(name = "Unite-square-light", defaultWidth = 256.0.dp,
...
private var `_unite-square-light`: ImageVector? = null
