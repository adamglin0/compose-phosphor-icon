...
public val ThinGroup.`Chart-donut-thin`: ImageVector
    get() {
        if (`_chart-donut-thin` != null) {
            return `_chart-donut-thin`!!
        }
        `_chart-donut-thin` = Builder(name = "Chart-donut-thin", defaultWidth = 256.0.dp,
...
private var `_chart-donut-thin`: ImageVector? = null
