...
public val ThinGroup.`Thumbs-down-thin`: ImageVector
    get() {
        if (`_thumbs-down-thin` != null) {
            return `_thumbs-down-thin`!!
        }
        `_thumbs-down-thin` = Builder(name = "Thumbs-down-thin", defaultWidth = 256.0.dp,
...
private var `_thumbs-down-thin`: ImageVector? = null
