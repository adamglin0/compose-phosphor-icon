...
public val DuotoneGroup.`Magnet-straight-duotone`: ImageVector
    get() {
        if (`_magnet-straight-duotone` != null) {
            return `_magnet-straight-duotone`!!
        }
        `_magnet-straight-duotone` = Builder(name = "Magnet-straight-duotone", defaultWidth =
...
private var `_magnet-straight-duotone`: ImageVector? = null
