...
public val BoldGroup.`Dresser-bold`: ImageVector
    get() {
        if (`_dresser-bold` != null) {
            return `_dresser-bold`!!
        }
        `_dresser-bold` = Builder(name = "Dresser-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dresser-bold`: ImageVector? = null
