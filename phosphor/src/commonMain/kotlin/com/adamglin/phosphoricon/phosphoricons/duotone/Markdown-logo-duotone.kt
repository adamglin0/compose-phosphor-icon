...
public val DuotoneGroup.`Markdown-logo-duotone`: ImageVector
    get() {
        if (`_markdown-logo-duotone` != null) {
            return `_markdown-logo-duotone`!!
        }
        `_markdown-logo-duotone` = Builder(name = "Markdown-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_markdown-logo-duotone`: ImageVector? = null
