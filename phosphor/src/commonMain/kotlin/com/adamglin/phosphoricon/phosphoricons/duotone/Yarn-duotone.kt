...
public val DuotoneGroup.`Yarn-duotone`: ImageVector
    get() {
        if (`_yarn-duotone` != null) {
            return `_yarn-duotone`!!
        }
        `_yarn-duotone` = Builder(name = "Yarn-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_yarn-duotone`: ImageVector? = null
