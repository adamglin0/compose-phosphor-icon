...
public val DuotoneGroup.`Bell-simple-z-duotone`: ImageVector
    get() {
        if (`_bell-simple-z-duotone` != null) {
            return `_bell-simple-z-duotone`!!
        }
        `_bell-simple-z-duotone` = Builder(name = "Bell-simple-z-duotone", defaultWidth = 256.0.dp,
...
private var `_bell-simple-z-duotone`: ImageVector? = null
