...
public val DuotoneGroup.`Phone-outgoing-duotone`: ImageVector
    get() {
        if (`_phone-outgoing-duotone` != null) {
            return `_phone-outgoing-duotone`!!
        }
        `_phone-outgoing-duotone` = Builder(name = "Phone-outgoing-duotone", defaultWidth =
...
private var `_phone-outgoing-duotone`: ImageVector? = null
