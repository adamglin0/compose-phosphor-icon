...
public val DuotoneGroup.`Cloud-rain-duotone`: ImageVector
    get() {
        if (`_cloud-rain-duotone` != null) {
            return `_cloud-rain-duotone`!!
        }
        `_cloud-rain-duotone` = Builder(name = "Cloud-rain-duotone", defaultWidth = 256.0.dp,
...
private var `_cloud-rain-duotone`: ImageVector? = null
