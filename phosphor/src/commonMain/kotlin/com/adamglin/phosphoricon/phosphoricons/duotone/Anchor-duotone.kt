...
public val DuotoneGroup.`Anchor-duotone`: ImageVector
    get() {
        if (`_anchor-duotone` != null) {
            return `_anchor-duotone`!!
        }
        `_anchor-duotone` = Builder(name = "Anchor-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_anchor-duotone`: ImageVector? = null
