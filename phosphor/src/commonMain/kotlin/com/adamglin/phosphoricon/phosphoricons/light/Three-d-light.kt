...
public val LightGroup.`Three-d-light`: ImageVector
    get() {
        if (`_three-d-light` != null) {
            return `_three-d-light`!!
        }
        `_three-d-light` = Builder(name = "Three-d-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_three-d-light`: ImageVector? = null
