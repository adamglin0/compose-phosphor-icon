...
public val LightGroup.`Line-segments-light`: ImageVector
    get() {
        if (`_line-segments-light` != null) {
            return `_line-segments-light`!!
        }
        `_line-segments-light` = Builder(name = "Line-segments-light", defaultWidth = 256.0.dp,
...
private var `_line-segments-light`: ImageVector? = null
