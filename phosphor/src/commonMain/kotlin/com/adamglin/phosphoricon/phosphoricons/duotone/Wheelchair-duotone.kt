...
public val DuotoneGroup.`Wheelchair-duotone`: ImageVector
    get() {
        if (`_wheelchair-duotone` != null) {
            return `_wheelchair-duotone`!!
        }
        `_wheelchair-duotone` = Builder(name = "Wheelchair-duotone", defaultWidth = 256.0.dp,
...
private var `_wheelchair-duotone`: ImageVector? = null
