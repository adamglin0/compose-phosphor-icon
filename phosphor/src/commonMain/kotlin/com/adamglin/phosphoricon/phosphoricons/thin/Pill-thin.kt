...
public val ThinGroup.`Pill-thin`: ImageVector
    get() {
        if (`_pill-thin` != null) {
            return `_pill-thin`!!
        }
        `_pill-thin` = Builder(name = "Pill-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pill-thin`: ImageVector? = null
