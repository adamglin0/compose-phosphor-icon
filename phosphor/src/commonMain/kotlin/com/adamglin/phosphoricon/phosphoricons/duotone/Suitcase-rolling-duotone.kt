...
public val DuotoneGroup.`Suitcase-rolling-duotone`: ImageVector
    get() {
        if (`_suitcase-rolling-duotone` != null) {
            return `_suitcase-rolling-duotone`!!
        }
        `_suitcase-rolling-duotone` = Builder(name = "Suitcase-rolling-duotone", defaultWidth =
...
private var `_suitcase-rolling-duotone`: ImageVector? = null
