...
public val BoldGroup.`Airplane-takeoff-bold`: ImageVector
    get() {
        if (`_airplane-takeoff-bold` != null) {
            return `_airplane-takeoff-bold`!!
        }
        `_airplane-takeoff-bold` = Builder(name = "Airplane-takeoff-bold", defaultWidth = 256.0.dp,
...
private var `_airplane-takeoff-bold`: ImageVector? = null
