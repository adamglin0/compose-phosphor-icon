...
public val DuotoneGroup.`User-circle-dashed-duotone`: ImageVector
    get() {
        if (`_user-circle-dashed-duotone` != null) {
            return `_user-circle-dashed-duotone`!!
        }
        `_user-circle-dashed-duotone` = Builder(name = "User-circle-dashed-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.67f, 4.23f)
                arcToRelative(8.11f, 8.11f, 0.0f, false, true, -1.46f, 0.14f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.35f, -2.05f)
...
private var `_user-circle-dashed-duotone`: ImageVector? = null
