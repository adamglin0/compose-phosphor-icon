...
public val DuotoneGroup.`Star-duotone`: ImageVector
    get() {
        if (`_star-duotone` != null) {
            return `_star-duotone`!!
        }
        `_star-duotone` = Builder(name = "Star-duotone", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(229.06f, 108.79f)
                lineToRelative(-48.7f, 42.0f)
                lineToRelative(14.88f, 62.79f)
                arcToRelative(8.4f, 8.4f, 0.0f, false, true, -12.52f, 9.17f)
                lineTo(128.0f, 189.09f)
                ...
                arcToRelative(8.36f, 8.36f, 0.0f, false, true, 15.48f, 0.0f)
                lineToRelative(24.62f, 59.6f)
                lineTo(224.27f, 94.0f)
                arcTo(8.46f, 8.46f, 0.0f, false, true, 229.06f, 108.79f)
                close()
            }
...
private var `_star-duotone`: ImageVector? = null
