...
public val BoldGroup.`Arrows-in-line-vertical-bold`: ImageVector
    get() {
        if (`_arrows-in-line-vertical-bold` != null) {
            return `_arrows-in-line-vertical-bold`!!
        }
        `_arrows-in-line-vertical-bold` = Builder(name = "Arrows-in-line-vertical-bold",
...
private var `_arrows-in-line-vertical-bold`: ImageVector? = null
