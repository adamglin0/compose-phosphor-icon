...
public val LightGroup.`File-zip-light`: ImageVector
    get() {
        if (`_file-zip-light` != null) {
            return `_file-zip-light`!!
        }
        `_file-zip-light` = Builder(name = "File-zip-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-zip-light`: ImageVector? = null
