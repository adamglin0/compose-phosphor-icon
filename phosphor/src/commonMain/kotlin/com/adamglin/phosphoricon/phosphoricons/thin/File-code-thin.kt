...
public val ThinGroup.`File-code-thin`: ImageVector
    get() {
        if (`_file-code-thin` != null) {
            return `_file-code-thin`!!
        }
        `_file-code-thin` = Builder(name = "File-code-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-code-thin`: ImageVector? = null
