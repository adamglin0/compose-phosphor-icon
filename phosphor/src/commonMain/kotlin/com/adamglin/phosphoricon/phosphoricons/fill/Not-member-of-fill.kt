...
public val FillGroup.`Not-member-of-fill`: ImageVector
    get() {
        if (`_not-member-of-fill` != null) {
            return `_not-member-of-fill`!!
        }
        `_not-member-of-fill` = Builder(name = "Not-member-of-fill", defaultWidth = 256.0.dp,
...
private var `_not-member-of-fill`: ImageVector? = null
