...
public val BoldGroup.`Tumblr-logo-bold`: ImageVector
    get() {
        if (`_tumblr-logo-bold` != null) {
            return `_tumblr-logo-bold`!!
        }
        `_tumblr-logo-bold` = Builder(name = "Tumblr-logo-bold", defaultWidth = 256.0.dp,
...
private var `_tumblr-logo-bold`: ImageVector? = null
