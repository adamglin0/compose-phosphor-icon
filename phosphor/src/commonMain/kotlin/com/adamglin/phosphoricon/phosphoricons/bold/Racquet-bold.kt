...
public val BoldGroup.`Racquet-bold`: ImageVector
    get() {
        if (`_racquet-bold` != null) {
            return `_racquet-bold`!!
        }
        `_racquet-bold` = Builder(name = "Racquet-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_racquet-bold`: ImageVector? = null
