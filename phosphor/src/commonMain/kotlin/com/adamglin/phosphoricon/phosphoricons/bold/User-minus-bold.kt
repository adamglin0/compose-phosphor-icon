...
public val BoldGroup.`User-minus-bold`: ImageVector
    get() {
        if (`_user-minus-bold` != null) {
            return `_user-minus-bold`!!
        }
        `_user-minus-bold` = Builder(name = "User-minus-bold", defaultWidth = 256.0.dp,
...
private var `_user-minus-bold`: ImageVector? = null
