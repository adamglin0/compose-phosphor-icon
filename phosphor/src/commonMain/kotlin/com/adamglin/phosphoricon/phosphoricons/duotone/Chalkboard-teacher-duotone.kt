...
public val DuotoneGroup.`Chalkboard-teacher-duotone`: ImageVector
    get() {
        if (`_chalkboard-teacher-duotone` != null) {
            return `_chalkboard-teacher-duotone`!!
        }
        `_chalkboard-teacher-duotone` = Builder(name = "Chalkboard-teacher-duotone", defaultWidth =
...
private var `_chalkboard-teacher-duotone`: ImageVector? = null
