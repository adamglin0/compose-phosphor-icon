...
public val LightGroup.`Standard-definition-light`: ImageVector
    get() {
        if (`_standard-definition-light` != null) {
            return `_standard-definition-light`!!
        }
        `_standard-definition-light` = Builder(name = "Standard-definition-light", defaultWidth =
...
private var `_standard-definition-light`: ImageVector? = null
