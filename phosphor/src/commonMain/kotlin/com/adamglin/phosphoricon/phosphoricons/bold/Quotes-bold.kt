...
public val BoldGroup.`Quotes-bold`: ImageVector
    get() {
        if (`_quotes-bold` != null) {
            return `_quotes-bold`!!
        }
        `_quotes-bold` = Builder(name = "Quotes-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_quotes-bold`: ImageVector? = null
