...
public val ThinGroup.`Warning-octagon-thin`: ImageVector
    get() {
        if (`_warning-octagon-thin` != null) {
            return `_warning-octagon-thin`!!
        }
        `_warning-octagon-thin` = Builder(name = "Warning-octagon-thin", defaultWidth = 256.0.dp,
...
private var `_warning-octagon-thin`: ImageVector? = null
