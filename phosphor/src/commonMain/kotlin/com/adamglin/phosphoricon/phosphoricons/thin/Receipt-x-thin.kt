...
public val ThinGroup.`Receipt-x-thin`: ImageVector
    get() {
        if (`_receipt-x-thin` != null) {
            return `_receipt-x-thin`!!
        }
        `_receipt-x-thin` = Builder(name = "Receipt-x-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_receipt-x-thin`: ImageVector? = null
