...
public val LightGroup.`Framer-logo-light`: ImageVector
    get() {
        if (`_framer-logo-light` != null) {
            return `_framer-logo-light`!!
        }
        `_framer-logo-light` = Builder(name = "Framer-logo-light", defaultWidth = 256.0.dp,
...
private var `_framer-logo-light`: ImageVector? = null
