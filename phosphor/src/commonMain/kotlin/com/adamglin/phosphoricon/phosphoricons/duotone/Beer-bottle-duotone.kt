...
public val DuotoneGroup.`Beer-bottle-duotone`: ImageVector
    get() {
        if (`_beer-bottle-duotone` != null) {
            return `_beer-bottle-duotone`!!
        }
        `_beer-bottle-duotone` = Builder(name = "Beer-bottle-duotone", defaultWidth = 256.0.dp,
...
private var `_beer-bottle-duotone`: ImageVector? = null
