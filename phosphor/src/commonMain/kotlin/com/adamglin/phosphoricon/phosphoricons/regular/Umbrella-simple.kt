...
public val RegularGroup.`Umbrella-simple`: ImageVector
    get() {
        if (`_umbrella-simple` != null) {
            return `_umbrella-simple`!!
        }
        `_umbrella-simple` = Builder(name = "Umbrella-simple", defaultWidth = 256.0.dp,
...
private var `_umbrella-simple`: ImageVector? = null
