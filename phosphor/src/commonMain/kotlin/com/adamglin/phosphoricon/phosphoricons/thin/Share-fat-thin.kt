...
public val ThinGroup.`Share-fat-thin`: ImageVector
    get() {
        if (`_share-fat-thin` != null) {
            return `_share-fat-thin`!!
        }
        `_share-fat-thin` = Builder(name = "Share-fat-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_share-fat-thin`: ImageVector? = null
