...
public val LightGroup.`List-magnifying-glass-light`: ImageVector
    get() {
        if (`_list-magnifying-glass-light` != null) {
            return `_list-magnifying-glass-light`!!
        }
        `_list-magnifying-glass-light` = Builder(name = "List-magnifying-glass-light", defaultWidth
...
private var `_list-magnifying-glass-light`: ImageVector? = null
