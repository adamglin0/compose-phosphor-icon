...
public val DuotoneGroup.`Hurricane-duotone`: ImageVector
    get() {
        if (`_hurricane-duotone` != null) {
            return `_hurricane-duotone`!!
        }
        `_hurricane-duotone` = Builder(name = "Hurricane-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(160.0f, 8.0f)
                reflectiveCurveTo(48.0f, 32.0f, 48.0f, 128.0f)
                arcToRelative(80.0f, 80.0f, 0.0f, false, false, 59.38f, 77.32f)
                lineTo(96.0f, 248.0f)
                reflectiveCurveToRelative(112.0f, -24.0f, 112.0f, -120.0f)
                arcTo(80.0f, 80.0f, 0.0f, false, false, 148.62f, 50.68f)
                close()
...
private var `_hurricane-duotone`: ImageVector? = null
