...
public val BoldGroup.`List-star-bold`: ImageVector
    get() {
        if (`_list-star-bold` != null) {
            return `_list-star-bold`!!
        }
        `_list-star-bold` = Builder(name = "List-star-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_list-star-bold`: ImageVector? = null
