...
public val LightGroup.`Arrow-bend-double-up-left-light`: ImageVector
    get() {
        if (`_arrow-bend-double-up-left-light` != null) {
            return `_arrow-bend-double-up-left-light`!!
        }
        `_arrow-bend-double-up-left-light` = Builder(name = "Arrow-bend-double-up-left-light",
...
private var `_arrow-bend-double-up-left-light`: ImageVector? = null
