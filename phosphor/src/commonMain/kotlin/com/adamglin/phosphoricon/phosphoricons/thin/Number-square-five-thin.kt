...
public val ThinGroup.`Number-square-five-thin`: ImageVector
    get() {
        if (`_number-square-five-thin` != null) {
            return `_number-square-five-thin`!!
        }
        `_number-square-five-thin` = Builder(name = "Number-square-five-thin", defaultWidth =
...
private var `_number-square-five-thin`: ImageVector? = null
