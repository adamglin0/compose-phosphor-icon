...
public val DuotoneGroup.`User-plus-duotone`: ImageVector
    get() {
        if (`_user-plus-duotone` != null) {
            return `_user-plus-duotone`!!
        }
        `_user-plus-duotone` = Builder(name = "User-plus-duotone", defaultWidth = 256.0.dp,
...
private var `_user-plus-duotone`: ImageVector? = null
