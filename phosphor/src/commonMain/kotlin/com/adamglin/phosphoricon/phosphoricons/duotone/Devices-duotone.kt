...
public val DuotoneGroup.`Devices-duotone`: ImageVector
    get() {
        if (`_devices-duotone` != null) {
            return `_devices-duotone`!!
        }
        `_devices-duotone` = Builder(name = "Devices-duotone", defaultWidth = 256.0.dp,
...
private var `_devices-duotone`: ImageVector? = null
