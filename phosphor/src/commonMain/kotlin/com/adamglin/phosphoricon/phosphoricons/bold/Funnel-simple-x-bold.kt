...
public val BoldGroup.`Funnel-simple-x-bold`: ImageVector
    get() {
        if (`_funnel-simple-x-bold` != null) {
            return `_funnel-simple-x-bold`!!
        }
        `_funnel-simple-x-bold` = Builder(name = "Funnel-simple-x-bold", defaultWidth = 256.0.dp,
...
private var `_funnel-simple-x-bold`: ImageVector? = null
