...
public val LightGroup.`Treasure-chest-light`: ImageVector
    get() {
        if (`_treasure-chest-light` != null) {
            return `_treasure-chest-light`!!
        }
        `_treasure-chest-light` = Builder(name = "Treasure-chest-light", defaultWidth = 256.0.dp,
...
private var `_treasure-chest-light`: ImageVector? = null
