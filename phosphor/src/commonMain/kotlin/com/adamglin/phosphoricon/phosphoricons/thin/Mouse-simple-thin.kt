...
public val ThinGroup.`Mouse-simple-thin`: ImageVector
    get() {
        if (`_mouse-simple-thin` != null) {
            return `_mouse-simple-thin`!!
        }
        `_mouse-simple-thin` = Builder(name = "Mouse-simple-thin", defaultWidth = 256.0.dp,
...
private var `_mouse-simple-thin`: ImageVector? = null
