...
public val ThinGroup.`Smiley-angry-thin`: ImageVector
    get() {
        if (`_smiley-angry-thin` != null) {
            return `_smiley-angry-thin`!!
        }
        `_smiley-angry-thin` = Builder(name = "Smiley-angry-thin", defaultWidth = 256.0.dp,
...
private var `_smiley-angry-thin`: ImageVector? = null
