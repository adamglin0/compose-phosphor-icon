...
public val BoldGroup.`Folder-bold`: ImageVector
    get() {
        if (`_folder-bold` != null) {
            return `_folder-bold`!!
        }
        `_folder-bold` = Builder(name = "Folder-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folder-bold`: ImageVector? = null
