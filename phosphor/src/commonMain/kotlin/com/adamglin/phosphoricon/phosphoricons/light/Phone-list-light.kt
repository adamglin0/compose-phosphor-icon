...
public val LightGroup.`Phone-list-light`: ImageVector
    get() {
        if (`_phone-list-light` != null) {
            return `_phone-list-light`!!
        }
        `_phone-list-light` = Builder(name = "Phone-list-light", defaultWidth = 256.0.dp,
...
private var `_phone-list-light`: ImageVector? = null
