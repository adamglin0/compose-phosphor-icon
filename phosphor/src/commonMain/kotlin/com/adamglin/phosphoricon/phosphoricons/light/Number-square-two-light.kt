...
public val LightGroup.`Number-square-two-light`: ImageVector
    get() {
        if (`_number-square-two-light` != null) {
            return `_number-square-two-light`!!
        }
        `_number-square-two-light` = Builder(name = "Number-square-two-light", defaultWidth =
...
private var `_number-square-two-light`: ImageVector? = null
