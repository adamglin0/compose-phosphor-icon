...
public val LightGroup.`Google-chrome-logo-light`: ImageVector
    get() {
        if (`_google-chrome-logo-light` != null) {
            return `_google-chrome-logo-light`!!
        }
        `_google-chrome-logo-light` = Builder(name = "Google-chrome-logo-light", defaultWidth =
...
private var `_google-chrome-logo-light`: ImageVector? = null
