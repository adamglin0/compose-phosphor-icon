...
public val DuotoneGroup.`Horse-duotone`: ImageVector
    get() {
        if (`_horse-duotone` != null) {
            return `_horse-duotone`!!
        }
        `_horse-duotone` = Builder(name = "Horse-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_horse-duotone`: ImageVector? = null
