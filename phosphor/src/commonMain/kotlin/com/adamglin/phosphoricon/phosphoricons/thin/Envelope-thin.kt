...
public val ThinGroup.`Envelope-thin`: ImageVector
    get() {
        if (`_envelope-thin` != null) {
            return `_envelope-thin`!!
        }
        `_envelope-thin` = Builder(name = "Envelope-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_envelope-thin`: ImageVector? = null
