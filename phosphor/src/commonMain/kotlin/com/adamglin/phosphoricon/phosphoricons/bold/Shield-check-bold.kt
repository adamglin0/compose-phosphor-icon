...
public val BoldGroup.`Shield-check-bold`: ImageVector
    get() {
        if (`_shield-check-bold` != null) {
            return `_shield-check-bold`!!
        }
        `_shield-check-bold` = Builder(name = "Shield-check-bold", defaultWidth = 256.0.dp,
...
private var `_shield-check-bold`: ImageVector? = null
