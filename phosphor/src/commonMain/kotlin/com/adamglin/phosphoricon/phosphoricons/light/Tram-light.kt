...
public val LightGroup.`Tram-light`: ImageVector
    get() {
        if (`_tram-light` != null) {
            return `_tram-light`!!
        }
        `_tram-light` = Builder(name = "Tram-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tram-light`: ImageVector? = null
