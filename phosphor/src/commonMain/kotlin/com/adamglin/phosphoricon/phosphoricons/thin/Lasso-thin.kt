...
public val ThinGroup.`Lasso-thin`: ImageVector
    get() {
        if (`_lasso-thin` != null) {
            return `_lasso-thin`!!
        }
        `_lasso-thin` = Builder(name = "Lasso-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lasso-thin`: ImageVector? = null
