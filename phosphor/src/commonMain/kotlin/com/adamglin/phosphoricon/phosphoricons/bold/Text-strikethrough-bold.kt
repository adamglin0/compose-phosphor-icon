...
public val BoldGroup.`Text-strikethrough-bold`: ImageVector
    get() {
        if (`_text-strikethrough-bold` != null) {
            return `_text-strikethrough-bold`!!
        }
        `_text-strikethrough-bold` = Builder(name = "Text-strikethrough-bold", defaultWidth =
...
private var `_text-strikethrough-bold`: ImageVector? = null
