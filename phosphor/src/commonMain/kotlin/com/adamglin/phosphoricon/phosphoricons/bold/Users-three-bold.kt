...
public val BoldGroup.`Users-three-bold`: ImageVector
    get() {
        if (`_users-three-bold` != null) {
            return `_users-three-bold`!!
        }
        `_users-three-bold` = Builder(name = "Users-three-bold", defaultWidth = 256.0.dp,
...
private var `_users-three-bold`: ImageVector? = null
