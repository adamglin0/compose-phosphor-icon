...
public val ThinGroup.`User-circle-check-thin`: ImageVector
    get() {
        if (`_user-circle-check-thin` != null) {
            return `_user-circle-check-thin`!!
        }
        `_user-circle-check-thin` = Builder(name = "User-circle-check-thin", defaultWidth =
...
private var `_user-circle-check-thin`: ImageVector? = null
