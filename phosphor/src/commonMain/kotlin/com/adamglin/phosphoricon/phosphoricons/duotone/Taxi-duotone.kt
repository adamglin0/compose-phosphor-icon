...
public val DuotoneGroup.`Taxi-duotone`: ImageVector
    get() {
        if (`_taxi-duotone` != null) {
            return `_taxi-duotone`!!
        }
        `_taxi-duotone` = Builder(name = "Taxi-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_taxi-duotone`: ImageVector? = null
