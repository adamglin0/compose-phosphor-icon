...
public val ThinGroup.`Chat-teardrop-dots-thin`: ImageVector
    get() {
        if (`_chat-teardrop-dots-thin` != null) {
            return `_chat-teardrop-dots-thin`!!
        }
        `_chat-teardrop-dots-thin` = Builder(name = "Chat-teardrop-dots-thin", defaultWidth =
...
private var `_chat-teardrop-dots-thin`: ImageVector? = null
