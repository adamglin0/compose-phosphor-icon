...
public val DuotoneGroup.`Device-rotate-duotone`: ImageVector
    get() {
        if (`_device-rotate-duotone` != null) {
            return `_device-rotate-duotone`!!
        }
        `_device-rotate-duotone` = Builder(name = "Device-rotate-duotone", defaultWidth = 256.0.dp,
...
private var `_device-rotate-duotone`: ImageVector? = null
