...
public val LightGroup.`Sailboat-light`: ImageVector
    get() {
        if (`_sailboat-light` != null) {
            return `_sailboat-light`!!
        }
        `_sailboat-light` = Builder(name = "Sailboat-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_sailboat-light`: ImageVector? = null
