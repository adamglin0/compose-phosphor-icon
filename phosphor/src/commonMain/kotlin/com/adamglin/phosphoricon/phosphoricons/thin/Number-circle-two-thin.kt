...
public val ThinGroup.`Number-circle-two-thin`: ImageVector
    get() {
        if (`_number-circle-two-thin` != null) {
            return `_number-circle-two-thin`!!
        }
        `_number-circle-two-thin` = Builder(name = "Number-circle-two-thin", defaultWidth =
...
private var `_number-circle-two-thin`: ImageVector? = null
