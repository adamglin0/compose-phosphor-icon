...
public val FillGroup.`Mask-happy-fill`: ImageVector
    get() {
        if (`_mask-happy-fill` != null) {
            return `_mask-happy-fill`!!
        }
        `_mask-happy-fill` = Builder(name = "Mask-happy-fill", defaultWidth = 256.0.dp,
...
private var `_mask-happy-fill`: ImageVector? = null
