...
public val LightGroup.`Confetti-light`: ImageVector
    get() {
        if (`_confetti-light` != null) {
            return `_confetti-light`!!
        }
        `_confetti-light` = Builder(name = "Confetti-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_confetti-light`: ImageVector? = null
