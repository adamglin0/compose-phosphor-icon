...
public val DuotoneGroup.`Hourglass-simple-duotone`: ImageVector
    get() {
        if (`_hourglass-simple-duotone` != null) {
            return `_hourglass-simple-duotone`!!
        }
        `_hourglass-simple-duotone` = Builder(name = "Hourglass-simple-duotone", defaultWidth =
...
private var `_hourglass-simple-duotone`: ImageVector? = null
