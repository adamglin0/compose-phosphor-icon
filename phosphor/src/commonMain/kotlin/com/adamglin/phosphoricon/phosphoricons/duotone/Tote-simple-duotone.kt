...
public val DuotoneGroup.`Tote-simple-duotone`: ImageVector
    get() {
        if (`_tote-simple-duotone` != null) {
            return `_tote-simple-duotone`!!
        }
        `_tote-simple-duotone` = Builder(name = "Tote-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_tote-simple-duotone`: ImageVector? = null
