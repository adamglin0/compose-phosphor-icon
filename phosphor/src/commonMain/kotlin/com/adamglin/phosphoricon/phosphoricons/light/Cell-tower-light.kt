...
public val LightGroup.`Cell-tower-light`: ImageVector
    get() {
        if (`_cell-tower-light` != null) {
            return `_cell-tower-light`!!
        }
        `_cell-tower-light` = Builder(name = "Cell-tower-light", defaultWidth = 256.0.dp,
...
private var `_cell-tower-light`: ImageVector? = null
