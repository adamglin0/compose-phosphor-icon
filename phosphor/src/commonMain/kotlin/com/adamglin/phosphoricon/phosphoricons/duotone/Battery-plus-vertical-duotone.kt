...
public val DuotoneGroup.`Battery-plus-vertical-duotone`: ImageVector
    get() {
        if (`_battery-plus-vertical-duotone` != null) {
            return `_battery-plus-vertical-duotone`!!
        }
        `_battery-plus-vertical-duotone` = Builder(name = "Battery-plus-vertical-duotone",
...
private var `_battery-plus-vertical-duotone`: ImageVector? = null
