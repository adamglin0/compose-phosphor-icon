...
public val RegularGroup.`Hourglass-simple-low`: ImageVector
    get() {
        if (`_hourglass-simple-low` != null) {
            return `_hourglass-simple-low`!!
        }
        `_hourglass-simple-low` = Builder(name = "Hourglass-simple-low", defaultWidth = 256.0.dp,
...
private var `_hourglass-simple-low`: ImageVector? = null
