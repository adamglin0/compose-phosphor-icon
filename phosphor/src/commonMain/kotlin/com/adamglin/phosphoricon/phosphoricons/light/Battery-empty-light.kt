...
public val LightGroup.`Battery-empty-light`: ImageVector
    get() {
        if (`_battery-empty-light` != null) {
            return `_battery-empty-light`!!
        }
        `_battery-empty-light` = Builder(name = "Battery-empty-light", defaultWidth = 256.0.dp,
...
private var `_battery-empty-light`: ImageVector? = null
