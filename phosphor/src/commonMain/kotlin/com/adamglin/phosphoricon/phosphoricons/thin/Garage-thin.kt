...
public val ThinGroup.`Garage-thin`: ImageVector
    get() {
        if (`_garage-thin` != null) {
            return `_garage-thin`!!
        }
        `_garage-thin` = Builder(name = "Garage-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_garage-thin`: ImageVector? = null
