...
public val ThinGroup.`Prohibit-inset-thin`: ImageVector
    get() {
        if (`_prohibit-inset-thin` != null) {
            return `_prohibit-inset-thin`!!
        }
        `_prohibit-inset-thin` = Builder(name = "Prohibit-inset-thin", defaultWidth = 256.0.dp,
...
private var `_prohibit-inset-thin`: ImageVector? = null
