...
public val DuotoneGroup.`Picnic-table-duotone`: ImageVector
    get() {
        if (`_picnic-table-duotone` != null) {
            return `_picnic-table-duotone`!!
        }
        `_picnic-table-duotone` = Builder(name = "Picnic-table-duotone", defaultWidth = 256.0.dp,
...
private var `_picnic-table-duotone`: ImageVector? = null
