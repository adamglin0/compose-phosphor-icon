...
public val DuotoneGroup.`Arrow-arc-right-duotone`: ImageVector
    get() {
        if (`_arrow-arc-right-duotone` != null) {
            return `_arrow-arc-right-duotone`!!
        }
        `_arrow-arc-right-duotone` = Builder(name = "Arrow-arc-right-duotone", defaultWidth =
...
private var `_arrow-arc-right-duotone`: ImageVector? = null
