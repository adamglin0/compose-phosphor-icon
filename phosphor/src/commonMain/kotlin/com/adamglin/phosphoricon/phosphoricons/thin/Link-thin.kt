...
public val ThinGroup.`Link-thin`: ImageVector
    get() {
        if (`_link-thin` != null) {
            return `_link-thin`!!
        }
        `_link-thin` = Builder(name = "Link-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_link-thin`: ImageVector? = null
