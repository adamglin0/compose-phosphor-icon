...
public val BoldGroup.`Graduation-cap-bold`: ImageVector
    get() {
        if (`_graduation-cap-bold` != null) {
            return `_graduation-cap-bold`!!
        }
        `_graduation-cap-bold` = Builder(name = "Graduation-cap-bold", defaultWidth = 256.0.dp,
...
private var `_graduation-cap-bold`: ImageVector? = null
