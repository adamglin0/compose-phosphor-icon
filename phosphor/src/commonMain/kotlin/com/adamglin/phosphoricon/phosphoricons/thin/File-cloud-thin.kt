...
public val ThinGroup.`File-cloud-thin`: ImageVector
    get() {
        if (`_file-cloud-thin` != null) {
            return `_file-cloud-thin`!!
        }
        `_file-cloud-thin` = Builder(name = "File-cloud-thin", defaultWidth = 256.0.dp,
...
private var `_file-cloud-thin`: ImageVector? = null
