...
public val DuotoneGroup.`Speaker-low-duotone`: ImageVector
    get() {
        if (`_speaker-low-duotone` != null) {
            return `_speaker-low-duotone`!!
        }
        `_speaker-low-duotone` = Builder(name = "Speaker-low-duotone", defaultWidth = 256.0.dp,
...
private var `_speaker-low-duotone`: ImageVector? = null
