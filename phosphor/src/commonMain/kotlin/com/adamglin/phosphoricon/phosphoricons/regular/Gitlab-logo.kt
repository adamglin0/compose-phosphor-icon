...
public val RegularGroup.`Gitlab-logo`: ImageVector
    get() {
        if (`_gitlab-logo` != null) {
            return `_gitlab-logo`!!
        }
        `_gitlab-logo` = Builder(name = "Gitlab-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gitlab-logo`: ImageVector? = null
