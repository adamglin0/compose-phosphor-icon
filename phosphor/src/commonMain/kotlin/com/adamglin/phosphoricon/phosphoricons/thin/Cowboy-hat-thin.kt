...
public val ThinGroup.`Cowboy-hat-thin`: ImageVector
    get() {
        if (`_cowboy-hat-thin` != null) {
            return `_cowboy-hat-thin`!!
        }
        `_cowboy-hat-thin` = Builder(name = "Cowboy-hat-thin", defaultWidth = 256.0.dp,
...
private var `_cowboy-hat-thin`: ImageVector? = null
