...
public val DuotoneGroup.`Folder-open-duotone`: ImageVector
    get() {
        if (`_folder-open-duotone` != null) {
            return `_folder-open-duotone`!!
        }
        `_folder-open-duotone` = Builder(name = "Folder-open-duotone", defaultWidth = 256.0.dp,
...
private var `_folder-open-duotone`: ImageVector? = null
