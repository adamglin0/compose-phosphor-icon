...
public val LightGroup.`Cards-light`: ImageVector
    get() {
        if (`_cards-light` != null) {
            return `_cards-light`!!
        }
        `_cards-light` = Builder(name = "Cards-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cards-light`: ImageVector? = null
