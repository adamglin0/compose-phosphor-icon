...
public val BoldGroup.`Shuffle-bold`: ImageVector
    get() {
        if (`_shuffle-bold` != null) {
            return `_shuffle-bold`!!
        }
        `_shuffle-bold` = Builder(name = "Shuffle-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shuffle-bold`: ImageVector? = null
