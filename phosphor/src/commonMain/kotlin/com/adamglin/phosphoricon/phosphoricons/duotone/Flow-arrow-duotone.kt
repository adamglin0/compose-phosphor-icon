...
public val DuotoneGroup.`Flow-arrow-duotone`: ImageVector
    get() {
        if (`_flow-arrow-duotone` != null) {
            return `_flow-arrow-duotone`!!
        }
        `_flow-arrow-duotone` = Builder(name = "Flow-arrow-duotone", defaultWidth = 256.0.dp,
...
private var `_flow-arrow-duotone`: ImageVector? = null
