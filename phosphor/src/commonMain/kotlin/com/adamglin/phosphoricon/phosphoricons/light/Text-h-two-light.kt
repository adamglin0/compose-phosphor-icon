...
public val LightGroup.`Text-h-two-light`: ImageVector
    get() {
        if (`_text-h-two-light` != null) {
            return `_text-h-two-light`!!
        }
        `_text-h-two-light` = Builder(name = "Text-h-two-light", defaultWidth = 256.0.dp,
...
private var `_text-h-two-light`: ImageVector? = null
