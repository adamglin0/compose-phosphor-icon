...
public val DuotoneGroup.`Egg-duotone`: ImageVector
    get() {
        if (`_egg-duotone` != null) {
            return `_egg-duotone`!!
        }
        `_egg-duotone` = Builder(name = "Egg-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_egg-duotone`: ImageVector? = null
