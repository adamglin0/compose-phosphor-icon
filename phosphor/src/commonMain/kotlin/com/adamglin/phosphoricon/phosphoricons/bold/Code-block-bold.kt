...
public val BoldGroup.`Code-block-bold`: ImageVector
    get() {
        if (`_code-block-bold` != null) {
            return `_code-block-bold`!!
        }
        `_code-block-bold` = Builder(name = "Code-block-bold", defaultWidth = 256.0.dp,
...
private var `_code-block-bold`: ImageVector? = null
