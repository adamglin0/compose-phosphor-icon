...
public val BoldGroup.`Baby-carriage-bold`: ImageVector
    get() {
        if (`_baby-carriage-bold` != null) {
            return `_baby-carriage-bold`!!
        }
        `_baby-carriage-bold` = Builder(name = "Baby-carriage-bold", defaultWidth = 256.0.dp,
...
private var `_baby-carriage-bold`: ImageVector? = null
