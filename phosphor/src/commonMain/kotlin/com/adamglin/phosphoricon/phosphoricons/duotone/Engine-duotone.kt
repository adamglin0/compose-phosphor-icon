...
public val DuotoneGroup.`Engine-duotone`: ImageVector
    get() {
        if (`_engine-duotone` != null) {
            return `_engine-duotone`!!
        }
        `_engine-duotone` = Builder(name = "Engine-duotone", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 56.0f, 168.69f)
...
private var `_engine-duotone`: ImageVector? = null
