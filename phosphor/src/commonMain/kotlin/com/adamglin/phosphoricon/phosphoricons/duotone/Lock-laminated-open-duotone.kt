...
public val DuotoneGroup.`Lock-laminated-open-duotone`: ImageVector
    get() {
        if (`_lock-laminated-open-duotone` != null) {
            return `_lock-laminated-open-duotone`!!
        }
        `_lock-laminated-open-duotone` = Builder(name = "Lock-laminated-open-duotone", defaultWidth
...
private var `_lock-laminated-open-duotone`: ImageVector? = null
