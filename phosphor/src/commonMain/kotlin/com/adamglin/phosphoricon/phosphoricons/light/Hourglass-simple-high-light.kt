...
public val LightGroup.`Hourglass-simple-high-light`: ImageVector
    get() {
        if (`_hourglass-simple-high-light` != null) {
            return `_hourglass-simple-high-light`!!
        }
        `_hourglass-simple-high-light` = Builder(name = "Hourglass-simple-high-light", defaultWidth
...
private var `_hourglass-simple-high-light`: ImageVector? = null
