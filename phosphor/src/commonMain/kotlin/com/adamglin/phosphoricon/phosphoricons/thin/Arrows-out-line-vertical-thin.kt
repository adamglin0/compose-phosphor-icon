...
public val ThinGroup.`Arrows-out-line-vertical-thin`: ImageVector
    get() {
        if (`_arrows-out-line-vertical-thin` != null) {
            return `_arrows-out-line-vertical-thin`!!
        }
        `_arrows-out-line-vertical-thin` = Builder(name = "Arrows-out-line-vertical-thin",
...
private var `_arrows-out-line-vertical-thin`: ImageVector? = null
