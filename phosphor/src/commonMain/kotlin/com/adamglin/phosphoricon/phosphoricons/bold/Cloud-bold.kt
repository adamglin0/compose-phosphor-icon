...
public val BoldGroup.`Cloud-bold`: ImageVector
    get() {
        if (`_cloud-bold` != null) {
            return `_cloud-bold`!!
        }
        `_cloud-bold` = Builder(name = "Cloud-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-bold`: ImageVector? = null
