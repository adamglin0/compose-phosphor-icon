...
public val BoldGroup.`Strategy-bold`: ImageVector
    get() {
        if (`_strategy-bold` != null) {
            return `_strategy-bold`!!
        }
        `_strategy-bold` = Builder(name = "Strategy-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_strategy-bold`: ImageVector? = null
