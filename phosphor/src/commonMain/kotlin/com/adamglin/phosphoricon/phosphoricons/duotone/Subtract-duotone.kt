...
public val DuotoneGroup.`Subtract-duotone`: ImageVector
    get() {
        if (`_subtract-duotone` != null) {
            return `_subtract-duotone`!!
        }
        `_subtract-duotone` = Builder(name = "Subtract-duotone", defaultWidth = 256.0.dp,
...
private var `_subtract-duotone`: ImageVector? = null
