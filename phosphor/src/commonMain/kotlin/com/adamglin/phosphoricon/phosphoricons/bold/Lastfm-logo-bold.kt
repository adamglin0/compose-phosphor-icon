...
public val BoldGroup.`Lastfm-logo-bold`: ImageVector
    get() {
        if (`_lastfm-logo-bold` != null) {
            return `_lastfm-logo-bold`!!
        }
        `_lastfm-logo-bold` = Builder(name = "Lastfm-logo-bold", defaultWidth = 256.0.dp,
...
private var `_lastfm-logo-bold`: ImageVector? = null
