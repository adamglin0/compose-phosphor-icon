...
public val BoldGroup.`Toggle-left-bold`: ImageVector
    get() {
        if (`_toggle-left-bold` != null) {
            return `_toggle-left-bold`!!
        }
        `_toggle-left-bold` = Builder(name = "Toggle-left-bold", defaultWidth = 256.0.dp,
...
private var `_toggle-left-bold`: ImageVector? = null
