...
public val LightGroup.`Hourglass-light`: ImageVector
    get() {
        if (`_hourglass-light` != null) {
            return `_hourglass-light`!!
        }
        `_hourglass-light` = Builder(name = "Hourglass-light", defaultWidth = 256.0.dp,
...
private var `_hourglass-light`: ImageVector? = null
