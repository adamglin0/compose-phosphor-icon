...
public val BoldGroup.`Chalkboard-bold`: ImageVector
    get() {
        if (`_chalkboard-bold` != null) {
            return `_chalkboard-bold`!!
        }
        `_chalkboard-bold` = Builder(name = "Chalkboard-bold", defaultWidth = 256.0.dp,
...
private var `_chalkboard-bold`: ImageVector? = null
