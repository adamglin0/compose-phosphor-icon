...
public val DuotoneGroup.`Approximate-equals-duotone`: ImageVector
    get() {
        if (`_approximate-equals-duotone` != null) {
            return `_approximate-equals-duotone`!!
        }
        `_approximate-equals-duotone` = Builder(name = "Approximate-equals-duotone", defaultWidth =
...
private var `_approximate-equals-duotone`: ImageVector? = null
