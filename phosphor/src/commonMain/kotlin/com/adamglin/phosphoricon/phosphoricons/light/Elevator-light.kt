...
public val LightGroup.`Elevator-light`: ImageVector
    get() {
        if (`_elevator-light` != null) {
            return `_elevator-light`!!
        }
        `_elevator-light` = Builder(name = "Elevator-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_elevator-light`: ImageVector? = null
