...
public val BoldGroup.`Ranking-bold`: ImageVector
    get() {
        if (`_ranking-bold` != null) {
            return `_ranking-bold`!!
        }
        `_ranking-bold` = Builder(name = "Ranking-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ranking-bold`: ImageVector? = null
