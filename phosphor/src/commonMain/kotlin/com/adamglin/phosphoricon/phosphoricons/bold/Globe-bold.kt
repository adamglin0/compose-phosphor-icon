...
public val BoldGroup.`Globe-bold`: ImageVector
    get() {
        if (`_globe-bold` != null) {
            return `_globe-bold`!!
        }
        `_globe-bold` = Builder(name = "Globe-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_globe-bold`: ImageVector? = null
