...
public val BoldGroup.`Visor-bold`: ImageVector
    get() {
        if (`_visor-bold` != null) {
            return `_visor-bold`!!
        }
        `_visor-bold` = Builder(name = "Visor-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_visor-bold`: ImageVector? = null
