...
public val BoldGroup.`Barricade-bold`: ImageVector
    get() {
        if (`_barricade-bold` != null) {
            return `_barricade-bold`!!
        }
        `_barricade-bold` = Builder(name = "Barricade-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_barricade-bold`: ImageVector? = null
