...
public val BoldGroup.`Cable-car-bold`: ImageVector
    get() {
        if (`_cable-car-bold` != null) {
            return `_cable-car-bold`!!
        }
        `_cable-car-bold` = Builder(name = "Cable-car-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cable-car-bold`: ImageVector? = null
