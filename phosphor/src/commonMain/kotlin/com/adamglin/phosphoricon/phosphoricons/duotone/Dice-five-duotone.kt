...
public val DuotoneGroup.`Dice-five-duotone`: ImageVector
    get() {
        if (`_dice-five-duotone` != null) {
            return `_dice-five-duotone`!!
        }
        `_dice-five-duotone` = Builder(name = "Dice-five-duotone", defaultWidth = 256.0.dp,
...
private var `_dice-five-duotone`: ImageVector? = null
