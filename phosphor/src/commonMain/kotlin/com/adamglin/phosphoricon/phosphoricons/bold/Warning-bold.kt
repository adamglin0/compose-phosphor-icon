...
public val BoldGroup.`Warning-bold`: ImageVector
    get() {
        if (`_warning-bold` != null) {
            return `_warning-bold`!!
        }
        `_warning-bold` = Builder(name = "Warning-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_warning-bold`: ImageVector? = null
