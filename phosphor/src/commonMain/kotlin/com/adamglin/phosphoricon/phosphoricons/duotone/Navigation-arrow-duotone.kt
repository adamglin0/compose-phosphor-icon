...
public val DuotoneGroup.`Navigation-arrow-duotone`: ImageVector
    get() {
        if (`_navigation-arrow-duotone` != null) {
            return `_navigation-arrow-duotone`!!
        }
        `_navigation-arrow-duotone` = Builder(name = "Navigation-arrow-duotone", defaultWidth =
...
private var `_navigation-arrow-duotone`: ImageVector? = null
