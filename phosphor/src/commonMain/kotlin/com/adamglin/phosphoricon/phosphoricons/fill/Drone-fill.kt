...
public val FillGroup.`Drone-fill`: ImageVector
    get() {
        if (`_drone-fill` != null) {
            return `_drone-fill`!!
        }
        `_drone-fill` = Builder(name = "Drone-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_drone-fill`: ImageVector? = null
