...
public val DuotoneGroup.`Path-duotone`: ImageVector
    get() {
        if (`_path-duotone` != null) {
            return `_path-duotone`!!
        }
        `_path-duotone` = Builder(name = "Path-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_path-duotone`: ImageVector? = null
