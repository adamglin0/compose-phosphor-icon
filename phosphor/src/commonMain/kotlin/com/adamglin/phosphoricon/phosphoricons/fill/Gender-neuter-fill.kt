...
public val FillGroup.`Gender-neuter-fill`: ImageVector
    get() {
        if (`_gender-neuter-fill` != null) {
            return `_gender-neuter-fill`!!
        }
        `_gender-neuter-fill` = Builder(name = "Gender-neuter-fill", defaultWidth = 256.0.dp,
...
private var `_gender-neuter-fill`: ImageVector? = null
