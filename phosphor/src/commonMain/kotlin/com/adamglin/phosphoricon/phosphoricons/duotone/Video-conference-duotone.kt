...
public val DuotoneGroup.`Video-conference-duotone`: ImageVector
    get() {
        if (`_video-conference-duotone` != null) {
            return `_video-conference-duotone`!!
        }
        `_video-conference-duotone` = Builder(name = "Video-conference-duotone", defaultWidth =
...
private var `_video-conference-duotone`: ImageVector? = null
