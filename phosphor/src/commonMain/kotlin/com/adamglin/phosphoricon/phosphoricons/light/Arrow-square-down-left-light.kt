...
public val LightGroup.`Arrow-square-down-left-light`: ImageVector
    get() {
        if (`_arrow-square-down-left-light` != null) {
            return `_arrow-square-down-left-light`!!
        }
        `_arrow-square-down-left-light` = Builder(name = "Arrow-square-down-left-light",
...
private var `_arrow-square-down-left-light`: ImageVector? = null
