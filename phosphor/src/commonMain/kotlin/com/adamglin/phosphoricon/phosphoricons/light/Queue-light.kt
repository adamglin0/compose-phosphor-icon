...
public val LightGroup.`Queue-light`: ImageVector
    get() {
        if (`_queue-light` != null) {
            return `_queue-light`!!
        }
        `_queue-light` = Builder(name = "Queue-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_queue-light`: ImageVector? = null
