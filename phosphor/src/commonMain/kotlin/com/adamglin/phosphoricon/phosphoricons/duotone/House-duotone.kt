...
public val DuotoneGroup.`House-duotone`: ImageVector
    get() {
        if (`_house-duotone` != null) {
            return `_house-duotone`!!
        }
        `_house-duotone` = Builder(name = "House-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_house-duotone`: ImageVector? = null
