...
public val ThinGroup.`Not-subset-of-thin`: ImageVector
    get() {
        if (`_not-subset-of-thin` != null) {
            return `_not-subset-of-thin`!!
        }
        `_not-subset-of-thin` = Builder(name = "Not-subset-of-thin", defaultWidth = 256.0.dp,
...
private var `_not-subset-of-thin`: ImageVector? = null
