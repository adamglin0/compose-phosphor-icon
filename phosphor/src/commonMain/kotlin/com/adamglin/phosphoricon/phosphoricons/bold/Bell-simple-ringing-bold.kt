...
public val BoldGroup.`Bell-simple-ringing-bold`: ImageVector
    get() {
        if (`_bell-simple-ringing-bold` != null) {
            return `_bell-simple-ringing-bold`!!
        }
        `_bell-simple-ringing-bold` = Builder(name = "Bell-simple-ringing-bold", defaultWidth =
...
private var `_bell-simple-ringing-bold`: ImageVector? = null
