...
public val FillGroup.`Number-circle-two-fill`: ImageVector
    get() {
        if (`_number-circle-two-fill` != null) {
            return `_number-circle-two-fill`!!
        }
        `_number-circle-two-fill` = Builder(name = "Number-circle-two-fill", defaultWidth =
...
private var `_number-circle-two-fill`: ImageVector? = null
