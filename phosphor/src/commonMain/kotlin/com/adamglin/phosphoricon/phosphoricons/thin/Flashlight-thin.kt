...
public val ThinGroup.`Flashlight-thin`: ImageVector
    get() {
        if (`_flashlight-thin` != null) {
            return `_flashlight-thin`!!
        }
        `_flashlight-thin` = Builder(name = "Flashlight-thin", defaultWidth = 256.0.dp,
...
private var `_flashlight-thin`: ImageVector? = null
