...
public val BoldGroup.`Tea-bag-bold`: ImageVector
    get() {
        if (`_tea-bag-bold` != null) {
            return `_tea-bag-bold`!!
        }
        `_tea-bag-bold` = Builder(name = "Tea-bag-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tea-bag-bold`: ImageVector? = null
