...
public val BoldGroup.`Mask-sad-bold`: ImageVector
    get() {
        if (`_mask-sad-bold` != null) {
            return `_mask-sad-bold`!!
        }
        `_mask-sad-bold` = Builder(name = "Mask-sad-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mask-sad-bold`: ImageVector? = null
