...
public val ThinGroup.`Recycle-thin`: ImageVector
    get() {
        if (`_recycle-thin` != null) {
            return `_recycle-thin`!!
        }
        `_recycle-thin` = Builder(name = "Recycle-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_recycle-thin`: ImageVector? = null
