...
public val LightGroup.`Cooking-pot-light`: ImageVector
    get() {
        if (`_cooking-pot-light` != null) {
            return `_cooking-pot-light`!!
        }
        `_cooking-pot-light` = Builder(name = "Cooking-pot-light", defaultWidth = 256.0.dp,
...
private var `_cooking-pot-light`: ImageVector? = null
