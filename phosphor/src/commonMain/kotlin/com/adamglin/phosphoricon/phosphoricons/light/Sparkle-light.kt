...
public val LightGroup.`Sparkle-light`: ImageVector
    get() {
        if (`_sparkle-light` != null) {
            return `_sparkle-light`!!
        }
        `_sparkle-light` = Builder(name = "Sparkle-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sparkle-light`: ImageVector? = null
