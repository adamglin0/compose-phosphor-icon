...
public val BoldGroup.`Parallelogram-bold`: ImageVector
    get() {
        if (`_parallelogram-bold` != null) {
            return `_parallelogram-bold`!!
        }
        `_parallelogram-bold` = Builder(name = "Parallelogram-bold", defaultWidth = 256.0.dp,
...
private var `_parallelogram-bold`: ImageVector? = null
