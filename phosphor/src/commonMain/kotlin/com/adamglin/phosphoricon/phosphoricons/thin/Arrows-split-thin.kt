...
public val ThinGroup.`Arrows-split-thin`: ImageVector
    get() {
        if (`_arrows-split-thin` != null) {
            return `_arrows-split-thin`!!
        }
        `_arrows-split-thin` = Builder(name = "Arrows-split-thin", defaultWidth = 256.0.dp,
...
private var `_arrows-split-thin`: ImageVector? = null
