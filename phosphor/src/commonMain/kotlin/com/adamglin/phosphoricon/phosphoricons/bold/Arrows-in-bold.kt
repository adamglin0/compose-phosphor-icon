...
public val BoldGroup.`Arrows-in-bold`: ImageVector
    get() {
        if (`_arrows-in-bold` != null) {
            return `_arrows-in-bold`!!
        }
        `_arrows-in-bold` = Builder(name = "Arrows-in-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_arrows-in-bold`: ImageVector? = null
