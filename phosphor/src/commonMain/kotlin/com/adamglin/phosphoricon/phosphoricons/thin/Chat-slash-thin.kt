...
public val ThinGroup.`Chat-slash-thin`: ImageVector
    get() {
        if (`_chat-slash-thin` != null) {
            return `_chat-slash-thin`!!
        }
        `_chat-slash-thin` = Builder(name = "Chat-slash-thin", defaultWidth = 256.0.dp,
...
private var `_chat-slash-thin`: ImageVector? = null
