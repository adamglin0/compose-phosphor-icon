...
public val DuotoneGroup.`Microphone-duotone`: ImageVector
    get() {
        if (`_microphone-duotone` != null) {
            return `_microphone-duotone`!!
        }
        `_microphone-duotone` = Builder(name = "Microphone-duotone", defaultWidth = 256.0.dp,
...
private var `_microphone-duotone`: ImageVector? = null
