...
public val ThinGroup.`Shield-checkered-thin`: ImageVector
    get() {
        if (`_shield-checkered-thin` != null) {
            return `_shield-checkered-thin`!!
        }
        `_shield-checkered-thin` = Builder(name = "Shield-checkered-thin", defaultWidth = 256.0.dp,
...
private var `_shield-checkered-thin`: ImageVector? = null
