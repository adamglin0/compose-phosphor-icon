...
public val ThinGroup.`Lifebuoy-thin`: ImageVector
    get() {
        if (`_lifebuoy-thin` != null) {
            return `_lifebuoy-thin`!!
        }
        `_lifebuoy-thin` = Builder(name = "Lifebuoy-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lifebuoy-thin`: ImageVector? = null
