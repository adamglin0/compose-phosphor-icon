...
public val RegularGroup.`Eye-closed`: ImageVector
    get() {
        if (`_eye-closed` != null) {
            return `_eye-closed`!!
        }
        `_eye-closed` = Builder(name = "Eye-closed", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eye-closed`: ImageVector? = null
