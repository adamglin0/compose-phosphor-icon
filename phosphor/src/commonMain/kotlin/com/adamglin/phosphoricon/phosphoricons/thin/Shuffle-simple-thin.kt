...
public val ThinGroup.`Shuffle-simple-thin`: ImageVector
    get() {
        if (`_shuffle-simple-thin` != null) {
            return `_shuffle-simple-thin`!!
        }
        `_shuffle-simple-thin` = Builder(name = "Shuffle-simple-thin", defaultWidth = 256.0.dp,
...
private var `_shuffle-simple-thin`: ImageVector? = null
