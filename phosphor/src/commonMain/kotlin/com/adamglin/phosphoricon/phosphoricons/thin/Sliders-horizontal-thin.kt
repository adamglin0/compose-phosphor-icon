...
public val ThinGroup.`Sliders-horizontal-thin`: ImageVector
    get() {
        if (`_sliders-horizontal-thin` != null) {
            return `_sliders-horizontal-thin`!!
        }
        `_sliders-horizontal-thin` = Builder(name = "Sliders-horizontal-thin", defaultWidth =
...
private var `_sliders-horizontal-thin`: ImageVector? = null
