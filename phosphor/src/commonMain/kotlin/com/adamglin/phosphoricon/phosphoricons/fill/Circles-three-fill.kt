...
public val FillGroup.`Circles-three-fill`: ImageVector
    get() {
        if (`_circles-three-fill` != null) {
            return `_circles-three-fill`!!
        }
        `_circles-three-fill` = Builder(name = "Circles-three-fill", defaultWidth = 256.0.dp,
...
private var `_circles-three-fill`: ImageVector? = null
