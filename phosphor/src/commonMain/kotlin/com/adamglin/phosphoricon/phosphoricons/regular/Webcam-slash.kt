...
public val RegularGroup.`Webcam-slash`: ImageVector
    get() {
        if (`_webcam-slash` != null) {
            return `_webcam-slash`!!
        }
        `_webcam-slash` = Builder(name = "Webcam-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_webcam-slash`: ImageVector? = null
