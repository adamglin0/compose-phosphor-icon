...
public val FillGroup.`Shower-fill`: ImageVector
    get() {
        if (`_shower-fill` != null) {
            return `_shower-fill`!!
        }
        `_shower-fill` = Builder(name = "Shower-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shower-fill`: ImageVector? = null
