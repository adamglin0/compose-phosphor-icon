...
public val DuotoneGroup.`User-circle-duotone`: ImageVector
    get() {
        if (`_user-circle-duotone` != null) {
            return `_user-circle-duotone`!!
        }
        `_user-circle-duotone` = Builder(name = "User-circle-duotone", defaultWidth = 256.0.dp,
...
private var `_user-circle-duotone`: ImageVector? = null
