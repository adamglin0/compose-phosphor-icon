...
public val ThinGroup.`Pentagram-thin`: ImageVector
    get() {
        if (`_pentagram-thin` != null) {
            return `_pentagram-thin`!!
        }
        `_pentagram-thin` = Builder(name = "Pentagram-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_pentagram-thin`: ImageVector? = null
