...
public val LightGroup.`Stack-minus-light`: ImageVector
    get() {
        if (`_stack-minus-light` != null) {
            return `_stack-minus-light`!!
        }
        `_stack-minus-light` = Builder(name = "Stack-minus-light", defaultWidth = 256.0.dp,
...
private var `_stack-minus-light`: ImageVector? = null
