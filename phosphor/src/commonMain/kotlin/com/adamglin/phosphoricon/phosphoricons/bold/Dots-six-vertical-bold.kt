...
public val BoldGroup.`Dots-six-vertical-bold`: ImageVector
    get() {
        if (`_dots-six-vertical-bold` != null) {
            return `_dots-six-vertical-bold`!!
        }
        `_dots-six-vertical-bold` = Builder(name = "Dots-six-vertical-bold", defaultWidth =
...
private var `_dots-six-vertical-bold`: ImageVector? = null
