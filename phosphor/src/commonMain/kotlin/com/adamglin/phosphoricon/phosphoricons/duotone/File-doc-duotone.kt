...
public val DuotoneGroup.`File-doc-duotone`: ImageVector
    get() {
        if (`_file-doc-duotone` != null) {
            return `_file-doc-duotone`!!
        }
        `_file-doc-duotone` = Builder(name = "File-doc-duotone", defaultWidth = 256.0.dp,
...
private var `_file-doc-duotone`: ImageVector? = null
