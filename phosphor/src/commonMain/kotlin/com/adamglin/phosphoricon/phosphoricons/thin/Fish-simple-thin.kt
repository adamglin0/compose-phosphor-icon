...
public val ThinGroup.`Fish-simple-thin`: ImageVector
    get() {
        if (`_fish-simple-thin` != null) {
            return `_fish-simple-thin`!!
        }
        `_fish-simple-thin` = Builder(name = "Fish-simple-thin", defaultWidth = 256.0.dp,
...
private var `_fish-simple-thin`: ImageVector? = null
