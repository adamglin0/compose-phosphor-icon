...
public val DuotoneGroup.`Park-duotone`: ImageVector
    get() {
        if (`_park-duotone` != null) {
            return `_park-duotone`!!
        }
        `_park-duotone` = Builder(name = "Park-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_park-duotone`: ImageVector? = null
