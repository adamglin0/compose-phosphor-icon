...
public val LightGroup.`Numpad-light`: ImageVector
    get() {
        if (`_numpad-light` != null) {
            return `_numpad-light`!!
        }
        `_numpad-light` = Builder(name = "Numpad-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_numpad-light`: ImageVector? = null
