...
public val BoldGroup.`Compass-bold`: ImageVector
    get() {
        if (`_compass-bold` != null) {
            return `_compass-bold`!!
        }
        `_compass-bold` = Builder(name = "Compass-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_compass-bold`: ImageVector? = null
