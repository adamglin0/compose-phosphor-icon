...
public val BoldGroup.`Sneaker-bold`: ImageVector
    get() {
        if (`_sneaker-bold` != null) {
            return `_sneaker-bold`!!
        }
        `_sneaker-bold` = Builder(name = "Sneaker-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sneaker-bold`: ImageVector? = null
