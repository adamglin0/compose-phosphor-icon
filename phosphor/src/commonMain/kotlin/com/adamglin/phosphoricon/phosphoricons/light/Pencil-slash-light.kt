...
public val LightGroup.`Pencil-slash-light`: ImageVector
    get() {
        if (`_pencil-slash-light` != null) {
            return `_pencil-slash-light`!!
        }
        `_pencil-slash-light` = Builder(name = "Pencil-slash-light", defaultWidth = 256.0.dp,
...
private var `_pencil-slash-light`: ImageVector? = null
