...
public val LightGroup.`Map-pin-line-light`: ImageVector
    get() {
        if (`_map-pin-line-light` != null) {
            return `_map-pin-line-light`!!
        }
        `_map-pin-line-light` = Builder(name = "Map-pin-line-light", defaultWidth = 256.0.dp,
...
private var `_map-pin-line-light`: ImageVector? = null
