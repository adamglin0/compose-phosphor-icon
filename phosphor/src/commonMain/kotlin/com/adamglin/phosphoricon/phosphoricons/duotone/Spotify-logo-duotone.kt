...
public val DuotoneGroup.`Spotify-logo-duotone`: ImageVector
    get() {
        if (`_spotify-logo-duotone` != null) {
            return `_spotify-logo-duotone`!!
        }
        `_spotify-logo-duotone` = Builder(name = "Spotify-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_spotify-logo-duotone`: ImageVector? = null
