...
public val DuotoneGroup.`Cloud-x-duotone`: ImageVector
    get() {
        if (`_cloud-x-duotone` != null) {
            return `_cloud-x-duotone`!!
        }
        `_cloud-x-duotone` = Builder(name = "Cloud-x-duotone", defaultWidth = 256.0.dp,
...
private var `_cloud-x-duotone`: ImageVector? = null
