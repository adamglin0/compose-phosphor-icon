...
public val ThinGroup.`Chat-circle-text-thin`: ImageVector
    get() {
        if (`_chat-circle-text-thin` != null) {
            return `_chat-circle-text-thin`!!
        }
        `_chat-circle-text-thin` = Builder(name = "Chat-circle-text-thin", defaultWidth = 256.0.dp,
...
private var `_chat-circle-text-thin`: ImageVector? = null
