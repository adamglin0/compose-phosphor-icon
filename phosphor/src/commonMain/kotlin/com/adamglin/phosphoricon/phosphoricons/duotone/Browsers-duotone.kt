...
public val DuotoneGroup.`Browsers-duotone`: ImageVector
    get() {
        if (`_browsers-duotone` != null) {
            return `_browsers-duotone`!!
        }
        `_browsers-duotone` = Builder(name = "Browsers-duotone", defaultWidth = 256.0.dp,
...
private var `_browsers-duotone`: ImageVector? = null
