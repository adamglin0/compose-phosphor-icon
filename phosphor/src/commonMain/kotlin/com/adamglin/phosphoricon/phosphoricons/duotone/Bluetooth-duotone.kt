...
public val DuotoneGroup.`Bluetooth-duotone`: ImageVector
    get() {
        if (`_bluetooth-duotone` != null) {
            return `_bluetooth-duotone`!!
        }
        `_bluetooth-duotone` = Builder(name = "Bluetooth-duotone", defaultWidth = 256.0.dp,
...
private var `_bluetooth-duotone`: ImageVector? = null
