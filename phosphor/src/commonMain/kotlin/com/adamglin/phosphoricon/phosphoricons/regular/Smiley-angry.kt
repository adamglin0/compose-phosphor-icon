...
public val RegularGroup.`Smiley-angry`: ImageVector
    get() {
        if (`_smiley-angry` != null) {
            return `_smiley-angry`!!
        }
        `_smiley-angry` = Builder(name = "Smiley-angry", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_smiley-angry`: ImageVector? = null
