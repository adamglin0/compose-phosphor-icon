...
public val DuotoneGroup.`Cloud-arrow-down-duotone`: ImageVector
    get() {
        if (`_cloud-arrow-down-duotone` != null) {
            return `_cloud-arrow-down-duotone`!!
        }
        `_cloud-arrow-down-duotone` = Builder(name = "Cloud-arrow-down-duotone", defaultWidth =
...
private var `_cloud-arrow-down-duotone`: ImageVector? = null
