...
public val RegularGroup.`Person-simple`: ImageVector
    get() {
        if (`_person-simple` != null) {
            return `_person-simple`!!
        }
        `_person-simple` = Builder(name = "Person-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_person-simple`: ImageVector? = null
