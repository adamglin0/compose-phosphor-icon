...
public val BoldGroup.`File-ppt-bold`: ImageVector
    get() {
        if (`_file-ppt-bold` != null) {
            return `_file-ppt-bold`!!
        }
        `_file-ppt-bold` = Builder(name = "File-ppt-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-ppt-bold`: ImageVector? = null
