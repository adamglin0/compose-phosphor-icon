...
public val ThinGroup.`Ladder-thin`: ImageVector
    get() {
        if (`_ladder-thin` != null) {
            return `_ladder-thin`!!
        }
        `_ladder-thin` = Builder(name = "Ladder-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ladder-thin`: ImageVector? = null
