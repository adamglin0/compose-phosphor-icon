...
public val DuotoneGroup.`Paperclip-duotone`: ImageVector
    get() {
        if (`_paperclip-duotone` != null) {
            return `_paperclip-duotone`!!
        }
        `_paperclip-duotone` = Builder(name = "Paperclip-duotone", defaultWidth = 256.0.dp,
...
private var `_paperclip-duotone`: ImageVector? = null
