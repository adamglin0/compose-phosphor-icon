...
public val LightGroup.`Shower-light`: ImageVector
    get() {
        if (`_shower-light` != null) {
            return `_shower-light`!!
        }
        `_shower-light` = Builder(name = "Shower-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shower-light`: ImageVector? = null
