...
public val LightGroup.`Paw-print-light`: ImageVector
    get() {
        if (`_paw-print-light` != null) {
            return `_paw-print-light`!!
        }
        `_paw-print-light` = Builder(name = "Paw-print-light", defaultWidth = 256.0.dp,
...
private var `_paw-print-light`: ImageVector? = null
