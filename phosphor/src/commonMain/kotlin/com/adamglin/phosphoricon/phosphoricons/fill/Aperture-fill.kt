...
public val FillGroup.`Aperture-fill`: ImageVector
    get() {
        if (`_aperture-fill` != null) {
            return `_aperture-fill`!!
        }
        `_aperture-fill` = Builder(name = "Aperture-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_aperture-fill`: ImageVector? = null
