...
public val DuotoneGroup.`Hand-tap-duotone`: ImageVector
    get() {
        if (`_hand-tap-duotone` != null) {
            return `_hand-tap-duotone`!!
        }
        `_hand-tap-duotone` = Builder(name = "Hand-tap-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-tap-duotone`: ImageVector? = null
