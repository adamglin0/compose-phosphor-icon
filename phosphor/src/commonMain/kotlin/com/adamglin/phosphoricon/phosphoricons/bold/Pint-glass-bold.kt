...
public val BoldGroup.`Pint-glass-bold`: ImageVector
    get() {
        if (`_pint-glass-bold` != null) {
            return `_pint-glass-bold`!!
        }
        `_pint-glass-bold` = Builder(name = "Pint-glass-bold", defaultWidth = 256.0.dp,
...
private var `_pint-glass-bold`: ImageVector? = null
