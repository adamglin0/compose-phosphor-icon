...
public val RegularGroup.`Git-branch`: ImageVector
    get() {
        if (`_git-branch` != null) {
            return `_git-branch`!!
        }
        `_git-branch` = Builder(name = "Git-branch", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_git-branch`: ImageVector? = null
