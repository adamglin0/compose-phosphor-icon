...
public val LightGroup.`Waves-light`: ImageVector
    get() {
        if (`_waves-light` != null) {
            return `_waves-light`!!
        }
        `_waves-light` = Builder(name = "Waves-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_waves-light`: ImageVector? = null
