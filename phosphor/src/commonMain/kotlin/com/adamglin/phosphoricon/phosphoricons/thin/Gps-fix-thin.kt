...
public val ThinGroup.`Gps-fix-thin`: ImageVector
    get() {
        if (`_gps-fix-thin` != null) {
            return `_gps-fix-thin`!!
        }
        `_gps-fix-thin` = Builder(name = "Gps-fix-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gps-fix-thin`: ImageVector? = null
