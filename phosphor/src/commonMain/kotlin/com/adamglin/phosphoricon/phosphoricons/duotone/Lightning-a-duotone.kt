...
public val DuotoneGroup.`Lightning-a-duotone`: ImageVector
    get() {
        if (`_lightning-a-duotone` != null) {
            return `_lightning-a-duotone`!!
        }
        `_lightning-a-duotone` = Builder(name = "Lightning-a-duotone", defaultWidth = 256.0.dp,
...
private var `_lightning-a-duotone`: ImageVector? = null
