...
public val ThinGroup.`Images-thin`: ImageVector
    get() {
        if (`_images-thin` != null) {
            return `_images-thin`!!
        }
        `_images-thin` = Builder(name = "Images-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_images-thin`: ImageVector? = null
