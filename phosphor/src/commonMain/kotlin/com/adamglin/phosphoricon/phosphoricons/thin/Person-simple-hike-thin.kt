...
public val ThinGroup.`Person-simple-hike-thin`: ImageVector
    get() {
        if (`_person-simple-hike-thin` != null) {
            return `_person-simple-hike-thin`!!
        }
        `_person-simple-hike-thin` = Builder(name = "Person-simple-hike-thin", defaultWidth =
...
private var `_person-simple-hike-thin`: ImageVector? = null
