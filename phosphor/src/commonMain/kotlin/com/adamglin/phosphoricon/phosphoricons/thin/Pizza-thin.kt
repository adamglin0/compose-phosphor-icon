...
public val ThinGroup.`Pizza-thin`: ImageVector
    get() {
        if (`_pizza-thin` != null) {
            return `_pizza-thin`!!
        }
        `_pizza-thin` = Builder(name = "Pizza-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pizza-thin`: ImageVector? = null
