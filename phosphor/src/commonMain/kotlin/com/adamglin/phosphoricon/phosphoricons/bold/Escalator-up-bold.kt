...
public val BoldGroup.`Escalator-up-bold`: ImageVector
    get() {
        if (`_escalator-up-bold` != null) {
            return `_escalator-up-bold`!!
        }
        `_escalator-up-bold` = Builder(name = "Escalator-up-bold", defaultWidth = 256.0.dp,
...
private var `_escalator-up-bold`: ImageVector? = null
