...
public val ThinGroup.`Play-circle-thin`: ImageVector
    get() {
        if (`_play-circle-thin` != null) {
            return `_play-circle-thin`!!
        }
        `_play-circle-thin` = Builder(name = "Play-circle-thin", defaultWidth = 256.0.dp,
...
private var `_play-circle-thin`: ImageVector? = null
