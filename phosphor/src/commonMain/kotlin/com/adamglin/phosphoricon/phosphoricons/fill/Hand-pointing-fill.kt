...
public val FillGroup.`Hand-pointing-fill`: ImageVector
    get() {
        if (`_hand-pointing-fill` != null) {
            return `_hand-pointing-fill`!!
        }
        `_hand-pointing-fill` = Builder(name = "Hand-pointing-fill", defaultWidth = 256.0.dp,
...
private var `_hand-pointing-fill`: ImageVector? = null
