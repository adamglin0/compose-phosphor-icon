...
public val DuotoneGroup.`Gender-neuter-duotone`: ImageVector
    get() {
        if (`_gender-neuter-duotone` != null) {
            return `_gender-neuter-duotone`!!
        }
        `_gender-neuter-duotone` = Builder(name = "Gender-neuter-duotone", defaultWidth = 256.0.dp,
...
private var `_gender-neuter-duotone`: ImageVector? = null
