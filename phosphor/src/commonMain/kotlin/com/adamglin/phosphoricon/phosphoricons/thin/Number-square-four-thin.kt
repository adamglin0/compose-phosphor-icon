...
public val ThinGroup.`Number-square-four-thin`: ImageVector
    get() {
        if (`_number-square-four-thin` != null) {
            return `_number-square-four-thin`!!
        }
        `_number-square-four-thin` = Builder(name = "Number-square-four-thin", defaultWidth =
...
private var `_number-square-four-thin`: ImageVector? = null
