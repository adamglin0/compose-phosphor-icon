...
public val DuotoneGroup.`Medal-duotone`: ImageVector
    get() {
        if (`_medal-duotone` != null) {
            return `_medal-duotone`!!
        }
        `_medal-duotone` = Builder(name = "Medal-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_medal-duotone`: ImageVector? = null
