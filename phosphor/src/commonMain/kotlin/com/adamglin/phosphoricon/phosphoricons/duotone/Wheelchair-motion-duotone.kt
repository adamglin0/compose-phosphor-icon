...
public val DuotoneGroup.`Wheelchair-motion-duotone`: ImageVector
    get() {
        if (`_wheelchair-motion-duotone` != null) {
            return `_wheelchair-motion-duotone`!!
        }
        `_wheelchair-motion-duotone` = Builder(name = "Wheelchair-motion-duotone", defaultWidth =
...
private var `_wheelchair-motion-duotone`: ImageVector? = null
