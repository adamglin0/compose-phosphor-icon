...
public val DuotoneGroup.`Currency-ngn-duotone`: ImageVector
    get() {
        if (`_currency-ngn-duotone` != null) {
            return `_currency-ngn-duotone`!!
        }
        `_currency-ngn-duotone` = Builder(name = "Currency-ngn-duotone", defaultWidth = 256.0.dp,
...
private var `_currency-ngn-duotone`: ImageVector? = null
