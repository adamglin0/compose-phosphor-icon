...
public val DuotoneGroup.`Wind-duotone`: ImageVector
    get() {
        if (`_wind-duotone` != null) {
            return `_wind-duotone`!!
        }
        `_wind-duotone` = Builder(name = "Wind-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wind-duotone`: ImageVector? = null
