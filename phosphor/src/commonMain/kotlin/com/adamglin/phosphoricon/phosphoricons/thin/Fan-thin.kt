...
public val ThinGroup.`Fan-thin`: ImageVector
    get() {
        if (`_fan-thin` != null) {
            return `_fan-thin`!!
        }
        `_fan-thin` = Builder(name = "Fan-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_fan-thin`: ImageVector? = null
