...
public val DuotoneGroup.`Arrows-out-line-horizontal-duotone`: ImageVector
    get() {
        if (`_arrows-out-line-horizontal-duotone` != null) {
            return `_arrows-out-line-horizontal-duotone`!!
        }
        `_arrows-out-line-horizontal-duotone` = Builder(name = "Arrows-out-line-horizontal-duotone",
...
private var `_arrows-out-line-horizontal-duotone`: ImageVector? = null
