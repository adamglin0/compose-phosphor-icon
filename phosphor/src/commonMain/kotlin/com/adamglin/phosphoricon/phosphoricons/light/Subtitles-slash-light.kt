...
public val LightGroup.`Subtitles-slash-light`: ImageVector
    get() {
        if (`_subtitles-slash-light` != null) {
            return `_subtitles-slash-light`!!
        }
        `_subtitles-slash-light` = Builder(name = "Subtitles-slash-light", defaultWidth = 256.0.dp,
...
private var `_subtitles-slash-light`: ImageVector? = null
