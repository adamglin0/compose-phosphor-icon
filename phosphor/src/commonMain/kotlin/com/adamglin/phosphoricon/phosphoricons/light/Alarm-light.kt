...
public val LightGroup.`Alarm-light`: ImageVector
    get() {
        if (`_alarm-light` != null) {
            return `_alarm-light`!!
        }
        `_alarm-light` = Builder(name = "Alarm-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_alarm-light`: ImageVector? = null
