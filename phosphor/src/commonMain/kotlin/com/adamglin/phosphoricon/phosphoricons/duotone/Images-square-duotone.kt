...
public val DuotoneGroup.`Images-square-duotone`: ImageVector
    get() {
        if (`_images-square-duotone` != null) {
            return `_images-square-duotone`!!
        }
        `_images-square-duotone` = Builder(name = "Images-square-duotone", defaultWidth = 256.0.dp,
...
private var `_images-square-duotone`: ImageVector? = null
