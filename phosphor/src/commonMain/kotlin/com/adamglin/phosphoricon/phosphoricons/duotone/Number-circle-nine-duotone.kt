...
public val DuotoneGroup.`Number-circle-nine-duotone`: ImageVector
    get() {
        if (`_number-circle-nine-duotone` != null) {
            return `_number-circle-nine-duotone`!!
        }
        `_number-circle-nine-duotone` = Builder(name = "Number-circle-nine-duotone", defaultWidth =
...
private var `_number-circle-nine-duotone`: ImageVector? = null
