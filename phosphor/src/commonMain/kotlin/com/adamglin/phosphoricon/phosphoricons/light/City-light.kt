...
public val LightGroup.`City-light`: ImageVector
    get() {
        if (`_city-light` != null) {
            return `_city-light`!!
        }
        `_city-light` = Builder(name = "City-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_city-light`: ImageVector? = null
