...
public val LightGroup.`User-light`: ImageVector
    get() {
        if (`_user-light` != null) {
            return `_user-light`!!
        }
        `_user-light` = Builder(name = "User-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_user-light`: ImageVector? = null
