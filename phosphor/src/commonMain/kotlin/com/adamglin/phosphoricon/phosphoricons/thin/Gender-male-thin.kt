...
public val ThinGroup.`Gender-male-thin`: ImageVector
    get() {
        if (`_gender-male-thin` != null) {
            return `_gender-male-thin`!!
        }
        `_gender-male-thin` = Builder(name = "Gender-male-thin", defaultWidth = 256.0.dp,
...
private var `_gender-male-thin`: ImageVector? = null
