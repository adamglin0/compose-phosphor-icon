...
public val LightGroup.`Truck-light`: ImageVector
    get() {
        if (`_truck-light` != null) {
            return `_truck-light`!!
        }
        `_truck-light` = Builder(name = "Truck-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_truck-light`: ImageVector? = null
