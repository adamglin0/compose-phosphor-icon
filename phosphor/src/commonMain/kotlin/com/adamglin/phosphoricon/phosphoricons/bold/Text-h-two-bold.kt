...
public val BoldGroup.`Text-h-two-bold`: ImageVector
    get() {
        if (`_text-h-two-bold` != null) {
            return `_text-h-two-bold`!!
        }
        `_text-h-two-bold` = Builder(name = "Text-h-two-bold", defaultWidth = 256.0.dp,
...
private var `_text-h-two-bold`: ImageVector? = null
