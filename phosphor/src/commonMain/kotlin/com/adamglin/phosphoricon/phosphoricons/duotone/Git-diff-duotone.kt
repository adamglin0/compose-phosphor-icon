...
public val DuotoneGroup.`Git-diff-duotone`: ImageVector
    get() {
        if (`_git-diff-duotone` != null) {
            return `_git-diff-duotone`!!
        }
        `_git-diff-duotone` = Builder(name = "Git-diff-duotone", defaultWidth = 256.0.dp,
...
private var `_git-diff-duotone`: ImageVector? = null
