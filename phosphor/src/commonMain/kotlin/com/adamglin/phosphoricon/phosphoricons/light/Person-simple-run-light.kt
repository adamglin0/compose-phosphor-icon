...
public val LightGroup.`Person-simple-run-light`: ImageVector
    get() {
        if (`_person-simple-run-light` != null) {
            return `_person-simple-run-light`!!
        }
        `_person-simple-run-light` = Builder(name = "Person-simple-run-light", defaultWidth =
...
private var `_person-simple-run-light`: ImageVector? = null
