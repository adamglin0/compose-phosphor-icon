...
public val DuotoneGroup.`Chats-duotone`: ImageVector
    get() {
        if (`_chats-duotone` != null) {
            return `_chats-duotone`!!
        }
        `_chats-duotone` = Builder(name = "Chats-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chats-duotone`: ImageVector? = null
