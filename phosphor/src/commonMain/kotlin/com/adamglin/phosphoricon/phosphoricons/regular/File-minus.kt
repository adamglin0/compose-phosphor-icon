...
public val RegularGroup.`File-minus`: ImageVector
    get() {
        if (`_file-minus` != null) {
            return `_file-minus`!!
        }
        `_file-minus` = Builder(name = "File-minus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-minus`: ImageVector? = null
