...
public val LightGroup.`Mask-sad-light`: ImageVector
    get() {
        if (`_mask-sad-light` != null) {
            return `_mask-sad-light`!!
        }
        `_mask-sad-light` = Builder(name = "Mask-sad-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_mask-sad-light`: ImageVector? = null
