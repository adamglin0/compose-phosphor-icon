...
public val DuotoneGroup.`Smiley-nervous-duotone`: ImageVector
    get() {
        if (`_smiley-nervous-duotone` != null) {
            return `_smiley-nervous-duotone`!!
        }
        `_smiley-nervous-duotone` = Builder(name = "Smiley-nervous-duotone", defaultWidth =
...
private var `_smiley-nervous-duotone`: ImageVector? = null
