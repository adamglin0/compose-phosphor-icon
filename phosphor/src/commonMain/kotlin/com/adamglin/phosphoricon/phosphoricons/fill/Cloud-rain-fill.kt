...
public val FillGroup.`Cloud-rain-fill`: ImageVector
    get() {
        if (`_cloud-rain-fill` != null) {
            return `_cloud-rain-fill`!!
        }
        `_cloud-rain-fill` = Builder(name = "Cloud-rain-fill", defaultWidth = 256.0.dp,
...
private var `_cloud-rain-fill`: ImageVector? = null
