...
public val ThinGroup.`Codepen-logo-thin`: ImageVector
    get() {
        if (`_codepen-logo-thin` != null) {
            return `_codepen-logo-thin`!!
        }
        `_codepen-logo-thin` = Builder(name = "Codepen-logo-thin", defaultWidth = 256.0.dp,
...
private var `_codepen-logo-thin`: ImageVector? = null
