...
public val DuotoneGroup.`City-duotone`: ImageVector
    get() {
        if (`_city-duotone` != null) {
            return `_city-duotone`!!
        }
        `_city-duotone` = Builder(name = "City-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_city-duotone`: ImageVector? = null
