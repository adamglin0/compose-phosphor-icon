...
public val ThinGroup.`Exclude-square-thin`: ImageVector
    get() {
        if (`_exclude-square-thin` != null) {
            return `_exclude-square-thin`!!
        }
        `_exclude-square-thin` = Builder(name = "Exclude-square-thin", defaultWidth = 256.0.dp,
...
private var `_exclude-square-thin`: ImageVector? = null
