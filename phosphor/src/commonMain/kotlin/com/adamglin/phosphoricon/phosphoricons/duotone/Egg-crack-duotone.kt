...
public val DuotoneGroup.`Egg-crack-duotone`: ImageVector
    get() {
        if (`_egg-crack-duotone` != null) {
            return `_egg-crack-duotone`!!
        }
        `_egg-crack-duotone` = Builder(name = "Egg-crack-duotone", defaultWidth = 256.0.dp,
...
private var `_egg-crack-duotone`: ImageVector? = null
