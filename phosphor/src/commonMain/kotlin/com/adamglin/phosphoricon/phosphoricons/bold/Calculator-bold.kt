...
public val BoldGroup.`Calculator-bold`: ImageVector
    get() {
        if (`_calculator-bold` != null) {
            return `_calculator-bold`!!
        }
        `_calculator-bold` = Builder(name = "Calculator-bold", defaultWidth = 256.0.dp,
...
private var `_calculator-bold`: ImageVector? = null
