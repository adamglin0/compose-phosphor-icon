...
public val RegularGroup.`Hand-swipe-left`: ImageVector
    get() {
        if (`_hand-swipe-left` != null) {
            return `_hand-swipe-left`!!
        }
        `_hand-swipe-left` = Builder(name = "Hand-swipe-left", defaultWidth = 256.0.dp,
...
private var `_hand-swipe-left`: ImageVector? = null
