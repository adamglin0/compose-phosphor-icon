...
public val FillGroup.`Microphone-slash-fill`: ImageVector
    get() {
        if (`_microphone-slash-fill` != null) {
            return `_microphone-slash-fill`!!
        }
        `_microphone-slash-fill` = Builder(name = "Microphone-slash-fill", defaultWidth = 256.0.dp,
...
private var `_microphone-slash-fill`: ImageVector? = null
