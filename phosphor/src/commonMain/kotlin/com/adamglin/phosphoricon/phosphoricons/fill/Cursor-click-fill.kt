...
public val FillGroup.`Cursor-click-fill`: ImageVector
    get() {
        if (`_cursor-click-fill` != null) {
            return `_cursor-click-fill`!!
        }
        `_cursor-click-fill` = Builder(name = "Cursor-click-fill", defaultWidth = 256.0.dp,
...
private var `_cursor-click-fill`: ImageVector? = null
