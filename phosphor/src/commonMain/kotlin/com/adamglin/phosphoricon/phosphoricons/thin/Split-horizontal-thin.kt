...
public val ThinGroup.`Split-horizontal-thin`: ImageVector
    get() {
        if (`_split-horizontal-thin` != null) {
            return `_split-horizontal-thin`!!
        }
        `_split-horizontal-thin` = Builder(name = "Split-horizontal-thin", defaultWidth = 256.0.dp,
...
private var `_split-horizontal-thin`: ImageVector? = null
