...
public val RegularGroup.`Wifi-medium`: ImageVector
    get() {
        if (`_wifi-medium` != null) {
            return `_wifi-medium`!!
        }
        `_wifi-medium` = Builder(name = "Wifi-medium", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wifi-medium`: ImageVector? = null
