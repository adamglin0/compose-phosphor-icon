...
public val BoldGroup.`Chat-centered-slash-bold`: ImageVector
    get() {
        if (`_chat-centered-slash-bold` != null) {
            return `_chat-centered-slash-bold`!!
        }
        `_chat-centered-slash-bold` = Builder(name = "Chat-centered-slash-bold", defaultWidth =
...
private var `_chat-centered-slash-bold`: ImageVector? = null
