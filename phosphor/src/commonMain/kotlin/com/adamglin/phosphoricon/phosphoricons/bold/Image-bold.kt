...
public val BoldGroup.`Image-bold`: ImageVector
    get() {
        if (`_image-bold` != null) {
            return `_image-bold`!!
        }
        `_image-bold` = Builder(name = "Image-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_image-bold`: ImageVector? = null
