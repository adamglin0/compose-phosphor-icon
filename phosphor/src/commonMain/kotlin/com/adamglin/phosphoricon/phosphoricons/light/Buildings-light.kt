...
public val LightGroup.`Buildings-light`: ImageVector
    get() {
        if (`_buildings-light` != null) {
            return `_buildings-light`!!
        }
        `_buildings-light` = Builder(name = "Buildings-light", defaultWidth = 256.0.dp,
...
private var `_buildings-light`: ImageVector? = null
