...
public val LightGroup.`Split-vertical-light`: ImageVector
    get() {
        if (`_split-vertical-light` != null) {
            return `_split-vertical-light`!!
        }
        `_split-vertical-light` = Builder(name = "Split-vertical-light", defaultWidth = 256.0.dp,
...
private var `_split-vertical-light`: ImageVector? = null
