...
public val ThinGroup.`Plugs-connected-thin`: ImageVector
    get() {
        if (`_plugs-connected-thin` != null) {
            return `_plugs-connected-thin`!!
        }
        `_plugs-connected-thin` = Builder(name = "Plugs-connected-thin", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(3.91f, 3.91f, 0.0f, false, true, 104.0f, 56.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.71f, -2.51f)
                close()
                moveTo(28.29f, 94.49f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 5.2f, -2.22f)
                lineToRelative(20.0f, 8.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 52.0f, 108.0f)
                arcToRelative(3.91f, 3.91f, 0.0f, false, true, -1.49f, -0.29f)
                lineToRelative(-20.0f, -8.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 28.29f, 94.51f)
                close()
                moveTo(227.71f, 161.49f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 224.0f, 164.0f)
                arcToRelative(3.91f, 3.91f, 0.0f, false, true, -1.49f, -0.29f)
                lineToRelative(-20.0f, -8.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, true, true, 3.0f, -7.42f)
                lineToRelative(20.0f, 8.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 227.71f, 161.49f)
                close()
                moveTo(163.71f, 222.49f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.22f, 5.2f)
                arcTo(3.91f, 3.91f, 0.0f, false, true, 160.0f, 228.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.71f, -2.51f)
                lineToRelative(-8.0f, -20.0f)
...
private var `_plugs-connected-thin`: ImageVector? = null
