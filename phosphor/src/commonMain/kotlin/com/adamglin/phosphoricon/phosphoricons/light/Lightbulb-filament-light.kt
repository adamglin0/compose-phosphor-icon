...
public val LightGroup.`Lightbulb-filament-light`: ImageVector
    get() {
        if (`_lightbulb-filament-light` != null) {
            return `_lightbulb-filament-light`!!
        }
        `_lightbulb-filament-light` = Builder(name = "Lightbulb-filament-light", defaultWidth =
...
private var `_lightbulb-filament-light`: ImageVector? = null
