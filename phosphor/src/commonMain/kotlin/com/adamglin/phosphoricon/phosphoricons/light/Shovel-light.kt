...
public val LightGroup.`Shovel-light`: ImageVector
    get() {
        if (`_shovel-light` != null) {
            return `_shovel-light`!!
        }
        `_shovel-light` = Builder(name = "Shovel-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shovel-light`: ImageVector? = null
