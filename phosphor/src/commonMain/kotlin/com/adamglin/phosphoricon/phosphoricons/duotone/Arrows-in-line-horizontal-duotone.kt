...
public val DuotoneGroup.`Arrows-in-line-horizontal-duotone`: ImageVector
    get() {
        if (`_arrows-in-line-horizontal-duotone` != null) {
            return `_arrows-in-line-horizontal-duotone`!!
        }
        `_arrows-in-line-horizontal-duotone` = Builder(name = "Arrows-in-line-horizontal-duotone",
...
private var `_arrows-in-line-horizontal-duotone`: ImageVector? = null
