...
public val LightGroup.`Wifi-slash-light`: ImageVector
    get() {
        if (`_wifi-slash-light` != null) {
            return `_wifi-slash-light`!!
        }
        `_wifi-slash-light` = Builder(name = "Wifi-slash-light", defaultWidth = 256.0.dp,
...
private var `_wifi-slash-light`: ImageVector? = null
