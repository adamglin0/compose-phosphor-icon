...
public val LightGroup.`Person-simple-bike-light`: ImageVector
    get() {
        if (`_person-simple-bike-light` != null) {
            return `_person-simple-bike-light`!!
        }
        `_person-simple-bike-light` = Builder(name = "Person-simple-bike-light", defaultWidth =
...
private var `_person-simple-bike-light`: ImageVector? = null
