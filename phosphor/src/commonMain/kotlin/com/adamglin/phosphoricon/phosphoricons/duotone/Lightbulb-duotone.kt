...
public val DuotoneGroup.`Lightbulb-duotone`: ImageVector
    get() {
        if (`_lightbulb-duotone` != null) {
            return `_lightbulb-duotone`!!
        }
        `_lightbulb-duotone` = Builder(name = "Lightbulb-duotone", defaultWidth = 256.0.dp,
...
private var `_lightbulb-duotone`: ImageVector? = null
