...
public val LightGroup.`Hard-hat-light`: ImageVector
    get() {
        if (`_hard-hat-light` != null) {
            return `_hard-hat-light`!!
        }
        `_hard-hat-light` = Builder(name = "Hard-hat-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hard-hat-light`: ImageVector? = null
