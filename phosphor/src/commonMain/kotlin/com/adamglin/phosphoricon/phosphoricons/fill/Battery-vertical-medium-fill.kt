...
public val FillGroup.`Battery-vertical-medium-fill`: ImageVector
    get() {
        if (`_battery-vertical-medium-fill` != null) {
            return `_battery-vertical-medium-fill`!!
        }
        `_battery-vertical-medium-fill` = Builder(name = "Battery-vertical-medium-fill",
...
private var `_battery-vertical-medium-fill`: ImageVector? = null
