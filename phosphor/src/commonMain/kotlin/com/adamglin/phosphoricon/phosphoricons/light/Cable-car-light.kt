...
public val LightGroup.`Cable-car-light`: ImageVector
    get() {
        if (`_cable-car-light` != null) {
            return `_cable-car-light`!!
        }
        `_cable-car-light` = Builder(name = "Cable-car-light", defaultWidth = 256.0.dp,
...
private var `_cable-car-light`: ImageVector? = null
