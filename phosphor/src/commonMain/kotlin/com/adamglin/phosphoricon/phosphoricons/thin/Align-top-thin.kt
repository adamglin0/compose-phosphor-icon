...
public val ThinGroup.`Align-top-thin`: ImageVector
    get() {
        if (`_align-top-thin` != null) {
            return `_align-top-thin`!!
        }
        `_align-top-thin` = Builder(name = "Align-top-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_align-top-thin`: ImageVector? = null
