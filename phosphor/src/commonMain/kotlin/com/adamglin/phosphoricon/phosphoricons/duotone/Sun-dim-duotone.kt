...
public val DuotoneGroup.`Sun-dim-duotone`: ImageVector
    get() {
        if (`_sun-dim-duotone` != null) {
            return `_sun-dim-duotone`!!
        }
        `_sun-dim-duotone` = Builder(name = "Sun-dim-duotone", defaultWidth = 256.0.dp,
...
private var `_sun-dim-duotone`: ImageVector? = null
