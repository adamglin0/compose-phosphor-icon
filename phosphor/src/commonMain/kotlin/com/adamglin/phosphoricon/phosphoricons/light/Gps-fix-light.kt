...
public val LightGroup.`Gps-fix-light`: ImageVector
    get() {
        if (`_gps-fix-light` != null) {
            return `_gps-fix-light`!!
        }
        `_gps-fix-light` = Builder(name = "Gps-fix-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gps-fix-light`: ImageVector? = null
