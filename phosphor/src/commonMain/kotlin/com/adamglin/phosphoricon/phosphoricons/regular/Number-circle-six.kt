...
public val RegularGroup.`Number-circle-six`: ImageVector
    get() {
        if (`_number-circle-six` != null) {
            return `_number-circle-six`!!
        }
        `_number-circle-six` = Builder(name = "Number-circle-six", defaultWidth = 256.0.dp,
...
private var `_number-circle-six`: ImageVector? = null
