...
public val RegularGroup.`Paperclip-horizontal`: ImageVector
    get() {
        if (`_paperclip-horizontal` != null) {
            return `_paperclip-horizontal`!!
        }
        `_paperclip-horizontal` = Builder(name = "Paperclip-horizontal", defaultWidth = 256.0.dp,
...
private var `_paperclip-horizontal`: ImageVector? = null
