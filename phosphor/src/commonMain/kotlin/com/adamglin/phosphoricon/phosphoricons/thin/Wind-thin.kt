...
public val ThinGroup.`Wind-thin`: ImageVector
    get() {
        if (`_wind-thin` != null) {
            return `_wind-thin`!!
        }
        `_wind-thin` = Builder(name = "Wind-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wind-thin`: ImageVector? = null
