...
public val BoldGroup.`Number-circle-three-bold`: ImageVector
    get() {
        if (`_number-circle-three-bold` != null) {
            return `_number-circle-three-bold`!!
        }
        `_number-circle-three-bold` = Builder(name = "Number-circle-three-bold", defaultWidth =
...
private var `_number-circle-three-bold`: ImageVector? = null
