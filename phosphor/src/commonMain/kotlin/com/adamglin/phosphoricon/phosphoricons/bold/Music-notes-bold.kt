...
public val BoldGroup.`Music-notes-bold`: ImageVector
    get() {
        if (`_music-notes-bold` != null) {
            return `_music-notes-bold`!!
        }
        `_music-notes-bold` = Builder(name = "Music-notes-bold", defaultWidth = 256.0.dp,
...
private var `_music-notes-bold`: ImageVector? = null
