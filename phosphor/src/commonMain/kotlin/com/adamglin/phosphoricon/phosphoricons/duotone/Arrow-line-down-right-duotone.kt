...
public val DuotoneGroup.`Arrow-line-down-right-duotone`: ImageVector
    get() {
        if (`_arrow-line-down-right-duotone` != null) {
            return `_arrow-line-down-right-duotone`!!
        }
        `_arrow-line-down-right-duotone` = Builder(name = "Arrow-line-down-right-duotone",
...
private var `_arrow-line-down-right-duotone`: ImageVector? = null
