...
public val LightGroup.`Map-pin-area-light`: ImageVector
    get() {
        if (`_map-pin-area-light` != null) {
            return `_map-pin-area-light`!!
        }
        `_map-pin-area-light` = Builder(name = "Map-pin-area-light", defaultWidth = 256.0.dp,
...
private var `_map-pin-area-light`: ImageVector? = null
