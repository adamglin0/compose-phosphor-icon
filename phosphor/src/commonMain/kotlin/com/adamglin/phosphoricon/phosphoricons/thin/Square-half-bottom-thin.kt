...
public val ThinGroup.`Square-half-bottom-thin`: ImageVector
    get() {
        if (`_square-half-bottom-thin` != null) {
            return `_square-half-bottom-thin`!!
        }
        `_square-half-bottom-thin` = Builder(name = "Square-half-bottom-thin", defaultWidth =
...
private var `_square-half-bottom-thin`: ImageVector? = null
