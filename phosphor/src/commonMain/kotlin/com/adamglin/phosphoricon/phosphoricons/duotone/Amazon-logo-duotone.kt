...
public val DuotoneGroup.`Amazon-logo-duotone`: ImageVector
    get() {
        if (`_amazon-logo-duotone` != null) {
            return `_amazon-logo-duotone`!!
        }
        `_amazon-logo-duotone` = Builder(name = "Amazon-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_amazon-logo-duotone`: ImageVector? = null
