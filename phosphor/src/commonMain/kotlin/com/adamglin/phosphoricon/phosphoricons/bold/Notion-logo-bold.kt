...
public val BoldGroup.`Notion-logo-bold`: ImageVector
    get() {
        if (`_notion-logo-bold` != null) {
            return `_notion-logo-bold`!!
        }
        `_notion-logo-bold` = Builder(name = "Notion-logo-bold", defaultWidth = 256.0.dp,
...
private var `_notion-logo-bold`: ImageVector? = null
