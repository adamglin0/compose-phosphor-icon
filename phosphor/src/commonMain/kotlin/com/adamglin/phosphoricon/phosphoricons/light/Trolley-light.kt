...
public val LightGroup.`Trolley-light`: ImageVector
    get() {
        if (`_trolley-light` != null) {
            return `_trolley-light`!!
        }
        `_trolley-light` = Builder(name = "Trolley-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_trolley-light`: ImageVector? = null
