...
public val BoldGroup.`Smiley-blank-bold`: ImageVector
    get() {
        if (`_smiley-blank-bold` != null) {
            return `_smiley-blank-bold`!!
        }
        `_smiley-blank-bold` = Builder(name = "Smiley-blank-bold", defaultWidth = 256.0.dp,
...
private var `_smiley-blank-bold`: ImageVector? = null
