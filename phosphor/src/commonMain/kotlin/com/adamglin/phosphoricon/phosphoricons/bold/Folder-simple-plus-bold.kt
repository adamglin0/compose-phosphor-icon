...
public val BoldGroup.`Folder-simple-plus-bold`: ImageVector
    get() {
        if (`_folder-simple-plus-bold` != null) {
            return `_folder-simple-plus-bold`!!
        }
        `_folder-simple-plus-bold` = Builder(name = "Folder-simple-plus-bold", defaultWidth =
...
private var `_folder-simple-plus-bold`: ImageVector? = null
