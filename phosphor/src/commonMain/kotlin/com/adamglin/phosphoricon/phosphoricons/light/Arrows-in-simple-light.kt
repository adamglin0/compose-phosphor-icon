...
public val LightGroup.`Arrows-in-simple-light`: ImageVector
    get() {
        if (`_arrows-in-simple-light` != null) {
            return `_arrows-in-simple-light`!!
        }
        `_arrows-in-simple-light` = Builder(name = "Arrows-in-simple-light", defaultWidth =
...
private var `_arrows-in-simple-light`: ImageVector? = null
