...
public val BoldGroup.`Chat-teardrop-slash-bold`: ImageVector
    get() {
        if (`_chat-teardrop-slash-bold` != null) {
            return `_chat-teardrop-slash-bold`!!
        }
        `_chat-teardrop-slash-bold` = Builder(name = "Chat-teardrop-slash-bold", defaultWidth =
...
private var `_chat-teardrop-slash-bold`: ImageVector? = null
