...
public val LightGroup.`Car-light`: ImageVector
    get() {
        if (`_car-light` != null) {
            return `_car-light`!!
        }
        `_car-light` = Builder(name = "Car-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_car-light`: ImageVector? = null
