...
public val LightGroup.`Fast-forward-light`: ImageVector
    get() {
        if (`_fast-forward-light` != null) {
            return `_fast-forward-light`!!
        }
        `_fast-forward-light` = Builder(name = "Fast-forward-light", defaultWidth = 256.0.dp,
...
private var `_fast-forward-light`: ImageVector? = null
