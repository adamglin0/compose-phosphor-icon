...
public val ThinGroup.`Number-square-seven-thin`: ImageVector
    get() {
        if (`_number-square-seven-thin` != null) {
            return `_number-square-seven-thin`!!
        }
        `_number-square-seven-thin` = Builder(name = "Number-square-seven-thin", defaultWidth =
...
private var `_number-square-seven-thin`: ImageVector? = null
