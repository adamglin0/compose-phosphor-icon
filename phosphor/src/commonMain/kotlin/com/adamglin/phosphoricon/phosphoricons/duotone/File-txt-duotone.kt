...
public val DuotoneGroup.`File-txt-duotone`: ImageVector
    get() {
        if (`_file-txt-duotone` != null) {
            return `_file-txt-duotone`!!
        }
        `_file-txt-duotone` = Builder(name = "File-txt-duotone", defaultWidth = 256.0.dp,
...
private var `_file-txt-duotone`: ImageVector? = null
