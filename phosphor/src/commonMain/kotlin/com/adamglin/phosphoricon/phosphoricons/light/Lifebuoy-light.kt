...
public val LightGroup.`Lifebuoy-light`: ImageVector
    get() {
        if (`_lifebuoy-light` != null) {
            return `_lifebuoy-light`!!
        }
        `_lifebuoy-light` = Builder(name = "Lifebuoy-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_lifebuoy-light`: ImageVector? = null
