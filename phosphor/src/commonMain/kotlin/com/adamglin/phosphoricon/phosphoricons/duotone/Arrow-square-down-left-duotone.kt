...
public val DuotoneGroup.`Arrow-square-down-left-duotone`: ImageVector
    get() {
        if (`_arrow-square-down-left-duotone` != null) {
            return `_arrow-square-down-left-duotone`!!
        }
        `_arrow-square-down-left-duotone` = Builder(name = "Arrow-square-down-left-duotone",
...
private var `_arrow-square-down-left-duotone`: ImageVector? = null
