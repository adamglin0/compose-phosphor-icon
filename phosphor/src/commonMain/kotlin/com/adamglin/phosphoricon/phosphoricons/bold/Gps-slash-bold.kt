...
public val BoldGroup.`Gps-slash-bold`: ImageVector
    get() {
        if (`_gps-slash-bold` != null) {
            return `_gps-slash-bold`!!
        }
        `_gps-slash-bold` = Builder(name = "Gps-slash-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_gps-slash-bold`: ImageVector? = null
