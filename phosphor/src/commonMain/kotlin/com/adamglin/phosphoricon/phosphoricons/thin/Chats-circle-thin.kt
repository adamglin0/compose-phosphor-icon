...
public val ThinGroup.`Chats-circle-thin`: ImageVector
    get() {
        if (`_chats-circle-thin` != null) {
            return `_chats-circle-thin`!!
        }
        `_chats-circle-thin` = Builder(name = "Chats-circle-thin", defaultWidth = 256.0.dp,
...
private var `_chats-circle-thin`: ImageVector? = null
