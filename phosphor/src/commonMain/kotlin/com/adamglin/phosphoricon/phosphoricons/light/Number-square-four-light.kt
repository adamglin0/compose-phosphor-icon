...
public val LightGroup.`Number-square-four-light`: ImageVector
    get() {
        if (`_number-square-four-light` != null) {
            return `_number-square-four-light`!!
        }
        `_number-square-four-light` = Builder(name = "Number-square-four-light", defaultWidth =
...
private var `_number-square-four-light`: ImageVector? = null
