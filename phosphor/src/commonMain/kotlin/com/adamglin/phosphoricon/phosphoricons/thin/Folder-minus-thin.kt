...
public val ThinGroup.`Folder-minus-thin`: ImageVector
    get() {
        if (`_folder-minus-thin` != null) {
            return `_folder-minus-thin`!!
        }
        `_folder-minus-thin` = Builder(name = "Folder-minus-thin", defaultWidth = 256.0.dp,
...
private var `_folder-minus-thin`: ImageVector? = null
