...
public val BoldGroup.`Tag-bold`: ImageVector
    get() {
        if (`_tag-bold` != null) {
            return `_tag-bold`!!
        }
        `_tag-bold` = Builder(name = "Tag-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_tag-bold`: ImageVector? = null
