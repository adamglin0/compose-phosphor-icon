...
public val LightGroup.`Tree-palm-light`: ImageVector
    get() {
        if (`_tree-palm-light` != null) {
            return `_tree-palm-light`!!
        }
        `_tree-palm-light` = Builder(name = "Tree-palm-light", defaultWidth = 256.0.dp,
...
private var `_tree-palm-light`: ImageVector? = null
