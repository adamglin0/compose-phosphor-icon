...
public val DuotoneGroup.`Notion-logo-duotone`: ImageVector
    get() {
        if (`_notion-logo-duotone` != null) {
            return `_notion-logo-duotone`!!
        }
        `_notion-logo-duotone` = Builder(name = "Notion-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_notion-logo-duotone`: ImageVector? = null
