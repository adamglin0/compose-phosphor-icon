...
public val LightGroup.`Dice-two-light`: ImageVector
    get() {
        if (`_dice-two-light` != null) {
            return `_dice-two-light`!!
        }
        `_dice-two-light` = Builder(name = "Dice-two-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dice-two-light`: ImageVector? = null
