...
public val DuotoneGroup.`Text-h-five-duotone`: ImageVector
    get() {
        if (`_text-h-five-duotone` != null) {
            return `_text-h-five-duotone`!!
        }
        `_text-h-five-duotone` = Builder(name = "Text-h-five-duotone", defaultWidth = 256.0.dp,
...
private var `_text-h-five-duotone`: ImageVector? = null
