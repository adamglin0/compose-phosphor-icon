...
public val DuotoneGroup.`Dots-six-vertical-duotone`: ImageVector
    get() {
        if (`_dots-six-vertical-duotone` != null) {
            return `_dots-six-vertical-duotone`!!
        }
        `_dots-six-vertical-duotone` = Builder(name = "Dots-six-vertical-duotone", defaultWidth =
...
private var `_dots-six-vertical-duotone`: ImageVector? = null
