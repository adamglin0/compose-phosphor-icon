...
public val ThinGroup.`Brandy-thin`: ImageVector
    get() {
        if (`_brandy-thin` != null) {
            return `_brandy-thin`!!
        }
        `_brandy-thin` = Builder(name = "Brandy-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_brandy-thin`: ImageVector? = null
