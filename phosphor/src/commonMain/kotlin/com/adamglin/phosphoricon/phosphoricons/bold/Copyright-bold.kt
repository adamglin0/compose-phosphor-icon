...
public val BoldGroup.`Copyright-bold`: ImageVector
    get() {
        if (`_copyright-bold` != null) {
            return `_copyright-bold`!!
        }
        `_copyright-bold` = Builder(name = "Copyright-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_copyright-bold`: ImageVector? = null
