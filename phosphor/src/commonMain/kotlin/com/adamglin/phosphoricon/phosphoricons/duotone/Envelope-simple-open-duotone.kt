...
public val DuotoneGroup.`Envelope-simple-open-duotone`: ImageVector
    get() {
        if (`_envelope-simple-open-duotone` != null) {
            return `_envelope-simple-open-duotone`!!
        }
        `_envelope-simple-open-duotone` = Builder(name = "Envelope-simple-open-duotone",
...
private var `_envelope-simple-open-duotone`: ImageVector? = null
