...
public val BoldGroup.`Tree-structure-bold`: ImageVector
    get() {
        if (`_tree-structure-bold` != null) {
            return `_tree-structure-bold`!!
        }
        `_tree-structure-bold` = Builder(name = "Tree-structure-bold", defaultWidth = 256.0.dp,
...
private var `_tree-structure-bold`: ImageVector? = null
