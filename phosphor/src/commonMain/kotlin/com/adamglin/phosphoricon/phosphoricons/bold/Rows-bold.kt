...
public val BoldGroup.`Rows-bold`: ImageVector
    get() {
        if (`_rows-bold` != null) {
            return `_rows-bold`!!
        }
        `_rows-bold` = Builder(name = "Rows-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rows-bold`: ImageVector? = null
