...
public val RegularGroup.`Plug-charging`: ImageVector
    get() {
        if (`_plug-charging` != null) {
            return `_plug-charging`!!
        }
        `_plug-charging` = Builder(name = "Plug-charging", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plug-charging`: ImageVector? = null
