...
public val ThinGroup.`Beach-ball-thin`: ImageVector
    get() {
        if (`_beach-ball-thin` != null) {
            return `_beach-ball-thin`!!
        }
        `_beach-ball-thin` = Builder(name = "Beach-ball-thin", defaultWidth = 256.0.dp,
...
private var `_beach-ball-thin`: ImageVector? = null
