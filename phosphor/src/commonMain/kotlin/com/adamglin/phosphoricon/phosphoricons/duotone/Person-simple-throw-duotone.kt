...
public val DuotoneGroup.`Person-simple-throw-duotone`: ImageVector
    get() {
        if (`_person-simple-throw-duotone` != null) {
            return `_person-simple-throw-duotone`!!
        }
        `_person-simple-throw-duotone` = Builder(name = "Person-simple-throw-duotone", defaultWidth
...
private var `_person-simple-throw-duotone`: ImageVector? = null
