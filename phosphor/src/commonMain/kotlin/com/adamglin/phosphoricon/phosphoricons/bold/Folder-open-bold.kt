...
public val BoldGroup.`Folder-open-bold`: ImageVector
    get() {
        if (`_folder-open-bold` != null) {
            return `_folder-open-bold`!!
        }
        `_folder-open-bold` = Builder(name = "Folder-open-bold", defaultWidth = 256.0.dp,
...
private var `_folder-open-bold`: ImageVector? = null
