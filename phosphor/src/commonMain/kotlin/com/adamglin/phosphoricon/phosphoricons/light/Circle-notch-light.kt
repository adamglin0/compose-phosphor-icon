...
public val LightGroup.`Circle-notch-light`: ImageVector
    get() {
        if (`_circle-notch-light` != null) {
            return `_circle-notch-light`!!
        }
        `_circle-notch-light` = Builder(name = "Circle-notch-light", defaultWidth = 256.0.dp,
...
private var `_circle-notch-light`: ImageVector? = null
