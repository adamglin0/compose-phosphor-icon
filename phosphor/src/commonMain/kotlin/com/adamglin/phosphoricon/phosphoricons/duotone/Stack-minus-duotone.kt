...
public val DuotoneGroup.`Stack-minus-duotone`: ImageVector
    get() {
        if (`_stack-minus-duotone` != null) {
            return `_stack-minus-duotone`!!
        }
        `_stack-minus-duotone` = Builder(name = "Stack-minus-duotone", defaultWidth = 256.0.dp,
...
private var `_stack-minus-duotone`: ImageVector? = null
