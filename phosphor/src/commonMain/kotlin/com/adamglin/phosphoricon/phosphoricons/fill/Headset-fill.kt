...
public val FillGroup.`Headset-fill`: ImageVector
    get() {
        if (`_headset-fill` != null) {
            return `_headset-fill`!!
        }
        `_headset-fill` = Builder(name = "Headset-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_headset-fill`: ImageVector? = null
