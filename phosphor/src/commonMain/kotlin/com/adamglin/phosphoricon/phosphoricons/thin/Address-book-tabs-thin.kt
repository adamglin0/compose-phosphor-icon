...
public val ThinGroup.`Address-book-tabs-thin`: ImageVector
    get() {
        if (`_address-book-tabs-thin` != null) {
            return `_address-book-tabs-thin`!!
        }
        `_address-book-tabs-thin` = Builder(name = "Address-book-tabs-thin", defaultWidth =
...
private var `_address-book-tabs-thin`: ImageVector? = null
