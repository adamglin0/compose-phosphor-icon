...
public val ThinGroup.`Plus-square-thin`: ImageVector
    get() {
        if (`_plus-square-thin` != null) {
            return `_plus-square-thin`!!
        }
        `_plus-square-thin` = Builder(name = "Plus-square-thin", defaultWidth = 256.0.dp,
...
private var `_plus-square-thin`: ImageVector? = null
