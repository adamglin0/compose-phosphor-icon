...
public val DuotoneGroup.`Dropbox-logo-duotone`: ImageVector
    get() {
        if (`_dropbox-logo-duotone` != null) {
            return `_dropbox-logo-duotone`!!
        }
        `_dropbox-logo-duotone` = Builder(name = "Dropbox-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_dropbox-logo-duotone`: ImageVector? = null
