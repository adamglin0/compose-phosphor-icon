...
public val DuotoneGroup.`Brain-duotone`: ImageVector
    get() {
        if (`_brain-duotone` != null) {
            return `_brain-duotone`!!
        }
        `_brain-duotone` = Builder(name = "Brain-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_brain-duotone`: ImageVector? = null
