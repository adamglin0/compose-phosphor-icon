...
public val BoldGroup.`Microsoft-excel-logo-bold`: ImageVector
    get() {
        if (`_microsoft-excel-logo-bold` != null) {
            return `_microsoft-excel-logo-bold`!!
        }
        `_microsoft-excel-logo-bold` = Builder(name = "Microsoft-excel-logo-bold", defaultWidth =
...
private var `_microsoft-excel-logo-bold`: ImageVector? = null
