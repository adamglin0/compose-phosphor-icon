...
public val RegularGroup.`Battery-warning`: ImageVector
    get() {
        if (`_battery-warning` != null) {
            return `_battery-warning`!!
        }
        `_battery-warning` = Builder(name = "Battery-warning", defaultWidth = 256.0.dp,
...
private var `_battery-warning`: ImageVector? = null
