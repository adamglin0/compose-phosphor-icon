...
public val DuotoneGroup.`Thermometer-hot-duotone`: ImageVector
    get() {
        if (`_thermometer-hot-duotone` != null) {
            return `_thermometer-hot-duotone`!!
        }
        `_thermometer-hot-duotone` = Builder(name = "Thermometer-hot-duotone", defaultWidth =
...
private var `_thermometer-hot-duotone`: ImageVector? = null
