...
public val LightGroup.`Images-square-light`: ImageVector
    get() {
        if (`_images-square-light` != null) {
            return `_images-square-light`!!
        }
        `_images-square-light` = Builder(name = "Images-square-light", defaultWidth = 256.0.dp,
...
private var `_images-square-light`: ImageVector? = null
