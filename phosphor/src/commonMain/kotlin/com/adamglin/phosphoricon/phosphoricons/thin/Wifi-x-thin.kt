...
public val ThinGroup.`Wifi-x-thin`: ImageVector
    get() {
        if (`_wifi-x-thin` != null) {
            return `_wifi-x-thin`!!
        }
        `_wifi-x-thin` = Builder(name = "Wifi-x-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wifi-x-thin`: ImageVector? = null
