...
public val LightGroup.`House-simple-light`: ImageVector
    get() {
        if (`_house-simple-light` != null) {
            return `_house-simple-light`!!
        }
        `_house-simple-light` = Builder(name = "House-simple-light", defaultWidth = 256.0.dp,
...
private var `_house-simple-light`: ImageVector? = null
