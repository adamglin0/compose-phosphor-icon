...
public val BoldGroup.`Paint-roller-bold`: ImageVector
    get() {
        if (`_paint-roller-bold` != null) {
            return `_paint-roller-bold`!!
        }
        `_paint-roller-bold` = Builder(name = "Paint-roller-bold", defaultWidth = 256.0.dp,
...
private var `_paint-roller-bold`: ImageVector? = null
