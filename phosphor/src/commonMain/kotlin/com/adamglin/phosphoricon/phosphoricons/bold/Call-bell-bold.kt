...
public val BoldGroup.`Call-bell-bold`: ImageVector
    get() {
        if (`_call-bell-bold` != null) {
            return `_call-bell-bold`!!
        }
        `_call-bell-bold` = Builder(name = "Call-bell-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_call-bell-bold`: ImageVector? = null
