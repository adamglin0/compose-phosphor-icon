...
public val DuotoneGroup.`Warning-octagon-duotone`: ImageVector
    get() {
        if (`_warning-octagon-duotone` != null) {
            return `_warning-octagon-duotone`!!
        }
        `_warning-octagon-duotone` = Builder(name = "Warning-octagon-duotone", defaultWidth =
...
private var `_warning-octagon-duotone`: ImageVector? = null
