...
public val DuotoneGroup.`Cookie-duotone`: ImageVector
    get() {
        if (`_cookie-duotone` != null) {
            return `_cookie-duotone`!!
        }
        `_cookie-duotone` = Builder(name = "Cookie-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cookie-duotone`: ImageVector? = null
