...
public val LightGroup.`Battery-high-light`: ImageVector
    get() {
        if (`_battery-high-light` != null) {
            return `_battery-high-light`!!
        }
        `_battery-high-light` = Builder(name = "Battery-high-light", defaultWidth = 256.0.dp,
...
private var `_battery-high-light`: ImageVector? = null
