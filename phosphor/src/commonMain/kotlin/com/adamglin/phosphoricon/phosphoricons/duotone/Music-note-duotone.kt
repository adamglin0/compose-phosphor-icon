...
public val DuotoneGroup.`Music-note-duotone`: ImageVector
    get() {
        if (`_music-note-duotone` != null) {
            return `_music-note-duotone`!!
        }
        `_music-note-duotone` = Builder(name = "Music-note-duotone", defaultWidth = 256.0.dp,
...
private var `_music-note-duotone`: ImageVector? = null
