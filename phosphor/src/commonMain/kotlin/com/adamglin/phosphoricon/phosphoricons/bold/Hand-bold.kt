...
public val BoldGroup.`Hand-bold`: ImageVector
    get() {
        if (`_hand-bold` != null) {
            return `_hand-bold`!!
        }
        `_hand-bold` = Builder(name = "Hand-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-bold`: ImageVector? = null
