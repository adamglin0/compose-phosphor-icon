...
public val FillGroup.`Gear-six-fill`: ImageVector
    get() {
        if (`_gear-six-fill` != null) {
            return `_gear-six-fill`!!
        }
        `_gear-six-fill` = Builder(name = "Gear-six-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gear-six-fill`: ImageVector? = null
