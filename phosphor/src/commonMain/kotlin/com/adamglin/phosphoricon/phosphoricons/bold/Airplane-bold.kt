...
public val BoldGroup.`Airplane-bold`: ImageVector
    get() {
        if (`_airplane-bold` != null) {
            return `_airplane-bold`!!
        }
        `_airplane-bold` = Builder(name = "Airplane-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_airplane-bold`: ImageVector? = null
