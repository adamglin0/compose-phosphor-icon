...
public val BoldGroup.`Speaker-slash-bold`: ImageVector
    get() {
        if (`_speaker-slash-bold` != null) {
            return `_speaker-slash-bold`!!
        }
        `_speaker-slash-bold` = Builder(name = "Speaker-slash-bold", defaultWidth = 256.0.dp,
...
private var `_speaker-slash-bold`: ImageVector? = null
