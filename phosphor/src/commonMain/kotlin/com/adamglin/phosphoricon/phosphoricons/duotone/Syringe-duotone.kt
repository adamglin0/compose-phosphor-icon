...
public val DuotoneGroup.`Syringe-duotone`: ImageVector
    get() {
        if (`_syringe-duotone` != null) {
            return `_syringe-duotone`!!
        }
        `_syringe-duotone` = Builder(name = "Syringe-duotone", defaultWidth = 256.0.dp,
...
private var `_syringe-duotone`: ImageVector? = null
