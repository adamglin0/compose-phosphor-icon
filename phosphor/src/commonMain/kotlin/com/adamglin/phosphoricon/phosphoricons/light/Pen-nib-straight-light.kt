...
public val LightGroup.`Pen-nib-straight-light`: ImageVector
    get() {
        if (`_pen-nib-straight-light` != null) {
            return `_pen-nib-straight-light`!!
        }
        `_pen-nib-straight-light` = Builder(name = "Pen-nib-straight-light", defaultWidth =
...
private var `_pen-nib-straight-light`: ImageVector? = null
