...
public val RegularGroup.`Egg-crack`: ImageVector
    get() {
        if (`_egg-crack` != null) {
            return `_egg-crack`!!
        }
        `_egg-crack` = Builder(name = "Egg-crack", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_egg-crack`: ImageVector? = null
