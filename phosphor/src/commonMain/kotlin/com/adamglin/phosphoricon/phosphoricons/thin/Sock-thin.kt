...
public val ThinGroup.`Sock-thin`: ImageVector
    get() {
        if (`_sock-thin` != null) {
            return `_sock-thin`!!
        }
        `_sock-thin` = Builder(name = "Sock-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sock-thin`: ImageVector? = null
