...
public val DuotoneGroup.`Music-notes-plus-duotone`: ImageVector
    get() {
        if (`_music-notes-plus-duotone` != null) {
            return `_music-notes-plus-duotone`!!
        }
        `_music-notes-plus-duotone` = Builder(name = "Music-notes-plus-duotone", defaultWidth =
...
private var `_music-notes-plus-duotone`: ImageVector? = null
