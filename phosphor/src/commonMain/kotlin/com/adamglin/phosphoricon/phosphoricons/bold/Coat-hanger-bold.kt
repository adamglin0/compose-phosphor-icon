...
public val BoldGroup.`Coat-hanger-bold`: ImageVector
    get() {
        if (`_coat-hanger-bold` != null) {
            return `_coat-hanger-bold`!!
        }
        `_coat-hanger-bold` = Builder(name = "Coat-hanger-bold", defaultWidth = 256.0.dp,
...
private var `_coat-hanger-bold`: ImageVector? = null
