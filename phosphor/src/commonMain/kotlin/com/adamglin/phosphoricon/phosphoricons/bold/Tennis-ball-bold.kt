...
public val BoldGroup.`Tennis-ball-bold`: ImageVector
    get() {
        if (`_tennis-ball-bold` != null) {
            return `_tennis-ball-bold`!!
        }
        `_tennis-ball-bold` = Builder(name = "Tennis-ball-bold", defaultWidth = 256.0.dp,
...
private var `_tennis-ball-bold`: ImageVector? = null
