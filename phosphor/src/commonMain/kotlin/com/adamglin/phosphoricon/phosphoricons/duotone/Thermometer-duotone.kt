...
public val DuotoneGroup.`Thermometer-duotone`: ImageVector
    get() {
        if (`_thermometer-duotone` != null) {
            return `_thermometer-duotone`!!
        }
        `_thermometer-duotone` = Builder(name = "Thermometer-duotone", defaultWidth = 256.0.dp,
...
private var `_thermometer-duotone`: ImageVector? = null
