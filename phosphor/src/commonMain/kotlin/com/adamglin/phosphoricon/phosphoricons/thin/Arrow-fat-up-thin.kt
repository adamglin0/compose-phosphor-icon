...
public val ThinGroup.`Arrow-fat-up-thin`: ImageVector
    get() {
        if (`_arrow-fat-up-thin` != null) {
            return `_arrow-fat-up-thin`!!
        }
        `_arrow-fat-up-thin` = Builder(name = "Arrow-fat-up-thin", defaultWidth = 256.0.dp,
...
private var `_arrow-fat-up-thin`: ImageVector? = null
