...
public val DuotoneGroup.`File-minus-duotone`: ImageVector
    get() {
        if (`_file-minus-duotone` != null) {
            return `_file-minus-duotone`!!
        }
        `_file-minus-duotone` = Builder(name = "File-minus-duotone", defaultWidth = 256.0.dp,
...
private var `_file-minus-duotone`: ImageVector? = null
