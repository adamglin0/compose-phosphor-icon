...
public val DuotoneGroup.`Number-circle-seven-duotone`: ImageVector
    get() {
        if (`_number-circle-seven-duotone` != null) {
            return `_number-circle-seven-duotone`!!
        }
        `_number-circle-seven-duotone` = Builder(name = "Number-circle-seven-duotone", defaultWidth
...
private var `_number-circle-seven-duotone`: ImageVector? = null
