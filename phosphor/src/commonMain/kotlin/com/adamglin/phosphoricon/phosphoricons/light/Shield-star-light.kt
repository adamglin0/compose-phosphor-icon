...
public val LightGroup.`Shield-star-light`: ImageVector
    get() {
        if (`_shield-star-light` != null) {
            return `_shield-star-light`!!
        }
        `_shield-star-light` = Builder(name = "Shield-star-light", defaultWidth = 256.0.dp,
...
private var `_shield-star-light`: ImageVector? = null
