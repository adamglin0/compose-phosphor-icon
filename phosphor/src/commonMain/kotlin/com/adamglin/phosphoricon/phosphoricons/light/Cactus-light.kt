...
public val LightGroup.`Cactus-light`: ImageVector
    get() {
        if (`_cactus-light` != null) {
            return `_cactus-light`!!
        }
        `_cactus-light` = Builder(name = "Cactus-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cactus-light`: ImageVector? = null
