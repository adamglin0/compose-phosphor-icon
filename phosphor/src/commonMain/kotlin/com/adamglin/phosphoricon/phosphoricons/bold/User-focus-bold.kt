...
public val BoldGroup.`User-focus-bold`: ImageVector
    get() {
        if (`_user-focus-bold` != null) {
            return `_user-focus-bold`!!
        }
        `_user-focus-bold` = Builder(name = "User-focus-bold", defaultWidth = 256.0.dp,
...
private var `_user-focus-bold`: ImageVector? = null
