...
public val FillGroup.`Pix-logo-fill`: ImageVector
    get() {
        if (`_pix-logo-fill` != null) {
            return `_pix-logo-fill`!!
        }
        `_pix-logo-fill` = Builder(name = "Pix-logo-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pix-logo-fill`: ImageVector? = null
