...
public val ThinGroup.`Number-circle-nine-thin`: ImageVector
    get() {
        if (`_number-circle-nine-thin` != null) {
            return `_number-circle-nine-thin`!!
        }
        `_number-circle-nine-thin` = Builder(name = "Number-circle-nine-thin", defaultWidth =
...
private var `_number-circle-nine-thin`: ImageVector? = null
