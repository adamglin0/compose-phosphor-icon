...
public val LightGroup.`Air-traffic-control-light`: ImageVector
    get() {
        if (`_air-traffic-control-light` != null) {
            return `_air-traffic-control-light`!!
        }
        `_air-traffic-control-light` = Builder(name = "Air-traffic-control-light", defaultWidth =
...
private var `_air-traffic-control-light`: ImageVector? = null
