...
public val DuotoneGroup.`Cardholder-duotone`: ImageVector
    get() {
        if (`_cardholder-duotone` != null) {
            return `_cardholder-duotone`!!
        }
        `_cardholder-duotone` = Builder(name = "Cardholder-duotone", defaultWidth = 256.0.dp,
...
private var `_cardholder-duotone`: ImageVector? = null
