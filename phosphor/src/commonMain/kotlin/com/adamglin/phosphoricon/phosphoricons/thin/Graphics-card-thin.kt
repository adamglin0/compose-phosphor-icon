...
public val ThinGroup.`Graphics-card-thin`: ImageVector
    get() {
        if (`_graphics-card-thin` != null) {
            return `_graphics-card-thin`!!
        }
        `_graphics-card-thin` = Builder(name = "Graphics-card-thin", defaultWidth = 256.0.dp,
...
private var `_graphics-card-thin`: ImageVector? = null
