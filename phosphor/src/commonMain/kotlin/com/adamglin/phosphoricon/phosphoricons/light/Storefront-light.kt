...
public val LightGroup.`Storefront-light`: ImageVector
    get() {
        if (`_storefront-light` != null) {
            return `_storefront-light`!!
        }
        `_storefront-light` = Builder(name = "Storefront-light", defaultWidth = 256.0.dp,
...
private var `_storefront-light`: ImageVector? = null
