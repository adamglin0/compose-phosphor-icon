...
public val BoldGroup.`Speaker-simple-high-bold`: ImageVector
    get() {
        if (`_speaker-simple-high-bold` != null) {
            return `_speaker-simple-high-bold`!!
        }
        `_speaker-simple-high-bold` = Builder(name = "Speaker-simple-high-bold", defaultWidth =
...
private var `_speaker-simple-high-bold`: ImageVector? = null
