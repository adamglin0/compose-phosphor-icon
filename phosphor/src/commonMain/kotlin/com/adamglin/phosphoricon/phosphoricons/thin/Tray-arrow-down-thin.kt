...
public val ThinGroup.`Tray-arrow-down-thin`: ImageVector
    get() {
        if (`_tray-arrow-down-thin` != null) {
            return `_tray-arrow-down-thin`!!
        }
        `_tray-arrow-down-thin` = Builder(name = "Tray-arrow-down-thin", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-down-thin`: ImageVector? = null
