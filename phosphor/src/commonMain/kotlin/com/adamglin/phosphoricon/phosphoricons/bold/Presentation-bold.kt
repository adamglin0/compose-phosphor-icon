...
public val BoldGroup.`Presentation-bold`: ImageVector
    get() {
        if (`_presentation-bold` != null) {
            return `_presentation-bold`!!
        }
        `_presentation-bold` = Builder(name = "Presentation-bold", defaultWidth = 256.0.dp,
...
private var `_presentation-bold`: ImageVector? = null
