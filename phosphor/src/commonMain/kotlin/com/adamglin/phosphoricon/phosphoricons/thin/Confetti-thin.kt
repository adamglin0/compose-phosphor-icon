...
public val ThinGroup.`Confetti-thin`: ImageVector
    get() {
        if (`_confetti-thin` != null) {
            return `_confetti-thin`!!
        }
        `_confetti-thin` = Builder(name = "Confetti-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_confetti-thin`: ImageVector? = null
