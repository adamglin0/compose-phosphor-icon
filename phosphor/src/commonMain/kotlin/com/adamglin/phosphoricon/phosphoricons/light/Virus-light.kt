...
public val LightGroup.`Virus-light`: ImageVector
    get() {
        if (`_virus-light` != null) {
            return `_virus-light`!!
        }
        `_virus-light` = Builder(name = "Virus-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_virus-light`: ImageVector? = null
