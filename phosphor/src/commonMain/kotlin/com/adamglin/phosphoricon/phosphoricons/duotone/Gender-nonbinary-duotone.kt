...
public val DuotoneGroup.`Gender-nonbinary-duotone`: ImageVector
    get() {
        if (`_gender-nonbinary-duotone` != null) {
            return `_gender-nonbinary-duotone`!!
        }
        `_gender-nonbinary-duotone` = Builder(name = "Gender-nonbinary-duotone", defaultWidth =
...
private var `_gender-nonbinary-duotone`: ImageVector? = null
