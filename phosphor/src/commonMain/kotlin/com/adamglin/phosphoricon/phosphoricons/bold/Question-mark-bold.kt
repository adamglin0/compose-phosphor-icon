...
public val BoldGroup.`Question-mark-bold`: ImageVector
    get() {
        if (`_question-mark-bold` != null) {
            return `_question-mark-bold`!!
        }
        `_question-mark-bold` = Builder(name = "Question-mark-bold", defaultWidth = 256.0.dp,
...
private var `_question-mark-bold`: ImageVector? = null
