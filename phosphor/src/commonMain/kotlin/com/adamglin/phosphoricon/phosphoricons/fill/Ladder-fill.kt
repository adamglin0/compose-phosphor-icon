...
public val FillGroup.`Ladder-fill`: ImageVector
    get() {
        if (`_ladder-fill` != null) {
            return `_ladder-fill`!!
        }
        `_ladder-fill` = Builder(name = "Ladder-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ladder-fill`: ImageVector? = null
