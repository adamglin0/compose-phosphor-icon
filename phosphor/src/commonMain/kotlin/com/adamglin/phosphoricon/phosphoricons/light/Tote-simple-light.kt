...
public val LightGroup.`Tote-simple-light`: ImageVector
    get() {
        if (`_tote-simple-light` != null) {
            return `_tote-simple-light`!!
        }
        `_tote-simple-light` = Builder(name = "Tote-simple-light", defaultWidth = 256.0.dp,
...
private var `_tote-simple-light`: ImageVector? = null
