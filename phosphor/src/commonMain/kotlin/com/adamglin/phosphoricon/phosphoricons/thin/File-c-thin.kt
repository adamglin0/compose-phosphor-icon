...
public val ThinGroup.`File-c-thin`: ImageVector
    get() {
        if (`_file-c-thin` != null) {
            return `_file-c-thin`!!
        }
        `_file-c-thin` = Builder(name = "File-c-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-c-thin`: ImageVector? = null
