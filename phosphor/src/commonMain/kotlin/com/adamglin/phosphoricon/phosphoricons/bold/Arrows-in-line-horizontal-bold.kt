...
public val BoldGroup.`Arrows-in-line-horizontal-bold`: ImageVector
    get() {
        if (`_arrows-in-line-horizontal-bold` != null) {
            return `_arrows-in-line-horizontal-bold`!!
        }
        `_arrows-in-line-horizontal-bold` = Builder(name = "Arrows-in-line-horizontal-bold",
...
private var `_arrows-in-line-horizontal-bold`: ImageVector? = null
