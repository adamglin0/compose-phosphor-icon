...
public val LightGroup.`Bicycle-light`: ImageVector
    get() {
        if (`_bicycle-light` != null) {
            return `_bicycle-light`!!
        }
        `_bicycle-light` = Builder(name = "Bicycle-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bicycle-light`: ImageVector? = null
