...
public val LightGroup.`Chair-light`: ImageVector
    get() {
        if (`_chair-light` != null) {
            return `_chair-light`!!
        }
        `_chair-light` = Builder(name = "Chair-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chair-light`: ImageVector? = null
