...
public val BoldGroup.`Wifi-medium-bold`: ImageVector
    get() {
        if (`_wifi-medium-bold` != null) {
            return `_wifi-medium-bold`!!
        }
        `_wifi-medium-bold` = Builder(name = "Wifi-medium-bold", defaultWidth = 256.0.dp,
...
private var `_wifi-medium-bold`: ImageVector? = null
