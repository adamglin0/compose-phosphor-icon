...
public val DuotoneGroup.`Church-duotone`: ImageVector
    get() {
        if (`_church-duotone` != null) {
            return `_church-duotone`!!
        }
        `_church-duotone` = Builder(name = "Church-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_church-duotone`: ImageVector? = null
