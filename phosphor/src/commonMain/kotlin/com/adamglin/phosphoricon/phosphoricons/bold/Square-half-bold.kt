...
public val BoldGroup.`Square-half-bold`: ImageVector
    get() {
        if (`_square-half-bold` != null) {
            return `_square-half-bold`!!
        }
        `_square-half-bold` = Builder(name = "Square-half-bold", defaultWidth = 256.0.dp,
...
private var `_square-half-bold`: ImageVector? = null
