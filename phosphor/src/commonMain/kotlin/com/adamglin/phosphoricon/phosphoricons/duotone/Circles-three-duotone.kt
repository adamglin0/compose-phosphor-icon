...
public val DuotoneGroup.`Circles-three-duotone`: ImageVector
    get() {
        if (`_circles-three-duotone` != null) {
            return `_circles-three-duotone`!!
        }
        `_circles-three-duotone` = Builder(name = "Circles-three-duotone", defaultWidth = 256.0.dp,
...
private var `_circles-three-duotone`: ImageVector? = null
