...
public val FillGroup.`Spiral-fill`: ImageVector
    get() {
        if (`_spiral-fill` != null) {
            return `_spiral-fill`!!
        }
        `_spiral-fill` = Builder(name = "Spiral-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spiral-fill`: ImageVector? = null
