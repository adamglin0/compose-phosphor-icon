...
public val DuotoneGroup.`Waves-duotone`: ImageVector
    get() {
        if (`_waves-duotone` != null) {
            return `_waves-duotone`!!
        }
        `_waves-duotone` = Builder(name = "Waves-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_waves-duotone`: ImageVector? = null
