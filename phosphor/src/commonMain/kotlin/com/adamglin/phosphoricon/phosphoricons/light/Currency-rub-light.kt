...
public val LightGroup.`Currency-rub-light`: ImageVector
    get() {
        if (`_currency-rub-light` != null) {
            return `_currency-rub-light`!!
        }
        `_currency-rub-light` = Builder(name = "Currency-rub-light", defaultWidth = 256.0.dp,
...
private var `_currency-rub-light`: ImageVector? = null
