...
public val LightGroup.`Speaker-simple-high-light`: ImageVector
    get() {
        if (`_speaker-simple-high-light` != null) {
            return `_speaker-simple-high-light`!!
        }
        `_speaker-simple-high-light` = Builder(name = "Speaker-simple-high-light", defaultWidth =
...
private var `_speaker-simple-high-light`: ImageVector? = null
