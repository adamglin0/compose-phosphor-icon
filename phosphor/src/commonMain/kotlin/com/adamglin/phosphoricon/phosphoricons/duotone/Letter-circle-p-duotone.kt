...
public val DuotoneGroup.`Letter-circle-p-duotone`: ImageVector
    get() {
        if (`_letter-circle-p-duotone` != null) {
            return `_letter-circle-p-duotone`!!
        }
        `_letter-circle-p-duotone` = Builder(name = "Letter-circle-p-duotone", defaultWidth =
...
private var `_letter-circle-p-duotone`: ImageVector? = null
