...
public val FillGroup.`File-xls-fill`: ImageVector
    get() {
        if (`_file-xls-fill` != null) {
            return `_file-xls-fill`!!
        }
        `_file-xls-fill` = Builder(name = "File-xls-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-xls-fill`: ImageVector? = null
