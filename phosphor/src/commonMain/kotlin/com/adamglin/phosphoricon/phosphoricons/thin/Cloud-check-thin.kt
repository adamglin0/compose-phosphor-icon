...
public val ThinGroup.`Cloud-check-thin`: ImageVector
    get() {
        if (`_cloud-check-thin` != null) {
            return `_cloud-check-thin`!!
        }
        `_cloud-check-thin` = Builder(name = "Cloud-check-thin", defaultWidth = 256.0.dp,
...
private var `_cloud-check-thin`: ImageVector? = null
