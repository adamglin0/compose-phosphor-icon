...
public val DuotoneGroup.`Receipt-x-duotone`: ImageVector
    get() {
        if (`_receipt-x-duotone` != null) {
            return `_receipt-x-duotone`!!
        }
        `_receipt-x-duotone` = Builder(name = "Receipt-x-duotone", defaultWidth = 256.0.dp,
...
private var `_receipt-x-duotone`: ImageVector? = null
