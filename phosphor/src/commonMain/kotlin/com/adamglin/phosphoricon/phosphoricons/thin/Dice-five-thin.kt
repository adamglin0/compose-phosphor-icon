...
public val ThinGroup.`Dice-five-thin`: ImageVector
    get() {
        if (`_dice-five-thin` != null) {
            return `_dice-five-thin`!!
        }
        `_dice-five-thin` = Builder(name = "Dice-five-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dice-five-thin`: ImageVector? = null
