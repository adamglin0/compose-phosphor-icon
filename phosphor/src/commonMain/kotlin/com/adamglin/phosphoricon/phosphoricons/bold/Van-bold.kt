...
public val BoldGroup.`Van-bold`: ImageVector
    get() {
        if (`_van-bold` != null) {
            return `_van-bold`!!
        }
        `_van-bold` = Builder(name = "Van-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_van-bold`: ImageVector? = null
