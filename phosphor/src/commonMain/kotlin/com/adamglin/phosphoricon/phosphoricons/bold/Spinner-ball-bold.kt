...
public val BoldGroup.`Spinner-ball-bold`: ImageVector
    get() {
        if (`_spinner-ball-bold` != null) {
            return `_spinner-ball-bold`!!
        }
        `_spinner-ball-bold` = Builder(name = "Spinner-ball-bold", defaultWidth = 256.0.dp,
...
private var `_spinner-ball-bold`: ImageVector? = null
