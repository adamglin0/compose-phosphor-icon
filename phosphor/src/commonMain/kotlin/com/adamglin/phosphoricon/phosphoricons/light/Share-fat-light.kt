...
public val LightGroup.`Share-fat-light`: ImageVector
    get() {
        if (`_share-fat-light` != null) {
            return `_share-fat-light`!!
        }
        `_share-fat-light` = Builder(name = "Share-fat-light", defaultWidth = 256.0.dp,
...
private var `_share-fat-light`: ImageVector? = null
