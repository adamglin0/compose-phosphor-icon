...
public val DuotoneGroup.`Webcam-slash-duotone`: ImageVector
    get() {
        if (`_webcam-slash-duotone` != null) {
            return `_webcam-slash-duotone`!!
        }
        `_webcam-slash-duotone` = Builder(name = "Webcam-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_webcam-slash-duotone`: ImageVector? = null
