...
public val BoldGroup.`Calendar-star-bold`: ImageVector
    get() {
        if (`_calendar-star-bold` != null) {
            return `_calendar-star-bold`!!
        }
        `_calendar-star-bold` = Builder(name = "Calendar-star-bold", defaultWidth = 256.0.dp,
...
private var `_calendar-star-bold`: ImageVector? = null
