...
public val ThinGroup.`Clock-countdown-thin`: ImageVector
    get() {
        if (`_clock-countdown-thin` != null) {
            return `_clock-countdown-thin`!!
        }
        `_clock-countdown-thin` = Builder(name = "Clock-countdown-thin", defaultWidth = 256.0.dp,
...
private var `_clock-countdown-thin`: ImageVector? = null
