...
public val LightGroup.`Joystick-light`: ImageVector
    get() {
        if (`_joystick-light` != null) {
            return `_joystick-light`!!
        }
        `_joystick-light` = Builder(name = "Joystick-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_joystick-light`: ImageVector? = null
