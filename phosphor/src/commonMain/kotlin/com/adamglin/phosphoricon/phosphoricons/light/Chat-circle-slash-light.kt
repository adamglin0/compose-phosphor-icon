...
public val LightGroup.`Chat-circle-slash-light`: ImageVector
    get() {
        if (`_chat-circle-slash-light` != null) {
            return `_chat-circle-slash-light`!!
        }
        `_chat-circle-slash-light` = Builder(name = "Chat-circle-slash-light", defaultWidth =
...
private var `_chat-circle-slash-light`: ImageVector? = null
