...
public val ThinGroup.`Handbag-thin`: ImageVector
    get() {
        if (`_handbag-thin` != null) {
            return `_handbag-thin`!!
        }
        `_handbag-thin` = Builder(name = "Handbag-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_handbag-thin`: ImageVector? = null
