...
public val LightGroup.`Graph-light`: ImageVector
    get() {
        if (`_graph-light` != null) {
            return `_graph-light`!!
        }
        `_graph-light` = Builder(name = "Graph-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_graph-light`: ImageVector? = null
