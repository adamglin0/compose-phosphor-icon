...
public val ThinGroup.`Airplane-takeoff-thin`: ImageVector
    get() {
        if (`_airplane-takeoff-thin` != null) {
            return `_airplane-takeoff-thin`!!
        }
        `_airplane-takeoff-thin` = Builder(name = "Airplane-takeoff-thin", defaultWidth = 256.0.dp,
...
private var `_airplane-takeoff-thin`: ImageVector? = null
