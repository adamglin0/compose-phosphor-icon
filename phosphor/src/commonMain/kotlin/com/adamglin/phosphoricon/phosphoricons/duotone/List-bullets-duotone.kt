...
public val DuotoneGroup.`List-bullets-duotone`: ImageVector
    get() {
        if (`_list-bullets-duotone` != null) {
            return `_list-bullets-duotone`!!
        }
        `_list-bullets-duotone` = Builder(name = "List-bullets-duotone", defaultWidth = 256.0.dp,
...
private var `_list-bullets-duotone`: ImageVector? = null
