...
public val DuotoneGroup.`Alien-duotone`: ImageVector
    get() {
        if (`_alien-duotone` != null) {
            return `_alien-duotone`!!
        }
        `_alien-duotone` = Builder(name = "Alien-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_alien-duotone`: ImageVector? = null
