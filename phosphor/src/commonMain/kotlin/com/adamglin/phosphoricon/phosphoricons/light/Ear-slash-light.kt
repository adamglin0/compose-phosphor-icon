...
public val LightGroup.`Ear-slash-light`: ImageVector
    get() {
        if (`_ear-slash-light` != null) {
            return `_ear-slash-light`!!
        }
        `_ear-slash-light` = Builder(name = "Ear-slash-light", defaultWidth = 256.0.dp,
...
private var `_ear-slash-light`: ImageVector? = null
