...
public val ThinGroup.`Rows-thin`: ImageVector
    get() {
        if (`_rows-thin` != null) {
            return `_rows-thin`!!
        }
        `_rows-thin` = Builder(name = "Rows-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rows-thin`: ImageVector? = null
