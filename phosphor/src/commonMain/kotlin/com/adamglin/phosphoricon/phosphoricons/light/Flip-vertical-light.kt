...
public val LightGroup.`Flip-vertical-light`: ImageVector
    get() {
        if (`_flip-vertical-light` != null) {
            return `_flip-vertical-light`!!
        }
        `_flip-vertical-light` = Builder(name = "Flip-vertical-light", defaultWidth = 256.0.dp,
...
private var `_flip-vertical-light`: ImageVector? = null
