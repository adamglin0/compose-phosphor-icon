...
public val BoldGroup.`Airplane-in-flight-bold`: ImageVector
    get() {
        if (`_airplane-in-flight-bold` != null) {
            return `_airplane-in-flight-bold`!!
        }
        `_airplane-in-flight-bold` = Builder(name = "Airplane-in-flight-bold", defaultWidth =
...
private var `_airplane-in-flight-bold`: ImageVector? = null
