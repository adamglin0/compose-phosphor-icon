...
public val BoldGroup.`Currency-btc-bold`: ImageVector
    get() {
        if (`_currency-btc-bold` != null) {
            return `_currency-btc-bold`!!
        }
        `_currency-btc-bold` = Builder(name = "Currency-btc-bold", defaultWidth = 256.0.dp,
...
private var `_currency-btc-bold`: ImageVector? = null
