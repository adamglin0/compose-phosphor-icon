...
public val ThinGroup.`Toggle-left-thin`: ImageVector
    get() {
        if (`_toggle-left-thin` != null) {
            return `_toggle-left-thin`!!
        }
        `_toggle-left-thin` = Builder(name = "Toggle-left-thin", defaultWidth = 256.0.dp,
...
private var `_toggle-left-thin`: ImageVector? = null
