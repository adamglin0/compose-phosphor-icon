...
public val ThinGroup.`User-sound-thin`: ImageVector
    get() {
        if (`_user-sound-thin` != null) {
            return `_user-sound-thin`!!
        }
        `_user-sound-thin` = Builder(name = "User-sound-thin", defaultWidth = 256.0.dp,
...
private var `_user-sound-thin`: ImageVector? = null
