...
public val DuotoneGroup.`Fallout-shelter-duotone`: ImageVector
    get() {
        if (`_fallout-shelter-duotone` != null) {
            return `_fallout-shelter-duotone`!!
        }
        `_fallout-shelter-duotone` = Builder(name = "Fallout-shelter-duotone", defaultWidth =
...
private var `_fallout-shelter-duotone`: ImageVector? = null
