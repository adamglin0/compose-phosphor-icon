...
public val BoldGroup.`Shower-bold`: ImageVector
    get() {
        if (`_shower-bold` != null) {
            return `_shower-bold`!!
        }
        `_shower-bold` = Builder(name = "Shower-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shower-bold`: ImageVector? = null
