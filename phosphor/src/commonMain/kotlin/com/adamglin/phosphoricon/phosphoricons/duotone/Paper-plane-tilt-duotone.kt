...
public val DuotoneGroup.`Paper-plane-tilt-duotone`: ImageVector
    get() {
        if (`_paper-plane-tilt-duotone` != null) {
            return `_paper-plane-tilt-duotone`!!
        }
        `_paper-plane-tilt-duotone` = Builder(name = "Paper-plane-tilt-duotone", defaultWidth =
...
private var `_paper-plane-tilt-duotone`: ImageVector? = null
