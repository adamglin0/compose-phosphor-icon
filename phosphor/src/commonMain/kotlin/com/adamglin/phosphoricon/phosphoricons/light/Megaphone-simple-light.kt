...
public val LightGroup.`Megaphone-simple-light`: ImageVector
    get() {
        if (`_megaphone-simple-light` != null) {
            return `_megaphone-simple-light`!!
        }
        `_megaphone-simple-light` = Builder(name = "Megaphone-simple-light", defaultWidth =
...
private var `_megaphone-simple-light`: ImageVector? = null
