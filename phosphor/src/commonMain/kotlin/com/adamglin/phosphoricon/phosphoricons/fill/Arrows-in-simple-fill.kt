...
public val FillGroup.`Arrows-in-simple-fill`: ImageVector
    get() {
        if (`_arrows-in-simple-fill` != null) {
            return `_arrows-in-simple-fill`!!
        }
        `_arrows-in-simple-fill` = Builder(name = "Arrows-in-simple-fill", defaultWidth = 256.0.dp,
...
private var `_arrows-in-simple-fill`: ImageVector? = null
