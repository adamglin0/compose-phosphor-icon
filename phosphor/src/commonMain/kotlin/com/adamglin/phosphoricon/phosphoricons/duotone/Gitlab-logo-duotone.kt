...
public val DuotoneGroup.`Gitlab-logo-duotone`: ImageVector
    get() {
        if (`_gitlab-logo-duotone` != null) {
            return `_gitlab-logo-duotone`!!
        }
        `_gitlab-logo-duotone` = Builder(name = "Gitlab-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_gitlab-logo-duotone`: ImageVector? = null
