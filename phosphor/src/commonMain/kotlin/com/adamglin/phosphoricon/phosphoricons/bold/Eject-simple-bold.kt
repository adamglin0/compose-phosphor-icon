...
public val BoldGroup.`Eject-simple-bold`: ImageVector
    get() {
        if (`_eject-simple-bold` != null) {
            return `_eject-simple-bold`!!
        }
        `_eject-simple-bold` = Builder(name = "Eject-simple-bold", defaultWidth = 256.0.dp,
...
private var `_eject-simple-bold`: ImageVector? = null
