...
public val DuotoneGroup.`Person-simple-run-duotone`: ImageVector
    get() {
        if (`_person-simple-run-duotone` != null) {
            return `_person-simple-run-duotone`!!
        }
        `_person-simple-run-duotone` = Builder(name = "Person-simple-run-duotone", defaultWidth =
...
private var `_person-simple-run-duotone`: ImageVector? = null
