...
public val BoldGroup.`Toilet-bold`: ImageVector
    get() {
        if (`_toilet-bold` != null) {
            return `_toilet-bold`!!
        }
        `_toilet-bold` = Builder(name = "Toilet-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_toilet-bold`: ImageVector? = null
