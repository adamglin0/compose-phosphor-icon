...
public val LightGroup.`Tiktok-logo-light`: ImageVector
    get() {
        if (`_tiktok-logo-light` != null) {
            return `_tiktok-logo-light`!!
        }
        `_tiktok-logo-light` = Builder(name = "Tiktok-logo-light", defaultWidth = 256.0.dp,
...
private var `_tiktok-logo-light`: ImageVector? = null
