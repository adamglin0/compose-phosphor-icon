...
public val ThinGroup.`Lastfm-logo-thin`: ImageVector
    get() {
        if (`_lastfm-logo-thin` != null) {
            return `_lastfm-logo-thin`!!
        }
        `_lastfm-logo-thin` = Builder(name = "Lastfm-logo-thin", defaultWidth = 256.0.dp,
...
private var `_lastfm-logo-thin`: ImageVector? = null
