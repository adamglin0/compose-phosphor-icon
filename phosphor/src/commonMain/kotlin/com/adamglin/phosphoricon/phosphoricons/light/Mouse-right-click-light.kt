...
public val LightGroup.`Mouse-right-click-light`: ImageVector
    get() {
        if (`_mouse-right-click-light` != null) {
            return `_mouse-right-click-light`!!
        }
        `_mouse-right-click-light` = Builder(name = "Mouse-right-click-light", defaultWidth =
...
private var `_mouse-right-click-light`: ImageVector? = null
