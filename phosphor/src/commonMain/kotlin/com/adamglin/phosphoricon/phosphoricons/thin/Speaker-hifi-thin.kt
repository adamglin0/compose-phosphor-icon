...
public val ThinGroup.`Speaker-hifi-thin`: ImageVector
    get() {
        if (`_speaker-hifi-thin` != null) {
            return `_speaker-hifi-thin`!!
        }
        `_speaker-hifi-thin` = Builder(name = "Speaker-hifi-thin", defaultWidth = 256.0.dp,
...
private var `_speaker-hifi-thin`: ImageVector? = null
