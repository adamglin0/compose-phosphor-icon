...
public val LightGroup.`Car-battery-light`: ImageVector
    get() {
        if (`_car-battery-light` != null) {
            return `_car-battery-light`!!
        }
        `_car-battery-light` = Builder(name = "Car-battery-light", defaultWidth = 256.0.dp,
...
private var `_car-battery-light`: ImageVector? = null
