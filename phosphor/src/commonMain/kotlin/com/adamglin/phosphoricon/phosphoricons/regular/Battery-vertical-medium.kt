...
public val RegularGroup.`Battery-vertical-medium`: ImageVector
    get() {
        if (`_battery-vertical-medium` != null) {
            return `_battery-vertical-medium`!!
        }
        `_battery-vertical-medium` = Builder(name = "Battery-vertical-medium", defaultWidth =
...
private var `_battery-vertical-medium`: ImageVector? = null
