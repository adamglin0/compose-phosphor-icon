...
public val LightGroup.`Resize-light`: ImageVector
    get() {
        if (`_resize-light` != null) {
            return `_resize-light`!!
        }
        `_resize-light` = Builder(name = "Resize-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_resize-light`: ImageVector? = null
