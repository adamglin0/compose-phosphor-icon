...
public val LightGroup.`Speedometer-light`: ImageVector
    get() {
        if (`_speedometer-light` != null) {
            return `_speedometer-light`!!
        }
        `_speedometer-light` = Builder(name = "Speedometer-light", defaultWidth = 256.0.dp,
...
private var `_speedometer-light`: ImageVector? = null
