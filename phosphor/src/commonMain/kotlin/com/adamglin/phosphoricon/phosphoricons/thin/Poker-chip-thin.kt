...
public val ThinGroup.`Poker-chip-thin`: ImageVector
    get() {
        if (`_poker-chip-thin` != null) {
            return `_poker-chip-thin`!!
        }
        `_poker-chip-thin` = Builder(name = "Poker-chip-thin", defaultWidth = 256.0.dp,
...
private var `_poker-chip-thin`: ImageVector? = null
