...
public val BoldGroup.`Cloud-x-bold`: ImageVector
    get() {
        if (`_cloud-x-bold` != null) {
            return `_cloud-x-bold`!!
        }
        `_cloud-x-bold` = Builder(name = "Cloud-x-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-x-bold`: ImageVector? = null
