...
public val LightGroup.`Cherries-light`: ImageVector
    get() {
        if (`_cherries-light` != null) {
            return `_cherries-light`!!
        }
        `_cherries-light` = Builder(name = "Cherries-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cherries-light`: ImageVector? = null
