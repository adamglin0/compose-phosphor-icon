...
public val DuotoneGroup.`Binoculars-duotone`: ImageVector
    get() {
        if (`_binoculars-duotone` != null) {
            return `_binoculars-duotone`!!
        }
        `_binoculars-duotone` = Builder(name = "Binoculars-duotone", defaultWidth = 256.0.dp,
...
private var `_binoculars-duotone`: ImageVector? = null
