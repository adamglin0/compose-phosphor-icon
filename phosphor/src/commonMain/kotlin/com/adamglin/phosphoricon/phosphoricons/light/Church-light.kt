...
public val LightGroup.`Church-light`: ImageVector
    get() {
        if (`_church-light` != null) {
            return `_church-light`!!
        }
        `_church-light` = Builder(name = "Church-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_church-light`: ImageVector? = null
