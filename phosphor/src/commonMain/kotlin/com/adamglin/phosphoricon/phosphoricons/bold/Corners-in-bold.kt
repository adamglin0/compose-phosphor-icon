...
public val BoldGroup.`Corners-in-bold`: ImageVector
    get() {
        if (`_corners-in-bold` != null) {
            return `_corners-in-bold`!!
        }
        `_corners-in-bold` = Builder(name = "Corners-in-bold", defaultWidth = 256.0.dp,
...
private var `_corners-in-bold`: ImageVector? = null
