...
public val BoldGroup.`Paperclip-bold`: ImageVector
    get() {
        if (`_paperclip-bold` != null) {
            return `_paperclip-bold`!!
        }
        `_paperclip-bold` = Builder(name = "Paperclip-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_paperclip-bold`: ImageVector? = null
