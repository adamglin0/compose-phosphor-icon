...
public val ThinGroup.`Bell-simple-z-thin`: ImageVector
    get() {
        if (`_bell-simple-z-thin` != null) {
            return `_bell-simple-z-thin`!!
        }
        `_bell-simple-z-thin` = Builder(name = "Bell-simple-z-thin", defaultWidth = 256.0.dp,
...
private var `_bell-simple-z-thin`: ImageVector? = null
