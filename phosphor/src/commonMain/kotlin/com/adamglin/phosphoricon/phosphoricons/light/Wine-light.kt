...
public val LightGroup.`Wine-light`: ImageVector
    get() {
        if (`_wine-light` != null) {
            return `_wine-light`!!
        }
        `_wine-light` = Builder(name = "Wine-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wine-light`: ImageVector? = null
