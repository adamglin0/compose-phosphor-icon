...
public val ThinGroup.`Arrows-in-cardinal-thin`: ImageVector
    get() {
        if (`_arrows-in-cardinal-thin` != null) {
            return `_arrows-in-cardinal-thin`!!
        }
        `_arrows-in-cardinal-thin` = Builder(name = "Arrows-in-cardinal-thin", defaultWidth =
...
private var `_arrows-in-cardinal-thin`: ImageVector? = null
