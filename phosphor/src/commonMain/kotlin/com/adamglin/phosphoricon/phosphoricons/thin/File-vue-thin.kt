...
public val ThinGroup.`File-vue-thin`: ImageVector
    get() {
        if (`_file-vue-thin` != null) {
            return `_file-vue-thin`!!
        }
        `_file-vue-thin` = Builder(name = "File-vue-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-vue-thin`: ImageVector? = null
