...
public val DuotoneGroup.`Text-h-four-duotone`: ImageVector
    get() {
        if (`_text-h-four-duotone` != null) {
            return `_text-h-four-duotone`!!
        }
        `_text-h-four-duotone` = Builder(name = "Text-h-four-duotone", defaultWidth = 256.0.dp,
...
private var `_text-h-four-duotone`: ImageVector? = null
