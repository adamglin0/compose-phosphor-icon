...
public val DuotoneGroup.`Smiley-melting-duotone`: ImageVector
    get() {
        if (`_smiley-melting-duotone` != null) {
            return `_smiley-melting-duotone`!!
        }
        `_smiley-melting-duotone` = Builder(name = "Smiley-melting-duotone", defaultWidth =
...
private var `_smiley-melting-duotone`: ImageVector? = null
