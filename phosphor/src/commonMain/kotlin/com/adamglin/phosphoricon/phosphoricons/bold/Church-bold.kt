...
public val BoldGroup.`Church-bold`: ImageVector
    get() {
        if (`_church-bold` != null) {
            return `_church-bold`!!
        }
        `_church-bold` = Builder(name = "Church-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_church-bold`: ImageVector? = null
