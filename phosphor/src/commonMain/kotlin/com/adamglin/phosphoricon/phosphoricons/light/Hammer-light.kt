...
public val LightGroup.`Hammer-light`: ImageVector
    get() {
        if (`_hammer-light` != null) {
            return `_hammer-light`!!
        }
        `_hammer-light` = Builder(name = "Hammer-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hammer-light`: ImageVector? = null
