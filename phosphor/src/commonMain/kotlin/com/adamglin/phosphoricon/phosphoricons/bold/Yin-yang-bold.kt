...
public val BoldGroup.`Yin-yang-bold`: ImageVector
    get() {
        if (`_yin-yang-bold` != null) {
            return `_yin-yang-bold`!!
        }
        `_yin-yang-bold` = Builder(name = "Yin-yang-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_yin-yang-bold`: ImageVector? = null
