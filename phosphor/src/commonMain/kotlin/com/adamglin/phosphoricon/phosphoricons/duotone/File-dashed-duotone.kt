...
public val DuotoneGroup.`File-dashed-duotone`: ImageVector
    get() {
        if (`_file-dashed-duotone` != null) {
            return `_file-dashed-duotone`!!
        }
        `_file-dashed-duotone` = Builder(name = "File-dashed-duotone", defaultWidth = 256.0.dp,
...
private var `_file-dashed-duotone`: ImageVector? = null
