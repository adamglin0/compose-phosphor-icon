...
public val BoldGroup.`Square-logo-bold`: ImageVector
    get() {
        if (`_square-logo-bold` != null) {
            return `_square-logo-bold`!!
        }
        `_square-logo-bold` = Builder(name = "Square-logo-bold", defaultWidth = 256.0.dp,
...
private var `_square-logo-bold`: ImageVector? = null
