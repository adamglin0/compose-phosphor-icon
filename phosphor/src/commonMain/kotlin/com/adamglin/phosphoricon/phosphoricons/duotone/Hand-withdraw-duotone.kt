...
public val DuotoneGroup.`Hand-withdraw-duotone`: ImageVector
    get() {
        if (`_hand-withdraw-duotone` != null) {
            return `_hand-withdraw-duotone`!!
        }
        `_hand-withdraw-duotone` = Builder(name = "Hand-withdraw-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(173.32f, 186.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, false, false, -36.9f, 14.0f)
...
private var `_hand-withdraw-duotone`: ImageVector? = null
