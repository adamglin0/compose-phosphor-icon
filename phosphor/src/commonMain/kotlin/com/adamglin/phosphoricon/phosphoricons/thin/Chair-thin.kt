...
public val ThinGroup.`Chair-thin`: ImageVector
    get() {
        if (`_chair-thin` != null) {
            return `_chair-thin`!!
        }
        `_chair-thin` = Builder(name = "Chair-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chair-thin`: ImageVector? = null
