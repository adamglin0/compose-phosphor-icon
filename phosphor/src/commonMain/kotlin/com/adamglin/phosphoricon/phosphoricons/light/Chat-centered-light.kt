...
public val LightGroup.`Chat-centered-light`: ImageVector
    get() {
        if (`_chat-centered-light` != null) {
            return `_chat-centered-light`!!
        }
        `_chat-centered-light` = Builder(name = "Chat-centered-light", defaultWidth = 256.0.dp,
...
private var `_chat-centered-light`: ImageVector? = null
