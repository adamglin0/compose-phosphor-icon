...
public val DuotoneGroup.`Dress-duotone`: ImageVector
    get() {
        if (`_dress-duotone` != null) {
            return `_dress-duotone`!!
        }
        `_dress-duotone` = Builder(name = "Dress-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dress-duotone`: ImageVector? = null
