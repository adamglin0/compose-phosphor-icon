...
public val ThinGroup.`Nut-thin`: ImageVector
    get() {
        if (`_nut-thin` != null) {
            return `_nut-thin`!!
        }
        `_nut-thin` = Builder(name = "Nut-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_nut-thin`: ImageVector? = null
