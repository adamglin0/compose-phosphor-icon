...
public val FillGroup.`Framer-logo-fill`: ImageVector
    get() {
        if (`_framer-logo-fill` != null) {
            return `_framer-logo-fill`!!
        }
        `_framer-logo-fill` = Builder(name = "Framer-logo-fill", defaultWidth = 256.0.dp,
...
private var `_framer-logo-fill`: ImageVector? = null
