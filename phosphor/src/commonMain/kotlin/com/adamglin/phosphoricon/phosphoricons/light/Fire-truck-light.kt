...
public val LightGroup.`Fire-truck-light`: ImageVector
    get() {
        if (`_fire-truck-light` != null) {
            return `_fire-truck-light`!!
        }
        `_fire-truck-light` = Builder(name = "Fire-truck-light", defaultWidth = 256.0.dp,
...
private var `_fire-truck-light`: ImageVector? = null
