...
public val RegularGroup.`Corners-in`: ImageVector
    get() {
        if (`_corners-in` != null) {
            return `_corners-in`!!
        }
        `_corners-in` = Builder(name = "Corners-in", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_corners-in`: ImageVector? = null
