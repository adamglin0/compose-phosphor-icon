...
public val BoldGroup.`Solar-roof-bold`: ImageVector
    get() {
        if (`_solar-roof-bold` != null) {
            return `_solar-roof-bold`!!
        }
        `_solar-roof-bold` = Builder(name = "Solar-roof-bold", defaultWidth = 256.0.dp,
...
private var `_solar-roof-bold`: ImageVector? = null
