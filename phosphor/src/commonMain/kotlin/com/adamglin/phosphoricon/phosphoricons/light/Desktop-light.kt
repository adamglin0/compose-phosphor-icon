...
public val LightGroup.`Desktop-light`: ImageVector
    get() {
        if (`_desktop-light` != null) {
            return `_desktop-light`!!
        }
        `_desktop-light` = Builder(name = "Desktop-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_desktop-light`: ImageVector? = null
