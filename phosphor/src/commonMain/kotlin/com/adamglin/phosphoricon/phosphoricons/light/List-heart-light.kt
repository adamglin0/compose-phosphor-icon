...
public val LightGroup.`List-heart-light`: ImageVector
    get() {
        if (`_list-heart-light` != null) {
            return `_list-heart-light`!!
        }
        `_list-heart-light` = Builder(name = "List-heart-light", defaultWidth = 256.0.dp,
...
private var `_list-heart-light`: ImageVector? = null
