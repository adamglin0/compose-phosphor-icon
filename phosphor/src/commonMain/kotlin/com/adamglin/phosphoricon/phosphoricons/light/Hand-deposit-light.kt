...
public val LightGroup.`Hand-deposit-light`: ImageVector
    get() {
        if (`_hand-deposit-light` != null) {
            return `_hand-deposit-light`!!
        }
        `_hand-deposit-light` = Builder(name = "Hand-deposit-light", defaultWidth = 256.0.dp,
...
private var `_hand-deposit-light`: ImageVector? = null
