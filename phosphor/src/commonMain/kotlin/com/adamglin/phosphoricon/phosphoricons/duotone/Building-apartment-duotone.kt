...
public val DuotoneGroup.`Building-apartment-duotone`: ImageVector
    get() {
        if (`_building-apartment-duotone` != null) {
            return `_building-apartment-duotone`!!
        }
        `_building-apartment-duotone` = Builder(name = "Building-apartment-duotone", defaultWidth =
...
private var `_building-apartment-duotone`: ImageVector? = null
