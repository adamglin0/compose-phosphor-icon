...
public val DuotoneGroup.`Brackets-curly-duotone`: ImageVector
    get() {
        if (`_brackets-curly-duotone` != null) {
            return `_brackets-curly-duotone`!!
        }
        `_brackets-curly-duotone` = Builder(name = "Brackets-curly-duotone", defaultWidth =
...
private var `_brackets-curly-duotone`: ImageVector? = null
