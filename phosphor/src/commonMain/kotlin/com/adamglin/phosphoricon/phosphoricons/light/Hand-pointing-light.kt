...
public val LightGroup.`Hand-pointing-light`: ImageVector
    get() {
        if (`_hand-pointing-light` != null) {
            return `_hand-pointing-light`!!
        }
        `_hand-pointing-light` = Builder(name = "Hand-pointing-light", defaultWidth = 256.0.dp,
...
private var `_hand-pointing-light`: ImageVector? = null
