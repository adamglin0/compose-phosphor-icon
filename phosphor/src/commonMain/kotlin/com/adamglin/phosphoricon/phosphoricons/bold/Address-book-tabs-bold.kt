...
public val BoldGroup.`Address-book-tabs-bold`: ImageVector
    get() {
        if (`_address-book-tabs-bold` != null) {
            return `_address-book-tabs-bold`!!
        }
        `_address-book-tabs-bold` = Builder(name = "Address-book-tabs-bold", defaultWidth =
...
private var `_address-book-tabs-bold`: ImageVector? = null
