...
public val BoldGroup.`Command-bold`: ImageVector
    get() {
        if (`_command-bold` != null) {
            return `_command-bold`!!
        }
        `_command-bold` = Builder(name = "Command-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_command-bold`: ImageVector? = null
