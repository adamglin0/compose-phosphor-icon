...
public val BoldGroup.`Phone-pause-bold`: ImageVector
    get() {
        if (`_phone-pause-bold` != null) {
            return `_phone-pause-bold`!!
        }
        `_phone-pause-bold` = Builder(name = "Phone-pause-bold", defaultWidth = 256.0.dp,
...
private var `_phone-pause-bold`: ImageVector? = null
