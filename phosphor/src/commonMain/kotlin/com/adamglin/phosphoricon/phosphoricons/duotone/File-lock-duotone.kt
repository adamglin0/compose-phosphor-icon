...
public val DuotoneGroup.`File-lock-duotone`: ImageVector
    get() {
        if (`_file-lock-duotone` != null) {
            return `_file-lock-duotone`!!
        }
        `_file-lock-duotone` = Builder(name = "File-lock-duotone", defaultWidth = 256.0.dp,
...
private var `_file-lock-duotone`: ImageVector? = null
