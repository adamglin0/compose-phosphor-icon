...
public val DuotoneGroup.`File-text-duotone`: ImageVector
    get() {
        if (`_file-text-duotone` != null) {
            return `_file-text-duotone`!!
        }
        `_file-text-duotone` = Builder(name = "File-text-duotone", defaultWidth = 256.0.dp,
...
private var `_file-text-duotone`: ImageVector? = null
