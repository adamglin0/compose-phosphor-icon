...
public val DuotoneGroup.`Currency-btc-duotone`: ImageVector
    get() {
        if (`_currency-btc-duotone` != null) {
            return `_currency-btc-duotone`!!
        }
        `_currency-btc-duotone` = Builder(name = "Currency-btc-duotone", defaultWidth = 256.0.dp,
...
private var `_currency-btc-duotone`: ImageVector? = null
