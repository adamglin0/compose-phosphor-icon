...
public val DuotoneGroup.`Handshake-duotone`: ImageVector
    get() {
        if (`_handshake-duotone` != null) {
            return `_handshake-duotone`!!
        }
        `_handshake-duotone` = Builder(name = "Handshake-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(41.53f, 64.0f)
                lineTo(62.0f, 74.22f)
                lineTo(36.43f, 125.27f)
                lineTo(16.0f, 115.06f)
                close()
                moveTo(157.53f, 183.13f)
                ...
                close()
                moveTo(219.53f, 125.26f)
                lineTo(194.01f, 74.26f)
                lineTo(214.47f, 64.0f)
                lineTo(240.0f, 115.06f)
                close()
                moveTo(131.78f, 217.93f)
...
private var `_handshake-duotone`: ImageVector? = null
