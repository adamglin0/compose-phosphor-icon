...
public val DuotoneGroup.`Scales-duotone`: ImageVector
    get() {
        if (`_scales-duotone` != null) {
            return `_scales-duotone`!!
        }
        `_scales-duotone` = Builder(name = "Scales-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_scales-duotone`: ImageVector? = null
