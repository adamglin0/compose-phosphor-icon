...
public val BoldGroup.`Wheelchair-bold`: ImageVector
    get() {
        if (`_wheelchair-bold` != null) {
            return `_wheelchair-bold`!!
        }
        `_wheelchair-bold` = Builder(name = "Wheelchair-bold", defaultWidth = 256.0.dp,
...
private var `_wheelchair-bold`: ImageVector? = null
