...
public val ThinGroup.`Webcam-thin`: ImageVector
    get() {
        if (`_webcam-thin` != null) {
            return `_webcam-thin`!!
        }
        `_webcam-thin` = Builder(name = "Webcam-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_webcam-thin`: ImageVector? = null
