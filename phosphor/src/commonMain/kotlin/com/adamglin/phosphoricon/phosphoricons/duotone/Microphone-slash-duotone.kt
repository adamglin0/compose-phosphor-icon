...
public val DuotoneGroup.`Microphone-slash-duotone`: ImageVector
    get() {
        if (`_microphone-slash-duotone` != null) {
            return `_microphone-slash-duotone`!!
        }
        `_microphone-slash-duotone` = Builder(name = "Microphone-slash-duotone", defaultWidth =
...
private var `_microphone-slash-duotone`: ImageVector? = null
