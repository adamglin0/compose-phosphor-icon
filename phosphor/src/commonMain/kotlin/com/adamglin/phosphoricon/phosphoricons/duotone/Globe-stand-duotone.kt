...
public val DuotoneGroup.`Globe-stand-duotone`: ImageVector
    get() {
        if (`_globe-stand-duotone` != null) {
            return `_globe-stand-duotone`!!
        }
        `_globe-stand-duotone` = Builder(name = "Globe-stand-duotone", defaultWidth = 256.0.dp,
...
private var `_globe-stand-duotone`: ImageVector? = null
