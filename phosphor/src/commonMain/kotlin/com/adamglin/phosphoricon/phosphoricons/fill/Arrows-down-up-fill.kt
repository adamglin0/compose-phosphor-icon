...
public val FillGroup.`Arrows-down-up-fill`: ImageVector
    get() {
        if (`_arrows-down-up-fill` != null) {
            return `_arrows-down-up-fill`!!
        }
        `_arrows-down-up-fill` = Builder(name = "Arrows-down-up-fill", defaultWidth = 256.0.dp,
...
private var `_arrows-down-up-fill`: ImageVector? = null
