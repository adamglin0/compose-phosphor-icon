...
public val BoldGroup.`Microsoft-teams-logo-bold`: ImageVector
    get() {
        if (`_microsoft-teams-logo-bold` != null) {
            return `_microsoft-teams-logo-bold`!!
        }
        `_microsoft-teams-logo-bold` = Builder(name = "Microsoft-teams-logo-bold", defaultWidth =
...
private var `_microsoft-teams-logo-bold`: ImageVector? = null
