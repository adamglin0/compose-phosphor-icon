...
public val LightGroup.`Play-pause-light`: ImageVector
    get() {
        if (`_play-pause-light` != null) {
            return `_play-pause-light`!!
        }
        `_play-pause-light` = Builder(name = "Play-pause-light", defaultWidth = 256.0.dp,
...
private var `_play-pause-light`: ImageVector? = null
