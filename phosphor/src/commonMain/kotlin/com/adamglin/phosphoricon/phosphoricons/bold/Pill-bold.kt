...
public val BoldGroup.`Pill-bold`: ImageVector
    get() {
        if (`_pill-bold` != null) {
            return `_pill-bold`!!
        }
        `_pill-bold` = Builder(name = "Pill-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pill-bold`: ImageVector? = null
