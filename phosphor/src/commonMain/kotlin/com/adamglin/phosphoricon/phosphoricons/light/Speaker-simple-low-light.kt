...
public val LightGroup.`Speaker-simple-low-light`: ImageVector
    get() {
        if (`_speaker-simple-low-light` != null) {
            return `_speaker-simple-low-light`!!
        }
        `_speaker-simple-low-light` = Builder(name = "Speaker-simple-low-light", defaultWidth =
...
private var `_speaker-simple-low-light`: ImageVector? = null
