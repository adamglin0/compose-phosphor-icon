...
public val DuotoneGroup.`Caret-circle-double-left-duotone`: ImageVector
    get() {
        if (`_caret-circle-double-left-duotone` != null) {
            return `_caret-circle-double-left-duotone`!!
        }
        `_caret-circle-double-left-duotone` = Builder(name = "Caret-circle-double-left-duotone",
...
private var `_caret-circle-double-left-duotone`: ImageVector? = null
