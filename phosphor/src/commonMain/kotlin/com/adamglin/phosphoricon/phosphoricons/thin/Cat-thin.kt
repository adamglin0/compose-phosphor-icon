...
public val ThinGroup.`Cat-thin`: ImageVector
    get() {
        if (`_cat-thin` != null) {
            return `_cat-thin`!!
        }
        `_cat-thin` = Builder(name = "Cat-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_cat-thin`: ImageVector? = null
