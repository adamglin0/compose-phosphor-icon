...
public val DuotoneGroup.`Gas-can-duotone`: ImageVector
    get() {
        if (`_gas-can-duotone` != null) {
            return `_gas-can-duotone`!!
        }
        `_gas-can-duotone` = Builder(name = "Gas-can-duotone", defaultWidth = 256.0.dp,
...
private var `_gas-can-duotone`: ImageVector? = null
