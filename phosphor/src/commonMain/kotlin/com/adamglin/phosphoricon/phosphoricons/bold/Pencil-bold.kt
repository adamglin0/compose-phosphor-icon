...
public val BoldGroup.`Pencil-bold`: ImageVector
    get() {
        if (`_pencil-bold` != null) {
            return `_pencil-bold`!!
        }
        `_pencil-bold` = Builder(name = "Pencil-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pencil-bold`: ImageVector? = null
