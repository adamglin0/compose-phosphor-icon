...
public val DuotoneGroup.`Equalizer-duotone`: ImageVector
    get() {
        if (`_equalizer-duotone` != null) {
            return `_equalizer-duotone`!!
        }
        `_equalizer-duotone` = Builder(name = "Equalizer-duotone", defaultWidth = 256.0.dp,
...
private var `_equalizer-duotone`: ImageVector? = null
