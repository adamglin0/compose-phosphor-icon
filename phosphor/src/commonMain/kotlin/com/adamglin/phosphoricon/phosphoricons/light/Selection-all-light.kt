...
public val LightGroup.`Selection-all-light`: ImageVector
    get() {
        if (`_selection-all-light` != null) {
            return `_selection-all-light`!!
        }
        `_selection-all-light` = Builder(name = "Selection-all-light", defaultWidth = 256.0.dp,
...
private var `_selection-all-light`: ImageVector? = null
