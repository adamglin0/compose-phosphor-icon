...
public val ThinGroup.`Pencil-simple-thin`: ImageVector
    get() {
        if (`_pencil-simple-thin` != null) {
            return `_pencil-simple-thin`!!
        }
        `_pencil-simple-thin` = Builder(name = "Pencil-simple-thin", defaultWidth = 256.0.dp,
...
private var `_pencil-simple-thin`: ImageVector? = null
