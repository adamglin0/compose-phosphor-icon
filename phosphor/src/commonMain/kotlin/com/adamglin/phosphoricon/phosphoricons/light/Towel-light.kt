...
public val LightGroup.`Towel-light`: ImageVector
    get() {
        if (`_towel-light` != null) {
            return `_towel-light`!!
        }
        `_towel-light` = Builder(name = "Towel-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_towel-light`: ImageVector? = null
