...
public val DuotoneGroup.`Upload-duotone`: ImageVector
    get() {
        if (`_upload-duotone` != null) {
            return `_upload-duotone`!!
        }
        `_upload-duotone` = Builder(name = "Upload-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_upload-duotone`: ImageVector? = null
