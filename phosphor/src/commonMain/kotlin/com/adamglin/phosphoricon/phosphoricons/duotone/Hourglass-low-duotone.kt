...
public val DuotoneGroup.`Hourglass-low-duotone`: ImageVector
    get() {
        if (`_hourglass-low-duotone` != null) {
            return `_hourglass-low-duotone`!!
        }
        `_hourglass-low-duotone` = Builder(name = "Hourglass-low-duotone", defaultWidth = 256.0.dp,
...
private var `_hourglass-low-duotone`: ImageVector? = null
