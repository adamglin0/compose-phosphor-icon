...
public val ThinGroup.`Horse-thin`: ImageVector
    get() {
        if (`_horse-thin` != null) {
            return `_horse-thin`!!
        }
        `_horse-thin` = Builder(name = "Horse-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_horse-thin`: ImageVector? = null
