...
public val DuotoneGroup.`Hand-arrow-up-duotone`: ImageVector
    get() {
        if (`_hand-arrow-up-duotone` != null) {
            return `_hand-arrow-up-duotone`!!
        }
        `_hand-arrow-up-duotone` = Builder(name = "Hand-arrow-up-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(7.35f, 7.35f, 0.0f, false, false, 1.2f, -0.4f)
                ...
                lineTo(200.0f, 43.31f)
                lineTo(200.0f, 104.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -16.0f, 0.0f)
                lineTo(184.0f, 43.31f)
                lineTo(165.66f, 61.66f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 154.34f, 61.66f)
                close()
            }
        }
        .build()
...
private var `_hand-arrow-up-duotone`: ImageVector? = null
