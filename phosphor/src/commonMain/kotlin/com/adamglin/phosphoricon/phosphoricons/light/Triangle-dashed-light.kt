...
public val LightGroup.`Triangle-dashed-light`: ImageVector
    get() {
        if (`_triangle-dashed-light` != null) {
            return `_triangle-dashed-light`!!
        }
        `_triangle-dashed-light` = Builder(name = "Triangle-dashed-light", defaultWidth = 256.0.dp,
...
private var `_triangle-dashed-light`: ImageVector? = null
