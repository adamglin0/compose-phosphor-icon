...
public val DuotoneGroup.`Robot-duotone`: ImageVector
    get() {
        if (`_robot-duotone` != null) {
            return `_robot-duotone`!!
        }
        `_robot-duotone` = Builder(name = "Robot-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_robot-duotone`: ImageVector? = null
