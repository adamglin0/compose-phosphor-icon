...
public val DuotoneGroup.`Flag-banner-fold-duotone`: ImageVector
    get() {
        if (`_flag-banner-fold-duotone` != null) {
            return `_flag-banner-fold-duotone`!!
        }
        `_flag-banner-fold-duotone` = Builder(name = "Flag-banner-fold-duotone", defaultWidth =
...
private var `_flag-banner-fold-duotone`: ImageVector? = null
