...
public val LightGroup.`Jar-light`: ImageVector
    get() {
        if (`_jar-light` != null) {
            return `_jar-light`!!
        }
        `_jar-light` = Builder(name = "Jar-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_jar-light`: ImageVector? = null
