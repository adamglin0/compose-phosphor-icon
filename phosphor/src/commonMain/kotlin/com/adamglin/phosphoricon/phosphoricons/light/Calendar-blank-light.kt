...
public val LightGroup.`Calendar-blank-light`: ImageVector
    get() {
        if (`_calendar-blank-light` != null) {
            return `_calendar-blank-light`!!
        }
        `_calendar-blank-light` = Builder(name = "Calendar-blank-light", defaultWidth = 256.0.dp,
...
private var `_calendar-blank-light`: ImageVector? = null
