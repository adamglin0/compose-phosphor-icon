...
public val BoldGroup.`Mouse-bold`: ImageVector
    get() {
        if (`_mouse-bold` != null) {
            return `_mouse-bold`!!
        }
        `_mouse-bold` = Builder(name = "Mouse-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mouse-bold`: ImageVector? = null
