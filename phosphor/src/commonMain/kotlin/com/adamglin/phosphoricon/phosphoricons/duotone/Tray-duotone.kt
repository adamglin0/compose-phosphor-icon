...
public val DuotoneGroup.`Tray-duotone`: ImageVector
    get() {
        if (`_tray-duotone` != null) {
            return `_tray-duotone`!!
        }
        `_tray-duotone` = Builder(name = "Tray-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tray-duotone`: ImageVector? = null
