...
public val DuotoneGroup.`Chat-circle-text-duotone`: ImageVector
    get() {
        if (`_chat-circle-text-duotone` != null) {
            return `_chat-circle-text-duotone`!!
        }
        `_chat-circle-text-duotone` = Builder(name = "Chat-circle-text-duotone", defaultWidth =
...
private var `_chat-circle-text-duotone`: ImageVector? = null
