...
public val BoldGroup.`File-txt-bold`: ImageVector
    get() {
        if (`_file-txt-bold` != null) {
            return `_file-txt-bold`!!
        }
        `_file-txt-bold` = Builder(name = "File-txt-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-txt-bold`: ImageVector? = null
