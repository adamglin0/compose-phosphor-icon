...
public val FillGroup.`Cigarette-fill`: ImageVector
    get() {
        if (`_cigarette-fill` != null) {
            return `_cigarette-fill`!!
        }
        `_cigarette-fill` = Builder(name = "Cigarette-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cigarette-fill`: ImageVector? = null
