...
public val ThinGroup.`X-logo-thin`: ImageVector
    get() {
        if (`_x-logo-thin` != null) {
            return `_x-logo-thin`!!
        }
        `_x-logo-thin` = Builder(name = "X-logo-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_x-logo-thin`: ImageVector? = null
