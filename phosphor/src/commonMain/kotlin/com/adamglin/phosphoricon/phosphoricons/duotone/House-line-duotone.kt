...
public val DuotoneGroup.`House-line-duotone`: ImageVector
    get() {
        if (`_house-line-duotone` != null) {
            return `_house-line-duotone`!!
        }
        `_house-line-duotone` = Builder(name = "House-line-duotone", defaultWidth = 256.0.dp,
...
private var `_house-line-duotone`: ImageVector? = null
