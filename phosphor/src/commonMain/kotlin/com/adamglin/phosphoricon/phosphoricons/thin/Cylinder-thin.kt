...
public val ThinGroup.`Cylinder-thin`: ImageVector
    get() {
        if (`_cylinder-thin` != null) {
            return `_cylinder-thin`!!
        }
        `_cylinder-thin` = Builder(name = "Cylinder-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cylinder-thin`: ImageVector? = null
