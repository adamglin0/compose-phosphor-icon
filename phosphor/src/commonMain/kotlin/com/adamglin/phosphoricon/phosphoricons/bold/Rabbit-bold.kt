...
public val BoldGroup.`Rabbit-bold`: ImageVector
    get() {
        if (`_rabbit-bold` != null) {
            return `_rabbit-bold`!!
        }
        `_rabbit-bold` = Builder(name = "Rabbit-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rabbit-bold`: ImageVector? = null
