...
public val DuotoneGroup.`Island-duotone`: ImageVector
    get() {
        if (`_island-duotone` != null) {
            return `_island-duotone`!!
        }
        `_island-duotone` = Builder(name = "Island-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_island-duotone`: ImageVector? = null
