...
public val ThinGroup.`Number-circle-seven-thin`: ImageVector
    get() {
        if (`_number-circle-seven-thin` != null) {
            return `_number-circle-seven-thin`!!
        }
        `_number-circle-seven-thin` = Builder(name = "Number-circle-seven-thin", defaultWidth =
...
private var `_number-circle-seven-thin`: ImageVector? = null
