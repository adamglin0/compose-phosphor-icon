...
public val LightGroup.`Battery-vertical-full-light`: ImageVector
    get() {
        if (`_battery-vertical-full-light` != null) {
            return `_battery-vertical-full-light`!!
        }
        `_battery-vertical-full-light` = Builder(name = "Battery-vertical-full-light", defaultWidth
...
private var `_battery-vertical-full-light`: ImageVector? = null
