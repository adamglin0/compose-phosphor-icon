...
public val LightGroup.`Bridge-light`: ImageVector
    get() {
        if (`_bridge-light` != null) {
            return `_bridge-light`!!
        }
        `_bridge-light` = Builder(name = "Bridge-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bridge-light`: ImageVector? = null
