...
public val BoldGroup.`Feather-bold`: ImageVector
    get() {
        if (`_feather-bold` != null) {
            return `_feather-bold`!!
        }
        `_feather-bold` = Builder(name = "Feather-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_feather-bold`: ImageVector? = null
