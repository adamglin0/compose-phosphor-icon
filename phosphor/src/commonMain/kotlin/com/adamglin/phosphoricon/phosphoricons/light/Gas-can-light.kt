...
public val LightGroup.`Gas-can-light`: ImageVector
    get() {
        if (`_gas-can-light` != null) {
            return `_gas-can-light`!!
        }
        `_gas-can-light` = Builder(name = "Gas-can-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gas-can-light`: ImageVector? = null
