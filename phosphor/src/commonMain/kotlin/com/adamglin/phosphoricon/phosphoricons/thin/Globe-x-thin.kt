...
public val ThinGroup.`Globe-x-thin`: ImageVector
    get() {
        if (`_globe-x-thin` != null) {
            return `_globe-x-thin`!!
        }
        `_globe-x-thin` = Builder(name = "Globe-x-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_globe-x-thin`: ImageVector? = null
