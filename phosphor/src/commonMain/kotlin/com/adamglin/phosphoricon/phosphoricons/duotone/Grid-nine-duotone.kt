...
public val DuotoneGroup.`Grid-nine-duotone`: ImageVector
    get() {
        if (`_grid-nine-duotone` != null) {
            return `_grid-nine-duotone`!!
        }
        `_grid-nine-duotone` = Builder(name = "Grid-nine-duotone", defaultWidth = 256.0.dp,
...
private var `_grid-nine-duotone`: ImageVector? = null
