...
public val ThinGroup.`Book-open-thin`: ImageVector
    get() {
        if (`_book-open-thin` != null) {
            return `_book-open-thin`!!
        }
        `_book-open-thin` = Builder(name = "Book-open-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_book-open-thin`: ImageVector? = null
