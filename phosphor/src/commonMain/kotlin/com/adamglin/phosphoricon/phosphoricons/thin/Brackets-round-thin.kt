...
public val ThinGroup.`Brackets-round-thin`: ImageVector
    get() {
        if (`_brackets-round-thin` != null) {
            return `_brackets-round-thin`!!
        }
        `_brackets-round-thin` = Builder(name = "Brackets-round-thin", defaultWidth = 256.0.dp,
...
private var `_brackets-round-thin`: ImageVector? = null
