...
public val LightGroup.`Compass-rose-light`: ImageVector
    get() {
        if (`_compass-rose-light` != null) {
            return `_compass-rose-light`!!
        }
        `_compass-rose-light` = Builder(name = "Compass-rose-light", defaultWidth = 256.0.dp,
...
private var `_compass-rose-light`: ImageVector? = null
