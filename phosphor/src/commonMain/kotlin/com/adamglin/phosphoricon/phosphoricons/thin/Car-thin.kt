...
public val ThinGroup.`Car-thin`: ImageVector
    get() {
        if (`_car-thin` != null) {
            return `_car-thin`!!
        }
        `_car-thin` = Builder(name = "Car-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_car-thin`: ImageVector? = null
