...
public val ThinGroup.`Magnifying-glass-minus-thin`: ImageVector
    get() {
        if (`_magnifying-glass-minus-thin` != null) {
            return `_magnifying-glass-minus-thin`!!
        }
        `_magnifying-glass-minus-thin` = Builder(name = "Magnifying-glass-minus-thin", defaultWidth
...
private var `_magnifying-glass-minus-thin`: ImageVector? = null
