...
public val RegularGroup.`Cloud-arrow-down`: ImageVector
    get() {
        if (`_cloud-arrow-down` != null) {
            return `_cloud-arrow-down`!!
        }
        `_cloud-arrow-down` = Builder(name = "Cloud-arrow-down", defaultWidth = 256.0.dp,
...
private var `_cloud-arrow-down`: ImageVector? = null
