...
public val LightGroup.`Upload-light`: ImageVector
    get() {
        if (`_upload-light` != null) {
            return `_upload-light`!!
        }
        `_upload-light` = Builder(name = "Upload-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_upload-light`: ImageVector? = null
