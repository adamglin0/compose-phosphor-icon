...
public val RegularGroup.`Patreon-logo`: ImageVector
    get() {
        if (`_patreon-logo` != null) {
            return `_patreon-logo`!!
        }
        `_patreon-logo` = Builder(name = "Patreon-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_patreon-logo`: ImageVector? = null
