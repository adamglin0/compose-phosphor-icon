...
public val DuotoneGroup.`Webcam-duotone`: ImageVector
    get() {
        if (`_webcam-duotone` != null) {
            return `_webcam-duotone`!!
        }
        `_webcam-duotone` = Builder(name = "Webcam-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_webcam-duotone`: ImageVector? = null
