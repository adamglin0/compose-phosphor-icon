...
public val ThinGroup.`Pants-thin`: ImageVector
    get() {
        if (`_pants-thin` != null) {
            return `_pants-thin`!!
        }
        `_pants-thin` = Builder(name = "Pants-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pants-thin`: ImageVector? = null
