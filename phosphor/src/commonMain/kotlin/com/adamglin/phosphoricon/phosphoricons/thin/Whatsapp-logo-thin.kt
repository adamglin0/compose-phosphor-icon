...
public val ThinGroup.`Whatsapp-logo-thin`: ImageVector
    get() {
        if (`_whatsapp-logo-thin` != null) {
            return `_whatsapp-logo-thin`!!
        }
        `_whatsapp-logo-thin` = Builder(name = "Whatsapp-logo-thin", defaultWidth = 256.0.dp,
...
private var `_whatsapp-logo-thin`: ImageVector? = null
