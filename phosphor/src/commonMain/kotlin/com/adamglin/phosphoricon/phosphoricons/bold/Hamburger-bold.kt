...
public val BoldGroup.`Hamburger-bold`: ImageVector
    get() {
        if (`_hamburger-bold` != null) {
            return `_hamburger-bold`!!
        }
        `_hamburger-bold` = Builder(name = "Hamburger-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hamburger-bold`: ImageVector? = null
