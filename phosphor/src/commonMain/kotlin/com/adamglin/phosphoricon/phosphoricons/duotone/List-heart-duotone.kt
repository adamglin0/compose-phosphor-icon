...
public val DuotoneGroup.`List-heart-duotone`: ImageVector
    get() {
        if (`_list-heart-duotone` != null) {
            return `_list-heart-duotone`!!
        }
        `_list-heart-duotone` = Builder(name = "List-heart-duotone", defaultWidth = 256.0.dp,
...
private var `_list-heart-duotone`: ImageVector? = null
