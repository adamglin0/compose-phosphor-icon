...
public val ThinGroup.`Kanban-thin`: ImageVector
    get() {
        if (`_kanban-thin` != null) {
            return `_kanban-thin`!!
        }
        `_kanban-thin` = Builder(name = "Kanban-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_kanban-thin`: ImageVector? = null
