...
public val LightGroup.`Plug-light`: ImageVector
    get() {
        if (`_plug-light` != null) {
            return `_plug-light`!!
        }
        `_plug-light` = Builder(name = "Plug-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plug-light`: ImageVector? = null
