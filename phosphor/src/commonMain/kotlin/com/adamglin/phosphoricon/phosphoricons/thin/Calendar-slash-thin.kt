...
public val ThinGroup.`Calendar-slash-thin`: ImageVector
    get() {
        if (`_calendar-slash-thin` != null) {
            return `_calendar-slash-thin`!!
        }
        `_calendar-slash-thin` = Builder(name = "Calendar-slash-thin", defaultWidth = 256.0.dp,
...
private var `_calendar-slash-thin`: ImageVector? = null
