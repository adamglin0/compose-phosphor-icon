...
public val BoldGroup.`Webcam-slash-bold`: ImageVector
    get() {
        if (`_webcam-slash-bold` != null) {
            return `_webcam-slash-bold`!!
        }
        `_webcam-slash-bold` = Builder(name = "Webcam-slash-bold", defaultWidth = 256.0.dp,
...
private var `_webcam-slash-bold`: ImageVector? = null
