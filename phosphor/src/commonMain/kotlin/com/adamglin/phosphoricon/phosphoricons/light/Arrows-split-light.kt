...
public val LightGroup.`Arrows-split-light`: ImageVector
    get() {
        if (`_arrows-split-light` != null) {
            return `_arrows-split-light`!!
        }
        `_arrows-split-light` = Builder(name = "Arrows-split-light", defaultWidth = 256.0.dp,
...
private var `_arrows-split-light`: ImageVector? = null
