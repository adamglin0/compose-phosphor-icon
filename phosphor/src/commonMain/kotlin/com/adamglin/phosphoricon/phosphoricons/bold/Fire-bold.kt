...
public val BoldGroup.`Fire-bold`: ImageVector
    get() {
        if (`_fire-bold` != null) {
            return `_fire-bold`!!
        }
        `_fire-bold` = Builder(name = "Fire-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fire-bold`: ImageVector? = null
