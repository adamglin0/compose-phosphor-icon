...
public val BoldGroup.`Number-square-four-bold`: ImageVector
    get() {
        if (`_number-square-four-bold` != null) {
            return `_number-square-four-bold`!!
        }
        `_number-square-four-bold` = Builder(name = "Number-square-four-bold", defaultWidth =
...
private var `_number-square-four-bold`: ImageVector? = null
