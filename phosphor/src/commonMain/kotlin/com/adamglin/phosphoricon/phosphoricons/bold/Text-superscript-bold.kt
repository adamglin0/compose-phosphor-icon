...
public val BoldGroup.`Text-superscript-bold`: ImageVector
    get() {
        if (`_text-superscript-bold` != null) {
            return `_text-superscript-bold`!!
        }
        `_text-superscript-bold` = Builder(name = "Text-superscript-bold", defaultWidth = 256.0.dp,
...
private var `_text-superscript-bold`: ImageVector? = null
