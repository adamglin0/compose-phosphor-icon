...
public val ThinGroup.`Cloud-x-thin`: ImageVector
    get() {
        if (`_cloud-x-thin` != null) {
            return `_cloud-x-thin`!!
        }
        `_cloud-x-thin` = Builder(name = "Cloud-x-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-x-thin`: ImageVector? = null
