...
public val LightGroup.`Envelope-simple-open-light`: ImageVector
    get() {
        if (`_envelope-simple-open-light` != null) {
            return `_envelope-simple-open-light`!!
        }
        `_envelope-simple-open-light` = Builder(name = "Envelope-simple-open-light", defaultWidth =
...
private var `_envelope-simple-open-light`: ImageVector? = null
