...
public val LightGroup.`Polygon-light`: ImageVector
    get() {
        if (`_polygon-light` != null) {
            return `_polygon-light`!!
        }
        `_polygon-light` = Builder(name = "Polygon-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_polygon-light`: ImageVector? = null
