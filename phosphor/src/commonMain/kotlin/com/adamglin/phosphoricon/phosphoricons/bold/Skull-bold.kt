...
public val BoldGroup.`Skull-bold`: ImageVector
    get() {
        if (`_skull-bold` != null) {
            return `_skull-bold`!!
        }
        `_skull-bold` = Builder(name = "Skull-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_skull-bold`: ImageVector? = null
