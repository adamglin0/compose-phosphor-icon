...
public val ThinGroup.`Folder-simple-dashed-thin`: ImageVector
    get() {
        if (`_folder-simple-dashed-thin` != null) {
            return `_folder-simple-dashed-thin`!!
        }
        `_folder-simple-dashed-thin` = Builder(name = "Folder-simple-dashed-thin", defaultWidth =
...
private var `_folder-simple-dashed-thin`: ImageVector? = null
