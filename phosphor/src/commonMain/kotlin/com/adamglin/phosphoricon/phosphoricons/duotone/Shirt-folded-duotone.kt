...
public val DuotoneGroup.`Shirt-folded-duotone`: ImageVector
    get() {
        if (`_shirt-folded-duotone` != null) {
            return `_shirt-folded-duotone`!!
        }
        `_shirt-folded-duotone` = Builder(name = "Shirt-folded-duotone", defaultWidth = 256.0.dp,
...
private var `_shirt-folded-duotone`: ImageVector? = null
