...
public val LightGroup.`Mouse-left-click-light`: ImageVector
    get() {
        if (`_mouse-left-click-light` != null) {
            return `_mouse-left-click-light`!!
        }
        `_mouse-left-click-light` = Builder(name = "Mouse-left-click-light", defaultWidth =
...
private var `_mouse-left-click-light`: ImageVector? = null
