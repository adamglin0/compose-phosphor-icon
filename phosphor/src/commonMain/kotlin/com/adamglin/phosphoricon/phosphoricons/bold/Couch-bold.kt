...
public val BoldGroup.`Couch-bold`: ImageVector
    get() {
        if (`_couch-bold` != null) {
            return `_couch-bold`!!
        }
        `_couch-bold` = Builder(name = "Couch-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_couch-bold`: ImageVector? = null
