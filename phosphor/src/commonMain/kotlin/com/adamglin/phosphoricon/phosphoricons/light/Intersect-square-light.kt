...
public val LightGroup.`Intersect-square-light`: ImageVector
    get() {
        if (`_intersect-square-light` != null) {
            return `_intersect-square-light`!!
        }
        `_intersect-square-light` = Builder(name = "Intersect-square-light", defaultWidth =
...
private var `_intersect-square-light`: ImageVector? = null
