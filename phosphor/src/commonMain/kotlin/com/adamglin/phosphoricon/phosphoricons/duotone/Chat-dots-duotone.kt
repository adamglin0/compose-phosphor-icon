...
public val DuotoneGroup.`Chat-dots-duotone`: ImageVector
    get() {
        if (`_chat-dots-duotone` != null) {
            return `_chat-dots-duotone`!!
        }
        `_chat-dots-duotone` = Builder(name = "Chat-dots-duotone", defaultWidth = 256.0.dp,
...
private var `_chat-dots-duotone`: ImageVector? = null
