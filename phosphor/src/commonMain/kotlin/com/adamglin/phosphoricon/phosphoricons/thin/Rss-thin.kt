...
public val ThinGroup.`Rss-thin`: ImageVector
    get() {
        if (`_rss-thin` != null) {
            return `_rss-thin`!!
        }
        `_rss-thin` = Builder(name = "Rss-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_rss-thin`: ImageVector? = null
