...
public val BoldGroup.`Book-open-text-bold`: ImageVector
    get() {
        if (`_book-open-text-bold` != null) {
            return `_book-open-text-bold`!!
        }
        `_book-open-text-bold` = Builder(name = "Book-open-text-bold", defaultWidth = 256.0.dp,
...
private var `_book-open-text-bold`: ImageVector? = null
