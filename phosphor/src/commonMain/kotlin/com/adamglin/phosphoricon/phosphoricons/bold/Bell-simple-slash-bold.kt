...
public val BoldGroup.`Bell-simple-slash-bold`: ImageVector
    get() {
        if (`_bell-simple-slash-bold` != null) {
            return `_bell-simple-slash-bold`!!
        }
        `_bell-simple-slash-bold` = Builder(name = "Bell-simple-slash-bold", defaultWidth =
...
private var `_bell-simple-slash-bold`: ImageVector? = null
