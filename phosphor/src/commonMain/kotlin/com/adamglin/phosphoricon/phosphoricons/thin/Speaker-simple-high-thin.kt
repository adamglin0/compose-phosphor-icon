...
public val ThinGroup.`Speaker-simple-high-thin`: ImageVector
    get() {
        if (`_speaker-simple-high-thin` != null) {
            return `_speaker-simple-high-thin`!!
        }
        `_speaker-simple-high-thin` = Builder(name = "Speaker-simple-high-thin", defaultWidth =
...
private var `_speaker-simple-high-thin`: ImageVector? = null
