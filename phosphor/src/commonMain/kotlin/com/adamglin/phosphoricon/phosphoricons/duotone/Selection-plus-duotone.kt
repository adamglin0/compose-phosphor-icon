...
public val DuotoneGroup.`Selection-plus-duotone`: ImageVector
    get() {
        if (`_selection-plus-duotone` != null) {
            return `_selection-plus-duotone`!!
        }
        `_selection-plus-duotone` = Builder(name = "Selection-plus-duotone", defaultWidth =
...
private var `_selection-plus-duotone`: ImageVector? = null
