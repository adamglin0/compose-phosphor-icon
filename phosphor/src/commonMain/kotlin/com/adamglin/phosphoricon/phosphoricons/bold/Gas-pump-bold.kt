...
public val BoldGroup.`Gas-pump-bold`: ImageVector
    get() {
        if (`_gas-pump-bold` != null) {
            return `_gas-pump-bold`!!
        }
        `_gas-pump-bold` = Builder(name = "Gas-pump-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gas-pump-bold`: ImageVector? = null
