...
public val DuotoneGroup.`Office-chair-duotone`: ImageVector
    get() {
        if (`_office-chair-duotone` != null) {
            return `_office-chair-duotone`!!
        }
        `_office-chair-duotone` = Builder(name = "Office-chair-duotone", defaultWidth = 256.0.dp,
...
private var `_office-chair-duotone`: ImageVector? = null
