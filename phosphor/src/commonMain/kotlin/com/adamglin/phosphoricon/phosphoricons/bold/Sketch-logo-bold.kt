...
public val BoldGroup.`Sketch-logo-bold`: ImageVector
    get() {
        if (`_sketch-logo-bold` != null) {
            return `_sketch-logo-bold`!!
        }
        `_sketch-logo-bold` = Builder(name = "Sketch-logo-bold", defaultWidth = 256.0.dp,
...
private var `_sketch-logo-bold`: ImageVector? = null
