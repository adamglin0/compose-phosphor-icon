...
public val ThinGroup.`Stethoscope-thin`: ImageVector
    get() {
        if (`_stethoscope-thin` != null) {
            return `_stethoscope-thin`!!
        }
        `_stethoscope-thin` = Builder(name = "Stethoscope-thin", defaultWidth = 256.0.dp,
...
private var `_stethoscope-thin`: ImageVector? = null
