...
public val DuotoneGroup.`Trademark-duotone`: ImageVector
    get() {
        if (`_trademark-duotone` != null) {
            return `_trademark-duotone`!!
        }
        `_trademark-duotone` = Builder(name = "Trademark-duotone", defaultWidth = 256.0.dp,
...
private var `_trademark-duotone`: ImageVector? = null
