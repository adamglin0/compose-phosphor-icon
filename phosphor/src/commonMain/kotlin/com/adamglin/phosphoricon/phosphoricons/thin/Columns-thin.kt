...
public val ThinGroup.`Columns-thin`: ImageVector
    get() {
        if (`_columns-thin` != null) {
            return `_columns-thin`!!
        }
        `_columns-thin` = Builder(name = "Columns-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_columns-thin`: ImageVector? = null
