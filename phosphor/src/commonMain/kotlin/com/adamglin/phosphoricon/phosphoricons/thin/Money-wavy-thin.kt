...
public val ThinGroup.`Money-wavy-thin`: ImageVector
    get() {
        if (`_money-wavy-thin` != null) {
            return `_money-wavy-thin`!!
        }
        `_money-wavy-thin` = Builder(name = "Money-wavy-thin", defaultWidth = 256.0.dp,
...
private var `_money-wavy-thin`: ImageVector? = null
