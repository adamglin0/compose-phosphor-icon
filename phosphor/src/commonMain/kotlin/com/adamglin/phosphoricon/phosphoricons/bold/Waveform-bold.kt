...
public val BoldGroup.`Waveform-bold`: ImageVector
    get() {
        if (`_waveform-bold` != null) {
            return `_waveform-bold`!!
        }
        `_waveform-bold` = Builder(name = "Waveform-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_waveform-bold`: ImageVector? = null
