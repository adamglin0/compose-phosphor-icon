...
public val LightGroup.`Bookmark-light`: ImageVector
    get() {
        if (`_bookmark-light` != null) {
            return `_bookmark-light`!!
        }
        `_bookmark-light` = Builder(name = "Bookmark-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bookmark-light`: ImageVector? = null
