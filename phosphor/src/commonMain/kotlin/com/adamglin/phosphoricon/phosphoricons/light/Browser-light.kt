...
public val LightGroup.`Browser-light`: ImageVector
    get() {
        if (`_browser-light` != null) {
            return `_browser-light`!!
        }
        `_browser-light` = Builder(name = "Browser-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_browser-light`: ImageVector? = null
