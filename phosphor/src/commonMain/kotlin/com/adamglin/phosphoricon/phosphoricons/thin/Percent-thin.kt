...
public val ThinGroup.`Percent-thin`: ImageVector
    get() {
        if (`_percent-thin` != null) {
            return `_percent-thin`!!
        }
        `_percent-thin` = Builder(name = "Percent-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_percent-thin`: ImageVector? = null
