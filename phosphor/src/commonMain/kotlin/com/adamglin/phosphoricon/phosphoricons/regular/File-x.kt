...
public val RegularGroup.`File-x`: ImageVector
    get() {
        if (`_file-x` != null) {
            return `_file-x`!!
        }
        `_file-x` = Builder(name = "File-x", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-x`: ImageVector? = null
