...
public val DuotoneGroup.`Magic-wand-duotone`: ImageVector
    get() {
        if (`_magic-wand-duotone` != null) {
            return `_magic-wand-duotone`!!
        }
        `_magic-wand-duotone` = Builder(name = "Magic-wand-duotone", defaultWidth = 256.0.dp,
...
private var `_magic-wand-duotone`: ImageVector? = null
