...
public val ThinGroup.`Hoodie-thin`: ImageVector
    get() {
        if (`_hoodie-thin` != null) {
            return `_hoodie-thin`!!
        }
        `_hoodie-thin` = Builder(name = "Hoodie-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hoodie-thin`: ImageVector? = null
