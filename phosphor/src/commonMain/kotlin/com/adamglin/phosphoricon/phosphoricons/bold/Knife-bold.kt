...
public val BoldGroup.`Knife-bold`: ImageVector
    get() {
        if (`_knife-bold` != null) {
            return `_knife-bold`!!
        }
        `_knife-bold` = Builder(name = "Knife-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_knife-bold`: ImageVector? = null
