...
public val DuotoneGroup.`Instagram-logo-duotone`: ImageVector
    get() {
        if (`_instagram-logo-duotone` != null) {
            return `_instagram-logo-duotone`!!
        }
        `_instagram-logo-duotone` = Builder(name = "Instagram-logo-duotone", defaultWidth =
...
private var `_instagram-logo-duotone`: ImageVector? = null
