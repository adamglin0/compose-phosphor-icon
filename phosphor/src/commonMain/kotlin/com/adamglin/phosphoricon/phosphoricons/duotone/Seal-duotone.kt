...
public val DuotoneGroup.`Seal-duotone`: ImageVector
    get() {
        if (`_seal-duotone` != null) {
            return `_seal-duotone`!!
        }
        `_seal-duotone` = Builder(name = "Seal-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seal-duotone`: ImageVector? = null
