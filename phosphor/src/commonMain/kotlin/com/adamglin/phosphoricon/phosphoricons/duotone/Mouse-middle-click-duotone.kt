...
public val DuotoneGroup.`Mouse-middle-click-duotone`: ImageVector
    get() {
        if (`_mouse-middle-click-duotone` != null) {
            return `_mouse-middle-click-duotone`!!
        }
        `_mouse-middle-click-duotone` = Builder(name = "Mouse-middle-click-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 144.0f, 88.0f)
                close()
            }
...
private var `_mouse-middle-click-duotone`: ImageVector? = null
