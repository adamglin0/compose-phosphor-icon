...
public val LightGroup.`Campfire-light`: ImageVector
    get() {
        if (`_campfire-light` != null) {
            return `_campfire-light`!!
        }
        `_campfire-light` = Builder(name = "Campfire-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_campfire-light`: ImageVector? = null
