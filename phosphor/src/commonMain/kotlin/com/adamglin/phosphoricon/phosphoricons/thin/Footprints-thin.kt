...
public val ThinGroup.`Footprints-thin`: ImageVector
    get() {
        if (`_footprints-thin` != null) {
            return `_footprints-thin`!!
        }
        `_footprints-thin` = Builder(name = "Footprints-thin", defaultWidth = 256.0.dp,
...
private var `_footprints-thin`: ImageVector? = null
