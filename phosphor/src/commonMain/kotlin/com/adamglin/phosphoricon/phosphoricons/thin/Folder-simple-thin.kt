...
public val ThinGroup.`Folder-simple-thin`: ImageVector
    get() {
        if (`_folder-simple-thin` != null) {
            return `_folder-simple-thin`!!
        }
        `_folder-simple-thin` = Builder(name = "Folder-simple-thin", defaultWidth = 256.0.dp,
...
private var `_folder-simple-thin`: ImageVector? = null
