...
public val LightGroup.`Tilde-light`: ImageVector
    get() {
        if (`_tilde-light` != null) {
            return `_tilde-light`!!
        }
        `_tilde-light` = Builder(name = "Tilde-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tilde-light`: ImageVector? = null
