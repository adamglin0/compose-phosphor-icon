...
public val BoldGroup.`Google-drive-logo-bold`: ImageVector
    get() {
        if (`_google-drive-logo-bold` != null) {
            return `_google-drive-logo-bold`!!
        }
        `_google-drive-logo-bold` = Builder(name = "Google-drive-logo-bold", defaultWidth =
...
private var `_google-drive-logo-bold`: ImageVector? = null
