...
public val ThinGroup.`Lock-open-thin`: ImageVector
    get() {
        if (`_lock-open-thin` != null) {
            return `_lock-open-thin`!!
        }
        `_lock-open-thin` = Builder(name = "Lock-open-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_lock-open-thin`: ImageVector? = null
