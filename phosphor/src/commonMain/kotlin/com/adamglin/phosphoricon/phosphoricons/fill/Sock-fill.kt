...
public val FillGroup.`Sock-fill`: ImageVector
    get() {
        if (`_sock-fill` != null) {
            return `_sock-fill`!!
        }
        `_sock-fill` = Builder(name = "Sock-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sock-fill`: ImageVector? = null
