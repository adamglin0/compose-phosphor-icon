...
public val BoldGroup.`Divide-bold`: ImageVector
    get() {
        if (`_divide-bold` != null) {
            return `_divide-bold`!!
        }
        `_divide-bold` = Builder(name = "Divide-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_divide-bold`: ImageVector? = null
