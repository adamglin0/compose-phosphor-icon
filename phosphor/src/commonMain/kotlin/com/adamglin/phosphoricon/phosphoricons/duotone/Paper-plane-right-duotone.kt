...
public val DuotoneGroup.`Paper-plane-right-duotone`: ImageVector
    get() {
        if (`_paper-plane-right-duotone` != null) {
            return `_paper-plane-right-duotone`!!
        }
        `_paper-plane-right-duotone` = Builder(name = "Paper-plane-right-duotone", defaultWidth =
...
private var `_paper-plane-right-duotone`: ImageVector? = null
