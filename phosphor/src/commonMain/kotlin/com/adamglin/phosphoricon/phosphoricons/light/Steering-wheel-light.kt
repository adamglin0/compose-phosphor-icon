...
public val LightGroup.`Steering-wheel-light`: ImageVector
    get() {
        if (`_steering-wheel-light` != null) {
            return `_steering-wheel-light`!!
        }
        `_steering-wheel-light` = Builder(name = "Steering-wheel-light", defaultWidth = 256.0.dp,
...
private var `_steering-wheel-light`: ImageVector? = null
