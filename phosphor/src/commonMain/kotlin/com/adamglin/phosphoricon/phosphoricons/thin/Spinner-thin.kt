...
public val ThinGroup.`Spinner-thin`: ImageVector
    get() {
        if (`_spinner-thin` != null) {
            return `_spinner-thin`!!
        }
        `_spinner-thin` = Builder(name = "Spinner-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spinner-thin`: ImageVector? = null
