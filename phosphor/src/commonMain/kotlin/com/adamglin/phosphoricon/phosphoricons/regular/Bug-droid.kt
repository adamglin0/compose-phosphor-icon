...
public val RegularGroup.`Bug-droid`: ImageVector
    get() {
        if (`_bug-droid` != null) {
            return `_bug-droid`!!
        }
        `_bug-droid` = Builder(name = "Bug-droid", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bug-droid`: ImageVector? = null
