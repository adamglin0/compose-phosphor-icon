...
public val LightGroup.`Thermometer-simple-light`: ImageVector
    get() {
        if (`_thermometer-simple-light` != null) {
            return `_thermometer-simple-light`!!
        }
        `_thermometer-simple-light` = Builder(name = "Thermometer-simple-light", defaultWidth =
...
private var `_thermometer-simple-light`: ImageVector? = null
