...
public val DuotoneGroup.`Prescription-duotone`: ImageVector
    get() {
        if (`_prescription-duotone` != null) {
            return `_prescription-duotone`!!
        }
        `_prescription-duotone` = Builder(name = "Prescription-duotone", defaultWidth = 256.0.dp,
...
private var `_prescription-duotone`: ImageVector? = null
