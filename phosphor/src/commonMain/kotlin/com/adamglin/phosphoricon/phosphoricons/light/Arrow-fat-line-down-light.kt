...
public val LightGroup.`Arrow-fat-line-down-light`: ImageVector
    get() {
        if (`_arrow-fat-line-down-light` != null) {
            return `_arrow-fat-line-down-light`!!
        }
        `_arrow-fat-line-down-light` = Builder(name = "Arrow-fat-line-down-light", defaultWidth =
...
private var `_arrow-fat-line-down-light`: ImageVector? = null
