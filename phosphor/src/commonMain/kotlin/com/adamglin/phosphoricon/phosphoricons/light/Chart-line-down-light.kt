...
public val LightGroup.`Chart-line-down-light`: ImageVector
    get() {
        if (`_chart-line-down-light` != null) {
            return `_chart-line-down-light`!!
        }
        `_chart-line-down-light` = Builder(name = "Chart-line-down-light", defaultWidth = 256.0.dp,
...
private var `_chart-line-down-light`: ImageVector? = null
