...
public val LightGroup.`Dots-three-outline-vertical-light`: ImageVector
    get() {
        if (`_dots-three-outline-vertical-light` != null) {
            return `_dots-three-outline-vertical-light`!!
        }
        `_dots-three-outline-vertical-light` = Builder(name = "Dots-three-outline-vertical-light",
...
private var `_dots-three-outline-vertical-light`: ImageVector? = null
