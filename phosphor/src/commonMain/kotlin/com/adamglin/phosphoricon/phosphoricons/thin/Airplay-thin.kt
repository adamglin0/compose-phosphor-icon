...
public val ThinGroup.`Airplay-thin`: ImageVector
    get() {
        if (`_airplay-thin` != null) {
            return `_airplay-thin`!!
        }
        `_airplay-thin` = Builder(name = "Airplay-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_airplay-thin`: ImageVector? = null
