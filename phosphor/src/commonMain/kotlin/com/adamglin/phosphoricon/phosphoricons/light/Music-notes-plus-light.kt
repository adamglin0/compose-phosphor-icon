...
public val LightGroup.`Music-notes-plus-light`: ImageVector
    get() {
        if (`_music-notes-plus-light` != null) {
            return `_music-notes-plus-light`!!
        }
        `_music-notes-plus-light` = Builder(name = "Music-notes-plus-light", defaultWidth =
...
private var `_music-notes-plus-light`: ImageVector? = null
