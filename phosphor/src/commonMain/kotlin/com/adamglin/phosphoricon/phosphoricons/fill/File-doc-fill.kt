...
public val FillGroup.`File-doc-fill`: ImageVector
    get() {
        if (`_file-doc-fill` != null) {
            return `_file-doc-fill`!!
        }
        `_file-doc-fill` = Builder(name = "File-doc-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-doc-fill`: ImageVector? = null
