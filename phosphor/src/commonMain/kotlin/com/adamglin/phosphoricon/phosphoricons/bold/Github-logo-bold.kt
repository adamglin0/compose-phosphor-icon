...
public val BoldGroup.`Github-logo-bold`: ImageVector
    get() {
        if (`_github-logo-bold` != null) {
            return `_github-logo-bold`!!
        }
        `_github-logo-bold` = Builder(name = "Github-logo-bold", defaultWidth = 256.0.dp,
...
private var `_github-logo-bold`: ImageVector? = null
