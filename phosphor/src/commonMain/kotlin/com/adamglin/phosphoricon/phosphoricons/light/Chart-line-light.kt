...
public val LightGroup.`Chart-line-light`: ImageVector
    get() {
        if (`_chart-line-light` != null) {
            return `_chart-line-light`!!
        }
        `_chart-line-light` = Builder(name = "Chart-line-light", defaultWidth = 256.0.dp,
...
private var `_chart-line-light`: ImageVector? = null
