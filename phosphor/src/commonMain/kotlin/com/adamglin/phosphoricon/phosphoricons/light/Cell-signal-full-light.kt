...
public val LightGroup.`Cell-signal-full-light`: ImageVector
    get() {
        if (`_cell-signal-full-light` != null) {
            return `_cell-signal-full-light`!!
        }
        `_cell-signal-full-light` = Builder(name = "Cell-signal-full-light", defaultWidth =
...
private var `_cell-signal-full-light`: ImageVector? = null
