...
public val LightGroup.`Highlighter-light`: ImageVector
    get() {
        if (`_highlighter-light` != null) {
            return `_highlighter-light`!!
        }
        `_highlighter-light` = Builder(name = "Highlighter-light", defaultWidth = 256.0.dp,
...
private var `_highlighter-light`: ImageVector? = null
