...
public val ThinGroup.`Hand-arrow-down-thin`: ImageVector
    get() {
        if (`_hand-arrow-down-thin` != null) {
            return `_hand-arrow-down-thin`!!
        }
        `_hand-arrow-down-thin` = Builder(name = "Hand-arrow-down-thin", defaultWidth = 256.0.dp,
...
private var `_hand-arrow-down-thin`: ImageVector? = null
