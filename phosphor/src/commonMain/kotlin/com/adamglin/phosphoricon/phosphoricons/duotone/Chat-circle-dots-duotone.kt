...
public val DuotoneGroup.`Chat-circle-dots-duotone`: ImageVector
    get() {
        if (`_chat-circle-dots-duotone` != null) {
            return `_chat-circle-dots-duotone`!!
        }
        `_chat-circle-dots-duotone` = Builder(name = "Chat-circle-dots-duotone", defaultWidth =
...
private var `_chat-circle-dots-duotone`: ImageVector? = null
