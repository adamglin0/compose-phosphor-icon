...
public val BoldGroup.`Chat-dots-bold`: ImageVector
    get() {
        if (`_chat-dots-bold` != null) {
            return `_chat-dots-bold`!!
        }
        `_chat-dots-bold` = Builder(name = "Chat-dots-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_chat-dots-bold`: ImageVector? = null
