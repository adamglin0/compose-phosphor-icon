...
public val FillGroup.`Arrows-in-line-vertical-fill`: ImageVector
    get() {
        if (`_arrows-in-line-vertical-fill` != null) {
            return `_arrows-in-line-vertical-fill`!!
        }
        `_arrows-in-line-vertical-fill` = Builder(name = "Arrows-in-line-vertical-fill",
...
private var `_arrows-in-line-vertical-fill`: ImageVector? = null
