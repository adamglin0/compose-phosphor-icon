...
public val DuotoneGroup.`Gender-transgender-duotone`: ImageVector
    get() {
        if (`_gender-transgender-duotone` != null) {
            return `_gender-transgender-duotone`!!
        }
        `_gender-transgender-duotone` = Builder(name = "Gender-transgender-duotone", defaultWidth =
...
private var `_gender-transgender-duotone`: ImageVector? = null
