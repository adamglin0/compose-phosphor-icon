...
public val DuotoneGroup.`Jeep-duotone`: ImageVector
    get() {
        if (`_jeep-duotone` != null) {
            return `_jeep-duotone`!!
        }
        `_jeep-duotone` = Builder(name = "Jeep-duotone", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(42.65f, 46.32f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 50.47f, 40.0f)
...
private var `_jeep-duotone`: ImageVector? = null
