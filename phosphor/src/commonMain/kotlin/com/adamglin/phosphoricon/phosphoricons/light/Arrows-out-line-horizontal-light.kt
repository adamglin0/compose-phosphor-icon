...
public val LightGroup.`Arrows-out-line-horizontal-light`: ImageVector
    get() {
        if (`_arrows-out-line-horizontal-light` != null) {
            return `_arrows-out-line-horizontal-light`!!
        }
        `_arrows-out-line-horizontal-light` = Builder(name = "Arrows-out-line-horizontal-light",
...
private var `_arrows-out-line-horizontal-light`: ImageVector? = null
