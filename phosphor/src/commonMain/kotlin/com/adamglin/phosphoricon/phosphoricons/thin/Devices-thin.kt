...
public val ThinGroup.`Devices-thin`: ImageVector
    get() {
        if (`_devices-thin` != null) {
            return `_devices-thin`!!
        }
        `_devices-thin` = Builder(name = "Devices-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_devices-thin`: ImageVector? = null
