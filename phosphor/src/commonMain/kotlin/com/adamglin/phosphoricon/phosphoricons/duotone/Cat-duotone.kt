...
public val DuotoneGroup.`Cat-duotone`: ImageVector
    get() {
        if (`_cat-duotone` != null) {
            return `_cat-duotone`!!
        }
        `_cat-duotone` = Builder(name = "Cat-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cat-duotone`: ImageVector? = null
