...
public val FillGroup.`Drop-slash-fill`: ImageVector
    get() {
        if (`_drop-slash-fill` != null) {
            return `_drop-slash-fill`!!
        }
        `_drop-slash-fill` = Builder(name = "Drop-slash-fill", defaultWidth = 256.0.dp,
...
private var `_drop-slash-fill`: ImageVector? = null
