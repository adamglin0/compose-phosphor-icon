...
public val ThinGroup.`City-thin`: ImageVector
    get() {
        if (`_city-thin` != null) {
            return `_city-thin`!!
        }
        `_city-thin` = Builder(name = "City-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_city-thin`: ImageVector? = null
