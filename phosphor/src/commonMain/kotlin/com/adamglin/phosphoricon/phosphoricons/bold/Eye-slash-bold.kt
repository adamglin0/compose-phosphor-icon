...
public val BoldGroup.`Eye-slash-bold`: ImageVector
    get() {
        if (`_eye-slash-bold` != null) {
            return `_eye-slash-bold`!!
        }
        `_eye-slash-bold` = Builder(name = "Eye-slash-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_eye-slash-bold`: ImageVector? = null
