...
public val BoldGroup.`Phone-incoming-bold`: ImageVector
    get() {
        if (`_phone-incoming-bold` != null) {
            return `_phone-incoming-bold`!!
        }
        `_phone-incoming-bold` = Builder(name = "Phone-incoming-bold", defaultWidth = 256.0.dp,
...
private var `_phone-incoming-bold`: ImageVector? = null
