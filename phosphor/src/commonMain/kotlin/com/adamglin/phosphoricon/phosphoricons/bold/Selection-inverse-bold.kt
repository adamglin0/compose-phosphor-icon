...
public val BoldGroup.`Selection-inverse-bold`: ImageVector
    get() {
        if (`_selection-inverse-bold` != null) {
            return `_selection-inverse-bold`!!
        }
        `_selection-inverse-bold` = Builder(name = "Selection-inverse-bold", defaultWidth =
...
private var `_selection-inverse-bold`: ImageVector? = null
