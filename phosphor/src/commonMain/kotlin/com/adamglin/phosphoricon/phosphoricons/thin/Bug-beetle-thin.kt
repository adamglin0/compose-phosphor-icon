...
public val ThinGroup.`Bug-beetle-thin`: ImageVector
    get() {
        if (`_bug-beetle-thin` != null) {
            return `_bug-beetle-thin`!!
        }
        `_bug-beetle-thin` = Builder(name = "Bug-beetle-thin", defaultWidth = 256.0.dp,
...
private var `_bug-beetle-thin`: ImageVector? = null
