...
public val DuotoneGroup.`Wifi-none-duotone`: ImageVector
    get() {
        if (`_wifi-none-duotone` != null) {
            return `_wifi-none-duotone`!!
        }
        `_wifi-none-duotone` = Builder(name = "Wifi-none-duotone", defaultWidth = 256.0.dp,
...
private var `_wifi-none-duotone`: ImageVector? = null
