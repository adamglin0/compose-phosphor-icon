...
public val BoldGroup.`Pencil-line-bold`: ImageVector
    get() {
        if (`_pencil-line-bold` != null) {
            return `_pencil-line-bold`!!
        }
        `_pencil-line-bold` = Builder(name = "Pencil-line-bold", defaultWidth = 256.0.dp,
...
private var `_pencil-line-bold`: ImageVector? = null
