...
public val ThinGroup.`Arrow-square-down-thin`: ImageVector
    get() {
        if (`_arrow-square-down-thin` != null) {
            return `_arrow-square-down-thin`!!
        }
        `_arrow-square-down-thin` = Builder(name = "Arrow-square-down-thin", defaultWidth =
...
private var `_arrow-square-down-thin`: ImageVector? = null
