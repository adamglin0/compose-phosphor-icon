...
public val FillGroup.`Potted-plant-fill`: ImageVector
    get() {
        if (`_potted-plant-fill` != null) {
            return `_potted-plant-fill`!!
        }
        `_potted-plant-fill` = Builder(name = "Potted-plant-fill", defaultWidth = 256.0.dp,
...
private var `_potted-plant-fill`: ImageVector? = null
