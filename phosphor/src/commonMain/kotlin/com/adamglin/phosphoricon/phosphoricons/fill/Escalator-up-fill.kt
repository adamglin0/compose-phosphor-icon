...
public val FillGroup.`Escalator-up-fill`: ImageVector
    get() {
        if (`_escalator-up-fill` != null) {
            return `_escalator-up-fill`!!
        }
        `_escalator-up-fill` = Builder(name = "Escalator-up-fill", defaultWidth = 256.0.dp,
...
private var `_escalator-up-fill`: ImageVector? = null
