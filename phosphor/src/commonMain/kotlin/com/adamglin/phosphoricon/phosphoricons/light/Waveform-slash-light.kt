...
public val LightGroup.`Waveform-slash-light`: ImageVector
    get() {
        if (`_waveform-slash-light` != null) {
            return `_waveform-slash-light`!!
        }
        `_waveform-slash-light` = Builder(name = "Waveform-slash-light", defaultWidth = 256.0.dp,
...
private var `_waveform-slash-light`: ImageVector? = null
