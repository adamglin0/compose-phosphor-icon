...
public val BoldGroup.`Jar-label-bold`: ImageVector
    get() {
        if (`_jar-label-bold` != null) {
            return `_jar-label-bold`!!
        }
        `_jar-label-bold` = Builder(name = "Jar-label-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_jar-label-bold`: ImageVector? = null
