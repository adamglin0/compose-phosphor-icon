...
public val BoldGroup.`Floppy-disk-back-bold`: ImageVector
    get() {
        if (`_floppy-disk-back-bold` != null) {
            return `_floppy-disk-back-bold`!!
        }
        `_floppy-disk-back-bold` = Builder(name = "Floppy-disk-back-bold", defaultWidth = 256.0.dp,
...
private var `_floppy-disk-back-bold`: ImageVector? = null
