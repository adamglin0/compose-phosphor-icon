...
public val ThinGroup.`Keyhole-thin`: ImageVector
    get() {
        if (`_keyhole-thin` != null) {
            return `_keyhole-thin`!!
        }
        `_keyhole-thin` = Builder(name = "Keyhole-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_keyhole-thin`: ImageVector? = null
