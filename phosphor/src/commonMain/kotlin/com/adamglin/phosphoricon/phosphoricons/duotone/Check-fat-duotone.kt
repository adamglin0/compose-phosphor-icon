...
public val DuotoneGroup.`Check-fat-duotone`: ImageVector
    get() {
        if (`_check-fat-duotone` != null) {
            return `_check-fat-duotone`!!
        }
        `_check-fat-duotone` = Builder(name = "Check-fat-duotone", defaultWidth = 256.0.dp,
...
private var `_check-fat-duotone`: ImageVector? = null
