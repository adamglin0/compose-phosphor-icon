...
public val BoldGroup.`Pizza-bold`: ImageVector
    get() {
        if (`_pizza-bold` != null) {
            return `_pizza-bold`!!
        }
        `_pizza-bold` = Builder(name = "Pizza-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pizza-bold`: ImageVector? = null
