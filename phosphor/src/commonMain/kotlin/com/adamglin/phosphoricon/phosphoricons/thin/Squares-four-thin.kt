...
public val ThinGroup.`Squares-four-thin`: ImageVector
    get() {
        if (`_squares-four-thin` != null) {
            return `_squares-four-thin`!!
        }
        `_squares-four-thin` = Builder(name = "Squares-four-thin", defaultWidth = 256.0.dp,
...
private var `_squares-four-thin`: ImageVector? = null
