...
public val LightGroup.`Fediverse-logo-light`: ImageVector
    get() {
        if (`_fediverse-logo-light` != null) {
            return `_fediverse-logo-light`!!
        }
        `_fediverse-logo-light` = Builder(name = "Fediverse-logo-light", defaultWidth = 256.0.dp,
...
private var `_fediverse-logo-light`: ImageVector? = null
