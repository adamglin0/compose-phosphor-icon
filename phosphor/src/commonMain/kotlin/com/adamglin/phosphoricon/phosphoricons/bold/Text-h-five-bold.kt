...
public val BoldGroup.`Text-h-five-bold`: ImageVector
    get() {
        if (`_text-h-five-bold` != null) {
            return `_text-h-five-bold`!!
        }
        `_text-h-five-bold` = Builder(name = "Text-h-five-bold", defaultWidth = 256.0.dp,
...
private var `_text-h-five-bold`: ImageVector? = null
