...
public val BoldGroup.`Battery-plus-bold`: ImageVector
    get() {
        if (`_battery-plus-bold` != null) {
            return `_battery-plus-bold`!!
        }
        `_battery-plus-bold` = Builder(name = "Battery-plus-bold", defaultWidth = 256.0.dp,
...
private var `_battery-plus-bold`: ImageVector? = null
