...
public val DuotoneGroup.`Users-duotone`: ImageVector
    get() {
        if (`_users-duotone` != null) {
            return `_users-duotone`!!
        }
        `_users-duotone` = Builder(name = "Users-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_users-duotone`: ImageVector? = null
