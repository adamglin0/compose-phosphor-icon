...
public val ThinGroup.`File-thin`: ImageVector
    get() {
        if (`_file-thin` != null) {
            return `_file-thin`!!
        }
        `_file-thin` = Builder(name = "File-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-thin`: ImageVector? = null
