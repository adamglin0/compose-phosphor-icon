...
public val ThinGroup.`Fallout-shelter-thin`: ImageVector
    get() {
        if (`_fallout-shelter-thin` != null) {
            return `_fallout-shelter-thin`!!
        }
        `_fallout-shelter-thin` = Builder(name = "Fallout-shelter-thin", defaultWidth = 256.0.dp,
...
private var `_fallout-shelter-thin`: ImageVector? = null
