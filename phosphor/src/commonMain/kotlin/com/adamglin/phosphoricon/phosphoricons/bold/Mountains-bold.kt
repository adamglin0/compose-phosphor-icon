...
public val BoldGroup.`Mountains-bold`: ImageVector
    get() {
        if (`_mountains-bold` != null) {
            return `_mountains-bold`!!
        }
        `_mountains-bold` = Builder(name = "Mountains-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_mountains-bold`: ImageVector? = null
