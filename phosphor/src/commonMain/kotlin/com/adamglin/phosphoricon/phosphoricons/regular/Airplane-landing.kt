...
public val RegularGroup.`Airplane-landing`: ImageVector
    get() {
        if (`_airplane-landing` != null) {
            return `_airplane-landing`!!
        }
        `_airplane-landing` = Builder(name = "Airplane-landing", defaultWidth = 256.0.dp,
...
private var `_airplane-landing`: ImageVector? = null
