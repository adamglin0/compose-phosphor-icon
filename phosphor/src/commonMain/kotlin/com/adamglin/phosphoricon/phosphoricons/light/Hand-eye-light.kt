...
public val LightGroup.`Hand-eye-light`: ImageVector
    get() {
        if (`_hand-eye-light` != null) {
            return `_hand-eye-light`!!
        }
        `_hand-eye-light` = Builder(name = "Hand-eye-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hand-eye-light`: ImageVector? = null
