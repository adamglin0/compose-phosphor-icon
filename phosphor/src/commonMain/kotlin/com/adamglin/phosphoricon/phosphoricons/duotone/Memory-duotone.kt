...
public val DuotoneGroup.`Memory-duotone`: ImageVector
    get() {
        if (`_memory-duotone` != null) {
            return `_memory-duotone`!!
        }
        `_memory-duotone` = Builder(name = "Memory-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_memory-duotone`: ImageVector? = null
