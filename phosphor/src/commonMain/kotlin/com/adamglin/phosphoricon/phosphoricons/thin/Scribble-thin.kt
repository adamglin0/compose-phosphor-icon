...
public val ThinGroup.`Scribble-thin`: ImageVector
    get() {
        if (`_scribble-thin` != null) {
            return `_scribble-thin`!!
        }
        `_scribble-thin` = Builder(name = "Scribble-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scribble-thin`: ImageVector? = null
