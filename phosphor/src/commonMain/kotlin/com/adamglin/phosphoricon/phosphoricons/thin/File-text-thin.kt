...
public val ThinGroup.`File-text-thin`: ImageVector
    get() {
        if (`_file-text-thin` != null) {
            return `_file-text-thin`!!
        }
        `_file-text-thin` = Builder(name = "File-text-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-text-thin`: ImageVector? = null
