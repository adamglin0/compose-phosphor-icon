...
public val BoldGroup.`Hand-arrow-up-bold`: ImageVector
    get() {
        if (`_hand-arrow-up-bold` != null) {
            return `_hand-arrow-up-bold`!!
        }
        `_hand-arrow-up-bold` = Builder(name = "Hand-arrow-up-bold", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(35.74f, 35.74f, 0.0f, false, false, -25.45f, 10.54f)
                lineTo(43.0f, 140.0f)
                lineTo(20.0f, 140.0f)
                ...
                arcToRelative(4.6f, 4.6f, 0.0f, false, true, 5.81f, 4.44f)
                arcTo(4.58f, 4.58f, 0.0f, false, true, 217.68f, 164.61f)
                close()
                moveTo(151.51f, 64.48f)
                ...
                lineTo(180.0f, 53.0f)
                lineTo(168.49f, 64.48f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 151.51f, 64.48f)
                close()
            }
        }
        .build()
...
private var `_hand-arrow-up-bold`: ImageVector? = null
