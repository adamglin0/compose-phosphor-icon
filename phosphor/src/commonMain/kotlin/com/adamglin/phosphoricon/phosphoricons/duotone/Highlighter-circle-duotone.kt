...
public val DuotoneGroup.`Highlighter-circle-duotone`: ImageVector
    get() {
        if (`_highlighter-circle-duotone` != null) {
            return `_highlighter-circle-duotone`!!
        }
        `_highlighter-circle-duotone` = Builder(name = "Highlighter-circle-duotone", defaultWidth =
...
private var `_highlighter-circle-duotone`: ImageVector? = null
