...
public val LightGroup.`Usb-light`: ImageVector
    get() {
        if (`_usb-light` != null) {
            return `_usb-light`!!
        }
        `_usb-light` = Builder(name = "Usb-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_usb-light`: ImageVector? = null
