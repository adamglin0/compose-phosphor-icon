...
public val DuotoneGroup.`Octagon-duotone`: ImageVector
    get() {
        if (`_octagon-duotone` != null) {
            return `_octagon-duotone`!!
        }
        `_octagon-duotone` = Builder(name = "Octagon-duotone", defaultWidth = 256.0.dp,
...
private var `_octagon-duotone`: ImageVector? = null
