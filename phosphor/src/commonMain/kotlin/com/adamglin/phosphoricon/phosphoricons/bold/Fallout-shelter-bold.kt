...
public val BoldGroup.`Fallout-shelter-bold`: ImageVector
    get() {
        if (`_fallout-shelter-bold` != null) {
            return `_fallout-shelter-bold`!!
        }
        `_fallout-shelter-bold` = Builder(name = "Fallout-shelter-bold", defaultWidth = 256.0.dp,
...
private var `_fallout-shelter-bold`: ImageVector? = null
