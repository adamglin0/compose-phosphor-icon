...
public val ThinGroup.`Hospital-thin`: ImageVector
    get() {
        if (`_hospital-thin` != null) {
            return `_hospital-thin`!!
        }
        `_hospital-thin` = Builder(name = "Hospital-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hospital-thin`: ImageVector? = null
