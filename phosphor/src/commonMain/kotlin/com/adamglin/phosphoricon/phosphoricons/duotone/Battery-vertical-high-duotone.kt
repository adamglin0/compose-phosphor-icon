...
public val DuotoneGroup.`Battery-vertical-high-duotone`: ImageVector
    get() {
        if (`_battery-vertical-high-duotone` != null) {
            return `_battery-vertical-high-duotone`!!
        }
        `_battery-vertical-high-duotone` = Builder(name = "Battery-vertical-high-duotone",
...
private var `_battery-vertical-high-duotone`: ImageVector? = null
