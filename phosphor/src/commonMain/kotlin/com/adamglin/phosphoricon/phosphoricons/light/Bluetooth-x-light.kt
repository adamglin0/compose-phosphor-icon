...
public val LightGroup.`Bluetooth-x-light`: ImageVector
    get() {
        if (`_bluetooth-x-light` != null) {
            return `_bluetooth-x-light`!!
        }
        `_bluetooth-x-light` = Builder(name = "Bluetooth-x-light", defaultWidth = 256.0.dp,
...
private var `_bluetooth-x-light`: ImageVector? = null
