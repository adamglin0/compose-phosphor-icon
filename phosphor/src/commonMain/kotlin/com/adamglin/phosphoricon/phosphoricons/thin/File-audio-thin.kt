...
public val ThinGroup.`File-audio-thin`: ImageVector
    get() {
        if (`_file-audio-thin` != null) {
            return `_file-audio-thin`!!
        }
        `_file-audio-thin` = Builder(name = "File-audio-thin", defaultWidth = 256.0.dp,
...
private var `_file-audio-thin`: ImageVector? = null
