...
public val ThinGroup.`Phosphor-logo-thin`: ImageVector
    get() {
        if (`_phosphor-logo-thin` != null) {
            return `_phosphor-logo-thin`!!
        }
        `_phosphor-logo-thin` = Builder(name = "Phosphor-logo-thin", defaultWidth = 256.0.dp,
...
private var `_phosphor-logo-thin`: ImageVector? = null
