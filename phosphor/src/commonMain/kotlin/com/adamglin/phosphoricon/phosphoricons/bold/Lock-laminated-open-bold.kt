...
public val BoldGroup.`Lock-laminated-open-bold`: ImageVector
    get() {
        if (`_lock-laminated-open-bold` != null) {
            return `_lock-laminated-open-bold`!!
        }
        `_lock-laminated-open-bold` = Builder(name = "Lock-laminated-open-bold", defaultWidth =
...
private var `_lock-laminated-open-bold`: ImageVector? = null
