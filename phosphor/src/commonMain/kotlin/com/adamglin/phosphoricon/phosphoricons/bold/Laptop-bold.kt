...
public val BoldGroup.`Laptop-bold`: ImageVector
    get() {
        if (`_laptop-bold` != null) {
            return `_laptop-bold`!!
        }
        `_laptop-bold` = Builder(name = "Laptop-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_laptop-bold`: ImageVector? = null
