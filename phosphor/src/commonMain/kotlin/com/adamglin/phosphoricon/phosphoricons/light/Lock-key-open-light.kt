...
public val LightGroup.`Lock-key-open-light`: ImageVector
    get() {
        if (`_lock-key-open-light` != null) {
            return `_lock-key-open-light`!!
        }
        `_lock-key-open-light` = Builder(name = "Lock-key-open-light", defaultWidth = 256.0.dp,
...
private var `_lock-key-open-light`: ImageVector? = null
