...
public val RegularGroup.`Cell-signal-x`: ImageVector
    get() {
        if (`_cell-signal-x` != null) {
            return `_cell-signal-x`!!
        }
        `_cell-signal-x` = Builder(name = "Cell-signal-x", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, false, 200.0f, 120.0f)
                close()
...
private var `_cell-signal-x`: ImageVector? = null
