...
public val FillGroup.`Folder-plus-fill`: ImageVector
    get() {
        if (`_folder-plus-fill` != null) {
            return `_folder-plus-fill`!!
        }
        `_folder-plus-fill` = Builder(name = "Folder-plus-fill", defaultWidth = 256.0.dp,
...
private var `_folder-plus-fill`: ImageVector? = null
