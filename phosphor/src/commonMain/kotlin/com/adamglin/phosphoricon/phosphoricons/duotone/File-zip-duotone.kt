...
public val DuotoneGroup.`File-zip-duotone`: ImageVector
    get() {
        if (`_file-zip-duotone` != null) {
            return `_file-zip-duotone`!!
        }
        `_file-zip-duotone` = Builder(name = "File-zip-duotone", defaultWidth = 256.0.dp,
...
private var `_file-zip-duotone`: ImageVector? = null
