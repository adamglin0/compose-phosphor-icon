...
public val RegularGroup.`Selection-slash`: ImageVector
    get() {
        if (`_selection-slash` != null) {
            return `_selection-slash`!!
        }
        `_selection-slash` = Builder(name = "Selection-slash", defaultWidth = 256.0.dp,
...
private var `_selection-slash`: ImageVector? = null
