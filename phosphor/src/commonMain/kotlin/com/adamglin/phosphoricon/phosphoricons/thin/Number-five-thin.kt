...
public val ThinGroup.`Number-five-thin`: ImageVector
    get() {
        if (`_number-five-thin` != null) {
            return `_number-five-thin`!!
        }
        `_number-five-thin` = Builder(name = "Number-five-thin", defaultWidth = 256.0.dp,
...
private var `_number-five-thin`: ImageVector? = null
