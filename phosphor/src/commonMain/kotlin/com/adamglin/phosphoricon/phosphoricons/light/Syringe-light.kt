...
public val LightGroup.`Syringe-light`: ImageVector
    get() {
        if (`_syringe-light` != null) {
            return `_syringe-light`!!
        }
        `_syringe-light` = Builder(name = "Syringe-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_syringe-light`: ImageVector? = null
