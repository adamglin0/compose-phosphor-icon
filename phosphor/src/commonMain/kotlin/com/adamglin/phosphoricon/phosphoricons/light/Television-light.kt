...
public val LightGroup.`Television-light`: ImageVector
    get() {
        if (`_television-light` != null) {
            return `_television-light`!!
        }
        `_television-light` = Builder(name = "Television-light", defaultWidth = 256.0.dp,
...
private var `_television-light`: ImageVector? = null
