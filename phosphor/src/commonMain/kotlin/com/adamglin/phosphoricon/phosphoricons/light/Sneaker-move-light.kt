...
public val LightGroup.`Sneaker-move-light`: ImageVector
    get() {
        if (`_sneaker-move-light` != null) {
            return `_sneaker-move-light`!!
        }
        `_sneaker-move-light` = Builder(name = "Sneaker-move-light", defaultWidth = 256.0.dp,
...
private var `_sneaker-move-light`: ImageVector? = null
