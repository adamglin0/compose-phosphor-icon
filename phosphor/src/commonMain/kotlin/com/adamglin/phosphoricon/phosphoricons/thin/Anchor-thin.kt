...
public val ThinGroup.`Anchor-thin`: ImageVector
    get() {
        if (`_anchor-thin` != null) {
            return `_anchor-thin`!!
        }
        `_anchor-thin` = Builder(name = "Anchor-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_anchor-thin`: ImageVector? = null
