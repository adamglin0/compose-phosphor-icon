...
public val BoldGroup.`Person-simple-ski-bold`: ImageVector
    get() {
        if (`_person-simple-ski-bold` != null) {
            return `_person-simple-ski-bold`!!
        }
        `_person-simple-ski-bold` = Builder(name = "Person-simple-ski-bold", defaultWidth =
...
private var `_person-simple-ski-bold`: ImageVector? = null
