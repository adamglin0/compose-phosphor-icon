...
public val BoldGroup.`Bug-droid-bold`: ImageVector
    get() {
        if (`_bug-droid-bold` != null) {
            return `_bug-droid-bold`!!
        }
        `_bug-droid-bold` = Builder(name = "Bug-droid-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bug-droid-bold`: ImageVector? = null
