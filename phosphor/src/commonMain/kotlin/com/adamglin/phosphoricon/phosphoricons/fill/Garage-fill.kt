...
public val FillGroup.`Garage-fill`: ImageVector
    get() {
        if (`_garage-fill` != null) {
            return `_garage-fill`!!
        }
        `_garage-fill` = Builder(name = "Garage-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_garage-fill`: ImageVector? = null
