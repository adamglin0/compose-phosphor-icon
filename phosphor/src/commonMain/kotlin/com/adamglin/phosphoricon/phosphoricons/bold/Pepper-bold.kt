...
public val BoldGroup.`Pepper-bold`: ImageVector
    get() {
        if (`_pepper-bold` != null) {
            return `_pepper-bold`!!
        }
        `_pepper-bold` = Builder(name = "Pepper-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pepper-bold`: ImageVector? = null
