...
public val DuotoneGroup.`Not-subset-of-duotone`: ImageVector
    get() {
        if (`_not-subset-of-duotone` != null) {
            return `_not-subset-of-duotone`!!
        }
        `_not-subset-of-duotone` = Builder(name = "Not-subset-of-duotone", defaultWidth = 256.0.dp,
...
private var `_not-subset-of-duotone`: ImageVector? = null
