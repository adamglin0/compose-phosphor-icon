...
public val DuotoneGroup.`Envelope-duotone`: ImageVector
    get() {
        if (`_envelope-duotone` != null) {
            return `_envelope-duotone`!!
        }
        `_envelope-duotone` = Builder(name = "Envelope-duotone", defaultWidth = 256.0.dp,
...
private var `_envelope-duotone`: ImageVector? = null
