...
public val BoldGroup.`Battery-high-bold`: ImageVector
    get() {
        if (`_battery-high-bold` != null) {
            return `_battery-high-bold`!!
        }
        `_battery-high-bold` = Builder(name = "Battery-high-bold", defaultWidth = 256.0.dp,
...
private var `_battery-high-bold`: ImageVector? = null
