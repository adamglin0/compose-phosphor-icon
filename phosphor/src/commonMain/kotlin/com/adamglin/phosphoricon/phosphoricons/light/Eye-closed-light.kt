...
public val LightGroup.`Eye-closed-light`: ImageVector
    get() {
        if (`_eye-closed-light` != null) {
            return `_eye-closed-light`!!
        }
        `_eye-closed-light` = Builder(name = "Eye-closed-light", defaultWidth = 256.0.dp,
...
private var `_eye-closed-light`: ImageVector? = null
