...
public val RegularGroup.`Number-square-five`: ImageVector
    get() {
        if (`_number-square-five` != null) {
            return `_number-square-five`!!
        }
        `_number-square-five` = Builder(name = "Number-square-five", defaultWidth = 256.0.dp,
...
private var `_number-square-five`: ImageVector? = null
