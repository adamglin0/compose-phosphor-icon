...
public val BoldGroup.`Broadcast-bold`: ImageVector
    get() {
        if (`_broadcast-bold` != null) {
            return `_broadcast-bold`!!
        }
        `_broadcast-bold` = Builder(name = "Broadcast-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_broadcast-bold`: ImageVector? = null
