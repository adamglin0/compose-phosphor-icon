...
public val LightGroup.`Backpack-light`: ImageVector
    get() {
        if (`_backpack-light` != null) {
            return `_backpack-light`!!
        }
        `_backpack-light` = Builder(name = "Backpack-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_backpack-light`: ImageVector? = null
