...
public val RegularGroup.`Prohibit-inset`: ImageVector
    get() {
        if (`_prohibit-inset` != null) {
            return `_prohibit-inset`!!
        }
        `_prohibit-inset` = Builder(name = "Prohibit-inset", defaultWidth = 256.0.dp, defaultHeight
...
private var `_prohibit-inset`: ImageVector? = null
