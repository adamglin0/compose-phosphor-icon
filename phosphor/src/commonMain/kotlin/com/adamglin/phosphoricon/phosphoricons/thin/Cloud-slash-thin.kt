...
public val ThinGroup.`Cloud-slash-thin`: ImageVector
    get() {
        if (`_cloud-slash-thin` != null) {
            return `_cloud-slash-thin`!!
        }
        `_cloud-slash-thin` = Builder(name = "Cloud-slash-thin", defaultWidth = 256.0.dp,
...
private var `_cloud-slash-thin`: ImageVector? = null
