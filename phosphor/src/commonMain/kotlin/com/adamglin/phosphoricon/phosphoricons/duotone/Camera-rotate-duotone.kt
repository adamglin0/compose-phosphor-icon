...
public val DuotoneGroup.`Camera-rotate-duotone`: ImageVector
    get() {
        if (`_camera-rotate-duotone` != null) {
            return `_camera-rotate-duotone`!!
        }
        `_camera-rotate-duotone` = Builder(name = "Camera-rotate-duotone", defaultWidth = 256.0.dp,
...
private var `_camera-rotate-duotone`: ImageVector? = null
