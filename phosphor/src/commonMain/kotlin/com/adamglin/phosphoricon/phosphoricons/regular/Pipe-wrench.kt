...
public val RegularGroup.`Pipe-wrench`: ImageVector
    get() {
        if (`_pipe-wrench` != null) {
            return `_pipe-wrench`!!
        }
        `_pipe-wrench` = Builder(name = "Pipe-wrench", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pipe-wrench`: ImageVector? = null
