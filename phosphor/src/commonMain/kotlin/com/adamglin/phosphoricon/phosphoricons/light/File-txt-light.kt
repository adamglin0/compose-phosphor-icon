...
public val LightGroup.`File-txt-light`: ImageVector
    get() {
        if (`_file-txt-light` != null) {
            return `_file-txt-light`!!
        }
        `_file-txt-light` = Builder(name = "File-txt-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-txt-light`: ImageVector? = null
