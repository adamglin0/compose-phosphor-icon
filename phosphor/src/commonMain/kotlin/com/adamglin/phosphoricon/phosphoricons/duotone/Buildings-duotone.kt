...
public val DuotoneGroup.`Buildings-duotone`: ImageVector
    get() {
        if (`_buildings-duotone` != null) {
            return `_buildings-duotone`!!
        }
        `_buildings-duotone` = Builder(name = "Buildings-duotone", defaultWidth = 256.0.dp,
...
private var `_buildings-duotone`: ImageVector? = null
