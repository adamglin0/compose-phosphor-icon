...
public val BoldGroup.`Markdown-logo-bold`: ImageVector
    get() {
        if (`_markdown-logo-bold` != null) {
            return `_markdown-logo-bold`!!
        }
        `_markdown-logo-bold` = Builder(name = "Markdown-logo-bold", defaultWidth = 256.0.dp,
...
private var `_markdown-logo-bold`: ImageVector? = null
