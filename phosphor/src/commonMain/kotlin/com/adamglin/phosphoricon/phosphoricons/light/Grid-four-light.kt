...
public val LightGroup.`Grid-four-light`: ImageVector
    get() {
        if (`_grid-four-light` != null) {
            return `_grid-four-light`!!
        }
        `_grid-four-light` = Builder(name = "Grid-four-light", defaultWidth = 256.0.dp,
...
private var `_grid-four-light`: ImageVector? = null
