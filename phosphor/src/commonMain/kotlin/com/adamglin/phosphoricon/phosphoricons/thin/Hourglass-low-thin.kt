...
public val ThinGroup.`Hourglass-low-thin`: ImageVector
    get() {
        if (`_hourglass-low-thin` != null) {
            return `_hourglass-low-thin`!!
        }
        `_hourglass-low-thin` = Builder(name = "Hourglass-low-thin", defaultWidth = 256.0.dp,
...
private var `_hourglass-low-thin`: ImageVector? = null
