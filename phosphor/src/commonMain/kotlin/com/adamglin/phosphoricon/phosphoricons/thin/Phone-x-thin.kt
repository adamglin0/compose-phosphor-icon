...
public val ThinGroup.`Phone-x-thin`: ImageVector
    get() {
        if (`_phone-x-thin` != null) {
            return `_phone-x-thin`!!
        }
        `_phone-x-thin` = Builder(name = "Phone-x-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-x-thin`: ImageVector? = null
