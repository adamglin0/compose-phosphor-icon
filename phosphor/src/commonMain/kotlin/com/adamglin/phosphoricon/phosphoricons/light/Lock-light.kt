...
public val LightGroup.`Lock-light`: ImageVector
    get() {
        if (`_lock-light` != null) {
            return `_lock-light`!!
        }
        `_lock-light` = Builder(name = "Lock-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-light`: ImageVector? = null
