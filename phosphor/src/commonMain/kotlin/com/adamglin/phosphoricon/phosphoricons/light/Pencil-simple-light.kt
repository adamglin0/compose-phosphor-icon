...
public val LightGroup.`Pencil-simple-light`: ImageVector
    get() {
        if (`_pencil-simple-light` != null) {
            return `_pencil-simple-light`!!
        }
        `_pencil-simple-light` = Builder(name = "Pencil-simple-light", defaultWidth = 256.0.dp,
...
private var `_pencil-simple-light`: ImageVector? = null
