...
public val LightGroup.`Cloud-moon-light`: ImageVector
    get() {
        if (`_cloud-moon-light` != null) {
            return `_cloud-moon-light`!!
        }
        `_cloud-moon-light` = Builder(name = "Cloud-moon-light", defaultWidth = 256.0.dp,
...
private var `_cloud-moon-light`: ImageVector? = null
