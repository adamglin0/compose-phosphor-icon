...
public val DuotoneGroup.`Popcorn-duotone`: ImageVector
    get() {
        if (`_popcorn-duotone` != null) {
            return `_popcorn-duotone`!!
        }
        `_popcorn-duotone` = Builder(name = "Popcorn-duotone", defaultWidth = 256.0.dp,
...
private var `_popcorn-duotone`: ImageVector? = null
