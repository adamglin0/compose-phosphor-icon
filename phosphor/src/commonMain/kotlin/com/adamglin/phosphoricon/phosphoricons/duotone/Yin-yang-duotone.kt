...
public val DuotoneGroup.`Yin-yang-duotone`: ImageVector
    get() {
        if (`_yin-yang-duotone` != null) {
            return `_yin-yang-duotone`!!
        }
        `_yin-yang-duotone` = Builder(name = "Yin-yang-duotone", defaultWidth = 256.0.dp,
...
private var `_yin-yang-duotone`: ImageVector? = null
