...
public val DuotoneGroup.`Person-simple-circle-duotone`: ImageVector
    get() {
        if (`_person-simple-circle-duotone` != null) {
            return `_person-simple-circle-duotone`!!
        }
        `_person-simple-circle-duotone` = Builder(name = "Person-simple-circle-duotone",
...
private var `_person-simple-circle-duotone`: ImageVector? = null
