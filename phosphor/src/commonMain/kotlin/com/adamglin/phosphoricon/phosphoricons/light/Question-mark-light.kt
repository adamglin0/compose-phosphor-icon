...
public val LightGroup.`Question-mark-light`: ImageVector
    get() {
        if (`_question-mark-light` != null) {
            return `_question-mark-light`!!
        }
        `_question-mark-light` = Builder(name = "Question-mark-light", defaultWidth = 256.0.dp,
...
private var `_question-mark-light`: ImageVector? = null
