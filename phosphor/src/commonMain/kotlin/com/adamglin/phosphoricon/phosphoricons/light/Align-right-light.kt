...
public val LightGroup.`Align-right-light`: ImageVector
    get() {
        if (`_align-right-light` != null) {
            return `_align-right-light`!!
        }
        `_align-right-light` = Builder(name = "Align-right-light", defaultWidth = 256.0.dp,
...
private var `_align-right-light`: ImageVector? = null
