...
public val ThinGroup.`Train-simple-thin`: ImageVector
    get() {
        if (`_train-simple-thin` != null) {
            return `_train-simple-thin`!!
        }
        `_train-simple-thin` = Builder(name = "Train-simple-thin", defaultWidth = 256.0.dp,
...
private var `_train-simple-thin`: ImageVector? = null
