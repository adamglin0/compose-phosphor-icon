...
public val LightGroup.`Scan-smiley-light`: ImageVector
    get() {
        if (`_scan-smiley-light` != null) {
            return `_scan-smiley-light`!!
        }
        `_scan-smiley-light` = Builder(name = "Scan-smiley-light", defaultWidth = 256.0.dp,
...
private var `_scan-smiley-light`: ImageVector? = null
