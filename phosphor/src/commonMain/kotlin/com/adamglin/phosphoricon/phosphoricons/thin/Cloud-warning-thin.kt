...
public val ThinGroup.`Cloud-warning-thin`: ImageVector
    get() {
        if (`_cloud-warning-thin` != null) {
            return `_cloud-warning-thin`!!
        }
        `_cloud-warning-thin` = Builder(name = "Cloud-warning-thin", defaultWidth = 256.0.dp,
...
private var `_cloud-warning-thin`: ImageVector? = null
