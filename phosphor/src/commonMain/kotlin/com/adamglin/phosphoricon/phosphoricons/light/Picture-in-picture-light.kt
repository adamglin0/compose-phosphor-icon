...
public val LightGroup.`Picture-in-picture-light`: ImageVector
    get() {
        if (`_picture-in-picture-light` != null) {
            return `_picture-in-picture-light`!!
        }
        `_picture-in-picture-light` = Builder(name = "Picture-in-picture-light", defaultWidth =
...
private var `_picture-in-picture-light`: ImageVector? = null
