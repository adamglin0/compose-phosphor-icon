...
public val LightGroup.`Rabbit-light`: ImageVector
    get() {
        if (`_rabbit-light` != null) {
            return `_rabbit-light`!!
        }
        `_rabbit-light` = Builder(name = "Rabbit-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rabbit-light`: ImageVector? = null
