...
public val DuotoneGroup.`Map-pin-simple-area-duotone`: ImageVector
    get() {
        if (`_map-pin-simple-area-duotone` != null) {
            return `_map-pin-simple-area-duotone`!!
        }
        `_map-pin-simple-area-duotone` = Builder(name = "Map-pin-simple-area-duotone", defaultWidth
...
private var `_map-pin-simple-area-duotone`: ImageVector? = null
