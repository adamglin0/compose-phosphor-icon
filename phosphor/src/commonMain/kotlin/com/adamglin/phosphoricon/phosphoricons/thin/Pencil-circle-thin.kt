...
public val ThinGroup.`Pencil-circle-thin`: ImageVector
    get() {
        if (`_pencil-circle-thin` != null) {
            return `_pencil-circle-thin`!!
        }
        `_pencil-circle-thin` = Builder(name = "Pencil-circle-thin", defaultWidth = 256.0.dp,
...
private var `_pencil-circle-thin`: ImageVector? = null
