...
public val BoldGroup.`Camera-slash-bold`: ImageVector
    get() {
        if (`_camera-slash-bold` != null) {
            return `_camera-slash-bold`!!
        }
        `_camera-slash-bold` = Builder(name = "Camera-slash-bold", defaultWidth = 256.0.dp,
...
private var `_camera-slash-bold`: ImageVector? = null
