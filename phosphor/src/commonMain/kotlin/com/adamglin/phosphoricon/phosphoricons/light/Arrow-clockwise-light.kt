...
public val LightGroup.`Arrow-clockwise-light`: ImageVector
    get() {
        if (`_arrow-clockwise-light` != null) {
            return `_arrow-clockwise-light`!!
        }
        `_arrow-clockwise-light` = Builder(name = "Arrow-clockwise-light", defaultWidth = 256.0.dp,
...
private var `_arrow-clockwise-light`: ImageVector? = null
