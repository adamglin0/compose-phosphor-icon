...
public val DuotoneGroup.`Asterisk-duotone`: ImageVector
    get() {
        if (`_asterisk-duotone` != null) {
            return `_asterisk-duotone`!!
        }
        `_asterisk-duotone` = Builder(name = "Asterisk-duotone", defaultWidth = 256.0.dp,
...
private var `_asterisk-duotone`: ImageVector? = null
