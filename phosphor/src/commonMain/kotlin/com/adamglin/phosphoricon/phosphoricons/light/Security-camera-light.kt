...
public val LightGroup.`Security-camera-light`: ImageVector
    get() {
        if (`_security-camera-light` != null) {
            return `_security-camera-light`!!
        }
        `_security-camera-light` = Builder(name = "Security-camera-light", defaultWidth = 256.0.dp,
...
private var `_security-camera-light`: ImageVector? = null
