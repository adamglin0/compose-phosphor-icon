...
public val DuotoneGroup.`Key-return-duotone`: ImageVector
    get() {
        if (`_key-return-duotone` != null) {
            return `_key-return-duotone`!!
        }
        `_key-return-duotone` = Builder(name = "Key-return-duotone", defaultWidth = 256.0.dp,
...
private var `_key-return-duotone`: ImageVector? = null
