...
public val ThinGroup.`Bookmark-simple-thin`: ImageVector
    get() {
        if (`_bookmark-simple-thin` != null) {
            return `_bookmark-simple-thin`!!
        }
        `_bookmark-simple-thin` = Builder(name = "Bookmark-simple-thin", defaultWidth = 256.0.dp,
...
private var `_bookmark-simple-thin`: ImageVector? = null
