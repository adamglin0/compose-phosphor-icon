...
public val DuotoneGroup.`Bell-simple-slash-duotone`: ImageVector
    get() {
        if (`_bell-simple-slash-duotone` != null) {
            return `_bell-simple-slash-duotone`!!
        }
        `_bell-simple-slash-duotone` = Builder(name = "Bell-simple-slash-duotone", defaultWidth =
...
private var `_bell-simple-slash-duotone`: ImageVector? = null
