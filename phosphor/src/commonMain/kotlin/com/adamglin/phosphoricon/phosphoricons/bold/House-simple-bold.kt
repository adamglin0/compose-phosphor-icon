...
public val BoldGroup.`House-simple-bold`: ImageVector
    get() {
        if (`_house-simple-bold` != null) {
            return `_house-simple-bold`!!
        }
        `_house-simple-bold` = Builder(name = "House-simple-bold", defaultWidth = 256.0.dp,
...
private var `_house-simple-bold`: ImageVector? = null
