...
public val DuotoneGroup.`Contactless-payment-duotone`: ImageVector
    get() {
        if (`_contactless-payment-duotone` != null) {
            return `_contactless-payment-duotone`!!
        }
        `_contactless-payment-duotone` = Builder(name = "Contactless-payment-duotone", defaultWidth
...
private var `_contactless-payment-duotone`: ImageVector? = null
