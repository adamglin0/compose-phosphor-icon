...
public val ThinGroup.`Barcode-thin`: ImageVector
    get() {
        if (`_barcode-thin` != null) {
            return `_barcode-thin`!!
        }
        `_barcode-thin` = Builder(name = "Barcode-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barcode-thin`: ImageVector? = null
