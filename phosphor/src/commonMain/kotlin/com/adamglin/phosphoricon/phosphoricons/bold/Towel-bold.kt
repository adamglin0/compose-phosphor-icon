...
public val BoldGroup.`Towel-bold`: ImageVector
    get() {
        if (`_towel-bold` != null) {
            return `_towel-bold`!!
        }
        `_towel-bold` = Builder(name = "Towel-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_towel-bold`: ImageVector? = null
