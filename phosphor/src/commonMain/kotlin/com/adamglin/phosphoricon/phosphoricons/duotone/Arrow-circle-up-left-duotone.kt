...
public val DuotoneGroup.`Arrow-circle-up-left-duotone`: ImageVector
    get() {
        if (`_arrow-circle-up-left-duotone` != null) {
            return `_arrow-circle-up-left-duotone`!!
        }
        `_arrow-circle-up-left-duotone` = Builder(name = "Arrow-circle-up-left-duotone",
...
private var `_arrow-circle-up-left-duotone`: ImageVector? = null
