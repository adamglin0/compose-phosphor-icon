...
public val ThinGroup.`Medal-thin`: ImageVector
    get() {
        if (`_medal-thin` != null) {
            return `_medal-thin`!!
        }
        `_medal-thin` = Builder(name = "Medal-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_medal-thin`: ImageVector? = null
