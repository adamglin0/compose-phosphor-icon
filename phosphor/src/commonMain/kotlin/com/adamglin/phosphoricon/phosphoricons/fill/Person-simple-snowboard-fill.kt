...
public val FillGroup.`Person-simple-snowboard-fill`: ImageVector
    get() {
        if (`_person-simple-snowboard-fill` != null) {
            return `_person-simple-snowboard-fill`!!
        }
        `_person-simple-snowboard-fill` = Builder(name = "Person-simple-snowboard-fill",
...
private var `_person-simple-snowboard-fill`: ImageVector? = null
