...
public val BoldGroup.`Faders-bold`: ImageVector
    get() {
        if (`_faders-bold` != null) {
            return `_faders-bold`!!
        }
        `_faders-bold` = Builder(name = "Faders-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_faders-bold`: ImageVector? = null
