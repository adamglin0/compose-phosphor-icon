...
public val RegularGroup.`Cable-car`: ImageVector
    get() {
        if (`_cable-car` != null) {
            return `_cable-car`!!
        }
        `_cable-car` = Builder(name = "Cable-car", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cable-car`: ImageVector? = null
