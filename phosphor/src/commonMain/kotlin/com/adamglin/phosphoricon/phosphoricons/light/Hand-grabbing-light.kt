...
public val LightGroup.`Hand-grabbing-light`: ImageVector
    get() {
        if (`_hand-grabbing-light` != null) {
            return `_hand-grabbing-light`!!
        }
        `_hand-grabbing-light` = Builder(name = "Hand-grabbing-light", defaultWidth = 256.0.dp,
...
private var `_hand-grabbing-light`: ImageVector? = null
