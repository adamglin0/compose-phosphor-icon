...
public val RegularGroup.`Pencil-circle`: ImageVector
    get() {
        if (`_pencil-circle` != null) {
            return `_pencil-circle`!!
        }
        `_pencil-circle` = Builder(name = "Pencil-circle", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pencil-circle`: ImageVector? = null
