...
public val LightGroup.`Rewind-circle-light`: ImageVector
    get() {
        if (`_rewind-circle-light` != null) {
            return `_rewind-circle-light`!!
        }
        `_rewind-circle-light` = Builder(name = "Rewind-circle-light", defaultWidth = 256.0.dp,
...
private var `_rewind-circle-light`: ImageVector? = null
