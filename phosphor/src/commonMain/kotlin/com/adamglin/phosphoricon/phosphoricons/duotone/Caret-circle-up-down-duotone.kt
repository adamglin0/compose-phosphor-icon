...
public val DuotoneGroup.`Caret-circle-up-down-duotone`: ImageVector
    get() {
        if (`_caret-circle-up-down-duotone` != null) {
            return `_caret-circle-up-down-duotone`!!
        }
        `_caret-circle-up-down-duotone` = Builder(name = "Caret-circle-up-down-duotone",
...
private var `_caret-circle-up-down-duotone`: ImageVector? = null
