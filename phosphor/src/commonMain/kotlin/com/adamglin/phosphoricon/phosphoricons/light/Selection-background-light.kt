...
public val LightGroup.`Selection-background-light`: ImageVector
    get() {
        if (`_selection-background-light` != null) {
            return `_selection-background-light`!!
        }
        `_selection-background-light` = Builder(name = "Selection-background-light", defaultWidth =
...
private var `_selection-background-light`: ImageVector? = null
