...
public val DuotoneGroup.`Graph-duotone`: ImageVector
    get() {
        if (`_graph-duotone` != null) {
            return `_graph-duotone`!!
        }
        `_graph-duotone` = Builder(name = "Graph-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_graph-duotone`: ImageVector? = null
