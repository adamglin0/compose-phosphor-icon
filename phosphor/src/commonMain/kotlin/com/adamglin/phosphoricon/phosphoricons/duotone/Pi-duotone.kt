...
public val DuotoneGroup.`Pi-duotone`: ImageVector
    get() {
        if (`_pi-duotone` != null) {
            return `_pi-duotone`!!
        }
        `_pi-duotone` = Builder(name = "Pi-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pi-duotone`: ImageVector? = null
