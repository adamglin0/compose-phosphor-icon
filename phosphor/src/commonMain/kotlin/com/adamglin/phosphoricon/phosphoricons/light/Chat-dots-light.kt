...
public val LightGroup.`Chat-dots-light`: ImageVector
    get() {
        if (`_chat-dots-light` != null) {
            return `_chat-dots-light`!!
        }
        `_chat-dots-light` = Builder(name = "Chat-dots-light", defaultWidth = 256.0.dp,
...
private var `_chat-dots-light`: ImageVector? = null
