...
public val BoldGroup.`Flag-bold`: ImageVector
    get() {
        if (`_flag-bold` != null) {
            return `_flag-bold`!!
        }
        `_flag-bold` = Builder(name = "Flag-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flag-bold`: ImageVector? = null
