...
public val LightGroup.`Farm-light`: ImageVector
    get() {
        if (`_farm-light` != null) {
            return `_farm-light`!!
        }
        `_farm-light` = Builder(name = "Farm-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_farm-light`: ImageVector? = null
