...
public val ThinGroup.`File-txt-thin`: ImageVector
    get() {
        if (`_file-txt-thin` != null) {
            return `_file-txt-thin`!!
        }
        `_file-txt-thin` = Builder(name = "File-txt-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-txt-thin`: ImageVector? = null
