...
public val BoldGroup.`Bank-bold`: ImageVector
    get() {
        if (`_bank-bold` != null) {
            return `_bank-bold`!!
        }
        `_bank-bold` = Builder(name = "Bank-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bank-bold`: ImageVector? = null
