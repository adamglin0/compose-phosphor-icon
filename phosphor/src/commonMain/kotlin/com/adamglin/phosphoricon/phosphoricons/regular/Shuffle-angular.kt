...
public val RegularGroup.`Shuffle-angular`: ImageVector
    get() {
        if (`_shuffle-angular` != null) {
            return `_shuffle-angular`!!
        }
        `_shuffle-angular` = Builder(name = "Shuffle-angular", defaultWidth = 256.0.dp,
...
private var `_shuffle-angular`: ImageVector? = null
