...
public val FillGroup.`Mailbox-fill`: ImageVector
    get() {
        if (`_mailbox-fill` != null) {
            return `_mailbox-fill`!!
        }
        `_mailbox-fill` = Builder(name = "Mailbox-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mailbox-fill`: ImageVector? = null
