...
public val ThinGroup.`Text-outdent-thin`: ImageVector
    get() {
        if (`_text-outdent-thin` != null) {
            return `_text-outdent-thin`!!
        }
        `_text-outdent-thin` = Builder(name = "Text-outdent-thin", defaultWidth = 256.0.dp,
...
private var `_text-outdent-thin`: ImageVector? = null
