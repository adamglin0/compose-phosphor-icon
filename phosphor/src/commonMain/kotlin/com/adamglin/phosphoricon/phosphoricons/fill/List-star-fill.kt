...
public val FillGroup.`List-star-fill`: ImageVector
    get() {
        if (`_list-star-fill` != null) {
            return `_list-star-fill`!!
        }
        `_list-star-fill` = Builder(name = "List-star-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_list-star-fill`: ImageVector? = null
