...
public val DuotoneGroup.`Camera-slash-duotone`: ImageVector
    get() {
        if (`_camera-slash-duotone` != null) {
            return `_camera-slash-duotone`!!
        }
        `_camera-slash-duotone` = Builder(name = "Camera-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_camera-slash-duotone`: ImageVector? = null
