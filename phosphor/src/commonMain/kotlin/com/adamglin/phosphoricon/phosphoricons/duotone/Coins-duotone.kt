...
public val DuotoneGroup.`Coins-duotone`: ImageVector
    get() {
        if (`_coins-duotone` != null) {
            return `_coins-duotone`!!
        }
        `_coins-duotone` = Builder(name = "Coins-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coins-duotone`: ImageVector? = null
