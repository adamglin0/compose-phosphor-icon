...
public val LightGroup.`Cloud-rain-light`: ImageVector
    get() {
        if (`_cloud-rain-light` != null) {
            return `_cloud-rain-light`!!
        }
        `_cloud-rain-light` = Builder(name = "Cloud-rain-light", defaultWidth = 256.0.dp,
...
private var `_cloud-rain-light`: ImageVector? = null
