...
public val BoldGroup.`Dribbble-logo-bold`: ImageVector
    get() {
        if (`_dribbble-logo-bold` != null) {
            return `_dribbble-logo-bold`!!
        }
        `_dribbble-logo-bold` = Builder(name = "Dribbble-logo-bold", defaultWidth = 256.0.dp,
...
private var `_dribbble-logo-bold`: ImageVector? = null
