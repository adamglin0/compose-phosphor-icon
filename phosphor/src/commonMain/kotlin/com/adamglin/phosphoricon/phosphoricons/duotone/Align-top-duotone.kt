...
public val DuotoneGroup.`Align-top-duotone`: ImageVector
    get() {
        if (`_align-top-duotone` != null) {
            return `_align-top-duotone`!!
        }
        `_align-top-duotone` = Builder(name = "Align-top-duotone", defaultWidth = 256.0.dp,
...
private var `_align-top-duotone`: ImageVector? = null
