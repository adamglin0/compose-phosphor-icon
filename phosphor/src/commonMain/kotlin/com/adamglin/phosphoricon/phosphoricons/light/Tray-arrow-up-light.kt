...
public val LightGroup.`Tray-arrow-up-light`: ImageVector
    get() {
        if (`_tray-arrow-up-light` != null) {
            return `_tray-arrow-up-light`!!
        }
        `_tray-arrow-up-light` = Builder(name = "Tray-arrow-up-light", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-up-light`: ImageVector? = null
