...
public val DuotoneGroup.`Music-notes-minus-duotone`: ImageVector
    get() {
        if (`_music-notes-minus-duotone` != null) {
            return `_music-notes-minus-duotone`!!
        }
        `_music-notes-minus-duotone` = Builder(name = "Music-notes-minus-duotone", defaultWidth =
...
private var `_music-notes-minus-duotone`: ImageVector? = null
