...
public val DuotoneGroup.`Book-bookmark-duotone`: ImageVector
    get() {
        if (`_book-bookmark-duotone` != null) {
            return `_book-bookmark-duotone`!!
        }
        `_book-bookmark-duotone` = Builder(name = "Book-bookmark-duotone", defaultWidth = 256.0.dp,
...
private var `_book-bookmark-duotone`: ImageVector? = null
