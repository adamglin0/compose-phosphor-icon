...
public val BoldGroup.`Lock-key-open-bold`: ImageVector
    get() {
        if (`_lock-key-open-bold` != null) {
            return `_lock-key-open-bold`!!
        }
        `_lock-key-open-bold` = Builder(name = "Lock-key-open-bold", defaultWidth = 256.0.dp,
...
private var `_lock-key-open-bold`: ImageVector? = null
