...
public val RegularGroup.`Calendar-heart`: ImageVector
    get() {
        if (`_calendar-heart` != null) {
            return `_calendar-heart`!!
        }
        `_calendar-heart` = Builder(name = "Calendar-heart", defaultWidth = 256.0.dp, defaultHeight
...
private var `_calendar-heart`: ImageVector? = null
