...
public val BoldGroup.`Keyhole-bold`: ImageVector
    get() {
        if (`_keyhole-bold` != null) {
            return `_keyhole-bold`!!
        }
        `_keyhole-bold` = Builder(name = "Keyhole-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_keyhole-bold`: ImageVector? = null
