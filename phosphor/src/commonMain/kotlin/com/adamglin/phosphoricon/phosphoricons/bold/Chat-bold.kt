...
public val BoldGroup.`Chat-bold`: ImageVector
    get() {
        if (`_chat-bold` != null) {
            return `_chat-bold`!!
        }
        `_chat-bold` = Builder(name = "Chat-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chat-bold`: ImageVector? = null
