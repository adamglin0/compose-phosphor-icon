...
public val RegularGroup.`Number-circle-five`: ImageVector
    get() {
        if (`_number-circle-five` != null) {
            return `_number-circle-five`!!
        }
        `_number-circle-five` = Builder(name = "Number-circle-five", defaultWidth = 256.0.dp,
...
private var `_number-circle-five`: ImageVector? = null
