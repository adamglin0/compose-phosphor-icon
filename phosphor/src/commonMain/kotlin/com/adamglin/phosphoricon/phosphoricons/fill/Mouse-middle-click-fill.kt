...
public val FillGroup.`Mouse-middle-click-fill`: ImageVector
    get() {
        if (`_mouse-middle-click-fill` != null) {
            return `_mouse-middle-click-fill`!!
        }
        `_mouse-middle-click-fill` = Builder(name = "Mouse-middle-click-fill", defaultWidth =
...
private var `_mouse-middle-click-fill`: ImageVector? = null
