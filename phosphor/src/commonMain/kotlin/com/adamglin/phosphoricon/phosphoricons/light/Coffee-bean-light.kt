...
public val LightGroup.`Coffee-bean-light`: ImageVector
    get() {
        if (`_coffee-bean-light` != null) {
            return `_coffee-bean-light`!!
        }
        `_coffee-bean-light` = Builder(name = "Coffee-bean-light", defaultWidth = 256.0.dp,
...
private var `_coffee-bean-light`: ImageVector? = null
