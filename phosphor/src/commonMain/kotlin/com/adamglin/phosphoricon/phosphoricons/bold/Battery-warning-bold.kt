...
public val BoldGroup.`Battery-warning-bold`: ImageVector
    get() {
        if (`_battery-warning-bold` != null) {
            return `_battery-warning-bold`!!
        }
        `_battery-warning-bold` = Builder(name = "Battery-warning-bold", defaultWidth = 256.0.dp,
...
private var `_battery-warning-bold`: ImageVector? = null
