...
public val LightGroup.`Folder-star-light`: ImageVector
    get() {
        if (`_folder-star-light` != null) {
            return `_folder-star-light`!!
        }
        `_folder-star-light` = Builder(name = "Folder-star-light", defaultWidth = 256.0.dp,
...
private var `_folder-star-light`: ImageVector? = null
