...
public val BoldGroup.`Security-camera-bold`: ImageVector
    get() {
        if (`_security-camera-bold` != null) {
            return `_security-camera-bold`!!
        }
        `_security-camera-bold` = Builder(name = "Security-camera-bold", defaultWidth = 256.0.dp,
...
private var `_security-camera-bold`: ImageVector? = null
