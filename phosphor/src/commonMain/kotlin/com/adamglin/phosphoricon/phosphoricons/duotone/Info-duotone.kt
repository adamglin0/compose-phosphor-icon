...
public val DuotoneGroup.`Info-duotone`: ImageVector
    get() {
        if (`_info-duotone` != null) {
            return `_info-duotone`!!
        }
        `_info-duotone` = Builder(name = "Info-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_info-duotone`: ImageVector? = null
