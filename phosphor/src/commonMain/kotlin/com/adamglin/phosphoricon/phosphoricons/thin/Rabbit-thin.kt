...
public val ThinGroup.`Rabbit-thin`: ImageVector
    get() {
        if (`_rabbit-thin` != null) {
            return `_rabbit-thin`!!
        }
        `_rabbit-thin` = Builder(name = "Rabbit-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rabbit-thin`: ImageVector? = null
