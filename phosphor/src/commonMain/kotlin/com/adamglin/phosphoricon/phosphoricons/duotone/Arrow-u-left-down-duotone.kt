...
public val DuotoneGroup.`Arrow-u-left-down-duotone`: ImageVector
    get() {
        if (`_arrow-u-left-down-duotone` != null) {
            return `_arrow-u-left-down-duotone`!!
        }
        `_arrow-u-left-down-duotone` = Builder(name = "Arrow-u-left-down-duotone", defaultWidth =
...
private var `_arrow-u-left-down-duotone`: ImageVector? = null
