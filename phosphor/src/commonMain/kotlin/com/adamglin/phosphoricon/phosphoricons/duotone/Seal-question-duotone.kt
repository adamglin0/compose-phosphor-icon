...
public val DuotoneGroup.`Seal-question-duotone`: ImageVector
    get() {
        if (`_seal-question-duotone` != null) {
            return `_seal-question-duotone`!!
        }
        `_seal-question-duotone` = Builder(name = "Seal-question-duotone", defaultWidth = 256.0.dp,
...
private var `_seal-question-duotone`: ImageVector? = null
