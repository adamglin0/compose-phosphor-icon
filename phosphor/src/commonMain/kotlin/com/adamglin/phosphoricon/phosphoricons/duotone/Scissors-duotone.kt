...
public val DuotoneGroup.`Scissors-duotone`: ImageVector
    get() {
        if (`_scissors-duotone` != null) {
            return `_scissors-duotone`!!
        }
        `_scissors-duotone` = Builder(name = "Scissors-duotone", defaultWidth = 256.0.dp,
...
private var `_scissors-duotone`: ImageVector? = null
