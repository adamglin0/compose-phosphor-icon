...
public val FillGroup.`Airplane-landing-fill`: ImageVector
    get() {
        if (`_airplane-landing-fill` != null) {
            return `_airplane-landing-fill`!!
        }
        `_airplane-landing-fill` = Builder(name = "Airplane-landing-fill", defaultWidth = 256.0.dp,
...
private var `_airplane-landing-fill`: ImageVector? = null
