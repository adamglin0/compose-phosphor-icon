...
public val ThinGroup.`Dice-six-thin`: ImageVector
    get() {
        if (`_dice-six-thin` != null) {
            return `_dice-six-thin`!!
        }
        `_dice-six-thin` = Builder(name = "Dice-six-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dice-six-thin`: ImageVector? = null
