...
public val BoldGroup.`Google-cardboard-logo-bold`: ImageVector
    get() {
        if (`_google-cardboard-logo-bold` != null) {
            return `_google-cardboard-logo-bold`!!
        }
        `_google-cardboard-logo-bold` = Builder(name = "Google-cardboard-logo-bold", defaultWidth =
...
private var `_google-cardboard-logo-bold`: ImageVector? = null
