...
public val DuotoneGroup.`Export-duotone`: ImageVector
    get() {
        if (`_export-duotone` != null) {
            return `_export-duotone`!!
        }
        `_export-duotone` = Builder(name = "Export-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_export-duotone`: ImageVector? = null
