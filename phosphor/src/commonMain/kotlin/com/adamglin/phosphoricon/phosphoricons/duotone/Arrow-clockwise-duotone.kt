...
public val DuotoneGroup.`Arrow-clockwise-duotone`: ImageVector
    get() {
        if (`_arrow-clockwise-duotone` != null) {
            return `_arrow-clockwise-duotone`!!
        }
        `_arrow-clockwise-duotone` = Builder(name = "Arrow-clockwise-duotone", defaultWidth =
...
private var `_arrow-clockwise-duotone`: ImageVector? = null
