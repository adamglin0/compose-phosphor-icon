...
public val DuotoneGroup.`Lock-open-duotone`: ImageVector
    get() {
        if (`_lock-open-duotone` != null) {
            return `_lock-open-duotone`!!
        }
        `_lock-open-duotone` = Builder(name = "Lock-open-duotone", defaultWidth = 256.0.dp,
...
private var `_lock-open-duotone`: ImageVector? = null
