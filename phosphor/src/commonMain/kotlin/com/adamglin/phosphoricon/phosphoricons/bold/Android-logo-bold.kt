...
public val BoldGroup.`Android-logo-bold`: ImageVector
    get() {
        if (`_android-logo-bold` != null) {
            return `_android-logo-bold`!!
        }
        `_android-logo-bold` = Builder(name = "Android-logo-bold", defaultWidth = 256.0.dp,
...
private var `_android-logo-bold`: ImageVector? = null
