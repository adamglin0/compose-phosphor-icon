...
public val DuotoneGroup.`Baby-duotone`: ImageVector
    get() {
        if (`_baby-duotone` != null) {
            return `_baby-duotone`!!
        }
        `_baby-duotone` = Builder(name = "Baby-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_baby-duotone`: ImageVector? = null
