...
public val LightGroup.`Image-light`: ImageVector
    get() {
        if (`_image-light` != null) {
            return `_image-light`!!
        }
        `_image-light` = Builder(name = "Image-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_image-light`: ImageVector? = null
