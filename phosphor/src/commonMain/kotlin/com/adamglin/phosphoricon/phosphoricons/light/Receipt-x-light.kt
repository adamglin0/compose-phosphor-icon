...
public val LightGroup.`Receipt-x-light`: ImageVector
    get() {
        if (`_receipt-x-light` != null) {
            return `_receipt-x-light`!!
        }
        `_receipt-x-light` = Builder(name = "Receipt-x-light", defaultWidth = 256.0.dp,
...
private var `_receipt-x-light`: ImageVector? = null
