...
public val FillGroup.`Magic-wand-fill`: ImageVector
    get() {
        if (`_magic-wand-fill` != null) {
            return `_magic-wand-fill`!!
        }
        `_magic-wand-fill` = Builder(name = "Magic-wand-fill", defaultWidth = 256.0.dp,
...
private var `_magic-wand-fill`: ImageVector? = null
