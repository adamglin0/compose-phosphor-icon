...
public val RegularGroup.`Less-than-or-equal`: ImageVector
    get() {
        if (`_less-than-or-equal` != null) {
            return `_less-than-or-equal`!!
        }
        `_less-than-or-equal` = Builder(name = "Less-than-or-equal", defaultWidth = 256.0.dp,
...
private var `_less-than-or-equal`: ImageVector? = null
