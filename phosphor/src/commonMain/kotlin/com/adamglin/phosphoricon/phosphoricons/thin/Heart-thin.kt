...
public val ThinGroup.`Heart-thin`: ImageVector
    get() {
        if (`_heart-thin` != null) {
            return `_heart-thin`!!
        }
        `_heart-thin` = Builder(name = "Heart-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_heart-thin`: ImageVector? = null
