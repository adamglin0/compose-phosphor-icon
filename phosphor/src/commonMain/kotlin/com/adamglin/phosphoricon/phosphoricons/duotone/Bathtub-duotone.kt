...
public val DuotoneGroup.`Bathtub-duotone`: ImageVector
    get() {
        if (`_bathtub-duotone` != null) {
            return `_bathtub-duotone`!!
        }
        `_bathtub-duotone` = Builder(name = "Bathtub-duotone", defaultWidth = 256.0.dp,
...
private var `_bathtub-duotone`: ImageVector? = null
