...
public val DuotoneGroup.`User-sound-duotone`: ImageVector
    get() {
        if (`_user-sound-duotone` != null) {
            return `_user-sound-duotone`!!
        }
        `_user-sound-duotone` = Builder(name = "User-sound-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(60.0f, 60.0f, 0.0f, false, true, 168.0f, 108.0f)
                close()
            }
...
private var `_user-sound-duotone`: ImageVector? = null
