...
public val BoldGroup.`Circle-half-bold`: ImageVector
    get() {
        if (`_circle-half-bold` != null) {
            return `_circle-half-bold`!!
        }
        `_circle-half-bold` = Builder(name = "Circle-half-bold", defaultWidth = 256.0.dp,
...
private var `_circle-half-bold`: ImageVector? = null
