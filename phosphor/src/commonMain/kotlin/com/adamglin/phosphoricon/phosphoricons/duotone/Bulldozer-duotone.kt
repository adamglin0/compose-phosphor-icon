...
public val DuotoneGroup.`Bulldozer-duotone`: ImageVector
    get() {
        if (`_bulldozer-duotone` != null) {
            return `_bulldozer-duotone`!!
        }
        `_bulldozer-duotone` = Builder(name = "Bulldozer-duotone", defaultWidth = 256.0.dp,
...
private var `_bulldozer-duotone`: ImageVector? = null
