...
public val DuotoneGroup.`Microsoft-powerpoint-logo-duotone`: ImageVector
    get() {
        if (`_microsoft-powerpoint-logo-duotone` != null) {
            return `_microsoft-powerpoint-logo-duotone`!!
        }
        `_microsoft-powerpoint-logo-duotone` = Builder(name = "Microsoft-powerpoint-logo-duotone",
...
private var `_microsoft-powerpoint-logo-duotone`: ImageVector? = null
