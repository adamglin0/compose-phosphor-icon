...
public val BoldGroup.`Amazon-logo-bold`: ImageVector
    get() {
        if (`_amazon-logo-bold` != null) {
            return `_amazon-logo-bold`!!
        }
        `_amazon-logo-bold` = Builder(name = "Amazon-logo-bold", defaultWidth = 256.0.dp,
...
private var `_amazon-logo-bold`: ImageVector? = null
