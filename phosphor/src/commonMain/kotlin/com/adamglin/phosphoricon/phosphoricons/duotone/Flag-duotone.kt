...
public val DuotoneGroup.`Flag-duotone`: ImageVector
    get() {
        if (`_flag-duotone` != null) {
            return `_flag-duotone`!!
        }
        `_flag-duotone` = Builder(name = "Flag-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flag-duotone`: ImageVector? = null
