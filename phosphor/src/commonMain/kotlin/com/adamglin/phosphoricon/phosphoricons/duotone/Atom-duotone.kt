...
public val DuotoneGroup.`Atom-duotone`: ImageVector
    get() {
        if (`_atom-duotone` != null) {
            return `_atom-duotone`!!
        }
        `_atom-duotone` = Builder(name = "Atom-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_atom-duotone`: ImageVector? = null
