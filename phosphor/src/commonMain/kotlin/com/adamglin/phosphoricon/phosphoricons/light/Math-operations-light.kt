...
public val LightGroup.`Math-operations-light`: ImageVector
    get() {
        if (`_math-operations-light` != null) {
            return `_math-operations-light`!!
        }
        `_math-operations-light` = Builder(name = "Math-operations-light", defaultWidth = 256.0.dp,
...
private var `_math-operations-light`: ImageVector? = null
