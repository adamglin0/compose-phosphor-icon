...
public val LightGroup.`Skip-back-light`: ImageVector
    get() {
        if (`_skip-back-light` != null) {
            return `_skip-back-light`!!
        }
        `_skip-back-light` = Builder(name = "Skip-back-light", defaultWidth = 256.0.dp,
...
private var `_skip-back-light`: ImageVector? = null
