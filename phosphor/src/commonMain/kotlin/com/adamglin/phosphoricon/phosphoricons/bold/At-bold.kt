...
public val BoldGroup.`At-bold`: ImageVector
    get() {
        if (`_at-bold` != null) {
            return `_at-bold`!!
        }
        `_at-bold` = Builder(name = "At-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_at-bold`: ImageVector? = null
