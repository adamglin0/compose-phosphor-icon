...
public val LightGroup.`Sketch-logo-light`: ImageVector
    get() {
        if (`_sketch-logo-light` != null) {
            return `_sketch-logo-light`!!
        }
        `_sketch-logo-light` = Builder(name = "Sketch-logo-light", defaultWidth = 256.0.dp,
...
private var `_sketch-logo-light`: ImageVector? = null
