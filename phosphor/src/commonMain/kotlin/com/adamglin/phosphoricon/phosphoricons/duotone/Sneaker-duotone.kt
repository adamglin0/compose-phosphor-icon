...
public val DuotoneGroup.`Sneaker-duotone`: ImageVector
    get() {
        if (`_sneaker-duotone` != null) {
            return `_sneaker-duotone`!!
        }
        `_sneaker-duotone` = Builder(name = "Sneaker-duotone", defaultWidth = 256.0.dp,
...
private var `_sneaker-duotone`: ImageVector? = null
