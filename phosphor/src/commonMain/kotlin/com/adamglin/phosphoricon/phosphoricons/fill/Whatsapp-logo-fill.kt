...
public val FillGroup.`Whatsapp-logo-fill`: ImageVector
    get() {
        if (`_whatsapp-logo-fill` != null) {
            return `_whatsapp-logo-fill`!!
        }
        `_whatsapp-logo-fill` = Builder(name = "Whatsapp-logo-fill", defaultWidth = 256.0.dp,
...
private var `_whatsapp-logo-fill`: ImageVector? = null
