...
public val BoldGroup.`Mouse-left-click-bold`: ImageVector
    get() {
        if (`_mouse-left-click-bold` != null) {
            return `_mouse-left-click-bold`!!
        }
        `_mouse-left-click-bold` = Builder(name = "Mouse-left-click-bold", defaultWidth = 256.0.dp,
...
private var `_mouse-left-click-bold`: ImageVector? = null
