...
public val DuotoneGroup.`Ear-duotone`: ImageVector
    get() {
        if (`_ear-duotone` != null) {
            return `_ear-duotone`!!
        }
        `_ear-duotone` = Builder(name = "Ear-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ear-duotone`: ImageVector? = null
