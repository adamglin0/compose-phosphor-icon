...
public val BoldGroup.`Trolley-suitcase-bold`: ImageVector
    get() {
        if (`_trolley-suitcase-bold` != null) {
            return `_trolley-suitcase-bold`!!
        }
        `_trolley-suitcase-bold` = Builder(name = "Trolley-suitcase-bold", defaultWidth = 256.0.dp,
...
private var `_trolley-suitcase-bold`: ImageVector? = null
