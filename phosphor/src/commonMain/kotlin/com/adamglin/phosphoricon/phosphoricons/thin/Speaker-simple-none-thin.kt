...
public val ThinGroup.`Speaker-simple-none-thin`: ImageVector
    get() {
        if (`_speaker-simple-none-thin` != null) {
            return `_speaker-simple-none-thin`!!
        }
        `_speaker-simple-none-thin` = Builder(name = "Speaker-simple-none-thin", defaultWidth =
...
private var `_speaker-simple-none-thin`: ImageVector? = null
