...
public val FillGroup.`Presentation-chart-fill`: ImageVector
    get() {
        if (`_presentation-chart-fill` != null) {
            return `_presentation-chart-fill`!!
        }
        `_presentation-chart-fill` = Builder(name = "Presentation-chart-fill", defaultWidth =
...
private var `_presentation-chart-fill`: ImageVector? = null
