...
public val ThinGroup.`Text-strikethrough-thin`: ImageVector
    get() {
        if (`_text-strikethrough-thin` != null) {
            return `_text-strikethrough-thin`!!
        }
        `_text-strikethrough-thin` = Builder(name = "Text-strikethrough-thin", defaultWidth =
...
private var `_text-strikethrough-thin`: ImageVector? = null
