...
public val DuotoneGroup.`File-image-duotone`: ImageVector
    get() {
        if (`_file-image-duotone` != null) {
            return `_file-image-duotone`!!
        }
        `_file-image-duotone` = Builder(name = "File-image-duotone", defaultWidth = 256.0.dp,
...
private var `_file-image-duotone`: ImageVector? = null
