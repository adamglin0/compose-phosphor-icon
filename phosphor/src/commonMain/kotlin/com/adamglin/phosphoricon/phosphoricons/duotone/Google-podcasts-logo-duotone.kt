...
public val DuotoneGroup.`Google-podcasts-logo-duotone`: ImageVector
    get() {
        if (`_google-podcasts-logo-duotone` != null) {
            return `_google-podcasts-logo-duotone`!!
        }
        `_google-podcasts-logo-duotone` = Builder(name = "Google-podcasts-logo-duotone",
...
private var `_google-podcasts-logo-duotone`: ImageVector? = null
