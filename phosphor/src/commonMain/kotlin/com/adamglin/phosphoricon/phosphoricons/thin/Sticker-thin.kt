...
public val ThinGroup.`Sticker-thin`: ImageVector
    get() {
        if (`_sticker-thin` != null) {
            return `_sticker-thin`!!
        }
        `_sticker-thin` = Builder(name = "Sticker-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sticker-thin`: ImageVector? = null
