...
public val LightGroup.`Number-square-eight-light`: ImageVector
    get() {
        if (`_number-square-eight-light` != null) {
            return `_number-square-eight-light`!!
        }
        `_number-square-eight-light` = Builder(name = "Number-square-eight-light", defaultWidth =
...
private var `_number-square-eight-light`: ImageVector? = null
