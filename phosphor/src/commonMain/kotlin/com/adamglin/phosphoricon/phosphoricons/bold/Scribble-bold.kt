...
public val BoldGroup.`Scribble-bold`: ImageVector
    get() {
        if (`_scribble-bold` != null) {
            return `_scribble-bold`!!
        }
        `_scribble-bold` = Builder(name = "Scribble-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scribble-bold`: ImageVector? = null
