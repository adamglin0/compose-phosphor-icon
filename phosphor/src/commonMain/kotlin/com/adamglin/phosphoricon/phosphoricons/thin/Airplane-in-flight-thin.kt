...
public val ThinGroup.`Airplane-in-flight-thin`: ImageVector
    get() {
        if (`_airplane-in-flight-thin` != null) {
            return `_airplane-in-flight-thin`!!
        }
        `_airplane-in-flight-thin` = Builder(name = "Airplane-in-flight-thin", defaultWidth =
...
private var `_airplane-in-flight-thin`: ImageVector? = null
