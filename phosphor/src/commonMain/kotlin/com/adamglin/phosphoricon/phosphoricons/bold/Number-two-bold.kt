...
public val BoldGroup.`Number-two-bold`: ImageVector
    get() {
        if (`_number-two-bold` != null) {
            return `_number-two-bold`!!
        }
        `_number-two-bold` = Builder(name = "Number-two-bold", defaultWidth = 256.0.dp,
...
private var `_number-two-bold`: ImageVector? = null
