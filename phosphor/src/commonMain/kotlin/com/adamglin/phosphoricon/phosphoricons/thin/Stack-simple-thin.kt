...
public val ThinGroup.`Stack-simple-thin`: ImageVector
    get() {
        if (`_stack-simple-thin` != null) {
            return `_stack-simple-thin`!!
        }
        `_stack-simple-thin` = Builder(name = "Stack-simple-thin", defaultWidth = 256.0.dp,
...
private var `_stack-simple-thin`: ImageVector? = null
