...
public val DuotoneGroup.`Paypal-logo-duotone`: ImageVector
    get() {
        if (`_paypal-logo-duotone` != null) {
            return `_paypal-logo-duotone`!!
        }
        `_paypal-logo-duotone` = Builder(name = "Paypal-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_paypal-logo-duotone`: ImageVector? = null
