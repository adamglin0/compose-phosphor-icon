...
public val BoldGroup.`Video-conference-bold`: ImageVector
    get() {
        if (`_video-conference-bold` != null) {
            return `_video-conference-bold`!!
        }
        `_video-conference-bold` = Builder(name = "Video-conference-bold", defaultWidth = 256.0.dp,
...
private var `_video-conference-bold`: ImageVector? = null
