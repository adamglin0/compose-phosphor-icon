...
public val DuotoneGroup.`Line-segments-duotone`: ImageVector
    get() {
        if (`_line-segments-duotone` != null) {
            return `_line-segments-duotone`!!
        }
        `_line-segments-duotone` = Builder(name = "Line-segments-duotone", defaultWidth = 256.0.dp,
...
private var `_line-segments-duotone`: ImageVector? = null
