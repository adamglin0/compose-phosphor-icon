...
public val DuotoneGroup.`Van-duotone`: ImageVector
    get() {
        if (`_van-duotone` != null) {
            return `_van-duotone`!!
        }
        `_van-duotone` = Builder(name = "Van-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_van-duotone`: ImageVector? = null
