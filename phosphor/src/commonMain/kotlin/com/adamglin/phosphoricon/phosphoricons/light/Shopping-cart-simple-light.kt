...
public val LightGroup.`Shopping-cart-simple-light`: ImageVector
    get() {
        if (`_shopping-cart-simple-light` != null) {
            return `_shopping-cart-simple-light`!!
        }
        `_shopping-cart-simple-light` = Builder(name = "Shopping-cart-simple-light", defaultWidth =
...
private var `_shopping-cart-simple-light`: ImageVector? = null
