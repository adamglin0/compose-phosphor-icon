...
public val BoldGroup.`Circle-half-tilt-bold`: ImageVector
    get() {
        if (`_circle-half-tilt-bold` != null) {
            return `_circle-half-tilt-bold`!!
        }
        `_circle-half-tilt-bold` = Builder(name = "Circle-half-tilt-bold", defaultWidth = 256.0.dp,
...
private var `_circle-half-tilt-bold`: ImageVector? = null
