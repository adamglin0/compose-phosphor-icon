...
public val RegularGroup.`Cloud-warning`: ImageVector
    get() {
        if (`_cloud-warning` != null) {
            return `_cloud-warning`!!
        }
        `_cloud-warning` = Builder(name = "Cloud-warning", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-warning`: ImageVector? = null
