...
public val LightGroup.`Brain-light`: ImageVector
    get() {
        if (`_brain-light` != null) {
            return `_brain-light`!!
        }
        `_brain-light` = Builder(name = "Brain-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_brain-light`: ImageVector? = null
