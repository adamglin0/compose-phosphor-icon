...
public val ThinGroup.`Video-conference-thin`: ImageVector
    get() {
        if (`_video-conference-thin` != null) {
            return `_video-conference-thin`!!
        }
        `_video-conference-thin` = Builder(name = "Video-conference-thin", defaultWidth = 256.0.dp,
...
private var `_video-conference-thin`: ImageVector? = null
