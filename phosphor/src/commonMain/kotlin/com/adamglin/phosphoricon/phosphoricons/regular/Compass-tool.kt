...
public val RegularGroup.`Compass-tool`: ImageVector
    get() {
        if (`_compass-tool` != null) {
            return `_compass-tool`!!
        }
        `_compass-tool` = Builder(name = "Compass-tool", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_compass-tool`: ImageVector? = null
