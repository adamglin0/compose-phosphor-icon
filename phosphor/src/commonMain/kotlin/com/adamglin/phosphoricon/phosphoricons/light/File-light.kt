...
public val LightGroup.`File-light`: ImageVector
    get() {
        if (`_file-light` != null) {
            return `_file-light`!!
        }
        `_file-light` = Builder(name = "File-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-light`: ImageVector? = null
