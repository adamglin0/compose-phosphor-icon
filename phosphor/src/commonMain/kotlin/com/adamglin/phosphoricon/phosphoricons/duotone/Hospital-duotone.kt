...
public val DuotoneGroup.`Hospital-duotone`: ImageVector
    get() {
        if (`_hospital-duotone` != null) {
            return `_hospital-duotone`!!
        }
        `_hospital-duotone` = Builder(name = "Hospital-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 160.0f, 48.0f)
                close()
            }
...
private var `_hospital-duotone`: ImageVector? = null
