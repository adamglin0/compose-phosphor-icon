...
public val RegularGroup.`Person-simple-run`: ImageVector
    get() {
        if (`_person-simple-run` != null) {
            return `_person-simple-run`!!
        }
        `_person-simple-run` = Builder(name = "Person-simple-run", defaultWidth = 256.0.dp,
...
private var `_person-simple-run`: ImageVector? = null
