...
public val BoldGroup.`Folder-minus-bold`: ImageVector
    get() {
        if (`_folder-minus-bold` != null) {
            return `_folder-minus-bold`!!
        }
        `_folder-minus-bold` = Builder(name = "Folder-minus-bold", defaultWidth = 256.0.dp,
...
private var `_folder-minus-bold`: ImageVector? = null
