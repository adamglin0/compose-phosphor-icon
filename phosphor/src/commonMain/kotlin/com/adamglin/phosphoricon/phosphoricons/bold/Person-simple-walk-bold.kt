...
public val BoldGroup.`Person-simple-walk-bold`: ImageVector
    get() {
        if (`_person-simple-walk-bold` != null) {
            return `_person-simple-walk-bold`!!
        }
        `_person-simple-walk-bold` = Builder(name = "Person-simple-walk-bold", defaultWidth =
...
private var `_person-simple-walk-bold`: ImageVector? = null
