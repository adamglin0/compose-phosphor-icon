...
public val BoldGroup.`Speaker-high-bold`: ImageVector
    get() {
        if (`_speaker-high-bold` != null) {
            return `_speaker-high-bold`!!
        }
        `_speaker-high-bold` = Builder(name = "Speaker-high-bold", defaultWidth = 256.0.dp,
...
private var `_speaker-high-bold`: ImageVector? = null
