...
public val LightGroup.`Escalator-down-light`: ImageVector
    get() {
        if (`_escalator-down-light` != null) {
            return `_escalator-down-light`!!
        }
        `_escalator-down-light` = Builder(name = "Escalator-down-light", defaultWidth = 256.0.dp,
...
private var `_escalator-down-light`: ImageVector? = null
