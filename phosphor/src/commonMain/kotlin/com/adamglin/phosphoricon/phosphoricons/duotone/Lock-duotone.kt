...
public val DuotoneGroup.`Lock-duotone`: ImageVector
    get() {
        if (`_lock-duotone` != null) {
            return `_lock-duotone`!!
        }
        `_lock-duotone` = Builder(name = "Lock-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-duotone`: ImageVector? = null
