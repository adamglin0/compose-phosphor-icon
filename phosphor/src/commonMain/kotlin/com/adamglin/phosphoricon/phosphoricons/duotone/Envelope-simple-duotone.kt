...
public val DuotoneGroup.`Envelope-simple-duotone`: ImageVector
    get() {
        if (`_envelope-simple-duotone` != null) {
            return `_envelope-simple-duotone`!!
        }
        `_envelope-simple-duotone` = Builder(name = "Envelope-simple-duotone", defaultWidth =
...
private var `_envelope-simple-duotone`: ImageVector? = null
