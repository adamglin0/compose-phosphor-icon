...
public val ThinGroup.`Dev-to-logo-thin`: ImageVector
    get() {
        if (`_dev-to-logo-thin` != null) {
            return `_dev-to-logo-thin`!!
        }
        `_dev-to-logo-thin` = Builder(name = "Dev-to-logo-thin", defaultWidth = 256.0.dp,
...
private var `_dev-to-logo-thin`: ImageVector? = null
