...
public val DuotoneGroup.`Sort-ascending-duotone`: ImageVector
    get() {
        if (`_sort-ascending-duotone` != null) {
            return `_sort-ascending-duotone`!!
        }
        `_sort-ascending-duotone` = Builder(name = "Sort-ascending-duotone", defaultWidth =
...
private var `_sort-ascending-duotone`: ImageVector? = null
