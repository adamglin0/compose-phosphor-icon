...
public val BoldGroup.`Moped-front-bold`: ImageVector
    get() {
        if (`_moped-front-bold` != null) {
            return `_moped-front-bold`!!
        }
        `_moped-front-bold` = Builder(name = "Moped-front-bold", defaultWidth = 256.0.dp,
...
private var `_moped-front-bold`: ImageVector? = null
