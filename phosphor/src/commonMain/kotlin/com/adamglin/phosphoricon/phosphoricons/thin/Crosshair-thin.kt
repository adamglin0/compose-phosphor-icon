...
public val ThinGroup.`Crosshair-thin`: ImageVector
    get() {
        if (`_crosshair-thin` != null) {
            return `_crosshair-thin`!!
        }
        `_crosshair-thin` = Builder(name = "Crosshair-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_crosshair-thin`: ImageVector? = null
