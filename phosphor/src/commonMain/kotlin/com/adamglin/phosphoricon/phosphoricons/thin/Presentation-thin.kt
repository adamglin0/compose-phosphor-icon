...
public val ThinGroup.`Presentation-thin`: ImageVector
    get() {
        if (`_presentation-thin` != null) {
            return `_presentation-thin`!!
        }
        `_presentation-thin` = Builder(name = "Presentation-thin", defaultWidth = 256.0.dp,
...
private var `_presentation-thin`: ImageVector? = null
