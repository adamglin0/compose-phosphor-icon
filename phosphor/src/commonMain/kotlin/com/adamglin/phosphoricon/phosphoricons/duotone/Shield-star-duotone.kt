...
public val DuotoneGroup.`Shield-star-duotone`: ImageVector
    get() {
        if (`_shield-star-duotone` != null) {
            return `_shield-star-duotone`!!
        }
        `_shield-star-duotone` = Builder(name = "Shield-star-duotone", defaultWidth = 256.0.dp,
...
private var `_shield-star-duotone`: ImageVector? = null
