...
public val BoldGroup.`Cassette-tape-bold`: ImageVector
    get() {
        if (`_cassette-tape-bold` != null) {
            return `_cassette-tape-bold`!!
        }
        `_cassette-tape-bold` = Builder(name = "Cassette-tape-bold", defaultWidth = 256.0.dp,
...
private var `_cassette-tape-bold`: ImageVector? = null
