...
public val RegularGroup.`Envelope-simple-open`: ImageVector
    get() {
        if (`_envelope-simple-open` != null) {
            return `_envelope-simple-open`!!
        }
        `_envelope-simple-open` = Builder(name = "Envelope-simple-open", defaultWidth = 256.0.dp,
...
private var `_envelope-simple-open`: ImageVector? = null
