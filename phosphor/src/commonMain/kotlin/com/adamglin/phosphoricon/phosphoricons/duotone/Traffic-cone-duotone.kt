...
public val DuotoneGroup.`Traffic-cone-duotone`: ImageVector
    get() {
        if (`_traffic-cone-duotone` != null) {
            return `_traffic-cone-duotone`!!
        }
        `_traffic-cone-duotone` = Builder(name = "Traffic-cone-duotone", defaultWidth = 256.0.dp,
...
private var `_traffic-cone-duotone`: ImageVector? = null
