...
public val LightGroup.`Visor-light`: ImageVector
    get() {
        if (`_visor-light` != null) {
            return `_visor-light`!!
        }
        `_visor-light` = Builder(name = "Visor-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_visor-light`: ImageVector? = null
