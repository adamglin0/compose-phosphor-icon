...
public val FillGroup.`Number-four-fill`: ImageVector
    get() {
        if (`_number-four-fill` != null) {
            return `_number-four-fill`!!
        }
        `_number-four-fill` = Builder(name = "Number-four-fill", defaultWidth = 256.0.dp,
...
private var `_number-four-fill`: ImageVector? = null
