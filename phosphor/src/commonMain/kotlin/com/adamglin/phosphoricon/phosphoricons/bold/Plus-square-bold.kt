...
public val BoldGroup.`Plus-square-bold`: ImageVector
    get() {
        if (`_plus-square-bold` != null) {
            return `_plus-square-bold`!!
        }
        `_plus-square-bold` = Builder(name = "Plus-square-bold", defaultWidth = 256.0.dp,
...
private var `_plus-square-bold`: ImageVector? = null
