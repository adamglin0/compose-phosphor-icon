...
public val ThinGroup.`Chalkboard-thin`: ImageVector
    get() {
        if (`_chalkboard-thin` != null) {
            return `_chalkboard-thin`!!
        }
        `_chalkboard-thin` = Builder(name = "Chalkboard-thin", defaultWidth = 256.0.dp,
...
private var `_chalkboard-thin`: ImageVector? = null
