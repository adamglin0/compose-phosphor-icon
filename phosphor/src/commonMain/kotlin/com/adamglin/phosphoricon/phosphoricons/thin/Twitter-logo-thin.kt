...
public val ThinGroup.`Twitter-logo-thin`: ImageVector
    get() {
        if (`_twitter-logo-thin` != null) {
            return `_twitter-logo-thin`!!
        }
        `_twitter-logo-thin` = Builder(name = "Twitter-logo-thin", defaultWidth = 256.0.dp,
...
private var `_twitter-logo-thin`: ImageVector? = null
