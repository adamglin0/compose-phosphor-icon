...
public val BoldGroup.`Plugs-connected-bold`: ImageVector
    get() {
        if (`_plugs-connected-bold` != null) {
            return `_plugs-connected-bold`!!
        }
        `_plugs-connected-bold` = Builder(name = "Plugs-connected-bold", defaultWidth = 256.0.dp,
...
private var `_plugs-connected-bold`: ImageVector? = null
