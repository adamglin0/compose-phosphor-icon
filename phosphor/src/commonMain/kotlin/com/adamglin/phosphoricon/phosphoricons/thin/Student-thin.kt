...
public val ThinGroup.`Student-thin`: ImageVector
    get() {
        if (`_student-thin` != null) {
            return `_student-thin`!!
        }
        `_student-thin` = Builder(name = "Student-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_student-thin`: ImageVector? = null
