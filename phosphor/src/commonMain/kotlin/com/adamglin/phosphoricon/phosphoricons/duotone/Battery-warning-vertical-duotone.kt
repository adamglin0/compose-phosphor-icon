...
public val DuotoneGroup.`Battery-warning-vertical-duotone`: ImageVector
    get() {
        if (`_battery-warning-vertical-duotone` != null) {
            return `_battery-warning-vertical-duotone`!!
        }
        `_battery-warning-vertical-duotone` = Builder(name = "Battery-warning-vertical-duotone",
...
private var `_battery-warning-vertical-duotone`: ImageVector? = null
