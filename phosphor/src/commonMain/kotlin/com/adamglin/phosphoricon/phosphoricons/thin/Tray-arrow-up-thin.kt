...
public val ThinGroup.`Tray-arrow-up-thin`: ImageVector
    get() {
        if (`_tray-arrow-up-thin` != null) {
            return `_tray-arrow-up-thin`!!
        }
        `_tray-arrow-up-thin` = Builder(name = "Tray-arrow-up-thin", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-up-thin`: ImageVector? = null
