...
public val DuotoneGroup.`Book-open-text-duotone`: ImageVector
    get() {
        if (`_book-open-text-duotone` != null) {
            return `_book-open-text-duotone`!!
        }
        `_book-open-text-duotone` = Builder(name = "Book-open-text-duotone", defaultWidth =
...
private var `_book-open-text-duotone`: ImageVector? = null
