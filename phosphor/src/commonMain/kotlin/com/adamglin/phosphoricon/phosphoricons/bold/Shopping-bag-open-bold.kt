...
public val BoldGroup.`Shopping-bag-open-bold`: ImageVector
    get() {
        if (`_shopping-bag-open-bold` != null) {
            return `_shopping-bag-open-bold`!!
        }
        `_shopping-bag-open-bold` = Builder(name = "Shopping-bag-open-bold", defaultWidth =
...
private var `_shopping-bag-open-bold`: ImageVector? = null
