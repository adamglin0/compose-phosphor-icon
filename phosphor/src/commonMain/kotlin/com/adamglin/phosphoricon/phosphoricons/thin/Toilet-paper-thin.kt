...
public val ThinGroup.`Toilet-paper-thin`: ImageVector
    get() {
        if (`_toilet-paper-thin` != null) {
            return `_toilet-paper-thin`!!
        }
        `_toilet-paper-thin` = Builder(name = "Toilet-paper-thin", defaultWidth = 256.0.dp,
...
private var `_toilet-paper-thin`: ImageVector? = null
