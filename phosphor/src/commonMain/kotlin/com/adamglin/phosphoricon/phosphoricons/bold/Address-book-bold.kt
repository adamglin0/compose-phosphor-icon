...
public val BoldGroup.`Address-book-bold`: ImageVector
    get() {
        if (`_address-book-bold` != null) {
            return `_address-book-bold`!!
        }
        `_address-book-bold` = Builder(name = "Address-book-bold", defaultWidth = 256.0.dp,
...
private var `_address-book-bold`: ImageVector? = null
