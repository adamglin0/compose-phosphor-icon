...
public val BoldGroup.`Scribble-loop-bold`: ImageVector
    get() {
        if (`_scribble-loop-bold` != null) {
            return `_scribble-loop-bold`!!
        }
        `_scribble-loop-bold` = Builder(name = "Scribble-loop-bold", defaultWidth = 256.0.dp,
...
private var `_scribble-loop-bold`: ImageVector? = null
