...
public val LightGroup.`Chat-centered-text-light`: ImageVector
    get() {
        if (`_chat-centered-text-light` != null) {
            return `_chat-centered-text-light`!!
        }
        `_chat-centered-text-light` = Builder(name = "Chat-centered-text-light", defaultWidth =
...
private var `_chat-centered-text-light`: ImageVector? = null
