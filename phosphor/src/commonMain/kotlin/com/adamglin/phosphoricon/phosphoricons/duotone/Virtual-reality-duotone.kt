...
public val DuotoneGroup.`Virtual-reality-duotone`: ImageVector
    get() {
        if (`_virtual-reality-duotone` != null) {
            return `_virtual-reality-duotone`!!
        }
        `_virtual-reality-duotone` = Builder(name = "Virtual-reality-duotone", defaultWidth =
...
private var `_virtual-reality-duotone`: ImageVector? = null
