...
public val DuotoneGroup.`Arrow-fat-down-duotone`: ImageVector
    get() {
        if (`_arrow-fat-down-duotone` != null) {
            return `_arrow-fat-down-duotone`!!
        }
        `_arrow-fat-down-duotone` = Builder(name = "Arrow-fat-down-duotone", defaultWidth =
...
private var `_arrow-fat-down-duotone`: ImageVector? = null
