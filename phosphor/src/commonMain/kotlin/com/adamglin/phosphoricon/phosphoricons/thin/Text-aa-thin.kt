...
public val ThinGroup.`Text-aa-thin`: ImageVector
    get() {
        if (`_text-aa-thin` != null) {
            return `_text-aa-thin`!!
        }
        `_text-aa-thin` = Builder(name = "Text-aa-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-aa-thin`: ImageVector? = null
