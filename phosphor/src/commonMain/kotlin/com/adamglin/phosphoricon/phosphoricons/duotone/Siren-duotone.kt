...
public val DuotoneGroup.`Siren-duotone`: ImageVector
    get() {
        if (`_siren-duotone` != null) {
            return `_siren-duotone`!!
        }
        `_siren-duotone` = Builder(name = "Siren-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_siren-duotone`: ImageVector? = null
