...
public val BoldGroup.`File-plus-bold`: ImageVector
    get() {
        if (`_file-plus-bold` != null) {
            return `_file-plus-bold`!!
        }
        `_file-plus-bold` = Builder(name = "File-plus-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-plus-bold`: ImageVector? = null
