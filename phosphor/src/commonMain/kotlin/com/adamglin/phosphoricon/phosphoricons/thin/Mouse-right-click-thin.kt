...
public val ThinGroup.`Mouse-right-click-thin`: ImageVector
    get() {
        if (`_mouse-right-click-thin` != null) {
            return `_mouse-right-click-thin`!!
        }
        `_mouse-right-click-thin` = Builder(name = "Mouse-right-click-thin", defaultWidth =
...
private var `_mouse-right-click-thin`: ImageVector? = null
