...
public val ThinGroup.`Chef-hat-thin`: ImageVector
    get() {
        if (`_chef-hat-thin` != null) {
            return `_chef-hat-thin`!!
        }
        `_chef-hat-thin` = Builder(name = "Chef-hat-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chef-hat-thin`: ImageVector? = null
