...
public val ThinGroup.`Pencil-line-thin`: ImageVector
    get() {
        if (`_pencil-line-thin` != null) {
            return `_pencil-line-thin`!!
        }
        `_pencil-line-thin` = Builder(name = "Pencil-line-thin", defaultWidth = 256.0.dp,
...
private var `_pencil-line-thin`: ImageVector? = null
