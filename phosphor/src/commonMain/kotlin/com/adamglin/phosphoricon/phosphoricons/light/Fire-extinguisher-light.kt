...
public val LightGroup.`Fire-extinguisher-light`: ImageVector
    get() {
        if (`_fire-extinguisher-light` != null) {
            return `_fire-extinguisher-light`!!
        }
        `_fire-extinguisher-light` = Builder(name = "Fire-extinguisher-light", defaultWidth =
...
private var `_fire-extinguisher-light`: ImageVector? = null
