...
public val FillGroup.`Pizza-fill`: ImageVector
    get() {
        if (`_pizza-fill` != null) {
            return `_pizza-fill`!!
        }
        `_pizza-fill` = Builder(name = "Pizza-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pizza-fill`: ImageVector? = null
