...
public val DuotoneGroup.`Stack-duotone`: ImageVector
    get() {
        if (`_stack-duotone` != null) {
            return `_stack-duotone`!!
        }
        `_stack-duotone` = Builder(name = "Stack-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stack-duotone`: ImageVector? = null
