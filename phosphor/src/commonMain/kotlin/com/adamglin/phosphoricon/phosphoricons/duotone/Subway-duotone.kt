...
public val DuotoneGroup.`Subway-duotone`: ImageVector
    get() {
        if (`_subway-duotone` != null) {
            return `_subway-duotone`!!
        }
        `_subway-duotone` = Builder(name = "Subway-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_subway-duotone`: ImageVector? = null
