...
public val LightGroup.`Beer-stein-light`: ImageVector
    get() {
        if (`_beer-stein-light` != null) {
            return `_beer-stein-light`!!
        }
        `_beer-stein-light` = Builder(name = "Beer-stein-light", defaultWidth = 256.0.dp,
...
private var `_beer-stein-light`: ImageVector? = null
