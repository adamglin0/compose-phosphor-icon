...
public val ThinGroup.`Eyedropper-thin`: ImageVector
    get() {
        if (`_eyedropper-thin` != null) {
            return `_eyedropper-thin`!!
        }
        `_eyedropper-thin` = Builder(name = "Eyedropper-thin", defaultWidth = 256.0.dp,
...
private var `_eyedropper-thin`: ImageVector? = null
