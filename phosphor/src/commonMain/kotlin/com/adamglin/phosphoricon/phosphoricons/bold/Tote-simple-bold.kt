...
public val BoldGroup.`Tote-simple-bold`: ImageVector
    get() {
        if (`_tote-simple-bold` != null) {
            return `_tote-simple-bold`!!
        }
        `_tote-simple-bold` = Builder(name = "Tote-simple-bold", defaultWidth = 256.0.dp,
...
private var `_tote-simple-bold`: ImageVector? = null
