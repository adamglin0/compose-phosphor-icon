...
public val LightGroup.`Cricket-light`: ImageVector
    get() {
        if (`_cricket-light` != null) {
            return `_cricket-light`!!
        }
        `_cricket-light` = Builder(name = "Cricket-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cricket-light`: ImageVector? = null
