...
public val LightGroup.`Butterfly-light`: ImageVector
    get() {
        if (`_butterfly-light` != null) {
            return `_butterfly-light`!!
        }
        `_butterfly-light` = Builder(name = "Butterfly-light", defaultWidth = 256.0.dp,
...
private var `_butterfly-light`: ImageVector? = null
