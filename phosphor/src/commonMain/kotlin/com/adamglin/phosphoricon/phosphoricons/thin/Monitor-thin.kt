...
public val ThinGroup.`Monitor-thin`: ImageVector
    get() {
        if (`_monitor-thin` != null) {
            return `_monitor-thin`!!
        }
        `_monitor-thin` = Builder(name = "Monitor-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_monitor-thin`: ImageVector? = null
