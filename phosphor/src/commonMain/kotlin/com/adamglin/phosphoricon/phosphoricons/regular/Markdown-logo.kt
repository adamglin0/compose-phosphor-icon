...
public val RegularGroup.`Markdown-logo`: ImageVector
    get() {
        if (`_markdown-logo` != null) {
            return `_markdown-logo`!!
        }
        `_markdown-logo` = Builder(name = "Markdown-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_markdown-logo`: ImageVector? = null
