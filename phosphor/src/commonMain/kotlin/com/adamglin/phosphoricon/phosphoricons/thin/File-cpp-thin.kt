...
public val ThinGroup.`File-cpp-thin`: ImageVector
    get() {
        if (`_file-cpp-thin` != null) {
            return `_file-cpp-thin`!!
        }
        `_file-cpp-thin` = Builder(name = "File-cpp-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-cpp-thin`: ImageVector? = null
