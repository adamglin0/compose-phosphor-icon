...
public val DuotoneGroup.`Speaker-x-duotone`: ImageVector
    get() {
        if (`_speaker-x-duotone` != null) {
            return `_speaker-x-duotone`!!
        }
        `_speaker-x-duotone` = Builder(name = "Speaker-x-duotone", defaultWidth = 256.0.dp,
...
private var `_speaker-x-duotone`: ImageVector? = null
