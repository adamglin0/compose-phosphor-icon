...
public val FillGroup.`Cassette-tape-fill`: ImageVector
    get() {
        if (`_cassette-tape-fill` != null) {
            return `_cassette-tape-fill`!!
        }
        `_cassette-tape-fill` = Builder(name = "Cassette-tape-fill", defaultWidth = 256.0.dp,
...
private var `_cassette-tape-fill`: ImageVector? = null
