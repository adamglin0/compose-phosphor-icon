...
public val BoldGroup.`Rocket-launch-bold`: ImageVector
    get() {
        if (`_rocket-launch-bold` != null) {
            return `_rocket-launch-bold`!!
        }
        `_rocket-launch-bold` = Builder(name = "Rocket-launch-bold", defaultWidth = 256.0.dp,
...
private var `_rocket-launch-bold`: ImageVector? = null
