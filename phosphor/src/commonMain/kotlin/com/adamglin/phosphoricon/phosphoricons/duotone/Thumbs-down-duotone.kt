...
public val DuotoneGroup.`Thumbs-down-duotone`: ImageVector
    get() {
        if (`_thumbs-down-duotone` != null) {
            return `_thumbs-down-duotone`!!
        }
        `_thumbs-down-duotone` = Builder(name = "Thumbs-down-duotone", defaultWidth = 256.0.dp,
...
private var `_thumbs-down-duotone`: ImageVector? = null
