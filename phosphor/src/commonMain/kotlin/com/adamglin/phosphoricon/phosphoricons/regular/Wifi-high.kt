...
public val RegularGroup.`Wifi-high`: ImageVector
    get() {
        if (`_wifi-high` != null) {
            return `_wifi-high`!!
        }
        `_wifi-high` = Builder(name = "Wifi-high", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wifi-high`: ImageVector? = null
