...
public val LightGroup.`Court-basketball-light`: ImageVector
    get() {
        if (`_court-basketball-light` != null) {
            return `_court-basketball-light`!!
        }
        `_court-basketball-light` = Builder(name = "Court-basketball-light", defaultWidth =
...
private var `_court-basketball-light`: ImageVector? = null
