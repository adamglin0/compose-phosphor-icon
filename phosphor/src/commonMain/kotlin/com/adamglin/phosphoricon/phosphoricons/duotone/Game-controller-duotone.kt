...
public val DuotoneGroup.`Game-controller-duotone`: ImageVector
    get() {
        if (`_game-controller-duotone` != null) {
            return `_game-controller-duotone`!!
        }
        `_game-controller-duotone` = Builder(name = "Game-controller-duotone", defaultWidth =
...
private var `_game-controller-duotone`: ImageVector? = null
