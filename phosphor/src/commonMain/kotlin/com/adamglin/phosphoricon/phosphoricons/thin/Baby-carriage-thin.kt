...
public val ThinGroup.`Baby-carriage-thin`: ImageVector
    get() {
        if (`_baby-carriage-thin` != null) {
            return `_baby-carriage-thin`!!
        }
        `_baby-carriage-thin` = Builder(name = "Baby-carriage-thin", defaultWidth = 256.0.dp,
...
private var `_baby-carriage-thin`: ImageVector? = null
