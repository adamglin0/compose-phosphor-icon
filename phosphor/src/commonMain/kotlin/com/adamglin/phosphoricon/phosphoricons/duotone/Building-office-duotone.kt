...
public val DuotoneGroup.`Building-office-duotone`: ImageVector
    get() {
        if (`_building-office-duotone` != null) {
            return `_building-office-duotone`!!
        }
        `_building-office-duotone` = Builder(name = "Building-office-duotone", defaultWidth =
...
private var `_building-office-duotone`: ImageVector? = null
