...
public val RegularGroup.`Repeat-once`: ImageVector
    get() {
        if (`_repeat-once` != null) {
            return `_repeat-once`!!
        }
        `_repeat-once` = Builder(name = "Repeat-once", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_repeat-once`: ImageVector? = null
