...
public val DuotoneGroup.`Selection-background-duotone`: ImageVector
    get() {
        if (`_selection-background-duotone` != null) {
            return `_selection-background-duotone`!!
        }
        `_selection-background-duotone` = Builder(name = "Selection-background-duotone",
...
private var `_selection-background-duotone`: ImageVector? = null
