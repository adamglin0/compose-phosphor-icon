...
public val ThinGroup.`Smiley-sad-thin`: ImageVector
    get() {
        if (`_smiley-sad-thin` != null) {
            return `_smiley-sad-thin`!!
        }
        `_smiley-sad-thin` = Builder(name = "Smiley-sad-thin", defaultWidth = 256.0.dp,
...
private var `_smiley-sad-thin`: ImageVector? = null
