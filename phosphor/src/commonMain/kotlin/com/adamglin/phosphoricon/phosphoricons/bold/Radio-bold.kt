...
public val BoldGroup.`Radio-bold`: ImageVector
    get() {
        if (`_radio-bold` != null) {
            return `_radio-bold`!!
        }
        `_radio-bold` = Builder(name = "Radio-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_radio-bold`: ImageVector? = null
