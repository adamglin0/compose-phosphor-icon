...
public val ThinGroup.`Shirt-folded-thin`: ImageVector
    get() {
        if (`_shirt-folded-thin` != null) {
            return `_shirt-folded-thin`!!
        }
        `_shirt-folded-thin` = Builder(name = "Shirt-folded-thin", defaultWidth = 256.0.dp,
...
private var `_shirt-folded-thin`: ImageVector? = null
