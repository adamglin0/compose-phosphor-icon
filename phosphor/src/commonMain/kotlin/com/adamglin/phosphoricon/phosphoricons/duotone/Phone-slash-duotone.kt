...
public val DuotoneGroup.`Phone-slash-duotone`: ImageVector
    get() {
        if (`_phone-slash-duotone` != null) {
            return `_phone-slash-duotone`!!
        }
        `_phone-slash-duotone` = Builder(name = "Phone-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_phone-slash-duotone`: ImageVector? = null
