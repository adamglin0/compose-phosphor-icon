...
public val ThinGroup.`Castle-turret-thin`: ImageVector
    get() {
        if (`_castle-turret-thin` != null) {
            return `_castle-turret-thin`!!
        }
        `_castle-turret-thin` = Builder(name = "Castle-turret-thin", defaultWidth = 256.0.dp,
...
private var `_castle-turret-thin`: ImageVector? = null
