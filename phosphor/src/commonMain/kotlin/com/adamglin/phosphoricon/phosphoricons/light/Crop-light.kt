...
public val LightGroup.`Crop-light`: ImageVector
    get() {
        if (`_crop-light` != null) {
            return `_crop-light`!!
        }
        `_crop-light` = Builder(name = "Crop-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_crop-light`: ImageVector? = null
