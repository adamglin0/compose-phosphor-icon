...
public val ThinGroup.`Clock-counter-clockwise-thin`: ImageVector
    get() {
        if (`_clock-counter-clockwise-thin` != null) {
            return `_clock-counter-clockwise-thin`!!
        }
        `_clock-counter-clockwise-thin` = Builder(name = "Clock-counter-clockwise-thin",
...
private var `_clock-counter-clockwise-thin`: ImageVector? = null
