...
public val DuotoneGroup.`Phone-plus-duotone`: ImageVector
    get() {
        if (`_phone-plus-duotone` != null) {
            return `_phone-plus-duotone`!!
        }
        `_phone-plus-duotone` = Builder(name = "Phone-plus-duotone", defaultWidth = 256.0.dp,
...
private var `_phone-plus-duotone`: ImageVector? = null
