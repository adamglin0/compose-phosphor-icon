...
public val LightGroup.`Ambulance-light`: ImageVector
    get() {
        if (`_ambulance-light` != null) {
            return `_ambulance-light`!!
        }
        `_ambulance-light` = Builder(name = "Ambulance-light", defaultWidth = 256.0.dp,
...
private var `_ambulance-light`: ImageVector? = null
