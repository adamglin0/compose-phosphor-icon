...
public val DuotoneGroup.`Train-duotone`: ImageVector
    get() {
        if (`_train-duotone` != null) {
            return `_train-duotone`!!
        }
        `_train-duotone` = Builder(name = "Train-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_train-duotone`: ImageVector? = null
