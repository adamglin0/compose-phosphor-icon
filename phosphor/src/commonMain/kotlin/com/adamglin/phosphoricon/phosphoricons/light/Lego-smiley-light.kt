...
public val LightGroup.`Lego-smiley-light`: ImageVector
    get() {
        if (`_lego-smiley-light` != null) {
            return `_lego-smiley-light`!!
        }
        `_lego-smiley-light` = Builder(name = "Lego-smiley-light", defaultWidth = 256.0.dp,
...
private var `_lego-smiley-light`: ImageVector? = null
