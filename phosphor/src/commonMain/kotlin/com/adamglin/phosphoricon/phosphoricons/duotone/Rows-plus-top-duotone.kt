...
public val DuotoneGroup.`Rows-plus-top-duotone`: ImageVector
    get() {
        if (`_rows-plus-top-duotone` != null) {
            return `_rows-plus-top-duotone`!!
        }
        `_rows-plus-top-duotone` = Builder(name = "Rows-plus-top-duotone", defaultWidth = 256.0.dp,
...
private var `_rows-plus-top-duotone`: ImageVector? = null
