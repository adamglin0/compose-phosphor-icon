...
public val ThinGroup.`Headphones-thin`: ImageVector
    get() {
        if (`_headphones-thin` != null) {
            return `_headphones-thin`!!
        }
        `_headphones-thin` = Builder(name = "Headphones-thin", defaultWidth = 256.0.dp,
...
private var `_headphones-thin`: ImageVector? = null
