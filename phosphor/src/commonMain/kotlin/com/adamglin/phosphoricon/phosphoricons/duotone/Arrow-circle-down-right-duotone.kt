...
public val DuotoneGroup.`Arrow-circle-down-right-duotone`: ImageVector
    get() {
        if (`_arrow-circle-down-right-duotone` != null) {
            return `_arrow-circle-down-right-duotone`!!
        }
        `_arrow-circle-down-right-duotone` = Builder(name = "Arrow-circle-down-right-duotone",
...
private var `_arrow-circle-down-right-duotone`: ImageVector? = null
