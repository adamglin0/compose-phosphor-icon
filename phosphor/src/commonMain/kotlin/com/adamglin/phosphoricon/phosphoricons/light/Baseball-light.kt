...
public val LightGroup.`Baseball-light`: ImageVector
    get() {
        if (`_baseball-light` != null) {
            return `_baseball-light`!!
        }
        `_baseball-light` = Builder(name = "Baseball-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_baseball-light`: ImageVector? = null
