...
public val BoldGroup.`Vinyl-record-bold`: ImageVector
    get() {
        if (`_vinyl-record-bold` != null) {
            return `_vinyl-record-bold`!!
        }
        `_vinyl-record-bold` = Builder(name = "Vinyl-record-bold", defaultWidth = 256.0.dp,
...
private var `_vinyl-record-bold`: ImageVector? = null
