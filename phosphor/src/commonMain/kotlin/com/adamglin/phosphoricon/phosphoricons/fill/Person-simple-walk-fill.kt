...
public val FillGroup.`Person-simple-walk-fill`: ImageVector
    get() {
        if (`_person-simple-walk-fill` != null) {
            return `_person-simple-walk-fill`!!
        }
        `_person-simple-walk-fill` = Builder(name = "Person-simple-walk-fill", defaultWidth =
...
private var `_person-simple-walk-fill`: ImageVector? = null
