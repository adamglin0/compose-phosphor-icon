...
public val RegularGroup.`Airplane-taxiing`: ImageVector
    get() {
        if (`_airplane-taxiing` != null) {
            return `_airplane-taxiing`!!
        }
        `_airplane-taxiing` = Builder(name = "Airplane-taxiing", defaultWidth = 256.0.dp,
...
private var `_airplane-taxiing`: ImageVector? = null
