...
public val DuotoneGroup.`Recycle-duotone`: ImageVector
    get() {
        if (`_recycle-duotone` != null) {
            return `_recycle-duotone`!!
        }
        `_recycle-duotone` = Builder(name = "Recycle-duotone", defaultWidth = 256.0.dp,
...
private var `_recycle-duotone`: ImageVector? = null
