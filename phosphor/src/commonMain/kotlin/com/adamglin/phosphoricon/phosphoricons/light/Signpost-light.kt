...
public val LightGroup.`Signpost-light`: ImageVector
    get() {
        if (`_signpost-light` != null) {
            return `_signpost-light`!!
        }
        `_signpost-light` = Builder(name = "Signpost-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_signpost-light`: ImageVector? = null
