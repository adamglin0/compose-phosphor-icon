...
public val ThinGroup.`Target-thin`: ImageVector
    get() {
        if (`_target-thin` != null) {
            return `_target-thin`!!
        }
        `_target-thin` = Builder(name = "Target-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_target-thin`: ImageVector? = null
