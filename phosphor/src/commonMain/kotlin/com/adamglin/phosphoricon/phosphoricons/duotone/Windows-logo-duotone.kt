...
public val DuotoneGroup.`Windows-logo-duotone`: ImageVector
    get() {
        if (`_windows-logo-duotone` != null) {
            return `_windows-logo-duotone`!!
        }
        `_windows-logo-duotone` = Builder(name = "Windows-logo-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(200.0f, 206.41f)
                lineTo(136.0f, 194.78f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, false, 96.0f, 136.0f)
                close()
                moveTo(88.0f, 186.05f)
                lineTo(40.0f, 177.32f)
                lineTo(40.0f, 152.0f)
                lineTo(88.0f, 152.0f)
                close()
...
private var `_windows-logo-duotone`: ImageVector? = null
