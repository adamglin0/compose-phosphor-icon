...
public val LightGroup.`Club-light`: ImageVector
    get() {
        if (`_club-light` != null) {
            return `_club-light`!!
        }
        `_club-light` = Builder(name = "Club-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_club-light`: ImageVector? = null
