...
public val FillGroup.`Racquet-fill`: ImageVector
    get() {
        if (`_racquet-fill` != null) {
            return `_racquet-fill`!!
        }
        `_racquet-fill` = Builder(name = "Racquet-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_racquet-fill`: ImageVector? = null
