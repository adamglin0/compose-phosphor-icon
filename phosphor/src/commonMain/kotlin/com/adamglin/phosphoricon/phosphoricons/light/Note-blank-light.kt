...
public val LightGroup.`Note-blank-light`: ImageVector
    get() {
        if (`_note-blank-light` != null) {
            return `_note-blank-light`!!
        }
        `_note-blank-light` = Builder(name = "Note-blank-light", defaultWidth = 256.0.dp,
...
private var `_note-blank-light`: ImageVector? = null
