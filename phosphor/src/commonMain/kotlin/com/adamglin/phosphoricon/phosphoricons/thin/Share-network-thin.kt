...
public val ThinGroup.`Share-network-thin`: ImageVector
    get() {
        if (`_share-network-thin` != null) {
            return `_share-network-thin`!!
        }
        `_share-network-thin` = Builder(name = "Share-network-thin", defaultWidth = 256.0.dp,
...
private var `_share-network-thin`: ImageVector? = null
