...
public val DuotoneGroup.`Gear-fine-duotone`: ImageVector
    get() {
        if (`_gear-fine-duotone` != null) {
            return `_gear-fine-duotone`!!
        }
        `_gear-fine-duotone` = Builder(name = "Gear-fine-duotone", defaultWidth = 256.0.dp,
...
private var `_gear-fine-duotone`: ImageVector? = null
