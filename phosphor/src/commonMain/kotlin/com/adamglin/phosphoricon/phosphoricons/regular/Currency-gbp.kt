...
public val RegularGroup.`Currency-gbp`: ImageVector
    get() {
        if (`_currency-gbp` != null) {
            return `_currency-gbp`!!
        }
        `_currency-gbp` = Builder(name = "Currency-gbp", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_currency-gbp`: ImageVector? = null
