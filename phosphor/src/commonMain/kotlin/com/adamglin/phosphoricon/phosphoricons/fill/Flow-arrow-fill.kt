...
public val FillGroup.`Flow-arrow-fill`: ImageVector
    get() {
        if (`_flow-arrow-fill` != null) {
            return `_flow-arrow-fill`!!
        }
        `_flow-arrow-fill` = Builder(name = "Flow-arrow-fill", defaultWidth = 256.0.dp,
...
private var `_flow-arrow-fill`: ImageVector? = null
