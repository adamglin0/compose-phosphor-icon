...
public val DuotoneGroup.`Number-circle-eight-duotone`: ImageVector
    get() {
        if (`_number-circle-eight-duotone` != null) {
            return `_number-circle-eight-duotone`!!
        }
        `_number-circle-eight-duotone` = Builder(name = "Number-circle-eight-duotone", defaultWidth
...
private var `_number-circle-eight-duotone`: ImageVector? = null
