...
public val LightGroup.`Cloud-x-light`: ImageVector
    get() {
        if (`_cloud-x-light` != null) {
            return `_cloud-x-light`!!
        }
        `_cloud-x-light` = Builder(name = "Cloud-x-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-x-light`: ImageVector? = null
