...
public val ThinGroup.`Folder-star-thin`: ImageVector
    get() {
        if (`_folder-star-thin` != null) {
            return `_folder-star-thin`!!
        }
        `_folder-star-thin` = Builder(name = "Folder-star-thin", defaultWidth = 256.0.dp,
...
private var `_folder-star-thin`: ImageVector? = null
