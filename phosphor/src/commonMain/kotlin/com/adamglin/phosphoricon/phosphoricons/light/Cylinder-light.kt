...
public val LightGroup.`Cylinder-light`: ImageVector
    get() {
        if (`_cylinder-light` != null) {
            return `_cylinder-light`!!
        }
        `_cylinder-light` = Builder(name = "Cylinder-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cylinder-light`: ImageVector? = null
