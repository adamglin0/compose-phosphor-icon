...
public val BoldGroup.`Champagne-bold`: ImageVector
    get() {
        if (`_champagne-bold` != null) {
            return `_champagne-bold`!!
        }
        `_champagne-bold` = Builder(name = "Champagne-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_champagne-bold`: ImageVector? = null
