...
public val ThinGroup.`Truck-trailer-thin`: ImageVector
    get() {
        if (`_truck-trailer-thin` != null) {
            return `_truck-trailer-thin`!!
        }
        `_truck-trailer-thin` = Builder(name = "Truck-trailer-thin", defaultWidth = 256.0.dp,
...
private var `_truck-trailer-thin`: ImageVector? = null
