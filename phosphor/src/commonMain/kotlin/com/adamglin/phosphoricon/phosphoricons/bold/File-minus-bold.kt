...
public val BoldGroup.`File-minus-bold`: ImageVector
    get() {
        if (`_file-minus-bold` != null) {
            return `_file-minus-bold`!!
        }
        `_file-minus-bold` = Builder(name = "File-minus-bold", defaultWidth = 256.0.dp,
...
private var `_file-minus-bold`: ImageVector? = null
