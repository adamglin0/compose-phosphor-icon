...
public val DuotoneGroup.`Tractor-duotone`: ImageVector
    get() {
        if (`_tractor-duotone` != null) {
            return `_tractor-duotone`!!
        }
        `_tractor-duotone` = Builder(name = "Tractor-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(28.0f, 28.0f, 0.0f, false, true, 240.0f, 188.0f)
                close()
                moveTo(68.0f, 128.0f)
...
private var `_tractor-duotone`: ImageVector? = null
