...
public val LightGroup.`Skip-forward-circle-light`: ImageVector
    get() {
        if (`_skip-forward-circle-light` != null) {
            return `_skip-forward-circle-light`!!
        }
        `_skip-forward-circle-light` = Builder(name = "Skip-forward-circle-light", defaultWidth =
...
private var `_skip-forward-circle-light`: ImageVector? = null
