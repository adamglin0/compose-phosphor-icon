...
public val FillGroup.`Spinner-gap-fill`: ImageVector
    get() {
        if (`_spinner-gap-fill` != null) {
            return `_spinner-gap-fill`!!
        }
        `_spinner-gap-fill` = Builder(name = "Spinner-gap-fill", defaultWidth = 256.0.dp,
...
private var `_spinner-gap-fill`: ImageVector? = null
