...
public val ThinGroup.`Seatbelt-thin`: ImageVector
    get() {
        if (`_seatbelt-thin` != null) {
            return `_seatbelt-thin`!!
        }
        `_seatbelt-thin` = Builder(name = "Seatbelt-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seatbelt-thin`: ImageVector? = null
