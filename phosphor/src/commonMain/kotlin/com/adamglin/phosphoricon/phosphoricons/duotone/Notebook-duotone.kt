...
public val DuotoneGroup.`Notebook-duotone`: ImageVector
    get() {
        if (`_notebook-duotone` != null) {
            return `_notebook-duotone`!!
        }
        `_notebook-duotone` = Builder(name = "Notebook-duotone", defaultWidth = 256.0.dp,
...
private var `_notebook-duotone`: ImageVector? = null
