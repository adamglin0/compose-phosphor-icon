...
public val DuotoneGroup.`Calendar-dots-duotone`: ImageVector
    get() {
        if (`_calendar-dots-duotone` != null) {
            return `_calendar-dots-duotone`!!
        }
        `_calendar-dots-duotone` = Builder(name = "Calendar-dots-duotone", defaultWidth = 256.0.dp,
...
private var `_calendar-dots-duotone`: ImageVector? = null
