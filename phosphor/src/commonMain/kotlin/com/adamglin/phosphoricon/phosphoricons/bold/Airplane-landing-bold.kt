...
public val BoldGroup.`Airplane-landing-bold`: ImageVector
    get() {
        if (`_airplane-landing-bold` != null) {
            return `_airplane-landing-bold`!!
        }
        `_airplane-landing-bold` = Builder(name = "Airplane-landing-bold", defaultWidth = 256.0.dp,
...
private var `_airplane-landing-bold`: ImageVector? = null
