...
public val LightGroup.`Pinterest-logo-light`: ImageVector
    get() {
        if (`_pinterest-logo-light` != null) {
            return `_pinterest-logo-light`!!
        }
        `_pinterest-logo-light` = Builder(name = "Pinterest-logo-light", defaultWidth = 256.0.dp,
...
private var `_pinterest-logo-light`: ImageVector? = null
