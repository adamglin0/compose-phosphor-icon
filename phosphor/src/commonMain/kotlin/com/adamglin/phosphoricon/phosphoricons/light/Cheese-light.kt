...
public val LightGroup.`Cheese-light`: ImageVector
    get() {
        if (`_cheese-light` != null) {
            return `_cheese-light`!!
        }
        `_cheese-light` = Builder(name = "Cheese-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cheese-light`: ImageVector? = null
