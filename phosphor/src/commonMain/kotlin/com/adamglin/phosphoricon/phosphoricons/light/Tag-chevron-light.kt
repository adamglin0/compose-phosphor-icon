...
public val LightGroup.`Tag-chevron-light`: ImageVector
    get() {
        if (`_tag-chevron-light` != null) {
            return `_tag-chevron-light`!!
        }
        `_tag-chevron-light` = Builder(name = "Tag-chevron-light", defaultWidth = 256.0.dp,
...
private var `_tag-chevron-light`: ImageVector? = null
