...
public val LightGroup.`Microphone-slash-light`: ImageVector
    get() {
        if (`_microphone-slash-light` != null) {
            return `_microphone-slash-light`!!
        }
        `_microphone-slash-light` = Builder(name = "Microphone-slash-light", defaultWidth =
...
private var `_microphone-slash-light`: ImageVector? = null
