...
public val LightGroup.`Music-note-simple-light`: ImageVector
    get() {
        if (`_music-note-simple-light` != null) {
            return `_music-note-simple-light`!!
        }
        `_music-note-simple-light` = Builder(name = "Music-note-simple-light", defaultWidth =
...
private var `_music-note-simple-light`: ImageVector? = null
