...
public val DuotoneGroup.`Box-arrow-up-duotone`: ImageVector
    get() {
        if (`_box-arrow-up-duotone` != null) {
            return `_box-arrow-up-duotone`!!
        }
        `_box-arrow-up-duotone` = Builder(name = "Box-arrow-up-duotone", defaultWidth = 256.0.dp,
...
private var `_box-arrow-up-duotone`: ImageVector? = null
