...
public val ThinGroup.`Vault-thin`: ImageVector
    get() {
        if (`_vault-thin` != null) {
            return `_vault-thin`!!
        }
        `_vault-thin` = Builder(name = "Vault-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_vault-thin`: ImageVector? = null
