...
public val FillGroup.`Currency-ngn-fill`: ImageVector
    get() {
        if (`_currency-ngn-fill` != null) {
            return `_currency-ngn-fill`!!
        }
        `_currency-ngn-fill` = Builder(name = "Currency-ngn-fill", defaultWidth = 256.0.dp,
...
private var `_currency-ngn-fill`: ImageVector? = null
