...
public val ThinGroup.`Play-thin`: ImageVector
    get() {
        if (`_play-thin` != null) {
            return `_play-thin`!!
        }
        `_play-thin` = Builder(name = "Play-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_play-thin`: ImageVector? = null
