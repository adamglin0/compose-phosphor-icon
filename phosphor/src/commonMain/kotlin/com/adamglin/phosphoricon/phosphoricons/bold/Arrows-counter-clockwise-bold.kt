...
public val BoldGroup.`Arrows-counter-clockwise-bold`: ImageVector
    get() {
        if (`_arrows-counter-clockwise-bold` != null) {
            return `_arrows-counter-clockwise-bold`!!
        }
        `_arrows-counter-clockwise-bold` = Builder(name = "Arrows-counter-clockwise-bold",
...
private var `_arrows-counter-clockwise-bold`: ImageVector? = null
