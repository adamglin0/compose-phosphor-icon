...
public val RegularGroup.`Bell-simple`: ImageVector
    get() {
        if (`_bell-simple` != null) {
            return `_bell-simple`!!
        }
        `_bell-simple` = Builder(name = "Bell-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bell-simple`: ImageVector? = null
