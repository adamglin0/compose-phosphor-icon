...
public val RegularGroup.`Pencil-ruler`: ImageVector
    get() {
        if (`_pencil-ruler` != null) {
            return `_pencil-ruler`!!
        }
        `_pencil-ruler` = Builder(name = "Pencil-ruler", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pencil-ruler`: ImageVector? = null
