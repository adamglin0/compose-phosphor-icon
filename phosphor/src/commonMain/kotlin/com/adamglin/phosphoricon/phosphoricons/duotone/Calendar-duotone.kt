...
public val DuotoneGroup.`Calendar-duotone`: ImageVector
    get() {
        if (`_calendar-duotone` != null) {
            return `_calendar-duotone`!!
        }
        `_calendar-duotone` = Builder(name = "Calendar-duotone", defaultWidth = 256.0.dp,
...
private var `_calendar-duotone`: ImageVector? = null
