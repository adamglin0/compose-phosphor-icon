...
public val BoldGroup.`Anchor-bold`: ImageVector
    get() {
        if (`_anchor-bold` != null) {
            return `_anchor-bold`!!
        }
        `_anchor-bold` = Builder(name = "Anchor-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_anchor-bold`: ImageVector? = null
