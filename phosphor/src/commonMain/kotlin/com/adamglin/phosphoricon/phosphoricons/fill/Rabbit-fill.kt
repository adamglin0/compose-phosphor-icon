...
public val FillGroup.`Rabbit-fill`: ImageVector
    get() {
        if (`_rabbit-fill` != null) {
            return `_rabbit-fill`!!
        }
        `_rabbit-fill` = Builder(name = "Rabbit-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rabbit-fill`: ImageVector? = null
