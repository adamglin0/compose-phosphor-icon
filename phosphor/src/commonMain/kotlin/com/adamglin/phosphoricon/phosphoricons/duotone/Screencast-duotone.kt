...
public val DuotoneGroup.`Screencast-duotone`: ImageVector
    get() {
        if (`_screencast-duotone` != null) {
            return `_screencast-duotone`!!
        }
        `_screencast-duotone` = Builder(name = "Screencast-duotone", defaultWidth = 256.0.dp,
...
private var `_screencast-duotone`: ImageVector? = null
