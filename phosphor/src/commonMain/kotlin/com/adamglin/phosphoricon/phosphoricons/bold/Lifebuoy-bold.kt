...
public val BoldGroup.`Lifebuoy-bold`: ImageVector
    get() {
        if (`_lifebuoy-bold` != null) {
            return `_lifebuoy-bold`!!
        }
        `_lifebuoy-bold` = Builder(name = "Lifebuoy-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lifebuoy-bold`: ImageVector? = null
