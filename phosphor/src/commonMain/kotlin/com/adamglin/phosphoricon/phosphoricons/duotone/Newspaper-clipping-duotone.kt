...
public val DuotoneGroup.`Newspaper-clipping-duotone`: ImageVector
    get() {
        if (`_newspaper-clipping-duotone` != null) {
            return `_newspaper-clipping-duotone`!!
        }
        `_newspaper-clipping-duotone` = Builder(name = "Newspaper-clipping-duotone", defaultWidth =
...
private var `_newspaper-clipping-duotone`: ImageVector? = null
