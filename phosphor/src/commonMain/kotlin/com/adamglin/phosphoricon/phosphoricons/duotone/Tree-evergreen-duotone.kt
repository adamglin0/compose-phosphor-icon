...
public val DuotoneGroup.`Tree-evergreen-duotone`: ImageVector
    get() {
        if (`_tree-evergreen-duotone` != null) {
            return `_tree-evergreen-duotone`!!
        }
        `_tree-evergreen-duotone` = Builder(name = "Tree-evergreen-duotone", defaultWidth =
...
private var `_tree-evergreen-duotone`: ImageVector? = null
