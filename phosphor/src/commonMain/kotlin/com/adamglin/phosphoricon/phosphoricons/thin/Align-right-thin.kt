...
public val ThinGroup.`Align-right-thin`: ImageVector
    get() {
        if (`_align-right-thin` != null) {
            return `_align-right-thin`!!
        }
        `_align-right-thin` = Builder(name = "Align-right-thin", defaultWidth = 256.0.dp,
...
private var `_align-right-thin`: ImageVector? = null
