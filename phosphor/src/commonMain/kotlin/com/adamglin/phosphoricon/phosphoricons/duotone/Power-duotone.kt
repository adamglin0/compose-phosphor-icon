...
public val DuotoneGroup.`Power-duotone`: ImageVector
    get() {
        if (`_power-duotone` != null) {
            return `_power-duotone`!!
        }
        `_power-duotone` = Builder(name = "Power-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_power-duotone`: ImageVector? = null
