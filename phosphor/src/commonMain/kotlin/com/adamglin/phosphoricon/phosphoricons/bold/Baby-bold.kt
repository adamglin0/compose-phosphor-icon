...
public val BoldGroup.`Baby-bold`: ImageVector
    get() {
        if (`_baby-bold` != null) {
            return `_baby-bold`!!
        }
        `_baby-bold` = Builder(name = "Baby-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_baby-bold`: ImageVector? = null
