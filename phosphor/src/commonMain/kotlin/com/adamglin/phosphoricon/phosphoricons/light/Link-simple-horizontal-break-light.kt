...
public val LightGroup.`Link-simple-horizontal-break-light`: ImageVector
    get() {
        if (`_link-simple-horizontal-break-light` != null) {
            return `_link-simple-horizontal-break-light`!!
        }
        `_link-simple-horizontal-break-light` = Builder(name = "Link-simple-horizontal-break-light",
...
private var `_link-simple-horizontal-break-light`: ImageVector? = null
