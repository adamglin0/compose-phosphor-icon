...
public val ThinGroup.`Currency-ngn-thin`: ImageVector
    get() {
        if (`_currency-ngn-thin` != null) {
            return `_currency-ngn-thin`!!
        }
        `_currency-ngn-thin` = Builder(name = "Currency-ngn-thin", defaultWidth = 256.0.dp,
...
private var `_currency-ngn-thin`: ImageVector? = null
