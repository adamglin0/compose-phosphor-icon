...
public val DuotoneGroup.`Planet-duotone`: ImageVector
    get() {
        if (`_planet-duotone` != null) {
            return `_planet-duotone`!!
        }
        `_planet-duotone` = Builder(name = "Planet-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_planet-duotone`: ImageVector? = null
