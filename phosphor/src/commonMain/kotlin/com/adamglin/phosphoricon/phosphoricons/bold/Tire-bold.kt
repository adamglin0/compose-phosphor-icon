...
public val BoldGroup.`Tire-bold`: ImageVector
    get() {
        if (`_tire-bold` != null) {
            return `_tire-bold`!!
        }
        `_tire-bold` = Builder(name = "Tire-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tire-bold`: ImageVector? = null
