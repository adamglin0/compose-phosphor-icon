...
public val LightGroup.`Pill-light`: ImageVector
    get() {
        if (`_pill-light` != null) {
            return `_pill-light`!!
        }
        `_pill-light` = Builder(name = "Pill-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pill-light`: ImageVector? = null
