...
public val ThinGroup.`Google-play-logo-thin`: ImageVector
    get() {
        if (`_google-play-logo-thin` != null) {
            return `_google-play-logo-thin`!!
        }
        `_google-play-logo-thin` = Builder(name = "Google-play-logo-thin", defaultWidth = 256.0.dp,
...
private var `_google-play-logo-thin`: ImageVector? = null
