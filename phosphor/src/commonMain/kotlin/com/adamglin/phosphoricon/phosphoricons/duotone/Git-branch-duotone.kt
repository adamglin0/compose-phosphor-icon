...
public val DuotoneGroup.`Git-branch-duotone`: ImageVector
    get() {
        if (`_git-branch-duotone` != null) {
            return `_git-branch-duotone`!!
        }
        `_git-branch-duotone` = Builder(name = "Git-branch-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(24.0f, 24.0f, 0.0f, false, true, 224.0f, 64.0f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(200.0f, 80.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, 16.0f, -16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 200.0f, 80.0f)
                close()
            }
        }
        .build()
...
private var `_git-branch-duotone`: ImageVector? = null
