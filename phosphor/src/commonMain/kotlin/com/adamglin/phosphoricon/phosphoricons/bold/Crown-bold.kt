...
public val BoldGroup.`Crown-bold`: ImageVector
    get() {
        if (`_crown-bold` != null) {
            return `_crown-bold`!!
        }
        `_crown-bold` = Builder(name = "Crown-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_crown-bold`: ImageVector? = null
