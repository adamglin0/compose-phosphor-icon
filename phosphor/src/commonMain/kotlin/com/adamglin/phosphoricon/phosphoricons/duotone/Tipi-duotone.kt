...
public val DuotoneGroup.`Tipi-duotone`: ImageVector
    get() {
        if (`_tipi-duotone` != null) {
            return `_tipi-duotone`!!
        }
        `_tipi-duotone` = Builder(name = "Tipi-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tipi-duotone`: ImageVector? = null
