...
public val DuotoneGroup.`Battery-vertical-full-duotone`: ImageVector
    get() {
        if (`_battery-vertical-full-duotone` != null) {
            return `_battery-vertical-full-duotone`!!
        }
        `_battery-vertical-full-duotone` = Builder(name = "Battery-vertical-full-duotone",
...
private var `_battery-vertical-full-duotone`: ImageVector? = null
