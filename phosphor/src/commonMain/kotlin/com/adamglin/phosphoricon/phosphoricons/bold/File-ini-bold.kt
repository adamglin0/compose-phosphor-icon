...
public val BoldGroup.`File-ini-bold`: ImageVector
    get() {
        if (`_file-ini-bold` != null) {
            return `_file-ini-bold`!!
        }
        `_file-ini-bold` = Builder(name = "File-ini-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-ini-bold`: ImageVector? = null
