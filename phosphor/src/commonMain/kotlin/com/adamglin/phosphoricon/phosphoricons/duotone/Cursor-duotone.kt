...
public val DuotoneGroup.`Cursor-duotone`: ImageVector
    get() {
        if (`_cursor-duotone` != null) {
            return `_cursor-duotone`!!
        }
        `_cursor-duotone` = Builder(name = "Cursor-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cursor-duotone`: ImageVector? = null
