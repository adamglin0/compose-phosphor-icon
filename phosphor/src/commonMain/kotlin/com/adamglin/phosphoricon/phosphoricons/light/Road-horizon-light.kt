...
public val LightGroup.`Road-horizon-light`: ImageVector
    get() {
        if (`_road-horizon-light` != null) {
            return `_road-horizon-light`!!
        }
        `_road-horizon-light` = Builder(name = "Road-horizon-light", defaultWidth = 256.0.dp,
...
private var `_road-horizon-light`: ImageVector? = null
