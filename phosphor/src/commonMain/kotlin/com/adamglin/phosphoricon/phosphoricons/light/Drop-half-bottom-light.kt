...
public val LightGroup.`Drop-half-bottom-light`: ImageVector
    get() {
        if (`_drop-half-bottom-light` != null) {
            return `_drop-half-bottom-light`!!
        }
        `_drop-half-bottom-light` = Builder(name = "Drop-half-bottom-light", defaultWidth =
...
private var `_drop-half-bottom-light`: ImageVector? = null
