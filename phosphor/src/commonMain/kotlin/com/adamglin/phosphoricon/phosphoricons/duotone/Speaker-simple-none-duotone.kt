...
public val DuotoneGroup.`Speaker-simple-none-duotone`: ImageVector
    get() {
        if (`_speaker-simple-none-duotone` != null) {
            return `_speaker-simple-none-duotone`!!
        }
        `_speaker-simple-none-duotone` = Builder(name = "Speaker-simple-none-duotone", defaultWidth
...
private var `_speaker-simple-none-duotone`: ImageVector? = null
