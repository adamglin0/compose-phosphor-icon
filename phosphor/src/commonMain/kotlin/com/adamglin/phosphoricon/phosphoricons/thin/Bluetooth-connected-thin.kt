...
public val ThinGroup.`Bluetooth-connected-thin`: ImageVector
    get() {
        if (`_bluetooth-connected-thin` != null) {
            return `_bluetooth-connected-thin`!!
        }
        `_bluetooth-connected-thin` = Builder(name = "Bluetooth-connected-thin", defaultWidth =
...
private var `_bluetooth-connected-thin`: ImageVector? = null
