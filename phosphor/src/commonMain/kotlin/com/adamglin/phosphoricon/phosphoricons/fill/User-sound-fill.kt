...
public val FillGroup.`User-sound-fill`: ImageVector
    get() {
        if (`_user-sound-fill` != null) {
            return `_user-sound-fill`!!
        }
        `_user-sound-fill` = Builder(name = "User-sound-fill", defaultWidth = 256.0.dp,
...
private var `_user-sound-fill`: ImageVector? = null
