...
public val ThinGroup.`Align-bottom-thin`: ImageVector
    get() {
        if (`_align-bottom-thin` != null) {
            return `_align-bottom-thin`!!
        }
        `_align-bottom-thin` = Builder(name = "Align-bottom-thin", defaultWidth = 256.0.dp,
...
private var `_align-bottom-thin`: ImageVector? = null
