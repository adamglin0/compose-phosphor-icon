...
public val FillGroup.`Wave-sine-fill`: ImageVector
    get() {
        if (`_wave-sine-fill` != null) {
            return `_wave-sine-fill`!!
        }
        `_wave-sine-fill` = Builder(name = "Wave-sine-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_wave-sine-fill`: ImageVector? = null
