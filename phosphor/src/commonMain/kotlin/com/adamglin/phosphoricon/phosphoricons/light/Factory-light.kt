...
public val LightGroup.`Factory-light`: ImageVector
    get() {
        if (`_factory-light` != null) {
            return `_factory-light`!!
        }
        `_factory-light` = Builder(name = "Factory-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_factory-light`: ImageVector? = null
