...
public val LightGroup.`Push-pin-light`: ImageVector
    get() {
        if (`_push-pin-light` != null) {
            return `_push-pin-light`!!
        }
        `_push-pin-light` = Builder(name = "Push-pin-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_push-pin-light`: ImageVector? = null
