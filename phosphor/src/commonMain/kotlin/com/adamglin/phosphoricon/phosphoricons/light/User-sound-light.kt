...
public val LightGroup.`User-sound-light`: ImageVector
    get() {
        if (`_user-sound-light` != null) {
            return `_user-sound-light`!!
        }
        `_user-sound-light` = Builder(name = "User-sound-light", defaultWidth = 256.0.dp,
...
private var `_user-sound-light`: ImageVector? = null
