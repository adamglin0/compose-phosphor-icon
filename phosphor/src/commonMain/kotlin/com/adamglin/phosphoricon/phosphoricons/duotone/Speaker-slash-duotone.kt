...
public val DuotoneGroup.`Speaker-slash-duotone`: ImageVector
    get() {
        if (`_speaker-slash-duotone` != null) {
            return `_speaker-slash-duotone`!!
        }
        `_speaker-slash-duotone` = Builder(name = "Speaker-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_speaker-slash-duotone`: ImageVector? = null
