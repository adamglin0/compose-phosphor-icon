...
public val BoldGroup.`Heart-bold`: ImageVector
    get() {
        if (`_heart-bold` != null) {
            return `_heart-bold`!!
        }
        `_heart-bold` = Builder(name = "Heart-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_heart-bold`: ImageVector? = null
