...
public val ThinGroup.`First-aid-kit-thin`: ImageVector
    get() {
        if (`_first-aid-kit-thin` != null) {
            return `_first-aid-kit-thin`!!
        }
        `_first-aid-kit-thin` = Builder(name = "First-aid-kit-thin", defaultWidth = 256.0.dp,
...
private var `_first-aid-kit-thin`: ImageVector? = null
