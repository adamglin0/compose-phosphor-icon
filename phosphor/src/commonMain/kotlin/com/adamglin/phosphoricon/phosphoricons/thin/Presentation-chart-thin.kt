...
public val ThinGroup.`Presentation-chart-thin`: ImageVector
    get() {
        if (`_presentation-chart-thin` != null) {
            return `_presentation-chart-thin`!!
        }
        `_presentation-chart-thin` = Builder(name = "Presentation-chart-thin", defaultWidth =
...
private var `_presentation-chart-thin`: ImageVector? = null
