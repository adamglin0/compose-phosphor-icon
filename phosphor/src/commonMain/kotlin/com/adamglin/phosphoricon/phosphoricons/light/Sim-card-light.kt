...
public val LightGroup.`Sim-card-light`: ImageVector
    get() {
        if (`_sim-card-light` != null) {
            return `_sim-card-light`!!
        }
        `_sim-card-light` = Builder(name = "Sim-card-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_sim-card-light`: ImageVector? = null
