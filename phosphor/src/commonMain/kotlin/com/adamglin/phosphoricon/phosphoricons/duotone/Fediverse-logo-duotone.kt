...
public val DuotoneGroup.`Fediverse-logo-duotone`: ImageVector
    get() {
        if (`_fediverse-logo-duotone` != null) {
            return `_fediverse-logo-duotone`!!
        }
        `_fediverse-logo-duotone` = Builder(name = "Fediverse-logo-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(20.0f, 20.0f, 0.0f, false, false, 212.0f, 104.0f)
                close()
                moveTo(156.0f, 192.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, false, 20.0f, 20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 156.0f, 192.0f)
                close()
                moveTo(56.0f, 164.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, false, 20.0f, 20.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 56.0f, 164.0f)
                close()
                moveTo(52.0f, 104.0f)
                arcTo(20.0f, 20.0f, 0.0f, true, false, 32.0f, 84.0f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 52.0f, 104.0f)
                close()
            }
...
private var `_fediverse-logo-duotone`: ImageVector? = null
