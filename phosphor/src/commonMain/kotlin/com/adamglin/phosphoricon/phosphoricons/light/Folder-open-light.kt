...
public val LightGroup.`Folder-open-light`: ImageVector
    get() {
        if (`_folder-open-light` != null) {
            return `_folder-open-light`!!
        }
        `_folder-open-light` = Builder(name = "Folder-open-light", defaultWidth = 256.0.dp,
...
private var `_folder-open-light`: ImageVector? = null
