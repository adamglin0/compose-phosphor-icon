...
public val BoldGroup.`Toggle-right-bold`: ImageVector
    get() {
        if (`_toggle-right-bold` != null) {
            return `_toggle-right-bold`!!
        }
        `_toggle-right-bold` = Builder(name = "Toggle-right-bold", defaultWidth = 256.0.dp,
...
private var `_toggle-right-bold`: ImageVector? = null
