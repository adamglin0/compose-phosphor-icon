...
public val LightGroup.`Selection-plus-light`: ImageVector
    get() {
        if (`_selection-plus-light` != null) {
            return `_selection-plus-light`!!
        }
        `_selection-plus-light` = Builder(name = "Selection-plus-light", defaultWidth = 256.0.dp,
...
private var `_selection-plus-light`: ImageVector? = null
