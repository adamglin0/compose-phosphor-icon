...
public val ThinGroup.`User-gear-thin`: ImageVector
    get() {
        if (`_user-gear-thin` != null) {
            return `_user-gear-thin`!!
        }
        `_user-gear-thin` = Builder(name = "User-gear-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_user-gear-thin`: ImageVector? = null
