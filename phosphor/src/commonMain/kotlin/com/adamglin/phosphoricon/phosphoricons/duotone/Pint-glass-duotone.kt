...
public val DuotoneGroup.`Pint-glass-duotone`: ImageVector
    get() {
        if (`_pint-glass-duotone` != null) {
            return `_pint-glass-duotone`!!
        }
        `_pint-glass-duotone` = Builder(name = "Pint-glass-duotone", defaultWidth = 256.0.dp,
...
private var `_pint-glass-duotone`: ImageVector? = null
