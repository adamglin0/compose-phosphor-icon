...
public val DuotoneGroup.`Diamond-duotone`: ImageVector
    get() {
        if (`_diamond-duotone` != null) {
            return `_diamond-duotone`!!
        }
        `_diamond-duotone` = Builder(name = "Diamond-duotone", defaultWidth = 256.0.dp,
...
private var `_diamond-duotone`: ImageVector? = null
