...
public val DuotoneGroup.`Align-center-vertical-duotone`: ImageVector
    get() {
        if (`_align-center-vertical-duotone` != null) {
            return `_align-center-vertical-duotone`!!
        }
        `_align-center-vertical-duotone` = Builder(name = "Align-center-vertical-duotone",
...
private var `_align-center-vertical-duotone`: ImageVector? = null
