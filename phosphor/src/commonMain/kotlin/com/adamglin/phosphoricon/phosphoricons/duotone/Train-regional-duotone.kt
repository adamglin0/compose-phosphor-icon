...
public val DuotoneGroup.`Train-regional-duotone`: ImageVector
    get() {
        if (`_train-regional-duotone` != null) {
            return `_train-regional-duotone`!!
        }
        `_train-regional-duotone` = Builder(name = "Train-regional-duotone", defaultWidth =
...
private var `_train-regional-duotone`: ImageVector? = null
