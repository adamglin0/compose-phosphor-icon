...
public val LightGroup.`Coat-hanger-light`: ImageVector
    get() {
        if (`_coat-hanger-light` != null) {
            return `_coat-hanger-light`!!
        }
        `_coat-hanger-light` = Builder(name = "Coat-hanger-light", defaultWidth = 256.0.dp,
...
private var `_coat-hanger-light`: ImageVector? = null
