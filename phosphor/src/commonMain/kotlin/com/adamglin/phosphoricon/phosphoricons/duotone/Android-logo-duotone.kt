...
public val DuotoneGroup.`Android-logo-duotone`: ImageVector
    get() {
        if (`_android-logo-duotone` != null) {
            return `_android-logo-duotone`!!
        }
        `_android-logo-duotone` = Builder(name = "Android-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_android-logo-duotone`: ImageVector? = null
