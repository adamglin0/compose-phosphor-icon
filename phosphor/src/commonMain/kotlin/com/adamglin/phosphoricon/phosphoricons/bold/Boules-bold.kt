...
public val BoldGroup.`Boules-bold`: ImageVector
    get() {
        if (`_boules-bold` != null) {
            return `_boules-bold`!!
        }
        `_boules-bold` = Builder(name = "Boules-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_boules-bold`: ImageVector? = null
