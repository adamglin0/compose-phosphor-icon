...
public val ThinGroup.`Spotify-logo-thin`: ImageVector
    get() {
        if (`_spotify-logo-thin` != null) {
            return `_spotify-logo-thin`!!
        }
        `_spotify-logo-thin` = Builder(name = "Spotify-logo-thin", defaultWidth = 256.0.dp,
...
private var `_spotify-logo-thin`: ImageVector? = null
