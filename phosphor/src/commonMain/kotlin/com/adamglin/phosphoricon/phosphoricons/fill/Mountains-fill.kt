...
public val FillGroup.`Mountains-fill`: ImageVector
    get() {
        if (`_mountains-fill` != null) {
            return `_mountains-fill`!!
        }
        `_mountains-fill` = Builder(name = "Mountains-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_mountains-fill`: ImageVector? = null
