...
public val DuotoneGroup.`Crosshair-simple-duotone`: ImageVector
    get() {
        if (`_crosshair-simple-duotone` != null) {
            return `_crosshair-simple-duotone`!!
        }
        `_crosshair-simple-duotone` = Builder(name = "Crosshair-simple-duotone", defaultWidth =
...
private var `_crosshair-simple-duotone`: ImageVector? = null
