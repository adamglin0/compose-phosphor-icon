...
public val DuotoneGroup.`Presentation-chart-duotone`: ImageVector
    get() {
        if (`_presentation-chart-duotone` != null) {
            return `_presentation-chart-duotone`!!
        }
        `_presentation-chart-duotone` = Builder(name = "Presentation-chart-duotone", defaultWidth =
...
private var `_presentation-chart-duotone`: ImageVector? = null
