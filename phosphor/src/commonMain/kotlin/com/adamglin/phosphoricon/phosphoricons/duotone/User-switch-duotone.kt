...
public val DuotoneGroup.`User-switch-duotone`: ImageVector
    get() {
        if (`_user-switch-duotone` != null) {
            return `_user-switch-duotone`!!
        }
        `_user-switch-duotone` = Builder(name = "User-switch-duotone", defaultWidth = 256.0.dp,
...
private var `_user-switch-duotone`: ImageVector? = null
