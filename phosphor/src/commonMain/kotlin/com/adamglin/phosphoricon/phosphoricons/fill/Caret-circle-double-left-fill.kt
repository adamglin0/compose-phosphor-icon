...
public val FillGroup.`Caret-circle-double-left-fill`: ImageVector
    get() {
        if (`_caret-circle-double-left-fill` != null) {
            return `_caret-circle-double-left-fill`!!
        }
        `_caret-circle-double-left-fill` = Builder(name = "Caret-circle-double-left-fill",
...
private var `_caret-circle-double-left-fill`: ImageVector? = null
