...
public val LightGroup.`Not-subset-of-light`: ImageVector
    get() {
        if (`_not-subset-of-light` != null) {
            return `_not-subset-of-light`!!
        }
        `_not-subset-of-light` = Builder(name = "Not-subset-of-light", defaultWidth = 256.0.dp,
...
private var `_not-subset-of-light`: ImageVector? = null
