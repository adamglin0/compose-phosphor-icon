...
public val DuotoneGroup.`Address-book-tabs-duotone`: ImageVector
    get() {
        if (`_address-book-tabs-duotone` != null) {
            return `_address-book-tabs-duotone`!!
        }
        `_address-book-tabs-duotone` = Builder(name = "Address-book-tabs-duotone", defaultWidth =
...
private var `_address-book-tabs-duotone`: ImageVector? = null
