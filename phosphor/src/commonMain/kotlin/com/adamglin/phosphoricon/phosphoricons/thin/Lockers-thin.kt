...
public val ThinGroup.`Lockers-thin`: ImageVector
    get() {
        if (`_lockers-thin` != null) {
            return `_lockers-thin`!!
        }
        `_lockers-thin` = Builder(name = "Lockers-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lockers-thin`: ImageVector? = null
