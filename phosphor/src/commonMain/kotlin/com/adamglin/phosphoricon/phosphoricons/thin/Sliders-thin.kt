...
public val ThinGroup.`Sliders-thin`: ImageVector
    get() {
        if (`_sliders-thin` != null) {
            return `_sliders-thin`!!
        }
        `_sliders-thin` = Builder(name = "Sliders-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sliders-thin`: ImageVector? = null
