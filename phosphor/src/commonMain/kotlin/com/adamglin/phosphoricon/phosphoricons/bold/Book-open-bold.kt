...
public val BoldGroup.`Book-open-bold`: ImageVector
    get() {
        if (`_book-open-bold` != null) {
            return `_book-open-bold`!!
        }
        `_book-open-bold` = Builder(name = "Book-open-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_book-open-bold`: ImageVector? = null
