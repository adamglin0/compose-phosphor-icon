...
public val LightGroup.`Fish-light`: ImageVector
    get() {
        if (`_fish-light` != null) {
            return `_fish-light`!!
        }
        `_fish-light` = Builder(name = "Fish-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fish-light`: ImageVector? = null
