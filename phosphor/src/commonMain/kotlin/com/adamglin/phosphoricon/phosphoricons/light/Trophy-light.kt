...
public val LightGroup.`Trophy-light`: ImageVector
    get() {
        if (`_trophy-light` != null) {
            return `_trophy-light`!!
        }
        `_trophy-light` = Builder(name = "Trophy-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_trophy-light`: ImageVector? = null
