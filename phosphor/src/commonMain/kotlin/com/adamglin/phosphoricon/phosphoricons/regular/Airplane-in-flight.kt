...
public val RegularGroup.`Airplane-in-flight`: ImageVector
    get() {
        if (`_airplane-in-flight` != null) {
            return `_airplane-in-flight`!!
        }
        `_airplane-in-flight` = Builder(name = "Airplane-in-flight", defaultWidth = 256.0.dp,
...
private var `_airplane-in-flight`: ImageVector? = null
