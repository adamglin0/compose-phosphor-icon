...
public val RegularGroup.`Git-diff`: ImageVector
    get() {
        if (`_git-diff` != null) {
            return `_git-diff`!!
        }
        `_git-diff` = Builder(name = "Git-diff", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_git-diff`: ImageVector? = null
