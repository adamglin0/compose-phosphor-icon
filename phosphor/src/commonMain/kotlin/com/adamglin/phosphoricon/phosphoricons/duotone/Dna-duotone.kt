...
public val DuotoneGroup.`Dna-duotone`: ImageVector
    get() {
        if (`_dna-duotone` != null) {
            return `_dna-duotone`!!
        }
        `_dna-duotone` = Builder(name = "Dna-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dna-duotone`: ImageVector? = null
