...
public val DuotoneGroup.`Security-camera-duotone`: ImageVector
    get() {
        if (`_security-camera-duotone` != null) {
            return `_security-camera-duotone`!!
        }
        `_security-camera-duotone` = Builder(name = "Security-camera-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(52.69f, 168.0f)
                lineTo(184.0f, 36.69f)
                lineToRelative(37.66f, 37.65f)
...
private var `_security-camera-duotone`: ImageVector? = null
