...
public val FillGroup.`File-arrow-down-fill`: ImageVector
    get() {
        if (`_file-arrow-down-fill` != null) {
            return `_file-arrow-down-fill`!!
        }
        `_file-arrow-down-fill` = Builder(name = "File-arrow-down-fill", defaultWidth = 256.0.dp,
...
private var `_file-arrow-down-fill`: ImageVector? = null
