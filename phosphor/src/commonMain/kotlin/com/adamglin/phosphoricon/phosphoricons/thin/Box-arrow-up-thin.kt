...
public val ThinGroup.`Box-arrow-up-thin`: ImageVector
    get() {
        if (`_box-arrow-up-thin` != null) {
            return `_box-arrow-up-thin`!!
        }
        `_box-arrow-up-thin` = Builder(name = "Box-arrow-up-thin", defaultWidth = 256.0.dp,
...
private var `_box-arrow-up-thin`: ImageVector? = null
