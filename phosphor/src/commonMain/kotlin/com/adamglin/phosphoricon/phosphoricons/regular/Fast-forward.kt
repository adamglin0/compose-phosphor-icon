...
public val RegularGroup.`Fast-forward`: ImageVector
    get() {
        if (`_fast-forward` != null) {
            return `_fast-forward`!!
        }
        `_fast-forward` = Builder(name = "Fast-forward", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fast-forward`: ImageVector? = null
