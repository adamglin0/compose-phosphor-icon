...
public val DuotoneGroup.`Git-fork-duotone`: ImageVector
    get() {
        if (`_git-fork-duotone` != null) {
            return `_git-fork-duotone`!!
        }
        `_git-fork-duotone` = Builder(name = "Git-fork-duotone", defaultWidth = 256.0.dp,
...
private var `_git-fork-duotone`: ImageVector? = null
