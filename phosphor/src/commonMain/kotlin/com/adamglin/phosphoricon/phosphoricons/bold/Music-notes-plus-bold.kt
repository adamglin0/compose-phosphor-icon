...
public val BoldGroup.`Music-notes-plus-bold`: ImageVector
    get() {
        if (`_music-notes-plus-bold` != null) {
            return `_music-notes-plus-bold`!!
        }
        `_music-notes-plus-bold` = Builder(name = "Music-notes-plus-bold", defaultWidth = 256.0.dp,
...
private var `_music-notes-plus-bold`: ImageVector? = null
