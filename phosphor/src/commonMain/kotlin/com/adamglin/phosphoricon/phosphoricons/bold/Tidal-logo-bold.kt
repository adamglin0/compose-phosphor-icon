...
public val BoldGroup.`Tidal-logo-bold`: ImageVector
    get() {
        if (`_tidal-logo-bold` != null) {
            return `_tidal-logo-bold`!!
        }
        `_tidal-logo-bold` = Builder(name = "Tidal-logo-bold", defaultWidth = 256.0.dp,
...
private var `_tidal-logo-bold`: ImageVector? = null
