...
public val BoldGroup.`Number-square-zero-bold`: ImageVector
    get() {
        if (`_number-square-zero-bold` != null) {
            return `_number-square-zero-bold`!!
        }
        `_number-square-zero-bold` = Builder(name = "Number-square-zero-bold", defaultWidth =
...
private var `_number-square-zero-bold`: ImageVector? = null
