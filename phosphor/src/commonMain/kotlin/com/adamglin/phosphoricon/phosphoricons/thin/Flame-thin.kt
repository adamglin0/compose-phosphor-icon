...
public val ThinGroup.`Flame-thin`: ImageVector
    get() {
        if (`_flame-thin` != null) {
            return `_flame-thin`!!
        }
        `_flame-thin` = Builder(name = "Flame-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flame-thin`: ImageVector? = null
