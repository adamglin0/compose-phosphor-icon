...
public val BoldGroup.`Music-note-simple-bold`: ImageVector
    get() {
        if (`_music-note-simple-bold` != null) {
            return `_music-note-simple-bold`!!
        }
        `_music-note-simple-bold` = Builder(name = "Music-note-simple-bold", defaultWidth =
...
private var `_music-note-simple-bold`: ImageVector? = null
