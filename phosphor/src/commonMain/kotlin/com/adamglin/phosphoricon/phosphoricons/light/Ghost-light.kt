...
public val LightGroup.`Ghost-light`: ImageVector
    get() {
        if (`_ghost-light` != null) {
            return `_ghost-light`!!
        }
        `_ghost-light` = Builder(name = "Ghost-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ghost-light`: ImageVector? = null
