...
public val FillGroup.`Cricket-fill`: ImageVector
    get() {
        if (`_cricket-fill` != null) {
            return `_cricket-fill`!!
        }
        `_cricket-fill` = Builder(name = "Cricket-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cricket-fill`: ImageVector? = null
