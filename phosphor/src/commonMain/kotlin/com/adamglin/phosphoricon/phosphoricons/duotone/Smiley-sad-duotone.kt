...
public val DuotoneGroup.`Smiley-sad-duotone`: ImageVector
    get() {
        if (`_smiley-sad-duotone` != null) {
            return `_smiley-sad-duotone`!!
        }
        `_smiley-sad-duotone` = Builder(name = "Smiley-sad-duotone", defaultWidth = 256.0.dp,
...
private var `_smiley-sad-duotone`: ImageVector? = null
