...
public val ThinGroup.`Arrows-out-cardinal-thin`: ImageVector
    get() {
        if (`_arrows-out-cardinal-thin` != null) {
            return `_arrows-out-cardinal-thin`!!
        }
        `_arrows-out-cardinal-thin` = Builder(name = "Arrows-out-cardinal-thin", defaultWidth =
...
private var `_arrows-out-cardinal-thin`: ImageVector? = null
