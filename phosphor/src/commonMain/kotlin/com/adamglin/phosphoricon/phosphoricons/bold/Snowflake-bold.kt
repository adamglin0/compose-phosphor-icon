...
public val BoldGroup.`Snowflake-bold`: ImageVector
    get() {
        if (`_snowflake-bold` != null) {
            return `_snowflake-bold`!!
        }
        `_snowflake-bold` = Builder(name = "Snowflake-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_snowflake-bold`: ImageVector? = null
