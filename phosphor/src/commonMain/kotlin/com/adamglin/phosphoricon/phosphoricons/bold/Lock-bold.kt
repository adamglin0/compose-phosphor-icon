...
public val BoldGroup.`Lock-bold`: ImageVector
    get() {
        if (`_lock-bold` != null) {
            return `_lock-bold`!!
        }
        `_lock-bold` = Builder(name = "Lock-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-bold`: ImageVector? = null
