...
public val RegularGroup.`Folder-simple-minus`: ImageVector
    get() {
        if (`_folder-simple-minus` != null) {
            return `_folder-simple-minus`!!
        }
        `_folder-simple-minus` = Builder(name = "Folder-simple-minus", defaultWidth = 256.0.dp,
...
private var `_folder-simple-minus`: ImageVector? = null
