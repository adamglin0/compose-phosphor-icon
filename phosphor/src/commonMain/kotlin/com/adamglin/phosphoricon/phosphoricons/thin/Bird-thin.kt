...
public val ThinGroup.`Bird-thin`: ImageVector
    get() {
        if (`_bird-thin` != null) {
            return `_bird-thin`!!
        }
        `_bird-thin` = Builder(name = "Bird-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bird-thin`: ImageVector? = null
