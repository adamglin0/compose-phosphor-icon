...
public val BoldGroup.`Suitcase-bold`: ImageVector
    get() {
        if (`_suitcase-bold` != null) {
            return `_suitcase-bold`!!
        }
        `_suitcase-bold` = Builder(name = "Suitcase-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_suitcase-bold`: ImageVector? = null
