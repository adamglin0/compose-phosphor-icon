...
public val LightGroup.`Square-logo-light`: ImageVector
    get() {
        if (`_square-logo-light` != null) {
            return `_square-logo-light`!!
        }
        `_square-logo-light` = Builder(name = "Square-logo-light", defaultWidth = 256.0.dp,
...
private var `_square-logo-light`: ImageVector? = null
