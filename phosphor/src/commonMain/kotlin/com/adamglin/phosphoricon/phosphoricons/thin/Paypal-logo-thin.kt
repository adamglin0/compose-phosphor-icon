...
public val ThinGroup.`Paypal-logo-thin`: ImageVector
    get() {
        if (`_paypal-logo-thin` != null) {
            return `_paypal-logo-thin`!!
        }
        `_paypal-logo-thin` = Builder(name = "Paypal-logo-thin", defaultWidth = 256.0.dp,
...
private var `_paypal-logo-thin`: ImageVector? = null
