...
public val LightGroup.`High-heel-light`: ImageVector
    get() {
        if (`_high-heel-light` != null) {
            return `_high-heel-light`!!
        }
        `_high-heel-light` = Builder(name = "High-heel-light", defaultWidth = 256.0.dp,
...
private var `_high-heel-light`: ImageVector? = null
