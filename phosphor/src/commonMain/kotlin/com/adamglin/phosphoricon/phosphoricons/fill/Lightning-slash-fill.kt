...
public val FillGroup.`Lightning-slash-fill`: ImageVector
    get() {
        if (`_lightning-slash-fill` != null) {
            return `_lightning-slash-fill`!!
        }
        `_lightning-slash-fill` = Builder(name = "Lightning-slash-fill", defaultWidth = 256.0.dp,
...
private var `_lightning-slash-fill`: ImageVector? = null
