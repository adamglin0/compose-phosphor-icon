...
public val DuotoneGroup.`Shipping-container-duotone`: ImageVector
    get() {
        if (`_shipping-container-duotone` != null) {
            return `_shipping-container-duotone`!!
        }
        `_shipping-container-duotone` = Builder(name = "Shipping-container-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -5.8f, 7.69f)
                lineTo(128.0f, 208.0f)
                verticalLineTo(48.0f)
                lineTo(234.2f, 78.34f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 240.0f, 86.0f)
                close()
            }
...
private var `_shipping-container-duotone`: ImageVector? = null
