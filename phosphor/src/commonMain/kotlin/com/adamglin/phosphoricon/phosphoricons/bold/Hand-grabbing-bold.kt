...
public val BoldGroup.`Hand-grabbing-bold`: ImageVector
    get() {
        if (`_hand-grabbing-bold` != null) {
            return `_hand-grabbing-bold`!!
        }
        `_hand-grabbing-bold` = Builder(name = "Hand-grabbing-bold", defaultWidth = 256.0.dp,
...
private var `_hand-grabbing-bold`: ImageVector? = null
