...
public val DuotoneGroup.`Cell-tower-duotone`: ImageVector
    get() {
        if (`_cell-tower-duotone` != null) {
            return `_cell-tower-duotone`!!
        }
        `_cell-tower-duotone` = Builder(name = "Cell-tower-duotone", defaultWidth = 256.0.dp,
...
private var `_cell-tower-duotone`: ImageVector? = null
