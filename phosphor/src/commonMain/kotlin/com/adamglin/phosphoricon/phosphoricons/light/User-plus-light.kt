...
public val LightGroup.`User-plus-light`: ImageVector
    get() {
        if (`_user-plus-light` != null) {
            return `_user-plus-light`!!
        }
        `_user-plus-light` = Builder(name = "User-plus-light", defaultWidth = 256.0.dp,
...
private var `_user-plus-light`: ImageVector? = null
