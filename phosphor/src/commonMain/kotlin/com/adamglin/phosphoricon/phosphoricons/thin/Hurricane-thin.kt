...
public val ThinGroup.`Hurricane-thin`: ImageVector
    get() {
        if (`_hurricane-thin` != null) {
            return `_hurricane-thin`!!
        }
        `_hurricane-thin` = Builder(name = "Hurricane-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hurricane-thin`: ImageVector? = null
