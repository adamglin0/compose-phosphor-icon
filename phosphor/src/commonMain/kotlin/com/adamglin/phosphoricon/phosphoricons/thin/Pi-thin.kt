...
public val ThinGroup.`Pi-thin`: ImageVector
    get() {
        if (`_pi-thin` != null) {
            return `_pi-thin`!!
        }
        `_pi-thin` = Builder(name = "Pi-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_pi-thin`: ImageVector? = null
