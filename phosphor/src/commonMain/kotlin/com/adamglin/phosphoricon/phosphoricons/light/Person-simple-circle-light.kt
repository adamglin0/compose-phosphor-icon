...
public val LightGroup.`Person-simple-circle-light`: ImageVector
    get() {
        if (`_person-simple-circle-light` != null) {
            return `_person-simple-circle-light`!!
        }
        `_person-simple-circle-light` = Builder(name = "Person-simple-circle-light", defaultWidth =
...
private var `_person-simple-circle-light`: ImageVector? = null
