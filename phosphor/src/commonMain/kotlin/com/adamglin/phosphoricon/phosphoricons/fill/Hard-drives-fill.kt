...
public val FillGroup.`Hard-drives-fill`: ImageVector
    get() {
        if (`_hard-drives-fill` != null) {
            return `_hard-drives-fill`!!
        }
        `_hard-drives-fill` = Builder(name = "Hard-drives-fill", defaultWidth = 256.0.dp,
...
private var `_hard-drives-fill`: ImageVector? = null
