...
public val DuotoneGroup.`Circle-dashed-duotone`: ImageVector
    get() {
        if (`_circle-dashed-duotone` != null) {
            return `_circle-dashed-duotone`!!
        }
        `_circle-dashed-duotone` = Builder(name = "Circle-dashed-duotone", defaultWidth = 256.0.dp,
...
private var `_circle-dashed-duotone`: ImageVector? = null
