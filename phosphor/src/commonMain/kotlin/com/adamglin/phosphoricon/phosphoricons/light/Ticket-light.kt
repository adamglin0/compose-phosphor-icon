...
public val LightGroup.`Ticket-light`: ImageVector
    get() {
        if (`_ticket-light` != null) {
            return `_ticket-light`!!
        }
        `_ticket-light` = Builder(name = "Ticket-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ticket-light`: ImageVector? = null
