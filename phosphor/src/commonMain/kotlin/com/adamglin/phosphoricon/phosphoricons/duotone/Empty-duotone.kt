...
public val DuotoneGroup.`Empty-duotone`: ImageVector
    get() {
        if (`_empty-duotone` != null) {
            return `_empty-duotone`!!
        }
        `_empty-duotone` = Builder(name = "Empty-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_empty-duotone`: ImageVector? = null
