...
public val ThinGroup.`Buildings-thin`: ImageVector
    get() {
        if (`_buildings-thin` != null) {
            return `_buildings-thin`!!
        }
        `_buildings-thin` = Builder(name = "Buildings-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_buildings-thin`: ImageVector? = null
