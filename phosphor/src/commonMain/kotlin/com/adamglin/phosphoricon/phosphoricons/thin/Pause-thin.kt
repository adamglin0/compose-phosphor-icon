...
public val ThinGroup.`Pause-thin`: ImageVector
    get() {
        if (`_pause-thin` != null) {
            return `_pause-thin`!!
        }
        `_pause-thin` = Builder(name = "Pause-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pause-thin`: ImageVector? = null
