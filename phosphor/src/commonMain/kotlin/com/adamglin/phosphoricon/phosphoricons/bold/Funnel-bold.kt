...
public val BoldGroup.`Funnel-bold`: ImageVector
    get() {
        if (`_funnel-bold` != null) {
            return `_funnel-bold`!!
        }
        `_funnel-bold` = Builder(name = "Funnel-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_funnel-bold`: ImageVector? = null
