...
public val LightGroup.`Skip-forward-light`: ImageVector
    get() {
        if (`_skip-forward-light` != null) {
            return `_skip-forward-light`!!
        }
        `_skip-forward-light` = Builder(name = "Skip-forward-light", defaultWidth = 256.0.dp,
...
private var `_skip-forward-light`: ImageVector? = null
