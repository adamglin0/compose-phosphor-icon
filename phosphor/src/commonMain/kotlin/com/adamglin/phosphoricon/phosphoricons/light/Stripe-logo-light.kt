...
public val LightGroup.`Stripe-logo-light`: ImageVector
    get() {
        if (`_stripe-logo-light` != null) {
            return `_stripe-logo-light`!!
        }
        `_stripe-logo-light` = Builder(name = "Stripe-logo-light", defaultWidth = 256.0.dp,
...
private var `_stripe-logo-light`: ImageVector? = null
