...
public val RegularGroup.`Handbag-simple`: ImageVector
    get() {
        if (`_handbag-simple` != null) {
            return `_handbag-simple`!!
        }
        `_handbag-simple` = Builder(name = "Handbag-simple", defaultWidth = 256.0.dp, defaultHeight
...
private var `_handbag-simple`: ImageVector? = null
