...
public val ThinGroup.`Image-thin`: ImageVector
    get() {
        if (`_image-thin` != null) {
            return `_image-thin`!!
        }
        `_image-thin` = Builder(name = "Image-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_image-thin`: ImageVector? = null
