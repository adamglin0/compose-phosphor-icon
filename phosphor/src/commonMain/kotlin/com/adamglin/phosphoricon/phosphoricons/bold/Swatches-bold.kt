...
public val BoldGroup.`Swatches-bold`: ImageVector
    get() {
        if (`_swatches-bold` != null) {
            return `_swatches-bold`!!
        }
        `_swatches-bold` = Builder(name = "Swatches-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_swatches-bold`: ImageVector? = null
