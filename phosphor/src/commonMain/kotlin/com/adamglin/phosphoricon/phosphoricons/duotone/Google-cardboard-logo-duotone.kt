...
public val DuotoneGroup.`Google-cardboard-logo-duotone`: ImageVector
    get() {
        if (`_google-cardboard-logo-duotone` != null) {
            return `_google-cardboard-logo-duotone`!!
        }
        `_google-cardboard-logo-duotone` = Builder(name = "Google-cardboard-logo-duotone",
...
private var `_google-cardboard-logo-duotone`: ImageVector? = null
