...
public val ThinGroup.`Warning-diamond-thin`: ImageVector
    get() {
        if (`_warning-diamond-thin` != null) {
            return `_warning-diamond-thin`!!
        }
        `_warning-diamond-thin` = Builder(name = "Warning-diamond-thin", defaultWidth = 256.0.dp,
...
private var `_warning-diamond-thin`: ImageVector? = null
