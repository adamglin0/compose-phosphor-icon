...
public val BoldGroup.`Arrow-fat-line-down-bold`: ImageVector
    get() {
        if (`_arrow-fat-line-down-bold` != null) {
            return `_arrow-fat-line-down-bold`!!
        }
        `_arrow-fat-line-down-bold` = Builder(name = "Arrow-fat-line-down-bold", defaultWidth =
...
private var `_arrow-fat-line-down-bold`: ImageVector? = null
