...
public val LightGroup.`Map-trifold-light`: ImageVector
    get() {
        if (`_map-trifold-light` != null) {
            return `_map-trifold-light`!!
        }
        `_map-trifold-light` = Builder(name = "Map-trifold-light", defaultWidth = 256.0.dp,
...
private var `_map-trifold-light`: ImageVector? = null
