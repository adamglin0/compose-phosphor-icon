...
public val LightGroup.`Repeat-once-light`: ImageVector
    get() {
        if (`_repeat-once-light` != null) {
            return `_repeat-once-light`!!
        }
        `_repeat-once-light` = Builder(name = "Repeat-once-light", defaultWidth = 256.0.dp,
...
private var `_repeat-once-light`: ImageVector? = null
