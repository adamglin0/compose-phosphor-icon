...
public val ThinGroup.`Bookmark-thin`: ImageVector
    get() {
        if (`_bookmark-thin` != null) {
            return `_bookmark-thin`!!
        }
        `_bookmark-thin` = Builder(name = "Bookmark-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bookmark-thin`: ImageVector? = null
