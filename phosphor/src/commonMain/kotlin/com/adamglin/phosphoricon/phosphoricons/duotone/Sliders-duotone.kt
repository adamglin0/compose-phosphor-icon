...
public val DuotoneGroup.`Sliders-duotone`: ImageVector
    get() {
        if (`_sliders-duotone` != null) {
            return `_sliders-duotone`!!
        }
        `_sliders-duotone` = Builder(name = "Sliders-duotone", defaultWidth = 256.0.dp,
...
private var `_sliders-duotone`: ImageVector? = null
