...
public val ThinGroup.`Speaker-simple-slash-thin`: ImageVector
    get() {
        if (`_speaker-simple-slash-thin` != null) {
            return `_speaker-simple-slash-thin`!!
        }
        `_speaker-simple-slash-thin` = Builder(name = "Speaker-simple-slash-thin", defaultWidth =
...
private var `_speaker-simple-slash-thin`: ImageVector? = null
