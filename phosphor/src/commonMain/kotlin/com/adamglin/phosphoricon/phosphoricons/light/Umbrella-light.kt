...
public val LightGroup.`Umbrella-light`: ImageVector
    get() {
        if (`_umbrella-light` != null) {
            return `_umbrella-light`!!
        }
        `_umbrella-light` = Builder(name = "Umbrella-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_umbrella-light`: ImageVector? = null
