...
public val BoldGroup.`Figma-logo-bold`: ImageVector
    get() {
        if (`_figma-logo-bold` != null) {
            return `_figma-logo-bold`!!
        }
        `_figma-logo-bold` = Builder(name = "Figma-logo-bold", defaultWidth = 256.0.dp,
...
private var `_figma-logo-bold`: ImageVector? = null
