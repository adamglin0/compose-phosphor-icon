...
public val DuotoneGroup.`Head-circuit-duotone`: ImageVector
    get() {
        if (`_head-circuit-duotone` != null) {
            return `_head-circuit-duotone`!!
        }
        `_head-circuit-duotone` = Builder(name = "Head-circuit-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(215.93f, 100.72f)
                arcTo(80.0f, 80.0f, 0.0f, false, false, 56.0f, 104.0f)
                lineTo(32.65f, 148.87f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 3.77f, 10.31f)
                lineTo(64.0f, 171.81f)
                lineTo(64.0f, 208.0f)
                ...
                arcTo(79.86f, 79.86f, 0.0f, false, false, 215.93f, 100.72f)
                close()
                moveTo(112.13f, 74.08f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, 13.79f, 13.79f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 112.13f, 74.08f)
                close()
                moveTo(146.13f, 151.87f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, 13.79f, -13.79f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 146.08f, 151.87f)
                close()
            }
...
private var `_head-circuit-duotone`: ImageVector? = null
