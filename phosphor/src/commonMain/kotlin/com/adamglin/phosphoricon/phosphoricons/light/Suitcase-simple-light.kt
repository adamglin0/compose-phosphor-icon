...
public val LightGroup.`Suitcase-simple-light`: ImageVector
    get() {
        if (`_suitcase-simple-light` != null) {
            return `_suitcase-simple-light`!!
        }
        `_suitcase-simple-light` = Builder(name = "Suitcase-simple-light", defaultWidth = 256.0.dp,
...
private var `_suitcase-simple-light`: ImageVector? = null
