...
public val ThinGroup.`Island-thin`: ImageVector
    get() {
        if (`_island-thin` != null) {
            return `_island-thin`!!
        }
        `_island-thin` = Builder(name = "Island-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_island-thin`: ImageVector? = null
