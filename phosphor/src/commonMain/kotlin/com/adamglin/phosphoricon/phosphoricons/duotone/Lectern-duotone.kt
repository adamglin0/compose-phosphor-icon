...
public val DuotoneGroup.`Lectern-duotone`: ImageVector
    get() {
        if (`_lectern-duotone` != null) {
            return `_lectern-duotone`!!
        }
        `_lectern-duotone` = Builder(name = "Lectern-duotone", defaultWidth = 256.0.dp,
...
private var `_lectern-duotone`: ImageVector? = null
