...
public val DuotoneGroup.`Align-left-duotone`: ImageVector
    get() {
        if (`_align-left-duotone` != null) {
            return `_align-left-duotone`!!
        }
        `_align-left-duotone` = Builder(name = "Align-left-duotone", defaultWidth = 256.0.dp,
...
private var `_align-left-duotone`: ImageVector? = null
