...
public val LightGroup.`Playlist-light`: ImageVector
    get() {
        if (`_playlist-light` != null) {
            return `_playlist-light`!!
        }
        `_playlist-light` = Builder(name = "Playlist-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_playlist-light`: ImageVector? = null
