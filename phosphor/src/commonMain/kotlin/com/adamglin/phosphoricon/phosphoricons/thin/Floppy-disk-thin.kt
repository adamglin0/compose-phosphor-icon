...
public val ThinGroup.`Floppy-disk-thin`: ImageVector
    get() {
        if (`_floppy-disk-thin` != null) {
            return `_floppy-disk-thin`!!
        }
        `_floppy-disk-thin` = Builder(name = "Floppy-disk-thin", defaultWidth = 256.0.dp,
...
private var `_floppy-disk-thin`: ImageVector? = null
