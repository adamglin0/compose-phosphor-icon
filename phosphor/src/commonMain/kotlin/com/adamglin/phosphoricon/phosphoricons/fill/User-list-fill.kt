...
public val FillGroup.`User-list-fill`: ImageVector
    get() {
        if (`_user-list-fill` != null) {
            return `_user-list-fill`!!
        }
        `_user-list-fill` = Builder(name = "User-list-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_user-list-fill`: ImageVector? = null
