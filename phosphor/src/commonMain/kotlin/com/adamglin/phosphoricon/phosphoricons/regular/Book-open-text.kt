...
public val RegularGroup.`Book-open-text`: ImageVector
    get() {
        if (`_book-open-text` != null) {
            return `_book-open-text`!!
        }
        `_book-open-text` = Builder(name = "Book-open-text", defaultWidth = 256.0.dp, defaultHeight
...
private var `_book-open-text`: ImageVector? = null
