...
public val LightGroup.`Onigiri-light`: ImageVector
    get() {
        if (`_onigiri-light` != null) {
            return `_onigiri-light`!!
        }
        `_onigiri-light` = Builder(name = "Onigiri-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_onigiri-light`: ImageVector? = null
