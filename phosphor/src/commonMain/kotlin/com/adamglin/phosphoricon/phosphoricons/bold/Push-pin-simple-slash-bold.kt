...
public val BoldGroup.`Push-pin-simple-slash-bold`: ImageVector
    get() {
        if (`_push-pin-simple-slash-bold` != null) {
            return `_push-pin-simple-slash-bold`!!
        }
        `_push-pin-simple-slash-bold` = Builder(name = "Push-pin-simple-slash-bold", defaultWidth =
...
private var `_push-pin-simple-slash-bold`: ImageVector? = null
