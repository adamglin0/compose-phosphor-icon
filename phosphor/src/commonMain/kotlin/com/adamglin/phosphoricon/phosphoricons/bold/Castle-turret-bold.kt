...
public val BoldGroup.`Castle-turret-bold`: ImageVector
    get() {
        if (`_castle-turret-bold` != null) {
            return `_castle-turret-bold`!!
        }
        `_castle-turret-bold` = Builder(name = "Castle-turret-bold", defaultWidth = 256.0.dp,
...
private var `_castle-turret-bold`: ImageVector? = null
