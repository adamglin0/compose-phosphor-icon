...
public val BoldGroup.`Pen-nib-straight-bold`: ImageVector
    get() {
        if (`_pen-nib-straight-bold` != null) {
            return `_pen-nib-straight-bold`!!
        }
        `_pen-nib-straight-bold` = Builder(name = "Pen-nib-straight-bold", defaultWidth = 256.0.dp,
...
private var `_pen-nib-straight-bold`: ImageVector? = null
