...
public val BoldGroup.`Calendar-slash-bold`: ImageVector
    get() {
        if (`_calendar-slash-bold` != null) {
            return `_calendar-slash-bold`!!
        }
        `_calendar-slash-bold` = Builder(name = "Calendar-slash-bold", defaultWidth = 256.0.dp,
...
private var `_calendar-slash-bold`: ImageVector? = null
