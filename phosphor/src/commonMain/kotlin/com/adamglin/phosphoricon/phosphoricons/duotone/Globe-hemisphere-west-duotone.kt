...
public val DuotoneGroup.`Globe-hemisphere-west-duotone`: ImageVector
    get() {
        if (`_globe-hemisphere-west-duotone` != null) {
            return `_globe-hemisphere-west-duotone`!!
        }
        `_globe-hemisphere-west-duotone` = Builder(name = "Globe-hemisphere-west-duotone",
...
private var `_globe-hemisphere-west-duotone`: ImageVector? = null
