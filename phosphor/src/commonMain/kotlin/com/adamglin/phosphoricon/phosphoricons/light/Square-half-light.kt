...
public val LightGroup.`Square-half-light`: ImageVector
    get() {
        if (`_square-half-light` != null) {
            return `_square-half-light`!!
        }
        `_square-half-light` = Builder(name = "Square-half-light", defaultWidth = 256.0.dp,
...
private var `_square-half-light`: ImageVector? = null
