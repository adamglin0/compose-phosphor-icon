...
public val ThinGroup.`Sigma-thin`: ImageVector
    get() {
        if (`_sigma-thin` != null) {
            return `_sigma-thin`!!
        }
        `_sigma-thin` = Builder(name = "Sigma-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sigma-thin`: ImageVector? = null
