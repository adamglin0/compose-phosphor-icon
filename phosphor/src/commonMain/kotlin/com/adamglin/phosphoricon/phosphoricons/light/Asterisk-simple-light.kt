...
public val LightGroup.`Asterisk-simple-light`: ImageVector
    get() {
        if (`_asterisk-simple-light` != null) {
            return `_asterisk-simple-light`!!
        }
        `_asterisk-simple-light` = Builder(name = "Asterisk-simple-light", defaultWidth = 256.0.dp,
...
private var `_asterisk-simple-light`: ImageVector? = null
