...
public val LightGroup.`Boxing-glove-light`: ImageVector
    get() {
        if (`_boxing-glove-light` != null) {
            return `_boxing-glove-light`!!
        }
        `_boxing-glove-light` = Builder(name = "Boxing-glove-light", defaultWidth = 256.0.dp,
...
private var `_boxing-glove-light`: ImageVector? = null
