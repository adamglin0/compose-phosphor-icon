...
public val ThinGroup.`Call-bell-thin`: ImageVector
    get() {
        if (`_call-bell-thin` != null) {
            return `_call-bell-thin`!!
        }
        `_call-bell-thin` = Builder(name = "Call-bell-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_call-bell-thin`: ImageVector? = null
