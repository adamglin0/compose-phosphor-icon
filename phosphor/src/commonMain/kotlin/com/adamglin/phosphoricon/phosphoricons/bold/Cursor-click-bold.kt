...
public val BoldGroup.`Cursor-click-bold`: ImageVector
    get() {
        if (`_cursor-click-bold` != null) {
            return `_cursor-click-bold`!!
        }
        `_cursor-click-bold` = Builder(name = "Cursor-click-bold", defaultWidth = 256.0.dp,
...
private var `_cursor-click-bold`: ImageVector? = null
