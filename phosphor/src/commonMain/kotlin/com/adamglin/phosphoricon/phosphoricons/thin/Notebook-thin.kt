...
public val ThinGroup.`Notebook-thin`: ImageVector
    get() {
        if (`_notebook-thin` != null) {
            return `_notebook-thin`!!
        }
        `_notebook-thin` = Builder(name = "Notebook-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_notebook-thin`: ImageVector? = null
