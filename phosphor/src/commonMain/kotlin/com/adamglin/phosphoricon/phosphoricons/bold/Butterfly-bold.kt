...
public val BoldGroup.`Butterfly-bold`: ImageVector
    get() {
        if (`_butterfly-bold` != null) {
            return `_butterfly-bold`!!
        }
        `_butterfly-bold` = Builder(name = "Butterfly-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_butterfly-bold`: ImageVector? = null
