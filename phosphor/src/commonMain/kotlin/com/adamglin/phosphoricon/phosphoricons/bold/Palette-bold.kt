...
public val BoldGroup.`Palette-bold`: ImageVector
    get() {
        if (`_palette-bold` != null) {
            return `_palette-bold`!!
        }
        `_palette-bold` = Builder(name = "Palette-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_palette-bold`: ImageVector? = null
