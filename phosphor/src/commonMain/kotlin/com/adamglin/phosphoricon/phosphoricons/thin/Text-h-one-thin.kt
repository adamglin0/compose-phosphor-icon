...
public val ThinGroup.`Text-h-one-thin`: ImageVector
    get() {
        if (`_text-h-one-thin` != null) {
            return `_text-h-one-thin`!!
        }
        `_text-h-one-thin` = Builder(name = "Text-h-one-thin", defaultWidth = 256.0.dp,
...
private var `_text-h-one-thin`: ImageVector? = null
