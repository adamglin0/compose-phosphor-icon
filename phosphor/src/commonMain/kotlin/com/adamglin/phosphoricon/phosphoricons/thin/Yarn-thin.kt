...
public val ThinGroup.`Yarn-thin`: ImageVector
    get() {
        if (`_yarn-thin` != null) {
            return `_yarn-thin`!!
        }
        `_yarn-thin` = Builder(name = "Yarn-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_yarn-thin`: ImageVector? = null
