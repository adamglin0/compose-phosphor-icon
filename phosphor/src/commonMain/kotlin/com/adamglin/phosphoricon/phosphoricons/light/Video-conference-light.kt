...
public val LightGroup.`Video-conference-light`: ImageVector
    get() {
        if (`_video-conference-light` != null) {
            return `_video-conference-light`!!
        }
        `_video-conference-light` = Builder(name = "Video-conference-light", defaultWidth =
...
private var `_video-conference-light`: ImageVector? = null
