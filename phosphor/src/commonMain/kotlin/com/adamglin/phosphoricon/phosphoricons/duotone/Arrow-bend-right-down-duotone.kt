...
public val DuotoneGroup.`Arrow-bend-right-down-duotone`: ImageVector
    get() {
        if (`_arrow-bend-right-down-duotone` != null) {
            return `_arrow-bend-right-down-duotone`!!
        }
        `_arrow-bend-right-down-duotone` = Builder(name = "Arrow-bend-right-down-duotone",
...
private var `_arrow-bend-right-down-duotone`: ImageVector? = null
