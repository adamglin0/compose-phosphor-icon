...
public val BoldGroup.`Cloud-snow-bold`: ImageVector
    get() {
        if (`_cloud-snow-bold` != null) {
            return `_cloud-snow-bold`!!
        }
        `_cloud-snow-bold` = Builder(name = "Cloud-snow-bold", defaultWidth = 256.0.dp,
...
private var `_cloud-snow-bold`: ImageVector? = null
