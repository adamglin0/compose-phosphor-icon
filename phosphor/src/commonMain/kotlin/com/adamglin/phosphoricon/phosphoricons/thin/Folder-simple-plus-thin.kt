...
public val ThinGroup.`Folder-simple-plus-thin`: ImageVector
    get() {
        if (`_folder-simple-plus-thin` != null) {
            return `_folder-simple-plus-thin`!!
        }
        `_folder-simple-plus-thin` = Builder(name = "Folder-simple-plus-thin", defaultWidth =
...
private var `_folder-simple-plus-thin`: ImageVector? = null
