...
public val ThinGroup.`Paper-plane-right-thin`: ImageVector
    get() {
        if (`_paper-plane-right-thin` != null) {
            return `_paper-plane-right-thin`!!
        }
        `_paper-plane-right-thin` = Builder(name = "Paper-plane-right-thin", defaultWidth =
...
private var `_paper-plane-right-thin`: ImageVector? = null
