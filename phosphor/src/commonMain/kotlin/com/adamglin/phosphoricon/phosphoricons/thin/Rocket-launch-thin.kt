...
public val ThinGroup.`Rocket-launch-thin`: ImageVector
    get() {
        if (`_rocket-launch-thin` != null) {
            return `_rocket-launch-thin`!!
        }
        `_rocket-launch-thin` = Builder(name = "Rocket-launch-thin", defaultWidth = 256.0.dp,
...
private var `_rocket-launch-thin`: ImageVector? = null
