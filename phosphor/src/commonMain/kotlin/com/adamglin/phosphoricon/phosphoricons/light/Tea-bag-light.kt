...
public val LightGroup.`Tea-bag-light`: ImageVector
    get() {
        if (`_tea-bag-light` != null) {
            return `_tea-bag-light`!!
        }
        `_tea-bag-light` = Builder(name = "Tea-bag-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tea-bag-light`: ImageVector? = null
