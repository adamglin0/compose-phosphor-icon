...
public val ThinGroup.`Trademark-registered-thin`: ImageVector
    get() {
        if (`_trademark-registered-thin` != null) {
            return `_trademark-registered-thin`!!
        }
        `_trademark-registered-thin` = Builder(name = "Trademark-registered-thin", defaultWidth =
...
private var `_trademark-registered-thin`: ImageVector? = null
