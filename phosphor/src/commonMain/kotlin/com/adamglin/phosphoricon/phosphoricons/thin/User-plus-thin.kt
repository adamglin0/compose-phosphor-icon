...
public val ThinGroup.`User-plus-thin`: ImageVector
    get() {
        if (`_user-plus-thin` != null) {
            return `_user-plus-thin`!!
        }
        `_user-plus-thin` = Builder(name = "User-plus-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_user-plus-thin`: ImageVector? = null
