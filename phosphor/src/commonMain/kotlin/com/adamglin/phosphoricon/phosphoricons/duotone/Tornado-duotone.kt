...
public val DuotoneGroup.`Tornado-duotone`: ImageVector
    get() {
        if (`_tornado-duotone` != null) {
            return `_tornado-duotone`!!
        }
        `_tornado-duotone` = Builder(name = "Tornado-duotone", defaultWidth = 256.0.dp,
...
private var `_tornado-duotone`: ImageVector? = null
