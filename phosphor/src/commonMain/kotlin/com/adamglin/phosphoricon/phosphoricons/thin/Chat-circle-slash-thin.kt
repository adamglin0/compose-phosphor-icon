...
public val ThinGroup.`Chat-circle-slash-thin`: ImageVector
    get() {
        if (`_chat-circle-slash-thin` != null) {
            return `_chat-circle-slash-thin`!!
        }
        `_chat-circle-slash-thin` = Builder(name = "Chat-circle-slash-thin", defaultWidth =
...
private var `_chat-circle-slash-thin`: ImageVector? = null
