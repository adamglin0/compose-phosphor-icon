...
public val ThinGroup.`Hourglass-simple-medium-thin`: ImageVector
    get() {
        if (`_hourglass-simple-medium-thin` != null) {
            return `_hourglass-simple-medium-thin`!!
        }
        `_hourglass-simple-medium-thin` = Builder(name = "Hourglass-simple-medium-thin",
...
private var `_hourglass-simple-medium-thin`: ImageVector? = null
