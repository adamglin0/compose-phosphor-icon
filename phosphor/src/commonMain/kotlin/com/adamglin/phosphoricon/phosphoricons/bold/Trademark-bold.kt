...
public val BoldGroup.`Trademark-bold`: ImageVector
    get() {
        if (`_trademark-bold` != null) {
            return `_trademark-bold`!!
        }
        `_trademark-bold` = Builder(name = "Trademark-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_trademark-bold`: ImageVector? = null
