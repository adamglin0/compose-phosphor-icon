...
public val BoldGroup.`Phone-plus-bold`: ImageVector
    get() {
        if (`_phone-plus-bold` != null) {
            return `_phone-plus-bold`!!
        }
        `_phone-plus-bold` = Builder(name = "Phone-plus-bold", defaultWidth = 256.0.dp,
...
private var `_phone-plus-bold`: ImageVector? = null
