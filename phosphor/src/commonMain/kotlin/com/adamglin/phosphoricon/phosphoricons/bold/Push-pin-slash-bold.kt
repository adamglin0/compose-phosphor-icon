...
public val BoldGroup.`Push-pin-slash-bold`: ImageVector
    get() {
        if (`_push-pin-slash-bold` != null) {
            return `_push-pin-slash-bold`!!
        }
        `_push-pin-slash-bold` = Builder(name = "Push-pin-slash-bold", defaultWidth = 256.0.dp,
...
private var `_push-pin-slash-bold`: ImageVector? = null
