...
public val DuotoneGroup.`Coffee-bean-duotone`: ImageVector
    get() {
        if (`_coffee-bean-duotone` != null) {
            return `_coffee-bean-duotone`!!
        }
        `_coffee-bean-duotone` = Builder(name = "Coffee-bean-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(183.79f, 183.79f)
                curveToRelative(-43.14f, 43.14f, -103.09f, 53.14f, -133.9f, 22.32f)
                reflectiveCurveTo(29.07f, 115.35f, 72.21f, 72.21f)
                reflectiveCurveTo(175.3f, 19.07f, 206.11f, 49.89f)
                reflectiveCurveTo(226.93f, 140.65f, 183.79f, 183.79f)
                close()
            }
...
private var `_coffee-bean-duotone`: ImageVector? = null
