...
public val LightGroup.`Circle-half-light`: ImageVector
    get() {
        if (`_circle-half-light` != null) {
            return `_circle-half-light`!!
        }
        `_circle-half-light` = Builder(name = "Circle-half-light", defaultWidth = 256.0.dp,
...
private var `_circle-half-light`: ImageVector? = null
