...
public val ThinGroup.`Ranking-thin`: ImageVector
    get() {
        if (`_ranking-thin` != null) {
            return `_ranking-thin`!!
        }
        `_ranking-thin` = Builder(name = "Ranking-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ranking-thin`: ImageVector? = null
