...
public val ThinGroup.`Codesandbox-logo-thin`: ImageVector
    get() {
        if (`_codesandbox-logo-thin` != null) {
            return `_codesandbox-logo-thin`!!
        }
        `_codesandbox-logo-thin` = Builder(name = "Codesandbox-logo-thin", defaultWidth = 256.0.dp,
...
private var `_codesandbox-logo-thin`: ImageVector? = null
