...
public val BoldGroup.`Smiley-sticker-bold`: ImageVector
    get() {
        if (`_smiley-sticker-bold` != null) {
            return `_smiley-sticker-bold`!!
        }
        `_smiley-sticker-bold` = Builder(name = "Smiley-sticker-bold", defaultWidth = 256.0.dp,
...
private var `_smiley-sticker-bold`: ImageVector? = null
