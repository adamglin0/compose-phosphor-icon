...
public val LightGroup.`Equalizer-light`: ImageVector
    get() {
        if (`_equalizer-light` != null) {
            return `_equalizer-light`!!
        }
        `_equalizer-light` = Builder(name = "Equalizer-light", defaultWidth = 256.0.dp,
...
private var `_equalizer-light`: ImageVector? = null
