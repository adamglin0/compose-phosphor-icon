...
public val LightGroup.`Currency-krw-light`: ImageVector
    get() {
        if (`_currency-krw-light` != null) {
            return `_currency-krw-light`!!
        }
        `_currency-krw-light` = Builder(name = "Currency-krw-light", defaultWidth = 256.0.dp,
...
private var `_currency-krw-light`: ImageVector? = null
