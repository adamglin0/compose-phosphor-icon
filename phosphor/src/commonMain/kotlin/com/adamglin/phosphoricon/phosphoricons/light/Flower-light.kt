...
public val LightGroup.`Flower-light`: ImageVector
    get() {
        if (`_flower-light` != null) {
            return `_flower-light`!!
        }
        `_flower-light` = Builder(name = "Flower-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flower-light`: ImageVector? = null
