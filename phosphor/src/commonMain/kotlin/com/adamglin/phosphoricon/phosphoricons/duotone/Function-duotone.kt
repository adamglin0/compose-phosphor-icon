...
public val DuotoneGroup.`Function-duotone`: ImageVector
    get() {
        if (`_function-duotone` != null) {
            return `_function-duotone`!!
        }
        `_function-duotone` = Builder(name = "Function-duotone", defaultWidth = 256.0.dp,
...
private var `_function-duotone`: ImageVector? = null
