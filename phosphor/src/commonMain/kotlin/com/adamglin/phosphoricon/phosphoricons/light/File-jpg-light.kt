...
public val LightGroup.`File-jpg-light`: ImageVector
    get() {
        if (`_file-jpg-light` != null) {
            return `_file-jpg-light`!!
        }
        `_file-jpg-light` = Builder(name = "File-jpg-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-jpg-light`: ImageVector? = null
