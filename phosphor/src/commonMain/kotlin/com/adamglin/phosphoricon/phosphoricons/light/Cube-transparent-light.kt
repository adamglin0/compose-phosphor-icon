...
public val LightGroup.`Cube-transparent-light`: ImageVector
    get() {
        if (`_cube-transparent-light` != null) {
            return `_cube-transparent-light`!!
        }
        `_cube-transparent-light` = Builder(name = "Cube-transparent-light", defaultWidth =
...
private var `_cube-transparent-light`: ImageVector? = null
