...
public val DuotoneGroup.`Cactus-duotone`: ImageVector
    get() {
        if (`_cactus-duotone` != null) {
            return `_cactus-duotone`!!
        }
        `_cactus-duotone` = Builder(name = "Cactus-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cactus-duotone`: ImageVector? = null
