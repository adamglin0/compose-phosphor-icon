...
public val ThinGroup.`Play-pause-thin`: ImageVector
    get() {
        if (`_play-pause-thin` != null) {
            return `_play-pause-thin`!!
        }
        `_play-pause-thin` = Builder(name = "Play-pause-thin", defaultWidth = 256.0.dp,
...
private var `_play-pause-thin`: ImageVector? = null
