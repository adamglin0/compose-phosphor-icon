...
public val DuotoneGroup.`Cube-transparent-duotone`: ImageVector
    get() {
        if (`_cube-transparent-duotone` != null) {
            return `_cube-transparent-duotone`!!
        }
        `_cube-transparent-duotone` = Builder(name = "Cube-transparent-duotone", defaultWidth =
...
private var `_cube-transparent-duotone`: ImageVector? = null
