...
public val ThinGroup.`Grid-nine-thin`: ImageVector
    get() {
        if (`_grid-nine-thin` != null) {
            return `_grid-nine-thin`!!
        }
        `_grid-nine-thin` = Builder(name = "Grid-nine-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_grid-nine-thin`: ImageVector? = null
