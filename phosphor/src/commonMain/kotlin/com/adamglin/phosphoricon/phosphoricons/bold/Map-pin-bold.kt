...
public val BoldGroup.`Map-pin-bold`: ImageVector
    get() {
        if (`_map-pin-bold` != null) {
            return `_map-pin-bold`!!
        }
        `_map-pin-bold` = Builder(name = "Map-pin-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_map-pin-bold`: ImageVector? = null
