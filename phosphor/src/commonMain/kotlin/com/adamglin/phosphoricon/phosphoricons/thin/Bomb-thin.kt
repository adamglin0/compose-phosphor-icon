...
public val ThinGroup.`Bomb-thin`: ImageVector
    get() {
        if (`_bomb-thin` != null) {
            return `_bomb-thin`!!
        }
        `_bomb-thin` = Builder(name = "Bomb-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bomb-thin`: ImageVector? = null
