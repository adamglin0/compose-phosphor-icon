...
public val RegularGroup.`Intersect-square`: ImageVector
    get() {
        if (`_intersect-square` != null) {
            return `_intersect-square`!!
        }
        `_intersect-square` = Builder(name = "Intersect-square", defaultWidth = 256.0.dp,
...
private var `_intersect-square`: ImageVector? = null
