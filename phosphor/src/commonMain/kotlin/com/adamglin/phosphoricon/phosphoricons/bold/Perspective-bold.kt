...
public val BoldGroup.`Perspective-bold`: ImageVector
    get() {
        if (`_perspective-bold` != null) {
            return `_perspective-bold`!!
        }
        `_perspective-bold` = Builder(name = "Perspective-bold", defaultWidth = 256.0.dp,
...
private var `_perspective-bold`: ImageVector? = null
