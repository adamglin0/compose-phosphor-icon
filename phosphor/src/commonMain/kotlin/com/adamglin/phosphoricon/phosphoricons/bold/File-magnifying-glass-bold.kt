...
public val BoldGroup.`File-magnifying-glass-bold`: ImageVector
    get() {
        if (`_file-magnifying-glass-bold` != null) {
            return `_file-magnifying-glass-bold`!!
        }
        `_file-magnifying-glass-bold` = Builder(name = "File-magnifying-glass-bold", defaultWidth =
...
private var `_file-magnifying-glass-bold`: ImageVector? = null
