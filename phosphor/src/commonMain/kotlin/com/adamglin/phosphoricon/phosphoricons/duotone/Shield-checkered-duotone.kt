...
public val DuotoneGroup.`Shield-checkered-duotone`: ImageVector
    get() {
        if (`_shield-checkered-duotone` != null) {
            return `_shield-checkered-duotone`!!
        }
        `_shield-checkered-duotone` = Builder(name = "Shield-checkered-duotone", defaultWidth =
...
private var `_shield-checkered-duotone`: ImageVector? = null
