...
public val BoldGroup.`Bookmark-bold`: ImageVector
    get() {
        if (`_bookmark-bold` != null) {
            return `_bookmark-bold`!!
        }
        `_bookmark-bold` = Builder(name = "Bookmark-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bookmark-bold`: ImageVector? = null
