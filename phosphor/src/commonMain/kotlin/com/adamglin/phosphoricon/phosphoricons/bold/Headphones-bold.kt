...
public val BoldGroup.`Headphones-bold`: ImageVector
    get() {
        if (`_headphones-bold` != null) {
            return `_headphones-bold`!!
        }
        `_headphones-bold` = Builder(name = "Headphones-bold", defaultWidth = 256.0.dp,
...
private var `_headphones-bold`: ImageVector? = null
