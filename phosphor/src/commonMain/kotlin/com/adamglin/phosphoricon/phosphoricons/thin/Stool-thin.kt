...
public val ThinGroup.`Stool-thin`: ImageVector
    get() {
        if (`_stool-thin` != null) {
            return `_stool-thin`!!
        }
        `_stool-thin` = Builder(name = "Stool-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stool-thin`: ImageVector? = null
