...
public val LightGroup.`Shield-checkered-light`: ImageVector
    get() {
        if (`_shield-checkered-light` != null) {
            return `_shield-checkered-light`!!
        }
        `_shield-checkered-light` = Builder(name = "Shield-checkered-light", defaultWidth =
...
private var `_shield-checkered-light`: ImageVector? = null
