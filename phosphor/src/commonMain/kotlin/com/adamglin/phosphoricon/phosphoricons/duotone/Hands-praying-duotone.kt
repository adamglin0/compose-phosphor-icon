...
public val DuotoneGroup.`Hands-praying-duotone`: ImageVector
    get() {
        if (`_hands-praying-duotone` != null) {
            return `_hands-praying-duotone`!!
        }
        `_hands-praying-duotone` = Builder(name = "Hands-praying-duotone", defaultWidth = 256.0.dp,
...
private var `_hands-praying-duotone`: ImageVector? = null
