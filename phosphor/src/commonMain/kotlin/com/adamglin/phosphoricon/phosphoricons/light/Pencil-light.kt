...
public val LightGroup.`Pencil-light`: ImageVector
    get() {
        if (`_pencil-light` != null) {
            return `_pencil-light`!!
        }
        `_pencil-light` = Builder(name = "Pencil-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pencil-light`: ImageVector? = null
