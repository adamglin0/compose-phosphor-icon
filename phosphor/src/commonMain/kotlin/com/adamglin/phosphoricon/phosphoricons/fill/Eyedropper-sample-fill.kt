...
public val FillGroup.`Eyedropper-sample-fill`: ImageVector
    get() {
        if (`_eyedropper-sample-fill` != null) {
            return `_eyedropper-sample-fill`!!
        }
        `_eyedropper-sample-fill` = Builder(name = "Eyedropper-sample-fill", defaultWidth =
...
private var `_eyedropper-sample-fill`: ImageVector? = null
