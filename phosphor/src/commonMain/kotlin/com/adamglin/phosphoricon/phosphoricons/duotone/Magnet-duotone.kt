...
public val DuotoneGroup.`Magnet-duotone`: ImageVector
    get() {
        if (`_magnet-duotone` != null) {
            return `_magnet-duotone`!!
        }
        `_magnet-duotone` = Builder(name = "Magnet-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_magnet-duotone`: ImageVector? = null
