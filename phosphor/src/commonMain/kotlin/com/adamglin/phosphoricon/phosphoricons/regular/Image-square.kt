...
public val RegularGroup.`Image-square`: ImageVector
    get() {
        if (`_image-square` != null) {
            return `_image-square`!!
        }
        `_image-square` = Builder(name = "Image-square", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_image-square`: ImageVector? = null
