...
public val BoldGroup.`Wall-bold`: ImageVector
    get() {
        if (`_wall-bold` != null) {
            return `_wall-bold`!!
        }
        `_wall-bold` = Builder(name = "Wall-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wall-bold`: ImageVector? = null
