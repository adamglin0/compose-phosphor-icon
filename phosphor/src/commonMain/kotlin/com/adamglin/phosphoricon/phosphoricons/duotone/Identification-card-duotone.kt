...
public val DuotoneGroup.`Identification-card-duotone`: ImageVector
    get() {
        if (`_identification-card-duotone` != null) {
            return `_identification-card-duotone`!!
        }
        `_identification-card-duotone` = Builder(name = "Identification-card-duotone", defaultWidth
...
private var `_identification-card-duotone`: ImageVector? = null
