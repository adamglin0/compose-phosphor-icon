...
public val ThinGroup.`Shield-check-thin`: ImageVector
    get() {
        if (`_shield-check-thin` != null) {
            return `_shield-check-thin`!!
        }
        `_shield-check-thin` = Builder(name = "Shield-check-thin", defaultWidth = 256.0.dp,
...
private var `_shield-check-thin`: ImageVector? = null
