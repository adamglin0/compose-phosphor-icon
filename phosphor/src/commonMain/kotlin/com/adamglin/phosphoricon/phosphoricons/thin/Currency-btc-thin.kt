...
public val ThinGroup.`Currency-btc-thin`: ImageVector
    get() {
        if (`_currency-btc-thin` != null) {
            return `_currency-btc-thin`!!
        }
        `_currency-btc-thin` = Builder(name = "Currency-btc-thin", defaultWidth = 256.0.dp,
...
private var `_currency-btc-thin`: ImageVector? = null
