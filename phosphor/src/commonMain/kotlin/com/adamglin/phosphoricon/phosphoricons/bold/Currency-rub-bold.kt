...
public val BoldGroup.`Currency-rub-bold`: ImageVector
    get() {
        if (`_currency-rub-bold` != null) {
            return `_currency-rub-bold`!!
        }
        `_currency-rub-bold` = Builder(name = "Currency-rub-bold", defaultWidth = 256.0.dp,
...
private var `_currency-rub-bold`: ImageVector? = null
