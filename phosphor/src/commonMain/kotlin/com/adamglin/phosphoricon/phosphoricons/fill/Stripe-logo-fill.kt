...
public val FillGroup.`Stripe-logo-fill`: ImageVector
    get() {
        if (`_stripe-logo-fill` != null) {
            return `_stripe-logo-fill`!!
        }
        `_stripe-logo-fill` = Builder(name = "Stripe-logo-fill", defaultWidth = 256.0.dp,
...
private var `_stripe-logo-fill`: ImageVector? = null
