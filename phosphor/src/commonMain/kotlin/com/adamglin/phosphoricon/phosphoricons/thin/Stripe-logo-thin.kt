...
public val ThinGroup.`Stripe-logo-thin`: ImageVector
    get() {
        if (`_stripe-logo-thin` != null) {
            return `_stripe-logo-thin`!!
        }
        `_stripe-logo-thin` = Builder(name = "Stripe-logo-thin", defaultWidth = 256.0.dp,
...
private var `_stripe-logo-thin`: ImageVector? = null
