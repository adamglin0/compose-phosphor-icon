...
public val DuotoneGroup.`User-circle-minus-duotone`: ImageVector
    get() {
        if (`_user-circle-minus-duotone` != null) {
            return `_user-circle-minus-duotone`!!
        }
        `_user-circle-minus-duotone` = Builder(name = "User-circle-minus-duotone", defaultWidth =
...
private var `_user-circle-minus-duotone`: ImageVector? = null
