...
public val ThinGroup.`Sketch-logo-thin`: ImageVector
    get() {
        if (`_sketch-logo-thin` != null) {
            return `_sketch-logo-thin`!!
        }
        `_sketch-logo-thin` = Builder(name = "Sketch-logo-thin", defaultWidth = 256.0.dp,
...
private var `_sketch-logo-thin`: ImageVector? = null
