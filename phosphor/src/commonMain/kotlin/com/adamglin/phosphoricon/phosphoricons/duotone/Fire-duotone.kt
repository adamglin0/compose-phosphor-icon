...
public val DuotoneGroup.`Fire-duotone`: ImageVector
    get() {
        if (`_fire-duotone` != null) {
            return `_fire-duotone`!!
        }
        `_fire-duotone` = Builder(name = "Fire-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fire-duotone`: ImageVector? = null
