...
public val LightGroup.`House-light`: ImageVector
    get() {
        if (`_house-light` != null) {
            return `_house-light`!!
        }
        `_house-light` = Builder(name = "House-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_house-light`: ImageVector? = null
