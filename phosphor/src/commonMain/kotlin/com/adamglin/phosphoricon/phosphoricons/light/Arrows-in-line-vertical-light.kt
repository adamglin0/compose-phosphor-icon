...
public val LightGroup.`Arrows-in-line-vertical-light`: ImageVector
    get() {
        if (`_arrows-in-line-vertical-light` != null) {
            return `_arrows-in-line-vertical-light`!!
        }
        `_arrows-in-line-vertical-light` = Builder(name = "Arrows-in-line-vertical-light",
...
private var `_arrows-in-line-vertical-light`: ImageVector? = null
