...
public val DuotoneGroup.`Gif-duotone`: ImageVector
    get() {
        if (`_gif-duotone` != null) {
            return `_gif-duotone`!!
        }
        `_gif-duotone` = Builder(name = "Gif-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gif-duotone`: ImageVector? = null
