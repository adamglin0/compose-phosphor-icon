...
public val BoldGroup.`Shield-chevron-bold`: ImageVector
    get() {
        if (`_shield-chevron-bold` != null) {
            return `_shield-chevron-bold`!!
        }
        `_shield-chevron-bold` = Builder(name = "Shield-chevron-bold", defaultWidth = 256.0.dp,
...
private var `_shield-chevron-bold`: ImageVector? = null
