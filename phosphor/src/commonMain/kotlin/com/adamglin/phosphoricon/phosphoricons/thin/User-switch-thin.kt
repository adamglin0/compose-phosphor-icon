...
public val ThinGroup.`User-switch-thin`: ImageVector
    get() {
        if (`_user-switch-thin` != null) {
            return `_user-switch-thin`!!
        }
        `_user-switch-thin` = Builder(name = "User-switch-thin", defaultWidth = 256.0.dp,
...
private var `_user-switch-thin`: ImageVector? = null
