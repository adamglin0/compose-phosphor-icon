...
public val ThinGroup.`Address-book-thin`: ImageVector
    get() {
        if (`_address-book-thin` != null) {
            return `_address-book-thin`!!
        }
        `_address-book-thin` = Builder(name = "Address-book-thin", defaultWidth = 256.0.dp,
...
private var `_address-book-thin`: ImageVector? = null
