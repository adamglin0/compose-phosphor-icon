...
public val LightGroup.`Codepen-logo-light`: ImageVector
    get() {
        if (`_codepen-logo-light` != null) {
            return `_codepen-logo-light`!!
        }
        `_codepen-logo-light` = Builder(name = "Codepen-logo-light", defaultWidth = 256.0.dp,
...
private var `_codepen-logo-light`: ImageVector? = null
