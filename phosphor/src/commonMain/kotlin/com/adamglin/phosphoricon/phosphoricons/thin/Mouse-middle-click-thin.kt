...
public val ThinGroup.`Mouse-middle-click-thin`: ImageVector
    get() {
        if (`_mouse-middle-click-thin` != null) {
            return `_mouse-middle-click-thin`!!
        }
        `_mouse-middle-click-thin` = Builder(name = "Mouse-middle-click-thin", defaultWidth =
...
private var `_mouse-middle-click-thin`: ImageVector? = null
