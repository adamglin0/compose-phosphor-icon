...
public val DuotoneGroup.`Pencil-circle-duotone`: ImageVector
    get() {
        if (`_pencil-circle-duotone` != null) {
            return `_pencil-circle-duotone`!!
        }
        `_pencil-circle-duotone` = Builder(name = "Pencil-circle-duotone", defaultWidth = 256.0.dp,
...
private var `_pencil-circle-duotone`: ImageVector? = null
