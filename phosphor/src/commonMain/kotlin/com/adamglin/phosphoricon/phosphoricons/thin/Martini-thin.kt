...
public val ThinGroup.`Martini-thin`: ImageVector
    get() {
        if (`_martini-thin` != null) {
            return `_martini-thin`!!
        }
        `_martini-thin` = Builder(name = "Martini-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_martini-thin`: ImageVector? = null
