...
public val BoldGroup.`Rocket-bold`: ImageVector
    get() {
        if (`_rocket-bold` != null) {
            return `_rocket-bold`!!
        }
        `_rocket-bold` = Builder(name = "Rocket-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rocket-bold`: ImageVector? = null
