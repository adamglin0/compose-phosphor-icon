...
public val BoldGroup.`Key-bold`: ImageVector
    get() {
        if (`_key-bold` != null) {
            return `_key-bold`!!
        }
        `_key-bold` = Builder(name = "Key-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_key-bold`: ImageVector? = null
