...
public val DuotoneGroup.`Chat-teardrop-dots-duotone`: ImageVector
    get() {
        if (`_chat-teardrop-dots-duotone` != null) {
            return `_chat-teardrop-dots-duotone`!!
        }
        `_chat-teardrop-dots-duotone` = Builder(name = "Chat-teardrop-dots-duotone", defaultWidth =
...
private var `_chat-teardrop-dots-duotone`: ImageVector? = null
