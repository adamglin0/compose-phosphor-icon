...
public val LightGroup.`Dice-one-light`: ImageVector
    get() {
        if (`_dice-one-light` != null) {
            return `_dice-one-light`!!
        }
        `_dice-one-light` = Builder(name = "Dice-one-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dice-one-light`: ImageVector? = null
