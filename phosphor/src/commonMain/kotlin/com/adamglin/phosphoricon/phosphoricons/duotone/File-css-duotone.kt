...
public val DuotoneGroup.`File-css-duotone`: ImageVector
    get() {
        if (`_file-css-duotone` != null) {
            return `_file-css-duotone`!!
        }
        `_file-css-duotone` = Builder(name = "File-css-duotone", defaultWidth = 256.0.dp,
...
private var `_file-css-duotone`: ImageVector? = null
