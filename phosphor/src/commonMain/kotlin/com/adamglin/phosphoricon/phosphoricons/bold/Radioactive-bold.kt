...
public val BoldGroup.`Radioactive-bold`: ImageVector
    get() {
        if (`_radioactive-bold` != null) {
            return `_radioactive-bold`!!
        }
        `_radioactive-bold` = Builder(name = "Radioactive-bold", defaultWidth = 256.0.dp,
...
private var `_radioactive-bold`: ImageVector? = null
