...
public val BoldGroup.`T-shirt-bold`: ImageVector
    get() {
        if (`_t-shirt-bold` != null) {
            return `_t-shirt-bold`!!
        }
        `_t-shirt-bold` = Builder(name = "T-shirt-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_t-shirt-bold`: ImageVector? = null
