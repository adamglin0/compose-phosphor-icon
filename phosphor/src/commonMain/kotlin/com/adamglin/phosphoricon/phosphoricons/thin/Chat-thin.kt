...
public val ThinGroup.`Chat-thin`: ImageVector
    get() {
        if (`_chat-thin` != null) {
            return `_chat-thin`!!
        }
        `_chat-thin` = Builder(name = "Chat-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chat-thin`: ImageVector? = null
