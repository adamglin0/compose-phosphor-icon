...
public val BoldGroup.`Code-simple-bold`: ImageVector
    get() {
        if (`_code-simple-bold` != null) {
            return `_code-simple-bold`!!
        }
        `_code-simple-bold` = Builder(name = "Code-simple-bold", defaultWidth = 256.0.dp,
...
private var `_code-simple-bold`: ImageVector? = null
