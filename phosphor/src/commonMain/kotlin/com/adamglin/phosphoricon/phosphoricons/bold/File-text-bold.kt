...
public val BoldGroup.`File-text-bold`: ImageVector
    get() {
        if (`_file-text-bold` != null) {
            return `_file-text-bold`!!
        }
        `_file-text-bold` = Builder(name = "File-text-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-text-bold`: ImageVector? = null
