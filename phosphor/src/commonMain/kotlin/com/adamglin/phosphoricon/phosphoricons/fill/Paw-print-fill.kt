...
public val FillGroup.`Paw-print-fill`: ImageVector
    get() {
        if (`_paw-print-fill` != null) {
            return `_paw-print-fill`!!
        }
        `_paw-print-fill` = Builder(name = "Paw-print-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_paw-print-fill`: ImageVector? = null
