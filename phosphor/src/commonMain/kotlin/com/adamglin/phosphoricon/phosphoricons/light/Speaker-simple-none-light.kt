...
public val LightGroup.`Speaker-simple-none-light`: ImageVector
    get() {
        if (`_speaker-simple-none-light` != null) {
            return `_speaker-simple-none-light`!!
        }
        `_speaker-simple-none-light` = Builder(name = "Speaker-simple-none-light", defaultWidth =
...
private var `_speaker-simple-none-light`: ImageVector? = null
