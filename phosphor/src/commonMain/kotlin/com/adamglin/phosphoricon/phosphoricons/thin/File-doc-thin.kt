...
public val ThinGroup.`File-doc-thin`: ImageVector
    get() {
        if (`_file-doc-thin` != null) {
            return `_file-doc-thin`!!
        }
        `_file-doc-thin` = Builder(name = "File-doc-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-doc-thin`: ImageVector? = null
