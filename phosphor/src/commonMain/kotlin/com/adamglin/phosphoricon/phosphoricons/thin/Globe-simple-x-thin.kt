...
public val ThinGroup.`Globe-simple-x-thin`: ImageVector
    get() {
        if (`_globe-simple-x-thin` != null) {
            return `_globe-simple-x-thin`!!
        }
        `_globe-simple-x-thin` = Builder(name = "Globe-simple-x-thin", defaultWidth = 256.0.dp,
...
private var `_globe-simple-x-thin`: ImageVector? = null
