...
public val ThinGroup.`Peace-thin`: ImageVector
    get() {
        if (`_peace-thin` != null) {
            return `_peace-thin`!!
        }
        `_peace-thin` = Builder(name = "Peace-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_peace-thin`: ImageVector? = null
