...
public val FillGroup.`Bowl-food-fill`: ImageVector
    get() {
        if (`_bowl-food-fill` != null) {
            return `_bowl-food-fill`!!
        }
        `_bowl-food-fill` = Builder(name = "Bowl-food-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bowl-food-fill`: ImageVector? = null
