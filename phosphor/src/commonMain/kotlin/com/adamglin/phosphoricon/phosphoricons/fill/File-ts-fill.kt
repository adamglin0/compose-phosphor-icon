...
public val FillGroup.`File-ts-fill`: ImageVector
    get() {
        if (`_file-ts-fill` != null) {
            return `_file-ts-fill`!!
        }
        `_file-ts-fill` = Builder(name = "File-ts-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-ts-fill`: ImageVector? = null
