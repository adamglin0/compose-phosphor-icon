...
public val BoldGroup.`Stack-plus-bold`: ImageVector
    get() {
        if (`_stack-plus-bold` != null) {
            return `_stack-plus-bold`!!
        }
        `_stack-plus-bold` = Builder(name = "Stack-plus-bold", defaultWidth = 256.0.dp,
...
private var `_stack-plus-bold`: ImageVector? = null
