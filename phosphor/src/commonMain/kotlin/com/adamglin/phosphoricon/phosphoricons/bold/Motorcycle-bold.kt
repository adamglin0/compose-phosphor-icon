...
public val BoldGroup.`Motorcycle-bold`: ImageVector
    get() {
        if (`_motorcycle-bold` != null) {
            return `_motorcycle-bold`!!
        }
        `_motorcycle-bold` = Builder(name = "Motorcycle-bold", defaultWidth = 256.0.dp,
...
private var `_motorcycle-bold`: ImageVector? = null
