...
public val LightGroup.`Eyedropper-sample-light`: ImageVector
    get() {
        if (`_eyedropper-sample-light` != null) {
            return `_eyedropper-sample-light`!!
        }
        `_eyedropper-sample-light` = Builder(name = "Eyedropper-sample-light", defaultWidth =
...
private var `_eyedropper-sample-light`: ImageVector? = null
