...
public val FillGroup.`Battery-medium-fill`: ImageVector
    get() {
        if (`_battery-medium-fill` != null) {
            return `_battery-medium-fill`!!
        }
        `_battery-medium-fill` = Builder(name = "Battery-medium-fill", defaultWidth = 256.0.dp,
...
private var `_battery-medium-fill`: ImageVector? = null
