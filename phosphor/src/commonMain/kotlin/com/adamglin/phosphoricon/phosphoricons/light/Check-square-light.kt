...
public val LightGroup.`Check-square-light`: ImageVector
    get() {
        if (`_check-square-light` != null) {
            return `_check-square-light`!!
        }
        `_check-square-light` = Builder(name = "Check-square-light", defaultWidth = 256.0.dp,
...
private var `_check-square-light`: ImageVector? = null
