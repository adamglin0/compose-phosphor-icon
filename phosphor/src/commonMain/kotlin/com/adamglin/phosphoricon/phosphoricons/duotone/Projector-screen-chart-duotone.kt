...
public val DuotoneGroup.`Projector-screen-chart-duotone`: ImageVector
    get() {
        if (`_projector-screen-chart-duotone` != null) {
            return `_projector-screen-chart-duotone`!!
        }
        `_projector-screen-chart-duotone` = Builder(name = "Projector-screen-chart-duotone",
...
private var `_projector-screen-chart-duotone`: ImageVector? = null
