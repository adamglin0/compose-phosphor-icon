...
public val LightGroup.`Invoice-light`: ImageVector
    get() {
        if (`_invoice-light` != null) {
            return `_invoice-light`!!
        }
        `_invoice-light` = Builder(name = "Invoice-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_invoice-light`: ImageVector? = null
