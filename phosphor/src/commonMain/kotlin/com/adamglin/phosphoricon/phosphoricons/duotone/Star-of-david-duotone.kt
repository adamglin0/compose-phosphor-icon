...
public val DuotoneGroup.`Star-of-david-duotone`: ImageVector
    get() {
        if (`_star-of-david-duotone` != null) {
            return `_star-of-david-duotone`!!
        }
        `_star-of-david-duotone` = Builder(name = "Star-of-david-duotone", defaultWidth = 256.0.dp,
...
private var `_star-of-david-duotone`: ImageVector? = null
