...
public val DuotoneGroup.`Text-underline-duotone`: ImageVector
    get() {
        if (`_text-underline-duotone` != null) {
            return `_text-underline-duotone`!!
        }
        `_text-underline-duotone` = Builder(name = "Text-underline-duotone", defaultWidth =
...
private var `_text-underline-duotone`: ImageVector? = null
