...
public val ThinGroup.`File-ini-thin`: ImageVector
    get() {
        if (`_file-ini-thin` != null) {
            return `_file-ini-thin`!!
        }
        `_file-ini-thin` = Builder(name = "File-ini-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-ini-thin`: ImageVector? = null
