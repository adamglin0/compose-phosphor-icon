...
public val LightGroup.`Hand-tap-light`: ImageVector
    get() {
        if (`_hand-tap-light` != null) {
            return `_hand-tap-light`!!
        }
        `_hand-tap-light` = Builder(name = "Hand-tap-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hand-tap-light`: ImageVector? = null
