...
public val ThinGroup.`Virtual-reality-thin`: ImageVector
    get() {
        if (`_virtual-reality-thin` != null) {
            return `_virtual-reality-thin`!!
        }
        `_virtual-reality-thin` = Builder(name = "Virtual-reality-thin", defaultWidth = 256.0.dp,
...
private var `_virtual-reality-thin`: ImageVector? = null
