...
public val DuotoneGroup.`Number-square-two-duotone`: ImageVector
    get() {
        if (`_number-square-two-duotone` != null) {
            return `_number-square-two-duotone`!!
        }
        `_number-square-two-duotone` = Builder(name = "Number-square-two-duotone", defaultWidth =
...
private var `_number-square-two-duotone`: ImageVector? = null
