...
public val ThinGroup.`Calendar-blank-thin`: ImageVector
    get() {
        if (`_calendar-blank-thin` != null) {
            return `_calendar-blank-thin`!!
        }
        `_calendar-blank-thin` = Builder(name = "Calendar-blank-thin", defaultWidth = 256.0.dp,
...
private var `_calendar-blank-thin`: ImageVector? = null
