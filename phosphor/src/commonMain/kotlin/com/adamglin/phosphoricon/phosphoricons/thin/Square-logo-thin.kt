...
public val ThinGroup.`Square-logo-thin`: ImageVector
    get() {
        if (`_square-logo-thin` != null) {
            return `_square-logo-thin`!!
        }
        `_square-logo-thin` = Builder(name = "Square-logo-thin", defaultWidth = 256.0.dp,
...
private var `_square-logo-thin`: ImageVector? = null
