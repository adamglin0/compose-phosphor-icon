...
public val FillGroup.`Signature-fill`: ImageVector
    get() {
        if (`_signature-fill` != null) {
            return `_signature-fill`!!
        }
        `_signature-fill` = Builder(name = "Signature-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_signature-fill`: ImageVector? = null
