...
public val FillGroup.`Spotify-logo-fill`: ImageVector
    get() {
        if (`_spotify-logo-fill` != null) {
            return `_spotify-logo-fill`!!
        }
        `_spotify-logo-fill` = Builder(name = "Spotify-logo-fill", defaultWidth = 256.0.dp,
...
private var `_spotify-logo-fill`: ImageVector? = null
