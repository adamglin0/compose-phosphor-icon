...
public val ThinGroup.`Apple-logo-thin`: ImageVector
    get() {
        if (`_apple-logo-thin` != null) {
            return `_apple-logo-thin`!!
        }
        `_apple-logo-thin` = Builder(name = "Apple-logo-thin", defaultWidth = 256.0.dp,
...
private var `_apple-logo-thin`: ImageVector? = null
