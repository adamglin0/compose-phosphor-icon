...
public val FillGroup.`Music-notes-fill`: ImageVector
    get() {
        if (`_music-notes-fill` != null) {
            return `_music-notes-fill`!!
        }
        `_music-notes-fill` = Builder(name = "Music-notes-fill", defaultWidth = 256.0.dp,
...
private var `_music-notes-fill`: ImageVector? = null
