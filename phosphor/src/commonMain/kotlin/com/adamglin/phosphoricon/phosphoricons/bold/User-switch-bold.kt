...
public val BoldGroup.`User-switch-bold`: ImageVector
    get() {
        if (`_user-switch-bold` != null) {
            return `_user-switch-bold`!!
        }
        `_user-switch-bold` = Builder(name = "User-switch-bold", defaultWidth = 256.0.dp,
...
private var `_user-switch-bold`: ImageVector? = null
