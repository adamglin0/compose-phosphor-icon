...
public val LightGroup.`Television-simple-light`: ImageVector
    get() {
        if (`_television-simple-light` != null) {
            return `_television-simple-light`!!
        }
        `_television-simple-light` = Builder(name = "Television-simple-light", defaultWidth =
...
private var `_television-simple-light`: ImageVector? = null
