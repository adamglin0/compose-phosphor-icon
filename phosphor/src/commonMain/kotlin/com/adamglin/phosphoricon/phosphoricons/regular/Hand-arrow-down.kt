...
public val RegularGroup.`Hand-arrow-down`: ImageVector
    get() {
        if (`_hand-arrow-down` != null) {
            return `_hand-arrow-down`!!
        }
        `_hand-arrow-down` = Builder(name = "Hand-arrow-down", defaultWidth = 256.0.dp,
...
private var `_hand-arrow-down`: ImageVector? = null
