...
public val BoldGroup.`Bug-beetle-bold`: ImageVector
    get() {
        if (`_bug-beetle-bold` != null) {
            return `_bug-beetle-bold`!!
        }
        `_bug-beetle-bold` = Builder(name = "Bug-beetle-bold", defaultWidth = 256.0.dp,
...
private var `_bug-beetle-bold`: ImageVector? = null
