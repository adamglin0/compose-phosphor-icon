...
public val BoldGroup.`Phone-list-bold`: ImageVector
    get() {
        if (`_phone-list-bold` != null) {
            return `_phone-list-bold`!!
        }
        `_phone-list-bold` = Builder(name = "Phone-list-bold", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(144.0f, 76.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 132.0f, 64.0f)
                close()
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, true, 132.0f, 104.0f)
                close()
            }
        }
        .build()
...
private var `_phone-list-bold`: ImageVector? = null
