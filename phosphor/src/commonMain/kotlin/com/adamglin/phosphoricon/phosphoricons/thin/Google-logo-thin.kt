...
public val ThinGroup.`Google-logo-thin`: ImageVector
    get() {
        if (`_google-logo-thin` != null) {
            return `_google-logo-thin`!!
        }
        `_google-logo-thin` = Builder(name = "Google-logo-thin", defaultWidth = 256.0.dp,
...
private var `_google-logo-thin`: ImageVector? = null
