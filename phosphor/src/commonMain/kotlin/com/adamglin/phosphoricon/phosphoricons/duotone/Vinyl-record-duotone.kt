...
public val DuotoneGroup.`Vinyl-record-duotone`: ImageVector
    get() {
        if (`_vinyl-record-duotone` != null) {
            return `_vinyl-record-duotone`!!
        }
        `_vinyl-record-duotone` = Builder(name = "Vinyl-record-duotone", defaultWidth = 256.0.dp,
...
private var `_vinyl-record-duotone`: ImageVector? = null
