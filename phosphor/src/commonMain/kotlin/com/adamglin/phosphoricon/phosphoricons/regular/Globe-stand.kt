...
public val RegularGroup.`Globe-stand`: ImageVector
    get() {
        if (`_globe-stand` != null) {
            return `_globe-stand`!!
        }
        `_globe-stand` = Builder(name = "Globe-stand", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_globe-stand`: ImageVector? = null
