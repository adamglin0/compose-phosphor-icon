...
public val DuotoneGroup.`Magnifying-glass-plus-duotone`: ImageVector
    get() {
        if (`_magnifying-glass-plus-duotone` != null) {
            return `_magnifying-glass-plus-duotone`!!
        }
        `_magnifying-glass-plus-duotone` = Builder(name = "Magnifying-glass-plus-duotone",
...
private var `_magnifying-glass-plus-duotone`: ImageVector? = null
