...
public val DuotoneGroup.`Bird-duotone`: ImageVector
    get() {
        if (`_bird-duotone` != null) {
            return `_bird-duotone`!!
        }
        `_bird-duotone` = Builder(name = "Bird-duotone", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(104.0f, 99.52f)
                verticalLineTo(76.89f)
                curveToRelative(0.0f, -28.77f, 23.0f, -52.75f, 51.74f, -52.89f)
                arcToRelative(52.0f, 52.0f, 0.0f, false, true, 50.59f, 38.89f)
                close()
            }
...
private var `_bird-duotone`: ImageVector? = null
