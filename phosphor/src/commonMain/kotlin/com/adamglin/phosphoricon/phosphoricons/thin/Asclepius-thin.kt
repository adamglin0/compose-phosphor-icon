...
public val ThinGroup.`Asclepius-thin`: ImageVector
    get() {
        if (`_asclepius-thin` != null) {
            return `_asclepius-thin`!!
        }
        `_asclepius-thin` = Builder(name = "Asclepius-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_asclepius-thin`: ImageVector? = null
