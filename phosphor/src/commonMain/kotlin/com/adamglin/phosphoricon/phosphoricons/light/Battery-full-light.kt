...
public val LightGroup.`Battery-full-light`: ImageVector
    get() {
        if (`_battery-full-light` != null) {
            return `_battery-full-light`!!
        }
        `_battery-full-light` = Builder(name = "Battery-full-light", defaultWidth = 256.0.dp,
...
private var `_battery-full-light`: ImageVector? = null
