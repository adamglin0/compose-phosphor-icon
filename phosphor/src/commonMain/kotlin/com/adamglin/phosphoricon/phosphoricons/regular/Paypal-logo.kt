...
public val RegularGroup.`Paypal-logo`: ImageVector
    get() {
        if (`_paypal-logo` != null) {
            return `_paypal-logo`!!
        }
        `_paypal-logo` = Builder(name = "Paypal-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_paypal-logo`: ImageVector? = null
