...
public val ThinGroup.`Airplane-landing-thin`: ImageVector
    get() {
        if (`_airplane-landing-thin` != null) {
            return `_airplane-landing-thin`!!
        }
        `_airplane-landing-thin` = Builder(name = "Airplane-landing-thin", defaultWidth = 256.0.dp,
...
private var `_airplane-landing-thin`: ImageVector? = null
