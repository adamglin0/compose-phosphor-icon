...
public val ThinGroup.`Steering-wheel-thin`: ImageVector
    get() {
        if (`_steering-wheel-thin` != null) {
            return `_steering-wheel-thin`!!
        }
        `_steering-wheel-thin` = Builder(name = "Steering-wheel-thin", defaultWidth = 256.0.dp,
...
private var `_steering-wheel-thin`: ImageVector? = null
