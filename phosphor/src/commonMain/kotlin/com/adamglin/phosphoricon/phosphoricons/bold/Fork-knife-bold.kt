...
public val BoldGroup.`Fork-knife-bold`: ImageVector
    get() {
        if (`_fork-knife-bold` != null) {
            return `_fork-knife-bold`!!
        }
        `_fork-knife-bold` = Builder(name = "Fork-knife-bold", defaultWidth = 256.0.dp,
...
private var `_fork-knife-bold`: ImageVector? = null
