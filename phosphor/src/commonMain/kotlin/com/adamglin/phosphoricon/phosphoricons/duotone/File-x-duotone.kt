...
public val DuotoneGroup.`File-x-duotone`: ImageVector
    get() {
        if (`_file-x-duotone` != null) {
            return `_file-x-duotone`!!
        }
        `_file-x-duotone` = Builder(name = "File-x-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-x-duotone`: ImageVector? = null
