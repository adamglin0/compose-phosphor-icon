...
public val DuotoneGroup.`Receipt-duotone`: ImageVector
    get() {
        if (`_receipt-duotone` != null) {
            return `_receipt-duotone`!!
        }
        `_receipt-duotone` = Builder(name = "Receipt-duotone", defaultWidth = 256.0.dp,
...
private var `_receipt-duotone`: ImageVector? = null
