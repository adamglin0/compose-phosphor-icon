...
public val BoldGroup.`Battery-plus-vertical-bold`: ImageVector
    get() {
        if (`_battery-plus-vertical-bold` != null) {
            return `_battery-plus-vertical-bold`!!
        }
        `_battery-plus-vertical-bold` = Builder(name = "Battery-plus-vertical-bold", defaultWidth =
...
private var `_battery-plus-vertical-bold`: ImageVector? = null
