...
public val BoldGroup.`Person-arms-spread-bold`: ImageVector
    get() {
        if (`_person-arms-spread-bold` != null) {
            return `_person-arms-spread-bold`!!
        }
        `_person-arms-spread-bold` = Builder(name = "Person-arms-spread-bold", defaultWidth =
...
private var `_person-arms-spread-bold`: ImageVector? = null
