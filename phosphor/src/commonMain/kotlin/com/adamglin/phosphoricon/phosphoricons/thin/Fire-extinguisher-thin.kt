...
public val ThinGroup.`Fire-extinguisher-thin`: ImageVector
    get() {
        if (`_fire-extinguisher-thin` != null) {
            return `_fire-extinguisher-thin`!!
        }
        `_fire-extinguisher-thin` = Builder(name = "Fire-extinguisher-thin", defaultWidth =
...
private var `_fire-extinguisher-thin`: ImageVector? = null
