...
public val BoldGroup.`Bathtub-bold`: ImageVector
    get() {
        if (`_bathtub-bold` != null) {
            return `_bathtub-bold`!!
        }
        `_bathtub-bold` = Builder(name = "Bathtub-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bathtub-bold`: ImageVector? = null
