...
public val DuotoneGroup.`Seal-warning-duotone`: ImageVector
    get() {
        if (`_seal-warning-duotone` != null) {
            return `_seal-warning-duotone`!!
        }
        `_seal-warning-duotone` = Builder(name = "Seal-warning-duotone", defaultWidth = 256.0.dp,
...
private var `_seal-warning-duotone`: ImageVector? = null
