...
public val LightGroup.`Rocket-light`: ImageVector
    get() {
        if (`_rocket-light` != null) {
            return `_rocket-light`!!
        }
        `_rocket-light` = Builder(name = "Rocket-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rocket-light`: ImageVector? = null
