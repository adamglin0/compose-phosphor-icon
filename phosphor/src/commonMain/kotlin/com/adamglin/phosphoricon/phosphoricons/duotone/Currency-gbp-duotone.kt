...
public val DuotoneGroup.`Currency-gbp-duotone`: ImageVector
    get() {
        if (`_currency-gbp-duotone` != null) {
            return `_currency-gbp-duotone`!!
        }
        `_currency-gbp-duotone` = Builder(name = "Currency-gbp-duotone", defaultWidth = 256.0.dp,
...
private var `_currency-gbp-duotone`: ImageVector? = null
