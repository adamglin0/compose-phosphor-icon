...
public val ThinGroup.`Twitch-logo-thin`: ImageVector
    get() {
        if (`_twitch-logo-thin` != null) {
            return `_twitch-logo-thin`!!
        }
        `_twitch-logo-thin` = Builder(name = "Twitch-logo-thin", defaultWidth = 256.0.dp,
...
private var `_twitch-logo-thin`: ImageVector? = null
