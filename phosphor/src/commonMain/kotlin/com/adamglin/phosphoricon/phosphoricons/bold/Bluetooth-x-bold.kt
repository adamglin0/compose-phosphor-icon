...
public val BoldGroup.`Bluetooth-x-bold`: ImageVector
    get() {
        if (`_bluetooth-x-bold` != null) {
            return `_bluetooth-x-bold`!!
        }
        `_bluetooth-x-bold` = Builder(name = "Bluetooth-x-bold", defaultWidth = 256.0.dp,
...
private var `_bluetooth-x-bold`: ImageVector? = null
