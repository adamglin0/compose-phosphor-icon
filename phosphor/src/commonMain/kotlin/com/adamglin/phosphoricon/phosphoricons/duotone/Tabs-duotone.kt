...
public val DuotoneGroup.`Tabs-duotone`: ImageVector
    get() {
        if (`_tabs-duotone` != null) {
            return `_tabs-duotone`!!
        }
        `_tabs-duotone` = Builder(name = "Tabs-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tabs-duotone`: ImageVector? = null
