...
public val LightGroup.`Balloon-light`: ImageVector
    get() {
        if (`_balloon-light` != null) {
            return `_balloon-light`!!
        }
        `_balloon-light` = Builder(name = "Balloon-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_balloon-light`: ImageVector? = null
