...
public val DuotoneGroup.`Gift-duotone`: ImageVector
    get() {
        if (`_gift-duotone` != null) {
            return `_gift-duotone`!!
        }
        `_gift-duotone` = Builder(name = "Gift-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gift-duotone`: ImageVector? = null
