...
public val DuotoneGroup.`Push-pin-duotone`: ImageVector
    get() {
        if (`_push-pin-duotone` != null) {
            return `_push-pin-duotone`!!
        }
        `_push-pin-duotone` = Builder(name = "Push-pin-duotone", defaultWidth = 256.0.dp,
...
private var `_push-pin-duotone`: ImageVector? = null
