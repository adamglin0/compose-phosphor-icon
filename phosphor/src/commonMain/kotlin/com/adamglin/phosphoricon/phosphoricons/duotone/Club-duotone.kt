...
public val DuotoneGroup.`Club-duotone`: ImageVector
    get() {
        if (`_club-duotone` != null) {
            return `_club-duotone`!!
        }
        `_club-duotone` = Builder(name = "Club-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_club-duotone`: ImageVector? = null
