...
public val DuotoneGroup.`Onigiri-duotone`: ImageVector
    get() {
        if (`_onigiri-duotone` != null) {
            return `_onigiri-duotone`!!
        }
        `_onigiri-duotone` = Builder(name = "Onigiri-duotone", defaultWidth = 256.0.dp,
...
private var `_onigiri-duotone`: ImageVector? = null
