...
public val LightGroup.`Vinyl-record-light`: ImageVector
    get() {
        if (`_vinyl-record-light` != null) {
            return `_vinyl-record-light`!!
        }
        `_vinyl-record-light` = Builder(name = "Vinyl-record-light", defaultWidth = 256.0.dp,
...
private var `_vinyl-record-light`: ImageVector? = null
