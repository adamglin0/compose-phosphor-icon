...
public val ThinGroup.`Alien-thin`: ImageVector
    get() {
        if (`_alien-thin` != null) {
            return `_alien-thin`!!
        }
        `_alien-thin` = Builder(name = "Alien-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_alien-thin`: ImageVector? = null
