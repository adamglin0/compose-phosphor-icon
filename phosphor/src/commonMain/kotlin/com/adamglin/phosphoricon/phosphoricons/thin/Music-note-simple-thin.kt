...
public val ThinGroup.`Music-note-simple-thin`: ImageVector
    get() {
        if (`_music-note-simple-thin` != null) {
            return `_music-note-simple-thin`!!
        }
        `_music-note-simple-thin` = Builder(name = "Music-note-simple-thin", defaultWidth =
...
private var `_music-note-simple-thin`: ImageVector? = null
