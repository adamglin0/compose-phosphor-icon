...
public val LightGroup.`File-lock-light`: ImageVector
    get() {
        if (`_file-lock-light` != null) {
            return `_file-lock-light`!!
        }
        `_file-lock-light` = Builder(name = "File-lock-light", defaultWidth = 256.0.dp,
...
private var `_file-lock-light`: ImageVector? = null
