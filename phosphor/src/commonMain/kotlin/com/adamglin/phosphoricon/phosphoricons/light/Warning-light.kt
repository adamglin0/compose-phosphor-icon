...
public val LightGroup.`Warning-light`: ImageVector
    get() {
        if (`_warning-light` != null) {
            return `_warning-light`!!
        }
        `_warning-light` = Builder(name = "Warning-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_warning-light`: ImageVector? = null
