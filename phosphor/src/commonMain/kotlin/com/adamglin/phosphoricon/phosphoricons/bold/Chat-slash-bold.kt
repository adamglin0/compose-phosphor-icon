...
public val BoldGroup.`Chat-slash-bold`: ImageVector
    get() {
        if (`_chat-slash-bold` != null) {
            return `_chat-slash-bold`!!
        }
        `_chat-slash-bold` = Builder(name = "Chat-slash-bold", defaultWidth = 256.0.dp,
...
private var `_chat-slash-bold`: ImageVector? = null
