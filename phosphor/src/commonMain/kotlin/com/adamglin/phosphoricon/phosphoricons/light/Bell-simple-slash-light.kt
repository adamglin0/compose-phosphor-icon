...
public val LightGroup.`Bell-simple-slash-light`: ImageVector
    get() {
        if (`_bell-simple-slash-light` != null) {
            return `_bell-simple-slash-light`!!
        }
        `_bell-simple-slash-light` = Builder(name = "Bell-simple-slash-light", defaultWidth =
...
private var `_bell-simple-slash-light`: ImageVector? = null
