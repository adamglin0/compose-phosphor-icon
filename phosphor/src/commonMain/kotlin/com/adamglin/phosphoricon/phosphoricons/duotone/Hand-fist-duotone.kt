...
public val DuotoneGroup.`Hand-fist-duotone`: ImageVector
    get() {
        if (`_hand-fist-duotone` != null) {
            return `_hand-fist-duotone`!!
        }
        `_hand-fist-duotone` = Builder(name = "Hand-fist-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-fist-duotone`: ImageVector? = null
