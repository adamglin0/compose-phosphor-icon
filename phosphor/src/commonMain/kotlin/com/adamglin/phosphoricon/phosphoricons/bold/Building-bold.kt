...
public val BoldGroup.`Building-bold`: ImageVector
    get() {
        if (`_building-bold` != null) {
            return `_building-bold`!!
        }
        `_building-bold` = Builder(name = "Building-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_building-bold`: ImageVector? = null
