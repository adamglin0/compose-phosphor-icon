...
public val BoldGroup.`Wheelchair-motion-bold`: ImageVector
    get() {
        if (`_wheelchair-motion-bold` != null) {
            return `_wheelchair-motion-bold`!!
        }
        `_wheelchair-motion-bold` = Builder(name = "Wheelchair-motion-bold", defaultWidth =
...
private var `_wheelchair-motion-bold`: ImageVector? = null
