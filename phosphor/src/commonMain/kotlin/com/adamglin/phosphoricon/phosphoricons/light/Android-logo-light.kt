...
public val LightGroup.`Android-logo-light`: ImageVector
    get() {
        if (`_android-logo-light` != null) {
            return `_android-logo-light`!!
        }
        `_android-logo-light` = Builder(name = "Android-logo-light", defaultWidth = 256.0.dp,
...
private var `_android-logo-light`: ImageVector? = null
