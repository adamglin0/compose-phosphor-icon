...
public val FillGroup.`Text-t-slash-fill`: ImageVector
    get() {
        if (`_text-t-slash-fill` != null) {
            return `_text-t-slash-fill`!!
        }
        `_text-t-slash-fill` = Builder(name = "Text-t-slash-fill", defaultWidth = 256.0.dp,
...
private var `_text-t-slash-fill`: ImageVector? = null
