...
public val LightGroup.`Pi-light`: ImageVector
    get() {
        if (`_pi-light` != null) {
            return `_pi-light`!!
        }
        `_pi-light` = Builder(name = "Pi-light", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_pi-light`: ImageVector? = null
