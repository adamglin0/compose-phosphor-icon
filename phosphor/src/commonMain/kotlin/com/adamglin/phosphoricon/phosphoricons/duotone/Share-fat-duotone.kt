...
public val DuotoneGroup.`Share-fat-duotone`: ImageVector
    get() {
        if (`_share-fat-duotone` != null) {
            return `_share-fat-duotone`!!
        }
        `_share-fat-duotone` = Builder(name = "Share-fat-duotone", defaultWidth = 256.0.dp,
...
private var `_share-fat-duotone`: ImageVector? = null
