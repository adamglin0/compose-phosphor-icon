...
public val ThinGroup.`Translate-thin`: ImageVector
    get() {
        if (`_translate-thin` != null) {
            return `_translate-thin`!!
        }
        `_translate-thin` = Builder(name = "Translate-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_translate-thin`: ImageVector? = null
