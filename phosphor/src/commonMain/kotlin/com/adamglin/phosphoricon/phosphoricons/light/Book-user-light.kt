...
public val LightGroup.`Book-user-light`: ImageVector
    get() {
        if (`_book-user-light` != null) {
            return `_book-user-light`!!
        }
        `_book-user-light` = Builder(name = "Book-user-light", defaultWidth = 256.0.dp,
...
private var `_book-user-light`: ImageVector? = null
