...
public val RegularGroup.`Car-battery`: ImageVector
    get() {
        if (`_car-battery` != null) {
            return `_car-battery`!!
        }
        `_car-battery` = Builder(name = "Car-battery", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_car-battery`: ImageVector? = null
