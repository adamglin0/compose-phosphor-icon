...
public val ThinGroup.`Number-square-zero-thin`: ImageVector
    get() {
        if (`_number-square-zero-thin` != null) {
            return `_number-square-zero-thin`!!
        }
        `_number-square-zero-thin` = Builder(name = "Number-square-zero-thin", defaultWidth =
...
private var `_number-square-zero-thin`: ImageVector? = null
