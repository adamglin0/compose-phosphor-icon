...
public val ThinGroup.`Arrow-square-down-right-thin`: ImageVector
    get() {
        if (`_arrow-square-down-right-thin` != null) {
            return `_arrow-square-down-right-thin`!!
        }
        `_arrow-square-down-right-thin` = Builder(name = "Arrow-square-down-right-thin",
...
private var `_arrow-square-down-right-thin`: ImageVector? = null
