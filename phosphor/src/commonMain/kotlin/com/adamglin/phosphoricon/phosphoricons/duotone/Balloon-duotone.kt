...
public val DuotoneGroup.`Balloon-duotone`: ImageVector
    get() {
        if (`_balloon-duotone` != null) {
            return `_balloon-duotone`!!
        }
        `_balloon-duotone` = Builder(name = "Balloon-duotone", defaultWidth = 256.0.dp,
...
private var `_balloon-duotone`: ImageVector? = null
