...
public val LightGroup.`Columns-light`: ImageVector
    get() {
        if (`_columns-light` != null) {
            return `_columns-light`!!
        }
        `_columns-light` = Builder(name = "Columns-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_columns-light`: ImageVector? = null
