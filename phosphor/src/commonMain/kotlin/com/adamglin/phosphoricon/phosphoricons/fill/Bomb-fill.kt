...
public val FillGroup.`Bomb-fill`: ImageVector
    get() {
        if (`_bomb-fill` != null) {
            return `_bomb-fill`!!
        }
        `_bomb-fill` = Builder(name = "Bomb-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bomb-fill`: ImageVector? = null
