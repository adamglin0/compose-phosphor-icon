...
public val ThinGroup.`Eye-closed-thin`: ImageVector
    get() {
        if (`_eye-closed-thin` != null) {
            return `_eye-closed-thin`!!
        }
        `_eye-closed-thin` = Builder(name = "Eye-closed-thin", defaultWidth = 256.0.dp,
...
private var `_eye-closed-thin`: ImageVector? = null
