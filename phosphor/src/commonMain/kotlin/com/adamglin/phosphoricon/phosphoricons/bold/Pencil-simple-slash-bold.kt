...
public val BoldGroup.`Pencil-simple-slash-bold`: ImageVector
    get() {
        if (`_pencil-simple-slash-bold` != null) {
            return `_pencil-simple-slash-bold`!!
        }
        `_pencil-simple-slash-bold` = Builder(name = "Pencil-simple-slash-bold", defaultWidth =
...
private var `_pencil-simple-slash-bold`: ImageVector? = null
