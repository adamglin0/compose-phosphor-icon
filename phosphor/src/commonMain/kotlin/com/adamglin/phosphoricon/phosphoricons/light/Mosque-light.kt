...
public val LightGroup.`Mosque-light`: ImageVector
    get() {
        if (`_mosque-light` != null) {
            return `_mosque-light`!!
        }
        `_mosque-light` = Builder(name = "Mosque-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mosque-light`: ImageVector? = null
