...
public val DuotoneGroup.`Bell-slash-duotone`: ImageVector
    get() {
        if (`_bell-slash-duotone` != null) {
            return `_bell-slash-duotone`!!
        }
        `_bell-slash-duotone` = Builder(name = "Bell-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_bell-slash-duotone`: ImageVector? = null
