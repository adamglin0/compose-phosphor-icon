...
public val DuotoneGroup.`Hand-arrow-down-duotone`: ImageVector
    get() {
        if (`_hand-arrow-down-duotone` != null) {
            return `_hand-arrow-down-duotone`!!
        }
        `_hand-arrow-down-duotone` = Builder(name = "Hand-arrow-down-duotone", defaultWidth =
...
private var `_hand-arrow-down-duotone`: ImageVector? = null
