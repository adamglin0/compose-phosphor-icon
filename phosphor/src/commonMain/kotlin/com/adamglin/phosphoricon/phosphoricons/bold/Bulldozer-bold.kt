...
public val BoldGroup.`Bulldozer-bold`: ImageVector
    get() {
        if (`_bulldozer-bold` != null) {
            return `_bulldozer-bold`!!
        }
        `_bulldozer-bold` = Builder(name = "Bulldozer-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bulldozer-bold`: ImageVector? = null
