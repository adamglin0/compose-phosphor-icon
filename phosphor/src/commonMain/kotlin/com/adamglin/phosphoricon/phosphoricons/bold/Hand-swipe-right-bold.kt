...
public val BoldGroup.`Hand-swipe-right-bold`: ImageVector
    get() {
        if (`_hand-swipe-right-bold` != null) {
            return `_hand-swipe-right-bold`!!
        }
        `_hand-swipe-right-bold` = Builder(name = "Hand-swipe-right-bold", defaultWidth = 256.0.dp,
...
private var `_hand-swipe-right-bold`: ImageVector? = null
