...
public val BoldGroup.`Selection-foreground-bold`: ImageVector
    get() {
        if (`_selection-foreground-bold` != null) {
            return `_selection-foreground-bold`!!
        }
        `_selection-foreground-bold` = Builder(name = "Selection-foreground-bold", defaultWidth =
...
private var `_selection-foreground-bold`: ImageVector? = null
