...
public val BoldGroup.`Cloud-sun-bold`: ImageVector
    get() {
        if (`_cloud-sun-bold` != null) {
            return `_cloud-sun-bold`!!
        }
        `_cloud-sun-bold` = Builder(name = "Cloud-sun-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cloud-sun-bold`: ImageVector? = null
