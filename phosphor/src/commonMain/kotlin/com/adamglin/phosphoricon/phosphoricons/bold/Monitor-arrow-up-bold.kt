...
public val BoldGroup.`Monitor-arrow-up-bold`: ImageVector
    get() {
        if (`_monitor-arrow-up-bold` != null) {
            return `_monitor-arrow-up-bold`!!
        }
        `_monitor-arrow-up-bold` = Builder(name = "Monitor-arrow-up-bold", defaultWidth = 256.0.dp,
...
private var `_monitor-arrow-up-bold`: ImageVector? = null
