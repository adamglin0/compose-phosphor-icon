...
public val FillGroup.`Chart-donut-fill`: ImageVector
    get() {
        if (`_chart-donut-fill` != null) {
            return `_chart-donut-fill`!!
        }
        `_chart-donut-fill` = Builder(name = "Chart-donut-fill", defaultWidth = 256.0.dp,
...
private var `_chart-donut-fill`: ImageVector? = null
