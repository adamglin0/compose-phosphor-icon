...
public val BoldGroup.`X-circle-bold`: ImageVector
    get() {
        if (`_x-circle-bold` != null) {
            return `_x-circle-bold`!!
        }
        `_x-circle-bold` = Builder(name = "X-circle-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_x-circle-bold`: ImageVector? = null
