...
public val ThinGroup.`Headset-thin`: ImageVector
    get() {
        if (`_headset-thin` != null) {
            return `_headset-thin`!!
        }
        `_headset-thin` = Builder(name = "Headset-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_headset-thin`: ImageVector? = null
