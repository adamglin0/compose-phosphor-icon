...
public val ThinGroup.`Network-thin`: ImageVector
    get() {
        if (`_network-thin` != null) {
            return `_network-thin`!!
        }
        `_network-thin` = Builder(name = "Network-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_network-thin`: ImageVector? = null
