...
public val LightGroup.`Spade-light`: ImageVector
    get() {
        if (`_spade-light` != null) {
            return `_spade-light`!!
        }
        `_spade-light` = Builder(name = "Spade-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spade-light`: ImageVector? = null
