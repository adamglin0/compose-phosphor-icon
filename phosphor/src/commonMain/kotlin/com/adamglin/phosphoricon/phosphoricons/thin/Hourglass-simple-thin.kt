...
public val ThinGroup.`Hourglass-simple-thin`: ImageVector
    get() {
        if (`_hourglass-simple-thin` != null) {
            return `_hourglass-simple-thin`!!
        }
        `_hourglass-simple-thin` = Builder(name = "Hourglass-simple-thin", defaultWidth = 256.0.dp,
...
private var `_hourglass-simple-thin`: ImageVector? = null
