...
public val BoldGroup.`Asterisk-simple-bold`: ImageVector
    get() {
        if (`_asterisk-simple-bold` != null) {
            return `_asterisk-simple-bold`!!
        }
        `_asterisk-simple-bold` = Builder(name = "Asterisk-simple-bold", defaultWidth = 256.0.dp,
...
private var `_asterisk-simple-bold`: ImageVector? = null
