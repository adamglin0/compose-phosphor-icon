...
public val ThinGroup.`Spinner-ball-thin`: ImageVector
    get() {
        if (`_spinner-ball-thin` != null) {
            return `_spinner-ball-thin`!!
        }
        `_spinner-ball-thin` = Builder(name = "Spinner-ball-thin", defaultWidth = 256.0.dp,
...
private var `_spinner-ball-thin`: ImageVector? = null
