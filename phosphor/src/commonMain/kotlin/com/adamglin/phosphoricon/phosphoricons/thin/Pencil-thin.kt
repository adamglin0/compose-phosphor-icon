...
public val ThinGroup.`Pencil-thin`: ImageVector
    get() {
        if (`_pencil-thin` != null) {
            return `_pencil-thin`!!
        }
        `_pencil-thin` = Builder(name = "Pencil-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pencil-thin`: ImageVector? = null
