...
public val ThinGroup.`Compass-rose-thin`: ImageVector
    get() {
        if (`_compass-rose-thin` != null) {
            return `_compass-rose-thin`!!
        }
        `_compass-rose-thin` = Builder(name = "Compass-rose-thin", defaultWidth = 256.0.dp,
...
private var `_compass-rose-thin`: ImageVector? = null
