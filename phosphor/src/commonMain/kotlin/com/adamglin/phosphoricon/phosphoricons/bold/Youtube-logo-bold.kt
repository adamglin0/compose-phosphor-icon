...
public val BoldGroup.`Youtube-logo-bold`: ImageVector
    get() {
        if (`_youtube-logo-bold` != null) {
            return `_youtube-logo-bold`!!
        }
        `_youtube-logo-bold` = Builder(name = "Youtube-logo-bold", defaultWidth = 256.0.dp,
...
private var `_youtube-logo-bold`: ImageVector? = null
