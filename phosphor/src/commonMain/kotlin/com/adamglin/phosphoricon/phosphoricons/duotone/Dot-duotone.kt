...
public val DuotoneGroup.`Dot-duotone`: ImageVector
    get() {
        if (`_dot-duotone` != null) {
            return `_dot-duotone`!!
        }
        `_dot-duotone` = Builder(name = "Dot-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dot-duotone`: ImageVector? = null
