...
public val DuotoneGroup.`Hand-eye-duotone`: ImageVector
    get() {
        if (`_hand-eye-duotone` != null) {
            return `_hand-eye-duotone`!!
        }
        `_hand-eye-duotone` = Builder(name = "Hand-eye-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-eye-duotone`: ImageVector? = null
