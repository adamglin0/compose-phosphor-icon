...
public val RegularGroup.`Map-trifold`: ImageVector
    get() {
        if (`_map-trifold` != null) {
            return `_map-trifold`!!
        }
        `_map-trifold` = Builder(name = "Map-trifold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_map-trifold`: ImageVector? = null
