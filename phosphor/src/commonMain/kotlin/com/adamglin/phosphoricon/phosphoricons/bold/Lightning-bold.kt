...
public val BoldGroup.`Lightning-bold`: ImageVector
    get() {
        if (`_lightning-bold` != null) {
            return `_lightning-bold`!!
        }
        `_lightning-bold` = Builder(name = "Lightning-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_lightning-bold`: ImageVector? = null
