...
public val RegularGroup.`Text-h-six`: ImageVector
    get() {
        if (`_text-h-six` != null) {
            return `_text-h-six`!!
        }
        `_text-h-six` = Builder(name = "Text-h-six", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-h-six`: ImageVector? = null
