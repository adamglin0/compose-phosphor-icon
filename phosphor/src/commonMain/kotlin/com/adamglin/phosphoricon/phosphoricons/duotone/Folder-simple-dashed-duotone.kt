...
public val DuotoneGroup.`Folder-simple-dashed-duotone`: ImageVector
    get() {
        if (`_folder-simple-dashed-duotone` != null) {
            return `_folder-simple-dashed-duotone`!!
        }
        `_folder-simple-dashed-duotone` = Builder(name = "Folder-simple-dashed-duotone",
...
private var `_folder-simple-dashed-duotone`: ImageVector? = null
