...
public val FillGroup.`Fast-forward-fill`: ImageVector
    get() {
        if (`_fast-forward-fill` != null) {
            return `_fast-forward-fill`!!
        }
        `_fast-forward-fill` = Builder(name = "Fast-forward-fill", defaultWidth = 256.0.dp,
...
private var `_fast-forward-fill`: ImageVector? = null
