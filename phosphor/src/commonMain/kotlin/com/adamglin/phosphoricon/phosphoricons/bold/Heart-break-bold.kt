...
public val BoldGroup.`Heart-break-bold`: ImageVector
    get() {
        if (`_heart-break-bold` != null) {
            return `_heart-break-bold`!!
        }
        `_heart-break-bold` = Builder(name = "Heart-break-bold", defaultWidth = 256.0.dp,
...
private var `_heart-break-bold`: ImageVector? = null
