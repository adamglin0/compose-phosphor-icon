...
public val LightGroup.`Address-book-light`: ImageVector
    get() {
        if (`_address-book-light` != null) {
            return `_address-book-light`!!
        }
        `_address-book-light` = Builder(name = "Address-book-light", defaultWidth = 256.0.dp,
...
private var `_address-book-light`: ImageVector? = null
