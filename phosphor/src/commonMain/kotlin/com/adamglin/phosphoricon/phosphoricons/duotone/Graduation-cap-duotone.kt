...
public val DuotoneGroup.`Graduation-cap-duotone`: ImageVector
    get() {
        if (`_graduation-cap-duotone` != null) {
            return `_graduation-cap-duotone`!!
        }
        `_graduation-cap-duotone` = Builder(name = "Graduation-cap-duotone", defaultWidth =
...
private var `_graduation-cap-duotone`: ImageVector? = null
