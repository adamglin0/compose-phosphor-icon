...
public val RegularGroup.`Hand-swipe-right`: ImageVector
    get() {
        if (`_hand-swipe-right` != null) {
            return `_hand-swipe-right`!!
        }
        `_hand-swipe-right` = Builder(name = "Hand-swipe-right", defaultWidth = 256.0.dp,
...
private var `_hand-swipe-right`: ImageVector? = null
