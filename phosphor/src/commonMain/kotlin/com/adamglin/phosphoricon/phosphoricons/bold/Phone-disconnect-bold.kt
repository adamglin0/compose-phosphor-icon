...
public val BoldGroup.`Phone-disconnect-bold`: ImageVector
    get() {
        if (`_phone-disconnect-bold` != null) {
            return `_phone-disconnect-bold`!!
        }
        `_phone-disconnect-bold` = Builder(name = "Phone-disconnect-bold", defaultWidth = 256.0.dp,
...
private var `_phone-disconnect-bold`: ImageVector? = null
