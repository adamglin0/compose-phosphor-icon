...
public val DuotoneGroup.`List-star-duotone`: ImageVector
    get() {
        if (`_list-star-duotone` != null) {
            return `_list-star-duotone`!!
        }
        `_list-star-duotone` = Builder(name = "List-star-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(205.6f, 159.41f)
                lineTo(213.67f, 192.0f)
                lineTo(184.0f, 174.54f)
                lineTo(154.33f, 192.0f)
                lineToRelative(8.07f, -32.59f)
                lineTo(136.0f, 137.61f)
                lineToRelative(34.65f, -2.67f)
                lineTo(184.0f, 104.0f)
                lineToRelative(13.35f, 30.94f)
                lineTo(232.0f, 137.61f)
                close()
            }
...
private var `_list-star-duotone`: ImageVector? = null
