...
public val DuotoneGroup.`Folder-minus-duotone`: ImageVector
    get() {
        if (`_folder-minus-duotone` != null) {
            return `_folder-minus-duotone`!!
        }
        `_folder-minus-duotone` = Builder(name = "Folder-minus-duotone", defaultWidth = 256.0.dp,
...
private var `_folder-minus-duotone`: ImageVector? = null
