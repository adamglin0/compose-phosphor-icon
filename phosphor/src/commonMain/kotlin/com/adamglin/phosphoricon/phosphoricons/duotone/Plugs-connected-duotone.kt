...
public val DuotoneGroup.`Plugs-connected-duotone`: ImageVector
    get() {
        if (`_plugs-connected-duotone` != null) {
            return `_plugs-connected-duotone`!!
        }
        `_plugs-connected-duotone` = Builder(name = "Plugs-connected-duotone", defaultWidth =
...
private var `_plugs-connected-duotone`: ImageVector? = null
