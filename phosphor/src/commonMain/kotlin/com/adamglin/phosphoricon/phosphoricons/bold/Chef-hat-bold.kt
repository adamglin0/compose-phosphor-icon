...
public val BoldGroup.`Chef-hat-bold`: ImageVector
    get() {
        if (`_chef-hat-bold` != null) {
            return `_chef-hat-bold`!!
        }
        `_chef-hat-bold` = Builder(name = "Chef-hat-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chef-hat-bold`: ImageVector? = null
