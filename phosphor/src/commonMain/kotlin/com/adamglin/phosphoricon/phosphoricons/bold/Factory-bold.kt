...
public val BoldGroup.`Factory-bold`: ImageVector
    get() {
        if (`_factory-bold` != null) {
            return `_factory-bold`!!
        }
        `_factory-bold` = Builder(name = "Factory-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_factory-bold`: ImageVector? = null
