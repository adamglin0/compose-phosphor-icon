...
public val BoldGroup.`Paint-bucket-bold`: ImageVector
    get() {
        if (`_paint-bucket-bold` != null) {
            return `_paint-bucket-bold`!!
        }
        `_paint-bucket-bold` = Builder(name = "Paint-bucket-bold", defaultWidth = 256.0.dp,
...
private var `_paint-bucket-bold`: ImageVector? = null
