...
public val LightGroup.`Toggle-left-light`: ImageVector
    get() {
        if (`_toggle-left-light` != null) {
            return `_toggle-left-light`!!
        }
        `_toggle-left-light` = Builder(name = "Toggle-left-light", defaultWidth = 256.0.dp,
...
private var `_toggle-left-light`: ImageVector? = null
