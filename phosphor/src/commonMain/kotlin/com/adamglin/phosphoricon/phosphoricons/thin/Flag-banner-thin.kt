...
public val ThinGroup.`Flag-banner-thin`: ImageVector
    get() {
        if (`_flag-banner-thin` != null) {
            return `_flag-banner-thin`!!
        }
        `_flag-banner-thin` = Builder(name = "Flag-banner-thin", defaultWidth = 256.0.dp,
...
private var `_flag-banner-thin`: ImageVector? = null
