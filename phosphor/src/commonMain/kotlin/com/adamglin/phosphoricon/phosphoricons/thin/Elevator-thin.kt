...
public val ThinGroup.`Elevator-thin`: ImageVector
    get() {
        if (`_elevator-thin` != null) {
            return `_elevator-thin`!!
        }
        `_elevator-thin` = Builder(name = "Elevator-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_elevator-thin`: ImageVector? = null
