...
public val BoldGroup.`Farm-bold`: ImageVector
    get() {
        if (`_farm-bold` != null) {
            return `_farm-bold`!!
        }
        `_farm-bold` = Builder(name = "Farm-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_farm-bold`: ImageVector? = null
