...
public val BoldGroup.`Copyleft-bold`: ImageVector
    get() {
        if (`_copyleft-bold` != null) {
            return `_copyleft-bold`!!
        }
        `_copyleft-bold` = Builder(name = "Copyleft-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_copyleft-bold`: ImageVector? = null
