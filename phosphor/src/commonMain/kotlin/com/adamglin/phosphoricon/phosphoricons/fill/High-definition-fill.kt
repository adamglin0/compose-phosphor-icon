...
public val FillGroup.`High-definition-fill`: ImageVector
    get() {
        if (`_high-definition-fill` != null) {
            return `_high-definition-fill`!!
        }
        `_high-definition-fill` = Builder(name = "High-definition-fill", defaultWidth = 256.0.dp,
...
private var `_high-definition-fill`: ImageVector? = null
