...
public val LightGroup.`Smiley-x-eyes-light`: ImageVector
    get() {
        if (`_smiley-x-eyes-light` != null) {
            return `_smiley-x-eyes-light`!!
        }
        `_smiley-x-eyes-light` = Builder(name = "Smiley-x-eyes-light", defaultWidth = 256.0.dp,
...
private var `_smiley-x-eyes-light`: ImageVector? = null
