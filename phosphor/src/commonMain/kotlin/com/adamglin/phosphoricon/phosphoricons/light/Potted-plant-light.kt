...
public val LightGroup.`Potted-plant-light`: ImageVector
    get() {
        if (`_potted-plant-light` != null) {
            return `_potted-plant-light`!!
        }
        `_potted-plant-light` = Builder(name = "Potted-plant-light", defaultWidth = 256.0.dp,
...
private var `_potted-plant-light`: ImageVector? = null
