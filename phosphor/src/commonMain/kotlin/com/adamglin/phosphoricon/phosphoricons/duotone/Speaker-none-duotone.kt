...
public val DuotoneGroup.`Speaker-none-duotone`: ImageVector
    get() {
        if (`_speaker-none-duotone` != null) {
            return `_speaker-none-duotone`!!
        }
        `_speaker-none-duotone` = Builder(name = "Speaker-none-duotone", defaultWidth = 256.0.dp,
...
private var `_speaker-none-duotone`: ImageVector? = null
