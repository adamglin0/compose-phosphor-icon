...
public val ThinGroup.`Train-thin`: ImageVector
    get() {
        if (`_train-thin` != null) {
            return `_train-thin`!!
        }
        `_train-thin` = Builder(name = "Train-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_train-thin`: ImageVector? = null
