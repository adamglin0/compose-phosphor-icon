...
public val LightGroup.`Cell-signal-x-light`: ImageVector
    get() {
        if (`_cell-signal-x-light` != null) {
            return `_cell-signal-x-light`!!
        }
        `_cell-signal-x-light` = Builder(name = "Cell-signal-x-light", defaultWidth = 256.0.dp,
...
private var `_cell-signal-x-light`: ImageVector? = null
