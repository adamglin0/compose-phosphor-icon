...
public val DuotoneGroup.`Solar-panel-duotone`: ImageVector
    get() {
        if (`_solar-panel-duotone` != null) {
            return `_solar-panel-duotone`!!
        }
        `_solar-panel-duotone` = Builder(name = "Solar-panel-duotone", defaultWidth = 256.0.dp,
...
private var `_solar-panel-duotone`: ImageVector? = null
