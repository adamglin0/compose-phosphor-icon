...
public val ThinGroup.`Swatches-thin`: ImageVector
    get() {
        if (`_swatches-thin` != null) {
            return `_swatches-thin`!!
        }
        `_swatches-thin` = Builder(name = "Swatches-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_swatches-thin`: ImageVector? = null
