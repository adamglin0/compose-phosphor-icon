...
public val ThinGroup.`Option-thin`: ImageVector
    get() {
        if (`_option-thin` != null) {
            return `_option-thin`!!
        }
        `_option-thin` = Builder(name = "Option-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_option-thin`: ImageVector? = null
