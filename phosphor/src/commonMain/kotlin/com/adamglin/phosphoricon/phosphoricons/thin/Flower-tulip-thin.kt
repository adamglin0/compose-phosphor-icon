...
public val ThinGroup.`Flower-tulip-thin`: ImageVector
    get() {
        if (`_flower-tulip-thin` != null) {
            return `_flower-tulip-thin`!!
        }
        `_flower-tulip-thin` = Builder(name = "Flower-tulip-thin", defaultWidth = 256.0.dp,
...
private var `_flower-tulip-thin`: ImageVector? = null
