...
public val LightGroup.`Sun-dim-light`: ImageVector
    get() {
        if (`_sun-dim-light` != null) {
            return `_sun-dim-light`!!
        }
        `_sun-dim-light` = Builder(name = "Sun-dim-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sun-dim-light`: ImageVector? = null
