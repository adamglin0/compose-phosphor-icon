...
public val DuotoneGroup.`Fire-extinguisher-duotone`: ImageVector
    get() {
        if (`_fire-extinguisher-duotone` != null) {
            return `_fire-extinguisher-duotone`!!
        }
        `_fire-extinguisher-duotone` = Builder(name = "Fire-extinguisher-duotone", defaultWidth =
...
private var `_fire-extinguisher-duotone`: ImageVector? = null
