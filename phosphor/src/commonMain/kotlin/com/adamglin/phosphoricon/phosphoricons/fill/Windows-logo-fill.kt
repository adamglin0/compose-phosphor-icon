...
public val FillGroup.`Windows-logo-fill`: ImageVector
    get() {
        if (`_windows-logo-fill` != null) {
            return `_windows-logo-fill`!!
        }
        `_windows-logo-fill` = Builder(name = "Windows-logo-fill", defaultWidth = 256.0.dp,
...
private var `_windows-logo-fill`: ImageVector? = null
