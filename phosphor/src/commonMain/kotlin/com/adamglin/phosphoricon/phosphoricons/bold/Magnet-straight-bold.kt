...
public val BoldGroup.`Magnet-straight-bold`: ImageVector
    get() {
        if (`_magnet-straight-bold` != null) {
            return `_magnet-straight-bold`!!
        }
        `_magnet-straight-bold` = Builder(name = "Magnet-straight-bold", defaultWidth = 256.0.dp,
...
private var `_magnet-straight-bold`: ImageVector? = null
