...
public val BoldGroup.`Clock-clockwise-bold`: ImageVector
    get() {
        if (`_clock-clockwise-bold` != null) {
            return `_clock-clockwise-bold`!!
        }
        `_clock-clockwise-bold` = Builder(name = "Clock-clockwise-bold", defaultWidth = 256.0.dp,
...
private var `_clock-clockwise-bold`: ImageVector? = null
