...
public val BoldGroup.`Smiley-nervous-bold`: ImageVector
    get() {
        if (`_smiley-nervous-bold` != null) {
            return `_smiley-nervous-bold`!!
        }
        `_smiley-nervous-bold` = Builder(name = "Smiley-nervous-bold", defaultWidth = 256.0.dp,
...
private var `_smiley-nervous-bold`: ImageVector? = null
