...
public val ThinGroup.`Microscope-thin`: ImageVector
    get() {
        if (`_microscope-thin` != null) {
            return `_microscope-thin`!!
        }
        `_microscope-thin` = Builder(name = "Microscope-thin", defaultWidth = 256.0.dp,
...
private var `_microscope-thin`: ImageVector? = null
