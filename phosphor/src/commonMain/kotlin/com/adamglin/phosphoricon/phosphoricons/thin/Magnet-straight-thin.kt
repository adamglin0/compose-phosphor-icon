...
public val ThinGroup.`Magnet-straight-thin`: ImageVector
    get() {
        if (`_magnet-straight-thin` != null) {
            return `_magnet-straight-thin`!!
        }
        `_magnet-straight-thin` = Builder(name = "Magnet-straight-thin", defaultWidth = 256.0.dp,
...
private var `_magnet-straight-thin`: ImageVector? = null
