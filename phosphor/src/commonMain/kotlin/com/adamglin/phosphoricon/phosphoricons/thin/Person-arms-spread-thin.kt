...
public val ThinGroup.`Person-arms-spread-thin`: ImageVector
    get() {
        if (`_person-arms-spread-thin` != null) {
            return `_person-arms-spread-thin`!!
        }
        `_person-arms-spread-thin` = Builder(name = "Person-arms-spread-thin", defaultWidth =
...
private var `_person-arms-spread-thin`: ImageVector? = null
