...
public val LightGroup.`Cross-light`: ImageVector
    get() {
        if (`_cross-light` != null) {
            return `_cross-light`!!
        }
        `_cross-light` = Builder(name = "Cross-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cross-light`: ImageVector? = null
