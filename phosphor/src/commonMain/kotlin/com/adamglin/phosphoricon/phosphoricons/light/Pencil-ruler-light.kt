...
public val LightGroup.`Pencil-ruler-light`: ImageVector
    get() {
        if (`_pencil-ruler-light` != null) {
            return `_pencil-ruler-light`!!
        }
        `_pencil-ruler-light` = Builder(name = "Pencil-ruler-light", defaultWidth = 256.0.dp,
...
private var `_pencil-ruler-light`: ImageVector? = null
