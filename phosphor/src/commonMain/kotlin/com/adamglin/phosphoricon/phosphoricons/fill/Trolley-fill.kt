...
public val FillGroup.`Trolley-fill`: ImageVector
    get() {
        if (`_trolley-fill` != null) {
            return `_trolley-fill`!!
        }
        `_trolley-fill` = Builder(name = "Trolley-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, false, 88.0f, 160.0f)
                close()
            }
        }
        .build()
...
private var `_trolley-fill`: ImageVector? = null
