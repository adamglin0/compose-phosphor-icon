...
public val LightGroup.`Chat-text-light`: ImageVector
    get() {
        if (`_chat-text-light` != null) {
            return `_chat-text-light`!!
        }
        `_chat-text-light` = Builder(name = "Chat-text-light", defaultWidth = 256.0.dp,
...
private var `_chat-text-light`: ImageVector? = null
