...
public val BoldGroup.`Stack-overflow-logo-bold`: ImageVector
    get() {
        if (`_stack-overflow-logo-bold` != null) {
            return `_stack-overflow-logo-bold`!!
        }
        `_stack-overflow-logo-bold` = Builder(name = "Stack-overflow-logo-bold", defaultWidth =
...
private var `_stack-overflow-logo-bold`: ImageVector? = null
