...
public val BoldGroup.`Crop-bold`: ImageVector
    get() {
        if (`_crop-bold` != null) {
            return `_crop-bold`!!
        }
        `_crop-bold` = Builder(name = "Crop-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_crop-bold`: ImageVector? = null
