...
public val FillGroup.`Butterfly-fill`: ImageVector
    get() {
        if (`_butterfly-fill` != null) {
            return `_butterfly-fill`!!
        }
        `_butterfly-fill` = Builder(name = "Butterfly-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_butterfly-fill`: ImageVector? = null
