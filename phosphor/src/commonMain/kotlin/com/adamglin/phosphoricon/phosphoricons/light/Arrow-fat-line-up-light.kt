...
public val LightGroup.`Arrow-fat-line-up-light`: ImageVector
    get() {
        if (`_arrow-fat-line-up-light` != null) {
            return `_arrow-fat-line-up-light`!!
        }
        `_arrow-fat-line-up-light` = Builder(name = "Arrow-fat-line-up-light", defaultWidth =
...
private var `_arrow-fat-line-up-light`: ImageVector? = null
