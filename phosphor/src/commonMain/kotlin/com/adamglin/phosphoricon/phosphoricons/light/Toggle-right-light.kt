...
public val LightGroup.`Toggle-right-light`: ImageVector
    get() {
        if (`_toggle-right-light` != null) {
            return `_toggle-right-light`!!
        }
        `_toggle-right-light` = Builder(name = "Toggle-right-light", defaultWidth = 256.0.dp,
...
private var `_toggle-right-light`: ImageVector? = null
