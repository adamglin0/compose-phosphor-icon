...
public val LightGroup.`Barcode-light`: ImageVector
    get() {
        if (`_barcode-light` != null) {
            return `_barcode-light`!!
        }
        `_barcode-light` = Builder(name = "Barcode-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barcode-light`: ImageVector? = null
