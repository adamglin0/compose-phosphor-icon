...
public val ThinGroup.`Paint-bucket-thin`: ImageVector
    get() {
        if (`_paint-bucket-thin` != null) {
            return `_paint-bucket-thin`!!
        }
        `_paint-bucket-thin` = Builder(name = "Paint-bucket-thin", defaultWidth = 256.0.dp,
...
private var `_paint-bucket-thin`: ImageVector? = null
