...
public val LightGroup.`Engine-light`: ImageVector
    get() {
        if (`_engine-light` != null) {
            return `_engine-light`!!
        }
        `_engine-light` = Builder(name = "Engine-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_engine-light`: ImageVector? = null
