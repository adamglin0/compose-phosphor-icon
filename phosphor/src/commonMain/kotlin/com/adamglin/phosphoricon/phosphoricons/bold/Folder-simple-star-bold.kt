...
public val BoldGroup.`Folder-simple-star-bold`: ImageVector
    get() {
        if (`_folder-simple-star-bold` != null) {
            return `_folder-simple-star-bold`!!
        }
        `_folder-simple-star-bold` = Builder(name = "Folder-simple-star-bold", defaultWidth =
...
private var `_folder-simple-star-bold`: ImageVector? = null
