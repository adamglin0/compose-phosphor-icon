...
public val DuotoneGroup.`Dice-one-duotone`: ImageVector
    get() {
        if (`_dice-one-duotone` != null) {
            return `_dice-one-duotone`!!
        }
        `_dice-one-duotone` = Builder(name = "Dice-one-duotone", defaultWidth = 256.0.dp,
...
private var `_dice-one-duotone`: ImageVector? = null
