...
public val RegularGroup.`Goodreads-logo`: ImageVector
    get() {
        if (`_goodreads-logo` != null) {
            return `_goodreads-logo`!!
        }
        `_goodreads-logo` = Builder(name = "Goodreads-logo", defaultWidth = 256.0.dp, defaultHeight
...
private var `_goodreads-logo`: ImageVector? = null
