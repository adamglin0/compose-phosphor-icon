...
public val BoldGroup.`File-x-bold`: ImageVector
    get() {
        if (`_file-x-bold` != null) {
            return `_file-x-bold`!!
        }
        `_file-x-bold` = Builder(name = "File-x-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-x-bold`: ImageVector? = null
