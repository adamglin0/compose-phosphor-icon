...
public val BoldGroup.`Star-bold`: ImageVector
    get() {
        if (`_star-bold` != null) {
            return `_star-bold`!!
        }
        `_star-bold` = Builder(name = "Star-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_star-bold`: ImageVector? = null
