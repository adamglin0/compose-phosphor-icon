...
public val DuotoneGroup.`Lock-key-duotone`: ImageVector
    get() {
        if (`_lock-key-duotone` != null) {
            return `_lock-key-duotone`!!
        }
        `_lock-key-duotone` = Builder(name = "Lock-key-duotone", defaultWidth = 256.0.dp,
...
private var `_lock-key-duotone`: ImageVector? = null
