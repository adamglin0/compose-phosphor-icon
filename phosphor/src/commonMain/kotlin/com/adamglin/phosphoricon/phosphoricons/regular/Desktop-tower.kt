...
public val RegularGroup.`Desktop-tower`: ImageVector
    get() {
        if (`_desktop-tower` != null) {
            return `_desktop-tower`!!
        }
        `_desktop-tower` = Builder(name = "Desktop-tower", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_desktop-tower`: ImageVector? = null
