...
public val BoldGroup.`Sort-ascending-bold`: ImageVector
    get() {
        if (`_sort-ascending-bold` != null) {
            return `_sort-ascending-bold`!!
        }
        `_sort-ascending-bold` = Builder(name = "Sort-ascending-bold", defaultWidth = 256.0.dp,
...
private var `_sort-ascending-bold`: ImageVector? = null
