...
public val BoldGroup.`Exclude-bold`: ImageVector
    get() {
        if (`_exclude-bold` != null) {
            return `_exclude-bold`!!
        }
        `_exclude-bold` = Builder(name = "Exclude-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_exclude-bold`: ImageVector? = null
