...
public val FillGroup.`Stack-overflow-logo-fill`: ImageVector
    get() {
        if (`_stack-overflow-logo-fill` != null) {
            return `_stack-overflow-logo-fill`!!
        }
        `_stack-overflow-logo-fill` = Builder(name = "Stack-overflow-logo-fill", defaultWidth =
...
private var `_stack-overflow-logo-fill`: ImageVector? = null
