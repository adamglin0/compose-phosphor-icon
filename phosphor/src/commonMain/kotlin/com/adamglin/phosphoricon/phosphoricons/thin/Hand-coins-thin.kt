...
public val ThinGroup.`Hand-coins-thin`: ImageVector
    get() {
        if (`_hand-coins-thin` != null) {
            return `_hand-coins-thin`!!
        }
        `_hand-coins-thin` = Builder(name = "Hand-coins-thin", defaultWidth = 256.0.dp,
...
private var `_hand-coins-thin`: ImageVector? = null
