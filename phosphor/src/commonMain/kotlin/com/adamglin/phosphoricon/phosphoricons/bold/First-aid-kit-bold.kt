...
public val BoldGroup.`First-aid-kit-bold`: ImageVector
    get() {
        if (`_first-aid-kit-bold` != null) {
            return `_first-aid-kit-bold`!!
        }
        `_first-aid-kit-bold` = Builder(name = "First-aid-kit-bold", defaultWidth = 256.0.dp,
...
private var `_first-aid-kit-bold`: ImageVector? = null
