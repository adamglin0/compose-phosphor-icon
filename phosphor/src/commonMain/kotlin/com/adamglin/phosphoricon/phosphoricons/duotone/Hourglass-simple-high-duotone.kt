...
public val DuotoneGroup.`Hourglass-simple-high-duotone`: ImageVector
    get() {
        if (`_hourglass-simple-high-duotone` != null) {
            return `_hourglass-simple-high-duotone`!!
        }
        `_hourglass-simple-high-duotone` = Builder(name = "Hourglass-simple-high-duotone",
...
private var `_hourglass-simple-high-duotone`: ImageVector? = null
