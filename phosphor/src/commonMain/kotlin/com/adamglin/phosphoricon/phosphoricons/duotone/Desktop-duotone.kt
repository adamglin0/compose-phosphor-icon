...
public val DuotoneGroup.`Desktop-duotone`: ImageVector
    get() {
        if (`_desktop-duotone` != null) {
            return `_desktop-duotone`!!
        }
        `_desktop-duotone` = Builder(name = "Desktop-duotone", defaultWidth = 256.0.dp,
...
private var `_desktop-duotone`: ImageVector? = null
