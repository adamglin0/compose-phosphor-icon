...
public val DuotoneGroup.`Currency-eth-duotone`: ImageVector
    get() {
        if (`_currency-eth-duotone` != null) {
            return `_currency-eth-duotone`!!
        }
        `_currency-eth-duotone` = Builder(name = "Currency-eth-duotone", defaultWidth = 256.0.dp,
...
private var `_currency-eth-duotone`: ImageVector? = null
