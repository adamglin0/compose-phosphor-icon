...
public val LightGroup.`Patreon-logo-light`: ImageVector
    get() {
        if (`_patreon-logo-light` != null) {
            return `_patreon-logo-light`!!
        }
        `_patreon-logo-light` = Builder(name = "Patreon-logo-light", defaultWidth = 256.0.dp,
...
private var `_patreon-logo-light`: ImageVector? = null
