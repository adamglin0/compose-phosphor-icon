...
public val DuotoneGroup.`Chair-duotone`: ImageVector
    get() {
        if (`_chair-duotone` != null) {
            return `_chair-duotone`!!
        }
        `_chair-duotone` = Builder(name = "Chair-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chair-duotone`: ImageVector? = null
