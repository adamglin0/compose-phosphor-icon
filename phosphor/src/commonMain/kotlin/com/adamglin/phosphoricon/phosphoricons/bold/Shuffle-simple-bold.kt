...
public val BoldGroup.`Shuffle-simple-bold`: ImageVector
    get() {
        if (`_shuffle-simple-bold` != null) {
            return `_shuffle-simple-bold`!!
        }
        `_shuffle-simple-bold` = Builder(name = "Shuffle-simple-bold", defaultWidth = 256.0.dp,
...
private var `_shuffle-simple-bold`: ImageVector? = null
