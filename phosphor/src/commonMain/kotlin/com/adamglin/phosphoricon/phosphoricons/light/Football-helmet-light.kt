...
public val LightGroup.`Football-helmet-light`: ImageVector
    get() {
        if (`_football-helmet-light` != null) {
            return `_football-helmet-light`!!
        }
        `_football-helmet-light` = Builder(name = "Football-helmet-light", defaultWidth = 256.0.dp,
...
private var `_football-helmet-light`: ImageVector? = null
