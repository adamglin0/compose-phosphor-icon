...
public val DuotoneGroup.`Gps-duotone`: ImageVector
    get() {
        if (`_gps-duotone` != null) {
            return `_gps-duotone`!!
        }
        `_gps-duotone` = Builder(name = "Gps-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gps-duotone`: ImageVector? = null
