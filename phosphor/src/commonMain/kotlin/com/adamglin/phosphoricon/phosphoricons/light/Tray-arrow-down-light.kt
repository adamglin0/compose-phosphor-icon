...
public val LightGroup.`Tray-arrow-down-light`: ImageVector
    get() {
        if (`_tray-arrow-down-light` != null) {
            return `_tray-arrow-down-light`!!
        }
        `_tray-arrow-down-light` = Builder(name = "Tray-arrow-down-light", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-down-light`: ImageVector? = null
