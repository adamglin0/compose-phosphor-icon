...
public val ThinGroup.`Password-thin`: ImageVector
    get() {
        if (`_password-thin` != null) {
            return `_password-thin`!!
        }
        `_password-thin` = Builder(name = "Password-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_password-thin`: ImageVector? = null
