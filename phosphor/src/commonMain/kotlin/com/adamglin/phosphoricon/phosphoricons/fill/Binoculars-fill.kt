...
public val FillGroup.`Binoculars-fill`: ImageVector
    get() {
        if (`_binoculars-fill` != null) {
            return `_binoculars-fill`!!
        }
        `_binoculars-fill` = Builder(name = "Binoculars-fill", defaultWidth = 256.0.dp,
...
private var `_binoculars-fill`: ImageVector? = null
