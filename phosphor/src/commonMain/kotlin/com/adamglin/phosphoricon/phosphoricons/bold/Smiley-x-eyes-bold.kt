...
public val BoldGroup.`Smiley-x-eyes-bold`: ImageVector
    get() {
        if (`_smiley-x-eyes-bold` != null) {
            return `_smiley-x-eyes-bold`!!
        }
        `_smiley-x-eyes-bold` = Builder(name = "Smiley-x-eyes-bold", defaultWidth = 256.0.dp,
...
private var `_smiley-x-eyes-bold`: ImageVector? = null
