...
public val BoldGroup.`Selection-all-bold`: ImageVector
    get() {
        if (`_selection-all-bold` != null) {
            return `_selection-all-bold`!!
        }
        `_selection-all-bold` = Builder(name = "Selection-all-bold", defaultWidth = 256.0.dp,
...
private var `_selection-all-bold`: ImageVector? = null
