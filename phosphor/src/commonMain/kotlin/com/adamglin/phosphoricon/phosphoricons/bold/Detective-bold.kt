...
public val BoldGroup.`Detective-bold`: ImageVector
    get() {
        if (`_detective-bold` != null) {
            return `_detective-bold`!!
        }
        `_detective-bold` = Builder(name = "Detective-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_detective-bold`: ImageVector? = null
