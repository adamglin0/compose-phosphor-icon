...
public val FillGroup.`Speaker-low-fill`: ImageVector
    get() {
        if (`_speaker-low-fill` != null) {
            return `_speaker-low-fill`!!
        }
        `_speaker-low-fill` = Builder(name = "Speaker-low-fill", defaultWidth = 256.0.dp,
...
private var `_speaker-low-fill`: ImageVector? = null
