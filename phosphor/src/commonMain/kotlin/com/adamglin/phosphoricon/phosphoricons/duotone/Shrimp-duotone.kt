...
public val DuotoneGroup.`Shrimp-duotone`: ImageVector
    get() {
        if (`_shrimp-duotone` != null) {
            return `_shrimp-duotone`!!
        }
        `_shrimp-duotone` = Builder(name = "Shrimp-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_shrimp-duotone`: ImageVector? = null
