...
public val DuotoneGroup.`Storefront-duotone`: ImageVector
    get() {
        if (`_storefront-duotone` != null) {
            return `_storefront-duotone`!!
        }
        `_storefront-duotone` = Builder(name = "Storefront-duotone", defaultWidth = 256.0.dp,
...
private var `_storefront-duotone`: ImageVector? = null
