...
public val LightGroup.`Not-member-of-light`: ImageVector
    get() {
        if (`_not-member-of-light` != null) {
            return `_not-member-of-light`!!
        }
        `_not-member-of-light` = Builder(name = "Not-member-of-light", defaultWidth = 256.0.dp,
...
private var `_not-member-of-light`: ImageVector? = null
