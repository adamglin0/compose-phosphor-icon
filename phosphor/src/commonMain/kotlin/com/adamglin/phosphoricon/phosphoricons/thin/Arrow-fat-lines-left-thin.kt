...
public val ThinGroup.`Arrow-fat-lines-left-thin`: ImageVector
    get() {
        if (`_arrow-fat-lines-left-thin` != null) {
            return `_arrow-fat-lines-left-thin`!!
        }
        `_arrow-fat-lines-left-thin` = Builder(name = "Arrow-fat-lines-left-thin", defaultWidth =
...
private var `_arrow-fat-lines-left-thin`: ImageVector? = null
