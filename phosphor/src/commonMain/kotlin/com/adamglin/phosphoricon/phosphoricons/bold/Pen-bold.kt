...
public val BoldGroup.`Pen-bold`: ImageVector
    get() {
        if (`_pen-bold` != null) {
            return `_pen-bold`!!
        }
        `_pen-bold` = Builder(name = "Pen-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_pen-bold`: ImageVector? = null
