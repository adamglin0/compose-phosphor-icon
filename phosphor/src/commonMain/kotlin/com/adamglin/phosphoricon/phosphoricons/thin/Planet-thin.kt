...
public val ThinGroup.`Planet-thin`: ImageVector
    get() {
        if (`_planet-thin` != null) {
            return `_planet-thin`!!
        }
        `_planet-thin` = Builder(name = "Planet-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_planet-thin`: ImageVector? = null
