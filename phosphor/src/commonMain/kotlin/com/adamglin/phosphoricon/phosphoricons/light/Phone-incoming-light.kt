...
public val LightGroup.`Phone-incoming-light`: ImageVector
    get() {
        if (`_phone-incoming-light` != null) {
            return `_phone-incoming-light`!!
        }
        `_phone-incoming-light` = Builder(name = "Phone-incoming-light", defaultWidth = 256.0.dp,
...
private var `_phone-incoming-light`: ImageVector? = null
