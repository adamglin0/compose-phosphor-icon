...
public val LightGroup.`Currency-dollar-simple-light`: ImageVector
    get() {
        if (`_currency-dollar-simple-light` != null) {
            return `_currency-dollar-simple-light`!!
        }
        `_currency-dollar-simple-light` = Builder(name = "Currency-dollar-simple-light",
...
private var `_currency-dollar-simple-light`: ImageVector? = null
