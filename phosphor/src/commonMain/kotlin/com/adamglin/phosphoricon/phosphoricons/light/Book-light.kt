...
public val LightGroup.`Book-light`: ImageVector
    get() {
        if (`_book-light` != null) {
            return `_book-light`!!
        }
        `_book-light` = Builder(name = "Book-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_book-light`: ImageVector? = null
