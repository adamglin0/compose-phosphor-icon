...
public val ThinGroup.`Text-t-slash-thin`: ImageVector
    get() {
        if (`_text-t-slash-thin` != null) {
            return `_text-t-slash-thin`!!
        }
        `_text-t-slash-thin` = Builder(name = "Text-t-slash-thin", defaultWidth = 256.0.dp,
...
private var `_text-t-slash-thin`: ImageVector? = null
