...
public val BoldGroup.`Dev-to-logo-bold`: ImageVector
    get() {
        if (`_dev-to-logo-bold` != null) {
            return `_dev-to-logo-bold`!!
        }
        `_dev-to-logo-bold` = Builder(name = "Dev-to-logo-bold", defaultWidth = 256.0.dp,
...
private var `_dev-to-logo-bold`: ImageVector? = null
