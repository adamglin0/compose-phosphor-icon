...
public val ThinGroup.`Arrow-fat-line-down-thin`: ImageVector
    get() {
        if (`_arrow-fat-line-down-thin` != null) {
            return `_arrow-fat-line-down-thin`!!
        }
        `_arrow-fat-line-down-thin` = Builder(name = "Arrow-fat-line-down-thin", defaultWidth =
...
private var `_arrow-fat-line-down-thin`: ImageVector? = null
