...
public val ThinGroup.`Coin-vertical-thin`: ImageVector
    get() {
        if (`_coin-vertical-thin` != null) {
            return `_coin-vertical-thin`!!
        }
        `_coin-vertical-thin` = Builder(name = "Coin-vertical-thin", defaultWidth = 256.0.dp,
...
private var `_coin-vertical-thin`: ImageVector? = null
