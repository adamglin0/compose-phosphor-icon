...
public val LightGroup.`Currency-eth-light`: ImageVector
    get() {
        if (`_currency-eth-light` != null) {
            return `_currency-eth-light`!!
        }
        `_currency-eth-light` = Builder(name = "Currency-eth-light", defaultWidth = 256.0.dp,
...
private var `_currency-eth-light`: ImageVector? = null
