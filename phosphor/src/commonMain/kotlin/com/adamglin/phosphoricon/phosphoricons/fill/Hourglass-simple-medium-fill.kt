...
public val FillGroup.`Hourglass-simple-medium-fill`: ImageVector
    get() {
        if (`_hourglass-simple-medium-fill` != null) {
            return `_hourglass-simple-medium-fill`!!
        }
        `_hourglass-simple-medium-fill` = Builder(name = "Hourglass-simple-medium-fill",
...
private var `_hourglass-simple-medium-fill`: ImageVector? = null
