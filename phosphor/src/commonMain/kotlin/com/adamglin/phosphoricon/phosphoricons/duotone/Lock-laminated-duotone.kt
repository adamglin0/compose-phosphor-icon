...
public val DuotoneGroup.`Lock-laminated-duotone`: ImageVector
    get() {
        if (`_lock-laminated-duotone` != null) {
            return `_lock-laminated-duotone`!!
        }
        `_lock-laminated-duotone` = Builder(name = "Lock-laminated-duotone", defaultWidth =
...
private var `_lock-laminated-duotone`: ImageVector? = null
