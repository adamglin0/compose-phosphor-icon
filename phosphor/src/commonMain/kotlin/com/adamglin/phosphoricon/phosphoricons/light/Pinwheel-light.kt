...
public val LightGroup.`Pinwheel-light`: ImageVector
    get() {
        if (`_pinwheel-light` != null) {
            return `_pinwheel-light`!!
        }
        `_pinwheel-light` = Builder(name = "Pinwheel-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_pinwheel-light`: ImageVector? = null
