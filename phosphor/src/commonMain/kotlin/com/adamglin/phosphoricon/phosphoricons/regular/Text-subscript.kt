...
public val RegularGroup.`Text-subscript`: ImageVector
    get() {
        if (`_text-subscript` != null) {
            return `_text-subscript`!!
        }
        `_text-subscript` = Builder(name = "Text-subscript", defaultWidth = 256.0.dp, defaultHeight
...
private var `_text-subscript`: ImageVector? = null
