...
public val DuotoneGroup.`Laptop-duotone`: ImageVector
    get() {
        if (`_laptop-duotone` != null) {
            return `_laptop-duotone`!!
        }
        `_laptop-duotone` = Builder(name = "Laptop-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_laptop-duotone`: ImageVector? = null
