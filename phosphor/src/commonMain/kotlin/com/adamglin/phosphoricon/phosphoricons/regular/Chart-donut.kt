...
public val RegularGroup.`Chart-donut`: ImageVector
    get() {
        if (`_chart-donut` != null) {
            return `_chart-donut`!!
        }
        `_chart-donut` = Builder(name = "Chart-donut", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chart-donut`: ImageVector? = null
