...
public val LightGroup.`Hourglass-simple-medium-light`: ImageVector
    get() {
        if (`_hourglass-simple-medium-light` != null) {
            return `_hourglass-simple-medium-light`!!
        }
        `_hourglass-simple-medium-light` = Builder(name = "Hourglass-simple-medium-light",
...
private var `_hourglass-simple-medium-light`: ImageVector? = null
