...
public val LightGroup.`Gps-slash-light`: ImageVector
    get() {
        if (`_gps-slash-light` != null) {
            return `_gps-slash-light`!!
        }
        `_gps-slash-light` = Builder(name = "Gps-slash-light", defaultWidth = 256.0.dp,
...
private var `_gps-slash-light`: ImageVector? = null
