...
public val LightGroup.`Bag-simple-light`: ImageVector
    get() {
        if (`_bag-simple-light` != null) {
            return `_bag-simple-light`!!
        }
        `_bag-simple-light` = Builder(name = "Bag-simple-light", defaultWidth = 256.0.dp,
...
private var `_bag-simple-light`: ImageVector? = null
