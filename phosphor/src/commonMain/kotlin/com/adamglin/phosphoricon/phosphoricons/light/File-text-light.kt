...
public val LightGroup.`File-text-light`: ImageVector
    get() {
        if (`_file-text-light` != null) {
            return `_file-text-light`!!
        }
        `_file-text-light` = Builder(name = "File-text-light", defaultWidth = 256.0.dp,
...
private var `_file-text-light`: ImageVector? = null
