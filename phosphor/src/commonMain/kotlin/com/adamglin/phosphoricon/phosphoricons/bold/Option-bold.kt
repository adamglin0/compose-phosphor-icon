...
public val BoldGroup.`Option-bold`: ImageVector
    get() {
        if (`_option-bold` != null) {
            return `_option-bold`!!
        }
        `_option-bold` = Builder(name = "Option-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_option-bold`: ImageVector? = null
