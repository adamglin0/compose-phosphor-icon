...
public val BoldGroup.`Skip-back-circle-bold`: ImageVector
    get() {
        if (`_skip-back-circle-bold` != null) {
            return `_skip-back-circle-bold`!!
        }
        `_skip-back-circle-bold` = Builder(name = "Skip-back-circle-bold", defaultWidth = 256.0.dp,
...
private var `_skip-back-circle-bold`: ImageVector? = null
