...
public val DuotoneGroup.`File-code-duotone`: ImageVector
    get() {
        if (`_file-code-duotone` != null) {
            return `_file-code-duotone`!!
        }
        `_file-code-duotone` = Builder(name = "File-code-duotone", defaultWidth = 256.0.dp,
...
private var `_file-code-duotone`: ImageVector? = null
