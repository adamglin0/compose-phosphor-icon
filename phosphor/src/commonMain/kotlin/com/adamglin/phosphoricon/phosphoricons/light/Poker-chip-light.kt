...
public val LightGroup.`Poker-chip-light`: ImageVector
    get() {
        if (`_poker-chip-light` != null) {
            return `_poker-chip-light`!!
        }
        `_poker-chip-light` = Builder(name = "Poker-chip-light", defaultWidth = 256.0.dp,
...
private var `_poker-chip-light`: ImageVector? = null
