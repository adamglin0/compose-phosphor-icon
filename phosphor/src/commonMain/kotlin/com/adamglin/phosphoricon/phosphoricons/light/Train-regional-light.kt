...
public val LightGroup.`Train-regional-light`: ImageVector
    get() {
        if (`_train-regional-light` != null) {
            return `_train-regional-light`!!
        }
        `_train-regional-light` = Builder(name = "Train-regional-light", defaultWidth = 256.0.dp,
...
private var `_train-regional-light`: ImageVector? = null
