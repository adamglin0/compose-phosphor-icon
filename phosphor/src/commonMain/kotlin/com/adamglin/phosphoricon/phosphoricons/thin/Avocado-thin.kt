...
public val ThinGroup.`Avocado-thin`: ImageVector
    get() {
        if (`_avocado-thin` != null) {
            return `_avocado-thin`!!
        }
        `_avocado-thin` = Builder(name = "Avocado-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_avocado-thin`: ImageVector? = null
