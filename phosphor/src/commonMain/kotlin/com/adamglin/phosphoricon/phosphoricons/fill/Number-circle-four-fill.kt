...
public val FillGroup.`Number-circle-four-fill`: ImageVector
    get() {
        if (`_number-circle-four-fill` != null) {
            return `_number-circle-four-fill`!!
        }
        `_number-circle-four-fill` = Builder(name = "Number-circle-four-fill", defaultWidth =
...
private var `_number-circle-four-fill`: ImageVector? = null
