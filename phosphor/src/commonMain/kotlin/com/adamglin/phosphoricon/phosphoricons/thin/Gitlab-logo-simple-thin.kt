...
public val ThinGroup.`Gitlab-logo-simple-thin`: ImageVector
    get() {
        if (`_gitlab-logo-simple-thin` != null) {
            return `_gitlab-logo-simple-thin`!!
        }
        `_gitlab-logo-simple-thin` = Builder(name = "Gitlab-logo-simple-thin", defaultWidth =
...
private var `_gitlab-logo-simple-thin`: ImageVector? = null
