...
public val DuotoneGroup.`Steam-logo-duotone`: ImageVector
    get() {
        if (`_steam-logo-duotone` != null) {
            return `_steam-logo-duotone`!!
        }
        `_steam-logo-duotone` = Builder(name = "Steam-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_steam-logo-duotone`: ImageVector? = null
