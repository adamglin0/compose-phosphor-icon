...
public val DuotoneGroup.`Television-duotone`: ImageVector
    get() {
        if (`_television-duotone` != null) {
            return `_television-duotone`!!
        }
        `_television-duotone` = Builder(name = "Television-duotone", defaultWidth = 256.0.dp,
...
private var `_television-duotone`: ImageVector? = null
