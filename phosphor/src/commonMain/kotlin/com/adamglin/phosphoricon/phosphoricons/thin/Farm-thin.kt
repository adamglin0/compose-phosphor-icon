...
public val ThinGroup.`Farm-thin`: ImageVector
    get() {
        if (`_farm-thin` != null) {
            return `_farm-thin`!!
        }
        `_farm-thin` = Builder(name = "Farm-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_farm-thin`: ImageVector? = null
