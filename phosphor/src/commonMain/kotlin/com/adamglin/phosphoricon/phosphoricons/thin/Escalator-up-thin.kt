...
public val ThinGroup.`Escalator-up-thin`: ImageVector
    get() {
        if (`_escalator-up-thin` != null) {
            return `_escalator-up-thin`!!
        }
        `_escalator-up-thin` = Builder(name = "Escalator-up-thin", defaultWidth = 256.0.dp,
...
private var `_escalator-up-thin`: ImageVector? = null
