...
public val LightGroup.`Four-k-light`: ImageVector
    get() {
        if (`_four-k-light` != null) {
            return `_four-k-light`!!
        }
        `_four-k-light` = Builder(name = "Four-k-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_four-k-light`: ImageVector? = null
