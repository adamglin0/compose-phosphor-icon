...
public val FillGroup.`Hourglass-high-fill`: ImageVector
    get() {
        if (`_hourglass-high-fill` != null) {
            return `_hourglass-high-fill`!!
        }
        `_hourglass-high-fill` = Builder(name = "Hourglass-high-fill", defaultWidth = 256.0.dp,
...
private var `_hourglass-high-fill`: ImageVector? = null
