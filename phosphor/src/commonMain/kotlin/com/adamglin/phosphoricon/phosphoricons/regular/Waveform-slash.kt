...
public val RegularGroup.`Waveform-slash`: ImageVector
    get() {
        if (`_waveform-slash` != null) {
            return `_waveform-slash`!!
        }
        `_waveform-slash` = Builder(name = "Waveform-slash", defaultWidth = 256.0.dp, defaultHeight
...
private var `_waveform-slash`: ImageVector? = null
