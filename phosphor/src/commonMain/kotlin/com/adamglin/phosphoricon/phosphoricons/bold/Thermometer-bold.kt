...
public val BoldGroup.`Thermometer-bold`: ImageVector
    get() {
        if (`_thermometer-bold` != null) {
            return `_thermometer-bold`!!
        }
        `_thermometer-bold` = Builder(name = "Thermometer-bold", defaultWidth = 256.0.dp,
...
private var `_thermometer-bold`: ImageVector? = null
