...
public val RegularGroup.`Toilet-paper`: ImageVector
    get() {
        if (`_toilet-paper` != null) {
            return `_toilet-paper`!!
        }
        `_toilet-paper` = Builder(name = "Toilet-paper", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_toilet-paper`: ImageVector? = null
