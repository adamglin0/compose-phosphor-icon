...
public val BoldGroup.`Pipe-wrench-bold`: ImageVector
    get() {
        if (`_pipe-wrench-bold` != null) {
            return `_pipe-wrench-bold`!!
        }
        `_pipe-wrench-bold` = Builder(name = "Pipe-wrench-bold", defaultWidth = 256.0.dp,
...
private var `_pipe-wrench-bold`: ImageVector? = null
