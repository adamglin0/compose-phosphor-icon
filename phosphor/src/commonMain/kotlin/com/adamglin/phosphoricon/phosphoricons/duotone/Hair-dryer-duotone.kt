...
public val DuotoneGroup.`Hair-dryer-duotone`: ImageVector
    get() {
        if (`_hair-dryer-duotone` != null) {
            return `_hair-dryer-duotone`!!
        }
        `_hair-dryer-duotone` = Builder(name = "Hair-dryer-duotone", defaultWidth = 256.0.dp,
...
private var `_hair-dryer-duotone`: ImageVector? = null
