...
public val LightGroup.`Bell-simple-ringing-light`: ImageVector
    get() {
        if (`_bell-simple-ringing-light` != null) {
            return `_bell-simple-ringing-light`!!
        }
        `_bell-simple-ringing-light` = Builder(name = "Bell-simple-ringing-light", defaultWidth =
...
private var `_bell-simple-ringing-light`: ImageVector? = null
