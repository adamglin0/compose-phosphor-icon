...
public val BoldGroup.`Cloud-rain-bold`: ImageVector
    get() {
        if (`_cloud-rain-bold` != null) {
            return `_cloud-rain-bold`!!
        }
        `_cloud-rain-bold` = Builder(name = "Cloud-rain-bold", defaultWidth = 256.0.dp,
...
private var `_cloud-rain-bold`: ImageVector? = null
