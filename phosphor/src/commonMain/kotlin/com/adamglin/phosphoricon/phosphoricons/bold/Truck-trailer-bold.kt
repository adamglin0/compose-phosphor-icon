...
public val BoldGroup.`Truck-trailer-bold`: ImageVector
    get() {
        if (`_truck-trailer-bold` != null) {
            return `_truck-trailer-bold`!!
        }
        `_truck-trailer-bold` = Builder(name = "Truck-trailer-bold", defaultWidth = 256.0.dp,
...
private var `_truck-trailer-bold`: ImageVector? = null
