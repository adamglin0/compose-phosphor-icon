...
public val ThinGroup.`Ear-slash-thin`: ImageVector
    get() {
        if (`_ear-slash-thin` != null) {
            return `_ear-slash-thin`!!
        }
        `_ear-slash-thin` = Builder(name = "Ear-slash-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_ear-slash-thin`: ImageVector? = null
