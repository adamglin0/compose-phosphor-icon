...
public val BoldGroup.`Synagogue-bold`: ImageVector
    get() {
        if (`_synagogue-bold` != null) {
            return `_synagogue-bold`!!
        }
        `_synagogue-bold` = Builder(name = "Synagogue-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_synagogue-bold`: ImageVector? = null
