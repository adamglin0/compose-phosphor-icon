...
public val LightGroup.`Rainbow-light`: ImageVector
    get() {
        if (`_rainbow-light` != null) {
            return `_rainbow-light`!!
        }
        `_rainbow-light` = Builder(name = "Rainbow-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rainbow-light`: ImageVector? = null
