...
public val LightGroup.`Windmill-light`: ImageVector
    get() {
        if (`_windmill-light` != null) {
            return `_windmill-light`!!
        }
        `_windmill-light` = Builder(name = "Windmill-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_windmill-light`: ImageVector? = null
