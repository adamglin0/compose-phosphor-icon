...
public val ThinGroup.`Perspective-thin`: ImageVector
    get() {
        if (`_perspective-thin` != null) {
            return `_perspective-thin`!!
        }
        `_perspective-thin` = Builder(name = "Perspective-thin", defaultWidth = 256.0.dp,
...
private var `_perspective-thin`: ImageVector? = null
