...
public val ThinGroup.`Moped-thin`: ImageVector
    get() {
        if (`_moped-thin` != null) {
            return `_moped-thin`!!
        }
        `_moped-thin` = Builder(name = "Moped-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_moped-thin`: ImageVector? = null
