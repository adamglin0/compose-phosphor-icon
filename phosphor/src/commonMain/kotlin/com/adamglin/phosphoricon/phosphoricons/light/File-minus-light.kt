...
public val LightGroup.`File-minus-light`: ImageVector
    get() {
        if (`_file-minus-light` != null) {
            return `_file-minus-light`!!
        }
        `_file-minus-light` = Builder(name = "File-minus-light", defaultWidth = 256.0.dp,
...
private var `_file-minus-light`: ImageVector? = null
