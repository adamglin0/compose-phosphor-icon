...
public val ThinGroup.`Number-square-nine-thin`: ImageVector
    get() {
        if (`_number-square-nine-thin` != null) {
            return `_number-square-nine-thin`!!
        }
        `_number-square-nine-thin` = Builder(name = "Number-square-nine-thin", defaultWidth =
...
private var `_number-square-nine-thin`: ImageVector? = null
