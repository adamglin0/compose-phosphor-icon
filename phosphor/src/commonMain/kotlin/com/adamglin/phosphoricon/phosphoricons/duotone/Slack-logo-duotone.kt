...
public val DuotoneGroup.`Slack-logo-duotone`: ImageVector
    get() {
        if (`_slack-logo-duotone` != null) {
            return `_slack-logo-duotone`!!
        }
        `_slack-logo-duotone` = Builder(name = "Slack-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_slack-logo-duotone`: ImageVector? = null
