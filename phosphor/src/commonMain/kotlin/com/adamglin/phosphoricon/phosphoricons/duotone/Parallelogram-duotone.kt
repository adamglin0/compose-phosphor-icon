...
public val DuotoneGroup.`Parallelogram-duotone`: ImageVector
    get() {
        if (`_parallelogram-duotone` != null) {
            return `_parallelogram-duotone`!!
        }
        `_parallelogram-duotone` = Builder(name = "Parallelogram-duotone", defaultWidth = 256.0.dp,
...
private var `_parallelogram-duotone`: ImageVector? = null
