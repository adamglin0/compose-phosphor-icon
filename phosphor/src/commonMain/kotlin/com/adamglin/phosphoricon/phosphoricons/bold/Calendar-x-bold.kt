...
public val BoldGroup.`Calendar-x-bold`: ImageVector
    get() {
        if (`_calendar-x-bold` != null) {
            return `_calendar-x-bold`!!
        }
        `_calendar-x-bold` = Builder(name = "Calendar-x-bold", defaultWidth = 256.0.dp,
...
private var `_calendar-x-bold`: ImageVector? = null
