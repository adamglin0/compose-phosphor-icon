...
public val BoldGroup.`Gender-intersex-bold`: ImageVector
    get() {
        if (`_gender-intersex-bold` != null) {
            return `_gender-intersex-bold`!!
        }
        `_gender-intersex-bold` = Builder(name = "Gender-intersex-bold", defaultWidth = 256.0.dp,
...
private var `_gender-intersex-bold`: ImageVector? = null
