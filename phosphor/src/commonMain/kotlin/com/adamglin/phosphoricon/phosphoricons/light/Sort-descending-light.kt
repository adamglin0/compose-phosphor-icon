...
public val LightGroup.`Sort-descending-light`: ImageVector
    get() {
        if (`_sort-descending-light` != null) {
            return `_sort-descending-light`!!
        }
        `_sort-descending-light` = Builder(name = "Sort-descending-light", defaultWidth = 256.0.dp,
...
private var `_sort-descending-light`: ImageVector? = null
