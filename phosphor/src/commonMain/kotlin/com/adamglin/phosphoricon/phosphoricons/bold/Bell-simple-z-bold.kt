...
public val BoldGroup.`Bell-simple-z-bold`: ImageVector
    get() {
        if (`_bell-simple-z-bold` != null) {
            return `_bell-simple-z-bold`!!
        }
        `_bell-simple-z-bold` = Builder(name = "Bell-simple-z-bold", defaultWidth = 256.0.dp,
...
private var `_bell-simple-z-bold`: ImageVector? = null
