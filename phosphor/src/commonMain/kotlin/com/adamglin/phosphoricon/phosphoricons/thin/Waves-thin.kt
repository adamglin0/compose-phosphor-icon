...
public val ThinGroup.`Waves-thin`: ImageVector
    get() {
        if (`_waves-thin` != null) {
            return `_waves-thin`!!
        }
        `_waves-thin` = Builder(name = "Waves-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_waves-thin`: ImageVector? = null
