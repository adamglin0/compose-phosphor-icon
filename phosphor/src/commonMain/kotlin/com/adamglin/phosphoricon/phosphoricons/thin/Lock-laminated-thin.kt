...
public val ThinGroup.`Lock-laminated-thin`: ImageVector
    get() {
        if (`_lock-laminated-thin` != null) {
            return `_lock-laminated-thin`!!
        }
        `_lock-laminated-thin` = Builder(name = "Lock-laminated-thin", defaultWidth = 256.0.dp,
...
private var `_lock-laminated-thin`: ImageVector? = null
