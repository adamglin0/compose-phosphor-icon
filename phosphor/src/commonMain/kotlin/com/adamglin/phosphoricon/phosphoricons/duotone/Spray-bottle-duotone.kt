...
public val DuotoneGroup.`Spray-bottle-duotone`: ImageVector
    get() {
        if (`_spray-bottle-duotone` != null) {
            return `_spray-bottle-duotone`!!
        }
        `_spray-bottle-duotone` = Builder(name = "Spray-bottle-duotone", defaultWidth = 256.0.dp,
...
private var `_spray-bottle-duotone`: ImageVector? = null
