...
public val BoldGroup.`Link-simple-break-bold`: ImageVector
    get() {
        if (`_link-simple-break-bold` != null) {
            return `_link-simple-break-bold`!!
        }
        `_link-simple-break-bold` = Builder(name = "Link-simple-break-bold", defaultWidth =
...
private var `_link-simple-break-bold`: ImageVector? = null
