...
public val ThinGroup.`Person-simple-bike-thin`: ImageVector
    get() {
        if (`_person-simple-bike-thin` != null) {
            return `_person-simple-bike-thin`!!
        }
        `_person-simple-bike-thin` = Builder(name = "Person-simple-bike-thin", defaultWidth =
...
private var `_person-simple-bike-thin`: ImageVector? = null
