...
public val LightGroup.`Speaker-x-light`: ImageVector
    get() {
        if (`_speaker-x-light` != null) {
            return `_speaker-x-light`!!
        }
        `_speaker-x-light` = Builder(name = "Speaker-x-light", defaultWidth = 256.0.dp,
...
private var `_speaker-x-light`: ImageVector? = null
