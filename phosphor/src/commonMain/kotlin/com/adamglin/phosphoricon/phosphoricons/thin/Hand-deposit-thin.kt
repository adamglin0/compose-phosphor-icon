...
public val ThinGroup.`Hand-deposit-thin`: ImageVector
    get() {
        if (`_hand-deposit-thin` != null) {
            return `_hand-deposit-thin`!!
        }
        `_hand-deposit-thin` = Builder(name = "Hand-deposit-thin", defaultWidth = 256.0.dp,
...
private var `_hand-deposit-thin`: ImageVector? = null
