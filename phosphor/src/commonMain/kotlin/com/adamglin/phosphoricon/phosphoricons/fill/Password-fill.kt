...
public val FillGroup.`Password-fill`: ImageVector
    get() {
        if (`_password-fill` != null) {
            return `_password-fill`!!
        }
        `_password-fill` = Builder(name = "Password-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_password-fill`: ImageVector? = null
