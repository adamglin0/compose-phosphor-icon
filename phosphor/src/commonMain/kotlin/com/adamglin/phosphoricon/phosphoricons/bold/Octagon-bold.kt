...
public val BoldGroup.`Octagon-bold`: ImageVector
    get() {
        if (`_octagon-bold` != null) {
            return `_octagon-bold`!!
        }
        `_octagon-bold` = Builder(name = "Octagon-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_octagon-bold`: ImageVector? = null
