...
public val DuotoneGroup.`Hand-duotone`: ImageVector
    get() {
        if (`_hand-duotone` != null) {
            return `_hand-duotone`!!
        }
        `_hand-duotone` = Builder(name = "Hand-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-duotone`: ImageVector? = null
