...
public val ThinGroup.`Exam-thin`: ImageVector
    get() {
        if (`_exam-thin` != null) {
            return `_exam-thin`!!
        }
        `_exam-thin` = Builder(name = "Exam-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_exam-thin`: ImageVector? = null
