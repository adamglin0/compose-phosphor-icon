...
public val BoldGroup.`Selection-background-bold`: ImageVector
    get() {
        if (`_selection-background-bold` != null) {
            return `_selection-background-bold`!!
        }
        `_selection-background-bold` = Builder(name = "Selection-background-bold", defaultWidth =
...
private var `_selection-background-bold`: ImageVector? = null
