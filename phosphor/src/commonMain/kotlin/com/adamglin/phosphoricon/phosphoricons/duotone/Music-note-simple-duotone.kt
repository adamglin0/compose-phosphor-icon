...
public val DuotoneGroup.`Music-note-simple-duotone`: ImageVector
    get() {
        if (`_music-note-simple-duotone` != null) {
            return `_music-note-simple-duotone`!!
        }
        `_music-note-simple-duotone` = Builder(name = "Music-note-simple-duotone", defaultWidth =
...
private var `_music-note-simple-duotone`: ImageVector? = null
