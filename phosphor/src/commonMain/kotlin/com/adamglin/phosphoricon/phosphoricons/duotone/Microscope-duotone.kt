...
public val DuotoneGroup.`Microscope-duotone`: ImageVector
    get() {
        if (`_microscope-duotone` != null) {
            return `_microscope-duotone`!!
        }
        `_microscope-duotone` = Builder(name = "Microscope-duotone", defaultWidth = 256.0.dp,
...
private var `_microscope-duotone`: ImageVector? = null
