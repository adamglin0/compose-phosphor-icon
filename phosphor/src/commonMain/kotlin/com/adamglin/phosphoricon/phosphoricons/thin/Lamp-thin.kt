...
public val ThinGroup.`Lamp-thin`: ImageVector
    get() {
        if (`_lamp-thin` != null) {
            return `_lamp-thin`!!
        }
        `_lamp-thin` = Builder(name = "Lamp-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lamp-thin`: ImageVector? = null
