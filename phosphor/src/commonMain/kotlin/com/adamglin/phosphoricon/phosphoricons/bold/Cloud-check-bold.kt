...
public val BoldGroup.`Cloud-check-bold`: ImageVector
    get() {
        if (`_cloud-check-bold` != null) {
            return `_cloud-check-bold`!!
        }
        `_cloud-check-bold` = Builder(name = "Cloud-check-bold", defaultWidth = 256.0.dp,
...
private var `_cloud-check-bold`: ImageVector? = null
