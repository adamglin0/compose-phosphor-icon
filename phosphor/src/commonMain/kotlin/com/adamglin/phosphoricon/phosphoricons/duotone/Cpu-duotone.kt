...
public val DuotoneGroup.`Cpu-duotone`: ImageVector
    get() {
        if (`_cpu-duotone` != null) {
            return `_cpu-duotone`!!
        }
        `_cpu-duotone` = Builder(name = "Cpu-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cpu-duotone`: ImageVector? = null
