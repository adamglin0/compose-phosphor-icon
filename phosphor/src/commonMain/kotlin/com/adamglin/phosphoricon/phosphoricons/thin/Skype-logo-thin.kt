...
public val ThinGroup.`Skype-logo-thin`: ImageVector
    get() {
        if (`_skype-logo-thin` != null) {
            return `_skype-logo-thin`!!
        }
        `_skype-logo-thin` = Builder(name = "Skype-logo-thin", defaultWidth = 256.0.dp,
...
private var `_skype-logo-thin`: ImageVector? = null
