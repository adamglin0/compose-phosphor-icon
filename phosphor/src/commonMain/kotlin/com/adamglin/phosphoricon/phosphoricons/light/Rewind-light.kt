...
public val LightGroup.`Rewind-light`: ImageVector
    get() {
        if (`_rewind-light` != null) {
            return `_rewind-light`!!
        }
        `_rewind-light` = Builder(name = "Rewind-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rewind-light`: ImageVector? = null
