...
public val BoldGroup.`User-circle-bold`: ImageVector
    get() {
        if (`_user-circle-bold` != null) {
            return `_user-circle-bold`!!
        }
        `_user-circle-bold` = Builder(name = "User-circle-bold", defaultWidth = 256.0.dp,
...
private var `_user-circle-bold`: ImageVector? = null
