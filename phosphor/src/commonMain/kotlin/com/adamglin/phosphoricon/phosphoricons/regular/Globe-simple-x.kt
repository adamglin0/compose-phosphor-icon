...
public val RegularGroup.`Globe-simple-x`: ImageVector
    get() {
        if (`_globe-simple-x` != null) {
            return `_globe-simple-x`!!
        }
        `_globe-simple-x` = Builder(name = "Globe-simple-x", defaultWidth = 256.0.dp, defaultHeight
...
private var `_globe-simple-x`: ImageVector? = null
