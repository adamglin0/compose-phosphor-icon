...
public val DuotoneGroup.`User-circle-plus-duotone`: ImageVector
    get() {
        if (`_user-circle-plus-duotone` != null) {
            return `_user-circle-plus-duotone`!!
        }
        `_user-circle-plus-duotone` = Builder(name = "User-circle-plus-duotone", defaultWidth =
...
private var `_user-circle-plus-duotone`: ImageVector? = null
