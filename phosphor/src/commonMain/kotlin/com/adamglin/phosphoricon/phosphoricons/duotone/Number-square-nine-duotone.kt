...
public val DuotoneGroup.`Number-square-nine-duotone`: ImageVector
    get() {
        if (`_number-square-nine-duotone` != null) {
            return `_number-square-nine-duotone`!!
        }
        `_number-square-nine-duotone` = Builder(name = "Number-square-nine-duotone", defaultWidth =
...
private var `_number-square-nine-duotone`: ImageVector? = null
