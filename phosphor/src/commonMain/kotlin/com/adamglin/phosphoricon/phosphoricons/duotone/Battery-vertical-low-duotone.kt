...
public val DuotoneGroup.`Battery-vertical-low-duotone`: ImageVector
    get() {
        if (`_battery-vertical-low-duotone` != null) {
            return `_battery-vertical-low-duotone`!!
        }
        `_battery-vertical-low-duotone` = Builder(name = "Battery-vertical-low-duotone",
...
private var `_battery-vertical-low-duotone`: ImageVector? = null
