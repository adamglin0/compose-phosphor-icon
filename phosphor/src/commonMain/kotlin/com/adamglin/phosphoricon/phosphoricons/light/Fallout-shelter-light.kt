...
public val LightGroup.`Fallout-shelter-light`: ImageVector
    get() {
        if (`_fallout-shelter-light` != null) {
            return `_fallout-shelter-light`!!
        }
        `_fallout-shelter-light` = Builder(name = "Fallout-shelter-light", defaultWidth = 256.0.dp,
...
private var `_fallout-shelter-light`: ImageVector? = null
