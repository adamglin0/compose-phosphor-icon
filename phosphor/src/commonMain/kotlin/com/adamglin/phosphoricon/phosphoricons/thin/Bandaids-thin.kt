...
public val ThinGroup.`Bandaids-thin`: ImageVector
    get() {
        if (`_bandaids-thin` != null) {
            return `_bandaids-thin`!!
        }
        `_bandaids-thin` = Builder(name = "Bandaids-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bandaids-thin`: ImageVector? = null
