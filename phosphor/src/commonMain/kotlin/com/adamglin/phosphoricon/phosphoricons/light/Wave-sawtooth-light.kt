...
public val LightGroup.`Wave-sawtooth-light`: ImageVector
    get() {
        if (`_wave-sawtooth-light` != null) {
            return `_wave-sawtooth-light`!!
        }
        `_wave-sawtooth-light` = Builder(name = "Wave-sawtooth-light", defaultWidth = 256.0.dp,
...
private var `_wave-sawtooth-light`: ImageVector? = null
