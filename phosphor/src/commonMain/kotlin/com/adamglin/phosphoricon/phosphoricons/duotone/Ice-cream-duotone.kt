...
public val DuotoneGroup.`Ice-cream-duotone`: ImageVector
    get() {
        if (`_ice-cream-duotone` != null) {
            return `_ice-cream-duotone`!!
        }
        `_ice-cream-duotone` = Builder(name = "Ice-cream-duotone", defaultWidth = 256.0.dp,
...
private var `_ice-cream-duotone`: ImageVector? = null
