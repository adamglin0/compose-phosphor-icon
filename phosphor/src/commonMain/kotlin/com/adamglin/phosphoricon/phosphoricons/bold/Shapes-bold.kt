...
public val BoldGroup.`Shapes-bold`: ImageVector
    get() {
        if (`_shapes-bold` != null) {
            return `_shapes-bold`!!
        }
        `_shapes-bold` = Builder(name = "Shapes-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shapes-bold`: ImageVector? = null
