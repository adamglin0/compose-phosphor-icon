...
public val BoldGroup.`Signpost-bold`: ImageVector
    get() {
        if (`_signpost-bold` != null) {
            return `_signpost-bold`!!
        }
        `_signpost-bold` = Builder(name = "Signpost-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_signpost-bold`: ImageVector? = null
