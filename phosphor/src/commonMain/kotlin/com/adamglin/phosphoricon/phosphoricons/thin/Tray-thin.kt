...
public val ThinGroup.`Tray-thin`: ImageVector
    get() {
        if (`_tray-thin` != null) {
            return `_tray-thin`!!
        }
        `_tray-thin` = Builder(name = "Tray-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tray-thin`: ImageVector? = null
