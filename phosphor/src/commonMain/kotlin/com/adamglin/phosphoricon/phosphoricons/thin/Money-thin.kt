...
public val ThinGroup.`Money-thin`: ImageVector
    get() {
        if (`_money-thin` != null) {
            return `_money-thin`!!
        }
        `_money-thin` = Builder(name = "Money-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_money-thin`: ImageVector? = null
