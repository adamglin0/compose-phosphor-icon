...
public val LightGroup.`Folder-lock-light`: ImageVector
    get() {
        if (`_folder-lock-light` != null) {
            return `_folder-lock-light`!!
        }
        `_folder-lock-light` = Builder(name = "Folder-lock-light", defaultWidth = 256.0.dp,
...
private var `_folder-lock-light`: ImageVector? = null
