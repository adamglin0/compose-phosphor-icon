...
public val ThinGroup.`Aperture-thin`: ImageVector
    get() {
        if (`_aperture-thin` != null) {
            return `_aperture-thin`!!
        }
        `_aperture-thin` = Builder(name = "Aperture-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_aperture-thin`: ImageVector? = null
