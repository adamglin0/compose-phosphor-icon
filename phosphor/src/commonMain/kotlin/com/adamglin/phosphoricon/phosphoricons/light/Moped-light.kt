...
public val LightGroup.`Moped-light`: ImageVector
    get() {
        if (`_moped-light` != null) {
            return `_moped-light`!!
        }
        `_moped-light` = Builder(name = "Moped-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_moped-light`: ImageVector? = null
