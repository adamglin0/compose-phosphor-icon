...
public val BoldGroup.`Eyedropper-bold`: ImageVector
    get() {
        if (`_eyedropper-bold` != null) {
            return `_eyedropper-bold`!!
        }
        `_eyedropper-bold` = Builder(name = "Eyedropper-bold", defaultWidth = 256.0.dp,
...
private var `_eyedropper-bold`: ImageVector? = null
