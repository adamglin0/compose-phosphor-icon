...
public val RegularGroup.`Device-rotate`: ImageVector
    get() {
        if (`_device-rotate` != null) {
            return `_device-rotate`!!
        }
        `_device-rotate` = Builder(name = "Device-rotate", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_device-rotate`: ImageVector? = null
