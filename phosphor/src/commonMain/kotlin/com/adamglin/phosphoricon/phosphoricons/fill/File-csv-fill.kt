...
public val FillGroup.`File-csv-fill`: ImageVector
    get() {
        if (`_file-csv-fill` != null) {
            return `_file-csv-fill`!!
        }
        `_file-csv-fill` = Builder(name = "File-csv-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(14.18f, 14.18f, 0.0f, false, false, 10.06f, -4.5f)
                arcToRelative(8.21f, 8.21f, 0.0f, false, true, 10.9f, -0.91f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.82f, 11.81f)
                ...
                arcTo(61.14f, 61.14f, 0.0f, false, true, 110.0f, 214.0f)
                ...
                curveTo(137.49f, 174.17f, 154.05f, 179.0f, 151.81f, 196.31f)
                close()
                moveTo(215.42f, 155.0f)
                lineToRelative(-19.89f, 55.68f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -15.06f, 0.0f)
                lineTo(160.58f, 155.0f)
                arcToRelative(8.21f, 8.21f, 0.0f, false, true, 4.5f, -10.45f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 10.45f, 4.76f)
                lineTo(188.0f, 184.21f)
                lineToRelative(12.47f, -34.9f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 10.45f, -4.76f)
                arcTo(8.23f, 8.23f, 0.0f, false, true, 215.42f, 155.0f)
                close()
            }
        }
        .build()
...
private var `_file-csv-fill`: ImageVector? = null
