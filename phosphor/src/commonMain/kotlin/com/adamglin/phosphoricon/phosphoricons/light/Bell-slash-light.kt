...
public val LightGroup.`Bell-slash-light`: ImageVector
    get() {
        if (`_bell-slash-light` != null) {
            return `_bell-slash-light`!!
        }
        `_bell-slash-light` = Builder(name = "Bell-slash-light", defaultWidth = 256.0.dp,
...
private var `_bell-slash-light`: ImageVector? = null
