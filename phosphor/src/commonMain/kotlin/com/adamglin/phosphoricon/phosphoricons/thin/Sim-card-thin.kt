...
public val ThinGroup.`Sim-card-thin`: ImageVector
    get() {
        if (`_sim-card-thin` != null) {
            return `_sim-card-thin`!!
        }
        `_sim-card-thin` = Builder(name = "Sim-card-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sim-card-thin`: ImageVector? = null
