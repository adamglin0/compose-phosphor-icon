...
public val DuotoneGroup.`Pencil-duotone`: ImageVector
    get() {
        if (`_pencil-duotone` != null) {
            return `_pencil-duotone`!!
        }
        `_pencil-duotone` = Builder(name = "Pencil-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_pencil-duotone`: ImageVector? = null
