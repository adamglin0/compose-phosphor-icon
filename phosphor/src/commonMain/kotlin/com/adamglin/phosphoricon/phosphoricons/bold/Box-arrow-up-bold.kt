...
public val BoldGroup.`Box-arrow-up-bold`: ImageVector
    get() {
        if (`_box-arrow-up-bold` != null) {
            return `_box-arrow-up-bold`!!
        }
        `_box-arrow-up-bold` = Builder(name = "Box-arrow-up-bold", defaultWidth = 256.0.dp,
...
private var `_box-arrow-up-bold`: ImageVector? = null
