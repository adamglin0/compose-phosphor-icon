...
public val ThinGroup.`Flow-arrow-thin`: ImageVector
    get() {
        if (`_flow-arrow-thin` != null) {
            return `_flow-arrow-thin`!!
        }
        `_flow-arrow-thin` = Builder(name = "Flow-arrow-thin", defaultWidth = 256.0.dp,
...
private var `_flow-arrow-thin`: ImageVector? = null
