...
public val DuotoneGroup.`Article-duotone`: ImageVector
    get() {
        if (`_article-duotone` != null) {
            return `_article-duotone`!!
        }
        `_article-duotone` = Builder(name = "Article-duotone", defaultWidth = 256.0.dp,
...
private var `_article-duotone`: ImageVector? = null
