...
public val DuotoneGroup.`Caret-double-right-duotone`: ImageVector
    get() {
        if (`_caret-double-right-duotone` != null) {
            return `_caret-double-right-duotone`!!
        }
        `_caret-double-right-duotone` = Builder(name = "Caret-double-right-duotone", defaultWidth =
...
private var `_caret-double-right-duotone`: ImageVector? = null
