...
public val BoldGroup.`Music-note-bold`: ImageVector
    get() {
        if (`_music-note-bold` != null) {
            return `_music-note-bold`!!
        }
        `_music-note-bold` = Builder(name = "Music-note-bold", defaultWidth = 256.0.dp,
...
private var `_music-note-bold`: ImageVector? = null
