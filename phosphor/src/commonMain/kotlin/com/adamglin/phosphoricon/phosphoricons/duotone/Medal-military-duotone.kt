...
public val DuotoneGroup.`Medal-military-duotone`: ImageVector
    get() {
        if (`_medal-military-duotone` != null) {
            return `_medal-military-duotone`!!
        }
        `_medal-military-duotone` = Builder(name = "Medal-military-duotone", defaultWidth =
...
private var `_medal-military-duotone`: ImageVector? = null
