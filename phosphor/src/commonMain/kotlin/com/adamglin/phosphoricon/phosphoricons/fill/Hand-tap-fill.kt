...
public val FillGroup.`Hand-tap-fill`: ImageVector
    get() {
        if (`_hand-tap-fill` != null) {
            return `_hand-tap-fill`!!
        }
        `_hand-tap-fill` = Builder(name = "Hand-tap-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-tap-fill`: ImageVector? = null
