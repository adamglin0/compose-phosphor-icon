...
public val ThinGroup.`Meta-logo-thin`: ImageVector
    get() {
        if (`_meta-logo-thin` != null) {
            return `_meta-logo-thin`!!
        }
        `_meta-logo-thin` = Builder(name = "Meta-logo-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_meta-logo-thin`: ImageVector? = null
