...
public val BoldGroup.`Drop-bold`: ImageVector
    get() {
        if (`_drop-bold` != null) {
            return `_drop-bold`!!
        }
        `_drop-bold` = Builder(name = "Drop-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_drop-bold`: ImageVector? = null
