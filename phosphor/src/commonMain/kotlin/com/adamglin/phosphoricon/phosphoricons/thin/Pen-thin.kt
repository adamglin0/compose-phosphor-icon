...
public val ThinGroup.`Pen-thin`: ImageVector
    get() {
        if (`_pen-thin` != null) {
            return `_pen-thin`!!
        }
        `_pen-thin` = Builder(name = "Pen-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_pen-thin`: ImageVector? = null
