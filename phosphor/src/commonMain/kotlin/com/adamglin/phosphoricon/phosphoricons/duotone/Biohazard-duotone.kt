...
public val DuotoneGroup.`Biohazard-duotone`: ImageVector
    get() {
        if (`_biohazard-duotone` != null) {
            return `_biohazard-duotone`!!
        }
        `_biohazard-duotone` = Builder(name = "Biohazard-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(56.0f, 56.0f, 0.0f, false, true, 184.0f, 132.0f)
                close()
            }
...
private var `_biohazard-duotone`: ImageVector? = null
