...
public val LightGroup.`Piano-keys-light`: ImageVector
    get() {
        if (`_piano-keys-light` != null) {
            return `_piano-keys-light`!!
        }
        `_piano-keys-light` = Builder(name = "Piano-keys-light", defaultWidth = 256.0.dp,
...
private var `_piano-keys-light`: ImageVector? = null
