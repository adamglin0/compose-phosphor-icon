...
public val ThinGroup.`Lighthouse-thin`: ImageVector
    get() {
        if (`_lighthouse-thin` != null) {
            return `_lighthouse-thin`!!
        }
        `_lighthouse-thin` = Builder(name = "Lighthouse-thin", defaultWidth = 256.0.dp,
...
private var `_lighthouse-thin`: ImageVector? = null
