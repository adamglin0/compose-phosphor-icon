...
public val DuotoneGroup.`Metronome-duotone`: ImageVector
    get() {
        if (`_metronome-duotone` != null) {
            return `_metronome-duotone`!!
        }
        `_metronome-duotone` = Builder(name = "Metronome-duotone", defaultWidth = 256.0.dp,
...
private var `_metronome-duotone`: ImageVector? = null
