...
public val DuotoneGroup.`Newspaper-duotone`: ImageVector
    get() {
        if (`_newspaper-duotone` != null) {
            return `_newspaper-duotone`!!
        }
        `_newspaper-duotone` = Builder(name = "Newspaper-duotone", defaultWidth = 256.0.dp,
...
private var `_newspaper-duotone`: ImageVector? = null
