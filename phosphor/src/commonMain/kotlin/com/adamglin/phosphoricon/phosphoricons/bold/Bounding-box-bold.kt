...
public val BoldGroup.`Bounding-box-bold`: ImageVector
    get() {
        if (`_bounding-box-bold` != null) {
            return `_bounding-box-bold`!!
        }
        `_bounding-box-bold` = Builder(name = "Bounding-box-bold", defaultWidth = 256.0.dp,
...
private var `_bounding-box-bold`: ImageVector? = null
