...
public val LightGroup.`Tumblr-logo-light`: ImageVector
    get() {
        if (`_tumblr-logo-light` != null) {
            return `_tumblr-logo-light`!!
        }
        `_tumblr-logo-light` = Builder(name = "Tumblr-logo-light", defaultWidth = 256.0.dp,
...
private var `_tumblr-logo-light`: ImageVector? = null
