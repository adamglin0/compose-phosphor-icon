...
public val DuotoneGroup.`Calendar-slash-duotone`: ImageVector
    get() {
        if (`_calendar-slash-duotone` != null) {
            return `_calendar-slash-duotone`!!
        }
        `_calendar-slash-duotone` = Builder(name = "Calendar-slash-duotone", defaultWidth =
...
private var `_calendar-slash-duotone`: ImageVector? = null
