...
public val DuotoneGroup.`Currency-dollar-duotone`: ImageVector
    get() {
        if (`_currency-dollar-duotone` != null) {
            return `_currency-dollar-duotone`!!
        }
        `_currency-dollar-duotone` = Builder(name = "Currency-dollar-duotone", defaultWidth =
...
private var `_currency-dollar-duotone`: ImageVector? = null
