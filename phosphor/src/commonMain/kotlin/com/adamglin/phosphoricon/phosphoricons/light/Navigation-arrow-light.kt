...
public val LightGroup.`Navigation-arrow-light`: ImageVector
    get() {
        if (`_navigation-arrow-light` != null) {
            return `_navigation-arrow-light`!!
        }
        `_navigation-arrow-light` = Builder(name = "Navigation-arrow-light", defaultWidth =
...
private var `_navigation-arrow-light`: ImageVector? = null
