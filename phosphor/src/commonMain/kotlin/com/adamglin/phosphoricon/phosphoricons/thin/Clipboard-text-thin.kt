...
public val ThinGroup.`Clipboard-text-thin`: ImageVector
    get() {
        if (`_clipboard-text-thin` != null) {
            return `_clipboard-text-thin`!!
        }
        `_clipboard-text-thin` = Builder(name = "Clipboard-text-thin", defaultWidth = 256.0.dp,
...
private var `_clipboard-text-thin`: ImageVector? = null
