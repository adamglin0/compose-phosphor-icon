...
public val LightGroup.`Speaker-low-light`: ImageVector
    get() {
        if (`_speaker-low-light` != null) {
            return `_speaker-low-light`!!
        }
        `_speaker-low-light` = Builder(name = "Speaker-low-light", defaultWidth = 256.0.dp,
...
private var `_speaker-low-light`: ImageVector? = null
