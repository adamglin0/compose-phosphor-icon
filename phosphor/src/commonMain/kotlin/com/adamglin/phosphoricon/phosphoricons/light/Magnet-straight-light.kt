...
public val LightGroup.`Magnet-straight-light`: ImageVector
    get() {
        if (`_magnet-straight-light` != null) {
            return `_magnet-straight-light`!!
        }
        `_magnet-straight-light` = Builder(name = "Magnet-straight-light", defaultWidth = 256.0.dp,
...
private var `_magnet-straight-light`: ImageVector? = null
