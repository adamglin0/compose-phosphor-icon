...
public val LightGroup.`Atom-light`: ImageVector
    get() {
        if (`_atom-light` != null) {
            return `_atom-light`!!
        }
        `_atom-light` = Builder(name = "Atom-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_atom-light`: ImageVector? = null
