...
public val ThinGroup.`Knife-thin`: ImageVector
    get() {
        if (`_knife-thin` != null) {
            return `_knife-thin`!!
        }
        `_knife-thin` = Builder(name = "Knife-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_knife-thin`: ImageVector? = null
