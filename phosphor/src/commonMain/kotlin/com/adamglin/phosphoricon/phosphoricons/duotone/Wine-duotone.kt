...
public val DuotoneGroup.`Wine-duotone`: ImageVector
    get() {
        if (`_wine-duotone` != null) {
            return `_wine-duotone`!!
        }
        `_wine-duotone` = Builder(name = "Wine-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wine-duotone`: ImageVector? = null
