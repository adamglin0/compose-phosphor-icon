...
public val FillGroup.`Paperclip-fill`: ImageVector
    get() {
        if (`_paperclip-fill` != null) {
            return `_paperclip-fill`!!
        }
        `_paperclip-fill` = Builder(name = "Paperclip-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_paperclip-fill`: ImageVector? = null
