...
public val BoldGroup.`Horse-bold`: ImageVector
    get() {
        if (`_horse-bold` != null) {
            return `_horse-bold`!!
        }
        `_horse-bold` = Builder(name = "Horse-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_horse-bold`: ImageVector? = null
