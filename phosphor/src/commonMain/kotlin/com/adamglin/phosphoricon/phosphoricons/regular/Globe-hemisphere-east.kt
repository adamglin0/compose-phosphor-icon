...
public val RegularGroup.`Globe-hemisphere-east`: ImageVector
    get() {
        if (`_globe-hemisphere-east` != null) {
            return `_globe-hemisphere-east`!!
        }
        `_globe-hemisphere-east` = Builder(name = "Globe-hemisphere-east", defaultWidth = 256.0.dp,
...
private var `_globe-hemisphere-east`: ImageVector? = null
