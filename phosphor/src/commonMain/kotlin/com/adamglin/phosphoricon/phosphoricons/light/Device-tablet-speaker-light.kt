...
public val LightGroup.`Device-tablet-speaker-light`: ImageVector
    get() {
        if (`_device-tablet-speaker-light` != null) {
            return `_device-tablet-speaker-light`!!
        }
        `_device-tablet-speaker-light` = Builder(name = "Device-tablet-speaker-light", defaultWidth
...
private var `_device-tablet-speaker-light`: ImageVector? = null
