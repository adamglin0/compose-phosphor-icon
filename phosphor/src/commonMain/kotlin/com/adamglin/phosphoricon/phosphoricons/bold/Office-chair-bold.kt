...
public val BoldGroup.`Office-chair-bold`: ImageVector
    get() {
        if (`_office-chair-bold` != null) {
            return `_office-chair-bold`!!
        }
        `_office-chair-bold` = Builder(name = "Office-chair-bold", defaultWidth = 256.0.dp,
...
private var `_office-chair-bold`: ImageVector? = null
