...
public val FillGroup.`Folder-simple-plus-fill`: ImageVector
    get() {
        if (`_folder-simple-plus-fill` != null) {
            return `_folder-simple-plus-fill`!!
        }
        `_folder-simple-plus-fill` = Builder(name = "Folder-simple-plus-fill", defaultWidth =
...
private var `_folder-simple-plus-fill`: ImageVector? = null
