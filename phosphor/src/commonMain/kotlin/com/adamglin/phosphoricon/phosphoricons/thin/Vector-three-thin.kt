...
public val ThinGroup.`Vector-three-thin`: ImageVector
    get() {
        if (`_vector-three-thin` != null) {
            return `_vector-three-thin`!!
        }
        `_vector-three-thin` = Builder(name = "Vector-three-thin", defaultWidth = 256.0.dp,
...
private var `_vector-three-thin`: ImageVector? = null
