...
public val BoldGroup.`Messenger-logo-bold`: ImageVector
    get() {
        if (`_messenger-logo-bold` != null) {
            return `_messenger-logo-bold`!!
        }
        `_messenger-logo-bold` = Builder(name = "Messenger-logo-bold", defaultWidth = 256.0.dp,
...
private var `_messenger-logo-bold`: ImageVector? = null
