...
public val ThinGroup.`Plug-thin`: ImageVector
    get() {
        if (`_plug-thin` != null) {
            return `_plug-thin`!!
        }
        `_plug-thin` = Builder(name = "Plug-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plug-thin`: ImageVector? = null
