...
public val DuotoneGroup.`Suitcase-duotone`: ImageVector
    get() {
        if (`_suitcase-duotone` != null) {
            return `_suitcase-duotone`!!
        }
        `_suitcase-duotone` = Builder(name = "Suitcase-duotone", defaultWidth = 256.0.dp,
...
private var `_suitcase-duotone`: ImageVector? = null
