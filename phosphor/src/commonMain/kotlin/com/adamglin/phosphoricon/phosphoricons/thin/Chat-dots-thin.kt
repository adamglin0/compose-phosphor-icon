...
public val ThinGroup.`Chat-dots-thin`: ImageVector
    get() {
        if (`_chat-dots-thin` != null) {
            return `_chat-dots-thin`!!
        }
        `_chat-dots-thin` = Builder(name = "Chat-dots-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_chat-dots-thin`: ImageVector? = null
