...
public val DuotoneGroup.`Box-arrow-down-duotone`: ImageVector
    get() {
        if (`_box-arrow-down-duotone` != null) {
            return `_box-arrow-down-duotone`!!
        }
        `_box-arrow-down-duotone` = Builder(name = "Box-arrow-down-duotone", defaultWidth =
...
private var `_box-arrow-down-duotone`: ImageVector? = null
