...
public val BoldGroup.`Bomb-bold`: ImageVector
    get() {
        if (`_bomb-bold` != null) {
            return `_bomb-bold`!!
        }
        `_bomb-bold` = Builder(name = "Bomb-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bomb-bold`: ImageVector? = null
