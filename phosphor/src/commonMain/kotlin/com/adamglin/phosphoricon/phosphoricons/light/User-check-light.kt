...
public val LightGroup.`User-check-light`: ImageVector
    get() {
        if (`_user-check-light` != null) {
            return `_user-check-light`!!
        }
        `_user-check-light` = Builder(name = "User-check-light", defaultWidth = 256.0.dp,
...
private var `_user-check-light`: ImageVector? = null
