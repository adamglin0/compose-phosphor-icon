...
public val DuotoneGroup.`Paint-bucket-duotone`: ImageVector
    get() {
        if (`_paint-bucket-duotone` != null) {
            return `_paint-bucket-duotone`!!
        }
        `_paint-bucket-duotone` = Builder(name = "Paint-bucket-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, -16.0f, 16.0f, -40.0f, 16.0f, -40.0f)
                reflectiveCurveTo(248.0f, 192.0f, 248.0f, 208.0f)
                close()
                moveTo(232.0f, 131.48f)
                lineTo(208.0f, 139.48f)
                lineTo(128.17f, 219.31f)
                ...
                lineTo(116.52f, 16.0f)
                close()
                moveTo(138.14f, 101.86f)
                arcToRelative(20.0f, 20.0f, 0.0f, true, false, 0.0f, 28.28f)
                arcTo(20.0f, 20.0f, 0.0f, false, false, 138.14f, 101.86f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(238.66f, 163.56f)
...
private var `_paint-bucket-duotone`: ImageVector? = null
