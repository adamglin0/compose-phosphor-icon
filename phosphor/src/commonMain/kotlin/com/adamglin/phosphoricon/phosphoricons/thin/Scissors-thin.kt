...
public val ThinGroup.`Scissors-thin`: ImageVector
    get() {
        if (`_scissors-thin` != null) {
            return `_scissors-thin`!!
        }
        `_scissors-thin` = Builder(name = "Scissors-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scissors-thin`: ImageVector? = null
