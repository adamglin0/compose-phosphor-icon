...
public val DuotoneGroup.`Swatches-duotone`: ImageVector
    get() {
        if (`_swatches-duotone` != null) {
            return `_swatches-duotone`!!
        }
        `_swatches-duotone` = Builder(name = "Swatches-duotone", defaultWidth = 256.0.dp,
...
private var `_swatches-duotone`: ImageVector? = null
