...
public val DuotoneGroup.`Codepen-logo-duotone`: ImageVector
    get() {
        if (`_codepen-logo-duotone` != null) {
            return `_codepen-logo-duotone`!!
        }
        `_codepen-logo-duotone` = Builder(name = "Codepen-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_codepen-logo-duotone`: ImageVector? = null
