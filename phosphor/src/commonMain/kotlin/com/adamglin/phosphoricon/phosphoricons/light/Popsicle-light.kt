...
public val LightGroup.`Popsicle-light`: ImageVector
    get() {
        if (`_popsicle-light` != null) {
            return `_popsicle-light`!!
        }
        `_popsicle-light` = Builder(name = "Popsicle-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_popsicle-light`: ImageVector? = null
