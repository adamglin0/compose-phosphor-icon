...
public val ThinGroup.`Figma-logo-thin`: ImageVector
    get() {
        if (`_figma-logo-thin` != null) {
            return `_figma-logo-thin`!!
        }
        `_figma-logo-thin` = Builder(name = "Figma-logo-thin", defaultWidth = 256.0.dp,
...
private var `_figma-logo-thin`: ImageVector? = null
