...
public val ThinGroup.`Star-and-crescent-thin`: ImageVector
    get() {
        if (`_star-and-crescent-thin` != null) {
            return `_star-and-crescent-thin`!!
        }
        `_star-and-crescent-thin` = Builder(name = "Star-and-crescent-thin", defaultWidth =
...
private var `_star-and-crescent-thin`: ImageVector? = null
