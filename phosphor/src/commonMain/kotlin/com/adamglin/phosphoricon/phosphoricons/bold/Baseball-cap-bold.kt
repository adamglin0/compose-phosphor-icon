...
public val BoldGroup.`Baseball-cap-bold`: ImageVector
    get() {
        if (`_baseball-cap-bold` != null) {
            return `_baseball-cap-bold`!!
        }
        `_baseball-cap-bold` = Builder(name = "Baseball-cap-bold", defaultWidth = 256.0.dp,
...
private var `_baseball-cap-bold`: ImageVector? = null
