...
public val LightGroup.`Hexagon-light`: ImageVector
    get() {
        if (`_hexagon-light` != null) {
            return `_hexagon-light`!!
        }
        `_hexagon-light` = Builder(name = "Hexagon-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hexagon-light`: ImageVector? = null
