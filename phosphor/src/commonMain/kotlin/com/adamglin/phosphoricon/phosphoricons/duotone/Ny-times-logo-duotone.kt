...
public val DuotoneGroup.`Ny-times-logo-duotone`: ImageVector
    get() {
        if (`_ny-times-logo-duotone` != null) {
            return `_ny-times-logo-duotone`!!
        }
        `_ny-times-logo-duotone` = Builder(name = "Ny-times-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_ny-times-logo-duotone`: ImageVector? = null
