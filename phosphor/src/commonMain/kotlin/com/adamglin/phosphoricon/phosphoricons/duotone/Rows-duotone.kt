...
public val DuotoneGroup.`Rows-duotone`: ImageVector
    get() {
        if (`_rows-duotone` != null) {
            return `_rows-duotone`!!
        }
        `_rows-duotone` = Builder(name = "Rows-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rows-duotone`: ImageVector? = null
