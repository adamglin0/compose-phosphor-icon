...
public val ThinGroup.`Behance-logo-thin`: ImageVector
    get() {
        if (`_behance-logo-thin` != null) {
            return `_behance-logo-thin`!!
        }
        `_behance-logo-thin` = Builder(name = "Behance-logo-thin", defaultWidth = 256.0.dp,
...
private var `_behance-logo-thin`: ImageVector? = null
