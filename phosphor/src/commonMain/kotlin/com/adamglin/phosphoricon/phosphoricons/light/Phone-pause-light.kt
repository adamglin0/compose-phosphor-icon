...
public val LightGroup.`Phone-pause-light`: ImageVector
    get() {
        if (`_phone-pause-light` != null) {
            return `_phone-pause-light`!!
        }
        `_phone-pause-light` = Builder(name = "Phone-pause-light", defaultWidth = 256.0.dp,
...
private var `_phone-pause-light`: ImageVector? = null
