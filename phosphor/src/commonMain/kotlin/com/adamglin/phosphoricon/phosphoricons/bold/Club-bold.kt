...
public val BoldGroup.`Club-bold`: ImageVector
    get() {
        if (`_club-bold` != null) {
            return `_club-bold`!!
        }
        `_club-bold` = Builder(name = "Club-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_club-bold`: ImageVector? = null
