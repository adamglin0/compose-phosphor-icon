...
public val BoldGroup.`Moon-bold`: ImageVector
    get() {
        if (`_moon-bold` != null) {
            return `_moon-bold`!!
        }
        `_moon-bold` = Builder(name = "Moon-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_moon-bold`: ImageVector? = null
