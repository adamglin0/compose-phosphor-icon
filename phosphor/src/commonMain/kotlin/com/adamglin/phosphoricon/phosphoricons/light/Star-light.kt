...
public val LightGroup.`Star-light`: ImageVector
    get() {
        if (`_star-light` != null) {
            return `_star-light`!!
        }
        `_star-light` = Builder(name = "Star-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_star-light`: ImageVector? = null
