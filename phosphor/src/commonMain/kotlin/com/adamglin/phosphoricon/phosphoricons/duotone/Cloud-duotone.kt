...
public val DuotoneGroup.`Cloud-duotone`: ImageVector
    get() {
        if (`_cloud-duotone` != null) {
            return `_cloud-duotone`!!
        }
        `_cloud-duotone` = Builder(name = "Cloud-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-duotone`: ImageVector? = null
