...
public val LightGroup.`Folder-light`: ImageVector
    get() {
        if (`_folder-light` != null) {
            return `_folder-light`!!
        }
        `_folder-light` = Builder(name = "Folder-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folder-light`: ImageVector? = null
