...
public val BoldGroup.`Rss-bold`: ImageVector
    get() {
        if (`_rss-bold` != null) {
            return `_rss-bold`!!
        }
        `_rss-bold` = Builder(name = "Rss-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_rss-bold`: ImageVector? = null
