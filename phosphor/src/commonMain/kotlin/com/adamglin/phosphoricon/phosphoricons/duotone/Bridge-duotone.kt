...
public val DuotoneGroup.`Bridge-duotone`: ImageVector
    get() {
        if (`_bridge-duotone` != null) {
            return `_bridge-duotone`!!
        }
        `_bridge-duotone` = Builder(name = "Bridge-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bridge-duotone`: ImageVector? = null
