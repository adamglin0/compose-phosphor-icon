...
public val FillGroup.`Globe-fill`: ImageVector
    get() {
        if (`_globe-fill` != null) {
            return `_globe-fill`!!
        }
        `_globe-fill` = Builder(name = "Globe-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(102.0f, 88.0f)
                arcTo(115.11f, 115.11f, 0.0f, false, true, 128.0f, 43.0f)
                close()
