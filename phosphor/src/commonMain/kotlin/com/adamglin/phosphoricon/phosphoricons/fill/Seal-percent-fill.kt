...
public val FillGroup.`Seal-percent-fill`: ImageVector
    get() {
        if (`_seal-percent-fill` != null) {
            return `_seal-percent-fill`!!
        }
        `_seal-percent-fill` = Builder(name = "Seal-percent-fill", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(24.0f, 24.0f, 0.0f, false, false, 184.0f, 160.0f)
                close()
            }
        }
        .build()
...
private var `_seal-percent-fill`: ImageVector? = null
