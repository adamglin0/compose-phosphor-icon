...
public val FillGroup.`Ambulance-fill`: ImageVector
    get() {
        if (`_ambulance-fill` != null) {
            return `_ambulance-fill`!!
        }
        `_ambulance-fill` = Builder(name = "Ambulance-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_ambulance-fill`: ImageVector? = null
