...
public val BoldGroup.`Arrow-fat-down-bold`: ImageVector
    get() {
        if (`_arrow-fat-down-bold` != null) {
            return `_arrow-fat-down-bold`!!
        }
        `_arrow-fat-down-bold` = Builder(name = "Arrow-fat-down-bold", defaultWidth = 256.0.dp,
...
private var `_arrow-fat-down-bold`: ImageVector? = null
