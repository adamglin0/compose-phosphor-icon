...
public val LightGroup.`Number-circle-two-light`: ImageVector
    get() {
        if (`_number-circle-two-light` != null) {
            return `_number-circle-two-light`!!
        }
        `_number-circle-two-light` = Builder(name = "Number-circle-two-light", defaultWidth =
...
private var `_number-circle-two-light`: ImageVector? = null
