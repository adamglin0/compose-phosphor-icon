...
public val BoldGroup.`Hockey-bold`: ImageVector
    get() {
        if (`_hockey-bold` != null) {
            return `_hockey-bold`!!
        }
        `_hockey-bold` = Builder(name = "Hockey-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hockey-bold`: ImageVector? = null
