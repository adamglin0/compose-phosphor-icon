...
public val ThinGroup.`Paint-roller-thin`: ImageVector
    get() {
        if (`_paint-roller-thin` != null) {
            return `_paint-roller-thin`!!
        }
        `_paint-roller-thin` = Builder(name = "Paint-roller-thin", defaultWidth = 256.0.dp,
...
private var `_paint-roller-thin`: ImageVector? = null
