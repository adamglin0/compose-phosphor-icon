...
public val ThinGroup.`Eject-thin`: ImageVector
    get() {
        if (`_eject-thin` != null) {
            return `_eject-thin`!!
        }
        `_eject-thin` = Builder(name = "Eject-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eject-thin`: ImageVector? = null
