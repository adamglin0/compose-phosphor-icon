...
public val DuotoneGroup.`Smiley-meh-duotone`: ImageVector
    get() {
        if (`_smiley-meh-duotone` != null) {
            return `_smiley-meh-duotone`!!
        }
        `_smiley-meh-duotone` = Builder(name = "Smiley-meh-duotone", defaultWidth = 256.0.dp,
...
private var `_smiley-meh-duotone`: ImageVector? = null
