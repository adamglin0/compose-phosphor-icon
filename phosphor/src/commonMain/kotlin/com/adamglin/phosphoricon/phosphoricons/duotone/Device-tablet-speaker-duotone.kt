...
public val DuotoneGroup.`Device-tablet-speaker-duotone`: ImageVector
    get() {
        if (`_device-tablet-speaker-duotone` != null) {
            return `_device-tablet-speaker-duotone`!!
        }
        `_device-tablet-speaker-duotone` = Builder(name = "Device-tablet-speaker-duotone",
...
private var `_device-tablet-speaker-duotone`: ImageVector? = null
