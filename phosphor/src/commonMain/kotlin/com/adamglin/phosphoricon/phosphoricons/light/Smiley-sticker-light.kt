...
public val LightGroup.`Smiley-sticker-light`: ImageVector
    get() {
        if (`_smiley-sticker-light` != null) {
            return `_smiley-sticker-light`!!
        }
        `_smiley-sticker-light` = Builder(name = "Smiley-sticker-light", defaultWidth = 256.0.dp,
...
private var `_smiley-sticker-light`: ImageVector? = null
