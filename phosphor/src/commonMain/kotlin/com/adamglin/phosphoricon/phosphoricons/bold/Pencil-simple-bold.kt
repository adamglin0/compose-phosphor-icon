...
public val BoldGroup.`Pencil-simple-bold`: ImageVector
    get() {
        if (`_pencil-simple-bold` != null) {
            return `_pencil-simple-bold`!!
        }
        `_pencil-simple-bold` = Builder(name = "Pencil-simple-bold", defaultWidth = 256.0.dp,
...
private var `_pencil-simple-bold`: ImageVector? = null
