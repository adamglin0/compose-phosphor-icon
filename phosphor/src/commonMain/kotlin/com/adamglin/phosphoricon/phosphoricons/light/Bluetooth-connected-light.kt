...
public val LightGroup.`Bluetooth-connected-light`: ImageVector
    get() {
        if (`_bluetooth-connected-light` != null) {
            return `_bluetooth-connected-light`!!
        }
        `_bluetooth-connected-light` = Builder(name = "Bluetooth-connected-light", defaultWidth =
...
private var `_bluetooth-connected-light`: ImageVector? = null
