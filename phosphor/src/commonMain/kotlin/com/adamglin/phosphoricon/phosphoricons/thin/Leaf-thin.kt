...
public val ThinGroup.`Leaf-thin`: ImageVector
    get() {
        if (`_leaf-thin` != null) {
            return `_leaf-thin`!!
        }
        `_leaf-thin` = Builder(name = "Leaf-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_leaf-thin`: ImageVector? = null
