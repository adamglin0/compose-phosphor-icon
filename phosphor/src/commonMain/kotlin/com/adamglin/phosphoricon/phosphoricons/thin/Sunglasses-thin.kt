...
public val ThinGroup.`Sunglasses-thin`: ImageVector
    get() {
        if (`_sunglasses-thin` != null) {
            return `_sunglasses-thin`!!
        }
        `_sunglasses-thin` = Builder(name = "Sunglasses-thin", defaultWidth = 256.0.dp,
...
private var `_sunglasses-thin`: ImageVector? = null
