...
public val LightGroup.`Text-b-light`: ImageVector
    get() {
        if (`_text-b-light` != null) {
            return `_text-b-light`!!
        }
        `_text-b-light` = Builder(name = "Text-b-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-b-light`: ImageVector? = null
