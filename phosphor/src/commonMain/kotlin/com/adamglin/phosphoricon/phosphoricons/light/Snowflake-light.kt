...
public val LightGroup.`Snowflake-light`: ImageVector
    get() {
        if (`_snowflake-light` != null) {
            return `_snowflake-light`!!
        }
        `_snowflake-light` = Builder(name = "Snowflake-light", defaultWidth = 256.0.dp,
...
private var `_snowflake-light`: ImageVector? = null
