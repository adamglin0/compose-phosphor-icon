...
public val RegularGroup.`Hair-dryer`: ImageVector
    get() {
        if (`_hair-dryer` != null) {
            return `_hair-dryer`!!
        }
        `_hair-dryer` = Builder(name = "Hair-dryer", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hair-dryer`: ImageVector? = null
