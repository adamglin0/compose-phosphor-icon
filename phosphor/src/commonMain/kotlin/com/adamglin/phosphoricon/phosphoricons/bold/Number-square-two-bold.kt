...
public val BoldGroup.`Number-square-two-bold`: ImageVector
    get() {
        if (`_number-square-two-bold` != null) {
            return `_number-square-two-bold`!!
        }
        `_number-square-two-bold` = Builder(name = "Number-square-two-bold", defaultWidth =
...
private var `_number-square-two-bold`: ImageVector? = null
