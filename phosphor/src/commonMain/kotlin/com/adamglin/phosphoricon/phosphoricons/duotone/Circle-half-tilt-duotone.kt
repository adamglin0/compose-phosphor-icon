...
public val DuotoneGroup.`Circle-half-tilt-duotone`: ImageVector
    get() {
        if (`_circle-half-tilt-duotone` != null) {
            return `_circle-half-tilt-duotone`!!
        }
        `_circle-half-tilt-duotone` = Builder(name = "Circle-half-tilt-duotone", defaultWidth =
...
private var `_circle-half-tilt-duotone`: ImageVector? = null
