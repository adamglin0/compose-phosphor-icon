...
public val FillGroup.`Arrow-bend-double-up-right-fill`: ImageVector
    get() {
        if (`_arrow-bend-double-up-right-fill` != null) {
            return `_arrow-bend-double-up-right-fill`!!
        }
        `_arrow-bend-double-up-right-fill` = Builder(name = "Arrow-bend-double-up-right-fill",
...
private var `_arrow-bend-double-up-right-fill`: ImageVector? = null
