...
public val LightGroup.`Exclude-light`: ImageVector
    get() {
        if (`_exclude-light` != null) {
            return `_exclude-light`!!
        }
        `_exclude-light` = Builder(name = "Exclude-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_exclude-light`: ImageVector? = null
