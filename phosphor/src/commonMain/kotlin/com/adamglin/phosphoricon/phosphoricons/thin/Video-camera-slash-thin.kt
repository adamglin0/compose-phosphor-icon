...
public val ThinGroup.`Video-camera-slash-thin`: ImageVector
    get() {
        if (`_video-camera-slash-thin` != null) {
            return `_video-camera-slash-thin`!!
        }
        `_video-camera-slash-thin` = Builder(name = "Video-camera-slash-thin", defaultWidth =
...
private var `_video-camera-slash-thin`: ImageVector? = null
