...
public val BoldGroup.`Cow-bold`: ImageVector
    get() {
        if (`_cow-bold` != null) {
            return `_cow-bold`!!
        }
        `_cow-bold` = Builder(name = "Cow-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_cow-bold`: ImageVector? = null
