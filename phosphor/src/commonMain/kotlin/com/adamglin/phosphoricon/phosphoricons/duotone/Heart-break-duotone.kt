...
public val DuotoneGroup.`Heart-break-duotone`: ImageVector
    get() {
        if (`_heart-break-duotone` != null) {
            return `_heart-break-duotone`!!
        }
        `_heart-break-duotone` = Builder(name = "Heart-break-duotone", defaultWidth = 256.0.dp,
...
private var `_heart-break-duotone`: ImageVector? = null
