...
public val BoldGroup.`Math-operations-bold`: ImageVector
    get() {
        if (`_math-operations-bold` != null) {
            return `_math-operations-bold`!!
        }
        `_math-operations-bold` = Builder(name = "Math-operations-bold", defaultWidth = 256.0.dp,
...
private var `_math-operations-bold`: ImageVector? = null
