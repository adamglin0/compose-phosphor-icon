...
public val BoldGroup.`Smiley-angry-bold`: ImageVector
    get() {
        if (`_smiley-angry-bold` != null) {
            return `_smiley-angry-bold`!!
        }
        `_smiley-angry-bold` = Builder(name = "Smiley-angry-bold", defaultWidth = 256.0.dp,
...
private var `_smiley-angry-bold`: ImageVector? = null
