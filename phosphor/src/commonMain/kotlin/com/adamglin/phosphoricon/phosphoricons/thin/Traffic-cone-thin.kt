...
public val ThinGroup.`Traffic-cone-thin`: ImageVector
    get() {
        if (`_traffic-cone-thin` != null) {
            return `_traffic-cone-thin`!!
        }
        `_traffic-cone-thin` = Builder(name = "Traffic-cone-thin", defaultWidth = 256.0.dp,
...
private var `_traffic-cone-thin`: ImageVector? = null
