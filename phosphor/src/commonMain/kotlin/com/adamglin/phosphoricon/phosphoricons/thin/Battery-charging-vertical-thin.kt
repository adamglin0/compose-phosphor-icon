...
public val ThinGroup.`Battery-charging-vertical-thin`: ImageVector
    get() {
        if (`_battery-charging-vertical-thin` != null) {
            return `_battery-charging-vertical-thin`!!
        }
        `_battery-charging-vertical-thin` = Builder(name = "Battery-charging-vertical-thin",
...
private var `_battery-charging-vertical-thin`: ImageVector? = null
