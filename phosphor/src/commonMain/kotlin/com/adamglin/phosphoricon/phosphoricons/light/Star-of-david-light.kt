...
public val LightGroup.`Star-of-david-light`: ImageVector
    get() {
        if (`_star-of-david-light` != null) {
            return `_star-of-david-light`!!
        }
        `_star-of-david-light` = Builder(name = "Star-of-david-light", defaultWidth = 256.0.dp,
...
private var `_star-of-david-light`: ImageVector? = null
