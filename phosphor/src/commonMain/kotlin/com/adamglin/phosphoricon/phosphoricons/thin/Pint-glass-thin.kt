...
public val ThinGroup.`Pint-glass-thin`: ImageVector
    get() {
        if (`_pint-glass-thin` != null) {
            return `_pint-glass-thin`!!
        }
        `_pint-glass-thin` = Builder(name = "Pint-glass-thin", defaultWidth = 256.0.dp,
...
private var `_pint-glass-thin`: ImageVector? = null
