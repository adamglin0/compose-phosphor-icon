...
public val DuotoneGroup.`Number-zero-duotone`: ImageVector
    get() {
        if (`_number-zero-duotone` != null) {
            return `_number-zero-duotone`!!
        }
        `_number-zero-duotone` = Builder(name = "Number-zero-duotone", defaultWidth = 256.0.dp,
...
private var `_number-zero-duotone`: ImageVector? = null
