...
public val DuotoneGroup.`Number-square-five-duotone`: ImageVector
    get() {
        if (`_number-square-five-duotone` != null) {
            return `_number-square-five-duotone`!!
        }
        `_number-square-five-duotone` = Builder(name = "Number-square-five-duotone", defaultWidth =
...
private var `_number-square-five-duotone`: ImageVector? = null
