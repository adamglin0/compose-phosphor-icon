...
public val DuotoneGroup.`Charging-station-duotone`: ImageVector
    get() {
        if (`_charging-station-duotone` != null) {
            return `_charging-station-duotone`!!
        }
        `_charging-station-duotone` = Builder(name = "Charging-station-duotone", defaultWidth =
...
private var `_charging-station-duotone`: ImageVector? = null
