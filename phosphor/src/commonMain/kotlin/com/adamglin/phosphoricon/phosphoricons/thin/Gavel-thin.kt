...
public val ThinGroup.`Gavel-thin`: ImageVector
    get() {
        if (`_gavel-thin` != null) {
            return `_gavel-thin`!!
        }
        `_gavel-thin` = Builder(name = "Gavel-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gavel-thin`: ImageVector? = null
