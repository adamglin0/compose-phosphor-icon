...
public val RegularGroup.`Codepen-logo`: ImageVector
    get() {
        if (`_codepen-logo` != null) {
            return `_codepen-logo`!!
        }
        `_codepen-logo` = Builder(name = "Codepen-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_codepen-logo`: ImageVector? = null
