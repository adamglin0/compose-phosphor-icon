...
public val LightGroup.`Twitter-logo-light`: ImageVector
    get() {
        if (`_twitter-logo-light` != null) {
            return `_twitter-logo-light`!!
        }
        `_twitter-logo-light` = Builder(name = "Twitter-logo-light", defaultWidth = 256.0.dp,
...
private var `_twitter-logo-light`: ImageVector? = null
