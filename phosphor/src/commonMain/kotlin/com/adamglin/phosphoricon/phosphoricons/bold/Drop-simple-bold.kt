...
public val BoldGroup.`Drop-simple-bold`: ImageVector
    get() {
        if (`_drop-simple-bold` != null) {
            return `_drop-simple-bold`!!
        }
        `_drop-simple-bold` = Builder(name = "Drop-simple-bold", defaultWidth = 256.0.dp,
...
private var `_drop-simple-bold`: ImageVector? = null
