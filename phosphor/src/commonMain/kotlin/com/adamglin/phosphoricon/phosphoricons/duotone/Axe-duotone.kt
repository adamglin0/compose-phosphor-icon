...
public val DuotoneGroup.`Axe-duotone`: ImageVector
    get() {
        if (`_axe-duotone` != null) {
            return `_axe-duotone`!!
        }
        `_axe-duotone` = Builder(name = "Axe-duotone", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(245.65f, 108.46f)
                lineToRelative(-81.19f, 81.19f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 150.87f, 185.0f)
                curveToRelative(-7.09f, -53.14f, -42.41f, -87.8f, -59.45f, -99.76f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 90.33f, 73.0f)
                lineTo(129.0f, 34.33f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 12.2f, 1.09f)
                curveToRelative(12.0f, 17.0f, 46.62f, 52.36f, 99.76f, 59.45f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 245.65f, 108.46f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(150.89f, 150.89f, 0.0f, false, true, 11.65f, 13.71f)
                close()
                moveTo(158.8f, 183.92f)
                curveTo(150.0f, 118.29f, 101.52f, 82.52f, 96.0f, 78.67f)
                lineTo(134.66f, 40.0f)
                curveToRelative(3.86f, 5.5f, 39.63f, 54.0f, 105.25f, 62.78f)
                close()
            }
        }
        .build()
...
private var `_axe-duotone`: ImageVector? = null
