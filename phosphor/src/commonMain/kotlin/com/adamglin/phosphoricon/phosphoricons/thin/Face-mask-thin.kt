...
public val ThinGroup.`Face-mask-thin`: ImageVector
    get() {
        if (`_face-mask-thin` != null) {
            return `_face-mask-thin`!!
        }
        `_face-mask-thin` = Builder(name = "Face-mask-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_face-mask-thin`: ImageVector? = null
