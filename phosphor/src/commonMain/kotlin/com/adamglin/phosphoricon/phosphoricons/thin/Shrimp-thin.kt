...
public val ThinGroup.`Shrimp-thin`: ImageVector
    get() {
        if (`_shrimp-thin` != null) {
            return `_shrimp-thin`!!
        }
        `_shrimp-thin` = Builder(name = "Shrimp-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shrimp-thin`: ImageVector? = null
