...
public val DuotoneGroup.`Question-mark-duotone`: ImageVector
    get() {
        if (`_question-mark-duotone` != null) {
            return `_question-mark-duotone`!!
        }
        `_question-mark-duotone` = Builder(name = "Question-mark-duotone", defaultWidth = 256.0.dp,
...
private var `_question-mark-duotone`: ImageVector? = null
