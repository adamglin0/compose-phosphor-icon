...
public val LightGroup.`Text-h-six-light`: ImageVector
    get() {
        if (`_text-h-six-light` != null) {
            return `_text-h-six-light`!!
        }
        `_text-h-six-light` = Builder(name = "Text-h-six-light", defaultWidth = 256.0.dp,
...
private var `_text-h-six-light`: ImageVector? = null
