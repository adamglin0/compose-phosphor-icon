...
public val DuotoneGroup.`Peace-duotone`: ImageVector
    get() {
        if (`_peace-duotone` != null) {
            return `_peace-duotone`!!
        }
        `_peace-duotone` = Builder(name = "Peace-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_peace-duotone`: ImageVector? = null
