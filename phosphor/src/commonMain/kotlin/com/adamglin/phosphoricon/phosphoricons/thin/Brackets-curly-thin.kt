...
public val ThinGroup.`Brackets-curly-thin`: ImageVector
    get() {
        if (`_brackets-curly-thin` != null) {
            return `_brackets-curly-thin`!!
        }
        `_brackets-curly-thin` = Builder(name = "Brackets-curly-thin", defaultWidth = 256.0.dp,
...
private var `_brackets-curly-thin`: ImageVector? = null
