...
public val BoldGroup.`Subway-bold`: ImageVector
    get() {
        if (`_subway-bold` != null) {
            return `_subway-bold`!!
        }
        `_subway-bold` = Builder(name = "Subway-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_subway-bold`: ImageVector? = null
