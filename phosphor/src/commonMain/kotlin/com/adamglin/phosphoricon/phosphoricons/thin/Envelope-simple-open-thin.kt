...
public val ThinGroup.`Envelope-simple-open-thin`: ImageVector
    get() {
        if (`_envelope-simple-open-thin` != null) {
            return `_envelope-simple-open-thin`!!
        }
        `_envelope-simple-open-thin` = Builder(name = "Envelope-simple-open-thin", defaultWidth =
...
private var `_envelope-simple-open-thin`: ImageVector? = null
