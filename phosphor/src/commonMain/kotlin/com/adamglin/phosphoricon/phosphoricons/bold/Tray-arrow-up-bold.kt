...
public val BoldGroup.`Tray-arrow-up-bold`: ImageVector
    get() {
        if (`_tray-arrow-up-bold` != null) {
            return `_tray-arrow-up-bold`!!
        }
        `_tray-arrow-up-bold` = Builder(name = "Tray-arrow-up-bold", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-up-bold`: ImageVector? = null
