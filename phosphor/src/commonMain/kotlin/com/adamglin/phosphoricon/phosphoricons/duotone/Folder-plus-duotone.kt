...
public val DuotoneGroup.`Folder-plus-duotone`: ImageVector
    get() {
        if (`_folder-plus-duotone` != null) {
            return `_folder-plus-duotone`!!
        }
        `_folder-plus-duotone` = Builder(name = "Folder-plus-duotone", defaultWidth = 256.0.dp,
...
private var `_folder-plus-duotone`: ImageVector? = null
