...
public val LightGroup.`Cloud-snow-light`: ImageVector
    get() {
        if (`_cloud-snow-light` != null) {
            return `_cloud-snow-light`!!
        }
        `_cloud-snow-light` = Builder(name = "Cloud-snow-light", defaultWidth = 256.0.dp,
...
private var `_cloud-snow-light`: ImageVector? = null
