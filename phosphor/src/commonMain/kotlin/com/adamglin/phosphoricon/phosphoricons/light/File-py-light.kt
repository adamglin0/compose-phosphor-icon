...
public val LightGroup.`File-py-light`: ImageVector
    get() {
        if (`_file-py-light` != null) {
            return `_file-py-light`!!
        }
        `_file-py-light` = Builder(name = "File-py-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-py-light`: ImageVector? = null
