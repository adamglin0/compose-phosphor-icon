...
public val BoldGroup.`Read-cv-logo-bold`: ImageVector
    get() {
        if (`_read-cv-logo-bold` != null) {
            return `_read-cv-logo-bold`!!
        }
        `_read-cv-logo-bold` = Builder(name = "Read-cv-logo-bold", defaultWidth = 256.0.dp,
...
private var `_read-cv-logo-bold`: ImageVector? = null
