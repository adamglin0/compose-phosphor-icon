...
public val LightGroup.`File-md-light`: ImageVector
    get() {
        if (`_file-md-light` != null) {
            return `_file-md-light`!!
        }
        `_file-md-light` = Builder(name = "File-md-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-md-light`: ImageVector? = null
