...
public val ThinGroup.`Bus-thin`: ImageVector
    get() {
        if (`_bus-thin` != null) {
            return `_bus-thin`!!
        }
        `_bus-thin` = Builder(name = "Bus-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_bus-thin`: ImageVector? = null
