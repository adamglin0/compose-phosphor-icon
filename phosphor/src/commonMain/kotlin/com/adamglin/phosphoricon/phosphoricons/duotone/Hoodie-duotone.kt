...
public val DuotoneGroup.`Hoodie-duotone`: ImageVector
    get() {
        if (`_hoodie-duotone` != null) {
            return `_hoodie-duotone`!!
        }
        `_hoodie-duotone` = Builder(name = "Hoodie-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hoodie-duotone`: ImageVector? = null
