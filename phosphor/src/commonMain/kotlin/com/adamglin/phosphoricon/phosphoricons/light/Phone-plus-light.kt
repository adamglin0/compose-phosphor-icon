...
public val LightGroup.`Phone-plus-light`: ImageVector
    get() {
        if (`_phone-plus-light` != null) {
            return `_phone-plus-light`!!
        }
        `_phone-plus-light` = Builder(name = "Phone-plus-light", defaultWidth = 256.0.dp,
...
private var `_phone-plus-light`: ImageVector? = null
