...
public val ThinGroup.`Bell-simple-ringing-thin`: ImageVector
    get() {
        if (`_bell-simple-ringing-thin` != null) {
            return `_bell-simple-ringing-thin`!!
        }
        `_bell-simple-ringing-thin` = Builder(name = "Bell-simple-ringing-thin", defaultWidth =
...
private var `_bell-simple-ringing-thin`: ImageVector? = null
