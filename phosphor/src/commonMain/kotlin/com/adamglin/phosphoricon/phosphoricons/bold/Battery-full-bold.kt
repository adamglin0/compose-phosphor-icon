...
public val BoldGroup.`Battery-full-bold`: ImageVector
    get() {
        if (`_battery-full-bold` != null) {
            return `_battery-full-bold`!!
        }
        `_battery-full-bold` = Builder(name = "Battery-full-bold", defaultWidth = 256.0.dp,
...
private var `_battery-full-bold`: ImageVector? = null
