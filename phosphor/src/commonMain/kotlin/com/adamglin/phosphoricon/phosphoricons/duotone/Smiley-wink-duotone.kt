...
public val DuotoneGroup.`Smiley-wink-duotone`: ImageVector
    get() {
        if (`_smiley-wink-duotone` != null) {
            return `_smiley-wink-duotone`!!
        }
        `_smiley-wink-duotone` = Builder(name = "Smiley-wink-duotone", defaultWidth = 256.0.dp,
...
private var `_smiley-wink-duotone`: ImageVector? = null
