...
public val RegularGroup.`Seal-warning`: ImageVector
    get() {
        if (`_seal-warning` != null) {
            return `_seal-warning`!!
        }
        `_seal-warning` = Builder(name = "Seal-warning", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seal-warning`: ImageVector? = null
