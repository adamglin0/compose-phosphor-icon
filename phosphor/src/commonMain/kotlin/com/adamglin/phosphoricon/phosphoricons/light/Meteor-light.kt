...
public val LightGroup.`Meteor-light`: ImageVector
    get() {
        if (`_meteor-light` != null) {
            return `_meteor-light`!!
        }
        `_meteor-light` = Builder(name = "Meteor-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_meteor-light`: ImageVector? = null
