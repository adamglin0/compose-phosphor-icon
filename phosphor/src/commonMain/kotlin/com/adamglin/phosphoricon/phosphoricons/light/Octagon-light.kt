...
public val LightGroup.`Octagon-light`: ImageVector
    get() {
        if (`_octagon-light` != null) {
            return `_octagon-light`!!
        }
        `_octagon-light` = Builder(name = "Octagon-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_octagon-light`: ImageVector? = null
