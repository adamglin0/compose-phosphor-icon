...
public val ThinGroup.`Egg-crack-thin`: ImageVector
    get() {
        if (`_egg-crack-thin` != null) {
            return `_egg-crack-thin`!!
        }
        `_egg-crack-thin` = Builder(name = "Egg-crack-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_egg-crack-thin`: ImageVector? = null
