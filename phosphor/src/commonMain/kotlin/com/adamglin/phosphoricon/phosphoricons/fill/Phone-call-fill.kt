...
public val FillGroup.`Phone-call-fill`: ImageVector
    get() {
        if (`_phone-call-fill` != null) {
            return `_phone-call-fill`!!
        }
        `_phone-call-fill` = Builder(name = "Phone-call-fill", defaultWidth = 256.0.dp,
...
private var `_phone-call-fill`: ImageVector? = null
