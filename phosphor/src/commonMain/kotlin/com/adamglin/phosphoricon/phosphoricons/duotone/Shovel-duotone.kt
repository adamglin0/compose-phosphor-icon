...
public val DuotoneGroup.`Shovel-duotone`: ImageVector
    get() {
        if (`_shovel-duotone` != null) {
            return `_shovel-duotone`!!
        }
        `_shovel-duotone` = Builder(name = "Shovel-duotone", defaultWidth = 256.0.dp, defaultHeight
                = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(173.66f, 173.66f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 173.66f, 173.66f)
                close()
            }
...
private var `_shovel-duotone`: ImageVector? = null
