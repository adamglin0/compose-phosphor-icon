...
public val DuotoneGroup.`Toilet-duotone`: ImageVector
    get() {
        if (`_toilet-duotone` != null) {
            return `_toilet-duotone`!!
        }
        `_toilet-duotone` = Builder(name = "Toilet-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_toilet-duotone`: ImageVector? = null
