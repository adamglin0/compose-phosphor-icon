...
public val LightGroup.`Text-h-three-light`: ImageVector
    get() {
        if (`_text-h-three-light` != null) {
            return `_text-h-three-light`!!
        }
        `_text-h-three-light` = Builder(name = "Text-h-three-light", defaultWidth = 256.0.dp,
...
private var `_text-h-three-light`: ImageVector? = null
