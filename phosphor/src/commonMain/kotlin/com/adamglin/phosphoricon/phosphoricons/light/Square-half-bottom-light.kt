...
public val LightGroup.`Square-half-bottom-light`: ImageVector
    get() {
        if (`_square-half-bottom-light` != null) {
            return `_square-half-bottom-light`!!
        }
        `_square-half-bottom-light` = Builder(name = "Square-half-bottom-light", defaultWidth =
...
private var `_square-half-bottom-light`: ImageVector? = null
