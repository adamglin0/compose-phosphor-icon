...
public val DuotoneGroup.`Phone-pause-duotone`: ImageVector
    get() {
        if (`_phone-pause-duotone` != null) {
            return `_phone-pause-duotone`!!
        }
        `_phone-pause-duotone` = Builder(name = "Phone-pause-duotone", defaultWidth = 256.0.dp,
...
private var `_phone-pause-duotone`: ImageVector? = null
