...
public val BoldGroup.`Pi-bold`: ImageVector
    get() {
        if (`_pi-bold` != null) {
            return `_pi-bold`!!
        }
        `_pi-bold` = Builder(name = "Pi-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_pi-bold`: ImageVector? = null
