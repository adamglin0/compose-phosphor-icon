...
public val FillGroup.`Meta-logo-fill`: ImageVector
    get() {
        if (`_meta-logo-fill` != null) {
            return `_meta-logo-fill`!!
        }
        `_meta-logo-fill` = Builder(name = "Meta-logo-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_meta-logo-fill`: ImageVector? = null
