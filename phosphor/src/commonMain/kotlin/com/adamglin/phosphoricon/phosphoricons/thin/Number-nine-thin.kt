...
public val ThinGroup.`Number-nine-thin`: ImageVector
    get() {
        if (`_number-nine-thin` != null) {
            return `_number-nine-thin`!!
        }
        `_number-nine-thin` = Builder(name = "Number-nine-thin", defaultWidth = 256.0.dp,
...
private var `_number-nine-thin`: ImageVector? = null
