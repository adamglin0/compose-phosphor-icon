...
public val ThinGroup.`Bookmarks-thin`: ImageVector
    get() {
        if (`_bookmarks-thin` != null) {
            return `_bookmarks-thin`!!
        }
        `_bookmarks-thin` = Builder(name = "Bookmarks-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bookmarks-thin`: ImageVector? = null
