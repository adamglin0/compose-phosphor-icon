...
public val DuotoneGroup.`Goodreads-logo-duotone`: ImageVector
    get() {
        if (`_goodreads-logo-duotone` != null) {
            return `_goodreads-logo-duotone`!!
        }
        `_goodreads-logo-duotone` = Builder(name = "Goodreads-logo-duotone", defaultWidth =
...
private var `_goodreads-logo-duotone`: ImageVector? = null
