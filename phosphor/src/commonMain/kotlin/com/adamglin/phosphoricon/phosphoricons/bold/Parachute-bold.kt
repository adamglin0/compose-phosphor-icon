...
public val BoldGroup.`Parachute-bold`: ImageVector
    get() {
        if (`_parachute-bold` != null) {
            return `_parachute-bold`!!
        }
        `_parachute-bold` = Builder(name = "Parachute-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_parachute-bold`: ImageVector? = null
