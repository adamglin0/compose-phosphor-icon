...
public val LightGroup.`Shield-slash-light`: ImageVector
    get() {
        if (`_shield-slash-light` != null) {
            return `_shield-slash-light`!!
        }
        `_shield-slash-light` = Builder(name = "Shield-slash-light", defaultWidth = 256.0.dp,
...
private var `_shield-slash-light`: ImageVector? = null
