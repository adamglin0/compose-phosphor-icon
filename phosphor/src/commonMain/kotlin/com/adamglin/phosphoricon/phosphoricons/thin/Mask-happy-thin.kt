...
public val ThinGroup.`Mask-happy-thin`: ImageVector
    get() {
        if (`_mask-happy-thin` != null) {
            return `_mask-happy-thin`!!
        }
        `_mask-happy-thin` = Builder(name = "Mask-happy-thin", defaultWidth = 256.0.dp,
...
private var `_mask-happy-thin`: ImageVector? = null
