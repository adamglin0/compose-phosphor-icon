...
public val BoldGroup.`Lighthouse-bold`: ImageVector
    get() {
        if (`_lighthouse-bold` != null) {
            return `_lighthouse-bold`!!
        }
        `_lighthouse-bold` = Builder(name = "Lighthouse-bold", defaultWidth = 256.0.dp,
...
private var `_lighthouse-bold`: ImageVector? = null
