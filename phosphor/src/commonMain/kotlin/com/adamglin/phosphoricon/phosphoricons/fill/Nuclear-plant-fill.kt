...
public val FillGroup.`Nuclear-plant-fill`: ImageVector
    get() {
        if (`_nuclear-plant-fill` != null) {
            return `_nuclear-plant-fill`!!
        }
        `_nuclear-plant-fill` = Builder(name = "Nuclear-plant-fill", defaultWidth = 256.0.dp,
...
private var `_nuclear-plant-fill`: ImageVector? = null
