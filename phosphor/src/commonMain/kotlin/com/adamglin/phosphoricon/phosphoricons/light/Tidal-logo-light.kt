...
public val LightGroup.`Tidal-logo-light`: ImageVector
    get() {
        if (`_tidal-logo-light` != null) {
            return `_tidal-logo-light`!!
        }
        `_tidal-logo-light` = Builder(name = "Tidal-logo-light", defaultWidth = 256.0.dp,
...
private var `_tidal-logo-light`: ImageVector? = null
