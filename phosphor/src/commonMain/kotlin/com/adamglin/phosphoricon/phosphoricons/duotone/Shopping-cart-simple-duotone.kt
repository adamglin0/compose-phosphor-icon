...
public val DuotoneGroup.`Shopping-cart-simple-duotone`: ImageVector
    get() {
        if (`_shopping-cart-simple-duotone` != null) {
            return `_shopping-cart-simple-duotone`!!
        }
        `_shopping-cart-simple-duotone` = Builder(name = "Shopping-cart-simple-duotone",
...
private var `_shopping-cart-simple-duotone`: ImageVector? = null
