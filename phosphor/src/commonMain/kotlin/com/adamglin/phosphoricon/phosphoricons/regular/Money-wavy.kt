...
public val RegularGroup.`Money-wavy`: ImageVector
    get() {
        if (`_money-wavy` != null) {
            return `_money-wavy`!!
        }
        `_money-wavy` = Builder(name = "Money-wavy", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_money-wavy`: ImageVector? = null
