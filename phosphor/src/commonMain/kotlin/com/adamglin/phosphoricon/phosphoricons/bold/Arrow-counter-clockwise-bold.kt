...
public val BoldGroup.`Arrow-counter-clockwise-bold`: ImageVector
    get() {
        if (`_arrow-counter-clockwise-bold` != null) {
            return `_arrow-counter-clockwise-bold`!!
        }
        `_arrow-counter-clockwise-bold` = Builder(name = "Arrow-counter-clockwise-bold",
...
private var `_arrow-counter-clockwise-bold`: ImageVector? = null
