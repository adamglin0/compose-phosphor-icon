...
public val DuotoneGroup.`Shield-chevron-duotone`: ImageVector
    get() {
        if (`_shield-chevron-duotone` != null) {
            return `_shield-chevron-duotone`!!
        }
        `_shield-chevron-duotone` = Builder(name = "Shield-chevron-duotone", defaultWidth =
                256.0.dp, defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight =
                256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(202.0f, 171.78f)
                curveTo(177.13f, 218.6f, 128.0f, 232.0f, 128.0f, 232.0f)
                reflectiveCurveToRelative(-49.13f, -13.4f, -74.0f, -60.22f)
...
private var `_shield-chevron-duotone`: ImageVector? = null
