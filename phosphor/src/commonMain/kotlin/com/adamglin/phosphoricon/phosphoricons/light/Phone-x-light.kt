...
public val LightGroup.`Phone-x-light`: ImageVector
    get() {
        if (`_phone-x-light` != null) {
            return `_phone-x-light`!!
        }
        `_phone-x-light` = Builder(name = "Phone-x-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-x-light`: ImageVector? = null
