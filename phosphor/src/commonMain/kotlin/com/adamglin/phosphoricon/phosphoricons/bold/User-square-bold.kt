...
public val BoldGroup.`User-square-bold`: ImageVector
    get() {
        if (`_user-square-bold` != null) {
            return `_user-square-bold`!!
        }
        `_user-square-bold` = Builder(name = "User-square-bold", defaultWidth = 256.0.dp,
...
private var `_user-square-bold`: ImageVector? = null
