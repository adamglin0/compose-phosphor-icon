...
public val LightGroup.`Note-light`: ImageVector
    get() {
        if (`_note-light` != null) {
            return `_note-light`!!
        }
        `_note-light` = Builder(name = "Note-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_note-light`: ImageVector? = null
