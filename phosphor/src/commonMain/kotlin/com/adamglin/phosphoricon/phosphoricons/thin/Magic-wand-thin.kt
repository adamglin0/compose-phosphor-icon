...
public val ThinGroup.`Magic-wand-thin`: ImageVector
    get() {
        if (`_magic-wand-thin` != null) {
            return `_magic-wand-thin`!!
        }
        `_magic-wand-thin` = Builder(name = "Magic-wand-thin", defaultWidth = 256.0.dp,
...
private var `_magic-wand-thin`: ImageVector? = null
