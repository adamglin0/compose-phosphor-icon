...
public val LightGroup.`Bird-light`: ImageVector
    get() {
        if (`_bird-light` != null) {
            return `_bird-light`!!
        }
        `_bird-light` = Builder(name = "Bird-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bird-light`: ImageVector? = null
