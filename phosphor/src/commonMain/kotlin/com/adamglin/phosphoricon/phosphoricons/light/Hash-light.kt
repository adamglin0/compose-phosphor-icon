...
public val LightGroup.`Hash-light`: ImageVector
    get() {
        if (`_hash-light` != null) {
            return `_hash-light`!!
        }
        `_hash-light` = Builder(name = "Hash-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hash-light`: ImageVector? = null
