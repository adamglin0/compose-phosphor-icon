...
public val LightGroup.`Ladder-light`: ImageVector
    get() {
        if (`_ladder-light` != null) {
            return `_ladder-light`!!
        }
        `_ladder-light` = Builder(name = "Ladder-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ladder-light`: ImageVector? = null
