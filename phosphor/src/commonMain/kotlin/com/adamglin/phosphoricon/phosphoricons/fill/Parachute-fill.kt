...
public val FillGroup.`Parachute-fill`: ImageVector
    get() {
        if (`_parachute-fill` != null) {
            return `_parachute-fill`!!
        }
        `_parachute-fill` = Builder(name = "Parachute-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_parachute-fill`: ImageVector? = null
