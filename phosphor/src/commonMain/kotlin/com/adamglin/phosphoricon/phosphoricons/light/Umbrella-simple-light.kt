...
public val LightGroup.`Umbrella-simple-light`: ImageVector
    get() {
        if (`_umbrella-simple-light` != null) {
            return `_umbrella-simple-light`!!
        }
        `_umbrella-simple-light` = Builder(name = "Umbrella-simple-light", defaultWidth = 256.0.dp,
...
private var `_umbrella-simple-light`: ImageVector? = null
