...
public val LightGroup.`Wifi-x-light`: ImageVector
    get() {
        if (`_wifi-x-light` != null) {
            return `_wifi-x-light`!!
        }
        `_wifi-x-light` = Builder(name = "Wifi-x-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wifi-x-light`: ImageVector? = null
