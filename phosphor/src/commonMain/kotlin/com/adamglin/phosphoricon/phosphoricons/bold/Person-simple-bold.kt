...
public val BoldGroup.`Person-simple-bold`: ImageVector
    get() {
        if (`_person-simple-bold` != null) {
            return `_person-simple-bold`!!
        }
        `_person-simple-bold` = Builder(name = "Person-simple-bold", defaultWidth = 256.0.dp,
...
private var `_person-simple-bold`: ImageVector? = null
