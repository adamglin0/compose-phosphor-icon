...
public val LightGroup.`Plant-light`: ImageVector
    get() {
        if (`_plant-light` != null) {
            return `_plant-light`!!
        }
        `_plant-light` = Builder(name = "Plant-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plant-light`: ImageVector? = null
