...
public val DuotoneGroup.`Bandaids-duotone`: ImageVector
    get() {
        if (`_bandaids-duotone` != null) {
            return `_bandaids-duotone`!!
        }
        `_bandaids-duotone` = Builder(name = "Bandaids-duotone", defaultWidth = 256.0.dp,
...
private var `_bandaids-duotone`: ImageVector? = null
