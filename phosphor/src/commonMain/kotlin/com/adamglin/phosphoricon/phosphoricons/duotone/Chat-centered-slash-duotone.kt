...
public val DuotoneGroup.`Chat-centered-slash-duotone`: ImageVector
    get() {
        if (`_chat-centered-slash-duotone` != null) {
            return `_chat-centered-slash-duotone`!!
        }
        `_chat-centered-slash-duotone` = Builder(name = "Chat-centered-slash-duotone", defaultWidth
...
private var `_chat-centered-slash-duotone`: ImageVector? = null
