...
public val LightGroup.`Desk-light`: ImageVector
    get() {
        if (`_desk-light` != null) {
            return `_desk-light`!!
        }
        `_desk-light` = Builder(name = "Desk-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_desk-light`: ImageVector? = null
