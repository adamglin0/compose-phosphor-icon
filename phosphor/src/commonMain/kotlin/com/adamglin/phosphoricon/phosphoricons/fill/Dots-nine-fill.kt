...
public val FillGroup.`Dots-nine-fill`: ImageVector
    get() {
        if (`_dots-nine-fill` != null) {
            return `_dots-nine-fill`!!
        }
        `_dots-nine-fill` = Builder(name = "Dots-nine-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dots-nine-fill`: ImageVector? = null
