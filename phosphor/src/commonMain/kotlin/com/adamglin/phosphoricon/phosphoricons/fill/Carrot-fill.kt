...
public val FillGroup.`Carrot-fill`: ImageVector
    get() {
        if (`_carrot-fill` != null) {
            return `_carrot-fill`!!
        }
        `_carrot-fill` = Builder(name = "Carrot-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_carrot-fill`: ImageVector? = null
