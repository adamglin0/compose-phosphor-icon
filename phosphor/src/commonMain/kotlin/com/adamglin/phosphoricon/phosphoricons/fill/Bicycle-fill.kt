...
public val FillGroup.`Bicycle-fill`: ImageVector
    get() {
        if (`_bicycle-fill` != null) {
            return `_bicycle-fill`!!
        }
        `_bicycle-fill` = Builder(name = "Bicycle-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bicycle-fill`: ImageVector? = null
