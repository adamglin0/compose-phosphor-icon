...
public val BoldGroup.`Treasure-chest-bold`: ImageVector
    get() {
        if (`_treasure-chest-bold` != null) {
            return `_treasure-chest-bold`!!
        }
        `_treasure-chest-bold` = Builder(name = "Treasure-chest-bold", defaultWidth = 256.0.dp,
...
private var `_treasure-chest-bold`: ImageVector? = null
