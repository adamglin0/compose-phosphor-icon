...
public val LightGroup.`Hockey-light`: ImageVector
    get() {
        if (`_hockey-light` != null) {
            return `_hockey-light`!!
        }
        `_hockey-light` = Builder(name = "Hockey-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hockey-light`: ImageVector? = null
