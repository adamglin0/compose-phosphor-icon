...
public val DuotoneGroup.`File-cpp-duotone`: ImageVector
    get() {
        if (`_file-cpp-duotone` != null) {
            return `_file-cpp-duotone`!!
        }
        `_file-cpp-duotone` = Builder(name = "File-cpp-duotone", defaultWidth = 256.0.dp,
...
private var `_file-cpp-duotone`: ImageVector? = null
