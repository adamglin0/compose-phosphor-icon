...
public val RegularGroup.`Bug-beetle`: ImageVector
    get() {
        if (`_bug-beetle` != null) {
            return `_bug-beetle`!!
        }
        `_bug-beetle` = Builder(name = "Bug-beetle", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bug-beetle`: ImageVector? = null
