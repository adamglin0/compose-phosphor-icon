...
public val LightGroup.`Magnet-light`: ImageVector
    get() {
        if (`_magnet-light` != null) {
            return `_magnet-light`!!
        }
        `_magnet-light` = Builder(name = "Magnet-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_magnet-light`: ImageVector? = null
