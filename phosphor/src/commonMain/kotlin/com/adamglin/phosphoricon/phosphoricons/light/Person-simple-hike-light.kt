...
public val LightGroup.`Person-simple-hike-light`: ImageVector
    get() {
        if (`_person-simple-hike-light` != null) {
            return `_person-simple-hike-light`!!
        }
        `_person-simple-hike-light` = Builder(name = "Person-simple-hike-light", defaultWidth =
...
private var `_person-simple-hike-light`: ImageVector? = null
