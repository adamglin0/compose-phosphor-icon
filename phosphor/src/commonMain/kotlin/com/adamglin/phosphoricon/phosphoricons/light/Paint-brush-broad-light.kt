...
public val LightGroup.`Paint-brush-broad-light`: ImageVector
    get() {
        if (`_paint-brush-broad-light` != null) {
            return `_paint-brush-broad-light`!!
        }
        `_paint-brush-broad-light` = Builder(name = "Paint-brush-broad-light", defaultWidth =
...
private var `_paint-brush-broad-light`: ImageVector? = null
