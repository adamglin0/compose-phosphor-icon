...
public val LightGroup.`Align-bottom-light`: ImageVector
    get() {
        if (`_align-bottom-light` != null) {
            return `_align-bottom-light`!!
        }
        `_align-bottom-light` = Builder(name = "Align-bottom-light", defaultWidth = 256.0.dp,
...
private var `_align-bottom-light`: ImageVector? = null
