...
public val DuotoneGroup.`Caret-circle-double-up-duotone`: ImageVector
    get() {
        if (`_caret-circle-double-up-duotone` != null) {
            return `_caret-circle-double-up-duotone`!!
        }
        `_caret-circle-double-up-duotone` = Builder(name = "Caret-circle-double-up-duotone",
...
private var `_caret-circle-double-up-duotone`: ImageVector? = null
