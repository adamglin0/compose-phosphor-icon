...
public val DuotoneGroup.`Globe-hemisphere-east-duotone`: ImageVector
    get() {
        if (`_globe-hemisphere-east-duotone` != null) {
            return `_globe-hemisphere-east-duotone`!!
        }
        `_globe-hemisphere-east-duotone` = Builder(name = "Globe-hemisphere-east-duotone",
...
private var `_globe-hemisphere-east-duotone`: ImageVector? = null
