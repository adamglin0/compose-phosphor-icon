...
public val ThinGroup.`Chat-centered-thin`: ImageVector
    get() {
        if (`_chat-centered-thin` != null) {
            return `_chat-centered-thin`!!
        }
        `_chat-centered-thin` = Builder(name = "Chat-centered-thin", defaultWidth = 256.0.dp,
...
private var `_chat-centered-thin`: ImageVector? = null
