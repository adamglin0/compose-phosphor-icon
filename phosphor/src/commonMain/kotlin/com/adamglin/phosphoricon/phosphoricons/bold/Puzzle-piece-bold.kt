...
public val BoldGroup.`Puzzle-piece-bold`: ImageVector
    get() {
        if (`_puzzle-piece-bold` != null) {
            return `_puzzle-piece-bold`!!
        }
        `_puzzle-piece-bold` = Builder(name = "Puzzle-piece-bold", defaultWidth = 256.0.dp,
...
private var `_puzzle-piece-bold`: ImageVector? = null
