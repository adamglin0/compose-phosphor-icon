...
public val LightGroup.`Lock-simple-open-light`: ImageVector
    get() {
        if (`_lock-simple-open-light` != null) {
            return `_lock-simple-open-light`!!
        }
        `_lock-simple-open-light` = Builder(name = "Lock-simple-open-light", defaultWidth =
...
private var `_lock-simple-open-light`: ImageVector? = null
