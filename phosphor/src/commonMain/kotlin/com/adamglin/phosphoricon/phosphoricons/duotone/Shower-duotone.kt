...
public val DuotoneGroup.`Shower-duotone`: ImageVector
    get() {
        if (`_shower-duotone` != null) {
            return `_shower-duotone`!!
        }
        `_shower-duotone` = Builder(name = "Shower-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_shower-duotone`: ImageVector? = null
