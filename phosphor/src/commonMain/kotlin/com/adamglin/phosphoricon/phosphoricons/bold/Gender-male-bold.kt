...
public val BoldGroup.`Gender-male-bold`: ImageVector
    get() {
        if (`_gender-male-bold` != null) {
            return `_gender-male-bold`!!
        }
        `_gender-male-bold` = Builder(name = "Gender-male-bold", defaultWidth = 256.0.dp,
...
private var `_gender-male-bold`: ImageVector? = null
