...
public val LightGroup.`Smiley-angry-light`: ImageVector
    get() {
        if (`_smiley-angry-light` != null) {
            return `_smiley-angry-light`!!
        }
        `_smiley-angry-light` = Builder(name = "Smiley-angry-light", defaultWidth = 256.0.dp,
...
private var `_smiley-angry-light`: ImageVector? = null
