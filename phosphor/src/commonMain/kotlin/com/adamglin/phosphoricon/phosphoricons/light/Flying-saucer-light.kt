...
public val LightGroup.`Flying-saucer-light`: ImageVector
    get() {
        if (`_flying-saucer-light` != null) {
            return `_flying-saucer-light`!!
        }
        `_flying-saucer-light` = Builder(name = "Flying-saucer-light", defaultWidth = 256.0.dp,
...
private var `_flying-saucer-light`: ImageVector? = null
