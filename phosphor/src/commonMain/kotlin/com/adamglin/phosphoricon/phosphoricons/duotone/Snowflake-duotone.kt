...
public val DuotoneGroup.`Snowflake-duotone`: ImageVector
    get() {
        if (`_snowflake-duotone` != null) {
            return `_snowflake-duotone`!!
        }
        `_snowflake-duotone` = Builder(name = "Snowflake-duotone", defaultWidth = 256.0.dp,
...
private var `_snowflake-duotone`: ImageVector? = null
