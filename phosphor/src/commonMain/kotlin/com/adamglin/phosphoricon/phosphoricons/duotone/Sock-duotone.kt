...
public val DuotoneGroup.`Sock-duotone`: ImageVector
    get() {
        if (`_sock-duotone` != null) {
            return `_sock-duotone`!!
        }
        `_sock-duotone` = Builder(name = "Sock-duotone", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(200.0f, 112.0f)
                verticalLineToRelative(33.37f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, -4.69f, 11.32f)
                lineToRelative(-33.0f, 33.0f)
                arcTo(48.0f, 48.0f, 0.0f, false, true, 200.0f, 112.0f)
                close()
                moveTo(192.0f, 24.0f)
                lineTo(104.0f, 24.0f)
...
private var `_sock-duotone`: ImageVector? = null
