...
public val FillGroup.`Steam-logo-fill`: ImageVector
    get() {
        if (`_steam-logo-fill` != null) {
            return `_steam-logo-fill`!!
        }
        `_steam-logo-fill` = Builder(name = "Steam-logo-fill", defaultWidth = 256.0.dp,
...
private var `_steam-logo-fill`: ImageVector? = null
