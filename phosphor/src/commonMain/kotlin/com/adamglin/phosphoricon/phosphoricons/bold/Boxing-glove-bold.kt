...
public val BoldGroup.`Boxing-glove-bold`: ImageVector
    get() {
        if (`_boxing-glove-bold` != null) {
            return `_boxing-glove-bold`!!
        }
        `_boxing-glove-bold` = Builder(name = "Boxing-glove-bold", defaultWidth = 256.0.dp,
...
private var `_boxing-glove-bold`: ImageVector? = null
