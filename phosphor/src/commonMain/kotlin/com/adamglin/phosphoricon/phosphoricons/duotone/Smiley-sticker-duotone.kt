...
public val DuotoneGroup.`Smiley-sticker-duotone`: ImageVector
    get() {
        if (`_smiley-sticker-duotone` != null) {
            return `_smiley-sticker-duotone`!!
        }
        `_smiley-sticker-duotone` = Builder(name = "Smiley-sticker-duotone", defaultWidth =
...
private var `_smiley-sticker-duotone`: ImageVector? = null
