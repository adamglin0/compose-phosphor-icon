...
public val FillGroup.`Number-five-fill`: ImageVector
    get() {
        if (`_number-five-fill` != null) {
            return `_number-five-fill`!!
        }
        `_number-five-fill` = Builder(name = "Number-five-fill", defaultWidth = 256.0.dp,
...
private var `_number-five-fill`: ImageVector? = null
