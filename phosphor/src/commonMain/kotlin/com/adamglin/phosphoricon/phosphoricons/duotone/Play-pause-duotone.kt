...
public val DuotoneGroup.`Play-pause-duotone`: ImageVector
    get() {
        if (`_play-pause-duotone` != null) {
            return `_play-pause-duotone`!!
        }
        `_play-pause-duotone` = Builder(name = "Play-pause-duotone", defaultWidth = 256.0.dp,
...
private var `_play-pause-duotone`: ImageVector? = null
