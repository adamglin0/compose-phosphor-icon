...
public val BoldGroup.`Shield-warning-bold`: ImageVector
    get() {
        if (`_shield-warning-bold` != null) {
            return `_shield-warning-bold`!!
        }
        `_shield-warning-bold` = Builder(name = "Shield-warning-bold", defaultWidth = 256.0.dp,
...
private var `_shield-warning-bold`: ImageVector? = null
