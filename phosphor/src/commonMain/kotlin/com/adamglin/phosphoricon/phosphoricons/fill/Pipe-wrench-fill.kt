...
public val FillGroup.`Pipe-wrench-fill`: ImageVector
    get() {
        if (`_pipe-wrench-fill` != null) {
            return `_pipe-wrench-fill`!!
        }
        `_pipe-wrench-fill` = Builder(name = "Pipe-wrench-fill", defaultWidth = 256.0.dp,
...
private var `_pipe-wrench-fill`: ImageVector? = null
