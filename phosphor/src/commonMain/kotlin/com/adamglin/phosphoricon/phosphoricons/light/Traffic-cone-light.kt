...
public val LightGroup.`Traffic-cone-light`: ImageVector
    get() {
        if (`_traffic-cone-light` != null) {
            return `_traffic-cone-light`!!
        }
        `_traffic-cone-light` = Builder(name = "Traffic-cone-light", defaultWidth = 256.0.dp,
...
private var `_traffic-cone-light`: ImageVector? = null
