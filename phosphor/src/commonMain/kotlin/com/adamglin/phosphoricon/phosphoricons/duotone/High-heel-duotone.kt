...
public val DuotoneGroup.`High-heel-duotone`: ImageVector
    get() {
        if (`_high-heel-duotone` != null) {
            return `_high-heel-duotone`!!
        }
        `_high-heel-duotone` = Builder(name = "High-heel-duotone", defaultWidth = 256.0.dp,
...
private var `_high-heel-duotone`: ImageVector? = null
