...
public val LightGroup.`Address-book-tabs-light`: ImageVector
    get() {
        if (`_address-book-tabs-light` != null) {
            return `_address-book-tabs-light`!!
        }
        `_address-book-tabs-light` = Builder(name = "Address-book-tabs-light", defaultWidth =
...
private var `_address-book-tabs-light`: ImageVector? = null
