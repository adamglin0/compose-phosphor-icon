...
public val BoldGroup.`Rectangle-dashed-bold`: ImageVector
    get() {
        if (`_rectangle-dashed-bold` != null) {
            return `_rectangle-dashed-bold`!!
        }
        `_rectangle-dashed-bold` = Builder(name = "Rectangle-dashed-bold", defaultWidth = 256.0.dp,
...
private var `_rectangle-dashed-bold`: ImageVector? = null
