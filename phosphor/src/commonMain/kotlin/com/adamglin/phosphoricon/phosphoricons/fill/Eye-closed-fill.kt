...
public val FillGroup.`Eye-closed-fill`: ImageVector
    get() {
        if (`_eye-closed-fill` != null) {
            return `_eye-closed-fill`!!
        }
        `_eye-closed-fill` = Builder(name = "Eye-closed-fill", defaultWidth = 256.0.dp,
...
private var `_eye-closed-fill`: ImageVector? = null
