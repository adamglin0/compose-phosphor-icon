...
public val DuotoneGroup.`Arrows-in-simple-duotone`: ImageVector
    get() {
        if (`_arrows-in-simple-duotone` != null) {
            return `_arrows-in-simple-duotone`!!
        }
        `_arrows-in-simple-duotone` = Builder(name = "Arrows-in-simple-duotone", defaultWidth =
...
private var `_arrows-in-simple-duotone`: ImageVector? = null
