...
public val LightGroup.`Repeat-light`: ImageVector
    get() {
        if (`_repeat-light` != null) {
            return `_repeat-light`!!
        }
        `_repeat-light` = Builder(name = "Repeat-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_repeat-light`: ImageVector? = null
