...
public val DuotoneGroup.`Key-duotone`: ImageVector
    get() {
        if (`_key-duotone` != null) {
            return `_key-duotone`!!
        }
        `_key-duotone` = Builder(name = "Key-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_key-duotone`: ImageVector? = null
