...
public val BoldGroup.`Magnet-bold`: ImageVector
    get() {
        if (`_magnet-bold` != null) {
            return `_magnet-bold`!!
        }
        `_magnet-bold` = Builder(name = "Magnet-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_magnet-bold`: ImageVector? = null
