...
public val ThinGroup.`Apple-podcasts-logo-thin`: ImageVector
    get() {
        if (`_apple-podcasts-logo-thin` != null) {
            return `_apple-podcasts-logo-thin`!!
        }
        `_apple-podcasts-logo-thin` = Builder(name = "Apple-podcasts-logo-thin", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(60.0f, 60.0f, 0.0f, true, false, 70.19f, 144.11f)
                arcToRelative(4.0f, 4.0f, 0.0f, true, true, -7.71f, 2.14f)
                arcToRelative(68.0f, 68.0f, 0.0f, true, true, 131.0f, 0.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.85f, 2.93f)
                arcToRelative(3.88f, 3.88f, 0.0f, false, true, -1.07f, -0.14f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.79f, -4.93f)
                arcTo(60.19f, 60.19f, 0.0f, false, false, 188.0f, 128.0f)
                close()
                moveTo(228.0f, 128.0f)
                arcToRelative(99.92f, 99.92f, 0.0f, false, true, -44.4f, 83.13f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.46f, -6.64f)
                arcToRelative(92.0f, 92.0f, 0.0f, true, false, -102.28f, 0.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.46f, 6.64f)
...
private var `_apple-podcasts-logo-thin`: ImageVector? = null
