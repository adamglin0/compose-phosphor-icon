...
public val ThinGroup.`Download-thin`: ImageVector
    get() {
        if (`_download-thin` != null) {
            return `_download-thin`!!
        }
        `_download-thin` = Builder(name = "Download-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_download-thin`: ImageVector? = null
