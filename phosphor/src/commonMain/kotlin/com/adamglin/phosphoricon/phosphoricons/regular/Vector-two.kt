...
public val RegularGroup.`Vector-two`: ImageVector
    get() {
        if (`_vector-two` != null) {
            return `_vector-two`!!
        }
        `_vector-two` = Builder(name = "Vector-two", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_vector-two`: ImageVector? = null
