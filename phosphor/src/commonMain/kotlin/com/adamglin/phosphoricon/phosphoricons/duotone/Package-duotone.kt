...
public val DuotoneGroup.`Package-duotone`: ImageVector
    get() {
        if (`_package-duotone` != null) {
            return `_package-duotone`!!
        }
        `_package-duotone` = Builder(name = "Package-duotone", defaultWidth = 256.0.dp,
...
private var `_package-duotone`: ImageVector? = null
