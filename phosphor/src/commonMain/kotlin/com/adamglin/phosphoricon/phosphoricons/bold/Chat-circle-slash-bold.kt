...
public val BoldGroup.`Chat-circle-slash-bold`: ImageVector
    get() {
        if (`_chat-circle-slash-bold` != null) {
            return `_chat-circle-slash-bold`!!
        }
        `_chat-circle-slash-bold` = Builder(name = "Chat-circle-slash-bold", defaultWidth =
...
private var `_chat-circle-slash-bold`: ImageVector? = null
