...
public val ThinGroup.`Arrows-in-thin`: ImageVector
    get() {
        if (`_arrows-in-thin` != null) {
            return `_arrows-in-thin`!!
        }
        `_arrows-in-thin` = Builder(name = "Arrows-in-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_arrows-in-thin`: ImageVector? = null
