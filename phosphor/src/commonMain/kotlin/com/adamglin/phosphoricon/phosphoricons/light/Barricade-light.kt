...
public val LightGroup.`Barricade-light`: ImageVector
    get() {
        if (`_barricade-light` != null) {
            return `_barricade-light`!!
        }
        `_barricade-light` = Builder(name = "Barricade-light", defaultWidth = 256.0.dp,
...
private var `_barricade-light`: ImageVector? = null
