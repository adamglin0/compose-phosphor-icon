...
public val BoldGroup.`Folder-simple-lock-bold`: ImageVector
    get() {
        if (`_folder-simple-lock-bold` != null) {
            return `_folder-simple-lock-bold`!!
        }
        `_folder-simple-lock-bold` = Builder(name = "Folder-simple-lock-bold", defaultWidth =
...
private var `_folder-simple-lock-bold`: ImageVector? = null
