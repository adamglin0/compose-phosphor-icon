...
public val DuotoneGroup.`Brackets-round-duotone`: ImageVector
    get() {
        if (`_brackets-round-duotone` != null) {
            return `_brackets-round-duotone`!!
        }
        `_brackets-round-duotone` = Builder(name = "Brackets-round-duotone", defaultWidth =
...
private var `_brackets-round-duotone`: ImageVector? = null
