...
public val ThinGroup.`Person-simple-run-thin`: ImageVector
    get() {
        if (`_person-simple-run-thin` != null) {
            return `_person-simple-run-thin`!!
        }
        `_person-simple-run-thin` = Builder(name = "Person-simple-run-thin", defaultWidth =
...
private var `_person-simple-run-thin`: ImageVector? = null
