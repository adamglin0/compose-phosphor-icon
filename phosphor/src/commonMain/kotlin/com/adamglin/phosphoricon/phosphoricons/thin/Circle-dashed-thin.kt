...
public val ThinGroup.`Circle-dashed-thin`: ImageVector
    get() {
        if (`_circle-dashed-thin` != null) {
            return `_circle-dashed-thin`!!
        }
        `_circle-dashed-thin` = Builder(name = "Circle-dashed-thin", defaultWidth = 256.0.dp,
...
private var `_circle-dashed-thin`: ImageVector? = null
