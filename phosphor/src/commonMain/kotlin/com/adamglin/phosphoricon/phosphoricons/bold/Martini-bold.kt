...
public val BoldGroup.`Martini-bold`: ImageVector
    get() {
        if (`_martini-bold` != null) {
            return `_martini-bold`!!
        }
        `_martini-bold` = Builder(name = "Martini-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_martini-bold`: ImageVector? = null
