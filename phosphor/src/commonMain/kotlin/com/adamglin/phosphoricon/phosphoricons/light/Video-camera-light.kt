...
public val LightGroup.`Video-camera-light`: ImageVector
    get() {
        if (`_video-camera-light` != null) {
            return `_video-camera-light`!!
        }
        `_video-camera-light` = Builder(name = "Video-camera-light", defaultWidth = 256.0.dp,
...
private var `_video-camera-light`: ImageVector? = null
