...
public val LightGroup.`Linux-logo-light`: ImageVector
    get() {
        if (`_linux-logo-light` != null) {
            return `_linux-logo-light`!!
        }
        `_linux-logo-light` = Builder(name = "Linux-logo-light", defaultWidth = 256.0.dp,
...
private var `_linux-logo-light`: ImageVector? = null
