...
public val FillGroup.`Shuffle-angular-fill`: ImageVector
    get() {
        if (`_shuffle-angular-fill` != null) {
            return `_shuffle-angular-fill`!!
        }
        `_shuffle-angular-fill` = Builder(name = "Shuffle-angular-fill", defaultWidth = 256.0.dp,
...
private var `_shuffle-angular-fill`: ImageVector? = null
