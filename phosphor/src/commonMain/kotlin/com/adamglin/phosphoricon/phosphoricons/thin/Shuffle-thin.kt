...
public val ThinGroup.`Shuffle-thin`: ImageVector
    get() {
        if (`_shuffle-thin` != null) {
            return `_shuffle-thin`!!
        }
        `_shuffle-thin` = Builder(name = "Shuffle-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shuffle-thin`: ImageVector? = null
