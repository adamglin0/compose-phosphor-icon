...
public val LightGroup.`Medal-military-light`: ImageVector
    get() {
        if (`_medal-military-light` != null) {
            return `_medal-military-light`!!
        }
        `_medal-military-light` = Builder(name = "Medal-military-light", defaultWidth = 256.0.dp,
...
private var `_medal-military-light`: ImageVector? = null
