...
public val ThinGroup.`Crop-thin`: ImageVector
    get() {
        if (`_crop-thin` != null) {
            return `_crop-thin`!!
        }
        `_crop-thin` = Builder(name = "Crop-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_crop-thin`: ImageVector? = null
