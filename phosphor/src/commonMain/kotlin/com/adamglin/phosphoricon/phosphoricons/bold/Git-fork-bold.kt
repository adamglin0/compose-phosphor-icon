...
public val BoldGroup.`Git-fork-bold`: ImageVector
    get() {
        if (`_git-fork-bold` != null) {
            return `_git-fork-bold`!!
        }
        `_git-fork-bold` = Builder(name = "Git-fork-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_git-fork-bold`: ImageVector? = null
