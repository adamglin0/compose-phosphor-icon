...
public val BoldGroup.`Spiral-bold`: ImageVector
    get() {
        if (`_spiral-bold` != null) {
            return `_spiral-bold`!!
        }
        `_spiral-bold` = Builder(name = "Spiral-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spiral-bold`: ImageVector? = null
