...
public val LightGroup.`Apple-podcasts-logo-light`: ImageVector
    get() {
        if (`_apple-podcasts-logo-light` != null) {
            return `_apple-podcasts-logo-light`!!
        }
        `_apple-podcasts-logo-light` = Builder(name = "Apple-podcasts-logo-light", defaultWidth =
...
private var `_apple-podcasts-logo-light`: ImageVector? = null
