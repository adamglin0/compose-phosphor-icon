...
public val DuotoneGroup.`Bookmarks-simple-duotone`: ImageVector
    get() {
        if (`_bookmarks-simple-duotone` != null) {
            return `_bookmarks-simple-duotone`!!
        }
        `_bookmarks-simple-duotone` = Builder(name = "Bookmarks-simple-duotone", defaultWidth =
...
private var `_bookmarks-simple-duotone`: ImageVector? = null
