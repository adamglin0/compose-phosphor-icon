...
public val LightGroup.`Not-equals-light`: ImageVector
    get() {
        if (`_not-equals-light` != null) {
            return `_not-equals-light`!!
        }
        `_not-equals-light` = Builder(name = "Not-equals-light", defaultWidth = 256.0.dp,
...
private var `_not-equals-light`: ImageVector? = null
