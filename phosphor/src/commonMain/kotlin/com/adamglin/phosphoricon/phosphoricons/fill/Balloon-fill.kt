...
public val FillGroup.`Balloon-fill`: ImageVector
    get() {
        if (`_balloon-fill` != null) {
            return `_balloon-fill`!!
        }
        `_balloon-fill` = Builder(name = "Balloon-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_balloon-fill`: ImageVector? = null
