...
public val BoldGroup.`Toilet-paper-bold`: ImageVector
    get() {
        if (`_toilet-paper-bold` != null) {
            return `_toilet-paper-bold`!!
        }
        `_toilet-paper-bold` = Builder(name = "Toilet-paper-bold", defaultWidth = 256.0.dp,
...
private var `_toilet-paper-bold`: ImageVector? = null
