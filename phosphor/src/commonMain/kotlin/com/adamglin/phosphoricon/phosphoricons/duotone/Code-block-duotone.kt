...
public val DuotoneGroup.`Code-block-duotone`: ImageVector
    get() {
        if (`_code-block-duotone` != null) {
            return `_code-block-duotone`!!
        }
        `_code-block-duotone` = Builder(name = "Code-block-duotone", defaultWidth = 256.0.dp,
...
private var `_code-block-duotone`: ImageVector? = null
