...
public val ThinGroup.`Phone-call-thin`: ImageVector
    get() {
        if (`_phone-call-thin` != null) {
            return `_phone-call-thin`!!
        }
        `_phone-call-thin` = Builder(name = "Phone-call-thin", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(148.14f, 47.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 153.0f, 44.13f)
                arcTo(82.24f, 82.24f, 0.0f, false, true, 211.86f, 103.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -2.83f, 4.89f)
                arcToRelative(3.65f, 3.65f, 0.0f, false, true, -1.0f, 0.14f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -3.86f, -3.0f)
                arcTo(74.35f, 74.35f, 0.0f, false, false, 151.0f, 51.86f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 148.14f, 47.0f)
                close()
                moveTo(143.0f, 83.86f)
                curveTo(158.0f, 87.89f, 168.11f, 98.0f, 172.14f, 113.0f)
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, false, 143.0f, 83.86f)
                close()
                moveTo(219.94f, 182.58f)
...
private var `_phone-call-thin`: ImageVector? = null
