...
public val BoldGroup.`Coin-vertical-bold`: ImageVector
    get() {
        if (`_coin-vertical-bold` != null) {
            return `_coin-vertical-bold`!!
        }
        `_coin-vertical-bold` = Builder(name = "Coin-vertical-bold", defaultWidth = 256.0.dp,
...
private var `_coin-vertical-bold`: ImageVector? = null
