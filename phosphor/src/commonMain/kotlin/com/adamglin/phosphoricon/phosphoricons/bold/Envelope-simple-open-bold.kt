...
public val BoldGroup.`Envelope-simple-open-bold`: ImageVector
    get() {
        if (`_envelope-simple-open-bold` != null) {
            return `_envelope-simple-open-bold`!!
        }
        `_envelope-simple-open-bold` = Builder(name = "Envelope-simple-open-bold", defaultWidth =
...
private var `_envelope-simple-open-bold`: ImageVector? = null
