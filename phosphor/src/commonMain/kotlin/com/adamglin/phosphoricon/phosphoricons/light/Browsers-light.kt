...
public val LightGroup.`Browsers-light`: ImageVector
    get() {
        if (`_browsers-light` != null) {
            return `_browsers-light`!!
        }
        `_browsers-light` = Builder(name = "Browsers-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_browsers-light`: ImageVector? = null
