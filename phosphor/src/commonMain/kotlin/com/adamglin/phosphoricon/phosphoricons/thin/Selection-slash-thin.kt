...
public val ThinGroup.`Selection-slash-thin`: ImageVector
    get() {
        if (`_selection-slash-thin` != null) {
            return `_selection-slash-thin`!!
        }
        `_selection-slash-thin` = Builder(name = "Selection-slash-thin", defaultWidth = 256.0.dp,
...
private var `_selection-slash-thin`: ImageVector? = null
