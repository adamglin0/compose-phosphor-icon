...
public val BoldGroup.`Sticker-bold`: ImageVector
    get() {
        if (`_sticker-bold` != null) {
            return `_sticker-bold`!!
        }
        `_sticker-bold` = Builder(name = "Sticker-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sticker-bold`: ImageVector? = null
