...
public val ThinGroup.`Number-square-six-thin`: ImageVector
    get() {
        if (`_number-square-six-thin` != null) {
            return `_number-square-six-thin`!!
        }
        `_number-square-six-thin` = Builder(name = "Number-square-six-thin", defaultWidth =
...
private var `_number-square-six-thin`: ImageVector? = null
