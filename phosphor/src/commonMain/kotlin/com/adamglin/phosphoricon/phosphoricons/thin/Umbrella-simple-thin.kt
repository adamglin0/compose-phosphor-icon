...
public val ThinGroup.`Umbrella-simple-thin`: ImageVector
    get() {
        if (`_umbrella-simple-thin` != null) {
            return `_umbrella-simple-thin`!!
        }
        `_umbrella-simple-thin` = Builder(name = "Umbrella-simple-thin", defaultWidth = 256.0.dp,
...
private var `_umbrella-simple-thin`: ImageVector? = null
