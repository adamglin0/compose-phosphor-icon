...
public val ThinGroup.`Shipping-container-thin`: ImageVector
    get() {
        if (`_shipping-container-thin` != null) {
            return `_shipping-container-thin`!!
        }
        `_shipping-container-thin` = Builder(name = "Shipping-container-thin", defaultWidth =
...
private var `_shipping-container-thin`: ImageVector? = null
