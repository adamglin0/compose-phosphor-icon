...
public val LightGroup.`Device-rotate-light`: ImageVector
    get() {
        if (`_device-rotate-light` != null) {
            return `_device-rotate-light`!!
        }
        `_device-rotate-light` = Builder(name = "Device-rotate-light", defaultWidth = 256.0.dp,
...
private var `_device-rotate-light`: ImageVector? = null
