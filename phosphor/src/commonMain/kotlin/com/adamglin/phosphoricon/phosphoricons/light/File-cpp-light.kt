...
public val LightGroup.`File-cpp-light`: ImageVector
    get() {
        if (`_file-cpp-light` != null) {
            return `_file-cpp-light`!!
        }
        `_file-cpp-light` = Builder(name = "File-cpp-light", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(202.0f, 174.0f)
                lineTo(202.0f, 160.0f)
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -12.0f, 0.0f)
                verticalLineToRelative(14.0f)
...
private var `_file-cpp-light`: ImageVector? = null
