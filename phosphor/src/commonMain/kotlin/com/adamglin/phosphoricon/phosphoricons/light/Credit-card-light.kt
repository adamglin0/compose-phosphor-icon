...
public val LightGroup.`Credit-card-light`: ImageVector
    get() {
        if (`_credit-card-light` != null) {
            return `_credit-card-light`!!
        }
        `_credit-card-light` = Builder(name = "Credit-card-light", defaultWidth = 256.0.dp,
...
private var `_credit-card-light`: ImageVector? = null
