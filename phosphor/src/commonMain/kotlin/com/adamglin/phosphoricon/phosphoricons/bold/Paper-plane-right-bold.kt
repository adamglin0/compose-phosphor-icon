...
public val BoldGroup.`Paper-plane-right-bold`: ImageVector
    get() {
        if (`_paper-plane-right-bold` != null) {
            return `_paper-plane-right-bold`!!
        }
        `_paper-plane-right-bold` = Builder(name = "Paper-plane-right-bold", defaultWidth =
...
private var `_paper-plane-right-bold`: ImageVector? = null
