...
public val BoldGroup.`Umbrella-bold`: ImageVector
    get() {
        if (`_umbrella-bold` != null) {
            return `_umbrella-bold`!!
        }
        `_umbrella-bold` = Builder(name = "Umbrella-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_umbrella-bold`: ImageVector? = null
