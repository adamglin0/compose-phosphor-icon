...
public val FillGroup.`Radioactive-fill`: ImageVector
    get() {
        if (`_radioactive-fill` != null) {
            return `_radioactive-fill`!!
        }
        `_radioactive-fill` = Builder(name = "Radioactive-fill", defaultWidth = 256.0.dp,
...
private var `_radioactive-fill`: ImageVector? = null
