...
public val ThinGroup.`Lock-key-thin`: ImageVector
    get() {
        if (`_lock-key-thin` != null) {
            return `_lock-key-thin`!!
        }
        `_lock-key-thin` = Builder(name = "Lock-key-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-key-thin`: ImageVector? = null
