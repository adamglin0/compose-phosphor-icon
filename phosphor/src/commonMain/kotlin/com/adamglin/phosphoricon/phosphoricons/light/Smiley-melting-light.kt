...
public val LightGroup.`Smiley-melting-light`: ImageVector
    get() {
        if (`_smiley-melting-light` != null) {
            return `_smiley-melting-light`!!
        }
        `_smiley-melting-light` = Builder(name = "Smiley-melting-light", defaultWidth = 256.0.dp,
...
private var `_smiley-melting-light`: ImageVector? = null
