...
public val BoldGroup.`Database-bold`: ImageVector
    get() {
        if (`_database-bold` != null) {
            return `_database-bold`!!
        }
        `_database-bold` = Builder(name = "Database-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_database-bold`: ImageVector? = null
