...
public val ThinGroup.`Number-circle-six-thin`: ImageVector
    get() {
        if (`_number-circle-six-thin` != null) {
            return `_number-circle-six-thin`!!
        }
        `_number-circle-six-thin` = Builder(name = "Number-circle-six-thin", defaultWidth =
...
private var `_number-circle-six-thin`: ImageVector? = null
