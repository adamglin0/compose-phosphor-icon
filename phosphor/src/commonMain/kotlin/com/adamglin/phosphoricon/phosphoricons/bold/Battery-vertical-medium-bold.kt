...
public val BoldGroup.`Battery-vertical-medium-bold`: ImageVector
    get() {
        if (`_battery-vertical-medium-bold` != null) {
            return `_battery-vertical-medium-bold`!!
        }
        `_battery-vertical-medium-bold` = Builder(name = "Battery-vertical-medium-bold",
...
private var `_battery-vertical-medium-bold`: ImageVector? = null
