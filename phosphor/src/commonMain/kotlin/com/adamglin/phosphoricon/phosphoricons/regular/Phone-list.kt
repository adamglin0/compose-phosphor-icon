...
public val RegularGroup.`Phone-list`: ImageVector
    get() {
        if (`_phone-list` != null) {
            return `_phone-list`!!
        }
        `_phone-list` = Builder(name = "Phone-list", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-list`: ImageVector? = null
