...
public val ThinGroup.`Smiley-wink-thin`: ImageVector
    get() {
        if (`_smiley-wink-thin` != null) {
            return `_smiley-wink-thin`!!
        }
        `_smiley-wink-thin` = Builder(name = "Smiley-wink-thin", defaultWidth = 256.0.dp,
...
private var `_smiley-wink-thin`: ImageVector? = null
