...
public val RegularGroup.`Sun-dim`: ImageVector
    get() {
        if (`_sun-dim` != null) {
            return `_sun-dim`!!
        }
        `_sun-dim` = Builder(name = "Sun-dim", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_sun-dim`: ImageVector? = null
