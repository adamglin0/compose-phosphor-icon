...
public val FillGroup.`Hoodie-fill`: ImageVector
    get() {
        if (`_hoodie-fill` != null) {
            return `_hoodie-fill`!!
        }
        `_hoodie-fill` = Builder(name = "Hoodie-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hoodie-fill`: ImageVector? = null
