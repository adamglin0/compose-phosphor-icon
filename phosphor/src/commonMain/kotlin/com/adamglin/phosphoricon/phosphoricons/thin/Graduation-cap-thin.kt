...
public val ThinGroup.`Graduation-cap-thin`: ImageVector
    get() {
        if (`_graduation-cap-thin` != null) {
            return `_graduation-cap-thin`!!
        }
        `_graduation-cap-thin` = Builder(name = "Graduation-cap-thin", defaultWidth = 256.0.dp,
...
private var `_graduation-cap-thin`: ImageVector? = null
