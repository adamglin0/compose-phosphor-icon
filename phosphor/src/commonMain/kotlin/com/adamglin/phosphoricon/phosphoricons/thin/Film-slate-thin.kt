...
public val ThinGroup.`Film-slate-thin`: ImageVector
    get() {
        if (`_film-slate-thin` != null) {
            return `_film-slate-thin`!!
        }
        `_film-slate-thin` = Builder(name = "Film-slate-thin", defaultWidth = 256.0.dp,
...
private var `_film-slate-thin`: ImageVector? = null
