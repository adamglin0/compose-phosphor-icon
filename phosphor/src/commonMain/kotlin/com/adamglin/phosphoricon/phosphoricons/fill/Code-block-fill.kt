...
public val FillGroup.`Code-block-fill`: ImageVector
    get() {
        if (`_code-block-fill` != null) {
            return `_code-block-fill`!!
        }
        `_code-block-fill` = Builder(name = "Code-block-fill", defaultWidth = 256.0.dp,
...
private var `_code-block-fill`: ImageVector? = null
