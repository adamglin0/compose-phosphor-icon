...
public val FillGroup.`Numpad-fill`: ImageVector
    get() {
        if (`_numpad-fill` != null) {
            return `_numpad-fill`!!
        }
        `_numpad-fill` = Builder(name = "Numpad-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_numpad-fill`: ImageVector? = null
