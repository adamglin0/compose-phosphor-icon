...
public val RegularGroup.`Flower-tulip`: ImageVector
    get() {
        if (`_flower-tulip` != null) {
            return `_flower-tulip`!!
        }
        `_flower-tulip` = Builder(name = "Flower-tulip", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flower-tulip`: ImageVector? = null
