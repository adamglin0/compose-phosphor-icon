...
public val RegularGroup.`Call-bell`: ImageVector
    get() {
        if (`_call-bell` != null) {
            return `_call-bell`!!
        }
        `_call-bell` = Builder(name = "Call-bell", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_call-bell`: ImageVector? = null
