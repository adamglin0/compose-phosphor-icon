...
public val ThinGroup.`Pentagon-thin`: ImageVector
    get() {
        if (`_pentagon-thin` != null) {
            return `_pentagon-thin`!!
        }
        `_pentagon-thin` = Builder(name = "Pentagon-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pentagon-thin`: ImageVector? = null
