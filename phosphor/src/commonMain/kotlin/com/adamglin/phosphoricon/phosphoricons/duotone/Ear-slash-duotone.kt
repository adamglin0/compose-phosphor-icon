...
public val DuotoneGroup.`Ear-slash-duotone`: ImageVector
    get() {
        if (`_ear-slash-duotone` != null) {
            return `_ear-slash-duotone`!!
        }
        `_ear-slash-duotone` = Builder(name = "Ear-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_ear-slash-duotone`: ImageVector? = null
