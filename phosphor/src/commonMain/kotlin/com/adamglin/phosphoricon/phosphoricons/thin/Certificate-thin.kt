...
public val ThinGroup.`Certificate-thin`: ImageVector
    get() {
        if (`_certificate-thin` != null) {
            return `_certificate-thin`!!
        }
        `_certificate-thin` = Builder(name = "Certificate-thin", defaultWidth = 256.0.dp,
...
private var `_certificate-thin`: ImageVector? = null
