...
public val DuotoneGroup.`Link-simple-duotone`: ImageVector
    get() {
        if (`_link-simple-duotone` != null) {
            return `_link-simple-duotone`!!
        }
        `_link-simple-duotone` = Builder(name = "Link-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_link-simple-duotone`: ImageVector? = null
