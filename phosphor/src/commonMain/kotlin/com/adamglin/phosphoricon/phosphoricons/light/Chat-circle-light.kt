...
public val LightGroup.`Chat-circle-light`: ImageVector
    get() {
        if (`_chat-circle-light` != null) {
            return `_chat-circle-light`!!
        }
        `_chat-circle-light` = Builder(name = "Chat-circle-light", defaultWidth = 256.0.dp,
...
private var `_chat-circle-light`: ImageVector? = null
