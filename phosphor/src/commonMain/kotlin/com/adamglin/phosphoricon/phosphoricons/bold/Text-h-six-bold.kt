...
public val BoldGroup.`Text-h-six-bold`: ImageVector
    get() {
        if (`_text-h-six-bold` != null) {
            return `_text-h-six-bold`!!
        }
        `_text-h-six-bold` = Builder(name = "Text-h-six-bold", defaultWidth = 256.0.dp,
...
private var `_text-h-six-bold`: ImageVector? = null
