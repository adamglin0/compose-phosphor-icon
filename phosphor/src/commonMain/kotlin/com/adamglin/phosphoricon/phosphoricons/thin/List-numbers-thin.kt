...
public val ThinGroup.`List-numbers-thin`: ImageVector
    get() {
        if (`_list-numbers-thin` != null) {
            return `_list-numbers-thin`!!
        }
        `_list-numbers-thin` = Builder(name = "List-numbers-thin", defaultWidth = 256.0.dp,
...
private var `_list-numbers-thin`: ImageVector? = null
