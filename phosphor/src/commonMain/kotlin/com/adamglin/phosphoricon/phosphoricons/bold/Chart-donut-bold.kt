...
public val BoldGroup.`Chart-donut-bold`: ImageVector
    get() {
        if (`_chart-donut-bold` != null) {
            return `_chart-donut-bold`!!
        }
        `_chart-donut-bold` = Builder(name = "Chart-donut-bold", defaultWidth = 256.0.dp,
...
private var `_chart-donut-bold`: ImageVector? = null
