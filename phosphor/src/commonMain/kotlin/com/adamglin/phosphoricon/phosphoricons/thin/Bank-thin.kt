...
public val ThinGroup.`Bank-thin`: ImageVector
    get() {
        if (`_bank-thin` != null) {
            return `_bank-thin`!!
        }
        `_bank-thin` = Builder(name = "Bank-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bank-thin`: ImageVector? = null
