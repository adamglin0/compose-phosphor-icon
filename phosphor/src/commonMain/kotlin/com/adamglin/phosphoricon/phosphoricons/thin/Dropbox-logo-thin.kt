...
public val ThinGroup.`Dropbox-logo-thin`: ImageVector
    get() {
        if (`_dropbox-logo-thin` != null) {
            return `_dropbox-logo-thin`!!
        }
        `_dropbox-logo-thin` = Builder(name = "Dropbox-logo-thin", defaultWidth = 256.0.dp,
...
private var `_dropbox-logo-thin`: ImageVector? = null
