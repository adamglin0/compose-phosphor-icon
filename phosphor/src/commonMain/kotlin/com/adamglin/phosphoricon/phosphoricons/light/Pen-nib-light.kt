...
public val LightGroup.`Pen-nib-light`: ImageVector
    get() {
        if (`_pen-nib-light` != null) {
            return `_pen-nib-light`!!
        }
        `_pen-nib-light` = Builder(name = "Pen-nib-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pen-nib-light`: ImageVector? = null
