...
public val FillGroup.`Rss-simple-fill`: ImageVector
    get() {
        if (`_rss-simple-fill` != null) {
            return `_rss-simple-fill`!!
        }
        `_rss-simple-fill` = Builder(name = "Rss-simple-fill", defaultWidth = 256.0.dp,
...
private var `_rss-simple-fill`: ImageVector? = null
