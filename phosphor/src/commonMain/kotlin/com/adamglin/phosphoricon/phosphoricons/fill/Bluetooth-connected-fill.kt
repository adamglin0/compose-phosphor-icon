...
public val FillGroup.`Bluetooth-connected-fill`: ImageVector
    get() {
        if (`_bluetooth-connected-fill` != null) {
            return `_bluetooth-connected-fill`!!
        }
        `_bluetooth-connected-fill` = Builder(name = "Bluetooth-connected-fill", defaultWidth =
...
private var `_bluetooth-connected-fill`: ImageVector? = null
