...
public val FillGroup.`Seal-fill`: ImageVector
    get() {
        if (`_seal-fill` != null) {
            return `_seal-fill`!!
        }
        `_seal-fill` = Builder(name = "Seal-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seal-fill`: ImageVector? = null
