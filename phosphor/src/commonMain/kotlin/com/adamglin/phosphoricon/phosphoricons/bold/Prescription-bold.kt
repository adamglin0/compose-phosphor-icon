...
public val BoldGroup.`Prescription-bold`: ImageVector
    get() {
        if (`_prescription-bold` != null) {
            return `_prescription-bold`!!
        }
        `_prescription-bold` = Builder(name = "Prescription-bold", defaultWidth = 256.0.dp,
...
private var `_prescription-bold`: ImageVector? = null
