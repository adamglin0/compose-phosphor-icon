...
public val BoldGroup.`Barn-bold`: ImageVector
    get() {
        if (`_barn-bold` != null) {
            return `_barn-bold`!!
        }
        `_barn-bold` = Builder(name = "Barn-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barn-bold`: ImageVector? = null
