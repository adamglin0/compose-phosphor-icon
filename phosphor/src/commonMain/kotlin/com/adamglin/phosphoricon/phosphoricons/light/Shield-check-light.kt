...
public val LightGroup.`Shield-check-light`: ImageVector
    get() {
        if (`_shield-check-light` != null) {
            return `_shield-check-light`!!
        }
        `_shield-check-light` = Builder(name = "Shield-check-light", defaultWidth = 256.0.dp,
...
private var `_shield-check-light`: ImageVector? = null
