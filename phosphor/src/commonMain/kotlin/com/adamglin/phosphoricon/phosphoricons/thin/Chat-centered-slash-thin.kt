...
public val ThinGroup.`Chat-centered-slash-thin`: ImageVector
    get() {
        if (`_chat-centered-slash-thin` != null) {
            return `_chat-centered-slash-thin`!!
        }
        `_chat-centered-slash-thin` = Builder(name = "Chat-centered-slash-thin", defaultWidth =
...
private var `_chat-centered-slash-thin`: ImageVector? = null
