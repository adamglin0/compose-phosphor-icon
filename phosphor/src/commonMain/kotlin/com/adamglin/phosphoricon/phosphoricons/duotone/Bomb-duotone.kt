...
public val DuotoneGroup.`Bomb-duotone`: ImageVector
    get() {
        if (`_bomb-duotone` != null) {
            return `_bomb-duotone`!!
        }
        `_bomb-duotone` = Builder(name = "Bomb-duotone", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(192.0f, 160.0f)
                arcTo(80.0f, 80.0f, 0.0f, true, true, 80.0f, 86.66f)
                verticalLineTo(72.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f)
                horizontalLineToRelative(48.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, 8.0f)
                verticalLineTo(86.66f)
                arcTo(80.0f, 80.0f, 0.0f, false, true, 192.0f, 160.0f)
                close()
            }
...
private var `_bomb-duotone`: ImageVector? = null
