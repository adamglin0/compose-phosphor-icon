...
public val ThinGroup.`Finn-the-human-thin`: ImageVector
    get() {
        if (`_finn-the-human-thin` != null) {
            return `_finn-the-human-thin`!!
        }
        `_finn-the-human-thin` = Builder(name = "Finn-the-human-thin", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(36.0f, 36.0f, 0.0f, false, false, 36.0f, -36.0f)
                verticalLineToRelative(-8.0f)
                arcTo(36.0f, 36.0f, 0.0f, false, false, 168.0f, 108.0f)
                close()
...
private var `_finn-the-human-thin`: ImageVector? = null
