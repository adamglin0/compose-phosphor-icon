...
public val BoldGroup.`Person-simple-swim-bold`: ImageVector
    get() {
        if (`_person-simple-swim-bold` != null) {
            return `_person-simple-swim-bold`!!
        }
        `_person-simple-swim-bold` = Builder(name = "Person-simple-swim-bold", defaultWidth =
...
private var `_person-simple-swim-bold`: ImageVector? = null
