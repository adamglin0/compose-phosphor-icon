...
public val DuotoneGroup.`Fish-simple-duotone`: ImageVector
    get() {
        if (`_fish-simple-duotone` != null) {
            return `_fish-simple-duotone`!!
        }
        `_fish-simple-duotone` = Builder(name = "Fish-simple-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(202.43f, 151.85f)
                curveToRelative(-21.26f, 28.17f, -62.09f, 48.24f, -138.35f, 40.0f)
                curveTo(55.89f, 115.64f, 76.0f, 74.82f, 104.15f, 53.57f)
                arcTo(104.0f, 104.0f, 0.0f, false, false, 202.43f, 151.85f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(115.0f, 35.76f, 140.12f, 23.64f, 179.27f, 24.0f)
...
private var `_fish-simple-duotone`: ImageVector? = null
