...
public val ThinGroup.`Info-thin`: ImageVector
    get() {
        if (`_info-thin` != null) {
            return `_info-thin`!!
        }
        `_info-thin` = Builder(name = "Info-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_info-thin`: ImageVector? = null
