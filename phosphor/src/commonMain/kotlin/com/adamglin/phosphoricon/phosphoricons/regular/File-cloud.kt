...
public val RegularGroup.`File-cloud`: ImageVector
    get() {
        if (`_file-cloud` != null) {
            return `_file-cloud`!!
        }
        `_file-cloud` = Builder(name = "File-cloud", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-cloud`: ImageVector? = null
