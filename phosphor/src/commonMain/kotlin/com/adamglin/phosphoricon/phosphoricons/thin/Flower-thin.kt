...
public val ThinGroup.`Flower-thin`: ImageVector
    get() {
        if (`_flower-thin` != null) {
            return `_flower-thin`!!
        }
        `_flower-thin` = Builder(name = "Flower-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flower-thin`: ImageVector? = null
