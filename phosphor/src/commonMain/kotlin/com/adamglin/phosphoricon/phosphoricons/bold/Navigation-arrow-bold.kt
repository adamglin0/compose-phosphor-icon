...
public val BoldGroup.`Navigation-arrow-bold`: ImageVector
    get() {
        if (`_navigation-arrow-bold` != null) {
            return `_navigation-arrow-bold`!!
        }
        `_navigation-arrow-bold` = Builder(name = "Navigation-arrow-bold", defaultWidth = 256.0.dp,
...
private var `_navigation-arrow-bold`: ImageVector? = null
