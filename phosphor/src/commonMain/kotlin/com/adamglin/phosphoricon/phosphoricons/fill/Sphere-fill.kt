...
public val FillGroup.`Sphere-fill`: ImageVector
    get() {
        if (`_sphere-fill` != null) {
            return `_sphere-fill`!!
        }
        `_sphere-fill` = Builder(name = "Sphere-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sphere-fill`: ImageVector? = null
