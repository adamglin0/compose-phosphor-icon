...
public val RegularGroup.`User-circle-check`: ImageVector
    get() {
        if (`_user-circle-check` != null) {
            return `_user-circle-check`!!
        }
        `_user-circle-check` = Builder(name = "User-circle-check", defaultWidth = 256.0.dp,
...
private var `_user-circle-check`: ImageVector? = null
