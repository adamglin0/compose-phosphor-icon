...
public val DuotoneGroup.`Confetti-duotone`: ImageVector
    get() {
        if (`_confetti-duotone` != null) {
            return `_confetti-duotone`!!
        }
        `_confetti-duotone` = Builder(name = "Confetti-duotone", defaultWidth = 256.0.dp,
...
private var `_confetti-duotone`: ImageVector? = null
