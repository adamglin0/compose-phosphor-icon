...
public val FillGroup.`Arrows-out-cardinal-fill`: ImageVector
    get() {
        if (`_arrows-out-cardinal-fill` != null) {
            return `_arrows-out-cardinal-fill`!!
        }
        `_arrows-out-cardinal-fill` = Builder(name = "Arrows-out-cardinal-fill", defaultWidth =
...
private var `_arrows-out-cardinal-fill`: ImageVector? = null
