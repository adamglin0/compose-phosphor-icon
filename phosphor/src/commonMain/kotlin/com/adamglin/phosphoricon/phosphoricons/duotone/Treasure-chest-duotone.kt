...
public val DuotoneGroup.`Treasure-chest-duotone`: ImageVector
    get() {
        if (`_treasure-chest-duotone` != null) {
            return `_treasure-chest-duotone`!!
        }
        `_treasure-chest-duotone` = Builder(name = "Treasure-chest-duotone", defaultWidth =
...
private var `_treasure-chest-duotone`: ImageVector? = null
