...
public val RegularGroup.`Google-drive-logo`: ImageVector
    get() {
        if (`_google-drive-logo` != null) {
            return `_google-drive-logo`!!
        }
        `_google-drive-logo` = Builder(name = "Google-drive-logo", defaultWidth = 256.0.dp,
...
private var `_google-drive-logo`: ImageVector? = null
