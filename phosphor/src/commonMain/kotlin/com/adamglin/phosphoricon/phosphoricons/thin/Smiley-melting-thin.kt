...
public val ThinGroup.`Smiley-melting-thin`: ImageVector
    get() {
        if (`_smiley-melting-thin` != null) {
            return `_smiley-melting-thin`!!
        }
        `_smiley-melting-thin` = Builder(name = "Smiley-melting-thin", defaultWidth = 256.0.dp,
...
private var `_smiley-melting-thin`: ImageVector? = null
