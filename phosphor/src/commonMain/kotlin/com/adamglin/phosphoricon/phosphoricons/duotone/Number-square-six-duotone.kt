...
public val DuotoneGroup.`Number-square-six-duotone`: ImageVector
    get() {
        if (`_number-square-six-duotone` != null) {
            return `_number-square-six-duotone`!!
        }
        `_number-square-six-duotone` = Builder(name = "Number-square-six-duotone", defaultWidth =
...
private var `_number-square-six-duotone`: ImageVector? = null
