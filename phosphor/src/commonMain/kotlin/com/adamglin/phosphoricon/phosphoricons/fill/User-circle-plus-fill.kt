...
public val FillGroup.`User-circle-plus-fill`: ImageVector
    get() {
        if (`_user-circle-plus-fill` != null) {
            return `_user-circle-plus-fill`!!
        }
        `_user-circle-plus-fill` = Builder(name = "User-circle-plus-fill", defaultWidth = 256.0.dp,
...
private var `_user-circle-plus-fill`: ImageVector? = null
