...
public val DuotoneGroup.`Text-h-two-duotone`: ImageVector
    get() {
        if (`_text-h-two-duotone` != null) {
            return `_text-h-two-duotone`!!
        }
        `_text-h-two-duotone` = Builder(name = "Text-h-two-duotone", defaultWidth = 256.0.dp,
...
private var `_text-h-two-duotone`: ImageVector? = null
