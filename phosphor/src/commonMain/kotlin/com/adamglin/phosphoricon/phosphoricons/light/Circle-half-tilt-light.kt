...
public val LightGroup.`Circle-half-tilt-light`: ImageVector
    get() {
        if (`_circle-half-tilt-light` != null) {
            return `_circle-half-tilt-light`!!
        }
        `_circle-half-tilt-light` = Builder(name = "Circle-half-tilt-light", defaultWidth =
...
private var `_circle-half-tilt-light`: ImageVector? = null
