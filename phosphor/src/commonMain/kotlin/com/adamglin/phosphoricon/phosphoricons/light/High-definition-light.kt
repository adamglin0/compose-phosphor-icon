...
public val LightGroup.`High-definition-light`: ImageVector
    get() {
        if (`_high-definition-light` != null) {
            return `_high-definition-light`!!
        }
        `_high-definition-light` = Builder(name = "High-definition-light", defaultWidth = 256.0.dp,
...
private var `_high-definition-light`: ImageVector? = null
