...
public val BoldGroup.`Stripe-logo-bold`: ImageVector
    get() {
        if (`_stripe-logo-bold` != null) {
            return `_stripe-logo-bold`!!
        }
        `_stripe-logo-bold` = Builder(name = "Stripe-logo-bold", defaultWidth = 256.0.dp,
...
private var `_stripe-logo-bold`: ImageVector? = null
