...
public val BoldGroup.`Hand-tap-bold`: ImageVector
    get() {
        if (`_hand-tap-bold` != null) {
            return `_hand-tap-bold`!!
        }
        `_hand-tap-bold` = Builder(name = "Hand-tap-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-tap-bold`: ImageVector? = null
