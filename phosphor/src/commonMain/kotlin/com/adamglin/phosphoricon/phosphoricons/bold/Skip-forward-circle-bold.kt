...
public val BoldGroup.`Skip-forward-circle-bold`: ImageVector
    get() {
        if (`_skip-forward-circle-bold` != null) {
            return `_skip-forward-circle-bold`!!
        }
        `_skip-forward-circle-bold` = Builder(name = "Skip-forward-circle-bold", defaultWidth =
...
private var `_skip-forward-circle-bold`: ImageVector? = null
