...
public val BoldGroup.`Star-of-david-bold`: ImageVector
    get() {
        if (`_star-of-david-bold` != null) {
            return `_star-of-david-bold`!!
        }
        `_star-of-david-bold` = Builder(name = "Star-of-david-bold", defaultWidth = 256.0.dp,
...
private var `_star-of-david-bold`: ImageVector? = null
