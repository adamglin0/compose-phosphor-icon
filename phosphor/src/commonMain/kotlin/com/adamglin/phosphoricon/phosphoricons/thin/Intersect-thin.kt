...
public val ThinGroup.`Intersect-thin`: ImageVector
    get() {
        if (`_intersect-thin` != null) {
            return `_intersect-thin`!!
        }
        `_intersect-thin` = Builder(name = "Intersect-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_intersect-thin`: ImageVector? = null
