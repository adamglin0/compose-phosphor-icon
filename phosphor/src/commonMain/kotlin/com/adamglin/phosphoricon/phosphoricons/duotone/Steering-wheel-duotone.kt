...
public val DuotoneGroup.`Steering-wheel-duotone`: ImageVector
    get() {
        if (`_steering-wheel-duotone` != null) {
            return `_steering-wheel-duotone`!!
        }
        `_steering-wheel-duotone` = Builder(name = "Steering-wheel-duotone", defaultWidth =
...
private var `_steering-wheel-duotone`: ImageVector? = null
