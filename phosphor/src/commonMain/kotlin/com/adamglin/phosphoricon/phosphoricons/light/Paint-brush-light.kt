...
public val LightGroup.`Paint-brush-light`: ImageVector
    get() {
        if (`_paint-brush-light` != null) {
            return `_paint-brush-light`!!
        }
        `_paint-brush-light` = Builder(name = "Paint-brush-light", defaultWidth = 256.0.dp,
...
private var `_paint-brush-light`: ImageVector? = null
