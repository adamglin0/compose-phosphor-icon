...
public val BoldGroup.`Bag-bold`: ImageVector
    get() {
        if (`_bag-bold` != null) {
            return `_bag-bold`!!
        }
        `_bag-bold` = Builder(name = "Bag-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_bag-bold`: ImageVector? = null
