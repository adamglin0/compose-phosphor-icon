...
public val ThinGroup.`Calendar-minus-thin`: ImageVector
    get() {
        if (`_calendar-minus-thin` != null) {
            return `_calendar-minus-thin`!!
        }
        `_calendar-minus-thin` = Builder(name = "Calendar-minus-thin", defaultWidth = 256.0.dp,
...
private var `_calendar-minus-thin`: ImageVector? = null
