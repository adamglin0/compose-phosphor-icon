...
public val BoldGroup.`User-circle-minus-bold`: ImageVector
    get() {
        if (`_user-circle-minus-bold` != null) {
            return `_user-circle-minus-bold`!!
        }
        `_user-circle-minus-bold` = Builder(name = "User-circle-minus-bold", defaultWidth =
...
private var `_user-circle-minus-bold`: ImageVector? = null
