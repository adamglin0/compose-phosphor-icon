...
public val FillGroup.`Lectern-fill`: ImageVector
    get() {
        if (`_lectern-fill` != null) {
            return `_lectern-fill`!!
        }
        `_lectern-fill` = Builder(name = "Lectern-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lectern-fill`: ImageVector? = null
