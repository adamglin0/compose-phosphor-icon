...
public val LightGroup.`Drop-simple-light`: ImageVector
    get() {
        if (`_drop-simple-light` != null) {
            return `_drop-simple-light`!!
        }
        `_drop-simple-light` = Builder(name = "Drop-simple-light", defaultWidth = 256.0.dp,
...
private var `_drop-simple-light`: ImageVector? = null
