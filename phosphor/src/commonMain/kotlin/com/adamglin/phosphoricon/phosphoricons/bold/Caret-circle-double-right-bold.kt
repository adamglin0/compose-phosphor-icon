...
public val BoldGroup.`Caret-circle-double-right-bold`: ImageVector
    get() {
        if (`_caret-circle-double-right-bold` != null) {
            return `_caret-circle-double-right-bold`!!
        }
        `_caret-circle-double-right-bold` = Builder(name = "Caret-circle-double-right-bold",
...
private var `_caret-circle-double-right-bold`: ImageVector? = null
