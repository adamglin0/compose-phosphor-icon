...
public val ThinGroup.`Heart-straight-break-thin`: ImageVector
    get() {
        if (`_heart-straight-break-thin` != null) {
            return `_heart-straight-break-thin`!!
        }
        `_heart-straight-break-thin` = Builder(name = "Heart-straight-break-thin", defaultWidth =
...
private var `_heart-straight-break-thin`: ImageVector? = null
