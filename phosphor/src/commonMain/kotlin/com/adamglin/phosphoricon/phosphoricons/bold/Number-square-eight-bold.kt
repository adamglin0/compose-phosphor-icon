...
public val BoldGroup.`Number-square-eight-bold`: ImageVector
    get() {
        if (`_number-square-eight-bold` != null) {
            return `_number-square-eight-bold`!!
        }
        `_number-square-eight-bold` = Builder(name = "Number-square-eight-bold", defaultWidth =
...
private var `_number-square-eight-bold`: ImageVector? = null
