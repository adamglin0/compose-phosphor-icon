...
public val DuotoneGroup.`List-checks-duotone`: ImageVector
    get() {
        if (`_list-checks-duotone` != null) {
            return `_list-checks-duotone`!!
        }
        `_list-checks-duotone` = Builder(name = "List-checks-duotone", defaultWidth = 256.0.dp,
...
private var `_list-checks-duotone`: ImageVector? = null
