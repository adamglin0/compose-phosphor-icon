...
public val RegularGroup.`Text-b`: ImageVector
    get() {
        if (`_text-b` != null) {
            return `_text-b`!!
        }
        `_text-b` = Builder(name = "Text-b", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_text-b`: ImageVector? = null
