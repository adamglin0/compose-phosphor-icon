...
public val ThinGroup.`Framer-logo-thin`: ImageVector
    get() {
        if (`_framer-logo-thin` != null) {
            return `_framer-logo-thin`!!
        }
        `_framer-logo-thin` = Builder(name = "Framer-logo-thin", defaultWidth = 256.0.dp,
...
private var `_framer-logo-thin`: ImageVector? = null
