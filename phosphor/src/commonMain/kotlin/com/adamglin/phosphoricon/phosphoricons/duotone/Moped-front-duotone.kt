...
public val DuotoneGroup.`Moped-front-duotone`: ImageVector
    get() {
        if (`_moped-front-duotone` != null) {
            return `_moped-front-duotone`!!
        }
        `_moped-front-duotone` = Builder(name = "Moped-front-duotone", defaultWidth = 256.0.dp,
...
private var `_moped-front-duotone`: ImageVector? = null
