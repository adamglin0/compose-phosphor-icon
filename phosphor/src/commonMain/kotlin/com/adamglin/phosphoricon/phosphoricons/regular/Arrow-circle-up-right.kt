...
public val RegularGroup.`Arrow-circle-up-right`: ImageVector
    get() {
        if (`_arrow-circle-up-right` != null) {
            return `_arrow-circle-up-right`!!
        }
        `_arrow-circle-up-right` = Builder(name = "Arrow-circle-up-right", defaultWidth = 256.0.dp,
...
private var `_arrow-circle-up-right`: ImageVector? = null
