...
public val ThinGroup.`Log-thin`: ImageVector
    get() {
        if (`_log-thin` != null) {
            return `_log-thin`!!
        }
        `_log-thin` = Builder(name = "Log-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_log-thin`: ImageVector? = null
