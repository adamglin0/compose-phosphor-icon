...
public val FillGroup.`Stack-simple-fill`: ImageVector
    get() {
        if (`_stack-simple-fill` != null) {
            return `_stack-simple-fill`!!
        }
        `_stack-simple-fill` = Builder(name = "Stack-simple-fill", defaultWidth = 256.0.dp,
...
private var `_stack-simple-fill`: ImageVector? = null
