...
public val ThinGroup.`Fire-simple-thin`: ImageVector
    get() {
        if (`_fire-simple-thin` != null) {
            return `_fire-simple-thin`!!
        }
        `_fire-simple-thin` = Builder(name = "Fire-simple-thin", defaultWidth = 256.0.dp,
...
private var `_fire-simple-thin`: ImageVector? = null
