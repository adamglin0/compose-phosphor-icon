...
public val ThinGroup.`Heart-break-thin`: ImageVector
    get() {
        if (`_heart-break-thin` != null) {
            return `_heart-break-thin`!!
        }
        `_heart-break-thin` = Builder(name = "Heart-break-thin", defaultWidth = 256.0.dp,
...
private var `_heart-break-thin`: ImageVector? = null
