...
public val ThinGroup.`Patreon-logo-thin`: ImageVector
    get() {
        if (`_patreon-logo-thin` != null) {
            return `_patreon-logo-thin`!!
        }
        `_patreon-logo-thin` = Builder(name = "Patreon-logo-thin", defaultWidth = 256.0.dp,
...
private var `_patreon-logo-thin`: ImageVector? = null
