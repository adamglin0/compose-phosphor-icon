...
public val ThinGroup.`List-bullets-thin`: ImageVector
    get() {
        if (`_list-bullets-thin` != null) {
            return `_list-bullets-thin`!!
        }
        `_list-bullets-thin` = Builder(name = "List-bullets-thin", defaultWidth = 256.0.dp,
...
private var `_list-bullets-thin`: ImageVector? = null
