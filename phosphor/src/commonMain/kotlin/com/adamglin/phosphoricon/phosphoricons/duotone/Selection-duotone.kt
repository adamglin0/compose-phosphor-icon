...
public val DuotoneGroup.`Selection-duotone`: ImageVector
    get() {
        if (`_selection-duotone` != null) {
            return `_selection-duotone`!!
        }
        `_selection-duotone` = Builder(name = "Selection-duotone", defaultWidth = 256.0.dp,
...
private var `_selection-duotone`: ImageVector? = null
