...
public val ThinGroup.`Phone-incoming-thin`: ImageVector
    get() {
        if (`_phone-incoming-thin` != null) {
            return `_phone-incoming-thin`!!
        }
        `_phone-incoming-thin` = Builder(name = "Phone-incoming-thin", defaultWidth = 256.0.dp,
...
private var `_phone-incoming-thin`: ImageVector? = null
