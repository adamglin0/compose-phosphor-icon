...
public val BoldGroup.`Polygon-bold`: ImageVector
    get() {
        if (`_polygon-bold` != null) {
            return `_polygon-bold`!!
        }
        `_polygon-bold` = Builder(name = "Polygon-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_polygon-bold`: ImageVector? = null
