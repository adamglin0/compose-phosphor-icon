...
public val LightGroup.`File-ppt-light`: ImageVector
    get() {
        if (`_file-ppt-light` != null) {
            return `_file-ppt-light`!!
        }
        `_file-ppt-light` = Builder(name = "File-ppt-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-ppt-light`: ImageVector? = null
