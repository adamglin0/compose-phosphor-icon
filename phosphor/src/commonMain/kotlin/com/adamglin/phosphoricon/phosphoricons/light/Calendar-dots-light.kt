...
public val LightGroup.`Calendar-dots-light`: ImageVector
    get() {
        if (`_calendar-dots-light` != null) {
            return `_calendar-dots-light`!!
        }
        `_calendar-dots-light` = Builder(name = "Calendar-dots-light", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(10.0f, 10.0f, 0.0f, false, true, 138.0f, 132.0f)
                close()
...
private var `_calendar-dots-light`: ImageVector? = null
