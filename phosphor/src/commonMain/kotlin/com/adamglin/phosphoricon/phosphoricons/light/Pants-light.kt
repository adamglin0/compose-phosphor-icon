...
public val LightGroup.`Pants-light`: ImageVector
    get() {
        if (`_pants-light` != null) {
            return `_pants-light`!!
        }
        `_pants-light` = Builder(name = "Pants-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pants-light`: ImageVector? = null
