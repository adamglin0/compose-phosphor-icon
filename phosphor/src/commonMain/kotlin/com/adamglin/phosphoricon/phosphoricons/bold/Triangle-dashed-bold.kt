...
public val BoldGroup.`Triangle-dashed-bold`: ImageVector
    get() {
        if (`_triangle-dashed-bold` != null) {
            return `_triangle-dashed-bold`!!
        }
        `_triangle-dashed-bold` = Builder(name = "Triangle-dashed-bold", defaultWidth = 256.0.dp,
...
private var `_triangle-dashed-bold`: ImageVector? = null
