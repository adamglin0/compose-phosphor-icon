...
public val RegularGroup.`File-py`: ImageVector
    get() {
        if (`_file-py` != null) {
            return `_file-py`!!
        }
        `_file-py` = Builder(name = "File-py", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-py`: ImageVector? = null
