...
public val DuotoneGroup.`Handbag-simple-duotone`: ImageVector
    get() {
        if (`_handbag-simple-duotone` != null) {
            return `_handbag-simple-duotone`!!
        }
        `_handbag-simple-duotone` = Builder(name = "Handbag-simple-duotone", defaultWidth =
...
private var `_handbag-simple-duotone`: ImageVector? = null
