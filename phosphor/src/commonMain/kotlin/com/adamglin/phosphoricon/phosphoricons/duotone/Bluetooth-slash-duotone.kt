...
public val DuotoneGroup.`Bluetooth-slash-duotone`: ImageVector
    get() {
        if (`_bluetooth-slash-duotone` != null) {
            return `_bluetooth-slash-duotone`!!
        }
        `_bluetooth-slash-duotone` = Builder(name = "Bluetooth-slash-duotone", defaultWidth =
...
private var `_bluetooth-slash-duotone`: ImageVector? = null
