...
public val DuotoneGroup.`Cigarette-slash-duotone`: ImageVector
    get() {
        if (`_cigarette-slash-duotone` != null) {
            return `_cigarette-slash-duotone`!!
        }
        `_cigarette-slash-duotone` = Builder(name = "Cigarette-slash-duotone", defaultWidth =
...
private var `_cigarette-slash-duotone`: ImageVector? = null
