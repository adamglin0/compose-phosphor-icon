...
public val DuotoneGroup.`Link-break-duotone`: ImageVector
    get() {
        if (`_link-break-duotone` != null) {
            return `_link-break-duotone`!!
        }
        `_link-break-duotone` = Builder(name = "Link-break-duotone", defaultWidth = 256.0.dp,
...
private var `_link-break-duotone`: ImageVector? = null
