...
public val DuotoneGroup.`Floppy-disk-back-duotone`: ImageVector
    get() {
        if (`_floppy-disk-back-duotone` != null) {
            return `_floppy-disk-back-duotone`!!
        }
        `_floppy-disk-back-duotone` = Builder(name = "Floppy-disk-back-duotone", defaultWidth =
...
private var `_floppy-disk-back-duotone`: ImageVector? = null
