...
public val DuotoneGroup.`Resize-duotone`: ImageVector
    get() {
        if (`_resize-duotone` != null) {
            return `_resize-duotone`!!
        }
        `_resize-duotone` = Builder(name = "Resize-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_resize-duotone`: ImageVector? = null
