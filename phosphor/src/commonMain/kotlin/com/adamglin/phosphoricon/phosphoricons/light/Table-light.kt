...
public val LightGroup.`Table-light`: ImageVector
    get() {
        if (`_table-light` != null) {
            return `_table-light`!!
        }
        `_table-light` = Builder(name = "Table-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_table-light`: ImageVector? = null
