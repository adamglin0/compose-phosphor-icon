...
public val LightGroup.`Layout-light`: ImageVector
    get() {
        if (`_layout-light` != null) {
            return `_layout-light`!!
        }
        `_layout-light` = Builder(name = "Layout-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_layout-light`: ImageVector? = null
