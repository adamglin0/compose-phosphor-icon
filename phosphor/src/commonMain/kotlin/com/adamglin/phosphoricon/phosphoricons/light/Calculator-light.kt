...
public val LightGroup.`Calculator-light`: ImageVector
    get() {
        if (`_calculator-light` != null) {
            return `_calculator-light`!!
        }
        `_calculator-light` = Builder(name = "Calculator-light", defaultWidth = 256.0.dp,
...
private var `_calculator-light`: ImageVector? = null
