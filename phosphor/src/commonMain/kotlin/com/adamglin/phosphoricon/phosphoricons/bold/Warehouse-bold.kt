...
public val BoldGroup.`Warehouse-bold`: ImageVector
    get() {
        if (`_warehouse-bold` != null) {
            return `_warehouse-bold`!!
        }
        `_warehouse-bold` = Builder(name = "Warehouse-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_warehouse-bold`: ImageVector? = null
