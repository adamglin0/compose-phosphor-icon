...
public val ThinGroup.`Drop-slash-thin`: ImageVector
    get() {
        if (`_drop-slash-thin` != null) {
            return `_drop-slash-thin`!!
        }
        `_drop-slash-thin` = Builder(name = "Drop-slash-thin", defaultWidth = 256.0.dp,
...
private var `_drop-slash-thin`: ImageVector? = null
