...
public val LightGroup.`Quotes-light`: ImageVector
    get() {
        if (`_quotes-light` != null) {
            return `_quotes-light`!!
        }
        `_quotes-light` = Builder(name = "Quotes-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_quotes-light`: ImageVector? = null
