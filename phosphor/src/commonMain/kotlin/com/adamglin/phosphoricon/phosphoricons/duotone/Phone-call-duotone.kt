...
public val DuotoneGroup.`Phone-call-duotone`: ImageVector
    get() {
        if (`_phone-call-duotone` != null) {
            return `_phone-call-duotone`!!
        }
        `_phone-call-duotone` = Builder(name = "Phone-call-duotone", defaultWidth = 256.0.dp,
...
private var `_phone-call-duotone`: ImageVector? = null
