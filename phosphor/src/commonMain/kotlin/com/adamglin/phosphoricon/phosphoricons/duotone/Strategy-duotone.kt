...
public val DuotoneGroup.`Strategy-duotone`: ImageVector
    get() {
        if (`_strategy-duotone` != null) {
            return `_strategy-duotone`!!
        }
        `_strategy-duotone` = Builder(name = "Strategy-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(28.0f, 28.0f, 0.0f, false, true, 104.0f, 188.0f)
                close()
            }
...
private var `_strategy-duotone`: ImageVector? = null
