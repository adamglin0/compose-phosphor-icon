...
public val DuotoneGroup.`Drop-simple-duotone`: ImageVector
    get() {
        if (`_drop-simple-duotone` != null) {
            return `_drop-simple-duotone`!!
        }
        `_drop-simple-duotone` = Builder(name = "Drop-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_drop-simple-duotone`: ImageVector? = null
