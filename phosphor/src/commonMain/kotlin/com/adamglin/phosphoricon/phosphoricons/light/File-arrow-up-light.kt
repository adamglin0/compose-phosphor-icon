...
public val LightGroup.`File-arrow-up-light`: ImageVector
    get() {
        if (`_file-arrow-up-light` != null) {
            return `_file-arrow-up-light`!!
        }
        `_file-arrow-up-light` = Builder(name = "File-arrow-up-light", defaultWidth = 256.0.dp,
...
private var `_file-arrow-up-light`: ImageVector? = null
