...
public val DuotoneGroup.`Selection-slash-duotone`: ImageVector
    get() {
        if (`_selection-slash-duotone` != null) {
            return `_selection-slash-duotone`!!
        }
        `_selection-slash-duotone` = Builder(name = "Selection-slash-duotone", defaultWidth =
...
private var `_selection-slash-duotone`: ImageVector? = null
