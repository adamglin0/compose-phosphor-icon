...
public val ThinGroup.`Air-traffic-control-thin`: ImageVector
    get() {
        if (`_air-traffic-control-thin` != null) {
            return `_air-traffic-control-thin`!!
        }
        `_air-traffic-control-thin` = Builder(name = "Air-traffic-control-thin", defaultWidth =
...
private var `_air-traffic-control-thin`: ImageVector? = null
