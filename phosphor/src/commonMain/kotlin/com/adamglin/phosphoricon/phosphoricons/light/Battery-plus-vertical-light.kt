...
public val LightGroup.`Battery-plus-vertical-light`: ImageVector
    get() {
        if (`_battery-plus-vertical-light` != null) {
            return `_battery-plus-vertical-light`!!
        }
        `_battery-plus-vertical-light` = Builder(name = "Battery-plus-vertical-light", defaultWidth
...
private var `_battery-plus-vertical-light`: ImageVector? = null
