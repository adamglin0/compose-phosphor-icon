...
public val LightGroup.`File-cloud-light`: ImageVector
    get() {
        if (`_file-cloud-light` != null) {
            return `_file-cloud-light`!!
        }
        `_file-cloud-light` = Builder(name = "File-cloud-light", defaultWidth = 256.0.dp,
...
private var `_file-cloud-light`: ImageVector? = null
