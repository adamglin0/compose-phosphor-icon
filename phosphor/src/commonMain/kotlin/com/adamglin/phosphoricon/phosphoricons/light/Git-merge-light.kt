...
public val LightGroup.`Git-merge-light`: ImageVector
    get() {
        if (`_git-merge-light` != null) {
            return `_git-merge-light`!!
        }
        `_git-merge-light` = Builder(name = "Git-merge-light", defaultWidth = 256.0.dp,
...
private var `_git-merge-light`: ImageVector? = null
