...
public val BoldGroup.`Nuclear-plant-bold`: ImageVector
    get() {
        if (`_nuclear-plant-bold` != null) {
            return `_nuclear-plant-bold`!!
        }
        `_nuclear-plant-bold` = Builder(name = "Nuclear-plant-bold", defaultWidth = 256.0.dp,
...
private var `_nuclear-plant-bold`: ImageVector? = null
