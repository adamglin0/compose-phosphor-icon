...
public val ThinGroup.`Bone-thin`: ImageVector
    get() {
        if (`_bone-thin` != null) {
            return `_bone-thin`!!
        }
        `_bone-thin` = Builder(name = "Bone-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bone-thin`: ImageVector? = null
