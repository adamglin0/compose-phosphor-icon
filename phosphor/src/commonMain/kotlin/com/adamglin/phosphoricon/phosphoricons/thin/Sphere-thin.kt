...
public val ThinGroup.`Sphere-thin`: ImageVector
    get() {
        if (`_sphere-thin` != null) {
            return `_sphere-thin`!!
        }
        `_sphere-thin` = Builder(name = "Sphere-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sphere-thin`: ImageVector? = null
