...
public val ThinGroup.`Cursor-click-thin`: ImageVector
    get() {
        if (`_cursor-click-thin` != null) {
            return `_cursor-click-thin`!!
        }
        `_cursor-click-thin` = Builder(name = "Cursor-click-thin", defaultWidth = 256.0.dp,
...
private var `_cursor-click-thin`: ImageVector? = null
