...
public val LightGroup.`Caret-circle-double-right-light`: ImageVector
    get() {
        if (`_caret-circle-double-right-light` != null) {
            return `_caret-circle-double-right-light`!!
        }
        `_caret-circle-double-right-light` = Builder(name = "Caret-circle-double-right-light",
...
private var `_caret-circle-double-right-light`: ImageVector? = null
