...
public val ThinGroup.`Selection-plus-thin`: ImageVector
    get() {
        if (`_selection-plus-thin` != null) {
            return `_selection-plus-thin`!!
        }
        `_selection-plus-thin` = Builder(name = "Selection-plus-thin", defaultWidth = 256.0.dp,
...
private var `_selection-plus-thin`: ImageVector? = null
