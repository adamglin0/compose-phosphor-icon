...
public val LightGroup.`Arrow-bend-double-up-right-light`: ImageVector
    get() {
        if (`_arrow-bend-double-up-right-light` != null) {
            return `_arrow-bend-double-up-right-light`!!
        }
        `_arrow-bend-double-up-right-light` = Builder(name = "Arrow-bend-double-up-right-light",
...
private var `_arrow-bend-double-up-right-light`: ImageVector? = null
