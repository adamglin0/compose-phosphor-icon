...
public val BoldGroup.`Fire-extinguisher-bold`: ImageVector
    get() {
        if (`_fire-extinguisher-bold` != null) {
            return `_fire-extinguisher-bold`!!
        }
        `_fire-extinguisher-bold` = Builder(name = "Fire-extinguisher-bold", defaultWidth =
...
private var `_fire-extinguisher-bold`: ImageVector? = null
