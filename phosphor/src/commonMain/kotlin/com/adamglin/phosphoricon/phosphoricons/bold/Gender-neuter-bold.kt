...
public val BoldGroup.`Gender-neuter-bold`: ImageVector
    get() {
        if (`_gender-neuter-bold` != null) {
            return `_gender-neuter-bold`!!
        }
        `_gender-neuter-bold` = Builder(name = "Gender-neuter-bold", defaultWidth = 256.0.dp,
...
private var `_gender-neuter-bold`: ImageVector? = null
