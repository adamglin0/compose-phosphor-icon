...
public val FillGroup.`Number-square-nine-fill`: ImageVector
    get() {
        if (`_number-square-nine-fill` != null) {
            return `_number-square-nine-fill`!!
        }
        `_number-square-nine-fill` = Builder(name = "Number-square-nine-fill", defaultWidth =
...
private var `_number-square-nine-fill`: ImageVector? = null
