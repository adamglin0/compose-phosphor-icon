...
public val DuotoneGroup.`Scan-duotone`: ImageVector
    get() {
        if (`_scan-duotone` != null) {
            return `_scan-duotone`!!
        }
        `_scan-duotone` = Builder(name = "Scan-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scan-duotone`: ImageVector? = null
