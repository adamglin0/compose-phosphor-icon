...
public val FillGroup.`Fan-fill`: ImageVector
    get() {
        if (`_fan-fill` != null) {
            return `_fan-fill`!!
        }
        `_fan-fill` = Builder(name = "Fan-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_fan-fill`: ImageVector? = null
