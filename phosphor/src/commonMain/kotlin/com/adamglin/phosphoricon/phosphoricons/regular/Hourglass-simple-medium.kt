...
public val RegularGroup.`Hourglass-simple-medium`: ImageVector
    get() {
        if (`_hourglass-simple-medium` != null) {
            return `_hourglass-simple-medium`!!
        }
        `_hourglass-simple-medium` = Builder(name = "Hourglass-simple-medium", defaultWidth =
...
private var `_hourglass-simple-medium`: ImageVector? = null
