...
public val LightGroup.`Amazon-logo-light`: ImageVector
    get() {
        if (`_amazon-logo-light` != null) {
            return `_amazon-logo-light`!!
        }
        `_amazon-logo-light` = Builder(name = "Amazon-logo-light", defaultWidth = 256.0.dp,
...
private var `_amazon-logo-light`: ImageVector? = null
