...
public val ThinGroup.`Folders-thin`: ImageVector
    get() {
        if (`_folders-thin` != null) {
            return `_folders-thin`!!
        }
        `_folders-thin` = Builder(name = "Folders-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folders-thin`: ImageVector? = null
