...
public val ThinGroup.`Shield-chevron-thin`: ImageVector
    get() {
        if (`_shield-chevron-thin` != null) {
            return `_shield-chevron-thin`!!
        }
        `_shield-chevron-thin` = Builder(name = "Shield-chevron-thin", defaultWidth = 256.0.dp,
...
private var `_shield-chevron-thin`: ImageVector? = null
