...
public val LightGroup.`Coin-light`: ImageVector
    get() {
        if (`_coin-light` != null) {
            return `_coin-light`!!
        }
        `_coin-light` = Builder(name = "Coin-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coin-light`: ImageVector? = null
