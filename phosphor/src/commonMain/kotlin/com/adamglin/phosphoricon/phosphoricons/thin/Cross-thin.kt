...
public val ThinGroup.`Cross-thin`: ImageVector
    get() {
        if (`_cross-thin` != null) {
            return `_cross-thin`!!
        }
        `_cross-thin` = Builder(name = "Cross-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cross-thin`: ImageVector? = null
