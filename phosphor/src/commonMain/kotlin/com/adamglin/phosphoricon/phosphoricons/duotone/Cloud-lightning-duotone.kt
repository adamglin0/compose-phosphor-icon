...
public val DuotoneGroup.`Cloud-lightning-duotone`: ImageVector
    get() {
        if (`_cloud-lightning-duotone` != null) {
            return `_cloud-lightning-duotone`!!
        }
        `_cloud-lightning-duotone` = Builder(name = "Cloud-lightning-duotone", defaultWidth =
...
private var `_cloud-lightning-duotone`: ImageVector? = null
