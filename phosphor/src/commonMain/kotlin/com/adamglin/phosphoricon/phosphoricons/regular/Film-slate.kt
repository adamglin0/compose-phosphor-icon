...
public val RegularGroup.`Film-slate`: ImageVector
    get() {
        if (`_film-slate` != null) {
            return `_film-slate`!!
        }
        `_film-slate` = Builder(name = "Film-slate", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_film-slate`: ImageVector? = null
