...
public val DuotoneGroup.`Text-h-three-duotone`: ImageVector
    get() {
        if (`_text-h-three-duotone` != null) {
            return `_text-h-three-duotone`!!
        }
        `_text-h-three-duotone` = Builder(name = "Text-h-three-duotone", defaultWidth = 256.0.dp,
...
private var `_text-h-three-duotone`: ImageVector? = null
