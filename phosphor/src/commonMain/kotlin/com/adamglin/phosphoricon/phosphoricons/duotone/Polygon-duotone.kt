...
public val DuotoneGroup.`Polygon-duotone`: ImageVector
    get() {
        if (`_polygon-duotone` != null) {
            return `_polygon-duotone`!!
        }
        `_polygon-duotone` = Builder(name = "Polygon-duotone", defaultWidth = 256.0.dp,
...
private var `_polygon-duotone`: ImageVector? = null
