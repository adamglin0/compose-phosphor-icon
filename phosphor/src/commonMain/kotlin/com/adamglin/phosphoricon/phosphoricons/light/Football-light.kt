...
public val LightGroup.`Football-light`: ImageVector
    get() {
        if (`_football-light` != null) {
            return `_football-light`!!
        }
        `_football-light` = Builder(name = "Football-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_football-light`: ImageVector? = null
