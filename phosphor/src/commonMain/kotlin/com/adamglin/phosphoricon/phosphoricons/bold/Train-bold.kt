...
public val BoldGroup.`Train-bold`: ImageVector
    get() {
        if (`_train-bold` != null) {
            return `_train-bold`!!
        }
        `_train-bold` = Builder(name = "Train-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_train-bold`: ImageVector? = null
