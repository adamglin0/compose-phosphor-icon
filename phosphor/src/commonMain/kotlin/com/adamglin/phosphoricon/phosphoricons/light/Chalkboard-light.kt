...
public val LightGroup.`Chalkboard-light`: ImageVector
    get() {
        if (`_chalkboard-light` != null) {
            return `_chalkboard-light`!!
        }
        `_chalkboard-light` = Builder(name = "Chalkboard-light", defaultWidth = 256.0.dp,
...
private var `_chalkboard-light`: ImageVector? = null
