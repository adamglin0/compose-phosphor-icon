...
public val FillGroup.`Student-fill`: ImageVector
    get() {
        if (`_student-fill` != null) {
            return `_student-fill`!!
        }
        `_student-fill` = Builder(name = "Student-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_student-fill`: ImageVector? = null
