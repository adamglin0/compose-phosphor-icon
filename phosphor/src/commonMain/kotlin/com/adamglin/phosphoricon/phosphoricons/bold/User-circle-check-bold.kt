...
public val BoldGroup.`User-circle-check-bold`: ImageVector
    get() {
        if (`_user-circle-check-bold` != null) {
            return `_user-circle-check-bold`!!
        }
        `_user-circle-check-bold` = Builder(name = "User-circle-check-bold", defaultWidth =
...
private var `_user-circle-check-bold`: ImageVector? = null
