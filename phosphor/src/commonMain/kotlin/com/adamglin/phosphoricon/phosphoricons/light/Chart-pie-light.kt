...
public val LightGroup.`Chart-pie-light`: ImageVector
    get() {
        if (`_chart-pie-light` != null) {
            return `_chart-pie-light`!!
        }
        `_chart-pie-light` = Builder(name = "Chart-pie-light", defaultWidth = 256.0.dp,
...
private var `_chart-pie-light`: ImageVector? = null
