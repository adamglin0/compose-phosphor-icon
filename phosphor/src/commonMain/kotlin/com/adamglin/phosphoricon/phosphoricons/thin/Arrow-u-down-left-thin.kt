...
public val ThinGroup.`Arrow-u-down-left-thin`: ImageVector
    get() {
        if (`_arrow-u-down-left-thin` != null) {
            return `_arrow-u-down-left-thin`!!
        }
        `_arrow-u-down-left-thin` = Builder(name = "Arrow-u-down-left-thin", defaultWidth =
...
private var `_arrow-u-down-left-thin`: ImageVector? = null
