...
public val DuotoneGroup.`Dice-three-duotone`: ImageVector
    get() {
        if (`_dice-three-duotone` != null) {
            return `_dice-three-duotone`!!
        }
        `_dice-three-duotone` = Builder(name = "Dice-three-duotone", defaultWidth = 256.0.dp,
...
private var `_dice-three-duotone`: ImageVector? = null
