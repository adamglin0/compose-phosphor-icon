...
public val ThinGroup.`Circuitry-thin`: ImageVector
    get() {
        if (`_circuitry-thin` != null) {
            return `_circuitry-thin`!!
        }
        `_circuitry-thin` = Builder(name = "Circuitry-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_circuitry-thin`: ImageVector? = null
