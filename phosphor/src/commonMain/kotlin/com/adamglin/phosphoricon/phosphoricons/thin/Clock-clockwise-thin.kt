...
public val ThinGroup.`Clock-clockwise-thin`: ImageVector
    get() {
        if (`_clock-clockwise-thin` != null) {
            return `_clock-clockwise-thin`!!
        }
        `_clock-clockwise-thin` = Builder(name = "Clock-clockwise-thin", defaultWidth = 256.0.dp,
...
private var `_clock-clockwise-thin`: ImageVector? = null
