...
public val LightGroup.`Git-pull-request-light`: ImageVector
    get() {
        if (`_git-pull-request-light` != null) {
            return `_git-pull-request-light`!!
        }
        `_git-pull-request-light` = Builder(name = "Git-pull-request-light", defaultWidth =
...
private var `_git-pull-request-light`: ImageVector? = null
