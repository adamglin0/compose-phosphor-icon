...
public val DuotoneGroup.`Heartbeat-duotone`: ImageVector
    get() {
        if (`_heartbeat-duotone` != null) {
            return `_heartbeat-duotone`!!
        }
        `_heartbeat-duotone` = Builder(name = "Heartbeat-duotone", defaultWidth = 256.0.dp,
...
private var `_heartbeat-duotone`: ImageVector? = null
