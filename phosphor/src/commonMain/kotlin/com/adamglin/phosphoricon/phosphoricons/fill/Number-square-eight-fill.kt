...
public val FillGroup.`Number-square-eight-fill`: ImageVector
    get() {
        if (`_number-square-eight-fill` != null) {
            return `_number-square-eight-fill`!!
        }
        `_number-square-eight-fill` = Builder(name = "Number-square-eight-fill", defaultWidth =
...
private var `_number-square-eight-fill`: ImageVector? = null
