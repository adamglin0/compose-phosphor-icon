...
public val ThinGroup.`Dress-thin`: ImageVector
    get() {
        if (`_dress-thin` != null) {
            return `_dress-thin`!!
        }
        `_dress-thin` = Builder(name = "Dress-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dress-thin`: ImageVector? = null
