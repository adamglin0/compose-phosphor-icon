...
public val ThinGroup.`Jar-thin`: ImageVector
    get() {
        if (`_jar-thin` != null) {
            return `_jar-thin`!!
        }
        `_jar-thin` = Builder(name = "Jar-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_jar-thin`: ImageVector? = null
