...
public val ThinGroup.`At-thin`: ImageVector
    get() {
        if (`_at-thin` != null) {
            return `_at-thin`!!
        }
        `_at-thin` = Builder(name = "At-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_at-thin`: ImageVector? = null
