...
public val ThinGroup.`Engine-thin`: ImageVector
    get() {
        if (`_engine-thin` != null) {
            return `_engine-thin`!!
        }
        `_engine-thin` = Builder(name = "Engine-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_engine-thin`: ImageVector? = null
