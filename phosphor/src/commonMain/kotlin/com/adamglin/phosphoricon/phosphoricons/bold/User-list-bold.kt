...
public val BoldGroup.`User-list-bold`: ImageVector
    get() {
        if (`_user-list-bold` != null) {
            return `_user-list-bold`!!
        }
        `_user-list-bold` = Builder(name = "User-list-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_user-list-bold`: ImageVector? = null
