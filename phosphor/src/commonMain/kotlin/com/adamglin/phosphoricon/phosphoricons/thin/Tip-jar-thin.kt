...
public val ThinGroup.`Tip-jar-thin`: ImageVector
    get() {
        if (`_tip-jar-thin` != null) {
            return `_tip-jar-thin`!!
        }
        `_tip-jar-thin` = Builder(name = "Tip-jar-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tip-jar-thin`: ImageVector? = null
