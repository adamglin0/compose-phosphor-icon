...
public val LightGroup.`Device-mobile-slash-light`: ImageVector
    get() {
        if (`_device-mobile-slash-light` != null) {
            return `_device-mobile-slash-light`!!
        }
        `_device-mobile-slash-light` = Builder(name = "Device-mobile-slash-light", defaultWidth =
...
private var `_device-mobile-slash-light`: ImageVector? = null
