...
public val ThinGroup.`Question-thin`: ImageVector
    get() {
        if (`_question-thin` != null) {
            return `_question-thin`!!
        }
        `_question-thin` = Builder(name = "Question-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_question-thin`: ImageVector? = null
