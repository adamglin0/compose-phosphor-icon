...
public val LightGroup.`X-square-light`: ImageVector
    get() {
        if (`_x-square-light` != null) {
            return `_x-square-light`!!
        }
        `_x-square-light` = Builder(name = "X-square-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_x-square-light`: ImageVector? = null
