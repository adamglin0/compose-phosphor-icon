...
public val DuotoneGroup.`Tag-simple-duotone`: ImageVector
    get() {
        if (`_tag-simple-duotone` != null) {
            return `_tag-simple-duotone`!!
        }
        `_tag-simple-duotone` = Builder(name = "Tag-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_tag-simple-duotone`: ImageVector? = null
