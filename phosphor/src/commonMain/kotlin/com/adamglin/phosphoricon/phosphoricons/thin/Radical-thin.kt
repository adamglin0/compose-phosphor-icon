...
public val ThinGroup.`Radical-thin`: ImageVector
    get() {
        if (`_radical-thin` != null) {
            return `_radical-thin`!!
        }
        `_radical-thin` = Builder(name = "Radical-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_radical-thin`: ImageVector? = null
