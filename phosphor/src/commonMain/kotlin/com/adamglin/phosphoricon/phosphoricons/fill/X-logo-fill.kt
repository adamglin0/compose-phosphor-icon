...
public val FillGroup.`X-logo-fill`: ImageVector
    get() {
        if (`_x-logo-fill` != null) {
            return `_x-logo-fill`!!
        }
        `_x-logo-fill` = Builder(name = "X-logo-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_x-logo-fill`: ImageVector? = null
