...
public val FillGroup.`Fish-simple-fill`: ImageVector
    get() {
        if (`_fish-simple-fill` != null) {
            return `_fish-simple-fill`!!
        }
        `_fish-simple-fill` = Builder(name = "Fish-simple-fill", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(115.0f, 35.76f, 140.14f, 23.64f, 179.27f, 24.0f)
...
private var `_fish-simple-fill`: ImageVector? = null
