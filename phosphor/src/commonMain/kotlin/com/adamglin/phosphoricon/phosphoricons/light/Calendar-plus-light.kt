...
public val LightGroup.`Calendar-plus-light`: ImageVector
    get() {
        if (`_calendar-plus-light` != null) {
            return `_calendar-plus-light`!!
        }
        `_calendar-plus-light` = Builder(name = "Calendar-plus-light", defaultWidth = 256.0.dp,
...
private var `_calendar-plus-light`: ImageVector? = null
