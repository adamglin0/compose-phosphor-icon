...
public val LightGroup.`Caret-double-right-light`: ImageVector
    get() {
        if (`_caret-double-right-light` != null) {
            return `_caret-double-right-light`!!
        }
        `_caret-double-right-light` = Builder(name = "Caret-double-right-light", defaultWidth =
...
private var `_caret-double-right-light`: ImageVector? = null
