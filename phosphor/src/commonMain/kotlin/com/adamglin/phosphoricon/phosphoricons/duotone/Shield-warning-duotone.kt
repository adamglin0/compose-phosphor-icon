...
public val DuotoneGroup.`Shield-warning-duotone`: ImageVector
    get() {
        if (`_shield-warning-duotone` != null) {
            return `_shield-warning-duotone`!!
        }
        `_shield-warning-duotone` = Builder(name = "Shield-warning-duotone", defaultWidth =
...
private var `_shield-warning-duotone`: ImageVector? = null
