...
public val LightGroup.`Pen-light`: ImageVector
    get() {
        if (`_pen-light` != null) {
            return `_pen-light`!!
        }
        `_pen-light` = Builder(name = "Pen-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pen-light`: ImageVector? = null
