...
public val LightGroup.`Copy-light`: ImageVector
    get() {
        if (`_copy-light` != null) {
            return `_copy-light`!!
        }
        `_copy-light` = Builder(name = "Copy-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_copy-light`: ImageVector? = null
