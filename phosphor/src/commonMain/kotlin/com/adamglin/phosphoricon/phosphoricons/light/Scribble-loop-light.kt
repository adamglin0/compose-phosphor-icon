...
public val LightGroup.`Scribble-loop-light`: ImageVector
    get() {
        if (`_scribble-loop-light` != null) {
            return `_scribble-loop-light`!!
        }
        `_scribble-loop-light` = Builder(name = "Scribble-loop-light", defaultWidth = 256.0.dp,
...
private var `_scribble-loop-light`: ImageVector? = null
