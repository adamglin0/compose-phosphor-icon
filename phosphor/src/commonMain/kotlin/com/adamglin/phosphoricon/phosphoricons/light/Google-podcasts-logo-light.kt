...
public val LightGroup.`Google-podcasts-logo-light`: ImageVector
    get() {
        if (`_google-podcasts-logo-light` != null) {
            return `_google-podcasts-logo-light`!!
        }
        `_google-podcasts-logo-light` = Builder(name = "Google-podcasts-logo-light", defaultWidth =
...
private var `_google-podcasts-logo-light`: ImageVector? = null
