...
public val LightGroup.`Microsoft-word-logo-light`: ImageVector
    get() {
        if (`_microsoft-word-logo-light` != null) {
            return `_microsoft-word-logo-light`!!
        }
        `_microsoft-word-logo-light` = Builder(name = "Microsoft-word-logo-light", defaultWidth =
...
private var `_microsoft-word-logo-light`: ImageVector? = null
