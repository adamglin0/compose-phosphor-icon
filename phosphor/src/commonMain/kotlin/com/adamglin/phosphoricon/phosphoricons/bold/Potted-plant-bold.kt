...
public val BoldGroup.`Potted-plant-bold`: ImageVector
    get() {
        if (`_potted-plant-bold` != null) {
            return `_potted-plant-bold`!!
        }
        `_potted-plant-bold` = Builder(name = "Potted-plant-bold", defaultWidth = 256.0.dp,
...
private var `_potted-plant-bold`: ImageVector? = null
