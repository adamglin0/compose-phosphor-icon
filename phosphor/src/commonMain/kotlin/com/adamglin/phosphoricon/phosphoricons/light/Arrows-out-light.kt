...
public val LightGroup.`Arrows-out-light`: ImageVector
    get() {
        if (`_arrows-out-light` != null) {
            return `_arrows-out-light`!!
        }
        `_arrows-out-light` = Builder(name = "Arrows-out-light", defaultWidth = 256.0.dp,
...
private var `_arrows-out-light`: ImageVector? = null
