...
public val BoldGroup.`Binoculars-bold`: ImageVector
    get() {
        if (`_binoculars-bold` != null) {
            return `_binoculars-bold`!!
        }
        `_binoculars-bold` = Builder(name = "Binoculars-bold", defaultWidth = 256.0.dp,
...
private var `_binoculars-bold`: ImageVector? = null
