...
public val BoldGroup.`Beach-ball-bold`: ImageVector
    get() {
        if (`_beach-ball-bold` != null) {
            return `_beach-ball-bold`!!
        }
        `_beach-ball-bold` = Builder(name = "Beach-ball-bold", defaultWidth = 256.0.dp,
...
private var `_beach-ball-bold`: ImageVector? = null
