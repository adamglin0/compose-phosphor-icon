...
public val BoldGroup.`Shield-star-bold`: ImageVector
    get() {
        if (`_shield-star-bold` != null) {
            return `_shield-star-bold`!!
        }
        `_shield-star-bold` = Builder(name = "Shield-star-bold", defaultWidth = 256.0.dp,
...
private var `_shield-star-bold`: ImageVector? = null
