...
public val DuotoneGroup.`Prohibit-duotone`: ImageVector
    get() {
        if (`_prohibit-duotone` != null) {
            return `_prohibit-duotone`!!
        }
        `_prohibit-duotone` = Builder(name = "Prohibit-duotone", defaultWidth = 256.0.dp,
...
private var `_prohibit-duotone`: ImageVector? = null
