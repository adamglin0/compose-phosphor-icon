...
public val BoldGroup.`Phone-x-bold`: ImageVector
    get() {
        if (`_phone-x-bold` != null) {
            return `_phone-x-bold`!!
        }
        `_phone-x-bold` = Builder(name = "Phone-x-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-x-bold`: ImageVector? = null
