...
public val BoldGroup.`Archive-bold`: ImageVector
    get() {
        if (`_archive-bold` != null) {
            return `_archive-bold`!!
        }
        `_archive-bold` = Builder(name = "Archive-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_archive-bold`: ImageVector? = null
