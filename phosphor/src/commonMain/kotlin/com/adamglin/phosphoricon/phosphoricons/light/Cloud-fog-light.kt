...
public val LightGroup.`Cloud-fog-light`: ImageVector
    get() {
        if (`_cloud-fog-light` != null) {
            return `_cloud-fog-light`!!
        }
        `_cloud-fog-light` = Builder(name = "Cloud-fog-light", defaultWidth = 256.0.dp,
...
private var `_cloud-fog-light`: ImageVector? = null
