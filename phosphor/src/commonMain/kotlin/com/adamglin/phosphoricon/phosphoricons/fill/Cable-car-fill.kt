...
public val FillGroup.`Cable-car-fill`: ImageVector
    get() {
        if (`_cable-car-fill` != null) {
            return `_cable-car-fill`!!
        }
        `_cable-car-fill` = Builder(name = "Cable-car-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_cable-car-fill`: ImageVector? = null
