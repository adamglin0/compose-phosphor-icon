...
public val ThinGroup.`Plant-thin`: ImageVector
    get() {
        if (`_plant-thin` != null) {
            return `_plant-thin`!!
        }
        `_plant-thin` = Builder(name = "Plant-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plant-thin`: ImageVector? = null
