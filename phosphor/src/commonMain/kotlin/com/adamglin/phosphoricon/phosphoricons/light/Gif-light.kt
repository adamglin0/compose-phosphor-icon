...
public val LightGroup.`Gif-light`: ImageVector
    get() {
        if (`_gif-light` != null) {
            return `_gif-light`!!
        }
        `_gif-light` = Builder(name = "Gif-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gif-light`: ImageVector? = null
