...
public val LightGroup.`Hand-heart-light`: ImageVector
    get() {
        if (`_hand-heart-light` != null) {
            return `_hand-heart-light`!!
        }
        `_hand-heart-light` = Builder(name = "Hand-heart-light", defaultWidth = 256.0.dp,
...
private var `_hand-heart-light`: ImageVector? = null
