...
public val ThinGroup.`Dice-three-thin`: ImageVector
    get() {
        if (`_dice-three-thin` != null) {
            return `_dice-three-thin`!!
        }
        `_dice-three-thin` = Builder(name = "Dice-three-thin", defaultWidth = 256.0.dp,
...
private var `_dice-three-thin`: ImageVector? = null
