...
public val ThinGroup.`App-window-thin`: ImageVector
    get() {
        if (`_app-window-thin` != null) {
            return `_app-window-thin`!!
        }
        `_app-window-thin` = Builder(name = "App-window-thin", defaultWidth = 256.0.dp,
...
private var `_app-window-thin`: ImageVector? = null
