...
public val ThinGroup.`Warehouse-thin`: ImageVector
    get() {
        if (`_warehouse-thin` != null) {
            return `_warehouse-thin`!!
        }
        `_warehouse-thin` = Builder(name = "Warehouse-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_warehouse-thin`: ImageVector? = null
