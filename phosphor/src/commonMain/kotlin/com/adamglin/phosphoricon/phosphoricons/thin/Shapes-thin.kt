...
public val ThinGroup.`Shapes-thin`: ImageVector
    get() {
        if (`_shapes-thin` != null) {
            return `_shapes-thin`!!
        }
        `_shapes-thin` = Builder(name = "Shapes-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shapes-thin`: ImageVector? = null
