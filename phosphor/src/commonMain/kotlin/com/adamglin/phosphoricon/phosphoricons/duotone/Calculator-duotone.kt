...
public val DuotoneGroup.`Calculator-duotone`: ImageVector
    get() {
        if (`_calculator-duotone` != null) {
            return `_calculator-duotone`!!
        }
        `_calculator-duotone` = Builder(name = "Calculator-duotone", defaultWidth = 256.0.dp,
...
private var `_calculator-duotone`: ImageVector? = null
