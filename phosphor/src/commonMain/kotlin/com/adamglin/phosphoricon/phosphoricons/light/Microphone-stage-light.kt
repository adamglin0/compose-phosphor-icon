...
public val LightGroup.`Microphone-stage-light`: ImageVector
    get() {
        if (`_microphone-stage-light` != null) {
            return `_microphone-stage-light`!!
        }
        `_microphone-stage-light` = Builder(name = "Microphone-stage-light", defaultWidth =
...
private var `_microphone-stage-light`: ImageVector? = null
