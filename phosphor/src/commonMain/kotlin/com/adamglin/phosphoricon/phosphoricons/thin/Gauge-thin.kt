...
public val ThinGroup.`Gauge-thin`: ImageVector
    get() {
        if (`_gauge-thin` != null) {
            return `_gauge-thin`!!
        }
        `_gauge-thin` = Builder(name = "Gauge-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gauge-thin`: ImageVector? = null
