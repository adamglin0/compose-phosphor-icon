...
public val BoldGroup.`Headset-bold`: ImageVector
    get() {
        if (`_headset-bold` != null) {
            return `_headset-bold`!!
        }
        `_headset-bold` = Builder(name = "Headset-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_headset-bold`: ImageVector? = null
