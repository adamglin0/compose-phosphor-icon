...
public val ThinGroup.`Rows-plus-bottom-thin`: ImageVector
    get() {
        if (`_rows-plus-bottom-thin` != null) {
            return `_rows-plus-bottom-thin`!!
        }
        `_rows-plus-bottom-thin` = Builder(name = "Rows-plus-bottom-thin", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, false, 208.0f, 116.0f)
                close()
...
private var `_rows-plus-bottom-thin`: ImageVector? = null
