...
public val BoldGroup.`Kanban-bold`: ImageVector
    get() {
        if (`_kanban-bold` != null) {
            return `_kanban-bold`!!
        }
        `_kanban-bold` = Builder(name = "Kanban-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_kanban-bold`: ImageVector? = null
