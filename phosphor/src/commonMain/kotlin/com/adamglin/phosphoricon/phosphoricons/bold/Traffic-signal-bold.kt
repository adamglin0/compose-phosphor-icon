...
public val BoldGroup.`Traffic-signal-bold`: ImageVector
    get() {
        if (`_traffic-signal-bold` != null) {
            return `_traffic-signal-bold`!!
        }
        `_traffic-signal-bold` = Builder(name = "Traffic-signal-bold", defaultWidth = 256.0.dp,
...
private var `_traffic-signal-bold`: ImageVector? = null
