...
public val BoldGroup.`Confetti-bold`: ImageVector
    get() {
        if (`_confetti-bold` != null) {
            return `_confetti-bold`!!
        }
        `_confetti-bold` = Builder(name = "Confetti-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_confetti-bold`: ImageVector? = null
