...
public val FillGroup.`Barbell-fill`: ImageVector
    get() {
        if (`_barbell-fill` != null) {
            return `_barbell-fill`!!
        }
        `_barbell-fill` = Builder(name = "Barbell-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barbell-fill`: ImageVector? = null
