...
public val BoldGroup.`Oven-bold`: ImageVector
    get() {
        if (`_oven-bold` != null) {
            return `_oven-bold`!!
        }
        `_oven-bold` = Builder(name = "Oven-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_oven-bold`: ImageVector? = null
