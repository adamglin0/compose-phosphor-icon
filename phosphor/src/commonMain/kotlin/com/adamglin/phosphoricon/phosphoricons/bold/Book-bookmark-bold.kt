...
public val BoldGroup.`Book-bookmark-bold`: ImageVector
    get() {
        if (`_book-bookmark-bold` != null) {
            return `_book-bookmark-bold`!!
        }
        `_book-bookmark-bold` = Builder(name = "Book-bookmark-bold", defaultWidth = 256.0.dp,
...
private var `_book-bookmark-bold`: ImageVector? = null
