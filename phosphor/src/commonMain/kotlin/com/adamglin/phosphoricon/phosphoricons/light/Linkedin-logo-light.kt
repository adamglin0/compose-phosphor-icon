...
public val LightGroup.`Linkedin-logo-light`: ImageVector
    get() {
        if (`_linkedin-logo-light` != null) {
            return `_linkedin-logo-light`!!
        }
        `_linkedin-logo-light` = Builder(name = "Linkedin-logo-light", defaultWidth = 256.0.dp,
...
private var `_linkedin-logo-light`: ImageVector? = null
