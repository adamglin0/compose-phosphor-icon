...
public val ThinGroup.`Circle-half-thin`: ImageVector
    get() {
        if (`_circle-half-thin` != null) {
            return `_circle-half-thin`!!
        }
        `_circle-half-thin` = Builder(name = "Circle-half-thin", defaultWidth = 256.0.dp,
...
private var `_circle-half-thin`: ImageVector? = null
