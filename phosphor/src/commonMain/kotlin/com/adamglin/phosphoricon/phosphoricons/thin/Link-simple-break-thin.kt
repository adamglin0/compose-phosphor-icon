...
public val ThinGroup.`Link-simple-break-thin`: ImageVector
    get() {
        if (`_link-simple-break-thin` != null) {
            return `_link-simple-break-thin`!!
        }
        `_link-simple-break-thin` = Builder(name = "Link-simple-break-thin", defaultWidth =
...
private var `_link-simple-break-thin`: ImageVector? = null
