...
public val DuotoneGroup.`Prohibit-inset-duotone`: ImageVector
    get() {
        if (`_prohibit-inset-duotone` != null) {
            return `_prohibit-inset-duotone`!!
        }
        `_prohibit-inset-duotone` = Builder(name = "Prohibit-inset-duotone", defaultWidth =
...
private var `_prohibit-inset-duotone`: ImageVector? = null
