...
public val BoldGroup.`Airplane-taxiing-bold`: ImageVector
    get() {
        if (`_airplane-taxiing-bold` != null) {
            return `_airplane-taxiing-bold`!!
        }
        `_airplane-taxiing-bold` = Builder(name = "Airplane-taxiing-bold", defaultWidth = 256.0.dp,
...
private var `_airplane-taxiing-bold`: ImageVector? = null
