...
public val DuotoneGroup.`Checks-duotone`: ImageVector
    get() {
        if (`_checks-duotone` != null) {
            return `_checks-duotone`!!
        }
        `_checks-duotone` = Builder(name = "Checks-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_checks-duotone`: ImageVector? = null
