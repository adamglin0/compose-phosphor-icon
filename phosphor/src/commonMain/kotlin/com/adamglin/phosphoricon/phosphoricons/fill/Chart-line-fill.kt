...
public val FillGroup.`Chart-line-fill`: ImageVector
    get() {
        if (`_chart-line-fill` != null) {
            return `_chart-line-fill`!!
        }
        `_chart-line-fill` = Builder(name = "Chart-line-fill", defaultWidth = 256.0.dp,
...
private var `_chart-line-fill`: ImageVector? = null
