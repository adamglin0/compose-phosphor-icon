...
public val ThinGroup.`Smiley-sticker-thin`: ImageVector
    get() {
        if (`_smiley-sticker-thin` != null) {
            return `_smiley-sticker-thin`!!
        }
        `_smiley-sticker-thin` = Builder(name = "Smiley-sticker-thin", defaultWidth = 256.0.dp,
...
private var `_smiley-sticker-thin`: ImageVector? = null
