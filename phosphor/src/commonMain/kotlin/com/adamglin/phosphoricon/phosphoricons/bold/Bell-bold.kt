...
public val BoldGroup.`Bell-bold`: ImageVector
    get() {
        if (`_bell-bold` != null) {
            return `_bell-bold`!!
        }
        `_bell-bold` = Builder(name = "Bell-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bell-bold`: ImageVector? = null
