...
public val LightGroup.`Wifi-high-light`: ImageVector
    get() {
        if (`_wifi-high-light` != null) {
            return `_wifi-high-light`!!
        }
        `_wifi-high-light` = Builder(name = "Wifi-high-light", defaultWidth = 256.0.dp,
...
private var `_wifi-high-light`: ImageVector? = null
