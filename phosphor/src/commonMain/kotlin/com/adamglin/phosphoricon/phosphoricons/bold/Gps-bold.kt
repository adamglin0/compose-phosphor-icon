...
public val BoldGroup.`Gps-bold`: ImageVector
    get() {
        if (`_gps-bold` != null) {
            return `_gps-bold`!!
        }
        `_gps-bold` = Builder(name = "Gps-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_gps-bold`: ImageVector? = null
