...
public val ThinGroup.`Triangle-thin`: ImageVector
    get() {
        if (`_triangle-thin` != null) {
            return `_triangle-thin`!!
        }
        `_triangle-thin` = Builder(name = "Triangle-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_triangle-thin`: ImageVector? = null
