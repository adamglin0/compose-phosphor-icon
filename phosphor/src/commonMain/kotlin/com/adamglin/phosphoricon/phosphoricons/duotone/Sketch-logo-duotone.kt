...
public val DuotoneGroup.`Sketch-logo-duotone`: ImageVector
    get() {
        if (`_sketch-logo-duotone` != null) {
            return `_sketch-logo-duotone`!!
        }
        `_sketch-logo-duotone` = Builder(name = "Sketch-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_sketch-logo-duotone`: ImageVector? = null
