...
public val DuotoneGroup.`Pinterest-logo-duotone`: ImageVector
    get() {
        if (`_pinterest-logo-duotone` != null) {
            return `_pinterest-logo-duotone`!!
        }
        `_pinterest-logo-duotone` = Builder(name = "Pinterest-logo-duotone", defaultWidth =
...
private var `_pinterest-logo-duotone`: ImageVector? = null
