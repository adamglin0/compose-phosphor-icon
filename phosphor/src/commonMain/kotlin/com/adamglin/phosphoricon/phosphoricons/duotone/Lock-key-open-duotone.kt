...
public val DuotoneGroup.`Lock-key-open-duotone`: ImageVector
    get() {
        if (`_lock-key-open-duotone` != null) {
            return `_lock-key-open-duotone`!!
        }
        `_lock-key-open-duotone` = Builder(name = "Lock-key-open-duotone", defaultWidth = 256.0.dp,
...
private var `_lock-key-open-duotone`: ImageVector? = null
