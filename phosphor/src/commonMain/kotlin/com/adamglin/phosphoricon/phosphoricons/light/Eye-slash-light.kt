...
public val LightGroup.`Eye-slash-light`: ImageVector
    get() {
        if (`_eye-slash-light` != null) {
            return `_eye-slash-light`!!
        }
        `_eye-slash-light` = Builder(name = "Eye-slash-light", defaultWidth = 256.0.dp,
...
private var `_eye-slash-light`: ImageVector? = null
