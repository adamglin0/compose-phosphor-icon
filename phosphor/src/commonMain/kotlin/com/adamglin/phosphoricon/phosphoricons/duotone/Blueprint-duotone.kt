...
public val DuotoneGroup.`Blueprint-duotone`: ImageVector
    get() {
        if (`_blueprint-duotone` != null) {
            return `_blueprint-duotone`!!
        }
        `_blueprint-duotone` = Builder(name = "Blueprint-duotone", defaultWidth = 256.0.dp,
...
private var `_blueprint-duotone`: ImageVector? = null
