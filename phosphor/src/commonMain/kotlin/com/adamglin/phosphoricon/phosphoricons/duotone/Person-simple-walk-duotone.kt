...
public val DuotoneGroup.`Person-simple-walk-duotone`: ImageVector
    get() {
        if (`_person-simple-walk-duotone` != null) {
            return `_person-simple-walk-duotone`!!
        }
        `_person-simple-walk-duotone` = Builder(name = "Person-simple-walk-duotone", defaultWidth =
...
private var `_person-simple-walk-duotone`: ImageVector? = null
