...
public val LightGroup.`Cloud-check-light`: ImageVector
    get() {
        if (`_cloud-check-light` != null) {
            return `_cloud-check-light`!!
        }
        `_cloud-check-light` = Builder(name = "Cloud-check-light", defaultWidth = 256.0.dp,
...
private var `_cloud-check-light`: ImageVector? = null
