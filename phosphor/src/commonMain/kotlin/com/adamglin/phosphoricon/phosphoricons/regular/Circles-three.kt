...
public val RegularGroup.`Circles-three`: ImageVector
    get() {
        if (`_circles-three` != null) {
            return `_circles-three`!!
        }
        `_circles-three` = Builder(name = "Circles-three", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_circles-three`: ImageVector? = null
