...
public val BoldGroup.`Grains-bold`: ImageVector
    get() {
        if (`_grains-bold` != null) {
            return `_grains-bold`!!
        }
        `_grains-bold` = Builder(name = "Grains-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_grains-bold`: ImageVector? = null
