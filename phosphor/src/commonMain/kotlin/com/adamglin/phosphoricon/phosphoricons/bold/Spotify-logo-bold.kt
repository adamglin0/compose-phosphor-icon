...
public val BoldGroup.`Spotify-logo-bold`: ImageVector
    get() {
        if (`_spotify-logo-bold` != null) {
            return `_spotify-logo-bold`!!
        }
        `_spotify-logo-bold` = Builder(name = "Spotify-logo-bold", defaultWidth = 256.0.dp,
...
private var `_spotify-logo-bold`: ImageVector? = null
