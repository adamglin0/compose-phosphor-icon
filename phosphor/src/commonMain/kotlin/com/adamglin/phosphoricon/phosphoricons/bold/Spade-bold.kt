...
public val BoldGroup.`Spade-bold`: ImageVector
    get() {
        if (`_spade-bold` != null) {
            return `_spade-bold`!!
        }
        `_spade-bold` = Builder(name = "Spade-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spade-bold`: ImageVector? = null
