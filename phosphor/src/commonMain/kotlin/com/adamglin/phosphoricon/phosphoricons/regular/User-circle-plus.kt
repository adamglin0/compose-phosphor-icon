...
public val RegularGroup.`User-circle-plus`: ImageVector
    get() {
        if (`_user-circle-plus` != null) {
            return `_user-circle-plus`!!
        }
        `_user-circle-plus` = Builder(name = "User-circle-plus", defaultWidth = 256.0.dp,
...
private var `_user-circle-plus`: ImageVector? = null
