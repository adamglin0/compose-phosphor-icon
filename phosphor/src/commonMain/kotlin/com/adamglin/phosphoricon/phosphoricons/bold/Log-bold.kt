...
public val BoldGroup.`Log-bold`: ImageVector
    get() {
        if (`_log-bold` != null) {
            return `_log-bold`!!
        }
        `_log-bold` = Builder(name = "Log-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_log-bold`: ImageVector? = null
