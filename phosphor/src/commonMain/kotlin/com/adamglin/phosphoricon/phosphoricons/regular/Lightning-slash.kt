...
public val RegularGroup.`Lightning-slash`: ImageVector
    get() {
        if (`_lightning-slash` != null) {
            return `_lightning-slash`!!
        }
        `_lightning-slash` = Builder(name = "Lightning-slash", defaultWidth = 256.0.dp,
...
private var `_lightning-slash`: ImageVector? = null
