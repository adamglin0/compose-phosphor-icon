...
public val ThinGroup.`Star-of-david-thin`: ImageVector
    get() {
        if (`_star-of-david-thin` != null) {
            return `_star-of-david-thin`!!
        }
        `_star-of-david-thin` = Builder(name = "Star-of-david-thin", defaultWidth = 256.0.dp,
...
private var `_star-of-david-thin`: ImageVector? = null
