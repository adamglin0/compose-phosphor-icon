...
public val RegularGroup.`Bookmarks-simple`: ImageVector
    get() {
        if (`_bookmarks-simple` != null) {
            return `_bookmarks-simple`!!
        }
        `_bookmarks-simple` = Builder(name = "Bookmarks-simple", defaultWidth = 256.0.dp,
...
private var `_bookmarks-simple`: ImageVector? = null
