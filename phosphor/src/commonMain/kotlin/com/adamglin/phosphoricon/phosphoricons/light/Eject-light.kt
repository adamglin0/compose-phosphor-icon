...
public val LightGroup.`Eject-light`: ImageVector
    get() {
        if (`_eject-light` != null) {
            return `_eject-light`!!
        }
        `_eject-light` = Builder(name = "Eject-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eject-light`: ImageVector? = null
