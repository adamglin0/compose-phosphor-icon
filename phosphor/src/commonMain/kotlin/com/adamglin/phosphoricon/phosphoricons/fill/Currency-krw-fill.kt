...
public val FillGroup.`Currency-krw-fill`: ImageVector
    get() {
        if (`_currency-krw-fill` != null) {
            return `_currency-krw-fill`!!
        }
        `_currency-krw-fill` = Builder(name = "Currency-krw-fill", defaultWidth = 256.0.dp,
...
private var `_currency-krw-fill`: ImageVector? = null
