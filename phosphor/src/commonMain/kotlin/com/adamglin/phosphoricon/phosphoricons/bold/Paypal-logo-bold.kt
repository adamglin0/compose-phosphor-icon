...
public val BoldGroup.`Paypal-logo-bold`: ImageVector
    get() {
        if (`_paypal-logo-bold` != null) {
            return `_paypal-logo-bold`!!
        }
        `_paypal-logo-bold` = Builder(name = "Paypal-logo-bold", defaultWidth = 256.0.dp,
...
private var `_paypal-logo-bold`: ImageVector? = null
