...
public val LightGroup.`User-circle-gear-light`: ImageVector
    get() {
        if (`_user-circle-gear-light` != null) {
            return `_user-circle-gear-light`!!
        }
        `_user-circle-gear-light` = Builder(name = "User-circle-gear-light", defaultWidth =
...
private var `_user-circle-gear-light`: ImageVector? = null
