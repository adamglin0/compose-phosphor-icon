...
public val LightGroup.`Clock-clockwise-light`: ImageVector
    get() {
        if (`_clock-clockwise-light` != null) {
            return `_clock-clockwise-light`!!
        }
        `_clock-clockwise-light` = Builder(name = "Clock-clockwise-light", defaultWidth = 256.0.dp,
...
private var `_clock-clockwise-light`: ImageVector? = null
