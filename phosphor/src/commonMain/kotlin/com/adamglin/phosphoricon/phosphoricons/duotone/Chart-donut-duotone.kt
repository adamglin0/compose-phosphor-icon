...
public val DuotoneGroup.`Chart-donut-duotone`: ImageVector
    get() {
        if (`_chart-donut-duotone` != null) {
            return `_chart-donut-duotone`!!
        }
        `_chart-donut-duotone` = Builder(name = "Chart-donut-duotone", defaultWidth = 256.0.dp,
...
private var `_chart-donut-duotone`: ImageVector? = null
