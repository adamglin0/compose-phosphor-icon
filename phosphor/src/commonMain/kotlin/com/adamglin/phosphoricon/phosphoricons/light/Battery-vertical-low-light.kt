...
public val LightGroup.`Battery-vertical-low-light`: ImageVector
    get() {
        if (`_battery-vertical-low-light` != null) {
            return `_battery-vertical-low-light`!!
        }
        `_battery-vertical-low-light` = Builder(name = "Battery-vertical-low-light", defaultWidth =
...
private var `_battery-vertical-low-light`: ImageVector? = null
