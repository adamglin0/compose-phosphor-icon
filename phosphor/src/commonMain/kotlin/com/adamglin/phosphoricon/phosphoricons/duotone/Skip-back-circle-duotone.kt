...
public val DuotoneGroup.`Skip-back-circle-duotone`: ImageVector
    get() {
        if (`_skip-back-circle-duotone` != null) {
            return `_skip-back-circle-duotone`!!
        }
        `_skip-back-circle-duotone` = Builder(name = "Skip-back-circle-duotone", defaultWidth =
...
private var `_skip-back-circle-duotone`: ImageVector? = null
