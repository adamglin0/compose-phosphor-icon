...
public val DuotoneGroup.`Heart-half-duotone`: ImageVector
    get() {
        if (`_heart-half-duotone` != null) {
            return `_heart-half-duotone`!!
        }
        `_heart-half-duotone` = Builder(name = "Heart-half-duotone", defaultWidth = 256.0.dp,
...
private var `_heart-half-duotone`: ImageVector? = null
