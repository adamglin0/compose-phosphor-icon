...
public val DuotoneGroup.`Exam-duotone`: ImageVector
    get() {
        if (`_exam-duotone` != null) {
            return `_exam-duotone`!!
        }
        `_exam-duotone` = Builder(name = "Exam-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_exam-duotone`: ImageVector? = null
