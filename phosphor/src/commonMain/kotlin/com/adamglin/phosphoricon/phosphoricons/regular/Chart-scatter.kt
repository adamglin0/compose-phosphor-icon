...
public val RegularGroup.`Chart-scatter`: ImageVector
    get() {
        if (`_chart-scatter` != null) {
            return `_chart-scatter`!!
        }
        `_chart-scatter` = Builder(name = "Chart-scatter", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chart-scatter`: ImageVector? = null
