...
public val LightGroup.`Mouse-light`: ImageVector
    get() {
        if (`_mouse-light` != null) {
            return `_mouse-light`!!
        }
        `_mouse-light` = Builder(name = "Mouse-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mouse-light`: ImageVector? = null
