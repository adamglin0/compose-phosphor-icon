...
public val RegularGroup.`Phone-outgoing`: ImageVector
    get() {
        if (`_phone-outgoing` != null) {
            return `_phone-outgoing`!!
        }
        `_phone-outgoing` = Builder(name = "Phone-outgoing", defaultWidth = 256.0.dp, defaultHeight
...
private var `_phone-outgoing`: ImageVector? = null
