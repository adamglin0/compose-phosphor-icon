...
public val DuotoneGroup.`Speaker-high-duotone`: ImageVector
    get() {
        if (`_speaker-high-duotone` != null) {
            return `_speaker-high-duotone`!!
        }
        `_speaker-high-duotone` = Builder(name = "Speaker-high-duotone", defaultWidth = 256.0.dp,
...
private var `_speaker-high-duotone`: ImageVector? = null
