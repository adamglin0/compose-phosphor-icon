...
public val BoldGroup.`Medal-military-bold`: ImageVector
    get() {
        if (`_medal-military-bold` != null) {
            return `_medal-military-bold`!!
        }
        `_medal-military-bold` = Builder(name = "Medal-military-bold", defaultWidth = 256.0.dp,
...
private var `_medal-military-bold`: ImageVector? = null
