...
public val DuotoneGroup.`Beanie-duotone`: ImageVector
    get() {
        if (`_beanie-duotone` != null) {
            return `_beanie-duotone`!!
        }
        `_beanie-duotone` = Builder(name = "Beanie-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_beanie-duotone`: ImageVector? = null
