...
public val ThinGroup.`File-ppt-thin`: ImageVector
    get() {
        if (`_file-ppt-thin` != null) {
            return `_file-ppt-thin`!!
        }
        `_file-ppt-thin` = Builder(name = "File-ppt-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-ppt-thin`: ImageVector? = null
