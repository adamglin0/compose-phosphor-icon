...
public val BoldGroup.`Jar-bold`: ImageVector
    get() {
        if (`_jar-bold` != null) {
            return `_jar-bold`!!
        }
        `_jar-bold` = Builder(name = "Jar-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_jar-bold`: ImageVector? = null
