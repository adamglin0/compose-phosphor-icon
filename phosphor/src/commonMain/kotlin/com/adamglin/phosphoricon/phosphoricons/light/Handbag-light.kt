...
public val LightGroup.`Handbag-light`: ImageVector
    get() {
        if (`_handbag-light` != null) {
            return `_handbag-light`!!
        }
        `_handbag-light` = Builder(name = "Handbag-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_handbag-light`: ImageVector? = null
