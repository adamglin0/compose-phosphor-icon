...
public val DuotoneGroup.`Network-x-duotone`: ImageVector
    get() {
        if (`_network-x-duotone` != null) {
            return `_network-x-duotone`!!
        }
        `_network-x-duotone` = Builder(name = "Network-x-duotone", defaultWidth = 256.0.dp,
...
private var `_network-x-duotone`: ImageVector? = null
