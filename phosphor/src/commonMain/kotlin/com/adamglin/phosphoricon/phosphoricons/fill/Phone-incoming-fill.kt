...
public val FillGroup.`Phone-incoming-fill`: ImageVector
    get() {
        if (`_phone-incoming-fill` != null) {
            return `_phone-incoming-fill`!!
        }
        `_phone-incoming-fill` = Builder(name = "Phone-incoming-fill", defaultWidth = 256.0.dp,
...
private var `_phone-incoming-fill`: ImageVector? = null
