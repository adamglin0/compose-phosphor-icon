...
public val LightGroup.`Webcam-slash-light`: ImageVector
    get() {
        if (`_webcam-slash-light` != null) {
            return `_webcam-slash-light`!!
        }
        `_webcam-slash-light` = Builder(name = "Webcam-slash-light", defaultWidth = 256.0.dp,
...
private var `_webcam-slash-light`: ImageVector? = null
