...
public val LightGroup.`User-circle-plus-light`: ImageVector
    get() {
        if (`_user-circle-plus-light` != null) {
            return `_user-circle-plus-light`!!
        }
        `_user-circle-plus-light` = Builder(name = "User-circle-plus-light", defaultWidth =
...
private var `_user-circle-plus-light`: ImageVector? = null
