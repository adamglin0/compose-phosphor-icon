...
public val LightGroup.`Google-photos-logo-light`: ImageVector
    get() {
        if (`_google-photos-logo-light` != null) {
            return `_google-photos-logo-light`!!
        }
        `_google-photos-logo-light` = Builder(name = "Google-photos-logo-light", defaultWidth =
...
private var `_google-photos-logo-light`: ImageVector? = null
