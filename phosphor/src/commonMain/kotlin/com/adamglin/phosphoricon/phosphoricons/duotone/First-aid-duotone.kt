...
public val DuotoneGroup.`First-aid-duotone`: ImageVector
    get() {
        if (`_first-aid-duotone` != null) {
            return `_first-aid-duotone`!!
        }
        `_first-aid-duotone` = Builder(name = "First-aid-duotone", defaultWidth = 256.0.dp,
...
private var `_first-aid-duotone`: ImageVector? = null
