...
public val DuotoneGroup.`Lego-smiley-duotone`: ImageVector
    get() {
        if (`_lego-smiley-duotone` != null) {
            return `_lego-smiley-duotone`!!
        }
        `_lego-smiley-duotone` = Builder(name = "Lego-smiley-duotone", defaultWidth = 256.0.dp,
...
private var `_lego-smiley-duotone`: ImageVector? = null
