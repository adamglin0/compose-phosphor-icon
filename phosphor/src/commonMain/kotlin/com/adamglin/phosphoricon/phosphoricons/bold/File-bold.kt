...
public val BoldGroup.`File-bold`: ImageVector
    get() {
        if (`_file-bold` != null) {
            return `_file-bold`!!
        }
        `_file-bold` = Builder(name = "File-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-bold`: ImageVector? = null
