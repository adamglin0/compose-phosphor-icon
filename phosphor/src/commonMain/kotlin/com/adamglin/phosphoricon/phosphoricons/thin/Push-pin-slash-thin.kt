...
public val ThinGroup.`Push-pin-slash-thin`: ImageVector
    get() {
        if (`_push-pin-slash-thin` != null) {
            return `_push-pin-slash-thin`!!
        }
        `_push-pin-slash-thin` = Builder(name = "Push-pin-slash-thin", defaultWidth = 256.0.dp,
...
private var `_push-pin-slash-thin`: ImageVector? = null
