...
public val DuotoneGroup.`Map-pin-duotone`: ImageVector
    get() {
        if (`_map-pin-duotone` != null) {
            return `_map-pin-duotone`!!
        }
        `_map-pin-duotone` = Builder(name = "Map-pin-duotone", defaultWidth = 256.0.dp,
...
private var `_map-pin-duotone`: ImageVector? = null
