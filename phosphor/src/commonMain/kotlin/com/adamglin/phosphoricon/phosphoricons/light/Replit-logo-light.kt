...
public val LightGroup.`Replit-logo-light`: ImageVector
    get() {
        if (`_replit-logo-light` != null) {
            return `_replit-logo-light`!!
        }
        `_replit-logo-light` = Builder(name = "Replit-logo-light", defaultWidth = 256.0.dp,
...
private var `_replit-logo-light`: ImageVector? = null
