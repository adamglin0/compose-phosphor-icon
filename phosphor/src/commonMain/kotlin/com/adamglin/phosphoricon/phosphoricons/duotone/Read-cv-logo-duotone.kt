...
public val DuotoneGroup.`Read-cv-logo-duotone`: ImageVector
    get() {
        if (`_read-cv-logo-duotone` != null) {
            return `_read-cv-logo-duotone`!!
        }
        `_read-cv-logo-duotone` = Builder(name = "Read-cv-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_read-cv-logo-duotone`: ImageVector? = null
