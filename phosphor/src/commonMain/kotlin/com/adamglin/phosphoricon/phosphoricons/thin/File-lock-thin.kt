...
public val ThinGroup.`File-lock-thin`: ImageVector
    get() {
        if (`_file-lock-thin` != null) {
            return `_file-lock-thin`!!
        }
        `_file-lock-thin` = Builder(name = "File-lock-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-lock-thin`: ImageVector? = null
