...
public val DuotoneGroup.`Tilde-duotone`: ImageVector
    get() {
        if (`_tilde-duotone` != null) {
            return `_tilde-duotone`!!
        }
        `_tilde-duotone` = Builder(name = "Tilde-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tilde-duotone`: ImageVector? = null
