...
public val DuotoneGroup.`Hand-pointing-duotone`: ImageVector
    get() {
        if (`_hand-pointing-duotone` != null) {
            return `_hand-pointing-duotone`!!
        }
        `_hand-pointing-duotone` = Builder(name = "Hand-pointing-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-pointing-duotone`: ImageVector? = null
