...
public val BoldGroup.`Poker-chip-bold`: ImageVector
    get() {
        if (`_poker-chip-bold` != null) {
            return `_poker-chip-bold`!!
        }
        `_poker-chip-bold` = Builder(name = "Poker-chip-bold", defaultWidth = 256.0.dp,
...
private var `_poker-chip-bold`: ImageVector? = null
