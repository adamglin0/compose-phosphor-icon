...
public val BoldGroup.`Currency-gbp-bold`: ImageVector
    get() {
        if (`_currency-gbp-bold` != null) {
            return `_currency-gbp-bold`!!
        }
        `_currency-gbp-bold` = Builder(name = "Currency-gbp-bold", defaultWidth = 256.0.dp,
...
private var `_currency-gbp-bold`: ImageVector? = null
