...
public val LightGroup.`Film-strip-light`: ImageVector
    get() {
        if (`_film-strip-light` != null) {
            return `_film-strip-light`!!
        }
        `_film-strip-light` = Builder(name = "Film-strip-light", defaultWidth = 256.0.dp,
...
private var `_film-strip-light`: ImageVector? = null
