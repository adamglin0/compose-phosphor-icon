...
public val ThinGroup.`Greater-than-or-equal-thin`: ImageVector
    get() {
        if (`_greater-than-or-equal-thin` != null) {
            return `_greater-than-or-equal-thin`!!
        }
        `_greater-than-or-equal-thin` = Builder(name = "Greater-than-or-equal-thin", defaultWidth =
...
private var `_greater-than-or-equal-thin`: ImageVector? = null
