...
public val FillGroup.`Chats-fill`: ImageVector
    get() {
        if (`_chats-fill` != null) {
            return `_chats-fill`!!
        }
        `_chats-fill` = Builder(name = "Chats-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chats-fill`: ImageVector? = null
