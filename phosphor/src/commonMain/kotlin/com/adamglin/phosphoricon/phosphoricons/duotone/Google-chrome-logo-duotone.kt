...
public val DuotoneGroup.`Google-chrome-logo-duotone`: ImageVector
    get() {
        if (`_google-chrome-logo-duotone` != null) {
            return `_google-chrome-logo-duotone`!!
        }
        `_google-chrome-logo-duotone` = Builder(name = "Google-chrome-logo-duotone", defaultWidth =
...
private var `_google-chrome-logo-duotone`: ImageVector? = null
