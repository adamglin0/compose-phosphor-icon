...
public val DuotoneGroup.`Speaker-simple-slash-duotone`: ImageVector
    get() {
        if (`_speaker-simple-slash-duotone` != null) {
            return `_speaker-simple-slash-duotone`!!
        }
        `_speaker-simple-slash-duotone` = Builder(name = "Speaker-simple-slash-duotone",
...
private var `_speaker-simple-slash-duotone`: ImageVector? = null
