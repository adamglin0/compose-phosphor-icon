...
public val DuotoneGroup.`Share-duotone`: ImageVector
    get() {
        if (`_share-duotone` != null) {
            return `_share-duotone`!!
        }
        `_share-duotone` = Builder(name = "Share-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_share-duotone`: ImageVector? = null
