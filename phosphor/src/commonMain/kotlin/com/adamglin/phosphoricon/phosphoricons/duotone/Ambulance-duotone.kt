...
public val DuotoneGroup.`Ambulance-duotone`: ImageVector
    get() {
        if (`_ambulance-duotone` != null) {
            return `_ambulance-duotone`!!
        }
        `_ambulance-duotone` = Builder(name = "Ambulance-duotone", defaultWidth = 256.0.dp,
...
private var `_ambulance-duotone`: ImageVector? = null
