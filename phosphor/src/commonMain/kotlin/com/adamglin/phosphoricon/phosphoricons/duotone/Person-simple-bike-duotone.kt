...
public val DuotoneGroup.`Person-simple-bike-duotone`: ImageVector
    get() {
        if (`_person-simple-bike-duotone` != null) {
            return `_person-simple-bike-duotone`!!
        }
        `_person-simple-bike-duotone` = Builder(name = "Person-simple-bike-duotone", defaultWidth =
...
private var `_person-simple-bike-duotone`: ImageVector? = null
