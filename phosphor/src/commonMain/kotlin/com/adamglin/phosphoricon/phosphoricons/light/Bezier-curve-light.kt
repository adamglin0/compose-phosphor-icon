...
public val LightGroup.`Bezier-curve-light`: ImageVector
    get() {
        if (`_bezier-curve-light` != null) {
            return `_bezier-curve-light`!!
        }
        `_bezier-curve-light` = Builder(name = "Bezier-curve-light", defaultWidth = 256.0.dp,
...
private var `_bezier-curve-light`: ImageVector? = null
