...
public val DuotoneGroup.`Identification-badge-duotone`: ImageVector
    get() {
        if (`_identification-badge-duotone` != null) {
            return `_identification-badge-duotone`!!
        }
        `_identification-badge-duotone` = Builder(name = "Identification-badge-duotone",
...
private var `_identification-badge-duotone`: ImageVector? = null
