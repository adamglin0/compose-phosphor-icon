...
public val BoldGroup.`Cloud-arrow-up-bold`: ImageVector
    get() {
        if (`_cloud-arrow-up-bold` != null) {
            return `_cloud-arrow-up-bold`!!
        }
        `_cloud-arrow-up-bold` = Builder(name = "Cloud-arrow-up-bold", defaultWidth = 256.0.dp,
...
private var `_cloud-arrow-up-bold`: ImageVector? = null
