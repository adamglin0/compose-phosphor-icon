...
public val DuotoneGroup.`Joystick-duotone`: ImageVector
    get() {
        if (`_joystick-duotone` != null) {
            return `_joystick-duotone`!!
        }
        `_joystick-duotone` = Builder(name = "Joystick-duotone", defaultWidth = 256.0.dp,
...
private var `_joystick-duotone`: ImageVector? = null
