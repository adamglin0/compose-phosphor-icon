...
public val FillGroup.`Scan-smiley-fill`: ImageVector
    get() {
        if (`_scan-smiley-fill` != null) {
            return `_scan-smiley-fill`!!
        }
        `_scan-smiley-fill` = Builder(name = "Scan-smiley-fill", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(12.0f, 12.0f, 0.0f, false, false, 104.0f, 128.0f)
                close()
                moveTo(158.0f, 146.71f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.29f, -0.71f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, false, 158.0f, 146.71f)
                close()
...
private var `_scan-smiley-fill`: ImageVector? = null
