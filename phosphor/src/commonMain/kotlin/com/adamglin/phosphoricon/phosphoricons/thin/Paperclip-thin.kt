...
public val ThinGroup.`Paperclip-thin`: ImageVector
    get() {
        if (`_paperclip-thin` != null) {
            return `_paperclip-thin`!!
        }
        `_paperclip-thin` = Builder(name = "Paperclip-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_paperclip-thin`: ImageVector? = null
