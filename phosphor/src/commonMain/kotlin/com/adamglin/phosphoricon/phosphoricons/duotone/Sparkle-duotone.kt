...
public val DuotoneGroup.`Sparkle-duotone`: ImageVector
    get() {
        if (`_sparkle-duotone` != null) {
            return `_sparkle-duotone`!!
        }
        `_sparkle-duotone` = Builder(name = "Sparkle-duotone", defaultWidth = 256.0.dp,
...
private var `_sparkle-duotone`: ImageVector? = null
