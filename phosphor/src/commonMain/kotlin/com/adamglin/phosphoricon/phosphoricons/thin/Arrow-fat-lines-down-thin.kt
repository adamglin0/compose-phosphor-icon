...
public val ThinGroup.`Arrow-fat-lines-down-thin`: ImageVector
    get() {
        if (`_arrow-fat-lines-down-thin` != null) {
            return `_arrow-fat-lines-down-thin`!!
        }
        `_arrow-fat-lines-down-thin` = Builder(name = "Arrow-fat-lines-down-thin", defaultWidth =
...
private var `_arrow-fat-lines-down-thin`: ImageVector? = null
