...
public val RegularGroup.`Heart-straight`: ImageVector
    get() {
        if (`_heart-straight` != null) {
            return `_heart-straight`!!
        }
        `_heart-straight` = Builder(name = "Heart-straight", defaultWidth = 256.0.dp, defaultHeight
...
private var `_heart-straight`: ImageVector? = null
