...
public val DuotoneGroup.`Tray-arrow-down-duotone`: ImageVector
    get() {
        if (`_tray-arrow-down-duotone` != null) {
            return `_tray-arrow-down-duotone`!!
        }
        `_tray-arrow-down-duotone` = Builder(name = "Tray-arrow-down-duotone", defaultWidth =
...
private var `_tray-arrow-down-duotone`: ImageVector? = null
