...
public val BoldGroup.`Caret-circle-double-up-bold`: ImageVector
    get() {
        if (`_caret-circle-double-up-bold` != null) {
            return `_caret-circle-double-up-bold`!!
        }
        `_caret-circle-double-up-bold` = Builder(name = "Caret-circle-double-up-bold", defaultWidth
...
private var `_caret-circle-double-up-bold`: ImageVector? = null
