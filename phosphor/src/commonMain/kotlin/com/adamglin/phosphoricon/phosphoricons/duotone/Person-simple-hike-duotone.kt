...
public val DuotoneGroup.`Person-simple-hike-duotone`: ImageVector
    get() {
        if (`_person-simple-hike-duotone` != null) {
            return `_person-simple-hike-duotone`!!
        }
        `_person-simple-hike-duotone` = Builder(name = "Person-simple-hike-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(7.68f, 11.84f, 13.23f, 20.4f, 36.6f, 20.4f)
...
private var `_person-simple-hike-duotone`: ImageVector? = null
