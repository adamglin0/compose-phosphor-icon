...
public val DuotoneGroup.`Closed-captioning-duotone`: ImageVector
    get() {
        if (`_closed-captioning-duotone` != null) {
            return `_closed-captioning-duotone`!!
        }
        `_closed-captioning-duotone` = Builder(name = "Closed-captioning-duotone", defaultWidth =
...
private var `_closed-captioning-duotone`: ImageVector? = null
