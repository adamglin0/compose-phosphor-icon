...
public val ThinGroup.`Watch-thin`: ImageVector
    get() {
        if (`_watch-thin` != null) {
            return `_watch-thin`!!
        }
        `_watch-thin` = Builder(name = "Watch-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_watch-thin`: ImageVector? = null
