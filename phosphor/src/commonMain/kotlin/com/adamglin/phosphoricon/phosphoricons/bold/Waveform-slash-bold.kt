...
public val BoldGroup.`Waveform-slash-bold`: ImageVector
    get() {
        if (`_waveform-slash-bold` != null) {
            return `_waveform-slash-bold`!!
        }
        `_waveform-slash-bold` = Builder(name = "Waveform-slash-bold", defaultWidth = 256.0.dp,
...
private var `_waveform-slash-bold`: ImageVector? = null
