...
public val ThinGroup.`Text-h-four-thin`: ImageVector
    get() {
        if (`_text-h-four-thin` != null) {
            return `_text-h-four-thin`!!
        }
        `_text-h-four-thin` = Builder(name = "Text-h-four-thin", defaultWidth = 256.0.dp,
...
private var `_text-h-four-thin`: ImageVector? = null
