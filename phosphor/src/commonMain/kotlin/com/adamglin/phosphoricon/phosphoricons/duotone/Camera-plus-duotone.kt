...
public val DuotoneGroup.`Camera-plus-duotone`: ImageVector
    get() {
        if (`_camera-plus-duotone` != null) {
            return `_camera-plus-duotone`!!
        }
        `_camera-plus-duotone` = Builder(name = "Camera-plus-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                lineTo(93.62f, 43.56f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 100.28f, 40.0f)
...
private var `_camera-plus-duotone`: ImageVector? = null
