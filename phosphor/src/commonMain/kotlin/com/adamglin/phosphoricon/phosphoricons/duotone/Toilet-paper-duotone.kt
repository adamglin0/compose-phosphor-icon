...
public val DuotoneGroup.`Toilet-paper-duotone`: ImageVector
    get() {
        if (`_toilet-paper-duotone` != null) {
            return `_toilet-paper-duotone`!!
        }
        `_toilet-paper-duotone` = Builder(name = "Toilet-paper-duotone", defaultWidth = 256.0.dp,
...
private var `_toilet-paper-duotone`: ImageVector? = null
