...
public val LightGroup.`Identification-badge-light`: ImageVector
    get() {
        if (`_identification-badge-light` != null) {
            return `_identification-badge-light`!!
        }
        `_identification-badge-light` = Builder(name = "Identification-badge-light", defaultWidth =
...
private var `_identification-badge-light`: ImageVector? = null
