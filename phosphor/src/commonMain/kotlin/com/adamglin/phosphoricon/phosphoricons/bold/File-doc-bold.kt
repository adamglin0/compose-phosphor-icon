...
public val BoldGroup.`File-doc-bold`: ImageVector
    get() {
        if (`_file-doc-bold` != null) {
            return `_file-doc-bold`!!
        }
        `_file-doc-bold` = Builder(name = "File-doc-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-doc-bold`: ImageVector? = null
