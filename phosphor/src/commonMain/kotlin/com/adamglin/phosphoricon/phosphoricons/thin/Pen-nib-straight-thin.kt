...
public val ThinGroup.`Pen-nib-straight-thin`: ImageVector
    get() {
        if (`_pen-nib-straight-thin` != null) {
            return `_pen-nib-straight-thin`!!
        }
        `_pen-nib-straight-thin` = Builder(name = "Pen-nib-straight-thin", defaultWidth = 256.0.dp,
...
private var `_pen-nib-straight-thin`: ImageVector? = null
