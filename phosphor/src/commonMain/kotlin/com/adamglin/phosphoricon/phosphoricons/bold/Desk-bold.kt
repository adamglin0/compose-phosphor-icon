...
public val BoldGroup.`Desk-bold`: ImageVector
    get() {
        if (`_desk-bold` != null) {
            return `_desk-bold`!!
        }
        `_desk-bold` = Builder(name = "Desk-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_desk-bold`: ImageVector? = null
