...
public val LightGroup.`Arrow-fat-right-light`: ImageVector
    get() {
        if (`_arrow-fat-right-light` != null) {
            return `_arrow-fat-right-light`!!
        }
        `_arrow-fat-right-light` = Builder(name = "Arrow-fat-right-light", defaultWidth = 256.0.dp,
...
private var `_arrow-fat-right-light`: ImageVector? = null
