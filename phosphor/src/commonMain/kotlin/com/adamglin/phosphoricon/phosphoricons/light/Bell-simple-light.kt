...
public val LightGroup.`Bell-simple-light`: ImageVector
    get() {
        if (`_bell-simple-light` != null) {
            return `_bell-simple-light`!!
        }
        `_bell-simple-light` = Builder(name = "Bell-simple-light", defaultWidth = 256.0.dp,
...
private var `_bell-simple-light`: ImageVector? = null
