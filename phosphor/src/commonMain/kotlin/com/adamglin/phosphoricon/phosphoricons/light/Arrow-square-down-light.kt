...
public val LightGroup.`Arrow-square-down-light`: ImageVector
    get() {
        if (`_arrow-square-down-light` != null) {
            return `_arrow-square-down-light`!!
        }
        `_arrow-square-down-light` = Builder(name = "Arrow-square-down-light", defaultWidth =
...
private var `_arrow-square-down-light`: ImageVector? = null
