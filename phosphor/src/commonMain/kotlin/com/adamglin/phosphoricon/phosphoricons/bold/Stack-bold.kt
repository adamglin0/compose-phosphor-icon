...
public val BoldGroup.`Stack-bold`: ImageVector
    get() {
        if (`_stack-bold` != null) {
            return `_stack-bold`!!
        }
        `_stack-bold` = Builder(name = "Stack-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stack-bold`: ImageVector? = null
