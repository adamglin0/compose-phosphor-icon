...
public val LightGroup.`Alien-light`: ImageVector
    get() {
        if (`_alien-light` != null) {
            return `_alien-light`!!
        }
        `_alien-light` = Builder(name = "Alien-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_alien-light`: ImageVector? = null
