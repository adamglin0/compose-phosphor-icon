...
public val ThinGroup.`Number-circle-zero-thin`: ImageVector
    get() {
        if (`_number-circle-zero-thin` != null) {
            return `_number-circle-zero-thin`!!
        }
        `_number-circle-zero-thin` = Builder(name = "Number-circle-zero-thin", defaultWidth =
...
private var `_number-circle-zero-thin`: ImageVector? = null
