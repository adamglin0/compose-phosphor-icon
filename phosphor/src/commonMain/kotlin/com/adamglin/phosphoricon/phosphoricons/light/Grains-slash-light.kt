...
public val LightGroup.`Grains-slash-light`: ImageVector
    get() {
        if (`_grains-slash-light` != null) {
            return `_grains-slash-light`!!
        }
        `_grains-slash-light` = Builder(name = "Grains-slash-light", defaultWidth = 256.0.dp,
...
private var `_grains-slash-light`: ImageVector? = null
