...
public val BoldGroup.`User-rectangle-bold`: ImageVector
    get() {
        if (`_user-rectangle-bold` != null) {
            return `_user-rectangle-bold`!!
        }
        `_user-rectangle-bold` = Builder(name = "User-rectangle-bold", defaultWidth = 256.0.dp,
...
private var `_user-rectangle-bold`: ImageVector? = null
