...
public val FillGroup.`Gif-fill`: ImageVector
    get() {
        if (`_gif-fill` != null) {
            return `_gif-fill`!!
        }
        `_gif-fill` = Builder(name = "Gif-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_gif-fill`: ImageVector? = null
