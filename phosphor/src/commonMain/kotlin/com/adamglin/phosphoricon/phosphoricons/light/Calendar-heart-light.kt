...
public val LightGroup.`Calendar-heart-light`: ImageVector
    get() {
        if (`_calendar-heart-light` != null) {
            return `_calendar-heart-light`!!
        }
        `_calendar-heart-light` = Builder(name = "Calendar-heart-light", defaultWidth = 256.0.dp,
...
private var `_calendar-heart-light`: ImageVector? = null
