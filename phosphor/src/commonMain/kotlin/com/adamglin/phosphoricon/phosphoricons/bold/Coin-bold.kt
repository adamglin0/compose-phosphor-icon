...
public val BoldGroup.`Coin-bold`: ImageVector
    get() {
        if (`_coin-bold` != null) {
            return `_coin-bold`!!
        }
        `_coin-bold` = Builder(name = "Coin-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coin-bold`: ImageVector? = null
