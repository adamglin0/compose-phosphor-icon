...
public val BoldGroup.`Three-d-bold`: ImageVector
    get() {
        if (`_three-d-bold` != null) {
            return `_three-d-bold`!!
        }
        `_three-d-bold` = Builder(name = "Three-d-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_three-d-bold`: ImageVector? = null
