...
public val DuotoneGroup.`File-magnifying-glass-duotone`: ImageVector
    get() {
        if (`_file-magnifying-glass-duotone` != null) {
            return `_file-magnifying-glass-duotone`!!
        }
        `_file-magnifying-glass-duotone` = Builder(name = "File-magnifying-glass-duotone",
...
private var `_file-magnifying-glass-duotone`: ImageVector? = null
