...
public val ThinGroup.`Repeat-thin`: ImageVector
    get() {
        if (`_repeat-thin` != null) {
            return `_repeat-thin`!!
        }
        `_repeat-thin` = Builder(name = "Repeat-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_repeat-thin`: ImageVector? = null
