...
public val DuotoneGroup.`Cricket-duotone`: ImageVector
    get() {
        if (`_cricket-duotone` != null) {
            return `_cricket-duotone`!!
        }
        `_cricket-duotone` = Builder(name = "Cricket-duotone", defaultWidth = 256.0.dp,
...
private var `_cricket-duotone`: ImageVector? = null
