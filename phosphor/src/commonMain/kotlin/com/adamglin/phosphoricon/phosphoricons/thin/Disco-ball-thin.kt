...
public val ThinGroup.`Disco-ball-thin`: ImageVector
    get() {
        if (`_disco-ball-thin` != null) {
            return `_disco-ball-thin`!!
        }
        `_disco-ball-thin` = Builder(name = "Disco-ball-thin", defaultWidth = 256.0.dp,
...
private var `_disco-ball-thin`: ImageVector? = null
