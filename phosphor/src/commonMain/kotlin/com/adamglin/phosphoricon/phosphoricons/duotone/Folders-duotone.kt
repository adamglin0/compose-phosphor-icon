...
public val DuotoneGroup.`Folders-duotone`: ImageVector
    get() {
        if (`_folders-duotone` != null) {
            return `_folders-duotone`!!
        }
        `_folders-duotone` = Builder(name = "Folders-duotone", defaultWidth = 256.0.dp,
...
private var `_folders-duotone`: ImageVector? = null
