...
public val DuotoneGroup.`Link-duotone`: ImageVector
    get() {
        if (`_link-duotone` != null) {
            return `_link-duotone`!!
        }
        `_link-duotone` = Builder(name = "Link-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_link-duotone`: ImageVector? = null
