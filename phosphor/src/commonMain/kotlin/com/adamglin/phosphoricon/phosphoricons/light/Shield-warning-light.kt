...
public val LightGroup.`Shield-warning-light`: ImageVector
    get() {
        if (`_shield-warning-light` != null) {
            return `_shield-warning-light`!!
        }
        `_shield-warning-light` = Builder(name = "Shield-warning-light", defaultWidth = 256.0.dp,
...
private var `_shield-warning-light`: ImageVector? = null
