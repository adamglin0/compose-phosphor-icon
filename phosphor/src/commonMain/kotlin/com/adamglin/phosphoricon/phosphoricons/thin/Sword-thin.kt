...
public val ThinGroup.`Sword-thin`: ImageVector
    get() {
        if (`_sword-thin` != null) {
            return `_sword-thin`!!
        }
        `_sword-thin` = Builder(name = "Sword-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sword-thin`: ImageVector? = null
