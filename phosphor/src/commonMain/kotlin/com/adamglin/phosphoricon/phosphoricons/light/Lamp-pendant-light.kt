...
public val LightGroup.`Lamp-pendant-light`: ImageVector
    get() {
        if (`_lamp-pendant-light` != null) {
            return `_lamp-pendant-light`!!
        }
        `_lamp-pendant-light` = Builder(name = "Lamp-pendant-light", defaultWidth = 256.0.dp,
...
private var `_lamp-pendant-light`: ImageVector? = null
