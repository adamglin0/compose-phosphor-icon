...
public val LightGroup.`Avocado-light`: ImageVector
    get() {
        if (`_avocado-light` != null) {
            return `_avocado-light`!!
        }
        `_avocado-light` = Builder(name = "Avocado-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_avocado-light`: ImageVector? = null
