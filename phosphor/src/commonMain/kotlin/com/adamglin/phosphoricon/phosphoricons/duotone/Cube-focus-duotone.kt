...
public val DuotoneGroup.`Cube-focus-duotone`: ImageVector
    get() {
        if (`_cube-focus-duotone` != null) {
            return `_cube-focus-duotone`!!
        }
        `_cube-focus-duotone` = Builder(name = "Cube-focus-duotone", defaultWidth = 256.0.dp,
...
private var `_cube-focus-duotone`: ImageVector? = null
