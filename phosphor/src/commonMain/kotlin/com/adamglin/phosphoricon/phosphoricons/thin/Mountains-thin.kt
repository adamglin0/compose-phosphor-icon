...
public val ThinGroup.`Mountains-thin`: ImageVector
    get() {
        if (`_mountains-thin` != null) {
            return `_mountains-thin`!!
        }
        `_mountains-thin` = Builder(name = "Mountains-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_mountains-thin`: ImageVector? = null
