...
public val BoldGroup.`Speaker-x-bold`: ImageVector
    get() {
        if (`_speaker-x-bold` != null) {
            return `_speaker-x-bold`!!
        }
        `_speaker-x-bold` = Builder(name = "Speaker-x-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_speaker-x-bold`: ImageVector? = null
