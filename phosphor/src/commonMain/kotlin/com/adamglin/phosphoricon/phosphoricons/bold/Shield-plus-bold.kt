...
public val BoldGroup.`Shield-plus-bold`: ImageVector
    get() {
        if (`_shield-plus-bold` != null) {
            return `_shield-plus-bold`!!
        }
        `_shield-plus-bold` = Builder(name = "Shield-plus-bold", defaultWidth = 256.0.dp,
...
private var `_shield-plus-bold`: ImageVector? = null
