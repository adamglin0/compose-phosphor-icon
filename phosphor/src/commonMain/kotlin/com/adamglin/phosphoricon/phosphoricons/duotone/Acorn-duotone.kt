...
public val DuotoneGroup.`Acorn-duotone`: ImageVector
    get() {
        if (`_acorn-duotone` != null) {
            return `_acorn-duotone`!!
        }
        `_acorn-duotone` = Builder(name = "Acorn-duotone", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 53.0f, -88.0f, 88.0f, -88.0f, 112.0f)
                curveToRelative(0.0f, -24.0f, -88.0f, -59.0f, -88.0f, -112.0f)
...
private var `_acorn-duotone`: ImageVector? = null
