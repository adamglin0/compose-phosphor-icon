...
public val LightGroup.`Currency-inr-light`: ImageVector
    get() {
        if (`_currency-inr-light` != null) {
            return `_currency-inr-light`!!
        }
        `_currency-inr-light` = Builder(name = "Currency-inr-light", defaultWidth = 256.0.dp,
...
private var `_currency-inr-light`: ImageVector? = null
