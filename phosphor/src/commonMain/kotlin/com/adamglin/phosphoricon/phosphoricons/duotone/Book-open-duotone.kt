...
public val DuotoneGroup.`Book-open-duotone`: ImageVector
    get() {
        if (`_book-open-duotone` != null) {
            return `_book-open-duotone`!!
        }
        `_book-open-duotone` = Builder(name = "Book-open-duotone", defaultWidth = 256.0.dp,
...
private var `_book-open-duotone`: ImageVector? = null
