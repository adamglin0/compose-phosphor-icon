...
public val DuotoneGroup.`Cell-signal-x-duotone`: ImageVector
    get() {
        if (`_cell-signal-x-duotone` != null) {
            return `_cell-signal-x-duotone`!!
        }
        `_cell-signal-x-duotone` = Builder(name = "Cell-signal-x-duotone", defaultWidth = 256.0.dp,
...
private var `_cell-signal-x-duotone`: ImageVector? = null
