...
public val RegularGroup.`Contactless-payment`: ImageVector
    get() {
        if (`_contactless-payment` != null) {
            return `_contactless-payment`!!
        }
        `_contactless-payment` = Builder(name = "Contactless-payment", defaultWidth = 256.0.dp,
...
private var `_contactless-payment`: ImageVector? = null
