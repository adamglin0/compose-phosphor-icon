...
public val RegularGroup.`Chat-centered-text`: ImageVector
    get() {
        if (`_chat-centered-text` != null) {
            return `_chat-centered-text`!!
        }
        `_chat-centered-text` = Builder(name = "Chat-centered-text", defaultWidth = 256.0.dp,
...
private var `_chat-centered-text`: ImageVector? = null
