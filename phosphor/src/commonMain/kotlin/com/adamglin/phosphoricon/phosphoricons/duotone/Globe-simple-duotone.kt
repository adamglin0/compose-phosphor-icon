...
public val DuotoneGroup.`Globe-simple-duotone`: ImageVector
    get() {
        if (`_globe-simple-duotone` != null) {
            return `_globe-simple-duotone`!!
        }
        `_globe-simple-duotone` = Builder(name = "Globe-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_globe-simple-duotone`: ImageVector? = null
