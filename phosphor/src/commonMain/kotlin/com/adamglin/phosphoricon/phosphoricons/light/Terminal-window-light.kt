...
public val LightGroup.`Terminal-window-light`: ImageVector
    get() {
        if (`_terminal-window-light` != null) {
            return `_terminal-window-light`!!
        }
        `_terminal-window-light` = Builder(name = "Terminal-window-light", defaultWidth = 256.0.dp,
...
private var `_terminal-window-light`: ImageVector? = null
