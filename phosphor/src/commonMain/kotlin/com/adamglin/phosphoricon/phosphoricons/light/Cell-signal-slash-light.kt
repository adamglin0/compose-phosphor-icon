...
public val LightGroup.`Cell-signal-slash-light`: ImageVector
    get() {
        if (`_cell-signal-slash-light` != null) {
            return `_cell-signal-slash-light`!!
        }
        `_cell-signal-slash-light` = Builder(name = "Cell-signal-slash-light", defaultWidth =
...
private var `_cell-signal-slash-light`: ImageVector? = null
