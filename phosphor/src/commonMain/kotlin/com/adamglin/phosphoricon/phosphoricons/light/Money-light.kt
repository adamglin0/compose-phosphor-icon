...
public val LightGroup.`Money-light`: ImageVector
    get() {
        if (`_money-light` != null) {
            return `_money-light`!!
        }
        `_money-light` = Builder(name = "Money-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_money-light`: ImageVector? = null
