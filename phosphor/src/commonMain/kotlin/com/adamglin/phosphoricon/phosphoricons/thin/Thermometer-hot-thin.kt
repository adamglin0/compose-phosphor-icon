...
public val ThinGroup.`Thermometer-hot-thin`: ImageVector
    get() {
        if (`_thermometer-hot-thin` != null) {
            return `_thermometer-hot-thin`!!
        }
        `_thermometer-hot-thin` = Builder(name = "Thermometer-hot-thin", defaultWidth = 256.0.dp,
...
private var `_thermometer-hot-thin`: ImageVector? = null
