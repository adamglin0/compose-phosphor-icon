...
public val FillGroup.`Bell-simple-z-fill`: ImageVector
    get() {
        if (`_bell-simple-z-fill` != null) {
            return `_bell-simple-z-fill`!!
        }
        `_bell-simple-z-fill` = Builder(name = "Bell-simple-z-fill", defaultWidth = 256.0.dp,
...
private var `_bell-simple-z-fill`: ImageVector? = null
