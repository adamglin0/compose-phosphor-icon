...
public val DuotoneGroup.`Hard-drive-duotone`: ImageVector
    get() {
        if (`_hard-drive-duotone` != null) {
            return `_hard-drive-duotone`!!
        }
        `_hard-drive-duotone` = Builder(name = "Hard-drive-duotone", defaultWidth = 256.0.dp,
...
private var `_hard-drive-duotone`: ImageVector? = null
