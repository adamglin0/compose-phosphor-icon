...
public val DuotoneGroup.`Flip-horizontal-duotone`: ImageVector
    get() {
        if (`_flip-horizontal-duotone` != null) {
            return `_flip-horizontal-duotone`!!
        }
        `_flip-horizontal-duotone` = Builder(name = "Flip-horizontal-duotone", defaultWidth =
...
private var `_flip-horizontal-duotone`: ImageVector? = null
