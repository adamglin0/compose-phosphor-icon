...
public val DuotoneGroup.`Leaf-duotone`: ImageVector
    get() {
        if (`_leaf-duotone` != null) {
            return `_leaf-duotone`!!
        }
        `_leaf-duotone` = Builder(name = "Leaf-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_leaf-duotone`: ImageVector? = null
