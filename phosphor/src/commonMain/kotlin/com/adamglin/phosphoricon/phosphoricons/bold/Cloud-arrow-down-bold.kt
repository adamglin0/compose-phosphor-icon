...
public val BoldGroup.`Cloud-arrow-down-bold`: ImageVector
    get() {
        if (`_cloud-arrow-down-bold` != null) {
            return `_cloud-arrow-down-bold`!!
        }
        `_cloud-arrow-down-bold` = Builder(name = "Cloud-arrow-down-bold", defaultWidth = 256.0.dp,
...
private var `_cloud-arrow-down-bold`: ImageVector? = null
