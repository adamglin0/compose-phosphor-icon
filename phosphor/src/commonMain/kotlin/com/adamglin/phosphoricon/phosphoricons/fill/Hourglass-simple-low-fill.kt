...
public val FillGroup.`Hourglass-simple-low-fill`: ImageVector
    get() {
        if (`_hourglass-simple-low-fill` != null) {
            return `_hourglass-simple-low-fill`!!
        }
        `_hourglass-simple-low-fill` = Builder(name = "Hourglass-simple-low-fill", defaultWidth =
...
private var `_hourglass-simple-low-fill`: ImageVector? = null
