...
public val BoldGroup.`Taxi-bold`: ImageVector
    get() {
        if (`_taxi-bold` != null) {
            return `_taxi-bold`!!
        }
        `_taxi-bold` = Builder(name = "Taxi-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_taxi-bold`: ImageVector? = null
