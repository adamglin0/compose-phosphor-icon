...
public val LightGroup.`Flag-pennant-light`: ImageVector
    get() {
        if (`_flag-pennant-light` != null) {
            return `_flag-pennant-light`!!
        }
        `_flag-pennant-light` = Builder(name = "Flag-pennant-light", defaultWidth = 256.0.dp,
...
private var `_flag-pennant-light`: ImageVector? = null
