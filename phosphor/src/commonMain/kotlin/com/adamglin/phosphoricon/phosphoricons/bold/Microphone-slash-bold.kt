...
public val BoldGroup.`Microphone-slash-bold`: ImageVector
    get() {
        if (`_microphone-slash-bold` != null) {
            return `_microphone-slash-bold`!!
        }
        `_microphone-slash-bold` = Builder(name = "Microphone-slash-bold", defaultWidth = 256.0.dp,
...
private var `_microphone-slash-bold`: ImageVector? = null
