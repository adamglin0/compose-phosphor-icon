...
public val ThinGroup.`Text-h-two-thin`: ImageVector
    get() {
        if (`_text-h-two-thin` != null) {
            return `_text-h-two-thin`!!
        }
        `_text-h-two-thin` = Builder(name = "Text-h-two-thin", defaultWidth = 256.0.dp,
...
private var `_text-h-two-thin`: ImageVector? = null
