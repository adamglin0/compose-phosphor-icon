...
public val ThinGroup.`Projector-screen-thin`: ImageVector
    get() {
        if (`_projector-screen-thin` != null) {
            return `_projector-screen-thin`!!
        }
        `_projector-screen-thin` = Builder(name = "Projector-screen-thin", defaultWidth = 256.0.dp,
...
private var `_projector-screen-thin`: ImageVector? = null
