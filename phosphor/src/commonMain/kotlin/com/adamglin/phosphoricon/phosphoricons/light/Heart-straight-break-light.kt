...
public val LightGroup.`Heart-straight-break-light`: ImageVector
    get() {
        if (`_heart-straight-break-light` != null) {
            return `_heart-straight-break-light`!!
        }
        `_heart-straight-break-light` = Builder(name = "Heart-straight-break-light", defaultWidth =
...
private var `_heart-straight-break-light`: ImageVector? = null
