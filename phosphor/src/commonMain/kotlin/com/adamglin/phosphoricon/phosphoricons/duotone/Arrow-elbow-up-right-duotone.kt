...
public val DuotoneGroup.`Arrow-elbow-up-right-duotone`: ImageVector
    get() {
        if (`_arrow-elbow-up-right-duotone` != null) {
            return `_arrow-elbow-up-right-duotone`!!
        }
        `_arrow-elbow-up-right-duotone` = Builder(name = "Arrow-elbow-up-right-duotone",
...
private var `_arrow-elbow-up-right-duotone`: ImageVector? = null
