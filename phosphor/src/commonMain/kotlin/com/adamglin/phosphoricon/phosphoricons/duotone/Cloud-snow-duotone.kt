...
public val DuotoneGroup.`Cloud-snow-duotone`: ImageVector
    get() {
        if (`_cloud-snow-duotone` != null) {
            return `_cloud-snow-duotone`!!
        }
        `_cloud-snow-duotone` = Builder(name = "Cloud-snow-duotone", defaultWidth = 256.0.dp,
...
private var `_cloud-snow-duotone`: ImageVector? = null
