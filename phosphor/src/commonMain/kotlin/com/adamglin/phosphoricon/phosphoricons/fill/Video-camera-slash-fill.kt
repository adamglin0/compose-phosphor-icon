...
public val FillGroup.`Video-camera-slash-fill`: ImageVector
    get() {
        if (`_video-camera-slash-fill` != null) {
            return `_video-camera-slash-fill`!!
        }
        `_video-camera-slash-fill` = Builder(name = "Video-camera-slash-fill", defaultWidth =
...
private var `_video-camera-slash-fill`: ImageVector? = null
