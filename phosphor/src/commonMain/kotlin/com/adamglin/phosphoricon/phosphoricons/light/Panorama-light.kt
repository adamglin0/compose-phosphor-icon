...
public val LightGroup.`Panorama-light`: ImageVector
    get() {
        if (`_panorama-light` != null) {
            return `_panorama-light`!!
        }
        `_panorama-light` = Builder(name = "Panorama-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_panorama-light`: ImageVector? = null
