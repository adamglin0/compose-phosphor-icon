...
public val ThinGroup.`Bread-thin`: ImageVector
    get() {
        if (`_bread-thin` != null) {
            return `_bread-thin`!!
        }
        `_bread-thin` = Builder(name = "Bread-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bread-thin`: ImageVector? = null
