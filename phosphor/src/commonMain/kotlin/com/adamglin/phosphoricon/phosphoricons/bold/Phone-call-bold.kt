...
public val BoldGroup.`Phone-call-bold`: ImageVector
    get() {
        if (`_phone-call-bold` != null) {
            return `_phone-call-bold`!!
        }
        `_phone-call-bold` = Builder(name = "Phone-call-bold", defaultWidth = 256.0.dp,
...
private var `_phone-call-bold`: ImageVector? = null
