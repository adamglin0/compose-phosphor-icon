...
public val BoldGroup.`Notebook-bold`: ImageVector
    get() {
        if (`_notebook-bold` != null) {
            return `_notebook-bold`!!
        }
        `_notebook-bold` = Builder(name = "Notebook-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_notebook-bold`: ImageVector? = null
