...
public val ThinGroup.`Train-regional-thin`: ImageVector
    get() {
        if (`_train-regional-thin` != null) {
            return `_train-regional-thin`!!
        }
        `_train-regional-thin` = Builder(name = "Train-regional-thin", defaultWidth = 256.0.dp,
...
private var `_train-regional-thin`: ImageVector? = null
