...
public val RegularGroup.`Wheelchair-motion`: ImageVector
    get() {
        if (`_wheelchair-motion` != null) {
            return `_wheelchair-motion`!!
        }
        `_wheelchair-motion` = Builder(name = "Wheelchair-motion", defaultWidth = 256.0.dp,
...
private var `_wheelchair-motion`: ImageVector? = null
