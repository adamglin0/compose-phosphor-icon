...
public val DuotoneGroup.`Phone-x-duotone`: ImageVector
    get() {
        if (`_phone-x-duotone` != null) {
            return `_phone-x-duotone`!!
        }
        `_phone-x-duotone` = Builder(name = "Phone-x-duotone", defaultWidth = 256.0.dp,
...
private var `_phone-x-duotone`: ImageVector? = null
