...
public val LightGroup.`Envelope-open-light`: ImageVector
    get() {
        if (`_envelope-open-light` != null) {
            return `_envelope-open-light`!!
        }
        `_envelope-open-light` = Builder(name = "Envelope-open-light", defaultWidth = 256.0.dp,
...
private var `_envelope-open-light`: ImageVector? = null
