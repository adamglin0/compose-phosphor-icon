...
public val DuotoneGroup.`Battery-vertical-empty-duotone`: ImageVector
    get() {
        if (`_battery-vertical-empty-duotone` != null) {
            return `_battery-vertical-empty-duotone`!!
        }
        `_battery-vertical-empty-duotone` = Builder(name = "Battery-vertical-empty-duotone",
...
private var `_battery-vertical-empty-duotone`: ImageVector? = null
