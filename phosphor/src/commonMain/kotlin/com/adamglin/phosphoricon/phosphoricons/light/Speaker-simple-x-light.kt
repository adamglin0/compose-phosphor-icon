...
public val LightGroup.`Speaker-simple-x-light`: ImageVector
    get() {
        if (`_speaker-simple-x-light` != null) {
            return `_speaker-simple-x-light`!!
        }
        `_speaker-simple-x-light` = Builder(name = "Speaker-simple-x-light", defaultWidth =
...
private var `_speaker-simple-x-light`: ImageVector? = null
