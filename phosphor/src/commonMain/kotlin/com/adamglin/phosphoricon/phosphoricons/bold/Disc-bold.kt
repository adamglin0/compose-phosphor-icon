...
public val BoldGroup.`Disc-bold`: ImageVector
    get() {
        if (`_disc-bold` != null) {
            return `_disc-bold`!!
        }
        `_disc-bold` = Builder(name = "Disc-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_disc-bold`: ImageVector? = null
