...
public val ThinGroup.`Browser-thin`: ImageVector
    get() {
        if (`_browser-thin` != null) {
            return `_browser-thin`!!
        }
        `_browser-thin` = Builder(name = "Browser-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_browser-thin`: ImageVector? = null
