...
public val ThinGroup.`Phone-pause-thin`: ImageVector
    get() {
        if (`_phone-pause-thin` != null) {
            return `_phone-pause-thin`!!
        }
        `_phone-pause-thin` = Builder(name = "Phone-pause-thin", defaultWidth = 256.0.dp,
...
private var `_phone-pause-thin`: ImageVector? = null
