...
public val DuotoneGroup.`Squares-four-duotone`: ImageVector
    get() {
        if (`_squares-four-duotone` != null) {
            return `_squares-four-duotone`!!
        }
        `_squares-four-duotone` = Builder(name = "Squares-four-duotone", defaultWidth = 256.0.dp,
...
private var `_squares-four-duotone`: ImageVector? = null
