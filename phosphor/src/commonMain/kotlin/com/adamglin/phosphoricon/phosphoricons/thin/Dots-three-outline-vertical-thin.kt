...
public val ThinGroup.`Dots-three-outline-vertical-thin`: ImageVector
    get() {
        if (`_dots-three-outline-vertical-thin` != null) {
            return `_dots-three-outline-vertical-thin`!!
        }
        `_dots-three-outline-vertical-thin` = Builder(name = "Dots-three-outline-vertical-thin",
...
private var `_dots-three-outline-vertical-thin`: ImageVector? = null
