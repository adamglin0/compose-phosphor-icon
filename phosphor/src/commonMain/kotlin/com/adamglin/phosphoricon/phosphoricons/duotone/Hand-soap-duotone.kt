...
public val DuotoneGroup.`Hand-soap-duotone`: ImageVector
    get() {
        if (`_hand-soap-duotone` != null) {
            return `_hand-soap-duotone`!!
        }
        `_hand-soap-duotone` = Builder(name = "Hand-soap-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-soap-duotone`: ImageVector? = null
