...
public val ThinGroup.`Eject-simple-thin`: ImageVector
    get() {
        if (`_eject-simple-thin` != null) {
            return `_eject-simple-thin`!!
        }
        `_eject-simple-thin` = Builder(name = "Eject-simple-thin", defaultWidth = 256.0.dp,
...
private var `_eject-simple-thin`: ImageVector? = null
