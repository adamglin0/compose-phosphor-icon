...
public val RegularGroup.`Selection-background`: ImageVector
    get() {
        if (`_selection-background` != null) {
            return `_selection-background`!!
        }
        `_selection-background` = Builder(name = "Selection-background", defaultWidth = 256.0.dp,
...
private var `_selection-background`: ImageVector? = null
