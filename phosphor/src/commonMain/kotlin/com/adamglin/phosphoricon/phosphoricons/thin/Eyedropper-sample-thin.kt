...
public val ThinGroup.`Eyedropper-sample-thin`: ImageVector
    get() {
        if (`_eyedropper-sample-thin` != null) {
            return `_eyedropper-sample-thin`!!
        }
        `_eyedropper-sample-thin` = Builder(name = "Eyedropper-sample-thin", defaultWidth =
...
private var `_eyedropper-sample-thin`: ImageVector? = null
