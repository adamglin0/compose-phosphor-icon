...
public val DuotoneGroup.`Face-mask-duotone`: ImageVector
    get() {
        if (`_face-mask-duotone` != null) {
            return `_face-mask-duotone`!!
        }
        `_face-mask-duotone` = Builder(name = "Face-mask-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                curveToRelative(0.0f, 56.0f, -88.0f, 72.0f, -88.0f, 72.0f)
                reflectiveCurveToRelative(-88.0f, -16.0f, -88.0f, -72.0f)
...
private var `_face-mask-duotone`: ImageVector? = null
