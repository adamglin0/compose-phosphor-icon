...
public val BoldGroup.`Codepen-logo-bold`: ImageVector
    get() {
        if (`_codepen-logo-bold` != null) {
            return `_codepen-logo-bold`!!
        }
        `_codepen-logo-bold` = Builder(name = "Codepen-logo-bold", defaultWidth = 256.0.dp,
...
private var `_codepen-logo-bold`: ImageVector? = null
