...
public val BoldGroup.`Car-profile-bold`: ImageVector
    get() {
        if (`_car-profile-bold` != null) {
            return `_car-profile-bold`!!
        }
        `_car-profile-bold` = Builder(name = "Car-profile-bold", defaultWidth = 256.0.dp,
...
private var `_car-profile-bold`: ImageVector? = null
