...
public val BoldGroup.`Chart-scatter-bold`: ImageVector
    get() {
        if (`_chart-scatter-bold` != null) {
            return `_chart-scatter-bold`!!
        }
        `_chart-scatter-bold` = Builder(name = "Chart-scatter-bold", defaultWidth = 256.0.dp,
...
private var `_chart-scatter-bold`: ImageVector? = null
