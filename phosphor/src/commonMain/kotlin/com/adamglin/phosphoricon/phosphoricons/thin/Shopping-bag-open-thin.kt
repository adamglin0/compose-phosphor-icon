...
public val ThinGroup.`Shopping-bag-open-thin`: ImageVector
    get() {
        if (`_shopping-bag-open-thin` != null) {
            return `_shopping-bag-open-thin`!!
        }
        `_shopping-bag-open-thin` = Builder(name = "Shopping-bag-open-thin", defaultWidth =
...
private var `_shopping-bag-open-thin`: ImageVector? = null
