...
public val LightGroup.`Lamp-light`: ImageVector
    get() {
        if (`_lamp-light` != null) {
            return `_lamp-light`!!
        }
        `_lamp-light` = Builder(name = "Lamp-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lamp-light`: ImageVector? = null
