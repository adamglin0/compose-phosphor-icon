...
public val LightGroup.`Pulse-light`: ImageVector
    get() {
        if (`_pulse-light` != null) {
            return `_pulse-light`!!
        }
        `_pulse-light` = Builder(name = "Pulse-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pulse-light`: ImageVector? = null
