...
public val ThinGroup.`Stack-thin`: ImageVector
    get() {
        if (`_stack-thin` != null) {
            return `_stack-thin`!!
        }
        `_stack-thin` = Builder(name = "Stack-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stack-thin`: ImageVector? = null
