...
public val DuotoneGroup.`Baseball-duotone`: ImageVector
    get() {
        if (`_baseball-duotone` != null) {
            return `_baseball-duotone`!!
        }
        `_baseball-duotone` = Builder(name = "Baseball-duotone", defaultWidth = 256.0.dp,
...
private var `_baseball-duotone`: ImageVector? = null
