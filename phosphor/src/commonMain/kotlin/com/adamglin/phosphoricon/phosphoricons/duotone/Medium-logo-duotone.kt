...
public val DuotoneGroup.`Medium-logo-duotone`: ImageVector
    get() {
        if (`_medium-logo-duotone` != null) {
            return `_medium-logo-duotone`!!
        }
        `_medium-logo-duotone` = Builder(name = "Medium-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_medium-logo-duotone`: ImageVector? = null
