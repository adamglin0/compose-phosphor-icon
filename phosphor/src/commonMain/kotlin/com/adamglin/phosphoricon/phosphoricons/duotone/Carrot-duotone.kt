...
public val DuotoneGroup.`Carrot-duotone`: ImageVector
    get() {
        if (`_carrot-duotone` != null) {
            return `_carrot-duotone`!!
        }
        `_carrot-duotone` = Builder(name = "Carrot-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_carrot-duotone`: ImageVector? = null
