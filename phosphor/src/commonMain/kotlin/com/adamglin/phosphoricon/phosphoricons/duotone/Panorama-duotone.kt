...
public val DuotoneGroup.`Panorama-duotone`: ImageVector
    get() {
        if (`_panorama-duotone` != null) {
            return `_panorama-duotone`!!
        }
        `_panorama-duotone` = Builder(name = "Panorama-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -3.47f, 6.6f)
                lineToRelative(-68.25f, -68.25f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.31f, 0.0f)
                lineTo(131.31f, 156.0f)
                lineTo(81.66f, 106.34f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -11.32f, 0.0f)
                lineTo(16.0f, 160.69f)
                verticalLineTo(64.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 10.05f, -7.74f)
                curveTo(43.35f, 60.89f, 81.44f, 72.0f, 128.0f, 72.0f)
                reflectiveCurveTo(212.65f, 60.89f, 230.0f, 56.27f)
...
private var `_panorama-duotone`: ImageVector? = null
