...
public val FillGroup.`Hand-fist-fill`: ImageVector
    get() {
        if (`_hand-fist-fill` != null) {
            return `_hand-fist-fill`!!
        }
        `_hand-fist-fill` = Builder(name = "Hand-fist-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hand-fist-fill`: ImageVector? = null
