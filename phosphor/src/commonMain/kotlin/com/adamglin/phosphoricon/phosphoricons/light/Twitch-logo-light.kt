...
public val LightGroup.`Twitch-logo-light`: ImageVector
    get() {
        if (`_twitch-logo-light` != null) {
            return `_twitch-logo-light`!!
        }
        `_twitch-logo-light` = Builder(name = "Twitch-logo-light", defaultWidth = 256.0.dp,
...
private var `_twitch-logo-light`: ImageVector? = null
