...
public val BoldGroup.`Hospital-bold`: ImageVector
    get() {
        if (`_hospital-bold` != null) {
            return `_hospital-bold`!!
        }
        `_hospital-bold` = Builder(name = "Hospital-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hospital-bold`: ImageVector? = null
