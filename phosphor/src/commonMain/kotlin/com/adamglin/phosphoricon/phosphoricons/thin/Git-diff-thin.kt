...
public val ThinGroup.`Git-diff-thin`: ImageVector
    get() {
        if (`_git-diff-thin` != null) {
            return `_git-diff-thin`!!
        }
        `_git-diff-thin` = Builder(name = "Git-diff-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_git-diff-thin`: ImageVector? = null
