...
public val FillGroup.`Rug-fill`: ImageVector
    get() {
        if (`_rug-fill` != null) {
            return `_rug-fill`!!
        }
        `_rug-fill` = Builder(name = "Rug-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_rug-fill`: ImageVector? = null
