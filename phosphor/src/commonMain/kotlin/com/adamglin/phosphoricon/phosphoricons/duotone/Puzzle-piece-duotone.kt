...
public val DuotoneGroup.`Puzzle-piece-duotone`: ImageVector
    get() {
        if (`_puzzle-piece-duotone` != null) {
            return `_puzzle-piece-duotone`!!
        }
        `_puzzle-piece-duotone` = Builder(name = "Puzzle-piece-duotone", defaultWidth = 256.0.dp,
...
private var `_puzzle-piece-duotone`: ImageVector? = null
