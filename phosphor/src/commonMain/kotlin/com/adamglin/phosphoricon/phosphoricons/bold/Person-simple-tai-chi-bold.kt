...
public val BoldGroup.`Person-simple-tai-chi-bold`: ImageVector
    get() {
        if (`_person-simple-tai-chi-bold` != null) {
            return `_person-simple-tai-chi-bold`!!
        }
        `_person-simple-tai-chi-bold` = Builder(name = "Person-simple-tai-chi-bold", defaultWidth =
...
private var `_person-simple-tai-chi-bold`: ImageVector? = null
