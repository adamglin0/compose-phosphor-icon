...
public val LightGroup.`Bell-simple-z-light`: ImageVector
    get() {
        if (`_bell-simple-z-light` != null) {
            return `_bell-simple-z-light`!!
        }
        `_bell-simple-z-light` = Builder(name = "Bell-simple-z-light", defaultWidth = 256.0.dp,
...
private var `_bell-simple-z-light`: ImageVector? = null
