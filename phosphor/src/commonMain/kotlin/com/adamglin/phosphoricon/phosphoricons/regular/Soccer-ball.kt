...
public val RegularGroup.`Soccer-ball`: ImageVector
    get() {
        if (`_soccer-ball` != null) {
            return `_soccer-ball`!!
        }
        `_soccer-ball` = Builder(name = "Soccer-ball", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_soccer-ball`: ImageVector? = null
