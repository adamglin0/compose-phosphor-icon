...
public val LightGroup.`Crosshair-simple-light`: ImageVector
    get() {
        if (`_crosshair-simple-light` != null) {
            return `_crosshair-simple-light`!!
        }
        `_crosshair-simple-light` = Builder(name = "Crosshair-simple-light", defaultWidth =
...
private var `_crosshair-simple-light`: ImageVector? = null
