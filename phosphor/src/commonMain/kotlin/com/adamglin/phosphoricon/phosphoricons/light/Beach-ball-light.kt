...
public val LightGroup.`Beach-ball-light`: ImageVector
    get() {
        if (`_beach-ball-light` != null) {
            return `_beach-ball-light`!!
        }
        `_beach-ball-light` = Builder(name = "Beach-ball-light", defaultWidth = 256.0.dp,
...
private var `_beach-ball-light`: ImageVector? = null
