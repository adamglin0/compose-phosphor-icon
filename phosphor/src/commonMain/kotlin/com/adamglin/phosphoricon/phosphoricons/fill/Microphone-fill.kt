...
public val FillGroup.`Microphone-fill`: ImageVector
    get() {
        if (`_microphone-fill` != null) {
            return `_microphone-fill`!!
        }
        `_microphone-fill` = Builder(name = "Microphone-fill", defaultWidth = 256.0.dp,
...
private var `_microphone-fill`: ImageVector? = null
