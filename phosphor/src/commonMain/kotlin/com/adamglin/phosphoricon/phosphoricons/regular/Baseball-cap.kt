...
public val RegularGroup.`Baseball-cap`: ImageVector
    get() {
        if (`_baseball-cap` != null) {
            return `_baseball-cap`!!
        }
        `_baseball-cap` = Builder(name = "Baseball-cap", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_baseball-cap`: ImageVector? = null
