...
public val DuotoneGroup.`Arrow-bend-left-down-duotone`: ImageVector
    get() {
        if (`_arrow-bend-left-down-duotone` != null) {
            return `_arrow-bend-left-down-duotone`!!
        }
        `_arrow-bend-left-down-duotone` = Builder(name = "Arrow-bend-left-down-duotone",
...
private var `_arrow-bend-left-down-duotone`: ImageVector? = null
