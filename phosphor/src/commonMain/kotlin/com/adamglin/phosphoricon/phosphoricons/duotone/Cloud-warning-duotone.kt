...
public val DuotoneGroup.`Cloud-warning-duotone`: ImageVector
    get() {
        if (`_cloud-warning-duotone` != null) {
            return `_cloud-warning-duotone`!!
        }
        `_cloud-warning-duotone` = Builder(name = "Cloud-warning-duotone", defaultWidth = 256.0.dp,
...
private var `_cloud-warning-duotone`: ImageVector? = null
