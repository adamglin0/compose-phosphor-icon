...
public val LightGroup.`Not-superset-of-light`: ImageVector
    get() {
        if (`_not-superset-of-light` != null) {
            return `_not-superset-of-light`!!
        }
        `_not-superset-of-light` = Builder(name = "Not-superset-of-light", defaultWidth = 256.0.dp,
...
private var `_not-superset-of-light`: ImageVector? = null
