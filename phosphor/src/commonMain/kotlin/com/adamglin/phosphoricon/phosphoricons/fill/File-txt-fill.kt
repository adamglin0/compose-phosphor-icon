...
public val FillGroup.`File-txt-fill`: ImageVector
    get() {
        if (`_file-txt-fill` != null) {
            return `_file-txt-fill`!!
        }
        `_file-txt-fill` = Builder(name = "File-txt-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-txt-fill`: ImageVector? = null
