...
public val LightGroup.`Train-simple-light`: ImageVector
    get() {
        if (`_train-simple-light` != null) {
            return `_train-simple-light`!!
        }
        `_train-simple-light` = Builder(name = "Train-simple-light", defaultWidth = 256.0.dp,
...
private var `_train-simple-light`: ImageVector? = null
