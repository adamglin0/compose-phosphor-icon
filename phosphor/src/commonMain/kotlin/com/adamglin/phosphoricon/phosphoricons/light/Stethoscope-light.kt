...
public val LightGroup.`Stethoscope-light`: ImageVector
    get() {
        if (`_stethoscope-light` != null) {
            return `_stethoscope-light`!!
        }
        `_stethoscope-light` = Builder(name = "Stethoscope-light", defaultWidth = 256.0.dp,
...
private var `_stethoscope-light`: ImageVector? = null
