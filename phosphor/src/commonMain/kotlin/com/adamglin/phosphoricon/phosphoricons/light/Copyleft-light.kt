...
public val LightGroup.`Copyleft-light`: ImageVector
    get() {
        if (`_copyleft-light` != null) {
            return `_copyleft-light`!!
        }
        `_copyleft-light` = Builder(name = "Copyleft-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_copyleft-light`: ImageVector? = null
