...
public val DuotoneGroup.`Hand-palm-duotone`: ImageVector
    get() {
        if (`_hand-palm-duotone` != null) {
            return `_hand-palm-duotone`!!
        }
        `_hand-palm-duotone` = Builder(name = "Hand-palm-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-palm-duotone`: ImageVector? = null
