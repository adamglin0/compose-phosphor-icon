...
public val LightGroup.`File-image-light`: ImageVector
    get() {
        if (`_file-image-light` != null) {
            return `_file-image-light`!!
        }
        `_file-image-light` = Builder(name = "File-image-light", defaultWidth = 256.0.dp,
...
private var `_file-image-light`: ImageVector? = null
