...
public val ThinGroup.`Check-square-thin`: ImageVector
    get() {
        if (`_check-square-thin` != null) {
            return `_check-square-thin`!!
        }
        `_check-square-thin` = Builder(name = "Check-square-thin", defaultWidth = 256.0.dp,
...
private var `_check-square-thin`: ImageVector? = null
