...
public val FillGroup.`Peace-fill`: ImageVector
    get() {
        if (`_peace-fill` != null) {
            return `_peace-fill`!!
        }
        `_peace-fill` = Builder(name = "Peace-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_peace-fill`: ImageVector? = null
