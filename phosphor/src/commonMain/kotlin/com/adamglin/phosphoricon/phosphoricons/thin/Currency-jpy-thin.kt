...
public val ThinGroup.`Currency-jpy-thin`: ImageVector
    get() {
        if (`_currency-jpy-thin` != null) {
            return `_currency-jpy-thin`!!
        }
        `_currency-jpy-thin` = Builder(name = "Currency-jpy-thin", defaultWidth = 256.0.dp,
...
private var `_currency-jpy-thin`: ImageVector? = null
