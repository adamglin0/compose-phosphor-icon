...
public val BoldGroup.`Floppy-disk-bold`: ImageVector
    get() {
        if (`_floppy-disk-bold` != null) {
            return `_floppy-disk-bold`!!
        }
        `_floppy-disk-bold` = Builder(name = "Floppy-disk-bold", defaultWidth = 256.0.dp,
...
private var `_floppy-disk-bold`: ImageVector? = null
