...
public val FillGroup.`Dribbble-logo-fill`: ImageVector
    get() {
        if (`_dribbble-logo-fill` != null) {
            return `_dribbble-logo-fill`!!
        }
        `_dribbble-logo-fill` = Builder(name = "Dribbble-logo-fill", defaultWidth = 256.0.dp,
...
private var `_dribbble-logo-fill`: ImageVector? = null
