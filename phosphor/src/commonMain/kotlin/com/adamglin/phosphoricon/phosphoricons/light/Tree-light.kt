...
public val LightGroup.`Tree-light`: ImageVector
    get() {
        if (`_tree-light` != null) {
            return `_tree-light`!!
        }
        `_tree-light` = Builder(name = "Tree-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tree-light`: ImageVector? = null
