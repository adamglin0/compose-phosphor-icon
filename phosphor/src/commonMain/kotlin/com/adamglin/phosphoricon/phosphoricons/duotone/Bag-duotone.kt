...
public val DuotoneGroup.`Bag-duotone`: ImageVector
    get() {
        if (`_bag-duotone` != null) {
            return `_bag-duotone`!!
        }
        `_bag-duotone` = Builder(name = "Bag-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bag-duotone`: ImageVector? = null
