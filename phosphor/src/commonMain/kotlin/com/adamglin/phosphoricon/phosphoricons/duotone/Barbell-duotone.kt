...
public val DuotoneGroup.`Barbell-duotone`: ImageVector
    get() {
        if (`_barbell-duotone` != null) {
            return `_barbell-duotone`!!
        }
        `_barbell-duotone` = Builder(name = "Barbell-duotone", defaultWidth = 256.0.dp,
...
private var `_barbell-duotone`: ImageVector? = null
