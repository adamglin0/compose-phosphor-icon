...
public val DuotoneGroup.`Arrow-square-out-duotone`: ImageVector
    get() {
        if (`_arrow-square-out-duotone` != null) {
            return `_arrow-square-out-duotone`!!
        }
        `_arrow-square-out-duotone` = Builder(name = "Arrow-square-out-duotone", defaultWidth =
...
private var `_arrow-square-out-duotone`: ImageVector? = null
