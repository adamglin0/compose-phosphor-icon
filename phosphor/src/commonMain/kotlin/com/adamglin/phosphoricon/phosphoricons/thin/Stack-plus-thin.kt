...
public val ThinGroup.`Stack-plus-thin`: ImageVector
    get() {
        if (`_stack-plus-thin` != null) {
            return `_stack-plus-thin`!!
        }
        `_stack-plus-thin` = Builder(name = "Stack-plus-thin", defaultWidth = 256.0.dp,
...
private var `_stack-plus-thin`: ImageVector? = null
