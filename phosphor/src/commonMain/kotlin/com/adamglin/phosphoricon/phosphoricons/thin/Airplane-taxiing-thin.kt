...
public val ThinGroup.`Airplane-taxiing-thin`: ImageVector
    get() {
        if (`_airplane-taxiing-thin` != null) {
            return `_airplane-taxiing-thin`!!
        }
        `_airplane-taxiing-thin` = Builder(name = "Airplane-taxiing-thin", defaultWidth = 256.0.dp,
...
private var `_airplane-taxiing-thin`: ImageVector? = null
