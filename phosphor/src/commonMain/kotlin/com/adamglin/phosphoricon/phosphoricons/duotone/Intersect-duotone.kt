...
public val DuotoneGroup.`Intersect-duotone`: ImageVector
    get() {
        if (`_intersect-duotone` != null) {
            return `_intersect-duotone`!!
        }
        `_intersect-duotone` = Builder(name = "Intersect-duotone", defaultWidth = 256.0.dp,
...
private var `_intersect-duotone`: ImageVector? = null
