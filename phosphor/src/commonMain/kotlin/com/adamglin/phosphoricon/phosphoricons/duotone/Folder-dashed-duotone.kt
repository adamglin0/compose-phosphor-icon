...
public val DuotoneGroup.`Folder-dashed-duotone`: ImageVector
    get() {
        if (`_folder-dashed-duotone` != null) {
            return `_folder-dashed-duotone`!!
        }
        `_folder-dashed-duotone` = Builder(name = "Folder-dashed-duotone", defaultWidth = 256.0.dp,
...
private var `_folder-dashed-duotone`: ImageVector? = null
