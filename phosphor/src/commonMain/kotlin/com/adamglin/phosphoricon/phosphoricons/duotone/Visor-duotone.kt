...
public val DuotoneGroup.`Visor-duotone`: ImageVector
    get() {
        if (`_visor-duotone` != null) {
            return `_visor-duotone`!!
        }
        `_visor-duotone` = Builder(name = "Visor-duotone", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(248.0f, 127.15f)
                arcTo(64.0f, 64.0f, 0.0f, false, true, 184.0f, 192.0f)
                curveToRelative(-15.48f, 0.0f, -29.68f, -9.35f, -40.75f, -18.5f)
                arcToRelative(23.91f, 23.91f, 0.0f, false, false, -30.45f, -0.05f)
                curveToRelative(-11.81f, 9.79f, -27.19f, 19.26f, -43.89f, 18.48f)
                arcTo(64.0f, 64.0f, 0.0f, false, true, 72.0f, 64.0f)
                horizontalLineTo(183.05f)
                curveTo(218.22f, 64.0f, 247.54f, 92.0f, 248.0f, 127.15f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(93.52f, 179.0f, 81.0f, 184.49f, 69.28f, 183.94f)
...
private var `_visor-duotone`: ImageVector? = null
