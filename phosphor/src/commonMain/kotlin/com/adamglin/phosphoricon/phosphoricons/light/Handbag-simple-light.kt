...
public val LightGroup.`Handbag-simple-light`: ImageVector
    get() {
        if (`_handbag-simple-light` != null) {
            return `_handbag-simple-light`!!
        }
        `_handbag-simple-light` = Builder(name = "Handbag-simple-light", defaultWidth = 256.0.dp,
...
private var `_handbag-simple-light`: ImageVector? = null
