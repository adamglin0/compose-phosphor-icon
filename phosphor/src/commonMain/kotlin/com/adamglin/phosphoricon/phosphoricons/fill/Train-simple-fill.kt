...
public val FillGroup.`Train-simple-fill`: ImageVector
    get() {
        if (`_train-simple-fill` != null) {
            return `_train-simple-fill`!!
        }
        `_train-simple-fill` = Builder(name = "Train-simple-fill", defaultWidth = 256.0.dp,
...
private var `_train-simple-fill`: ImageVector? = null
