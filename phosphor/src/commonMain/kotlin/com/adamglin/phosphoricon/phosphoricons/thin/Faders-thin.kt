...
public val ThinGroup.`Faders-thin`: ImageVector
    get() {
        if (`_faders-thin` != null) {
            return `_faders-thin`!!
        }
        `_faders-thin` = Builder(name = "Faders-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_faders-thin`: ImageVector? = null
