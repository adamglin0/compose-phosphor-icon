...
public val DuotoneGroup.`Drop-slash-duotone`: ImageVector
    get() {
        if (`_drop-slash-duotone` != null) {
            return `_drop-slash-duotone`!!
        }
        `_drop-slash-duotone` = Builder(name = "Drop-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_drop-slash-duotone`: ImageVector? = null
