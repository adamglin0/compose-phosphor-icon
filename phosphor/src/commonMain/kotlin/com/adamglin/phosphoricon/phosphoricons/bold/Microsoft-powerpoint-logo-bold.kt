...
public val BoldGroup.`Microsoft-powerpoint-logo-bold`: ImageVector
    get() {
        if (`_microsoft-powerpoint-logo-bold` != null) {
            return `_microsoft-powerpoint-logo-bold`!!
        }
        `_microsoft-powerpoint-logo-bold` = Builder(name = "Microsoft-powerpoint-logo-bold",
...
private var `_microsoft-powerpoint-logo-bold`: ImageVector? = null
