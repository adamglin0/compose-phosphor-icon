...
public val RegularGroup.`Linkedin-logo`: ImageVector
    get() {
        if (`_linkedin-logo` != null) {
            return `_linkedin-logo`!!
        }
        `_linkedin-logo` = Builder(name = "Linkedin-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_linkedin-logo`: ImageVector? = null
