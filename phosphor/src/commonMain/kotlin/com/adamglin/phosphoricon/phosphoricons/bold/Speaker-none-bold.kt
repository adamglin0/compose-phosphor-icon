...
public val BoldGroup.`Speaker-none-bold`: ImageVector
    get() {
        if (`_speaker-none-bold` != null) {
            return `_speaker-none-bold`!!
        }
        `_speaker-none-bold` = Builder(name = "Speaker-none-bold", defaultWidth = 256.0.dp,
...
private var `_speaker-none-bold`: ImageVector? = null
