...
public val DuotoneGroup.`Ghost-duotone`: ImageVector
    get() {
        if (`_ghost-duotone` != null) {
            return `_ghost-duotone`!!
        }
        `_ghost-duotone` = Builder(name = "Ghost-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ghost-duotone`: ImageVector? = null
