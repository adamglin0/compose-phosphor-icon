...
public val DuotoneGroup.`Number-circle-three-duotone`: ImageVector
    get() {
        if (`_number-circle-three-duotone` != null) {
            return `_number-circle-three-duotone`!!
        }
        `_number-circle-three-duotone` = Builder(name = "Number-circle-three-duotone", defaultWidth
...
private var `_number-circle-three-duotone`: ImageVector? = null
