...
public val DuotoneGroup.`Grains-duotone`: ImageVector
    get() {
        if (`_grains-duotone` != null) {
            return `_grains-duotone`!!
        }
        `_grains-duotone` = Builder(name = "Grains-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_grains-duotone`: ImageVector? = null
