...
public val DuotoneGroup.`Bug-droid-duotone`: ImageVector
    get() {
        if (`_bug-droid-duotone` != null) {
            return `_bug-droid-duotone`!!
        }
        `_bug-droid-duotone` = Builder(name = "Bug-droid-duotone", defaultWidth = 256.0.dp,
...
private var `_bug-droid-duotone`: ImageVector? = null
