...
public val BoldGroup.`Money-bold`: ImageVector
    get() {
        if (`_money-bold` != null) {
            return `_money-bold`!!
        }
        `_money-bold` = Builder(name = "Money-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_money-bold`: ImageVector? = null
