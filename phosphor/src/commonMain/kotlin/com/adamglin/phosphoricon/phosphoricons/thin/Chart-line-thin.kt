...
public val ThinGroup.`Chart-line-thin`: ImageVector
    get() {
        if (`_chart-line-thin` != null) {
            return `_chart-line-thin`!!
        }
        `_chart-line-thin` = Builder(name = "Chart-line-thin", defaultWidth = 256.0.dp,
...
private var `_chart-line-thin`: ImageVector? = null
