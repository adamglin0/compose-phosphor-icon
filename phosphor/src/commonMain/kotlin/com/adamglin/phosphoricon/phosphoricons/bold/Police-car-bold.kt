...
public val BoldGroup.`Police-car-bold`: ImageVector
    get() {
        if (`_police-car-bold` != null) {
            return `_police-car-bold`!!
        }
        `_police-car-bold` = Builder(name = "Police-car-bold", defaultWidth = 256.0.dp,
...
private var `_police-car-bold`: ImageVector? = null
