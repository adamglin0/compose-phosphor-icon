...
public val ThinGroup.`Newspaper-clipping-thin`: ImageVector
    get() {
        if (`_newspaper-clipping-thin` != null) {
            return `_newspaper-clipping-thin`!!
        }
        `_newspaper-clipping-thin` = Builder(name = "Newspaper-clipping-thin", defaultWidth =
...
private var `_newspaper-clipping-thin`: ImageVector? = null
