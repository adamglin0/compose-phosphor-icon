...
public val LightGroup.`Recycle-light`: ImageVector
    get() {
        if (`_recycle-light` != null) {
            return `_recycle-light`!!
        }
        `_recycle-light` = Builder(name = "Recycle-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_recycle-light`: ImageVector? = null
