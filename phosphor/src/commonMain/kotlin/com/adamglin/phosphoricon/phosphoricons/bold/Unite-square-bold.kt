...
public val BoldGroup.`Unite-square-bold`: ImageVector
    get() {
        if (`_unite-square-bold` != null) {
            return `_unite-square-bold`!!
        }
        `_unite-square-bold` = Builder(name = "Unite-square-bold", defaultWidth = 256.0.dp,
...
private var `_unite-square-bold`: ImageVector? = null
