...
public val DuotoneGroup.`Whatsapp-logo-duotone`: ImageVector
    get() {
        if (`_whatsapp-logo-duotone` != null) {
            return `_whatsapp-logo-duotone`!!
        }
        `_whatsapp-logo-duotone` = Builder(name = "Whatsapp-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_whatsapp-logo-duotone`: ImageVector? = null
