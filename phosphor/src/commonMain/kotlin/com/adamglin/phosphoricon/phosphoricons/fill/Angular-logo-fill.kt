...
public val FillGroup.`Angular-logo-fill`: ImageVector
    get() {
        if (`_angular-logo-fill` != null) {
            return `_angular-logo-fill`!!
        }
        `_angular-logo-fill` = Builder(name = "Angular-logo-fill", defaultWidth = 256.0.dp,
...
private var `_angular-logo-fill`: ImageVector? = null
