...
public val DuotoneGroup.`Plug-duotone`: ImageVector
    get() {
        if (`_plug-duotone` != null) {
            return `_plug-duotone`!!
        }
        `_plug-duotone` = Builder(name = "Plug-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plug-duotone`: ImageVector? = null
