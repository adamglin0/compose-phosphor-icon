...
public val ThinGroup.`Resize-thin`: ImageVector
    get() {
        if (`_resize-thin` != null) {
            return `_resize-thin`!!
        }
        `_resize-thin` = Builder(name = "Resize-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_resize-thin`: ImageVector? = null
