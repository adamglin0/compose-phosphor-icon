...
public val LightGroup.`Yarn-light`: ImageVector
    get() {
        if (`_yarn-light` != null) {
            return `_yarn-light`!!
        }
        `_yarn-light` = Builder(name = "Yarn-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_yarn-light`: ImageVector? = null
