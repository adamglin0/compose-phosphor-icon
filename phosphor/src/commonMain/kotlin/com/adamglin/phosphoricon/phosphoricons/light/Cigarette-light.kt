...
public val LightGroup.`Cigarette-light`: ImageVector
    get() {
        if (`_cigarette-light` != null) {
            return `_cigarette-light`!!
        }
        `_cigarette-light` = Builder(name = "Cigarette-light", defaultWidth = 256.0.dp,
...
private var `_cigarette-light`: ImageVector? = null
