...
public val BoldGroup.`Number-circle-seven-bold`: ImageVector
    get() {
        if (`_number-circle-seven-bold` != null) {
            return `_number-circle-seven-bold`!!
        }
        `_number-circle-seven-bold` = Builder(name = "Number-circle-seven-bold", defaultWidth =
...
private var `_number-circle-seven-bold`: ImageVector? = null
