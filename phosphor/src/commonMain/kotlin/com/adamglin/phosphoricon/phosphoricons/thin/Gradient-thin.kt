...
public val ThinGroup.`Gradient-thin`: ImageVector
    get() {
        if (`_gradient-thin` != null) {
            return `_gradient-thin`!!
        }
        `_gradient-thin` = Builder(name = "Gradient-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gradient-thin`: ImageVector? = null
