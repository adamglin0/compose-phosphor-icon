...
public val BoldGroup.`Thumbs-up-bold`: ImageVector
    get() {
        if (`_thumbs-up-bold` != null) {
            return `_thumbs-up-bold`!!
        }
        `_thumbs-up-bold` = Builder(name = "Thumbs-up-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_thumbs-up-bold`: ImageVector? = null
