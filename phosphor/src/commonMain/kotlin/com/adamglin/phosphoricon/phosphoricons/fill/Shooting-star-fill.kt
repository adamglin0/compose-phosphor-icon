...
public val FillGroup.`Shooting-star-fill`: ImageVector
    get() {
        if (`_shooting-star-fill` != null) {
            return `_shooting-star-fill`!!
        }
        `_shooting-star-fill` = Builder(name = "Shooting-star-fill", defaultWidth = 256.0.dp,
...
private var `_shooting-star-fill`: ImageVector? = null
