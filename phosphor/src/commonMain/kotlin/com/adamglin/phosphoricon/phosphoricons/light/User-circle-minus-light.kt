...
public val LightGroup.`User-circle-minus-light`: ImageVector
    get() {
        if (`_user-circle-minus-light` != null) {
            return `_user-circle-minus-light`!!
        }
        `_user-circle-minus-light` = Builder(name = "User-circle-minus-light", defaultWidth =
...
private var `_user-circle-minus-light`: ImageVector? = null
