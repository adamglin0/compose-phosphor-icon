...
public val DuotoneGroup.`Certificate-duotone`: ImageVector
    get() {
        if (`_certificate-duotone` != null) {
            return `_certificate-duotone`!!
        }
        `_certificate-duotone` = Builder(name = "Certificate-duotone", defaultWidth = 256.0.dp,
...
private var `_certificate-duotone`: ImageVector? = null
