...
public val ThinGroup.`Divide-thin`: ImageVector
    get() {
        if (`_divide-thin` != null) {
            return `_divide-thin`!!
        }
        `_divide-thin` = Builder(name = "Divide-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_divide-thin`: ImageVector? = null
