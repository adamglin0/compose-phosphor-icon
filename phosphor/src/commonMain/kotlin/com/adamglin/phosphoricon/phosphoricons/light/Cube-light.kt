...
public val LightGroup.`Cube-light`: ImageVector
    get() {
        if (`_cube-light` != null) {
            return `_cube-light`!!
        }
        `_cube-light` = Builder(name = "Cube-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cube-light`: ImageVector? = null
