...
public val BoldGroup.`Sailboat-bold`: ImageVector
    get() {
        if (`_sailboat-bold` != null) {
            return `_sailboat-bold`!!
        }
        `_sailboat-bold` = Builder(name = "Sailboat-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sailboat-bold`: ImageVector? = null
