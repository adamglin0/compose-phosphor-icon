...
public val BoldGroup.`Tray-arrow-down-bold`: ImageVector
    get() {
        if (`_tray-arrow-down-bold` != null) {
            return `_tray-arrow-down-bold`!!
        }
        `_tray-arrow-down-bold` = Builder(name = "Tray-arrow-down-bold", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-down-bold`: ImageVector? = null
