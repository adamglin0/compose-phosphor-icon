...
public val BoldGroup.`Bag-simple-bold`: ImageVector
    get() {
        if (`_bag-simple-bold` != null) {
            return `_bag-simple-bold`!!
        }
        `_bag-simple-bold` = Builder(name = "Bag-simple-bold", defaultWidth = 256.0.dp,
...
private var `_bag-simple-bold`: ImageVector? = null
