...
public val RegularGroup.`Arrows-counter-clockwise`: ImageVector
    get() {
        if (`_arrows-counter-clockwise` != null) {
            return `_arrows-counter-clockwise`!!
        }
        `_arrows-counter-clockwise` = Builder(name = "Arrows-counter-clockwise", defaultWidth =
...
private var `_arrows-counter-clockwise`: ImageVector? = null
