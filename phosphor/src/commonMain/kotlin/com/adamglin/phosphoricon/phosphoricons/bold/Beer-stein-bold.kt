...
public val BoldGroup.`Beer-stein-bold`: ImageVector
    get() {
        if (`_beer-stein-bold` != null) {
            return `_beer-stein-bold`!!
        }
        `_beer-stein-bold` = Builder(name = "Beer-stein-bold", defaultWidth = 256.0.dp,
...
private var `_beer-stein-bold`: ImageVector? = null
