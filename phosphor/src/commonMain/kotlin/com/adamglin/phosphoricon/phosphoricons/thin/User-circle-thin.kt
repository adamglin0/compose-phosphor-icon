...
public val ThinGroup.`User-circle-thin`: ImageVector
    get() {
        if (`_user-circle-thin` != null) {
            return `_user-circle-thin`!!
        }
        `_user-circle-thin` = Builder(name = "User-circle-thin", defaultWidth = 256.0.dp,
...
private var `_user-circle-thin`: ImageVector? = null
