...
public val FillGroup.`Television-simple-fill`: ImageVector
    get() {
        if (`_television-simple-fill` != null) {
            return `_television-simple-fill`!!
        }
        `_television-simple-fill` = Builder(name = "Television-simple-fill", defaultWidth =
...
private var `_television-simple-fill`: ImageVector? = null
