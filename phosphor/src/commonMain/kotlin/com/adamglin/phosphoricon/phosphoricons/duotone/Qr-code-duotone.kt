...
public val DuotoneGroup.`Qr-code-duotone`: ImageVector
    get() {
        if (`_qr-code-duotone` != null) {
            return `_qr-code-duotone`!!
        }
        `_qr-code-duotone` = Builder(name = "Qr-code-duotone", defaultWidth = 256.0.dp,
...
private var `_qr-code-duotone`: ImageVector? = null
