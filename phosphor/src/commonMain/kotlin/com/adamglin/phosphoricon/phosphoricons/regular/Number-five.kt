...
public val RegularGroup.`Number-five`: ImageVector
    get() {
        if (`_number-five` != null) {
            return `_number-five`!!
        }
        `_number-five` = Builder(name = "Number-five", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_number-five`: ImageVector? = null
