...
public val FillGroup.`Chat-circle-dots-fill`: ImageVector
    get() {
        if (`_chat-circle-dots-fill` != null) {
            return `_chat-circle-dots-fill`!!
        }
        `_chat-circle-dots-fill` = Builder(name = "Chat-circle-dots-fill", defaultWidth = 256.0.dp,
...
private var `_chat-circle-dots-fill`: ImageVector? = null
