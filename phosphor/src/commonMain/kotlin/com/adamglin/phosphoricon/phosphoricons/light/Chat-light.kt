...
public val LightGroup.`Chat-light`: ImageVector
    get() {
        if (`_chat-light` != null) {
            return `_chat-light`!!
        }
        `_chat-light` = Builder(name = "Chat-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chat-light`: ImageVector? = null
