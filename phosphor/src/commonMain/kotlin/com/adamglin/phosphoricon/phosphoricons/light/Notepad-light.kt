...
public val LightGroup.`Notepad-light`: ImageVector
    get() {
        if (`_notepad-light` != null) {
            return `_notepad-light`!!
        }
        `_notepad-light` = Builder(name = "Notepad-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_notepad-light`: ImageVector? = null
