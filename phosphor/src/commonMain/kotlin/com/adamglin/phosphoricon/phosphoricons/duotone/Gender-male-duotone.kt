...
public val DuotoneGroup.`Gender-male-duotone`: ImageVector
    get() {
        if (`_gender-male-duotone` != null) {
            return `_gender-male-duotone`!!
        }
        `_gender-male-duotone` = Builder(name = "Gender-male-duotone", defaultWidth = 256.0.dp,
...
private var `_gender-male-duotone`: ImageVector? = null
