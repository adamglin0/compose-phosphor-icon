...
public val DuotoneGroup.`Trademark-registered-duotone`: ImageVector
    get() {
        if (`_trademark-registered-duotone` != null) {
            return `_trademark-registered-duotone`!!
        }
        `_trademark-registered-duotone` = Builder(name = "Trademark-registered-duotone",
...
private var `_trademark-registered-duotone`: ImageVector? = null
