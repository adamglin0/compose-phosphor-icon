...
public val ThinGroup.`Hand-palm-thin`: ImageVector
    get() {
        if (`_hand-palm-thin` != null) {
            return `_hand-palm-thin`!!
        }
        `_hand-palm-thin` = Builder(name = "Hand-palm-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hand-palm-thin`: ImageVector? = null
