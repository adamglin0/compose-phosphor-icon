...
public val BoldGroup.`Map-pin-plus-bold`: ImageVector
    get() {
        if (`_map-pin-plus-bold` != null) {
            return `_map-pin-plus-bold`!!
        }
        `_map-pin-plus-bold` = Builder(name = "Map-pin-plus-bold", defaultWidth = 256.0.dp,
...
private var `_map-pin-plus-bold`: ImageVector? = null
