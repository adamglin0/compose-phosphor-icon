...
public val DuotoneGroup.`Phone-incoming-duotone`: ImageVector
    get() {
        if (`_phone-incoming-duotone` != null) {
            return `_phone-incoming-duotone`!!
        }
        `_phone-incoming-duotone` = Builder(name = "Phone-incoming-duotone", defaultWidth =
...
private var `_phone-incoming-duotone`: ImageVector? = null
