...
public val DuotoneGroup.`Arrow-bend-double-up-right-duotone`: ImageVector
    get() {
        if (`_arrow-bend-double-up-right-duotone` != null) {
            return `_arrow-bend-double-up-right-duotone`!!
        }
        `_arrow-bend-double-up-right-duotone` = Builder(name = "Arrow-bend-double-up-right-duotone",
...
private var `_arrow-bend-double-up-right-duotone`: ImageVector? = null
