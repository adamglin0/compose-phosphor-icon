...
public val LightGroup.`File-magnifying-glass-light`: ImageVector
    get() {
        if (`_file-magnifying-glass-light` != null) {
            return `_file-magnifying-glass-light`!!
        }
        `_file-magnifying-glass-light` = Builder(name = "File-magnifying-glass-light", defaultWidth
...
private var `_file-magnifying-glass-light`: ImageVector? = null
