...
public val ThinGroup.`Circles-three-plus-thin`: ImageVector
    get() {
        if (`_circles-three-plus-thin` != null) {
            return `_circles-three-plus-thin`!!
        }
        `_circles-three-plus-thin` = Builder(name = "Circles-three-plus-thin", defaultWidth =
...
private var `_circles-three-plus-thin`: ImageVector? = null
