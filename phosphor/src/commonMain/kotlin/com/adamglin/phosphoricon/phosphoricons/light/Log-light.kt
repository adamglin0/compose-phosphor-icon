...
public val LightGroup.`Log-light`: ImageVector
    get() {
        if (`_log-light` != null) {
            return `_log-light`!!
        }
        `_log-light` = Builder(name = "Log-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_log-light`: ImageVector? = null
