...
public val BoldGroup.`Eye-closed-bold`: ImageVector
    get() {
        if (`_eye-closed-bold` != null) {
            return `_eye-closed-bold`!!
        }
        `_eye-closed-bold` = Builder(name = "Eye-closed-bold", defaultWidth = 256.0.dp,
...
private var `_eye-closed-bold`: ImageVector? = null
