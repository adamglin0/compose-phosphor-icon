...
public val ThinGroup.`Music-notes-minus-thin`: ImageVector
    get() {
        if (`_music-notes-minus-thin` != null) {
            return `_music-notes-minus-thin`!!
        }
        `_music-notes-minus-thin` = Builder(name = "Music-notes-minus-thin", defaultWidth =
...
private var `_music-notes-minus-thin`: ImageVector? = null
