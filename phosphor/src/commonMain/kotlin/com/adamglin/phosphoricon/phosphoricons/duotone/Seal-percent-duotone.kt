...
public val DuotoneGroup.`Seal-percent-duotone`: ImageVector
    get() {
        if (`_seal-percent-duotone` != null) {
            return `_seal-percent-duotone`!!
        }
        `_seal-percent-duotone` = Builder(name = "Seal-percent-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(24.0f, 24.0f, 0.0f, true, false, 24.0f, 24.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 160.0f, 136.0f)
                close()
...
private var `_seal-percent-duotone`: ImageVector? = null
