...
public val DuotoneGroup.`Potted-plant-duotone`: ImageVector
    get() {
        if (`_potted-plant-duotone` != null) {
            return `_potted-plant-duotone`!!
        }
        `_potted-plant-duotone` = Builder(name = "Potted-plant-duotone", defaultWidth = 256.0.dp,
...
private var `_potted-plant-duotone`: ImageVector? = null
