...
public val ThinGroup.`Barbell-thin`: ImageVector
    get() {
        if (`_barbell-thin` != null) {
            return `_barbell-thin`!!
        }
        `_barbell-thin` = Builder(name = "Barbell-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barbell-thin`: ImageVector? = null
