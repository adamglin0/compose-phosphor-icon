...
public val FillGroup.`Clover-fill`: ImageVector
    get() {
        if (`_clover-fill` != null) {
            return `_clover-fill`!!
        }
        `_clover-fill` = Builder(name = "Clover-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_clover-fill`: ImageVector? = null
