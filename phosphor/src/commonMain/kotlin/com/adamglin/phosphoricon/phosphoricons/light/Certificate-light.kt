...
public val LightGroup.`Certificate-light`: ImageVector
    get() {
        if (`_certificate-light` != null) {
            return `_certificate-light`!!
        }
        `_certificate-light` = Builder(name = "Certificate-light", defaultWidth = 256.0.dp,
...
private var `_certificate-light`: ImageVector? = null
