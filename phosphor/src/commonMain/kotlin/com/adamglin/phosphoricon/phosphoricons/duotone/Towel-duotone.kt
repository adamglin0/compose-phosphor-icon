...
public val DuotoneGroup.`Towel-duotone`: ImageVector
    get() {
        if (`_towel-duotone` != null) {
            return `_towel-duotone`!!
        }
        `_towel-duotone` = Builder(name = "Towel-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_towel-duotone`: ImageVector? = null
