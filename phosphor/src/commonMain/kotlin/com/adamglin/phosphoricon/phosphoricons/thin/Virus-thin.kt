...
public val ThinGroup.`Virus-thin`: ImageVector
    get() {
        if (`_virus-thin` != null) {
            return `_virus-thin`!!
        }
        `_virus-thin` = Builder(name = "Virus-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_virus-thin`: ImageVector? = null
