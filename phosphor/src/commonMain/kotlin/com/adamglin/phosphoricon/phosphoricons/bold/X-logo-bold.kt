...
public val BoldGroup.`X-logo-bold`: ImageVector
    get() {
        if (`_x-logo-bold` != null) {
            return `_x-logo-bold`!!
        }
        `_x-logo-bold` = Builder(name = "X-logo-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_x-logo-bold`: ImageVector? = null
