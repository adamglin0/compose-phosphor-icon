...
public val DuotoneGroup.`Invoice-duotone`: ImageVector
    get() {
        if (`_invoice-duotone` != null) {
            return `_invoice-duotone`!!
        }
        `_invoice-duotone` = Builder(name = "Invoice-duotone", defaultWidth = 256.0.dp,
...
private var `_invoice-duotone`: ImageVector? = null
