...
public val LightGroup.`Wheelchair-motion-light`: ImageVector
    get() {
        if (`_wheelchair-motion-light` != null) {
            return `_wheelchair-motion-light`!!
        }
        `_wheelchair-motion-light` = Builder(name = "Wheelchair-motion-light", defaultWidth =
...
private var `_wheelchair-motion-light`: ImageVector? = null
