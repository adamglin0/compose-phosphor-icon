...
public val DuotoneGroup.`Target-duotone`: ImageVector
    get() {
        if (`_target-duotone` != null) {
            return `_target-duotone`!!
        }
        `_target-duotone` = Builder(name = "Target-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_target-duotone`: ImageVector? = null
