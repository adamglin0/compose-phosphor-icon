...
public val BoldGroup.`Calendar-dot-bold`: ImageVector
    get() {
        if (`_calendar-dot-bold` != null) {
            return `_calendar-dot-bold`!!
        }
        `_calendar-dot-bold` = Builder(name = "Calendar-dot-bold", defaultWidth = 256.0.dp,
...
private var `_calendar-dot-bold`: ImageVector? = null
