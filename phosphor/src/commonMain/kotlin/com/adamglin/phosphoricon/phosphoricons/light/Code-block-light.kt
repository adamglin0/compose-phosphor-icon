...
public val LightGroup.`Code-block-light`: ImageVector
    get() {
        if (`_code-block-light` != null) {
            return `_code-block-light`!!
        }
        `_code-block-light` = Builder(name = "Code-block-light", defaultWidth = 256.0.dp,
...
private var `_code-block-light`: ImageVector? = null
