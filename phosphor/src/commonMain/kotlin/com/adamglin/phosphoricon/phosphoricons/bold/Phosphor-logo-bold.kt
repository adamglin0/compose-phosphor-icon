...
public val BoldGroup.`Phosphor-logo-bold`: ImageVector
    get() {
        if (`_phosphor-logo-bold` != null) {
            return `_phosphor-logo-bold`!!
        }
        `_phosphor-logo-bold` = Builder(name = "Phosphor-logo-bold", defaultWidth = 256.0.dp,
...
private var `_phosphor-logo-bold`: ImageVector? = null
