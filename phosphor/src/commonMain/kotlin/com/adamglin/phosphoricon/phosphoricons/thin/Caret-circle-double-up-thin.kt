...
public val ThinGroup.`Caret-circle-double-up-thin`: ImageVector
    get() {
        if (`_caret-circle-double-up-thin` != null) {
            return `_caret-circle-double-up-thin`!!
        }
        `_caret-circle-double-up-thin` = Builder(name = "Caret-circle-double-up-thin", defaultWidth
...
private var `_caret-circle-double-up-thin`: ImageVector? = null
