...
public val DuotoneGroup.`Folder-simple-star-duotone`: ImageVector
    get() {
        if (`_folder-simple-star-duotone` != null) {
            return `_folder-simple-star-duotone`!!
        }
        `_folder-simple-star-duotone` = Builder(name = "Folder-simple-star-duotone", defaultWidth =
...
private var `_folder-simple-star-duotone`: ImageVector? = null
