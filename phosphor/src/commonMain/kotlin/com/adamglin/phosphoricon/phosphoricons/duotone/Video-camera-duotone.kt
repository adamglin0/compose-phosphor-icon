...
public val DuotoneGroup.`Video-camera-duotone`: ImageVector
    get() {
        if (`_video-camera-duotone` != null) {
            return `_video-camera-duotone`!!
        }
        `_video-camera-duotone` = Builder(name = "Video-camera-duotone", defaultWidth = 256.0.dp,
...
private var `_video-camera-duotone`: ImageVector? = null
