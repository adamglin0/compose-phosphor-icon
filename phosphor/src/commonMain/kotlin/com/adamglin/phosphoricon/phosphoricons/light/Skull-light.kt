...
public val LightGroup.`Skull-light`: ImageVector
    get() {
        if (`_skull-light` != null) {
            return `_skull-light`!!
        }
        `_skull-light` = Builder(name = "Skull-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_skull-light`: ImageVector? = null
