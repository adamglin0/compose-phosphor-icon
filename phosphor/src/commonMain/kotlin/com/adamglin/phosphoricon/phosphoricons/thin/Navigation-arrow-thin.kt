...
public val ThinGroup.`Navigation-arrow-thin`: ImageVector
    get() {
        if (`_navigation-arrow-thin` != null) {
            return `_navigation-arrow-thin`!!
        }
        `_navigation-arrow-thin` = Builder(name = "Navigation-arrow-thin", defaultWidth = 256.0.dp,
...
private var `_navigation-arrow-thin`: ImageVector? = null
