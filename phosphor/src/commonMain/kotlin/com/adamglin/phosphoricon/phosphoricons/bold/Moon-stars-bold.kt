...
public val BoldGroup.`Moon-stars-bold`: ImageVector
    get() {
        if (`_moon-stars-bold` != null) {
            return `_moon-stars-bold`!!
        }
        `_moon-stars-bold` = Builder(name = "Moon-stars-bold", defaultWidth = 256.0.dp,
...
private var `_moon-stars-bold`: ImageVector? = null
