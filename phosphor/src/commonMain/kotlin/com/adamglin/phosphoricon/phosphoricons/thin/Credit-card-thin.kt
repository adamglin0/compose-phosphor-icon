...
public val ThinGroup.`Credit-card-thin`: ImageVector
    get() {
        if (`_credit-card-thin` != null) {
            return `_credit-card-thin`!!
        }
        `_credit-card-thin` = Builder(name = "Credit-card-thin", defaultWidth = 256.0.dp,
...
private var `_credit-card-thin`: ImageVector? = null
