...
public val ThinGroup.`Screwdriver-thin`: ImageVector
    get() {
        if (`_screwdriver-thin` != null) {
            return `_screwdriver-thin`!!
        }
        `_screwdriver-thin` = Builder(name = "Screwdriver-thin", defaultWidth = 256.0.dp,
...
private var `_screwdriver-thin`: ImageVector? = null
