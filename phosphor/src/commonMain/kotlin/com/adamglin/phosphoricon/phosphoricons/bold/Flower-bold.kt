...
public val BoldGroup.`Flower-bold`: ImageVector
    get() {
        if (`_flower-bold` != null) {
            return `_flower-bold`!!
        }
        `_flower-bold` = Builder(name = "Flower-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flower-bold`: ImageVector? = null
