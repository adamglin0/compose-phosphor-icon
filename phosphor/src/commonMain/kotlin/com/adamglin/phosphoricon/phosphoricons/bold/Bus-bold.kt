...
public val BoldGroup.`Bus-bold`: ImageVector
    get() {
        if (`_bus-bold` != null) {
            return `_bus-bold`!!
        }
        `_bus-bold` = Builder(name = "Bus-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_bus-bold`: ImageVector? = null
