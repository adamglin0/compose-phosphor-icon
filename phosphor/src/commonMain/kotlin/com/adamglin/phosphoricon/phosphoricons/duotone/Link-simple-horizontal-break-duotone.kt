...
public val DuotoneGroup.`Link-simple-horizontal-break-duotone`: ImageVector
    get() {
        if (`_link-simple-horizontal-break-duotone` != null) {
            return `_link-simple-horizontal-break-duotone`!!
        }
        `_link-simple-horizontal-break-duotone` = Builder(name =
                "Link-simple-horizontal-break-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_link-simple-horizontal-break-duotone`: ImageVector? = null
