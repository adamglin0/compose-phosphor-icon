...
public val RegularGroup.`Microsoft-excel-logo`: ImageVector
    get() {
        if (`_microsoft-excel-logo` != null) {
            return `_microsoft-excel-logo`!!
        }
        `_microsoft-excel-logo` = Builder(name = "Microsoft-excel-logo", defaultWidth = 256.0.dp,
...
private var `_microsoft-excel-logo`: ImageVector? = null
