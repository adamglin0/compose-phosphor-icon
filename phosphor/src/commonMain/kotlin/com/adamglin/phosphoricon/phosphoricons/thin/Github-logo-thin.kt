...
public val ThinGroup.`Github-logo-thin`: ImageVector
    get() {
        if (`_github-logo-thin` != null) {
            return `_github-logo-thin`!!
        }
        `_github-logo-thin` = Builder(name = "Github-logo-thin", defaultWidth = 256.0.dp,
...
private var `_github-logo-thin`: ImageVector? = null
