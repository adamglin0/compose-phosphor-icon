...
public val DuotoneGroup.`Drop-duotone`: ImageVector
    get() {
        if (`_drop-duotone` != null) {
            return `_drop-duotone`!!
        }
        `_drop-duotone` = Builder(name = "Drop-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_drop-duotone`: ImageVector? = null
