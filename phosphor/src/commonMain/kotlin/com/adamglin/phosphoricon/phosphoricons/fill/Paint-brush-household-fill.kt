...
public val FillGroup.`Paint-brush-household-fill`: ImageVector
    get() {
        if (`_paint-brush-household-fill` != null) {
            return `_paint-brush-household-fill`!!
        }
        `_paint-brush-household-fill` = Builder(name = "Paint-brush-household-fill", defaultWidth =
...
private var `_paint-brush-household-fill`: ImageVector? = null
