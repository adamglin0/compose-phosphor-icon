...
public val LightGroup.`Tennis-ball-light`: ImageVector
    get() {
        if (`_tennis-ball-light` != null) {
            return `_tennis-ball-light`!!
        }
        `_tennis-ball-light` = Builder(name = "Tennis-ball-light", defaultWidth = 256.0.dp,
...
private var `_tennis-ball-light`: ImageVector? = null
