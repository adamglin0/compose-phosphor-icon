...
public val LightGroup.`Skip-back-circle-light`: ImageVector
    get() {
        if (`_skip-back-circle-light` != null) {
            return `_skip-back-circle-light`!!
        }
        `_skip-back-circle-light` = Builder(name = "Skip-back-circle-light", defaultWidth =
...
private var `_skip-back-circle-light`: ImageVector? = null
