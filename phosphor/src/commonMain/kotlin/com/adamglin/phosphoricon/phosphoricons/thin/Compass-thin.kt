...
public val ThinGroup.`Compass-thin`: ImageVector
    get() {
        if (`_compass-thin` != null) {
            return `_compass-thin`!!
        }
        `_compass-thin` = Builder(name = "Compass-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_compass-thin`: ImageVector? = null
