...
public val LightGroup.`Battery-low-light`: ImageVector
    get() {
        if (`_battery-low-light` != null) {
            return `_battery-low-light`!!
        }
        `_battery-low-light` = Builder(name = "Battery-low-light", defaultWidth = 256.0.dp,
...
private var `_battery-low-light`: ImageVector? = null
