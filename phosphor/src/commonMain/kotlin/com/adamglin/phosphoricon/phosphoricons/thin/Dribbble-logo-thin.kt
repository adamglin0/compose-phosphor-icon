...
public val ThinGroup.`Dribbble-logo-thin`: ImageVector
    get() {
        if (`_dribbble-logo-thin` != null) {
            return `_dribbble-logo-thin`!!
        }
        `_dribbble-logo-thin` = Builder(name = "Dribbble-logo-thin", defaultWidth = 256.0.dp,
...
private var `_dribbble-logo-thin`: ImageVector? = null
