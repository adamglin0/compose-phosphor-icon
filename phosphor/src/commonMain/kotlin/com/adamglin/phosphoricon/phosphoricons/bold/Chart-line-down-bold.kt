...
public val BoldGroup.`Chart-line-down-bold`: ImageVector
    get() {
        if (`_chart-line-down-bold` != null) {
            return `_chart-line-down-bold`!!
        }
        `_chart-line-down-bold` = Builder(name = "Chart-line-down-bold", defaultWidth = 256.0.dp,
...
private var `_chart-line-down-bold`: ImageVector? = null
