...
public val LightGroup.`Calendar-dot-light`: ImageVector
    get() {
        if (`_calendar-dot-light` != null) {
            return `_calendar-dot-light`!!
        }
        `_calendar-dot-light` = Builder(name = "Calendar-dot-light", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(14.0f, 14.0f, 0.0f, false, true, 142.0f, 152.0f)
                close()
            }
        }
        .build()
...
private var `_calendar-dot-light`: ImageVector? = null
