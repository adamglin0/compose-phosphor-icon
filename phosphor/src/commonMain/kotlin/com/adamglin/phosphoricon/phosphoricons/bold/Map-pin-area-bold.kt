...
public val BoldGroup.`Map-pin-area-bold`: ImageVector
    get() {
        if (`_map-pin-area-bold` != null) {
            return `_map-pin-area-bold`!!
        }
        `_map-pin-area-bold` = Builder(name = "Map-pin-area-bold", defaultWidth = 256.0.dp,
...
private var `_map-pin-area-bold`: ImageVector? = null
