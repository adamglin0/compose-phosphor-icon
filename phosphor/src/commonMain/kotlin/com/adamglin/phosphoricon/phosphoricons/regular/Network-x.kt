...
public val RegularGroup.`Network-x`: ImageVector
    get() {
        if (`_network-x` != null) {
            return `_network-x`!!
        }
        `_network-x` = Builder(name = "Network-x", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_network-x`: ImageVector? = null
