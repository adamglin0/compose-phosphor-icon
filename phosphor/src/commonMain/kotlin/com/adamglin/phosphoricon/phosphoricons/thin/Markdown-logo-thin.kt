...
public val ThinGroup.`Markdown-logo-thin`: ImageVector
    get() {
        if (`_markdown-logo-thin` != null) {
            return `_markdown-logo-thin`!!
        }
        `_markdown-logo-thin` = Builder(name = "Markdown-logo-thin", defaultWidth = 256.0.dp,
...
private var `_markdown-logo-thin`: ImageVector? = null
