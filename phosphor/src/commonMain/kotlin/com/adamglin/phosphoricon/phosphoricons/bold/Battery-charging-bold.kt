...
public val BoldGroup.`Battery-charging-bold`: ImageVector
    get() {
        if (`_battery-charging-bold` != null) {
            return `_battery-charging-bold`!!
        }
        `_battery-charging-bold` = Builder(name = "Battery-charging-bold", defaultWidth = 256.0.dp,
...
private var `_battery-charging-bold`: ImageVector? = null
