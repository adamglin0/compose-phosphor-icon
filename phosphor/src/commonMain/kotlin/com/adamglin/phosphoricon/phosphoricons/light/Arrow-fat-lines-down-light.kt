...
public val LightGroup.`Arrow-fat-lines-down-light`: ImageVector
    get() {
        if (`_arrow-fat-lines-down-light` != null) {
            return `_arrow-fat-lines-down-light`!!
        }
        `_arrow-fat-lines-down-light` = Builder(name = "Arrow-fat-lines-down-light", defaultWidth =
...
private var `_arrow-fat-lines-down-light`: ImageVector? = null
