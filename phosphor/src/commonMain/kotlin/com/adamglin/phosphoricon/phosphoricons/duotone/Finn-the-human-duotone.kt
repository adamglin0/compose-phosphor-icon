...
public val DuotoneGroup.`Finn-the-human-duotone`: ImageVector
    get() {
        if (`_finn-the-human-duotone` != null) {
            return `_finn-the-human-duotone`!!
        }
        `_finn-the-human-duotone` = Builder(name = "Finn-the-human-duotone", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(72.08f, 72.08f, 0.0f, false, false, 72.0f, -72.0f)
                lineTo(240.0f, 72.0f)
                arcTo(32.0f, 32.0f, 0.0f, false, false, 208.0f, 40.0f)
                close()
...
private var `_finn-the-human-duotone`: ImageVector? = null
