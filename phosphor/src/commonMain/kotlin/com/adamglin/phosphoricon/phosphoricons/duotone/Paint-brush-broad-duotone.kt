...
public val DuotoneGroup.`Paint-brush-broad-duotone`: ImageVector
    get() {
        if (`_paint-brush-broad-duotone` != null) {
            return `_paint-brush-broad-duotone`!!
        }
        `_paint-brush-broad-duotone` = Builder(name = "Paint-brush-broad-duotone", defaultWidth =
...
private var `_paint-brush-broad-duotone`: ImageVector? = null
