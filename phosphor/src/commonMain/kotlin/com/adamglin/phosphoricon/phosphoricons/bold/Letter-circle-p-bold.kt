...
public val BoldGroup.`Letter-circle-p-bold`: ImageVector
    get() {
        if (`_letter-circle-p-bold` != null) {
            return `_letter-circle-p-bold`!!
        }
        `_letter-circle-p-bold` = Builder(name = "Letter-circle-p-bold", defaultWidth = 256.0.dp,
...
private var `_letter-circle-p-bold`: ImageVector? = null
