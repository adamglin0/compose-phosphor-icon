...
public val LightGroup.`Sword-light`: ImageVector
    get() {
        if (`_sword-light` != null) {
            return `_sword-light`!!
        }
        `_sword-light` = Builder(name = "Sword-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sword-light`: ImageVector? = null
