...
public val RegularGroup.`Monitor-play`: ImageVector
    get() {
        if (`_monitor-play` != null) {
            return `_monitor-play`!!
        }
        `_monitor-play` = Builder(name = "Monitor-play", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_monitor-play`: ImageVector? = null
