...
public val LightGroup.`Info-light`: ImageVector
    get() {
        if (`_info-light` != null) {
            return `_info-light`!!
        }
        `_info-light` = Builder(name = "Info-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_info-light`: ImageVector? = null
