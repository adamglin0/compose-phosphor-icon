...
public val BoldGroup.`Vignette-bold`: ImageVector
    get() {
        if (`_vignette-bold` != null) {
            return `_vignette-bold`!!
        }
        `_vignette-bold` = Builder(name = "Vignette-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_vignette-bold`: ImageVector? = null
