...
public val ThinGroup.`Grains-slash-thin`: ImageVector
    get() {
        if (`_grains-slash-thin` != null) {
            return `_grains-slash-thin`!!
        }
        `_grains-slash-thin` = Builder(name = "Grains-slash-thin", defaultWidth = 256.0.dp,
...
private var `_grains-slash-thin`: ImageVector? = null
