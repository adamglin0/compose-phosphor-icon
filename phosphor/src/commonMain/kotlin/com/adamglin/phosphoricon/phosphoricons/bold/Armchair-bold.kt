...
public val BoldGroup.`Armchair-bold`: ImageVector
    get() {
        if (`_armchair-bold` != null) {
            return `_armchair-bold`!!
        }
        `_armchair-bold` = Builder(name = "Armchair-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_armchair-bold`: ImageVector? = null
