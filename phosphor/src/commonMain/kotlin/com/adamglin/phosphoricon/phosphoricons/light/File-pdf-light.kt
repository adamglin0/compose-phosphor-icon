...
public val LightGroup.`File-pdf-light`: ImageVector
    get() {
        if (`_file-pdf-light` != null) {
            return `_file-pdf-light`!!
        }
        `_file-pdf-light` = Builder(name = "File-pdf-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-pdf-light`: ImageVector? = null
