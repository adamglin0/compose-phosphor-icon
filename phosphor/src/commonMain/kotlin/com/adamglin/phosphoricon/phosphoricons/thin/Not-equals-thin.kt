...
public val ThinGroup.`Not-equals-thin`: ImageVector
    get() {
        if (`_not-equals-thin` != null) {
            return `_not-equals-thin`!!
        }
        `_not-equals-thin` = Builder(name = "Not-equals-thin", defaultWidth = 256.0.dp,
...
private var `_not-equals-thin`: ImageVector? = null
