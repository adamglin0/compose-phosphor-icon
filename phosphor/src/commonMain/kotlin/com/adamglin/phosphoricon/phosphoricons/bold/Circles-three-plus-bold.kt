...
public val BoldGroup.`Circles-three-plus-bold`: ImageVector
    get() {
        if (`_circles-three-plus-bold` != null) {
            return `_circles-three-plus-bold`!!
        }
        `_circles-three-plus-bold` = Builder(name = "Circles-three-plus-bold", defaultWidth =
...
private var `_circles-three-plus-bold`: ImageVector? = null
