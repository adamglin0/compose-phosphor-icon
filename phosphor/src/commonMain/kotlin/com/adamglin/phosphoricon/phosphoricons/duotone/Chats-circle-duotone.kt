...
public val DuotoneGroup.`Chats-circle-duotone`: ImageVector
    get() {
        if (`_chats-circle-duotone` != null) {
            return `_chats-circle-duotone`!!
        }
        `_chats-circle-duotone` = Builder(name = "Chats-circle-duotone", defaultWidth = 256.0.dp,
...
private var `_chats-circle-duotone`: ImageVector? = null
