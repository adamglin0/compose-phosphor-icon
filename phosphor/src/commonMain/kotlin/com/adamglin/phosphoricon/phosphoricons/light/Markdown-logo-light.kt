...
public val LightGroup.`Markdown-logo-light`: ImageVector
    get() {
        if (`_markdown-logo-light` != null) {
            return `_markdown-logo-light`!!
        }
        `_markdown-logo-light` = Builder(name = "Markdown-logo-light", defaultWidth = 256.0.dp,
...
private var `_markdown-logo-light`: ImageVector? = null
