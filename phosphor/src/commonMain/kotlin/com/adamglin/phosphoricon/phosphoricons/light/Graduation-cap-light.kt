...
public val LightGroup.`Graduation-cap-light`: ImageVector
    get() {
        if (`_graduation-cap-light` != null) {
            return `_graduation-cap-light`!!
        }
        `_graduation-cap-light` = Builder(name = "Graduation-cap-light", defaultWidth = 256.0.dp,
...
private var `_graduation-cap-light`: ImageVector? = null
