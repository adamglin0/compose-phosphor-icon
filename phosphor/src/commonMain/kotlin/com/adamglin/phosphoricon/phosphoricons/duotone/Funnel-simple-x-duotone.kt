...
public val DuotoneGroup.`Funnel-simple-x-duotone`: ImageVector
    get() {
        if (`_funnel-simple-x-duotone` != null) {
            return `_funnel-simple-x-duotone`!!
        }
        `_funnel-simple-x-duotone` = Builder(name = "Funnel-simple-x-duotone", defaultWidth =
...
private var `_funnel-simple-x-duotone`: ImageVector? = null
