...
public val FillGroup.`Heart-break-fill`: ImageVector
    get() {
        if (`_heart-break-fill` != null) {
            return `_heart-break-fill`!!
        }
        `_heart-break-fill` = Builder(name = "Heart-break-fill", defaultWidth = 256.0.dp,
...
private var `_heart-break-fill`: ImageVector? = null
