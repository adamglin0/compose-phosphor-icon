...
public val DuotoneGroup.`Tree-structure-duotone`: ImageVector
    get() {
        if (`_tree-structure-duotone` != null) {
            return `_tree-structure-duotone`!!
        }
        `_tree-structure-duotone` = Builder(name = "Tree-structure-duotone", defaultWidth =
...
private var `_tree-structure-duotone`: ImageVector? = null
