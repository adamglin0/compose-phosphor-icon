...
public val BoldGroup.`Receipt-x-bold`: ImageVector
    get() {
        if (`_receipt-x-bold` != null) {
            return `_receipt-x-bold`!!
        }
        `_receipt-x-bold` = Builder(name = "Receipt-x-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_receipt-x-bold`: ImageVector? = null
