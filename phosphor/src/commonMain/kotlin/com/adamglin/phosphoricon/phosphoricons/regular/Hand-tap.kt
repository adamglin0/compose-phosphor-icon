...
public val RegularGroup.`Hand-tap`: ImageVector
    get() {
        if (`_hand-tap` != null) {
            return `_hand-tap`!!
        }
        `_hand-tap` = Builder(name = "Hand-tap", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_hand-tap`: ImageVector? = null
