...
public val DuotoneGroup.`Arrow-fat-lines-right-duotone`: ImageVector
    get() {
        if (`_arrow-fat-lines-right-duotone` != null) {
            return `_arrow-fat-lines-right-duotone`!!
        }
        `_arrow-fat-lines-right-duotone` = Builder(name = "Arrow-fat-lines-right-duotone",
...
private var `_arrow-fat-lines-right-duotone`: ImageVector? = null
