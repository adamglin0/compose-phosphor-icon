...
public val ThinGroup.`Stack-minus-thin`: ImageVector
    get() {
        if (`_stack-minus-thin` != null) {
            return `_stack-minus-thin`!!
        }
        `_stack-minus-thin` = Builder(name = "Stack-minus-thin", defaultWidth = 256.0.dp,
...
private var `_stack-minus-thin`: ImageVector? = null
