...
public val BoldGroup.`Biohazard-bold`: ImageVector
    get() {
        if (`_biohazard-bold` != null) {
            return `_biohazard-bold`!!
        }
        `_biohazard-bold` = Builder(name = "Biohazard-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_biohazard-bold`: ImageVector? = null
