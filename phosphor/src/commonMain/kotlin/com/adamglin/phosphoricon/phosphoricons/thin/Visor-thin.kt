...
public val ThinGroup.`Visor-thin`: ImageVector
    get() {
        if (`_visor-thin` != null) {
            return `_visor-thin`!!
        }
        `_visor-thin` = Builder(name = "Visor-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_visor-thin`: ImageVector? = null
