...
public val FillGroup.`Highlighter-circle-fill`: ImageVector
    get() {
        if (`_highlighter-circle-fill` != null) {
            return `_highlighter-circle-fill`!!
        }
        `_highlighter-circle-fill` = Builder(name = "Highlighter-circle-fill", defaultWidth =
...
private var `_highlighter-circle-fill`: ImageVector? = null
