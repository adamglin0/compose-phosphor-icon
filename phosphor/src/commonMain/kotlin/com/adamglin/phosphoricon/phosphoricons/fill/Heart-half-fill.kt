...
public val FillGroup.`Heart-half-fill`: ImageVector
    get() {
        if (`_heart-half-fill` != null) {
            return `_heart-half-fill`!!
        }
        `_heart-half-fill` = Builder(name = "Heart-half-fill", defaultWidth = 256.0.dp,
...
private var `_heart-half-fill`: ImageVector? = null
