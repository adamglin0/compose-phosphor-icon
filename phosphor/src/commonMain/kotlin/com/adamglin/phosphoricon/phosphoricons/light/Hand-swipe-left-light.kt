...
public val LightGroup.`Hand-swipe-left-light`: ImageVector
    get() {
        if (`_hand-swipe-left-light` != null) {
            return `_hand-swipe-left-light`!!
        }
        `_hand-swipe-left-light` = Builder(name = "Hand-swipe-left-light", defaultWidth = 256.0.dp,
...
private var `_hand-swipe-left-light`: ImageVector? = null
