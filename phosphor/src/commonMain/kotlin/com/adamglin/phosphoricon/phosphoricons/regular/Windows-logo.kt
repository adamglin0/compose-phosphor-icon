...
public val RegularGroup.`Windows-logo`: ImageVector
    get() {
        if (`_windows-logo` != null) {
            return `_windows-logo`!!
        }
        `_windows-logo` = Builder(name = "Windows-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_windows-logo`: ImageVector? = null
