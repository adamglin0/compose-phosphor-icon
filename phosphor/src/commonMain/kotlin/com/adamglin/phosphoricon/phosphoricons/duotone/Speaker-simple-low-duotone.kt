...
public val DuotoneGroup.`Speaker-simple-low-duotone`: ImageVector
    get() {
        if (`_speaker-simple-low-duotone` != null) {
            return `_speaker-simple-low-duotone`!!
        }
        `_speaker-simple-low-duotone` = Builder(name = "Speaker-simple-low-duotone", defaultWidth =
...
private var `_speaker-simple-low-duotone`: ImageVector? = null
