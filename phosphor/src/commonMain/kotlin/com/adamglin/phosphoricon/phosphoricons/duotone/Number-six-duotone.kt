...
public val DuotoneGroup.`Number-six-duotone`: ImageVector
    get() {
        if (`_number-six-duotone` != null) {
            return `_number-six-duotone`!!
        }
        `_number-six-duotone` = Builder(name = "Number-six-duotone", defaultWidth = 256.0.dp,
...
private var `_number-six-duotone`: ImageVector? = null
