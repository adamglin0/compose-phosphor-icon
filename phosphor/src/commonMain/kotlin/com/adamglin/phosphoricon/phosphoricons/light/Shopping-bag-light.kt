...
public val LightGroup.`Shopping-bag-light`: ImageVector
    get() {
        if (`_shopping-bag-light` != null) {
            return `_shopping-bag-light`!!
        }
        `_shopping-bag-light` = Builder(name = "Shopping-bag-light", defaultWidth = 256.0.dp,
...
private var `_shopping-bag-light`: ImageVector? = null
