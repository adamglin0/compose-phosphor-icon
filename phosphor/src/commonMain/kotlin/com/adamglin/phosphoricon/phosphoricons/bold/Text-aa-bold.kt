...
public val BoldGroup.`Text-aa-bold`: ImageVector
    get() {
        if (`_text-aa-bold` != null) {
            return `_text-aa-bold`!!
        }
        `_text-aa-bold` = Builder(name = "Text-aa-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-aa-bold`: ImageVector? = null
