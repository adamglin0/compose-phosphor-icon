...
public val BoldGroup.`Globe-hemisphere-east-bold`: ImageVector
    get() {
        if (`_globe-hemisphere-east-bold` != null) {
            return `_globe-hemisphere-east-bold`!!
        }
        `_globe-hemisphere-east-bold` = Builder(name = "Globe-hemisphere-east-bold", defaultWidth =
...
private var `_globe-hemisphere-east-bold`: ImageVector? = null
