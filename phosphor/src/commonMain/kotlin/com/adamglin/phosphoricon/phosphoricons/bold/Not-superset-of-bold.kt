...
public val BoldGroup.`Not-superset-of-bold`: ImageVector
    get() {
        if (`_not-superset-of-bold` != null) {
            return `_not-superset-of-bold`!!
        }
        `_not-superset-of-bold` = Builder(name = "Not-superset-of-bold", defaultWidth = 256.0.dp,
...
private var `_not-superset-of-bold`: ImageVector? = null
