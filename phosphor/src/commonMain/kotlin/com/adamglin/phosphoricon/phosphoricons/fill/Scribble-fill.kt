...
public val FillGroup.`Scribble-fill`: ImageVector
    get() {
        if (`_scribble-fill` != null) {
            return `_scribble-fill`!!
        }
        `_scribble-fill` = Builder(name = "Scribble-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scribble-fill`: ImageVector? = null
