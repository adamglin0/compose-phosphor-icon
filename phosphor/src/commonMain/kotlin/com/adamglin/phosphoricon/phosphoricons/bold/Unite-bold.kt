...
public val BoldGroup.`Unite-bold`: ImageVector
    get() {
        if (`_unite-bold` != null) {
            return `_unite-bold`!!
        }
        `_unite-bold` = Builder(name = "Unite-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_unite-bold`: ImageVector? = null
