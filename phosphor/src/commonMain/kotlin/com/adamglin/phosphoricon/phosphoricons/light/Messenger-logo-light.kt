...
public val LightGroup.`Messenger-logo-light`: ImageVector
    get() {
        if (`_messenger-logo-light` != null) {
            return `_messenger-logo-light`!!
        }
        `_messenger-logo-light` = Builder(name = "Messenger-logo-light", defaultWidth = 256.0.dp,
...
private var `_messenger-logo-light`: ImageVector? = null
