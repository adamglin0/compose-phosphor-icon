...
public val ThinGroup.`Oven-thin`: ImageVector
    get() {
        if (`_oven-thin` != null) {
            return `_oven-thin`!!
        }
        `_oven-thin` = Builder(name = "Oven-thin", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 76.0f, 76.0f)
                close()
                moveTo(120.0f, 76.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, true, true, 8.0f, 8.0f)
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, false, 184.0f, 108.0f)
                close()
...
private var `_oven-thin`: ImageVector? = null
