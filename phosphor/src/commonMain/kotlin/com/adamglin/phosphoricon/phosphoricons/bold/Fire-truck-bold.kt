...
public val BoldGroup.`Fire-truck-bold`: ImageVector
    get() {
        if (`_fire-truck-bold` != null) {
            return `_fire-truck-bold`!!
        }
        `_fire-truck-bold` = Builder(name = "Fire-truck-bold", defaultWidth = 256.0.dp,
...
private var `_fire-truck-bold`: ImageVector? = null
