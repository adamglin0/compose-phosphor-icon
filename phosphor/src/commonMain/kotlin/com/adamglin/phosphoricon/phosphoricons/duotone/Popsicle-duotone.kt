...
public val DuotoneGroup.`Popsicle-duotone`: ImageVector
    get() {
        if (`_popsicle-duotone` != null) {
            return `_popsicle-duotone`!!
        }
        `_popsicle-duotone` = Builder(name = "Popsicle-duotone", defaultWidth = 256.0.dp,
...
private var `_popsicle-duotone`: ImageVector? = null
