...
public val LightGroup.`Paper-plane-light`: ImageVector
    get() {
        if (`_paper-plane-light` != null) {
            return `_paper-plane-light`!!
        }
        `_paper-plane-light` = Builder(name = "Paper-plane-light", defaultWidth = 256.0.dp,
...
private var `_paper-plane-light`: ImageVector? = null
