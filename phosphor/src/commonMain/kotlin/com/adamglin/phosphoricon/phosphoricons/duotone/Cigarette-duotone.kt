...
public val DuotoneGroup.`Cigarette-duotone`: ImageVector
    get() {
        if (`_cigarette-duotone` != null) {
            return `_cigarette-duotone`!!
        }
        `_cigarette-duotone` = Builder(name = "Cigarette-duotone", defaultWidth = 256.0.dp,
...
private var `_cigarette-duotone`: ImageVector? = null
