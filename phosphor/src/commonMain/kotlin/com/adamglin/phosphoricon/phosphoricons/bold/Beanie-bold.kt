...
public val BoldGroup.`Beanie-bold`: ImageVector
    get() {
        if (`_beanie-bold` != null) {
            return `_beanie-bold`!!
        }
        `_beanie-bold` = Builder(name = "Beanie-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_beanie-bold`: ImageVector? = null
