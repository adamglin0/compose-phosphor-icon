...
public val DuotoneGroup.`Backspace-duotone`: ImageVector
    get() {
        if (`_backspace-duotone` != null) {
            return `_backspace-duotone`!!
        }
        `_backspace-duotone` = Builder(name = "Backspace-duotone", defaultWidth = 256.0.dp,
...
private var `_backspace-duotone`: ImageVector? = null
