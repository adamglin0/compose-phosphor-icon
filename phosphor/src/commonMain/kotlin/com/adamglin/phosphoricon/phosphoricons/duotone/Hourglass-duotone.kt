...
public val DuotoneGroup.`Hourglass-duotone`: ImageVector
    get() {
        if (`_hourglass-duotone` != null) {
            return `_hourglass-duotone`!!
        }
        `_hourglass-duotone` = Builder(name = "Hourglass-duotone", defaultWidth = 256.0.dp,
...
private var `_hourglass-duotone`: ImageVector? = null
