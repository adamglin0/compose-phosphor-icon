...
public val BoldGroup.`Git-diff-bold`: ImageVector
    get() {
        if (`_git-diff-bold` != null) {
            return `_git-diff-bold`!!
        }
        `_git-diff-bold` = Builder(name = "Git-diff-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_git-diff-bold`: ImageVector? = null
