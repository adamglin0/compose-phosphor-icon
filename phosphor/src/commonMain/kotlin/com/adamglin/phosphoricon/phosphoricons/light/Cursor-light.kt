...
public val LightGroup.`Cursor-light`: ImageVector
    get() {
        if (`_cursor-light` != null) {
            return `_cursor-light`!!
        }
        `_cursor-light` = Builder(name = "Cursor-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cursor-light`: ImageVector? = null
