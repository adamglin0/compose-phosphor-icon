...
public val DuotoneGroup.`Books-duotone`: ImageVector
    get() {
        if (`_books-duotone` != null) {
            return `_books-duotone`!!
        }
        `_books-duotone` = Builder(name = "Books-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_books-duotone`: ImageVector? = null
