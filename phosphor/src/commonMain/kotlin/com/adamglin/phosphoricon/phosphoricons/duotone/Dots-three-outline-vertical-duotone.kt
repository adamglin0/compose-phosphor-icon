...
public val DuotoneGroup.`Dots-three-outline-vertical-duotone`: ImageVector
    get() {
        if (`_dots-three-outline-vertical-duotone` != null) {
            return `_dots-three-outline-vertical-duotone`!!
        }
        `_dots-three-outline-vertical-duotone` = Builder(name =
                "Dots-three-outline-vertical-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dots-three-outline-vertical-duotone`: ImageVector? = null
