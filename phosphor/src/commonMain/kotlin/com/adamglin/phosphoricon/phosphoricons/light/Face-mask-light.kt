...
public val LightGroup.`Face-mask-light`: ImageVector
    get() {
        if (`_face-mask-light` != null) {
            return `_face-mask-light`!!
        }
        `_face-mask-light` = Builder(name = "Face-mask-light", defaultWidth = 256.0.dp,
...
private var `_face-mask-light`: ImageVector? = null
