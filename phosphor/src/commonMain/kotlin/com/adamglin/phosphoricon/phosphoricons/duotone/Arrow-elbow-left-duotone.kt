...
public val DuotoneGroup.`Arrow-elbow-left-duotone`: ImageVector
    get() {
        if (`_arrow-elbow-left-duotone` != null) {
            return `_arrow-elbow-left-duotone`!!
        }
        `_arrow-elbow-left-duotone` = Builder(name = "Arrow-elbow-left-duotone", defaultWidth =
...
private var `_arrow-elbow-left-duotone`: ImageVector? = null
