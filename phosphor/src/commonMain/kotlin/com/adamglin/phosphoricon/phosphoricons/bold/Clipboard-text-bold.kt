...
public val BoldGroup.`Clipboard-text-bold`: ImageVector
    get() {
        if (`_clipboard-text-bold` != null) {
            return `_clipboard-text-bold`!!
        }
        `_clipboard-text-bold` = Builder(name = "Clipboard-text-bold", defaultWidth = 256.0.dp,
...
private var `_clipboard-text-bold`: ImageVector? = null
