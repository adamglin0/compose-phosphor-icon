...
public val LightGroup.`Push-pin-simple-slash-light`: ImageVector
    get() {
        if (`_push-pin-simple-slash-light` != null) {
            return `_push-pin-simple-slash-light`!!
        }
        `_push-pin-simple-slash-light` = Builder(name = "Push-pin-simple-slash-light", defaultWidth
...
private var `_push-pin-simple-slash-light`: ImageVector? = null
