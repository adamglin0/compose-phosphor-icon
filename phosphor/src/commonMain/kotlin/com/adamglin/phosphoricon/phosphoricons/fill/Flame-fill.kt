...
public val FillGroup.`Flame-fill`: ImageVector
    get() {
        if (`_flame-fill` != null) {
            return `_flame-fill`!!
        }
        `_flame-fill` = Builder(name = "Flame-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flame-fill`: ImageVector? = null
