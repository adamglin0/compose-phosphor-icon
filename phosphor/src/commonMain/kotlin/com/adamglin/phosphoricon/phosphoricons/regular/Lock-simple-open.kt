...
public val RegularGroup.`Lock-simple-open`: ImageVector
    get() {
        if (`_lock-simple-open` != null) {
            return `_lock-simple-open`!!
        }
        `_lock-simple-open` = Builder(name = "Lock-simple-open", defaultWidth = 256.0.dp,
...
private var `_lock-simple-open`: ImageVector? = null
