...
public val BoldGroup.`Globe-simple-x-bold`: ImageVector
    get() {
        if (`_globe-simple-x-bold` != null) {
            return `_globe-simple-x-bold`!!
        }
        `_globe-simple-x-bold` = Builder(name = "Globe-simple-x-bold", defaultWidth = 256.0.dp,
...
private var `_globe-simple-x-bold`: ImageVector? = null
