...
public val LightGroup.`Highlighter-circle-light`: ImageVector
    get() {
        if (`_highlighter-circle-light` != null) {
            return `_highlighter-circle-light`!!
        }
        `_highlighter-circle-light` = Builder(name = "Highlighter-circle-light", defaultWidth =
...
private var `_highlighter-circle-light`: ImageVector? = null
