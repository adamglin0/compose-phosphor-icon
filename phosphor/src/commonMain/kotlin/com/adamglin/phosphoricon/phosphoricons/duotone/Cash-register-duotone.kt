...
public val DuotoneGroup.`Cash-register-duotone`: ImageVector
    get() {
        if (`_cash-register-duotone` != null) {
            return `_cash-register-duotone`!!
        }
        `_cash-register-duotone` = Builder(name = "Cash-register-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 54.25f, 64.0f)
                horizontalLineToRelative(147.5f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 7.76f, 6.06f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 160.0f, 96.0f)
                close()
                moveTo(64.0f, 128.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 8.0f, -8.0f)
                lineTo(88.0f, 120.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.0f, 16.0f)
                lineTo(72.0f, 136.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 64.0f, 128.0f)
                close()
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 112.0f, 128.0f)
                close()
...
private var `_cash-register-duotone`: ImageVector? = null
