...
public val LightGroup.`Speaker-none-light`: ImageVector
    get() {
        if (`_speaker-none-light` != null) {
            return `_speaker-none-light`!!
        }
        `_speaker-none-light` = Builder(name = "Speaker-none-light", defaultWidth = 256.0.dp,
...
private var `_speaker-none-light`: ImageVector? = null
