...
public val RegularGroup.`Sneaker-move`: ImageVector
    get() {
        if (`_sneaker-move` != null) {
            return `_sneaker-move`!!
        }
        `_sneaker-move` = Builder(name = "Sneaker-move", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sneaker-move`: ImageVector? = null
