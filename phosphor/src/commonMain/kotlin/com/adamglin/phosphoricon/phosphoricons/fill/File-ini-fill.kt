...
public val FillGroup.`File-ini-fill`: ImageVector
    get() {
        if (`_file-ini-fill` != null) {
            return `_file-ini-fill`!!
        }
        `_file-ini-fill` = Builder(name = "File-ini-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-ini-fill`: ImageVector? = null
