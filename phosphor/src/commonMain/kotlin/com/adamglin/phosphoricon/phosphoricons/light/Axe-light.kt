...
public val LightGroup.`Axe-light`: ImageVector
    get() {
        if (`_axe-light` != null) {
            return `_axe-light`!!
        }
        `_axe-light` = Builder(name = "Axe-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_axe-light`: ImageVector? = null
