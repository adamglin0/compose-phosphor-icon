...
public val DuotoneGroup.`Align-bottom-duotone`: ImageVector
    get() {
        if (`_align-bottom-duotone` != null) {
            return `_align-bottom-duotone`!!
        }
        `_align-bottom-duotone` = Builder(name = "Align-bottom-duotone", defaultWidth = 256.0.dp,
...
private var `_align-bottom-duotone`: ImageVector? = null
