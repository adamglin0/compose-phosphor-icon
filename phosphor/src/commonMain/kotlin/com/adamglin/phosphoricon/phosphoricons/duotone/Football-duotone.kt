...
public val DuotoneGroup.`Football-duotone`: ImageVector
    get() {
        if (`_football-duotone` != null) {
            return `_football-duotone`!!
        }
        `_football-duotone` = Builder(name = "Football-duotone", defaultWidth = 256.0.dp,
...
private var `_football-duotone`: ImageVector? = null
