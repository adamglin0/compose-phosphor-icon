...
public val BoldGroup.`Belt-bold`: ImageVector
    get() {
        if (`_belt-bold` != null) {
            return `_belt-bold`!!
        }
        `_belt-bold` = Builder(name = "Belt-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_belt-bold`: ImageVector? = null
