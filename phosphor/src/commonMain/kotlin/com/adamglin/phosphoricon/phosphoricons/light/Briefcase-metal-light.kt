...
public val LightGroup.`Briefcase-metal-light`: ImageVector
    get() {
        if (`_briefcase-metal-light` != null) {
            return `_briefcase-metal-light`!!
        }
        `_briefcase-metal-light` = Builder(name = "Briefcase-metal-light", defaultWidth = 256.0.dp,
...
private var `_briefcase-metal-light`: ImageVector? = null
