...
public val ThinGroup.`Person-simple-circle-thin`: ImageVector
    get() {
        if (`_person-simple-circle-thin` != null) {
            return `_person-simple-circle-thin`!!
        }
        `_person-simple-circle-thin` = Builder(name = "Person-simple-circle-thin", defaultWidth =
...
private var `_person-simple-circle-thin`: ImageVector? = null
