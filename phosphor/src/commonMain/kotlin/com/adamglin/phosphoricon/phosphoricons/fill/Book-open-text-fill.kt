...
public val FillGroup.`Book-open-text-fill`: ImageVector
    get() {
        if (`_book-open-text-fill` != null) {
            return `_book-open-text-fill`!!
        }
        `_book-open-text-fill` = Builder(name = "Book-open-text-fill", defaultWidth = 256.0.dp,
...
private var `_book-open-text-fill`: ImageVector? = null
