...
public val DuotoneGroup.`Dice-two-duotone`: ImageVector
    get() {
        if (`_dice-two-duotone` != null) {
            return `_dice-two-duotone`!!
        }
        `_dice-two-duotone` = Builder(name = "Dice-two-duotone", defaultWidth = 256.0.dp,
...
private var `_dice-two-duotone`: ImageVector? = null
