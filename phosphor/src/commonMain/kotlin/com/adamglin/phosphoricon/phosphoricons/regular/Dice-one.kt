...
public val RegularGroup.`Dice-one`: ImageVector
    get() {
        if (`_dice-one` != null) {
            return `_dice-one`!!
        }
        `_dice-one` = Builder(name = "Dice-one", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dice-one`: ImageVector? = null
