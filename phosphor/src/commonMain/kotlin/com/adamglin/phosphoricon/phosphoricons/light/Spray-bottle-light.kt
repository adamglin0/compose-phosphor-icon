...
public val LightGroup.`Spray-bottle-light`: ImageVector
    get() {
        if (`_spray-bottle-light` != null) {
            return `_spray-bottle-light`!!
        }
        `_spray-bottle-light` = Builder(name = "Spray-bottle-light", defaultWidth = 256.0.dp,
...
private var `_spray-bottle-light`: ImageVector? = null
