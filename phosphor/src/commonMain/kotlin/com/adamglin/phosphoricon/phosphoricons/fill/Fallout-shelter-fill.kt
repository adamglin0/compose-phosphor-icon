...
public val FillGroup.`Fallout-shelter-fill`: ImageVector
    get() {
        if (`_fallout-shelter-fill` != null) {
            return `_fallout-shelter-fill`!!
        }
        `_fallout-shelter-fill` = Builder(name = "Fallout-shelter-fill", defaultWidth = 256.0.dp,
...
private var `_fallout-shelter-fill`: ImageVector? = null
