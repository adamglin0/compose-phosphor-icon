...
public val RegularGroup.`Stack-simple`: ImageVector
    get() {
        if (`_stack-simple` != null) {
            return `_stack-simple`!!
        }
        `_stack-simple` = Builder(name = "Stack-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stack-simple`: ImageVector? = null
