...
public val FillGroup.`Sunglasses-fill`: ImageVector
    get() {
        if (`_sunglasses-fill` != null) {
            return `_sunglasses-fill`!!
        }
        `_sunglasses-fill` = Builder(name = "Sunglasses-fill", defaultWidth = 256.0.dp,
...
private var `_sunglasses-fill`: ImageVector? = null
