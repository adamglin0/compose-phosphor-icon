...
public val RegularGroup.`Paper-plane-tilt`: ImageVector
    get() {
        if (`_paper-plane-tilt` != null) {
            return `_paper-plane-tilt`!!
        }
        `_paper-plane-tilt` = Builder(name = "Paper-plane-tilt", defaultWidth = 256.0.dp,
...
private var `_paper-plane-tilt`: ImageVector? = null
