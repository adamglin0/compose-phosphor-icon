...
public val BoldGroup.`Intersect-square-bold`: ImageVector
    get() {
        if (`_intersect-square-bold` != null) {
            return `_intersect-square-bold`!!
        }
        `_intersect-square-bold` = Builder(name = "Intersect-square-bold", defaultWidth = 256.0.dp,
...
private var `_intersect-square-bold`: ImageVector? = null
