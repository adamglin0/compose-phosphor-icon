...
public val ThinGroup.`Arrows-out-line-horizontal-thin`: ImageVector
    get() {
        if (`_arrows-out-line-horizontal-thin` != null) {
            return `_arrows-out-line-horizontal-thin`!!
        }
        `_arrows-out-line-horizontal-thin` = Builder(name = "Arrows-out-line-horizontal-thin",
...
private var `_arrows-out-line-horizontal-thin`: ImageVector? = null
