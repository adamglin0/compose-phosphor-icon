...
public val DuotoneGroup.`Bezier-curve-duotone`: ImageVector
    get() {
        if (`_bezier-curve-duotone` != null) {
            return `_bezier-curve-duotone`!!
        }
        `_bezier-curve-duotone` = Builder(name = "Bezier-curve-duotone", defaultWidth = 256.0.dp,
...
private var `_bezier-curve-duotone`: ImageVector? = null
