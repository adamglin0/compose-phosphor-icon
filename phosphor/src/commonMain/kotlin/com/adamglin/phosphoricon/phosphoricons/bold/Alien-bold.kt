...
public val BoldGroup.`Alien-bold`: ImageVector
    get() {
        if (`_alien-bold` != null) {
            return `_alien-bold`!!
        }
        `_alien-bold` = Builder(name = "Alien-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_alien-bold`: ImageVector? = null
