...
public val DuotoneGroup.`Traffic-sign-duotone`: ImageVector
    get() {
        if (`_traffic-sign-duotone` != null) {
            return `_traffic-sign-duotone`!!
        }
        `_traffic-sign-duotone` = Builder(name = "Traffic-sign-duotone", defaultWidth = 256.0.dp,
...
private var `_traffic-sign-duotone`: ImageVector? = null
