...
public val ThinGroup.`List-magnifying-glass-thin`: ImageVector
    get() {
        if (`_list-magnifying-glass-thin` != null) {
            return `_list-magnifying-glass-thin`!!
        }
        `_list-magnifying-glass-thin` = Builder(name = "List-magnifying-glass-thin", defaultWidth =
...
private var `_list-magnifying-glass-thin`: ImageVector? = null
