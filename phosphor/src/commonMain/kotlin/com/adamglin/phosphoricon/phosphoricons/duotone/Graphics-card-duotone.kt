...
public val DuotoneGroup.`Graphics-card-duotone`: ImageVector
    get() {
        if (`_graphics-card-duotone` != null) {
            return `_graphics-card-duotone`!!
        }
        `_graphics-card-duotone` = Builder(name = "Graphics-card-duotone", defaultWidth = 256.0.dp,
...
private var `_graphics-card-duotone`: ImageVector? = null
