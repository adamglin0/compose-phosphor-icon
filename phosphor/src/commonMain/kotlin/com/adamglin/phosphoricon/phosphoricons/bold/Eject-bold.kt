...
public val BoldGroup.`Eject-bold`: ImageVector
    get() {
        if (`_eject-bold` != null) {
            return `_eject-bold`!!
        }
        `_eject-bold` = Builder(name = "Eject-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eject-bold`: ImageVector? = null
