...
public val BoldGroup.`Music-notes-minus-bold`: ImageVector
    get() {
        if (`_music-notes-minus-bold` != null) {
            return `_music-notes-minus-bold`!!
        }
        `_music-notes-minus-bold` = Builder(name = "Music-notes-minus-bold", defaultWidth =
...
private var `_music-notes-minus-bold`: ImageVector? = null
