...
public val DuotoneGroup.`Door-open-duotone`: ImageVector
    get() {
        if (`_door-open-duotone` != null) {
            return `_door-open-duotone`!!
        }
        `_door-open-duotone` = Builder(name = "Door-open-duotone", defaultWidth = 256.0.dp,
...
private var `_door-open-duotone`: ImageVector? = null
