...
public val ThinGroup.`Film-strip-thin`: ImageVector
    get() {
        if (`_film-strip-thin` != null) {
            return `_film-strip-thin`!!
        }
        `_film-strip-thin` = Builder(name = "Film-strip-thin", defaultWidth = 256.0.dp,
...
private var `_film-strip-thin`: ImageVector? = null
