...
public val DuotoneGroup.`Beer-stein-duotone`: ImageVector
    get() {
        if (`_beer-stein-duotone` != null) {
            return `_beer-stein-duotone`!!
        }
        `_beer-stein-duotone` = Builder(name = "Beer-stein-duotone", defaultWidth = 256.0.dp,
...
private var `_beer-stein-duotone`: ImageVector? = null
