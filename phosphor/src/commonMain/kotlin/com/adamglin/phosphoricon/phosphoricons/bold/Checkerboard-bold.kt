...
public val BoldGroup.`Checkerboard-bold`: ImageVector
    get() {
        if (`_checkerboard-bold` != null) {
            return `_checkerboard-bold`!!
        }
        `_checkerboard-bold` = Builder(name = "Checkerboard-bold", defaultWidth = 256.0.dp,
...
private var `_checkerboard-bold`: ImageVector? = null
