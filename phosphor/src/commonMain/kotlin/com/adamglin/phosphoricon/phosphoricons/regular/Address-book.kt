...
public val RegularGroup.`Address-book`: ImageVector
    get() {
        if (`_address-book` != null) {
            return `_address-book`!!
        }
        `_address-book` = Builder(name = "Address-book", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_address-book`: ImageVector? = null
