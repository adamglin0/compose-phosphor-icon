...
public val LightGroup.`Chat-centered-dots-light`: ImageVector
    get() {
        if (`_chat-centered-dots-light` != null) {
            return `_chat-centered-dots-light`!!
        }
        `_chat-centered-dots-light` = Builder(name = "Chat-centered-dots-light", defaultWidth =
...
private var `_chat-centered-dots-light`: ImageVector? = null
