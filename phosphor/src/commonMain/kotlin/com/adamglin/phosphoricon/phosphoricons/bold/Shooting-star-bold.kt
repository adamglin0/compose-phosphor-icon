...
public val BoldGroup.`Shooting-star-bold`: ImageVector
    get() {
        if (`_shooting-star-bold` != null) {
            return `_shooting-star-bold`!!
        }
        `_shooting-star-bold` = Builder(name = "Shooting-star-bold", defaultWidth = 256.0.dp,
...
private var `_shooting-star-bold`: ImageVector? = null
