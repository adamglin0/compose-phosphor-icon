...
public val LightGroup.`Popcorn-light`: ImageVector
    get() {
        if (`_popcorn-light` != null) {
            return `_popcorn-light`!!
        }
        `_popcorn-light` = Builder(name = "Popcorn-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_popcorn-light`: ImageVector? = null
