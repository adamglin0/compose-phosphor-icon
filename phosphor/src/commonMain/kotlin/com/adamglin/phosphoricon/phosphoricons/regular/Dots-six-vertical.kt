...
public val RegularGroup.`Dots-six-vertical`: ImageVector
    get() {
        if (`_dots-six-vertical` != null) {
            return `_dots-six-vertical`!!
        }
        `_dots-six-vertical` = Builder(name = "Dots-six-vertical", defaultWidth = 256.0.dp,
...
private var `_dots-six-vertical`: ImageVector? = null
