...
public val ThinGroup.`Map-pin-line-thin`: ImageVector
    get() {
        if (`_map-pin-line-thin` != null) {
            return `_map-pin-line-thin`!!
        }
        `_map-pin-line-thin` = Builder(name = "Map-pin-line-thin", defaultWidth = 256.0.dp,
...
private var `_map-pin-line-thin`: ImageVector? = null
