...
public val ThinGroup.`Bluetooth-thin`: ImageVector
    get() {
        if (`_bluetooth-thin` != null) {
            return `_bluetooth-thin`!!
        }
        `_bluetooth-thin` = Builder(name = "Bluetooth-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bluetooth-thin`: ImageVector? = null
