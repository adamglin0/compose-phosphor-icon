...
public val BoldGroup.`Court-basketball-bold`: ImageVector
    get() {
        if (`_court-basketball-bold` != null) {
            return `_court-basketball-bold`!!
        }
        `_court-basketball-bold` = Builder(name = "Court-basketball-bold", defaultWidth = 256.0.dp,
...
private var `_court-basketball-bold`: ImageVector? = null
