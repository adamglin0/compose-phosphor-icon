...
public val DuotoneGroup.`Chart-pie-slice-duotone`: ImageVector
    get() {
        if (`_chart-pie-slice-duotone` != null) {
            return `_chart-pie-slice-duotone`!!
        }
        `_chart-pie-slice-duotone` = Builder(name = "Chart-pie-slice-duotone", defaultWidth =
...
private var `_chart-pie-slice-duotone`: ImageVector? = null
