...
public val LightGroup.`Monitor-light`: ImageVector
    get() {
        if (`_monitor-light` != null) {
            return `_monitor-light`!!
        }
        `_monitor-light` = Builder(name = "Monitor-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_monitor-light`: ImageVector? = null
