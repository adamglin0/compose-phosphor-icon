...
public val LightGroup.`Signature-light`: ImageVector
    get() {
        if (`_signature-light` != null) {
            return `_signature-light`!!
        }
        `_signature-light` = Builder(name = "Signature-light", defaultWidth = 256.0.dp,
...
private var `_signature-light`: ImageVector? = null
