...
public val ThinGroup.`Selection-all-thin`: ImageVector
    get() {
        if (`_selection-all-thin` != null) {
            return `_selection-all-thin`!!
        }
        `_selection-all-thin` = Builder(name = "Selection-all-thin", defaultWidth = 256.0.dp,
...
private var `_selection-all-thin`: ImageVector? = null
