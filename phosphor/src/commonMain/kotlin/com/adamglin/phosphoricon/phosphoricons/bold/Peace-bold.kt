...
public val BoldGroup.`Peace-bold`: ImageVector
    get() {
        if (`_peace-bold` != null) {
            return `_peace-bold`!!
        }
        `_peace-bold` = Builder(name = "Peace-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_peace-bold`: ImageVector? = null
