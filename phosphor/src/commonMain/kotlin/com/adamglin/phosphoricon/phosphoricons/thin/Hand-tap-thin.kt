...
public val ThinGroup.`Hand-tap-thin`: ImageVector
    get() {
        if (`_hand-tap-thin` != null) {
            return `_hand-tap-thin`!!
        }
        `_hand-tap-thin` = Builder(name = "Hand-tap-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-tap-thin`: ImageVector? = null
