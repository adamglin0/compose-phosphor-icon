...
public val DuotoneGroup.`Push-pin-slash-duotone`: ImageVector
    get() {
        if (`_push-pin-slash-duotone` != null) {
            return `_push-pin-slash-duotone`!!
        }
        `_push-pin-slash-duotone` = Builder(name = "Push-pin-slash-duotone", defaultWidth =
...
private var `_push-pin-slash-duotone`: ImageVector? = null
