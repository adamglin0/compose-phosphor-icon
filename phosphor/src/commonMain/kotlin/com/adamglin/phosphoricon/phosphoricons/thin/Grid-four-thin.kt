...
public val ThinGroup.`Grid-four-thin`: ImageVector
    get() {
        if (`_grid-four-thin` != null) {
            return `_grid-four-thin`!!
        }
        `_grid-four-thin` = Builder(name = "Grid-four-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_grid-four-thin`: ImageVector? = null
