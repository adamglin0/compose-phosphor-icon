...
public val LightGroup.`Link-break-light`: ImageVector
    get() {
        if (`_link-break-light` != null) {
            return `_link-break-light`!!
        }
        `_link-break-light` = Builder(name = "Link-break-light", defaultWidth = 256.0.dp,
...
private var `_link-break-light`: ImageVector? = null
