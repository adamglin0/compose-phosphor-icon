...
public val ThinGroup.`Gear-thin`: ImageVector
    get() {
        if (`_gear-thin` != null) {
            return `_gear-thin`!!
        }
        `_gear-thin` = Builder(name = "Gear-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gear-thin`: ImageVector? = null
