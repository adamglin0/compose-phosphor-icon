...
public val BoldGroup.`Pulse-bold`: ImageVector
    get() {
        if (`_pulse-bold` != null) {
            return `_pulse-bold`!!
        }
        `_pulse-bold` = Builder(name = "Pulse-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pulse-bold`: ImageVector? = null
