...
public val ThinGroup.`Metronome-thin`: ImageVector
    get() {
        if (`_metronome-thin` != null) {
            return `_metronome-thin`!!
        }
        `_metronome-thin` = Builder(name = "Metronome-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_metronome-thin`: ImageVector? = null
