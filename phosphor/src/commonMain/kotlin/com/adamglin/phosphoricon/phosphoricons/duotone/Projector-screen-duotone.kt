...
public val DuotoneGroup.`Projector-screen-duotone`: ImageVector
    get() {
        if (`_projector-screen-duotone` != null) {
            return `_projector-screen-duotone`!!
        }
        `_projector-screen-duotone` = Builder(name = "Projector-screen-duotone", defaultWidth =
...
private var `_projector-screen-duotone`: ImageVector? = null
