...
public val ThinGroup.`Arrow-fat-down-thin`: ImageVector
    get() {
        if (`_arrow-fat-down-thin` != null) {
            return `_arrow-fat-down-thin`!!
        }
        `_arrow-fat-down-thin` = Builder(name = "Arrow-fat-down-thin", defaultWidth = 256.0.dp,
...
private var `_arrow-fat-down-thin`: ImageVector? = null
