...
public val BoldGroup.`Magnifying-glass-plus-bold`: ImageVector
    get() {
        if (`_magnifying-glass-plus-bold` != null) {
            return `_magnifying-glass-plus-bold`!!
        }
        `_magnifying-glass-plus-bold` = Builder(name = "Magnifying-glass-plus-bold", defaultWidth =
...
private var `_magnifying-glass-plus-bold`: ImageVector? = null
