...
public val LightGroup.`Lightning-a-light`: ImageVector
    get() {
        if (`_lightning-a-light` != null) {
            return `_lightning-a-light`!!
        }
        `_lightning-a-light` = Builder(name = "Lightning-a-light", defaultWidth = 256.0.dp,
...
private var `_lightning-a-light`: ImageVector? = null
