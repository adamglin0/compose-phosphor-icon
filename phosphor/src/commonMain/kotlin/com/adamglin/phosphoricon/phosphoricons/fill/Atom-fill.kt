...
public val FillGroup.`Atom-fill`: ImageVector
    get() {
        if (`_atom-fill` != null) {
            return `_atom-fill`!!
        }
        `_atom-fill` = Builder(name = "Atom-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_atom-fill`: ImageVector? = null
