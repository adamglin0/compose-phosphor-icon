...
public val LightGroup.`Solar-panel-light`: ImageVector
    get() {
        if (`_solar-panel-light` != null) {
            return `_solar-panel-light`!!
        }
        `_solar-panel-light` = Builder(name = "Solar-panel-light", defaultWidth = 256.0.dp,
...
private var `_solar-panel-light`: ImageVector? = null
