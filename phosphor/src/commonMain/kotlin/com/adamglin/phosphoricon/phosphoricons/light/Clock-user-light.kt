...
public val LightGroup.`Clock-user-light`: ImageVector
    get() {
        if (`_clock-user-light` != null) {
            return `_clock-user-light`!!
        }
        `_clock-user-light` = Builder(name = "Clock-user-light", defaultWidth = 256.0.dp,
...
private var `_clock-user-light`: ImageVector? = null
