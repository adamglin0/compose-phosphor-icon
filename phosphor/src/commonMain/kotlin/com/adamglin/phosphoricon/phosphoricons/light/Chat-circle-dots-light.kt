...
public val LightGroup.`Chat-circle-dots-light`: ImageVector
    get() {
        if (`_chat-circle-dots-light` != null) {
            return `_chat-circle-dots-light`!!
        }
        `_chat-circle-dots-light` = Builder(name = "Chat-circle-dots-light", defaultWidth =
...
private var `_chat-circle-dots-light`: ImageVector? = null
