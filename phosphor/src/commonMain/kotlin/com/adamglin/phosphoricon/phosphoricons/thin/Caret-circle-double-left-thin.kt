...
public val ThinGroup.`Caret-circle-double-left-thin`: ImageVector
    get() {
        if (`_caret-circle-double-left-thin` != null) {
            return `_caret-circle-double-left-thin`!!
        }
        `_caret-circle-double-left-thin` = Builder(name = "Caret-circle-double-left-thin",
...
private var `_caret-circle-double-left-thin`: ImageVector? = null
