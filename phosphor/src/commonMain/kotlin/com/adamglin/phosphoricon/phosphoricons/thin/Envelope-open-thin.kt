...
public val ThinGroup.`Envelope-open-thin`: ImageVector
    get() {
        if (`_envelope-open-thin` != null) {
            return `_envelope-open-thin`!!
        }
        `_envelope-open-thin` = Builder(name = "Envelope-open-thin", defaultWidth = 256.0.dp,
...
private var `_envelope-open-thin`: ImageVector? = null
