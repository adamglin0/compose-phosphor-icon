...
public val DuotoneGroup.`Hand-swipe-left-duotone`: ImageVector
    get() {
        if (`_hand-swipe-left-duotone` != null) {
            return `_hand-swipe-left-duotone`!!
        }
        `_hand-swipe-left-duotone` = Builder(name = "Hand-swipe-left-duotone", defaultWidth =
...
private var `_hand-swipe-left-duotone`: ImageVector? = null
