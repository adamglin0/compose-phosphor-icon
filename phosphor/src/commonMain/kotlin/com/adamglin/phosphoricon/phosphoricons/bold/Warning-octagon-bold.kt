...
public val BoldGroup.`Warning-octagon-bold`: ImageVector
    get() {
        if (`_warning-octagon-bold` != null) {
            return `_warning-octagon-bold`!!
        }
        `_warning-octagon-bold` = Builder(name = "Warning-octagon-bold", defaultWidth = 256.0.dp,
...
private var `_warning-octagon-bold`: ImageVector? = null
