...
public val BoldGroup.`Caret-double-right-bold`: ImageVector
    get() {
        if (`_caret-double-right-bold` != null) {
            return `_caret-double-right-bold`!!
        }
        `_caret-double-right-bold` = Builder(name = "Caret-double-right-bold", defaultWidth =
...
private var `_caret-double-right-bold`: ImageVector? = null
