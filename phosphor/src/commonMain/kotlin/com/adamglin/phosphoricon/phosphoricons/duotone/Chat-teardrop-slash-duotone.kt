...
public val DuotoneGroup.`Chat-teardrop-slash-duotone`: ImageVector
    get() {
        if (`_chat-teardrop-slash-duotone` != null) {
            return `_chat-teardrop-slash-duotone`!!
        }
        `_chat-teardrop-slash-duotone` = Builder(name = "Chat-teardrop-slash-duotone", defaultWidth
...
private var `_chat-teardrop-slash-duotone`: ImageVector? = null
