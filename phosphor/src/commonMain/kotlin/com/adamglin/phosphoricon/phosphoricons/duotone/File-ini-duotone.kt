...
public val DuotoneGroup.`File-ini-duotone`: ImageVector
    get() {
        if (`_file-ini-duotone` != null) {
            return `_file-ini-duotone`!!
        }
        `_file-ini-duotone` = Builder(name = "File-ini-duotone", defaultWidth = 256.0.dp,
...
private var `_file-ini-duotone`: ImageVector? = null
