...
public val RegularGroup.`Bookmark-simple`: ImageVector
    get() {
        if (`_bookmark-simple` != null) {
            return `_bookmark-simple`!!
        }
        `_bookmark-simple` = Builder(name = "Bookmark-simple", defaultWidth = 256.0.dp,
...
private var `_bookmark-simple`: ImageVector? = null
