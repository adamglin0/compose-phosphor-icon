...
public val BoldGroup.`Currency-krw-bold`: ImageVector
    get() {
        if (`_currency-krw-bold` != null) {
            return `_currency-krw-bold`!!
        }
        `_currency-krw-bold` = Builder(name = "Currency-krw-bold", defaultWidth = 256.0.dp,
...
private var `_currency-krw-bold`: ImageVector? = null
