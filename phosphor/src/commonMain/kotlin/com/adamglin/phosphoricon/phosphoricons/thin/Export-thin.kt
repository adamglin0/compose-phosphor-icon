...
public val ThinGroup.`Export-thin`: ImageVector
    get() {
        if (`_export-thin` != null) {
            return `_export-thin`!!
        }
        `_export-thin` = Builder(name = "Export-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_export-thin`: ImageVector? = null
