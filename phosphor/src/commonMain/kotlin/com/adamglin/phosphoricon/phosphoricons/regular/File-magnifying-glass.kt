...
public val RegularGroup.`File-magnifying-glass`: ImageVector
    get() {
        if (`_file-magnifying-glass` != null) {
            return `_file-magnifying-glass`!!
        }
        `_file-magnifying-glass` = Builder(name = "File-magnifying-glass", defaultWidth = 256.0.dp,
...
private var `_file-magnifying-glass`: ImageVector? = null
