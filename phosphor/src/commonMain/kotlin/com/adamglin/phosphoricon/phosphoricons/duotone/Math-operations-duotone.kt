...
public val DuotoneGroup.`Math-operations-duotone`: ImageVector
    get() {
        if (`_math-operations-duotone` != null) {
            return `_math-operations-duotone`!!
        }
        `_math-operations-duotone` = Builder(name = "Math-operations-duotone", defaultWidth =
...
private var `_math-operations-duotone`: ImageVector? = null
