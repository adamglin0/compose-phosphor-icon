...
public val RegularGroup.`Cooking-pot`: ImageVector
    get() {
        if (`_cooking-pot` != null) {
            return `_cooking-pot`!!
        }
        `_cooking-pot` = Builder(name = "Cooking-pot", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cooking-pot`: ImageVector? = null
