...
public val BoldGroup.`Panorama-bold`: ImageVector
    get() {
        if (`_panorama-bold` != null) {
            return `_panorama-bold`!!
        }
        `_panorama-bold` = Builder(name = "Panorama-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_panorama-bold`: ImageVector? = null
