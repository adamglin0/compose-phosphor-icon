...
public val DuotoneGroup.`Bell-duotone`: ImageVector
    get() {
        if (`_bell-duotone` != null) {
            return `_bell-duotone`!!
        }
        `_bell-duotone` = Builder(name = "Bell-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bell-duotone`: ImageVector? = null
