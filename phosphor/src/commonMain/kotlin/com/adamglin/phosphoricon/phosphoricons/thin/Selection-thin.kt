...
public val ThinGroup.`Selection-thin`: ImageVector
    get() {
        if (`_selection-thin` != null) {
            return `_selection-thin`!!
        }
        `_selection-thin` = Builder(name = "Selection-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_selection-thin`: ImageVector? = null
