...
public val BoldGroup.`Share-fat-bold`: ImageVector
    get() {
        if (`_share-fat-bold` != null) {
            return `_share-fat-bold`!!
        }
        `_share-fat-bold` = Builder(name = "Share-fat-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_share-fat-bold`: ImageVector? = null
