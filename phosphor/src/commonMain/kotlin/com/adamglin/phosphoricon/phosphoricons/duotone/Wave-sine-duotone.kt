...
public val DuotoneGroup.`Wave-sine-duotone`: ImageVector
    get() {
        if (`_wave-sine-duotone` != null) {
            return `_wave-sine-duotone`!!
        }
        `_wave-sine-duotone` = Builder(name = "Wave-sine-duotone", defaultWidth = 256.0.dp,
...
private var `_wave-sine-duotone`: ImageVector? = null
