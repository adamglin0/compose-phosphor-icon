...
public val RegularGroup.`Hourglass-high`: ImageVector
    get() {
        if (`_hourglass-high` != null) {
            return `_hourglass-high`!!
        }
        `_hourglass-high` = Builder(name = "Hourglass-high", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hourglass-high`: ImageVector? = null
