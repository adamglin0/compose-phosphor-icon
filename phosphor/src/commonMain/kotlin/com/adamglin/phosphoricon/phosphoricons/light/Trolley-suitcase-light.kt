...
public val LightGroup.`Trolley-suitcase-light`: ImageVector
    get() {
        if (`_trolley-suitcase-light` != null) {
            return `_trolley-suitcase-light`!!
        }
        `_trolley-suitcase-light` = Builder(name = "Trolley-suitcase-light", defaultWidth =
...
private var `_trolley-suitcase-light`: ImageVector? = null
