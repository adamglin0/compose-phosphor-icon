...
public val DuotoneGroup.`Git-merge-duotone`: ImageVector
    get() {
        if (`_git-merge-duotone` != null) {
            return `_git-merge-duotone`!!
        }
        `_git-merge-duotone` = Builder(name = "Git-merge-duotone", defaultWidth = 256.0.dp,
...
private var `_git-merge-duotone`: ImageVector? = null
