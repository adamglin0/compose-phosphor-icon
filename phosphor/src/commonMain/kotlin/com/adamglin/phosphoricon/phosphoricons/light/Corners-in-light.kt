...
public val LightGroup.`Corners-in-light`: ImageVector
    get() {
        if (`_corners-in-light` != null) {
            return `_corners-in-light`!!
        }
        `_corners-in-light` = Builder(name = "Corners-in-light", defaultWidth = 256.0.dp,
...
private var `_corners-in-light`: ImageVector? = null
