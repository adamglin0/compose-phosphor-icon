...
public val DuotoneGroup.`Tumblr-logo-duotone`: ImageVector
    get() {
        if (`_tumblr-logo-duotone` != null) {
            return `_tumblr-logo-duotone`!!
        }
        `_tumblr-logo-duotone` = Builder(name = "Tumblr-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_tumblr-logo-duotone`: ImageVector? = null
