...
public val BoldGroup.`High-definition-bold`: ImageVector
    get() {
        if (`_high-definition-bold` != null) {
            return `_high-definition-bold`!!
        }
        `_high-definition-bold` = Builder(name = "High-definition-bold", defaultWidth = 256.0.dp,
...
private var `_high-definition-bold`: ImageVector? = null
