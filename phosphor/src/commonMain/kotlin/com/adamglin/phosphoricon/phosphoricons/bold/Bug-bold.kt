...
public val BoldGroup.`Bug-bold`: ImageVector
    get() {
        if (`_bug-bold` != null) {
            return `_bug-bold`!!
        }
        `_bug-bold` = Builder(name = "Bug-bold", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_bug-bold`: ImageVector? = null
