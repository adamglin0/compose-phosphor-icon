...
public val LightGroup.`Crosshair-light`: ImageVector
    get() {
        if (`_crosshair-light` != null) {
            return `_crosshair-light`!!
        }
        `_crosshair-light` = Builder(name = "Crosshair-light", defaultWidth = 256.0.dp,
...
private var `_crosshair-light`: ImageVector? = null
