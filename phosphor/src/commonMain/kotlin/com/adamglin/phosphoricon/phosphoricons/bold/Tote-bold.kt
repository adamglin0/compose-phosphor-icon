...
public val BoldGroup.`Tote-bold`: ImageVector
    get() {
        if (`_tote-bold` != null) {
            return `_tote-bold`!!
        }
        `_tote-bold` = Builder(name = "Tote-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tote-bold`: ImageVector? = null
