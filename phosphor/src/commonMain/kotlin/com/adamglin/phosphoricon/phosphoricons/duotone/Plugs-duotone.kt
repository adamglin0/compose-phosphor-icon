...
public val DuotoneGroup.`Plugs-duotone`: ImageVector
    get() {
        if (`_plugs-duotone` != null) {
            return `_plugs-duotone`!!
        }
        `_plugs-duotone` = Builder(name = "Plugs-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plugs-duotone`: ImageVector? = null
