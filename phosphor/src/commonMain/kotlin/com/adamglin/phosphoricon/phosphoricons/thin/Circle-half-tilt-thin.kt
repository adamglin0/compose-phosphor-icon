...
public val ThinGroup.`Circle-half-tilt-thin`: ImageVector
    get() {
        if (`_circle-half-tilt-thin` != null) {
            return `_circle-half-tilt-thin`!!
        }
        `_circle-half-tilt-thin` = Builder(name = "Circle-half-tilt-thin", defaultWidth = 256.0.dp,
...
private var `_circle-half-tilt-thin`: ImageVector? = null
