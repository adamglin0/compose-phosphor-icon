...
public val BoldGroup.`Power-bold`: ImageVector
    get() {
        if (`_power-bold` != null) {
            return `_power-bold`!!
        }
        `_power-bold` = Builder(name = "Power-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_power-bold`: ImageVector? = null
