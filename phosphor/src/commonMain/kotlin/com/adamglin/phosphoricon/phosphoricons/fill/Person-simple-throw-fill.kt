...
public val FillGroup.`Person-simple-throw-fill`: ImageVector
    get() {
        if (`_person-simple-throw-fill` != null) {
            return `_person-simple-throw-fill`!!
        }
        `_person-simple-throw-fill` = Builder(name = "Person-simple-throw-fill", defaultWidth =
...
private var `_person-simple-throw-fill`: ImageVector? = null
