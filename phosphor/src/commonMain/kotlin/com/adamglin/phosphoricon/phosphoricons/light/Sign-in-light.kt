...
public val LightGroup.`Sign-in-light`: ImageVector
    get() {
        if (`_sign-in-light` != null) {
            return `_sign-in-light`!!
        }
        `_sign-in-light` = Builder(name = "Sign-in-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sign-in-light`: ImageVector? = null
