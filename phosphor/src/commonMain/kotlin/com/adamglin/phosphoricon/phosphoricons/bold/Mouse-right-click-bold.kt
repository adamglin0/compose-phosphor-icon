...
public val BoldGroup.`Mouse-right-click-bold`: ImageVector
    get() {
        if (`_mouse-right-click-bold` != null) {
            return `_mouse-right-click-bold`!!
        }
        `_mouse-right-click-bold` = Builder(name = "Mouse-right-click-bold", defaultWidth =
...
private var `_mouse-right-click-bold`: ImageVector? = null
