...
public val FillGroup.`Folder-simple-minus-fill`: ImageVector
    get() {
        if (`_folder-simple-minus-fill` != null) {
            return `_folder-simple-minus-fill`!!
        }
        `_folder-simple-minus-fill` = Builder(name = "Folder-simple-minus-fill", defaultWidth =
...
private var `_folder-simple-minus-fill`: ImageVector? = null
