...
public val ThinGroup.`Baseball-helmet-thin`: ImageVector
    get() {
        if (`_baseball-helmet-thin` != null) {
            return `_baseball-helmet-thin`!!
        }
        `_baseball-helmet-thin` = Builder(name = "Baseball-helmet-thin", defaultWidth = 256.0.dp,
...
private var `_baseball-helmet-thin`: ImageVector? = null
