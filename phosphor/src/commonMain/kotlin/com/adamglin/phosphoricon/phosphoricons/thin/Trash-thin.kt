...
public val ThinGroup.`Trash-thin`: ImageVector
    get() {
        if (`_trash-thin` != null) {
            return `_trash-thin`!!
        }
        `_trash-thin` = Builder(name = "Trash-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_trash-thin`: ImageVector? = null
