...
public val DuotoneGroup.`Mastodon-logo-duotone`: ImageVector
    get() {
        if (`_mastodon-logo-duotone` != null) {
            return `_mastodon-logo-duotone`!!
        }
        `_mastodon-logo-duotone` = Builder(name = "Mastodon-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_mastodon-logo-duotone`: ImageVector? = null
