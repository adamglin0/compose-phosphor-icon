...
public val ThinGroup.`Infinity-thin`: ImageVector
    get() {
        if (`_infinity-thin` != null) {
            return `_infinity-thin`!!
        }
        `_infinity-thin` = Builder(name = "Infinity-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_infinity-thin`: ImageVector? = null
