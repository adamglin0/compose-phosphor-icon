...
public val ThinGroup.`Axe-thin`: ImageVector
    get() {
        if (`_axe-thin` != null) {
            return `_axe-thin`!!
        }
        `_axe-thin` = Builder(name = "Axe-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_axe-thin`: ImageVector? = null
