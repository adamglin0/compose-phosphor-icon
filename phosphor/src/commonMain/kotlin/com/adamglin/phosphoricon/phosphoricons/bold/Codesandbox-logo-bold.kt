...
public val BoldGroup.`Codesandbox-logo-bold`: ImageVector
    get() {
        if (`_codesandbox-logo-bold` != null) {
            return `_codesandbox-logo-bold`!!
        }
        `_codesandbox-logo-bold` = Builder(name = "Codesandbox-logo-bold", defaultWidth = 256.0.dp,
...
private var `_codesandbox-logo-bold`: ImageVector? = null
