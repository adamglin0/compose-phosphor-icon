...
public val BoldGroup.`Terminal-window-bold`: ImageVector
    get() {
        if (`_terminal-window-bold` != null) {
            return `_terminal-window-bold`!!
        }
        `_terminal-window-bold` = Builder(name = "Terminal-window-bold", defaultWidth = 256.0.dp,
...
private var `_terminal-window-bold`: ImageVector? = null
