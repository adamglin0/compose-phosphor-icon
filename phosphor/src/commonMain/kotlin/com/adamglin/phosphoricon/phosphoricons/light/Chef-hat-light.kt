...
public val LightGroup.`Chef-hat-light`: ImageVector
    get() {
        if (`_chef-hat-light` != null) {
            return `_chef-hat-light`!!
        }
        `_chef-hat-light` = Builder(name = "Chef-hat-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_chef-hat-light`: ImageVector? = null
