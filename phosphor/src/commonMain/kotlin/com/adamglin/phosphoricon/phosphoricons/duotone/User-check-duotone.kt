...
public val DuotoneGroup.`User-check-duotone`: ImageVector
    get() {
        if (`_user-check-duotone` != null) {
            return `_user-check-duotone`!!
        }
        `_user-check-duotone` = Builder(name = "User-check-duotone", defaultWidth = 256.0.dp,
...
private var `_user-check-duotone`: ImageVector? = null
