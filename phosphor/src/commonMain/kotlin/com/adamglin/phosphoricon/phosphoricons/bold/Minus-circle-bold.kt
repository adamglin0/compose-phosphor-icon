...
public val BoldGroup.`Minus-circle-bold`: ImageVector
    get() {
        if (`_minus-circle-bold` != null) {
            return `_minus-circle-bold`!!
        }
        `_minus-circle-bold` = Builder(name = "Minus-circle-bold", defaultWidth = 256.0.dp,
...
private var `_minus-circle-bold`: ImageVector? = null
