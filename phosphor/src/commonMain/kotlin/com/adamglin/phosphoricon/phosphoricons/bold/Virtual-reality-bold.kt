...
public val BoldGroup.`Virtual-reality-bold`: ImageVector
    get() {
        if (`_virtual-reality-bold` != null) {
            return `_virtual-reality-bold`!!
        }
        `_virtual-reality-bold` = Builder(name = "Virtual-reality-bold", defaultWidth = 256.0.dp,
...
private var `_virtual-reality-bold`: ImageVector? = null
