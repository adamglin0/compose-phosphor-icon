...
public val DuotoneGroup.`Smiley-blank-duotone`: ImageVector
    get() {
        if (`_smiley-blank-duotone` != null) {
            return `_smiley-blank-duotone`!!
        }
        `_smiley-blank-duotone` = Builder(name = "Smiley-blank-duotone", defaultWidth = 256.0.dp,
...
private var `_smiley-blank-duotone`: ImageVector? = null
