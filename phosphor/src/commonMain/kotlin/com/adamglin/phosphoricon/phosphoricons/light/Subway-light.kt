...
public val LightGroup.`Subway-light`: ImageVector
    get() {
        if (`_subway-light` != null) {
            return `_subway-light`!!
        }
        `_subway-light` = Builder(name = "Subway-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_subway-light`: ImageVector? = null
