...
public val ThinGroup.`Book-bookmark-thin`: ImageVector
    get() {
        if (`_book-bookmark-thin` != null) {
            return `_book-bookmark-thin`!!
        }
        `_book-bookmark-thin` = Builder(name = "Book-bookmark-thin", defaultWidth = 256.0.dp,
...
private var `_book-bookmark-thin`: ImageVector? = null
