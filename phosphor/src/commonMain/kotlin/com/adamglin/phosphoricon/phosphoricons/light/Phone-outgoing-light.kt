...
public val LightGroup.`Phone-outgoing-light`: ImageVector
    get() {
        if (`_phone-outgoing-light` != null) {
            return `_phone-outgoing-light`!!
        }
        `_phone-outgoing-light` = Builder(name = "Phone-outgoing-light", defaultWidth = 256.0.dp,
...
private var `_phone-outgoing-light`: ImageVector? = null
