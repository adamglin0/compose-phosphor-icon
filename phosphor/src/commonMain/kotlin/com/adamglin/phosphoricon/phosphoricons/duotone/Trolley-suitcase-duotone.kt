...
public val DuotoneGroup.`Trolley-suitcase-duotone`: ImageVector
    get() {
        if (`_trolley-suitcase-duotone` != null) {
            return `_trolley-suitcase-duotone`!!
        }
        `_trolley-suitcase-duotone` = Builder(name = "Trolley-suitcase-duotone", defaultWidth =
...
private var `_trolley-suitcase-duotone`: ImageVector? = null
