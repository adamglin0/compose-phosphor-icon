...
public val LightGroup.`Camera-rotate-light`: ImageVector
    get() {
        if (`_camera-rotate-light` != null) {
            return `_camera-rotate-light`!!
        }
        `_camera-rotate-light` = Builder(name = "Camera-rotate-light", defaultWidth = 256.0.dp,
...
private var `_camera-rotate-light`: ImageVector? = null
