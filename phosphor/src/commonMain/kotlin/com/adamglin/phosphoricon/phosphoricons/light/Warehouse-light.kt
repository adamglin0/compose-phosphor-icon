...
public val LightGroup.`Warehouse-light`: ImageVector
    get() {
        if (`_warehouse-light` != null) {
            return `_warehouse-light`!!
        }
        `_warehouse-light` = Builder(name = "Warehouse-light", defaultWidth = 256.0.dp,
...
private var `_warehouse-light`: ImageVector? = null
