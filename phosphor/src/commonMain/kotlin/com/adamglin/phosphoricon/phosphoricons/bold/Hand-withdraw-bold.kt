...
public val BoldGroup.`Hand-withdraw-bold`: ImageVector
    get() {
        if (`_hand-withdraw-bold` != null) {
            return `_hand-withdraw-bold`!!
        }
        `_hand-withdraw-bold` = Builder(name = "Hand-withdraw-bold", defaultWidth = 256.0.dp,
...
private var `_hand-withdraw-bold`: ImageVector? = null
