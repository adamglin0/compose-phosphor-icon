...
public val LightGroup.`Arrows-out-line-vertical-light`: ImageVector
    get() {
        if (`_arrows-out-line-vertical-light` != null) {
            return `_arrows-out-line-vertical-light`!!
        }
        `_arrows-out-line-vertical-light` = Builder(name = "Arrows-out-line-vertical-light",
...
private var `_arrows-out-line-vertical-light`: ImageVector? = null
