...
public val ThinGroup.`Person-simple-tai-chi-thin`: ImageVector
    get() {
        if (`_person-simple-tai-chi-thin` != null) {
            return `_person-simple-tai-chi-thin`!!
        }
        `_person-simple-tai-chi-thin` = Builder(name = "Person-simple-tai-chi-thin", defaultWidth =
...
private var `_person-simple-tai-chi-thin`: ImageVector? = null
