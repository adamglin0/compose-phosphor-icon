...
public val BoldGroup.`Google-chrome-logo-bold`: ImageVector
    get() {
        if (`_google-chrome-logo-bold` != null) {
            return `_google-chrome-logo-bold`!!
        }
        `_google-chrome-logo-bold` = Builder(name = "Google-chrome-logo-bold", defaultWidth =
...
private var `_google-chrome-logo-bold`: ImageVector? = null
