...
public val FillGroup.`Confetti-fill`: ImageVector
    get() {
        if (`_confetti-fill` != null) {
            return `_confetti-fill`!!
        }
        `_confetti-fill` = Builder(name = "Confetti-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_confetti-fill`: ImageVector? = null
