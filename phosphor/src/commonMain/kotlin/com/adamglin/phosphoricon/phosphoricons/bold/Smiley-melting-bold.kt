...
public val BoldGroup.`Smiley-melting-bold`: ImageVector
    get() {
        if (`_smiley-melting-bold` != null) {
            return `_smiley-melting-bold`!!
        }
        `_smiley-melting-bold` = Builder(name = "Smiley-melting-bold", defaultWidth = 256.0.dp,
...
private var `_smiley-melting-bold`: ImageVector? = null
