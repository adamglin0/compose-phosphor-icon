...
public val RegularGroup.`Warning-octagon`: ImageVector
    get() {
        if (`_warning-octagon` != null) {
            return `_warning-octagon`!!
        }
        `_warning-octagon` = Builder(name = "Warning-octagon", defaultWidth = 256.0.dp,
...
private var `_warning-octagon`: ImageVector? = null
