...
public val BoldGroup.`Dots-nine-bold`: ImageVector
    get() {
        if (`_dots-nine-bold` != null) {
            return `_dots-nine-bold`!!
        }
        `_dots-nine-bold` = Builder(name = "Dots-nine-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dots-nine-bold`: ImageVector? = null
