...
public val DuotoneGroup.`Paperclip-horizontal-duotone`: ImageVector
    get() {
        if (`_paperclip-horizontal-duotone` != null) {
            return `_paperclip-horizontal-duotone`!!
        }
        `_paperclip-horizontal-duotone` = Builder(name = "Paperclip-horizontal-duotone",
...
private var `_paperclip-horizontal-duotone`: ImageVector? = null
