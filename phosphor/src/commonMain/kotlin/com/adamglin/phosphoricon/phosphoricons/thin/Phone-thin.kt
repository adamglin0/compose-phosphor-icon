...
public val ThinGroup.`Phone-thin`: ImageVector
    get() {
        if (`_phone-thin` != null) {
            return `_phone-thin`!!
        }
        `_phone-thin` = Builder(name = "Phone-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-thin`: ImageVector? = null
