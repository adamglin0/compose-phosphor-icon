...
public val ThinGroup.`Video-thin`: ImageVector
    get() {
        if (`_video-thin` != null) {
            return `_video-thin`!!
        }
        `_video-thin` = Builder(name = "Video-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_video-thin`: ImageVector? = null
