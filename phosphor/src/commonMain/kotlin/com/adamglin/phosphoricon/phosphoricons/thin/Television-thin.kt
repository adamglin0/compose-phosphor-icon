...
public val ThinGroup.`Television-thin`: ImageVector
    get() {
        if (`_television-thin` != null) {
            return `_television-thin`!!
        }
        `_television-thin` = Builder(name = "Television-thin", defaultWidth = 256.0.dp,
...
private var `_television-thin`: ImageVector? = null
