...
public val LightGroup.`Fork-knife-light`: ImageVector
    get() {
        if (`_fork-knife-light` != null) {
            return `_fork-knife-light`!!
        }
        `_fork-knife-light` = Builder(name = "Fork-knife-light", defaultWidth = 256.0.dp,
...
private var `_fork-knife-light`: ImageVector? = null
