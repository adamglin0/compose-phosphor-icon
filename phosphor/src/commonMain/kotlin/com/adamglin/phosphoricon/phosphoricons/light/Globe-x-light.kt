...
public val LightGroup.`Globe-x-light`: ImageVector
    get() {
        if (`_globe-x-light` != null) {
            return `_globe-x-light`!!
        }
        `_globe-x-light` = Builder(name = "Globe-x-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_globe-x-light`: ImageVector? = null
