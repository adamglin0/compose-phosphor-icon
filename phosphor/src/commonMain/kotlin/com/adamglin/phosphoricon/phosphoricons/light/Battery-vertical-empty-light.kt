...
public val LightGroup.`Battery-vertical-empty-light`: ImageVector
    get() {
        if (`_battery-vertical-empty-light` != null) {
            return `_battery-vertical-empty-light`!!
        }
        `_battery-vertical-empty-light` = Builder(name = "Battery-vertical-empty-light",
...
private var `_battery-vertical-empty-light`: ImageVector? = null
