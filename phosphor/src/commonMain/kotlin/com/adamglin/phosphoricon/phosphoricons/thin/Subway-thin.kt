...
public val ThinGroup.`Subway-thin`: ImageVector
    get() {
        if (`_subway-thin` != null) {
            return `_subway-thin`!!
        }
        `_subway-thin` = Builder(name = "Subway-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_subway-thin`: ImageVector? = null
