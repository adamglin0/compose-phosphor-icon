...
public val ThinGroup.`Hockey-thin`: ImageVector
    get() {
        if (`_hockey-thin` != null) {
            return `_hockey-thin`!!
        }
        `_hockey-thin` = Builder(name = "Hockey-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hockey-thin`: ImageVector? = null
