...
public val LightGroup.`Chart-pie-slice-light`: ImageVector
    get() {
        if (`_chart-pie-slice-light` != null) {
            return `_chart-pie-slice-light`!!
        }
        `_chart-pie-slice-light` = Builder(name = "Chart-pie-slice-light", defaultWidth = 256.0.dp,
...
private var `_chart-pie-slice-light`: ImageVector? = null
