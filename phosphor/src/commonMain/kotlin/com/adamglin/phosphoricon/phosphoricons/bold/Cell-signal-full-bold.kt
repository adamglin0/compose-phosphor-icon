...
public val BoldGroup.`Cell-signal-full-bold`: ImageVector
    get() {
        if (`_cell-signal-full-bold` != null) {
            return `_cell-signal-full-bold`!!
        }
        `_cell-signal-full-bold` = Builder(name = "Cell-signal-full-bold", defaultWidth = 256.0.dp,
...
private var `_cell-signal-full-bold`: ImageVector? = null
