...
public val RegularGroup.`House-line`: ImageVector
    get() {
        if (`_house-line` != null) {
            return `_house-line`!!
        }
        `_house-line` = Builder(name = "House-line", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_house-line`: ImageVector? = null
