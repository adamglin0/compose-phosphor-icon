...
public val DuotoneGroup.`Hard-drives-duotone`: ImageVector
    get() {
        if (`_hard-drives-duotone` != null) {
            return `_hard-drives-duotone`!!
        }
        `_hard-drives-duotone` = Builder(name = "Hard-drives-duotone", defaultWidth = 256.0.dp,
...
private var `_hard-drives-duotone`: ImageVector? = null
