...
public val BoldGroup.`Square-half-bottom-bold`: ImageVector
    get() {
        if (`_square-half-bottom-bold` != null) {
            return `_square-half-bottom-bold`!!
        }
        `_square-half-bottom-bold` = Builder(name = "Square-half-bottom-bold", defaultWidth =
...
private var `_square-half-bottom-bold`: ImageVector? = null
