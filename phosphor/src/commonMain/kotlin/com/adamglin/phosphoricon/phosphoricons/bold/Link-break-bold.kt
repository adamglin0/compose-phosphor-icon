...
public val BoldGroup.`Link-break-bold`: ImageVector
    get() {
        if (`_link-break-bold` != null) {
            return `_link-break-bold`!!
        }
        `_link-break-bold` = Builder(name = "Link-break-bold", defaultWidth = 256.0.dp,
...
private var `_link-break-bold`: ImageVector? = null
