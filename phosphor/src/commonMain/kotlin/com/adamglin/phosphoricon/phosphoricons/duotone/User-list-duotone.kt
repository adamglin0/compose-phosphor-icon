...
public val DuotoneGroup.`User-list-duotone`: ImageVector
    get() {
        if (`_user-list-duotone` != null) {
            return `_user-list-duotone`!!
        }
        `_user-list-duotone` = Builder(name = "User-list-duotone", defaultWidth = 256.0.dp,
...
private var `_user-list-duotone`: ImageVector? = null
