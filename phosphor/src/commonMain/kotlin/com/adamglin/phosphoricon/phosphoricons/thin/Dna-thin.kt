...
public val ThinGroup.`Dna-thin`: ImageVector
    get() {
        if (`_dna-thin` != null) {
            return `_dna-thin`!!
        }
        `_dna-thin` = Builder(name = "Dna-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dna-thin`: ImageVector? = null
