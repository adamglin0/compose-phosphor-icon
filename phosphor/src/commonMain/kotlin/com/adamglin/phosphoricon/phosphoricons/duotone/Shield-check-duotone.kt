...
public val DuotoneGroup.`Shield-check-duotone`: ImageVector
    get() {
        if (`_shield-check-duotone` != null) {
            return `_shield-check-duotone`!!
        }
        `_shield-check-duotone` = Builder(name = "Shield-check-duotone", defaultWidth = 256.0.dp,
...
private var `_shield-check-duotone`: ImageVector? = null
