...
public val DuotoneGroup.`Speedometer-duotone`: ImageVector
    get() {
        if (`_speedometer-duotone` != null) {
            return `_speedometer-duotone`!!
        }
        `_speedometer-duotone` = Builder(name = "Speedometer-duotone", defaultWidth = 256.0.dp,
...
private var `_speedometer-duotone`: ImageVector? = null
