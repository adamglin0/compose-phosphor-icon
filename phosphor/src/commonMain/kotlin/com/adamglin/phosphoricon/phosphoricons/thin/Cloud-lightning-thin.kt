...
public val ThinGroup.`Cloud-lightning-thin`: ImageVector
    get() {
        if (`_cloud-lightning-thin` != null) {
            return `_cloud-lightning-thin`!!
        }
        `_cloud-lightning-thin` = Builder(name = "Cloud-lightning-thin", defaultWidth = 256.0.dp,
...
private var `_cloud-lightning-thin`: ImageVector? = null
