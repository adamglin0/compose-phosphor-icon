...
public val FillGroup.`Sneaker-fill`: ImageVector
    get() {
        if (`_sneaker-fill` != null) {
            return `_sneaker-fill`!!
        }
        `_sneaker-fill` = Builder(name = "Sneaker-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sneaker-fill`: ImageVector? = null
