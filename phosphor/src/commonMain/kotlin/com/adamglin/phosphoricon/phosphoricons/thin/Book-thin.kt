...
public val ThinGroup.`Book-thin`: ImageVector
    get() {
        if (`_book-thin` != null) {
            return `_book-thin`!!
        }
        `_book-thin` = Builder(name = "Book-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_book-thin`: ImageVector? = null
