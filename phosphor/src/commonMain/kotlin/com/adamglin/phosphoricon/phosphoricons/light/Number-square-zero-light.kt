...
public val LightGroup.`Number-square-zero-light`: ImageVector
    get() {
        if (`_number-square-zero-light` != null) {
            return `_number-square-zero-light`!!
        }
        `_number-square-zero-light` = Builder(name = "Number-square-zero-light", defaultWidth =
...
private var `_number-square-zero-light`: ImageVector? = null
