...
public val LightGroup.`Number-five-light`: ImageVector
    get() {
        if (`_number-five-light` != null) {
            return `_number-five-light`!!
        }
        `_number-five-light` = Builder(name = "Number-five-light", defaultWidth = 256.0.dp,
...
private var `_number-five-light`: ImageVector? = null
