...
public val FillGroup.`Treasure-chest-fill`: ImageVector
    get() {
        if (`_treasure-chest-fill` != null) {
            return `_treasure-chest-fill`!!
        }
        `_treasure-chest-fill` = Builder(name = "Treasure-chest-fill", defaultWidth = 256.0.dp,
...
private var `_treasure-chest-fill`: ImageVector? = null
