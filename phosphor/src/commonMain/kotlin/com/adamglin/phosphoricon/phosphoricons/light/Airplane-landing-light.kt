...
public val LightGroup.`Airplane-landing-light`: ImageVector
    get() {
        if (`_airplane-landing-light` != null) {
            return `_airplane-landing-light`!!
        }
        `_airplane-landing-light` = Builder(name = "Airplane-landing-light", defaultWidth =
...
private var `_airplane-landing-light`: ImageVector? = null
