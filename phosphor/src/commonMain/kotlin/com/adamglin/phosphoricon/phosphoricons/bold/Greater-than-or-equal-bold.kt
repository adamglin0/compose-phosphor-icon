...
public val BoldGroup.`Greater-than-or-equal-bold`: ImageVector
    get() {
        if (`_greater-than-or-equal-bold` != null) {
            return `_greater-than-or-equal-bold`!!
        }
        `_greater-than-or-equal-bold` = Builder(name = "Greater-than-or-equal-bold", defaultWidth =
...
private var `_greater-than-or-equal-bold`: ImageVector? = null
