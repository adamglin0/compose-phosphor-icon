...
public val DuotoneGroup.`Matrix-logo-duotone`: ImageVector
    get() {
        if (`_matrix-logo-duotone` != null) {
            return `_matrix-logo-duotone`!!
        }
        `_matrix-logo-duotone` = Builder(name = "Matrix-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_matrix-logo-duotone`: ImageVector? = null
