...
public val BoldGroup.`Gender-transgender-bold`: ImageVector
    get() {
        if (`_gender-transgender-bold` != null) {
            return `_gender-transgender-bold`!!
        }
        `_gender-transgender-bold` = Builder(name = "Gender-transgender-bold", defaultWidth =
...
private var `_gender-transgender-bold`: ImageVector? = null
