...
public val BoldGroup.`Wrench-bold`: ImageVector
    get() {
        if (`_wrench-bold` != null) {
            return `_wrench-bold`!!
        }
        `_wrench-bold` = Builder(name = "Wrench-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wrench-bold`: ImageVector? = null
