...
public val DuotoneGroup.`Umbrella-simple-duotone`: ImageVector
    get() {
        if (`_umbrella-simple-duotone` != null) {
            return `_umbrella-simple-duotone`!!
        }
        `_umbrella-simple-duotone` = Builder(name = "Umbrella-simple-duotone", defaultWidth =
...
private var `_umbrella-simple-duotone`: ImageVector? = null
