...
public val ThinGroup.`Vignette-thin`: ImageVector
    get() {
        if (`_vignette-thin` != null) {
            return `_vignette-thin`!!
        }
        `_vignette-thin` = Builder(name = "Vignette-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_vignette-thin`: ImageVector? = null
