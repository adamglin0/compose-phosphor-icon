...
public val BoldGroup.`Tooth-bold`: ImageVector
    get() {
        if (`_tooth-bold` != null) {
            return `_tooth-bold`!!
        }
        `_tooth-bold` = Builder(name = "Tooth-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tooth-bold`: ImageVector? = null
