...
public val DuotoneGroup.`Heart-duotone`: ImageVector
    get() {
        if (`_heart-duotone` != null) {
            return `_heart-duotone`!!
        }
        `_heart-duotone` = Builder(name = "Heart-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_heart-duotone`: ImageVector? = null
