...
public val LightGroup.`Number-two-light`: ImageVector
    get() {
        if (`_number-two-light` != null) {
            return `_number-two-light`!!
        }
        `_number-two-light` = Builder(name = "Number-two-light", defaultWidth = 256.0.dp,
...
private var `_number-two-light`: ImageVector? = null
