...
public val LightGroup.`Currency-circle-dollar-light`: ImageVector
    get() {
        if (`_currency-circle-dollar-light` != null) {
            return `_currency-circle-dollar-light`!!
        }
        `_currency-circle-dollar-light` = Builder(name = "Currency-circle-dollar-light",
...
private var `_currency-circle-dollar-light`: ImageVector? = null
