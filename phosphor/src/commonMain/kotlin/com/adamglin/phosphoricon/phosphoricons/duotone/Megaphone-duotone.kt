...
public val DuotoneGroup.`Megaphone-duotone`: ImageVector
    get() {
        if (`_megaphone-duotone` != null) {
            return `_megaphone-duotone`!!
        }
        `_megaphone-duotone` = Builder(name = "Megaphone-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(40.0f, 40.0f, 0.0f, false, true, 240.0f, 120.0f)
                close()
            }
...
private var `_megaphone-duotone`: ImageVector? = null
