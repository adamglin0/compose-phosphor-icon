...
public val DuotoneGroup.`Circles-three-plus-duotone`: ImageVector
    get() {
        if (`_circles-three-plus-duotone` != null) {
            return `_circles-three-plus-duotone`!!
        }
        `_circles-three-plus-duotone` = Builder(name = "Circles-three-plus-duotone", defaultWidth =
...
private var `_circles-three-plus-duotone`: ImageVector? = null
