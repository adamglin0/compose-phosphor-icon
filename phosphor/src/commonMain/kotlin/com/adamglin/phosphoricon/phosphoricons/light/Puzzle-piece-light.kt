...
public val LightGroup.`Puzzle-piece-light`: ImageVector
    get() {
        if (`_puzzle-piece-light` != null) {
            return `_puzzle-piece-light`!!
        }
        `_puzzle-piece-light` = Builder(name = "Puzzle-piece-light", defaultWidth = 256.0.dp,
...
private var `_puzzle-piece-light`: ImageVector? = null
