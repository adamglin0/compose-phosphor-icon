...
public val BoldGroup.`Flag-banner-fold-bold`: ImageVector
    get() {
        if (`_flag-banner-fold-bold` != null) {
            return `_flag-banner-fold-bold`!!
        }
        `_flag-banner-fold-bold` = Builder(name = "Flag-banner-fold-bold", defaultWidth = 256.0.dp,
...
private var `_flag-banner-fold-bold`: ImageVector? = null
