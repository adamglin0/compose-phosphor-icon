...
public val BoldGroup.`Funnel-x-bold`: ImageVector
    get() {
        if (`_funnel-x-bold` != null) {
            return `_funnel-x-bold`!!
        }
        `_funnel-x-bold` = Builder(name = "Funnel-x-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_funnel-x-bold`: ImageVector? = null
