...
public val ThinGroup.`Git-pull-request-thin`: ImageVector
    get() {
        if (`_git-pull-request-thin` != null) {
            return `_git-pull-request-thin`!!
        }
        `_git-pull-request-thin` = Builder(name = "Git-pull-request-thin", defaultWidth = 256.0.dp,
...
private var `_git-pull-request-thin`: ImageVector? = null
