...
public val BoldGroup.`Rewind-bold`: ImageVector
    get() {
        if (`_rewind-bold` != null) {
            return `_rewind-bold`!!
        }
        `_rewind-bold` = Builder(name = "Rewind-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rewind-bold`: ImageVector? = null
