...
public val BoldGroup.`Chat-centered-dots-bold`: ImageVector
    get() {
        if (`_chat-centered-dots-bold` != null) {
            return `_chat-centered-dots-bold`!!
        }
        `_chat-centered-dots-bold` = Builder(name = "Chat-centered-dots-bold", defaultWidth =
...
private var `_chat-centered-dots-bold`: ImageVector? = null
