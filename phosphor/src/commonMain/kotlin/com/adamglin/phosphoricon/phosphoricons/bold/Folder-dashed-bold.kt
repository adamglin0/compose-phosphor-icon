...
public val BoldGroup.`Folder-dashed-bold`: ImageVector
    get() {
        if (`_folder-dashed-bold` != null) {
            return `_folder-dashed-bold`!!
        }
        `_folder-dashed-bold` = Builder(name = "Folder-dashed-bold", defaultWidth = 256.0.dp,
...
private var `_folder-dashed-bold`: ImageVector? = null
