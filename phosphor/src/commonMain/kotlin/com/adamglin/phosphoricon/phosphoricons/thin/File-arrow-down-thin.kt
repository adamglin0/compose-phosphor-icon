...
public val ThinGroup.`File-arrow-down-thin`: ImageVector
    get() {
        if (`_file-arrow-down-thin` != null) {
            return `_file-arrow-down-thin`!!
        }
        `_file-arrow-down-thin` = Builder(name = "File-arrow-down-thin", defaultWidth = 256.0.dp,
...
private var `_file-arrow-down-thin`: ImageVector? = null
