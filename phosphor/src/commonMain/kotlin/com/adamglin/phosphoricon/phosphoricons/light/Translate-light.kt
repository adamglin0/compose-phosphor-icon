...
public val LightGroup.`Translate-light`: ImageVector
    get() {
        if (`_translate-light` != null) {
            return `_translate-light`!!
        }
        `_translate-light` = Builder(name = "Translate-light", defaultWidth = 256.0.dp,
...
private var `_translate-light`: ImageVector? = null
