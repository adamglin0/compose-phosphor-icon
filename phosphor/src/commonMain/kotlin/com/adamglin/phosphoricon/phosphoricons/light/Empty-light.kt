...
public val LightGroup.`Empty-light`: ImageVector
    get() {
        if (`_empty-light` != null) {
            return `_empty-light`!!
        }
        `_empty-light` = Builder(name = "Empty-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_empty-light`: ImageVector? = null
