...
public val FillGroup.`Seal-question-fill`: ImageVector
    get() {
        if (`_seal-question-fill` != null) {
            return `_seal-question-fill`!!
        }
        `_seal-question-fill` = Builder(name = "Seal-question-fill", defaultWidth = 256.0.dp,
...
private var `_seal-question-fill`: ImageVector? = null
