...
public val ThinGroup.`Youtube-logo-thin`: ImageVector
    get() {
        if (`_youtube-logo-thin` != null) {
            return `_youtube-logo-thin`!!
        }
        `_youtube-logo-thin` = Builder(name = "Youtube-logo-thin", defaultWidth = 256.0.dp,
...
private var `_youtube-logo-thin`: ImageVector? = null
