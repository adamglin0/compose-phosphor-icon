...
public val DuotoneGroup.`Scroll-duotone`: ImageVector
    get() {
        if (`_scroll-duotone` != null) {
            return `_scroll-duotone`!!
        }
        `_scroll-duotone` = Builder(name = "Scroll-duotone", defaultWidth = 256.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                reflectiveCurveToRelative(8.0f, 6.0f, 8.0f, 16.0f)
                arcToRelative(24.0f, 24.0f, 0.0f, false, true, -48.0f, 0.0f)
                verticalLineTo(64.0f)
                arcTo(24.0f, 24.0f, 0.0f, false, false, 40.0f, 40.0f)
...
private var `_scroll-duotone`: ImageVector? = null
