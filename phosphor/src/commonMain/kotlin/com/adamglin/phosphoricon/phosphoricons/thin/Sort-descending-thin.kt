...
public val ThinGroup.`Sort-descending-thin`: ImageVector
    get() {
        if (`_sort-descending-thin` != null) {
            return `_sort-descending-thin`!!
        }
        `_sort-descending-thin` = Builder(name = "Sort-descending-thin", defaultWidth = 256.0.dp,
...
private var `_sort-descending-thin`: ImageVector? = null
