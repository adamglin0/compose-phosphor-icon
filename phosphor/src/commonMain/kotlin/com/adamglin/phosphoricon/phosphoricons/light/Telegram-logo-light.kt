...
public val LightGroup.`Telegram-logo-light`: ImageVector
    get() {
        if (`_telegram-logo-light` != null) {
            return `_telegram-logo-light`!!
        }
        `_telegram-logo-light` = Builder(name = "Telegram-logo-light", defaultWidth = 256.0.dp,
...
private var `_telegram-logo-light`: ImageVector? = null
