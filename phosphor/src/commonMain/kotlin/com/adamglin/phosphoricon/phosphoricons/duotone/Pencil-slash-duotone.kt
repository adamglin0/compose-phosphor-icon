...
public val DuotoneGroup.`Pencil-slash-duotone`: ImageVector
    get() {
        if (`_pencil-slash-duotone` != null) {
            return `_pencil-slash-duotone`!!
        }
        `_pencil-slash-duotone` = Builder(name = "Pencil-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_pencil-slash-duotone`: ImageVector? = null
