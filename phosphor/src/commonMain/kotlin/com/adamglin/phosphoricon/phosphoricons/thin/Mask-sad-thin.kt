...
public val ThinGroup.`Mask-sad-thin`: ImageVector
    get() {
        if (`_mask-sad-thin` != null) {
            return `_mask-sad-thin`!!
        }
        `_mask-sad-thin` = Builder(name = "Mask-sad-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mask-sad-thin`: ImageVector? = null
