...
public val BoldGroup.`Bell-ringing-bold`: ImageVector
    get() {
        if (`_bell-ringing-bold` != null) {
            return `_bell-ringing-bold`!!
        }
        `_bell-ringing-bold` = Builder(name = "Bell-ringing-bold", defaultWidth = 256.0.dp,
...
private var `_bell-ringing-bold`: ImageVector? = null
