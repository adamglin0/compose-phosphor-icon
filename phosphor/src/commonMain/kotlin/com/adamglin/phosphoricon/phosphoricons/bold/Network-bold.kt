...
public val BoldGroup.`Network-bold`: ImageVector
    get() {
        if (`_network-bold` != null) {
            return `_network-bold`!!
        }
        `_network-bold` = Builder(name = "Network-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_network-bold`: ImageVector? = null
