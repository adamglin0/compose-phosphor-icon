...
public val LightGroup.`Computer-tower-light`: ImageVector
    get() {
        if (`_computer-tower-light` != null) {
            return `_computer-tower-light`!!
        }
        `_computer-tower-light` = Builder(name = "Computer-tower-light", defaultWidth = 256.0.dp,
...
private var `_computer-tower-light`: ImageVector? = null
