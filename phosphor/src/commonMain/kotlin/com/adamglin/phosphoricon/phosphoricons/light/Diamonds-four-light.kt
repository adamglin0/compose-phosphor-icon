...
public val LightGroup.`Diamonds-four-light`: ImageVector
    get() {
        if (`_diamonds-four-light` != null) {
            return `_diamonds-four-light`!!
        }
        `_diamonds-four-light` = Builder(name = "Diamonds-four-light", defaultWidth = 256.0.dp,
...
private var `_diamonds-four-light`: ImageVector? = null
