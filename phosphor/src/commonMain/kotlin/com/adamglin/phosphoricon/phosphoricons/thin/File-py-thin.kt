...
public val ThinGroup.`File-py-thin`: ImageVector
    get() {
        if (`_file-py-thin` != null) {
            return `_file-py-thin`!!
        }
        `_file-py-thin` = Builder(name = "File-py-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-py-thin`: ImageVector? = null
