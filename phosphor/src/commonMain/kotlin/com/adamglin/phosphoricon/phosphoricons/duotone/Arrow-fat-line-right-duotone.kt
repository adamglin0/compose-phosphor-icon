...
public val DuotoneGroup.`Arrow-fat-line-right-duotone`: ImageVector
    get() {
        if (`_arrow-fat-line-right-duotone` != null) {
            return `_arrow-fat-line-right-duotone`!!
        }
        `_arrow-fat-line-right-duotone` = Builder(name = "Arrow-fat-line-right-duotone",
...
private var `_arrow-fat-line-right-duotone`: ImageVector? = null
