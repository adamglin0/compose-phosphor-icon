...
public val DuotoneGroup.`Angular-logo-duotone`: ImageVector
    get() {
        if (`_angular-logo-duotone` != null) {
            return `_angular-logo-duotone`!!
        }
        `_angular-logo-duotone` = Builder(name = "Angular-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_angular-logo-duotone`: ImageVector? = null
