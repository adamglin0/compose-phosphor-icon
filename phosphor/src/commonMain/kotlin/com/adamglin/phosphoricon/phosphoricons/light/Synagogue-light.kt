...
public val LightGroup.`Synagogue-light`: ImageVector
    get() {
        if (`_synagogue-light` != null) {
            return `_synagogue-light`!!
        }
        `_synagogue-light` = Builder(name = "Synagogue-light", defaultWidth = 256.0.dp,
...
private var `_synagogue-light`: ImageVector? = null
