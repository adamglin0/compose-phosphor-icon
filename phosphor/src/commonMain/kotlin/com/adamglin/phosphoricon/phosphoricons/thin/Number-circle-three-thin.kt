...
public val ThinGroup.`Number-circle-three-thin`: ImageVector
    get() {
        if (`_number-circle-three-thin` != null) {
            return `_number-circle-three-thin`!!
        }
        `_number-circle-three-thin` = Builder(name = "Number-circle-three-thin", defaultWidth =
...
private var `_number-circle-three-thin`: ImageVector? = null
