...
public val DuotoneGroup.`Trolley-duotone`: ImageVector
    get() {
        if (`_trolley-duotone` != null) {
            return `_trolley-duotone`!!
        }
        `_trolley-duotone` = Builder(name = "Trolley-duotone", defaultWidth = 256.0.dp,
...
private var `_trolley-duotone`: ImageVector? = null
