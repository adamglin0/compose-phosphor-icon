...
public val LightGroup.`Arrow-fat-line-left-light`: ImageVector
    get() {
        if (`_arrow-fat-line-left-light` != null) {
            return `_arrow-fat-line-left-light`!!
        }
        `_arrow-fat-line-left-light` = Builder(name = "Arrow-fat-line-left-light", defaultWidth =
...
private var `_arrow-fat-line-left-light`: ImageVector? = null
