...
public val BoldGroup.`Bookmarks-bold`: ImageVector
    get() {
        if (`_bookmarks-bold` != null) {
            return `_bookmarks-bold`!!
        }
        `_bookmarks-bold` = Builder(name = "Bookmarks-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bookmarks-bold`: ImageVector? = null
