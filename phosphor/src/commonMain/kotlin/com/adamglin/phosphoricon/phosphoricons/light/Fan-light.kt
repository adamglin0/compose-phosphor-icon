...
public val LightGroup.`Fan-light`: ImageVector
    get() {
        if (`_fan-light` != null) {
            return `_fan-light`!!
        }
        `_fan-light` = Builder(name = "Fan-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fan-light`: ImageVector? = null
