...
public val LightGroup.`Approximate-equals-light`: ImageVector
    get() {
        if (`_approximate-equals-light` != null) {
            return `_approximate-equals-light`!!
        }
        `_approximate-equals-light` = Builder(name = "Approximate-equals-light", defaultWidth =
...
private var `_approximate-equals-light`: ImageVector? = null
