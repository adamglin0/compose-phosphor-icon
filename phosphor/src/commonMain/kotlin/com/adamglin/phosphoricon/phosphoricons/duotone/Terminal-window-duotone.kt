...
public val DuotoneGroup.`Terminal-window-duotone`: ImageVector
    get() {
        if (`_terminal-window-duotone` != null) {
            return `_terminal-window-duotone`!!
        }
        `_terminal-window-duotone` = Builder(name = "Terminal-window-duotone", defaultWidth =
...
private var `_terminal-window-duotone`: ImageVector? = null
