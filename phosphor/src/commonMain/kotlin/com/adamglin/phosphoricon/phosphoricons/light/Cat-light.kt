...
public val LightGroup.`Cat-light`: ImageVector
    get() {
        if (`_cat-light` != null) {
            return `_cat-light`!!
        }
        `_cat-light` = Builder(name = "Cat-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cat-light`: ImageVector? = null
