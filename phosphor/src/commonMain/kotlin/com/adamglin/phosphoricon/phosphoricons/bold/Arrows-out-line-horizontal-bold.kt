...
public val BoldGroup.`Arrows-out-line-horizontal-bold`: ImageVector
    get() {
        if (`_arrows-out-line-horizontal-bold` != null) {
            return `_arrows-out-line-horizontal-bold`!!
        }
        `_arrows-out-line-horizontal-bold` = Builder(name = "Arrows-out-line-horizontal-bold",
...
private var `_arrows-out-line-horizontal-bold`: ImageVector? = null
