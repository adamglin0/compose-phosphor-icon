...
public val ThinGroup.`Flag-banner-fold-thin`: ImageVector
    get() {
        if (`_flag-banner-fold-thin` != null) {
            return `_flag-banner-fold-thin`!!
        }
        `_flag-banner-fold-thin` = Builder(name = "Flag-banner-fold-thin", defaultWidth = 256.0.dp,
...
private var `_flag-banner-fold-thin`: ImageVector? = null
