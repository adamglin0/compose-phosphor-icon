...
public val DuotoneGroup.`Arrows-out-cardinal-duotone`: ImageVector
    get() {
        if (`_arrows-out-cardinal-duotone` != null) {
            return `_arrows-out-cardinal-duotone`!!
        }
        `_arrows-out-cardinal-duotone` = Builder(name = "Arrows-out-cardinal-duotone", defaultWidth
...
private var `_arrows-out-cardinal-duotone`: ImageVector? = null
