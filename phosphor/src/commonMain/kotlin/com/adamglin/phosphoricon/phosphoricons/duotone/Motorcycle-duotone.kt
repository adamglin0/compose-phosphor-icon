...
public val DuotoneGroup.`Motorcycle-duotone`: ImageVector
    get() {
        if (`_motorcycle-duotone` != null) {
            return `_motorcycle-duotone`!!
        }
        `_motorcycle-duotone` = Builder(name = "Motorcycle-duotone", defaultWidth = 256.0.dp,
...
private var `_motorcycle-duotone`: ImageVector? = null
