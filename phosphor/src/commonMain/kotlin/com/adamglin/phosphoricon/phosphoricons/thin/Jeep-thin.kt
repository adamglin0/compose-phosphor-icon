...
public val ThinGroup.`Jeep-thin`: ImageVector
    get() {
        if (`_jeep-thin` != null) {
            return `_jeep-thin`!!
        }
        `_jeep-thin` = Builder(name = "Jeep-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_jeep-thin`: ImageVector? = null
