...
public val DuotoneGroup.`Test-tube-duotone`: ImageVector
    get() {
        if (`_test-tube-duotone` != null) {
            return `_test-tube-duotone`!!
        }
        `_test-tube-duotone` = Builder(name = "Test-tube-duotone", defaultWidth = 256.0.dp,
...
private var `_test-tube-duotone`: ImageVector? = null
