...
public val ThinGroup.`File-image-thin`: ImageVector
    get() {
        if (`_file-image-thin` != null) {
            return `_file-image-thin`!!
        }
        `_file-image-thin` = Builder(name = "File-image-thin", defaultWidth = 256.0.dp,
...
private var `_file-image-thin`: ImageVector? = null
