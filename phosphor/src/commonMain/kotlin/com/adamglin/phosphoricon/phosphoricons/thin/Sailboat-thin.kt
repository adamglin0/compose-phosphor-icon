...
public val ThinGroup.`Sailboat-thin`: ImageVector
    get() {
        if (`_sailboat-thin` != null) {
            return `_sailboat-thin`!!
        }
        `_sailboat-thin` = Builder(name = "Sailboat-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sailboat-thin`: ImageVector? = null
