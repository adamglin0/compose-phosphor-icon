...
public val BoldGroup.`Speaker-simple-low-bold`: ImageVector
    get() {
        if (`_speaker-simple-low-bold` != null) {
            return `_speaker-simple-low-bold`!!
        }
        `_speaker-simple-low-bold` = Builder(name = "Speaker-simple-low-bold", defaultWidth =
...
private var `_speaker-simple-low-bold`: ImageVector? = null
