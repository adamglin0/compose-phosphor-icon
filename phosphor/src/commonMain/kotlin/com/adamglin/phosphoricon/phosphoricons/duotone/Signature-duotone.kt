...
public val DuotoneGroup.`Signature-duotone`: ImageVector
    get() {
        if (`_signature-duotone` != null) {
            return `_signature-duotone`!!
        }
        `_signature-duotone` = Builder(name = "Signature-duotone", defaultWidth = 256.0.dp,
...
private var `_signature-duotone`: ImageVector? = null
