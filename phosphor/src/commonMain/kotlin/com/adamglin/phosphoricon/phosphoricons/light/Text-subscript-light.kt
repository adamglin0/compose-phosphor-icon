...
public val LightGroup.`Text-subscript-light`: ImageVector
    get() {
        if (`_text-subscript-light` != null) {
            return `_text-subscript-light`!!
        }
        `_text-subscript-light` = Builder(name = "Text-subscript-light", defaultWidth = 256.0.dp,
...
private var `_text-subscript-light`: ImageVector? = null
