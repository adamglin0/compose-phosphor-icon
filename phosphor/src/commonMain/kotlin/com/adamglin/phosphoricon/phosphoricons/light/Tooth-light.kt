...
public val LightGroup.`Tooth-light`: ImageVector
    get() {
        if (`_tooth-light` != null) {
            return `_tooth-light`!!
        }
        `_tooth-light` = Builder(name = "Tooth-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tooth-light`: ImageVector? = null
