...
public val LightGroup.`Soundcloud-logo-light`: ImageVector
    get() {
        if (`_soundcloud-logo-light` != null) {
            return `_soundcloud-logo-light`!!
        }
        `_soundcloud-logo-light` = Builder(name = "Soundcloud-logo-light", defaultWidth = 256.0.dp,
...
private var `_soundcloud-logo-light`: ImageVector? = null
