...
public val LightGroup.`Island-light`: ImageVector
    get() {
        if (`_island-light` != null) {
            return `_island-light`!!
        }
        `_island-light` = Builder(name = "Island-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_island-light`: ImageVector? = null
