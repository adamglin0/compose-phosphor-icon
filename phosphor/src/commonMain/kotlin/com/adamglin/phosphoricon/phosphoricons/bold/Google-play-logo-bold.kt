...
public val BoldGroup.`Google-play-logo-bold`: ImageVector
    get() {
        if (`_google-play-logo-bold` != null) {
            return `_google-play-logo-bold`!!
        }
        `_google-play-logo-bold` = Builder(name = "Google-play-logo-bold", defaultWidth = 256.0.dp,
...
private var `_google-play-logo-bold`: ImageVector? = null
