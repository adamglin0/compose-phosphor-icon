...
public val LightGroup.`Meta-logo-light`: ImageVector
    get() {
        if (`_meta-logo-light` != null) {
            return `_meta-logo-light`!!
        }
        `_meta-logo-light` = Builder(name = "Meta-logo-light", defaultWidth = 256.0.dp,
...
private var `_meta-logo-light`: ImageVector? = null
