...
public val DuotoneGroup.`Repeat-once-duotone`: ImageVector
    get() {
        if (`_repeat-once-duotone` != null) {
            return `_repeat-once-duotone`!!
        }
        `_repeat-once-duotone` = Builder(name = "Repeat-once-duotone", defaultWidth = 256.0.dp,
...
private var `_repeat-once-duotone`: ImageVector? = null
