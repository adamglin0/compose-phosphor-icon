...
public val BoldGroup.`Arrows-out-bold`: ImageVector
    get() {
        if (`_arrows-out-bold` != null) {
            return `_arrows-out-bold`!!
        }
        `_arrows-out-bold` = Builder(name = "Arrows-out-bold", defaultWidth = 256.0.dp,
...
private var `_arrows-out-bold`: ImageVector? = null
