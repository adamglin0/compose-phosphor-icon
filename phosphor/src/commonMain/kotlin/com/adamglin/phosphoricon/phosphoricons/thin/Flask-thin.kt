...
public val ThinGroup.`Flask-thin`: ImageVector
    get() {
        if (`_flask-thin` != null) {
            return `_flask-thin`!!
        }
        `_flask-thin` = Builder(name = "Flask-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flask-thin`: ImageVector? = null
