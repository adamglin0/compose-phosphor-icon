...
public val LightGroup.`Ny-times-logo-light`: ImageVector
    get() {
        if (`_ny-times-logo-light` != null) {
            return `_ny-times-logo-light`!!
        }
        `_ny-times-logo-light` = Builder(name = "Ny-times-logo-light", defaultWidth = 256.0.dp,
...
private var `_ny-times-logo-light`: ImageVector? = null
