...
public val ThinGroup.`Dice-one-thin`: ImageVector
    get() {
        if (`_dice-one-thin` != null) {
            return `_dice-one-thin`!!
        }
        `_dice-one-thin` = Builder(name = "Dice-one-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dice-one-thin`: ImageVector? = null
