...
public val FillGroup.`House-line-fill`: ImageVector
    get() {
        if (`_house-line-fill` != null) {
            return `_house-line-fill`!!
        }
        `_house-line-fill` = Builder(name = "House-line-fill", defaultWidth = 256.0.dp,
...
private var `_house-line-fill`: ImageVector? = null
