...
public val RegularGroup.`Phone-pause`: ImageVector
    get() {
        if (`_phone-pause` != null) {
            return `_phone-pause`!!
        }
        `_phone-pause` = Builder(name = "Phone-pause", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-pause`: ImageVector? = null
