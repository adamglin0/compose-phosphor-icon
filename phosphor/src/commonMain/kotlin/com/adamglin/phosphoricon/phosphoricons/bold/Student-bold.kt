...
public val BoldGroup.`Student-bold`: ImageVector
    get() {
        if (`_student-bold` != null) {
            return `_student-bold`!!
        }
        `_student-bold` = Builder(name = "Student-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_student-bold`: ImageVector? = null
