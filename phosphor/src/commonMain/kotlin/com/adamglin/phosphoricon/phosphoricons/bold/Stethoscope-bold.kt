...
public val BoldGroup.`Stethoscope-bold`: ImageVector
    get() {
        if (`_stethoscope-bold` != null) {
            return `_stethoscope-bold`!!
        }
        `_stethoscope-bold` = Builder(name = "Stethoscope-bold", defaultWidth = 256.0.dp,
...
private var `_stethoscope-bold`: ImageVector? = null
