...
public val ThinGroup.`Hourglass-simple-low-thin`: ImageVector
    get() {
        if (`_hourglass-simple-low-thin` != null) {
            return `_hourglass-simple-low-thin`!!
        }
        `_hourglass-simple-low-thin` = Builder(name = "Hourglass-simple-low-thin", defaultWidth =
...
private var `_hourglass-simple-low-thin`: ImageVector? = null
