...
public val LightGroup.`Hamburger-light`: ImageVector
    get() {
        if (`_hamburger-light` != null) {
            return `_hamburger-light`!!
        }
        `_hamburger-light` = Builder(name = "Hamburger-light", defaultWidth = 256.0.dp,
...
private var `_hamburger-light`: ImageVector? = null
