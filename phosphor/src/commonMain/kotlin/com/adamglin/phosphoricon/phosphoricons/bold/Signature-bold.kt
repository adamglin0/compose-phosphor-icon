...
public val BoldGroup.`Signature-bold`: ImageVector
    get() {
        if (`_signature-bold` != null) {
            return `_signature-bold`!!
        }
        `_signature-bold` = Builder(name = "Signature-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_signature-bold`: ImageVector? = null
