...
public val BoldGroup.`Circuitry-bold`: ImageVector
    get() {
        if (`_circuitry-bold` != null) {
            return `_circuitry-bold`!!
        }
        `_circuitry-bold` = Builder(name = "Circuitry-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_circuitry-bold`: ImageVector? = null
