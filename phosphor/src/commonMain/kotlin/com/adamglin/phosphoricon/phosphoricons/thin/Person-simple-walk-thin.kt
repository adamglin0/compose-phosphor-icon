...
public val ThinGroup.`Person-simple-walk-thin`: ImageVector
    get() {
        if (`_person-simple-walk-thin` != null) {
            return `_person-simple-walk-thin`!!
        }
        `_person-simple-walk-thin` = Builder(name = "Person-simple-walk-thin", defaultWidth =
...
private var `_person-simple-walk-thin`: ImageVector? = null
