...
public val LightGroup.`Oven-light`: ImageVector
    get() {
        if (`_oven-light` != null) {
            return `_oven-light`!!
        }
        `_oven-light` = Builder(name = "Oven-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_oven-light`: ImageVector? = null
