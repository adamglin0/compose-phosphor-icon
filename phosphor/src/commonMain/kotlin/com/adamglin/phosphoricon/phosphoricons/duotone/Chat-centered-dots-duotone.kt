...
public val DuotoneGroup.`Chat-centered-dots-duotone`: ImageVector
    get() {
        if (`_chat-centered-dots-duotone` != null) {
            return `_chat-centered-dots-duotone`!!
        }
        `_chat-centered-dots-duotone` = Builder(name = "Chat-centered-dots-duotone", defaultWidth =
...
private var `_chat-centered-dots-duotone`: ImageVector? = null
