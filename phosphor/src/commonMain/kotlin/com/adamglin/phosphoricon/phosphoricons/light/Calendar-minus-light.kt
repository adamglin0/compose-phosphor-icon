...
public val LightGroup.`Calendar-minus-light`: ImageVector
    get() {
        if (`_calendar-minus-light` != null) {
            return `_calendar-minus-light`!!
        }
        `_calendar-minus-light` = Builder(name = "Calendar-minus-light", defaultWidth = 256.0.dp,
...
private var `_calendar-minus-light`: ImageVector? = null
