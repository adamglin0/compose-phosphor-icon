...
public val ThinGroup.`Standard-definition-thin`: ImageVector
    get() {
        if (`_standard-definition-thin` != null) {
            return `_standard-definition-thin`!!
        }
        `_standard-definition-thin` = Builder(name = "Standard-definition-thin", defaultWidth =
...
private var `_standard-definition-thin`: ImageVector? = null
