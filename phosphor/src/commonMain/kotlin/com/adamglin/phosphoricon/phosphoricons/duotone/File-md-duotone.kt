...
public val DuotoneGroup.`File-md-duotone`: ImageVector
    get() {
        if (`_file-md-duotone` != null) {
            return `_file-md-duotone`!!
        }
        `_file-md-duotone` = Builder(name = "File-md-duotone", defaultWidth = 256.0.dp,
...
private var `_file-md-duotone`: ImageVector? = null
