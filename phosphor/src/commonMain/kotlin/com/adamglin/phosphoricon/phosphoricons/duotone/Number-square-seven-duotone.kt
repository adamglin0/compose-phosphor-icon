...
public val DuotoneGroup.`Number-square-seven-duotone`: ImageVector
    get() {
        if (`_number-square-seven-duotone` != null) {
            return `_number-square-seven-duotone`!!
        }
        `_number-square-seven-duotone` = Builder(name = "Number-square-seven-duotone", defaultWidth
...
private var `_number-square-seven-duotone`: ImageVector? = null
