...
public val DuotoneGroup.`Check-circle-duotone`: ImageVector
    get() {
        if (`_check-circle-duotone` != null) {
            return `_check-circle-duotone`!!
        }
        `_check-circle-duotone` = Builder(name = "Check-circle-duotone", defaultWidth = 256.0.dp,
...
private var `_check-circle-duotone`: ImageVector? = null
