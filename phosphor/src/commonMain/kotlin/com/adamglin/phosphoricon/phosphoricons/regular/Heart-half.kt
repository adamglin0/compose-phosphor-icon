...
public val RegularGroup.`Heart-half`: ImageVector
    get() {
        if (`_heart-half` != null) {
            return `_heart-half`!!
        }
        `_heart-half` = Builder(name = "Heart-half", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_heart-half`: ImageVector? = null
