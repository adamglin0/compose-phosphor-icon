...
public val ThinGroup.`Trolley-suitcase-thin`: ImageVector
    get() {
        if (`_trolley-suitcase-thin` != null) {
            return `_trolley-suitcase-thin`!!
        }
        `_trolley-suitcase-thin` = Builder(name = "Trolley-suitcase-thin", defaultWidth = 256.0.dp,
...
private var `_trolley-suitcase-thin`: ImageVector? = null
