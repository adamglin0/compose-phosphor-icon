...
public val BoldGroup.`Balloon-bold`: ImageVector
    get() {
        if (`_balloon-bold` != null) {
            return `_balloon-bold`!!
        }
        `_balloon-bold` = Builder(name = "Balloon-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_balloon-bold`: ImageVector? = null
