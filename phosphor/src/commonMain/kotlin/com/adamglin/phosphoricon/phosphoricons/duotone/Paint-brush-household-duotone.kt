...
public val DuotoneGroup.`Paint-brush-household-duotone`: ImageVector
    get() {
        if (`_paint-brush-household-duotone` != null) {
            return `_paint-brush-household-duotone`!!
        }
        `_paint-brush-household-duotone` = Builder(name = "Paint-brush-household-duotone",
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(219.52f, 59.1f)
                lineToRelative(-68.71f, 58.81f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, -0.46f, 11.74f)
                lineTo(167.0f, 146.34f)
                ...
                lineToRelative(16.69f, 16.69f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 11.74f, -0.46f)
                lineTo(196.9f, 36.48f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 219.52f, 59.1f)
                close()
            }
        }
        .build()
...
private var `_paint-brush-household-duotone`: ImageVector? = null
