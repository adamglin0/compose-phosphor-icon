...
public val ThinGroup.`Hamburger-thin`: ImageVector
    get() {
        if (`_hamburger-thin` != null) {
            return `_hamburger-thin`!!
        }
        `_hamburger-thin` = Builder(name = "Hamburger-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hamburger-thin`: ImageVector? = null
