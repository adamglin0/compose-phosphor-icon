...
public val LightGroup.`Golf-light`: ImageVector
    get() {
        if (`_golf-light` != null) {
            return `_golf-light`!!
        }
        `_golf-light` = Builder(name = "Golf-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_golf-light`: ImageVector? = null
