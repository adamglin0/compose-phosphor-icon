...
public val DuotoneGroup.`Arrow-circle-down-left-duotone`: ImageVector
    get() {
        if (`_arrow-circle-down-left-duotone` != null) {
            return `_arrow-circle-down-left-duotone`!!
        }
        `_arrow-circle-down-left-duotone` = Builder(name = "Arrow-circle-down-left-duotone",
...
private var `_arrow-circle-down-left-duotone`: ImageVector? = null
