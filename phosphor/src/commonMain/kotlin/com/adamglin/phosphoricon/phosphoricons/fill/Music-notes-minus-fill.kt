...
public val FillGroup.`Music-notes-minus-fill`: ImageVector
    get() {
        if (`_music-notes-minus-fill` != null) {
            return `_music-notes-minus-fill`!!
        }
        `_music-notes-minus-fill` = Builder(name = "Music-notes-minus-fill", defaultWidth =
...
private var `_music-notes-minus-fill`: ImageVector? = null
