...
public val BoldGroup.`Hand-swipe-left-bold`: ImageVector
    get() {
        if (`_hand-swipe-left-bold` != null) {
            return `_hand-swipe-left-bold`!!
        }
        `_hand-swipe-left-bold` = Builder(name = "Hand-swipe-left-bold", defaultWidth = 256.0.dp,
...
private var `_hand-swipe-left-bold`: ImageVector? = null
