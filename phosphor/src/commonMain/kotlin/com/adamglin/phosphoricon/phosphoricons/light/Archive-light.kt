...
public val LightGroup.`Archive-light`: ImageVector
    get() {
        if (`_archive-light` != null) {
            return `_archive-light`!!
        }
        `_archive-light` = Builder(name = "Archive-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_archive-light`: ImageVector? = null
