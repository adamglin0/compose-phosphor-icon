...
public val LightGroup.`Newspaper-light`: ImageVector
    get() {
        if (`_newspaper-light` != null) {
            return `_newspaper-light`!!
        }
        `_newspaper-light` = Builder(name = "Newspaper-light", defaultWidth = 256.0.dp,
...
private var `_newspaper-light`: ImageVector? = null
