...
public val BoldGroup.`Arrow-square-in-bold`: ImageVector
    get() {
        if (`_arrow-square-in-bold` != null) {
            return `_arrow-square-in-bold`!!
        }
        `_arrow-square-in-bold` = Builder(name = "Arrow-square-in-bold", defaultWidth = 256.0.dp,
...
private var `_arrow-square-in-bold`: ImageVector? = null
