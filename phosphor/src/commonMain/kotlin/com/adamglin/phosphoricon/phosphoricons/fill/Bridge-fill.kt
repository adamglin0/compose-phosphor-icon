...
public val FillGroup.`Bridge-fill`: ImageVector
    get() {
        if (`_bridge-fill` != null) {
            return `_bridge-fill`!!
        }
        `_bridge-fill` = Builder(name = "Bridge-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bridge-fill`: ImageVector? = null
