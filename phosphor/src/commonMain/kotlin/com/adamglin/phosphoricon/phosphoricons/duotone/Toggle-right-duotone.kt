...
public val DuotoneGroup.`Toggle-right-duotone`: ImageVector
    get() {
        if (`_toggle-right-duotone` != null) {
            return `_toggle-right-duotone`!!
        }
        `_toggle-right-duotone` = Builder(name = "Toggle-right-duotone", defaultWidth = 256.0.dp,
...
private var `_toggle-right-duotone`: ImageVector? = null
