...
public val RegularGroup.`Thermometer-cold`: ImageVector
    get() {
        if (`_thermometer-cold` != null) {
            return `_thermometer-cold`!!
        }
        `_thermometer-cold` = Builder(name = "Thermometer-cold", defaultWidth = 256.0.dp,
...
private var `_thermometer-cold`: ImageVector? = null
