...
public val DuotoneGroup.`Fast-forward-duotone`: ImageVector
    get() {
        if (`_fast-forward-duotone` != null) {
            return `_fast-forward-duotone`!!
        }
        `_fast-forward-duotone` = Builder(name = "Fast-forward-duotone", defaultWidth = 256.0.dp,
...
private var `_fast-forward-duotone`: ImageVector? = null
