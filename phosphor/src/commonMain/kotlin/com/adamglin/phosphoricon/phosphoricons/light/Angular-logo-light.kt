...
public val LightGroup.`Angular-logo-light`: ImageVector
    get() {
        if (`_angular-logo-light` != null) {
            return `_angular-logo-light`!!
        }
        `_angular-logo-light` = Builder(name = "Angular-logo-light", defaultWidth = 256.0.dp,
...
private var `_angular-logo-light`: ImageVector? = null
