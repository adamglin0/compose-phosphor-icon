...
public val DuotoneGroup.`Cherries-duotone`: ImageVector
    get() {
        if (`_cherries-duotone` != null) {
            return `_cherries-duotone`!!
        }
        `_cherries-duotone` = Builder(name = "Cherries-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(240.0f, 144.0f)
                arcToRelative(64.0f, 64.0f, 0.0f, false, true, -99.78f, 53.07f)
                lineToRelative(0.0f, -0.07f)
                arcToRelative(64.0f, 64.0f, 0.0f, true, true, -16.39f, -90.0f)
                arcTo(64.0f, 64.0f, 0.0f, false, true, 240.0f, 144.0f)
                close()
            }
...
private var `_cherries-duotone`: ImageVector? = null
