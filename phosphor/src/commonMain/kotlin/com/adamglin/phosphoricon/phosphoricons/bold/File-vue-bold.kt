...
public val BoldGroup.`File-vue-bold`: ImageVector
    get() {
        if (`_file-vue-bold` != null) {
            return `_file-vue-bold`!!
        }
        `_file-vue-bold` = Builder(name = "File-vue-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-vue-bold`: ImageVector? = null
