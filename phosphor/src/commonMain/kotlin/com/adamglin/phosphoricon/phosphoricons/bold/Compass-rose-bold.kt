...
public val BoldGroup.`Compass-rose-bold`: ImageVector
    get() {
        if (`_compass-rose-bold` != null) {
            return `_compass-rose-bold`!!
        }
        `_compass-rose-bold` = Builder(name = "Compass-rose-bold", defaultWidth = 256.0.dp,
...
private var `_compass-rose-bold`: ImageVector? = null
