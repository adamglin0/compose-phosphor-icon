...
public val LightGroup.`Brackets-angle-light`: ImageVector
    get() {
        if (`_brackets-angle-light` != null) {
            return `_brackets-angle-light`!!
        }
        `_brackets-angle-light` = Builder(name = "Brackets-angle-light", defaultWidth = 256.0.dp,
...
private var `_brackets-angle-light`: ImageVector? = null
