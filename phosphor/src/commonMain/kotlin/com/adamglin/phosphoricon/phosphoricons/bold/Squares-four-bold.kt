...
public val BoldGroup.`Squares-four-bold`: ImageVector
    get() {
        if (`_squares-four-bold` != null) {
            return `_squares-four-bold`!!
        }
        `_squares-four-bold` = Builder(name = "Squares-four-bold", defaultWidth = 256.0.dp,
...
private var `_squares-four-bold`: ImageVector? = null
