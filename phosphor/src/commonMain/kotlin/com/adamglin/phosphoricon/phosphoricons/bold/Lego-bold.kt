...
public val BoldGroup.`Lego-bold`: ImageVector
    get() {
        if (`_lego-bold` != null) {
            return `_lego-bold`!!
        }
        `_lego-bold` = Builder(name = "Lego-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lego-bold`: ImageVector? = null
