...
public val LightGroup.`Circles-three-plus-light`: ImageVector
    get() {
        if (`_circles-three-plus-light` != null) {
            return `_circles-three-plus-light`!!
        }
        `_circles-three-plus-light` = Builder(name = "Circles-three-plus-light", defaultWidth =
...
private var `_circles-three-plus-light`: ImageVector? = null
