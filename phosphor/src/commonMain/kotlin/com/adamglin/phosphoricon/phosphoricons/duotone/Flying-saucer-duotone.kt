...
public val DuotoneGroup.`Flying-saucer-duotone`: ImageVector
    get() {
        if (`_flying-saucer-duotone` != null) {
            return `_flying-saucer-duotone`!!
        }
        `_flying-saucer-duotone` = Builder(name = "Flying-saucer-duotone", defaultWidth = 256.0.dp,
...
private var `_flying-saucer-duotone`: ImageVector? = null
