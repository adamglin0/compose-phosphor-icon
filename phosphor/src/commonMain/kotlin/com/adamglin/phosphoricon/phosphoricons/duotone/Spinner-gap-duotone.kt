...
public val DuotoneGroup.`Spinner-gap-duotone`: ImageVector
    get() {
        if (`_spinner-gap-duotone` != null) {
            return `_spinner-gap-duotone`!!
        }
        `_spinner-gap-duotone` = Builder(name = "Spinner-gap-duotone", defaultWidth = 256.0.dp,
...
private var `_spinner-gap-duotone`: ImageVector? = null
