...
public val ThinGroup.`Plug-charging-thin`: ImageVector
    get() {
        if (`_plug-charging-thin` != null) {
            return `_plug-charging-thin`!!
        }
        `_plug-charging-thin` = Builder(name = "Plug-charging-thin", defaultWidth = 256.0.dp,
...
private var `_plug-charging-thin`: ImageVector? = null
