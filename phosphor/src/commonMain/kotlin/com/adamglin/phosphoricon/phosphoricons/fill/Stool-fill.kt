...
public val FillGroup.`Stool-fill`: ImageVector
    get() {
        if (`_stool-fill` != null) {
            return `_stool-fill`!!
        }
        `_stool-fill` = Builder(name = "Stool-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stool-fill`: ImageVector? = null
