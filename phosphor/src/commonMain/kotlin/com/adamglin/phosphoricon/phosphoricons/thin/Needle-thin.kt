...
public val ThinGroup.`Needle-thin`: ImageVector
    get() {
        if (`_needle-thin` != null) {
            return `_needle-thin`!!
        }
        `_needle-thin` = Builder(name = "Needle-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_needle-thin`: ImageVector? = null
