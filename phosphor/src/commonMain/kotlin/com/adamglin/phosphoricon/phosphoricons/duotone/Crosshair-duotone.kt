...
public val DuotoneGroup.`Crosshair-duotone`: ImageVector
    get() {
        if (`_crosshair-duotone` != null) {
            return `_crosshair-duotone`!!
        }
        `_crosshair-duotone` = Builder(name = "Crosshair-duotone", defaultWidth = 256.0.dp,
...
private var `_crosshair-duotone`: ImageVector? = null
