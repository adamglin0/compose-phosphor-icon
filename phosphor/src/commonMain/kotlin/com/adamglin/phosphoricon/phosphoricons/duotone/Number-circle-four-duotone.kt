...
public val DuotoneGroup.`Number-circle-four-duotone`: ImageVector
    get() {
        if (`_number-circle-four-duotone` != null) {
            return `_number-circle-four-duotone`!!
        }
        `_number-circle-four-duotone` = Builder(name = "Number-circle-four-duotone", defaultWidth =
...
private var `_number-circle-four-duotone`: ImageVector? = null
