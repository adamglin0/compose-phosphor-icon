...
public val LightGroup.`Export-light`: ImageVector
    get() {
        if (`_export-light` != null) {
            return `_export-light`!!
        }
        `_export-light` = Builder(name = "Export-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_export-light`: ImageVector? = null
