...
public val DuotoneGroup.`Dev-to-logo-duotone`: ImageVector
    get() {
        if (`_dev-to-logo-duotone` != null) {
            return `_dev-to-logo-duotone`!!
        }
        `_dev-to-logo-duotone` = Builder(name = "Dev-to-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_dev-to-logo-duotone`: ImageVector? = null
