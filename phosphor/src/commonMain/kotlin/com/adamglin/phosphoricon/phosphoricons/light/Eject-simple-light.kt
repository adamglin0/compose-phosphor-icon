...
public val LightGroup.`Eject-simple-light`: ImageVector
    get() {
        if (`_eject-simple-light` != null) {
            return `_eject-simple-light`!!
        }
        `_eject-simple-light` = Builder(name = "Eject-simple-light", defaultWidth = 256.0.dp,
...
private var `_eject-simple-light`: ImageVector? = null
