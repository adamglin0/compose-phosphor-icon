...
public val BoldGroup.`Person-simple-run-bold`: ImageVector
    get() {
        if (`_person-simple-run-bold` != null) {
            return `_person-simple-run-bold`!!
        }
        `_person-simple-run-bold` = Builder(name = "Person-simple-run-bold", defaultWidth =
...
private var `_person-simple-run-bold`: ImageVector? = null
