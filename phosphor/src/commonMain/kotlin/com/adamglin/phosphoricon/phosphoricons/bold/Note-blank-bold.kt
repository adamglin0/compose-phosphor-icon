...
public val BoldGroup.`Note-blank-bold`: ImageVector
    get() {
        if (`_note-blank-bold` != null) {
            return `_note-blank-bold`!!
        }
        `_note-blank-bold` = Builder(name = "Note-blank-bold", defaultWidth = 256.0.dp,
...
private var `_note-blank-bold`: ImageVector? = null
