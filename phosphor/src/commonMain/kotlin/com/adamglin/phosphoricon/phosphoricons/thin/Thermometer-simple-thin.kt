...
public val ThinGroup.`Thermometer-simple-thin`: ImageVector
    get() {
        if (`_thermometer-simple-thin` != null) {
            return `_thermometer-simple-thin`!!
        }
        `_thermometer-simple-thin` = Builder(name = "Thermometer-simple-thin", defaultWidth =
...
private var `_thermometer-simple-thin`: ImageVector? = null
