...
public val DuotoneGroup.`Number-square-eight-duotone`: ImageVector
    get() {
        if (`_number-square-eight-duotone` != null) {
            return `_number-square-eight-duotone`!!
        }
        `_number-square-eight-duotone` = Builder(name = "Number-square-eight-duotone", defaultWidth
...
private var `_number-square-eight-duotone`: ImageVector? = null
