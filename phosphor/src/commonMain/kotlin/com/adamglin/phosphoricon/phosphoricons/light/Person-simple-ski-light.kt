...
public val LightGroup.`Person-simple-ski-light`: ImageVector
    get() {
        if (`_person-simple-ski-light` != null) {
            return `_person-simple-ski-light`!!
        }
        `_person-simple-ski-light` = Builder(name = "Person-simple-ski-light", defaultWidth =
...
private var `_person-simple-ski-light`: ImageVector? = null
