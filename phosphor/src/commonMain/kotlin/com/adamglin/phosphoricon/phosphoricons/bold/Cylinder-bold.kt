...
public val BoldGroup.`Cylinder-bold`: ImageVector
    get() {
        if (`_cylinder-bold` != null) {
            return `_cylinder-bold`!!
        }
        `_cylinder-bold` = Builder(name = "Cylinder-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cylinder-bold`: ImageVector? = null
