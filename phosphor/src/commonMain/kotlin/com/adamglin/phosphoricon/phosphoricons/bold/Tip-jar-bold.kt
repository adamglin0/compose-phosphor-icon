...
public val BoldGroup.`Tip-jar-bold`: ImageVector
    get() {
        if (`_tip-jar-bold` != null) {
            return `_tip-jar-bold`!!
        }
        `_tip-jar-bold` = Builder(name = "Tip-jar-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tip-jar-bold`: ImageVector? = null
