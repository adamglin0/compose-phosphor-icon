...
public val LightGroup.`Floppy-disk-back-light`: ImageVector
    get() {
        if (`_floppy-disk-back-light` != null) {
            return `_floppy-disk-back-light`!!
        }
        `_floppy-disk-back-light` = Builder(name = "Floppy-disk-back-light", defaultWidth =
...
private var `_floppy-disk-back-light`: ImageVector? = null
