...
public val LightGroup.`Prescription-light`: ImageVector
    get() {
        if (`_prescription-light` != null) {
            return `_prescription-light`!!
        }
        `_prescription-light` = Builder(name = "Prescription-light", defaultWidth = 256.0.dp,
...
private var `_prescription-light`: ImageVector? = null
