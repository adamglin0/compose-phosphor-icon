...
public val LightGroup.`Cowboy-hat-light`: ImageVector
    get() {
        if (`_cowboy-hat-light` != null) {
            return `_cowboy-hat-light`!!
        }
        `_cowboy-hat-light` = Builder(name = "Cowboy-hat-light", defaultWidth = 256.0.dp,
...
private var `_cowboy-hat-light`: ImageVector? = null
