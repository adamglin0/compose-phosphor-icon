...
public val BoldGroup.`Google-podcasts-logo-bold`: ImageVector
    get() {
        if (`_google-podcasts-logo-bold` != null) {
            return `_google-podcasts-logo-bold`!!
        }
        `_google-podcasts-logo-bold` = Builder(name = "Google-podcasts-logo-bold", defaultWidth =
...
private var `_google-podcasts-logo-bold`: ImageVector? = null
