...
public val BoldGroup.`Mouse-middle-click-bold`: ImageVector
    get() {
        if (`_mouse-middle-click-bold` != null) {
            return `_mouse-middle-click-bold`!!
        }
        `_mouse-middle-click-bold` = Builder(name = "Mouse-middle-click-bold", defaultWidth =
...
private var `_mouse-middle-click-bold`: ImageVector? = null
