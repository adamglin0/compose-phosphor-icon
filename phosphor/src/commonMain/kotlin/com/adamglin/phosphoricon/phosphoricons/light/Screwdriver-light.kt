...
public val LightGroup.`Screwdriver-light`: ImageVector
    get() {
        if (`_screwdriver-light` != null) {
            return `_screwdriver-light`!!
        }
        `_screwdriver-light` = Builder(name = "Screwdriver-light", defaultWidth = 256.0.dp,
...
private var `_screwdriver-light`: ImageVector? = null
