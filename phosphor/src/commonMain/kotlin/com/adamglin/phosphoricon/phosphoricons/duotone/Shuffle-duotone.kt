...
public val DuotoneGroup.`Shuffle-duotone`: ImageVector
    get() {
        if (`_shuffle-duotone` != null) {
            return `_shuffle-duotone`!!
        }
        `_shuffle-duotone` = Builder(name = "Shuffle-duotone", defaultWidth = 256.0.dp,
...
private var `_shuffle-duotone`: ImageVector? = null
