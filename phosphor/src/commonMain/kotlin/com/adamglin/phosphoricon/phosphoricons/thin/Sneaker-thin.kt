...
public val ThinGroup.`Sneaker-thin`: ImageVector
    get() {
        if (`_sneaker-thin` != null) {
            return `_sneaker-thin`!!
        }
        `_sneaker-thin` = Builder(name = "Sneaker-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sneaker-thin`: ImageVector? = null
