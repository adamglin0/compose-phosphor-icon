...
public val BoldGroup.`Repeat-once-bold`: ImageVector
    get() {
        if (`_repeat-once-bold` != null) {
            return `_repeat-once-bold`!!
        }
        `_repeat-once-bold` = Builder(name = "Repeat-once-bold", defaultWidth = 256.0.dp,
...
private var `_repeat-once-bold`: ImageVector? = null
