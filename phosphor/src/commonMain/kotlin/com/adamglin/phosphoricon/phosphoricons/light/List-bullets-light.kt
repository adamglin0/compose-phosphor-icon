...
public val LightGroup.`List-bullets-light`: ImageVector
    get() {
        if (`_list-bullets-light` != null) {
            return `_list-bullets-light`!!
        }
        `_list-bullets-light` = Builder(name = "List-bullets-light", defaultWidth = 256.0.dp,
...
private var `_list-bullets-light`: ImageVector? = null
