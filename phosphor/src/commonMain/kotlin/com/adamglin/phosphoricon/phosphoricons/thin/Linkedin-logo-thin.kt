...
public val ThinGroup.`Linkedin-logo-thin`: ImageVector
    get() {
        if (`_linkedin-logo-thin` != null) {
            return `_linkedin-logo-thin`!!
        }
        `_linkedin-logo-thin` = Builder(name = "Linkedin-logo-thin", defaultWidth = 256.0.dp,
...
private var `_linkedin-logo-thin`: ImageVector? = null
