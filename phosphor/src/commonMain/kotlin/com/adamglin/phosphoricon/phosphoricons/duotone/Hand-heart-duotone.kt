...
public val DuotoneGroup.`Hand-heart-duotone`: ImageVector
    get() {
        if (`_hand-heart-duotone` != null) {
            return `_hand-heart-duotone`!!
        }
        `_hand-heart-duotone` = Builder(name = "Hand-heart-duotone", defaultWidth = 256.0.dp,
...
private var `_hand-heart-duotone`: ImageVector? = null
