...
public val DuotoneGroup.`Arrows-out-simple-duotone`: ImageVector
    get() {
        if (`_arrows-out-simple-duotone` != null) {
            return `_arrows-out-simple-duotone`!!
        }
        `_arrows-out-simple-duotone` = Builder(name = "Arrows-out-simple-duotone", defaultWidth =
...
private var `_arrows-out-simple-duotone`: ImageVector? = null
