...
public val LightGroup.`Garage-light`: ImageVector
    get() {
        if (`_garage-light` != null) {
            return `_garage-light`!!
        }
        `_garage-light` = Builder(name = "Garage-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_garage-light`: ImageVector? = null
