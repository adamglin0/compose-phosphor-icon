...
public val LightGroup.`User-minus-light`: ImageVector
    get() {
        if (`_user-minus-light` != null) {
            return `_user-minus-light`!!
        }
        `_user-minus-light` = Builder(name = "User-minus-light", defaultWidth = 256.0.dp,
...
private var `_user-minus-light`: ImageVector? = null
