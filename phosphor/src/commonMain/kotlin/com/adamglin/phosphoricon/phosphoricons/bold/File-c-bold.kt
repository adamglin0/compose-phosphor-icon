...
public val BoldGroup.`File-c-bold`: ImageVector
    get() {
        if (`_file-c-bold` != null) {
            return `_file-c-bold`!!
        }
        `_file-c-bold` = Builder(name = "File-c-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-c-bold`: ImageVector? = null
