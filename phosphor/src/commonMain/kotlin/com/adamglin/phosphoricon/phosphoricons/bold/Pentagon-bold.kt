...
public val BoldGroup.`Pentagon-bold`: ImageVector
    get() {
        if (`_pentagon-bold` != null) {
            return `_pentagon-bold`!!
        }
        `_pentagon-bold` = Builder(name = "Pentagon-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pentagon-bold`: ImageVector? = null
