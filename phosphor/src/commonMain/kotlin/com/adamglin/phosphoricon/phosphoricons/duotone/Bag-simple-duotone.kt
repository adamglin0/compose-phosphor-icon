...
public val DuotoneGroup.`Bag-simple-duotone`: ImageVector
    get() {
        if (`_bag-simple-duotone` != null) {
            return `_bag-simple-duotone`!!
        }
        `_bag-simple-duotone` = Builder(name = "Bag-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_bag-simple-duotone`: ImageVector? = null
