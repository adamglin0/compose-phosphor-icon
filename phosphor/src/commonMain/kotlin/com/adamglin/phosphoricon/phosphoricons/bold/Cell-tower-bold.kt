...
public val BoldGroup.`Cell-tower-bold`: ImageVector
    get() {
        if (`_cell-tower-bold` != null) {
            return `_cell-tower-bold`!!
        }
        `_cell-tower-bold` = Builder(name = "Cell-tower-bold", defaultWidth = 256.0.dp,
...
private var `_cell-tower-bold`: ImageVector? = null
