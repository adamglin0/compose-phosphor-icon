...
public val RegularGroup.`Squares-four`: ImageVector
    get() {
        if (`_squares-four` != null) {
            return `_squares-four`!!
        }
        `_squares-four` = Builder(name = "Squares-four", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_squares-four`: ImageVector? = null
