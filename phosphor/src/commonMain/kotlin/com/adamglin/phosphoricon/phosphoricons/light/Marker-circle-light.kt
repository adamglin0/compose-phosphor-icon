...
public val LightGroup.`Marker-circle-light`: ImageVector
    get() {
        if (`_marker-circle-light` != null) {
            return `_marker-circle-light`!!
        }
        `_marker-circle-light` = Builder(name = "Marker-circle-light", defaultWidth = 256.0.dp,
...
private var `_marker-circle-light`: ImageVector? = null
