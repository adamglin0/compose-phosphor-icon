...
public val FillGroup.`Crane-tower-fill`: ImageVector
    get() {
        if (`_crane-tower-fill` != null) {
            return `_crane-tower-fill`!!
        }
        `_crane-tower-fill` = Builder(name = "Crane-tower-fill", defaultWidth = 256.0.dp,
...
private var `_crane-tower-fill`: ImageVector? = null
