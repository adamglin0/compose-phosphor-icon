...
public val ThinGroup.`Toolbox-thin`: ImageVector
    get() {
        if (`_toolbox-thin` != null) {
            return `_toolbox-thin`!!
        }
        `_toolbox-thin` = Builder(name = "Toolbox-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_toolbox-thin`: ImageVector? = null
