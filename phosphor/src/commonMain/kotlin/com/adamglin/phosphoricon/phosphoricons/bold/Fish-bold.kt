...
public val BoldGroup.`Fish-bold`: ImageVector
    get() {
        if (`_fish-bold` != null) {
            return `_fish-bold`!!
        }
        `_fish-bold` = Builder(name = "Fish-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fish-bold`: ImageVector? = null
