...
public val FillGroup.`Train-regional-fill`: ImageVector
    get() {
        if (`_train-regional-fill` != null) {
            return `_train-regional-fill`!!
        }
        `_train-regional-fill` = Builder(name = "Train-regional-fill", defaultWidth = 256.0.dp,
...
private var `_train-regional-fill`: ImageVector? = null
