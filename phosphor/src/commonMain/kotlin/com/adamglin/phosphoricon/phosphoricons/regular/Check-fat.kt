...
public val RegularGroup.`Check-fat`: ImageVector
    get() {
        if (`_check-fat` != null) {
            return `_check-fat`!!
        }
        `_check-fat` = Builder(name = "Check-fat", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_check-fat`: ImageVector? = null
