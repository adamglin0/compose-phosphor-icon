...
public val BoldGroup.`Git-merge-bold`: ImageVector
    get() {
        if (`_git-merge-bold` != null) {
            return `_git-merge-bold`!!
        }
        `_git-merge-bold` = Builder(name = "Git-merge-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_git-merge-bold`: ImageVector? = null
