...
public val BoldGroup.`Chart-pie-bold`: ImageVector
    get() {
        if (`_chart-pie-bold` != null) {
            return `_chart-pie-bold`!!
        }
        `_chart-pie-bold` = Builder(name = "Chart-pie-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_chart-pie-bold`: ImageVector? = null
