...
public val FillGroup.`Square-split-horizontal-fill`: ImageVector
    get() {
        if (`_square-split-horizontal-fill` != null) {
            return `_square-split-horizontal-fill`!!
        }
        `_square-split-horizontal-fill` = Builder(name = "Square-split-horizontal-fill",
...
private var `_square-split-horizontal-fill`: ImageVector? = null
