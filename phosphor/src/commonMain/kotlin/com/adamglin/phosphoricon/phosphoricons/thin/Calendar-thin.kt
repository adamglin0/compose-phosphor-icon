...
public val ThinGroup.`Calendar-thin`: ImageVector
    get() {
        if (`_calendar-thin` != null) {
            return `_calendar-thin`!!
        }
        `_calendar-thin` = Builder(name = "Calendar-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_calendar-thin`: ImageVector? = null
