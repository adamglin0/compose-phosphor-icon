...
public val DuotoneGroup.`Folder-simple-duotone`: ImageVector
    get() {
        if (`_folder-simple-duotone` != null) {
            return `_folder-simple-duotone`!!
        }
        `_folder-simple-duotone` = Builder(name = "Folder-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_folder-simple-duotone`: ImageVector? = null
