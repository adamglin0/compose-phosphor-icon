...
public val ThinGroup.`Bag-thin`: ImageVector
    get() {
        if (`_bag-thin` != null) {
            return `_bag-thin`!!
        }
        `_bag-thin` = Builder(name = "Bag-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_bag-thin`: ImageVector? = null
