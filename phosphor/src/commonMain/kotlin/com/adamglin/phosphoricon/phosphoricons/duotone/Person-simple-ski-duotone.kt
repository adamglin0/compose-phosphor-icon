...
public val DuotoneGroup.`Person-simple-ski-duotone`: ImageVector
    get() {
        if (`_person-simple-ski-duotone` != null) {
            return `_person-simple-ski-duotone`!!
        }
        `_person-simple-ski-duotone` = Builder(name = "Person-simple-ski-duotone", defaultWidth =
...
private var `_person-simple-ski-duotone`: ImageVector? = null
