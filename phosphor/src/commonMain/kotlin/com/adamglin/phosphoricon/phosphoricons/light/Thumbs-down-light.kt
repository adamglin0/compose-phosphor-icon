...
public val LightGroup.`Thumbs-down-light`: ImageVector
    get() {
        if (`_thumbs-down-light` != null) {
            return `_thumbs-down-light`!!
        }
        `_thumbs-down-light` = Builder(name = "Thumbs-down-light", defaultWidth = 256.0.dp,
...
private var `_thumbs-down-light`: ImageVector? = null
