...
public val LightGroup.`Student-light`: ImageVector
    get() {
        if (`_student-light` != null) {
            return `_student-light`!!
        }
        `_student-light` = Builder(name = "Student-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_student-light`: ImageVector? = null
