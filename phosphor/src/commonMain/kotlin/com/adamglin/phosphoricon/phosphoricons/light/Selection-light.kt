...
public val LightGroup.`Selection-light`: ImageVector
    get() {
        if (`_selection-light` != null) {
            return `_selection-light`!!
        }
        `_selection-light` = Builder(name = "Selection-light", defaultWidth = 256.0.dp,
...
private var `_selection-light`: ImageVector? = null
