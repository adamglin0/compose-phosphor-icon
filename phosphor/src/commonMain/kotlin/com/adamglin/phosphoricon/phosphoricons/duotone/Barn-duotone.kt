...
public val DuotoneGroup.`Barn-duotone`: ImageVector
    get() {
        if (`_barn-duotone` != null) {
            return `_barn-duotone`!!
        }
        `_barn-duotone` = Builder(name = "Barn-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_barn-duotone`: ImageVector? = null
