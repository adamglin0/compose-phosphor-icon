...
public val BoldGroup.`Ghost-bold`: ImageVector
    get() {
        if (`_ghost-bold` != null) {
            return `_ghost-bold`!!
        }
        `_ghost-bold` = Builder(name = "Ghost-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ghost-bold`: ImageVector? = null
