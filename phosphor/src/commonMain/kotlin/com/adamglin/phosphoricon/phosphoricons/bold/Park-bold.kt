...
public val BoldGroup.`Park-bold`: ImageVector
    get() {
        if (`_park-bold` != null) {
            return `_park-bold`!!
        }
        `_park-bold` = Builder(name = "Park-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_park-bold`: ImageVector? = null
