...
public val BoldGroup.`Resize-bold`: ImageVector
    get() {
        if (`_resize-bold` != null) {
            return `_resize-bold`!!
        }
        `_resize-bold` = Builder(name = "Resize-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_resize-bold`: ImageVector? = null
