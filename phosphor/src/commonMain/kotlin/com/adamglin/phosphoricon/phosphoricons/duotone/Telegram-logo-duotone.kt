...
public val DuotoneGroup.`Telegram-logo-duotone`: ImageVector
    get() {
        if (`_telegram-logo-duotone` != null) {
            return `_telegram-logo-duotone`!!
        }
        `_telegram-logo-duotone` = Builder(name = "Telegram-logo-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(223.41f, 32.09f)
                lineTo(80.0f, 134.87f)
                lineTo(21.0f, 123.3f)
                arcTo(6.23f, 6.23f, 0.0f, false, true, 20.0f, 111.38f)
                lineTo(222.63f, 32.07f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 223.41f, 32.09f)
                close()
                moveTo(80.0f, 200.0f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 13.76f, 5.56f)
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(78.15f, 126.35f)
                lineToRelative(-49.61f, -9.73f)
                lineToRelative(139.2f, -54.48f)
                close()
                moveTo(88.0f, 200.0f)
...
private var `_telegram-logo-duotone`: ImageVector? = null
