...
public val LightGroup.`Finn-the-human-light`: ImageVector
    get() {
        if (`_finn-the-human-light` != null) {
            return `_finn-the-human-light`!!
        }
        `_finn-the-human-light` = Builder(name = "Finn-the-human-light", defaultWidth = 256.0.dp,
...
private var `_finn-the-human-light`: ImageVector? = null
