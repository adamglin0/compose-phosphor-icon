...
public val DuotoneGroup.`Notches-duotone`: ImageVector
    get() {
        if (`_notches-duotone` != null) {
            return `_notches-duotone`!!
        }
        `_notches-duotone` = Builder(name = "Notches-duotone", defaultWidth = 256.0.dp,
...
private var `_notches-duotone`: ImageVector? = null
