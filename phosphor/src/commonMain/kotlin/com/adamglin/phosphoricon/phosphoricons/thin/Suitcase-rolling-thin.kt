...
public val ThinGroup.`Suitcase-rolling-thin`: ImageVector
    get() {
        if (`_suitcase-rolling-thin` != null) {
            return `_suitcase-rolling-thin`!!
        }
        `_suitcase-rolling-thin` = Builder(name = "Suitcase-rolling-thin", defaultWidth = 256.0.dp,
...
private var `_suitcase-rolling-thin`: ImageVector? = null
