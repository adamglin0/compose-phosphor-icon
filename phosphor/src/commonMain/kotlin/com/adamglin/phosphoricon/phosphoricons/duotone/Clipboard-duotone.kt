...
public val DuotoneGroup.`Clipboard-duotone`: ImageVector
    get() {
        if (`_clipboard-duotone` != null) {
            return `_clipboard-duotone`!!
        }
        `_clipboard-duotone` = Builder(name = "Clipboard-duotone", defaultWidth = 256.0.dp,
...
private var `_clipboard-duotone`: ImageVector? = null
