...
public val DuotoneGroup.`Compass-tool-duotone`: ImageVector
    get() {
        if (`_compass-tool-duotone` != null) {
            return `_compass-tool-duotone`!!
        }
        `_compass-tool-duotone` = Builder(name = "Compass-tool-duotone", defaultWidth = 256.0.dp,
...
private var `_compass-tool-duotone`: ImageVector? = null
