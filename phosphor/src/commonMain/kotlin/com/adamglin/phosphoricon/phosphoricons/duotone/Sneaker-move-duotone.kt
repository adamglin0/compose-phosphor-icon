...
public val DuotoneGroup.`Sneaker-move-duotone`: ImageVector
    get() {
        if (`_sneaker-move-duotone` != null) {
            return `_sneaker-move-duotone`!!
        }
        `_sneaker-move-duotone` = Builder(name = "Sneaker-move-duotone", defaultWidth = 256.0.dp,
...
private var `_sneaker-move-duotone`: ImageVector? = null
