...
public val RegularGroup.`Chart-line-down`: ImageVector
    get() {
        if (`_chart-line-down` != null) {
            return `_chart-line-down`!!
        }
        `_chart-line-down` = Builder(name = "Chart-line-down", defaultWidth = 256.0.dp,
...
private var `_chart-line-down`: ImageVector? = null
