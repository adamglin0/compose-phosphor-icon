...
public val DuotoneGroup.`Brandy-duotone`: ImageVector
    get() {
        if (`_brandy-duotone` != null) {
            return `_brandy-duotone`!!
        }
        `_brandy-duotone` = Builder(name = "Brandy-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_brandy-duotone`: ImageVector? = null
