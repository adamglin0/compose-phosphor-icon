...
public val BoldGroup.`Shopping-cart-bold`: ImageVector
    get() {
        if (`_shopping-cart-bold` != null) {
            return `_shopping-cart-bold`!!
        }
        `_shopping-cart-bold` = Builder(name = "Shopping-cart-bold", defaultWidth = 256.0.dp,
...
private var `_shopping-cart-bold`: ImageVector? = null
