...
public val BoldGroup.`Eyeglasses-bold`: ImageVector
    get() {
        if (`_eyeglasses-bold` != null) {
            return `_eyeglasses-bold`!!
        }
        `_eyeglasses-bold` = Builder(name = "Eyeglasses-bold", defaultWidth = 256.0.dp,
...
private var `_eyeglasses-bold`: ImageVector? = null
