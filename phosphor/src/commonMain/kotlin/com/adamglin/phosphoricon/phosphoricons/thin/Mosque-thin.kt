...
public val ThinGroup.`Mosque-thin`: ImageVector
    get() {
        if (`_mosque-thin` != null) {
            return `_mosque-thin`!!
        }
        `_mosque-thin` = Builder(name = "Mosque-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mosque-thin`: ImageVector? = null
