...
public val FillGroup.`Smiley-x-eyes-fill`: ImageVector
    get() {
        if (`_smiley-x-eyes-fill` != null) {
            return `_smiley-x-eyes-fill`!!
        }
        `_smiley-x-eyes-fill` = Builder(name = "Smiley-x-eyes-fill", defaultWidth = 256.0.dp,
...
private var `_smiley-x-eyes-fill`: ImageVector? = null
