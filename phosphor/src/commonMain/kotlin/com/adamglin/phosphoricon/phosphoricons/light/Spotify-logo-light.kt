...
public val LightGroup.`Spotify-logo-light`: ImageVector
    get() {
        if (`_spotify-logo-light` != null) {
            return `_spotify-logo-light`!!
        }
        `_spotify-logo-light` = Builder(name = "Spotify-logo-light", defaultWidth = 256.0.dp,
...
private var `_spotify-logo-light`: ImageVector? = null
