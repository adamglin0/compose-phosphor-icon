...
public val BoldGroup.`File-dashed-bold`: ImageVector
    get() {
        if (`_file-dashed-bold` != null) {
            return `_file-dashed-bold`!!
        }
        `_file-dashed-bold` = Builder(name = "File-dashed-bold", defaultWidth = 256.0.dp,
...
private var `_file-dashed-bold`: ImageVector? = null
