...
public val LightGroup.`Number-square-one-light`: ImageVector
    get() {
        if (`_number-square-one-light` != null) {
            return `_number-square-one-light`!!
        }
        `_number-square-one-light` = Builder(name = "Number-square-one-light", defaultWidth =
...
private var `_number-square-one-light`: ImageVector? = null
