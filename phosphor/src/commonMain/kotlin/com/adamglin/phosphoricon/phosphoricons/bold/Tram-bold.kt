...
public val BoldGroup.`Tram-bold`: ImageVector
    get() {
        if (`_tram-bold` != null) {
            return `_tram-bold`!!
        }
        `_tram-bold` = Builder(name = "Tram-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tram-bold`: ImageVector? = null
