...
public val ThinGroup.`X-circle-thin`: ImageVector
    get() {
        if (`_x-circle-thin` != null) {
            return `_x-circle-thin`!!
        }
        `_x-circle-thin` = Builder(name = "X-circle-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_x-circle-thin`: ImageVector? = null
