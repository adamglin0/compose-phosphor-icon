...
public val LightGroup.`Stack-simple-light`: ImageVector
    get() {
        if (`_stack-simple-light` != null) {
            return `_stack-simple-light`!!
        }
        `_stack-simple-light` = Builder(name = "Stack-simple-light", defaultWidth = 256.0.dp,
...
private var `_stack-simple-light`: ImageVector? = null
