...
public val DuotoneGroup.`Pause-duotone`: ImageVector
    get() {
        if (`_pause-duotone` != null) {
            return `_pause-duotone`!!
        }
        `_pause-duotone` = Builder(name = "Pause-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pause-duotone`: ImageVector? = null
