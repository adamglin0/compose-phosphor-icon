...
public val LightGroup.`Lock-open-light`: ImageVector
    get() {
        if (`_lock-open-light` != null) {
            return `_lock-open-light`!!
        }
        `_lock-open-light` = Builder(name = "Lock-open-light", defaultWidth = 256.0.dp,
...
private var `_lock-open-light`: ImageVector? = null
