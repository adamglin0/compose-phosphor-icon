...
public val RegularGroup.`Train-simple`: ImageVector
    get() {
        if (`_train-simple` != null) {
            return `_train-simple`!!
        }
        `_train-simple` = Builder(name = "Train-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_train-simple`: ImageVector? = null
