...
public val LightGroup.`Door-open-light`: ImageVector
    get() {
        if (`_door-open-light` != null) {
            return `_door-open-light`!!
        }
        `_door-open-light` = Builder(name = "Door-open-light", defaultWidth = 256.0.dp,
...
private var `_door-open-light`: ImageVector? = null
