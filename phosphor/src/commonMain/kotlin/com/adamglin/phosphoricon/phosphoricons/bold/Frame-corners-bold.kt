...
public val BoldGroup.`Frame-corners-bold`: ImageVector
    get() {
        if (`_frame-corners-bold` != null) {
            return `_frame-corners-bold`!!
        }
        `_frame-corners-bold` = Builder(name = "Frame-corners-bold", defaultWidth = 256.0.dp,
...
private var `_frame-corners-bold`: ImageVector? = null
