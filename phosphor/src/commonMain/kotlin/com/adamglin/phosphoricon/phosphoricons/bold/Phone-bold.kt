...
public val BoldGroup.`Phone-bold`: ImageVector
    get() {
        if (`_phone-bold` != null) {
            return `_phone-bold`!!
        }
        `_phone-bold` = Builder(name = "Phone-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-bold`: ImageVector? = null
