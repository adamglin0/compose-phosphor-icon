...
public val LightGroup.`Lock-simple-light`: ImageVector
    get() {
        if (`_lock-simple-light` != null) {
            return `_lock-simple-light`!!
        }
        `_lock-simple-light` = Builder(name = "Lock-simple-light", defaultWidth = 256.0.dp,
...
private var `_lock-simple-light`: ImageVector? = null
