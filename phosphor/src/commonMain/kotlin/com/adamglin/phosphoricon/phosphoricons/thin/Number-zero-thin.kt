...
public val ThinGroup.`Number-zero-thin`: ImageVector
    get() {
        if (`_number-zero-thin` != null) {
            return `_number-zero-thin`!!
        }
        `_number-zero-thin` = Builder(name = "Number-zero-thin", defaultWidth = 256.0.dp,
...
private var `_number-zero-thin`: ImageVector? = null
