...
public val RegularGroup.`Pen-nib-straight`: ImageVector
    get() {
        if (`_pen-nib-straight` != null) {
            return `_pen-nib-straight`!!
        }
        `_pen-nib-straight` = Builder(name = "Pen-nib-straight", defaultWidth = 256.0.dp,
...
private var `_pen-nib-straight`: ImageVector? = null
