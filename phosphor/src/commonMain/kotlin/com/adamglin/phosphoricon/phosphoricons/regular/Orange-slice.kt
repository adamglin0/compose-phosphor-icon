...
public val RegularGroup.`Orange-slice`: ImageVector
    get() {
        if (`_orange-slice` != null) {
            return `_orange-slice`!!
        }
        `_orange-slice` = Builder(name = "Orange-slice", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_orange-slice`: ImageVector? = null
