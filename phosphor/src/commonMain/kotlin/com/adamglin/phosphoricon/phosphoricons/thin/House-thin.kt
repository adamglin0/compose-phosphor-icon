...
public val ThinGroup.`House-thin`: ImageVector
    get() {
        if (`_house-thin` != null) {
            return `_house-thin`!!
        }
        `_house-thin` = Builder(name = "House-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_house-thin`: ImageVector? = null
