...
public val DuotoneGroup.`Wrench-duotone`: ImageVector
    get() {
        if (`_wrench-duotone` != null) {
            return `_wrench-duotone`!!
        }
        `_wrench-duotone` = Builder(name = "Wrench-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_wrench-duotone`: ImageVector? = null
