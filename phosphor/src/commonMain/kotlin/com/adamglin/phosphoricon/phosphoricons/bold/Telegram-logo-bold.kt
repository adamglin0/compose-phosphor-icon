...
public val BoldGroup.`Telegram-logo-bold`: ImageVector
    get() {
        if (`_telegram-logo-bold` != null) {
            return `_telegram-logo-bold`!!
        }
        `_telegram-logo-bold` = Builder(name = "Telegram-logo-bold", defaultWidth = 256.0.dp,
...
private var `_telegram-logo-bold`: ImageVector? = null
