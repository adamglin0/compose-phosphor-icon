...
public val DuotoneGroup.`Lighthouse-duotone`: ImageVector
    get() {
        if (`_lighthouse-duotone` != null) {
            return `_lighthouse-duotone`!!
        }
        `_lighthouse-duotone` = Builder(name = "Lighthouse-duotone", defaultWidth = 256.0.dp,
...
private var `_lighthouse-duotone`: ImageVector? = null
