...
public val DuotoneGroup.`Text-strikethrough-duotone`: ImageVector
    get() {
        if (`_text-strikethrough-duotone` != null) {
            return `_text-strikethrough-duotone`!!
        }
        `_text-strikethrough-duotone` = Builder(name = "Text-strikethrough-duotone", defaultWidth =
...
private var `_text-strikethrough-duotone`: ImageVector? = null
