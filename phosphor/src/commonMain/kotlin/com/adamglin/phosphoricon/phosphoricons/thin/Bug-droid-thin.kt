...
public val ThinGroup.`Bug-droid-thin`: ImageVector
    get() {
        if (`_bug-droid-thin` != null) {
            return `_bug-droid-thin`!!
        }
        `_bug-droid-thin` = Builder(name = "Bug-droid-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bug-droid-thin`: ImageVector? = null
