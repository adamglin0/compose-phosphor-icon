...
public val DuotoneGroup.`Eyeglasses-duotone`: ImageVector
    get() {
        if (`_eyeglasses-duotone` != null) {
            return `_eyeglasses-duotone`!!
        }
        `_eyeglasses-duotone` = Builder(name = "Eyeglasses-duotone", defaultWidth = 256.0.dp,
...
private var `_eyeglasses-duotone`: ImageVector? = null
