...
public val LightGroup.`Number-six-light`: ImageVector
    get() {
        if (`_number-six-light` != null) {
            return `_number-six-light`!!
        }
        `_number-six-light` = Builder(name = "Number-six-light", defaultWidth = 256.0.dp,
...
private var `_number-six-light`: ImageVector? = null
