...
public val BoldGroup.`File-rs-bold`: ImageVector
    get() {
        if (`_file-rs-bold` != null) {
            return `_file-rs-bold`!!
        }
        `_file-rs-bold` = Builder(name = "File-rs-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-rs-bold`: ImageVector? = null
