...
public val LightGroup.`Folder-simple-minus-light`: ImageVector
    get() {
        if (`_folder-simple-minus-light` != null) {
            return `_folder-simple-minus-light`!!
        }
        `_folder-simple-minus-light` = Builder(name = "Folder-simple-minus-light", defaultWidth =
...
private var `_folder-simple-minus-light`: ImageVector? = null
