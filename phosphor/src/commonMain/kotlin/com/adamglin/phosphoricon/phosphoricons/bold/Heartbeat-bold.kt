...
public val BoldGroup.`Heartbeat-bold`: ImageVector
    get() {
        if (`_heartbeat-bold` != null) {
            return `_heartbeat-bold`!!
        }
        `_heartbeat-bold` = Builder(name = "Heartbeat-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_heartbeat-bold`: ImageVector? = null
