...
public val ThinGroup.`Hand-swipe-left-thin`: ImageVector
    get() {
        if (`_hand-swipe-left-thin` != null) {
            return `_hand-swipe-left-thin`!!
        }
        `_hand-swipe-left-thin` = Builder(name = "Hand-swipe-left-thin", defaultWidth = 256.0.dp,
...
private var `_hand-swipe-left-thin`: ImageVector? = null
