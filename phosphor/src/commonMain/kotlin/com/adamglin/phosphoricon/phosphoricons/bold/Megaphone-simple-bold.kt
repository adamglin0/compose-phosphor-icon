...
public val BoldGroup.`Megaphone-simple-bold`: ImageVector
    get() {
        if (`_megaphone-simple-bold` != null) {
            return `_megaphone-simple-bold`!!
        }
        `_megaphone-simple-bold` = Builder(name = "Megaphone-simple-bold", defaultWidth = 256.0.dp,
...
private var `_megaphone-simple-bold`: ImageVector? = null
