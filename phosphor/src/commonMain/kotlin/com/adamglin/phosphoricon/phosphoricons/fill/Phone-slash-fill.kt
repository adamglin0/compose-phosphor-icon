...
public val FillGroup.`Phone-slash-fill`: ImageVector
    get() {
        if (`_phone-slash-fill` != null) {
            return `_phone-slash-fill`!!
        }
        `_phone-slash-fill` = Builder(name = "Phone-slash-fill", defaultWidth = 256.0.dp,
...
private var `_phone-slash-fill`: ImageVector? = null
