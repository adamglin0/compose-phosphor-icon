...
public val ThinGroup.`Gas-can-thin`: ImageVector
    get() {
        if (`_gas-can-thin` != null) {
            return `_gas-can-thin`!!
        }
        `_gas-can-thin` = Builder(name = "Gas-can-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gas-can-thin`: ImageVector? = null
