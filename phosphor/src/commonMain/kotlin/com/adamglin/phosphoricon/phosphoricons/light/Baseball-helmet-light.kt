...
public val LightGroup.`Baseball-helmet-light`: ImageVector
    get() {
        if (`_baseball-helmet-light` != null) {
            return `_baseball-helmet-light`!!
        }
        `_baseball-helmet-light` = Builder(name = "Baseball-helmet-light", defaultWidth = 256.0.dp,
...
private var `_baseball-helmet-light`: ImageVector? = null
