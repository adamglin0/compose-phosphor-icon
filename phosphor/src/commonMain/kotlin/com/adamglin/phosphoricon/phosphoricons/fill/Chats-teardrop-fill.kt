...
public val FillGroup.`Chats-teardrop-fill`: ImageVector
    get() {
        if (`_chats-teardrop-fill` != null) {
            return `_chats-teardrop-fill`!!
        }
        `_chats-teardrop-fill` = Builder(name = "Chats-teardrop-fill", defaultWidth = 256.0.dp,
...
private var `_chats-teardrop-fill`: ImageVector? = null
