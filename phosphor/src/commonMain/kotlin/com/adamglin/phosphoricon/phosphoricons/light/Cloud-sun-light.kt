...
public val LightGroup.`Cloud-sun-light`: ImageVector
    get() {
        if (`_cloud-sun-light` != null) {
            return `_cloud-sun-light`!!
        }
        `_cloud-sun-light` = Builder(name = "Cloud-sun-light", defaultWidth = 256.0.dp,
...
private var `_cloud-sun-light`: ImageVector? = null
