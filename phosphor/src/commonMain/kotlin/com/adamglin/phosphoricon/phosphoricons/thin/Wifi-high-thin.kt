...
public val ThinGroup.`Wifi-high-thin`: ImageVector
    get() {
        if (`_wifi-high-thin` != null) {
            return `_wifi-high-thin`!!
        }
        `_wifi-high-thin` = Builder(name = "Wifi-high-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_wifi-high-thin`: ImageVector? = null
