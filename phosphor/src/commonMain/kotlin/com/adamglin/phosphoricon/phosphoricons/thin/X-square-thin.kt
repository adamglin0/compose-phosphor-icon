...
public val ThinGroup.`X-square-thin`: ImageVector
    get() {
        if (`_x-square-thin` != null) {
            return `_x-square-thin`!!
        }
        `_x-square-thin` = Builder(name = "X-square-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_x-square-thin`: ImageVector? = null
