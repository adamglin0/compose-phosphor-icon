...
public val BoldGroup.`Dice-five-bold`: ImageVector
    get() {
        if (`_dice-five-bold` != null) {
            return `_dice-five-bold`!!
        }
        `_dice-five-bold` = Builder(name = "Dice-five-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dice-five-bold`: ImageVector? = null
