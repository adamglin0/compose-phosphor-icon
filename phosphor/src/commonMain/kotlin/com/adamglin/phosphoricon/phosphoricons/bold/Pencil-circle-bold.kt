...
public val BoldGroup.`Pencil-circle-bold`: ImageVector
    get() {
        if (`_pencil-circle-bold` != null) {
            return `_pencil-circle-bold`!!
        }
        `_pencil-circle-bold` = Builder(name = "Pencil-circle-bold", defaultWidth = 256.0.dp,
...
private var `_pencil-circle-bold`: ImageVector? = null
