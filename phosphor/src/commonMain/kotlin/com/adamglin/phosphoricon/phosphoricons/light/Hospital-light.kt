...
public val LightGroup.`Hospital-light`: ImageVector
    get() {
        if (`_hospital-light` != null) {
            return `_hospital-light`!!
        }
        `_hospital-light` = Builder(name = "Hospital-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hospital-light`: ImageVector? = null
