...
public val ThinGroup.`Note-thin`: ImageVector
    get() {
        if (`_note-thin` != null) {
            return `_note-thin`!!
        }
        `_note-thin` = Builder(name = "Note-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_note-thin`: ImageVector? = null
