...
public val RegularGroup.`File-rs`: ImageVector
    get() {
        if (`_file-rs` != null) {
            return `_file-rs`!!
        }
        `_file-rs` = Builder(name = "File-rs", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-rs`: ImageVector? = null
