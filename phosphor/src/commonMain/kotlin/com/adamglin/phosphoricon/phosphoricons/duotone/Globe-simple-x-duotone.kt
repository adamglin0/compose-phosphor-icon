...
public val DuotoneGroup.`Globe-simple-x-duotone`: ImageVector
    get() {
        if (`_globe-simple-x-duotone` != null) {
            return `_globe-simple-x-duotone`!!
        }
        `_globe-simple-x-duotone` = Builder(name = "Globe-simple-x-duotone", defaultWidth =
...
private var `_globe-simple-x-duotone`: ImageVector? = null
