...
public val LightGroup.`Flag-banner-light`: ImageVector
    get() {
        if (`_flag-banner-light` != null) {
            return `_flag-banner-light`!!
        }
        `_flag-banner-light` = Builder(name = "Flag-banner-light", defaultWidth = 256.0.dp,
...
private var `_flag-banner-light`: ImageVector? = null
