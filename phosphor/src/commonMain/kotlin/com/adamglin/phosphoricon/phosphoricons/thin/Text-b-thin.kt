...
public val ThinGroup.`Text-b-thin`: ImageVector
    get() {
        if (`_text-b-thin` != null) {
            return `_text-b-thin`!!
        }
        `_text-b-thin` = Builder(name = "Text-b-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-b-thin`: ImageVector? = null
