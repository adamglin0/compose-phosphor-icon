...
public val ThinGroup.`Cloud-arrow-down-thin`: ImageVector
    get() {
        if (`_cloud-arrow-down-thin` != null) {
            return `_cloud-arrow-down-thin`!!
        }
        `_cloud-arrow-down-thin` = Builder(name = "Cloud-arrow-down-thin", defaultWidth = 256.0.dp,
...
private var `_cloud-arrow-down-thin`: ImageVector? = null
