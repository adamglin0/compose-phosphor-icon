...
public val BoldGroup.`Link-bold`: ImageVector
    get() {
        if (`_link-bold` != null) {
            return `_link-bold`!!
        }
        `_link-bold` = Builder(name = "Link-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_link-bold`: ImageVector? = null
