...
public val DuotoneGroup.`Presentation-duotone`: ImageVector
    get() {
        if (`_presentation-duotone` != null) {
            return `_presentation-duotone`!!
        }
        `_presentation-duotone` = Builder(name = "Presentation-duotone", defaultWidth = 256.0.dp,
...
private var `_presentation-duotone`: ImageVector? = null
