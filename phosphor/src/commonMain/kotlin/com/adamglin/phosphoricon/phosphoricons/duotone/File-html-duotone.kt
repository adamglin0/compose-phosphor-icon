...
public val DuotoneGroup.`File-html-duotone`: ImageVector
    get() {
        if (`_file-html-duotone` != null) {
            return `_file-html-duotone`!!
        }
        `_file-html-duotone` = Builder(name = "File-html-duotone", defaultWidth = 256.0.dp,
...
private var `_file-html-duotone`: ImageVector? = null
