...
public val BoldGroup.`Wave-triangle-bold`: ImageVector
    get() {
        if (`_wave-triangle-bold` != null) {
            return `_wave-triangle-bold`!!
        }
        `_wave-triangle-bold` = Builder(name = "Wave-triangle-bold", defaultWidth = 256.0.dp,
...
private var `_wave-triangle-bold`: ImageVector? = null
