...
public val BoldGroup.`Folder-lock-bold`: ImageVector
    get() {
        if (`_folder-lock-bold` != null) {
            return `_folder-lock-bold`!!
        }
        `_folder-lock-bold` = Builder(name = "Folder-lock-bold", defaultWidth = 256.0.dp,
...
private var `_folder-lock-bold`: ImageVector? = null
