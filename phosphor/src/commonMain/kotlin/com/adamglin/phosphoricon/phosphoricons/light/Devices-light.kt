...
public val LightGroup.`Devices-light`: ImageVector
    get() {
        if (`_devices-light` != null) {
            return `_devices-light`!!
        }
        `_devices-light` = Builder(name = "Devices-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_devices-light`: ImageVector? = null
