...
public val LightGroup.`Network-x-light`: ImageVector
    get() {
        if (`_network-x-light` != null) {
            return `_network-x-light`!!
        }
        `_network-x-light` = Builder(name = "Network-x-light", defaultWidth = 256.0.dp,
...
private var `_network-x-light`: ImageVector? = null
