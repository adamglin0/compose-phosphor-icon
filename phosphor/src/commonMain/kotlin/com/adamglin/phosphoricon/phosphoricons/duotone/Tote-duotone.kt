...
public val DuotoneGroup.`Tote-duotone`: ImageVector
    get() {
        if (`_tote-duotone` != null) {
            return `_tote-duotone`!!
        }
        `_tote-duotone` = Builder(name = "Tote-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tote-duotone`: ImageVector? = null
