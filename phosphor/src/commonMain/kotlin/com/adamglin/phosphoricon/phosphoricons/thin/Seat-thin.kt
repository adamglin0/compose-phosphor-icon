...
public val ThinGroup.`Seat-thin`: ImageVector
    get() {
        if (`_seat-thin` != null) {
            return `_seat-thin`!!
        }
        `_seat-thin` = Builder(name = "Seat-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seat-thin`: ImageVector? = null
