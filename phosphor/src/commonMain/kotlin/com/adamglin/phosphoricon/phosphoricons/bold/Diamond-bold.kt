...
public val BoldGroup.`Diamond-bold`: ImageVector
    get() {
        if (`_diamond-bold` != null) {
            return `_diamond-bold`!!
        }
        `_diamond-bold` = Builder(name = "Diamond-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_diamond-bold`: ImageVector? = null
