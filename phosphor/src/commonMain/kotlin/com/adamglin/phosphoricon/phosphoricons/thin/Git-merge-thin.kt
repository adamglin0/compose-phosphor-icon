...
public val ThinGroup.`Git-merge-thin`: ImageVector
    get() {
        if (`_git-merge-thin` != null) {
            return `_git-merge-thin`!!
        }
        `_git-merge-thin` = Builder(name = "Git-merge-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_git-merge-thin`: ImageVector? = null
