...
public val DuotoneGroup.`Warehouse-duotone`: ImageVector
    get() {
        if (`_warehouse-duotone` != null) {
            return `_warehouse-duotone`!!
        }
        `_warehouse-duotone` = Builder(name = "Warehouse-duotone", defaultWidth = 256.0.dp,
...
private var `_warehouse-duotone`: ImageVector? = null
