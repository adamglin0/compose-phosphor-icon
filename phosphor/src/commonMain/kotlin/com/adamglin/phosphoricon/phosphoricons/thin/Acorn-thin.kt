...
public val ThinGroup.`Acorn-thin`: ImageVector
    get() {
        if (`_acorn-thin` != null) {
            return `_acorn-thin`!!
        }
        `_acorn-thin` = Builder(name = "Acorn-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_acorn-thin`: ImageVector? = null
