...
public val ThinGroup.`Prescription-thin`: ImageVector
    get() {
        if (`_prescription-thin` != null) {
            return `_prescription-thin`!!
        }
        `_prescription-thin` = Builder(name = "Prescription-thin", defaultWidth = 256.0.dp,
...
private var `_prescription-thin`: ImageVector? = null
