...
public val ThinGroup.`Office-chair-thin`: ImageVector
    get() {
        if (`_office-chair-thin` != null) {
            return `_office-chair-thin`!!
        }
        `_office-chair-thin` = Builder(name = "Office-chair-thin", defaultWidth = 256.0.dp,
...
private var `_office-chair-thin`: ImageVector? = null
