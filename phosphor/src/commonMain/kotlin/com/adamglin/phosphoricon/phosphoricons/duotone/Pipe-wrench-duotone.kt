...
public val DuotoneGroup.`Pipe-wrench-duotone`: ImageVector
    get() {
        if (`_pipe-wrench-duotone` != null) {
            return `_pipe-wrench-duotone`!!
        }
        `_pipe-wrench-duotone` = Builder(name = "Pipe-wrench-duotone", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(173.66f, 145.66f)
                lineTo(85.0f, 235.0f)
                arcToRelative(17.0f, 17.0f, 0.0f, false, true, -24.0f, -24.0f)
                lineToRelative(64.69f, -65.37f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, false, 0.0f, -11.32f)
                lineTo(77.0f, 85.0f)
                arcToRelative(17.0f, 17.0f, 0.0f, false, true, 0.0f, -24.0f)
                horizontalLineToRelative(0.0f)
                arcToRelative(17.0f, 17.0f, 0.0f, false, true, 24.0f, 0.0f)
                lineToRelative(72.69f, 73.37f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 173.66f, 145.66f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(79.31f, 229.37f)
                arcToRelative(9.0f, 9.0f, 0.0f, true, true, -12.65f, -12.71f)
                lineToRelative(64.67f, -65.37f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, false, 0.0f, -22.57f)
                lineTo(82.63f, 79.31f)
                arcTo(9.0f, 9.0f, 0.0f, false, true, 95.29f, 66.6f)
...
private var `_pipe-wrench-duotone`: ImageVector? = null
