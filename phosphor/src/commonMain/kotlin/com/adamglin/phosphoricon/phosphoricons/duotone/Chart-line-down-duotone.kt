...
public val DuotoneGroup.`Chart-line-down-duotone`: ImageVector
    get() {
        if (`_chart-line-down-duotone` != null) {
            return `_chart-line-down-duotone`!!
        }
        `_chart-line-down-duotone` = Builder(name = "Chart-line-down-duotone", defaultWidth =
...
private var `_chart-line-down-duotone`: ImageVector? = null
