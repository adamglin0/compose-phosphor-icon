...
public val DuotoneGroup.`Flip-vertical-duotone`: ImageVector
    get() {
        if (`_flip-vertical-duotone` != null) {
            return `_flip-vertical-duotone`!!
        }
        `_flip-vertical-duotone` = Builder(name = "Flip-vertical-duotone", defaultWidth = 256.0.dp,
...
private var `_flip-vertical-duotone`: ImageVector? = null
