...
public val LightGroup.`Broom-light`: ImageVector
    get() {
        if (`_broom-light` != null) {
            return `_broom-light`!!
        }
        `_broom-light` = Builder(name = "Broom-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_broom-light`: ImageVector? = null
