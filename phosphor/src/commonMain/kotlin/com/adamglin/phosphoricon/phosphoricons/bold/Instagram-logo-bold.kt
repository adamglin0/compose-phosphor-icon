...
public val BoldGroup.`Instagram-logo-bold`: ImageVector
    get() {
        if (`_instagram-logo-bold` != null) {
            return `_instagram-logo-bold`!!
        }
        `_instagram-logo-bold` = Builder(name = "Instagram-logo-bold", defaultWidth = 256.0.dp,
...
private var `_instagram-logo-bold`: ImageVector? = null
