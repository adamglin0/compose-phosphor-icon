...
public val LightGroup.`Bug-light`: ImageVector
    get() {
        if (`_bug-light` != null) {
            return `_bug-light`!!
        }
        `_bug-light` = Builder(name = "Bug-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bug-light`: ImageVector? = null
