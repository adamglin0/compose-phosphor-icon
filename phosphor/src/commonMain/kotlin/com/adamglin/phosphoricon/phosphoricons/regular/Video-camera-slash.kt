...
public val RegularGroup.`Video-camera-slash`: ImageVector
    get() {
        if (`_video-camera-slash` != null) {
            return `_video-camera-slash`!!
        }
        `_video-camera-slash` = Builder(name = "Video-camera-slash", defaultWidth = 256.0.dp,
...
private var `_video-camera-slash`: ImageVector? = null
