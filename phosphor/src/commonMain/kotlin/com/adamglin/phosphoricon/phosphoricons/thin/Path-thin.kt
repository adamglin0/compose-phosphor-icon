...
public val ThinGroup.`Path-thin`: ImageVector
    get() {
        if (`_path-thin` != null) {
            return `_path-thin`!!
        }
        `_path-thin` = Builder(name = "Path-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_path-thin`: ImageVector? = null
