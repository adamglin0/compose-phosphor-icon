...
public val ThinGroup.`Lectern-thin`: ImageVector
    get() {
        if (`_lectern-thin` != null) {
            return `_lectern-thin`!!
        }
        `_lectern-thin` = Builder(name = "Lectern-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lectern-thin`: ImageVector? = null
