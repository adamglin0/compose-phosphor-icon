...
public val DuotoneGroup.`Quotes-duotone`: ImageVector
    get() {
        if (`_quotes-duotone` != null) {
            return `_quotes-duotone`!!
        }
        `_quotes-duotone` = Builder(name = "Quotes-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_quotes-duotone`: ImageVector? = null
