...
public val RegularGroup.`Road-horizon`: ImageVector
    get() {
        if (`_road-horizon` != null) {
            return `_road-horizon`!!
        }
        `_road-horizon` = Builder(name = "Road-horizon", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_road-horizon`: ImageVector? = null
