...
public val DuotoneGroup.`Cube-duotone`: ImageVector
    get() {
        if (`_cube-duotone` != null) {
            return `_cube-duotone`!!
        }
        `_cube-duotone` = Builder(name = "Cube-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cube-duotone`: ImageVector? = null
