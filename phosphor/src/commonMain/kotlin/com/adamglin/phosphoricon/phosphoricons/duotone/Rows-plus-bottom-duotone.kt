...
public val DuotoneGroup.`Rows-plus-bottom-duotone`: ImageVector
    get() {
        if (`_rows-plus-bottom-duotone` != null) {
            return `_rows-plus-bottom-duotone`!!
        }
        `_rows-plus-bottom-duotone` = Builder(name = "Rows-plus-bottom-duotone", defaultWidth =
...
private var `_rows-plus-bottom-duotone`: ImageVector? = null
