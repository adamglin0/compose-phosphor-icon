...
public val DuotoneGroup.`Oven-duotone`: ImageVector
    get() {
        if (`_oven-duotone` != null) {
            return `_oven-duotone`!!
        }
        `_oven-duotone` = Builder(name = "Oven-duotone", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(160.0f, 76.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, true, true, 12.0f, 12.0f)
                arcTo(12.0f, 12.0f, 0.0f, false, true, 160.0f, 76.0f)
                close()
...
private var `_oven-duotone`: ImageVector? = null
