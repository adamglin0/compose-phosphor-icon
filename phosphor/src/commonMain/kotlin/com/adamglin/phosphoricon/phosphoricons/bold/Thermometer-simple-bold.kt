...
public val BoldGroup.`Thermometer-simple-bold`: ImageVector
    get() {
        if (`_thermometer-simple-bold` != null) {
            return `_thermometer-simple-bold`!!
        }
        `_thermometer-simple-bold` = Builder(name = "Thermometer-simple-bold", defaultWidth =
...
private var `_thermometer-simple-bold`: ImageVector? = null
