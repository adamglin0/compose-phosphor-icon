...
public val ThinGroup.`Phone-outgoing-thin`: ImageVector
    get() {
        if (`_phone-outgoing-thin` != null) {
            return `_phone-outgoing-thin`!!
        }
        `_phone-outgoing-thin` = Builder(name = "Phone-outgoing-thin", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(149.17f, 106.83f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -5.66f)
                lineTo(190.34f, 60.0f)
                lineTo(160.0f, 60.0f)
...
private var `_phone-outgoing-thin`: ImageVector? = null
