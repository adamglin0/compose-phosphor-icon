...
public val DuotoneGroup.`Bell-simple-duotone`: ImageVector
    get() {
        if (`_bell-simple-duotone` != null) {
            return `_bell-simple-duotone`!!
        }
        `_bell-simple-duotone` = Builder(name = "Bell-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_bell-simple-duotone`: ImageVector? = null
