...
public val LightGroup.`Leaf-light`: ImageVector
    get() {
        if (`_leaf-light` != null) {
            return `_leaf-light`!!
        }
        `_leaf-light` = Builder(name = "Leaf-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_leaf-light`: ImageVector? = null
