...
public val LightGroup.`Arrows-out-cardinal-light`: ImageVector
    get() {
        if (`_arrows-out-cardinal-light` != null) {
            return `_arrows-out-cardinal-light`!!
        }
        `_arrows-out-cardinal-light` = Builder(name = "Arrows-out-cardinal-light", defaultWidth =
...
private var `_arrows-out-cardinal-light`: ImageVector? = null
