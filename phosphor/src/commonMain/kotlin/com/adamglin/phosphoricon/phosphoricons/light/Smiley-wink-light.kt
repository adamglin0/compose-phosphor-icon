...
public val LightGroup.`Smiley-wink-light`: ImageVector
    get() {
        if (`_smiley-wink-light` != null) {
            return `_smiley-wink-light`!!
        }
        `_smiley-wink-light` = Builder(name = "Smiley-wink-light", defaultWidth = 256.0.dp,
...
private var `_smiley-wink-light`: ImageVector? = null
