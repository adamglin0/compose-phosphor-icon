...
public val ThinGroup.`Calendar-plus-thin`: ImageVector
    get() {
        if (`_calendar-plus-thin` != null) {
            return `_calendar-plus-thin`!!
        }
        `_calendar-plus-thin` = Builder(name = "Calendar-plus-thin", defaultWidth = 256.0.dp,
...
private var `_calendar-plus-thin`: ImageVector? = null
