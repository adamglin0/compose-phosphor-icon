...
public val DuotoneGroup.`Hourglass-simple-low-duotone`: ImageVector
    get() {
        if (`_hourglass-simple-low-duotone` != null) {
            return `_hourglass-simple-low-duotone`!!
        }
        `_hourglass-simple-low-duotone` = Builder(name = "Hourglass-simple-low-duotone",
...
private var `_hourglass-simple-low-duotone`: ImageVector? = null
