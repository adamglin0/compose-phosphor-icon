...
public val LightGroup.`Arrows-down-up-light`: ImageVector
    get() {
        if (`_arrows-down-up-light` != null) {
            return `_arrows-down-up-light`!!
        }
        `_arrows-down-up-light` = Builder(name = "Arrows-down-up-light", defaultWidth = 256.0.dp,
...
private var `_arrows-down-up-light`: ImageVector? = null
