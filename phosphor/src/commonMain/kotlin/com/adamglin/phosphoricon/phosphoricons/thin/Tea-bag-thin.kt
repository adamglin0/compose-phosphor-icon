...
public val ThinGroup.`Tea-bag-thin`: ImageVector
    get() {
        if (`_tea-bag-thin` != null) {
            return `_tea-bag-thin`!!
        }
        `_tea-bag-thin` = Builder(name = "Tea-bag-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tea-bag-thin`: ImageVector? = null
