...
public val FillGroup.`Currency-cny-fill`: ImageVector
    get() {
        if (`_currency-cny-fill` != null) {
            return `_currency-cny-fill`!!
        }
        `_currency-cny-fill` = Builder(name = "Currency-cny-fill", defaultWidth = 256.0.dp,
...
private var `_currency-cny-fill`: ImageVector? = null
