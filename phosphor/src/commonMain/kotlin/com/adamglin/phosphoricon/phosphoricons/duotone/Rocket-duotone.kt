...
public val DuotoneGroup.`Rocket-duotone`: ImageVector
    get() {
        if (`_rocket-duotone` != null) {
            return `_rocket-duotone`!!
        }
        `_rocket-duotone` = Builder(name = "Rocket-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_rocket-duotone`: ImageVector? = null
