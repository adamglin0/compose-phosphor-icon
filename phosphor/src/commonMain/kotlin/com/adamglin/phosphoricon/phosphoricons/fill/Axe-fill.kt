...
public val FillGroup.`Axe-fill`: ImageVector
    get() {
        if (`_axe-fill` != null) {
            return `_axe-fill`!!
        }
        `_axe-fill` = Builder(name = "Axe-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_axe-fill`: ImageVector? = null
