...
public val DuotoneGroup.`Pix-logo-duotone`: ImageVector
    get() {
        if (`_pix-logo-duotone` != null) {
            return `_pix-logo-duotone`!!
        }
        `_pix-logo-duotone` = Builder(name = "Pix-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_pix-logo-duotone`: ImageVector? = null
