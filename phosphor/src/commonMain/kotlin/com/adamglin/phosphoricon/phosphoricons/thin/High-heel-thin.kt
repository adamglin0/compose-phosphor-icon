...
public val ThinGroup.`High-heel-thin`: ImageVector
    get() {
        if (`_high-heel-thin` != null) {
            return `_high-heel-thin`!!
        }
        `_high-heel-thin` = Builder(name = "High-heel-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_high-heel-thin`: ImageVector? = null
