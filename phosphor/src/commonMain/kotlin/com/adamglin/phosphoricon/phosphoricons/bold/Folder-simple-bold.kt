...
public val BoldGroup.`Folder-simple-bold`: ImageVector
    get() {
        if (`_folder-simple-bold` != null) {
            return `_folder-simple-bold`!!
        }
        `_folder-simple-bold` = Builder(name = "Folder-simple-bold", defaultWidth = 256.0.dp,
...
private var `_folder-simple-bold`: ImageVector? = null
