...
public val BoldGroup.`Lectern-bold`: ImageVector
    get() {
        if (`_lectern-bold` != null) {
            return `_lectern-bold`!!
        }
        `_lectern-bold` = Builder(name = "Lectern-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lectern-bold`: ImageVector? = null
