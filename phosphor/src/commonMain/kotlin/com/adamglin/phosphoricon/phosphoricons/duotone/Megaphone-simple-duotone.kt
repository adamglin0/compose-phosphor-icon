...
public val DuotoneGroup.`Megaphone-simple-duotone`: ImageVector
    get() {
        if (`_megaphone-simple-duotone` != null) {
            return `_megaphone-simple-duotone`!!
        }
        `_megaphone-simple-duotone` = Builder(name = "Megaphone-simple-duotone", defaultWidth =
...
private var `_megaphone-simple-duotone`: ImageVector? = null
