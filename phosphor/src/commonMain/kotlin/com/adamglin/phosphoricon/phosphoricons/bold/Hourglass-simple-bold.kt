...
public val BoldGroup.`Hourglass-simple-bold`: ImageVector
    get() {
        if (`_hourglass-simple-bold` != null) {
            return `_hourglass-simple-bold`!!
        }
        `_hourglass-simple-bold` = Builder(name = "Hourglass-simple-bold", defaultWidth = 256.0.dp,
...
private var `_hourglass-simple-bold`: ImageVector? = null
