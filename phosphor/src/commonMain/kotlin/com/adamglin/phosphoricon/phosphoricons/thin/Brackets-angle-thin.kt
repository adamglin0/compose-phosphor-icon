...
public val ThinGroup.`Brackets-angle-thin`: ImageVector
    get() {
        if (`_brackets-angle-thin` != null) {
            return `_brackets-angle-thin`!!
        }
        `_brackets-angle-thin` = Builder(name = "Brackets-angle-thin", defaultWidth = 256.0.dp,
...
private var `_brackets-angle-thin`: ImageVector? = null
