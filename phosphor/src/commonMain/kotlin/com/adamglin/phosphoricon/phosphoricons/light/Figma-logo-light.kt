...
public val LightGroup.`Figma-logo-light`: ImageVector
    get() {
        if (`_figma-logo-light` != null) {
            return `_figma-logo-light`!!
        }
        `_figma-logo-light` = Builder(name = "Figma-logo-light", defaultWidth = 256.0.dp,
...
private var `_figma-logo-light`: ImageVector? = null
