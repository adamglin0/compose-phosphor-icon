...
public val DuotoneGroup.`Shield-duotone`: ImageVector
    get() {
        if (`_shield-duotone` != null) {
            return `_shield-duotone`!!
        }
        `_shield-duotone` = Builder(name = "Shield-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_shield-duotone`: ImageVector? = null
