...
public val BoldGroup.`Ny-times-logo-bold`: ImageVector
    get() {
        if (`_ny-times-logo-bold` != null) {
            return `_ny-times-logo-bold`!!
        }
        `_ny-times-logo-bold` = Builder(name = "Ny-times-logo-bold", defaultWidth = 256.0.dp,
...
private var `_ny-times-logo-bold`: ImageVector? = null
