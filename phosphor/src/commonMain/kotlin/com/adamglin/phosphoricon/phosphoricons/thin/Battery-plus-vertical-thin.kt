...
public val ThinGroup.`Battery-plus-vertical-thin`: ImageVector
    get() {
        if (`_battery-plus-vertical-thin` != null) {
            return `_battery-plus-vertical-thin`!!
        }
        `_battery-plus-vertical-thin` = Builder(name = "Battery-plus-vertical-thin", defaultWidth =
...
private var `_battery-plus-vertical-thin`: ImageVector? = null
