...
public val FillGroup.`Plugs-connected-fill`: ImageVector
    get() {
        if (`_plugs-connected-fill` != null) {
            return `_plugs-connected-fill`!!
        }
        `_plugs-connected-fill` = Builder(name = "Plugs-connected-fill", defaultWidth = 256.0.dp,
...
private var `_plugs-connected-fill`: ImageVector? = null
