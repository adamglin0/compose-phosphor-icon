...
public val LightGroup.`Caret-circle-double-up-light`: ImageVector
    get() {
        if (`_caret-circle-double-up-light` != null) {
            return `_caret-circle-double-up-light`!!
        }
        `_caret-circle-double-up-light` = Builder(name = "Caret-circle-double-up-light",
...
private var `_caret-circle-double-up-light`: ImageVector? = null
