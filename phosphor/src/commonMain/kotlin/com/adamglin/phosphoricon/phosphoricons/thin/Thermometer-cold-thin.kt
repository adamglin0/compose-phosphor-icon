...
public val ThinGroup.`Thermometer-cold-thin`: ImageVector
    get() {
        if (`_thermometer-cold-thin` != null) {
            return `_thermometer-cold-thin`!!
        }
        `_thermometer-cold-thin` = Builder(name = "Thermometer-cold-thin", defaultWidth = 256.0.dp,
...
private var `_thermometer-cold-thin`: ImageVector? = null
