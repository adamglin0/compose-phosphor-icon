...
public val ThinGroup.`Coin-thin`: ImageVector
    get() {
        if (`_coin-thin` != null) {
            return `_coin-thin`!!
        }
        `_coin-thin` = Builder(name = "Coin-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coin-thin`: ImageVector? = null
