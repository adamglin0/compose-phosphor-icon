...
public val BoldGroup.`File-ts-bold`: ImageVector
    get() {
        if (`_file-ts-bold` != null) {
            return `_file-ts-bold`!!
        }
        `_file-ts-bold` = Builder(name = "File-ts-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-ts-bold`: ImageVector? = null
