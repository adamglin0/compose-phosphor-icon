...
public val RegularGroup.`Arrow-bend-left-up`: ImageVector
    get() {
        if (`_arrow-bend-left-up` != null) {
            return `_arrow-bend-left-up`!!
        }
        `_arrow-bend-left-up` = Builder(name = "Arrow-bend-left-up", defaultWidth = 256.0.dp,
...
private var `_arrow-bend-left-up`: ImageVector? = null
