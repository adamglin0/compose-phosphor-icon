...
public val LightGroup.`Hourglass-low-light`: ImageVector
    get() {
        if (`_hourglass-low-light` != null) {
            return `_hourglass-low-light`!!
        }
        `_hourglass-low-light` = Builder(name = "Hourglass-low-light", defaultWidth = 256.0.dp,
...
private var `_hourglass-low-light`: ImageVector? = null
