...
public val DuotoneGroup.`Coin-duotone`: ImageVector
    get() {
        if (`_coin-duotone` != null) {
            return `_coin-duotone`!!
        }
        `_coin-duotone` = Builder(name = "Coin-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coin-duotone`: ImageVector? = null
