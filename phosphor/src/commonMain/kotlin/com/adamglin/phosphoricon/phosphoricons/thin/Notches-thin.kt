...
public val ThinGroup.`Notches-thin`: ImageVector
    get() {
        if (`_notches-thin` != null) {
            return `_notches-thin`!!
        }
        `_notches-thin` = Builder(name = "Notches-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_notches-thin`: ImageVector? = null
