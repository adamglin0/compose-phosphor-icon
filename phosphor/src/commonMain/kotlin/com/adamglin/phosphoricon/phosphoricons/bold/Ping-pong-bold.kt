...
public val BoldGroup.`Ping-pong-bold`: ImageVector
    get() {
        if (`_ping-pong-bold` != null) {
            return `_ping-pong-bold`!!
        }
        `_ping-pong-bold` = Builder(name = "Ping-pong-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_ping-pong-bold`: ImageVector? = null
