...
public val DuotoneGroup.`Lastfm-logo-duotone`: ImageVector
    get() {
        if (`_lastfm-logo-duotone` != null) {
            return `_lastfm-logo-duotone`!!
        }
        `_lastfm-logo-duotone` = Builder(name = "Lastfm-logo-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcTo(48.0f, 48.0f, 0.0f, false, true, 64.0f, 72.0f)
...
private var `_lastfm-logo-duotone`: ImageVector? = null
