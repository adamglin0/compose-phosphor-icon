...
public val DuotoneGroup.`Speaker-simple-high-duotone`: ImageVector
    get() {
        if (`_speaker-simple-high-duotone` != null) {
            return `_speaker-simple-high-duotone`!!
        }
        `_speaker-simple-high-duotone` = Builder(name = "Speaker-simple-high-duotone", defaultWidth
...
private var `_speaker-simple-high-duotone`: ImageVector? = null
