...
public val DuotoneGroup.`Chat-duotone`: ImageVector
    get() {
        if (`_chat-duotone` != null) {
            return `_chat-duotone`!!
        }
        `_chat-duotone` = Builder(name = "Chat-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chat-duotone`: ImageVector? = null
