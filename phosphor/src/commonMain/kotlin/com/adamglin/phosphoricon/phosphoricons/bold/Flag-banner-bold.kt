...
public val BoldGroup.`Flag-banner-bold`: ImageVector
    get() {
        if (`_flag-banner-bold` != null) {
            return `_flag-banner-bold`!!
        }
        `_flag-banner-bold` = Builder(name = "Flag-banner-bold", defaultWidth = 256.0.dp,
...
private var `_flag-banner-bold`: ImageVector? = null
