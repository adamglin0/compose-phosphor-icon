...
public val ThinGroup.`Tooth-thin`: ImageVector
    get() {
        if (`_tooth-thin` != null) {
            return `_tooth-thin`!!
        }
        `_tooth-thin` = Builder(name = "Tooth-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tooth-thin`: ImageVector? = null
