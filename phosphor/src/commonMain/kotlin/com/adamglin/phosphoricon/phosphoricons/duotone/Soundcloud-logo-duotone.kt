...
public val DuotoneGroup.`Soundcloud-logo-duotone`: ImageVector
    get() {
        if (`_soundcloud-logo-duotone` != null) {
            return `_soundcloud-logo-duotone`!!
        }
        `_soundcloud-logo-duotone` = Builder(name = "Soundcloud-logo-duotone", defaultWidth =
...
private var `_soundcloud-logo-duotone`: ImageVector? = null
