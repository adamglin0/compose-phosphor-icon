...
public val BoldGroup.`File-audio-bold`: ImageVector
    get() {
        if (`_file-audio-bold` != null) {
            return `_file-audio-bold`!!
        }
        `_file-audio-bold` = Builder(name = "File-audio-bold", defaultWidth = 256.0.dp,
...
private var `_file-audio-bold`: ImageVector? = null
