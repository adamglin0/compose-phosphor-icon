...
public val DuotoneGroup.`Stamp-duotone`: ImageVector
    get() {
        if (`_stamp-duotone` != null) {
            return `_stamp-duotone`!!
        }
        `_stamp-duotone` = Builder(name = "Stamp-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stamp-duotone`: ImageVector? = null
