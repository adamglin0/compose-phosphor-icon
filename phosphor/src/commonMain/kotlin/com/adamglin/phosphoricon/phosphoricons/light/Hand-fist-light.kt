...
public val LightGroup.`Hand-fist-light`: ImageVector
    get() {
        if (`_hand-fist-light` != null) {
            return `_hand-fist-light`!!
        }
        `_hand-fist-light` = Builder(name = "Hand-fist-light", defaultWidth = 256.0.dp,
...
private var `_hand-fist-light`: ImageVector? = null
