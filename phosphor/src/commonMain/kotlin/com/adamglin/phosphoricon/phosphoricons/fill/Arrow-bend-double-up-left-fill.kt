...
public val FillGroup.`Arrow-bend-double-up-left-fill`: ImageVector
    get() {
        if (`_arrow-bend-double-up-left-fill` != null) {
            return `_arrow-bend-double-up-left-fill`!!
        }
        `_arrow-bend-double-up-left-fill` = Builder(name = "Arrow-bend-double-up-left-fill",
...
private var `_arrow-bend-double-up-left-fill`: ImageVector? = null
