...
public val FillGroup.`Pen-nib-straight-fill`: ImageVector
    get() {
        if (`_pen-nib-straight-fill` != null) {
            return `_pen-nib-straight-fill`!!
        }
        `_pen-nib-straight-fill` = Builder(name = "Pen-nib-straight-fill", defaultWidth = 256.0.dp,
...
private var `_pen-nib-straight-fill`: ImageVector? = null
