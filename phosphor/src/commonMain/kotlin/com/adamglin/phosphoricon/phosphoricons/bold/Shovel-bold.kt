...
public val BoldGroup.`Shovel-bold`: ImageVector
    get() {
        if (`_shovel-bold` != null) {
            return `_shovel-bold`!!
        }
        `_shovel-bold` = Builder(name = "Shovel-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shovel-bold`: ImageVector? = null
