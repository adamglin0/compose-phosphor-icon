...
public val LightGroup.`Lightning-slash-light`: ImageVector
    get() {
        if (`_lightning-slash-light` != null) {
            return `_lightning-slash-light`!!
        }
        `_lightning-slash-light` = Builder(name = "Lightning-slash-light", defaultWidth = 256.0.dp,
...
private var `_lightning-slash-light`: ImageVector? = null
