...
public val ThinGroup.`Backspace-thin`: ImageVector
    get() {
        if (`_backspace-thin` != null) {
            return `_backspace-thin`!!
        }
        `_backspace-thin` = Builder(name = "Backspace-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_backspace-thin`: ImageVector? = null
