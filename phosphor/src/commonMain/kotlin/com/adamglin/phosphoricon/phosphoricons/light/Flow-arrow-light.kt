...
public val LightGroup.`Flow-arrow-light`: ImageVector
    get() {
        if (`_flow-arrow-light` != null) {
            return `_flow-arrow-light`!!
        }
        `_flow-arrow-light` = Builder(name = "Flow-arrow-light", defaultWidth = 256.0.dp,
...
private var `_flow-arrow-light`: ImageVector? = null
