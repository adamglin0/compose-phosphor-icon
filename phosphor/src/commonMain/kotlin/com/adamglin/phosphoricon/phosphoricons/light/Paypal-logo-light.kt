...
public val LightGroup.`Paypal-logo-light`: ImageVector
    get() {
        if (`_paypal-logo-light` != null) {
            return `_paypal-logo-light`!!
        }
        `_paypal-logo-light` = Builder(name = "Paypal-logo-light", defaultWidth = 256.0.dp,
...
private var `_paypal-logo-light`: ImageVector? = null
