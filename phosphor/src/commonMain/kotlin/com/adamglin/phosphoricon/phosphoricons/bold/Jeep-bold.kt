...
public val BoldGroup.`Jeep-bold`: ImageVector
    get() {
        if (`_jeep-bold` != null) {
            return `_jeep-bold`!!
        }
        `_jeep-bold` = Builder(name = "Jeep-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_jeep-bold`: ImageVector? = null
