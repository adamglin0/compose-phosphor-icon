...
public val DuotoneGroup.`Phone-transfer-duotone`: ImageVector
    get() {
        if (`_phone-transfer-duotone` != null) {
            return `_phone-transfer-duotone`!!
        }
        `_phone-transfer-duotone` = Builder(name = "Phone-transfer-duotone", defaultWidth =
                256.0.dp, defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight =
                256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                    = 0.2f, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(215.94f, 182.08f)
                arcTo(48.33f, 48.33f, 0.0f, false, true, 168.0f, 224.0f)
                arcTo(136.0f, 136.0f, 0.0f, false, true, 32.0f, 88.0f)
                arcTo(48.33f, 48.33f, 0.0f, false, true, 73.92f, 40.06f)
                ...
                arcTo(8.0f, 8.0f, 0.0f, false, true, 215.94f, 182.08f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(223.87f, 183.08f)
                arcTo(56.24f, 56.24f, 0.0f, false, true, 168.0f, 232.0f)
                curveTo(88.6f, 232.0f, 24.0f, 167.4f, 24.0f, 88.0f)
                arcTo(56.24f, 56.24f, 0.0f, false, true, 72.92f, 32.13f)
                ...
                arcTo(16.0f, 16.0f, 0.0f, false, true, 223.87f, 183.08f)
                close()
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -0.74f, 0.56f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, -15.75f, 1.14f)
                curveToRelative(-18.73f, -9.0f, -37.4f, -27.58f, -46.46f, -46.11f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, 1.0f, -15.7f)
                arcToRelative(7.0f, 7.0f, 0.0f, false, true, 0.57f, -0.77f)
                lineTo(96.0f, 95.15f)
...
private var `_phone-transfer-duotone`: ImageVector? = null
