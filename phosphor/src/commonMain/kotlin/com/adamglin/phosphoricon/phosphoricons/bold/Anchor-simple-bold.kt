...
public val BoldGroup.`Anchor-simple-bold`: ImageVector
    get() {
        if (`_anchor-simple-bold` != null) {
            return `_anchor-simple-bold`!!
        }
        `_anchor-simple-bold` = Builder(name = "Anchor-simple-bold", defaultWidth = 256.0.dp,
...
private var `_anchor-simple-bold`: ImageVector? = null
