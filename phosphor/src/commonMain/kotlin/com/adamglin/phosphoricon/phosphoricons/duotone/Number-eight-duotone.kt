...
public val DuotoneGroup.`Number-eight-duotone`: ImageVector
    get() {
        if (`_number-eight-duotone` != null) {
            return `_number-eight-duotone`!!
        }
        `_number-eight-duotone` = Builder(name = "Number-eight-duotone", defaultWidth = 256.0.dp,
...
private var `_number-eight-duotone`: ImageVector? = null
