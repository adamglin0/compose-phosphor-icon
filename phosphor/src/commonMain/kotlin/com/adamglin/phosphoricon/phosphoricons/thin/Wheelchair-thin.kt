...
public val ThinGroup.`Wheelchair-thin`: ImageVector
    get() {
        if (`_wheelchair-thin` != null) {
            return `_wheelchair-thin`!!
        }
        `_wheelchair-thin` = Builder(name = "Wheelchair-thin", defaultWidth = 256.0.dp,
...
private var `_wheelchair-thin`: ImageVector? = null
