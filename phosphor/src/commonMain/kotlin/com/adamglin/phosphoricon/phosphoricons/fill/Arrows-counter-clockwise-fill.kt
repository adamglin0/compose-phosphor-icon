...
public val FillGroup.`Arrows-counter-clockwise-fill`: ImageVector
    get() {
        if (`_arrows-counter-clockwise-fill` != null) {
            return `_arrows-counter-clockwise-fill`!!
        }
        `_arrows-counter-clockwise-fill` = Builder(name = "Arrows-counter-clockwise-fill",
...
private var `_arrows-counter-clockwise-fill`: ImageVector? = null
