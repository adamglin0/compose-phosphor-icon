...
public val BoldGroup.`Rainbow-bold`: ImageVector
    get() {
        if (`_rainbow-bold` != null) {
            return `_rainbow-bold`!!
        }
        `_rainbow-bold` = Builder(name = "Rainbow-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rainbow-bold`: ImageVector? = null
