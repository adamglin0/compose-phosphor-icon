...
public val ThinGroup.`Text-columns-thin`: ImageVector
    get() {
        if (`_text-columns-thin` != null) {
            return `_text-columns-thin`!!
        }
        `_text-columns-thin` = Builder(name = "Text-columns-thin", defaultWidth = 256.0.dp,
...
private var `_text-columns-thin`: ImageVector? = null
