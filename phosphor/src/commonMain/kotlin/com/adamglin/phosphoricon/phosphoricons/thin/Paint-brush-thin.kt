...
public val ThinGroup.`Paint-brush-thin`: ImageVector
    get() {
        if (`_paint-brush-thin` != null) {
            return `_paint-brush-thin`!!
        }
        `_paint-brush-thin` = Builder(name = "Paint-brush-thin", defaultWidth = 256.0.dp,
...
private var `_paint-brush-thin`: ImageVector? = null
