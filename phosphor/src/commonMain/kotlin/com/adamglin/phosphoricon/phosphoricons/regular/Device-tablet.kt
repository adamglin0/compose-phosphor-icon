...
public val RegularGroup.`Device-tablet`: ImageVector
    get() {
        if (`_device-tablet` != null) {
            return `_device-tablet`!!
        }
        `_device-tablet` = Builder(name = "Device-tablet", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_device-tablet`: ImageVector? = null
