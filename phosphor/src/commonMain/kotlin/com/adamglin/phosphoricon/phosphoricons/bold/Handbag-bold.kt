...
public val BoldGroup.`Handbag-bold`: ImageVector
    get() {
        if (`_handbag-bold` != null) {
            return `_handbag-bold`!!
        }
        `_handbag-bold` = Builder(name = "Handbag-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_handbag-bold`: ImageVector? = null
