...
public val LightGroup.`Microscope-light`: ImageVector
    get() {
        if (`_microscope-light` != null) {
            return `_microscope-light`!!
        }
        `_microscope-light` = Builder(name = "Microscope-light", defaultWidth = 256.0.dp,
...
private var `_microscope-light`: ImageVector? = null
