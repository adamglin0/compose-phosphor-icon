...
public val FillGroup.`Pinwheel-fill`: ImageVector
    get() {
        if (`_pinwheel-fill` != null) {
            return `_pinwheel-fill`!!
        }
        `_pinwheel-fill` = Builder(name = "Pinwheel-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pinwheel-fill`: ImageVector? = null
