...
public val DuotoneGroup.`Signpost-duotone`: ImageVector
    get() {
        if (`_signpost-duotone` != null) {
            return `_signpost-duotone`!!
        }
        `_signpost-duotone` = Builder(name = "Signpost-duotone", defaultWidth = 256.0.dp,
...
private var `_signpost-duotone`: ImageVector? = null
