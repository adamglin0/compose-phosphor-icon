...
public val BoldGroup.`Whatsapp-logo-bold`: ImageVector
    get() {
        if (`_whatsapp-logo-bold` != null) {
            return `_whatsapp-logo-bold`!!
        }
        `_whatsapp-logo-bold` = Builder(name = "Whatsapp-logo-bold", defaultWidth = 256.0.dp,
...
private var `_whatsapp-logo-bold`: ImageVector? = null
