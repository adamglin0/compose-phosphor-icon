...
public val LightGroup.`List-numbers-light`: ImageVector
    get() {
        if (`_list-numbers-light` != null) {
            return `_list-numbers-light`!!
        }
        `_list-numbers-light` = Builder(name = "List-numbers-light", defaultWidth = 256.0.dp,
...
private var `_list-numbers-light`: ImageVector? = null
