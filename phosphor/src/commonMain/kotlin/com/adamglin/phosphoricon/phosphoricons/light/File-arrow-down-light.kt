...
public val LightGroup.`File-arrow-down-light`: ImageVector
    get() {
        if (`_file-arrow-down-light` != null) {
            return `_file-arrow-down-light`!!
        }
        `_file-arrow-down-light` = Builder(name = "File-arrow-down-light", defaultWidth = 256.0.dp,
...
private var `_file-arrow-down-light`: ImageVector? = null
