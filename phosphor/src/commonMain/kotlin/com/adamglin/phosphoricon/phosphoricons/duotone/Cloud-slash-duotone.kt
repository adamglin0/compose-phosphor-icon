...
public val DuotoneGroup.`Cloud-slash-duotone`: ImageVector
    get() {
        if (`_cloud-slash-duotone` != null) {
            return `_cloud-slash-duotone`!!
        }
        `_cloud-slash-duotone` = Builder(name = "Cloud-slash-duotone", defaultWidth = 256.0.dp,
...
private var `_cloud-slash-duotone`: ImageVector? = null
