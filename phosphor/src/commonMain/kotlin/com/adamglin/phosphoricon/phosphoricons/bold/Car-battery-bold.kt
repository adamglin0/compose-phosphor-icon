...
public val BoldGroup.`Car-battery-bold`: ImageVector
    get() {
        if (`_car-battery-bold` != null) {
            return `_car-battery-bold`!!
        }
        `_car-battery-bold` = Builder(name = "Car-battery-bold", defaultWidth = 256.0.dp,
...
private var `_car-battery-bold`: ImageVector? = null
