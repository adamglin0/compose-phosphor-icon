...
public val RegularGroup.`Git-fork`: ImageVector
    get() {
        if (`_git-fork` != null) {
            return `_git-fork`!!
        }
        `_git-fork` = Builder(name = "Git-fork", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_git-fork`: ImageVector? = null
