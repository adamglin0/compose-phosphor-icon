...
public val LightGroup.`Sliders-light`: ImageVector
    get() {
        if (`_sliders-light` != null) {
            return `_sliders-light`!!
        }
        `_sliders-light` = Builder(name = "Sliders-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sliders-light`: ImageVector? = null
