...
public val ThinGroup.`Megaphone-simple-thin`: ImageVector
    get() {
        if (`_megaphone-simple-thin` != null) {
            return `_megaphone-simple-thin`!!
        }
        `_megaphone-simple-thin` = Builder(name = "Megaphone-simple-thin", defaultWidth = 256.0.dp,
...
private var `_megaphone-simple-thin`: ImageVector? = null
