...
public val LightGroup.`Contactless-payment-light`: ImageVector
    get() {
        if (`_contactless-payment-light` != null) {
            return `_contactless-payment-light`!!
        }
        `_contactless-payment-light` = Builder(name = "Contactless-payment-light", defaultWidth =
...
private var `_contactless-payment-light`: ImageVector? = null
