...
public val ThinGroup.`Lightbulb-thin`: ImageVector
    get() {
        if (`_lightbulb-thin` != null) {
            return `_lightbulb-thin`!!
        }
        `_lightbulb-thin` = Builder(name = "Lightbulb-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_lightbulb-thin`: ImageVector? = null
