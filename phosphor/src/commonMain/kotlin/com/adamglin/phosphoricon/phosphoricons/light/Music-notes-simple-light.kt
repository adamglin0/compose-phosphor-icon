...
public val LightGroup.`Music-notes-simple-light`: ImageVector
    get() {
        if (`_music-notes-simple-light` != null) {
            return `_music-notes-simple-light`!!
        }
        `_music-notes-simple-light` = Builder(name = "Music-notes-simple-light", defaultWidth =
...
private var `_music-notes-simple-light`: ImageVector? = null
