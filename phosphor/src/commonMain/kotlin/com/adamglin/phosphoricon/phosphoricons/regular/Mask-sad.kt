...
public val RegularGroup.`Mask-sad`: ImageVector
    get() {
        if (`_mask-sad` != null) {
            return `_mask-sad`!!
        }
        `_mask-sad` = Builder(name = "Mask-sad", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_mask-sad`: ImageVector? = null
