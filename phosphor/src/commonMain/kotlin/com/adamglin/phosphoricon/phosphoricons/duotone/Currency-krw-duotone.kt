...
public val DuotoneGroup.`Currency-krw-duotone`: ImageVector
    get() {
        if (`_currency-krw-duotone` != null) {
            return `_currency-krw-duotone`!!
        }
        `_currency-krw-duotone` = Builder(name = "Currency-krw-duotone", defaultWidth = 256.0.dp,
...
private var `_currency-krw-duotone`: ImageVector? = null
