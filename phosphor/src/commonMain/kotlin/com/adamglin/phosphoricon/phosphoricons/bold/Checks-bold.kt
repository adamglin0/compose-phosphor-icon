...
public val BoldGroup.`Checks-bold`: ImageVector
    get() {
        if (`_checks-bold` != null) {
            return `_checks-bold`!!
        }
        `_checks-bold` = Builder(name = "Checks-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_checks-bold`: ImageVector? = null
