...
public val DuotoneGroup.`Stack-overflow-logo-duotone`: ImageVector
    get() {
        if (`_stack-overflow-logo-duotone` != null) {
            return `_stack-overflow-logo-duotone`!!
        }
        `_stack-overflow-logo-duotone` = Builder(name = "Stack-overflow-logo-duotone", defaultWidth
...
private var `_stack-overflow-logo-duotone`: ImageVector? = null
