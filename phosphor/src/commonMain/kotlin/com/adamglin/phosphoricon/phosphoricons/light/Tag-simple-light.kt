...
public val LightGroup.`Tag-simple-light`: ImageVector
    get() {
        if (`_tag-simple-light` != null) {
            return `_tag-simple-light`!!
        }
        `_tag-simple-light` = Builder(name = "Tag-simple-light", defaultWidth = 256.0.dp,
...
private var `_tag-simple-light`: ImageVector? = null
