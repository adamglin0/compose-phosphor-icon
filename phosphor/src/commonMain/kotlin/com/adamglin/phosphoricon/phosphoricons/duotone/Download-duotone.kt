...
public val DuotoneGroup.`Download-duotone`: ImageVector
    get() {
        if (`_download-duotone` != null) {
            return `_download-duotone`!!
        }
        `_download-duotone` = Builder(name = "Download-duotone", defaultWidth = 256.0.dp,
...
private var `_download-duotone`: ImageVector? = null
