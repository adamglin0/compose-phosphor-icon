...
public val LightGroup.`Grains-light`: ImageVector
    get() {
        if (`_grains-light` != null) {
            return `_grains-light`!!
        }
        `_grains-light` = Builder(name = "Grains-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_grains-light`: ImageVector? = null
