...
public val DuotoneGroup.`Percent-duotone`: ImageVector
    get() {
        if (`_percent-duotone` != null) {
            return `_percent-duotone`!!
        }
        `_percent-duotone` = Builder(name = "Percent-duotone", defaultWidth = 256.0.dp,
...
private var `_percent-duotone`: ImageVector? = null
