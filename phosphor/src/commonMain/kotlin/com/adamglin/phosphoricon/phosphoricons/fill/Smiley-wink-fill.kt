...
public val FillGroup.`Smiley-wink-fill`: ImageVector
    get() {
        if (`_smiley-wink-fill` != null) {
            return `_smiley-wink-fill`!!
        }
        `_smiley-wink-fill` = Builder(name = "Smiley-wink-fill", defaultWidth = 256.0.dp,
...
private var `_smiley-wink-fill`: ImageVector? = null
