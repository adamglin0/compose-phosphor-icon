...
public val LightGroup.`Baby-light`: ImageVector
    get() {
        if (`_baby-light` != null) {
            return `_baby-light`!!
        }
        `_baby-light` = Builder(name = "Baby-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_baby-light`: ImageVector? = null
