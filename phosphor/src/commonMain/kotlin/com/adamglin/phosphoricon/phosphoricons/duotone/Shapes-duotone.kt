...
public val DuotoneGroup.`Shapes-duotone`: ImageVector
    get() {
        if (`_shapes-duotone` != null) {
            return `_shapes-duotone`!!
        }
        `_shapes-duotone` = Builder(name = "Shapes-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_shapes-duotone`: ImageVector? = null
