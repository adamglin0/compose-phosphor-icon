...
public val ThinGroup.`Mouse-scroll-thin`: ImageVector
    get() {
        if (`_mouse-scroll-thin` != null) {
            return `_mouse-scroll-thin`!!
        }
        `_mouse-scroll-thin` = Builder(name = "Mouse-scroll-thin", defaultWidth = 256.0.dp,
...
private var `_mouse-scroll-thin`: ImageVector? = null
