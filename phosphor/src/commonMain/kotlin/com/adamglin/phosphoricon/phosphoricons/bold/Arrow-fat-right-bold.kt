...
public val BoldGroup.`Arrow-fat-right-bold`: ImageVector
    get() {
        if (`_arrow-fat-right-bold` != null) {
            return `_arrow-fat-right-bold`!!
        }
        `_arrow-fat-right-bold` = Builder(name = "Arrow-fat-right-bold", defaultWidth = 256.0.dp,
...
private var `_arrow-fat-right-bold`: ImageVector? = null
