...
public val LightGroup.`Notebook-light`: ImageVector
    get() {
        if (`_notebook-light` != null) {
            return `_notebook-light`!!
        }
        `_notebook-light` = Builder(name = "Notebook-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_notebook-light`: ImageVector? = null
