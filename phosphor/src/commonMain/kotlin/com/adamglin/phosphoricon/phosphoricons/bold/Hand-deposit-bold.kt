...
public val BoldGroup.`Hand-deposit-bold`: ImageVector
    get() {
        if (`_hand-deposit-bold` != null) {
            return `_hand-deposit-bold`!!
        }
        `_hand-deposit-bold` = Builder(name = "Hand-deposit-bold", defaultWidth = 256.0.dp,
...
private var `_hand-deposit-bold`: ImageVector? = null
