...
public val LightGroup.`Funnel-x-light`: ImageVector
    get() {
        if (`_funnel-x-light` != null) {
            return `_funnel-x-light`!!
        }
        `_funnel-x-light` = Builder(name = "Funnel-x-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_funnel-x-light`: ImageVector? = null
