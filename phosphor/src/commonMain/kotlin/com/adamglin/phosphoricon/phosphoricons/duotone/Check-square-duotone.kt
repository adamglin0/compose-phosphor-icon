...
public val DuotoneGroup.`Check-square-duotone`: ImageVector
    get() {
        if (`_check-square-duotone` != null) {
            return `_check-square-duotone`!!
        }
        `_check-square-duotone` = Builder(name = "Check-square-duotone", defaultWidth = 256.0.dp,
...
private var `_check-square-duotone`: ImageVector? = null
