...
public val BoldGroup.`Webcam-bold`: ImageVector
    get() {
        if (`_webcam-bold` != null) {
            return `_webcam-bold`!!
        }
        `_webcam-bold` = Builder(name = "Webcam-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_webcam-bold`: ImageVector? = null
