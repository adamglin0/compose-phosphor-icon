...
public val LightGroup.`Folders-light`: ImageVector
    get() {
        if (`_folders-light` != null) {
            return `_folders-light`!!
        }
        `_folders-light` = Builder(name = "Folders-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folders-light`: ImageVector? = null
