...
public val FillGroup.`Stack-minus-fill`: ImageVector
    get() {
        if (`_stack-minus-fill` != null) {
            return `_stack-minus-fill`!!
        }
        `_stack-minus-fill` = Builder(name = "Stack-minus-fill", defaultWidth = 256.0.dp,
...
private var `_stack-minus-fill`: ImageVector? = null
