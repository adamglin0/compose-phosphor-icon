...
public val BoldGroup.`Mailbox-bold`: ImageVector
    get() {
        if (`_mailbox-bold` != null) {
            return `_mailbox-bold`!!
        }
        `_mailbox-bold` = Builder(name = "Mailbox-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mailbox-bold`: ImageVector? = null
