...
public val DuotoneGroup.`Monitor-duotone`: ImageVector
    get() {
        if (`_monitor-duotone` != null) {
            return `_monitor-duotone`!!
        }
        `_monitor-duotone` = Builder(name = "Monitor-duotone", defaultWidth = 256.0.dp,
...
private var `_monitor-duotone`: ImageVector? = null
