...
public val BoldGroup.`Eraser-bold`: ImageVector
    get() {
        if (`_eraser-bold` != null) {
            return `_eraser-bold`!!
        }
        `_eraser-bold` = Builder(name = "Eraser-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eraser-bold`: ImageVector? = null
