...
public val ThinGroup.`Thumbs-up-thin`: ImageVector
    get() {
        if (`_thumbs-up-thin` != null) {
            return `_thumbs-up-thin`!!
        }
        `_thumbs-up-thin` = Builder(name = "Thumbs-up-thin", defaultWidth = 256.0.dp, defaultHeight
...
private var `_thumbs-up-thin`: ImageVector? = null
