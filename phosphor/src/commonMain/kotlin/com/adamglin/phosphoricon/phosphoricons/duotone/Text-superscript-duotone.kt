...
public val DuotoneGroup.`Text-superscript-duotone`: ImageVector
    get() {
        if (`_text-superscript-duotone` != null) {
            return `_text-superscript-duotone`!!
        }
        `_text-superscript-duotone` = Builder(name = "Text-superscript-duotone", defaultWidth =
...
private var `_text-superscript-duotone`: ImageVector? = null
