...
public val LightGroup.`Pizza-light`: ImageVector
    get() {
        if (`_pizza-light` != null) {
            return `_pizza-light`!!
        }
        `_pizza-light` = Builder(name = "Pizza-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pizza-light`: ImageVector? = null
