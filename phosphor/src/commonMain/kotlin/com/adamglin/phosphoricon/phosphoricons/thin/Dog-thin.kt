...
public val ThinGroup.`Dog-thin`: ImageVector
    get() {
        if (`_dog-thin` != null) {
            return `_dog-thin`!!
        }
        `_dog-thin` = Builder(name = "Dog-thin", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dog-thin`: ImageVector? = null
