...
public val BoldGroup.`Arrows-merge-bold`: ImageVector
    get() {
        if (`_arrows-merge-bold` != null) {
            return `_arrows-merge-bold`!!
        }
        `_arrows-merge-bold` = Builder(name = "Arrows-merge-bold", defaultWidth = 256.0.dp,
...
private var `_arrows-merge-bold`: ImageVector? = null
