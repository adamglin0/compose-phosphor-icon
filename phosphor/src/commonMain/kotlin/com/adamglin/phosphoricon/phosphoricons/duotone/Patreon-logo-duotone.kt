...
public val DuotoneGroup.`Patreon-logo-duotone`: ImageVector
    get() {
        if (`_patreon-logo-duotone` != null) {
            return `_patreon-logo-duotone`!!
        }
        `_patreon-logo-duotone` = Builder(name = "Patreon-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_patreon-logo-duotone`: ImageVector? = null
