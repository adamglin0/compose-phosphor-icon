...
public val BoldGroup.`Sunglasses-bold`: ImageVector
    get() {
        if (`_sunglasses-bold` != null) {
            return `_sunglasses-bold`!!
        }
        `_sunglasses-bold` = Builder(name = "Sunglasses-bold", defaultWidth = 256.0.dp,
...
private var `_sunglasses-bold`: ImageVector? = null
