...
public val LightGroup.`Bathtub-light`: ImageVector
    get() {
        if (`_bathtub-light` != null) {
            return `_bathtub-light`!!
        }
        `_bathtub-light` = Builder(name = "Bathtub-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bathtub-light`: ImageVector? = null
