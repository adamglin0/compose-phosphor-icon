...
public val ThinGroup.`Invoice-thin`: ImageVector
    get() {
        if (`_invoice-thin` != null) {
            return `_invoice-thin`!!
        }
        `_invoice-thin` = Builder(name = "Invoice-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_invoice-thin`: ImageVector? = null
