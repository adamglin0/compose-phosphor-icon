...
public val LightGroup.`Bomb-light`: ImageVector
    get() {
        if (`_bomb-light` != null) {
            return `_bomb-light`!!
        }
        `_bomb-light` = Builder(name = "Bomb-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bomb-light`: ImageVector? = null
