...
public val BoldGroup.`Tray-bold`: ImageVector
    get() {
        if (`_tray-bold` != null) {
            return `_tray-bold`!!
        }
        `_tray-bold` = Builder(name = "Tray-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tray-bold`: ImageVector? = null
