...
public val LightGroup.`Shield-chevron-light`: ImageVector
    get() {
        if (`_shield-chevron-light` != null) {
            return `_shield-chevron-light`!!
        }
        `_shield-chevron-light` = Builder(name = "Shield-chevron-light", defaultWidth = 256.0.dp,
...
private var `_shield-chevron-light`: ImageVector? = null
