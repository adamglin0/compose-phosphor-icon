...
public val BoldGroup.`Number-three-bold`: ImageVector
    get() {
        if (`_number-three-bold` != null) {
            return `_number-three-bold`!!
        }
        `_number-three-bold` = Builder(name = "Number-three-bold", defaultWidth = 256.0.dp,
...
private var `_number-three-bold`: ImageVector? = null
