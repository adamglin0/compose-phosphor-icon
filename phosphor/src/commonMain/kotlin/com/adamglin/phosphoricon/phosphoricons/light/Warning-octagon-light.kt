...
public val LightGroup.`Warning-octagon-light`: ImageVector
    get() {
        if (`_warning-octagon-light` != null) {
            return `_warning-octagon-light`!!
        }
        `_warning-octagon-light` = Builder(name = "Warning-octagon-light", defaultWidth = 256.0.dp,
...
private var `_warning-octagon-light`: ImageVector? = null
