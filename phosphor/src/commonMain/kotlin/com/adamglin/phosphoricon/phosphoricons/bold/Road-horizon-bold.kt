...
public val BoldGroup.`Road-horizon-bold`: ImageVector
    get() {
        if (`_road-horizon-bold` != null) {
            return `_road-horizon-bold`!!
        }
        `_road-horizon-bold` = Builder(name = "Road-horizon-bold", defaultWidth = 256.0.dp,
...
private var `_road-horizon-bold`: ImageVector? = null
