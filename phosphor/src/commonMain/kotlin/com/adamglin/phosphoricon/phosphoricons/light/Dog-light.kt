...
public val LightGroup.`Dog-light`: ImageVector
    get() {
        if (`_dog-light` != null) {
            return `_dog-light`!!
        }
        `_dog-light` = Builder(name = "Dog-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dog-light`: ImageVector? = null
