...
public val DuotoneGroup.`Arrow-u-up-right-duotone`: ImageVector
    get() {
        if (`_arrow-u-up-right-duotone` != null) {
            return `_arrow-u-up-right-duotone`!!
        }
        `_arrow-u-up-right-duotone` = Builder(name = "Arrow-u-up-right-duotone", defaultWidth =
...
private var `_arrow-u-up-right-duotone`: ImageVector? = null
