...
public val LightGroup.`Paperclip-light`: ImageVector
    get() {
        if (`_paperclip-light` != null) {
            return `_paperclip-light`!!
        }
        `_paperclip-light` = Builder(name = "Paperclip-light", defaultWidth = 256.0.dp,
...
private var `_paperclip-light`: ImageVector? = null
