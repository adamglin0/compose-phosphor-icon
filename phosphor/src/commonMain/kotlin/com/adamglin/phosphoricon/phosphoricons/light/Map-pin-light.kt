...
public val LightGroup.`Map-pin-light`: ImageVector
    get() {
        if (`_map-pin-light` != null) {
            return `_map-pin-light`!!
        }
        `_map-pin-light` = Builder(name = "Map-pin-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_map-pin-light`: ImageVector? = null
