...
public val DuotoneGroup.`Folder-star-duotone`: ImageVector
    get() {
        if (`_folder-star-duotone` != null) {
            return `_folder-star-duotone`!!
        }
        `_folder-star-duotone` = Builder(name = "Folder-star-duotone", defaultWidth = 256.0.dp,
...
private var `_folder-star-duotone`: ImageVector? = null
