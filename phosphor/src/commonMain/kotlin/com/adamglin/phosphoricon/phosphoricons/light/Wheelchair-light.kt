...
public val LightGroup.`Wheelchair-light`: ImageVector
    get() {
        if (`_wheelchair-light` != null) {
            return `_wheelchair-light`!!
        }
        `_wheelchair-light` = Builder(name = "Wheelchair-light", defaultWidth = 256.0.dp,
...
private var `_wheelchair-light`: ImageVector? = null
