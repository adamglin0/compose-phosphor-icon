...
public val ThinGroup.`Shield-warning-thin`: ImageVector
    get() {
        if (`_shield-warning-thin` != null) {
            return `_shield-warning-thin`!!
        }
        `_shield-warning-thin` = Builder(name = "Shield-warning-thin", defaultWidth = 256.0.dp,
...
private var `_shield-warning-thin`: ImageVector? = null
