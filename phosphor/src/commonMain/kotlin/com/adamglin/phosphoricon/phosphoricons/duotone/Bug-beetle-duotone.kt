...
public val DuotoneGroup.`Bug-beetle-duotone`: ImageVector
    get() {
        if (`_bug-beetle-duotone` != null) {
            return `_bug-beetle-duotone`!!
        }
        `_bug-beetle-duotone` = Builder(name = "Bug-beetle-duotone", defaultWidth = 256.0.dp,
...
private var `_bug-beetle-duotone`: ImageVector? = null
