...
public val DuotoneGroup.`Escalator-up-duotone`: ImageVector
    get() {
        if (`_escalator-up-duotone` != null) {
            return `_escalator-up-duotone`!!
        }
        `_escalator-up-duotone` = Builder(name = "Escalator-up-duotone", defaultWidth = 256.0.dp,
...
private var `_escalator-up-duotone`: ImageVector? = null
