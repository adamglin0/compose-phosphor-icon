...
public val RegularGroup.`Magnifying-glass-plus`: ImageVector
    get() {
        if (`_magnifying-glass-plus` != null) {
            return `_magnifying-glass-plus`!!
        }
        `_magnifying-glass-plus` = Builder(name = "Magnifying-glass-plus", defaultWidth = 256.0.dp,
...
private var `_magnifying-glass-plus`: ImageVector? = null
