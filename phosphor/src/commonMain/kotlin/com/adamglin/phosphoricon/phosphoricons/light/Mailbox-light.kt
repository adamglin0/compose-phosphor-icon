...
public val LightGroup.`Mailbox-light`: ImageVector
    get() {
        if (`_mailbox-light` != null) {
            return `_mailbox-light`!!
        }
        `_mailbox-light` = Builder(name = "Mailbox-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mailbox-light`: ImageVector? = null
