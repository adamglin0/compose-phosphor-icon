...
public val BoldGroup.`Chair-bold`: ImageVector
    get() {
        if (`_chair-bold` != null) {
            return `_chair-bold`!!
        }
        `_chair-bold` = Builder(name = "Chair-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chair-bold`: ImageVector? = null
