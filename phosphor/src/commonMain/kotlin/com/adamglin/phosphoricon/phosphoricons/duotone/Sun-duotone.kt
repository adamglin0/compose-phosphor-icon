...
public val DuotoneGroup.`Sun-duotone`: ImageVector
    get() {
        if (`_sun-duotone` != null) {
            return `_sun-duotone`!!
        }
        `_sun-duotone` = Builder(name = "Sun-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sun-duotone`: ImageVector? = null
