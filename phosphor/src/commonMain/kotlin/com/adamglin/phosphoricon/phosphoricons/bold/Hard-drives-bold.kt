...
public val BoldGroup.`Hard-drives-bold`: ImageVector
    get() {
        if (`_hard-drives-bold` != null) {
            return `_hard-drives-bold`!!
        }
        `_hard-drives-bold` = Builder(name = "Hard-drives-bold", defaultWidth = 256.0.dp,
...
private var `_hard-drives-bold`: ImageVector? = null
