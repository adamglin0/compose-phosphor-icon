...
public val ThinGroup.`File-minus-thin`: ImageVector
    get() {
        if (`_file-minus-thin` != null) {
            return `_file-minus-thin`!!
        }
        `_file-minus-thin` = Builder(name = "File-minus-thin", defaultWidth = 256.0.dp,
...
private var `_file-minus-thin`: ImageVector? = null
