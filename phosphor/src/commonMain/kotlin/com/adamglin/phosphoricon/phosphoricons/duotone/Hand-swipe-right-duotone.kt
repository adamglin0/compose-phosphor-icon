...
public val DuotoneGroup.`Hand-swipe-right-duotone`: ImageVector
    get() {
        if (`_hand-swipe-right-duotone` != null) {
            return `_hand-swipe-right-duotone`!!
        }
        `_hand-swipe-right-duotone` = Builder(name = "Hand-swipe-right-duotone", defaultWidth =
...
private var `_hand-swipe-right-duotone`: ImageVector? = null
