...
public val BoldGroup.`Flask-bold`: ImageVector
    get() {
        if (`_flask-bold` != null) {
            return `_flask-bold`!!
        }
        `_flask-bold` = Builder(name = "Flask-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flask-bold`: ImageVector? = null
