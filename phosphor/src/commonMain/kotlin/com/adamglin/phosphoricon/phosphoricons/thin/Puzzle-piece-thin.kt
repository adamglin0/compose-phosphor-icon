...
public val ThinGroup.`Puzzle-piece-thin`: ImageVector
    get() {
        if (`_puzzle-piece-thin` != null) {
            return `_puzzle-piece-thin`!!
        }
        `_puzzle-piece-thin` = Builder(name = "Puzzle-piece-thin", defaultWidth = 256.0.dp,
...
private var `_puzzle-piece-thin`: ImageVector? = null
