...
public val BoldGroup.`Text-h-one-bold`: ImageVector
    get() {
        if (`_text-h-one-bold` != null) {
            return `_text-h-one-bold`!!
        }
        `_text-h-one-bold` = Builder(name = "Text-h-one-bold", defaultWidth = 256.0.dp,
...
private var `_text-h-one-bold`: ImageVector? = null
