...
public val DuotoneGroup.`Garage-duotone`: ImageVector
    get() {
        if (`_garage-duotone` != null) {
            return `_garage-duotone`!!
        }
        `_garage-duotone` = Builder(name = "Garage-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_garage-duotone`: ImageVector? = null
