...
public val LightGroup.`Arrow-fat-down-light`: ImageVector
    get() {
        if (`_arrow-fat-down-light` != null) {
            return `_arrow-fat-down-light`!!
        }
        `_arrow-fat-down-light` = Builder(name = "Arrow-fat-down-light", defaultWidth = 256.0.dp,
...
private var `_arrow-fat-down-light`: ImageVector? = null
