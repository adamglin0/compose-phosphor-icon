...
public val ThinGroup.`Cherries-thin`: ImageVector
    get() {
        if (`_cherries-thin` != null) {
            return `_cherries-thin`!!
        }
        `_cherries-thin` = Builder(name = "Cherries-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cherries-thin`: ImageVector? = null
