...
public val DuotoneGroup.`Stack-plus-duotone`: ImageVector
    get() {
        if (`_stack-plus-duotone` != null) {
            return `_stack-plus-duotone`!!
        }
        `_stack-plus-duotone` = Builder(name = "Stack-plus-duotone", defaultWidth = 256.0.dp,
...
private var `_stack-plus-duotone`: ImageVector? = null
