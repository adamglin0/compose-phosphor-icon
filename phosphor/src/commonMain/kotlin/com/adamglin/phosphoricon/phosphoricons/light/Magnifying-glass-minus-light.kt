...
public val LightGroup.`Magnifying-glass-minus-light`: ImageVector
    get() {
        if (`_magnifying-glass-minus-light` != null) {
            return `_magnifying-glass-minus-light`!!
        }
        `_magnifying-glass-minus-light` = Builder(name = "Magnifying-glass-minus-light",
...
private var `_magnifying-glass-minus-light`: ImageVector? = null
