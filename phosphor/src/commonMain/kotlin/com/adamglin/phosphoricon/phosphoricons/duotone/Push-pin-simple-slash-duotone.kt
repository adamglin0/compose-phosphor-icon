...
public val DuotoneGroup.`Push-pin-simple-slash-duotone`: ImageVector
    get() {
        if (`_push-pin-simple-slash-duotone` != null) {
            return `_push-pin-simple-slash-duotone`!!
        }
        `_push-pin-simple-slash-duotone` = Builder(name = "Push-pin-simple-slash-duotone",
...
private var `_push-pin-simple-slash-duotone`: ImageVector? = null
