...
public val BoldGroup.`Circles-three-bold`: ImageVector
    get() {
        if (`_circles-three-bold` != null) {
            return `_circles-three-bold`!!
        }
        `_circles-three-bold` = Builder(name = "Circles-three-bold", defaultWidth = 256.0.dp,
...
private var `_circles-three-bold`: ImageVector? = null
