...
public val LightGroup.`Wifi-low-light`: ImageVector
    get() {
        if (`_wifi-low-light` != null) {
            return `_wifi-low-light`!!
        }
        `_wifi-low-light` = Builder(name = "Wifi-low-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_wifi-low-light`: ImageVector? = null
