...
public val DuotoneGroup.`Tooth-duotone`: ImageVector
    get() {
        if (`_tooth-duotone` != null) {
            return `_tooth-duotone`!!
        }
        `_tooth-duotone` = Builder(name = "Tooth-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tooth-duotone`: ImageVector? = null
