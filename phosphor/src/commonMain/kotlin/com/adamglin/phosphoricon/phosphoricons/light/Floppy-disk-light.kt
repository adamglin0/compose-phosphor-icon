...
public val LightGroup.`Floppy-disk-light`: ImageVector
    get() {
        if (`_floppy-disk-light` != null) {
            return `_floppy-disk-light`!!
        }
        `_floppy-disk-light` = Builder(name = "Floppy-disk-light", defaultWidth = 256.0.dp,
...
private var `_floppy-disk-light`: ImageVector? = null
