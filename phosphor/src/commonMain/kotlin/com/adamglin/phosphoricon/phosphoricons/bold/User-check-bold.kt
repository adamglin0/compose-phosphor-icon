...
public val BoldGroup.`User-check-bold`: ImageVector
    get() {
        if (`_user-check-bold` != null) {
            return `_user-check-bold`!!
        }
        `_user-check-bold` = Builder(name = "User-check-bold", defaultWidth = 256.0.dp,
...
private var `_user-check-bold`: ImageVector? = null
