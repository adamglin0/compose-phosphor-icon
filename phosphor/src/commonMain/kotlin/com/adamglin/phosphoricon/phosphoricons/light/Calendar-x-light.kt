...
public val LightGroup.`Calendar-x-light`: ImageVector
    get() {
        if (`_calendar-x-light` != null) {
            return `_calendar-x-light`!!
        }
        `_calendar-x-light` = Builder(name = "Calendar-x-light", defaultWidth = 256.0.dp,
...
private var `_calendar-x-light`: ImageVector? = null
