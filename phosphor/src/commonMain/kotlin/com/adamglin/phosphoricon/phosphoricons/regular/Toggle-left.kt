...
public val RegularGroup.`Toggle-left`: ImageVector
    get() {
        if (`_toggle-left` != null) {
            return `_toggle-left`!!
        }
        `_toggle-left` = Builder(name = "Toggle-left", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_toggle-left`: ImageVector? = null
