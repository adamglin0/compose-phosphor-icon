...
public val ThinGroup.`Link-simple-thin`: ImageVector
    get() {
        if (`_link-simple-thin` != null) {
            return `_link-simple-thin`!!
        }
        `_link-simple-thin` = Builder(name = "Link-simple-thin", defaultWidth = 256.0.dp,
...
private var `_link-simple-thin`: ImageVector? = null
