...
public val DuotoneGroup.`Password-duotone`: ImageVector
    get() {
        if (`_password-duotone` != null) {
            return `_password-duotone`!!
        }
        `_password-duotone` = Builder(name = "Password-duotone", defaultWidth = 256.0.dp,
...
private var `_password-duotone`: ImageVector? = null
