...
public val DuotoneGroup.`Mouse-left-click-duotone`: ImageVector
    get() {
        if (`_mouse-left-click-duotone` != null) {
            return `_mouse-left-click-duotone`!!
        }
        `_mouse-left-click-duotone` = Builder(name = "Mouse-left-click-duotone", defaultWidth =
...
private var `_mouse-left-click-duotone`: ImageVector? = null
