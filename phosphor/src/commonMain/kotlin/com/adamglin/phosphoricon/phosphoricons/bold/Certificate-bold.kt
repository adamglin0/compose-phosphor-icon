...
public val BoldGroup.`Certificate-bold`: ImageVector
    get() {
        if (`_certificate-bold` != null) {
            return `_certificate-bold`!!
        }
        `_certificate-bold` = Builder(name = "Certificate-bold", defaultWidth = 256.0.dp,
...
private var `_certificate-bold`: ImageVector? = null
