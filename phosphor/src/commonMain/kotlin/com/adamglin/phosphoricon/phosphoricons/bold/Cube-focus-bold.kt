...
public val BoldGroup.`Cube-focus-bold`: ImageVector
    get() {
        if (`_cube-focus-bold` != null) {
            return `_cube-focus-bold`!!
        }
        `_cube-focus-bold` = Builder(name = "Cube-focus-bold", defaultWidth = 256.0.dp,
...
private var `_cube-focus-bold`: ImageVector? = null
