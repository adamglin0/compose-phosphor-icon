...
public val BoldGroup.`Exclude-square-bold`: ImageVector
    get() {
        if (`_exclude-square-bold` != null) {
            return `_exclude-square-bold`!!
        }
        `_exclude-square-bold` = Builder(name = "Exclude-square-bold", defaultWidth = 256.0.dp,
...
private var `_exclude-square-bold`: ImageVector? = null
