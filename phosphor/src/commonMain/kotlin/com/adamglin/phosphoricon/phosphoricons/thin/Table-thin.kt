...
public val ThinGroup.`Table-thin`: ImageVector
    get() {
        if (`_table-thin` != null) {
            return `_table-thin`!!
        }
        `_table-thin` = Builder(name = "Table-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_table-thin`: ImageVector? = null
