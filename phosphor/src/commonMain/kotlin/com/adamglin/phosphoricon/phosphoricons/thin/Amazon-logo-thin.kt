...
public val ThinGroup.`Amazon-logo-thin`: ImageVector
    get() {
        if (`_amazon-logo-thin` != null) {
            return `_amazon-logo-thin`!!
        }
        `_amazon-logo-thin` = Builder(name = "Amazon-logo-thin", defaultWidth = 256.0.dp,
...
private var `_amazon-logo-thin`: ImageVector? = null
