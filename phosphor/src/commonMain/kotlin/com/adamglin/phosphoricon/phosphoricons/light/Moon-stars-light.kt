...
public val LightGroup.`Moon-stars-light`: ImageVector
    get() {
        if (`_moon-stars-light` != null) {
            return `_moon-stars-light`!!
        }
        `_moon-stars-light` = Builder(name = "Moon-stars-light", defaultWidth = 256.0.dp,
...
private var `_moon-stars-light`: ImageVector? = null
