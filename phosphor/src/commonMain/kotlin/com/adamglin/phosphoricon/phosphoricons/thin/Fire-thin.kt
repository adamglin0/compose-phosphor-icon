...
public val ThinGroup.`Fire-thin`: ImageVector
    get() {
        if (`_fire-thin` != null) {
            return `_fire-thin`!!
        }
        `_fire-thin` = Builder(name = "Fire-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fire-thin`: ImageVector? = null
