...
public val BoldGroup.`Lock-open-bold`: ImageVector
    get() {
        if (`_lock-open-bold` != null) {
            return `_lock-open-bold`!!
        }
        `_lock-open-bold` = Builder(name = "Lock-open-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_lock-open-bold`: ImageVector? = null
