...
public val ThinGroup.`Check-circle-thin`: ImageVector
    get() {
        if (`_check-circle-thin` != null) {
            return `_check-circle-thin`!!
        }
        `_check-circle-thin` = Builder(name = "Check-circle-thin", defaultWidth = 256.0.dp,
...
private var `_check-circle-thin`: ImageVector? = null
