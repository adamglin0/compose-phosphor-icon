...
public val FillGroup.`Orange-fill`: ImageVector
    get() {
        if (`_orange-fill` != null) {
            return `_orange-fill`!!
        }
        `_orange-fill` = Builder(name = "Orange-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_orange-fill`: ImageVector? = null
