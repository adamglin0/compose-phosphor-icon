...
public val ThinGroup.`Shovel-thin`: ImageVector
    get() {
        if (`_shovel-thin` != null) {
            return `_shovel-thin`!!
        }
        `_shovel-thin` = Builder(name = "Shovel-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shovel-thin`: ImageVector? = null
