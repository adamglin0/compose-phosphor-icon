...
public val DuotoneGroup.`Meta-logo-duotone`: ImageVector
    get() {
        if (`_meta-logo-duotone` != null) {
            return `_meta-logo-duotone`!!
        }
        `_meta-logo-duotone` = Builder(name = "Meta-logo-duotone", defaultWidth = 256.0.dp,
...
private var `_meta-logo-duotone`: ImageVector? = null
