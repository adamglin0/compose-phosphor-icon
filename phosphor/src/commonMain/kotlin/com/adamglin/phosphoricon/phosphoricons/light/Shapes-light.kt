...
public val LightGroup.`Shapes-light`: ImageVector
    get() {
        if (`_shapes-light` != null) {
            return `_shapes-light`!!
        }
        `_shapes-light` = Builder(name = "Shapes-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shapes-light`: ImageVector? = null
