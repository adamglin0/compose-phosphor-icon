...
public val DuotoneGroup.`Timer-duotone`: ImageVector
    get() {
        if (`_timer-duotone` != null) {
            return `_timer-duotone`!!
        }
        `_timer-duotone` = Builder(name = "Timer-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_timer-duotone`: ImageVector? = null
