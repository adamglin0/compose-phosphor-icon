...
public val ThinGroup.`Calendar-dot-thin`: ImageVector
    get() {
        if (`_calendar-dot-thin` != null) {
            return `_calendar-dot-thin`!!
        }
        `_calendar-dot-thin` = Builder(name = "Calendar-dot-thin", defaultWidth = 256.0.dp,
...
private var `_calendar-dot-thin`: ImageVector? = null
