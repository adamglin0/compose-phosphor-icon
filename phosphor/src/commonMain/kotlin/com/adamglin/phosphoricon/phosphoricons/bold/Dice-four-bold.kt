...
public val BoldGroup.`Dice-four-bold`: ImageVector
    get() {
        if (`_dice-four-bold` != null) {
            return `_dice-four-bold`!!
        }
        `_dice-four-bold` = Builder(name = "Dice-four-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dice-four-bold`: ImageVector? = null
