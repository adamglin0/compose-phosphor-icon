...
public val RegularGroup.`Cloud-rain`: ImageVector
    get() {
        if (`_cloud-rain` != null) {
            return `_cloud-rain`!!
        }
        `_cloud-rain` = Builder(name = "Cloud-rain", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-rain`: ImageVector? = null
