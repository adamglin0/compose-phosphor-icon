...
public val BoldGroup.`Folders-bold`: ImageVector
    get() {
        if (`_folders-bold` != null) {
            return `_folders-bold`!!
        }
        `_folders-bold` = Builder(name = "Folders-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folders-bold`: ImageVector? = null
