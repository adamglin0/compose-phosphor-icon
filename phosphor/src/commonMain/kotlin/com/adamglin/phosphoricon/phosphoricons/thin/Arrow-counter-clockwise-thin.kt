...
public val ThinGroup.`Arrow-counter-clockwise-thin`: ImageVector
    get() {
        if (`_arrow-counter-clockwise-thin` != null) {
            return `_arrow-counter-clockwise-thin`!!
        }
        `_arrow-counter-clockwise-thin` = Builder(name = "Arrow-counter-clockwise-thin",
...
private var `_arrow-counter-clockwise-thin`: ImageVector? = null
