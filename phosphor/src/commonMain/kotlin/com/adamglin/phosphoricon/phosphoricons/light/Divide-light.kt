...
public val LightGroup.`Divide-light`: ImageVector
    get() {
        if (`_divide-light` != null) {
            return `_divide-light`!!
        }
        `_divide-light` = Builder(name = "Divide-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_divide-light`: ImageVector? = null
