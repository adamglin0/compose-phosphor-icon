...
public val LightGroup.`Siren-light`: ImageVector
    get() {
        if (`_siren-light` != null) {
            return `_siren-light`!!
        }
        `_siren-light` = Builder(name = "Siren-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_siren-light`: ImageVector? = null
