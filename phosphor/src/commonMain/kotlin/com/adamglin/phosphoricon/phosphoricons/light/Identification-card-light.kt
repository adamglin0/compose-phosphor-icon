...
public val LightGroup.`Identification-card-light`: ImageVector
    get() {
        if (`_identification-card-light` != null) {
            return `_identification-card-light`!!
        }
        `_identification-card-light` = Builder(name = "Identification-card-light", defaultWidth =
...
private var `_identification-card-light`: ImageVector? = null
