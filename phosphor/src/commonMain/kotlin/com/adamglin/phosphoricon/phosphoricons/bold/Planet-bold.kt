...
public val BoldGroup.`Planet-bold`: ImageVector
    get() {
        if (`_planet-bold` != null) {
            return `_planet-bold`!!
        }
        `_planet-bold` = Builder(name = "Planet-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_planet-bold`: ImageVector? = null
