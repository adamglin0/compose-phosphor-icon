...
public val LightGroup.`Link-light`: ImageVector
    get() {
        if (`_link-light` != null) {
            return `_link-light`!!
        }
        `_link-light` = Builder(name = "Link-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_link-light`: ImageVector? = null
