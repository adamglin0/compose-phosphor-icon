...
public val ThinGroup.`Orange-slice-thin`: ImageVector
    get() {
        if (`_orange-slice-thin` != null) {
            return `_orange-slice-thin`!!
        }
        `_orange-slice-thin` = Builder(name = "Orange-slice-thin", defaultWidth = 256.0.dp,
...
private var `_orange-slice-thin`: ImageVector? = null
