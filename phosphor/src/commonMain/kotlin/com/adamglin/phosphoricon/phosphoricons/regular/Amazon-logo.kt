...
public val RegularGroup.`Amazon-logo`: ImageVector
    get() {
        if (`_amazon-logo` != null) {
            return `_amazon-logo`!!
        }
        `_amazon-logo` = Builder(name = "Amazon-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_amazon-logo`: ImageVector? = null
