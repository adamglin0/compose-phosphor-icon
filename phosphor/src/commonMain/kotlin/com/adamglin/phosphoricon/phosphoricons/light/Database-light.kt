...
public val LightGroup.`Database-light`: ImageVector
    get() {
        if (`_database-light` != null) {
            return `_database-light`!!
        }
        `_database-light` = Builder(name = "Database-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_database-light`: ImageVector? = null
