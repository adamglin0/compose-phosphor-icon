...
public val DuotoneGroup.`Less-than-duotone`: ImageVector
    get() {
        if (`_less-than-duotone` != null) {
            return `_less-than-duotone`!!
        }
        `_less-than-duotone` = Builder(name = "Less-than-duotone", defaultWidth = 256.0.dp,
...
private var `_less-than-duotone`: ImageVector? = null
