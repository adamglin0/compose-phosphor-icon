...
public val BoldGroup.`Basket-bold`: ImageVector
    get() {
        if (`_basket-bold` != null) {
            return `_basket-bold`!!
        }
        `_basket-bold` = Builder(name = "Basket-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_basket-bold`: ImageVector? = null
