...
public val LightGroup.`Shuffle-angular-light`: ImageVector
    get() {
        if (`_shuffle-angular-light` != null) {
            return `_shuffle-angular-light`!!
        }
        `_shuffle-angular-light` = Builder(name = "Shuffle-angular-light", defaultWidth = 256.0.dp,
...
private var `_shuffle-angular-light`: ImageVector? = null
