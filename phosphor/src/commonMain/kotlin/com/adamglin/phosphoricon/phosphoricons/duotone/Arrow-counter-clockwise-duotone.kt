...
public val DuotoneGroup.`Arrow-counter-clockwise-duotone`: ImageVector
    get() {
        if (`_arrow-counter-clockwise-duotone` != null) {
            return `_arrow-counter-clockwise-duotone`!!
        }
        `_arrow-counter-clockwise-duotone` = Builder(name = "Arrow-counter-clockwise-duotone",
...
private var `_arrow-counter-clockwise-duotone`: ImageVector? = null
