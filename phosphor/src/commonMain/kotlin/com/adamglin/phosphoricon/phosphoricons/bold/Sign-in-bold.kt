...
public val BoldGroup.`Sign-in-bold`: ImageVector
    get() {
        if (`_sign-in-bold` != null) {
            return `_sign-in-bold`!!
        }
        `_sign-in-bold` = Builder(name = "Sign-in-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sign-in-bold`: ImageVector? = null
