...
public val FillGroup.`Microsoft-powerpoint-logo-fill`: ImageVector
    get() {
        if (`_microsoft-powerpoint-logo-fill` != null) {
            return `_microsoft-powerpoint-logo-fill`!!
        }
        `_microsoft-powerpoint-logo-fill` = Builder(name = "Microsoft-powerpoint-logo-fill",
...
private var `_microsoft-powerpoint-logo-fill`: ImageVector? = null
