...
public val DuotoneGroup.`Scan-smiley-duotone`: ImageVector
    get() {
        if (`_scan-smiley-duotone` != null) {
            return `_scan-smiley-duotone`!!
        }
        `_scan-smiley-duotone` = Builder(name = "Scan-smiley-duotone", defaultWidth = 256.0.dp,
...
private var `_scan-smiley-duotone`: ImageVector? = null
