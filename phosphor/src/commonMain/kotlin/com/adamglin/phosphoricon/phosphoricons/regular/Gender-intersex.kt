...
public val RegularGroup.`Gender-intersex`: ImageVector
    get() {
        if (`_gender-intersex` != null) {
            return `_gender-intersex`!!
        }
        `_gender-intersex` = Builder(name = "Gender-intersex", defaultWidth = 256.0.dp,
...
private var `_gender-intersex`: ImageVector? = null
