...
public val RegularGroup.`Poker-chip`: ImageVector
    get() {
        if (`_poker-chip` != null) {
            return `_poker-chip`!!
        }
        `_poker-chip` = Builder(name = "Poker-chip", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_poker-chip`: ImageVector? = null
