...
public val BoldGroup.`Clipboard-bold`: ImageVector
    get() {
        if (`_clipboard-bold` != null) {
            return `_clipboard-bold`!!
        }
        `_clipboard-bold` = Builder(name = "Clipboard-bold", defaultWidth = 256.0.dp, defaultHeight
...
private var `_clipboard-bold`: ImageVector? = null
