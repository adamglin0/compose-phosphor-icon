...
public val FillGroup.`Scooter-fill`: ImageVector
    get() {
        if (`_scooter-fill` != null) {
            return `_scooter-fill`!!
        }
        `_scooter-fill` = Builder(name = "Scooter-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scooter-fill`: ImageVector? = null
