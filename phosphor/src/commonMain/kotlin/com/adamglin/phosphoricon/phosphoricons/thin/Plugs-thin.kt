...
public val ThinGroup.`Plugs-thin`: ImageVector
    get() {
        if (`_plugs-thin` != null) {
            return `_plugs-thin`!!
        }
        `_plugs-thin` = Builder(name = "Plugs-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plugs-thin`: ImageVector? = null
