...
public val LightGroup.`Faders-light`: ImageVector
    get() {
        if (`_faders-light` != null) {
            return `_faders-light`!!
        }
        `_faders-light` = Builder(name = "Faders-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_faders-light`: ImageVector? = null
