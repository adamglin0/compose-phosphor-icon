...
public val LightGroup.`Magnifying-glass-plus-light`: ImageVector
    get() {
        if (`_magnifying-glass-plus-light` != null) {
            return `_magnifying-glass-plus-light`!!
        }
        `_magnifying-glass-plus-light` = Builder(name = "Magnifying-glass-plus-light", defaultWidth
...
private var `_magnifying-glass-plus-light`: ImageVector? = null
