...
public val FillGroup.`Network-slash-fill`: ImageVector
    get() {
        if (`_network-slash-fill` != null) {
            return `_network-slash-fill`!!
        }
        `_network-slash-fill` = Builder(name = "Network-slash-fill", defaultWidth = 256.0.dp,
                defaultHeight = 256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(98.08f, 59.41f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 96.0f, 54.0f)
...
private var `_network-slash-fill`: ImageVector? = null
