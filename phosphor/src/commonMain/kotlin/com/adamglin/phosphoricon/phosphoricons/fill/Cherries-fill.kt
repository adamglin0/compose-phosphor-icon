...
public val FillGroup.`Cherries-fill`: ImageVector
    get() {
        if (`_cherries-fill` != null) {
            return `_cherries-fill`!!
        }
        `_cherries-fill` = Builder(name = "Cherries-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cherries-fill`: ImageVector? = null
