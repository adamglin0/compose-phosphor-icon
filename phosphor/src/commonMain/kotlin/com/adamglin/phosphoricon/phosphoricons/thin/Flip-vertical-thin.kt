...
public val ThinGroup.`Flip-vertical-thin`: ImageVector
    get() {
        if (`_flip-vertical-thin` != null) {
            return `_flip-vertical-thin`!!
        }
        `_flip-vertical-thin` = Builder(name = "Flip-vertical-thin", defaultWidth = 256.0.dp,
...
private var `_flip-vertical-thin`: ImageVector? = null
