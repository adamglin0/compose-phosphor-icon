...
public val FillGroup.`Chart-pie-slice-fill`: ImageVector
    get() {
        if (`_chart-pie-slice-fill` != null) {
            return `_chart-pie-slice-fill`!!
        }
        `_chart-pie-slice-fill` = Builder(name = "Chart-pie-slice-fill", defaultWidth = 256.0.dp,
...
private var `_chart-pie-slice-fill`: ImageVector? = null
