...
public val DuotoneGroup.`Football-helmet-duotone`: ImageVector
    get() {
        if (`_football-helmet-duotone` != null) {
            return `_football-helmet-duotone`!!
        }
        `_football-helmet-duotone` = Builder(name = "Football-helmet-duotone", defaultWidth =
...
private var `_football-helmet-duotone`: ImageVector? = null
