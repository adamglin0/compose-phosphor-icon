...
public val FillGroup.`Dice-four-fill`: ImageVector
    get() {
        if (`_dice-four-fill` != null) {
            return `_dice-four-fill`!!
        }
        `_dice-four-fill` = Builder(name = "Dice-four-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_dice-four-fill`: ImageVector? = null
