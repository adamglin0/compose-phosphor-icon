...
public val BoldGroup.`Piano-keys-bold`: ImageVector
    get() {
        if (`_piano-keys-bold` != null) {
            return `_piano-keys-bold`!!
        }
        `_piano-keys-bold` = Builder(name = "Piano-keys-bold", defaultWidth = 256.0.dp,
...
private var `_piano-keys-bold`: ImageVector? = null
