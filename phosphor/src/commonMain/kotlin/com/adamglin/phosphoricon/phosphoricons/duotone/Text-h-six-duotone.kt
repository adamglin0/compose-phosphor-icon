...
public val DuotoneGroup.`Text-h-six-duotone`: ImageVector
    get() {
        if (`_text-h-six-duotone` != null) {
            return `_text-h-six-duotone`!!
        }
        `_text-h-six-duotone` = Builder(name = "Text-h-six-duotone", defaultWidth = 256.0.dp,
...
private var `_text-h-six-duotone`: ImageVector? = null
