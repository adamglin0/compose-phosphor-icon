...
public val DuotoneGroup.`Flame-duotone`: ImageVector
    get() {
        if (`_flame-duotone` != null) {
            return `_flame-duotone`!!
        }
        `_flame-duotone` = Builder(name = "Flame-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flame-duotone`: ImageVector? = null
