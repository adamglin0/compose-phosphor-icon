...
public val BoldGroup.`Sigma-bold`: ImageVector
    get() {
        if (`_sigma-bold` != null) {
            return `_sigma-bold`!!
        }
        `_sigma-bold` = Builder(name = "Sigma-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sigma-bold`: ImageVector? = null
