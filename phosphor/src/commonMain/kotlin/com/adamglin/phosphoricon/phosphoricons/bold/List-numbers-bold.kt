...
public val BoldGroup.`List-numbers-bold`: ImageVector
    get() {
        if (`_list-numbers-bold` != null) {
            return `_list-numbers-bold`!!
        }
        `_list-numbers-bold` = Builder(name = "List-numbers-bold", defaultWidth = 256.0.dp,
...
private var `_list-numbers-bold`: ImageVector? = null
