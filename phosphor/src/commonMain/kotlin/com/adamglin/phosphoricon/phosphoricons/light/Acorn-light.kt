...
public val LightGroup.`Acorn-light`: ImageVector
    get() {
        if (`_acorn-light` != null) {
            return `_acorn-light`!!
        }
        `_acorn-light` = Builder(name = "Acorn-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_acorn-light`: ImageVector? = null
