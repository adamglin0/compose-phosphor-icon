...
public val DuotoneGroup.`Video-duotone`: ImageVector
    get() {
        if (`_video-duotone` != null) {
            return `_video-duotone`!!
        }
        `_video-duotone` = Builder(name = "Video-duotone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_video-duotone`: ImageVector? = null
