...
public val DuotoneGroup.`User-focus-duotone`: ImageVector
    get() {
        if (`_user-focus-duotone` != null) {
            return `_user-focus-duotone`!!
        }
        `_user-focus-duotone` = Builder(name = "User-focus-duotone", defaultWidth = 256.0.dp,
...
private var `_user-focus-duotone`: ImageVector? = null
