...
public val BoldGroup.`Lasso-bold`: ImageVector
    get() {
        if (`_lasso-bold` != null) {
            return `_lasso-bold`!!
        }
        `_lasso-bold` = Builder(name = "Lasso-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lasso-bold`: ImageVector? = null
