...
public val LightGroup.`File-dashed-light`: ImageVector
    get() {
        if (`_file-dashed-light` != null) {
            return `_file-dashed-light`!!
        }
        `_file-dashed-light` = Builder(name = "File-dashed-light", defaultWidth = 256.0.dp,
...
private var `_file-dashed-light`: ImageVector? = null
