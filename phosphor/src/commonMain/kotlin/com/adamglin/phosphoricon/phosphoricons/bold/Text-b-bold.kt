...
public val BoldGroup.`Text-b-bold`: ImageVector
    get() {
        if (`_text-b-bold` != null) {
            return `_text-b-bold`!!
        }
        `_text-b-bold` = Builder(name = "Text-b-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-b-bold`: ImageVector? = null
