...
public val LightGroup.`Heartbeat-light`: ImageVector
    get() {
        if (`_heartbeat-light` != null) {
            return `_heartbeat-light`!!
        }
        `_heartbeat-light` = Builder(name = "Heartbeat-light", defaultWidth = 256.0.dp,
...
private var `_heartbeat-light`: ImageVector? = null
