...
public val DuotoneGroup.`Phone-list-duotone`: ImageVector
    get() {
        if (`_phone-list-duotone` != null) {
            return `_phone-list-duotone`!!
        }
        `_phone-list-duotone` = Builder(name = "Phone-list-duotone", defaultWidth = 256.0.dp,
...
private var `_phone-list-duotone`: ImageVector? = null
