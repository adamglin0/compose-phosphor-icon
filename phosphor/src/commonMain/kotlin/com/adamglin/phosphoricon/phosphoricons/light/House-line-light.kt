...
public val LightGroup.`House-line-light`: ImageVector
    get() {
        if (`_house-line-light` != null) {
            return `_house-line-light`!!
        }
        `_house-line-light` = Builder(name = "House-line-light", defaultWidth = 256.0.dp,
...
private var `_house-line-light`: ImageVector? = null
