...
public val DuotoneGroup.`Phone-disconnect-duotone`: ImageVector
    get() {
        if (`_phone-disconnect-duotone` != null) {
            return `_phone-disconnect-duotone`!!
        }
        `_phone-disconnect-duotone` = Builder(name = "Phone-disconnect-duotone", defaultWidth =
...
private var `_phone-disconnect-duotone`: ImageVector? = null
