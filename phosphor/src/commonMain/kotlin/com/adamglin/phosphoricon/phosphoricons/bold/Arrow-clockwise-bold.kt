...
public val BoldGroup.`Arrow-clockwise-bold`: ImageVector
    get() {
        if (`_arrow-clockwise-bold` != null) {
            return `_arrow-clockwise-bold`!!
        }
        `_arrow-clockwise-bold` = Builder(name = "Arrow-clockwise-bold", defaultWidth = 256.0.dp,
...
private var `_arrow-clockwise-bold`: ImageVector? = null
