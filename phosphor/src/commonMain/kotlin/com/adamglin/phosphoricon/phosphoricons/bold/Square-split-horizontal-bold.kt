...
public val BoldGroup.`Square-split-horizontal-bold`: ImageVector
    get() {
        if (`_square-split-horizontal-bold` != null) {
            return `_square-split-horizontal-bold`!!
        }
        `_square-split-horizontal-bold` = Builder(name = "Square-split-horizontal-bold",
...
private var `_square-split-horizontal-bold`: ImageVector? = null
