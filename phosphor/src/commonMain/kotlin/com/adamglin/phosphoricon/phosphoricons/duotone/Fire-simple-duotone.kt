...
public val DuotoneGroup.`Fire-simple-duotone`: ImageVector
    get() {
        if (`_fire-simple-duotone` != null) {
            return `_fire-simple-duotone`!!
        }
        `_fire-simple-duotone` = Builder(name = "Fire-simple-duotone", defaultWidth = 256.0.dp,
...
private var `_fire-simple-duotone`: ImageVector? = null
