...
public val LightGroup.`Gas-pump-light`: ImageVector
    get() {
        if (`_gas-pump-light` != null) {
            return `_gas-pump-light`!!
        }
        `_gas-pump-light` = Builder(name = "Gas-pump-light", defaultWidth = 256.0.dp, defaultHeight
...
private var `_gas-pump-light`: ImageVector? = null
