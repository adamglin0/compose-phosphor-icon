...
public val LightGroup.`Watch-light`: ImageVector
    get() {
        if (`_watch-light` != null) {
            return `_watch-light`!!
        }
        `_watch-light` = Builder(name = "Watch-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_watch-light`: ImageVector? = null
