...
public val BoldGroup.`Hand-arrow-down-bold`: ImageVector
    get() {
        if (`_hand-arrow-down-bold` != null) {
            return `_hand-arrow-down-bold`!!
        }
        `_hand-arrow-down-bold` = Builder(name = "Hand-arrow-down-bold", defaultWidth = 256.0.dp,
...
private var `_hand-arrow-down-bold`: ImageVector? = null
