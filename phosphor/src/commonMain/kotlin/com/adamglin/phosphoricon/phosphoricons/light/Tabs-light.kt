...
public val LightGroup.`Tabs-light`: ImageVector
    get() {
        if (`_tabs-light` != null) {
            return `_tabs-light`!!
        }
        `_tabs-light` = Builder(name = "Tabs-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tabs-light`: ImageVector? = null
