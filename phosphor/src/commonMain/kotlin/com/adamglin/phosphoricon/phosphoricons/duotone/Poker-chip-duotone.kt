...
public val DuotoneGroup.`Poker-chip-duotone`: ImageVector
    get() {
        if (`_poker-chip-duotone` != null) {
            return `_poker-chip-duotone`!!
        }
        `_poker-chip-duotone` = Builder(name = "Poker-chip-duotone", defaultWidth = 256.0.dp,
...
private var `_poker-chip-duotone`: ImageVector? = null
