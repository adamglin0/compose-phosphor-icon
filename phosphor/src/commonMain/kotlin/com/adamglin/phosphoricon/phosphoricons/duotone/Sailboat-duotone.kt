...
public val DuotoneGroup.`Sailboat-duotone`: ImageVector
    get() {
        if (`_sailboat-duotone` != null) {
            return `_sailboat-duotone`!!
        }
        `_sailboat-duotone` = Builder(name = "Sailboat-duotone", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -6.24f, 3.0f)
...
private var `_sailboat-duotone`: ImageVector? = null
