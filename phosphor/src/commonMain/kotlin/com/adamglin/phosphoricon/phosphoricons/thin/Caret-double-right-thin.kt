...
public val ThinGroup.`Caret-double-right-thin`: ImageVector
    get() {
        if (`_caret-double-right-thin` != null) {
            return `_caret-double-right-thin`!!
        }
        `_caret-double-right-thin` = Builder(name = "Caret-double-right-thin", defaultWidth =
...
private var `_caret-double-right-thin`: ImageVector? = null
