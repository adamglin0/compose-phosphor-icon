...
public val BoldGroup.`Folder-user-bold`: ImageVector
    get() {
        if (`_folder-user-bold` != null) {
            return `_folder-user-bold`!!
        }
        `_folder-user-bold` = Builder(name = "Folder-user-bold", defaultWidth = 256.0.dp,
...
private var `_folder-user-bold`: ImageVector? = null
