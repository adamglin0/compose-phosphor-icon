...
public val LightGroup.`Folder-simple-light`: ImageVector
    get() {
        if (`_folder-simple-light` != null) {
            return `_folder-simple-light`!!
        }
        `_folder-simple-light` = Builder(name = "Folder-simple-light", defaultWidth = 256.0.dp,
...
private var `_folder-simple-light`: ImageVector? = null
