...
public val BoldGroup.`Smiley-wink-bold`: ImageVector
    get() {
        if (`_smiley-wink-bold` != null) {
            return `_smiley-wink-bold`!!
        }
        `_smiley-wink-bold` = Builder(name = "Smiley-wink-bold", defaultWidth = 256.0.dp,
...
private var `_smiley-wink-bold`: ImageVector? = null
