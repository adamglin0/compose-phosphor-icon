...
public val BoldGroup.`Baseball-bold`: ImageVector
    get() {
        if (`_baseball-bold` != null) {
            return `_baseball-bold`!!
        }
        `_baseball-bold` = Builder(name = "Baseball-bold", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_baseball-bold`: ImageVector? = null
