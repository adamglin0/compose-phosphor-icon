...
public val DuotoneGroup.`Caret-circle-double-right-duotone`: ImageVector
    get() {
        if (`_caret-circle-double-right-duotone` != null) {
            return `_caret-circle-double-right-duotone`!!
        }
        `_caret-circle-double-right-duotone` = Builder(name = "Caret-circle-double-right-duotone",
...
private var `_caret-circle-double-right-duotone`: ImageVector? = null
