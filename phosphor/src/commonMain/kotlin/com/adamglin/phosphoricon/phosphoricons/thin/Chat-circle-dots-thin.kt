...
public val ThinGroup.`Chat-circle-dots-thin`: ImageVector
    get() {
        if (`_chat-circle-dots-thin` != null) {
            return `_chat-circle-dots-thin`!!
        }
        `_chat-circle-dots-thin` = Builder(name = "Chat-circle-dots-thin", defaultWidth = 256.0.dp,
...
private var `_chat-circle-dots-thin`: ImageVector? = null
