...
public val LightGroup.`Binary-light`: ImageVector
    get() {
        if (`_binary-light` != null) {
            return `_binary-light`!!
        }
        `_binary-light` = Builder(name = "Binary-light", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_binary-light`: ImageVector? = null
