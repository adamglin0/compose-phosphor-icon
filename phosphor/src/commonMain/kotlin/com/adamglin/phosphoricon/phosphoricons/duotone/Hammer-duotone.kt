...
public val DuotoneGroup.`Hammer-duotone`: ImageVector
    get() {
        if (`_hammer-duotone` != null) {
            return `_hammer-duotone`!!
        }
        `_hammer-duotone` = Builder(name = "Hammer-duotone", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hammer-duotone`: ImageVector? = null
