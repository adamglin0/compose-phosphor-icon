...
public val ThinGroup.`Projector-screen-chart-thin`: ImageVector
    get() {
        if (`_projector-screen-chart-thin` != null) {
            return `_projector-screen-chart-thin`!!
        }
        `_projector-screen-chart-thin` = Builder(name = "Projector-screen-chart-thin", defaultWidth
...
private var `_projector-screen-chart-thin`: ImageVector? = null
