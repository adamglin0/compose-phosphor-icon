...
public val ThinGroup.`Stairs-thin`: ImageVector
    get() {
        if (`_stairs-thin` != null) {
            return `_stairs-thin`!!
        }
        `_stairs-thin` = Builder(name = "Stairs-thin", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stairs-thin`: ImageVector? = null
