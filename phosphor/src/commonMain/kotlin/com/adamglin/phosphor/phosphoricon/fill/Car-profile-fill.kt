...
public val FillGroup.`Car-profile-fill`: ImageVector
    get() {
        if (`_car-profile-fill` != null) {
            return `_car-profile-fill`!!
        }
        `_car-profile-fill` = Builder(name = "Car-profile-fill", defaultWidth = 256.0.dp,
...
private var `_car-profile-fill`: ImageVector? = null
