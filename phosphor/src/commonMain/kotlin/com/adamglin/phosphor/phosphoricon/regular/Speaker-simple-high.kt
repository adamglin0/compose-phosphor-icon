...
public val RegularGroup.`Speaker-simple-high`: ImageVector
    get() {
        if (`_speaker-simple-high` != null) {
            return `_speaker-simple-high`!!
        }
        `_speaker-simple-high` = Builder(name = "Speaker-simple-high", defaultWidth = 256.0.dp,
...
private var `_speaker-simple-high`: ImageVector? = null
