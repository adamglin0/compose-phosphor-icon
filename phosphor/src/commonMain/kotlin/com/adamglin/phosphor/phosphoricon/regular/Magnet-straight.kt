...
public val RegularGroup.`Magnet-straight`: ImageVector
    get() {
        if (`_magnet-straight` != null) {
            return `_magnet-straight`!!
        }
        `_magnet-straight` = Builder(name = "Magnet-straight", defaultWidth = 256.0.dp,
...
private var `_magnet-straight`: ImageVector? = null
