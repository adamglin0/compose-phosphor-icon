...
public val RegularGroup.`Person-simple-walk`: ImageVector
    get() {
        if (`_person-simple-walk` != null) {
            return `_person-simple-walk`!!
        }
        `_person-simple-walk` = Builder(name = "Person-simple-walk", defaultWidth = 256.0.dp,
...
private var `_person-simple-walk`: ImageVector? = null
