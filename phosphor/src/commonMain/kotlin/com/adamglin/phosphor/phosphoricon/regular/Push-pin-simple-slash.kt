...
public val RegularGroup.`Push-pin-simple-slash`: ImageVector
    get() {
        if (`_push-pin-simple-slash` != null) {
            return `_push-pin-simple-slash`!!
        }
        `_push-pin-simple-slash` = Builder(name = "Push-pin-simple-slash", defaultWidth = 256.0.dp,
...
private var `_push-pin-simple-slash`: ImageVector? = null
