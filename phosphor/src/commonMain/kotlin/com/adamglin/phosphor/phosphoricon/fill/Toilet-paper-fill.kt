...
public val FillGroup.`Toilet-paper-fill`: ImageVector
    get() {
        if (`_toilet-paper-fill` != null) {
            return `_toilet-paper-fill`!!
        }
        `_toilet-paper-fill` = Builder(name = "Toilet-paper-fill", defaultWidth = 256.0.dp,
...
private var `_toilet-paper-fill`: ImageVector? = null
