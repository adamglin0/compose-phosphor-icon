...
public val RegularGroup.`Wechat-logo`: ImageVector
    get() {
        if (`_wechat-logo` != null) {
            return `_wechat-logo`!!
        }
        `_wechat-logo` = Builder(name = "Wechat-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wechat-logo`: ImageVector? = null
