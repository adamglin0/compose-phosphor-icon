...
public val RegularGroup.`Monitor-arrow-up`: ImageVector
    get() {
        if (`_monitor-arrow-up` != null) {
            return `_monitor-arrow-up`!!
        }
        `_monitor-arrow-up` = Builder(name = "Monitor-arrow-up", defaultWidth = 256.0.dp,
...
private var `_monitor-arrow-up`: ImageVector? = null
