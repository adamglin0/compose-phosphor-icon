...
public val FillGroup.`Anchor-simple-fill`: ImageVector
    get() {
        if (`_anchor-simple-fill` != null) {
            return `_anchor-simple-fill`!!
        }
        `_anchor-simple-fill` = Builder(name = "Anchor-simple-fill", defaultWidth = 256.0.dp,
...
private var `_anchor-simple-fill`: ImageVector? = null
