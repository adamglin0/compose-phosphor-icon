...
public val RegularGroup.`Smiley-meh`: ImageVector
    get() {
        if (`_smiley-meh` != null) {
            return `_smiley-meh`!!
        }
        `_smiley-meh` = Builder(name = "Smiley-meh", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_smiley-meh`: ImageVector? = null
