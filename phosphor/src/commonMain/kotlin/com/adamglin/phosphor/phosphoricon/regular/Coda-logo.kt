...
public val RegularGroup.`Coda-logo`: ImageVector
    get() {
        if (`_coda-logo` != null) {
            return `_coda-logo`!!
        }
        `_coda-logo` = Builder(name = "Coda-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coda-logo`: ImageVector? = null
