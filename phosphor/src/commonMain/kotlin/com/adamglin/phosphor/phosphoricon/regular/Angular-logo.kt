...
public val RegularGroup.`Angular-logo`: ImageVector
    get() {
        if (`_angular-logo` != null) {
            return `_angular-logo`!!
        }
        `_angular-logo` = Builder(name = "Angular-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_angular-logo`: ImageVector? = null
