...
public val FillGroup.`Spinner-ball-fill`: ImageVector
    get() {
        if (`_spinner-ball-fill` != null) {
            return `_spinner-ball-fill`!!
        }
        `_spinner-ball-fill` = Builder(name = "Spinner-ball-fill", defaultWidth = 256.0.dp,
...
private var `_spinner-ball-fill`: ImageVector? = null
