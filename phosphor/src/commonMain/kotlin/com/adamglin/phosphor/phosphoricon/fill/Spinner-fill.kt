...
public val FillGroup.`Spinner-fill`: ImageVector
    get() {
        if (`_spinner-fill` != null) {
            return `_spinner-fill`!!
        }
        `_spinner-fill` = Builder(name = "Spinner-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spinner-fill`: ImageVector? = null
