...
public val RegularGroup.`Jar-label`: ImageVector
    get() {
        if (`_jar-label` != null) {
            return `_jar-label`!!
        }
        `_jar-label` = Builder(name = "Jar-label", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_jar-label`: ImageVector? = null
