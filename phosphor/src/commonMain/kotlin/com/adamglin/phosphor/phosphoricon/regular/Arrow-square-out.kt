...
public val RegularGroup.`Arrow-square-out`: ImageVector
    get() {
        if (`_arrow-square-out` != null) {
            return `_arrow-square-out`!!
        }
        `_arrow-square-out` = Builder(name = "Arrow-square-out", defaultWidth = 256.0.dp,
...
private var `_arrow-square-out`: ImageVector? = null
