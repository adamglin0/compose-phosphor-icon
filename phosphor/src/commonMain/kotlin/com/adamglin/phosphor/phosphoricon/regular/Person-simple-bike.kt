...
public val RegularGroup.`Person-simple-bike`: ImageVector
    get() {
        if (`_person-simple-bike` != null) {
            return `_person-simple-bike`!!
        }
        `_person-simple-bike` = Builder(name = "Person-simple-bike", defaultWidth = 256.0.dp,
...
private var `_person-simple-bike`: ImageVector? = null
