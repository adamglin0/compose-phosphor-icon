...
public val RegularGroup.`Compass-rose`: ImageVector
    get() {
        if (`_compass-rose` != null) {
            return `_compass-rose`!!
        }
        `_compass-rose` = Builder(name = "Compass-rose", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_compass-rose`: ImageVector? = null
