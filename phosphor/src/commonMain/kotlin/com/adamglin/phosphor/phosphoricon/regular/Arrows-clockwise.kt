...
public val RegularGroup.`Arrows-clockwise`: ImageVector
    get() {
        if (`_arrows-clockwise` != null) {
            return `_arrows-clockwise`!!
        }
        `_arrows-clockwise` = Builder(name = "Arrows-clockwise", defaultWidth = 256.0.dp,
...
private var `_arrows-clockwise`: ImageVector? = null
