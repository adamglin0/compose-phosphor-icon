...
public val RegularGroup.`Replit-logo`: ImageVector
    get() {
        if (`_replit-logo` != null) {
            return `_replit-logo`!!
        }
        `_replit-logo` = Builder(name = "Replit-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_replit-logo`: ImageVector? = null
