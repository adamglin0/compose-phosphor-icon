...
public val RegularGroup.`Chat-dots`: ImageVector
    get() {
        if (`_chat-dots` != null) {
            return `_chat-dots`!!
        }
        `_chat-dots` = Builder(name = "Chat-dots", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chat-dots`: ImageVector? = null
