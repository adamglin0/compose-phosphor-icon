...
public val RegularGroup.`Charging-station`: ImageVector
    get() {
        if (`_charging-station` != null) {
            return `_charging-station`!!
        }
        `_charging-station` = Builder(name = "Charging-station", defaultWidth = 256.0.dp,
...
private var `_charging-station`: ImageVector? = null
