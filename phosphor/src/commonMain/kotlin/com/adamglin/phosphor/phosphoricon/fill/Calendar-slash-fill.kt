...
public val FillGroup.`Calendar-slash-fill`: ImageVector
    get() {
        if (`_calendar-slash-fill` != null) {
            return `_calendar-slash-fill`!!
        }
        `_calendar-slash-fill` = Builder(name = "Calendar-slash-fill", defaultWidth = 256.0.dp,
...
private var `_calendar-slash-fill`: ImageVector? = null
