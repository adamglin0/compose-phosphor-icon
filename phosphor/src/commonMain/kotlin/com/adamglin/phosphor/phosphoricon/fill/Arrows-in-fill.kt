...
public val FillGroup.`Arrows-in-fill`: ImageVector
    get() {
        if (`_arrows-in-fill` != null) {
            return `_arrows-in-fill`!!
        }
        `_arrows-in-fill` = Builder(name = "Arrows-in-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_arrows-in-fill`: ImageVector? = null
