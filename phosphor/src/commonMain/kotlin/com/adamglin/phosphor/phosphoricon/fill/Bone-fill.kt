...
public val FillGroup.`Bone-fill`: ImageVector
    get() {
        if (`_bone-fill` != null) {
            return `_bone-fill`!!
        }
        `_bone-fill` = Builder(name = "Bone-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bone-fill`: ImageVector? = null
