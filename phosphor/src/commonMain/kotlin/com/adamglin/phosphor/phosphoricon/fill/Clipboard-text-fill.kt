...
public val FillGroup.`Clipboard-text-fill`: ImageVector
    get() {
        if (`_clipboard-text-fill` != null) {
            return `_clipboard-text-fill`!!
        }
        `_clipboard-text-fill` = Builder(name = "Clipboard-text-fill", defaultWidth = 256.0.dp,
...
private var `_clipboard-text-fill`: ImageVector? = null
