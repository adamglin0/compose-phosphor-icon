...
public val FillGroup.`Suitcase-rolling-fill`: ImageVector
    get() {
        if (`_suitcase-rolling-fill` != null) {
            return `_suitcase-rolling-fill`!!
        }
        `_suitcase-rolling-fill` = Builder(name = "Suitcase-rolling-fill", defaultWidth = 256.0.dp,
...
private var `_suitcase-rolling-fill`: ImageVector? = null
