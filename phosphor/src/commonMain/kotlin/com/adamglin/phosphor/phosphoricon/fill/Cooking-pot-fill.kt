...
public val FillGroup.`Cooking-pot-fill`: ImageVector
    get() {
        if (`_cooking-pot-fill` != null) {
            return `_cooking-pot-fill`!!
        }
        `_cooking-pot-fill` = Builder(name = "Cooking-pot-fill", defaultWidth = 256.0.dp,
...
private var `_cooking-pot-fill`: ImageVector? = null
