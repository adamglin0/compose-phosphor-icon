...
public val RegularGroup.`Shield-slash`: ImageVector
    get() {
        if (`_shield-slash` != null) {
            return `_shield-slash`!!
        }
        `_shield-slash` = Builder(name = "Shield-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shield-slash`: ImageVector? = null
