...
public val FillGroup.`Funnel-fill`: ImageVector
    get() {
        if (`_funnel-fill` != null) {
            return `_funnel-fill`!!
        }
        `_funnel-fill` = Builder(name = "Funnel-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_funnel-fill`: ImageVector? = null
