...
public val FillGroup.`Arrow-counter-clockwise-fill`: ImageVector
    get() {
        if (`_arrow-counter-clockwise-fill` != null) {
            return `_arrow-counter-clockwise-fill`!!
        }
        `_arrow-counter-clockwise-fill` = Builder(name = "Arrow-counter-clockwise-fill",
...
private var `_arrow-counter-clockwise-fill`: ImageVector? = null
