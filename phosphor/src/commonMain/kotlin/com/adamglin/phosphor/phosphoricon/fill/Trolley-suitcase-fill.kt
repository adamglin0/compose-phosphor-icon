...
public val FillGroup.`Trolley-suitcase-fill`: ImageVector
    get() {
        if (`_trolley-suitcase-fill` != null) {
            return `_trolley-suitcase-fill`!!
        }
        `_trolley-suitcase-fill` = Builder(name = "Trolley-suitcase-fill", defaultWidth = 256.0.dp,
...
private var `_trolley-suitcase-fill`: ImageVector? = null
