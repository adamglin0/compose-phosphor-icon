...
public val FillGroup.`Number-square-six-fill`: ImageVector
    get() {
        if (`_number-square-six-fill` != null) {
            return `_number-square-six-fill`!!
        }
        `_number-square-six-fill` = Builder(name = "Number-square-six-fill", defaultWidth =
...
private var `_number-square-six-fill`: ImageVector? = null
