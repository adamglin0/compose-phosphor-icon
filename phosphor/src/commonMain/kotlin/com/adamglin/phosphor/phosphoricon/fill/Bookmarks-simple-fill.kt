...
public val FillGroup.`Bookmarks-simple-fill`: ImageVector
    get() {
        if (`_bookmarks-simple-fill` != null) {
            return `_bookmarks-simple-fill`!!
        }
        `_bookmarks-simple-fill` = Builder(name = "Bookmarks-simple-fill", defaultWidth = 256.0.dp,
...
private var `_bookmarks-simple-fill`: ImageVector? = null
