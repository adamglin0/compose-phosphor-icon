...
public val RegularGroup.`Folder-simple-dashed`: ImageVector
    get() {
        if (`_folder-simple-dashed` != null) {
            return `_folder-simple-dashed`!!
        }
        `_folder-simple-dashed` = Builder(name = "Folder-simple-dashed", defaultWidth = 256.0.dp,
...
private var `_folder-simple-dashed`: ImageVector? = null
