...
public val RegularGroup.`Grid-four`: ImageVector
    get() {
        if (`_grid-four` != null) {
            return `_grid-four`!!
        }
        `_grid-four` = Builder(name = "Grid-four", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_grid-four`: ImageVector? = null
