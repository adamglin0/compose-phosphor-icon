...
public val RegularGroup.`Hourglass-simple`: ImageVector
    get() {
        if (`_hourglass-simple` != null) {
            return `_hourglass-simple`!!
        }
        `_hourglass-simple` = Builder(name = "Hourglass-simple", defaultWidth = 256.0.dp,
...
private var `_hourglass-simple`: ImageVector? = null
