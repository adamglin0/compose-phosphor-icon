...
public val RegularGroup.`Coin-vertical`: ImageVector
    get() {
        if (`_coin-vertical` != null) {
            return `_coin-vertical`!!
        }
        `_coin-vertical` = Builder(name = "Coin-vertical", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coin-vertical`: ImageVector? = null
