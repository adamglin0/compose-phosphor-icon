...
public val FillGroup.`Bandaids-fill`: ImageVector
    get() {
        if (`_bandaids-fill` != null) {
            return `_bandaids-fill`!!
        }
        `_bandaids-fill` = Builder(name = "Bandaids-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bandaids-fill`: ImageVector? = null
