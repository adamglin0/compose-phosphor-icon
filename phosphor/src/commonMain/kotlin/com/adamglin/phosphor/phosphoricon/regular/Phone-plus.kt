...
public val RegularGroup.`Phone-plus`: ImageVector
    get() {
        if (`_phone-plus` != null) {
            return `_phone-plus`!!
        }
        `_phone-plus` = Builder(name = "Phone-plus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-plus`: ImageVector? = null
