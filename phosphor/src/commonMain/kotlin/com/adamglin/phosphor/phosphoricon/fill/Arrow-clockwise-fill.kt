...
public val FillGroup.`Arrow-clockwise-fill`: ImageVector
    get() {
        if (`_arrow-clockwise-fill` != null) {
            return `_arrow-clockwise-fill`!!
        }
        `_arrow-clockwise-fill` = Builder(name = "Arrow-clockwise-fill", defaultWidth = 256.0.dp,
...
private var `_arrow-clockwise-fill`: ImageVector? = null
