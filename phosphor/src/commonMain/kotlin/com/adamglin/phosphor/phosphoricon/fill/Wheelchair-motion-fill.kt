...
public val FillGroup.`Wheelchair-motion-fill`: ImageVector
    get() {
        if (`_wheelchair-motion-fill` != null) {
            return `_wheelchair-motion-fill`!!
        }
        `_wheelchair-motion-fill` = Builder(name = "Wheelchair-motion-fill", defaultWidth =
...
private var `_wheelchair-motion-fill`: ImageVector? = null
