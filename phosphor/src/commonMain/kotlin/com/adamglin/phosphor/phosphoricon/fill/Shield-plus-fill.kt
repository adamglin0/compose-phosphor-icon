...
public val FillGroup.`Shield-plus-fill`: ImageVector
    get() {
        if (`_shield-plus-fill` != null) {
            return `_shield-plus-fill`!!
        }
        `_shield-plus-fill` = Builder(name = "Shield-plus-fill", defaultWidth = 256.0.dp,
...
private var `_shield-plus-fill`: ImageVector? = null
