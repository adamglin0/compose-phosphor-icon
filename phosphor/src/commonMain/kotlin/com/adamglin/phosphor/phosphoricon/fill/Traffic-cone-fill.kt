...
public val FillGroup.`Traffic-cone-fill`: ImageVector
    get() {
        if (`_traffic-cone-fill` != null) {
            return `_traffic-cone-fill`!!
        }
        `_traffic-cone-fill` = Builder(name = "Traffic-cone-fill", defaultWidth = 256.0.dp,
...
private var `_traffic-cone-fill`: ImageVector? = null
