...
public val FillGroup.`Shield-warning-fill`: ImageVector
    get() {
        if (`_shield-warning-fill` != null) {
            return `_shield-warning-fill`!!
        }
        `_shield-warning-fill` = Builder(name = "Shield-warning-fill", defaultWidth = 256.0.dp,
...
private var `_shield-warning-fill`: ImageVector? = null
