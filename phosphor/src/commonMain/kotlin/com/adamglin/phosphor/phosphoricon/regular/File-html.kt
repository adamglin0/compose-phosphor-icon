...
public val RegularGroup.`File-html`: ImageVector
    get() {
        if (`_file-html` != null) {
            return `_file-html`!!
        }
        `_file-html` = Builder(name = "File-html", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-html`: ImageVector? = null
