...
public val RegularGroup.`Text-superscript`: ImageVector
    get() {
        if (`_text-superscript` != null) {
            return `_text-superscript`!!
        }
        `_text-superscript` = Builder(name = "Text-superscript", defaultWidth = 256.0.dp,
...
private var `_text-superscript`: ImageVector? = null
