...
public val FillGroup.`Projector-screen-chart-fill`: ImageVector
    get() {
        if (`_projector-screen-chart-fill` != null) {
            return `_projector-screen-chart-fill`!!
        }
        `_projector-screen-chart-fill` = Builder(name = "Projector-screen-chart-fill", defaultWidth
...
private var `_projector-screen-chart-fill`: ImageVector? = null
