...
public val RegularGroup.`Hand-palm`: ImageVector
    get() {
        if (`_hand-palm` != null) {
            return `_hand-palm`!!
        }
        `_hand-palm` = Builder(name = "Hand-palm", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-palm`: ImageVector? = null
