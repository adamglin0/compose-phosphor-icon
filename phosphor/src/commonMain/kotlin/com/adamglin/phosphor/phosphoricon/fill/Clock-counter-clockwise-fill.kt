...
public val FillGroup.`Clock-counter-clockwise-fill`: ImageVector
    get() {
        if (`_clock-counter-clockwise-fill` != null) {
            return `_clock-counter-clockwise-fill`!!
        }
        `_clock-counter-clockwise-fill` = Builder(name = "Clock-counter-clockwise-fill",
...
private var `_clock-counter-clockwise-fill`: ImageVector? = null
