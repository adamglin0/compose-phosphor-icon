...
public val RegularGroup.`Lightning-a`: ImageVector
    get() {
        if (`_lightning-a` != null) {
            return `_lightning-a`!!
        }
        `_lightning-a` = Builder(name = "Lightning-a", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lightning-a`: ImageVector? = null
