...
public val RegularGroup.`Speaker-x`: ImageVector
    get() {
        if (`_speaker-x` != null) {
            return `_speaker-x`!!
        }
        `_speaker-x` = Builder(name = "Speaker-x", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_speaker-x`: ImageVector? = null
