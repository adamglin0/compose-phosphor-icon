...
public val FillGroup.`Camera-slash-fill`: ImageVector
    get() {
        if (`_camera-slash-fill` != null) {
            return `_camera-slash-fill`!!
        }
        `_camera-slash-fill` = Builder(name = "Camera-slash-fill", defaultWidth = 256.0.dp,
...
private var `_camera-slash-fill`: ImageVector? = null
