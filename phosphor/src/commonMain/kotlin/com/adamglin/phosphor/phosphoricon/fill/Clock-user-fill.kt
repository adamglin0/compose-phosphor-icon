...
public val FillGroup.`Clock-user-fill`: ImageVector
    get() {
        if (`_clock-user-fill` != null) {
            return `_clock-user-fill`!!
        }
        `_clock-user-fill` = Builder(name = "Clock-user-fill", defaultWidth = 256.0.dp,
...
private var `_clock-user-fill`: ImageVector? = null
