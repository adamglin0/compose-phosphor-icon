...
public val RegularGroup.`File-c`: ImageVector
    get() {
        if (`_file-c` != null) {
            return `_file-c`!!
        }
        `_file-c` = Builder(name = "File-c", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-c`: ImageVector? = null
