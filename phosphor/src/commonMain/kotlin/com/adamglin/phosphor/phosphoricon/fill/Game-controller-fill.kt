...
public val FillGroup.`Game-controller-fill`: ImageVector
    get() {
        if (`_game-controller-fill` != null) {
            return `_game-controller-fill`!!
        }
        `_game-controller-fill` = Builder(name = "Game-controller-fill", defaultWidth = 256.0.dp,
...
private var `_game-controller-fill`: ImageVector? = null
