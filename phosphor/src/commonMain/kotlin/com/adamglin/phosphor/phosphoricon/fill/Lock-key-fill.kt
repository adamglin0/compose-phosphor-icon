...
public val FillGroup.`Lock-key-fill`: ImageVector
    get() {
        if (`_lock-key-fill` != null) {
            return `_lock-key-fill`!!
        }
        `_lock-key-fill` = Builder(name = "Lock-key-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-key-fill`: ImageVector? = null
