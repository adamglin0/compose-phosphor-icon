...
public val FillGroup.`Map-pin-plus-fill`: ImageVector
    get() {
        if (`_map-pin-plus-fill` != null) {
            return `_map-pin-plus-fill`!!
        }
        `_map-pin-plus-fill` = Builder(name = "Map-pin-plus-fill", defaultWidth = 256.0.dp,
...
private var `_map-pin-plus-fill`: ImageVector? = null
