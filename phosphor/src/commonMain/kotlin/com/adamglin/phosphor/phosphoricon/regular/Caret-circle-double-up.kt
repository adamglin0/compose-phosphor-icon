...
public val RegularGroup.`Caret-circle-double-up`: ImageVector
    get() {
        if (`_caret-circle-double-up` != null) {
            return `_caret-circle-double-up`!!
        }
        `_caret-circle-double-up` = Builder(name = "Caret-circle-double-up", defaultWidth =
...
private var `_caret-circle-double-up`: ImageVector? = null
