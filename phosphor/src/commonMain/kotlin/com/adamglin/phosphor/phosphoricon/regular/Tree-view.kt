...
public val RegularGroup.`Tree-view`: ImageVector
    get() {
        if (`_tree-view` != null) {
            return `_tree-view`!!
        }
        `_tree-view` = Builder(name = "Tree-view", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tree-view`: ImageVector? = null
