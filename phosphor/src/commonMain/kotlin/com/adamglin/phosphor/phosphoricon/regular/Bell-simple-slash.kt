...
public val RegularGroup.`Bell-simple-slash`: ImageVector
    get() {
        if (`_bell-simple-slash` != null) {
            return `_bell-simple-slash`!!
        }
        `_bell-simple-slash` = Builder(name = "Bell-simple-slash", defaultWidth = 256.0.dp,
...
private var `_bell-simple-slash`: ImageVector? = null
