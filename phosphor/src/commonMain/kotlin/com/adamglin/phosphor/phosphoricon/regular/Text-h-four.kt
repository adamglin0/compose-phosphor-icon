...
public val RegularGroup.`Text-h-four`: ImageVector
    get() {
        if (`_text-h-four` != null) {
            return `_text-h-four`!!
        }
        `_text-h-four` = Builder(name = "Text-h-four", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-h-four`: ImageVector? = null
