...
public val RegularGroup.`Not-subset-of`: ImageVector
    get() {
        if (`_not-subset-of` != null) {
            return `_not-subset-of`!!
        }
        `_not-subset-of` = Builder(name = "Not-subset-of", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_not-subset-of`: ImageVector? = null
