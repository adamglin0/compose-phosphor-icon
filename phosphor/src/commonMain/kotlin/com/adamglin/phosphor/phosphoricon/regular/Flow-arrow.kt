...
public val RegularGroup.`Flow-arrow`: ImageVector
    get() {
        if (`_flow-arrow` != null) {
            return `_flow-arrow`!!
        }
        `_flow-arrow` = Builder(name = "Flow-arrow", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flow-arrow`: ImageVector? = null
