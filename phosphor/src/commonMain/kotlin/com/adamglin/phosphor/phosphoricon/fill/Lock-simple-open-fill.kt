...
public val FillGroup.`Lock-simple-open-fill`: ImageVector
    get() {
        if (`_lock-simple-open-fill` != null) {
            return `_lock-simple-open-fill`!!
        }
        `_lock-simple-open-fill` = Builder(name = "Lock-simple-open-fill", defaultWidth = 256.0.dp,
...
private var `_lock-simple-open-fill`: ImageVector? = null
