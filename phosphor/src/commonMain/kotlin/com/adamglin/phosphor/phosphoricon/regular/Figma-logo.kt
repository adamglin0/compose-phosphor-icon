...
public val RegularGroup.`Figma-logo`: ImageVector
    get() {
        if (`_figma-logo` != null) {
            return `_figma-logo`!!
        }
        `_figma-logo` = Builder(name = "Figma-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_figma-logo`: ImageVector? = null
