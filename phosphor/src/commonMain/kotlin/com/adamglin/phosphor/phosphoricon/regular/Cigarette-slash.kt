...
public val RegularGroup.`Cigarette-slash`: ImageVector
    get() {
        if (`_cigarette-slash` != null) {
            return `_cigarette-slash`!!
        }
        `_cigarette-slash` = Builder(name = "Cigarette-slash", defaultWidth = 256.0.dp,
...
private var `_cigarette-slash`: ImageVector? = null
