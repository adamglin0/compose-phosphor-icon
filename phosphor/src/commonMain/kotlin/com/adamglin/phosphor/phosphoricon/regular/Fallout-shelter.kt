...
public val RegularGroup.`Fallout-shelter`: ImageVector
    get() {
        if (`_fallout-shelter` != null) {
            return `_fallout-shelter`!!
        }
        `_fallout-shelter` = Builder(name = "Fallout-shelter", defaultWidth = 256.0.dp,
...
private var `_fallout-shelter`: ImageVector? = null
