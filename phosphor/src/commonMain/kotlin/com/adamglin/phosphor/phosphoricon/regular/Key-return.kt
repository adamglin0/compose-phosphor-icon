...
public val RegularGroup.`Key-return`: ImageVector
    get() {
        if (`_key-return` != null) {
            return `_key-return`!!
        }
        `_key-return` = Builder(name = "Key-return", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_key-return`: ImageVector? = null
