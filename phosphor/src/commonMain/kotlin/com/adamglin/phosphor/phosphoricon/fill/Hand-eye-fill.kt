...
public val FillGroup.`Hand-eye-fill`: ImageVector
    get() {
        if (`_hand-eye-fill` != null) {
            return `_hand-eye-fill`!!
        }
        `_hand-eye-fill` = Builder(name = "Hand-eye-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-eye-fill`: ImageVector? = null
