...
public val RegularGroup.`File-ts`: ImageVector
    get() {
        if (`_file-ts` != null) {
            return `_file-ts`!!
        }
        `_file-ts` = Builder(name = "File-ts", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-ts`: ImageVector? = null
