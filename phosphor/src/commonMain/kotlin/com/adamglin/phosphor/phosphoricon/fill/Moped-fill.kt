...
public val FillGroup.`Moped-fill`: ImageVector
    get() {
        if (`_moped-fill` != null) {
            return `_moped-fill`!!
        }
        `_moped-fill` = Builder(name = "Moped-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_moped-fill`: ImageVector? = null
