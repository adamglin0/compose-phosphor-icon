...
public val RegularGroup.`Finn-the-human`: ImageVector
    get() {
        if (`_finn-the-human` != null) {
            return `_finn-the-human`!!
        }
        `_finn-the-human` = Builder(name = "Finn-the-human", defaultWidth = 256.0.dp, defaultHeight
...
private var `_finn-the-human`: ImageVector? = null
