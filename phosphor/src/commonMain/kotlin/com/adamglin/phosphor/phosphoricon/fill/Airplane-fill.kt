...
public val FillGroup.`Airplane-fill`: ImageVector
    get() {
        if (`_airplane-fill` != null) {
            return `_airplane-fill`!!
        }
        `_airplane-fill` = Builder(name = "Airplane-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_airplane-fill`: ImageVector? = null
