...
public val RegularGroup.`Presentation-chart`: ImageVector
    get() {
        if (`_presentation-chart` != null) {
            return `_presentation-chart`!!
        }
        `_presentation-chart` = Builder(name = "Presentation-chart", defaultWidth = 256.0.dp,
...
private var `_presentation-chart`: ImageVector? = null
