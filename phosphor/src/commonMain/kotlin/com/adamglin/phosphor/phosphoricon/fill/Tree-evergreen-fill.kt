...
public val FillGroup.`Tree-evergreen-fill`: ImageVector
    get() {
        if (`_tree-evergreen-fill` != null) {
            return `_tree-evergreen-fill`!!
        }
        `_tree-evergreen-fill` = Builder(name = "Tree-evergreen-fill", defaultWidth = 256.0.dp,
...
private var `_tree-evergreen-fill`: ImageVector? = null
