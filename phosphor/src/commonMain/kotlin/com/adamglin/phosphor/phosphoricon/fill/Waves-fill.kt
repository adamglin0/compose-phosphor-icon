...
public val FillGroup.`Waves-fill`: ImageVector
    get() {
        if (`_waves-fill` != null) {
            return `_waves-fill`!!
        }
        `_waves-fill` = Builder(name = "Waves-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_waves-fill`: ImageVector? = null
