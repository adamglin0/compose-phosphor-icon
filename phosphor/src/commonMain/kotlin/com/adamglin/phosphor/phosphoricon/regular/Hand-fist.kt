...
public val RegularGroup.`Hand-fist`: ImageVector
    get() {
        if (`_hand-fist` != null) {
            return `_hand-fist`!!
        }
        `_hand-fist` = Builder(name = "Hand-fist", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-fist`: ImageVector? = null
