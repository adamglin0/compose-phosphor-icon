...
public val RegularGroup.`Cell-signal-full`: ImageVector
    get() {
        if (`_cell-signal-full` != null) {
            return `_cell-signal-full`!!
        }
        `_cell-signal-full` = Builder(name = "Cell-signal-full", defaultWidth = 256.0.dp,
...
private var `_cell-signal-full`: ImageVector? = null
