...
public val RegularGroup.`Apple-logo`: ImageVector
    get() {
        if (`_apple-logo` != null) {
            return `_apple-logo`!!
        }
        `_apple-logo` = Builder(name = "Apple-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_apple-logo`: ImageVector? = null
