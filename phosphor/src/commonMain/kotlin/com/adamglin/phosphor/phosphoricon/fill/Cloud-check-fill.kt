...
public val FillGroup.`Cloud-check-fill`: ImageVector
    get() {
        if (`_cloud-check-fill` != null) {
            return `_cloud-check-fill`!!
        }
        `_cloud-check-fill` = Builder(name = "Cloud-check-fill", defaultWidth = 256.0.dp,
...
private var `_cloud-check-fill`: ImageVector? = null
