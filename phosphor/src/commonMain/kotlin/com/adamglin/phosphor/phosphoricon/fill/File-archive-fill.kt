...
public val FillGroup.`File-archive-fill`: ImageVector
    get() {
        if (`_file-archive-fill` != null) {
            return `_file-archive-fill`!!
        }
        `_file-archive-fill` = Builder(name = "File-archive-fill", defaultWidth = 256.0.dp,
...
private var `_file-archive-fill`: ImageVector? = null
