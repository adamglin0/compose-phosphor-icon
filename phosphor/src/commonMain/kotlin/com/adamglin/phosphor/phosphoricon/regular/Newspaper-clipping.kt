...
public val RegularGroup.`Newspaper-clipping`: ImageVector
    get() {
        if (`_newspaper-clipping` != null) {
            return `_newspaper-clipping`!!
        }
        `_newspaper-clipping` = Builder(name = "Newspaper-clipping", defaultWidth = 256.0.dp,
...
private var `_newspaper-clipping`: ImageVector? = null
