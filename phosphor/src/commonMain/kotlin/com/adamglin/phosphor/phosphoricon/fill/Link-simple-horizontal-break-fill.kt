...
public val FillGroup.`Link-simple-horizontal-break-fill`: ImageVector
    get() {
        if (`_link-simple-horizontal-break-fill` != null) {
            return `_link-simple-horizontal-break-fill`!!
        }
        `_link-simple-horizontal-break-fill` = Builder(name = "Link-simple-horizontal-break-fill",
...
private var `_link-simple-horizontal-break-fill`: ImageVector? = null
