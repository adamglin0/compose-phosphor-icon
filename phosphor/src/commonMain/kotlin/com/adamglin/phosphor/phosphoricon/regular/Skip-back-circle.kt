...
public val RegularGroup.`Skip-back-circle`: ImageVector
    get() {
        if (`_skip-back-circle` != null) {
            return `_skip-back-circle`!!
        }
        `_skip-back-circle` = Builder(name = "Skip-back-circle", defaultWidth = 256.0.dp,
...
private var `_skip-back-circle`: ImageVector? = null
