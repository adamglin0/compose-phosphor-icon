...
public val RegularGroup.`Chat-circle-slash`: ImageVector
    get() {
        if (`_chat-circle-slash` != null) {
            return `_chat-circle-slash`!!
        }
        `_chat-circle-slash` = Builder(name = "Chat-circle-slash", defaultWidth = 256.0.dp,
...
private var `_chat-circle-slash`: ImageVector? = null
