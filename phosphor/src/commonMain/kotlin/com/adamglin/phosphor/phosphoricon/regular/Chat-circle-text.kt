...
public val RegularGroup.`Chat-circle-text`: ImageVector
    get() {
        if (`_chat-circle-text` != null) {
            return `_chat-circle-text`!!
        }
        `_chat-circle-text` = Builder(name = "Chat-circle-text", defaultWidth = 256.0.dp,
...
private var `_chat-circle-text`: ImageVector? = null
