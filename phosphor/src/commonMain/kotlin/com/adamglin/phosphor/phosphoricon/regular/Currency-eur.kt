...
public val RegularGroup.`Currency-eur`: ImageVector
    get() {
        if (`_currency-eur` != null) {
            return `_currency-eur`!!
        }
        `_currency-eur` = Builder(name = "Currency-eur", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_currency-eur`: ImageVector? = null
