...
public val RegularGroup.`Pencil-slash`: ImageVector
    get() {
        if (`_pencil-slash` != null) {
            return `_pencil-slash`!!
        }
        `_pencil-slash` = Builder(name = "Pencil-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pencil-slash`: ImageVector? = null
