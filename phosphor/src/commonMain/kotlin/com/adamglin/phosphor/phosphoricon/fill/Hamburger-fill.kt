...
public val FillGroup.`Hamburger-fill`: ImageVector
    get() {
        if (`_hamburger-fill` != null) {
            return `_hamburger-fill`!!
        }
        `_hamburger-fill` = Builder(name = "Hamburger-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_hamburger-fill`: ImageVector? = null
