...
public val FillGroup.`Chat-centered-dots-fill`: ImageVector
    get() {
        if (`_chat-centered-dots-fill` != null) {
            return `_chat-centered-dots-fill`!!
        }
        `_chat-centered-dots-fill` = Builder(name = "Chat-centered-dots-fill", defaultWidth =
...
private var `_chat-centered-dots-fill`: ImageVector? = null
