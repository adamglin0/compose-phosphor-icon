...
public val FillGroup.`Cube-fill`: ImageVector
    get() {
        if (`_cube-fill` != null) {
            return `_cube-fill`!!
        }
        `_cube-fill` = Builder(name = "Cube-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cube-fill`: ImageVector? = null
