...
public val FillGroup.`Corners-in-fill`: ImageVector
    get() {
        if (`_corners-in-fill` != null) {
            return `_corners-in-fill`!!
        }
        `_corners-in-fill` = Builder(name = "Corners-in-fill", defaultWidth = 256.0.dp,
...
private var `_corners-in-fill`: ImageVector? = null
