...
public val FillGroup.`Faders-fill`: ImageVector
    get() {
        if (`_faders-fill` != null) {
            return `_faders-fill`!!
        }
        `_faders-fill` = Builder(name = "Faders-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_faders-fill`: ImageVector? = null
