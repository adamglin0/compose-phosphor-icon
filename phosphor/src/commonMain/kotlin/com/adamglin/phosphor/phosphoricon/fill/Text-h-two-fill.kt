...
public val FillGroup.`Text-h-two-fill`: ImageVector
    get() {
        if (`_text-h-two-fill` != null) {
            return `_text-h-two-fill`!!
        }
        `_text-h-two-fill` = Builder(name = "Text-h-two-fill", defaultWidth = 256.0.dp,
...
private var `_text-h-two-fill`: ImageVector? = null
