...
public val RegularGroup.`Person-simple-snowboard`: ImageVector
    get() {
        if (`_person-simple-snowboard` != null) {
            return `_person-simple-snowboard`!!
        }
        `_person-simple-snowboard` = Builder(name = "Person-simple-snowboard", defaultWidth =
...
private var `_person-simple-snowboard`: ImageVector? = null
