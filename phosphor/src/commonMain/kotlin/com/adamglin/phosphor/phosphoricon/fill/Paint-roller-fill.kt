...
public val FillGroup.`Paint-roller-fill`: ImageVector
    get() {
        if (`_paint-roller-fill` != null) {
            return `_paint-roller-fill`!!
        }
        `_paint-roller-fill` = Builder(name = "Paint-roller-fill", defaultWidth = 256.0.dp,
...
private var `_paint-roller-fill`: ImageVector? = null
