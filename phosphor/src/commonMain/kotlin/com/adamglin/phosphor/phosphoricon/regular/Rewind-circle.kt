...
public val RegularGroup.`Rewind-circle`: ImageVector
    get() {
        if (`_rewind-circle` != null) {
            return `_rewind-circle`!!
        }
        `_rewind-circle` = Builder(name = "Rewind-circle", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_rewind-circle`: ImageVector? = null
