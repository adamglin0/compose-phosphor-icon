...
public val FillGroup.`Tea-bag-fill`: ImageVector
    get() {
        if (`_tea-bag-fill` != null) {
            return `_tea-bag-fill`!!
        }
        `_tea-bag-fill` = Builder(name = "Tea-bag-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tea-bag-fill`: ImageVector? = null
