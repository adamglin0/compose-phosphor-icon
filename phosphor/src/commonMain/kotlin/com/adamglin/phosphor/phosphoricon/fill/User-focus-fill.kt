...
public val FillGroup.`User-focus-fill`: ImageVector
    get() {
        if (`_user-focus-fill` != null) {
            return `_user-focus-fill`!!
        }
        `_user-focus-fill` = Builder(name = "User-focus-fill", defaultWidth = 256.0.dp,
...
private var `_user-focus-fill`: ImageVector? = null
