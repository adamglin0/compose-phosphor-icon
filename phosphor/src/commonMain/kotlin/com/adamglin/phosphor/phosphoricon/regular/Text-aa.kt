...
public val RegularGroup.`Text-aa`: ImageVector
    get() {
        if (`_text-aa` != null) {
            return `_text-aa`!!
        }
        `_text-aa` = Builder(name = "Text-aa", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_text-aa`: ImageVector? = null
