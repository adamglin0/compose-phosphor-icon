...
public val RegularGroup.`Chat-teardrop-slash`: ImageVector
    get() {
        if (`_chat-teardrop-slash` != null) {
            return `_chat-teardrop-slash`!!
        }
        `_chat-teardrop-slash` = Builder(name = "Chat-teardrop-slash", defaultWidth = 256.0.dp,
...
private var `_chat-teardrop-slash`: ImageVector? = null
