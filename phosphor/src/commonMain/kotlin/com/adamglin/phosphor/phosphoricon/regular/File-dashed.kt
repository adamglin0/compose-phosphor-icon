...
public val RegularGroup.`File-dashed`: ImageVector
    get() {
        if (`_file-dashed` != null) {
            return `_file-dashed`!!
        }
        `_file-dashed` = Builder(name = "File-dashed", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-dashed`: ImageVector? = null
