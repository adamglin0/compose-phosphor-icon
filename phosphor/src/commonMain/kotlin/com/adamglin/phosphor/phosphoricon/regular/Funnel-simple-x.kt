...
public val RegularGroup.`Funnel-simple-x`: ImageVector
    get() {
        if (`_funnel-simple-x` != null) {
            return `_funnel-simple-x`!!
        }
        `_funnel-simple-x` = Builder(name = "Funnel-simple-x", defaultWidth = 256.0.dp,
...
private var `_funnel-simple-x`: ImageVector? = null
