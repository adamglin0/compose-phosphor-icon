...
public val FillGroup.`Flag-banner-fold-fill`: ImageVector
    get() {
        if (`_flag-banner-fold-fill` != null) {
            return `_flag-banner-fold-fill`!!
        }
        `_flag-banner-fold-fill` = Builder(name = "Flag-banner-fold-fill", defaultWidth = 256.0.dp,
...
private var `_flag-banner-fold-fill`: ImageVector? = null
