...
public val FillGroup.`Phone-transfer-fill`: ImageVector
    get() {
        if (`_phone-transfer-fill` != null) {
            return `_phone-transfer-fill`!!
        }
        `_phone-transfer-fill` = Builder(name = "Phone-transfer-fill", defaultWidth = 256.0.dp,
...
private var `_phone-transfer-fill`: ImageVector? = null
