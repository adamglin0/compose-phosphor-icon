...
public val FillGroup.`Orange-slice-fill`: ImageVector
    get() {
        if (`_orange-slice-fill` != null) {
            return `_orange-slice-fill`!!
        }
        `_orange-slice-fill` = Builder(name = "Orange-slice-fill", defaultWidth = 256.0.dp,
...
private var `_orange-slice-fill`: ImageVector? = null
