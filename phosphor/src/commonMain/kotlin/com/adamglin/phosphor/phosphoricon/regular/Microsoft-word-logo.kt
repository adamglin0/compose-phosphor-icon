...
public val RegularGroup.`Microsoft-word-logo`: ImageVector
    get() {
        if (`_microsoft-word-logo` != null) {
            return `_microsoft-word-logo`!!
        }
        `_microsoft-word-logo` = Builder(name = "Microsoft-word-logo", defaultWidth = 256.0.dp,
...
private var `_microsoft-word-logo`: ImageVector? = null
