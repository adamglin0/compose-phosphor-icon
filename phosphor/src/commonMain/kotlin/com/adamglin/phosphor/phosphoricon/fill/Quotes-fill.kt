...
public val FillGroup.`Quotes-fill`: ImageVector
    get() {
        if (`_quotes-fill` != null) {
            return `_quotes-fill`!!
        }
        `_quotes-fill` = Builder(name = "Quotes-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_quotes-fill`: ImageVector? = null
