...
public val FillGroup.`Network-x-fill`: ImageVector
    get() {
        if (`_network-x-fill` != null) {
            return `_network-x-fill`!!
        }
        `_network-x-fill` = Builder(name = "Network-x-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_network-x-fill`: ImageVector? = null
