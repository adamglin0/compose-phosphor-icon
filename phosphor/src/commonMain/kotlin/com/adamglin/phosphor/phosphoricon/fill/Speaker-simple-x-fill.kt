...
public val FillGroup.`Speaker-simple-x-fill`: ImageVector
    get() {
        if (`_speaker-simple-x-fill` != null) {
            return `_speaker-simple-x-fill`!!
        }
        `_speaker-simple-x-fill` = Builder(name = "Speaker-simple-x-fill", defaultWidth = 256.0.dp,
...
private var `_speaker-simple-x-fill`: ImageVector? = null
