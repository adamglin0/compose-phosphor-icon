...
public val FillGroup.`Number-square-zero-fill`: ImageVector
    get() {
        if (`_number-square-zero-fill` != null) {
            return `_number-square-zero-fill`!!
        }
        `_number-square-zero-fill` = Builder(name = "Number-square-zero-fill", defaultWidth =
...
private var `_number-square-zero-fill`: ImageVector? = null
