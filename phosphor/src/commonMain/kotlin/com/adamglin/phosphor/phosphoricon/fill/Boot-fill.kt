...
public val FillGroup.`Boot-fill`: ImageVector
    get() {
        if (`_boot-fill` != null) {
            return `_boot-fill`!!
        }
        `_boot-fill` = Builder(name = "Boot-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_boot-fill`: ImageVector? = null
