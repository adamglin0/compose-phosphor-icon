...
public val RegularGroup.`Phone-disconnect`: ImageVector
    get() {
        if (`_phone-disconnect` != null) {
            return `_phone-disconnect`!!
        }
        `_phone-disconnect` = Builder(name = "Phone-disconnect", defaultWidth = 256.0.dp,
...
private var `_phone-disconnect`: ImageVector? = null
