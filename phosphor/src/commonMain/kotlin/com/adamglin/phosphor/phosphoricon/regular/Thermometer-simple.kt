...
public val RegularGroup.`Thermometer-simple`: ImageVector
    get() {
        if (`_thermometer-simple` != null) {
            return `_thermometer-simple`!!
        }
        `_thermometer-simple` = Builder(name = "Thermometer-simple", defaultWidth = 256.0.dp,
...
private var `_thermometer-simple`: ImageVector? = null
