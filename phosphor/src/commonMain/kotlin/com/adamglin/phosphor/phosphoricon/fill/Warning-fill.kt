...
public val FillGroup.`Warning-fill`: ImageVector
    get() {
        if (`_warning-fill` != null) {
            return `_warning-fill`!!
        }
        `_warning-fill` = Builder(name = "Warning-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_warning-fill`: ImageVector? = null
