...
public val RegularGroup.`Chat-teardrop-dots`: ImageVector
    get() {
        if (`_chat-teardrop-dots` != null) {
            return `_chat-teardrop-dots`!!
        }
        `_chat-teardrop-dots` = Builder(name = "Chat-teardrop-dots", defaultWidth = 256.0.dp,
...
private var `_chat-teardrop-dots`: ImageVector? = null
