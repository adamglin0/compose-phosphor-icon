...
public val RegularGroup.`Number-square-two`: ImageVector
    get() {
        if (`_number-square-two` != null) {
            return `_number-square-two`!!
        }
        `_number-square-two` = Builder(name = "Number-square-two", defaultWidth = 256.0.dp,
...
private var `_number-square-two`: ImageVector? = null
