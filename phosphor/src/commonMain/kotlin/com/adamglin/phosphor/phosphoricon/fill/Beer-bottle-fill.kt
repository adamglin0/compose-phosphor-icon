...
public val FillGroup.`Beer-bottle-fill`: ImageVector
    get() {
        if (`_beer-bottle-fill` != null) {
            return `_beer-bottle-fill`!!
        }
        `_beer-bottle-fill` = Builder(name = "Beer-bottle-fill", defaultWidth = 256.0.dp,
...
private var `_beer-bottle-fill`: ImageVector? = null
