...
public val FillGroup.`Eyedropper-fill`: ImageVector
    get() {
        if (`_eyedropper-fill` != null) {
            return `_eyedropper-fill`!!
        }
        `_eyedropper-fill` = Builder(name = "Eyedropper-fill", defaultWidth = 256.0.dp,
...
private var `_eyedropper-fill`: ImageVector? = null
