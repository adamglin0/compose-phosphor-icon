...
public val RegularGroup.`File-c-sharp`: ImageVector
    get() {
        if (`_file-c-sharp` != null) {
            return `_file-c-sharp`!!
        }
        `_file-c-sharp` = Builder(name = "File-c-sharp", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-c-sharp`: ImageVector? = null
