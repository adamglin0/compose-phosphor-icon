...
public val RegularGroup.`Meta-logo`: ImageVector
    get() {
        if (`_meta-logo` != null) {
            return `_meta-logo`!!
        }
        `_meta-logo` = Builder(name = "Meta-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_meta-logo`: ImageVector? = null
