...
public val FillGroup.`Sketch-logo-fill`: ImageVector
    get() {
        if (`_sketch-logo-fill` != null) {
            return `_sketch-logo-fill`!!
        }
        `_sketch-logo-fill` = Builder(name = "Sketch-logo-fill", defaultWidth = 256.0.dp,
...
private var `_sketch-logo-fill`: ImageVector? = null
