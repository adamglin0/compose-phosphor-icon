...
public val RegularGroup.`Number-square-nine`: ImageVector
    get() {
        if (`_number-square-nine` != null) {
            return `_number-square-nine`!!
        }
        `_number-square-nine` = Builder(name = "Number-square-nine", defaultWidth = 256.0.dp,
...
private var `_number-square-nine`: ImageVector? = null
