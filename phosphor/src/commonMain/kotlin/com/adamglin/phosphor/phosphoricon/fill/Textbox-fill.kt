...
public val FillGroup.`Textbox-fill`: ImageVector
    get() {
        if (`_textbox-fill` != null) {
            return `_textbox-fill`!!
        }
        `_textbox-fill` = Builder(name = "Textbox-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_textbox-fill`: ImageVector? = null
