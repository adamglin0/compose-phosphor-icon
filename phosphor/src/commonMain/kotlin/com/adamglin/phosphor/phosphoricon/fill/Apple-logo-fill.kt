...
public val FillGroup.`Apple-logo-fill`: ImageVector
    get() {
        if (`_apple-logo-fill` != null) {
            return `_apple-logo-fill`!!
        }
        `_apple-logo-fill` = Builder(name = "Apple-logo-fill", defaultWidth = 256.0.dp,
...
private var `_apple-logo-fill`: ImageVector? = null
