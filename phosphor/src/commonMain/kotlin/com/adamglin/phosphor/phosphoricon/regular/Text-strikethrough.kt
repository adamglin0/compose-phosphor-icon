...
public val RegularGroup.`Text-strikethrough`: ImageVector
    get() {
        if (`_text-strikethrough` != null) {
            return `_text-strikethrough`!!
        }
        `_text-strikethrough` = Builder(name = "Text-strikethrough", defaultWidth = 256.0.dp,
...
private var `_text-strikethrough`: ImageVector? = null
