...
public val FillGroup.`Puzzle-piece-fill`: ImageVector
    get() {
        if (`_puzzle-piece-fill` != null) {
            return `_puzzle-piece-fill`!!
        }
        `_puzzle-piece-fill` = Builder(name = "Puzzle-piece-fill", defaultWidth = 256.0.dp,
...
private var `_puzzle-piece-fill`: ImageVector? = null
