...
public val RegularGroup.`Apple-podcasts-logo`: ImageVector
    get() {
        if (`_apple-podcasts-logo` != null) {
            return `_apple-podcasts-logo`!!
        }
        `_apple-podcasts-logo` = Builder(name = "Apple-podcasts-logo", defaultWidth = 256.0.dp,
...
private var `_apple-podcasts-logo`: ImageVector? = null
