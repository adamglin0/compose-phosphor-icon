...
public val RegularGroup.`Columns-plus-right`: ImageVector
    get() {
        if (`_columns-plus-right` != null) {
            return `_columns-plus-right`!!
        }
        `_columns-plus-right` = Builder(name = "Columns-plus-right", defaultWidth = 256.0.dp,
...
private var `_columns-plus-right`: ImageVector? = null
