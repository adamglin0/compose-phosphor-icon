...
public val RegularGroup.`Codesandbox-logo`: ImageVector
    get() {
        if (`_codesandbox-logo` != null) {
            return `_codesandbox-logo`!!
        }
        `_codesandbox-logo` = Builder(name = "Codesandbox-logo", defaultWidth = 256.0.dp,
...
private var `_codesandbox-logo`: ImageVector? = null
