...
public val FillGroup.`Scribble-loop-fill`: ImageVector
    get() {
        if (`_scribble-loop-fill` != null) {
            return `_scribble-loop-fill`!!
        }
        `_scribble-loop-fill` = Builder(name = "Scribble-loop-fill", defaultWidth = 256.0.dp,
...
private var `_scribble-loop-fill`: ImageVector? = null
