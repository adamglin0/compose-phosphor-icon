...
public val FillGroup.`Dresser-fill`: ImageVector
    get() {
        if (`_dresser-fill` != null) {
            return `_dresser-fill`!!
        }
        `_dresser-fill` = Builder(name = "Dresser-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dresser-fill`: ImageVector? = null
