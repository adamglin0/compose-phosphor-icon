...
public val RegularGroup.`Speaker-simple-none`: ImageVector
    get() {
        if (`_speaker-simple-none` != null) {
            return `_speaker-simple-none`!!
        }
        `_speaker-simple-none` = Builder(name = "Speaker-simple-none", defaultWidth = 256.0.dp,
...
private var `_speaker-simple-none`: ImageVector? = null
