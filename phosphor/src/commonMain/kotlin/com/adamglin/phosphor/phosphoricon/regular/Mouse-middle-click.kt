...
public val RegularGroup.`Mouse-middle-click`: ImageVector
    get() {
        if (`_mouse-middle-click` != null) {
            return `_mouse-middle-click`!!
        }
        `_mouse-middle-click` = Builder(name = "Mouse-middle-click", defaultWidth = 256.0.dp,
...
private var `_mouse-middle-click`: ImageVector? = null
