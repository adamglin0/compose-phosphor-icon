...
public val FillGroup.`Video-conference-fill`: ImageVector
    get() {
        if (`_video-conference-fill` != null) {
            return `_video-conference-fill`!!
        }
        `_video-conference-fill` = Builder(name = "Video-conference-fill", defaultWidth = 256.0.dp,
...
private var `_video-conference-fill`: ImageVector? = null
