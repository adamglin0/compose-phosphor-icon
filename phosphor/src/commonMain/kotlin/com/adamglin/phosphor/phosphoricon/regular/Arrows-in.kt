...
public val RegularGroup.`Arrows-in`: ImageVector
    get() {
        if (`_arrows-in` != null) {
            return `_arrows-in`!!
        }
        `_arrows-in` = Builder(name = "Arrows-in", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_arrows-in`: ImageVector? = null
