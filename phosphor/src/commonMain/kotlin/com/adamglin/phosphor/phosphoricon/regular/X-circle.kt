...
public val RegularGroup.`X-circle`: ImageVector
    get() {
        if (`_x-circle` != null) {
            return `_x-circle`!!
        }
        `_x-circle` = Builder(name = "X-circle", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_x-circle`: ImageVector? = null
