...
public val FillGroup.`Lamp-fill`: ImageVector
    get() {
        if (`_lamp-fill` != null) {
            return `_lamp-fill`!!
        }
        `_lamp-fill` = Builder(name = "Lamp-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lamp-fill`: ImageVector? = null
