...
public val RegularGroup.`Tree-palm`: ImageVector
    get() {
        if (`_tree-palm` != null) {
            return `_tree-palm`!!
        }
        `_tree-palm` = Builder(name = "Tree-palm", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tree-palm`: ImageVector? = null
