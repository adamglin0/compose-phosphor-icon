...
public val RegularGroup.`Phone-incoming`: ImageVector
    get() {
        if (`_phone-incoming` != null) {
            return `_phone-incoming`!!
        }
        `_phone-incoming` = Builder(name = "Phone-incoming", defaultWidth = 256.0.dp, defaultHeight
...
private var `_phone-incoming`: ImageVector? = null
