...
public val FillGroup.`Person-simple-ski-fill`: ImageVector
    get() {
        if (`_person-simple-ski-fill` != null) {
            return `_person-simple-ski-fill`!!
        }
        `_person-simple-ski-fill` = Builder(name = "Person-simple-ski-fill", defaultWidth =
...
private var `_person-simple-ski-fill`: ImageVector? = null
