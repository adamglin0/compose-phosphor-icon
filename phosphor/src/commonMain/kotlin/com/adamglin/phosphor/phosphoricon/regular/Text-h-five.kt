...
public val RegularGroup.`Text-h-five`: ImageVector
    get() {
        if (`_text-h-five` != null) {
            return `_text-h-five`!!
        }
        `_text-h-five` = Builder(name = "Text-h-five", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-h-five`: ImageVector? = null
