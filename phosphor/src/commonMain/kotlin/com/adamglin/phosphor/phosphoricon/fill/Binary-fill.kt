...
public val FillGroup.`Binary-fill`: ImageVector
    get() {
        if (`_binary-fill` != null) {
            return `_binary-fill`!!
        }
        `_binary-fill` = Builder(name = "Binary-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_binary-fill`: ImageVector? = null
