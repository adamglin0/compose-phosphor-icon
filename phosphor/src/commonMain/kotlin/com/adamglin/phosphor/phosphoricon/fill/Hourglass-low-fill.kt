...
public val FillGroup.`Hourglass-low-fill`: ImageVector
    get() {
        if (`_hourglass-low-fill` != null) {
            return `_hourglass-low-fill`!!
        }
        `_hourglass-low-fill` = Builder(name = "Hourglass-low-fill", defaultWidth = 256.0.dp,
...
private var `_hourglass-low-fill`: ImageVector? = null
