...
public val FillGroup.`Microsoft-word-logo-fill`: ImageVector
    get() {
        if (`_microsoft-word-logo-fill` != null) {
            return `_microsoft-word-logo-fill`!!
        }
        `_microsoft-word-logo-fill` = Builder(name = "Microsoft-word-logo-fill", defaultWidth =
...
private var `_microsoft-word-logo-fill`: ImageVector? = null
