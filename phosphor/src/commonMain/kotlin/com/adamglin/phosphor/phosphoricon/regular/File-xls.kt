...
public val RegularGroup.`File-xls`: ImageVector
    get() {
        if (`_file-xls` != null) {
            return `_file-xls`!!
        }
        `_file-xls` = Builder(name = "File-xls", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-xls`: ImageVector? = null
