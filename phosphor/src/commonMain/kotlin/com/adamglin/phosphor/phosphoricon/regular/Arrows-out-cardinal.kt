...
public val RegularGroup.`Arrows-out-cardinal`: ImageVector
    get() {
        if (`_arrows-out-cardinal` != null) {
            return `_arrows-out-cardinal`!!
        }
        `_arrows-out-cardinal` = Builder(name = "Arrows-out-cardinal", defaultWidth = 256.0.dp,
...
private var `_arrows-out-cardinal`: ImageVector? = null
