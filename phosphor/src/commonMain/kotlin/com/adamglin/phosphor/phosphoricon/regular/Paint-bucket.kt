...
public val RegularGroup.`Paint-bucket`: ImageVector
    get() {
        if (`_paint-bucket` != null) {
            return `_paint-bucket`!!
        }
        `_paint-bucket` = Builder(name = "Paint-bucket", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_paint-bucket`: ImageVector? = null
