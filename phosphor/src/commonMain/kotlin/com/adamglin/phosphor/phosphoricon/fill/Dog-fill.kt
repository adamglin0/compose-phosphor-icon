...
public val FillGroup.`Dog-fill`: ImageVector
    get() {
        if (`_dog-fill` != null) {
            return `_dog-fill`!!
        }
        `_dog-fill` = Builder(name = "Dog-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dog-fill`: ImageVector? = null
