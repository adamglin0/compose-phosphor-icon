...
public val FillGroup.`Microphone-stage-fill`: ImageVector
    get() {
        if (`_microphone-stage-fill` != null) {
            return `_microphone-stage-fill`!!
        }
        `_microphone-stage-fill` = Builder(name = "Microphone-stage-fill", defaultWidth = 256.0.dp,
...
private var `_microphone-stage-fill`: ImageVector? = null
