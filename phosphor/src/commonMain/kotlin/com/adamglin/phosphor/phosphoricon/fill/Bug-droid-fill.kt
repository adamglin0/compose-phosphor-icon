...
public val FillGroup.`Bug-droid-fill`: ImageVector
    get() {
        if (`_bug-droid-fill` != null) {
            return `_bug-droid-fill`!!
        }
        `_bug-droid-fill` = Builder(name = "Bug-droid-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_bug-droid-fill`: ImageVector? = null
