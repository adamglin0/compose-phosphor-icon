...
public val RegularGroup.`Potted-plant`: ImageVector
    get() {
        if (`_potted-plant` != null) {
            return `_potted-plant`!!
        }
        `_potted-plant` = Builder(name = "Potted-plant", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_potted-plant`: ImageVector? = null
