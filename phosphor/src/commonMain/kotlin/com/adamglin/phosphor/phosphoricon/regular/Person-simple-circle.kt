...
public val RegularGroup.`Person-simple-circle`: ImageVector
    get() {
        if (`_person-simple-circle` != null) {
            return `_person-simple-circle`!!
        }
        `_person-simple-circle` = Builder(name = "Person-simple-circle", defaultWidth = 256.0.dp,
...
private var `_person-simple-circle`: ImageVector? = null
