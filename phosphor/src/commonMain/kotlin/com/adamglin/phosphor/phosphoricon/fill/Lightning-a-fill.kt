...
public val FillGroup.`Lightning-a-fill`: ImageVector
    get() {
        if (`_lightning-a-fill` != null) {
            return `_lightning-a-fill`!!
        }
        `_lightning-a-fill` = Builder(name = "Lightning-a-fill", defaultWidth = 256.0.dp,
...
private var `_lightning-a-fill`: ImageVector? = null
