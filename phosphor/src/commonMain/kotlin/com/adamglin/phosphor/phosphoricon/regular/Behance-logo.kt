...
public val RegularGroup.`Behance-logo`: ImageVector
    get() {
        if (`_behance-logo` != null) {
            return `_behance-logo`!!
        }
        `_behance-logo` = Builder(name = "Behance-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_behance-logo`: ImageVector? = null
