...
public val FillGroup.`Link-simple-horizontal-fill`: ImageVector
    get() {
        if (`_link-simple-horizontal-fill` != null) {
            return `_link-simple-horizontal-fill`!!
        }
        `_link-simple-horizontal-fill` = Builder(name = "Link-simple-horizontal-fill", defaultWidth
...
private var `_link-simple-horizontal-fill`: ImageVector? = null
