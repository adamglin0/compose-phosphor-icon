...
public val FillGroup.`Currency-dollar-fill`: ImageVector
    get() {
        if (`_currency-dollar-fill` != null) {
            return `_currency-dollar-fill`!!
        }
        `_currency-dollar-fill` = Builder(name = "Currency-dollar-fill", defaultWidth = 256.0.dp,
...
private var `_currency-dollar-fill`: ImageVector? = null
