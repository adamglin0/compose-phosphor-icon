...
public val RegularGroup.`Check-square`: ImageVector
    get() {
        if (`_check-square` != null) {
            return `_check-square`!!
        }
        `_check-square` = Builder(name = "Check-square", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_check-square`: ImageVector? = null
