...
public val RegularGroup.`Currency-inr`: ImageVector
    get() {
        if (`_currency-inr` != null) {
            return `_currency-inr`!!
        }
        `_currency-inr` = Builder(name = "Currency-inr", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_currency-inr`: ImageVector? = null
