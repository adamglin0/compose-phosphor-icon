...
public val RegularGroup.`List-plus`: ImageVector
    get() {
        if (`_list-plus` != null) {
            return `_list-plus`!!
        }
        `_list-plus` = Builder(name = "List-plus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_list-plus`: ImageVector? = null
