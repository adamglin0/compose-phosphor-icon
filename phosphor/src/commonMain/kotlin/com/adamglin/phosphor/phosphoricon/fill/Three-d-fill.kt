...
public val FillGroup.`Three-d-fill`: ImageVector
    get() {
        if (`_three-d-fill` != null) {
            return `_three-d-fill`!!
        }
        `_three-d-fill` = Builder(name = "Three-d-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_three-d-fill`: ImageVector? = null
