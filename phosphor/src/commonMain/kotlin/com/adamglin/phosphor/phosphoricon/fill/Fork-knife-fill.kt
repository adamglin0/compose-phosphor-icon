...
public val FillGroup.`Fork-knife-fill`: ImageVector
    get() {
        if (`_fork-knife-fill` != null) {
            return `_fork-knife-fill`!!
        }
        `_fork-knife-fill` = Builder(name = "Fork-knife-fill", defaultWidth = 256.0.dp,
...
private var `_fork-knife-fill`: ImageVector? = null
