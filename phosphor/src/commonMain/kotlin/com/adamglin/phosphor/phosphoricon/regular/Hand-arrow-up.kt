...
public val RegularGroup.`Hand-arrow-up`: ImageVector
    get() {
        if (`_hand-arrow-up` != null) {
            return `_hand-arrow-up`!!
        }
        `_hand-arrow-up` = Builder(name = "Hand-arrow-up", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-arrow-up`: ImageVector? = null
