...
public val FillGroup.`Plugs-fill`: ImageVector
    get() {
        if (`_plugs-fill` != null) {
            return `_plugs-fill`!!
        }
        `_plugs-fill` = Builder(name = "Plugs-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_plugs-fill`: ImageVector? = null
