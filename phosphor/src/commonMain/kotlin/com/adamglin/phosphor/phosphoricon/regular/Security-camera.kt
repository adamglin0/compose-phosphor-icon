...
public val RegularGroup.`Security-camera`: ImageVector
    get() {
        if (`_security-camera` != null) {
            return `_security-camera`!!
        }
        `_security-camera` = Builder(name = "Security-camera", defaultWidth = 256.0.dp,
...
private var `_security-camera`: ImageVector? = null
