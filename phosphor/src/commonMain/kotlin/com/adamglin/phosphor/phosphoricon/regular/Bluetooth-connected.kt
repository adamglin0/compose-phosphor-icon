...
public val RegularGroup.`Bluetooth-connected`: ImageVector
    get() {
        if (`_bluetooth-connected` != null) {
            return `_bluetooth-connected`!!
        }
        `_bluetooth-connected` = Builder(name = "Bluetooth-connected", defaultWidth = 256.0.dp,
...
private var `_bluetooth-connected`: ImageVector? = null
