...
public val FillGroup.`Beanie-fill`: ImageVector
    get() {
        if (`_beanie-fill` != null) {
            return `_beanie-fill`!!
        }
        `_beanie-fill` = Builder(name = "Beanie-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_beanie-fill`: ImageVector? = null
