...
public val RegularGroup.`Folder-minus`: ImageVector
    get() {
        if (`_folder-minus` != null) {
            return `_folder-minus`!!
        }
        `_folder-minus` = Builder(name = "Folder-minus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folder-minus`: ImageVector? = null
