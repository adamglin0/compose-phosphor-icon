...
public val FillGroup.`Google-podcasts-logo-fill`: ImageVector
    get() {
        if (`_google-podcasts-logo-fill` != null) {
            return `_google-podcasts-logo-fill`!!
        }
        `_google-podcasts-logo-fill` = Builder(name = "Google-podcasts-logo-fill", defaultWidth =
...
private var `_google-podcasts-logo-fill`: ImageVector? = null
