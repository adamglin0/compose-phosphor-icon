...
public val RegularGroup.`Dice-three`: ImageVector
    get() {
        if (`_dice-three` != null) {
            return `_dice-three`!!
        }
        `_dice-three` = Builder(name = "Dice-three", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dice-three`: ImageVector? = null
