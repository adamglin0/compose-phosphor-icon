...
public val RegularGroup.`Flying-saucer`: ImageVector
    get() {
        if (`_flying-saucer` != null) {
            return `_flying-saucer`!!
        }
        `_flying-saucer` = Builder(name = "Flying-saucer", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flying-saucer`: ImageVector? = null
