...
public val RegularGroup.`Projector-screen-chart`: ImageVector
    get() {
        if (`_projector-screen-chart` != null) {
            return `_projector-screen-chart`!!
        }
        `_projector-screen-chart` = Builder(name = "Projector-screen-chart", defaultWidth =
...
private var `_projector-screen-chart`: ImageVector? = null
