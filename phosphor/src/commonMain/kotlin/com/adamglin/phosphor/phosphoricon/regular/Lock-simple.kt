...
public val RegularGroup.`Lock-simple`: ImageVector
    get() {
        if (`_lock-simple` != null) {
            return `_lock-simple`!!
        }
        `_lock-simple` = Builder(name = "Lock-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_lock-simple`: ImageVector? = null
