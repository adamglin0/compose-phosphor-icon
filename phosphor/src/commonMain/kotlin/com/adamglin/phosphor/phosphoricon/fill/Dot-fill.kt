...
public val FillGroup.`Dot-fill`: ImageVector
    get() {
        if (`_dot-fill` != null) {
            return `_dot-fill`!!
        }
        `_dot-fill` = Builder(name = "Dot-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dot-fill`: ImageVector? = null
