...
public val RegularGroup.`Open-ai-logo`: ImageVector
    get() {
        if (`_open-ai-logo` != null) {
            return `_open-ai-logo`!!
        }
        `_open-ai-logo` = Builder(name = "Open-ai-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_open-ai-logo`: ImageVector? = null
