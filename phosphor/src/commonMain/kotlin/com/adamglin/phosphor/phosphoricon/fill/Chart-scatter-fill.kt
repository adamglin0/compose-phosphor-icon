...
public val FillGroup.`Chart-scatter-fill`: ImageVector
    get() {
        if (`_chart-scatter-fill` != null) {
            return `_chart-scatter-fill`!!
        }
        `_chart-scatter-fill` = Builder(name = "Chart-scatter-fill", defaultWidth = 256.0.dp,
...
private var `_chart-scatter-fill`: ImageVector? = null
