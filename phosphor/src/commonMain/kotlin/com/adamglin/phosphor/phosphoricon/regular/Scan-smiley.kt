...
public val RegularGroup.`Scan-smiley`: ImageVector
    get() {
        if (`_scan-smiley` != null) {
            return `_scan-smiley`!!
        }
        `_scan-smiley` = Builder(name = "Scan-smiley", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_scan-smiley`: ImageVector? = null
