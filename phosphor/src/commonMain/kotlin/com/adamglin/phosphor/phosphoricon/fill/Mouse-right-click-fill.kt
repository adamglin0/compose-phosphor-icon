...
public val FillGroup.`Mouse-right-click-fill`: ImageVector
    get() {
        if (`_mouse-right-click-fill` != null) {
            return `_mouse-right-click-fill`!!
        }
        `_mouse-right-click-fill` = Builder(name = "Mouse-right-click-fill", defaultWidth =
...
private var `_mouse-right-click-fill`: ImageVector? = null
