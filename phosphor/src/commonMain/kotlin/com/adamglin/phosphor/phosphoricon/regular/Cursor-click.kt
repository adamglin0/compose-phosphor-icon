...
public val RegularGroup.`Cursor-click`: ImageVector
    get() {
        if (`_cursor-click` != null) {
            return `_cursor-click`!!
        }
        `_cursor-click` = Builder(name = "Cursor-click", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cursor-click`: ImageVector? = null
