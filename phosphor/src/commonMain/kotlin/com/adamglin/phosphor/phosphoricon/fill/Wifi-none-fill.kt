...
public val FillGroup.`Wifi-none-fill`: ImageVector
    get() {
        if (`_wifi-none-fill` != null) {
            return `_wifi-none-fill`!!
        }
        `_wifi-none-fill` = Builder(name = "Wifi-none-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_wifi-none-fill`: ImageVector? = null
