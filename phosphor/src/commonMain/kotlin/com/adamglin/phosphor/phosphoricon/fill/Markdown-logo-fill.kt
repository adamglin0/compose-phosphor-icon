...
public val FillGroup.`Markdown-logo-fill`: ImageVector
    get() {
        if (`_markdown-logo-fill` != null) {
            return `_markdown-logo-fill`!!
        }
        `_markdown-logo-fill` = Builder(name = "Markdown-logo-fill", defaultWidth = 256.0.dp,
...
private var `_markdown-logo-fill`: ImageVector? = null
