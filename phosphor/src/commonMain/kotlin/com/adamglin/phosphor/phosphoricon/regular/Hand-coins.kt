...
public val RegularGroup.`Hand-coins`: ImageVector
    get() {
        if (`_hand-coins` != null) {
            return `_hand-coins`!!
        }
        `_hand-coins` = Builder(name = "Hand-coins", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hand-coins`: ImageVector? = null
