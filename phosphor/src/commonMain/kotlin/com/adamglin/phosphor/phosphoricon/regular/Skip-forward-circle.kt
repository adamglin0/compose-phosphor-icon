...
public val RegularGroup.`Skip-forward-circle`: ImageVector
    get() {
        if (`_skip-forward-circle` != null) {
            return `_skip-forward-circle`!!
        }
        `_skip-forward-circle` = Builder(name = "Skip-forward-circle", defaultWidth = 256.0.dp,
...
private var `_skip-forward-circle`: ImageVector? = null
