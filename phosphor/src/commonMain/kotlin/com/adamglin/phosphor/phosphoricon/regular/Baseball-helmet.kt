...
public val RegularGroup.`Baseball-helmet`: ImageVector
    get() {
        if (`_baseball-helmet` != null) {
            return `_baseball-helmet`!!
        }
        `_baseball-helmet` = Builder(name = "Baseball-helmet", defaultWidth = 256.0.dp,
...
private var `_baseball-helmet`: ImageVector? = null
