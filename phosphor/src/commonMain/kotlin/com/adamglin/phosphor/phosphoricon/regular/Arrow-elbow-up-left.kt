...
public val RegularGroup.`Arrow-elbow-up-left`: ImageVector
    get() {
        if (`_arrow-elbow-up-left` != null) {
            return `_arrow-elbow-up-left`!!
        }
        `_arrow-elbow-up-left` = Builder(name = "Arrow-elbow-up-left", defaultWidth = 256.0.dp,
...
private var `_arrow-elbow-up-left`: ImageVector? = null
