...
public val FillGroup.`File-audio-fill`: ImageVector
    get() {
        if (`_file-audio-fill` != null) {
            return `_file-audio-fill`!!
        }
        `_file-audio-fill` = Builder(name = "File-audio-fill", defaultWidth = 256.0.dp,
...
private var `_file-audio-fill`: ImageVector? = null
