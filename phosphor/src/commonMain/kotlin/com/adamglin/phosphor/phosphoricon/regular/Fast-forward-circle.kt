...
public val RegularGroup.`Fast-forward-circle`: ImageVector
    get() {
        if (`_fast-forward-circle` != null) {
            return `_fast-forward-circle`!!
        }
        `_fast-forward-circle` = Builder(name = "Fast-forward-circle", defaultWidth = 256.0.dp,
...
private var `_fast-forward-circle`: ImageVector? = null
