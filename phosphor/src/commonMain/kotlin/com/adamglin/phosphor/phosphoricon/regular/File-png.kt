...
public val RegularGroup.`File-png`: ImageVector
    get() {
        if (`_file-png` != null) {
            return `_file-png`!!
        }
        `_file-png` = Builder(name = "File-png", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-png`: ImageVector? = null
