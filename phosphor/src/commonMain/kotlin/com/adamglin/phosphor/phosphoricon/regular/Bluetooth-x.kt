...
public val RegularGroup.`Bluetooth-x`: ImageVector
    get() {
        if (`_bluetooth-x` != null) {
            return `_bluetooth-x`!!
        }
        `_bluetooth-x` = Builder(name = "Bluetooth-x", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bluetooth-x`: ImageVector? = null
