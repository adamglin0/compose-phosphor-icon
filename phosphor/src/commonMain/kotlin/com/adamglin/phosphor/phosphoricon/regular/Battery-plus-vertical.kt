...
public val RegularGroup.`Battery-plus-vertical`: ImageVector
    get() {
        if (`_battery-plus-vertical` != null) {
            return `_battery-plus-vertical`!!
        }
        `_battery-plus-vertical` = Builder(name = "Battery-plus-vertical", defaultWidth = 256.0.dp,
...
private var `_battery-plus-vertical`: ImageVector? = null
