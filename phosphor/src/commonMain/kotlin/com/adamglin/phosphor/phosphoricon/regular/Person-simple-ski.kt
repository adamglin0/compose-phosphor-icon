...
public val RegularGroup.`Person-simple-ski`: ImageVector
    get() {
        if (`_person-simple-ski` != null) {
            return `_person-simple-ski`!!
        }
        `_person-simple-ski` = Builder(name = "Person-simple-ski", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(21.77f, 167.67f)
                arcToRelative(8.0f, 8.0f, 0.0f, true, true, 4.47f, -15.36f)
...
private var `_person-simple-ski`: ImageVector? = null
