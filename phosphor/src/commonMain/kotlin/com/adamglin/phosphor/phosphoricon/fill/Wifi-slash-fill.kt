...
public val FillGroup.`Wifi-slash-fill`: ImageVector
    get() {
        if (`_wifi-slash-fill` != null) {
            return `_wifi-slash-fill`!!
        }
        `_wifi-slash-fill` = Builder(name = "Wifi-slash-fill", defaultWidth = 256.0.dp,
...
private var `_wifi-slash-fill`: ImageVector? = null
