...
public val FillGroup.`Baby-carriage-fill`: ImageVector
    get() {
        if (`_baby-carriage-fill` != null) {
            return `_baby-carriage-fill`!!
        }
        `_baby-carriage-fill` = Builder(name = "Baby-carriage-fill", defaultWidth = 256.0.dp,
...
private var `_baby-carriage-fill`: ImageVector? = null
