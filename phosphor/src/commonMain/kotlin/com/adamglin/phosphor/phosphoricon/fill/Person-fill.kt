...
public val FillGroup.`Person-fill`: ImageVector
    get() {
        if (`_person-fill` != null) {
            return `_person-fill`!!
        }
        `_person-fill` = Builder(name = "Person-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_person-fill`: ImageVector? = null
