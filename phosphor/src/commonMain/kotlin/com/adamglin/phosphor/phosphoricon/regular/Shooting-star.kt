...
public val RegularGroup.`Shooting-star`: ImageVector
    get() {
        if (`_shooting-star` != null) {
            return `_shooting-star`!!
        }
        `_shooting-star` = Builder(name = "Shooting-star", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shooting-star`: ImageVector? = null
