...
public val FillGroup.`Text-indent-fill`: ImageVector
    get() {
        if (`_text-indent-fill` != null) {
            return `_text-indent-fill`!!
        }
        `_text-indent-fill` = Builder(name = "Text-indent-fill", defaultWidth = 256.0.dp,
...
private var `_text-indent-fill`: ImageVector? = null
