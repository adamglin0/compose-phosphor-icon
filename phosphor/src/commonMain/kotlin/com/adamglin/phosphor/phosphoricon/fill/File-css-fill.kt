...
public val FillGroup.`File-css-fill`: ImageVector
    get() {
        if (`_file-css-fill` != null) {
            return `_file-css-fill`!!
        }
        `_file-css-fill` = Builder(name = "File-css-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.2f, 8.2f, 0.0f, false, true, 10.9f, -0.91f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 0.81f, 11.81f)
                ...
                arcToRelative(30.0f, 30.0f, 0.0f, false, true, 21.38f, 9.19f)
                arcToRelative(8.26f, 8.26f, 0.0f, false, true, 0.74f, 11.09f)
...
private var `_file-css-fill`: ImageVector? = null
