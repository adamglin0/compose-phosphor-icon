...
public val RegularGroup.`Cowboy-hat`: ImageVector
    get() {
        if (`_cowboy-hat` != null) {
            return `_cowboy-hat`!!
        }
        `_cowboy-hat` = Builder(name = "Cowboy-hat", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cowboy-hat`: ImageVector? = null
