...
public val FillGroup.`Number-square-two-fill`: ImageVector
    get() {
        if (`_number-square-two-fill` != null) {
            return `_number-square-two-fill`!!
        }
        `_number-square-two-fill` = Builder(name = "Number-square-two-fill", defaultWidth =
...
private var `_number-square-two-fill`: ImageVector? = null
