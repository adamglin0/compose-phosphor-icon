...
public val RegularGroup.`Mouse-simple`: ImageVector
    get() {
        if (`_mouse-simple` != null) {
            return `_mouse-simple`!!
        }
        `_mouse-simple` = Builder(name = "Mouse-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mouse-simple`: ImageVector? = null
