...
public val RegularGroup.`User-circle-dashed`: ImageVector
    get() {
        if (`_user-circle-dashed` != null) {
            return `_user-circle-dashed`!!
        }
        `_user-circle-dashed` = Builder(name = "User-circle-dashed", defaultWidth = 256.0.dp,
...
private var `_user-circle-dashed`: ImageVector? = null
