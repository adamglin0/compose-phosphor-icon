...
public val RegularGroup.`Exclude-square`: ImageVector
    get() {
        if (`_exclude-square` != null) {
            return `_exclude-square`!!
        }
        `_exclude-square` = Builder(name = "Exclude-square", defaultWidth = 256.0.dp, defaultHeight
...
private var `_exclude-square`: ImageVector? = null
