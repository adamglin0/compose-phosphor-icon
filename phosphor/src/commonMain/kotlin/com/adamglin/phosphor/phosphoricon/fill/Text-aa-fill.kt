...
public val FillGroup.`Text-aa-fill`: ImageVector
    get() {
        if (`_text-aa-fill` != null) {
            return `_text-aa-fill`!!
        }
        `_text-aa-fill` = Builder(name = "Text-aa-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-aa-fill`: ImageVector? = null
