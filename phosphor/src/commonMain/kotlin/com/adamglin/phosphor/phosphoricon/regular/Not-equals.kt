...
public val RegularGroup.`Not-equals`: ImageVector
    get() {
        if (`_not-equals` != null) {
            return `_not-equals`!!
        }
        `_not-equals` = Builder(name = "Not-equals", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_not-equals`: ImageVector? = null
