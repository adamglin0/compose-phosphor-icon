...
public val RegularGroup.`Dice-six`: ImageVector
    get() {
        if (`_dice-six` != null) {
            return `_dice-six`!!
        }
        `_dice-six` = Builder(name = "Dice-six", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_dice-six`: ImageVector? = null
