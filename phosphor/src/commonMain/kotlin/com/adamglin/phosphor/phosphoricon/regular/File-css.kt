...
public val RegularGroup.`File-css`: ImageVector
    get() {
        if (`_file-css` != null) {
            return `_file-css`!!
        }
        `_file-css` = Builder(name = "File-css", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-css`: ImageVector? = null
