...
public val RegularGroup.`Read-cv-logo`: ImageVector
    get() {
        if (`_read-cv-logo` != null) {
            return `_read-cv-logo`!!
        }
        `_read-cv-logo` = Builder(name = "Read-cv-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_read-cv-logo`: ImageVector? = null
