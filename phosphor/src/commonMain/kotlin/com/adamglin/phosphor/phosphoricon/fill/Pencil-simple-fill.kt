...
public val FillGroup.`Pencil-simple-fill`: ImageVector
    get() {
        if (`_pencil-simple-fill` != null) {
            return `_pencil-simple-fill`!!
        }
        `_pencil-simple-fill` = Builder(name = "Pencil-simple-fill", defaultWidth = 256.0.dp,
...
private var `_pencil-simple-fill`: ImageVector? = null
