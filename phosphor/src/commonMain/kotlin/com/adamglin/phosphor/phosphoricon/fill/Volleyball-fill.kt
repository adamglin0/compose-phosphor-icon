...
public val FillGroup.`Volleyball-fill`: ImageVector
    get() {
        if (`_volleyball-fill` != null) {
            return `_volleyball-fill`!!
        }
        `_volleyball-fill` = Builder(name = "Volleyball-fill", defaultWidth = 256.0.dp,
...
private var `_volleyball-fill`: ImageVector? = null
