...
public val RegularGroup.`Hourglass-medium`: ImageVector
    get() {
        if (`_hourglass-medium` != null) {
            return `_hourglass-medium`!!
        }
        `_hourglass-medium` = Builder(name = "Hourglass-medium", defaultWidth = 256.0.dp,
...
private var `_hourglass-medium`: ImageVector? = null
