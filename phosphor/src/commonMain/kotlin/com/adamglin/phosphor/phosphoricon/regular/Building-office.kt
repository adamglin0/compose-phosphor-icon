...
public val RegularGroup.`Building-office`: ImageVector
    get() {
        if (`_building-office` != null) {
            return `_building-office`!!
        }
        `_building-office` = Builder(name = "Building-office", defaultWidth = 256.0.dp,
...
private var `_building-office`: ImageVector? = null
