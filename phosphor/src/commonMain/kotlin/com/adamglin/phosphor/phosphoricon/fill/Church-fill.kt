...
public val FillGroup.`Church-fill`: ImageVector
    get() {
        if (`_church-fill` != null) {
            return `_church-fill`!!
        }
        `_church-fill` = Builder(name = "Church-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_church-fill`: ImageVector? = null
