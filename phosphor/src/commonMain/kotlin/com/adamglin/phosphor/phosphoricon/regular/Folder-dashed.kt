...
public val RegularGroup.`Folder-dashed`: ImageVector
    get() {
        if (`_folder-dashed` != null) {
            return `_folder-dashed`!!
        }
        `_folder-dashed` = Builder(name = "Folder-dashed", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folder-dashed`: ImageVector? = null
