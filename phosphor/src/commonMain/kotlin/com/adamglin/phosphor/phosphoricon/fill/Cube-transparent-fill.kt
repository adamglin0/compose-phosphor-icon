...
public val FillGroup.`Cube-transparent-fill`: ImageVector
    get() {
        if (`_cube-transparent-fill` != null) {
            return `_cube-transparent-fill`!!
        }
        `_cube-transparent-fill` = Builder(name = "Cube-transparent-fill", defaultWidth = 256.0.dp,
...
private var `_cube-transparent-fill`: ImageVector? = null
