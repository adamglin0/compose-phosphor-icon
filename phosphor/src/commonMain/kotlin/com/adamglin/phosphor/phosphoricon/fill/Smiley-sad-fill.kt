...
public val FillGroup.`Smiley-sad-fill`: ImageVector
    get() {
        if (`_smiley-sad-fill` != null) {
            return `_smiley-sad-fill`!!
        }
        `_smiley-sad-fill` = Builder(name = "Smiley-sad-fill", defaultWidth = 256.0.dp,
...
private var `_smiley-sad-fill`: ImageVector? = null
