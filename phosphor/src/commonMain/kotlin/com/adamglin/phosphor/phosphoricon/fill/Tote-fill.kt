...
public val FillGroup.`Tote-fill`: ImageVector
    get() {
        if (`_tote-fill` != null) {
            return `_tote-fill`!!
        }
        `_tote-fill` = Builder(name = "Tote-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tote-fill`: ImageVector? = null
