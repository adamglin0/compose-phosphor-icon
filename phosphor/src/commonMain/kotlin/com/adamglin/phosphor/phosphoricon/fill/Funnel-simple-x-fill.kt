...
public val FillGroup.`Funnel-simple-x-fill`: ImageVector
    get() {
        if (`_funnel-simple-x-fill` != null) {
            return `_funnel-simple-x-fill`!!
        }
        `_funnel-simple-x-fill` = Builder(name = "Funnel-simple-x-fill", defaultWidth = 256.0.dp,
...
private var `_funnel-simple-x-fill`: ImageVector? = null
