...
public val RegularGroup.`Gender-male`: ImageVector
    get() {
        if (`_gender-male` != null) {
            return `_gender-male`!!
        }
        `_gender-male` = Builder(name = "Gender-male", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gender-male`: ImageVector? = null
