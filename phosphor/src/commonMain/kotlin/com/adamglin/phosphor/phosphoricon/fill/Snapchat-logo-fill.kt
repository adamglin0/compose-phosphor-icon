...
public val FillGroup.`Snapchat-logo-fill`: ImageVector
    get() {
        if (`_snapchat-logo-fill` != null) {
            return `_snapchat-logo-fill`!!
        }
        `_snapchat-logo-fill` = Builder(name = "Snapchat-logo-fill", defaultWidth = 256.0.dp,
...
private var `_snapchat-logo-fill`: ImageVector? = null
