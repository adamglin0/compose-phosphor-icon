...
public val FillGroup.`Speaker-simple-low-fill`: ImageVector
    get() {
        if (`_speaker-simple-low-fill` != null) {
            return `_speaker-simple-low-fill`!!
        }
        `_speaker-simple-low-fill` = Builder(name = "Speaker-simple-low-fill", defaultWidth =
...
private var `_speaker-simple-low-fill`: ImageVector? = null
