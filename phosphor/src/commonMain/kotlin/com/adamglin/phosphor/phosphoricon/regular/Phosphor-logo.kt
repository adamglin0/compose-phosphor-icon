...
public val RegularGroup.`Phosphor-logo`: ImageVector
    get() {
        if (`_phosphor-logo` != null) {
            return `_phosphor-logo`!!
        }
        `_phosphor-logo` = Builder(name = "Phosphor-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phosphor-logo`: ImageVector? = null
