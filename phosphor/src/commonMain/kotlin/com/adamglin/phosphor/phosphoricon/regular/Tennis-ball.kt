...
public val RegularGroup.`Tennis-ball`: ImageVector
    get() {
        if (`_tennis-ball` != null) {
            return `_tennis-ball`!!
        }
        `_tennis-ball` = Builder(name = "Tennis-ball", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tennis-ball`: ImageVector? = null
