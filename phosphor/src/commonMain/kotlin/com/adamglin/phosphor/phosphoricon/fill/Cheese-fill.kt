...
public val FillGroup.`Cheese-fill`: ImageVector
    get() {
        if (`_cheese-fill` != null) {
            return `_cheese-fill`!!
        }
        `_cheese-fill` = Builder(name = "Cheese-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cheese-fill`: ImageVector? = null
