...
public val FillGroup.`Radio-button-fill`: ImageVector
    get() {
        if (`_radio-button-fill` != null) {
            return `_radio-button-fill`!!
        }
        `_radio-button-fill` = Builder(name = "Radio-button-fill", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(56.06f, 56.06f, 0.0f, false, true, 184.0f, 128.0f)
                close()
            }
        }
        .build()
