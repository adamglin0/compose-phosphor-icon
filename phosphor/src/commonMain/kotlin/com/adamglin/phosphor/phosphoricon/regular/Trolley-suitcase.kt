...
public val RegularGroup.`Trolley-suitcase`: ImageVector
    get() {
        if (`_trolley-suitcase` != null) {
            return `_trolley-suitcase`!!
        }
        `_trolley-suitcase` = Builder(name = "Trolley-suitcase", defaultWidth = 256.0.dp,
...
private var `_trolley-suitcase`: ImageVector? = null
