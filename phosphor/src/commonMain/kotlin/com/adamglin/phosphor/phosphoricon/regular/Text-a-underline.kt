...
public val RegularGroup.`Text-a-underline`: ImageVector
    get() {
        if (`_text-a-underline` != null) {
            return `_text-a-underline`!!
        }
        `_text-a-underline` = Builder(name = "Text-a-underline", defaultWidth = 256.0.dp,
...
private var `_text-a-underline`: ImageVector? = null
