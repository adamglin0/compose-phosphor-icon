...
public val FillGroup.`Chair-fill`: ImageVector
    get() {
        if (`_chair-fill` != null) {
            return `_chair-fill`!!
        }
        `_chair-fill` = Builder(name = "Chair-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chair-fill`: ImageVector? = null
