...
public val FillGroup.`Pentagram-fill`: ImageVector
    get() {
        if (`_pentagram-fill` != null) {
            return `_pentagram-fill`!!
        }
        `_pentagram-fill` = Builder(name = "Pentagram-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_pentagram-fill`: ImageVector? = null
