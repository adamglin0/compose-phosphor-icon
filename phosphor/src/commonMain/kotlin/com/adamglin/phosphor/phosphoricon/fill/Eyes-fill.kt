...
public val FillGroup.`Eyes-fill`: ImageVector
    get() {
        if (`_eyes-fill` != null) {
            return `_eyes-fill`!!
        }
        `_eyes-fill` = Builder(name = "Eyes-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_eyes-fill`: ImageVector? = null
