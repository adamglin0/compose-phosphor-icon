...
public val RegularGroup.`Stripe-logo`: ImageVector
    get() {
        if (`_stripe-logo` != null) {
            return `_stripe-logo`!!
        }
        `_stripe-logo` = Builder(name = "Stripe-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stripe-logo`: ImageVector? = null
