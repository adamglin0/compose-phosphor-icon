...
public val FillGroup.`Joystick-fill`: ImageVector
    get() {
        if (`_joystick-fill` != null) {
            return `_joystick-fill`!!
        }
        `_joystick-fill` = Builder(name = "Joystick-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_joystick-fill`: ImageVector? = null
