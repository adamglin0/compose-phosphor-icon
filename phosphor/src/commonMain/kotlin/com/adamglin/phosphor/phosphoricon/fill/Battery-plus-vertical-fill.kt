...
public val FillGroup.`Battery-plus-vertical-fill`: ImageVector
    get() {
        if (`_battery-plus-vertical-fill` != null) {
            return `_battery-plus-vertical-fill`!!
        }
        `_battery-plus-vertical-fill` = Builder(name = "Battery-plus-vertical-fill", defaultWidth =
...
private var `_battery-plus-vertical-fill`: ImageVector? = null
