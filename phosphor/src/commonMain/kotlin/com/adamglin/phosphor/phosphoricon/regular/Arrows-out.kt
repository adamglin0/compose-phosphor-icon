...
public val RegularGroup.`Arrows-out`: ImageVector
    get() {
        if (`_arrows-out` != null) {
            return `_arrows-out`!!
        }
        `_arrows-out` = Builder(name = "Arrows-out", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_arrows-out`: ImageVector? = null
