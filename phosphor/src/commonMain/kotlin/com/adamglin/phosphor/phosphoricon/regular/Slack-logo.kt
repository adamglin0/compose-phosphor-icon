...
public val RegularGroup.`Slack-logo`: ImageVector
    get() {
        if (`_slack-logo` != null) {
            return `_slack-logo`!!
        }
        `_slack-logo` = Builder(name = "Slack-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_slack-logo`: ImageVector? = null
