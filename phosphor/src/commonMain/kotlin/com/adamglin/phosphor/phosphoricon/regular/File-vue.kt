...
public val RegularGroup.`File-vue`: ImageVector
    get() {
        if (`_file-vue` != null) {
            return `_file-vue`!!
        }
        `_file-vue` = Builder(name = "File-vue", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-vue`: ImageVector? = null
