...
public val RegularGroup.`Instagram-logo`: ImageVector
    get() {
        if (`_instagram-logo` != null) {
            return `_instagram-logo`!!
        }
        `_instagram-logo` = Builder(name = "Instagram-logo", defaultWidth = 256.0.dp, defaultHeight
...
private var `_instagram-logo`: ImageVector? = null
