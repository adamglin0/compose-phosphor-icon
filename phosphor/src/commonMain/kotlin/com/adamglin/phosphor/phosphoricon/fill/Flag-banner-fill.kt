...
public val FillGroup.`Flag-banner-fill`: ImageVector
    get() {
        if (`_flag-banner-fill` != null) {
            return `_flag-banner-fill`!!
        }
        `_flag-banner-fill` = Builder(name = "Flag-banner-fill", defaultWidth = 256.0.dp,
...
private var `_flag-banner-fill`: ImageVector? = null
