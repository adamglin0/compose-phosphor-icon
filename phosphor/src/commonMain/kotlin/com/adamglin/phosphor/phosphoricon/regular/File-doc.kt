...
public val RegularGroup.`File-doc`: ImageVector
    get() {
        if (`_file-doc` != null) {
            return `_file-doc`!!
        }
        `_file-doc` = Builder(name = "File-doc", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-doc`: ImageVector? = null
