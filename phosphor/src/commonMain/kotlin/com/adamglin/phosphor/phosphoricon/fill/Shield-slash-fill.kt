...
public val FillGroup.`Shield-slash-fill`: ImageVector
    get() {
        if (`_shield-slash-fill` != null) {
            return `_shield-slash-fill`!!
        }
        `_shield-slash-fill` = Builder(name = "Shield-slash-fill", defaultWidth = 256.0.dp,
...
private var `_shield-slash-fill`: ImageVector? = null
