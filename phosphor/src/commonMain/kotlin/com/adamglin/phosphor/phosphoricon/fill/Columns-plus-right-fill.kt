...
public val FillGroup.`Columns-plus-right-fill`: ImageVector
    get() {
        if (`_columns-plus-right-fill` != null) {
            return `_columns-plus-right-fill`!!
        }
        `_columns-plus-right-fill` = Builder(name = "Columns-plus-right-fill", defaultWidth =
...
private var `_columns-plus-right-fill`: ImageVector? = null
