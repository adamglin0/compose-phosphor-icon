...
public val RegularGroup.`Number-circle-two`: ImageVector
    get() {
        if (`_number-circle-two` != null) {
            return `_number-circle-two`!!
        }
        `_number-circle-two` = Builder(name = "Number-circle-two", defaultWidth = 256.0.dp,
...
private var `_number-circle-two`: ImageVector? = null
