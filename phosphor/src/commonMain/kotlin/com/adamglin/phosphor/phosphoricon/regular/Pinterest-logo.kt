...
public val RegularGroup.`Pinterest-logo`: ImageVector
    get() {
        if (`_pinterest-logo` != null) {
            return `_pinterest-logo`!!
        }
        `_pinterest-logo` = Builder(name = "Pinterest-logo", defaultWidth = 256.0.dp, defaultHeight
...
private var `_pinterest-logo`: ImageVector? = null
