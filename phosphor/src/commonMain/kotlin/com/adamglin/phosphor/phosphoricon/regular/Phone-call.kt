...
public val RegularGroup.`Phone-call`: ImageVector
    get() {
        if (`_phone-call` != null) {
            return `_phone-call`!!
        }
        `_phone-call` = Builder(name = "Phone-call", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_phone-call`: ImageVector? = null
