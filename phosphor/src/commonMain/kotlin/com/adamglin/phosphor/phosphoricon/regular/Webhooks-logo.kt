...
public val RegularGroup.`Webhooks-logo`: ImageVector
    get() {
        if (`_webhooks-logo` != null) {
            return `_webhooks-logo`!!
        }
        `_webhooks-logo` = Builder(name = "Webhooks-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_webhooks-logo`: ImageVector? = null
