...
public val RegularGroup.`Beach-ball`: ImageVector
    get() {
        if (`_beach-ball` != null) {
            return `_beach-ball`!!
        }
        `_beach-ball` = Builder(name = "Beach-ball", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_beach-ball`: ImageVector? = null
