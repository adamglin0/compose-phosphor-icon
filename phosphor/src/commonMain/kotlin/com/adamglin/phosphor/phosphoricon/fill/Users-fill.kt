...
public val FillGroup.`Users-fill`: ImageVector
    get() {
        if (`_users-fill` != null) {
            return `_users-fill`!!
        }
        `_users-fill` = Builder(name = "Users-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_users-fill`: ImageVector? = null
