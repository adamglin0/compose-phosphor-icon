...
public val FillGroup.`Tractor-fill`: ImageVector
    get() {
        if (`_tractor-fill` != null) {
            return `_tractor-fill`!!
        }
        `_tractor-fill` = Builder(name = "Tractor-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tractor-fill`: ImageVector? = null
