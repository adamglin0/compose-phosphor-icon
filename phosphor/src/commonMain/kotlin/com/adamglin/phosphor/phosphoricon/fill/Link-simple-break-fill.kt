...
public val FillGroup.`Link-simple-break-fill`: ImageVector
    get() {
        if (`_link-simple-break-fill` != null) {
            return `_link-simple-break-fill`!!
        }
        `_link-simple-break-fill` = Builder(name = "Link-simple-break-fill", defaultWidth =
...
private var `_link-simple-break-fill`: ImageVector? = null
