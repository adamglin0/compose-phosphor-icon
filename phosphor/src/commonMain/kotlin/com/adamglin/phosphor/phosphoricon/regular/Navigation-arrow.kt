...
public val RegularGroup.`Navigation-arrow`: ImageVector
    get() {
        if (`_navigation-arrow` != null) {
            return `_navigation-arrow`!!
        }
        `_navigation-arrow` = Builder(name = "Navigation-arrow", defaultWidth = 256.0.dp,
...
private var `_navigation-arrow`: ImageVector? = null
