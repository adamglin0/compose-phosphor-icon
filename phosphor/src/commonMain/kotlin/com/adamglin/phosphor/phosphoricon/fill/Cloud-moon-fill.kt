...
public val FillGroup.`Cloud-moon-fill`: ImageVector
    get() {
        if (`_cloud-moon-fill` != null) {
            return `_cloud-moon-fill`!!
        }
        `_cloud-moon-fill` = Builder(name = "Cloud-moon-fill", defaultWidth = 256.0.dp,
...
private var `_cloud-moon-fill`: ImageVector? = null
