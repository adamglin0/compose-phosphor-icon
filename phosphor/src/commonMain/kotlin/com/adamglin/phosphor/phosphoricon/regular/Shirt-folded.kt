...
public val RegularGroup.`Shirt-folded`: ImageVector
    get() {
        if (`_shirt-folded` != null) {
            return `_shirt-folded`!!
        }
        `_shirt-folded` = Builder(name = "Shirt-folded", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shirt-folded`: ImageVector? = null
