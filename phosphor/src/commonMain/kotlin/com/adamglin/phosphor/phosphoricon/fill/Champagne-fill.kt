...
public val FillGroup.`Champagne-fill`: ImageVector
    get() {
        if (`_champagne-fill` != null) {
            return `_champagne-fill`!!
        }
        `_champagne-fill` = Builder(name = "Champagne-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_champagne-fill`: ImageVector? = null
