...
public val RegularGroup.`X-logo`: ImageVector
    get() {
        if (`_x-logo` != null) {
            return `_x-logo`!!
        }
        `_x-logo` = Builder(name = "X-logo", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_x-logo`: ImageVector? = null
