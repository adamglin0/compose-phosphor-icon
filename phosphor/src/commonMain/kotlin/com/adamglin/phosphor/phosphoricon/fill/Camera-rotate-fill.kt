...
public val FillGroup.`Camera-rotate-fill`: ImageVector
    get() {
        if (`_camera-rotate-fill` != null) {
            return `_camera-rotate-fill`!!
        }
        `_camera-rotate-fill` = Builder(name = "Camera-rotate-fill", defaultWidth = 256.0.dp,
...
private var `_camera-rotate-fill`: ImageVector? = null
