...
public val RegularGroup.`Music-notes-plus`: ImageVector
    get() {
        if (`_music-notes-plus` != null) {
            return `_music-notes-plus`!!
        }
        `_music-notes-plus` = Builder(name = "Music-notes-plus", defaultWidth = 256.0.dp,
...
private var `_music-notes-plus`: ImageVector? = null
