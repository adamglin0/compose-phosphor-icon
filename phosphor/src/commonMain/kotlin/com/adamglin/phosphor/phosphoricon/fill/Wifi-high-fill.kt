...
public val FillGroup.`Wifi-high-fill`: ImageVector
    get() {
        if (`_wifi-high-fill` != null) {
            return `_wifi-high-fill`!!
        }
        `_wifi-high-fill` = Builder(name = "Wifi-high-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_wifi-high-fill`: ImageVector? = null
