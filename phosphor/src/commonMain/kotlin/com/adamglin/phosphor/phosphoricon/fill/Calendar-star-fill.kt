...
public val FillGroup.`Calendar-star-fill`: ImageVector
    get() {
        if (`_calendar-star-fill` != null) {
            return `_calendar-star-fill`!!
        }
        `_calendar-star-fill` = Builder(name = "Calendar-star-fill", defaultWidth = 256.0.dp,
...
private var `_calendar-star-fill`: ImageVector? = null
