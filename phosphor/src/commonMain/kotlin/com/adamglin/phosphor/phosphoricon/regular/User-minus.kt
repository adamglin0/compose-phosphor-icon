...
public val RegularGroup.`User-minus`: ImageVector
    get() {
        if (`_user-minus` != null) {
            return `_user-minus`!!
        }
        `_user-minus` = Builder(name = "User-minus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_user-minus`: ImageVector? = null
