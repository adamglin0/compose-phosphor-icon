...
public val FillGroup.`Number-circle-five-fill`: ImageVector
    get() {
        if (`_number-circle-five-fill` != null) {
            return `_number-circle-five-fill`!!
        }
        `_number-circle-five-fill` = Builder(name = "Number-circle-five-fill", defaultWidth =
...
private var `_number-circle-five-fill`: ImageVector? = null
