...
public val RegularGroup.`Flag-banner-fold`: ImageVector
    get() {
        if (`_flag-banner-fold` != null) {
            return `_flag-banner-fold`!!
        }
        `_flag-banner-fold` = Builder(name = "Flag-banner-fold", defaultWidth = 256.0.dp,
...
private var `_flag-banner-fold`: ImageVector? = null
