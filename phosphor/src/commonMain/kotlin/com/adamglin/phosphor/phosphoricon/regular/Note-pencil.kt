...
public val RegularGroup.`Note-pencil`: ImageVector
    get() {
        if (`_note-pencil` != null) {
            return `_note-pencil`!!
        }
        `_note-pencil` = Builder(name = "Note-pencil", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_note-pencil`: ImageVector? = null
