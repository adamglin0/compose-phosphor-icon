...
public val RegularGroup.`Mouse-left-click`: ImageVector
    get() {
        if (`_mouse-left-click` != null) {
            return `_mouse-left-click`!!
        }
        `_mouse-left-click` = Builder(name = "Mouse-left-click", defaultWidth = 256.0.dp,
...
private var `_mouse-left-click`: ImageVector? = null
