...
public val FillGroup.`Bell-z-fill`: ImageVector
    get() {
        if (`_bell-z-fill` != null) {
            return `_bell-z-fill`!!
        }
        `_bell-z-fill` = Builder(name = "Bell-z-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_bell-z-fill`: ImageVector? = null
