...
public val RegularGroup.`Line-segments`: ImageVector
    get() {
        if (`_line-segments` != null) {
            return `_line-segments`!!
        }
        `_line-segments` = Builder(name = "Line-segments", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_line-segments`: ImageVector? = null
