...
public val RegularGroup.`Wifi-slash`: ImageVector
    get() {
        if (`_wifi-slash` != null) {
            return `_wifi-slash`!!
        }
        `_wifi-slash` = Builder(name = "Wifi-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_wifi-slash`: ImageVector? = null
