...
public val FillGroup.`Tray-arrow-down-fill`: ImageVector
    get() {
        if (`_tray-arrow-down-fill` != null) {
            return `_tray-arrow-down-fill`!!
        }
        `_tray-arrow-down-fill` = Builder(name = "Tray-arrow-down-fill", defaultWidth = 256.0.dp,
...
private var `_tray-arrow-down-fill`: ImageVector? = null
