...
public val RegularGroup.`Dots-three`: ImageVector
    get() {
        if (`_dots-three` != null) {
            return `_dots-three`!!
        }
        `_dots-three` = Builder(name = "Dots-three", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dots-three`: ImageVector? = null
