...
public val FillGroup.`Tram-fill`: ImageVector
    get() {
        if (`_tram-fill` != null) {
            return `_tram-fill`!!
        }
        `_tram-fill` = Builder(name = "Tram-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tram-fill`: ImageVector? = null
