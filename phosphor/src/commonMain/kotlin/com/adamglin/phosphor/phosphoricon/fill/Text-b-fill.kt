...
public val FillGroup.`Text-b-fill`: ImageVector
    get() {
        if (`_text-b-fill` != null) {
            return `_text-b-fill`!!
        }
        `_text-b-fill` = Builder(name = "Text-b-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-b-fill`: ImageVector? = null
