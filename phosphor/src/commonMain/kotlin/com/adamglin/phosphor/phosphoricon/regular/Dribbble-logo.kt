...
public val RegularGroup.`Dribbble-logo`: ImageVector
    get() {
        if (`_dribbble-logo` != null) {
            return `_dribbble-logo`!!
        }
        `_dribbble-logo` = Builder(name = "Dribbble-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_dribbble-logo`: ImageVector? = null
