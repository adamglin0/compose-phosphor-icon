...
public val RegularGroup.`Cash-register`: ImageVector
    get() {
        if (`_cash-register` != null) {
            return `_cash-register`!!
        }
        `_cash-register` = Builder(name = "Cash-register", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cash-register`: ImageVector? = null
