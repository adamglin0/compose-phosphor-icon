...
public val FillGroup.`Person-simple-hike-fill`: ImageVector
    get() {
        if (`_person-simple-hike-fill` != null) {
            return `_person-simple-hike-fill`!!
        }
        `_person-simple-hike-fill` = Builder(name = "Person-simple-hike-fill", defaultWidth =
...
private var `_person-simple-hike-fill`: ImageVector? = null
