...
public val FillGroup.`Popcorn-fill`: ImageVector
    get() {
        if (`_popcorn-fill` != null) {
            return `_popcorn-fill`!!
        }
        `_popcorn-fill` = Builder(name = "Popcorn-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_popcorn-fill`: ImageVector? = null
