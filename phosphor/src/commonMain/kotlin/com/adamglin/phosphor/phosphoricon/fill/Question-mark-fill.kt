...
public val FillGroup.`Question-mark-fill`: ImageVector
    get() {
        if (`_question-mark-fill` != null) {
            return `_question-mark-fill`!!
        }
        `_question-mark-fill` = Builder(name = "Question-mark-fill", defaultWidth = 256.0.dp,
...
private var `_question-mark-fill`: ImageVector? = null
