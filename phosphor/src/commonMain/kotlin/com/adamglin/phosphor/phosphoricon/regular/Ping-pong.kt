...
public val RegularGroup.`Ping-pong`: ImageVector
    get() {
        if (`_ping-pong` != null) {
            return `_ping-pong`!!
        }
        `_ping-pong` = Builder(name = "Ping-pong", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_ping-pong`: ImageVector? = null
