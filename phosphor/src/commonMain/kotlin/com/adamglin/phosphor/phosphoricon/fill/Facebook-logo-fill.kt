...
public val FillGroup.`Facebook-logo-fill`: ImageVector
    get() {
        if (`_facebook-logo-fill` != null) {
            return `_facebook-logo-fill`!!
        }
        `_facebook-logo-fill` = Builder(name = "Facebook-logo-fill", defaultWidth = 256.0.dp,
...
private var `_facebook-logo-fill`: ImageVector? = null
