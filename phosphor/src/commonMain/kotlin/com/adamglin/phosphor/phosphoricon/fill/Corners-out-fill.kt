...
public val FillGroup.`Corners-out-fill`: ImageVector
    get() {
        if (`_corners-out-fill` != null) {
            return `_corners-out-fill`!!
        }
        `_corners-out-fill` = Builder(name = "Corners-out-fill", defaultWidth = 256.0.dp,
...
private var `_corners-out-fill`: ImageVector? = null
