...
public val FillGroup.`City-fill`: ImageVector
    get() {
        if (`_city-fill` != null) {
            return `_city-fill`!!
        }
        `_city-fill` = Builder(name = "City-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_city-fill`: ImageVector? = null
