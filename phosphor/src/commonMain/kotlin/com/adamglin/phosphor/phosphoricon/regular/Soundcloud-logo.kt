...
public val RegularGroup.`Soundcloud-logo`: ImageVector
    get() {
        if (`_soundcloud-logo` != null) {
            return `_soundcloud-logo`!!
        }
        `_soundcloud-logo` = Builder(name = "Soundcloud-logo", defaultWidth = 256.0.dp,
...
private var `_soundcloud-logo`: ImageVector? = null
