...
public val FillGroup.`Brackets-curly-fill`: ImageVector
    get() {
        if (`_brackets-curly-fill` != null) {
            return `_brackets-curly-fill`!!
        }
        `_brackets-curly-fill` = Builder(name = "Brackets-curly-fill", defaultWidth = 256.0.dp,
...
private var `_brackets-curly-fill`: ImageVector? = null
