...
public val FillGroup.`Bell-ringing-fill`: ImageVector
    get() {
        if (`_bell-ringing-fill` != null) {
            return `_bell-ringing-fill`!!
        }
        `_bell-ringing-fill` = Builder(name = "Bell-ringing-fill", defaultWidth = 256.0.dp,
...
private var `_bell-ringing-fill`: ImageVector? = null
