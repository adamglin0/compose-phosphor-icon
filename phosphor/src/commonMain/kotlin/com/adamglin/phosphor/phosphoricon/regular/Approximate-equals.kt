...
public val RegularGroup.`Approximate-equals`: ImageVector
    get() {
        if (`_approximate-equals` != null) {
            return `_approximate-equals`!!
        }
        `_approximate-equals` = Builder(name = "Approximate-equals", defaultWidth = 256.0.dp,
...
private var `_approximate-equals`: ImageVector? = null
