...
public val RegularGroup.`Microphone-stage`: ImageVector
    get() {
        if (`_microphone-stage` != null) {
            return `_microphone-stage`!!
        }
        `_microphone-stage` = Builder(name = "Microphone-stage", defaultWidth = 256.0.dp,
...
private var `_microphone-stage`: ImageVector? = null
