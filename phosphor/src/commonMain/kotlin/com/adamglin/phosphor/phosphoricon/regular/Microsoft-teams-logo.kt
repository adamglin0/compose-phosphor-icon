...
public val RegularGroup.`Microsoft-teams-logo`: ImageVector
    get() {
        if (`_microsoft-teams-logo` != null) {
            return `_microsoft-teams-logo`!!
        }
        `_microsoft-teams-logo` = Builder(name = "Microsoft-teams-logo", defaultWidth = 256.0.dp,
...
private var `_microsoft-teams-logo`: ImageVector? = null
