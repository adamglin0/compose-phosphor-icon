...
public val FillGroup.`Currency-inr-fill`: ImageVector
    get() {
        if (`_currency-inr-fill` != null) {
            return `_currency-inr-fill`!!
        }
        `_currency-inr-fill` = Builder(name = "Currency-inr-fill", defaultWidth = 256.0.dp,
...
private var `_currency-inr-fill`: ImageVector? = null
