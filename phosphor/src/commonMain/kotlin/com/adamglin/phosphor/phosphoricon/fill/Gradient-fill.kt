...
public val FillGroup.`Gradient-fill`: ImageVector
    get() {
        if (`_gradient-fill` != null) {
            return `_gradient-fill`!!
        }
        `_gradient-fill` = Builder(name = "Gradient-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gradient-fill`: ImageVector? = null
