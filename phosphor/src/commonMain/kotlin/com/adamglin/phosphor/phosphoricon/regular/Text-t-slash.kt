...
public val RegularGroup.`Text-t-slash`: ImageVector
    get() {
        if (`_text-t-slash` != null) {
            return `_text-t-slash`!!
        }
        `_text-t-slash` = Builder(name = "Text-t-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_text-t-slash`: ImageVector? = null
