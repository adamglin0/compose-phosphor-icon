...
public val FillGroup.`File-plus-fill`: ImageVector
    get() {
        if (`_file-plus-fill` != null) {
            return `_file-plus-fill`!!
        }
        `_file-plus-fill` = Builder(name = "File-plus-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-plus-fill`: ImageVector? = null
