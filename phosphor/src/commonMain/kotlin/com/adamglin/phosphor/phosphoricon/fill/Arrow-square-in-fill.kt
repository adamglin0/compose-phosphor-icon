...
public val FillGroup.`Arrow-square-in-fill`: ImageVector
    get() {
        if (`_arrow-square-in-fill` != null) {
            return `_arrow-square-in-fill`!!
        }
        `_arrow-square-in-fill` = Builder(name = "Arrow-square-in-fill", defaultWidth = 256.0.dp,
...
private var `_arrow-square-in-fill`: ImageVector? = null
