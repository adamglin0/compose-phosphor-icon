...
public val RegularGroup.`Airplane-takeoff`: ImageVector
    get() {
        if (`_airplane-takeoff` != null) {
            return `_airplane-takeoff`!!
        }
        `_airplane-takeoff` = Builder(name = "Airplane-takeoff", defaultWidth = 256.0.dp,
...
private var `_airplane-takeoff`: ImageVector? = null
