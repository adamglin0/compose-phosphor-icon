...
public val RegularGroup.`Microsoft-powerpoint-logo`: ImageVector
    get() {
        if (`_microsoft-powerpoint-logo` != null) {
            return `_microsoft-powerpoint-logo`!!
        }
        `_microsoft-powerpoint-logo` = Builder(name = "Microsoft-powerpoint-logo", defaultWidth =
...
private var `_microsoft-powerpoint-logo`: ImageVector? = null
