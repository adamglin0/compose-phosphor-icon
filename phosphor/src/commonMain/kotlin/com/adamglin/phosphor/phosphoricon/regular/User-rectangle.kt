...
public val RegularGroup.`User-rectangle`: ImageVector
    get() {
        if (`_user-rectangle` != null) {
            return `_user-rectangle`!!
        }
        `_user-rectangle` = Builder(name = "User-rectangle", defaultWidth = 256.0.dp, defaultHeight
...
private var `_user-rectangle`: ImageVector? = null
