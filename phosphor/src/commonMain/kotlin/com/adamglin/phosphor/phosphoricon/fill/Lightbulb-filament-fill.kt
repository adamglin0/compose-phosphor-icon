...
public val FillGroup.`Lightbulb-filament-fill`: ImageVector
    get() {
        if (`_lightbulb-filament-fill` != null) {
            return `_lightbulb-filament-fill`!!
        }
        `_lightbulb-filament-fill` = Builder(name = "Lightbulb-filament-fill", defaultWidth =
...
private var `_lightbulb-filament-fill`: ImageVector? = null
