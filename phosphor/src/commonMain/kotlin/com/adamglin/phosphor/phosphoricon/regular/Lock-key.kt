...
public val RegularGroup.`Lock-key`: ImageVector
    get() {
        if (`_lock-key` != null) {
            return `_lock-key`!!
        }
        `_lock-key` = Builder(name = "Lock-key", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_lock-key`: ImageVector? = null
