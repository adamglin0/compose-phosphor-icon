...
public val RegularGroup.`Android-logo`: ImageVector
    get() {
        if (`_android-logo` != null) {
            return `_android-logo`!!
        }
        `_android-logo` = Builder(name = "Android-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_android-logo`: ImageVector? = null
