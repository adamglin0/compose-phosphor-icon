...
public val RegularGroup.`Brackets-curly`: ImageVector
    get() {
        if (`_brackets-curly` != null) {
            return `_brackets-curly`!!
        }
        `_brackets-curly` = Builder(name = "Brackets-curly", defaultWidth = 256.0.dp, defaultHeight
...
private var `_brackets-curly`: ImageVector? = null
