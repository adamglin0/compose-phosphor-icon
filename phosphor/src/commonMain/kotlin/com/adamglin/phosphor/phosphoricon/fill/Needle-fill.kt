...
public val FillGroup.`Needle-fill`: ImageVector
    get() {
        if (`_needle-fill` != null) {
            return `_needle-fill`!!
        }
        `_needle-fill` = Builder(name = "Needle-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_needle-fill`: ImageVector? = null
