...
public val FillGroup.`Sparkle-fill`: ImageVector
    get() {
        if (`_sparkle-fill` != null) {
            return `_sparkle-fill`!!
        }
        `_sparkle-fill` = Builder(name = "Sparkle-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sparkle-fill`: ImageVector? = null
