...
public val RegularGroup.`File-ppt`: ImageVector
    get() {
        if (`_file-ppt` != null) {
            return `_file-ppt`!!
        }
        `_file-ppt` = Builder(name = "File-ppt", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-ppt`: ImageVector? = null
