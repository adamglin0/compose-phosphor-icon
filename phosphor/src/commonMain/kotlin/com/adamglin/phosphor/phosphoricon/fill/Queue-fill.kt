...
public val FillGroup.`Queue-fill`: ImageVector
    get() {
        if (`_queue-fill` != null) {
            return `_queue-fill`!!
        }
        `_queue-fill` = Builder(name = "Queue-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_queue-fill`: ImageVector? = null
