...
public val RegularGroup.`Escalator-up`: ImageVector
    get() {
        if (`_escalator-up` != null) {
            return `_escalator-up`!!
        }
        `_escalator-up` = Builder(name = "Escalator-up", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_escalator-up`: ImageVector? = null
