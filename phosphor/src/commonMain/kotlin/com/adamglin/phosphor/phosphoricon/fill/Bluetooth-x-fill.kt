...
public val FillGroup.`Bluetooth-x-fill`: ImageVector
    get() {
        if (`_bluetooth-x-fill` != null) {
            return `_bluetooth-x-fill`!!
        }
        `_bluetooth-x-fill` = Builder(name = "Bluetooth-x-fill", defaultWidth = 256.0.dp,
...
private var `_bluetooth-x-fill`: ImageVector? = null
