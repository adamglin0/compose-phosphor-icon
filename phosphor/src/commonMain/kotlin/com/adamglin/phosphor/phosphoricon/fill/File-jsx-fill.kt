...
public val FillGroup.`File-jsx-fill`: ImageVector
    get() {
        if (`_file-jsx-fill` != null) {
            return `_file-jsx-fill`!!
        }
        `_file-jsx-fill` = Builder(name = "File-jsx-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 14.23f, -11.18f, 26.27f, -25.41f, 26.59f)
                ...
                curveToRelative(7.85f, 4.82f, 16.0f, -0.76f, 16.0f, -8.2f)
...
private var `_file-jsx-fill`: ImageVector? = null
