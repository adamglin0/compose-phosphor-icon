...
public val FillGroup.`Amazon-logo-fill`: ImageVector
    get() {
        if (`_amazon-logo-fill` != null) {
            return `_amazon-logo-fill`!!
        }
        `_amazon-logo-fill` = Builder(name = "Amazon-logo-fill", defaultWidth = 256.0.dp,
...
private var `_amazon-logo-fill`: ImageVector? = null
