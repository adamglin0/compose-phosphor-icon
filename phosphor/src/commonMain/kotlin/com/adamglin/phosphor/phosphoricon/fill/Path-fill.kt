...
public val FillGroup.`Path-fill`: ImageVector
    get() {
        if (`_path-fill` != null) {
            return `_path-fill`!!
        }
        `_path-fill` = Builder(name = "Path-fill", defaultWidth = 256.0.dp, defaultHeight =
                256.0.dp, viewportWidth = 256.0f, viewportHeight = 256.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(228.0f, 200.0f)
                arcToRelative(28.0f, 28.0f, 0.0f, false, true, -54.83f, 8.0f)
                ...
                arcTo(28.0f, 28.0f, 0.0f, false, true, 228.0f, 200.0f)
                close()
            }
        }
        .build()
...
private var `_path-fill`: ImageVector? = null
