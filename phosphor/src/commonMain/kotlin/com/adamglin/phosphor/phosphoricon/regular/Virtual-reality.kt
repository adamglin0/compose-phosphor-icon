...
public val RegularGroup.`Virtual-reality`: ImageVector
    get() {
        if (`_virtual-reality` != null) {
            return `_virtual-reality`!!
        }
        `_virtual-reality` = Builder(name = "Virtual-reality", defaultWidth = 256.0.dp,
...
private var `_virtual-reality`: ImageVector? = null
