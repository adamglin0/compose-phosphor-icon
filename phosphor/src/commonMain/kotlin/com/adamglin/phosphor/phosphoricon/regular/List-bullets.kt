...
public val RegularGroup.`List-bullets`: ImageVector
    get() {
        if (`_list-bullets` != null) {
            return `_list-bullets`!!
        }
        `_list-bullets` = Builder(name = "List-bullets", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_list-bullets`: ImageVector? = null
