...
public val FillGroup.`Prescription-fill`: ImageVector
    get() {
        if (`_prescription-fill` != null) {
            return `_prescription-fill`!!
        }
        `_prescription-fill` = Builder(name = "Prescription-fill", defaultWidth = 256.0.dp,
...
private var `_prescription-fill`: ImageVector? = null
