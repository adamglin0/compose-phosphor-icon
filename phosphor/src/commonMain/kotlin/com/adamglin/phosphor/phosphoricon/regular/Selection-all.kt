...
public val RegularGroup.`Selection-all`: ImageVector
    get() {
        if (`_selection-all` != null) {
            return `_selection-all`!!
        }
        `_selection-all` = Builder(name = "Selection-all", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_selection-all`: ImageVector? = null
