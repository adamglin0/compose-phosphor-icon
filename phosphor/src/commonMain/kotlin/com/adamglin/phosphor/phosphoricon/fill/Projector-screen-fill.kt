...
public val FillGroup.`Projector-screen-fill`: ImageVector
    get() {
        if (`_projector-screen-fill` != null) {
            return `_projector-screen-fill`!!
        }
        `_projector-screen-fill` = Builder(name = "Projector-screen-fill", defaultWidth = 256.0.dp,
...
private var `_projector-screen-fill`: ImageVector? = null
