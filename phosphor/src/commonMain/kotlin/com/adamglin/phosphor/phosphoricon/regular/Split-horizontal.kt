...
public val RegularGroup.`Split-horizontal`: ImageVector
    get() {
        if (`_split-horizontal` != null) {
            return `_split-horizontal`!!
        }
        `_split-horizontal` = Builder(name = "Split-horizontal", defaultWidth = 256.0.dp,
...
private var `_split-horizontal`: ImageVector? = null
