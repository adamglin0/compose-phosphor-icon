...
public val RegularGroup.`Speaker-simple-x`: ImageVector
    get() {
        if (`_speaker-simple-x` != null) {
            return `_speaker-simple-x`!!
        }
        `_speaker-simple-x` = Builder(name = "Speaker-simple-x", defaultWidth = 256.0.dp,
...
private var `_speaker-simple-x`: ImageVector? = null
