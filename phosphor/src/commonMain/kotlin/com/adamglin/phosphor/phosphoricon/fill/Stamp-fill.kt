...
public val FillGroup.`Stamp-fill`: ImageVector
    get() {
        if (`_stamp-fill` != null) {
            return `_stamp-fill`!!
        }
        `_stamp-fill` = Builder(name = "Stamp-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stamp-fill`: ImageVector? = null
