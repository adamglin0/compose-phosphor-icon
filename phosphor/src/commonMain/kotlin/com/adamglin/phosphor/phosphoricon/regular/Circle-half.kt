...
public val RegularGroup.`Circle-half`: ImageVector
    get() {
        if (`_circle-half` != null) {
            return `_circle-half`!!
        }
        `_circle-half` = Builder(name = "Circle-half", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_circle-half`: ImageVector? = null
