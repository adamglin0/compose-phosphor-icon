...
public val FillGroup.`Tip-jar-fill`: ImageVector
    get() {
        if (`_tip-jar-fill` != null) {
            return `_tip-jar-fill`!!
        }
        `_tip-jar-fill` = Builder(name = "Tip-jar-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tip-jar-fill`: ImageVector? = null
