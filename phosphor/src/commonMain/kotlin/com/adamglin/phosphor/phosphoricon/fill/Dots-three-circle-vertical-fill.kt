...
public val FillGroup.`Dots-three-circle-vertical-fill`: ImageVector
    get() {
        if (`_dots-three-circle-vertical-fill` != null) {
            return `_dots-three-circle-vertical-fill`!!
        }
        `_dots-three-circle-vertical-fill` = Builder(name = "Dots-three-circle-vertical-fill",
...
private var `_dots-three-circle-vertical-fill`: ImageVector? = null
