...
public val FillGroup.`Number-square-three-fill`: ImageVector
    get() {
        if (`_number-square-three-fill` != null) {
            return `_number-square-three-fill`!!
        }
        `_number-square-three-fill` = Builder(name = "Number-square-three-fill", defaultWidth =
...
private var `_number-square-three-fill`: ImageVector? = null
