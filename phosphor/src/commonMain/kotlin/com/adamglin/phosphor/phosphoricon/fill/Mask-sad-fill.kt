...
public val FillGroup.`Mask-sad-fill`: ImageVector
    get() {
        if (`_mask-sad-fill` != null) {
            return `_mask-sad-fill`!!
        }
        `_mask-sad-fill` = Builder(name = "Mask-sad-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mask-sad-fill`: ImageVector? = null
