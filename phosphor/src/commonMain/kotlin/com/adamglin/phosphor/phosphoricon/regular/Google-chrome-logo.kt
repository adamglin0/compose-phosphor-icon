...
public val RegularGroup.`Google-chrome-logo`: ImageVector
    get() {
        if (`_google-chrome-logo` != null) {
            return `_google-chrome-logo`!!
        }
        `_google-chrome-logo` = Builder(name = "Google-chrome-logo", defaultWidth = 256.0.dp,
...
private var `_google-chrome-logo`: ImageVector? = null
