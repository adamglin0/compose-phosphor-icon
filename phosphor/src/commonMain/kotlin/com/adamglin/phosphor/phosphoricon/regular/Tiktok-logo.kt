...
public val RegularGroup.`Tiktok-logo`: ImageVector
    get() {
        if (`_tiktok-logo` != null) {
            return `_tiktok-logo`!!
        }
        `_tiktok-logo` = Builder(name = "Tiktok-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_tiktok-logo`: ImageVector? = null
