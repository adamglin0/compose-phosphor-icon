...
public val RegularGroup.`File-zip`: ImageVector
    get() {
        if (`_file-zip` != null) {
            return `_file-zip`!!
        }
        `_file-zip` = Builder(name = "File-zip", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-zip`: ImageVector? = null
