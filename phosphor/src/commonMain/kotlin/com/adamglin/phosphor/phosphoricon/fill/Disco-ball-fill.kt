...
public val FillGroup.`Disco-ball-fill`: ImageVector
    get() {
        if (`_disco-ball-fill` != null) {
            return `_disco-ball-fill`!!
        }
        `_disco-ball-fill` = Builder(name = "Disco-ball-fill", defaultWidth = 256.0.dp,
...
private var `_disco-ball-fill`: ImageVector? = null
