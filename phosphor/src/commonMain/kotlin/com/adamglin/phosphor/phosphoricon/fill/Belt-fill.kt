...
public val FillGroup.`Belt-fill`: ImageVector
    get() {
        if (`_belt-fill` != null) {
            return `_belt-fill`!!
        }
        `_belt-fill` = Builder(name = "Belt-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_belt-fill`: ImageVector? = null
