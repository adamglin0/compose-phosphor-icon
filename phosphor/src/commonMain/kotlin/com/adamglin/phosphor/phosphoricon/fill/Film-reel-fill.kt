...
public val FillGroup.`Film-reel-fill`: ImageVector
    get() {
        if (`_film-reel-fill` != null) {
            return `_film-reel-fill`!!
        }
        `_film-reel-fill` = Builder(name = "Film-reel-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_film-reel-fill`: ImageVector? = null
