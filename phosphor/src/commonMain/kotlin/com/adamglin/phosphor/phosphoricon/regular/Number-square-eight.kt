...
public val RegularGroup.`Number-square-eight`: ImageVector
    get() {
        if (`_number-square-eight` != null) {
            return `_number-square-eight`!!
        }
        `_number-square-eight` = Builder(name = "Number-square-eight", defaultWidth = 256.0.dp,
...
private var `_number-square-eight`: ImageVector? = null
