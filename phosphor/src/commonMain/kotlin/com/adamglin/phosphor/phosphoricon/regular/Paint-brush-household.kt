...
public val RegularGroup.`Paint-brush-household`: ImageVector
    get() {
        if (`_paint-brush-household` != null) {
            return `_paint-brush-household`!!
        }
        `_paint-brush-household` = Builder(name = "Paint-brush-household", defaultWidth = 256.0.dp,
...
private var `_paint-brush-household`: ImageVector? = null
