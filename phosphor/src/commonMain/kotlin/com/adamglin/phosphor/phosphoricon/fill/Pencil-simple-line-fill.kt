...
public val FillGroup.`Pencil-simple-line-fill`: ImageVector
    get() {
        if (`_pencil-simple-line-fill` != null) {
            return `_pencil-simple-line-fill`!!
        }
        `_pencil-simple-line-fill` = Builder(name = "Pencil-simple-line-fill", defaultWidth =
...
private var `_pencil-simple-line-fill`: ImageVector? = null
