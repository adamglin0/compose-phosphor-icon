...
public val FillGroup.`Bug-beetle-fill`: ImageVector
    get() {
        if (`_bug-beetle-fill` != null) {
            return `_bug-beetle-fill`!!
        }
        `_bug-beetle-fill` = Builder(name = "Bug-beetle-fill", defaultWidth = 256.0.dp,
...
private var `_bug-beetle-fill`: ImageVector? = null
