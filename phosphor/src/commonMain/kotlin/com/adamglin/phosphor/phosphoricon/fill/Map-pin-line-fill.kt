...
public val FillGroup.`Map-pin-line-fill`: ImageVector
    get() {
        if (`_map-pin-line-fill` != null) {
            return `_map-pin-line-fill`!!
        }
        `_map-pin-line-fill` = Builder(name = "Map-pin-line-fill", defaultWidth = 256.0.dp,
...
private var `_map-pin-line-fill`: ImageVector? = null
