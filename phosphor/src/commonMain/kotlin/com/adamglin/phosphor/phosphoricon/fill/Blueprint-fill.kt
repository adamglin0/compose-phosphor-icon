...
public val FillGroup.`Blueprint-fill`: ImageVector
    get() {
        if (`_blueprint-fill` != null) {
            return `_blueprint-fill`!!
        }
        `_blueprint-fill` = Builder(name = "Blueprint-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_blueprint-fill`: ImageVector? = null
