...
public val RegularGroup.`Hard-hat`: ImageVector
    get() {
        if (`_hard-hat` != null) {
            return `_hard-hat`!!
        }
        `_hard-hat` = Builder(name = "Hard-hat", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_hard-hat`: ImageVector? = null
