...
public val RegularGroup.`Lock-laminated-open`: ImageVector
    get() {
        if (`_lock-laminated-open` != null) {
            return `_lock-laminated-open`!!
        }
        `_lock-laminated-open` = Builder(name = "Lock-laminated-open", defaultWidth = 256.0.dp,
...
private var `_lock-laminated-open`: ImageVector? = null
