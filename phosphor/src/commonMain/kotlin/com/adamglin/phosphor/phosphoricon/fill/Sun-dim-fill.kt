...
public val FillGroup.`Sun-dim-fill`: ImageVector
    get() {
        if (`_sun-dim-fill` != null) {
            return `_sun-dim-fill`!!
        }
        `_sun-dim-fill` = Builder(name = "Sun-dim-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sun-dim-fill`: ImageVector? = null
