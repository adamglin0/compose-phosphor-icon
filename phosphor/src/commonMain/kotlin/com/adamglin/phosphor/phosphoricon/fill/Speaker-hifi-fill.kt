...
public val FillGroup.`Speaker-hifi-fill`: ImageVector
    get() {
        if (`_speaker-hifi-fill` != null) {
            return `_speaker-hifi-fill`!!
        }
        `_speaker-hifi-fill` = Builder(name = "Speaker-hifi-fill", defaultWidth = 256.0.dp,
...
private var `_speaker-hifi-fill`: ImageVector? = null
