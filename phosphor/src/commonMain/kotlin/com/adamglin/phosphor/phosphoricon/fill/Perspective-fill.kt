...
public val FillGroup.`Perspective-fill`: ImageVector
    get() {
        if (`_perspective-fill` != null) {
            return `_perspective-fill`!!
        }
        `_perspective-fill` = Builder(name = "Perspective-fill", defaultWidth = 256.0.dp,
...
private var `_perspective-fill`: ImageVector? = null
