...
public val RegularGroup.`List-heart`: ImageVector
    get() {
        if (`_list-heart` != null) {
            return `_list-heart`!!
        }
        `_list-heart` = Builder(name = "List-heart", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_list-heart`: ImageVector? = null
