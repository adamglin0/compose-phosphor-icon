...
public val FillGroup.`Heartbeat-fill`: ImageVector
    get() {
        if (`_heartbeat-fill` != null) {
            return `_heartbeat-fill`!!
        }
        `_heartbeat-fill` = Builder(name = "Heartbeat-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_heartbeat-fill`: ImageVector? = null
