...
public val RegularGroup.`Person-simple-tai-chi`: ImageVector
    get() {
        if (`_person-simple-tai-chi` != null) {
            return `_person-simple-tai-chi`!!
        }
        `_person-simple-tai-chi` = Builder(name = "Person-simple-tai-chi", defaultWidth = 256.0.dp,
...
private var `_person-simple-tai-chi`: ImageVector? = null
