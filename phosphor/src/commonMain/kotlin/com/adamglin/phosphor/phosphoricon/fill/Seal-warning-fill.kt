...
public val FillGroup.`Seal-warning-fill`: ImageVector
    get() {
        if (`_seal-warning-fill` != null) {
            return `_seal-warning-fill`!!
        }
        `_seal-warning-fill` = Builder(name = "Seal-warning-fill", defaultWidth = 256.0.dp,
...
private var `_seal-warning-fill`: ImageVector? = null
