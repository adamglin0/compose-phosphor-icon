...
public val FillGroup.`Arrows-out-fill`: ImageVector
    get() {
        if (`_arrows-out-fill` != null) {
            return `_arrows-out-fill`!!
        }
        `_arrows-out-fill` = Builder(name = "Arrows-out-fill", defaultWidth = 256.0.dp,
...
private var `_arrows-out-fill`: ImageVector? = null
