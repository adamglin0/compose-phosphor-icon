...
public val FillGroup.`File-minus-fill`: ImageVector
    get() {
        if (`_file-minus-fill` != null) {
            return `_file-minus-fill`!!
        }
        `_file-minus-fill` = Builder(name = "File-minus-fill", defaultWidth = 256.0.dp,
...
private var `_file-minus-fill`: ImageVector? = null
