...
public val RegularGroup.`Triangle-dashed`: ImageVector
    get() {
        if (`_triangle-dashed` != null) {
            return `_triangle-dashed`!!
        }
        `_triangle-dashed` = Builder(name = "Triangle-dashed", defaultWidth = 256.0.dp,
...
private var `_triangle-dashed`: ImageVector? = null
