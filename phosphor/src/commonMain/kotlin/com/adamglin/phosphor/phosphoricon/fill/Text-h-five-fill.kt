...
public val FillGroup.`Text-h-five-fill`: ImageVector
    get() {
        if (`_text-h-five-fill` != null) {
            return `_text-h-five-fill`!!
        }
        `_text-h-five-fill` = Builder(name = "Text-h-five-fill", defaultWidth = 256.0.dp,
...
private var `_text-h-five-fill`: ImageVector? = null
