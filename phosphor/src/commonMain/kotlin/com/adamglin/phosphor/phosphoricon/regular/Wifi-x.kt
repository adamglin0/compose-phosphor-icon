...
public val RegularGroup.`Wifi-x`: ImageVector
    get() {
        if (`_wifi-x` != null) {
            return `_wifi-x`!!
        }
        `_wifi-x` = Builder(name = "Wifi-x", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_wifi-x`: ImageVector? = null
