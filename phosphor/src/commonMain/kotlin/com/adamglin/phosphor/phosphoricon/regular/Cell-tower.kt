...
public val RegularGroup.`Cell-tower`: ImageVector
    get() {
        if (`_cell-tower` != null) {
            return `_cell-tower`!!
        }
        `_cell-tower` = Builder(name = "Cell-tower", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cell-tower`: ImageVector? = null
