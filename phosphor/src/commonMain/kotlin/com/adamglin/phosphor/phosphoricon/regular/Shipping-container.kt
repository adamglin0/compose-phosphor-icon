...
public val RegularGroup.`Shipping-container`: ImageVector
    get() {
        if (`_shipping-container` != null) {
            return `_shipping-container`!!
        }
        `_shipping-container` = Builder(name = "Shipping-container", defaultWidth = 256.0.dp,
...
private var `_shipping-container`: ImageVector? = null
