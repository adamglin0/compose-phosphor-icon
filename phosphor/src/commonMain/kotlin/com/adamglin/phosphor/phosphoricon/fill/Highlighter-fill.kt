...
public val FillGroup.`Highlighter-fill`: ImageVector
    get() {
        if (`_highlighter-fill` != null) {
            return `_highlighter-fill`!!
        }
        `_highlighter-fill` = Builder(name = "Highlighter-fill", defaultWidth = 256.0.dp,
...
private var `_highlighter-fill`: ImageVector? = null
