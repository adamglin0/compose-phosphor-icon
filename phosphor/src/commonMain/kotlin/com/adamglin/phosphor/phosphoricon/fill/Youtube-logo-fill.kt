...
public val FillGroup.`Youtube-logo-fill`: ImageVector
    get() {
        if (`_youtube-logo-fill` != null) {
            return `_youtube-logo-fill`!!
        }
        `_youtube-logo-fill` = Builder(name = "Youtube-logo-fill", defaultWidth = 256.0.dp,
...
private var `_youtube-logo-fill`: ImageVector? = null
