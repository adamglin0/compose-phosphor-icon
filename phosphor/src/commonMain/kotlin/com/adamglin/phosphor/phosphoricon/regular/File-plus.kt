...
public val RegularGroup.`File-plus`: ImageVector
    get() {
        if (`_file-plus` != null) {
            return `_file-plus`!!
        }
        `_file-plus` = Builder(name = "File-plus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-plus`: ImageVector? = null
