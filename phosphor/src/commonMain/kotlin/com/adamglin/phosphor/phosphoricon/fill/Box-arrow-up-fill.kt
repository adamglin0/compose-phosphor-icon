...
public val FillGroup.`Box-arrow-up-fill`: ImageVector
    get() {
        if (`_box-arrow-up-fill` != null) {
            return `_box-arrow-up-fill`!!
        }
        `_box-arrow-up-fill` = Builder(name = "Box-arrow-up-fill", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, 11.32f, 0.0f)
                lineToRelative(32.0f, 32.0f)
                arcTo(8.0f, 8.0f, 0.0f, false, true, 165.66f, 141.66f)
                close()
                moveTo(52.94f, 64.0f)
...
private var `_box-arrow-up-fill`: ImageVector? = null
