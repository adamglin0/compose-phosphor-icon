...
public val FillGroup.`Gauge-fill`: ImageVector
    get() {
        if (`_gauge-fill` != null) {
            return `_gauge-fill`!!
        }
        `_gauge-fill` = Builder(name = "Gauge-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gauge-fill`: ImageVector? = null
