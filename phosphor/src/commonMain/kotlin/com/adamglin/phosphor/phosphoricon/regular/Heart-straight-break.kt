...
public val RegularGroup.`Heart-straight-break`: ImageVector
    get() {
        if (`_heart-straight-break` != null) {
            return `_heart-straight-break`!!
        }
        `_heart-straight-break` = Builder(name = "Heart-straight-break", defaultWidth = 256.0.dp,
...
private var `_heart-straight-break`: ImageVector? = null
