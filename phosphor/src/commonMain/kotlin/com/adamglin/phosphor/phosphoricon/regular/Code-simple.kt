...
public val RegularGroup.`Code-simple`: ImageVector
    get() {
        if (`_code-simple` != null) {
            return `_code-simple`!!
        }
        `_code-simple` = Builder(name = "Code-simple", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_code-simple`: ImageVector? = null
