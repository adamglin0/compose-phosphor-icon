...
public val FillGroup.`Grains-fill`: ImageVector
    get() {
        if (`_grains-fill` != null) {
            return `_grains-fill`!!
        }
        `_grains-fill` = Builder(name = "Grains-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_grains-fill`: ImageVector? = null
