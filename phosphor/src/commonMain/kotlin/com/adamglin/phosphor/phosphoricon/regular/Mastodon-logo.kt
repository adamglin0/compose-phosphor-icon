...
public val RegularGroup.`Mastodon-logo`: ImageVector
    get() {
        if (`_mastodon-logo` != null) {
            return `_mastodon-logo`!!
        }
        `_mastodon-logo` = Builder(name = "Mastodon-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mastodon-logo`: ImageVector? = null
