...
public val RegularGroup.`File-jsx`: ImageVector
    get() {
        if (`_file-jsx` != null) {
            return `_file-jsx`!!
        }
        `_file-jsx` = Builder(name = "File-jsx", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-jsx`: ImageVector? = null
