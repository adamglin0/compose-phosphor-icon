...
public val FillGroup.`Visor-fill`: ImageVector
    get() {
        if (`_visor-fill` != null) {
            return `_visor-fill`!!
        }
        `_visor-fill` = Builder(name = "Visor-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_visor-fill`: ImageVector? = null
