...
public val FillGroup.`Spray-bottle-fill`: ImageVector
    get() {
        if (`_spray-bottle-fill` != null) {
            return `_spray-bottle-fill`!!
        }
        `_spray-bottle-fill` = Builder(name = "Spray-bottle-fill", defaultWidth = 256.0.dp,
...
private var `_spray-bottle-fill`: ImageVector? = null
