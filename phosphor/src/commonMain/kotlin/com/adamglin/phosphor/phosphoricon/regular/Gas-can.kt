...
public val RegularGroup.`Gas-can`: ImageVector
    get() {
        if (`_gas-can` != null) {
            return `_gas-can`!!
        }
        `_gas-can` = Builder(name = "Gas-can", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_gas-can`: ImageVector? = null
