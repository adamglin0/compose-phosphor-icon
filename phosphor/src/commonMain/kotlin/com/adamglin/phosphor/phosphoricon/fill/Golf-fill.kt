...
public val FillGroup.`Golf-fill`: ImageVector
    get() {
        if (`_golf-fill` != null) {
            return `_golf-fill`!!
        }
        `_golf-fill` = Builder(name = "Golf-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_golf-fill`: ImageVector? = null
