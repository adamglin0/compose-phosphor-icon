...
public val RegularGroup.`Arrow-u-up-left`: ImageVector
    get() {
        if (`_arrow-u-up-left` != null) {
            return `_arrow-u-up-left`!!
        }
        `_arrow-u-up-left` = Builder(name = "Arrow-u-up-left", defaultWidth = 256.0.dp,
...
private var `_arrow-u-up-left`: ImageVector? = null
