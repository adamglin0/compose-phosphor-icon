...
public val RegularGroup.`Images-square`: ImageVector
    get() {
        if (`_images-square` != null) {
            return `_images-square`!!
        }
        `_images-square` = Builder(name = "Images-square", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_images-square`: ImageVector? = null
