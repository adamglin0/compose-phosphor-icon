...
public val RegularGroup.`Link-break`: ImageVector
    get() {
        if (`_link-break` != null) {
            return `_link-break`!!
        }
        `_link-break` = Builder(name = "Link-break", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_link-break`: ImageVector? = null
