...
public val RegularGroup.`Selection-foreground`: ImageVector
    get() {
        if (`_selection-foreground` != null) {
            return `_selection-foreground`!!
        }
        `_selection-foreground` = Builder(name = "Selection-foreground", defaultWidth = 256.0.dp,
...
private var `_selection-foreground`: ImageVector? = null
