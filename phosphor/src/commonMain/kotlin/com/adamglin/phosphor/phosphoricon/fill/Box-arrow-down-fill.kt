...
public val FillGroup.`Box-arrow-down-fill`: ImageVector
    get() {
        if (`_box-arrow-down-fill` != null) {
            return `_box-arrow-down-fill`!!
        }
        `_box-arrow-down-fill` = Builder(name = "Box-arrow-down-fill", defaultWidth = 256.0.dp,
...
private var `_box-arrow-down-fill`: ImageVector? = null
