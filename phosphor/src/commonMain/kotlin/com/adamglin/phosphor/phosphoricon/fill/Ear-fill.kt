...
public val FillGroup.`Ear-fill`: ImageVector
    get() {
        if (`_ear-fill` != null) {
            return `_ear-fill`!!
        }
        `_ear-fill` = Builder(name = "Ear-fill", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_ear-fill`: ImageVector? = null
