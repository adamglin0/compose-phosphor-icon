...
public val RegularGroup.`Funnel-x`: ImageVector
    get() {
        if (`_funnel-x` != null) {
            return `_funnel-x`!!
        }
        `_funnel-x` = Builder(name = "Funnel-x", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_funnel-x`: ImageVector? = null
