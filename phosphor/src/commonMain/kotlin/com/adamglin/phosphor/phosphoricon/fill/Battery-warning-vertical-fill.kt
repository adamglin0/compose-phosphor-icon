...
public val FillGroup.`Battery-warning-vertical-fill`: ImageVector
    get() {
        if (`_battery-warning-vertical-fill` != null) {
            return `_battery-warning-vertical-fill`!!
        }
        `_battery-warning-vertical-fill` = Builder(name = "Battery-warning-vertical-fill",
...
private var `_battery-warning-vertical-fill`: ImageVector? = null
