...
public val FillGroup.`Not-superset-of-fill`: ImageVector
    get() {
        if (`_not-superset-of-fill` != null) {
            return `_not-superset-of-fill`!!
        }
        `_not-superset-of-fill` = Builder(name = "Not-superset-of-fill", defaultWidth = 256.0.dp,
...
private var `_not-superset-of-fill`: ImageVector? = null
