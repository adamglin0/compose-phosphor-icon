...
public val RegularGroup.`Seal-percent`: ImageVector
    get() {
        if (`_seal-percent` != null) {
            return `_seal-percent`!!
        }
        `_seal-percent` = Builder(name = "Seal-percent", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seal-percent`: ImageVector? = null
