...
public val FillGroup.`Television-fill`: ImageVector
    get() {
        if (`_television-fill` != null) {
            return `_television-fill`!!
        }
        `_television-fill` = Builder(name = "Television-fill", defaultWidth = 256.0.dp,
...
private var `_television-fill`: ImageVector? = null
