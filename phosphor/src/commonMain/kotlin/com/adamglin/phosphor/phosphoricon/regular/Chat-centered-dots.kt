...
public val RegularGroup.`Chat-centered-dots`: ImageVector
    get() {
        if (`_chat-centered-dots` != null) {
            return `_chat-centered-dots`!!
        }
        `_chat-centered-dots` = Builder(name = "Chat-centered-dots", defaultWidth = 256.0.dp,
...
private var `_chat-centered-dots`: ImageVector? = null
