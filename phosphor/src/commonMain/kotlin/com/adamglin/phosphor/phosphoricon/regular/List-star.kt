...
public val RegularGroup.`List-star`: ImageVector
    get() {
        if (`_list-star` != null) {
            return `_list-star`!!
        }
        `_list-star` = Builder(name = "List-star", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_list-star`: ImageVector? = null
