...
public val FillGroup.`Smiley-fill`: ImageVector
    get() {
        if (`_smiley-fill` != null) {
            return `_smiley-fill`!!
        }
        `_smiley-fill` = Builder(name = "Smiley-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_smiley-fill`: ImageVector? = null
