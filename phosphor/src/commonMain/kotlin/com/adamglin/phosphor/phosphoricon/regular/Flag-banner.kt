...
public val RegularGroup.`Flag-banner`: ImageVector
    get() {
        if (`_flag-banner` != null) {
            return `_flag-banner`!!
        }
        `_flag-banner` = Builder(name = "Flag-banner", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flag-banner`: ImageVector? = null
