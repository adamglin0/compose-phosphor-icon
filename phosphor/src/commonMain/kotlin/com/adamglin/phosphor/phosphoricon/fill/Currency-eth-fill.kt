...
public val FillGroup.`Currency-eth-fill`: ImageVector
    get() {
        if (`_currency-eth-fill` != null) {
            return `_currency-eth-fill`!!
        }
        `_currency-eth-fill` = Builder(name = "Currency-eth-fill", defaultWidth = 256.0.dp,
...
private var `_currency-eth-fill`: ImageVector? = null
