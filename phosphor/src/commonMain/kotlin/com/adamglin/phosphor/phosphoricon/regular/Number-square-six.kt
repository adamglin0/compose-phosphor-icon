...
public val RegularGroup.`Number-square-six`: ImageVector
    get() {
        if (`_number-square-six` != null) {
            return `_number-square-six`!!
        }
        `_number-square-six` = Builder(name = "Number-square-six", defaultWidth = 256.0.dp,
...
private var `_number-square-six`: ImageVector? = null
