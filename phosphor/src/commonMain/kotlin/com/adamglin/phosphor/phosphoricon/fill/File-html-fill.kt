...
public val FillGroup.`File-html-fill`: ImageVector
    get() {
        if (`_file-html-fill` != null) {
            return `_file-html-fill`!!
        }
        `_file-html-fill` = Builder(name = "File-html-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_file-html-fill`: ImageVector? = null
