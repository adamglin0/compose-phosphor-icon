...
public val RegularGroup.`Flip-vertical`: ImageVector
    get() {
        if (`_flip-vertical` != null) {
            return `_flip-vertical`!!
        }
        `_flip-vertical` = Builder(name = "Flip-vertical", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_flip-vertical`: ImageVector? = null
