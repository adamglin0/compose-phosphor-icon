...
public val FillGroup.`Radio-fill`: ImageVector
    get() {
        if (`_radio-fill` != null) {
            return `_radio-fill`!!
        }
        `_radio-fill` = Builder(name = "Radio-fill", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(32.0f, 32.0f, 0.0f, false, true, 168.0f, 168.0f)
                close()
            }
        }
        .build()
