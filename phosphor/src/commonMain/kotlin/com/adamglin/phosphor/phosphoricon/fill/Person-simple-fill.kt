...
public val FillGroup.`Person-simple-fill`: ImageVector
    get() {
        if (`_person-simple-fill` != null) {
            return `_person-simple-fill`!!
        }
        `_person-simple-fill` = Builder(name = "Person-simple-fill", defaultWidth = 256.0.dp,
...
private var `_person-simple-fill`: ImageVector? = null
