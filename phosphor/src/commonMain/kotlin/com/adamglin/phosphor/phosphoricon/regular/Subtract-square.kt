...
public val RegularGroup.`Subtract-square`: ImageVector
    get() {
        if (`_subtract-square` != null) {
            return `_subtract-square`!!
        }
        `_subtract-square` = Builder(name = "Subtract-square", defaultWidth = 256.0.dp,
...
private var `_subtract-square`: ImageVector? = null
