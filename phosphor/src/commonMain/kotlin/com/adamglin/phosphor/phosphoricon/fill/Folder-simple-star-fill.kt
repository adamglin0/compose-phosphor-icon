...
public val FillGroup.`Folder-simple-star-fill`: ImageVector
    get() {
        if (`_folder-simple-star-fill` != null) {
            return `_folder-simple-star-fill`!!
        }
        `_folder-simple-star-fill` = Builder(name = "Folder-simple-star-fill", defaultWidth =
...
private var `_folder-simple-star-fill`: ImageVector? = null
