...
public val RegularGroup.`Fire-truck`: ImageVector
    get() {
        if (`_fire-truck` != null) {
            return `_fire-truck`!!
        }
        `_fire-truck` = Builder(name = "Fire-truck", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fire-truck`: ImageVector? = null
