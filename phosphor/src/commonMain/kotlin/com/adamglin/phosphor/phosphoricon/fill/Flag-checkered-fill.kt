...
public val FillGroup.`Flag-checkered-fill`: ImageVector
    get() {
        if (`_flag-checkered-fill` != null) {
            return `_flag-checkered-fill`!!
        }
        `_flag-checkered-fill` = Builder(name = "Flag-checkered-fill", defaultWidth = 256.0.dp,
...
private var `_flag-checkered-fill`: ImageVector? = null
