...
public val RegularGroup.`Hand-eye`: ImageVector
    get() {
        if (`_hand-eye` != null) {
            return `_hand-eye`!!
        }
        `_hand-eye` = Builder(name = "Hand-eye", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_hand-eye`: ImageVector? = null
