...
public val RegularGroup.`Cube-transparent`: ImageVector
    get() {
        if (`_cube-transparent` != null) {
            return `_cube-transparent`!!
        }
        `_cube-transparent` = Builder(name = "Cube-transparent", defaultWidth = 256.0.dp,
...
private var `_cube-transparent`: ImageVector? = null
