...
public val FillGroup.`Twitch-logo-fill`: ImageVector
    get() {
        if (`_twitch-logo-fill` != null) {
            return `_twitch-logo-fill`!!
        }
        `_twitch-logo-fill` = Builder(name = "Twitch-logo-fill", defaultWidth = 256.0.dp,
...
private var `_twitch-logo-fill`: ImageVector? = null
