...
public val RegularGroup.`Traffic-sign`: ImageVector
    get() {
        if (`_traffic-sign` != null) {
            return `_traffic-sign`!!
        }
        `_traffic-sign` = Builder(name = "Traffic-sign", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_traffic-sign`: ImageVector? = null
