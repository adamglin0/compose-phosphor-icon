...
public val RegularGroup.`Video-conference`: ImageVector
    get() {
        if (`_video-conference` != null) {
            return `_video-conference`!!
        }
        `_video-conference` = Builder(name = "Video-conference", defaultWidth = 256.0.dp,
...
private var `_video-conference`: ImageVector? = null
