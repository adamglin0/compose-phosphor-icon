...
public val RegularGroup.`Floppy-disk`: ImageVector
    get() {
        if (`_floppy-disk` != null) {
            return `_floppy-disk`!!
        }
        `_floppy-disk` = Builder(name = "Floppy-disk", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_floppy-disk`: ImageVector? = null
