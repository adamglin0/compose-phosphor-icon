...
public val FillGroup.`Cloud-x-fill`: ImageVector
    get() {
        if (`_cloud-x-fill` != null) {
            return `_cloud-x-fill`!!
        }
        `_cloud-x-fill` = Builder(name = "Cloud-x-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cloud-x-fill`: ImageVector? = null
