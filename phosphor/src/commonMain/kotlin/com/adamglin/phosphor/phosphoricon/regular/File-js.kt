...
public val RegularGroup.`File-js`: ImageVector
    get() {
        if (`_file-js` != null) {
            return `_file-js`!!
        }
        `_file-js` = Builder(name = "File-js", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-js`: ImageVector? = null
