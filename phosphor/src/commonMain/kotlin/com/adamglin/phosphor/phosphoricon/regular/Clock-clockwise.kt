...
public val RegularGroup.`Clock-clockwise`: ImageVector
    get() {
        if (`_clock-clockwise` != null) {
            return `_clock-clockwise`!!
        }
        `_clock-clockwise` = Builder(name = "Clock-clockwise", defaultWidth = 256.0.dp,
...
private var `_clock-clockwise`: ImageVector? = null
