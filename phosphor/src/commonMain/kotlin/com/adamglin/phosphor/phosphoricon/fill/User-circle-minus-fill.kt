...
public val FillGroup.`User-circle-minus-fill`: ImageVector
    get() {
        if (`_user-circle-minus-fill` != null) {
            return `_user-circle-minus-fill`!!
        }
        `_user-circle-minus-fill` = Builder(name = "User-circle-minus-fill", defaultWidth =
...
private var `_user-circle-minus-fill`: ImageVector? = null
