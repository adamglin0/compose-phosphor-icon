...
public val FillGroup.`Codepen-logo-fill`: ImageVector
    get() {
        if (`_codepen-logo-fill` != null) {
            return `_codepen-logo-fill`!!
        }
        `_codepen-logo-fill` = Builder(name = "Codepen-logo-fill", defaultWidth = 256.0.dp,
...
private var `_codepen-logo-fill`: ImageVector? = null
