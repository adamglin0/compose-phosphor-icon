...
public val FillGroup.`Number-zero-fill`: ImageVector
    get() {
        if (`_number-zero-fill` != null) {
            return `_number-zero-fill`!!
        }
        `_number-zero-fill` = Builder(name = "Number-zero-fill", defaultWidth = 256.0.dp,
...
private var `_number-zero-fill`: ImageVector? = null
