...
public val RegularGroup.`Seal-question`: ImageVector
    get() {
        if (`_seal-question` != null) {
            return `_seal-question`!!
        }
        `_seal-question` = Builder(name = "Seal-question", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_seal-question`: ImageVector? = null
