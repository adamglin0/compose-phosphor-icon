...
public val FillGroup.`Virtual-reality-fill`: ImageVector
    get() {
        if (`_virtual-reality-fill` != null) {
            return `_virtual-reality-fill`!!
        }
        `_virtual-reality-fill` = Builder(name = "Virtual-reality-fill", defaultWidth = 256.0.dp,
...
private var `_virtual-reality-fill`: ImageVector? = null
