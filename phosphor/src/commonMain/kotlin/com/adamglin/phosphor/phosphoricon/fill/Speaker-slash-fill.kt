...
public val FillGroup.`Speaker-slash-fill`: ImageVector
    get() {
        if (`_speaker-slash-fill` != null) {
            return `_speaker-slash-fill`!!
        }
        `_speaker-slash-fill` = Builder(name = "Speaker-slash-fill", defaultWidth = 256.0.dp,
...
private var `_speaker-slash-fill`: ImageVector? = null
