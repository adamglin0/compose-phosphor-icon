...
public val FillGroup.`Magnet-straight-fill`: ImageVector
    get() {
        if (`_magnet-straight-fill` != null) {
            return `_magnet-straight-fill`!!
        }
        `_magnet-straight-fill` = Builder(name = "Magnet-straight-fill", defaultWidth = 256.0.dp,
...
private var `_magnet-straight-fill`: ImageVector? = null
