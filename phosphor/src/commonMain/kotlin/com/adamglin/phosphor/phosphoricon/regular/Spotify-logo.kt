...
public val RegularGroup.`Spotify-logo`: ImageVector
    get() {
        if (`_spotify-logo` != null) {
            return `_spotify-logo`!!
        }
        `_spotify-logo` = Builder(name = "Spotify-logo", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_spotify-logo`: ImageVector? = null
