...
public val RegularGroup.`Phone-transfer`: ImageVector
    get() {
        if (`_phone-transfer` != null) {
            return `_phone-transfer`!!
        }
        `_phone-transfer` = Builder(name = "Phone-transfer", defaultWidth = 256.0.dp, defaultHeight
...
private var `_phone-transfer`: ImageVector? = null
