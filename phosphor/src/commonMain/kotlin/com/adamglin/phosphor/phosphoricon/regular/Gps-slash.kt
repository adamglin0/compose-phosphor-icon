...
public val RegularGroup.`Gps-slash`: ImageVector
    get() {
        if (`_gps-slash` != null) {
            return `_gps-slash`!!
        }
        `_gps-slash` = Builder(name = "Gps-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gps-slash`: ImageVector? = null
