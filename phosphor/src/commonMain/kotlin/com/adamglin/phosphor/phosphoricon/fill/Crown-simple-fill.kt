...
public val FillGroup.`Crown-simple-fill`: ImageVector
    get() {
        if (`_crown-simple-fill` != null) {
            return `_crown-simple-fill`!!
        }
        `_crown-simple-fill` = Builder(name = "Crown-simple-fill", defaultWidth = 256.0.dp,
...
private var `_crown-simple-fill`: ImageVector? = null
