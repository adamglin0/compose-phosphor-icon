...
public val FillGroup.`Solar-roof-fill`: ImageVector
    get() {
        if (`_solar-roof-fill` != null) {
            return `_solar-roof-fill`!!
        }
        `_solar-roof-fill` = Builder(name = "Solar-roof-fill", defaultWidth = 256.0.dp,
...
private var `_solar-roof-fill`: ImageVector? = null
