...
public val FillGroup.`Graphics-card-fill`: ImageVector
    get() {
        if (`_graphics-card-fill` != null) {
            return `_graphics-card-fill`!!
        }
        `_graphics-card-fill` = Builder(name = "Graphics-card-fill", defaultWidth = 256.0.dp,
...
private var `_graphics-card-fill`: ImageVector? = null
