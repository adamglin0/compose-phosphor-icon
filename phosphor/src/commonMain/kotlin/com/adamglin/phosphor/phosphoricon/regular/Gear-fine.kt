...
public val RegularGroup.`Gear-fine`: ImageVector
    get() {
        if (`_gear-fine` != null) {
            return `_gear-fine`!!
        }
        `_gear-fine` = Builder(name = "Gear-fine", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_gear-fine`: ImageVector? = null
