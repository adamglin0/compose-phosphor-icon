...
public val RegularGroup.`Mask-happy`: ImageVector
    get() {
        if (`_mask-happy` != null) {
            return `_mask-happy`!!
        }
        `_mask-happy` = Builder(name = "Mask-happy", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_mask-happy`: ImageVector? = null
