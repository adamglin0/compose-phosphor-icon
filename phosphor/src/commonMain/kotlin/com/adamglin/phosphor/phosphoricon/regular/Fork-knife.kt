...
public val RegularGroup.`Fork-knife`: ImageVector
    get() {
        if (`_fork-knife` != null) {
            return `_fork-knife`!!
        }
        `_fork-knife` = Builder(name = "Fork-knife", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_fork-knife`: ImageVector? = null
