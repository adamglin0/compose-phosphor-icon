...
public val RegularGroup.`Hard-drive`: ImageVector
    get() {
        if (`_hard-drive` != null) {
            return `_hard-drive`!!
        }
        `_hard-drive` = Builder(name = "Hard-drive", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hard-drive`: ImageVector? = null
