...
public val FillGroup.`Panorama-fill`: ImageVector
    get() {
        if (`_panorama-fill` != null) {
            return `_panorama-fill`!!
        }
        `_panorama-fill` = Builder(name = "Panorama-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_panorama-fill`: ImageVector? = null
