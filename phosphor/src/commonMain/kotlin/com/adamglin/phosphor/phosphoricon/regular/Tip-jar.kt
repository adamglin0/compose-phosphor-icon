...
public val RegularGroup.`Tip-jar`: ImageVector
    get() {
        if (`_tip-jar` != null) {
            return `_tip-jar`!!
        }
        `_tip-jar` = Builder(name = "Tip-jar", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_tip-jar`: ImageVector? = null
