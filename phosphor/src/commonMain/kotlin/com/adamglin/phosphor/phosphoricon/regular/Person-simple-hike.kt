...
public val RegularGroup.`Person-simple-hike`: ImageVector
    get() {
        if (`_person-simple-hike` != null) {
            return `_person-simple-hike`!!
        }
        `_person-simple-hike` = Builder(name = "Person-simple-hike", defaultWidth = 256.0.dp,
...
private var `_person-simple-hike`: ImageVector? = null
