...
public val RegularGroup.`Identification-badge`: ImageVector
    get() {
        if (`_identification-badge` != null) {
            return `_identification-badge`!!
        }
        `_identification-badge` = Builder(name = "Identification-badge", defaultWidth = 256.0.dp,
...
private var `_identification-badge`: ImageVector? = null
