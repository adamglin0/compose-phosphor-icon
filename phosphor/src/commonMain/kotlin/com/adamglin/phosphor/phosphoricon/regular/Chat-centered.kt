...
public val RegularGroup.`Chat-centered`: ImageVector
    get() {
        if (`_chat-centered` != null) {
            return `_chat-centered`!!
        }
        `_chat-centered` = Builder(name = "Chat-centered", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_chat-centered`: ImageVector? = null
