...
public val RegularGroup.`Shield-star`: ImageVector
    get() {
        if (`_shield-star` != null) {
            return `_shield-star`!!
        }
        `_shield-star` = Builder(name = "Shield-star", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shield-star`: ImageVector? = null
