...
public val RegularGroup.`Coat-hanger`: ImageVector
    get() {
        if (`_coat-hanger` != null) {
            return `_coat-hanger`!!
        }
        `_coat-hanger` = Builder(name = "Coat-hanger", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_coat-hanger`: ImageVector? = null
