...
public val RegularGroup.`File-md`: ImageVector
    get() {
        if (`_file-md` != null) {
            return `_file-md`!!
        }
        `_file-md` = Builder(name = "File-md", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_file-md`: ImageVector? = null
