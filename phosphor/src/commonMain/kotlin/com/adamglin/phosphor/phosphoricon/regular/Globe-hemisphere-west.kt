...
public val RegularGroup.`Globe-hemisphere-west`: ImageVector
    get() {
        if (`_globe-hemisphere-west` != null) {
            return `_globe-hemisphere-west`!!
        }
        `_globe-hemisphere-west` = Builder(name = "Globe-hemisphere-west", defaultWidth = 256.0.dp,
...
private var `_globe-hemisphere-west`: ImageVector? = null
