...
public val FillGroup.`Images-fill`: ImageVector
    get() {
        if (`_images-fill` != null) {
            return `_images-fill`!!
        }
        `_images-fill` = Builder(name = "Images-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_images-fill`: ImageVector? = null
