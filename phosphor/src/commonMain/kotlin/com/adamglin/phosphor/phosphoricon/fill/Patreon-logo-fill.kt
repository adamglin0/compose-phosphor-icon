...
public val FillGroup.`Patreon-logo-fill`: ImageVector
    get() {
        if (`_patreon-logo-fill` != null) {
            return `_patreon-logo-fill`!!
        }
        `_patreon-logo-fill` = Builder(name = "Patreon-logo-fill", defaultWidth = 256.0.dp,
...
private var `_patreon-logo-fill`: ImageVector? = null
