...
public val RegularGroup.`Arrows-merge`: ImageVector
    get() {
        if (`_arrows-merge` != null) {
            return `_arrows-merge`!!
        }
        `_arrows-merge` = Builder(name = "Arrows-merge", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_arrows-merge`: ImageVector? = null
