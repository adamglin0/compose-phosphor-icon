...
public val FillGroup.`Drop-half-bottom-fill`: ImageVector
    get() {
        if (`_drop-half-bottom-fill` != null) {
            return `_drop-half-bottom-fill`!!
        }
        `_drop-half-bottom-fill` = Builder(name = "Drop-half-bottom-fill", defaultWidth = 256.0.dp,
...
private var `_drop-half-bottom-fill`: ImageVector? = null
