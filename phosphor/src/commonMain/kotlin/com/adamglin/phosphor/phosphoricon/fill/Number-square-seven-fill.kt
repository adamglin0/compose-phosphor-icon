...
public val FillGroup.`Number-square-seven-fill`: ImageVector
    get() {
        if (`_number-square-seven-fill` != null) {
            return `_number-square-seven-fill`!!
        }
        `_number-square-seven-fill` = Builder(name = "Number-square-seven-fill", defaultWidth =
...
private var `_number-square-seven-fill`: ImageVector? = null
