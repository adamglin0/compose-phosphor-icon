...
public val FillGroup.`Radical-fill`: ImageVector
    get() {
        if (`_radical-fill` != null) {
            return `_radical-fill`!!
        }
        `_radical-fill` = Builder(name = "Radical-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_radical-fill`: ImageVector? = null
