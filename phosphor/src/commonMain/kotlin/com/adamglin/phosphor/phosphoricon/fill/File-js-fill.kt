...
public val FillGroup.`File-js-fill`: ImageVector
    get() {
        if (`_file-js-fill` != null) {
            return `_file-js-fill`!!
        }
        `_file-js-fill` = Builder(name = "File-js-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_file-js-fill`: ImageVector? = null
