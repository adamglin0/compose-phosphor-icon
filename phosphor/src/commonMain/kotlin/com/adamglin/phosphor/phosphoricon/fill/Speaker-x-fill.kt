...
public val FillGroup.`Speaker-x-fill`: ImageVector
    get() {
        if (`_speaker-x-fill` != null) {
            return `_speaker-x-fill`!!
        }
        `_speaker-x-fill` = Builder(name = "Speaker-x-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_speaker-x-fill`: ImageVector? = null
