...
public val FillGroup.`Globe-simple-fill`: ImageVector
    get() {
        if (`_globe-simple-fill` != null) {
            return `_globe-simple-fill`!!
        }
        `_globe-simple-fill` = Builder(name = "Globe-simple-fill", defaultWidth = 256.0.dp,
...
private var `_globe-simple-fill`: ImageVector? = null
