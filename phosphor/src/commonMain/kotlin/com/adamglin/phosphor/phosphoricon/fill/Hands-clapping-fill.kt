...
public val FillGroup.`Hands-clapping-fill`: ImageVector
    get() {
        if (`_hands-clapping-fill` != null) {
            return `_hands-clapping-fill`!!
        }
        `_hands-clapping-fill` = Builder(name = "Hands-clapping-fill", defaultWidth = 256.0.dp,
...
private var `_hands-clapping-fill`: ImageVector? = null
