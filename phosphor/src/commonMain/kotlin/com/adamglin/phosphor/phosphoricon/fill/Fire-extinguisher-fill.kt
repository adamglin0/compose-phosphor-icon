...
public val FillGroup.`Fire-extinguisher-fill`: ImageVector
    get() {
        if (`_fire-extinguisher-fill` != null) {
            return `_fire-extinguisher-fill`!!
        }
        `_fire-extinguisher-fill` = Builder(name = "Fire-extinguisher-fill", defaultWidth =
...
private var `_fire-extinguisher-fill`: ImageVector? = null
