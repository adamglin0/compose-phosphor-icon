...
public val FillGroup.`Subtitles-slash-fill`: ImageVector
    get() {
        if (`_subtitles-slash-fill` != null) {
            return `_subtitles-slash-fill`!!
        }
        `_subtitles-slash-fill` = Builder(name = "Subtitles-slash-fill", defaultWidth = 256.0.dp,
...
private var `_subtitles-slash-fill`: ImageVector? = null
