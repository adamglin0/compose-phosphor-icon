...
public val RegularGroup.`Cube-focus`: ImageVector
    get() {
        if (`_cube-focus` != null) {
            return `_cube-focus`!!
        }
        `_cube-focus` = Builder(name = "Cube-focus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_cube-focus`: ImageVector? = null
