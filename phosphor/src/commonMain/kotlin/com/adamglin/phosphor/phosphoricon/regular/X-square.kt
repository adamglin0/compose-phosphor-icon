...
public val RegularGroup.`X-square`: ImageVector
    get() {
        if (`_x-square` != null) {
            return `_x-square`!!
        }
        `_x-square` = Builder(name = "X-square", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
...
private var `_x-square`: ImageVector? = null
