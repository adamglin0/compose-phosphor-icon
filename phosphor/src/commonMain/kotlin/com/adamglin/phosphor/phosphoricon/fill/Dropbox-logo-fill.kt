...
public val FillGroup.`Dropbox-logo-fill`: ImageVector
    get() {
        if (`_dropbox-logo-fill` != null) {
            return `_dropbox-logo-fill`!!
        }
        `_dropbox-logo-fill` = Builder(name = "Dropbox-logo-fill", defaultWidth = 256.0.dp,
...
private var `_dropbox-logo-fill`: ImageVector? = null
