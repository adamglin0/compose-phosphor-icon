...
public val FillGroup.`Google-drive-logo-fill`: ImageVector
    get() {
        if (`_google-drive-logo-fill` != null) {
            return `_google-drive-logo-fill`!!
        }
        `_google-drive-logo-fill` = Builder(name = "Google-drive-logo-fill", defaultWidth =
...
private var `_google-drive-logo-fill`: ImageVector? = null
