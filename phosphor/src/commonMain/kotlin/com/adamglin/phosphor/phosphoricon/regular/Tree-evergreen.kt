...
public val RegularGroup.`Tree-evergreen`: ImageVector
    get() {
        if (`_tree-evergreen` != null) {
            return `_tree-evergreen`!!
        }
        `_tree-evergreen` = Builder(name = "Tree-evergreen", defaultWidth = 256.0.dp, defaultHeight
...
private var `_tree-evergreen`: ImageVector? = null
