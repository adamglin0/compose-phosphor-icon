...
public val RegularGroup.`Shield-plus`: ImageVector
    get() {
        if (`_shield-plus` != null) {
            return `_shield-plus`!!
        }
        `_shield-plus` = Builder(name = "Shield-plus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_shield-plus`: ImageVector? = null
