...
public val FillGroup.`Currency-jpy-fill`: ImageVector
    get() {
        if (`_currency-jpy-fill` != null) {
            return `_currency-jpy-fill`!!
        }
        `_currency-jpy-fill` = Builder(name = "Currency-jpy-fill", defaultWidth = 256.0.dp,
...
private var `_currency-jpy-fill`: ImageVector? = null
