...
public val RegularGroup.`Map-pin-plus`: ImageVector
    get() {
        if (`_map-pin-plus` != null) {
            return `_map-pin-plus`!!
        }
        `_map-pin-plus` = Builder(name = "Map-pin-plus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_map-pin-plus`: ImageVector? = null
