...
public val RegularGroup.`Number-two`: ImageVector
    get() {
        if (`_number-two` != null) {
            return `_number-two`!!
        }
        `_number-two` = Builder(name = "Number-two", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_number-two`: ImageVector? = null
