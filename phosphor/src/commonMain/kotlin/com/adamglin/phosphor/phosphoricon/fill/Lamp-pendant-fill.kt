...
public val FillGroup.`Lamp-pendant-fill`: ImageVector
    get() {
        if (`_lamp-pendant-fill` != null) {
            return `_lamp-pendant-fill`!!
        }
        `_lamp-pendant-fill` = Builder(name = "Lamp-pendant-fill", defaultWidth = 256.0.dp,
...
private var `_lamp-pendant-fill`: ImageVector? = null
