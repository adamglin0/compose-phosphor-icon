...
public val FillGroup.`Selection-inverse-fill`: ImageVector
    get() {
        if (`_selection-inverse-fill` != null) {
            return `_selection-inverse-fill`!!
        }
        `_selection-inverse-fill` = Builder(name = "Selection-inverse-fill", defaultWidth =
...
private var `_selection-inverse-fill`: ImageVector? = null
