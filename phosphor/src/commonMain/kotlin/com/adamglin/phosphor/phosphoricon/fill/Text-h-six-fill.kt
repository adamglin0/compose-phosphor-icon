...
public val FillGroup.`Text-h-six-fill`: ImageVector
    get() {
        if (`_text-h-six-fill` != null) {
            return `_text-h-six-fill`!!
        }
        `_text-h-six-fill` = Builder(name = "Text-h-six-fill", defaultWidth = 256.0.dp,
...
private var `_text-h-six-fill`: ImageVector? = null
