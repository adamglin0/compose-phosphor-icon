...
public val RegularGroup.`Office-chair`: ImageVector
    get() {
        if (`_office-chair` != null) {
            return `_office-chair`!!
        }
        `_office-chair` = Builder(name = "Office-chair", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_office-chair`: ImageVector? = null
