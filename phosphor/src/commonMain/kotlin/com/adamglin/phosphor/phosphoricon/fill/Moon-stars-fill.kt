...
public val FillGroup.`Moon-stars-fill`: ImageVector
    get() {
        if (`_moon-stars-fill` != null) {
            return `_moon-stars-fill`!!
        }
        `_moon-stars-fill` = Builder(name = "Moon-stars-fill", defaultWidth = 256.0.dp,
...
private var `_moon-stars-fill`: ImageVector? = null
