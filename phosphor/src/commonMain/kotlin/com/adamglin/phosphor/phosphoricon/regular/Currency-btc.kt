...
public val RegularGroup.`Currency-btc`: ImageVector
    get() {
        if (`_currency-btc` != null) {
            return `_currency-btc`!!
        }
        `_currency-btc` = Builder(name = "Currency-btc", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_currency-btc`: ImageVector? = null
