...
public val FillGroup.`Money-fill`: ImageVector
    get() {
        if (`_money-fill` != null) {
            return `_money-fill`!!
        }
        `_money-fill` = Builder(name = "Money-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_money-fill`: ImageVector? = null
