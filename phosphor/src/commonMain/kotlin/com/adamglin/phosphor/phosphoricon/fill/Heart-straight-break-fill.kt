...
public val FillGroup.`Heart-straight-break-fill`: ImageVector
    get() {
        if (`_heart-straight-break-fill` != null) {
            return `_heart-straight-break-fill`!!
        }
        `_heart-straight-break-fill` = Builder(name = "Heart-straight-break-fill", defaultWidth =
...
private var `_heart-straight-break-fill`: ImageVector? = null
