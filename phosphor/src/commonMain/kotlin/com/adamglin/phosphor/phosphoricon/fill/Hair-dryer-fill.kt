...
public val FillGroup.`Hair-dryer-fill`: ImageVector
    get() {
        if (`_hair-dryer-fill` != null) {
            return `_hair-dryer-fill`!!
        }
        `_hair-dryer-fill` = Builder(name = "Hair-dryer-fill", defaultWidth = 256.0.dp,
...
private var `_hair-dryer-fill`: ImageVector? = null
