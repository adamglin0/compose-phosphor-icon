...
public val FillGroup.`Flower-lotus-fill`: ImageVector
    get() {
        if (`_flower-lotus-fill` != null) {
            return `_flower-lotus-fill`!!
        }
        `_flower-lotus-fill` = Builder(name = "Flower-lotus-fill", defaultWidth = 256.0.dp,
...
private var `_flower-lotus-fill`: ImageVector? = null
