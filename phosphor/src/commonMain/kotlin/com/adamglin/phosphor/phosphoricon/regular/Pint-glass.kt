...
public val RegularGroup.`Pint-glass`: ImageVector
    get() {
        if (`_pint-glass` != null) {
            return `_pint-glass`!!
        }
        `_pint-glass` = Builder(name = "Pint-glass", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_pint-glass`: ImageVector? = null
