...
public val RegularGroup.`Sun-horizon`: ImageVector
    get() {
        if (`_sun-horizon` != null) {
            return `_sun-horizon`!!
        }
        `_sun-horizon` = Builder(name = "Sun-horizon", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_sun-horizon`: ImageVector? = null
