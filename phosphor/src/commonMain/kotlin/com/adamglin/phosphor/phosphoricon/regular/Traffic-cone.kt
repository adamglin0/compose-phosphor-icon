...
public val RegularGroup.`Traffic-cone`: ImageVector
    get() {
        if (`_traffic-cone` != null) {
            return `_traffic-cone`!!
        }
        `_traffic-cone` = Builder(name = "Traffic-cone", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_traffic-cone`: ImageVector? = null
