...
public val RegularGroup.`Hands-praying`: ImageVector
    get() {
        if (`_hands-praying` != null) {
            return `_hands-praying`!!
        }
        `_hands-praying` = Builder(name = "Hands-praying", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_hands-praying`: ImageVector? = null
