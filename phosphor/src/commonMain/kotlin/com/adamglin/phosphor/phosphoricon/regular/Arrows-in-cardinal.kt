...
public val RegularGroup.`Arrows-in-cardinal`: ImageVector
    get() {
        if (`_arrows-in-cardinal` != null) {
            return `_arrows-in-cardinal`!!
        }
        `_arrows-in-cardinal` = Builder(name = "Arrows-in-cardinal", defaultWidth = 256.0.dp,
...
private var `_arrows-in-cardinal`: ImageVector? = null
