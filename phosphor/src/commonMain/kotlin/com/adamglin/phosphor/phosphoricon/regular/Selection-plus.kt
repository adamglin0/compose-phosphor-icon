...
public val RegularGroup.`Selection-plus`: ImageVector
    get() {
        if (`_selection-plus` != null) {
            return `_selection-plus`!!
        }
        `_selection-plus` = Builder(name = "Selection-plus", defaultWidth = 256.0.dp, defaultHeight
...
private var `_selection-plus`: ImageVector? = null
