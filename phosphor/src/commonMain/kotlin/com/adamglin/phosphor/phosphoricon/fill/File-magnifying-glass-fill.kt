...
public val FillGroup.`File-magnifying-glass-fill`: ImageVector
    get() {
        if (`_file-magnifying-glass-fill` != null) {
            return `_file-magnifying-glass-fill`!!
        }
        `_file-magnifying-glass-fill` = Builder(name = "File-magnifying-glass-fill", defaultWidth =
...
private var `_file-magnifying-glass-fill`: ImageVector? = null
