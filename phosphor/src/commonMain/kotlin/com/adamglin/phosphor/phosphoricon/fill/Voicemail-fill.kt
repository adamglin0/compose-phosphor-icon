...
public val FillGroup.`Voicemail-fill`: ImageVector
    get() {
        if (`_voicemail-fill` != null) {
            return `_voicemail-fill`!!
        }
        `_voicemail-fill` = Builder(name = "Voicemail-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_voicemail-fill`: ImageVector? = null
