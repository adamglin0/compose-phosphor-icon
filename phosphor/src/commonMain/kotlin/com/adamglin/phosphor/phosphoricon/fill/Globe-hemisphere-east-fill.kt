...
public val FillGroup.`Globe-hemisphere-east-fill`: ImageVector
    get() {
        if (`_globe-hemisphere-east-fill` != null) {
            return `_globe-hemisphere-east-fill`!!
        }
        `_globe-hemisphere-east-fill` = Builder(name = "Globe-hemisphere-east-fill", defaultWidth =
...
private var `_globe-hemisphere-east-fill`: ImageVector? = null
