...
public val FillGroup.`Chat-text-fill`: ImageVector
    get() {
        if (`_chat-text-fill` != null) {
            return `_chat-text-fill`!!
        }
        `_chat-text-fill` = Builder(name = "Chat-text-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_chat-text-fill`: ImageVector? = null
