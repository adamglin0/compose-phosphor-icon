...
public val RegularGroup.`Computer-tower`: ImageVector
    get() {
        if (`_computer-tower` != null) {
            return `_computer-tower`!!
        }
        `_computer-tower` = Builder(name = "Computer-tower", defaultWidth = 256.0.dp, defaultHeight
...
private var `_computer-tower`: ImageVector? = null
