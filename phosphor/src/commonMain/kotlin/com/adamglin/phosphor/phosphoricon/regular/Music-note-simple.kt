...
public val RegularGroup.`Music-note-simple`: ImageVector
    get() {
        if (`_music-note-simple` != null) {
            return `_music-note-simple`!!
        }
        `_music-note-simple` = Builder(name = "Music-note-simple", defaultWidth = 256.0.dp,
...
private var `_music-note-simple`: ImageVector? = null
