...
public val RegularGroup.`Person-arms-spread`: ImageVector
    get() {
        if (`_person-arms-spread` != null) {
            return `_person-arms-spread`!!
        }
        `_person-arms-spread` = Builder(name = "Person-arms-spread", defaultWidth = 256.0.dp,
...
private var `_person-arms-spread`: ImageVector? = null
