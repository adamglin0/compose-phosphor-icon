...
public val FillGroup.`Open-ai-logo-fill`: ImageVector
    get() {
        if (`_open-ai-logo-fill` != null) {
            return `_open-ai-logo-fill`!!
        }
        `_open-ai-logo-fill` = Builder(name = "Open-ai-logo-fill", defaultWidth = 256.0.dp,
...
private var `_open-ai-logo-fill`: ImageVector? = null
