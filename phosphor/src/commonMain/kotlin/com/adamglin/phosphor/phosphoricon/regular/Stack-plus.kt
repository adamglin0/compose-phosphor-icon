...
public val RegularGroup.`Stack-plus`: ImageVector
    get() {
        if (`_stack-plus` != null) {
            return `_stack-plus`!!
        }
        `_stack-plus` = Builder(name = "Stack-plus", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_stack-plus`: ImageVector? = null
