...
public val FillGroup.`Acorn-fill`: ImageVector
    get() {
        if (`_acorn-fill` != null) {
            return `_acorn-fill`!!
        }
        `_acorn-fill` = Builder(name = "Acorn-fill", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_acorn-fill`: ImageVector? = null
