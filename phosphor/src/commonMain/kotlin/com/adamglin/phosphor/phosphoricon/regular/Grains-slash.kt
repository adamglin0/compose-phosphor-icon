...
public val RegularGroup.`Grains-slash`: ImageVector
    get() {
        if (`_grains-slash` != null) {
            return `_grains-slash`!!
        }
        `_grains-slash` = Builder(name = "Grains-slash", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_grains-slash`: ImageVector? = null
