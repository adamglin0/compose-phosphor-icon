...
public val RegularGroup.`Folder-user`: ImageVector
    get() {
        if (`_folder-user` != null) {
            return `_folder-user`!!
        }
        `_folder-user` = Builder(name = "Folder-user", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_folder-user`: ImageVector? = null
