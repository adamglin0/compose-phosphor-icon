...
public val RegularGroup.`Users-three`: ImageVector
    get() {
        if (`_users-three` != null) {
            return `_users-three`!!
        }
        `_users-three` = Builder(name = "Users-three", defaultWidth = 256.0.dp, defaultHeight =
...
private var `_users-three`: ImageVector? = null
