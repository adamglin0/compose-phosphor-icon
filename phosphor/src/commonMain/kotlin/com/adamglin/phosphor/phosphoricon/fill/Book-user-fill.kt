...
public val FillGroup.`Book-user-fill`: ImageVector
    get() {
        if (`_book-user-fill` != null) {
            return `_book-user-fill`!!
        }
        `_book-user-fill` = Builder(name = "Book-user-fill", defaultWidth = 256.0.dp, defaultHeight
...
private var `_book-user-fill`: ImageVector? = null
