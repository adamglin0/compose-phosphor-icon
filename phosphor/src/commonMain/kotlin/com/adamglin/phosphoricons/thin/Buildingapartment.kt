...
public val ThinGroup.Buildingapartment: ImageVector
    get() {
        ...
        _buildingapartment = Builder(name = "Buildingapartment", defaultWidth = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(120.0f, 76.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 116.0f, 72.0f)
                close()
                ...
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -8.0f)
                lineTo(80.0f, 132.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 84.0f, 136.0f)
                close()
                moveTo(84.0f, 168.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, -4.0f, 4.0f)
                lineTo(64.0f, 172.0f)
                arcToRelative(4.0f, 4.0f, 0.0f, false, true, 0.0f, -8.0f)
                lineTo(80.0f, 164.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 84.0f, 168.0f)
                close()
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 172.0f, 168.0f)
                close()
            }
        }
        .build()
