...
public val ThinGroup.Rowsplustop: ImageVector
    get() {
        if (_rowsplustop != null) {
            return _rowsplustop!!
        }
        _rowsplustop = Builder(name = "Rowsplustop", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(124.0f, 44.0f)
                lineTo(104.0f, 44.0f)
                arcTo(4.0f, 4.0f, 0.0f, false, true, 100.0f, 40.0f)
                close()
            }
        }
        .build()
