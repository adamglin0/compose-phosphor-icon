...
public val ThinGroup.Firetruck: ImageVector
    get() {
        if (_firetruck != null) {
            return _firetruck!!
        }
        _firetruck = Builder(name = "Firetruck", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, false, 251.71f, 118.51f)
                close()
                moveTo(226.58f, 84.0f)
