    ...
    get() {
        ...
        _fileHtml = Builder(name = "FileHtml", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 120.0f, 160.0f)
                close()
                ...
                arcTo(4.0f, 4.0f, 0.0f, false, true, 248.0f, 208.0f)
                close()
            }
        }
        .build()
