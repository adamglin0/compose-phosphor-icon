...
public val BoldGroup.FilePy: ImageVector
    get() {
        if (_filePy != null) {
            return _filePy!!
        }
        _filePy = Builder(name = "FilePy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(144.0f, 187.44f)
                lineTo(144.0f, 208.0f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, -24.0f, 0.0f)
                lineTo(120.0f, 187.44f)
                lineToRelative(-18.18f, -29.08f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 20.36f, -12.72f)
                lineTo(132.0f, 161.36f)
                lineToRelative(9.82f, -15.72f)
                arcToRelative(12.0f, 12.0f, 0.0f, false, true, 20.36f, 12.72f)
                close()
            }
        }
