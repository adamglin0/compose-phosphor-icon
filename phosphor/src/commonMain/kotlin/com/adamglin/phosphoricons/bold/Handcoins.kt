    ...
    get() {
        ...
        _handcoins = Builder(name = "Handcoins", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(40.36f, 40.36f, 0.0f, false, false, 5.18f, -0.34f)
                arcToRelative(40.0f, 40.0f, 0.0f, true, false, 29.67f, -59.32f)
                arcTo(40.0f, 40.0f, 0.0f, true, false, 164.0f, 100.0f)
                close()
                moveTo(204.0f, 64.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, true, true, -16.0f, 16.0f)
                arcTo(16.0f, 16.0f, 0.0f, false, true, 204.0f, 64.0f)
                close()
                moveTo(164.0f, 44.0f)
                arcToRelative(16.0f, 16.0f, 0.0f, false, true, 12.94f, 6.58f)
                arcTo(39.9f, 39.9f, 0.0f, false, false, 164.2f, 76.0f)
                lineTo(164.0f, 76.0f)
