    ...
    get() {
        ...
        _shootingStar = Builder(name = "ShootingStar", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(230.08f, 78.26f)
                lineToRelative(-31.84f, 26.88f)
                lineTo(208.0f, 145.33f)
                arcToRelative(5.46f, 5.46f, 0.0f, false, true, -8.19f, 5.86f)
                lineTo(164.0f, 129.66f)
                lineToRelative(-35.78f, 21.53f)
                arcToRelative(5.46f, 5.46f, 0.0f, false, true, -8.19f, -5.86f)
                lineToRelative(9.73f, -40.19f)
                lineTo(97.92f, 78.26f)
                arcToRelative(5.38f, 5.38f, 0.0f, false, true, 3.13f, -9.48f)
                lineToRelative(41.79f, -3.31f)
                lineToRelative(16.1f, -38.14f)
                arcToRelative(5.51f, 5.51f, 0.0f, false, true, 10.12f, 0.0f)
                lineToRelative(16.1f, 38.14f)
                lineTo(227.0f, 68.78f)
                arcTo(5.38f, 5.38f, 0.0f, false, true, 230.08f, 78.26f)
                close()
            }
