    ...
    get() {
        ...
        _rocketlaunch = Builder(name = "Rocketlaunch", defaultWidth = 256.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -13.57f, -4.53f)
                ...
                close()
                moveTo(40.0f, 216.0f)
                curveToRelative(37.65f, 0.0f, 50.69f, -19.69f, 54.56f, -28.18f)
                lineTo(68.18f, 161.44f)
                curveTo(59.69f, 165.31f, 40.0f, 178.35f, 40.0f, 216.0f)
                close()
            }
