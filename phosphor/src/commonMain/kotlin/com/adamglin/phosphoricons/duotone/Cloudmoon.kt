    ...
    get() {
        ...
        _cloudmoon = Builder(name = "Cloudmoon", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                close()
                moveTo(102.38f, 17.62f)
                horizontalLineToRelative(0.0f)
                arcTo(64.06f, 64.06f, 0.0f, false, true, 25.62f, 94.38f)
                horizontalLineToRelative(0.0f)
                arcTo(64.12f, 64.12f, 0.0f, false, false, 63.0f, 138.93f)
                horizontalLineToRelative(0.0f)
                ...
                arcTo(64.0f, 64.0f, 0.0f, false, false, 102.38f, 17.62f)
                close()
            }
