    ...
    get() {
        ...
        _crown = Builder(name = "Crown", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, fillAlpha = 0.2f, strokeAlpha
                ...
                moveTo(216.71f, 99.73f)
                lineToRelative(-15.6f, 93.59f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.89f, 6.68f)
                horizontalLineTo(62.78f)
                arcToRelative(8.0f, 8.0f, 0.0f, false, true, -7.89f, -6.68f)
                lineTo(39.29f, 99.73f)
                lineToRelative(0.08f, 0.0f)
                arcToRelative(19.82f, 19.82f, 0.0f, false, false, 9.22f, -4.16f)
                horizontalLineToRelative(0.0f)
                lineTo(88.0f, 144.0f)
                lineToRelative(32.0f, -73.65f)
                horizontalLineToRelative(0.0f)
                arcToRelative(20.0f, 20.0f, 0.0f, false, false, 15.92f, 0.0f)
                horizontalLineToRelative(0.0f)
