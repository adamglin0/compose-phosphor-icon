    ...
    get() {
        ...
        _signature = Builder(name = "Signature", defaultWidth = 256.0.dp, defaultHeight = 256.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(15.0f, 1.65f, 32.58f, -8.78f, 52.66f, -31.14f)
                curveToRelative(5.0f, 13.46f, 14.45f, 30.93f, 30.58f, 31.25f)
                curveToRelative(9.06f, 0.18f, 18.11f, -5.2f, 27.42f, -16.37f)
                ...
                curveToRelative(-12.07f, 18.54f, -19.38f, 20.43f, -21.92f, 20.37f)
